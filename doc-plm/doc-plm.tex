...
\newenvironment{PLM}[1][0]{%
  ...
  \ifthenelse{\equal{\ParametrePLM}{0}}{
    ...
    {\singlespacing\begin{linenumbers}\resetlinenumber[\ParametrePLM]\ttfamily\input{temp.plm.tex}\end{linenumbers}}
  }
}
\makeatother
...
\setcounter{tocdepth}{3} % Faire apparaître jusqu'aux subsubsections
