...
\newenvironment{PLM}{%
  ...
  {\singlespacing\begin{siderules}\ttfamily\input{temp.plm.tex}\end{siderules}}
}
\makeatother
...
%\newcommand\keywordStyleplm[1]{\textcolor{blue}{\textbf{#1}}}
%\newcommand\instructionStyleplm[1]{\textcolor{brown}{\textbf{#1}}}
%\newcommand\delimitersStyleplm[1]{\textcolor{orange}{#1}}
%\newcommand\integerStyleplm[1]{\textcolor{orange}{#1}}
%\newcommand\characterStyleplm[1]{\textcolor{orange}{#1}}
%\newcommand\stringStyleplm[1]{\textcolor{gray}{#1}}
%\newcommand\commentStyleplm[1]{\textcolor{red}{#1}}
...
\input{chapitres/modes.tex}
\input{chapitres/declaration-variable.tex}
\input{chapitres/structures-de-controle.tex}
