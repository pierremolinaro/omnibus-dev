...
\RequirePackage{etex}
\usepackage{fontspec}
\setmainfont[Ligatures=TeX, Scale=1.15]{Gill Sans} % {Gill Sans} % {Palatino} % {Optima} % {Hoefler Text}
...
\newenvironment{PLM}[1][0]{%
  ...
  \ifthenelse{\equal{\ParametrePLM}{0}}{
    {\begin{siderules}\ttfamily\input{temp.plm.tex}\end{siderules}}
  }{
    {\begin{linenumbers}\resetlinenumber[\ParametrePLM]\ttfamily\input{temp.plm.tex}\end{linenumbers}}
  }
}
\makeatother
...
\newcommand\@plm[2]{%
  ...
  \lowercase{%
    \def\@tempa##1~{%
      ...
      \immediate\closeout\tempfile%
      \immediate\write18{plm --mode=latex:plm temp.plm}%
      \colorbox{gray!6}{\ttfamily\input{temp.plm.tex}\unskip}%
    }%
  }%
...
%--- Profondeur de la table des matières jusqu'au niveau 2 (subsection)
...
\input{chapitres/variable-globale.tex}
