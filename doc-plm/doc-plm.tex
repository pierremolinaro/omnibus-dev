...
\newcommand\typeStyleplm[1]{\textcolor{violet}{#1}}
\newcommand\groupStyleplm[1]{\textcolor{ProcessBlue}{#1}}
...
\newenvironment{PLM}[1][0]{%
  ...
  \ifthenelse{\equal{\ParametrePLM}{0}}{
    {\begin{siderules}\zeroEspaceAvantPonctuation{\ttfamily\input{temp.plm.tex}}\end{siderules}}
  }{
    {\begin{linenumbers}\resetlinenumber[\ParametrePLM]\zeroEspaceAvantPonctuation{\ttfamily\input{temp.plm.tex}}\end{linenumbers}}
  }
}
\makeatother
...
\newcommand\@plm[2]{%
  ...
  \lowercase{%
    \def\@tempa##1~{%
      ...
      \immediate\closeout\tempfile%
      \immediate\write18{plm --mode=latex:plm temp.plm}%
      \colorbox{gray!6}{\zeroEspaceAvantPonctuation{\ttfamily\input{temp.plm.tex}}\unskip}%
    }%
  }%
