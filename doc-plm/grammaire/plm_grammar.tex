...
\nonTerminalSection{effective\_parameters}{42}
...
\begin{tikzpicture}
  \matrix[column sep=\ruleMatrixColumnSeparation, row sep=\ruleMatrixRowSeparation] {
    \node (P0start) [firstPoint] {}; & & \node (p0-2) [nonterminal] {\nonTerminalSymbol{lvalue}{41}}; & \node (p0-3) [nonterminal] {\nonTerminalSymbol{assignment\_operator}{37}}; & \node (p0-4) [nonterminal] {\nonTerminalSymbol{expression}{21}}; & \node (p0-5) [lastPoint] {}; & \\
  };
  \draw[->] (P0start) -- (p0-2) ;
  \draw[->] (p0-2) -- (p0-3) ;
  \draw[->] (p0-3) -- (p0-4) ;
