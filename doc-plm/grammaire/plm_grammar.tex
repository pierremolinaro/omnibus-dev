...
\ruleSubsection{plm\_syntax}{type-structure-declaration}{92}

\begin{tikzpicture}
  \matrix[column sep=\ruleMatrixColumnSeparation, row sep=\ruleMatrixRowSeparation] {
    & & & & & & & & & & & & & & \node (p6-14) [point] {}; & \\
    & & & & & & & & & & & & & \node (p5-13) [terminal] {;}; & \\
    & & & & & & & & & & & & & \node (p4-13) [nonterminal] {\nonTerminalSymbol{guard}{20}}; & \\
    & & & & & & & & & & & & & \node (p3-13) [nonterminal] {\nonTerminalSymbol{system\_routine}{1}}; & \\
    & & & & & & & & \node (p2-8) [point] {}; & & & & & \node (p2-13) [nonterminal] {\nonTerminalSymbol{function}{0}}; & \\
    & & & & & & & \node (p1-7) [terminal] {@attribute}; & & & & & & \node (p1-13) [nonterminal] {\nonTerminalSymbol{private\_or\_public\_struct\_property\_declaration}{6}}; & \\
...
\begin{tikzpicture}
  \matrix[column sep=\ruleMatrixColumnSeparation, row sep=\ruleMatrixRowSeparation] {
    ...
    & & & & & & & & \node (p1-8) [nonterminal] {\nonTerminalSymbol{property\_in\_extension}{9}}; & \\
...
\ruleSubsection{plm\_syntax}{declaration-module}{85}
...
\begin{tikzpicture}
  \matrix[column sep=\ruleMatrixColumnSeparation, row sep=\ruleMatrixRowSeparation] {
    ...
    & & & & & & & & \node (p4-8) [nonterminal] {\nonTerminalSymbol{function}{0}}; & \\
    & & & & & & & & \node (p3-8) [nonterminal] {\nonTerminalSymbol{module\_property}{11}}; & \\
    & & & & & & & & \node (p2-8) [nonterminal] {\nonTerminalSymbol{isr}{19}}; & \\
...
\ruleSubsection{plm\_syntax}{declaration-module}{124}
...
\ruleSubsection{plm\_syntax}{declaration-task}{43}

\begin{tikzpicture}
  \matrix[column sep=\ruleMatrixColumnSeparation, row sep=\ruleMatrixRowSeparation] {
    \node (P0start) [firstPoint] {}; & & \node (p8-2) [terminal] {task}; & \\
    & & \node (p7-2) [terminal] {identifier}; & \\
    & & \node (p6-2) [terminal] {priority}; & \\
    & & \node (p5-2) [terminal] {integer}; & \\
    & & \node (p4-2) [terminal] {stackSize}; & \\
    & & \node (p3-2) [terminal] {integer}; & \\
    & & \node (p2-2) [terminal] {\{}; & \\
    & & \node (p1-2) [nonterminal] {\nonTerminalSymbol{taskBody}{14}}; & \\
    & & \node (p0-2) [terminal] {\}}; & \node (p0-3) [lastPoint] {}; & \\
  };
  \draw[->] (P0start) -- (p8-2) ;
  \draw[->] (p8-2) -- (p7-2) ;
...
\ruleSubsection{plm\_syntax}{declaration-init}{24}
...
\ruleSubsection{plm\_syntax}{declaration-init}{30}
...
\nonTerminalSection{declaration\_type}{5}
...
\nonTerminalSection{effective\_parameters}{33}
...
\nonTerminalSection{function\_header}{17}
...
\ruleSubsection{plm\_syntax}{instruction-sync}{46}

\begin{tikzpicture}
  \matrix[column sep=\ruleMatrixColumnSeparation, row sep=\ruleMatrixRowSeparation] {
    & & & & \node (p3-4) [terminal] {while}; & & & & \node (p3-8) [terminal] {.}; & \node (p3-9) [terminal] {identifier}; & \node (p3-10) [nonterminal] {\nonTerminalSymbol{effective\_parameters}{33}}; & \\
...
\nonTerminalSection{import\_file}{2}

\ruleSubsection{plm\_syntax}{syntax-grammar}{13}
...
\ruleSubsection{plm\_syntax}{instruction-assignment-without-self}{18}

\begin{tikzpicture}
  \matrix[column sep=\ruleMatrixColumnSeparation, row sep=\ruleMatrixRowSeparation] {
    \node (P0start) [firstPoint] {}; & & \node (p0-2) [nonterminal] {\nonTerminalSymbol{lvalue\_without\_self}{40}}; & \node (p0-3) [terminal] {=}; & \node (p0-4) [nonterminal] {\nonTerminalSymbol{expression}{21}}; & \node (p0-5) [lastPoint] {}; & \\
  };
  \draw[->] (P0start) -- (p0-2) ;
  \draw[->] (p0-2) -- (p0-3) ;
  \draw[->] (p0-3) -- (p0-4) ;
...
\ruleSubsection{plm\_syntax}{instruction-assignment-with-self}{18}

\begin{tikzpicture}
  \matrix[column sep=\ruleMatrixColumnSeparation, row sep=\ruleMatrixRowSeparation] {
    \node (P0start) [firstPoint] {}; & & \node (p0-2) [nonterminal] {\nonTerminalSymbol{lvalue\_with\_self}{41}}; & \node (p0-3) [terminal] {=}; & \node (p0-4) [nonterminal] {\nonTerminalSymbol{expression}{21}}; & \node (p0-5) [lastPoint] {}; & \\
  };
  \draw[->] (P0start) -- (p0-2) ;
  \draw[->] (p0-2) -- (p0-3) ;
  \draw[->] (p0-3) -- (p0-4) ;
...
\ruleSubsection{plm\_syntax}{instruction-assignment-operator}{43}

\begin{tikzpicture}
  \matrix[column sep=\ruleMatrixColumnSeparation, row sep=\ruleMatrixRowSeparation] {
    \node (P0start) [firstPoint] {}; & & \node (p0-2) [nonterminal] {\nonTerminalSymbol{lvalue\_without\_self}{40}}; & \node (p0-3) [nonterminal] {\nonTerminalSymbol{assignment\_operator}{36}}; & \node (p0-4) [nonterminal] {\nonTerminalSymbol{expression}{21}}; & \node (p0-5) [lastPoint] {}; & \\
  };
  \draw[->] (P0start) -- (p0-2) ;
  \draw[->] (p0-2) -- (p0-3) ;
  \draw[->] (p0-3) -- (p0-4) ;
...
\ruleSubsection{plm\_syntax}{instruction-assignment-operator}{79}
...
\ruleSubsection{plm\_syntax}{instruction-sync}{117}
...
\ruleSubsection{plm\_syntax}{instruction-procedure-call}{36}
...
\nonTerminalSection{lvalue\_with\_self}{41}

\ruleSubsection{plm\_syntax}{lvalue-with-self}{19}
...
\nonTerminalSection{lvalue\_without\_self}{40}

\ruleSubsection{plm\_syntax}{lvalue-without-self}{33}
...
\nonTerminalSection{module\_property}{11}

\ruleSubsection{plm\_syntax}{declaration-module}{57}
...
\begin{tikzpicture}
  \matrix[column sep=\ruleMatrixColumnSeparation, row sep=\ruleMatrixRowSeparation] {
    \node (P0start) [firstPoint] {}; & & \node (p8-2) [terminal] {if}; & \\
    & & \node (p7-2) [nonterminal] {\nonTerminalSymbol{expression}{21}}; & \\
    & & \node (p6-2) [terminal] {\{}; & \\
    & & \node (p5-2) [nonterminal] {\nonTerminalSymbol{expression}{21}}; & \\
    & & \node (p4-2) [terminal] {\}}; & \\
    & & \node (p3-2) [terminal] {else}; & \\
    & & \node (p2-2) [terminal] {\{}; & \\
    & & \node (p1-2) [nonterminal] {\nonTerminalSymbol{expression}{21}}; & \\
    & & \node (p0-2) [terminal] {\}}; & \node (p0-3) [lastPoint] {}; & \\
  };
...
\nonTerminalSection{private\_or\_public\_struct\_property\_declaration}{6}

\ruleSubsection{plm\_syntax}{type-structure-declaration}{45}

\begin{tikzpicture}
  \matrix[column sep=\ruleMatrixColumnSeparation, row sep=\ruleMatrixRowSeparation] {
    & & & \node (p1-3) [terminal] {public}; & \\
    \node (P0start) [firstPoint] {}; & & \node (p0-2) [point] {}; & \node (p0-3) [point] {}; & \node (p0-4) [point] {}; & \node (p0-5) [nonterminal] {\nonTerminalSymbol{struct\_property\_declaration}{8}}; & \node (p0-6) [lastPoint] {}; & \\
  };
  \draw (P0start) -- (p0-3) ;
  \draw[->] (p0-2) |- (p1-3) ;
  \draw (p0-3) -- (p0-4) ;
...
\nonTerminalSection{private\_struct\_property\_declaration}{7}

\ruleSubsection{plm\_syntax}{type-structure-declaration}{58}
...
\ruleSubsection{plm\_syntax}{instruction-procedure-call}{43}
...
\ruleSubsection{plm\_syntax}{instruction-procedure-call}{61}
...
\nonTerminalSection{property\_in\_extension}{9}
...
\nonTerminalSection{start\_symbol}{3}

\ruleSubsection{plm\_syntax}{syntax-grammar}{25}

\begin{tikzpicture}
  \matrix[column sep=\ruleMatrixColumnSeparation, row sep=\ruleMatrixRowSeparation] {
    & & & & & & \node (p6-6) [point] {}; & \\
    & & & & & \node (p5-5) [nonterminal] {\nonTerminalSymbol{import\_file}{2}}; & \\
    & & & & & \node (p4-5) [nonterminal] {\nonTerminalSymbol{isr}{19}}; & \\
    & & & & & \node (p3-5) [nonterminal] {\nonTerminalSymbol{system\_routine}{1}}; & \\
    & & & & & \node (p2-5) [nonterminal] {\nonTerminalSymbol{function}{0}}; & \\
    & & & & & \node (p1-5) [nonterminal] {\nonTerminalSymbol{declaration}{4}}; & \\
    \node (P0start) [firstPoint] {}; & & \node (p0-2) [point] {}; & \node (p0-3) [point] {}; & \node (p0-4) [point] {}; & & & \node (p0-7) [lastPoint] {}; & \\
  };
  \draw (P0start) -- (p0-3) ;
  \draw[->] (p0-4) |- (p1-5) ;
...
\nonTerminalSection{staticArrayProperty}{12}

\ruleSubsection{plm\_syntax}{declaration-static-array}{59}

\begin{tikzpicture}
  \matrix[column sep=\ruleMatrixColumnSeparation, row sep=\ruleMatrixRowSeparation] {
    & & & & & & & & & \node (p2-9) [terminal] {->}; & \node (p2-10) [terminal] {\$type}; & \\
...
\nonTerminalSection{staticArray\_exp}{13}

\ruleSubsection{plm\_syntax}{declaration-extend-static-array}{65}
...
\nonTerminalSection{struct\_property\_declaration}{8}

\ruleSubsection{plm\_syntax}{type-structure-declaration}{64}
...
\nonTerminalSection{system\_routine}{1}
...
\nonTerminalSection{taskBody}{14}

\ruleSubsection{plm\_syntax}{declaration-task}{71}

\begin{tikzpicture}
  \matrix[column sep=\ruleMatrixColumnSeparation, row sep=\ruleMatrixRowSeparation] {
    & & & & & & & & & & & & & & & \node (p6-15) [point] {}; & \\
    & & & & & \node (p5-5) [nonterminal] {\nonTerminalSymbol{guarded\_command}{38}}; & \node (p5-6) [terminal] {\{}; & \node (p5-7) [nonterminal] {\nonTerminalSymbol{instructionList}{34}}; & \node (p5-8) [terminal] {\}}; & \\
    & & & & & \node (p4-5) [terminal] {setup}; & \node (p4-6) [terminal] {integer}; & \node (p4-7) [terminal] {\{}; & \node (p4-8) [nonterminal] {\nonTerminalSymbol{instructionList}{34}}; & \node (p4-9) [terminal] {\}}; & \\
    & & & & & & & & & \node (p3-9) [terminal] {->}; & \node (p3-10) [terminal] {\$type}; & \\
    & & & & & \node (p2-5) [terminal] {func}; & \node (p2-6) [terminal] {identifier}; & \node (p2-7) [nonterminal] {\nonTerminalSymbol{procedure\_formal\_arguments}{18}}; & \node (p2-8) [point] {}; & \node (p2-9) [point] {}; & & \node (p2-11) [point] {}; & \node (p2-12) [terminal] {\{}; & \node (p2-13) [nonterminal] {\nonTerminalSymbol{instructionList}{34}}; & \node (p2-14) [terminal] {\}}; & \\
    & & & & & \node (p1-5) [nonterminal] {\nonTerminalSymbol{private\_struct\_property\_declaration}{7}}; & \\
    \node (P0start) [firstPoint] {}; & & \node (p0-2) [point] {}; & \node (p0-3) [point] {}; & \node (p0-4) [point] {}; & & & & & & & & & & & & \node (p0-16) [lastPoint] {}; & \\
  };
  \draw (P0start) -- (p0-3) ;
  \draw[->] (p0-4) |- (p1-5) ;
