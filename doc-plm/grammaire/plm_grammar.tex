...
\nonTerminalSection{assignment\_target\_noself}{38}

\ruleSubsection{plm\_syntax}{assignment-target}{41}

\begin{tikzpicture}
  \matrix[column sep=\ruleMatrixColumnSeparation, row sep=\ruleMatrixRowSeparation] {
    & & & & & & & & & \node (p3-9) [point] {}; & \\
    & & & & & & \node (p2-6) [terminal] {[}; & \node (p2-7) [nonterminal] {\nonTerminalSymbol{expression}{19}}; & \node (p2-8) [terminal] {]}; & \\
...
\nonTerminalSection{assignment\_target\_self}{39}

\ruleSubsection{plm\_syntax}{assignment-target}{63}
...
\ruleSubsection{plm\_syntax}{declaration-module}{77}
...
\begin{tikzpicture}
  \matrix[column sep=\ruleMatrixColumnSeparation, row sep=\ruleMatrixRowSeparation] {
    ...
    & & & & & & & & \node (p4-8) [nonterminal] {\nonTerminalSymbol{function}{0}}; & \\
    & & & & & & & & \node (p3-8) [nonterminal] {\nonTerminalSymbol{module\_variable}{10}}; & \\
    & & & & & & & & \node (p2-8) [nonterminal] {\nonTerminalSymbol{isr}{2}}; & \\
    & & & & & & & & \node (p1-8) [nonterminal] {\nonTerminalSymbol{declaration\_init}{14}}; & \\
...
\ruleSubsection{plm\_syntax}{declaration-module}{117}
...
\begin{tikzpicture}
  \matrix[column sep=\ruleMatrixColumnSeparation, row sep=\ruleMatrixRowSeparation] {
    ...
    & & \node (p3-2) [terminal] {integer}; & \\
    & & \node (p2-2) [terminal] {\{}; & \\
    & & \node (p1-2) [nonterminal] {\nonTerminalSymbol{instructionList}{32}}; & \\
    & & \node (p0-2) [terminal] {\}}; & \node (p0-3) [lastPoint] {}; & \\
  };
  \draw[->] (P0start) -- (p5-2) ;
  \draw[->] (p5-2) -- (p4-2) ;
...
\nonTerminalSection{declaration\_init}{14}
...
\nonTerminalSection{effective\_parameters}{31}
...
\nonTerminalSection{expression}{19}
...
\begin{tikzpicture}
  \matrix[column sep=\ruleMatrixColumnSeparation, row sep=\ruleMatrixRowSeparation] {
    & & & & & & & & \node (p2-8) [point] {}; & \\
    & & & & & & \node (p1-6) [terminal] {or}; & \node (p1-7) [nonterminal] {\nonTerminalSymbol{expression\_logical\_xor}{20}}; & \\
    \node (P0start) [firstPoint] {}; & & \node (p0-2) [nonterminal] {\nonTerminalSymbol{expression\_logical\_xor}{20}}; & \node (p0-3) [point] {}; & \node (p0-4) [point] {}; & \node (p0-5) [point] {}; & & & & \node (p0-9) [lastPoint] {}; & \\
  };
  \draw[->] (P0start) -- (p0-2) ;
  \draw (p0-2) -- (p0-4) ;
...
\nonTerminalSection{expression\_logical\_xor}{20}
...
\nonTerminalSection{function\_header}{16}
...
\begin{tikzpicture}
  \matrix[column sep=\ruleMatrixColumnSeparation, row sep=\ruleMatrixRowSeparation] {
    ...
    \node (P0start) [firstPoint] {}; & & \node (p0-2) [terminal] {func}; & \node (p0-3) [nonterminal] {\nonTerminalSymbol{mode}{15}}; & \node (p0-4) [terminal] {identifier}; & \node (p0-5) [point] {}; & \node (p0-6) [point] {}; & \node (p0-7) [point] {}; & & & \node (p0-10) [nonterminal] {\nonTerminalSymbol{procedure\_formal\_arguments}{17}}; & \node (p0-11) [lastPoint] {}; & \\
  };
  \draw[->] (P0start) -- (p0-2) ;
  \draw[->] (p0-2) -- (p0-3) ;
  \draw[->] (p0-3) -- (p0-4) ;
...
\begin{tikzpicture}
  \matrix[column sep=\ruleMatrixColumnSeparation, row sep=\ruleMatrixRowSeparation] {
    & & & & & & & & & & & \node (p2-11) [point] {}; & \\
    & & & \node (p1-3) [terminal] {public}; & & & & & & & \node (p1-10) [terminal] {@attribute}; & & & & \node (p1-14) [terminal] {:}; & \node (p1-15) [nonterminal] {\nonTerminalSymbol{procedure\_call}{37}}; & \\
...
\nonTerminalSection{instruction}{33}
...
\begin{tikzpicture}
  \matrix[column sep=\ruleMatrixColumnSeparation, row sep=\ruleMatrixRowSeparation] {
    \node (P0start) [firstPoint] {}; & & \node (p0-2) [nonterminal] {\nonTerminalSymbol{assignment\_target\_noself}{38}}; & \node (p0-3) [terminal] {=}; & \node (p0-4) [nonterminal] {\nonTerminalSymbol{expression}{19}}; & \node (p0-5) [lastPoint] {}; & \\
  };
  \draw[->] (P0start) -- (p0-2) ;
  \draw[->] (p0-2) -- (p0-3) ;
  \draw[->] (p0-3) -- (p0-4) ;
...
\ruleSubsection{plm\_syntax}{instruction-assignment}{31}

\begin{tikzpicture}
  \matrix[column sep=\ruleMatrixColumnSeparation, row sep=\ruleMatrixRowSeparation] {
    \node (P0start) [firstPoint] {}; & & \node (p0-2) [nonterminal] {\nonTerminalSymbol{assignment\_target\_self}{39}}; & \node (p0-3) [terminal] {=}; & \node (p0-4) [nonterminal] {\nonTerminalSymbol{expression}{19}}; & \node (p0-5) [lastPoint] {}; & \\
  };
  \draw[->] (P0start) -- (p0-2) ;
  \draw[->] (p0-2) -- (p0-3) ;
  \draw[->] (p0-3) -- (p0-4) ;
...
\ruleSubsection{plm\_syntax}{instruction-assignment-operator}{80}

\begin{tikzpicture}
  \matrix[column sep=\ruleMatrixColumnSeparation, row sep=\ruleMatrixRowSeparation] {
    \node (P0start) [firstPoint] {}; & & \node (p0-2) [nonterminal] {\nonTerminalSymbol{assignment\_target\_noself}{38}}; & \node (p0-3) [nonterminal] {\nonTerminalSymbol{assignment\_operator}{34}}; & \node (p0-4) [nonterminal] {\nonTerminalSymbol{expression}{19}}; & \node (p0-5) [lastPoint] {}; & \\
  };
  \draw[->] (P0start) -- (p0-2) ;
  \draw[->] (p0-2) -- (p0-3) ;
  \draw[->] (p0-3) -- (p0-4) ;
...
\ruleSubsection{plm\_syntax}{instruction-assignment-operator}{113}
...
\ruleSubsection{plm\_syntax}{instruction-procedure-call}{30}
...
\nonTerminalSection{instructionList}{32}
...
\begin{tikzpicture}
  \matrix[column sep=\ruleMatrixColumnSeparation, row sep=\ruleMatrixRowSeparation] {
    & & & & & & \node (p3-6) [point] {}; & \\
    & & & & & \node (p2-5) [terminal] {;}; & \\
    & & & & & \node (p1-5) [nonterminal] {\nonTerminalSymbol{instruction}{33}}; & \\
    \node (P0start) [firstPoint] {}; & & \node (p0-2) [point] {}; & \node (p0-3) [point] {}; & \node (p0-4) [point] {}; & & & \node (p0-7) [lastPoint] {}; & \\
  };
  \draw (P0start) -- (p0-3) ;
  \draw[->] (p0-4) |- (p1-5) ;
...
\nonTerminalSection{module\_variable}{10}

\ruleSubsection{plm\_syntax}{declaration-module}{56}
...
\nonTerminalSection{procedure\_call}{37}

\ruleSubsection{plm\_syntax}{instruction-procedure-call}{37}
...
\ruleSubsection{plm\_syntax}{instruction-procedure-call}{49}
...
\nonTerminalSection{procedure\_formal\_arguments}{17}
...
\ruleSubsection{plm\_syntax}{declaration-control-register}{136}
...
\ruleSubsection{plm\_syntax}{declaration-static-array}{77}
...
\nonTerminalSection{struct\_var\_declaration}{7}
...
\nonTerminalSection{taskBody}{13}

\ruleSubsection{plm\_syntax}{declaration-task}{124}

\begin{tikzpicture}
  \matrix[column sep=\ruleMatrixColumnSeparation, row sep=\ruleMatrixRowSeparation] {
    & & & & & & & & & & & & & & & \node (p7-15) [point] {}; & \\
    & & & & & \node (p6-5) [nonterminal] {\nonTerminalSymbol{guarded\_command}{36}}; & \node (p6-6) [terminal] {\{}; & \node (p6-7) [nonterminal] {\nonTerminalSymbol{instructionList}{32}}; & \node (p6-8) [terminal] {\}}; & \\
    & & & & & \node (p5-5) [terminal] {setup}; & \node (p5-6) [terminal] {integer}; & \node (p5-7) [terminal] {\{}; & \node (p5-8) [nonterminal] {\nonTerminalSymbol{instructionList}{32}}; & \node (p5-9) [terminal] {\}}; & \\
    & & & & & & & & & \node (p4-9) [terminal] {->}; & \node (p4-10) [terminal] {\$type}; & \\
    & & & & & \node (p3-5) [terminal] {func}; & \node (p3-6) [terminal] {identifier}; & \node (p3-7) [nonterminal] {\nonTerminalSymbol{procedure\_formal\_arguments}{17}}; & \node (p3-8) [point] {}; & \node (p3-9) [point] {}; & & \node (p3-11) [point] {}; & \node (p3-12) [terminal] {\{}; & \node (p3-13) [nonterminal] {\nonTerminalSymbol{instructionList}{32}}; & \node (p3-14) [terminal] {\}}; & \\
    & & & & & & & & \node (p2-8) [terminal] {\$type}; & \\
    & & & & & \node (p1-5) [terminal] {var}; & \node (p1-6) [terminal] {identifier}; & \node (p1-7) [point] {}; & \node (p1-8) [point] {}; & \node (p1-9) [point] {}; & \node (p1-10) [terminal] {=}; & \node (p1-11) [nonterminal] {\nonTerminalSymbol{expression}{19}}; & \\
    \node (P0start) [firstPoint] {}; & & \node (p0-2) [point] {}; & \node (p0-3) [point] {}; & \node (p0-4) [point] {}; & & & & & & & & & & & & \node (p0-16) [lastPoint] {}; & \\
  };
  \draw (P0start) -- (p0-3) ;
  \draw[->] (p0-4) |- (p1-5) ;
