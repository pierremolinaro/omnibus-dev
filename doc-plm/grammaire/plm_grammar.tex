...
\ruleSubsection{plm\_syntax}{declaration-module}{125}
...
\ruleSubsection{plm\_syntax}{instruction-sync}{89}

\begin{tikzpicture}
  \matrix[column sep=\ruleMatrixColumnSeparation, row sep=\ruleMatrixRowSeparation] {
    & & & & & & & \node (p1-7) [terminal] {continue}; & \\
...
\ruleSubsection{plm\_syntax}{instruction-sync}{112}
