...
\begin{itemize}
  \item le pilote \plm=time=, la gestion du temps (\refSubsectionPage{piloteTime})~;
  \item le pilote \plm=leds=, la gestion des leds (\refSubsectionPage{piloteLeds})~;
  \item le pilote \plm=lcd=, la gestion de l'afficheur LCD (\refSubsectionPage{piloteLCD})~;
...
\begin{itemize}
  \item \plm=section=, \refSubsubsection{itModeSection}~;
  \item \plm=safe=, \refSubsubsection{itModeSafe}~;
  \item \plm=service=, \refSubsubsection{itModeService}.
\end{itemize}
...
\subsubsectionLabel{Routine d'interruption en mode \texttt{safe}}{itModeSafe}
