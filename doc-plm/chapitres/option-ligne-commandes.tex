...
\OPTION{\ttfamily\bfseries-{}-extract-embedded-targets=$repertoire$}, \OPTION{\ttfamily\bfseries-X=$repertoire$} Extrait les fichiers de définition des cibles embarquées dans le compilateur et les écrit dans le répertoire $repertoire$.
