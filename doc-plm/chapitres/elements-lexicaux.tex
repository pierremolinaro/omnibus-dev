...
Un mode est une séquence commençant par un \texttt{\$} et suivi d'un ou plusieurs chiffres, lettres ; par exemple : \plm!$user!, \plm!$boot!, \plm!$init!. Un mode permet de caractériser le mode d'exécution logique d'une procédure, et fait l'objet du \refChapterPage{chapitreModesExecution}.
