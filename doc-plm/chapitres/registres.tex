...
\begin{itemize}
  ...
  \item les attributs applicables aux registres de contrôles (\refSectionPage{attributRo} et \refSectionPage{attributUser}) ;
  \item les restrictions d'usage des registres de contrôles (\refSectionPage{restrictionsUsageRegistres}).
\end{itemize}
