...
\sectionLabel{\texttt{PYTHON\_UTILITIES}}{configurationPythonUtilities}
...
\sectionLabel{\texttt{PYTHON\_BUILD}}{configurationPythonBuild}
...
\sectionLabel{\texttt{LINKER\_SCRIPT}}{configurationLinkerScript}
...
\begin{itemize}
  \item \texttt{!SYSTEMSTACKSIZE!} est remplacé par la taille allouée (en nombre d'octets) à la pile système~; cette valeur est fixée par la définition \texttt{SYSTEM\_STACK\_SIZE}, voir \refSectionPage{configurationSystemStackSize}.
\end{itemize}
...
\sectionLabel{\texttt{PANIC}}{configurationPanic}
...
La chaîne résultat est ensuite ajouté au fichier source LLVM \texttt{src.ll} du projet.
...
\sectionLabel{\texttt{UINT\_TYPE}}{configurationUINT}
...
\sectionLabel{\texttt{POINTER\_BIT\_COUNT}}{configurationPointerBitCount}
...
\sectionLabel{\texttt{SYSTEM\_STACK\_SIZE}}{configurationSystemStackSize}
...
\sectionLabel{\texttt{SERVICE}}{configurationService}
...
\sectionLabel{\texttt{SECTION}}{configurationSection}
...
\sectionLabel{\texttt{C\_FILES}}{configurationFichiersC}
...
\sectionLabel{\texttt{S\_FILES}}{configurationFichiersAssembleur}
...
\sectionLabel{\texttt{LL\_FILES}}{configurationFichiersLLVM}
...
\sectionLabel{\texttt{PLM\_FILES}}{configurationFichiersPLM}
...
\sectionLabel{\texttt{INTERRUPT\_HANDLER}}{configurationInterruptHandler}
...
\sectionLabel{\texttt{INTERRUPTS}}{configurationInterrupts}
...
\sectionLabel{Schéma d'appel des sections}{schemaAppelSections}
