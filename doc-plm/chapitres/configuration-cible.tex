...
{\bf Ligne 11.} Cette ligne déclare la représentation \plm+@size+, qui est celle utilisée par défaut pour les types énumérés (\refSectionPage{representation-type-enumere}). La déclaration de la représentation \plm+@size+ est obligatoire.
