...
\subsectionLabel{Attribut \texttt{@nullOnNoException}}{attributNullOnNoException}\index{"@nullOnNoException}

L'attribut \plm+@nullOnNoException+ signifie que la procédure est éliminée si le projet est compilé avec les exceptions désactivées (option \OPTION{-{}-no-exception-generation}, \refSectionPage{optionCodeEngendre}). Les références à cette routine sont alors remplacées par la valeur zéro.
