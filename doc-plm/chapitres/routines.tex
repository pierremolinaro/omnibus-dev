...
Le compilateur élimine les procédures qui ne sont jamais appelées, en calculant le graphe des appels. Les racines de ce graphes sont les procédures requises (\refSectionPage{procedureRequise}). Les procédures inatteignables sont éliminées, avec ou sans message d'alerte (\refSectionPage{attributNoWarningIfUnused}).
