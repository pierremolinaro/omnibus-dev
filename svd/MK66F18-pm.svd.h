...
//---  Registers CSC(0,1,2,3,4,5,6,7): Channel (n) Status and Control
  ...
  #define TPM1_C2SC (* ((volatile uint32_t *) (0x400c9000 + 0xc + 2 * 0x8)))
  #define TPM2_C2SC (* ((volatile uint32_t *) (0x400ca000 + 0xc + 2 * 0x8)))
  #define TPM1_C3SC (* ((volatile uint32_t *) (0x400c9000 + 0xc + 3 * 0x8)))
  #define TPM2_C3SC (* ((volatile uint32_t *) (0x400ca000 + 0xc + 3 * 0x8)))
  #define TPM1_C4SC (* ((volatile uint32_t *) (0x400c9000 + 0xc + 4 * 0x8)))
  #define TPM2_C4SC (* ((volatile uint32_t *) (0x400ca000 + 0xc + 4 * 0x8)))
  #define TPM1_C5SC (* ((volatile uint32_t *) (0x400c9000 + 0xc + 5 * 0x8)))
  #define TPM2_C5SC (* ((volatile uint32_t *) (0x400ca000 + 0xc + 5 * 0x8)))
  #define TPM1_C6SC (* ((volatile uint32_t *) (0x400c9000 + 0xc + 6 * 0x8)))
  #define TPM2_C6SC (* ((volatile uint32_t *) (0x400ca000 + 0xc + 6 * 0x8)))
  #define TPM1_C7SC (* ((volatile uint32_t *) (0x400c9000 + 0xc + 7 * 0x8)))
  #define TPM2_C7SC (* ((volatile uint32_t *) (0x400ca000 + 0xc + 7 * 0x8)))
