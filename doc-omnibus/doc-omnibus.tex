...
\RequirePackage{etex}
\usepackage{fontspec}
%\setmainfont[Ligatures=TeX, Scale=1.1]{Gill Sans} % {Palatino} % {Optima} % {Hoefler Text}
...
\newcommand\keywordsStyleomnibus[1]{\textcolor{blue}{\textbf{#1}}}
\newcommand\attributeStyleomnibus[1]{\textcolor{purple}{#1}}
\newcommand\delimitersStyleomnibus[1]{\textcolor{brown}{\textbf{#1}}}
\newcommand\integerStyleomnibus[1]{\textcolor{orange}{#1}}
\newcommand\commentStyleomnibus[1]{\textcolor{red}{#1}}
\newcommand\selectorStyleomnibus[1]{\textcolor{PineGreen}{#1}}
\newcommand\typeStyleomnibus[1]{\textcolor{violet}{#1}}
\newcommand\groupStyleomnibus[1]{\textcolor{ProcessBlue}{#1}}

\newcommand\characterStyleomnibus[1]{\textcolor{orange}{#1}}
\newcommand\stringStyleomnibus[1]{\textcolor{gray}{#1}}

\newcommand\lexicalErroromnibus{\textcolor{red}{\textbullet ERRLEX\textbullet}}
...
\makeatletter
\newenvironment{OMNIBUS}[1][0]{%
  \providecommand{\ParametreOMNIBUS}{#1}
  \begingroup
  \@bsphack
  \immediate\openout\tempfile=temp.omnibus%
  ...
  \@esphack
  \endgroup
  \immediate\write18{omnibus --mode=latex:omnibus temp.omnibus}
  \setstretch{1.2}
  \ifthenelse{\equal{\ParametreOMNIBUS}{0}}{
    {\begin{siderules}\zeroEspaceAvantPonctuation{\ttfamily\input{temp.omnibus.tex}}\end{siderules}}
  }{
    {\begin{linenumbers}\resetlinenumber[\ParametreOMNIBUS]\zeroEspaceAvantPonctuation{\ttfamily\input{temp.omnibus.tex}}\end{linenumbers}}
  }
}
\makeatother

%-----------------------------------------------------------------------------------------------------------------------*
% COMMANDE \omnibus : affichage de code en ligne omnibus                                                                        *
%-----------------------------------------------------------------------------------------------------------------------*
...
\newcommand\@omnibus[2]{%
  ...
  \lowercase{%
    \def\@tempa##1~{%
      ...
      \immediate\closeout\tempfile%
      \immediate\write18{omnibus --mode=latex:omnibus temp.omnibus}%
      \colorbox{gray!6}{\zeroEspaceAvantPonctuation{\ttfamily\input{temp.omnibus.tex}}\unskip}%
    }%
  }%
...
\newcommand\titreOuvrage{\Huge\textbf{OMNIBUS}}
...
\input{chapitres/tutorial.tex}
\input{chapitres/cible-teensy-3-1-its.tex}
\input{chapitres/option-ligne-commandes.tex}
\input{chapitres/elements-lexicaux.tex}
\input{chapitres/demarrage.tex}
\input{chapitres/type-booleen.tex}
\input{chapitres/types-entier-statique.tex}
\input{chapitres/types-entiers.tex}
\input{chapitres/types-flottants.tex}
\input{chapitres/type-caractere.tex}
\input{chapitres/types-chaine-de-caracteres.tex}
\input{chapitres/type-enumere.tex}
\input{chapitres/type-structure.tex}
\input{chapitres/type-opaque.tex}
\input{chapitres/type-tableau.tex}
\input{chapitres/listes-statiques.tex}
\input{chapitres/registres.tex}
\input{chapitres/declaration-constante.tex}
\input{chapitres/routines.tex}
\input{chapitres/expressions.tex}
\input{chapitres/instructions.tex}
\input{chapitres/pilotes.tex}
\input{chapitres/taches.tex}
\input{chapitres/synchronisations.tex}
\input{chapitres/controle-access.tex}
\input{chapitres/directives.tex}
\input{chapitres/exceptions.tex}
\input{chapitres/configuration-cible.tex}
%\input{chapitres/compilation-llvm.tex}
\input{grammaire/chapitre-grammaire.tex}
