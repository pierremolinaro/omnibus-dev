...
\begin{itemize}
\item la grammaire des sources des programmes OMNIBUS (\refSectionPage{grammaireOMNIBUS}) ;
...
\sectionLabel{Grammaire du langage \texttt{OMNIBUS}}{grammaireOMNIBUS}

\input{grammaire/omnibus_grammar.tex}
...
\input{grammaire/omnibus_target_grammar.tex}
}
