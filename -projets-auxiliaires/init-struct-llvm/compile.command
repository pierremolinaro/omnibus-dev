...
~/omnibus-tools/omnibus-Darwin-i386-llvm-9.0.0-binutils-2.32-openocd-0.10.0-libusb-1.0.23/bin/arm-eabi-as -mthumb -mcpu=cortex-m4 src-opt.s -o src-opt.s.o -aln=src-opt.s.list
