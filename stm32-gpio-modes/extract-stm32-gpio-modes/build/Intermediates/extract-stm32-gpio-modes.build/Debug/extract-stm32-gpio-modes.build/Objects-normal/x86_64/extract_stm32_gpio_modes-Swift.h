...
#ifndef EXTRACT_STM32_GPIO_MODES_SWIFT_H
#define EXTRACT_STM32_GPIO_MODES_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="extract_stm32_gpio_modes",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

@class NSXMLParser;

SWIFT_CLASS("_TtC24extract_stm32_gpio_modes15_XMLStackParser")
@interface _XMLStackParser : NSObject <NSXMLParserDelegate>
