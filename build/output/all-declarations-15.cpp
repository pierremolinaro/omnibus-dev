...
void routine_compileProject (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  if (kBoolTrue == test_2) {
    ...
    if (kBoolTrue == test_2) {
      var_ast_3320.mProperty_mDeclarationListAST.addAssign_operation (GALGAS_compiletimeBoolAST::constructor_new (SOURCE_FILE ("program.galgas", 120))  COMMA_SOURCE_FILE ("program.galgas", 120)) ;
      var_ast_3320.mProperty_mDeclarationListAST.addAssign_operation (GALGAS_compileTimeIntAST::constructor_new (SOURCE_FILE ("program.galgas", 122))  COMMA_SOURCE_FILE ("program.galgas", 122)) ;
      var_ast_3320.mProperty_mDeclarationListAST.addAssign_operation (GALGAS_boolTypeAST::constructor_new (SOURCE_FILE ("program.galgas", 124))  COMMA_SOURCE_FILE ("program.galgas", 124)) ;
  ...
  GALGAS_declarationListAST var_orderedDeclarationListAST_5385 = GALGAS_declarationListAST::constructor_emptyList (SOURCE_FILE ("program.galgas", 138)) ;
  enumGalgasBool test_5 = kBoolTrue ;
  if (kBoolTrue == test_5) {
    ...
    if (kBoolTrue == test_5) {
      GALGAS_timer var_t_5445 = GALGAS_timer::constructor_start (SOURCE_FILE ("program.galgas", 140)) ;
      enumGalgasBool test_6 = kBoolTrue ;
      if (kBoolTrue == test_6) {
      ...
      {
      routine_buildOrderedDeclarationList (var_ast_3320, constinArgument_inSourceFile.getter_string (HERE), constinArgument_inEndOfSourceFile, var_orderedDeclarationListAST_5385, inCompiler  COMMA_SOURCE_FILE ("program.galgas", 144)) ;
      }
      enumGalgasBool test_7 = kBoolTrue ;
      if (kBoolTrue == test_7) {
        test_7 = GALGAS_bool (gOption_omnibus_5F_options_printPasses.getter_value ()).boolEnum () ;
        if (kBoolTrue == test_7) {
          inCompiler->printMessage (GALGAS_string ("    Duration: ").add_operation (var_t_5445.getter_string (SOURCE_FILE ("program.galgas", 151)), inCompiler COMMA_SOURCE_FILE ("program.galgas", 151)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("program.galgas", 151))  COMMA_SOURCE_FILE ("program.galgas", 151)) ;
        }
      }
    }
  }
  ...
  if (kBoolTrue == test_8) {
    ...
    if (kBoolTrue == test_8) {
      cEnumerator_checkTargetListAST enumerator_6072 (var_ast_3320.getter_mCheckTargetListAST (HERE), kENUMERATION_UP) ;
      while (enumerator_6072.hasCurrentObject ()) {
        GALGAS_bool var_accepted_6094 = GALGAS_bool (false) ;
        cEnumerator_lstringlist enumerator_6151 (enumerator_6072.current_mAcceptedTargetList (HERE), kENUMERATION_UP) ;
        bool bool_9 = var_accepted_6094.operator_not (SOURCE_FILE ("program.galgas", 158)).isValidAndTrue () ;
        if (enumerator_6151.hasCurrentObject () && bool_9) {
          while (enumerator_6151.hasCurrentObject () && bool_9) {
            var_accepted_6094 = GALGAS_bool (kIsEqual, enumerator_6151.current_mValue (HERE).getter_string (HERE).objectCompare (constinArgument_inTargetName.getter_string (SOURCE_FILE ("program.galgas", 159)))) ;
            enumerator_6151.gotoNextObject () ;
            if (enumerator_6151.hasCurrentObject ()) {
              bool_9 = var_accepted_6094.operator_not (SOURCE_FILE ("program.galgas", 158)).isValidAndTrue () ;
            }
          }
        }
        enumGalgasBool test_10 = kBoolTrue ;
        if (kBoolTrue == test_10) {
          test_10 = var_accepted_6094.operator_not (SOURCE_FILE ("program.galgas", 161)).boolEnum () ;
          if (kBoolTrue == test_10) {
            TC_Array <C_FixItDescription> fixItArray11 ;
            inCompiler->emitSemanticError (enumerator_6072.current_mTargetConstructLocation (HERE), GALGAS_string ("invalid target"), fixItArray11  COMMA_SOURCE_FILE ("program.galgas", 162)) ;
          }
        }
  ...
  GALGAS_userLLVMTypeDefinitionListIR var_userLLVMTypeDefinitionListIR_6839 = GALGAS_userLLVMTypeDefinitionListIR::constructor_emptyList (SOURCE_FILE ("program.galgas", 174)) ;
  ...
  if (kBoolTrue == test_12) {
    ...
    if (kBoolTrue == test_12) {
      GALGAS_timer var_t_6893 = GALGAS_timer::constructor_start (SOURCE_FILE ("program.galgas", 176)) ;
      {
      routine_buildSemanticContext (constinArgument_inSourceFile, var_ast_3320, var_globalLiteralStringMap_6506, var_staticListValueMap_6567, var_semanticContext_6453, var_decoratedDeclarationList_6680, var_decoratedRoutineList_6737, var_routineListIR_6773, var_userLLVMTypeDefinitionListIR_6839, inCompiler  COMMA_SOURCE_FILE ("program.galgas", 177)) ;
      }
      enumGalgasBool test_13 = kBoolTrue ;
      if (kBoolTrue == test_13) {
        test_13 = GALGAS_bool (gOption_omnibus_5F_options_printPasses.getter_value ()).boolEnum () ;
        if (kBoolTrue == test_13) {
          inCompiler->printMessage (GALGAS_string ("** Context: ").add_operation (var_t_6893.getter_string (SOURCE_FILE ("program.galgas", 189)), inCompiler COMMA_SOURCE_FILE ("program.galgas", 189)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("program.galgas", 189))  COMMA_SOURCE_FILE ("program.galgas", 189)) ;
        }
      }
    }
  }
  GALGAS_intermediateCodeStruct var_intermediateCodeStruct_7469 = GALGAS_intermediateCodeStruct::constructor_default (SOURCE_FILE ("program.galgas", 193)) ;
  ...
  if (kBoolTrue == test_14) {
    ...
    if (kBoolTrue == test_14) {
      GALGAS_timer var_t_7529 = GALGAS_timer::constructor_start (SOURCE_FILE ("program.galgas", 195)) ;
      {
      routine_semanticAnalysis (constinArgument_inSourceFile.getter_string (HERE), var_ast_3320, var_sourceFileAbsolutePathSet_3367, var_decoratedDeclarationList_6680, var_decoratedRoutineList_6737, var_routineListIR_6773, var_semanticContext_6453, constinArgument_inEndOfSourceFile, var_globalLiteralStringMap_6506, var_intermediateCodeStruct_7469, inCompiler  COMMA_SOURCE_FILE ("program.galgas", 196)) ;
      }
      enumGalgasBool test_15 = kBoolTrue ;
      if (kBoolTrue == test_15) {
        test_15 = GALGAS_bool (gOption_omnibus_5F_options_printPasses.getter_value ()).boolEnum () ;
        if (kBoolTrue == test_15) {
          inCompiler->printMessage (GALGAS_string ("** Semantic: ").add_operation (var_t_7529.getter_string (SOURCE_FILE ("program.galgas", 209)), inCompiler COMMA_SOURCE_FILE ("program.galgas", 209)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("program.galgas", 209))  COMMA_SOURCE_FILE ("program.galgas", 209)) ;
        }
      }
    }
  }
  ...
  if (kBoolTrue == test_16) {
    ...
    if (kBoolTrue == test_16) {
      GALGAS_timer var_tOpt_8232 = GALGAS_timer::constructor_start (SOURCE_FILE ("program.galgas", 214)) ;
      {
      routine_codeOptimization (constinArgument_inSourceFile.getter_string (HERE), var_intermediateCodeStruct_7469, inCompiler  COMMA_SOURCE_FILE ("program.galgas", 215)) ;
      }
      enumGalgasBool test_17 = kBoolTrue ;
      if (kBoolTrue == test_17) {
        test_17 = GALGAS_bool (gOption_omnibus_5F_options_printPasses.getter_value ()).boolEnum () ;
        if (kBoolTrue == test_17) {
          inCompiler->printMessage (GALGAS_string ("    Duration: ").add_operation (var_tOpt_8232.getter_string (SOURCE_FILE ("program.galgas", 217)), inCompiler COMMA_SOURCE_FILE ("program.galgas", 217)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("program.galgas", 217))  COMMA_SOURCE_FILE ("program.galgas", 217)) ;
        }
      }
    }
  }
  ...
  if (kBoolTrue == test_18) {
    ...
    if (kBoolTrue == test_18) {
      {
      routine_codeGeneration (constinArgument_inCurrentDirectory, constinArgument_inSourceFile.getter_string (HERE), constinArgument_inEndOfSourceFile, var_intermediateCodeStruct_7469, var_userLLVMTypeDefinitionListIR_6839, constinArgument_inTargetName, var_semanticContext_6453.getter_mPanicCodeType (HERE), var_semanticContext_6453.getter_mPanicLineType (HERE), var_semanticContext_6453.getter_mAvailableInterruptMap (HERE), var_staticListValueMap_6567, var_semanticContext_6453.getter_mTargetParameters (HERE), inCompiler  COMMA_SOURCE_FILE ("program.galgas", 222)) ;
      }
    }
  }
}
...
void routine_addTargetSpecificFiles (const GALGAS_lstring constinArgument_inTargetName,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_0) {
      GALGAS_string var_targetDirectory_9546 = GALGAS_string (gOption_omnibus_5F_options_useDirAsTargetDir.getter_value ()).getter_absolutePathFromPath (constinArgument_inCurrentDirectory COMMA_SOURCE_FILE ("program.galgas", 247)) ;
      enumGalgasBool test_1 = kBoolTrue ;
      if (kBoolTrue == test_1) {
        test_1 = var_targetDirectory_9546.getter_directoryExists (SOURCE_FILE ("program.galgas", 248)).boolEnum () ;
        if (kBoolTrue == test_1) {
          GALGAS_string var_targetDefinitionFullPath_9721 = var_targetDirectory_9546.add_operation (GALGAS_string ("/"), inCompiler COMMA_SOURCE_FILE ("program.galgas", 249)).add_operation (constinArgument_inTargetName.getter_string (HERE), inCompiler COMMA_SOURCE_FILE ("program.galgas", 249)).add_operation (GALGAS_string ("/+config.omnibus-target"), inCompiler COMMA_SOURCE_FILE ("program.galgas", 249)) ;
          enumGalgasBool test_2 = kBoolTrue ;
          if (kBoolTrue == test_2) {
            test_2 = var_targetDefinitionFullPath_9721.getter_fileExists (SOURCE_FILE ("program.galgas", 250)).boolEnum () ;
            if (kBoolTrue == test_2) {
              GALGAS_lstringlist var_importedFileList_10000 ;
              var_importedFileList_10000.drop () ;
              GALGAS_location joker_10028 ; // Joker input parameter
              cGrammar_omnibus_5F_target_5F_grammar::_performSourceFileParsing_ (inCompiler, var_targetDefinitionFullPath_9721.getter_nowhere (SOURCE_FILE ("program.galgas", 252)), ioArgument_ioAST, var_importedFileList_10000, joker_10028  COMMA_SOURCE_FILE ("program.galgas", 251)) ;
              {
              routine_recursiveImportFileSystemTargetFiles (ioArgument_ioAST, var_targetDirectory_9546.add_operation (GALGAS_string ("/"), inCompiler COMMA_SOURCE_FILE ("program.galgas", 258)).add_operation (constinArgument_inTargetName.getter_string (HERE), inCompiler COMMA_SOURCE_FILE ("program.galgas", 258)), var_importedFileList_10000, ioArgument_ioImportedFileAbsolutePathSet, inCompiler  COMMA_SOURCE_FILE ("program.galgas", 256)) ;
              }
            }
          }
  ...
  if (kBoolFalse == test_0) {
    GALGAS_filewrapper var_fw_10685 = GALGAS_filewrapper (gWrapperDirectory_0_targetTemplates) ;
    enumGalgasBool test_5 = kBoolTrue ;
    if (kBoolTrue == test_5) {
      test_5 = var_fw_10685.getter_fileExistsAtPath (constinArgument_inTargetName.getter_string (HERE).add_operation (GALGAS_string ("/+config.omnibus-target"), inCompiler COMMA_SOURCE_FILE ("program.galgas", 272)), inCompiler COMMA_SOURCE_FILE ("program.galgas", 272)).boolEnum () ;
      if (kBoolTrue == test_5) {
        GALGAS_string var_source_10817 = var_fw_10685.getter_textFileContentsAtPath (constinArgument_inTargetName.getter_string (HERE).add_operation (GALGAS_string ("/+config.omnibus-target"), inCompiler COMMA_SOURCE_FILE ("program.galgas", 273)), inCompiler COMMA_SOURCE_FILE ("program.galgas", 273)) ;
        GALGAS_lstringlist var_importedFileList_11029 ;
        var_importedFileList_11029.drop () ;
        GALGAS_location joker_11055 ; // Joker input parameter
        cGrammar_omnibus_5F_target_5F_grammar::_performSourceStringParsing_ (inCompiler, var_source_10817, constinArgument_inTargetName.getter_string (HERE), ioArgument_ioAST, var_importedFileList_11029, joker_11055  COMMA_SOURCE_FILE ("program.galgas", 274)) ;
        {
        routine_recursiveImportEmbeddedTargetFiles (ioArgument_ioAST, constinArgument_inTargetName.getter_string (HERE), var_importedFileList_11029, ioArgument_ioImportedFileAbsolutePathSet, inCompiler  COMMA_SOURCE_FILE ("program.galgas", 278)) ;
        }
      }
    }
...
void routine_recursiveImportFileSystemTargetFiles (GALGAS_ast & ioArgument_ioAST,
                                                   ...
                                                   C_Compiler * inCompiler
                                                   COMMA_UNUSED_LOCATION_ARGS) {
  cEnumerator_lstringlist enumerator_11784 (inArgument_inImportedClauseList, kENUMERATION_UP) ;
  while (enumerator_11784.hasCurrentObject ()) {
    GALGAS_string var_absolutePath_11808 = constinArgument_inTargetDirectory.add_operation (GALGAS_string ("/"), inCompiler COMMA_SOURCE_FILE ("program.galgas", 300)).add_operation (enumerator_11784.current_mValue (HERE).getter_string (HERE), inCompiler COMMA_SOURCE_FILE ("program.galgas", 300)) ;
    enumGalgasBool test_0 = kBoolTrue ;
    if (kBoolTrue == test_0) {
      test_0 = var_absolutePath_11808.getter_fileExists (SOURCE_FILE ("program.galgas", 301)).boolEnum () ;
      if (kBoolTrue == test_0) {
        enumGalgasBool test_1 = kBoolTrue ;
        if (kBoolTrue == test_1) {
          test_1 = ioArgument_ioImportedFileAbsolutePathSet.getter_hasKey (var_absolutePath_11808 COMMA_SOURCE_FILE ("program.galgas", 302)).operator_not (SOURCE_FILE ("program.galgas", 302)).boolEnum () ;
          if (kBoolTrue == test_1) {
            ioArgument_ioImportedFileAbsolutePathSet.addAssign_operation (var_absolutePath_11808  COMMA_SOURCE_FILE ("program.galgas", 303)) ;
            enumGalgasBool test_2 = kBoolTrue ;
            if (kBoolTrue == test_2) {
              test_2 = GALGAS_bool (kIsEqual, var_absolutePath_11808.getter_pathExtension (SOURCE_FILE ("program.galgas", 304)).objectCompare (GALGAS_string ("omnibus-import"))).boolEnum () ;
              if (kBoolTrue == test_2) {
                GALGAS_lstringlist var_importedFileList_12229 ;
                var_importedFileList_12229.drop () ;
                GALGAS_location joker_12259 ; // Joker input parameter
                cGrammar_omnibus_5F_grammar::_performSourceFileParsing_ (inCompiler, GALGAS_lstring::constructor_new (var_absolutePath_11808, enumerator_11784.current_mValue (HERE).getter_location (HERE)  COMMA_SOURCE_FILE ("program.galgas", 305)), ioArgument_ioAST, var_importedFileList_12229, joker_12259  COMMA_SOURCE_FILE ("program.galgas", 305)) ;
                {
                routine_recursiveImportFileSystemTargetFiles (ioArgument_ioAST, constinArgument_inTargetDirectory, var_importedFileList_12229, ioArgument_ioImportedFileAbsolutePathSet, inCompiler  COMMA_SOURCE_FILE ("program.galgas", 309)) ;
                }
              }
            }
            if (kBoolFalse == test_2) {
              enumGalgasBool test_3 = kBoolTrue ;
              if (kBoolTrue == test_3) {
                test_3 = GALGAS_bool (kIsEqual, var_absolutePath_11808.getter_pathExtension (SOURCE_FILE ("program.galgas", 315)).objectCompare (GALGAS_string ("omnibus-target"))).boolEnum () ;
                if (kBoolTrue == test_3) {
                  GALGAS_lstringlist var_importedFileList_12730 ;
                  var_importedFileList_12730.drop () ;
                  GALGAS_location joker_12760 ; // Joker input parameter
                  cGrammar_omnibus_5F_target_5F_grammar::_performSourceFileParsing_ (inCompiler, GALGAS_lstring::constructor_new (var_absolutePath_11808, enumerator_11784.current_mValue (HERE).getter_location (HERE)  COMMA_SOURCE_FILE ("program.galgas", 316)), ioArgument_ioAST, var_importedFileList_12730, joker_12760  COMMA_SOURCE_FILE ("program.galgas", 316)) ;
                  {
                  routine_recursiveImportFileSystemTargetFiles (ioArgument_ioAST, constinArgument_inTargetDirectory, var_importedFileList_12730, ioArgument_ioImportedFileAbsolutePathSet, inCompiler  COMMA_SOURCE_FILE ("program.galgas", 320)) ;
                  }
                }
              }
              if (kBoolFalse == test_3) {
                TC_Array <C_FixItDescription> fixItArray4 ;
                inCompiler->emitSemanticError (enumerator_11784.current_mValue (HERE).getter_location (SOURCE_FILE ("program.galgas", 327)), GALGAS_string ("invalid extension (should be .omnibus-import or .omnibus-target)"), fixItArray4  COMMA_SOURCE_FILE ("program.galgas", 327)) ;
              }
            }
          }
        }
    ...
    if (kBoolFalse == test_0) {
      TC_Array <C_FixItDescription> fixItArray5 ;
      inCompiler->emitSemanticError (enumerator_11784.current_mValue (HERE).getter_location (SOURCE_FILE ("program.galgas", 331)), GALGAS_string ("file does not exist in file system target definition"), fixItArray5  COMMA_SOURCE_FILE ("program.galgas", 331)) ;
    }
...
void routine_recursiveImportEmbeddedTargetFiles (GALGAS_ast & ioArgument_ioAST,
                                                 ...
                                                 C_Compiler * inCompiler
                                                 COMMA_UNUSED_LOCATION_ARGS) {
  cEnumerator_lstringlist enumerator_13627 (inArgument_inImportedClauseList, kENUMERATION_UP) ;
  while (enumerator_13627.hasCurrentObject ()) {
    GALGAS_string var_fullPath_13647 = constinArgument_inCurrentDirectory.add_operation (GALGAS_string ("/"), inCompiler COMMA_SOURCE_FILE ("program.galgas", 345)).add_operation (enumerator_13627.current_mValue (HERE).getter_string (SOURCE_FILE ("program.galgas", 345)), inCompiler COMMA_SOURCE_FILE ("program.galgas", 345)) ;
    GALGAS_filewrapper var_fw_13705 = GALGAS_filewrapper (gWrapperDirectory_0_targetTemplates) ;
    enumGalgasBool test_0 = kBoolTrue ;
    if (kBoolTrue == test_0) {
      test_0 = var_fw_13705.getter_fileExistsAtPath (var_fullPath_13647, inCompiler COMMA_SOURCE_FILE ("program.galgas", 347)).boolEnum () ;
      if (kBoolTrue == test_0) {
        GALGAS_string var_embeddedPath_13804 = GALGAS_string (":").add_operation (var_fullPath_13647, inCompiler COMMA_SOURCE_FILE ("program.galgas", 348)) ;
        enumGalgasBool test_1 = kBoolTrue ;
        if (kBoolTrue == test_1) {
          test_1 = ioArgument_ioImportedFileAbsolutePathSet.getter_hasKey (var_embeddedPath_13804 COMMA_SOURCE_FILE ("program.galgas", 349)).operator_not (SOURCE_FILE ("program.galgas", 349)).boolEnum () ;
          if (kBoolTrue == test_1) {
            ioArgument_ioImportedFileAbsolutePathSet.addAssign_operation (var_embeddedPath_13804  COMMA_SOURCE_FILE ("program.galgas", 350)) ;
            GALGAS_lstringlist var_importedFileList_14102 ;
            var_importedFileList_14102.drop () ;
            GALGAS_location joker_14130 ; // Joker input parameter
            cGrammar_omnibus_5F_grammar::_performSourceStringParsing_ (inCompiler, var_fw_13705.getter_textFileContentsAtPath (var_fullPath_13647, inCompiler COMMA_SOURCE_FILE ("program.galgas", 351)), enumerator_13627.current_mValue (HERE).getter_string (HERE), ioArgument_ioAST, var_importedFileList_14102, joker_14130  COMMA_SOURCE_FILE ("program.galgas", 351)) ;
            {
            routine_recursiveImportEmbeddedTargetFiles (ioArgument_ioAST, var_fullPath_13647.getter_stringByDeletingLastPathComponent (SOURCE_FILE ("program.galgas", 357)), var_importedFileList_14102, ioArgument_ioImportedFileAbsolutePathSet, inCompiler  COMMA_SOURCE_FILE ("program.galgas", 355)) ;
            }
          }
        }
      }
    ...
    if (kBoolFalse == test_0) {
      TC_Array <C_FixItDescription> fixItArray2 ;
      inCompiler->emitSemanticError (GALGAS_location::constructor_nowhere (SOURCE_FILE ("program.galgas", 363)), GALGAS_string ("cannot find '").add_operation (enumerator_13627.current_mValue (HERE).getter_string (SOURCE_FILE ("program.galgas", 363)), inCompiler COMMA_SOURCE_FILE ("program.galgas", 363)).add_operation (GALGAS_string ("' file in embedded files"), inCompiler COMMA_SOURCE_FILE ("program.galgas", 363)), fixItArray2  COMMA_SOURCE_FILE ("program.galgas", 363)) ;
    }
...
void routine_recursiveImportFiles (GALGAS_ast & ioArgument_ioAST,
                                   ...
                                   C_Compiler * inCompiler
                                   COMMA_UNUSED_LOCATION_ARGS) {
  cEnumerator_lstringlist enumerator_14879 (inArgument_inImportedClauseList, kENUMERATION_UP) ;
  while (enumerator_14879.hasCurrentObject ()) {
    GALGAS_string var_absolutePath_14903 = enumerator_14879.current_mValue (HERE).getter_string (HERE).getter_absolutePathFromPath (inArgument_inCurrentDirectory COMMA_SOURCE_FILE ("program.galgas", 377)) ;
    enumGalgasBool test_0 = kBoolTrue ;
    if (kBoolTrue == test_0) {
      test_0 = var_absolutePath_14903.getter_fileExists (SOURCE_FILE ("program.galgas", 378)).boolEnum () ;
      if (kBoolTrue == test_0) {
        enumGalgasBool test_1 = kBoolTrue ;
        if (kBoolTrue == test_1) {
          test_1 = ioArgument_ioImportedFileAbsolutePathSet.getter_hasKey (var_absolutePath_14903 COMMA_SOURCE_FILE ("program.galgas", 379)).operator_not (SOURCE_FILE ("program.galgas", 379)).boolEnum () ;
          if (kBoolTrue == test_1) {
            ioArgument_ioImportedFileAbsolutePathSet.addAssign_operation (var_absolutePath_14903  COMMA_SOURCE_FILE ("program.galgas", 380)) ;
            enumGalgasBool test_2 = kBoolTrue ;
            if (kBoolTrue == test_2) {
              test_2 = GALGAS_bool (kIsEqual, var_absolutePath_14903.getter_pathExtension (SOURCE_FILE ("program.galgas", 381)).objectCompare (GALGAS_string ("omnibus-import"))).boolEnum () ;
              if (kBoolTrue == test_2) {
                GALGAS_lstringlist var_importedFileList_15367 ;
                var_importedFileList_15367.drop () ;
                GALGAS_location joker_15397 ; // Joker input parameter
                cGrammar_omnibus_5F_grammar::_performSourceFileParsing_ (inCompiler, GALGAS_lstring::constructor_new (var_absolutePath_14903, enumerator_14879.current_mValue (HERE).getter_location (HERE)  COMMA_SOURCE_FILE ("program.galgas", 382)), ioArgument_ioAST, var_importedFileList_15367, joker_15397  COMMA_SOURCE_FILE ("program.galgas", 382)) ;
                {
                routine_recursiveImportFiles (ioArgument_ioAST, inArgument_inCurrentDirectory, var_importedFileList_15367, ioArgument_ioImportedFileAbsolutePathSet, inCompiler  COMMA_SOURCE_FILE ("program.galgas", 386)) ;
                }
              }
            }
            if (kBoolFalse == test_2) {
              enumGalgasBool test_3 = kBoolTrue ;
              if (kBoolTrue == test_3) {
                test_3 = GALGAS_bool (kIsEqual, var_absolutePath_14903.getter_pathExtension (SOURCE_FILE ("program.galgas", 392)).objectCompare (GALGAS_string ("omnibus-target"))).boolEnum () ;
                if (kBoolTrue == test_3) {
                  GALGAS_lstringlist var_importedFileList_15854 ;
                  var_importedFileList_15854.drop () ;
                  GALGAS_location joker_15884 ; // Joker input parameter
                  cGrammar_omnibus_5F_target_5F_grammar::_performSourceFileParsing_ (inCompiler, GALGAS_lstring::constructor_new (var_absolutePath_14903, enumerator_14879.current_mValue (HERE).getter_location (HERE)  COMMA_SOURCE_FILE ("program.galgas", 393)), ioArgument_ioAST, var_importedFileList_15854, joker_15884  COMMA_SOURCE_FILE ("program.galgas", 393)) ;
                  {
                  routine_recursiveImportFiles (ioArgument_ioAST, inArgument_inCurrentDirectory, var_importedFileList_15854, ioArgument_ioImportedFileAbsolutePathSet, inCompiler  COMMA_SOURCE_FILE ("program.galgas", 397)) ;
                  }
                }
              }
              if (kBoolFalse == test_3) {
                TC_Array <C_FixItDescription> fixItArray4 ;
                inCompiler->emitSemanticError (enumerator_14879.current_mValue (HERE).getter_location (SOURCE_FILE ("program.galgas", 404)), GALGAS_string ("invalid extension (should be .omnibus-import or .omnibus-target)"), fixItArray4  COMMA_SOURCE_FILE ("program.galgas", 404)) ;
              }
            }
          }
        }
    ...
    if (kBoolFalse == test_0) {
      GALGAS_filewrapper var_fw_16274 = GALGAS_filewrapper (gWrapperDirectory_0_targetTemplates) ;
      enumGalgasBool test_5 = kBoolTrue ;
      if (kBoolTrue == test_5) {
        test_5 = var_fw_16274.getter_fileExistsAtPath (enumerator_14879.current_mValue (HERE).getter_string (HERE), inCompiler COMMA_SOURCE_FILE ("program.galgas", 409)).boolEnum () ;
        if (kBoolTrue == test_5) {
          GALGAS_string var_embeddedPath_16380 = GALGAS_string (":").add_operation (enumerator_14879.current_mValue (HERE).getter_string (SOURCE_FILE ("program.galgas", 410)), inCompiler COMMA_SOURCE_FILE ("program.galgas", 410)) ;
          enumGalgasBool test_6 = kBoolTrue ;
          if (kBoolTrue == test_6) {
            test_6 = ioArgument_ioImportedFileAbsolutePathSet.getter_hasKey (var_embeddedPath_16380 COMMA_SOURCE_FILE ("program.galgas", 411)).operator_not (SOURCE_FILE ("program.galgas", 411)).boolEnum () ;
            if (kBoolTrue == test_6) {
              ioArgument_ioImportedFileAbsolutePathSet.addAssign_operation (var_embeddedPath_16380  COMMA_SOURCE_FILE ("program.galgas", 412)) ;
              enumGalgasBool test_7 = kBoolTrue ;
              if (kBoolTrue == test_7) {
                test_7 = GALGAS_bool (kIsEqual, enumerator_14879.current_mValue (HERE).getter_string (HERE).getter_pathExtension (SOURCE_FILE ("program.galgas", 413)).objectCompare (GALGAS_string ("omnibus-import"))).boolEnum () ;
                if (kBoolTrue == test_7) {
                  GALGAS_lstringlist var_importedFileList_16752 ;
                  var_importedFileList_16752.drop () ;
                  GALGAS_location joker_16784 ; // Joker input parameter
                  cGrammar_omnibus_5F_grammar::_performSourceStringParsing_ (inCompiler, var_fw_16274.getter_textFileContentsAtPath (enumerator_14879.current_mValue (HERE).getter_string (HERE), inCompiler COMMA_SOURCE_FILE ("program.galgas", 414)), enumerator_14879.current_mValue (HERE).getter_string (HERE), ioArgument_ioAST, var_importedFileList_16752, joker_16784  COMMA_SOURCE_FILE ("program.galgas", 414)) ;
                  {
                  routine_recursiveImportFiles (ioArgument_ioAST, inArgument_inCurrentDirectory, var_importedFileList_16752, ioArgument_ioImportedFileAbsolutePathSet, inCompiler  COMMA_SOURCE_FILE ("program.galgas", 418)) ;
                  }
                }
              }
              if (kBoolFalse == test_7) {
                enumGalgasBool test_8 = kBoolTrue ;
                if (kBoolTrue == test_8) {
                  test_8 = GALGAS_bool (kIsEqual, enumerator_14879.current_mValue (HERE).getter_string (HERE).getter_pathExtension (SOURCE_FILE ("program.galgas", 424)).objectCompare (GALGAS_string ("omnibus-target"))).boolEnum () ;
                  if (kBoolTrue == test_8) {
                    GALGAS_lstringlist var_importedFileList_17265 ;
                    var_importedFileList_17265.drop () ;
                    GALGAS_location joker_17297 ; // Joker input parameter
                    cGrammar_omnibus_5F_target_5F_grammar::_performSourceStringParsing_ (inCompiler, var_fw_16274.getter_textFileContentsAtPath (enumerator_14879.current_mValue (HERE).getter_string (HERE), inCompiler COMMA_SOURCE_FILE ("program.galgas", 425)), enumerator_14879.current_mValue (HERE).getter_string (HERE), ioArgument_ioAST, var_importedFileList_17265, joker_17297  COMMA_SOURCE_FILE ("program.galgas", 425)) ;
                    {
                    routine_recursiveImportFiles (ioArgument_ioAST, inArgument_inCurrentDirectory, var_importedFileList_17265, ioArgument_ioImportedFileAbsolutePathSet, inCompiler  COMMA_SOURCE_FILE ("program.galgas", 429)) ;
                    }
                  }
                }
                if (kBoolFalse == test_8) {
                  TC_Array <C_FixItDescription> fixItArray9 ;
                  inCompiler->emitSemanticError (enumerator_14879.current_mValue (HERE).getter_location (SOURCE_FILE ("program.galgas", 436)), GALGAS_string ("invalid extension (should be .omnibus-import or .omnibus-target)"), fixItArray9  COMMA_SOURCE_FILE ("program.galgas", 436)) ;
                }
              }
            }
          }
      ...
      if (kBoolFalse == test_5) {
        ...
        inCompiler->emitSemanticError (enumerator_14879.current_mValue (HERE).getter_location (SOURCE_FILE ("program.galgas", 440)), GALGAS_string ("cannot find this file in file system and in embedded files"), fixItArray10  COMMA_SOURCE_FILE ("program.galgas", 440)) ;
      }
    }
...
const char * gWrapperFileContent_3_embeddedSampleCode = "target \"teensy-3-1/unprivileged\"\n"
  ...
  "task T2 @stacksize 512 @autostart {\n"
  "\n"
  "  while event s\xC3""\xA9""maphore.wait () {\n"
  "    digital.write (!yes !toPort: LED_L2)\n"
...
const char * gWrapperFileContent_5_embeddedSampleCode = "target \"teensy-3-1/unprivileged\"\n"
  ...
  "\n"
  "  var \xC3""\xA9""tat = [TRACE_SIZE : $u4] (!repeated:0)\n"
  "  var index\xC3""\x89""tat $u32 = 0\n"
  "\n"
  "  public section lire\xC3""\x89""tat (\?index $u32) -> $u32 {\n"
  ...
  "  //-- Enable USB\n"
  "    \xC2""\xA9""USB0.CTL = {\xC2""\xA9""USB0.CTL !USBENSOFEN:1}\n"
  ...
  "  //--- Enable d+ pullup\n"
  "    \xC2""\xA9""USB0.CONTROL = {\xC2""\xA9""USB0.CONTROL !DPPULLUPNONOTG:1} // Page 1515\n"
  "  }\n"
  "\n"
  "  //\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\n"
  "\n"
...
const char * gWrapperFileContent_33_embeddedSampleCode = "//\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\xE2""\x80""\x94""\n"
...
const char * gWrapperFileContent_19_embeddedSampleCode = "target \"teensy-3-6/xtr32\"\n"
  ...
  "    \xC2""\xA9""PIT.LDVAL [0] = $u32.max\n"
  "    \xC2""\xA9""PIT.LDVAL [1] = $u32.max\n"
  ...
  "    var r $u64 = extend (\xC2""\xA9""PIT.LTMR64H)\n"
  "    r <<= 32\n"
  ...
  "  }\n"
  "\n"
  "  public func \xC2""\xB5""s @noUnusedWarning () -> $u32 {\n"
...
const char * gWrapperFileContent_40_embeddedSampleCode = "target \"teensy-3-6/xtr32\"\n"
  ...
  "  var \xC3""\xA9""ch\xC3""\xA9""ance $u32 = 0\n"
  "  var freeRam $u32 = 0\n"
  "  var start $u32 = 0\n"
  ...
  "  }\n"
  "\n"
  "  while event time.wait (!until:self.\xC3""\xA9""ch\xC3""\xA9""ance) {\n"
  ...
  "  var \xC3""\xA9""ch\xC3""\xA9""ance1 $u32 = 2001\n"
  "  var \xC3""\xA9""ch\xC3""\xA9""ance2 $u32 = 2001\n"
  "  var \xC3""\xA9""ch\xC3""\xA9""ance3 $u32 = 2001\n"
  "  var data1 = $Array8 ()\n"
  "  var data2 = $Array8 ()\n"
  "  var structure = $AutreStructWithARC ()\n"
  "  var b $u8 = 0\n"
  "\n"
  "  while event time.wait (!until:self.\xC3""\xA9""ch\xC3""\xA9""ance1) {\n"
  ...
  "  }\n"
  "\n"
  "  while event time.wait (!until:self.\xC3""\xA9""ch\xC3""\xA9""ance2) {\n"
  "    self.\xC3""\xA9""ch\xC3""\xA9""ance2 +%= 97\n"
  "    self.data2 = self.data1\n"
  "  }\n"
  "\n"
  "  while event time.wait (!until:self.\xC3""\xA9""ch\xC3""\xA9""ance3) {\n"
...
const char * gWrapperFileContent_25_embeddedSampleCode = "target \"teensy-3-6/xtr32\"\n"
  ...
  "\n"
  "task T1 @stacksize 512 @autostart {\n"
  "  while event s\xC3""\xA9""maphore0.wait () {\n"
  ...
  "\n"
  "task T2 @stacksize 512 @autostart {\n"
  "  while event s\xC3""\xA9""maphore1.wait () {\n"
  ...
  "\n"
  "task T3 @stacksize 512 @autostart {\n"
  "  while event s\xC3""\xA9""maphore2.wait () {\n"
  ...
  "\n"
  "task T4 @stacksize 512 @autostart {\n"
  "  while event s\xC3""\xA9""maphore3.wait () {\n"
  ...
  "\n"
  "task T5 @stacksize 512 @autostart {\n"
  "  while event s\xC3""\xA9""maphore4.wait () {\n"
  ...
  "  while event s\xC3""\xA9""maphore5.wait () {\n"
  ...
  "  while event s\xC3""\xA9""maphore6.wait () {\n"
  ...
  "  while event s\xC3""\xA9""maphore7.wait () {\n"
  ...
  "  while event s\xC3""\xA9""maphore8.wait () {\n"
  ...
  "  while event s\xC3""\xA9""maphore9.wait () {\n"
  "    s\xC3""\xA9""maphore10.signal ()\n"
  "  }\n"
  "}\n"
  "\n"
  ...
  "  while event s\xC3""\xA9""maphore10.wait () {\n"
  ...
  "  while event s\xC3""\xA9""maphore11.wait () {\n"
  ...
  "  while event s\xC3""\xA9""maphore12.wait () {\n"
  ...
  "  while event s\xC3""\xA9""maphore13.wait () {\n"
  ...
  "  while event s\xC3""\xA9""maphore14.wait () {\n"
  ...
  "  while event s\xC3""\xA9""maphore15.wait () {\n"
  ...
  "  while event s\xC3""\xA9""maphore16.wait () {\n"
  ...
  "  while event s\xC3""\xA9""maphore17.wait () {\n"
  ...
  "  while event s\xC3""\xA9""maphore18.wait () {\n"
  ...
  "  while event s\xC3""\xA9""maphore19.wait () {\n"
  ...
  "  while event s\xC3""\xA9""maphore20.wait () {\n"
  ...
  "  while event s\xC3""\xA9""maphore21.wait () {\n"
  ...
  "  while event s\xC3""\xA9""maphore22.wait () {\n"
  ...
  "  while event s\xC3""\xA9""maphore23.wait () {\n"
  ...
  "  while event s\xC3""\xA9""maphore24.wait () {\n"
  ...
  "  while event s\xC3""\xA9""maphore25.wait () {\n"
  ...
  "  while event s\xC3""\xA9""maphore26.wait () {\n"
  ...
  "  while event s\xC3""\xA9""maphore27.wait () {\n"
  ...
  "  while event s\xC3""\xA9""maphore28.wait () {\n"
  ...
  "  while event s\xC3""\xA9""maphore29.wait () {\n"
  ...
  "  while event s\xC3""\xA9""maphore30.wait () {\n"
  "    let duration = myDriver.getDuration ()\n"
  "    lcd.goto (!line:0 !column:0)\n"
  "    lcd.print (!u32:duration)\n"
  "    digital.toggle (!port:LED_L0)\n"
...
const char * gWrapperFileContent_18_embeddedSampleCode = "target \"teensy-3-6/xtr64\"\n"
  ...
  "  while event s\xC3""\xA9""maphore31.wait () {\n"
  ...
  "  while event s\xC3""\xA9""maphore32.wait () {\n"
  ...
  "  while event s\xC3""\xA9""maphore33.wait () {\n"
  ...
  "  while event s\xC3""\xA9""maphore34.wait () {\n"
  ...
  "  while event s\xC3""\xA9""maphore35.wait () {\n"
  ...
  "  while event s\xC3""\xA9""maphore36.wait () {\n"
  ...
  "  while event s\xC3""\xA9""maphore37.wait () {\n"
  ...
  "  while event s\xC3""\xA9""maphore38.wait () {\n"
  ...
  "  while event s\xC3""\xA9""maphore39.wait () {\n"
  ...
  "  while event s\xC3""\xA9""maphore40.wait () {\n"
  ...
  "  while event s\xC3""\xA9""maphore41.wait () {\n"
  ...
  "  while event s\xC3""\xA9""maphore42.wait () {\n"
  ...
  "  while event s\xC3""\xA9""maphore43.wait () {\n"
  ...
  "  while event s\xC3""\xA9""maphore44.wait () {\n"
  ...
  "  while event s\xC3""\xA9""maphore45.wait () {\n"
  ...
  "  while event s\xC3""\xA9""maphore46.wait () {\n"
  ...
  "  while event s\xC3""\xA9""maphore47.wait () {\n"
  ...
  "  while event s\xC3""\xA9""maphore48.wait () {\n"
  ...
  "  while event s\xC3""\xA9""maphore49.wait () {\n"
  ...
  "  while event s\xC3""\xA9""maphore50.wait () {\n"
  ...
  "  while event s\xC3""\xA9""maphore51.wait () {\n"
  ...
  "  while event s\xC3""\xA9""maphore52.wait () {\n"
  ...
  "  while event s\xC3""\xA9""maphore53.wait () {\n"
  ...
  "  while event s\xC3""\xA9""maphore54.wait () {\n"
  ...
  "  while event s\xC3""\xA9""maphore55.wait () {\n"
  ...
  "  while event s\xC3""\xA9""maphore56.wait () {\n"
  ...
  "  while event s\xC3""\xA9""maphore57.wait () {\n"
  ...
  "  while event s\xC3""\xA9""maphore58.wait () {\n"
  ...
  "  while event s\xC3""\xA9""maphore59.wait () {\n"
  ...
  "  while event s\xC3""\xA9""maphore60.wait () {\n"
  ...
  "  while event s\xC3""\xA9""maphore61.wait () {\n"
  ...
  "  while event s\xC3""\xA9""maphore62.wait () {\n"
  "    let duration = myDriver.getDuration ()\n"
  "    lcd.goto (!line:0 !column:0)\n"
  "    lcd.print (!u32:duration)\n"
  "    digital.toggle (!port: LED_L0)\n"
...
const char * gWrapperFileContent_23_embeddedSampleCode = "target \"teensy-3-6/xtr32\"\n"
  ...
  "task T\xC3""\xA2""che0 @stacksize 512 @autostart {\n"
  "  var tick = $u32 ()\n"
  "  var \xC3""\xA9""num\xC3""\xA9""ration = $monEnum.z\xC3""\xA9""ro\n"
  "\n"
  "  while event time.wait (!until: self.tick) {\n"
  "    self.tick += 500\n"
  "    self.\xC3""\xA9""num\xC3""\xA9""ration = .un\n"
  "    var autre2num = self.\xC3""\xA9""num\xC3""\xA9""ration\n"
  "    self.\xC3""\xA9""num\xC3""\xA9""ration = .deux\n"
  "    digital.toggle (!port:LED_L0)\n"
  "    lcd.goto (!line:0 !column:0)\n"
