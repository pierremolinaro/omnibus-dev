...
//---------------------------------------------------------------------------------------------------------------------*
//                                                                                                                     *
//                                        @pseudoRegisterTypeDeclaration class                                         *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*

class GALGAS_pseudoRegisterTypeDeclaration : public GALGAS_abstractDeclaration {
//--- Constructor
  public : GALGAS_pseudoRegisterTypeDeclaration (void) ;

//--------------------------------- Default GALGAS constructor
  public : static GALGAS_pseudoRegisterTypeDeclaration constructor_default (LOCATION_ARGS) ;

//---
  public : inline const class cPtr_pseudoRegisterTypeDeclaration * ptr (void) const { return (const cPtr_pseudoRegisterTypeDeclaration *) mObjectPtr ; }

//--------------------------------- Constructor from pointer
  public : GALGAS_pseudoRegisterTypeDeclaration (const cPtr_pseudoRegisterTypeDeclaration * inSourcePtr) ;
...
//--------------------------------- Object extraction
  public : static GALGAS_pseudoRegisterTypeDeclaration extractObject (const GALGAS_object & inObject,
                                                                      C_Compiler * inCompiler
                                                                      COMMA_LOCATION_ARGS) ;

//--------------------------------- GALGAS constructors
  public : static class GALGAS_pseudoRegisterTypeDeclaration constructor_new (const class GALGAS_lstring & inOperand0
                                                                              COMMA_LOCATION_ARGS) ;

//--------------------------------- Comparison
  public : typeComparisonResult objectCompare (const GALGAS_pseudoRegisterTypeDeclaration & inOperand) const ;
...
} ; // End of GALGAS_pseudoRegisterTypeDeclaration class


//---------------------------------------------------------------------------------------------------------------------*

extern const C_galgas_type_descriptor kTypeDescriptor_GALGAS_pseudoRegisterTypeDeclaration ;
...
class cPtr_pseudoRegisterTypeDeclaration : public cPtr_abstractDeclaration {
//--- Attributes
  public : GALGAS_lstring mAttribute_mRegisterName ;

//--- Constructor
  public : cPtr_pseudoRegisterTypeDeclaration (const GALGAS_lstring & in_mRegisterName
                                               COMMA_LOCATION_ARGS) ;
