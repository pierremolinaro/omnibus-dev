...
static const C_cocoa_lexique_table_entry ktable_for_plm_5F_lexique_keyWordList [54] = {
  {"if", plm_lexique_1_if},
  {"in", plm_lexique_1_in},
  {"no", plm_lexique_1_no},
  {"on", plm_lexique_1_on},
  ...
  {"driver", plm_lexique_1_driver},
  {"extend", plm_lexique_1_extend},
  {"extern", plm_lexique_1_extern},
  {"import", plm_lexique_1_import},
  {"opaque", plm_lexique_1_opaque},
  {"option", plm_lexique_1_option},
  {"public", plm_lexique_1_public},
  {"sizeof", plm_lexique_1_sizeof},
  ...
  {"startup", plm_lexique_1_startup},
  {"required", plm_lexique_1_required},
  {"truncate", plm_lexique_1_truncate},
  {"addressof", plm_lexique_1_addressof},
  {"interrupt", plm_lexique_1_interrupt},
...
static NSInteger search_into_plm_5F_lexique_keyWordList (NSString * inSearchedString) {
  return searchStringInTable (inSearchedString, ktable_for_plm_5F_lexique_keyWordList, 54) ;
}
...
- (void) parseLexicalTokenForLexicalColoring {
  ...
  while ((mTokenCode == 0) && (mCurrentChar != '\0')) {
    ...
    if (scanningOk && ([self testForCharWithFunction:isUnicodeLetter])) {
      ...
      mLoop = YES ;
      mTokenCode = plm_lexique_1_commentMark ;
    }else if (scanningOk && ([self testForInputString:@"//" advance:YES])) {
      do {
        if (scanningOk && ([self testForInputFromChar:1 toChar:9] || [self testForInputChar:11] || [self testForInputChar:12] || [self testForInputFromChar:14 toChar:65533])) {
        }else{
      ...
      mTokenCode = plm_lexique_1__3E__3E__3D_ ;
    }else if (scanningOk && [self testForInputString:@"<<=" advance:YES]) {
      mTokenCode = plm_lexique_1__3C__3C__3D_ ;
    }else if (scanningOk && [self testForInputString:@"..<" advance:YES]) {
      mTokenCode = plm_lexique_1__2E__2E__3C_ ;
    }else if (scanningOk && [self testForInputString:@"..." advance:YES]) {
      mTokenCode = plm_lexique_1__2E__2E__2E_ ;
    }else if (scanningOk && [self testForInputString:@"-%=" advance:YES]) {
      ...
      mTokenCode = plm_lexique_1__2265_ ;
      ...
      if (scanningOk && ([self testForInputChar:33])) {
        ...
        mLoop = YES ;
        if (scanningOk && ([self testForInputChar:58])) {
          mTokenCode = plm_lexique_1__3F_selector_3A_ ;
        }else{
          scanner_cocoa_routine_resetString (& scanningOk, mLexicalAttribute_tokenString) ;
...
- (NSUInteger) styleIndexForTerminal: (NSInteger) inTerminal {
  static const NSUInteger kTerminalSymbolStyles [121] = {0,
...
- (BOOL) atomicSelectionForToken: (NSUInteger) inTokenIndex {
  static const BOOL kTerminalAtomicSelection [121] = {NO,
    ...
    NO /* plm_lexique_1_commentMark */,
    YES /* plm_lexique_1__3F_selector_3A_ */,
