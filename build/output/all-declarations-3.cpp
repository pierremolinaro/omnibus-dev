...
void extensionSetter_addFunctionWithoutArgument (GALGAS_propertyMap & ioObject,
                                                 ...
                                                 C_Compiler * inCompiler
                                                 COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_routineDescriptor var_descriptor_1437 = GALGAS_routineDescriptor::constructor_new (GALGAS_bool (true), GALGAS_bool (false), constinArgument_inMethodName, GALGAS_routineKind::constructor_function (GALGAS_mode::constructor_anyMode (SOURCE_FILE ("property-map.galgas", 35))  COMMA_SOURCE_FILE ("property-map.galgas", 35)), GALGAS_routineTypedSignature::constructor_emptyList (SOURCE_FILE ("property-map.galgas", 36)), constinArgument_inResultType, GALGAS_bool (false), constinArgument_inCanMutateProperties, constinArgument_inIsSafe  COMMA_SOURCE_FILE ("property-map.galgas", 31)) ;
  {
  ioObject.setter_insertKey (constinArgument_inMethodName.add_operation (GALGAS_string ("()"), inCompiler COMMA_SOURCE_FILE ("property-map.galgas", 43)).getter_nowhere (SOURCE_FILE ("property-map.galgas", 43)), GALGAS_bool (true), GALGAS_propertyAccessKind::constructor_nonVirtualMethod (var_descriptor_1437  COMMA_SOURCE_FILE ("property-map.galgas", 45)), inCompiler COMMA_SOURCE_FILE ("property-map.galgas", 42)) ;
  }
  GALGAS_lstring var_routineNameForInvocationGraph_2043 = function_routineMangledNameFromAST (constinArgument_inReceiverType.getter_key (inCompiler COMMA_SOURCE_FILE ("property-map.galgas", 49)), constinArgument_inMethodName.getter_nowhere (SOURCE_FILE ("property-map.galgas", 50)), GALGAS_routineFormalArgumentListAST::constructor_emptyList (SOURCE_FILE ("property-map.galgas", 51)), inCompiler COMMA_SOURCE_FILE ("property-map.galgas", 48)) ;
  {
  ioArgument_ioSubprogramInvocationGraph.setter_addNode (var_routineNameForInvocationGraph_2043, var_routineNameForInvocationGraph_2043, inCompiler COMMA_SOURCE_FILE ("property-map.galgas", 53)) ;
  }
}
...
void extensionSetter_addFunctionWithInputArgument (GALGAS_propertyMap & ioObject,
  ...
  GALGAS_routineFormalArgumentListAST var_argumentList_2972 = temp_0 ;
  GALGAS_routineTypedSignature var_signature_3204 ;
  {
  routine_routineSignature (ioArgument_ioContext.mProperty_mTypeMap, var_argumentList_2972, var_signature_3204, inCompiler  COMMA_SOURCE_FILE ("property-map.galgas", 79)) ;
  }
  GALGAS_routineDescriptor var_descriptor_3241 = GALGAS_routineDescriptor::constructor_new (GALGAS_bool (true), GALGAS_bool (false), constinArgument_inMethodName, GALGAS_routineKind::constructor_function (GALGAS_mode::constructor_anyMode (SOURCE_FILE ("property-map.galgas", 84))  COMMA_SOURCE_FILE ("property-map.galgas", 84)), var_signature_3204, constinArgument_inResultType, GALGAS_bool (false), constinArgument_inCanMutateProperties, constinArgument_inIsSafe  COMMA_SOURCE_FILE ("property-map.galgas", 80)) ;
  GALGAS_lstring var_methodMangledName_3607 = function_routineMangledNameFromAST (GALGAS_string::makeEmptyString (), GALGAS_lstring::constructor_new (constinArgument_inMethodName, GALGAS_location::constructor_nowhere (SOURCE_FILE ("property-map.galgas", 93))  COMMA_SOURCE_FILE ("property-map.galgas", 93)), var_argumentList_2972, inCompiler COMMA_SOURCE_FILE ("property-map.galgas", 91)) ;
  {
  ioObject.setter_insertKey (var_methodMangledName_3607, GALGAS_bool (true), GALGAS_propertyAccessKind::constructor_nonVirtualMethod (var_descriptor_3241  COMMA_SOURCE_FILE ("property-map.galgas", 99)), inCompiler COMMA_SOURCE_FILE ("property-map.galgas", 96)) ;
  }
  GALGAS_lstring var_routineNameForInvocationGraph_3870 = function_routineMangledNameFromAST (constinArgument_inReceiverType.getter_key (inCompiler COMMA_SOURCE_FILE ("property-map.galgas", 103)), constinArgument_inMethodName.getter_nowhere (SOURCE_FILE ("property-map.galgas", 104)), var_argumentList_2972, inCompiler COMMA_SOURCE_FILE ("property-map.galgas", 102)) ;
  {
  ioArgument_ioSubprogramInvocationGraph.setter_addNode (var_routineNameForInvocationGraph_3870, var_routineNameForInvocationGraph_3870, inCompiler COMMA_SOURCE_FILE ("property-map.galgas", 107)) ;
  }
}
...
void extensionSetter_addFunctionWithTwoInputArguments (GALGAS_propertyMap & ioObject,
                                                       ...
                                                       C_Compiler * inCompiler
                                                       COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_routineFormalArgumentListAST temp_0 = GALGAS_routineFormalArgumentListAST::constructor_emptyList (SOURCE_FILE ("property-map.galgas", 136)) ;
  temp_0.addAssign_operation (GALGAS_procFormalArgumentPassingMode::constructor_input (SOURCE_FILE ("property-map.galgas", 128)), constinArgument_inInputSelector_31_.getter_nowhere (SOURCE_FILE ("property-map.galgas", 129)), constinArgument_inInputArgumentTypeProxy_31_.getter_key (inCompiler COMMA_SOURCE_FILE ("property-map.galgas", 130)).getter_nowhere (SOURCE_FILE ("property-map.galgas", 130)), constinArgument_inInputArgumentName_31_.getter_nowhere (SOURCE_FILE ("property-map.galgas", 131))  COMMA_SOURCE_FILE ("property-map.galgas", 131)) ;
  temp_0.addAssign_operation (GALGAS_procFormalArgumentPassingMode::constructor_input (SOURCE_FILE ("property-map.galgas", 133)), constinArgument_inInputSelector_32_.getter_nowhere (SOURCE_FILE ("property-map.galgas", 134)), constinArgument_inInputArgumentTypeProxy_32_.getter_key (inCompiler COMMA_SOURCE_FILE ("property-map.galgas", 135)).getter_nowhere (SOURCE_FILE ("property-map.galgas", 135)), constinArgument_inInputArgumentName_32_.getter_nowhere (SOURCE_FILE ("property-map.galgas", 136))  COMMA_SOURCE_FILE ("property-map.galgas", 136)) ;
  GALGAS_routineFormalArgumentListAST var_argumentList_4998 = temp_0 ;
  GALGAS_routineTypedSignature var_signature_5364 ;
  {
  routine_routineSignature (ioArgument_ioContext.mProperty_mTypeMap, var_argumentList_4998, var_signature_5364, inCompiler  COMMA_SOURCE_FILE ("property-map.galgas", 138)) ;
  }
  GALGAS_routineDescriptor var_descriptor_5401 = GALGAS_routineDescriptor::constructor_new (GALGAS_bool (true), GALGAS_bool (false), constinArgument_inMethodName, GALGAS_routineKind::constructor_function (GALGAS_mode::constructor_anyMode (SOURCE_FILE ("property-map.galgas", 143))  COMMA_SOURCE_FILE ("property-map.galgas", 143)), var_signature_5364, constinArgument_inResultType, GALGAS_bool (false), constinArgument_inCanMutateProperties, constinArgument_inIsSafe  COMMA_SOURCE_FILE ("property-map.galgas", 139)) ;
  GALGAS_lstring var_methodMangledName_5767 = function_routineMangledNameFromAST (GALGAS_string::makeEmptyString (), GALGAS_lstring::constructor_new (constinArgument_inMethodName, GALGAS_location::constructor_nowhere (SOURCE_FILE ("property-map.galgas", 152))  COMMA_SOURCE_FILE ("property-map.galgas", 152)), var_argumentList_4998, inCompiler COMMA_SOURCE_FILE ("property-map.galgas", 150)) ;
  {
  ioObject.setter_insertKey (var_methodMangledName_5767, GALGAS_bool (true), GALGAS_propertyAccessKind::constructor_nonVirtualMethod (var_descriptor_5401  COMMA_SOURCE_FILE ("property-map.galgas", 158)), inCompiler COMMA_SOURCE_FILE ("property-map.galgas", 155)) ;
  }
  GALGAS_lstring var_routineNameForInvocationGraph_6030 = function_routineMangledNameFromAST (constinArgument_inReceiverType.getter_key (inCompiler COMMA_SOURCE_FILE ("property-map.galgas", 162)), constinArgument_inMethodName.getter_nowhere (SOURCE_FILE ("property-map.galgas", 163)), var_argumentList_4998, inCompiler COMMA_SOURCE_FILE ("property-map.galgas", 161)) ;
  {
  ioArgument_ioSubprogramInvocationGraph.setter_addNode (var_routineNameForInvocationGraph_6030, var_routineNameForInvocationGraph_6030, inCompiler COMMA_SOURCE_FILE ("property-map.galgas", 166)) ;
  }
}
...
void extensionMethod_generateAllocaList (const GALGAS_allocaList inObject,
  ...
  cEnumerator_allocaList enumerator_11504 (temp_0, kENUMERATION_UP) ;
  while (enumerator_11504.hasCurrentObject ()) {
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  ").add_operation (enumerator_11504.current_mVarLLVMName (HERE), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 279)).add_operation (GALGAS_string (" = alloca "), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 279)).add_operation (extensionGetter_llvmTypeName (enumerator_11504.current_mLLVMType (HERE), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 279)), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 279)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 279)), inCompiler  COMMA_SOURCE_FILE ("semantic-routines.galgas", 279)) ;
    enumerator_11504.gotoNextObject () ;
  }
  const GALGAS_allocaList temp_1 = inObject ;
  cEnumerator_allocaList enumerator_11665 (temp_1, kENUMERATION_UP) ;
  while (enumerator_11665.hasCurrentObject ()) {
    GALGAS_bool test_2 = enumerator_11665.current_mLLVMType (HERE).getter_kind (HERE).getter_isDynamicArrayType (SOURCE_FILE ("semantic-routines.galgas", 283)) ;
    if (kBoolTrue == test_2.boolEnum ()) {
      test_2 = enumerator_11665.current_mFormalInputArgument (HERE).operator_not (SOURCE_FILE ("semantic-routines.galgas", 283)) ;
    }
    const enumGalgasBool test_3 = test_2.boolEnum () ;
    if (kBoolTrue == test_3) {
      ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string (";--- init dynamic array type '").add_operation (enumerator_11665.current_mVarLLVMName (HERE), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 284)).add_operation (GALGAS_string ("'\n"), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 284)), inCompiler  COMMA_SOURCE_FILE ("semantic-routines.galgas", 284)) ;
      ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  store ").add_operation (extensionGetter_llvmTypeName (enumerator_11665.current_mLLVMType (HERE), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 285)), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 285)).add_operation (GALGAS_string (" null, "), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 285)).add_operation (extensionGetter_llvmTypeName (enumerator_11665.current_mLLVMType (HERE), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 285)), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 285)).add_operation (GALGAS_string ("* "), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 285)).add_operation (enumerator_11665.current_mVarLLVMName (HERE), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 285)).add_operation (GALGAS_string (" ; init ARC value\n"), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 285)), inCompiler  COMMA_SOURCE_FILE ("semantic-routines.galgas", 285)) ;
    }
...
void extensionMethod_noteTypesInPrecedenceGraph (const GALGAS_systemRoutineDeclarationListAST inObject,
  ...
  while (enumerator_4379.hasCurrentObject ()) {
    ...
    while (enumerator_4444.hasCurrentObject ()) {
      {
      ioArgument_ioGraph.setter_noteNode (enumerator_4444.current_mFormalArgumentTypeName (HERE) COMMA_SOURCE_FILE ("declaration-svc.galgas", 134)) ;
      }
      enumerator_4444.gotoNextObject () ;
    }
    extensionMethod_noteInstructionListTypesInPrecedenceGraph (enumerator_4379.current_mInstructionList (HERE), ioArgument_ioGraph, inCompiler COMMA_SOURCE_FILE ("declaration-svc.galgas", 136)) ;
...
void extensionMethod_enterSystemRoutineInContext (const GALGAS_systemRoutineDeclarationListAST inObject,
                                                  ...
                                                  COMMA_UNUSED_LOCATION_ARGS) {
  const GALGAS_systemRoutineDeclarationListAST temp_0 = inObject ;
  cEnumerator_systemRoutineDeclarationListAST enumerator_5128 (temp_0, kENUMERATION_UP) ;
  while (enumerator_5128.hasCurrentObject ()) {
    GALGAS_lstring var_routineMangledName_5186 = function_routineMangledNameFromAST (constinArgument_inReceiverTypeName, enumerator_5128.current (HERE).getter_mName (HERE), enumerator_5128.current (HERE).getter_mFormalArgumentList (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-svc.galgas", 150)) ;
    GALGAS_routineTypedSignature var_signature_5397 ;
    {
    routine_routineSignature (ioArgument_ioContext.mProperty_mTypeMap, enumerator_5128.current (HERE).getter_mFormalArgumentList (HERE), var_signature_5397, inCompiler  COMMA_SOURCE_FILE ("declaration-svc.galgas", 156)) ;
    }
    GALGAS_unifiedTypeMap_2D_proxy var_returnTypeProxy_5525 ;
    {
    GALGAS_unifiedTypeMap_2D_proxy::class_method_makeOptionalProxy (ioArgument_ioContext.mProperty_mTypeMap, enumerator_5128.current (HERE).getter_mReturnTypeName (HERE), var_returnTypeProxy_5525 COMMA_SOURCE_FILE ("declaration-svc.galgas", 158)) ;
    }
    GALGAS_bool var_mutating_5561 = GALGAS_bool (false) ;
    GALGAS_bool var_safe_5582 = GALGAS_bool (false) ;
    cEnumerator_lstringlist enumerator_5632 (enumerator_5128.current (HERE).getter_mAttributeList (HERE), kENUMERATION_UP) ;
    while (enumerator_5632.hasCurrentObject ()) {
      const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_5632.current_mValue (HERE).getter_string (HERE).objectCompare (function_mutatingAttribute (inCompiler COMMA_SOURCE_FILE ("declaration-svc.galgas", 163)))).boolEnum () ;
      if (kBoolTrue == test_1) {
        var_mutating_5561 = GALGAS_bool (true) ;
      }else if (kBoolFalse == test_1) {
        const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, enumerator_5632.current_mValue (HERE).getter_string (HERE).objectCompare (function_safeAttribute (inCompiler COMMA_SOURCE_FILE ("declaration-svc.galgas", 165)))).boolEnum () ;
        if (kBoolTrue == test_2) {
          var_safe_5582 = GALGAS_bool (true) ;
        }
      }
      enumerator_5632.gotoNextObject () ;
    }
    {
    extensionSetter_insertRoutine (ioArgument_ioContext.mProperty_mRoutineMapForContext, constinArgument_inReceiverTypeName, enumerator_5128.current (HERE).getter_mName (HERE), extensionGetter_routineSignature (enumerator_5128.current (HERE).getter_mFormalArgumentList (HERE), enumerator_5128.current (HERE).getter_mName (HERE).getter_location (SOURCE_FILE ("declaration-svc.galgas", 173)), inCompiler COMMA_SOURCE_FILE ("declaration-svc.galgas", 173)), var_routineMangledName_5186, GALGAS_routineDescriptor::constructor_new (enumerator_5128.current (HERE).getter_mPublic (HERE), GALGAS_bool (false), enumerator_5128.current (HERE).getter_mName (HERE).getter_string (SOURCE_FILE ("declaration-svc.galgas", 178)), enumerator_5128.current (HERE).getter_mRoutineKind (HERE), var_signature_5397, var_returnTypeProxy_5525, GALGAS_bool (true), var_mutating_5561, var_safe_5582  COMMA_SOURCE_FILE ("declaration-svc.galgas", 175)), inCompiler COMMA_SOURCE_FILE ("declaration-svc.galgas", 170)) ;
    }
...
void extensionMethod_systemRoutineSemanticAnalysis (const GALGAS_systemRoutineDeclarationListAST inObject,
                                                    ...
                                                    COMMA_UNUSED_LOCATION_ARGS) {
  const GALGAS_systemRoutineDeclarationListAST temp_0 = inObject ;
  cEnumerator_systemRoutineDeclarationListAST enumerator_7004 (temp_0, kENUMERATION_UP) ;
  while (enumerator_7004.hasCurrentObject ()) {
    GALGAS_bool var_mutating_7024 = GALGAS_bool (false) ;
    GALGAS_bool var_noUnusedWarning_7056 = GALGAS_bool (false) ;
    GALGAS_bool var_isSafe_7079 = GALGAS_bool (false) ;
    cEnumerator_lstringlist enumerator_7129 (enumerator_7004.current (HERE).getter_mAttributeList (HERE), kENUMERATION_UP) ;
    while (enumerator_7129.hasCurrentObject ()) {
      const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_7129.current_mValue (HERE).getter_string (HERE).objectCompare (function_noUnusedWarningAttribute (inCompiler COMMA_SOURCE_FILE ("declaration-svc.galgas", 205)))).boolEnum () ;
      if (kBoolTrue == test_1) {
        const enumGalgasBool test_2 = var_noUnusedWarning_7056.boolEnum () ;
        if (kBoolTrue == test_2) {
          TC_Array <C_FixItDescription> fixItArray3 ;
          fixItArray3.appendObject (C_FixItDescription (kFixItRemove, "")) ;
          inCompiler->emitSemanticError (enumerator_7129.current_mValue (HERE).getter_location (SOURCE_FILE ("declaration-svc.galgas", 207)), GALGAS_string ("duplicated @").add_operation (function_noUnusedWarningAttribute (inCompiler COMMA_SOURCE_FILE ("declaration-svc.galgas", 207)), inCompiler COMMA_SOURCE_FILE ("declaration-svc.galgas", 207)).add_operation (GALGAS_string (" attribute"), inCompiler COMMA_SOURCE_FILE ("declaration-svc.galgas", 207)), fixItArray3  COMMA_SOURCE_FILE ("declaration-svc.galgas", 207)) ;
        }
        var_noUnusedWarning_7056 = GALGAS_bool (true) ;
      }else if (kBoolFalse == test_1) {
        const enumGalgasBool test_4 = GALGAS_bool (kIsEqual, enumerator_7129.current_mValue (HERE).getter_string (HERE).objectCompare (function_mutatingAttribute (inCompiler COMMA_SOURCE_FILE ("declaration-svc.galgas", 210)))).boolEnum () ;
        if (kBoolTrue == test_4) {
          const enumGalgasBool test_5 = var_mutating_7024.boolEnum () ;
          if (kBoolTrue == test_5) {
          ...
          var_mutating_7024 = GALGAS_bool (true) ;
        }else if (kBoolFalse == test_4) {
          const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, enumerator_7129.current_mValue (HERE).getter_string (HERE).objectCompare (function_safeAttribute (inCompiler COMMA_SOURCE_FILE ("declaration-svc.galgas", 215)))).boolEnum () ;
          if (kBoolTrue == test_7) {
            const enumGalgasBool test_8 = var_isSafe_7079.boolEnum () ;
            if (kBoolTrue == test_8) {
            ...
            var_isSafe_7079 = GALGAS_bool (true) ;
    ...
    GALGAS_mode var_mode_8014 ;
    switch (enumerator_7004.current (HERE).getter_mRoutineKind (HERE).enumValue ()) {
    case GALGAS_routineKind::kNotBuilt:
      break ;
    case GALGAS_routineKind::kEnum_section:
      {
        var_mode_8014 = GALGAS_mode::constructor_sectionMode (SOURCE_FILE ("declaration-svc.galgas", 228)) ;
      }
      break ;
    case GALGAS_routineKind::kEnum_primitive:
      {
        var_mode_8014 = GALGAS_mode::constructor_primitiveMode (SOURCE_FILE ("declaration-svc.galgas", 229)) ;
      }
      break ;
    case GALGAS_routineKind::kEnum_service:
      {
        var_mode_8014 = GALGAS_mode::constructor_serviceMode (SOURCE_FILE ("declaration-svc.galgas", 230)) ;
      }
      break ;
    case GALGAS_routineKind::kEnum_function:
      {
        TC_Array <C_FixItDescription> fixItArray11 ;
        inCompiler->emitSemanticError (enumerator_7004.current (HERE).getter_mEndOfInstructionListLocation (HERE), GALGAS_string ("INTERNAL ERROR"), fixItArray11  COMMA_SOURCE_FILE ("declaration-svc.galgas", 231)) ;
        var_mode_8014.drop () ; // Release error dropped variable
      }
      break ;
    }
    GALGAS_routineAttributes var_attributes_8295 = GALGAS_routineAttributes::constructor_mutating (SOURCE_FILE ("declaration-svc.galgas", 233)).operator_or (GALGAS_routineAttributes::constructor_directPropertyAccess (SOURCE_FILE ("declaration-svc.galgas", 233)) COMMA_SOURCE_FILE ("declaration-svc.galgas", 233)).operator_or (GALGAS_routineAttributes::constructor_controlRegisterReadable (SOURCE_FILE ("declaration-svc.galgas", 233)) COMMA_SOURCE_FILE ("declaration-svc.galgas", 233)) ;
    const enumGalgasBool test_12 = var_isSafe_7079.operator_not (SOURCE_FILE ("declaration-svc.galgas", 234)).boolEnum () ;
    if (kBoolTrue == test_12) {
      var_attributes_8295 = var_attributes_8295.operator_or (GALGAS_routineAttributes::constructor_panicAllowed (SOURCE_FILE ("declaration-svc.galgas", 235)) COMMA_SOURCE_FILE ("declaration-svc.galgas", 235)) ;
    }
    {
    routine_routineSemanticAnalysis (inArgument_inReceiverType, enumerator_7004.current (HERE).getter_mRoutineKind (HERE), var_mode_8014, enumerator_7004.current (HERE).getter_mName (HERE), enumerator_7004.current (HERE).getter_mFormalArgumentList (HERE), enumerator_7004.current (HERE).getter_mReturnTypeName (HERE), enumerator_7004.current (HERE).getter_mInstructionList (HERE), enumerator_7004.current (HERE).getter_mEndOfInstructionListLocation (HERE), var_attributes_8295, var_noUnusedWarning_7056.operator_not (SOURCE_FILE ("declaration-svc.galgas", 247)), GALGAS_bool (true), constinArgument_inSemanticContext, ioArgument_ioTemporaries, ioArgument_ioIntermediateCodeStruct, inCompiler  COMMA_SOURCE_FILE ("declaration-svc.galgas", 237)) ;
    }
...
void extensionMethod_svcDeclarationGeneration (const GALGAS_routineMapIR inObject,
  ...
  cEnumerator_routineMapIR enumerator_11181 (temp_0, kENUMERATION_UP) ;
  while (enumerator_11181.hasCurrentObject ()) {
    const enumGalgasBool test_1 = enumerator_11181.current (HERE).getter_mKind (HERE).getter_isFunction (SOURCE_FILE ("declaration-svc.galgas", 314)).operator_not (SOURCE_FILE ("declaration-svc.galgas", 314)).boolEnum () ;
    if (kBoolTrue == test_1) {
      GALGAS_string var_svcCallName_11245 = function_llvmNameForSVCCall (enumerator_11181.current (HERE).getter_mRoutineNameForGeneration (HERE), enumerator_11181.current (HERE).getter_mKind (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-svc.galgas", 315)) ;
      GALGAS_string var_svcImplementationName_11342 = function_llvmNameForSVCImplementation (enumerator_11181.current (HERE).getter_mRoutineNameForGeneration (HERE), enumerator_11181.current (HERE).getter_mKind (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-svc.galgas", 316)) ;
      GALGAS_string var_prototype_11437 = function_llvmFunctionPrototype (extensionGetter_llvmTypeName (enumerator_11181.current (HERE).getter_mReturnType (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-svc.galgas", 318)), var_svcCallName_11245, enumerator_11181.current (HERE).getter_mReceiverType (HERE), enumerator_11181.current (HERE).getter_mFormalArgumentListForGeneration (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-svc.galgas", 317)) ;
      ioArgument_ioGenerationAdds.mProperty_mExternFunctionDeclarationSet.addAssign_operation (var_prototype_11437  COMMA_SOURCE_FILE ("declaration-svc.galgas", 323)) ;
      switch (enumerator_11181.current (HERE).getter_mKind (HERE).enumValue ()) {
      case GALGAS_routineKind::kNotBuilt:
        break ;
      case GALGAS_routineKind::kEnum_section:
        {
          ioArgument_ioSectionList.addAssign_operation (var_svcCallName_11245, var_svcImplementationName_11342, GALGAS_bool (true)  COMMA_SOURCE_FILE ("declaration-svc.galgas", 326)) ;
        }
        break ;
      case GALGAS_routineKind::kEnum_primitive:
      case GALGAS_routineKind::kEnum_service:
        {
          ioArgument_ioPrimitiveAndServiceList.addAssign_operation (var_svcCallName_11245, var_svcImplementationName_11342, GALGAS_bool (false)  COMMA_SOURCE_FILE ("declaration-svc.galgas", 328)) ;
        }
        break ;
      case GALGAS_routineKind::kEnum_function:
        {
...
void extensionMethod_generateCode (const GALGAS_bootListIR inObject,
                                   ...
                                   C_Compiler * inCompiler
                                   COMMA_UNUSED_LOCATION_ARGS) {
  ioArgument_ioLLVMcode.plusAssign_operation(function_llvmTitleComment (GALGAS_string ("Boot routines"), inCompiler COMMA_SOURCE_FILE ("declaration-boot.galgas", 179)), inCompiler  COMMA_SOURCE_FILE ("declaration-boot.galgas", 179)) ;
  ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("define internal void @boot ()").add_operation (function_llvmAttributeFunction (inCompiler COMMA_SOURCE_FILE ("declaration-boot.galgas", 180)), inCompiler COMMA_SOURCE_FILE ("declaration-boot.galgas", 180)).add_operation (GALGAS_string ("{\n"), inCompiler COMMA_SOURCE_FILE ("declaration-boot.galgas", 180)), inCompiler  COMMA_SOURCE_FILE ("declaration-boot.galgas", 180)) ;
  const GALGAS_bootListIR temp_0 = inObject ;
  cEnumerator_bootListIR enumerator_8021 (temp_0, kENUMERATION_UP) ;
  while (enumerator_8021.hasCurrentObject ()) {
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  call void @boot.").add_operation (enumerator_8021.current (HERE).getter_mDriverName (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-boot.galgas", 182)).add_operation (GALGAS_string (" ()\n"), inCompiler COMMA_SOURCE_FILE ("declaration-boot.galgas", 182)), inCompiler  COMMA_SOURCE_FILE ("declaration-boot.galgas", 182)) ;
    enumerator_8021.gotoNextObject () ;
  }
  ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  ret void\n"), inCompiler  COMMA_SOURCE_FILE ("declaration-boot.galgas", 184)) ;
  ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("}\n"
    "\n"), inCompiler  COMMA_SOURCE_FILE ("declaration-boot.galgas", 185)) ;
  const GALGAS_bootListIR temp_1 = inObject ;
  cEnumerator_bootListIR enumerator_8172 (temp_1, kENUMERATION_UP) ;
  while (enumerator_8172.hasCurrentObject ()) {
    ioArgument_ioLLVMcode.plusAssign_operation(function_llvmSeparatorLine (inCompiler COMMA_SOURCE_FILE ("declaration-boot.galgas", 187)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("declaration-boot.galgas", 187)), inCompiler  COMMA_SOURCE_FILE ("declaration-boot.galgas", 187)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("define internal void @boot.").add_operation (enumerator_8172.current (HERE).getter_mDriverName (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-boot.galgas", 188)).add_operation (GALGAS_string (" ()"), inCompiler COMMA_SOURCE_FILE ("declaration-boot.galgas", 188)).add_operation (function_llvmAttributeFunction (inCompiler COMMA_SOURCE_FILE ("declaration-boot.galgas", 188)), inCompiler COMMA_SOURCE_FILE ("declaration-boot.galgas", 188)).add_operation (GALGAS_string ("{\n"), inCompiler COMMA_SOURCE_FILE ("declaration-boot.galgas", 188)), inCompiler  COMMA_SOURCE_FILE ("declaration-boot.galgas", 188)) ;
    extensionMethod_generateAllocaList (enumerator_8172.current (HERE).getter_mAllocaList (HERE), ioArgument_ioLLVMcode, inCompiler COMMA_SOURCE_FILE ("declaration-boot.galgas", 189)) ;
    extensionMethod_instructionListLLVMCode (enumerator_8172.current (HERE).getter_mInstructionListIR (HERE), ioArgument_ioLLVMcode, constinArgument_inGenerationContext, ioArgument_ioGenerationAdds, inCompiler COMMA_SOURCE_FILE ("declaration-boot.galgas", 190)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  ret void\n"), inCompiler  COMMA_SOURCE_FILE ("declaration-boot.galgas", 191)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("}\n"
      "\n"), inCompiler  COMMA_SOURCE_FILE ("declaration-boot.galgas", 192)) ;
...
//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*
//                                                                                                                     *
//                                     Class for element of '@startupListIR' list                                      *
//                                                                                                                     *
//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*

class cCollectionElement_startupListIR : public cCollectionElement {
  public : GALGAS_startupListIR_2D_element mObject ;

//--- Constructor
  public : cCollectionElement_startupListIR (const GALGAS_PLMType & in_mSelfType,
                                             const GALGAS_string & in_mDriverName,
                                             const GALGAS_allocaList & in_mAllocaList,
                                             const GALGAS_instructionListIR & in_mInstructionListIR
                                             COMMA_LOCATION_ARGS) ;
...
cCollectionElement_startupListIR::cCollectionElement_startupListIR (const GALGAS_PLMType & in_mSelfType,
                                                                    const GALGAS_string & in_mDriverName,
                                                                    const GALGAS_allocaList & in_mAllocaList,
                                                                    const GALGAS_instructionListIR & in_mInstructionListIR
                                                                    COMMA_LOCATION_ARGS) :
...
bool cCollectionElement_startupListIR::isValid (void) const {
  return mObject.isValid () ;
}

//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*

cCollectionElement * cCollectionElement_startupListIR::copy (void) {
  cCollectionElement * result = NULL ;
  macroMyNew (result, cCollectionElement_startupListIR (mObject.mProperty_mSelfType, mObject.mProperty_mDriverName, mObject.mProperty_mAllocaList, mObject.mProperty_mInstructionListIR COMMA_HERE)) ;
  return result ;
}

//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*

void cCollectionElement_startupListIR::description (C_String & ioString, const int32_t inIndentation) const {
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "mSelfType" ":" ;
...
typeComparisonResult cCollectionElement_startupListIR::compare (const cCollectionElement * inOperand) const {
  cCollectionElement_startupListIR * operand = (cCollectionElement_startupListIR *) inOperand ;
  macroValidSharedObject (operand, cCollectionElement_startupListIR) ;
  return mObject.objectCompare (operand->mObject) ;
}

//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*

GALGAS_startupListIR::GALGAS_startupListIR (void) :
AC_GALGAS_list () {
}

//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*

GALGAS_startupListIR::GALGAS_startupListIR (const capCollectionElementArray & inSharedArray) :
AC_GALGAS_list (inSharedArray) {
}

//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*

GALGAS_startupListIR GALGAS_startupListIR::constructor_emptyList (UNUSED_LOCATION_ARGS) {
  return GALGAS_startupListIR  (capCollectionElementArray ()) ;
}

//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*

GALGAS_startupListIR GALGAS_startupListIR::constructor_listWithValue (const GALGAS_PLMType & inOperand0,
                                                                      const GALGAS_string & inOperand1,
                                                                      const GALGAS_allocaList & inOperand2,
                                                                      const GALGAS_instructionListIR & inOperand3
                                                                      COMMA_LOCATION_ARGS) {
  GALGAS_startupListIR result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid ()) {
    result = GALGAS_startupListIR (capCollectionElementArray ()) ;
    capCollectionElement attributes ;
    GALGAS_startupListIR::makeAttributesFromObjects (attributes, inOperand0, inOperand1, inOperand2, inOperand3 COMMA_THERE) ;
    result.appendObject (attributes) ;
  }
  return result ;
}
...
void GALGAS_startupListIR::makeAttributesFromObjects (capCollectionElement & outAttributes,
                                                      const GALGAS_PLMType & in_mSelfType,
                                                      const GALGAS_string & in_mDriverName,
                                                      const GALGAS_allocaList & in_mAllocaList,
                                                      const GALGAS_instructionListIR & in_mInstructionListIR
                                                      COMMA_LOCATION_ARGS) {
  cCollectionElement_startupListIR * p = NULL ;
  macroMyNew (p, cCollectionElement_startupListIR (in_mSelfType,
                                                   in_mDriverName,
                                                   in_mAllocaList,
...
void GALGAS_startupListIR::addAssign_operation (const GALGAS_PLMType & inOperand0,
                                                const GALGAS_string & inOperand1,
                                                const GALGAS_allocaList & inOperand2,
                                                const GALGAS_instructionListIR & inOperand3
                                                COMMA_LOCATION_ARGS) {
  if (isValid () && inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid ()) {
    cCollectionElement * p = NULL ;
    macroMyNew (p, cCollectionElement_startupListIR (inOperand0, inOperand1, inOperand2, inOperand3 COMMA_THERE)) ;
    capCollectionElement attributes ;
    attributes.setPointer (p) ;
    macroDetachSharedObject (p) ;
    appendObject (attributes) ;
...
void GALGAS_startupListIR::setter_insertAtIndex (const GALGAS_PLMType inOperand0,
                                                 const GALGAS_string inOperand1,
                                                 const GALGAS_allocaList inOperand2,
                                                 const GALGAS_instructionListIR inOperand3,
                                                 const GALGAS_uint inInsertionIndex,
...
void GALGAS_startupListIR::setter_removeAtIndex (GALGAS_PLMType & outOperand0,
                                                 GALGAS_string & outOperand1,
  ...
  if (isValid () && inRemoveIndex.isValid ()) {
    capCollectionElement attributes ;
    removeObjectAtIndex (attributes, inRemoveIndex.uintValue (), inCompiler COMMA_THERE) ;
    cCollectionElement_startupListIR * p = (cCollectionElement_startupListIR *) attributes.ptr () ;
    if (NULL == p) {
      outOperand0.drop () ;
      outOperand1.drop () ;
      outOperand2.drop () ;
      ...
      macroValidSharedObject (p, cCollectionElement_startupListIR) ;
...
void GALGAS_startupListIR::setter_popFirst (GALGAS_PLMType & outOperand0,
                                            GALGAS_string & outOperand1,
                                            GALGAS_allocaList & outOperand2,
                                            GALGAS_instructionListIR & outOperand3,
                                            C_Compiler * inCompiler
...
void GALGAS_startupListIR::setter_popLast (GALGAS_PLMType & outOperand0,
                                           GALGAS_string & outOperand1,
                                           GALGAS_allocaList & outOperand2,
                                           GALGAS_instructionListIR & outOperand3,
                                           C_Compiler * inCompiler
...
void GALGAS_startupListIR::method_first (GALGAS_PLMType & outOperand0,
                                         GALGAS_string & outOperand1,
                                         GALGAS_allocaList & outOperand2,
                                         GALGAS_instructionListIR & outOperand3,
                                         C_Compiler * inCompiler
...
void GALGAS_startupListIR::method_last (GALGAS_PLMType & outOperand0,
                                        GALGAS_string & outOperand1,
                                        GALGAS_allocaList & outOperand2,
                                        GALGAS_instructionListIR & outOperand3,
                                        C_Compiler * inCompiler
...
GALGAS_startupListIR GALGAS_startupListIR::add_operation (const GALGAS_startupListIR & inOperand,
                                                          C_Compiler * /* inCompiler */
                                                          COMMA_UNUSED_LOCATION_ARGS) const {
  GALGAS_startupListIR result ;
  if (isValid () && inOperand.isValid ()) {
...
GALGAS_startupListIR GALGAS_startupListIR::getter_subListWithRange (const GALGAS_range & inRange,
                                                                    C_Compiler * inCompiler
                                                                    COMMA_LOCATION_ARGS) const {
  GALGAS_startupListIR result = GALGAS_startupListIR::constructor_emptyList (THERE) ;
  subListWithRange (result, inRange, inCompiler COMMA_THERE) ;
  return result ;
}
...
GALGAS_startupListIR GALGAS_startupListIR::getter_subListFromIndex (const GALGAS_uint & inIndex,
                                                                    C_Compiler * inCompiler
                                                                    COMMA_LOCATION_ARGS) const {
  GALGAS_startupListIR result = GALGAS_startupListIR::constructor_emptyList (THERE) ;
  subListFromIndex (result, inIndex, inCompiler COMMA_THERE) ;
...
GALGAS_startupListIR GALGAS_startupListIR::getter_subListToIndex (const GALGAS_uint & inIndex,
                                                                  C_Compiler * inCompiler
                                                                  COMMA_LOCATION_ARGS) const {
  GALGAS_startupListIR result = GALGAS_startupListIR::constructor_emptyList (THERE) ;
  subListToIndex (result, inIndex, inCompiler COMMA_THERE) ;
...
void GALGAS_startupListIR::plusAssign_operation (const GALGAS_startupListIR inOperand,
                                                 C_Compiler * /* inCompiler */
                                                 COMMA_UNUSED_LOCATION_ARGS) {
  appendList (inOperand) ;
}
...
GALGAS_PLMType GALGAS_startupListIR::getter_mSelfTypeAtIndex (const GALGAS_uint & inIndex,
                                                              C_Compiler * inCompiler
                                                              COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_startupListIR * p = (cCollectionElement_startupListIR *) attributes.ptr () ;
...
GALGAS_string GALGAS_startupListIR::getter_mDriverNameAtIndex (const GALGAS_uint & inIndex,
                                                               C_Compiler * inCompiler
                                                               COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_startupListIR * p = (cCollectionElement_startupListIR *) attributes.ptr () ;
...
GALGAS_allocaList GALGAS_startupListIR::getter_mAllocaListAtIndex (const GALGAS_uint & inIndex,
                                                                   C_Compiler * inCompiler
                                                                   COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_startupListIR * p = (cCollectionElement_startupListIR *) attributes.ptr () ;
...
GALGAS_instructionListIR GALGAS_startupListIR::getter_mInstructionListIRAtIndex (const GALGAS_uint & inIndex,
                                                                                 C_Compiler * inCompiler
                                                                                 COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_startupListIR * p = (cCollectionElement_startupListIR *) attributes.ptr () ;
...
cEnumerator_startupListIR::cEnumerator_startupListIR (const GALGAS_startupListIR & inEnumeratedObject,
                                                      const typeEnumerationOrder inOrder) :
cGenericAbstractEnumerator (inOrder) {
  inEnumeratedObject.populateEnumerationArray (mEnumerationArray) ;
}
...
GALGAS_startupListIR_2D_element cEnumerator_startupListIR::current (LOCATION_ARGS) const {
  const cCollectionElement_startupListIR * p = (const cCollectionElement_startupListIR *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, cCollectionElement_startupListIR) ;
  return p->mObject ;
}
...
GALGAS_PLMType cEnumerator_startupListIR::current_mSelfType (LOCATION_ARGS) const {
  const cCollectionElement_startupListIR * p = (const cCollectionElement_startupListIR *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, cCollectionElement_startupListIR) ;
...
GALGAS_string cEnumerator_startupListIR::current_mDriverName (LOCATION_ARGS) const {
  const cCollectionElement_startupListIR * p = (const cCollectionElement_startupListIR *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, cCollectionElement_startupListIR) ;
  return p->mObject.mProperty_mDriverName ;
}
...
GALGAS_allocaList cEnumerator_startupListIR::current_mAllocaList (LOCATION_ARGS) const {
  const cCollectionElement_startupListIR * p = (const cCollectionElement_startupListIR *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, cCollectionElement_startupListIR) ;
  return p->mObject.mProperty_mAllocaList ;
}
...
GALGAS_instructionListIR cEnumerator_startupListIR::current_mInstructionListIR (LOCATION_ARGS) const {
  const cCollectionElement_startupListIR * p = (const cCollectionElement_startupListIR *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, cCollectionElement_startupListIR) ;
  return p->mObject.mProperty_mInstructionListIR ;
}
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_startupListIR ("startupListIR",
                                      NULL) ;

//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*

const C_galgas_type_descriptor * GALGAS_startupListIR::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_startupListIR ;
}

//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*

AC_GALGAS_root * GALGAS_startupListIR::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_startupListIR (*this)) ;
  }
  return result ;
}
...
GALGAS_startupListIR GALGAS_startupListIR::extractObject (const GALGAS_object & inObject,
                                                          C_Compiler * inCompiler
                                                          COMMA_LOCATION_ARGS) {
  GALGAS_startupListIR result ;
  const GALGAS_startupListIR * p = (const GALGAS_startupListIR *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_startupListIR *> (p)) {
      result = *p ;
    }else{
      inCompiler->castError ("startupListIR", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
void extensionMethod_generateLLVMinitCode (const GALGAS_startupListIR inObject,
                                           GALGAS_string & ioArgument_ioLLVMcode,
                                           ...
                                           C_Compiler * inCompiler
                                           COMMA_UNUSED_LOCATION_ARGS) {
  ioArgument_ioLLVMcode.plusAssign_operation(function_llvmTitleComment (GALGAS_string ("Startup"), inCompiler COMMA_SOURCE_FILE ("declaration-startup.galgas", 210)), inCompiler  COMMA_SOURCE_FILE ("declaration-startup.galgas", 210)) ;
  ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("define internal void @startup ()").add_operation (function_llvmAttributeFunction (inCompiler COMMA_SOURCE_FILE ("declaration-startup.galgas", 211)), inCompiler COMMA_SOURCE_FILE ("declaration-startup.galgas", 211)).add_operation (GALGAS_string ("{\n"), inCompiler COMMA_SOURCE_FILE ("declaration-startup.galgas", 211)), inCompiler  COMMA_SOURCE_FILE ("declaration-startup.galgas", 211)) ;
  const GALGAS_startupListIR temp_0 = inObject ;
  cEnumerator_startupListIR enumerator_9680 (temp_0, kENUMERATION_UP) ;
  while (enumerator_9680.hasCurrentObject ()) {
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  call void @startup.").add_operation (enumerator_9680.current (HERE).getter_mDriverName (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-startup.galgas", 213)).add_operation (GALGAS_string (" ("), inCompiler COMMA_SOURCE_FILE ("declaration-startup.galgas", 213)), inCompiler  COMMA_SOURCE_FILE ("declaration-startup.galgas", 213)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(extensionGetter_llvmTypeName (enumerator_9680.current (HERE).getter_mSelfType (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-startup.galgas", 214)).add_operation (GALGAS_string ("* "), inCompiler COMMA_SOURCE_FILE ("declaration-startup.galgas", 214)).add_operation (function_llvmNameForGlobalVariable (enumerator_9680.current (HERE).getter_mDriverName (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-startup.galgas", 214)), inCompiler COMMA_SOURCE_FILE ("declaration-startup.galgas", 214)), inCompiler  COMMA_SOURCE_FILE ("declaration-startup.galgas", 214)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string (")\n"), inCompiler  COMMA_SOURCE_FILE ("declaration-startup.galgas", 215)) ;
    enumerator_9680.gotoNextObject () ;
  }
  ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  ret void\n"), inCompiler  COMMA_SOURCE_FILE ("declaration-startup.galgas", 217)) ;
  ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("}\n"
    "\n"), inCompiler  COMMA_SOURCE_FILE ("declaration-startup.galgas", 218)) ;
  const GALGAS_startupListIR temp_1 = inObject ;
  cEnumerator_startupListIR enumerator_9961 (temp_1, kENUMERATION_UP) ;
  while (enumerator_9961.hasCurrentObject ()) {
    ioArgument_ioLLVMcode.plusAssign_operation(function_llvmSeparatorLine (inCompiler COMMA_SOURCE_FILE ("declaration-startup.galgas", 220)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("declaration-startup.galgas", 220)), inCompiler  COMMA_SOURCE_FILE ("declaration-startup.galgas", 220)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("define internal void @startup.").add_operation (enumerator_9961.current (HERE).getter_mDriverName (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-startup.galgas", 221)).add_operation (GALGAS_string (" ("), inCompiler COMMA_SOURCE_FILE ("declaration-startup.galgas", 221)), inCompiler  COMMA_SOURCE_FILE ("declaration-startup.galgas", 221)) ;
    const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, enumerator_9961.current (HERE).getter_mSelfType (HERE).getter_kind (HERE).objectCompare (GALGAS_typeKind::constructor_void (SOURCE_FILE ("declaration-startup.galgas", 222)))).boolEnum () ;
    if (kBoolTrue == test_2) {
      ioArgument_ioLLVMcode.plusAssign_operation(extensionGetter_llvmTypeName (enumerator_9961.current (HERE).getter_mSelfType (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-startup.galgas", 223)).add_operation (GALGAS_string ("* "), inCompiler COMMA_SOURCE_FILE ("declaration-startup.galgas", 223)).add_operation (function_llvmNameForSelf (inCompiler COMMA_SOURCE_FILE ("declaration-startup.galgas", 223)), inCompiler COMMA_SOURCE_FILE ("declaration-startup.galgas", 223)), inCompiler  COMMA_SOURCE_FILE ("declaration-startup.galgas", 223)) ;
    }
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string (")").add_operation (function_llvmAttributeFunction (inCompiler COMMA_SOURCE_FILE ("declaration-startup.galgas", 225)), inCompiler COMMA_SOURCE_FILE ("declaration-startup.galgas", 225)).add_operation (GALGAS_string ("{\n"), inCompiler COMMA_SOURCE_FILE ("declaration-startup.galgas", 225)), inCompiler  COMMA_SOURCE_FILE ("declaration-startup.galgas", 225)) ;
    extensionMethod_generateAllocaList (enumerator_9961.current (HERE).getter_mAllocaList (HERE), ioArgument_ioLLVMcode, inCompiler COMMA_SOURCE_FILE ("declaration-startup.galgas", 226)) ;
    extensionMethod_instructionListLLVMCode (enumerator_9961.current (HERE).getter_mInstructionListIR (HERE), ioArgument_ioLLVMcode, constinArgument_inGenerationContext, ioArgument_ioGenerationAdds, inCompiler COMMA_SOURCE_FILE ("declaration-startup.galgas", 227)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  ret void\n"), inCompiler  COMMA_SOURCE_FILE ("declaration-startup.galgas", 228)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("}\n"
      "\n"), inCompiler  COMMA_SOURCE_FILE ("declaration-startup.galgas", 229)) ;
...
void extensionMethod_enterFunctionInContext (const GALGAS_functionDeclarationListAST inObject,
                                             ...
                                             COMMA_UNUSED_LOCATION_ARGS) {
  const GALGAS_functionDeclarationListAST temp_0 = inObject ;
  cEnumerator_functionDeclarationListAST enumerator_7210 (temp_0, kENUMERATION_UP) ;
  while (enumerator_7210.hasCurrentObject ()) {
    GALGAS_routineTypedSignature var_signature_7326 ;
    {
    routine_routineSignature (ioArgument_ioContext.mProperty_mTypeMap, enumerator_7210.current (HERE).getter_mFunctionFormalArgumentList (HERE), var_signature_7326, inCompiler  COMMA_SOURCE_FILE ("declaration-func.galgas", 222)) ;
    }
    GALGAS_unifiedTypeMap_2D_proxy var_returnTypeProxy_7467 ;
    {
    GALGAS_unifiedTypeMap_2D_proxy::class_method_makeOptionalProxy (ioArgument_ioContext.mProperty_mTypeMap, enumerator_7210.current (HERE).getter_mFunctionReturnTypeName (HERE), var_returnTypeProxy_7467 COMMA_SOURCE_FILE ("declaration-func.galgas", 224)) ;
    }
    GALGAS_bool var_warnIfUnused_7507 = GALGAS_bool (true) ;
    GALGAS_bool var_globalFunction_7537 = GALGAS_bool (false) ;
    GALGAS_bool var_canMutateProperties_7573 = GALGAS_bool (false) ;
    GALGAS_bool var_isSafe_7596 = GALGAS_bool (false) ;
    cEnumerator_lstringlist enumerator_7659 (enumerator_7210.current (HERE).getter_mFunctionAttributeList (HERE), kENUMERATION_UP) ;
    while (enumerator_7659.hasCurrentObject ()) {
      const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_7659.current_mValue (HERE).getter_string (HERE).objectCompare (function_noUnusedWarningAttribute (inCompiler COMMA_SOURCE_FILE ("declaration-func.galgas", 231)))).boolEnum () ;
      if (kBoolTrue == test_1) {
        const enumGalgasBool test_2 = var_warnIfUnused_7507.operator_not (SOURCE_FILE ("declaration-func.galgas", 232)).boolEnum () ;
        if (kBoolTrue == test_2) {
          TC_Array <C_FixItDescription> fixItArray3 ;
          inCompiler->emitSemanticError (enumerator_7659.current_mValue (HERE).getter_location (SOURCE_FILE ("declaration-func.galgas", 233)), GALGAS_string ("duplicated @").add_operation (function_noUnusedWarningAttribute (inCompiler COMMA_SOURCE_FILE ("declaration-func.galgas", 233)), inCompiler COMMA_SOURCE_FILE ("declaration-func.galgas", 233)).add_operation (GALGAS_string (" attribute"), inCompiler COMMA_SOURCE_FILE ("declaration-func.galgas", 233)), fixItArray3  COMMA_SOURCE_FILE ("declaration-func.galgas", 233)) ;
        }
        var_warnIfUnused_7507 = GALGAS_bool (false) ;
      }else if (kBoolFalse == test_1) {
        const enumGalgasBool test_4 = GALGAS_bool (kIsEqual, enumerator_7659.current_mValue (HERE).getter_string (HERE).objectCompare (function_exportedAttribute (inCompiler COMMA_SOURCE_FILE ("declaration-func.galgas", 236)))).boolEnum () ;
        if (kBoolTrue == test_4) {
          const enumGalgasBool test_5 = var_globalFunction_7537.boolEnum () ;
          if (kBoolTrue == test_5) {
            TC_Array <C_FixItDescription> fixItArray6 ;
          ...
          var_globalFunction_7537 = GALGAS_bool (true) ;
        }else if (kBoolFalse == test_4) {
          const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, enumerator_7659.current_mValue (HERE).getter_string (HERE).objectCompare (function_mutatingAttribute (inCompiler COMMA_SOURCE_FILE ("declaration-func.galgas", 241)))).boolEnum () ;
          if (kBoolTrue == test_7) {
            const enumGalgasBool test_8 = var_canMutateProperties_7573.boolEnum () ;
            if (kBoolTrue == test_8) {
              TC_Array <C_FixItDescription> fixItArray9 ;
            ...
            var_canMutateProperties_7573 = GALGAS_bool (true) ;
          }else if (kBoolFalse == test_7) {
            const enumGalgasBool test_10 = GALGAS_bool (kIsEqual, enumerator_7659.current_mValue (HERE).getter_string (HERE).objectCompare (function_safeAttribute (inCompiler COMMA_SOURCE_FILE ("declaration-func.galgas", 246)))).boolEnum () ;
            if (kBoolTrue == test_10) {
              const enumGalgasBool test_11 = var_isSafe_7596.boolEnum () ;
              if (kBoolTrue == test_11) {
                TC_Array <C_FixItDescription> fixItArray12 ;
                fixItArray12.appendObject (C_FixItDescription (kFixItRemove, "")) ;
                inCompiler->emitSemanticError (enumerator_7659.current_mValue (HERE).getter_location (SOURCE_FILE ("declaration-func.galgas", 248)), GALGAS_string ("duplicated attribute"), fixItArray12  COMMA_SOURCE_FILE ("declaration-func.galgas", 248)) ;
              }else if (kBoolFalse == test_11) {
                var_isSafe_7596 = GALGAS_bool (true) ;
              }
    ...
    GALGAS_bool var_canAccessProperties_8784 = GALGAS_bool (kIsNotEqual, enumerator_7210.current (HERE).getter_mMode (HERE).objectCompare (GALGAS_mode::constructor_userMode (SOURCE_FILE ("declaration-func.galgas", 257)))) ;
    GALGAS_lstring var_routineMangledName_8869 = function_routineMangledNameFromAST (constinArgument_inSelfTypeName, enumerator_7210.current (HERE).getter_mFunctionName (HERE), enumerator_7210.current (HERE).getter_mFunctionFormalArgumentList (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-func.galgas", 259)) ;
    {
    extensionSetter_insertRoutine (ioArgument_ioContext.mProperty_mRoutineMapForContext, constinArgument_inSelfTypeName, enumerator_7210.current (HERE).getter_mFunctionName (HERE), extensionGetter_routineSignature (enumerator_7210.current (HERE).getter_mFunctionFormalArgumentList (HERE), enumerator_7210.current (HERE).getter_mFunctionName (HERE).getter_location (SOURCE_FILE ("declaration-func.galgas", 268)), inCompiler COMMA_SOURCE_FILE ("declaration-func.galgas", 268)), var_routineMangledName_8869, GALGAS_routineDescriptor::constructor_new (enumerator_7210.current (HERE).getter_mPublicFunction (HERE), var_globalFunction_7537, enumerator_7210.current (HERE).getter_mFunctionName (HERE).getter_string (SOURCE_FILE ("declaration-func.galgas", 273)), GALGAS_routineKind::constructor_function (enumerator_7210.current (HERE).getter_mMode (HERE)  COMMA_SOURCE_FILE ("declaration-func.galgas", 274)), var_signature_7326, var_returnTypeProxy_7467, var_canAccessProperties_8784, var_canMutateProperties_7573, var_isSafe_7596  COMMA_SOURCE_FILE ("declaration-func.galgas", 270)), inCompiler COMMA_SOURCE_FILE ("declaration-func.galgas", 265)) ;
    }
    ioArgument_ioDecoratedDeclarationList.addAssign_operation (GALGAS_decoratedFunction::constructor_new (constinArgument_inSelfTypeName, enumerator_7210.current (HERE).getter_mMode (HERE), enumerator_7210.current (HERE).getter_mPublicFunction (HERE), enumerator_7210.current (HERE).getter_mFunctionName (HERE), enumerator_7210.current (HERE).getter_mFunctionFormalArgumentList (HERE), enumerator_7210.current (HERE).getter_mFunctionReturnTypeName (HERE), enumerator_7210.current (HERE).getter_mFunctionInstructionList (HERE), enumerator_7210.current (HERE).getter_mEndOfFunctionDeclaration (HERE), var_warnIfUnused_7507, var_globalFunction_7537, var_isSafe_7596  COMMA_SOURCE_FILE ("declaration-func.galgas", 283))  COMMA_SOURCE_FILE ("declaration-func.galgas", 283)) ;
...
void extensionMethod_enterFunctionsInPropertyMap (const GALGAS_functionDeclarationListAST inObject,
                                                  ...
                                                  COMMA_UNUSED_LOCATION_ARGS) {
  const GALGAS_functionDeclarationListAST temp_0 = inObject ;
  cEnumerator_functionDeclarationListAST enumerator_10403 (temp_0, kENUMERATION_UP) ;
  while (enumerator_10403.hasCurrentObject ()) {
    GALGAS_stringset var_attributeSet_10452 = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("declaration-func.galgas", 308)) ;
    cEnumerator_lstringlist enumerator_10510 (enumerator_10403.current (HERE).getter_mFunctionAttributeList (HERE), kENUMERATION_UP) ;
    while (enumerator_10510.hasCurrentObject ()) {
      var_attributeSet_10452.addAssign_operation (enumerator_10510.current (HERE).getter_mValue (HERE).getter_string (HERE)  COMMA_SOURCE_FILE ("declaration-func.galgas", 310)) ;
      enumerator_10510.gotoNextObject () ;
    }
    GALGAS_bool var_exportedFunction_10593 = var_attributeSet_10452.getter_hasKey (function_exportedAttribute (inCompiler COMMA_SOURCE_FILE ("declaration-func.galgas", 312)) COMMA_SOURCE_FILE ("declaration-func.galgas", 312)) ;
    GALGAS_bool var_canMutateProperties_10667 = var_attributeSet_10452.getter_hasKey (function_mutatingAttribute (inCompiler COMMA_SOURCE_FILE ("declaration-func.galgas", 313)) COMMA_SOURCE_FILE ("declaration-func.galgas", 313)) ;
    GALGAS_bool var_safe_10726 = var_attributeSet_10452.getter_hasKey (function_safeAttribute (inCompiler COMMA_SOURCE_FILE ("declaration-func.galgas", 314)) COMMA_SOURCE_FILE ("declaration-func.galgas", 314)) ;
    GALGAS_bool var_canAccessProperties_10796 = GALGAS_bool (kIsNotEqual, enumerator_10403.current (HERE).getter_mMode (HERE).objectCompare (GALGAS_mode::constructor_userMode (SOURCE_FILE ("declaration-func.galgas", 315)))) ;
    GALGAS_routineTypedSignature var_signature_10939 ;
    {
    routine_routineSignature (ioArgument_ioContext.mProperty_mTypeMap, enumerator_10403.current (HERE).getter_mFunctionFormalArgumentList (HERE), var_signature_10939, inCompiler  COMMA_SOURCE_FILE ("declaration-func.galgas", 317)) ;
    }
    GALGAS_unifiedTypeMap_2D_proxy var_returnTypeProxy_11080 ;
    {
    GALGAS_unifiedTypeMap_2D_proxy::class_method_makeOptionalProxy (ioArgument_ioContext.mProperty_mTypeMap, enumerator_10403.current (HERE).getter_mFunctionReturnTypeName (HERE), var_returnTypeProxy_11080 COMMA_SOURCE_FILE ("declaration-func.galgas", 319)) ;
    }
    GALGAS_lstring var_routineMangledName_11136 = function_routineMangledNameFromAST (GALGAS_string::makeEmptyString (), enumerator_10403.current (HERE).getter_mFunctionName (HERE), enumerator_10403.current (HERE).getter_mFunctionFormalArgumentList (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-func.galgas", 321)) ;
    GALGAS_routineDescriptor var_descriptor_11301 = GALGAS_routineDescriptor::constructor_new (enumerator_10403.current (HERE).getter_mPublicFunction (HERE), var_exportedFunction_10593, enumerator_10403.current (HERE).getter_mFunctionName (HERE).getter_string (SOURCE_FILE ("declaration-func.galgas", 330)), GALGAS_routineKind::constructor_function (enumerator_10403.current (HERE).getter_mMode (HERE)  COMMA_SOURCE_FILE ("declaration-func.galgas", 331)), var_signature_10939, var_returnTypeProxy_11080, var_canAccessProperties_10796, var_canMutateProperties_10667, var_safe_10726  COMMA_SOURCE_FILE ("declaration-func.galgas", 327)) ;
    {
    ioArgument_ioPropertyMap.setter_insertKey (var_routineMangledName_11136, enumerator_10403.current (HERE).getter_mPublicFunction (HERE), GALGAS_propertyAccessKind::constructor_nonVirtualMethod (var_descriptor_11301  COMMA_SOURCE_FILE ("declaration-func.galgas", 339)), inCompiler COMMA_SOURCE_FILE ("declaration-func.galgas", 339)) ;
    }
