...
//--- Find method
  if (NULL != inObject) {
    ...
    if (NULL == f) {
      ...
      f (inObject, constin_inReceiverType, constin_inTargetType, constin_inContext, constin_inMode, io_ioTemporaryIndex, io_ioGlobalLiteralStringMap, io_ioVariableMap, io_ioInstructionGenerationList, out_outExpressionType, out_outGeneratedCode, out_outResultValueName, inCompiler COMMA_THERE) ;
    }
  }
}
...
void categoryMethod_enterAccessibleEntities (const GALGAS_instructionListIR inObject,
                                             ...
                                             COMMA_UNUSED_LOCATION_ARGS) {
  const GALGAS_instructionListIR temp_0 = inObject ;
  cEnumerator_instructionListIR enumerator_2317 (temp_0, kEnumeration_up) ;
  while (enumerator_2317.hasCurrentObject ()) {
    callCategoryMethod_enterAccessibleEntities ((const cPtr_abstractInstructionIR *) enumerator_2317.current_mInstructionGeneration (HERE).ptr (), ioArgument_ioAccessibleEntities, inCompiler COMMA_SOURCE_FILE ("code-optimisation.galgas", 47)) ;
...
mAttribute_mInitialValueExpressionGeneration () {
}
...
mAttribute_mInitialValueExpressionGeneration (inOperand3) {
}
...
typeComparisonResult GALGAS_globalVariableMapIR_2D_element::objectCompare (const GALGAS_globalVariableMapIR_2D_element & inOperand) const {
  ...
  if (result == kOperandEqual) {
    result = mAttribute_mInitialValueExpressionGeneration.objectCompare (inOperand.mAttribute_mInitialValueExpressionGeneration) ;
  }
  return result ;
}
...
void GALGAS_globalVariableMapIR_2D_element::drop (void) {
  ...
  mAttribute_mInitialValueExpressionGeneration.drop () ;
}
...
GALGAS_abstractExpressionGeneration GALGAS_globalVariableMapIR_2D_element::reader_mInitialValueExpressionGeneration (UNUSED_LOCATION_ARGS) const {
...
GALGAS_globalConstantMapIR_2D_element::GALGAS_globalConstantMapIR_2D_element (const GALGAS_lstring & inOperand0,
                                                                              const GALGAS_abstractExpressionGeneration & inOperand1) :
mAttribute_lkey (inOperand0),
...
GALGAS_abstractExpressionGeneration GALGAS_globalConstantMapIR_2D_element::reader_mValueExpressionGeneration (UNUSED_LOCATION_ARGS) const {
...
GALGAS_location categoryReader_location (const GALGAS_variableKindIR & inObject,
  ...
  case GALGAS_variableKindIR::kEnum_register:
    {
      const cEnumAssociatedValues_variableKindIR_register * extractPtr_1396 = (const cEnumAssociatedValues_variableKindIR_register *) (temp_0.unsafePointer ()) ;
      const GALGAS_lstring extractedValue_name = extractPtr_1396->mAssociatedValue0 ;
      result_outLocation = extractedValue_name.mAttribute_location ;
    }
    break ;
  case GALGAS_variableKindIR::kEnum_globalConstant:
    {
      const cEnumAssociatedValues_variableKindIR_globalConstant * extractPtr_1468 = (const cEnumAssociatedValues_variableKindIR_globalConstant *) (temp_0.unsafePointer ()) ;
  ...
  case GALGAS_variableKindIR::kEnum_globalVariable:
    {
      const cEnumAssociatedValues_variableKindIR_globalVariable * extractPtr_1540 = (const cEnumAssociatedValues_variableKindIR_globalVariable *) (temp_0.unsafePointer ()) ;
  ...
  case GALGAS_variableKindIR::kEnum_localVariable:
    {
      const cEnumAssociatedValues_variableKindIR_localVariable * extractPtr_1611 = (const cEnumAssociatedValues_variableKindIR_localVariable *) (temp_0.unsafePointer ()) ;
      const GALGAS_lstring extractedValue_name = extractPtr_1611->mAssociatedValue0 ;
      result_outLocation = extractedValue_name.mAttribute_location ;
    }
    break ;
  case GALGAS_variableKindIR::kEnum_inArgument:
    {
      const cEnumAssociatedValues_variableKindIR_inArgument * extractPtr_1679 = (const cEnumAssociatedValues_variableKindIR_inArgument *) (temp_0.unsafePointer ()) ;
      const GALGAS_lstring extractedValue_name = extractPtr_1679->mAssociatedValue0 ;
      result_outLocation = extractedValue_name.mAttribute_location ;
    }
    break ;
  case GALGAS_variableKindIR::kEnum_inOutArgument:
    {
      const cEnumAssociatedValues_variableKindIR_inOutArgument * extractPtr_1750 = (const cEnumAssociatedValues_variableKindIR_inOutArgument *) (temp_0.unsafePointer ()) ;
  ...
  case GALGAS_variableKindIR::kEnum_outArgument:
    {
      const cEnumAssociatedValues_variableKindIR_outArgument * extractPtr_1819 = (const cEnumAssociatedValues_variableKindIR_outArgument *) (temp_0.unsafePointer ()) ;
      const GALGAS_lstring extractedValue_name = extractPtr_1819->mAssociatedValue0 ;
      result_outLocation = extractedValue_name.mAttribute_location ;
    }
    break ;
  case GALGAS_variableKindIR::kEnum_localConstant:
    {
      const cEnumAssociatedValues_variableKindIR_localConstant * extractPtr_1890 = (const cEnumAssociatedValues_variableKindIR_localConstant *) (temp_0.unsafePointer ()) ;
      const GALGAS_lstring extractedValue_name = extractPtr_1890->mAssociatedValue0 ;
      result_outLocation = extractedValue_name.mAttribute_location ;
    }
    break ;
  case GALGAS_variableKindIR::kEnum_temporaryConstant:
    {
      inCompiler->emitSemanticError (GALGAS_location::constructor_nowhere (SOURCE_FILE ("variable-map.galgas", 43)), GALGAS_string ("internal error: cannot get location of a temporary")  COMMA_SOURCE_FILE ("variable-map.galgas", 43)) ;
      result_outLocation.drop () ; // Release error dropped variable
    }
    break ;
  case GALGAS_variableKindIR::kEnum_localAccess:
    {
      const cEnumAssociatedValues_variableKindIR_localAccess * extractPtr_2080 = (const cEnumAssociatedValues_variableKindIR_localAccess *) (temp_0.unsafePointer ()) ;
      const GALGAS_location extractedValue_location = extractPtr_2080->mAssociatedValue1 ;
      result_outLocation = extractedValue_location ;
    }
    break ;
  case GALGAS_variableKindIR::kEnum_literalUnsignedInteger:
    {
      const cEnumAssociatedValues_variableKindIR_literalUnsignedInteger * extractPtr_2164 = (const cEnumAssociatedValues_variableKindIR_literalUnsignedInteger *) (temp_0.unsafePointer ()) ;
      const GALGAS_luint_36__34_ extractedValue_value = extractPtr_2164->mAssociatedValue1 ;
      result_outLocation = extractedValue_value.mAttribute_location ;
    }
    break ;
  case GALGAS_variableKindIR::kEnum_literalString:
    {
      const cEnumAssociatedValues_variableKindIR_literalString * extractPtr_2239 = (const cEnumAssociatedValues_variableKindIR_literalString *) (temp_0.unsafePointer ()) ;
      const GALGAS_lstring extractedValue_value = extractPtr_2239->mAssociatedValue0 ;
      result_outLocation = extractedValue_value.mAttribute_location ;
    }
    break ;
  }
...
void categoryMethod_enterAccessibleEntities (const GALGAS_variableKindIR inObject,
  ...
  case GALGAS_variableKindIR::kEnum_literalString:
    {
      const cEnumAssociatedValues_variableKindIR_literalString * extractPtr_1834 = (const cEnumAssociatedValues_variableKindIR_literalString *) (temp_0.unsafePointer ()) ;
      const GALGAS_lstring extractedValue_value = extractPtr_1834->mAssociatedValue0 ;
      const GALGAS_string extractedValue_name = extractPtr_1834->mAssociatedValue1 ;
      ioArgument_ioAccessibleEntities.mAttribute_mStaticStringSet.addAssign_operation (extractedValue_value.mAttribute_string  COMMA_SOURCE_FILE ("code-optimisation.galgas", 35)) ;
    }
    break ;
  }
}
...
GALGAS_string categoryReader_mangledName (const GALGAS_variableKindIR & inObject,
  ...
  case GALGAS_variableKindIR::kEnum_literalString:
    {
      const cEnumAssociatedValues_variableKindIR_literalString * extractPtr_1891 = (const cEnumAssociatedValues_variableKindIR_literalString *) (temp_0.unsafePointer ()) ;
      const GALGAS_string extractedValue_name = extractPtr_1891->mAssociatedValue1 ;
...
GALGAS_string categoryReader_headerCodeGeneration (const GALGAS_globalConstantMapIR_2D_element & inObject,
                                                   ...
                                                   COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_outCode ; // Returned variable
  result_outCode = GALGAS_string (filewrapperTemplate_globalConstantGenerationTemplate_declaration (inCompiler, inObject.mAttribute_lkey.mAttribute_string, callCategoryReader_expressionCode ((const cPtr_abstractExpressionGeneration *) inObject.mAttribute_mValueExpressionGeneration.ptr (), inCompiler COMMA_SOURCE_FILE ("global-constant-declaration.galgas", 154)) COMMA_SOURCE_FILE ("global-constant-declaration.galgas", 152))) ;
//---
  return result_outCode ;
}
...
static void categoryMethod_procCallInstructionAST_analyze (const cPtr_instructionAST * inObject,
  ...
  while (enumerator_4488.hasCurrentObject () && enumerator_4519.hasCurrentObject ()) {
    ...
    case GALGAS_procEffectiveParameterPassingModeAST::kEnum_output:
      {
        const cEnumAssociatedValues_procEffectiveParameterPassingModeAST_output * extractPtr_5937 = (const cEnumAssociatedValues_procEffectiveParameterPassingModeAST_output *) (enumerator_4519.current_mEffectiveParameterKind (HERE).unsafePointer ()) ;
        const GALGAS_expressionAST extractedValue_expression = extractPtr_5937->mAssociatedValue0 ;
        GALGAS_unifiedTypeMap_2D_proxy var_expressionType ;
        GALGAS_abstractExpressionGeneration var_testExpressionGeneratedCode ;
        GALGAS_variableKindIR var_expressionResult ;
        callCategoryMethod_analyzeExpression ((const cPtr_expressionAST *) extractedValue_expression.ptr (), constinArgument_inReceiverType, enumerator_4488.current_mType (HERE), constinArgument_inContext, constinArgument_inMode, ioArgument_ioTemporaryIndex, ioArgument_ioGlobalLiteralStringMap, ioArgument_ioVariableMap, ioArgument_ioInstructionGenerationList, var_expressionType, var_testExpressionGeneratedCode, var_expressionResult, inCompiler COMMA_SOURCE_FILE ("instruction-proc-call.galgas", 137)) ;
    ...
    case GALGAS_procEffectiveParameterPassingModeAST::kEnum_outputInput:
      {
        const cEnumAssociatedValues_procEffectiveParameterPassingModeAST_outputInput * extractPtr_6480 = (const cEnumAssociatedValues_procEffectiveParameterPassingModeAST_outputInput *) (enumerator_4519.current_mEffectiveParameterKind (HERE).unsafePointer ()) ;
        ...
        GALGAS_variableKindIR var_parameterAccess ;
        {
        GALGAS_bool joker_6159 ; // Joker input parameter
        ioArgument_ioVariableMap.modifier_searchForReadWriteAccess (extractedValue_name, var_type, var_acceptedModeSet, var_variableAccess, var_parameterAccess, joker_6159, inCompiler COMMA_SOURCE_FILE ("instruction-proc-call.galgas", 153)) ;
        }
  ...
  if (kBoolTrue == test_8) {
    ...
    cEnumerator_procedureSignature enumerator_6902 (var_procSignature, kEnumeration_up) ;
    cEnumerator_procEffectiveParameterList enumerator_6931 (var_parameterList, kEnumeration_up) ;
    while (enumerator_6902.hasCurrentObject () && enumerator_6931.hasCurrentObject ()) {
      const enumGalgasBool test_10 = GALGAS_bool (kIsNotEqual, enumerator_6902.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("instruction-proc-call.galgas", 178)).objectCompare (enumerator_6931.current_mParameterType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("instruction-proc-call.galgas", 178)))).boolEnum () ;
      if (kBoolTrue == test_10) {
        GALGAS_location location_11 (enumerator_6931.current_mSelector (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_11, GALGAS_string ("the actual parameter type is '").add_operation (enumerator_6931.current_mParameterType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("instruction-proc-call.galgas", 179)), inCompiler COMMA_SOURCE_FILE ("instruction-proc-call.galgas", 179)).add_operation (GALGAS_string ("', and is incompatible with the formal type '"), inCompiler COMMA_SOURCE_FILE ("instruction-proc-call.galgas", 179)).add_operation (enumerator_6902.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("instruction-proc-call.galgas", 180)), inCompiler COMMA_SOURCE_FILE ("instruction-proc-call.galgas", 180)).add_operation (GALGAS_string ("'"), inCompiler COMMA_SOURCE_FILE ("instruction-proc-call.galgas", 180))  COMMA_SOURCE_FILE ("instruction-proc-call.galgas", 179)) ;
      }
      GALGAS_string var_requiredPassingMode = categoryReader_requiredActualPassingModeForSelector (enumerator_6902.current_mFormalArgumentPassingMode (HERE), enumerator_6902.current_mSelector (HERE), inCompiler COMMA_SOURCE_FILE ("instruction-proc-call.galgas", 182)) ;
      GALGAS_string var_testedPassingMode = categoryReader_passingModeForActualSelector (enumerator_6931.current_mEffectiveParameterPassingMode (HERE), enumerator_6931.current_mSelector (HERE), inCompiler COMMA_SOURCE_FILE ("instruction-proc-call.galgas", 183)) ;
      ...
      if (kBoolTrue == test_12) {
        GALGAS_location location_13 (enumerator_6931.current_mSelector (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
...
static GALGAS_string categoryReader_procCallInstructionIR_instructionCode (const cPtr_abstractInstructionIR * inObject,
  ...
  cEnumerator_procCallEffectiveParameterListIR enumerator_9075 (object->mAttribute_mParameters, kEnumeration_up) ;
  while (enumerator_9075.hasCurrentObject ()) {
    switch (enumerator_9075.current_mEffectiveParameterPassingMode (HERE).enumValue ()) {
    case GALGAS_procEffectiveParameterPassingModeIR::kNotBuilt:
      break ;
    case GALGAS_procEffectiveParameterPassingModeIR::kEnum_input:
      {
        result_outCode.dotAssign_operation (GALGAS_string ("&(").add_operation (categoryReader_mangledName (enumerator_9075.current_mParameter (HERE), inCompiler COMMA_SOURCE_FILE ("instruction-proc-call.galgas", 229)), inCompiler COMMA_SOURCE_FILE ("instruction-proc-call.galgas", 229)).add_operation (GALGAS_string (")"), inCompiler COMMA_SOURCE_FILE ("instruction-proc-call.galgas", 229))  COMMA_SOURCE_FILE ("instruction-proc-call.galgas", 229)) ;
      }
      break ;
    case GALGAS_procEffectiveParameterPassingModeIR::kEnum_output:
      {
        result_outCode.dotAssign_operation (categoryReader_mangledName (enumerator_9075.current_mParameter (HERE), inCompiler COMMA_SOURCE_FILE ("instruction-proc-call.galgas", 231))  COMMA_SOURCE_FILE ("instruction-proc-call.galgas", 231)) ;
      }
      break ;
    case GALGAS_procEffectiveParameterPassingModeIR::kEnum_outputInput:
      {
        result_outCode.dotAssign_operation (GALGAS_string ("&(").add_operation (categoryReader_mangledName (enumerator_9075.current_mParameter (HERE), inCompiler COMMA_SOURCE_FILE ("instruction-proc-call.galgas", 233)), inCompiler COMMA_SOURCE_FILE ("instruction-proc-call.galgas", 233)).add_operation (GALGAS_string (")"), inCompiler COMMA_SOURCE_FILE ("instruction-proc-call.galgas", 233))  COMMA_SOURCE_FILE ("instruction-proc-call.galgas", 233)) ;
      }
      break ;
    }
...
static void categoryMethod_procCallInstructionIR_enterAccessibleEntities (const cPtr_abstractInstructionIR * inObject,
  ...
  cEnumerator_procCallEffectiveParameterListIR enumerator_9700 (object->mAttribute_mParameters, kEnumeration_up) ;
  while (enumerator_9700.hasCurrentObject ()) {
    categoryMethod_enterAccessibleEntities (enumerator_9700.current_mParameter (HERE), ioArgument_ioAccessibleEntities, inCompiler COMMA_SOURCE_FILE ("instruction-proc-call.galgas", 246)) ;
...
static void categoryMethod_literalIntegerInExpressionAST_analyzeExpression (const cPtr_expressionAST * inObject,
  ...
  outArgument_outResult = GALGAS_variableKindIR::constructor_literalUnsignedInteger (outArgument_outExpressionType, object->mAttribute_mLiteralInteger  COMMA_SOURCE_FILE ("expression-literal-integer.galgas", 112)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_literalStringInExpressionAST_analyzeExpression (const cPtr_expressionAST * inObject,
  ...
  outArgument_outResultValueName = GALGAS_variableKindIR::constructor_literalString (object->mAttribute_mLiteralString, var_literalStringName  COMMA_SOURCE_FILE ("expression-literal-string.galgas", 80)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
