...
cMapElement_infixOperatorMap_5F_EX::cMapElement_infixOperatorMap_5F_EX (const GALGAS_lstring & inKey,
...
bool cMapElement_infixOperatorMap_5F_EX::isValid (void) const {
  return mProperty_lkey.isValid () && mProperty_mResultType.isValid () && mProperty_mOperation.isValid () ;
}

//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*

cMapElement * cMapElement_infixOperatorMap_5F_EX::copy (void) {
  cMapElement * result = NULL ;
  macroMyNew (result, cMapElement_infixOperatorMap_5F_EX (mProperty_lkey, mProperty_mResultType, mProperty_mOperation COMMA_HERE)) ;
  return result ;
}

//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*

void cMapElement_infixOperatorMap_5F_EX::description (C_String & ioString, const int32_t inIndentation) const {
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
...
typeComparisonResult cMapElement_infixOperatorMap_5F_EX::compare (const cCollectionElement * inOperand) const {
  cMapElement_infixOperatorMap_5F_EX * operand = (cMapElement_infixOperatorMap_5F_EX *) inOperand ;
  typeComparisonResult result = mProperty_lkey.objectCompare (operand->mProperty_lkey) ;
  if (kOperandEqual == result) {
...
GALGAS_infixOperatorMap_5F_EX::GALGAS_infixOperatorMap_5F_EX (void) :
AC_GALGAS_map () {
}

//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*

GALGAS_infixOperatorMap_5F_EX::GALGAS_infixOperatorMap_5F_EX (const GALGAS_infixOperatorMap_5F_EX & inSource) :
AC_GALGAS_map (inSource) {
}

//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*

GALGAS_infixOperatorMap_5F_EX & GALGAS_infixOperatorMap_5F_EX::operator = (const GALGAS_infixOperatorMap_5F_EX & inSource) {
  * ((AC_GALGAS_map *) this) = inSource ;
  return * this ;
}
...
GALGAS_infixOperatorMap_5F_EX GALGAS_infixOperatorMap_5F_EX::constructor_emptyMap (LOCATION_ARGS) {
  GALGAS_infixOperatorMap_5F_EX result ;
  result.makeNewEmptyMap (THERE) ;
  return result ;
}
...
GALGAS_infixOperatorMap_5F_EX GALGAS_infixOperatorMap_5F_EX::constructor_mapWithMapToOverride (const GALGAS_infixOperatorMap_5F_EX & inMapToOverride
                                                                                               COMMA_LOCATION_ARGS) {
  GALGAS_infixOperatorMap_5F_EX result ;
  result.makeNewEmptyMapWithMapToOverride (inMapToOverride COMMA_THERE) ;
  return result ;
...
GALGAS_infixOperatorMap_5F_EX GALGAS_infixOperatorMap_5F_EX::getter_overriddenMap (C_Compiler * inCompiler
                                                                                   COMMA_LOCATION_ARGS) const {
  GALGAS_infixOperatorMap_5F_EX result ;
  getOverridenMap (result, inCompiler COMMA_THERE) ;
  return result ;
...
void GALGAS_infixOperatorMap_5F_EX::addAssign_operation (const GALGAS_lstring & inKey,
                                                         const GALGAS_omnibusType & inArgument0,
                                                         const GALGAS_infixOperatorDescription & inArgument1,
                                                         C_Compiler * inCompiler
                                                         COMMA_LOCATION_ARGS) {
  cMapElement_infixOperatorMap_5F_EX * p = NULL ;
  macroMyNew (p, cMapElement_infixOperatorMap_5F_EX (inKey, inArgument0, inArgument1 COMMA_HERE)) ;
  capCollectionElement attributes ;
  attributes.setPointer (p) ;
  macroDetachSharedObject (p) ;
  const char * kInsertErrorMessage = "@infixOperatorMap_5F_EX insert error: '%K' already in map" ;
  const char * kShadowErrorMessage = "" ;
  performInsert (attributes, inCompiler, kInsertErrorMessage, kShadowErrorMessage COMMA_THERE) ;
}
...
void GALGAS_infixOperatorMap_5F_EX::setter_insertKey (GALGAS_lstring inKey,
                                                      GALGAS_omnibusType inArgument0,
...
const char * kSearchErrorMessage_infixOperatorMap_5F_EX_searchKey = "** internal error **" ;

//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*

void GALGAS_infixOperatorMap_5F_EX::method_searchKey (GALGAS_lstring inKey,
                                                      GALGAS_omnibusType & outArgument0,
                                                      GALGAS_infixOperatorDescription & outArgument1,
                                                      C_Compiler * inCompiler
                                                      COMMA_LOCATION_ARGS) const {
  const cMapElement_infixOperatorMap_5F_EX * p = (const cMapElement_infixOperatorMap_5F_EX *) performSearch (inKey,
                                                                                                             inCompiler,
                                                                                                             kSearchErrorMessage_infixOperatorMap_5F_EX_searchKey
                                                                                                             COMMA_THERE) ;
  if (NULL == p) {
    outArgument0.drop () ;
    outArgument1.drop () ;
  }else{
    macroValidSharedObject (p, cMapElement_infixOperatorMap_5F_EX) ;
...
GALGAS_omnibusType GALGAS_infixOperatorMap_5F_EX::getter_mResultTypeForKey (const GALGAS_string & inKey,
                                                                            C_Compiler * inCompiler
                                                                            COMMA_LOCATION_ARGS) const {
  const cCollectionElement * attributes = searchForReadingAttribute (inKey, inCompiler COMMA_THERE) ;
  const cMapElement_infixOperatorMap_5F_EX * p = (const cMapElement_infixOperatorMap_5F_EX *) attributes ;
  GALGAS_omnibusType result ;
  if (NULL != p) {
    macroValidSharedObject (p, cMapElement_infixOperatorMap_5F_EX) ;
...
GALGAS_infixOperatorDescription GALGAS_infixOperatorMap_5F_EX::getter_mOperationForKey (const GALGAS_string & inKey,
                                                                                        C_Compiler * inCompiler
                                                                                        COMMA_LOCATION_ARGS) const {
  const cCollectionElement * attributes = searchForReadingAttribute (inKey, inCompiler COMMA_THERE) ;
  const cMapElement_infixOperatorMap_5F_EX * p = (const cMapElement_infixOperatorMap_5F_EX *) attributes ;
...
void GALGAS_infixOperatorMap_5F_EX::setter_setMResultTypeForKey (GALGAS_omnibusType inAttributeValue,
                                                                 GALGAS_string inKey,
                                                                 C_Compiler * inCompiler
                                                                 COMMA_LOCATION_ARGS) {
  cCollectionElement * attributes = searchForReadWriteAttribute (inKey, true, inCompiler COMMA_THERE) ;
  cMapElement_infixOperatorMap_5F_EX * p = (cMapElement_infixOperatorMap_5F_EX *) attributes ;
  if (NULL != p) {
    macroValidSharedObject (p, cMapElement_infixOperatorMap_5F_EX) ;
...
void GALGAS_infixOperatorMap_5F_EX::setter_setMOperationForKey (GALGAS_infixOperatorDescription inAttributeValue,
                                                                GALGAS_string inKey,
                                                                C_Compiler * inCompiler
                                                                COMMA_LOCATION_ARGS) {
  cCollectionElement * attributes = searchForReadWriteAttribute (inKey, true, inCompiler COMMA_THERE) ;
...
cMapElement_infixOperatorMap_5F_EX * GALGAS_infixOperatorMap_5F_EX::readWriteAccessForWithInstruction (C_Compiler * inCompiler,
                                                                                                       const GALGAS_string & inKey
                                                                                                       COMMA_LOCATION_ARGS) {
  cMapElement_infixOperatorMap_5F_EX * result = (cMapElement_infixOperatorMap_5F_EX *) searchForReadWriteAttribute (inKey, false, inCompiler COMMA_THERE) ;
  macroNullOrValidSharedObject (result, cMapElement_infixOperatorMap_5F_EX) ;
  return result ;
}

//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*

cEnumerator_infixOperatorMap_5F_EX::cEnumerator_infixOperatorMap_5F_EX (const GALGAS_infixOperatorMap_5F_EX & inEnumeratedObject,
                                                                        const typeEnumerationOrder inOrder) :
cGenericAbstractEnumerator (inOrder) {
  inEnumeratedObject.populateEnumerationArray (mEnumerationArray) ;
}
...
GALGAS_infixOperatorMap_5F_EX_2D_element cEnumerator_infixOperatorMap_5F_EX::current (LOCATION_ARGS) const {
  const cMapElement_infixOperatorMap_5F_EX * p = (const cMapElement_infixOperatorMap_5F_EX *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, cMapElement_infixOperatorMap_5F_EX) ;
  return GALGAS_infixOperatorMap_5F_EX_2D_element (p->mProperty_lkey, p->mProperty_mResultType, p->mProperty_mOperation) ;
}

//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*

GALGAS_lstring cEnumerator_infixOperatorMap_5F_EX::current_lkey (LOCATION_ARGS) const {
  const cMapElement * p = (const cMapElement *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, cMapElement) ;
  return p->mProperty_lkey ;
}
...
GALGAS_omnibusType cEnumerator_infixOperatorMap_5F_EX::current_mResultType (LOCATION_ARGS) const {
  const cMapElement_infixOperatorMap_5F_EX * p = (const cMapElement_infixOperatorMap_5F_EX *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, cMapElement_infixOperatorMap_5F_EX) ;
...
GALGAS_infixOperatorDescription cEnumerator_infixOperatorMap_5F_EX::current_mOperation (LOCATION_ARGS) const {
  const cMapElement_infixOperatorMap_5F_EX * p = (const cMapElement_infixOperatorMap_5F_EX *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, cMapElement_infixOperatorMap_5F_EX) ;
...
//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*
//                                                                                                                     *
//                                              @infixOperatorMap_EX type                                              *
//                                                                                                                     *
//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*

const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_infixOperatorMap_5F_EX ("infixOperatorMap_EX",
                                               NULL) ;

//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*

const C_galgas_type_descriptor * GALGAS_infixOperatorMap_5F_EX::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_infixOperatorMap_5F_EX ;
}

//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*

AC_GALGAS_root * GALGAS_infixOperatorMap_5F_EX::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_infixOperatorMap_5F_EX (*this)) ;
  }
  return result ;
}
...
GALGAS_infixOperatorMap_5F_EX GALGAS_infixOperatorMap_5F_EX::extractObject (const GALGAS_object & inObject,
                                                                            C_Compiler * inCompiler
                                                                            COMMA_LOCATION_ARGS) {
  GALGAS_infixOperatorMap_5F_EX result ;
  const GALGAS_infixOperatorMap_5F_EX * p = (const GALGAS_infixOperatorMap_5F_EX *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_infixOperatorMap_5F_EX *> (p)) {
      result = *p ;
    }else{
      inCompiler->castError ("infixOperatorMap_EX", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
void cMapElement_infixOperatorMap::description (C_String & ioString, const int32_t inIndentation) const {
  ...
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "mLeftType" ":" ;
  mProperty_mLeftType.description (ioString, inIndentation) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "mRightType" ":" ;
  mProperty_mRightType.description (ioString, inIndentation) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "mResultType" ":" ;
  mProperty_mResultType.description (ioString, inIndentation) ;
...
typeComparisonResult cMapElement_infixOperatorMap::compare (const cCollectionElement * inOperand) const {
  ...
  typeComparisonResult result = mProperty_lkey.objectCompare (operand->mProperty_lkey) ;
  if (kOperandEqual == result) {
    result = mProperty_mLeftType.objectCompare (operand->mProperty_mLeftType) ;
  }
  if (kOperandEqual == result) {
    result = mProperty_mRightType.objectCompare (operand->mProperty_mRightType) ;
  }
  if (kOperandEqual == result) {
    result = mProperty_mResultType.objectCompare (operand->mProperty_mResultType) ;
  }
...
void GALGAS_infixOperatorMap::addAssign_operation (const GALGAS_lstring & inKey,
                                                   ...
                                                   const GALGAS_terminusInfixOperator & inArgument3,
                                                   C_Compiler * inCompiler
                                                   COMMA_LOCATION_ARGS) {
  cMapElement_infixOperatorMap * p = NULL ;
  macroMyNew (p, cMapElement_infixOperatorMap (inKey, inArgument0, inArgument1, inArgument2, inArgument3 COMMA_HERE)) ;
  capCollectionElement attributes ;
  attributes.setPointer (p) ;
  macroDetachSharedObject (p) ;
...
void GALGAS_infixOperatorMap::setter_insertKey (GALGAS_lstring inKey,
                                                ...
                                                GALGAS_terminusInfixOperator inArgument3,
                                                C_Compiler * inCompiler
                                                COMMA_LOCATION_ARGS) {
  cMapElement_infixOperatorMap * p = NULL ;
  macroMyNew (p, cMapElement_infixOperatorMap (inKey, inArgument0, inArgument1, inArgument2, inArgument3 COMMA_HERE)) ;
...
void GALGAS_infixOperatorMap::method_searchKey (GALGAS_lstring inKey,
                                                ...
                                                GALGAS_terminusInfixOperator & outArgument3,
                                                C_Compiler * inCompiler
                                                COMMA_LOCATION_ARGS) const {
...
GALGAS_omnibusType GALGAS_infixOperatorMap::getter_mLeftTypeForKey (const GALGAS_string & inKey,
                                                                    C_Compiler * inCompiler
                                                                    COMMA_LOCATION_ARGS) const {
  const cCollectionElement * attributes = searchForReadingAttribute (inKey, inCompiler COMMA_THERE) ;
...
GALGAS_omnibusType GALGAS_infixOperatorMap::getter_mRightTypeForKey (const GALGAS_string & inKey,
                                                                     C_Compiler * inCompiler
                                                                     COMMA_LOCATION_ARGS) const {
  const cCollectionElement * attributes = searchForReadingAttribute (inKey, inCompiler COMMA_THERE) ;
  const cMapElement_infixOperatorMap * p = (const cMapElement_infixOperatorMap *) attributes ;
...
GALGAS_terminusInfixOperator GALGAS_infixOperatorMap::getter_mOperatorForKey (const GALGAS_string & inKey,
                                                                              C_Compiler * inCompiler
                                                                              COMMA_LOCATION_ARGS) const {
  const cCollectionElement * attributes = searchForReadingAttribute (inKey, inCompiler COMMA_THERE) ;
  const cMapElement_infixOperatorMap * p = (const cMapElement_infixOperatorMap *) attributes ;
...
void GALGAS_infixOperatorMap::setter_setMLeftTypeForKey (GALGAS_omnibusType inAttributeValue,
                                                         GALGAS_string inKey,
                                                         C_Compiler * inCompiler
                                                         COMMA_LOCATION_ARGS) {
  cCollectionElement * attributes = searchForReadWriteAttribute (inKey, true, inCompiler COMMA_THERE) ;
  ...
  if (NULL != p) {
    macroValidSharedObject (p, cMapElement_infixOperatorMap) ;
    p->mProperty_mLeftType = inAttributeValue ;
  }
}

//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*

void GALGAS_infixOperatorMap::setter_setMRightTypeForKey (GALGAS_omnibusType inAttributeValue,
                                                          GALGAS_string inKey,
                                                          C_Compiler * inCompiler
                                                          COMMA_LOCATION_ARGS) {
  cCollectionElement * attributes = searchForReadWriteAttribute (inKey, true, inCompiler COMMA_THERE) ;
  ...
  if (NULL != p) {
    macroValidSharedObject (p, cMapElement_infixOperatorMap) ;
    p->mProperty_mRightType = inAttributeValue ;
  }
}
...
void GALGAS_infixOperatorMap::setter_setMOperatorForKey (GALGAS_terminusInfixOperator inAttributeValue,
                                                         GALGAS_string inKey,
                                                         C_Compiler * inCompiler
                                                         COMMA_LOCATION_ARGS) {
  cCollectionElement * attributes = searchForReadWriteAttribute (inKey, true, inCompiler COMMA_THERE) ;
...
GALGAS_omnibusType cEnumerator_infixOperatorMap::current_mLeftType (LOCATION_ARGS) const {
  const cMapElement_infixOperatorMap * p = (const cMapElement_infixOperatorMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, cMapElement_infixOperatorMap) ;
  return p->mProperty_mLeftType ;
}

//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*

GALGAS_omnibusType cEnumerator_infixOperatorMap::current_mRightType (LOCATION_ARGS) const {
  const cMapElement_infixOperatorMap * p = (const cMapElement_infixOperatorMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, cMapElement_infixOperatorMap) ;
  return p->mProperty_mRightType ;
}
...
GALGAS_terminusInfixOperator cEnumerator_infixOperatorMap::current_mOperator (LOCATION_ARGS) const {
  const cMapElement_infixOperatorMap * p = (const cMapElement_infixOperatorMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, cMapElement_infixOperatorMap) ;
...
cMapElement_terminusPrefixOperatorMap::cMapElement_terminusPrefixOperatorMap (const GALGAS_lstring & inKey,
...
bool cMapElement_terminusPrefixOperatorMap::isValid (void) const {
  return mProperty_lkey.isValid () && mProperty_mReceiverType.isValid () && mProperty_mResultType.isValid () && mProperty_mOperator.isValid () ;
}

//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*

cMapElement * cMapElement_terminusPrefixOperatorMap::copy (void) {
  cMapElement * result = NULL ;
  macroMyNew (result, cMapElement_terminusPrefixOperatorMap (mProperty_lkey, mProperty_mReceiverType, mProperty_mResultType, mProperty_mOperator COMMA_HERE)) ;
  return result ;
}

//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*

void cMapElement_terminusPrefixOperatorMap::description (C_String & ioString, const int32_t inIndentation) const {
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
...
typeComparisonResult cMapElement_terminusPrefixOperatorMap::compare (const cCollectionElement * inOperand) const {
  cMapElement_terminusPrefixOperatorMap * operand = (cMapElement_terminusPrefixOperatorMap *) inOperand ;
  typeComparisonResult result = mProperty_lkey.objectCompare (operand->mProperty_lkey) ;
  if (kOperandEqual == result) {
...
GALGAS_terminusPrefixOperatorMap::GALGAS_terminusPrefixOperatorMap (void) :
AC_GALGAS_map () {
}

//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*

GALGAS_terminusPrefixOperatorMap::GALGAS_terminusPrefixOperatorMap (const GALGAS_terminusPrefixOperatorMap & inSource) :
AC_GALGAS_map (inSource) {
}

//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*

GALGAS_terminusPrefixOperatorMap & GALGAS_terminusPrefixOperatorMap::operator = (const GALGAS_terminusPrefixOperatorMap & inSource) {
  * ((AC_GALGAS_map *) this) = inSource ;
  return * this ;
}
...
GALGAS_terminusPrefixOperatorMap GALGAS_terminusPrefixOperatorMap::constructor_emptyMap (LOCATION_ARGS) {
  GALGAS_terminusPrefixOperatorMap result ;
  result.makeNewEmptyMap (THERE) ;
  return result ;
}
...
GALGAS_terminusPrefixOperatorMap GALGAS_terminusPrefixOperatorMap::constructor_mapWithMapToOverride (const GALGAS_terminusPrefixOperatorMap & inMapToOverride
                                                                                                     COMMA_LOCATION_ARGS) {
  GALGAS_terminusPrefixOperatorMap result ;
  result.makeNewEmptyMapWithMapToOverride (inMapToOverride COMMA_THERE) ;
  return result ;
...
GALGAS_terminusPrefixOperatorMap GALGAS_terminusPrefixOperatorMap::getter_overriddenMap (C_Compiler * inCompiler
                                                                                         COMMA_LOCATION_ARGS) const {
  GALGAS_terminusPrefixOperatorMap result ;
  getOverridenMap (result, inCompiler COMMA_THERE) ;
  return result ;
...
void GALGAS_terminusPrefixOperatorMap::addAssign_operation (const GALGAS_lstring & inKey,
                                                            const GALGAS_omnibusType & inArgument0,
                                                            const GALGAS_omnibusType & inArgument1,
                                                            const GALGAS_terminusPrefixOperator & inArgument2,
                                                            C_Compiler * inCompiler
                                                            COMMA_LOCATION_ARGS) {
  cMapElement_terminusPrefixOperatorMap * p = NULL ;
  macroMyNew (p, cMapElement_terminusPrefixOperatorMap (inKey, inArgument0, inArgument1, inArgument2 COMMA_HERE)) ;
  capCollectionElement attributes ;
  attributes.setPointer (p) ;
  macroDetachSharedObject (p) ;
  const char * kInsertErrorMessage = "@terminusPrefixOperatorMap insert error: '%K' already in map" ;
  const char * kShadowErrorMessage = "" ;
  performInsert (attributes, inCompiler, kInsertErrorMessage, kShadowErrorMessage COMMA_THERE) ;
}
...
void GALGAS_terminusPrefixOperatorMap::setter_insertKey (GALGAS_lstring inKey,
                                                         GALGAS_omnibusType inArgument0,
                                                         GALGAS_omnibusType inArgument1,
                                                         GALGAS_terminusPrefixOperator inArgument2,
                                                         C_Compiler * inCompiler
                                                         COMMA_LOCATION_ARGS) {
  cMapElement_terminusPrefixOperatorMap * p = NULL ;
  macroMyNew (p, cMapElement_terminusPrefixOperatorMap (inKey, inArgument0, inArgument1, inArgument2 COMMA_HERE)) ;
...
const char * kSearchErrorMessage_terminusPrefixOperatorMap_searchKey = "there is no '%K' infix operator" ;

//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*

void GALGAS_terminusPrefixOperatorMap::method_searchKey (GALGAS_lstring inKey,
                                                         GALGAS_omnibusType & outArgument0,
                                                         GALGAS_omnibusType & outArgument1,
                                                         GALGAS_terminusPrefixOperator & outArgument2,
                                                         C_Compiler * inCompiler
                                                         COMMA_LOCATION_ARGS) const {
  const cMapElement_terminusPrefixOperatorMap * p = (const cMapElement_terminusPrefixOperatorMap *) performSearch (inKey,
                                                                                                                   inCompiler,
                                                                                                                   kSearchErrorMessage_terminusPrefixOperatorMap_searchKey
                                                                                                                   COMMA_THERE) ;
  if (NULL == p) {
    outArgument0.drop () ;
    outArgument1.drop () ;
    ...
    macroValidSharedObject (p, cMapElement_terminusPrefixOperatorMap) ;
...
GALGAS_omnibusType GALGAS_terminusPrefixOperatorMap::getter_mReceiverTypeForKey (const GALGAS_string & inKey,
                                                                                 C_Compiler * inCompiler
                                                                                 COMMA_LOCATION_ARGS) const {
  const cCollectionElement * attributes = searchForReadingAttribute (inKey, inCompiler COMMA_THERE) ;
  const cMapElement_terminusPrefixOperatorMap * p = (const cMapElement_terminusPrefixOperatorMap *) attributes ;
  GALGAS_omnibusType result ;
  if (NULL != p) {
    macroValidSharedObject (p, cMapElement_terminusPrefixOperatorMap) ;
...
GALGAS_omnibusType GALGAS_terminusPrefixOperatorMap::getter_mResultTypeForKey (const GALGAS_string & inKey,
                                                                               C_Compiler * inCompiler
                                                                               COMMA_LOCATION_ARGS) const {
  const cCollectionElement * attributes = searchForReadingAttribute (inKey, inCompiler COMMA_THERE) ;
  const cMapElement_terminusPrefixOperatorMap * p = (const cMapElement_terminusPrefixOperatorMap *) attributes ;
...
GALGAS_terminusPrefixOperator GALGAS_terminusPrefixOperatorMap::getter_mOperatorForKey (const GALGAS_string & inKey,
                                                                                        C_Compiler * inCompiler
                                                                                        COMMA_LOCATION_ARGS) const {
  const cCollectionElement * attributes = searchForReadingAttribute (inKey, inCompiler COMMA_THERE) ;
  const cMapElement_terminusPrefixOperatorMap * p = (const cMapElement_terminusPrefixOperatorMap *) attributes ;
...
void GALGAS_terminusPrefixOperatorMap::setter_setMReceiverTypeForKey (GALGAS_omnibusType inAttributeValue,
                                                                      GALGAS_string inKey,
                                                                      C_Compiler * inCompiler
                                                                      COMMA_LOCATION_ARGS) {
  cCollectionElement * attributes = searchForReadWriteAttribute (inKey, true, inCompiler COMMA_THERE) ;
  cMapElement_terminusPrefixOperatorMap * p = (cMapElement_terminusPrefixOperatorMap *) attributes ;
  if (NULL != p) {
    macroValidSharedObject (p, cMapElement_terminusPrefixOperatorMap) ;
...
void GALGAS_terminusPrefixOperatorMap::setter_setMResultTypeForKey (GALGAS_omnibusType inAttributeValue,
                                                                    GALGAS_string inKey,
                                                                    C_Compiler * inCompiler
                                                                    COMMA_LOCATION_ARGS) {
  cCollectionElement * attributes = searchForReadWriteAttribute (inKey, true, inCompiler COMMA_THERE) ;
...
void GALGAS_terminusPrefixOperatorMap::setter_setMOperatorForKey (GALGAS_terminusPrefixOperator inAttributeValue,
                                                                  GALGAS_string inKey,
                                                                  C_Compiler * inCompiler
                                                                  COMMA_LOCATION_ARGS) {
  cCollectionElement * attributes = searchForReadWriteAttribute (inKey, true, inCompiler COMMA_THERE) ;
...
cMapElement_terminusPrefixOperatorMap * GALGAS_terminusPrefixOperatorMap::readWriteAccessForWithInstruction (C_Compiler * inCompiler,
                                                                                                             const GALGAS_string & inKey
                                                                                                             COMMA_LOCATION_ARGS) {
  cMapElement_terminusPrefixOperatorMap * result = (cMapElement_terminusPrefixOperatorMap *) searchForReadWriteAttribute (inKey, false, inCompiler COMMA_THERE) ;
  macroNullOrValidSharedObject (result, cMapElement_terminusPrefixOperatorMap) ;
  return result ;
}

//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*

cEnumerator_terminusPrefixOperatorMap::cEnumerator_terminusPrefixOperatorMap (const GALGAS_terminusPrefixOperatorMap & inEnumeratedObject,
                                                                              const typeEnumerationOrder inOrder) :
cGenericAbstractEnumerator (inOrder) {
  inEnumeratedObject.populateEnumerationArray (mEnumerationArray) ;
}
...
GALGAS_terminusPrefixOperatorMap_2D_element cEnumerator_terminusPrefixOperatorMap::current (LOCATION_ARGS) const {
  const cMapElement_terminusPrefixOperatorMap * p = (const cMapElement_terminusPrefixOperatorMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, cMapElement_terminusPrefixOperatorMap) ;
  return GALGAS_terminusPrefixOperatorMap_2D_element (p->mProperty_lkey, p->mProperty_mReceiverType, p->mProperty_mResultType, p->mProperty_mOperator) ;
}

//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*

GALGAS_lstring cEnumerator_terminusPrefixOperatorMap::current_lkey (LOCATION_ARGS) const {
  const cMapElement * p = (const cMapElement *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, cMapElement) ;
  return p->mProperty_lkey ;
}
...
GALGAS_omnibusType cEnumerator_terminusPrefixOperatorMap::current_mReceiverType (LOCATION_ARGS) const {
  const cMapElement_terminusPrefixOperatorMap * p = (const cMapElement_terminusPrefixOperatorMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, cMapElement_terminusPrefixOperatorMap) ;
...
GALGAS_omnibusType cEnumerator_terminusPrefixOperatorMap::current_mResultType (LOCATION_ARGS) const {
  const cMapElement_terminusPrefixOperatorMap * p = (const cMapElement_terminusPrefixOperatorMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, cMapElement_terminusPrefixOperatorMap) ;
  return p->mProperty_mResultType ;
}
...
GALGAS_terminusPrefixOperator cEnumerator_terminusPrefixOperatorMap::current_mOperator (LOCATION_ARGS) const {
  const cMapElement_terminusPrefixOperatorMap * p = (const cMapElement_terminusPrefixOperatorMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, cMapElement_terminusPrefixOperatorMap) ;
  return p->mProperty_mOperator ;
}
...
//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*
//                                                                                                                     *
//                                           @terminusPrefixOperatorMap type                                           *
//                                                                                                                     *
//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*

const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_terminusPrefixOperatorMap ("terminusPrefixOperatorMap",
                                                  NULL) ;

//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*

const C_galgas_type_descriptor * GALGAS_terminusPrefixOperatorMap::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_terminusPrefixOperatorMap ;
}

//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*

AC_GALGAS_root * GALGAS_terminusPrefixOperatorMap::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_terminusPrefixOperatorMap (*this)) ;
  }
  return result ;
}
...
GALGAS_terminusPrefixOperatorMap GALGAS_terminusPrefixOperatorMap::extractObject (const GALGAS_object & inObject,
                                                                                  C_Compiler * inCompiler
                                                                                  COMMA_LOCATION_ARGS) {
  GALGAS_terminusPrefixOperatorMap result ;
  const GALGAS_terminusPrefixOperatorMap * p = (const GALGAS_terminusPrefixOperatorMap *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_terminusPrefixOperatorMap *> (p)) {
      result = *p ;
    }else{
      inCompiler->castError ("terminusPrefixOperatorMap", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
cMapElement * cMapElement_assignmentOperatorMap::copy (void) {
  cMapElement * result = NULL ;
  macroMyNew (result, cMapElement_assignmentOperatorMap (mProperty_lkey, mProperty_mTargetType, mProperty_mTargetVarName, mProperty_mTargetGenericFormalParameterList, mProperty_mSourceTpe, mProperty_mSourceVarName, mProperty_mSourceGenericFormalParameterList, mProperty_mWhereClause, mProperty_mInstructionList COMMA_HERE)) ;
  return result ;
}
...
void cMapElement_assignmentOperatorMap::description (C_String & ioString, const int32_t inIndentation) const {
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "mTargetType" ":" ;
  mProperty_mTargetType.description (ioString, inIndentation) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "mTargetVarName" ":" ;
  mProperty_mTargetVarName.description (ioString, inIndentation) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "mTargetGenericFormalParameterList" ":" ;
  mProperty_mTargetGenericFormalParameterList.description (ioString, inIndentation) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "mSourceTpe" ":" ;
  mProperty_mSourceTpe.description (ioString, inIndentation) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "mSourceVarName" ":" ;
  mProperty_mSourceVarName.description (ioString, inIndentation) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "mSourceGenericFormalParameterList" ":" ;
  mProperty_mSourceGenericFormalParameterList.description (ioString, inIndentation) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "mWhereClause" ":" ;
  mProperty_mWhereClause.description (ioString, inIndentation) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "mInstructionList" ":" ;
...
typeComparisonResult cMapElement_assignmentOperatorMap::compare (const cCollectionElement * inOperand) const {
  ...
  typeComparisonResult result = mProperty_lkey.objectCompare (operand->mProperty_lkey) ;
  if (kOperandEqual == result) {
    result = mProperty_mTargetType.objectCompare (operand->mProperty_mTargetType) ;
  }
  if (kOperandEqual == result) {
    result = mProperty_mTargetVarName.objectCompare (operand->mProperty_mTargetVarName) ;
  }
  if (kOperandEqual == result) {
    result = mProperty_mTargetGenericFormalParameterList.objectCompare (operand->mProperty_mTargetGenericFormalParameterList) ;
  }
  if (kOperandEqual == result) {
    result = mProperty_mSourceTpe.objectCompare (operand->mProperty_mSourceTpe) ;
  }
  if (kOperandEqual == result) {
    result = mProperty_mSourceVarName.objectCompare (operand->mProperty_mSourceVarName) ;
  }
  if (kOperandEqual == result) {
    result = mProperty_mSourceGenericFormalParameterList.objectCompare (operand->mProperty_mSourceGenericFormalParameterList) ;
  }
  if (kOperandEqual == result) {
    result = mProperty_mWhereClause.objectCompare (operand->mProperty_mWhereClause) ;
  }
  if (kOperandEqual == result) {
...
void GALGAS_assignmentOperatorMap::addAssign_operation (const GALGAS_lstring & inKey,
                                                        ...
                                                        const GALGAS_genericFormalParameterList & inArgument2,
                                                        const GALGAS_omnibusType & inArgument3,
                                                        const GALGAS_lstring & inArgument4,
                                                        const GALGAS_genericFormalParameterList & inArgument5,
                                                        const GALGAS_ctExpressionAST & inArgument6,
                                                        const GALGAS_llvmGenerationInstructionList & inArgument7,
                                                        C_Compiler * inCompiler
                                                        COMMA_LOCATION_ARGS) {
  cMapElement_assignmentOperatorMap * p = NULL ;
  macroMyNew (p, cMapElement_assignmentOperatorMap (inKey, inArgument0, inArgument1, inArgument2, inArgument3, inArgument4, inArgument5, inArgument6, inArgument7 COMMA_HERE)) ;
  capCollectionElement attributes ;
  attributes.setPointer (p) ;
  macroDetachSharedObject (p) ;
...
void GALGAS_assignmentOperatorMap::setter_insertKey (GALGAS_lstring inKey,
                                                     ...
                                                     GALGAS_genericFormalParameterList inArgument2,
                                                     GALGAS_omnibusType inArgument3,
                                                     GALGAS_lstring inArgument4,
                                                     GALGAS_genericFormalParameterList inArgument5,
                                                     GALGAS_ctExpressionAST inArgument6,
                                                     GALGAS_llvmGenerationInstructionList inArgument7,
                                                     C_Compiler * inCompiler
                                                     COMMA_LOCATION_ARGS) {
  cMapElement_assignmentOperatorMap * p = NULL ;
  macroMyNew (p, cMapElement_assignmentOperatorMap (inKey, inArgument0, inArgument1, inArgument2, inArgument3, inArgument4, inArgument5, inArgument6, inArgument7 COMMA_HERE)) ;
...
void GALGAS_assignmentOperatorMap::method_searchKey (GALGAS_lstring inKey,
                                                     ...
                                                     GALGAS_omnibusType & outArgument3,
                                                     GALGAS_lstring & outArgument4,
                                                     GALGAS_genericFormalParameterList & outArgument5,
                                                     GALGAS_ctExpressionAST & outArgument6,
                                                     GALGAS_llvmGenerationInstructionList & outArgument7,
                                                     C_Compiler * inCompiler
                                                     COMMA_LOCATION_ARGS) const {
  ...
  if (NULL == p) {
    ...
    outArgument0 = p->mProperty_mTargetType ;
    outArgument1 = p->mProperty_mTargetVarName ;
    outArgument2 = p->mProperty_mTargetGenericFormalParameterList ;
    outArgument3 = p->mProperty_mSourceTpe ;
    outArgument4 = p->mProperty_mSourceVarName ;
    outArgument5 = p->mProperty_mSourceGenericFormalParameterList ;
    outArgument6 = p->mProperty_mWhereClause ;
    outArgument7 = p->mProperty_mInstructionList ;
  }
}

//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*

GALGAS_omnibusType GALGAS_assignmentOperatorMap::getter_mTargetTypeForKey (const GALGAS_string & inKey,
                                                                           C_Compiler * inCompiler
                                                                           COMMA_LOCATION_ARGS) const {
  const cCollectionElement * attributes = searchForReadingAttribute (inKey, inCompiler COMMA_THERE) ;
...
GALGAS_lstring GALGAS_assignmentOperatorMap::getter_mTargetVarNameForKey (const GALGAS_string & inKey,
                                                                          C_Compiler * inCompiler
                                                                          COMMA_LOCATION_ARGS) const {
  const cCollectionElement * attributes = searchForReadingAttribute (inKey, inCompiler COMMA_THERE) ;
  const cMapElement_assignmentOperatorMap * p = (const cMapElement_assignmentOperatorMap *) attributes ;
...
GALGAS_genericFormalParameterList GALGAS_assignmentOperatorMap::getter_mTargetGenericFormalParameterListForKey (const GALGAS_string & inKey,
                                                                                                                C_Compiler * inCompiler
                                                                                                                COMMA_LOCATION_ARGS) const {
  const cCollectionElement * attributes = searchForReadingAttribute (inKey, inCompiler COMMA_THERE) ;
  const cMapElement_assignmentOperatorMap * p = (const cMapElement_assignmentOperatorMap *) attributes ;
...
GALGAS_omnibusType GALGAS_assignmentOperatorMap::getter_mSourceTpeForKey (const GALGAS_string & inKey,
                                                                          C_Compiler * inCompiler
                                                                          COMMA_LOCATION_ARGS) const {
  const cCollectionElement * attributes = searchForReadingAttribute (inKey, inCompiler COMMA_THERE) ;
  const cMapElement_assignmentOperatorMap * p = (const cMapElement_assignmentOperatorMap *) attributes ;
...
GALGAS_lstring GALGAS_assignmentOperatorMap::getter_mSourceVarNameForKey (const GALGAS_string & inKey,
                                                                          C_Compiler * inCompiler
                                                                          COMMA_LOCATION_ARGS) const {
  const cCollectionElement * attributes = searchForReadingAttribute (inKey, inCompiler COMMA_THERE) ;
  const cMapElement_assignmentOperatorMap * p = (const cMapElement_assignmentOperatorMap *) attributes ;
...
GALGAS_genericFormalParameterList GALGAS_assignmentOperatorMap::getter_mSourceGenericFormalParameterListForKey (const GALGAS_string & inKey,
                                                                                                                C_Compiler * inCompiler
                                                                                                                COMMA_LOCATION_ARGS) const {
  const cCollectionElement * attributes = searchForReadingAttribute (inKey, inCompiler COMMA_THERE) ;
  const cMapElement_assignmentOperatorMap * p = (const cMapElement_assignmentOperatorMap *) attributes ;
...
GALGAS_ctExpressionAST GALGAS_assignmentOperatorMap::getter_mWhereClauseForKey (const GALGAS_string & inKey,
                                                                                C_Compiler * inCompiler
                                                                                COMMA_LOCATION_ARGS) const {
  const cCollectionElement * attributes = searchForReadingAttribute (inKey, inCompiler COMMA_THERE) ;
  const cMapElement_assignmentOperatorMap * p = (const cMapElement_assignmentOperatorMap *) attributes ;
...
GALGAS_llvmGenerationInstructionList GALGAS_assignmentOperatorMap::getter_mInstructionListForKey (const GALGAS_string & inKey,
                                                                                                  C_Compiler * inCompiler
                                                                                                  COMMA_LOCATION_ARGS) const {
  const cCollectionElement * attributes = searchForReadingAttribute (inKey, inCompiler COMMA_THERE) ;
  const cMapElement_assignmentOperatorMap * p = (const cMapElement_assignmentOperatorMap *) attributes ;
...
void GALGAS_assignmentOperatorMap::setter_setMTargetTypeForKey (GALGAS_omnibusType inAttributeValue,
                                                                GALGAS_string inKey,
                                                                C_Compiler * inCompiler
                                                                COMMA_LOCATION_ARGS) {
  cCollectionElement * attributes = searchForReadWriteAttribute (inKey, true, inCompiler COMMA_THERE) ;
  ...
  if (NULL != p) {
    macroValidSharedObject (p, cMapElement_assignmentOperatorMap) ;
    p->mProperty_mTargetType = inAttributeValue ;
  }
}

//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*

void GALGAS_assignmentOperatorMap::setter_setMTargetVarNameForKey (GALGAS_lstring inAttributeValue,
                                                                   GALGAS_string inKey,
                                                                   C_Compiler * inCompiler
                                                                   COMMA_LOCATION_ARGS) {
  cCollectionElement * attributes = searchForReadWriteAttribute (inKey, true, inCompiler COMMA_THERE) ;
  ...
  if (NULL != p) {
    macroValidSharedObject (p, cMapElement_assignmentOperatorMap) ;
    p->mProperty_mTargetVarName = inAttributeValue ;
  }
}

//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*

void GALGAS_assignmentOperatorMap::setter_setMTargetGenericFormalParameterListForKey (GALGAS_genericFormalParameterList inAttributeValue,
                                                                                      GALGAS_string inKey,
                                                                                      C_Compiler * inCompiler
                                                                                      COMMA_LOCATION_ARGS) {
  cCollectionElement * attributes = searchForReadWriteAttribute (inKey, true, inCompiler COMMA_THERE) ;
  ...
  if (NULL != p) {
    macroValidSharedObject (p, cMapElement_assignmentOperatorMap) ;
    p->mProperty_mTargetGenericFormalParameterList = inAttributeValue ;
  }
}

//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*

void GALGAS_assignmentOperatorMap::setter_setMSourceTpeForKey (GALGAS_omnibusType inAttributeValue,
                                                               GALGAS_string inKey,
                                                               C_Compiler * inCompiler
                                                               COMMA_LOCATION_ARGS) {
  cCollectionElement * attributes = searchForReadWriteAttribute (inKey, true, inCompiler COMMA_THERE) ;
  ...
  if (NULL != p) {
    macroValidSharedObject (p, cMapElement_assignmentOperatorMap) ;
    p->mProperty_mSourceTpe = inAttributeValue ;
  }
}

//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*

void GALGAS_assignmentOperatorMap::setter_setMSourceVarNameForKey (GALGAS_lstring inAttributeValue,
                                                                   GALGAS_string inKey,
                                                                   C_Compiler * inCompiler
                                                                   COMMA_LOCATION_ARGS) {
  cCollectionElement * attributes = searchForReadWriteAttribute (inKey, true, inCompiler COMMA_THERE) ;
  ...
  if (NULL != p) {
    macroValidSharedObject (p, cMapElement_assignmentOperatorMap) ;
    p->mProperty_mSourceVarName = inAttributeValue ;
  }
}

//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*

void GALGAS_assignmentOperatorMap::setter_setMSourceGenericFormalParameterListForKey (GALGAS_genericFormalParameterList inAttributeValue,
                                                                                      GALGAS_string inKey,
                                                                                      C_Compiler * inCompiler
                                                                                      COMMA_LOCATION_ARGS) {
  cCollectionElement * attributes = searchForReadWriteAttribute (inKey, true, inCompiler COMMA_THERE) ;
  ...
  if (NULL != p) {
    macroValidSharedObject (p, cMapElement_assignmentOperatorMap) ;
    p->mProperty_mSourceGenericFormalParameterList = inAttributeValue ;
  }
}

//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*

void GALGAS_assignmentOperatorMap::setter_setMWhereClauseForKey (GALGAS_ctExpressionAST inAttributeValue,
                                                                 GALGAS_string inKey,
                                                                 C_Compiler * inCompiler
                                                                 COMMA_LOCATION_ARGS) {
  cCollectionElement * attributes = searchForReadWriteAttribute (inKey, true, inCompiler COMMA_THERE) ;
  ...
  if (NULL != p) {
    macroValidSharedObject (p, cMapElement_assignmentOperatorMap) ;
    p->mProperty_mWhereClause = inAttributeValue ;
  }
}

//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*

void GALGAS_assignmentOperatorMap::setter_setMInstructionListForKey (GALGAS_llvmGenerationInstructionList inAttributeValue,
                                                                     GALGAS_string inKey,
                                                                     C_Compiler * inCompiler
                                                                     COMMA_LOCATION_ARGS) {
  cCollectionElement * attributes = searchForReadWriteAttribute (inKey, true, inCompiler COMMA_THERE) ;
...
GALGAS_assignmentOperatorMap_2D_element cEnumerator_assignmentOperatorMap::current (LOCATION_ARGS) const {
  ...
  macroValidSharedObject (p, cMapElement_assignmentOperatorMap) ;
  return GALGAS_assignmentOperatorMap_2D_element (p->mProperty_lkey, p->mProperty_mTargetType, p->mProperty_mTargetVarName, p->mProperty_mTargetGenericFormalParameterList, p->mProperty_mSourceTpe, p->mProperty_mSourceVarName, p->mProperty_mSourceGenericFormalParameterList, p->mProperty_mWhereClause, p->mProperty_mInstructionList) ;
}
...
GALGAS_omnibusType cEnumerator_assignmentOperatorMap::current_mTargetType (LOCATION_ARGS) const {
  const cMapElement_assignmentOperatorMap * p = (const cMapElement_assignmentOperatorMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, cMapElement_assignmentOperatorMap) ;
...
GALGAS_lstring cEnumerator_assignmentOperatorMap::current_mTargetVarName (LOCATION_ARGS) const {
  const cMapElement_assignmentOperatorMap * p = (const cMapElement_assignmentOperatorMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, cMapElement_assignmentOperatorMap) ;
...
GALGAS_genericFormalParameterList cEnumerator_assignmentOperatorMap::current_mTargetGenericFormalParameterList (LOCATION_ARGS) const {
  const cMapElement_assignmentOperatorMap * p = (const cMapElement_assignmentOperatorMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, cMapElement_assignmentOperatorMap) ;
...
GALGAS_omnibusType cEnumerator_assignmentOperatorMap::current_mSourceTpe (LOCATION_ARGS) const {
  const cMapElement_assignmentOperatorMap * p = (const cMapElement_assignmentOperatorMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, cMapElement_assignmentOperatorMap) ;
...
GALGAS_lstring cEnumerator_assignmentOperatorMap::current_mSourceVarName (LOCATION_ARGS) const {
  const cMapElement_assignmentOperatorMap * p = (const cMapElement_assignmentOperatorMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, cMapElement_assignmentOperatorMap) ;
...
GALGAS_genericFormalParameterList cEnumerator_assignmentOperatorMap::current_mSourceGenericFormalParameterList (LOCATION_ARGS) const {
  const cMapElement_assignmentOperatorMap * p = (const cMapElement_assignmentOperatorMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, cMapElement_assignmentOperatorMap) ;
...
GALGAS_ctExpressionAST cEnumerator_assignmentOperatorMap::current_mWhereClause (LOCATION_ARGS) const {
  const cMapElement_assignmentOperatorMap * p = (const cMapElement_assignmentOperatorMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, cMapElement_assignmentOperatorMap) ;
...
GALGAS_llvmGenerationInstructionList cEnumerator_assignmentOperatorMap::current_mInstructionList (LOCATION_ARGS) const {
  const cMapElement_assignmentOperatorMap * p = (const cMapElement_assignmentOperatorMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, cMapElement_assignmentOperatorMap) ;
...
GALGAS_typeKind GALGAS_typeKind::constructor_llvmType (UNUSED_LOCATION_ARGS) {
  GALGAS_typeKind result ;
