...
void extensionMethod_noteTypesInPrecedenceGraph (const GALGAS_functionDeclarationListAST inObject,
  ...
  while (enumerator_6286.hasCurrentObject ()) {
    ...
    while (enumerator_6359.hasCurrentObject ()) {
      GALGAS_lstring var_typeName_6381 = function_llvmTypeNameFromPLMname (enumerator_6359.current_mFormalArgumentTypeName (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-func.galgas", 202)) ;
      {
      ioArgument_ioGraph.setter_noteNode (var_typeName_6381 COMMA_SOURCE_FILE ("declaration-func.galgas", 203)) ;
      }
      enumerator_6359.gotoNextObject () ;
    }
    extensionMethod_noteInstructionListTypesInPrecedenceGraph (enumerator_6286.current_mFunctionInstructionList (HERE), ioArgument_ioGraph, inCompiler COMMA_SOURCE_FILE ("declaration-func.galgas", 205)) ;
    ...
    if (kBoolTrue == test_1) {
      GALGAS_lstring var_typeName_6629 = function_llvmTypeNameFromPLMname (enumerator_6286.current_mFunctionReturnTypeName (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-func.galgas", 207)) ;
      {
      ioArgument_ioGraph.setter_noteNode (var_typeName_6629 COMMA_SOURCE_FILE ("declaration-func.galgas", 208)) ;
      }
    }
...
void extensionMethod_enterFunctionInContext (const GALGAS_functionDeclarationListAST inObject,
                                             ...
                                             COMMA_UNUSED_LOCATION_ARGS) {
  const GALGAS_functionDeclarationListAST temp_0 = inObject ;
  cEnumerator_functionDeclarationListAST enumerator_7324 (temp_0, kENUMERATION_UP) ;
  while (enumerator_7324.hasCurrentObject ()) {
    GALGAS_routineTypedSignature var_signature_7440 ;
    {
    routine_routineSignature (ioArgument_ioContext.mProperty_mTypeMap, enumerator_7324.current (HERE).getter_mFunctionFormalArgumentList (HERE), var_signature_7440, inCompiler  COMMA_SOURCE_FILE ("declaration-func.galgas", 224)) ;
    }
    GALGAS_unifiedTypeMap_2D_proxy var_returnTypeProxy_7581 ;
    {
    GALGAS_unifiedTypeMap_2D_proxy::class_method_makeOptionalProxy (ioArgument_ioContext.mProperty_mTypeMap, enumerator_7324.current (HERE).getter_mFunctionReturnTypeName (HERE), var_returnTypeProxy_7581 COMMA_SOURCE_FILE ("declaration-func.galgas", 226)) ;
    }
    GALGAS_bool var_warnIfUnused_7621 = GALGAS_bool (true) ;
    GALGAS_bool var_globalFunction_7651 = GALGAS_bool (false) ;
    GALGAS_bool var_canMutateProperties_7687 = GALGAS_bool (false) ;
    GALGAS_bool var_isSafe_7710 = GALGAS_bool (false) ;
    cEnumerator_lstringlist enumerator_7773 (enumerator_7324.current (HERE).getter_mFunctionAttributeList (HERE), kENUMERATION_UP) ;
    while (enumerator_7773.hasCurrentObject ()) {
      const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_7773.current_mValue (HERE).getter_string (HERE).objectCompare (function_noUnusedWarningAttribute (inCompiler COMMA_SOURCE_FILE ("declaration-func.galgas", 233)))).boolEnum () ;
      if (kBoolTrue == test_1) {
        const enumGalgasBool test_2 = var_warnIfUnused_7621.operator_not (SOURCE_FILE ("declaration-func.galgas", 234)).boolEnum () ;
        if (kBoolTrue == test_2) {
          TC_Array <C_FixItDescription> fixItArray3 ;
          inCompiler->emitSemanticError (enumerator_7773.current_mValue (HERE).getter_location (SOURCE_FILE ("declaration-func.galgas", 235)), GALGAS_string ("duplicated @").add_operation (function_noUnusedWarningAttribute (inCompiler COMMA_SOURCE_FILE ("declaration-func.galgas", 235)), inCompiler COMMA_SOURCE_FILE ("declaration-func.galgas", 235)).add_operation (GALGAS_string (" attribute"), inCompiler COMMA_SOURCE_FILE ("declaration-func.galgas", 235)), fixItArray3  COMMA_SOURCE_FILE ("declaration-func.galgas", 235)) ;
        }
        var_warnIfUnused_7621 = GALGAS_bool (false) ;
      }else if (kBoolFalse == test_1) {
        const enumGalgasBool test_4 = GALGAS_bool (kIsEqual, enumerator_7773.current_mValue (HERE).getter_string (HERE).objectCompare (function_exportedAttribute (inCompiler COMMA_SOURCE_FILE ("declaration-func.galgas", 238)))).boolEnum () ;
        if (kBoolTrue == test_4) {
          const enumGalgasBool test_5 = var_globalFunction_7651.boolEnum () ;
          if (kBoolTrue == test_5) {
          ...
          var_globalFunction_7651 = GALGAS_bool (true) ;
        }else if (kBoolFalse == test_4) {
          const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, enumerator_7773.current_mValue (HERE).getter_string (HERE).objectCompare (function_mutatingAttribute (inCompiler COMMA_SOURCE_FILE ("declaration-func.galgas", 243)))).boolEnum () ;
          if (kBoolTrue == test_7) {
            const enumGalgasBool test_8 = var_canMutateProperties_7687.boolEnum () ;
            if (kBoolTrue == test_8) {
            ...
            var_canMutateProperties_7687 = GALGAS_bool (true) ;
          }else if (kBoolFalse == test_7) {
            const enumGalgasBool test_10 = GALGAS_bool (kIsEqual, enumerator_7773.current_mValue (HERE).getter_string (HERE).objectCompare (function_safeAttribute (inCompiler COMMA_SOURCE_FILE ("declaration-func.galgas", 248)))).boolEnum () ;
            if (kBoolTrue == test_10) {
              const enumGalgasBool test_11 = var_isSafe_7710.boolEnum () ;
              if (kBoolTrue == test_11) {
                TC_Array <C_FixItDescription> fixItArray12 ;
                fixItArray12.appendObject (C_FixItDescription (kFixItRemove, "")) ;
                inCompiler->emitSemanticError (enumerator_7773.current_mValue (HERE).getter_location (SOURCE_FILE ("declaration-func.galgas", 250)), GALGAS_string ("duplicated attribute"), fixItArray12  COMMA_SOURCE_FILE ("declaration-func.galgas", 250)) ;
              }else if (kBoolFalse == test_11) {
                var_isSafe_7710 = GALGAS_bool (true) ;
              }
    ...
    GALGAS_bool var_canAccessProperties_8898 = GALGAS_bool (kIsNotEqual, enumerator_7324.current (HERE).getter_mMode (HERE).objectCompare (GALGAS_mode::constructor_userMode (SOURCE_FILE ("declaration-func.galgas", 259)))) ;
    GALGAS_lstring var_routineMangledName_8983 = function_routineMangledNameFromAST (constinArgument_inSelfTypeName, enumerator_7324.current (HERE).getter_mFunctionName (HERE), enumerator_7324.current (HERE).getter_mFunctionFormalArgumentList (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-func.galgas", 261)) ;
    {
    extensionSetter_insertRoutine (ioArgument_ioContext.mProperty_mRoutineMapForContext, constinArgument_inSelfTypeName, enumerator_7324.current (HERE).getter_mFunctionName (HERE), extensionGetter_routineSignature (enumerator_7324.current (HERE).getter_mFunctionFormalArgumentList (HERE), enumerator_7324.current (HERE).getter_mFunctionName (HERE).getter_location (SOURCE_FILE ("declaration-func.galgas", 270)), inCompiler COMMA_SOURCE_FILE ("declaration-func.galgas", 270)), var_routineMangledName_8983, GALGAS_routineDescriptor::constructor_new (enumerator_7324.current (HERE).getter_mPublicFunction (HERE), var_globalFunction_7651, enumerator_7324.current (HERE).getter_mFunctionName (HERE).getter_string (SOURCE_FILE ("declaration-func.galgas", 275)), GALGAS_routineKind::constructor_function (enumerator_7324.current (HERE).getter_mMode (HERE)  COMMA_SOURCE_FILE ("declaration-func.galgas", 276)), var_signature_7440, var_returnTypeProxy_7581, var_canAccessProperties_8898, var_canMutateProperties_7687, var_isSafe_7710  COMMA_SOURCE_FILE ("declaration-func.galgas", 272)), inCompiler COMMA_SOURCE_FILE ("declaration-func.galgas", 267)) ;
    }
    ioArgument_ioDecoratedDeclarationList.addAssign_operation (GALGAS_decoratedFunction::constructor_new (constinArgument_inSelfTypeName, enumerator_7324.current (HERE).getter_mMode (HERE), enumerator_7324.current (HERE).getter_mPublicFunction (HERE), enumerator_7324.current (HERE).getter_mFunctionName (HERE), enumerator_7324.current (HERE).getter_mFunctionFormalArgumentList (HERE), enumerator_7324.current (HERE).getter_mFunctionReturnTypeName (HERE), enumerator_7324.current (HERE).getter_mFunctionInstructionList (HERE), enumerator_7324.current (HERE).getter_mEndOfFunctionDeclaration (HERE), var_warnIfUnused_7621, var_globalFunction_7651, var_isSafe_7710  COMMA_SOURCE_FILE ("declaration-func.galgas", 285))  COMMA_SOURCE_FILE ("declaration-func.galgas", 285)) ;
...
void extensionMethod_enterFunctionsInPropertyMap (const GALGAS_functionDeclarationListAST inObject,
                                                  ...
                                                  COMMA_UNUSED_LOCATION_ARGS) {
  const GALGAS_functionDeclarationListAST temp_0 = inObject ;
  cEnumerator_functionDeclarationListAST enumerator_10517 (temp_0, kENUMERATION_UP) ;
  while (enumerator_10517.hasCurrentObject ()) {
    GALGAS_stringset var_attributeSet_10566 = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("declaration-func.galgas", 310)) ;
    cEnumerator_lstringlist enumerator_10624 (enumerator_10517.current (HERE).getter_mFunctionAttributeList (HERE), kENUMERATION_UP) ;
    while (enumerator_10624.hasCurrentObject ()) {
      var_attributeSet_10566.addAssign_operation (enumerator_10624.current (HERE).getter_mValue (HERE).getter_string (HERE)  COMMA_SOURCE_FILE ("declaration-func.galgas", 312)) ;
      enumerator_10624.gotoNextObject () ;
    }
    GALGAS_bool var_exportedFunction_10707 = var_attributeSet_10566.getter_hasKey (function_exportedAttribute (inCompiler COMMA_SOURCE_FILE ("declaration-func.galgas", 314)) COMMA_SOURCE_FILE ("declaration-func.galgas", 314)) ;
    GALGAS_bool var_canMutateProperties_10781 = var_attributeSet_10566.getter_hasKey (function_mutatingAttribute (inCompiler COMMA_SOURCE_FILE ("declaration-func.galgas", 315)) COMMA_SOURCE_FILE ("declaration-func.galgas", 315)) ;
    GALGAS_bool var_safe_10840 = var_attributeSet_10566.getter_hasKey (function_safeAttribute (inCompiler COMMA_SOURCE_FILE ("declaration-func.galgas", 316)) COMMA_SOURCE_FILE ("declaration-func.galgas", 316)) ;
    GALGAS_bool var_canAccessProperties_10910 = GALGAS_bool (kIsNotEqual, enumerator_10517.current (HERE).getter_mMode (HERE).objectCompare (GALGAS_mode::constructor_userMode (SOURCE_FILE ("declaration-func.galgas", 317)))) ;
    GALGAS_routineTypedSignature var_signature_11053 ;
    {
    routine_routineSignature (ioArgument_ioContext.mProperty_mTypeMap, enumerator_10517.current (HERE).getter_mFunctionFormalArgumentList (HERE), var_signature_11053, inCompiler  COMMA_SOURCE_FILE ("declaration-func.galgas", 319)) ;
    }
    GALGAS_unifiedTypeMap_2D_proxy var_returnTypeProxy_11194 ;
    {
    GALGAS_unifiedTypeMap_2D_proxy::class_method_makeOptionalProxy (ioArgument_ioContext.mProperty_mTypeMap, enumerator_10517.current (HERE).getter_mFunctionReturnTypeName (HERE), var_returnTypeProxy_11194 COMMA_SOURCE_FILE ("declaration-func.galgas", 321)) ;
    }
    GALGAS_lstring var_routineMangledName_11250 = function_routineMangledNameFromAST (GALGAS_string::makeEmptyString (), enumerator_10517.current (HERE).getter_mFunctionName (HERE), enumerator_10517.current (HERE).getter_mFunctionFormalArgumentList (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-func.galgas", 323)) ;
    GALGAS_routineDescriptor var_descriptor_11415 = GALGAS_routineDescriptor::constructor_new (enumerator_10517.current (HERE).getter_mPublicFunction (HERE), var_exportedFunction_10707, enumerator_10517.current (HERE).getter_mFunctionName (HERE).getter_string (SOURCE_FILE ("declaration-func.galgas", 332)), GALGAS_routineKind::constructor_function (enumerator_10517.current (HERE).getter_mMode (HERE)  COMMA_SOURCE_FILE ("declaration-func.galgas", 333)), var_signature_11053, var_returnTypeProxy_11194, var_canAccessProperties_10910, var_canMutateProperties_10781, var_safe_10840  COMMA_SOURCE_FILE ("declaration-func.galgas", 329)) ;
    {
    ioArgument_ioPropertyMap.setter_insertKey (var_routineMangledName_11250, enumerator_10517.current (HERE).getter_mPublicFunction (HERE), GALGAS_propertyAccessKind::constructor_nonVirtualMethod (var_descriptor_11415  COMMA_SOURCE_FILE ("declaration-func.galgas", 341)), inCompiler COMMA_SOURCE_FILE ("declaration-func.galgas", 341)) ;
    }
...
void extensionMethod_interruptCodeGeneration (const GALGAS_interruptMapIR inObject,
                                              ...
                                              C_Compiler * inCompiler
                                              COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_stringset var_definedInterrupts_6462 = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("declaration-isr.galgas", 154)) ;
  const GALGAS_interruptMapIR temp_0 = inObject ;
  cEnumerator_interruptMapIR enumerator_6491 (temp_0, kENUMERATION_UP) ;
  while (enumerator_6491.hasCurrentObject ()) {
    var_definedInterrupts_6462.addAssign_operation (enumerator_6491.current (HERE).getter_lkey (HERE).getter_string (HERE)  COMMA_SOURCE_FILE ("declaration-isr.galgas", 156)) ;
    GALGAS_string temp_1 ;
    const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, enumerator_6491.current (HERE).getter_mMode (HERE).objectCompare (GALGAS_mode::constructor_serviceMode (SOURCE_FILE ("declaration-isr.galgas", 157)))).boolEnum () ;
    if (kBoolTrue == test_2) {
      temp_1 = function_llvmNameForServiceInterrupt (enumerator_6491.current (HERE).getter_lkey (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 158)).getter_string (HERE) ;
    }else if (kBoolFalse == test_2) {
      temp_1 = function_llvmNameForSectionInterrupt (enumerator_6491.current (HERE).getter_lkey (HERE).getter_string (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 160)) ;
    }
    GALGAS_string var_interruptImplementationName_6578 = temp_1 ;
    ioArgument_ioLLVMcode.plusAssign_operation(function_llvmTitleComment (var_interruptImplementationName_6578, inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 162)), inCompiler  COMMA_SOURCE_FILE ("declaration-isr.galgas", 162)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("define void @").add_operation (var_interruptImplementationName_6578, inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 163)).add_operation (GALGAS_string (" ()"), inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 163)).add_operation (function_llvmAttributeFunction (inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 163)), inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 163)).add_operation (GALGAS_string (" {\n"), inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 163)), inCompiler  COMMA_SOURCE_FILE ("declaration-isr.galgas", 163)) ;
    extensionMethod_generateAllocaList (enumerator_6491.current (HERE).getter_mAllocaList (HERE), ioArgument_ioLLVMcode, inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 165)) ;
    const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, enumerator_6491.current (HERE).getter_mSelfType (HERE).getter_kind (HERE).objectCompare (GALGAS_typeKind::constructor_void (SOURCE_FILE ("declaration-isr.galgas", 167)))).boolEnum () ;
    if (kBoolTrue == test_3) {
      GALGAS_string var_varName_7086 = function_llvmNameForGlobalVariable (enumerator_6491.current (HERE).getter_mGlobalVariableName (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 168)) ;
      GALGAS_string var_typeName_7166 = extensionGetter_llvmTypeName (enumerator_6491.current (HERE).getter_mSelfType (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 169)) ;
      ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  ").add_operation (function_llvmNameForSelf (inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 170)), inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 170)).add_operation (GALGAS_string (" = getelementptr inbounds "), inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 170)).add_operation (var_typeName_7166, inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 170)).add_operation (GALGAS_string (", "), inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 170)).add_operation (var_typeName_7166, inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 170)).add_operation (GALGAS_string ("* "), inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 170)).add_operation (var_varName_7086, inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 170)), inCompiler  COMMA_SOURCE_FILE ("declaration-isr.galgas", 170)) ;
      ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string (", i32 0 ; Perform self = ").add_operation (var_varName_7086, inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 171)).add_operation (GALGAS_string (" \n"), inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 171)), inCompiler  COMMA_SOURCE_FILE ("declaration-isr.galgas", 171)) ;
    }
    extensionMethod_instructionListLLVMCode (enumerator_6491.current (HERE).getter_mInstructionGenerationList (HERE), ioArgument_ioLLVMcode, constinArgument_inGenerationContext, ioArgument_ioGenerationAdds, inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 174)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  ret void\n"), inCompiler  COMMA_SOURCE_FILE ("declaration-isr.galgas", 176)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("}\n"
      "\n"), inCompiler  COMMA_SOURCE_FILE ("declaration-isr.galgas", 177)) ;
    const enumGalgasBool test_4 = GALGAS_bool (kIsEqual, enumerator_6491.current (HERE).getter_mMode (HERE).objectCompare (GALGAS_mode::constructor_serviceMode (SOURCE_FILE ("declaration-isr.galgas", 179)))).boolEnum () ;
    if (kBoolTrue == test_4) {
      GALGAS_string var_interruptHandlerName_7735 = function_llvmNameForServiceInterrupt (enumerator_6491.current (HERE).getter_lkey (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 180)).getter_string (HERE) ;
      GALGAS_string var_isrName_7807 = function_llvmNameForSectionInterrupt (enumerator_6491.current (HERE).getter_lkey (HERE).getter_string (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 181)) ;
      GALGAS_string var_s_31__7874 = constinArgument_inXTRInterruptHandlerString.getter_stringByReplacingStringByString (GALGAS_string ("!ISR!"), var_isrName_7807, inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 182)) ;
      GALGAS_string var_s_32__7968 = var_s_31__7874.getter_stringByReplacingStringByString (GALGAS_string ("!HANDLER!"), var_interruptHandlerName_7735, inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 183)) ;
      ioArgument_ioAScode.plusAssign_operation(var_s_32__7968, inCompiler  COMMA_SOURCE_FILE ("declaration-isr.galgas", 184)) ;
    }
    enumerator_6491.gotoNextObject () ;
  }
  cEnumerator_availableInterruptMap enumerator_8197 (constinArgument_inGenerationContext.getter_mAvailableInterruptMap (HERE), kENUMERATION_UP) ;
  while (enumerator_8197.hasCurrentObject ()) {
    const enumGalgasBool test_5 = var_definedInterrupts_6462.getter_hasKey (enumerator_8197.current_lkey (HERE).getter_string (HERE) COMMA_SOURCE_FILE ("declaration-isr.galgas", 189)).operator_not (SOURCE_FILE ("declaration-isr.galgas", 189)).boolEnum () ;
    if (kBoolTrue == test_5) {
      ...
      case GALGAS_interruptionPanicCode::kEnum_noCode:
        {
          GALGAS_string var_s_8313 = constinArgument_inUndefinedInterruptString.getter_stringByReplacingStringByString (GALGAS_string ("!ISR!"), function_llvmNameForSectionInterrupt (enumerator_8197.current_lkey (HERE).getter_string (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 192)), inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 192)) ;
          ioArgument_ioAScode.plusAssign_operation(var_s_8313, inCompiler  COMMA_SOURCE_FILE ("declaration-isr.galgas", 193)) ;
        }
        break ;
      case GALGAS_interruptionPanicCode::kEnum_code:
        {
          const cEnumAssociatedValues_interruptionPanicCode_code * extractPtr_9181 = (const cEnumAssociatedValues_interruptionPanicCode_code *) (enumerator_8197.current_mInterruptionPanicCode (HERE).unsafePointer ()) ;
          const GALGAS_lbigint extractedValue_value = extractPtr_9181->mAssociatedValue0 ;
          const enumGalgasBool test_6 = GALGAS_bool (gOption_plm_5F_options_noPanicGeneration.getter_value ()).boolEnum () ;
          if (kBoolTrue == test_6) {
            GALGAS_string var_s_8563 = constinArgument_inUndefinedInterruptString.getter_stringByReplacingStringByString (GALGAS_string ("!ISR!"), function_llvmNameForSectionInterrupt (enumerator_8197.current_lkey (HERE).getter_string (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 196)), inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 196)) ;
            ioArgument_ioAScode.plusAssign_operation(var_s_8563, inCompiler  COMMA_SOURCE_FILE ("declaration-isr.galgas", 197)) ;
          }else if (kBoolFalse == test_6) {
            GALGAS_string var_name_8735 = function_llvmNameForSectionInterrupt (enumerator_8197.current_lkey (HERE).getter_string (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 199)) ;
            ioArgument_ioLLVMcode.plusAssign_operation(function_llvmTitleComment (GALGAS_string ("Panic code for ").add_operation (var_name_8735, inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 200)), inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 200)), inCompiler  COMMA_SOURCE_FILE ("declaration-isr.galgas", 200)) ;
            ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("define void @").add_operation (var_name_8735, inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 201)).add_operation (GALGAS_string (" ()"), inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 201)).add_operation (function_llvmAttributeFunction (inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 201)), inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 201)).add_operation (GALGAS_string (" noreturn {\n"), inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 201)), inCompiler  COMMA_SOURCE_FILE ("declaration-isr.galgas", 201)) ;
            ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  call void @panic.isr (").add_operation (extensionGetter_llvmTypeName (constinArgument_inGenerationContext.getter_mPanicCodeLLVMType (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 202)), inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 202)).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 202)).add_operation (extractedValue_value.getter_bigint (HERE).getter_string (SOURCE_FILE ("declaration-isr.galgas", 202)), inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 202)).add_operation (GALGAS_string (") noreturn \n"), inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 202)), inCompiler  COMMA_SOURCE_FILE ("declaration-isr.galgas", 202)) ;
            ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  unreachable\n"), inCompiler  COMMA_SOURCE_FILE ("declaration-isr.galgas", 203)) ;
            ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("}\n"
              "\n"), inCompiler  COMMA_SOURCE_FILE ("declaration-isr.galgas", 204)) ;
          }
        }
        break ;
      }
...
void extensionMethod_guardCodeGeneration (const GALGAS_guardMapIR inObject,
  ...
  cEnumerator_guardMapIR enumerator_19327 (temp_0, kENUMERATION_UP) ;
  while (enumerator_19327.hasCurrentObject ()) {
    switch (enumerator_19327.current (HERE).getter_mGuardKindGenerationIR (HERE).enumValue ()) {
    ...
    case GALGAS_guardKindGenerationIR::kEnum_baseGuard:
      {
        GALGAS_string var_guardImplementationName_19463 = function_llvmNameForGuardImplementation (enumerator_19327.current (HERE).getter_lkey (HERE).getter_string (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 482)) ;
        GALGAS_string var_guardCallName_19541 = function_llvmNameForGuardCall (enumerator_19327.current (HERE).getter_lkey (HERE).getter_string (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 483)) ;
        ioArgument_ioSectionList.addAssign_operation (var_guardCallName_19541, var_guardImplementationName_19463, GALGAS_bool (true)  COMMA_SOURCE_FILE ("declaration-guard.galgas", 484)) ;
      }
      break ;
    }
    extensionMethod_llvmCodeGeneration (enumerator_19327.current (HERE), ioArgument_ioLLVMcode, constinArgument_inGenerationContext, ioArgument_ioGenerationAdds, inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 489)) ;
    enumerator_19327.gotoNextObject () ;
  }
}
...
void extensionMethod_analyzeBranchInstructionList (const GALGAS_instructionListAST inObject,
                                                   ...
                                                   COMMA_UNUSED_LOCATION_ARGS) {
  {
  extensionSetter_openBranch (ioArgument_ioUniversalMap, inCompiler COMMA_SOURCE_FILE ("instructionList.galgas", 102)) ;
  }
  const GALGAS_instructionListAST temp_0 = inObject ;
  cEnumerator_instructionListAST enumerator_4549 (temp_0, kENUMERATION_UP) ;
  while (enumerator_4549.hasCurrentObject ()) {
    {
    extensionSetter_appendSourceLineComment (ioArgument_ioInstructionGenerationList, enumerator_4549.current_mInstruction (HERE).getter_mInstructionLocation (SOURCE_FILE ("instructionList.galgas", 104)), inCompiler COMMA_SOURCE_FILE ("instructionList.galgas", 104)) ;
    }
    callExtensionMethod_instructionSemanticAnalysis ((const cPtr_instructionAST *) enumerator_4549.current_mInstruction (HERE).ptr (), constinArgument_inSelfType, constinArgument_inRoutineAttributes, constinArgument_inCallerNameForInvocationGraph, constinArgument_inContext, constinArgument_inCurrentMode, ioArgument_ioTemporaries, ioArgument_ioStaticEntityMap, ioArgument_ioUniversalMap, ioArgument_ioAllocaList, ioArgument_ioInstructionGenerationList, inCompiler COMMA_SOURCE_FILE ("instructionList.galgas", 105)) ;
    enumerator_4549.gotoNextObject () ;
  }
  {
  extensionSetter_closeBranch (ioArgument_ioUniversalMap, inArgument_inEndOfInstructionList, inCompiler COMMA_SOURCE_FILE ("instructionList.galgas", 119)) ;
  }
}
...
void extensionMethod_analyzeRoutineInstructionList (const GALGAS_instructionListAST inObject,
                                                    ...
                                                    COMMA_UNUSED_LOCATION_ARGS) {
  const GALGAS_instructionListAST temp_0 = inObject ;
  cEnumerator_instructionListAST enumerator_5875 (temp_0, kENUMERATION_UP) ;
  while (enumerator_5875.hasCurrentObject ()) {
    {
    extensionSetter_appendSourceLineComment (ioArgument_ioInstructionGenerationList, enumerator_5875.current_mInstruction (HERE).getter_mInstructionLocation (SOURCE_FILE ("instructionList.galgas", 137)), inCompiler COMMA_SOURCE_FILE ("instructionList.galgas", 137)) ;
    }
    callExtensionMethod_instructionSemanticAnalysis ((const cPtr_instructionAST *) enumerator_5875.current_mInstruction (HERE).ptr (), constinArgument_inSelfType, constinArgument_inRoutineAttributes, constinArgument_inCallerNameForInvocationGraph, constinArgument_inContext, constinArgument_inCurrentMode, ioArgument_ioTemporaries, ioArgument_ioStaticEntityMap, ioArgument_ioUniversalMap, ioArgument_ioAllocaList, ioArgument_ioInstructionGenerationList, inCompiler COMMA_SOURCE_FILE ("instructionList.galgas", 138)) ;
...
void extensionMethod_instructionListLLVMCode (const GALGAS_instructionListIR inObject,
  ...
  cEnumerator_instructionListIR enumerator_6955 (temp_0, kENUMERATION_UP) ;
  while (enumerator_6955.hasCurrentObject ()) {
    callExtensionMethod_llvmInstructionCode ((const cPtr_abstractInstructionIR *) enumerator_6955.current_mInstructionGeneration (HERE).ptr (), ioArgument_ioLLVMcode, constinArgument_inGenerationContext, ioArgument_ioGenerationAdds, inCompiler COMMA_SOURCE_FILE ("instructionList.galgas", 163)) ;
