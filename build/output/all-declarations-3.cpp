...
void extensionMethod_guardSemanticAnalysis (const GALGAS_guardDeclarationListAST inObject,
                                            ...
                                            COMMA_UNUSED_LOCATION_ARGS) {
  const GALGAS_guardDeclarationListAST temp_0 = inObject ;
  cEnumerator_guardDeclarationListAST enumerator_7061 (temp_0, kENUMERATION_UP) ;
  while (enumerator_7061.hasCurrentObject ()) {
    GALGAS_bool var_warnIfUnused_7085 = GALGAS_bool (true) ;
    cEnumerator_lstringlist enumerator_7141 (enumerator_7061.current (HERE).getter_mGuardAttributeList (HERE), kENUMERATION_UP) ;
    while (enumerator_7141.hasCurrentObject ()) {
      const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_7141.current_mValue (HERE).getter_string (HERE).objectCompare (function_noUnusedWarningAttribute (inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 182)))).boolEnum () ;
      if (kBoolTrue == test_1) {
        const enumGalgasBool test_2 = var_warnIfUnused_7085.operator_not (SOURCE_FILE ("declaration-guard.galgas", 183)).boolEnum () ;
        if (kBoolTrue == test_2) {
          TC_Array <C_FixItDescription> fixItArray3 ;
          inCompiler->emitSemanticError (enumerator_7141.current_mValue (HERE).getter_location (SOURCE_FILE ("declaration-guard.galgas", 184)), GALGAS_string ("duplicate @").add_operation (function_noUnusedWarningAttribute (inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 184)), inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 184)).add_operation (GALGAS_string (" attribute"), inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 184)), fixItArray3  COMMA_SOURCE_FILE ("declaration-guard.galgas", 184)) ;
        }
        var_warnIfUnused_7085 = GALGAS_bool (false) ;
      }else if (kBoolFalse == test_1) {
        TC_Array <C_FixItDescription> fixItArray4 ;
        inCompiler->emitSemanticError (enumerator_7141.current_mValue (HERE).getter_location (SOURCE_FILE ("declaration-guard.galgas", 188)), GALGAS_string ("unknown attribute; available attribute is @").add_operation (function_noUnusedWarningAttribute (inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 188)), inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 188)), fixItArray4  COMMA_SOURCE_FILE ("declaration-guard.galgas", 188)) ;
      }
      enumerator_7141.gotoNextObject () ;
    }
    {
    routine_guardSemanticAnalysis (inArgument_inReceiverType, enumerator_7061.current (HERE).getter_mGuardName (HERE), enumerator_7061.current (HERE).getter_mGuardFormalArgumentList (HERE), enumerator_7061.current (HERE).getter_mGuardKind (HERE), enumerator_7061.current (HERE).getter_mGuardInstructionList (HERE), enumerator_7061.current (HERE).getter_mEndOfGuardDeclaration (HERE), var_warnIfUnused_7085, constinArgument_inSemanticContext, ioArgument_ioTemporaries, ioArgument_ioIntermediateCodeStruct, inCompiler  COMMA_SOURCE_FILE ("declaration-guard.galgas", 191)) ;
    }
...
//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*
//                                                                                                                     *
//                                       Class for element of '@guardMapIR' list                                       *
//                                                                                                                     *
//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*

class cCollectionElement_guardMapIR : public cCollectionElement {
  public : GALGAS_guardMapIR_2D_element mObject ;

//--- Constructors
  public : cCollectionElement_guardMapIR (const GALGAS_lstring & in_lkey,
                                          ...
                                          COMMA_LOCATION_ARGS) ;
  public : cCollectionElement_guardMapIR (const GALGAS_guardMapIR_2D_element & inElement COMMA_LOCATION_ARGS) ;
...
cCollectionElement_guardMapIR::cCollectionElement_guardMapIR (const GALGAS_lstring & in_lkey,
                                                              const GALGAS_routineFormalArgumentListIR & in_mFormalArgumentListForGeneration,
                                                              const GALGAS_PLMType & in_mReceiverType,
                                                              const GALGAS_guardKindGenerationIR & in_mGuardKindGenerationIR,
                                                              const GALGAS_allocaList & in_mAllocaList,
                                                              ...
                                                              COMMA_LOCATION_ARGS) :
cCollectionElement (THERE),
mObject (in_lkey, in_mFormalArgumentListForGeneration, in_mReceiverType, in_mGuardKindGenerationIR, in_mAllocaList, in_mInstructionGenerationList, in_mWarnIfUnused, in_mGuardImplementationMangledName) {
}

//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*

cCollectionElement_guardMapIR::cCollectionElement_guardMapIR (const GALGAS_guardMapIR_2D_element & inElement COMMA_LOCATION_ARGS) :
cCollectionElement (THERE),
mObject (inElement.mProperty_lkey, inElement.mProperty_mFormalArgumentListForGeneration, inElement.mProperty_mReceiverType, inElement.mProperty_mGuardKindGenerationIR, inElement.mProperty_mAllocaList, inElement.mProperty_mInstructionGenerationList, inElement.mProperty_mWarnIfUnused, inElement.mProperty_mGuardImplementationMangledName) {
}

//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*

bool cCollectionElement_guardMapIR::isValid (void) const {
  return mObject.isValid () ;
}

//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*

cCollectionElement * cCollectionElement_guardMapIR::copy (void) {
  cCollectionElement * result = NULL ;
  macroMyNew (result, cCollectionElement_guardMapIR (mObject.mProperty_lkey, mObject.mProperty_mFormalArgumentListForGeneration, mObject.mProperty_mReceiverType, mObject.mProperty_mGuardKindGenerationIR, mObject.mProperty_mAllocaList, mObject.mProperty_mInstructionGenerationList, mObject.mProperty_mWarnIfUnused, mObject.mProperty_mGuardImplementationMangledName COMMA_HERE)) ;
  return result ;
}

//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*

void cCollectionElement_guardMapIR::description (C_String & ioString, const int32_t inIndentation) const {
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "lkey" ":" ;
  mObject.mProperty_lkey.description (ioString, inIndentation) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ...
  mObject.mProperty_mGuardKindGenerationIR.description (ioString, inIndentation) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ...
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "mGuardImplementationMangledName" ":" ;
  mObject.mProperty_mGuardImplementationMangledName.description (ioString, inIndentation) ;
}

//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*

typeComparisonResult cCollectionElement_guardMapIR::compare (const cCollectionElement * inOperand) const {
  cCollectionElement_guardMapIR * operand = (cCollectionElement_guardMapIR *) inOperand ;
  macroValidSharedObject (operand, cCollectionElement_guardMapIR) ;
  return mObject.objectCompare (operand->mObject) ;
}
...
GALGAS_guardMapIR::GALGAS_guardMapIR (const capCollectionElementArray & inSharedArray) :
AC_GALGAS_list (inSharedArray) {
}

//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*

GALGAS_guardMapIR GALGAS_guardMapIR::constructor_emptyList (UNUSED_LOCATION_ARGS) {
  return GALGAS_guardMapIR  (capCollectionElementArray ()) ;
}

//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*

GALGAS_guardMapIR GALGAS_guardMapIR::constructor_listWithValue (const GALGAS_lstring & inOperand0,
  ...
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid () && inOperand5.isValid () && inOperand6.isValid () && inOperand7.isValid ()) {
    result = GALGAS_guardMapIR (capCollectionElementArray ()) ;
    capCollectionElement attributes ;
    GALGAS_guardMapIR::makeAttributesFromObjects (attributes, inOperand0, inOperand1, inOperand2, inOperand3, inOperand4, inOperand5, inOperand6, inOperand7 COMMA_THERE) ;
    result.appendObject (attributes) ;
  }
  return result ;
}
...
void GALGAS_guardMapIR::makeAttributesFromObjects (capCollectionElement & outAttributes,
                                                   const GALGAS_lstring & in_lkey,
                                                   const GALGAS_routineFormalArgumentListIR & in_mFormalArgumentListForGeneration,
                                                   const GALGAS_PLMType & in_mReceiverType,
                                                   const GALGAS_guardKindGenerationIR & in_mGuardKindGenerationIR,
                                                   const GALGAS_allocaList & in_mAllocaList,
                                                   ...
                                                   const GALGAS_string & in_mGuardImplementationMangledName
                                                   COMMA_LOCATION_ARGS) {
  cCollectionElement_guardMapIR * p = NULL ;
  macroMyNew (p, cCollectionElement_guardMapIR (in_lkey,
                                                in_mFormalArgumentListForGeneration,
                                                in_mReceiverType,
                                                in_mGuardKindGenerationIR,
                                                in_mAllocaList,
                                                in_mInstructionGenerationList,
                                                in_mWarnIfUnused,
                                                in_mGuardImplementationMangledName COMMA_THERE)) ;
  outAttributes.setPointer (p) ;
  macroDetachSharedObject (p) ;
}
...
void GALGAS_guardMapIR::addAssign_operation (const GALGAS_lstring & inOperand0,
                                             const GALGAS_routineFormalArgumentListIR & inOperand1,
                                             const GALGAS_PLMType & inOperand2,
                                             const GALGAS_guardKindGenerationIR & inOperand3,
                                             const GALGAS_allocaList & inOperand4,
  ...
  if (isValid () && inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid () && inOperand5.isValid () && inOperand6.isValid () && inOperand7.isValid ()) {
    cCollectionElement * p = NULL ;
    macroMyNew (p, cCollectionElement_guardMapIR (inOperand0, inOperand1, inOperand2, inOperand3, inOperand4, inOperand5, inOperand6, inOperand7 COMMA_THERE)) ;
    capCollectionElement attributes ;
    attributes.setPointer (p) ;
    macroDetachSharedObject (p) ;
    appendObject (attributes) ;
...
void GALGAS_guardMapIR::setter_append (GALGAS_guardMapIR_2D_element inElement,
                                       C_Compiler * /* inCompiler */
                                       COMMA_LOCATION_ARGS) {
  if (isValid () && inElement.isValid ()) {
    cCollectionElement * p = NULL ;
    macroMyNew (p, cCollectionElement_guardMapIR (inElement COMMA_THERE)) ;
    capCollectionElement attributes ;
    attributes.setPointer (p) ;
    macroDetachSharedObject (p) ;
    appendObject (attributes) ;
...
void GALGAS_guardMapIR::setter_insertAtIndex (const GALGAS_lstring inOperand0,
                                              const GALGAS_routineFormalArgumentListIR inOperand1,
                                              const GALGAS_PLMType inOperand2,
                                              const GALGAS_guardKindGenerationIR inOperand3,
                                              const GALGAS_allocaList inOperand4,
...
void GALGAS_guardMapIR::setter_removeAtIndex (GALGAS_lstring & outOperand0,
                                              GALGAS_routineFormalArgumentListIR & outOperand1,
                                              GALGAS_PLMType & outOperand2,
                                              GALGAS_guardKindGenerationIR & outOperand3,
  ...
  if (isValid () && inRemoveIndex.isValid ()) {
    capCollectionElement attributes ;
    removeObjectAtIndex (attributes, inRemoveIndex.uintValue (), inCompiler COMMA_THERE) ;
    cCollectionElement_guardMapIR * p = (cCollectionElement_guardMapIR *) attributes.ptr () ;
    if (NULL == p) {
      outOperand0.drop () ;
      outOperand1.drop () ;
      outOperand2.drop () ;
      ...
      macroValidSharedObject (p, cCollectionElement_guardMapIR) ;
      outOperand0 = p->mObject.mProperty_lkey ;
      outOperand1 = p->mObject.mProperty_mFormalArgumentListForGeneration ;
      outOperand2 = p->mObject.mProperty_mReceiverType ;
      outOperand3 = p->mObject.mProperty_mGuardKindGenerationIR ;
      outOperand4 = p->mObject.mProperty_mAllocaList ;
      outOperand5 = p->mObject.mProperty_mInstructionGenerationList ;
      outOperand6 = p->mObject.mProperty_mWarnIfUnused ;
      outOperand7 = p->mObject.mProperty_mGuardImplementationMangledName ;
    }
  }
}
...
void GALGAS_guardMapIR::setter_popFirst (GALGAS_lstring & outOperand0,
                                         GALGAS_routineFormalArgumentListIR & outOperand1,
                                         GALGAS_PLMType & outOperand2,
                                         GALGAS_guardKindGenerationIR & outOperand3,
                                         GALGAS_allocaList & outOperand4,
...
void GALGAS_guardMapIR::setter_popLast (GALGAS_lstring & outOperand0,
                                        GALGAS_routineFormalArgumentListIR & outOperand1,
                                        GALGAS_PLMType & outOperand2,
                                        GALGAS_guardKindGenerationIR & outOperand3,
                                        GALGAS_allocaList & outOperand4,
...
void GALGAS_guardMapIR::method_first (GALGAS_lstring & outOperand0,
                                      GALGAS_routineFormalArgumentListIR & outOperand1,
                                      GALGAS_PLMType & outOperand2,
                                      GALGAS_guardKindGenerationIR & outOperand3,
                                      GALGAS_allocaList & outOperand4,
...
void GALGAS_guardMapIR::method_last (GALGAS_lstring & outOperand0,
                                     GALGAS_routineFormalArgumentListIR & outOperand1,
                                     GALGAS_PLMType & outOperand2,
                                     GALGAS_guardKindGenerationIR & outOperand3,
                                     GALGAS_allocaList & outOperand4,
...
GALGAS_guardMapIR GALGAS_guardMapIR::add_operation (const GALGAS_guardMapIR & inOperand,
                                                    C_Compiler * /* inCompiler */
                                                    COMMA_UNUSED_LOCATION_ARGS) const {
  GALGAS_guardMapIR result ;
  if (isValid () && inOperand.isValid ()) {
...
GALGAS_guardMapIR GALGAS_guardMapIR::getter_subListWithRange (const GALGAS_range & inRange,
                                                              C_Compiler * inCompiler
                                                              COMMA_LOCATION_ARGS) const {
  GALGAS_guardMapIR result = GALGAS_guardMapIR::constructor_emptyList (THERE) ;
  subListWithRange (result, inRange, inCompiler COMMA_THERE) ;
  return result ;
}
...
GALGAS_guardMapIR GALGAS_guardMapIR::getter_subListFromIndex (const GALGAS_uint & inIndex,
                                                              C_Compiler * inCompiler
                                                              COMMA_LOCATION_ARGS) const {
  GALGAS_guardMapIR result = GALGAS_guardMapIR::constructor_emptyList (THERE) ;
  subListFromIndex (result, inIndex, inCompiler COMMA_THERE) ;
...
GALGAS_guardMapIR GALGAS_guardMapIR::getter_subListToIndex (const GALGAS_uint & inIndex,
                                                            C_Compiler * inCompiler
                                                            COMMA_LOCATION_ARGS) const {
  GALGAS_guardMapIR result = GALGAS_guardMapIR::constructor_emptyList (THERE) ;
  subListToIndex (result, inIndex, inCompiler COMMA_THERE) ;
...
void GALGAS_guardMapIR::plusAssign_operation (const GALGAS_guardMapIR inOperand,
                                              C_Compiler * /* inCompiler */
                                              COMMA_UNUSED_LOCATION_ARGS) {
  appendList (inOperand) ;
}
...
GALGAS_lstring GALGAS_guardMapIR::getter_lkeyAtIndex (const GALGAS_uint & inIndex,
                                                      C_Compiler * inCompiler
                                                      COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_guardMapIR * p = (cCollectionElement_guardMapIR *) attributes.ptr () ;
  ...
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_guardMapIR) ;
    result = p->mObject.mProperty_lkey ;
  }
  return result ;
}
...
GALGAS_routineFormalArgumentListIR GALGAS_guardMapIR::getter_mFormalArgumentListForGenerationAtIndex (const GALGAS_uint & inIndex,
                                                                                                      C_Compiler * inCompiler
                                                                                                      COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_guardMapIR * p = (cCollectionElement_guardMapIR *) attributes.ptr () ;
...
GALGAS_PLMType GALGAS_guardMapIR::getter_mReceiverTypeAtIndex (const GALGAS_uint & inIndex,
                                                               C_Compiler * inCompiler
                                                               COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_guardMapIR * p = (cCollectionElement_guardMapIR *) attributes.ptr () ;
...
GALGAS_guardKindGenerationIR GALGAS_guardMapIR::getter_mGuardKindGenerationIRAtIndex (const GALGAS_uint & inIndex,
                                                                                      C_Compiler * inCompiler
                                                                                      COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_guardMapIR * p = (cCollectionElement_guardMapIR *) attributes.ptr () ;
  ...
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_guardMapIR) ;
    result = p->mObject.mProperty_mGuardKindGenerationIR ;
  }
  return result ;
}
...
GALGAS_allocaList GALGAS_guardMapIR::getter_mAllocaListAtIndex (const GALGAS_uint & inIndex,
                                                                C_Compiler * inCompiler
                                                                COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_guardMapIR * p = (cCollectionElement_guardMapIR *) attributes.ptr () ;
...
GALGAS_instructionListIR GALGAS_guardMapIR::getter_mInstructionGenerationListAtIndex (const GALGAS_uint & inIndex,
                                                                                      C_Compiler * inCompiler
                                                                                      COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_guardMapIR * p = (cCollectionElement_guardMapIR *) attributes.ptr () ;
...
GALGAS_bool GALGAS_guardMapIR::getter_mWarnIfUnusedAtIndex (const GALGAS_uint & inIndex,
                                                            C_Compiler * inCompiler
                                                            COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_guardMapIR * p = (cCollectionElement_guardMapIR *) attributes.ptr () ;
...
GALGAS_string GALGAS_guardMapIR::getter_mGuardImplementationMangledNameAtIndex (const GALGAS_uint & inIndex,
                                                                                C_Compiler * inCompiler
                                                                                COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_guardMapIR * p = (cCollectionElement_guardMapIR *) attributes.ptr () ;
  ...
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_guardMapIR) ;
    result = p->mObject.mProperty_mGuardImplementationMangledName ;
  }
  return result ;
}
...
GALGAS_guardMapIR_2D_element cEnumerator_guardMapIR::current (LOCATION_ARGS) const {
  const cCollectionElement_guardMapIR * p = (const cCollectionElement_guardMapIR *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, cCollectionElement_guardMapIR) ;
  return p->mObject ;
}
...
GALGAS_lstring cEnumerator_guardMapIR::current_lkey (LOCATION_ARGS) const {
  const cCollectionElement_guardMapIR * p = (const cCollectionElement_guardMapIR *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, cCollectionElement_guardMapIR) ;
  return p->mObject.mProperty_lkey ;
}
...
GALGAS_guardKindGenerationIR cEnumerator_guardMapIR::current_mGuardKindGenerationIR (LOCATION_ARGS) const {
  const cCollectionElement_guardMapIR * p = (const cCollectionElement_guardMapIR *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, cCollectionElement_guardMapIR) ;
  return p->mObject.mProperty_mGuardKindGenerationIR ;
}
...
GALGAS_string cEnumerator_guardMapIR::current_mGuardImplementationMangledName (LOCATION_ARGS) const {
  const cCollectionElement_guardMapIR * p = (const cCollectionElement_guardMapIR *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, cCollectionElement_guardMapIR) ;
  return p->mObject.mProperty_mGuardImplementationMangledName ;
}
...
GALGAS_lstring GALGAS_decoratedRegularRoutineList::getter_mReceiverTypeNameAtIndex (const GALGAS_uint & inIndex,
                                                                                    C_Compiler * inCompiler
                                                                                    COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_decoratedRegularRoutineList * p = (cCollectionElement_decoratedRegularRoutineList *) attributes.ptr () ;
...
GALGAS_mode GALGAS_decoratedRegularRoutineList::getter_mModeAtIndex (const GALGAS_uint & inIndex,
                                                                     C_Compiler * inCompiler
                                                                     COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_decoratedRegularRoutineList * p = (cCollectionElement_decoratedRegularRoutineList *) attributes.ptr () ;
...
GALGAS_bool GALGAS_decoratedRegularRoutineList::getter_mWarnIfUnusedAtIndex (const GALGAS_uint & inIndex,
                                                                             C_Compiler * inCompiler
                                                                             COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_decoratedRegularRoutineList * p = (cCollectionElement_decoratedRegularRoutineList *) attributes.ptr () ;
...
GALGAS_bool GALGAS_decoratedRegularRoutineList::getter_mExportedRoutineAtIndex (const GALGAS_uint & inIndex,
                                                                                C_Compiler * inCompiler
                                                                                COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_decoratedRegularRoutineList * p = (cCollectionElement_decoratedRegularRoutineList *) attributes.ptr () ;
...
GALGAS_lstring GALGAS_decoratedRegularRoutineList::getter_mReturnTypeNameAtIndex (const GALGAS_uint & inIndex,
                                                                                  C_Compiler * inCompiler
                                                                                  COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_decoratedRegularRoutineList * p = (cCollectionElement_decoratedRegularRoutineList *) attributes.ptr () ;
...
GALGAS_lstring cEnumerator_decoratedRegularRoutineList::current_mReceiverTypeName (LOCATION_ARGS) const {
  const cCollectionElement_decoratedRegularRoutineList * p = (const cCollectionElement_decoratedRegularRoutineList *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, cCollectionElement_decoratedRegularRoutineList) ;
...
GALGAS_mode cEnumerator_decoratedRegularRoutineList::current_mMode (LOCATION_ARGS) const {
  const cCollectionElement_decoratedRegularRoutineList * p = (const cCollectionElement_decoratedRegularRoutineList *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, cCollectionElement_decoratedRegularRoutineList) ;
  return p->mObject.mProperty_mMode ;
}
...
GALGAS_bool cEnumerator_decoratedRegularRoutineList::current_mWarnIfUnused (LOCATION_ARGS) const {
  const cCollectionElement_decoratedRegularRoutineList * p = (const cCollectionElement_decoratedRegularRoutineList *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, cCollectionElement_decoratedRegularRoutineList) ;
  return p->mObject.mProperty_mWarnIfUnused ;
}
...
GALGAS_bool cEnumerator_decoratedRegularRoutineList::current_mExportedRoutine (LOCATION_ARGS) const {
  const cCollectionElement_decoratedRegularRoutineList * p = (const cCollectionElement_decoratedRegularRoutineList *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, cCollectionElement_decoratedRegularRoutineList) ;
...
GALGAS_lstring cEnumerator_decoratedRegularRoutineList::current_mReturnTypeName (LOCATION_ARGS) const {
  const cCollectionElement_decoratedRegularRoutineList * p = (const cCollectionElement_decoratedRegularRoutineList *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, cCollectionElement_decoratedRegularRoutineList) ;
...
void extensionSetter_addFunctionWithoutArgument (GALGAS_propertyMap & ioObject,
                                                 ...
                                                 C_Compiler * inCompiler
                                                 COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_lstring var_routineMangledName_1398 = function_routineMangledNameFromAST (constinArgument_inLLVMBaseTypeName, constinArgument_inMethodName.getter_nowhere (SOURCE_FILE ("property-map.galgas", 33)), GALGAS_routineFormalArgumentListAST::constructor_emptyList (SOURCE_FILE ("property-map.galgas", 34)), inCompiler COMMA_SOURCE_FILE ("property-map.galgas", 31)) ;
  GALGAS_routineDescriptor var_descriptor_1528 = GALGAS_routineDescriptor::constructor_new (GALGAS_bool (true), GALGAS_bool (false), constinArgument_inLLVMBaseTypeName.add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("property-map.galgas", 39)).add_operation (constinArgument_inMethodName, inCompiler COMMA_SOURCE_FILE ("property-map.galgas", 39)), var_routineMangledName_1398.getter_string (SOURCE_FILE ("property-map.galgas", 40)), GALGAS_routineKind::constructor_function (GALGAS_mode::constructor_anyMode (SOURCE_FILE ("property-map.galgas", 41))  COMMA_SOURCE_FILE ("property-map.galgas", 41)), GALGAS_routineTypedSignature::constructor_emptyList (SOURCE_FILE ("property-map.galgas", 42)), constinArgument_inResultType, GALGAS_bool (false), constinArgument_inCanMutateProperties, constinArgument_inIsSafe  COMMA_SOURCE_FILE ("property-map.galgas", 36)) ;
  {
  ioObject.setter_insertKey (var_routineMangledName_1398, GALGAS_bool (true), GALGAS_propertyAccessKind::constructor_nonVirtualMethod (var_descriptor_1528  COMMA_SOURCE_FILE ("property-map.galgas", 51)), inCompiler COMMA_SOURCE_FILE ("property-map.galgas", 48)) ;
  }
}
...
void extensionSetter_addFunctionWithInputArgument (GALGAS_propertyMap & ioObject,
                                                   ...
                                                   C_Compiler * inCompiler
                                                   COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_routineFormalArgumentListAST temp_0 = GALGAS_routineFormalArgumentListAST::constructor_emptyList (SOURCE_FILE ("property-map.galgas", 78)) ;
  temp_0.addAssign_operation (GALGAS_procFormalArgumentPassingMode::constructor_input (SOURCE_FILE ("property-map.galgas", 75)), constinArgument_inInputSelector.getter_nowhere (SOURCE_FILE ("property-map.galgas", 76)), constinArgument_inInputArgumentTypeProxy.getter_key (inCompiler COMMA_SOURCE_FILE ("property-map.galgas", 77)).getter_nowhere (SOURCE_FILE ("property-map.galgas", 77)), constinArgument_inInputArgumentName.getter_nowhere (SOURCE_FILE ("property-map.galgas", 78))  COMMA_SOURCE_FILE ("property-map.galgas", 78)) ;
  GALGAS_routineFormalArgumentListAST var_argumentList_2969 = temp_0 ;
  GALGAS_routineTypedSignature var_signature_3201 ;
  {
  routine_routineSignature (ioArgument_ioContext.mProperty_mTypeMap, var_argumentList_2969, var_signature_3201, inCompiler  COMMA_SOURCE_FILE ("property-map.galgas", 80)) ;
  }
  GALGAS_lstring var_routineMangledName_3227 = function_routineMangledNameFromAST (constinArgument_inLLVMBaseTypeName, GALGAS_lstring::constructor_new (constinArgument_inMethodName, GALGAS_location::constructor_nowhere (SOURCE_FILE ("property-map.galgas", 83))  COMMA_SOURCE_FILE ("property-map.galgas", 83)), var_argumentList_2969, inCompiler COMMA_SOURCE_FILE ("property-map.galgas", 81)) ;
  GALGAS_routineDescriptor var_descriptor_3375 = GALGAS_routineDescriptor::constructor_new (GALGAS_bool (true), GALGAS_bool (false), constinArgument_inMethodName, var_routineMangledName_3227.getter_string (SOURCE_FILE ("property-map.galgas", 90)), GALGAS_routineKind::constructor_function (GALGAS_mode::constructor_anyMode (SOURCE_FILE ("property-map.galgas", 91))  COMMA_SOURCE_FILE ("property-map.galgas", 91)), var_signature_3201, constinArgument_inResultType, GALGAS_bool (false), constinArgument_inCanMutateProperties, constinArgument_inIsSafe  COMMA_SOURCE_FILE ("property-map.galgas", 86)) ;
  {
  ioObject.setter_insertKey (var_routineMangledName_3227, GALGAS_bool (true), GALGAS_propertyAccessKind::constructor_nonVirtualMethod (var_descriptor_3375  COMMA_SOURCE_FILE ("property-map.galgas", 101)), inCompiler COMMA_SOURCE_FILE ("property-map.galgas", 98)) ;
  }
}
...
void extensionSetter_addFunctionWithTwoInputArguments (GALGAS_propertyMap & ioObject,
  ...
  temp_0.addAssign_operation (GALGAS_procFormalArgumentPassingMode::constructor_input (SOURCE_FILE ("property-map.galgas", 124)), constinArgument_inInputSelector_31_.getter_nowhere (SOURCE_FILE ("property-map.galgas", 125)), constinArgument_inInputArgumentTypeProxy_31_.getter_key (inCompiler COMMA_SOURCE_FILE ("property-map.galgas", 126)).getter_nowhere (SOURCE_FILE ("property-map.galgas", 126)), constinArgument_inInputArgumentName_31_.getter_nowhere (SOURCE_FILE ("property-map.galgas", 127))  COMMA_SOURCE_FILE ("property-map.galgas", 127)) ;
  temp_0.addAssign_operation (GALGAS_procFormalArgumentPassingMode::constructor_input (SOURCE_FILE ("property-map.galgas", 129)), constinArgument_inInputSelector_32_.getter_nowhere (SOURCE_FILE ("property-map.galgas", 130)), constinArgument_inInputArgumentTypeProxy_32_.getter_key (inCompiler COMMA_SOURCE_FILE ("property-map.galgas", 131)).getter_nowhere (SOURCE_FILE ("property-map.galgas", 131)), constinArgument_inInputArgumentName_32_.getter_nowhere (SOURCE_FILE ("property-map.galgas", 132))  COMMA_SOURCE_FILE ("property-map.galgas", 132)) ;
  GALGAS_routineFormalArgumentListAST var_argumentList_4840 = temp_0 ;
  GALGAS_lstring var_routineMangledName_5161 = function_routineMangledNameFromAST (constinArgument_inLLVMBaseTypeName, GALGAS_lstring::constructor_new (constinArgument_inMethodName, GALGAS_location::constructor_nowhere (SOURCE_FILE ("property-map.galgas", 136))  COMMA_SOURCE_FILE ("property-map.galgas", 136)), var_argumentList_4840, inCompiler COMMA_SOURCE_FILE ("property-map.galgas", 134)) ;
  GALGAS_routineTypedSignature var_signature_5343 ;
  {
  routine_routineSignature (ioArgument_ioContext.mProperty_mTypeMap, var_argumentList_4840, var_signature_5343, inCompiler  COMMA_SOURCE_FILE ("property-map.galgas", 139)) ;
  }
  GALGAS_routineDescriptor var_descriptor_5380 = GALGAS_routineDescriptor::constructor_new (GALGAS_bool (true), GALGAS_bool (false), constinArgument_inMethodName, var_routineMangledName_5161.getter_string (SOURCE_FILE ("property-map.galgas", 144)), GALGAS_routineKind::constructor_function (GALGAS_mode::constructor_anyMode (SOURCE_FILE ("property-map.galgas", 145))  COMMA_SOURCE_FILE ("property-map.galgas", 145)), var_signature_5343, constinArgument_inResultType, GALGAS_bool (false), constinArgument_inCanMutateProperties, constinArgument_inIsSafe  COMMA_SOURCE_FILE ("property-map.galgas", 140)) ;
  {
  ioObject.setter_insertKey (var_routineMangledName_5161, GALGAS_bool (true), GALGAS_propertyAccessKind::constructor_nonVirtualMethod (var_descriptor_5380  COMMA_SOURCE_FILE ("property-map.galgas", 155)), inCompiler COMMA_SOURCE_FILE ("property-map.galgas", 152)) ;
  }
}
