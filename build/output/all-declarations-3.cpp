...
static void categoryMethod_globalConstantDeclaration_semanticAnalysis (const cPtr_abstractDeclaration * inObject,
  ...
  macroValidSharedObject (object, cPtr_globalConstantDeclaration) ;
  GALGAS_abstractExpressionGeneration var_expressionGeneratedCode ;
  GALGAS_unifiedTypeMap_2D_proxy joker_6028 ; // Joker input parameter
  constinArgument_inContext.mAttribute_mGlobalConstantMap.method_searchKey (object->mAttribute_mConstantName, joker_6028, var_expressionGeneratedCode, inCompiler COMMA_SOURCE_FILE ("global-constant-declaration.galgas", 127)) ;
  ioArgument_ioOrderedGenerationList.addAssign_operation (GALGAS_globalConstantGeneration::constructor_new (object->mAttribute_mConstantName.mAttribute_string, var_expressionGeneratedCode  COMMA_SOURCE_FILE ("global-constant-declaration.galgas", 132))  COMMA_SOURCE_FILE ("global-constant-declaration.galgas", 132)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static GALGAS_string categoryReader_globalConstantGeneration_headerCodeGeneration (const cPtr_abstractGeneration * inObject,
  ...
  result_outCode = GALGAS_string (filewrapperTemplate_globalConstantGenerationTemplate_declaration (inCompiler, object->mAttribute_mGlobalConstanteName, callCategoryReader_expressionCode ((const cPtr_abstractExpressionGeneration *) object->mAttribute_mValueExpressionGeneration.ptr (), inCompiler COMMA_SOURCE_FILE ("global-constant-declaration.galgas", 161)) COMMA_SOURCE_FILE ("global-constant-declaration.galgas", 159))) ;
//---
  return result_outCode ;
}
...
static GALGAS_string categoryReader_functionGeneration_headerCodeGeneration (const cPtr_abstractGeneration * inObject,
  ...
  result_outCode = GALGAS_string (filewrapperTemplate_functionGenerationTemplate_declaration (inCompiler, object->mAttribute_mFunctionMangledName, object->mAttribute_mFormalArgumentListForGeneration, object->mAttribute_mResultType COMMA_SOURCE_FILE ("func-declaration.galgas", 236))) ;
//---
  return result_outCode ;
}
...
static GALGAS_string categoryReader_functionGeneration_implementationCodeGeneration (const cPtr_abstractGeneration * inObject,
  ...
  const cPtr_functionGeneration * object = (const cPtr_functionGeneration *) inObject ;
  macroValidSharedObject (object, cPtr_functionGeneration) ;
  result_outCode = GALGAS_string (filewrapperTemplate_functionGenerationTemplate_implementation (inCompiler, object->mAttribute_mFunctionMangledName, object->mAttribute_mFormalArgumentListForGeneration, object->mAttribute_mInstructionGenerationList, object->mAttribute_mResultType, object->mAttribute_mResultVarName COMMA_SOURCE_FILE ("func-declaration.galgas", 246))) ;
//---
  return result_outCode ;
}
...
static GALGAS_string categoryReader_procedureGeneration_headerCodeGeneration (const cPtr_abstractGeneration * inObject,
  ...
  result_outCode = GALGAS_string (filewrapperTemplate_procedureGenerationTemplate_declaration (inCompiler, object->mAttribute_mProcedureMangledName, object->mAttribute_mFormalArgumentListForGeneration COMMA_SOURCE_FILE ("proc-declaration.galgas", 380))) ;
//---
  return result_outCode ;
}
...
static GALGAS_string categoryReader_procedureGeneration_implementationCodeGeneration (const cPtr_abstractGeneration * inObject,
  ...
  const cPtr_procedureGeneration * object = (const cPtr_procedureGeneration *) inObject ;
  macroValidSharedObject (object, cPtr_procedureGeneration) ;
  result_outCode = GALGAS_string (filewrapperTemplate_procedureGenerationTemplate_implementation (inCompiler, object->mAttribute_mProcedureMangledName, object->mAttribute_mFormalArgumentListForGeneration, object->mAttribute_mInstructionGenerationList COMMA_SOURCE_FILE ("proc-declaration.galgas", 389))) ;
//---
  return result_outCode ;
}
...
static void categoryMethod_registerDeclaration_semanticAnalysis (const cPtr_abstractDeclaration * inObject,
  ...
  GALGAS_uint var_size ;
  GALGAS_bool var_isSigned ;
  GALGAS_string joker_5165 ; // Joker input parameter
  constinArgument_inContext.mAttribute_mTargetBaseTypeMap.method_searchKey (GALGAS_string ("size").reader_nowhere (SOURCE_FILE ("register-declaration.galgas", 118)), joker_5165, var_size, var_isSigned, inCompiler COMMA_SOURCE_FILE ("register-declaration.galgas", 118)) ;
  ...
  ioArgument_ioOrderedGenerationList.addAssign_operation (GALGAS_registerGeneration::constructor_new (object->mAttribute_mRegisterTypeName.mAttribute_string, object->mAttribute_mRegisterName.mAttribute_string, object->mAttribute_mRegisterAddress.mAttribute_uint_36__34_  COMMA_SOURCE_FILE ("register-declaration.galgas", 138))  COMMA_SOURCE_FILE ("register-declaration.galgas", 138)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static GALGAS_string categoryReader_registerGeneration_headerCodeGeneration (const cPtr_abstractGeneration * inObject,
  ...
  result_outCode = GALGAS_string (filewrapperTemplate_registerGenerationTemplate_declaration (inCompiler, object->mAttribute_mRegisterTypeName, object->mAttribute_mRegisterName, object->mAttribute_mRegisterAddress COMMA_SOURCE_FILE ("register-declaration.galgas", 169))) ;
//---
  return result_outCode ;
}
...
static void categoryMethod_varInstructionWithAssignmentAST_analyze (const cPtr_instructionAST * inObject,
  ...
  if (kBoolTrue == test_1) {
    temp_0 = GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("instruction-var.galgas", 114)) ;
  }else if (kBoolFalse == test_1) {
    temp_0 = GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inContext.mAttribute_mTypeMap, object->mAttribute_mOptionalTypeName, inCompiler  COMMA_SOURCE_FILE ("instruction-var.galgas", 115)) ;
  }
  GALGAS_unifiedTypeMap_2D_proxy var_targetType = temp_0 ;
  GALGAS_unifiedTypeMap_2D_proxy var_inferredType ;
  GALGAS_abstractExpressionGeneration var_expressionGeneratedCode ;
  callCategoryMethod_analyzeExpression ((const cPtr_expressionAST *) object->mAttribute_mSourceExpression.ptr (), constinArgument_inReceiverType, var_targetType, constinArgument_inContext, constinArgument_inMode, ioArgument_ioGlobalLiteralStringMap, ioArgument_ioVariableMap, var_inferredType, var_expressionGeneratedCode, inCompiler COMMA_SOURCE_FILE ("instruction-var.galgas", 118)) ;
  {
  GALGAS_stringset temp_2 = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("instruction-var.galgas", 132)) ;
  temp_2.addAssign_operation (constinArgument_inMode  COMMA_SOURCE_FILE ("instruction-var.galgas", 132)) ;
  ioArgument_ioVariableMap.modifier_insertDefinedLocalVariable (object->mAttribute_mVarName, var_inferredType, temp_2, function_mangledNameForVariable (object->mAttribute_mVarName.mAttribute_string, inCompiler COMMA_SOURCE_FILE ("instruction-var.galgas", 133)), var_inferredType.reader_copiable (inCompiler COMMA_SOURCE_FILE ("instruction-var.galgas", 134)), inCompiler COMMA_SOURCE_FILE ("instruction-var.galgas", 129)) ;
  }
  ioArgument_ioInstructionGenerationList.addAssign_operation (GALGAS_varInstructionWithAssignmentGeneration::constructor_new (var_inferredType, object->mAttribute_mVarName.mAttribute_string, var_expressionGeneratedCode  COMMA_SOURCE_FILE ("instruction-var.galgas", 137))  COMMA_SOURCE_FILE ("instruction-var.galgas", 137)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_varInstructionAST_analyze (const cPtr_instructionAST * inObject,
  ...
  GALGAS_unifiedTypeMap_2D_proxy var_targetType = GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inContext.mAttribute_mTypeMap, object->mAttribute_mTypeName, inCompiler  COMMA_SOURCE_FILE ("instruction-var.galgas", 154)) ;
  {
  GALGAS_stringset temp_0 = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("instruction-var.galgas", 159)) ;
  temp_0.addAssign_operation (constinArgument_inMode  COMMA_SOURCE_FILE ("instruction-var.galgas", 159)) ;
  ioArgument_ioVariableMap.modifier_insertUndefinedLocalVariable (object->mAttribute_mVarName, var_targetType, temp_0, function_mangledNameForVariable (object->mAttribute_mVarName.mAttribute_string, inCompiler COMMA_SOURCE_FILE ("instruction-var.galgas", 160)), var_targetType.reader_copiable (inCompiler COMMA_SOURCE_FILE ("instruction-var.galgas", 161)), inCompiler COMMA_SOURCE_FILE ("instruction-var.galgas", 156)) ;
  }
  ioArgument_ioInstructionGenerationList.addAssign_operation (GALGAS_varInstructionGeneration::constructor_new (var_targetType, object->mAttribute_mVarName.mAttribute_string  COMMA_SOURCE_FILE ("instruction-var.galgas", 164))  COMMA_SOURCE_FILE ("instruction-var.galgas", 164)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static GALGAS_string categoryReader_varInstructionWithAssignmentGeneration_instructionCode (const cPtr_abstractInstructionGeneration * inObject,
  ...
  result_outCode = function_mangledNameForType (object->mAttribute_mTargetType.reader_key (inCompiler COMMA_SOURCE_FILE ("instruction-var.galgas", 180)), inCompiler COMMA_SOURCE_FILE ("instruction-var.galgas", 180)).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("instruction-var.galgas", 180)).add_operation (function_mangledNameForVariable (object->mAttribute_mLocalVariable, inCompiler COMMA_SOURCE_FILE ("instruction-var.galgas", 180)), inCompiler COMMA_SOURCE_FILE ("instruction-var.galgas", 180)).add_operation (GALGAS_string (" = "), inCompiler COMMA_SOURCE_FILE ("instruction-var.galgas", 180)).add_operation (callCategoryReader_expressionCode ((const cPtr_abstractExpressionGeneration *) object->mAttribute_mExpressionGeneration.ptr (), inCompiler COMMA_SOURCE_FILE ("instruction-var.galgas", 181)), inCompiler COMMA_SOURCE_FILE ("instruction-var.galgas", 181)).add_operation (GALGAS_string (" ;\n"), inCompiler COMMA_SOURCE_FILE ("instruction-var.galgas", 181)) ;
//---
  return result_outCode ;
}
...
static GALGAS_string categoryReader_varInstructionGeneration_instructionCode (const cPtr_abstractInstructionGeneration * inObject,
  ...
  result_outCode = function_mangledNameForType (object->mAttribute_mTargetType.reader_key (inCompiler COMMA_SOURCE_FILE ("instruction-var.galgas", 194)), inCompiler COMMA_SOURCE_FILE ("instruction-var.galgas", 194)).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("instruction-var.galgas", 194)).add_operation (function_mangledNameForVariable (object->mAttribute_mLocalVariable, inCompiler COMMA_SOURCE_FILE ("instruction-var.galgas", 194)), inCompiler COMMA_SOURCE_FILE ("instruction-var.galgas", 194)).add_operation (GALGAS_string (" ;\n"), inCompiler COMMA_SOURCE_FILE ("instruction-var.galgas", 194)) ;
//---
  return result_outCode ;
}
