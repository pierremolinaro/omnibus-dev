...
static void extensionMethod_structureDeclarationAST_enterInContext (const cPtr_abstractDeclarationAST * inObject,
  ...
  const cPtr_structureDeclarationAST * object = (const cPtr_structureDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_structureDeclarationAST) ;
  GALGAS_propertyList var_propertyList_9948 = GALGAS_propertyList::constructor_emptyList (SOURCE_FILE ("type-structure-declaration.galgas", 251)) ;
  GALGAS_propertyMap var_propertyMap_9980 = GALGAS_propertyMap::constructor_emptyMap (SOURCE_FILE ("type-structure-declaration.galgas", 252)) ;
  GALGAS_sortedOperandIRList var_sortedOperandIRList_10028 = GALGAS_sortedOperandIRList::constructor_emptySortedList (SOURCE_FILE ("type-structure-declaration.galgas", 253)) ;
  GALGAS_constructorSignature var_constructorSignature_10078 = GALGAS_constructorSignature::constructor_emptyList (SOURCE_FILE ("type-structure-declaration.galgas", 254)) ;
  GALGAS_bool var_canBeCopied_10101 = GALGAS_bool (true) ;
  cEnumerator_structurePropertyListAST enumerator_10152 (object->mProperty_mStructurePropertyListAST, kENUMERATION_UP) ;
  while (enumerator_10152.hasCurrentObject ()) {
    extensionMethod_enterInContext (enumerator_10152.current (HERE), object->mProperty_mStructureName, ioArgument_ioContext, ioArgument_ioGlobalLiteralStringMap, var_propertyList_9948, var_propertyMap_9980, var_sortedOperandIRList_10028, var_constructorSignature_10078, var_canBeCopied_10101, inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 257)) ;
    enumerator_10152.gotoNextObject () ;
  }
  {
  ioArgument_ioContext.mProperty_mConstructorMap.setter_insertKey (object->mProperty_mStructureName, GALGAS_constructorValue::constructor_structure (var_constructorSignature_10078, var_sortedOperandIRList_10028  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 272)), inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 270)) ;
  }
  GALGAS_PLMTypeFlags var_flags_10730 = GALGAS_PLMTypeFlags::constructor_instanciable (SOURCE_FILE ("type-structure-declaration.galgas", 275)) ;
  cEnumerator_lstringlist enumerator_10790 (object->mProperty_mAttributeListAST, kENUMERATION_UP) ;
  while (enumerator_10790.hasCurrentObject ()) {
    const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, enumerator_10790.current_mValue (HERE).getter_string (HERE).objectCompare (GALGAS_string ("copyable"))).boolEnum () ;
    if (kBoolTrue == test_0) {
      const enumGalgasBool test_1 = var_flags_10730.getter_copyable (SOURCE_FILE ("type-structure-declaration.galgas", 278)).boolEnum () ;
      if (kBoolTrue == test_1) {
        TC_Array <C_FixItDescription> fixItArray2 ;
        inCompiler->emitSemanticError (enumerator_10790.current_mValue (HERE).getter_location (SOURCE_FILE ("type-structure-declaration.galgas", 279)), GALGAS_string ("duplicated attribute"), fixItArray2  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 279)) ;
      }else if (kBoolFalse == test_1) {
        const enumGalgasBool test_3 = var_canBeCopied_10101.operator_not (SOURCE_FILE ("type-structure-declaration.galgas", 280)).boolEnum () ;
        if (kBoolTrue == test_3) {
          ...
          var_flags_10730 = var_flags_10730.operator_or (GALGAS_PLMTypeFlags::constructor_copyable (SOURCE_FILE ("type-structure-declaration.galgas", 283)) COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 283)) ;
        }
      }
    }else if (kBoolFalse == test_0) {
      TC_Array <C_FixItDescription> fixItArray5 ;
      inCompiler->emitSemanticError (enumerator_10790.current_mValue (HERE).getter_location (SOURCE_FILE ("type-structure-declaration.galgas", 286)), GALGAS_string ("only @copyable attribute is allowed here"), fixItArray5  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 286)) ;
    }
    enumerator_10790.gotoNextObject () ;
  }
  cEnumerator_functionDeclarationListAST enumerator_11294 (object->mProperty_mFunctionDeclarationListAST, kENUMERATION_UP) ;
  while (enumerator_11294.hasCurrentObject ()) {
    GALGAS_stringset var_attributeSet_11346 = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("type-structure-declaration.galgas", 292)) ;
    cEnumerator_lstringlist enumerator_11404 (enumerator_11294.current (HERE).getter_mFunctionAttributeList (HERE), kENUMERATION_UP) ;
    while (enumerator_11404.hasCurrentObject ()) {
      var_attributeSet_11346.addAssign_operation (enumerator_11404.current (HERE).getter_mValue (HERE).getter_string (HERE)  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 294)) ;
      enumerator_11404.gotoNextObject () ;
    }
    enumerator_11294.gotoNextObject () ;
  }
  cEnumerator_systemRoutineDeclarationListAST enumerator_11506 (object->mProperty_mSystemRoutineListAST, kENUMERATION_UP) ;
  while (enumerator_11506.hasCurrentObject ()) {
    GALGAS_stringset var_attributeSet_11558 = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("type-structure-declaration.galgas", 299)) ;
    cEnumerator_lstringlist enumerator_11606 (enumerator_11506.current (HERE).getter_mAttributeList (HERE), kENUMERATION_UP) ;
    while (enumerator_11606.hasCurrentObject ()) {
      var_attributeSet_11558.addAssign_operation (enumerator_11606.current (HERE).getter_mValue (HERE).getter_string (HERE)  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 301)) ;
      enumerator_11606.gotoNextObject () ;
    }
    enumerator_11506.gotoNextObject () ;
  }
  {
  ioArgument_ioContext.mProperty_mTypeMap.setter_insertType (object->mProperty_mStructureName, GALGAS_PLMType::constructor_structure (object->mProperty_mStructureName, var_propertyMap_9980, var_propertyList_9948, var_flags_10730, object->mProperty_mStructureName.getter_string (SOURCE_FILE ("type-structure-declaration.galgas", 312))  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 307)), ioArgument_ioContext.getter_mTypeMap (HERE).getter_count (SOURCE_FILE ("type-structure-declaration.galgas", 314)), inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 305)) ;
  }
}
...
static void extensionMethod_structureDeclarationAST_enterRoutinesInContext (const cPtr_abstractDeclarationAST * inObject,
  ...
  const cPtr_structureDeclarationAST * object = (const cPtr_structureDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_structureDeclarationAST) ;
  extensionMethod_enterFunctionInContext (object->mProperty_mFunctionDeclarationListAST, function_llvmRegularTypeMangledNameFromName (object->mProperty_mStructureName, inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 444)).getter_string (HERE), ioArgument_ioContext, inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 443)) ;
  extensionMethod_enterInContext (object->mProperty_mSystemRoutineListAST, function_llvmRegularTypeMangledNameFromName (object->mProperty_mStructureName, inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 448)).getter_string (HERE), ioArgument_ioContext, inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 447)) ;
  extensionMethod_enterInContext (object->mProperty_mGuardListAST, function_llvmRegularTypeMangledNameFromName (object->mProperty_mStructureName, inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 452)).getter_string (HERE), ioArgument_ioContext, inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 451)) ;
}
...
static void extensionMethod_structureDeclarationAST_semanticAnalysis (const cPtr_abstractDeclarationAST * inObject,
  ...
  const cPtr_structureDeclarationAST * object = (const cPtr_structureDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_structureDeclarationAST) ;
  GALGAS_PLMType var_structureType_17910 = GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inContext.getter_mTypeMap (HERE), object->mProperty_mStructureName, inCompiler  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 466)).getter_type (inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 466)) ;
  const GALGAS_structureDeclarationAST temp_0 = object ;
  callExtensionMethod_functionSemanticAnalysis ((const cPtr_structureDeclarationAST *) temp_0.ptr (), var_structureType_17910, constinArgument_inContext, ioArgument_ioTemporaries, ioArgument_ioIntermediateCodeStruct, inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 468)) ;
  extensionMethod_systemRoutineSemanticAnalysis (object->mProperty_mSystemRoutineListAST, var_structureType_17910, constinArgument_inContext, ioArgument_ioTemporaries, ioArgument_ioIntermediateCodeStruct, inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 475)) ;
  extensionMethod_guardSemanticAnalysis (object->mProperty_mGuardListAST, var_structureType_17910, constinArgument_inContext, ioArgument_ioTemporaries, ioArgument_ioIntermediateCodeStruct, inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 482)) ;
  {
  routine_generatePropertyAccess (var_structureType_17910, ioArgument_ioIntermediateCodeStruct, inCompiler  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 489)) ;
  }
}
...
void routine_generatePropertyAccess (const GALGAS_PLMType constinArgument_inType,
                                     ...
                                     C_Compiler * inCompiler
                                     COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_propertyMap var_propertyMap_21704 ;
  GALGAS_lstring joker_21660_1 ; // Joker input parameter
  GALGAS_propertyList joker_21706_3 ; // Joker input parameter
  GALGAS_PLMTypeFlags joker_21706_2 ; // Joker input parameter
  GALGAS_string joker_21706_1 ; // Joker input parameter
  constinArgument_inType.method_structure (joker_21660_1, var_propertyMap_21704, joker_21706_3, joker_21706_2, joker_21706_1, inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 563)) ;
  cEnumerator_propertyMap enumerator_21760 (var_propertyMap_21704, kENUMERATION_UP) ;
  while (enumerator_21760.hasCurrentObject ()) {
    GALGAS_PLMType var_propertyType_21812 ;
    GALGAS_propertyAccessKind var_access_21842 ;
    GALGAS_lstring joker_21822 ; // Joker input parameter
    enumerator_21760.current_mPropertyObject (HERE).method_propertyRef (var_propertyType_21812, joker_21822, var_access_21842, inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 565)) ;
    ioArgument_ioIntermediateCodeStruct.mProperty_mPropertyAccessRoutineList.addAssign_operation (constinArgument_inType, var_propertyType_21812, enumerator_21760.current_lkey (HERE).getter_string (HERE), var_access_21842  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 566)) ;
    enumerator_21760.gotoNextObject () ;
  }
}
...
void routine_buildControlRegisterMapHTMLFile (const GALGAS_controlRegisterMap constinArgument_inControlRegisterMap,
                                              ...
                                              C_Compiler * inCompiler
                                              COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_typeDumpFilePath_16979 = constinArgument_inSourceFile.getter_string (HERE).add_operation (GALGAS_string (".control-registers.html"), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 444)) ;
  const enumGalgasBool test_0 = GALGAS_bool (gOption_plm_5F_options_writeControlRegisterHTMLDumpFile.getter_value ()).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_stringset var_firstLetterSet_17129 = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("declaration-control-register.galgas", 446)) ;
    cEnumerator_controlRegisterMap enumerator_17169 (constinArgument_inControlRegisterMap, kENUMERATION_UP) ;
    while (enumerator_17169.hasCurrentObject ()) {
      var_firstLetterSet_17129.addAssign_operation (enumerator_17169.current_lkey (HERE).getter_string (HERE).getter_characterAtIndex (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 448)).getter_string (SOURCE_FILE ("declaration-control-register.galgas", 448))  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 448)) ;
      enumerator_17169.gotoNextObject () ;
    }
    GALGAS_string var_tableOfTypeString_17277 = GALGAS_string::makeEmptyString () ;
    GALGAS_char var_currentFirstLetter_17311 = GALGAS_char (TO_UNICODE (32)) ;
    cEnumerator_controlRegisterMap enumerator_17358 (constinArgument_inControlRegisterMap, kENUMERATION_UP) ;
    while (enumerator_17358.hasCurrentObject ()) {
      const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, var_currentFirstLetter_17311.objectCompare (enumerator_17358.current_lkey (HERE).getter_string (HERE).getter_characterAtIndex (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 453)))).boolEnum () ;
      if (kBoolTrue == test_1) {
        var_currentFirstLetter_17311 = enumerator_17358.current_lkey (HERE).getter_string (HERE).getter_characterAtIndex (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 454)) ;
        var_tableOfTypeString_17277.plusAssign_operation(GALGAS_string ("<br><a name=\"").add_operation (var_currentFirstLetter_17311.getter_uint (SOURCE_FILE ("declaration-control-register.galgas", 455)).getter_string (SOURCE_FILE ("declaration-control-register.galgas", 455)), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 455)).add_operation (GALGAS_string ("\"><b>"), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 455)).add_operation (var_currentFirstLetter_17311.getter_string (SOURCE_FILE ("declaration-control-register.galgas", 455)), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 455)).add_operation (GALGAS_string ("</b></a><br>"), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 455)), inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 455)) ;
      }
      const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, enumerator_17358.current_mArraySize (HERE).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_2) {
        var_tableOfTypeString_17277.plusAssign_operation(function_linkForControlRegister (enumerator_17358.current_lkey (HERE).getter_string (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 458)).add_operation (GALGAS_string ("<br>"), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 458)), inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 458)) ;
      }else if (kBoolFalse == test_2) {
        cEnumerator_range enumerator_17803 (GALGAS_range (GALGAS_uint ((uint32_t) 0U), enumerator_17358.current_mArraySize (HERE).substract_operation (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 460))), kENUMERATION_UP) ;
        while (enumerator_17803.hasCurrentObject ()) {
          var_tableOfTypeString_17277.plusAssign_operation(function_linkForControlRegister (enumerator_17358.current_lkey (HERE).getter_string (HERE).add_operation (GALGAS_string (" ["), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 461)).add_operation (enumerator_17803.current (HERE).getter_string (SOURCE_FILE ("declaration-control-register.galgas", 461)), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 461)).add_operation (GALGAS_string ("]"), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 461)), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 461)).add_operation (GALGAS_string ("<br/>"), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 461)), inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 461)) ;
          enumerator_17803.gotoNextObject () ;
        }
      }
      enumerator_17358.gotoNextObject () ;
    }
    GALGAS_string var_typeDumpString_17968 = GALGAS_string (filewrapperTemplate_controlRegisterDumpGenerationTemplate_dump (inCompiler, constinArgument_inSourceFile.getter_string (HERE).getter_lastPathComponent (SOURCE_FILE ("declaration-control-register.galgas", 466)), constinArgument_inControlRegisterMap, var_firstLetterSet_17129, var_tableOfTypeString_17277 COMMA_SOURCE_FILE ("declaration-control-register.galgas", 465))) ;
    GALGAS_bool joker_18220 ; // Joker input parameter
    var_typeDumpString_17968.method_writeToFileWhenDifferentContents (var_typeDumpFilePath_16979, joker_18220, inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 471)) ;
  }else if (kBoolFalse == test_0) {
    {
    GALGAS_string::class_method_deleteFileIfExists (var_typeDumpFilePath_16979, inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 473)) ;
    }
  }
}
...
GALGAS_string function_fieldIndexColumns (const GALGAS_uint & constinArgument_inBitCount,
  ...
  cEnumerator_range enumerator_19246 (GALGAS_range (GALGAS_uint ((uint32_t) 0U), constinArgument_inBitCount.substract_operation (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 499))), kENUMERATION_DOWN) ;
  while (enumerator_19246.hasCurrentObject ()) {
    result_result.plusAssign_operation(GALGAS_string ("<td class=\"fields\">").add_operation (enumerator_19246.current (HERE).getter_string (SOURCE_FILE ("declaration-control-register.galgas", 500)), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 500)).add_operation (GALGAS_string ("</td>"), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 500)), inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 500)) ;
...
GALGAS_uintlist function_arrayIndexListFor (const GALGAS_uint & constinArgument_inSize,
  ...
  cEnumerator_range enumerator_19531 (GALGAS_range (GALGAS_uint ((uint32_t) 0U), constinArgument_inSize.substract_operation (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 508))), kENUMERATION_UP) ;
  while (enumerator_19531.hasCurrentObject ()) {
    result_result.addAssign_operation (enumerator_19531.current (HERE)  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 509)) ;
...
static void extensionMethod_staticArrayAST_enterInContext (const cPtr_abstractDeclarationAST * inObject,
  ...
  GALGAS_stringset var_propertyNameSet_6045 = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("declaration-static-array.galgas", 142)) ;
  GALGAS_lstring var_plmTypeName_6068 = function_plmNameForStaticListElementType (object->mProperty_mStaticListName, inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 143)) ;
  cEnumerator_staticArrayPropertyListAST enumerator_6164 (object->mProperty_mPropertyList, kENUMERATION_UP) ;
  GALGAS_uint index_6127 ((uint32_t) 0) ;
  while (enumerator_6164.hasCurrentObject ()) {
    switch (enumerator_6164.current_mPropertyType (HERE).enumValue ()) {
    case GALGAS_staticArrayPropertyTypeAST::kNotBuilt:
      break ;
    case GALGAS_staticArrayPropertyTypeAST::kEnum_valueType:
      {
        const cEnumAssociatedValues_staticArrayPropertyTypeAST_valueType * extractPtr_6859 = (const cEnumAssociatedValues_staticArrayPropertyTypeAST_valueType *) (enumerator_6164.current_mPropertyType (HERE).unsafePointer ()) ;
        const GALGAS_lstring extractedValue_propertyTypeName = extractPtr_6859->mAssociatedValue0 ;
        GALGAS_PLMType var_propertyType_6271 = GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (ioArgument_ioContext.getter_mTypeMap (HERE), extractedValue_propertyTypeName, inCompiler  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 147)).getter_type (inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 147)) ;
        const enumGalgasBool test_0 = var_propertyNameSet_6045.getter_hasKey (enumerator_6164.current_mPropertyName (HERE).getter_string (SOURCE_FILE ("declaration-static-array.galgas", 148)) COMMA_SOURCE_FILE ("declaration-static-array.galgas", 148)).boolEnum () ;
        if (kBoolTrue == test_0) {
          TC_Array <C_FixItDescription> fixItArray1 ;
          inCompiler->emitSemanticError (enumerator_6164.current_mPropertyName (HERE).getter_location (SOURCE_FILE ("declaration-static-array.galgas", 149)), GALGAS_string ("duplicated property name"), fixItArray1  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 149)) ;
        }
        var_propertyNameSet_6045.addAssign_operation (enumerator_6164.current_mPropertyName (HERE).getter_string (SOURCE_FILE ("declaration-static-array.galgas", 151))  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 151)) ;
        var_propertyList_5969.addAssign_operation (enumerator_6164.current_mPropertyName (HERE).getter_string (SOURCE_FILE ("declaration-static-array.galgas", 152)), var_propertyType_6271  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 152)) ;
        GALGAS_objectIR var_objectIR_6579 = GALGAS_objectIR::constructor_propertyRef (var_propertyType_6271, enumerator_6164.current_mPropertyName (HERE), GALGAS_propertyAccessKind::constructor_indexed (index_6127  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 153))  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 153)) ;
        {
        var_staticlistPropertyMap_6011.setter_insertKey (enumerator_6164.current_mPropertyName (HERE), GALGAS_bool (true), var_objectIR_6579, var_propertyType_6271, GALGAS_propertyAccessKind::constructor_indexed (index_6127  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 159)), inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 154)) ;
        }
      }
      break ;
    case GALGAS_staticArrayPropertyTypeAST::kEnum_function:
      {
        const cEnumAssociatedValues_staticArrayPropertyTypeAST_function * extractPtr_8198 = (const cEnumAssociatedValues_staticArrayPropertyTypeAST_function *) (enumerator_6164.current_mPropertyType (HERE).unsafePointer ()) ;
        const GALGAS_mode extractedValue_mode = extractPtr_8198->mAssociatedValue0 ;
        const GALGAS_routineFormalArgumentList extractedValue_formalArgs = extractPtr_8198->mAssociatedValue1 ;
        const GALGAS_lstring extractedValue_returnTypeName = extractPtr_8198->mAssociatedValue2 ;
        GALGAS_lstring var_routineMangledName_7013 = function_routineMangledNameFromAST (GALGAS_string::makeEmptyString (), enumerator_6164.current_mPropertyName (HERE), extractedValue_formalArgs, inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 163)) ;
        GALGAS_routineTypedSignature var_signature_7197 ;
        {
        routine_routineSignature (ioArgument_ioContext.mProperty_mTypeMap, extractedValue_formalArgs, var_signature_7197, inCompiler  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 169)) ;
        }
        ...
        GALGAS_unifiedTypeMap_2D_proxy var_returnTypeProxy_7246 = temp_2 ;
        GALGAS_PLMType var_type_7412 = GALGAS_PLMType::constructor_function (var_signature_7197, extractedValue_mode, var_returnTypeProxy_7246  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 175)) ;
        const enumGalgasBool test_4 = ioArgument_ioContext.getter_mTypeMap (HERE).getter_hasKey (var_routineMangledName_7013.getter_string (SOURCE_FILE ("declaration-static-array.galgas", 176)) COMMA_SOURCE_FILE ("declaration-static-array.galgas", 176)).operator_not (SOURCE_FILE ("declaration-static-array.galgas", 176)).boolEnum () ;
        if (kBoolTrue == test_4) {
          {
          ioArgument_ioContext.mProperty_mTypeMap.setter_insertType (var_routineMangledName_7013, var_type_7412, ioArgument_ioContext.getter_mTypeMap (HERE).getter_count (SOURCE_FILE ("declaration-static-array.galgas", 180)), inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 177)) ;
          }
        }
        GALGAS_PLMType var_propertyType_7749 = GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (ioArgument_ioContext.getter_mTypeMap (HERE), var_routineMangledName_7013, inCompiler  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 183)).getter_type (inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 183)) ;
        var_propertyList_5969.addAssign_operation (enumerator_6164.current_mPropertyName (HERE).getter_string (SOURCE_FILE ("declaration-static-array.galgas", 184)), var_propertyType_7749  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 184)) ;
        GALGAS_uint var_propertyIndex_7906 = var_staticlistPropertyMap_6011.getter_count (SOURCE_FILE ("declaration-static-array.galgas", 185)) ;
        {
        var_staticlistPropertyMap_6011.setter_insertKey (enumerator_6164.current_mPropertyName (HERE), GALGAS_bool (true), GALGAS_objectIR::constructor_propertyRef (var_propertyType_7749, enumerator_6164.current_mPropertyName (HERE), GALGAS_propertyAccessKind::constructor_indexed (var_propertyIndex_7906  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 189))  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 189)), var_propertyType_7749, GALGAS_propertyAccessKind::constructor_indexed (var_propertyIndex_7906  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 191)), inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 186)) ;
        }
      }
      break ;
    }
    enumerator_6164.gotoNextObject () ;
    index_6127.increment_operation (inCompiler  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 144)) ;
  }
  {
  ioArgument_ioContext.mProperty_mStaticlistMap.setter_insertKey (object->mProperty_mStaticListName, var_propertyList_5969, inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 195)) ;
  }
  GALGAS_PLMType var_kind_8331 = GALGAS_PLMType::constructor_structure (function_llvmNameForStaticListElementType (object->mProperty_mStaticListName, inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 198)), var_staticlistPropertyMap_6011, var_propertyList_5969, GALGAS_PLMTypeFlags::constructor_none (SOURCE_FILE ("declaration-static-array.galgas", 201)), object->mProperty_mStaticListName.getter_string (SOURCE_FILE ("declaration-static-array.galgas", 202))  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 197)) ;
  {
  ioArgument_ioContext.mProperty_mTypeMap.setter_insertType (var_plmTypeName_6068, var_kind_8331, ioArgument_ioContext.getter_mTypeMap (HERE).getter_count (SOURCE_FILE ("declaration-static-array.galgas", 207)), inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 204)) ;
  }
}
...
static void extensionMethod_staticArrayAST_semanticAnalysis (const cPtr_abstractDeclarationAST * inObject,
  ...
  const cPtr_staticArrayAST * object = (const cPtr_staticArrayAST *) inObject ;
  macroValidSharedObject (object, cPtr_staticArrayAST) ;
  GALGAS_lstring var_plmTypeName_9681 = function_plmNameForStaticListElementType (object->mProperty_mStaticListName, inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 230)) ;
  GALGAS_PLMType var_type_9799 ;
  GALGAS_uint joker_9801_1 ; // Joker input parameter
  constinArgument_inContext.getter_mTypeMap (HERE).method_searchKey (var_plmTypeName_9681, var_type_9799, joker_9801_1, inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 231)) ;
  {
  routine_generatePropertyAccess (var_type_9799, ioArgument_ioIntermediateCodeStruct, inCompiler  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 232)) ;
  }
}
...
void routine_guardSemanticAnalysis (const GALGAS_PLMType constinArgument_inSelfType,
  ...
  GALGAS_universalPropertyAndRoutineMapForContext var_universalMap_6744 ;
  {
  routine_initialVariableMap (constinArgument_inContext, GALGAS_mode::constructor_guardMode (SOURCE_FILE ("declaration-guard.galgas", 183)), GALGAS_bool (false), GALGAS_string::makeEmptyString ().getter_nowhere (SOURCE_FILE ("declaration-guard.galgas", 185)), var_universalMap_6744, inCompiler  COMMA_SOURCE_FILE ("declaration-guard.galgas", 181)) ;
  }
  GALGAS_routineFormalArgumentListForGeneration var_formalArguments_6806 = GALGAS_routineFormalArgumentListForGeneration::constructor_emptyList (SOURCE_FILE ("declaration-guard.galgas", 188)) ;
  GALGAS_guardKindGenerationIR var_convenienceGuardGenerationIR_6865 ;
  GALGAS_allocaList var_allocaList_6890 = GALGAS_allocaList::constructor_emptyList (SOURCE_FILE ("declaration-guard.galgas", 190)) ;
  GALGAS_instructionListIR var_instructionGenerationList_6942 = GALGAS_instructionListIR::constructor_emptyList (SOURCE_FILE ("declaration-guard.galgas", 191)) ;
  switch (constinArgument_inGuardKind.enumValue ()) {
  case GALGAS_guardKind::kNotBuilt:
    break ;
  case GALGAS_guardKind::kEnum_baseGuard:
    {
      GALGAS_lstring var_resultVarName_7045 = GALGAS_lstring::constructor_new (function_acceptVariablePLMName (inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 195)), constinArgument_inRoutineName.getter_location (HERE)  COMMA_SOURCE_FILE ("declaration-guard.galgas", 195)) ;
      GALGAS_PLMType var_resultType_7130 = GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inContext.getter_mTypeMap (HERE), function_boolTypeName (inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 196)).getter_nowhere (SOURCE_FILE ("declaration-guard.galgas", 196)), inCompiler  COMMA_SOURCE_FILE ("declaration-guard.galgas", 196)).getter_type (inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 196)) ;
      var_allocaList_6890.addAssign_operation (var_resultVarName_7045.getter_string (HERE), extensionGetter_llvmTypeName (var_resultType_7130, inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 197))  COMMA_SOURCE_FILE ("declaration-guard.galgas", 197)) ;
      {
      var_universalMap_6744.insulate (HERE) ;
      cPtr_universalPropertyAndRoutineMapForContext * ptr_7307 = (cPtr_universalPropertyAndRoutineMapForContext *) var_universalMap_6744.ptr () ;
      callExtensionSetter_insertLocalVariable ((cPtr_universalPropertyAndRoutineMapForContext *) ptr_7307, var_resultVarName_7045, var_resultType_7130, var_resultVarName_7045, GALGAS_valuedObjectState::constructor_noValue (SOURCE_FILE ("declaration-guard.galgas", 202)), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 198)) ;
      }
      {
      routine_enterFormalArguments (constinArgument_inContext, constinArgument_inRoutineFormalArgumentList, var_universalMap_6744, var_formalArguments_6806, inCompiler  COMMA_SOURCE_FILE ("declaration-guard.galgas", 206)) ;
      }
      var_convenienceGuardGenerationIR_6865 = GALGAS_guardKindGenerationIR::constructor_baseGuard (SOURCE_FILE ("declaration-guard.galgas", 212)) ;
      extensionMethod_analyzeRoutineInstructionList (constinArgument_inRoutineInstructionList, constinArgument_inSelfType, GALGAS_bool (true), GALGAS_bool (true), var_guardMangledName_6134, constinArgument_inContext, GALGAS_mode::constructor_guardMode (SOURCE_FILE ("declaration-guard.galgas", 220)), ioArgument_ioTemporaries, ioArgument_ioIntermediateCodeStruct.mProperty_mStaticStringMap, var_universalMap_6744, var_allocaList_6890, var_instructionGenerationList_6942, inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 214)) ;
    }
    break ;
  case GALGAS_guardKind::kEnum_convenienceGuard:
    {
      const cEnumAssociatedValues_guardKind_convenienceGuard * extractPtr_9405 = (const cEnumAssociatedValues_guardKind_convenienceGuard *) (constinArgument_inGuardKind.unsafePointer ()) ;
      const GALGAS_callInstructionAST extractedValue_baseGuardInstruction = extractPtr_9405->mAssociatedValue0 ;
      {
      routine_enterFormalArguments (constinArgument_inContext, constinArgument_inRoutineFormalArgumentList, var_universalMap_6744, var_formalArguments_6806, inCompiler  COMMA_SOURCE_FILE ("declaration-guard.galgas", 229)) ;
      }
      callExtensionMethod_baseGuardAnalyze ((const cPtr_callInstructionAST *) extractedValue_baseGuardInstruction.ptr (), constinArgument_inSelfType, var_guardMangledName_6134, constinArgument_inContext, GALGAS_mode::constructor_userMode (SOURCE_FILE ("declaration-guard.galgas", 241)), ioArgument_ioTemporaries, ioArgument_ioIntermediateCodeStruct.mProperty_mStaticStringMap, var_universalMap_6744, var_convenienceGuardGenerationIR_6865, inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 237)) ;
      extensionMethod_analyzeRoutineInstructionList (constinArgument_inRoutineInstructionList, constinArgument_inSelfType, GALGAS_bool (true), GALGAS_bool (true), var_guardMangledName_6134, constinArgument_inContext, GALGAS_mode::constructor_userMode (SOURCE_FILE ("declaration-guard.galgas", 254)), ioArgument_ioTemporaries, ioArgument_ioIntermediateCodeStruct.mProperty_mStaticStringMap, var_universalMap_6744, var_allocaList_6890, var_instructionGenerationList_6942, inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 248)) ;
    }
    break ;
  }
  callExtensionMethod_checkLocalVariableFinalState ((const cPtr_universalPropertyAndRoutineMapForContext *) var_universalMap_6744.ptr (), inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 265)) ;
  {
  ioArgument_ioIntermediateCodeStruct.mProperty_mGuardMapIR.setter_insertKey (var_guardMangledName_6134, var_formalArguments_6806, constinArgument_inSelfType, var_convenienceGuardGenerationIR_6865, var_allocaList_6890, var_instructionGenerationList_6942, constinArgument_inWarnIfUnused, inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 269)) ;
  }
}
...
static void extensionMethod_standAloneProcedureCallInstructionAST_baseGuardAnalyze (const cPtr_callInstructionAST * inObject,
  ...
  inCompiler->emitSemanticError (object->mProperty_mSandAloneRoutineName.getter_location (SOURCE_FILE ("declaration-guard.galgas", 304)), GALGAS_string ("NOT HANDLED YET"), fixItArray0  COMMA_SOURCE_FILE ("declaration-guard.galgas", 304)) ;
...
static void extensionMethod_procedureCallInstructionAST_baseGuardAnalyze (const cPtr_callInstructionAST * inObject,
  ...
  GALGAS_allocaList var_baseGuardAllocaList_11848 = GALGAS_allocaList::constructor_emptyList (SOURCE_FILE ("declaration-guard.galgas", 319)) ;
  GALGAS_instructionListIR var_baseGuardInstructionGenerationList_11909 = GALGAS_instructionListIR::constructor_emptyList (SOURCE_FILE ("declaration-guard.galgas", 320)) ;
  GALGAS_objectIR var_currentObject_12040 ;
  ...
  if (kBoolTrue == test_0) {
    const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, constinArgument_inSelfType.objectCompare (GALGAS_PLMType::constructor_void (SOURCE_FILE ("declaration-guard.galgas", 324)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      TC_Array <C_FixItDescription> fixItArray2 ;
      inCompiler->emitSemanticError (object->mProperty_mIdentifier.getter_location (SOURCE_FILE ("declaration-guard.galgas", 325)), GALGAS_string ("self is not available in this context"), fixItArray2  COMMA_SOURCE_FILE ("declaration-guard.galgas", 325)) ;
      var_currentObject_12040.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_1) {
      var_currentObject_12040 = GALGAS_objectIR::constructor_reference (constinArgument_inSelfType, function_llvmNameForSelf (inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 327))  COMMA_SOURCE_FILE ("declaration-guard.galgas", 327)) ;
    }
  }else if (kBoolFalse == test_0) {
    callExtensionMethod_searchValuedObject ((const cPtr_universalPropertyAndRoutineMapForContext *) ioArgument_ioUniversalMap.ptr (), object->mProperty_mIdentifier, var_currentObject_12040, inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 330)) ;
  }
  GALGAS_location var_currentErrorLocation_12414 = object->mProperty_mIdentifier.getter_location (HERE) ;
  GALGAS_accessInAssignmentListAST var_accessList_12480 = object->mProperty_mAccessList ;
  GALGAS_accessInAssignmentAST var_lastAccess_12534 ;
  {
  var_accessList_12480.setter_popLast (var_lastAccess_12534, inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 335)) ;
  }
  cEnumerator_accessInAssignmentListAST enumerator_12590 (var_accessList_12480, kENUMERATION_UP) ;
  while (enumerator_12590.hasCurrentObject ()) {
    GALGAS_PLMType var_currentType_12613 = extensionGetter_type (var_currentObject_12040, inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 338)) ;
    switch (enumerator_12590.current_mAccess (HERE).enumValue ()) {
    case GALGAS_accessInAssignmentAST::kNotBuilt:
      break ;
    case GALGAS_accessInAssignmentAST::kEnum_property:
      {
        const cEnumAssociatedValues_accessInAssignmentAST_property * extractPtr_13333 = (const cEnumAssociatedValues_accessInAssignmentAST_property *) (enumerator_12590.current_mAccess (HERE).unsafePointer ()) ;
        const GALGAS_lstring extractedValue_propertyName = extractPtr_13333->mAssociatedValue0 ;
        const enumGalgasBool test_3 = var_currentType_12613.getter_isStructure (SOURCE_FILE ("declaration-guard.galgas", 341)).boolEnum () ;
        if (kBoolTrue == test_3) {
          GALGAS_propertyMap var_propertyMap_12815 ;
          GALGAS_lstring joker_12771_1 ; // Joker input parameter
          GALGAS_propertyList joker_12817_3 ; // Joker input parameter
          GALGAS_PLMTypeFlags joker_12817_2 ; // Joker input parameter
          GALGAS_string joker_12817_1 ; // Joker input parameter
          var_currentType_12613.method_structure (joker_12771_1, var_propertyMap_12815, joker_12817_3, joker_12817_2, joker_12817_1, inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 342)) ;
          GALGAS_objectIR var_propertyObject_12888 ;
          GALGAS_bool joker_12867 ; // Joker input parameter
          GALGAS_PLMType joker_12890_2 ; // Joker input parameter
          GALGAS_propertyAccessKind joker_12890_1 ; // Joker input parameter
          var_propertyMap_12815.method_searchKey (extractedValue_propertyName, joker_12867, var_propertyObject_12888, joker_12890_2, joker_12890_1, inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 343)) ;
          var_currentErrorLocation_12414 = extractedValue_propertyName.getter_location (HERE) ;
          GALGAS_objectIR var_newObject_13042 ;
          {
          routine_getNewTempVariable (extensionGetter_type (var_propertyObject_12888, inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 345)), extractedValue_propertyName.getter_location (SOURCE_FILE ("declaration-guard.galgas", 345)), ioArgument_ioTemporaries, var_newObject_13042, inCompiler  COMMA_SOURCE_FILE ("declaration-guard.galgas", 345)) ;
          }
          {
          extensionSetter_appendGetPropertyReference (var_baseGuardInstructionGenerationList_11909, var_newObject_13042, var_currentObject_12040, extractedValue_propertyName.getter_string (SOURCE_FILE ("declaration-guard.galgas", 349)), inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 346)) ;
          }
          var_currentObject_12040 = var_newObject_13042 ;
        }else if (kBoolFalse == test_3) {
          TC_Array <C_FixItDescription> fixItArray4 ;
          inCompiler->emitSemanticError (var_currentErrorLocation_12414, GALGAS_string ("this object has no property"), fixItArray4  COMMA_SOURCE_FILE ("declaration-guard.galgas", 353)) ;
          var_currentObject_12040.drop () ; // Release error dropped variable
        }
      }
      break ;
    case GALGAS_accessInAssignmentAST::kEnum_arrayAccess:
      {
        const cEnumAssociatedValues_accessInAssignmentAST_arrayAccess * extractPtr_13476 = (const cEnumAssociatedValues_accessInAssignmentAST_arrayAccess *) (enumerator_12590.current_mAccess (HERE).unsafePointer ()) ;
        const GALGAS_expressionAST extractedValue_indexExpression = extractPtr_13476->mAssociatedValue0 ;
        const GALGAS_location extractedValue_endOfIndex = extractPtr_13476->mAssociatedValue1 ;
        TC_Array <C_FixItDescription> fixItArray5 ;
  ...
  GALGAS_lstring var_methodName_13536 ;
  switch (var_lastAccess_12534.enumValue ()) {
  case GALGAS_accessInAssignmentAST::kNotBuilt:
    break ;
  case GALGAS_accessInAssignmentAST::kEnum_property:
    {
      const cEnumAssociatedValues_accessInAssignmentAST_property * extractPtr_13986 = (const cEnumAssociatedValues_accessInAssignmentAST_property *) (var_lastAccess_12534.unsafePointer ()) ;
      const GALGAS_lstring extractedValue_propertyName = extractPtr_13986->mAssociatedValue0 ;
      var_methodName_13536 = extractedValue_propertyName ;
      GALGAS_PLMType var_currentType_13648 = extensionGetter_type (var_currentObject_12040, inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 364)) ;
      const enumGalgasBool test_6 = var_currentType_13648.getter_isStructure (SOURCE_FILE ("declaration-guard.galgas", 365)).boolEnum () ;
      if (kBoolTrue == test_6) {
        var_currentErrorLocation_12414 = extractedValue_propertyName.getter_location (HERE) ;
      }else if (kBoolFalse == test_6) {
        TC_Array <C_FixItDescription> fixItArray7 ;
        inCompiler->emitSemanticError (var_currentErrorLocation_12414, GALGAS_string ("this object has no property"), fixItArray7  COMMA_SOURCE_FILE ("declaration-guard.galgas", 370)) ;
        var_currentObject_12040.drop () ; // Release error dropped variable
        var_methodName_13536.drop () ; // Release error dropped variable
      }
    }
    break ;
  case GALGAS_accessInAssignmentAST::kEnum_arrayAccess:
    {
      const cEnumAssociatedValues_accessInAssignmentAST_arrayAccess * extractPtr_14120 = (const cEnumAssociatedValues_accessInAssignmentAST_arrayAccess *) (var_lastAccess_12534.unsafePointer ()) ;
      const GALGAS_location extractedValue_endOfIndex = extractPtr_14120->mAssociatedValue1 ;
      TC_Array <C_FixItDescription> fixItArray8 ;
      inCompiler->emitSemanticError (extractedValue_endOfIndex, GALGAS_string ("a property access is required here"), fixItArray8  COMMA_SOURCE_FILE ("declaration-guard.galgas", 373)) ;
      var_currentObject_12040.drop () ; // Release error dropped variable
      var_methodName_13536.drop () ; // Release error dropped variable
    }
    break ;
  }
  GALGAS_lstring var_routineMangledName_14217 = function_routineMangledNameFromCall (GALGAS_string ("$").add_operation (extensionGetter_key (extensionGetter_type (var_currentObject_12040, inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 376)), inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 376)), inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 376)), var_methodName_13536, object->mProperty_mArguments, inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 376)) ;
  GALGAS_lstring var_signature_14357 = extensionGetter_routineSignature (object->mProperty_mArguments, var_methodName_13536.getter_location (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 378)) ;
  GALGAS_lstring var_LLVMInvocationRoutineName_14565 ;
  GALGAS_routineDescriptor var_routineDescriptor_14607 ;
  GALGAS_location joker_14613 ; // Joker input parameter
  extensionMethod_searchKey (constinArgument_inContext.getter_mRoutineMapForContext (HERE), var_methodName_13536, var_signature_14357, var_LLVMInvocationRoutineName_14565, var_routineDescriptor_14607, joker_14613, inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 380)) ;
  GALGAS_procCallEffectiveParameterListIR var_effectiveParameterListIR_14906 = GALGAS_procCallEffectiveParameterListIR::constructor_emptyList (SOURCE_FILE ("declaration-guard.galgas", 394)) ;
  switch (var_routineDescriptor_14607.getter_mRoutineCallingScheme (HERE).enumValue ()) {
  case GALGAS_routineCallingSheme::kNotBuilt:
    break ;
  case GALGAS_routineCallingSheme::kEnum_staticCall:
    {
      var_effectiveParameterListIR_14906.addAssign_operation (GALGAS_procEffectiveParameterPassingModeIR::constructor_outputInput (SOURCE_FILE ("declaration-guard.galgas", 397)), var_currentObject_12040  COMMA_SOURCE_FILE ("declaration-guard.galgas", 397)) ;
    }
    break ;
  ...
  GALGAS_routineTypedSignature var_formalSignature_15287 = var_routineDescriptor_14607.getter_mSignature (HERE) ;
  const enumGalgasBool test_9 = GALGAS_bool (kIsNotEqual, var_routineDescriptor_14607.getter_mReturnTypeProxy (HERE).objectCompare (GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("declaration-guard.galgas", 406)))).boolEnum () ;
  if (kBoolTrue == test_9) {
    TC_Array <C_FixItDescription> fixItArray10 ;
    inCompiler->emitSemanticError (var_methodName_13536.getter_location (SOURCE_FILE ("declaration-guard.galgas", 407)), GALGAS_string ("not a procedure (returns a value)"), fixItArray10  COMMA_SOURCE_FILE ("declaration-guard.galgas", 407)) ;
    var_routineDescriptor_14607.drop () ; // Release error dropped variable
    outArgument_outConvenienceGuardGenerationIR.drop () ; // Release error dropped variable
  }else if (kBoolFalse == test_9) {
    {
    routine_analyzeEffectiveParameters (constinArgument_inSelfType, var_formalSignature_15287, object->mProperty_mArguments, var_methodName_13536.getter_location (HERE), constinArgument_inCallerNameForInvocationGraph, constinArgument_inContext, constinArgument_inMode, ioArgument_ioTemporaries, ioArgument_ioGlobalLiteralStringMap, ioArgument_ioUniversalMap, var_baseGuardAllocaList_11848, var_baseGuardInstructionGenerationList_11909, var_effectiveParameterListIR_14906, inCompiler  COMMA_SOURCE_FILE ("declaration-guard.galgas", 417)) ;
    }
    switch (var_routineDescriptor_14607.getter_mRoutineCallingScheme (HERE).enumValue ()) {
    case GALGAS_routineCallingSheme::kNotBuilt:
      break ;
    case GALGAS_routineCallingSheme::kEnum_staticCall:
      {
        outArgument_outConvenienceGuardGenerationIR = GALGAS_guardKindGenerationIR::constructor_convenienceGuard (var_baseGuardAllocaList_11848, var_baseGuardInstructionGenerationList_11909, var_routineMangledName_14217.getter_string (HERE), var_effectiveParameterListIR_14906  COMMA_SOURCE_FILE ("declaration-guard.galgas", 435)) ;
      }
      break ;
    case GALGAS_routineCallingSheme::kEnum_propertyIndirectCall:
      {
        TC_Array <C_FixItDescription> fixItArray11 ;
        inCompiler->emitSemanticError (GALGAS_location::constructor_nowhere (SOURCE_FILE ("declaration-guard.galgas", 442)), GALGAS_string ("NOT HANDLED YET"), fixItArray11  COMMA_SOURCE_FILE ("declaration-guard.galgas", 442)) ;
        outArgument_outConvenienceGuardGenerationIR.drop () ; // Release error dropped variable
      }
      break ;
    }
...
static void extensionMethod_convertExpressionAST_analyzeExpression (const cPtr_expressionAST * inObject,
  ...
  if (kBoolTrue == test_2) {
    ...
    if (kBoolTrue == test_4) {
      ...
      {
      routine_getNewTempVariable (var_resultType_4784, object->mProperty_mEndOfExpression, ioArgument_ioTemporaries, outArgument_outResult, inCompiler  COMMA_SOURCE_FILE ("expression-convert.galgas", 117)) ;
      }
...
static void extensionMethod_convertInstructionIR_llvmInstructionCode (const cPtr_abstractInstructionIR * inObject,
  ...
  GALGAS_uint var_staticStringIndex_7234 ;
  {
  extensionSetter_findOrAddStaticString (ioArgument_ioGenerationAdds.mProperty_mStaticStringMap, object->mProperty_mLocation.getter_file (inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 161)).getter_lastPathComponent (SOURCE_FILE ("expression-convert.galgas", 161)).getter_stringByDeletingPathExtension (SOURCE_FILE ("expression-convert.galgas", 161)), var_staticStringIndex_7234, inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 160)) ;
  }
  GALGAS_string var_lbl_7248 = object->mProperty_mLocation.getter_locationIndex (inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 164)).getter_string (SOURCE_FILE ("expression-convert.galgas", 164)) ;
  GALGAS_string var_convertMinOkLabel_7309 = GALGAS_string ("min.").add_operation (var_lbl_7248, inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 165)).add_operation (GALGAS_string (".ok"), inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 165)) ;
  GALGAS_string var_convertMaxOkLabel_7356 = GALGAS_string ("max.").add_operation (var_lbl_7248, inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 166)).add_operation (GALGAS_string (".ok"), inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 166)) ;
  GALGAS_string var_convertFailLabel_7402 = GALGAS_string ("fail.").add_operation (var_lbl_7248, inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 167)) ;
  GALGAS_string var_compareMinVar_7439 = GALGAS_string ("cmp.").add_operation (var_lbl_7248, inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 168)).add_operation (GALGAS_string (".min"), inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 168)) ;
  GALGAS_string var_compareMaxVar_7487 = GALGAS_string ("cmp.").add_operation (var_lbl_7248, inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 169)).add_operation (GALGAS_string (".max"), inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 169)) ;
  GALGAS_bigint var_minTarget_7560 ;
  GALGAS_bigint var_maxTarget_7579 ;
  GALGAS_bool joker_7581_3 ; // Joker input parameter
  GALGAS_uint joker_7581_2 ; // Joker input parameter
  GALGAS_string joker_7581_1 ; // Joker input parameter
  extensionGetter_type (object->mProperty_mTarget, inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 170)).method_integer (var_minTarget_7560, var_maxTarget_7579, joker_7581_3, joker_7581_2, joker_7581_1, inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 170)) ;
  GALGAS_bigint var_minSource_7630 ;
  GALGAS_bool var_operandIsUnsigned_7669 ;
  GALGAS_bigint joker_7636 ; // Joker input parameter
  GALGAS_uint joker_7671_2 ; // Joker input parameter
  GALGAS_string joker_7671_1 ; // Joker input parameter
  extensionGetter_type (object->mProperty_mOperand, inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 171)).method_integer (var_minSource_7630, joker_7636, var_operandIsUnsigned_7669, joker_7671_2, joker_7671_1, inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 171)) ;
  GALGAS_string var_operandType_7692 = extensionGetter_llvmTypeName (object->mProperty_mOperand, inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 172)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_minTarget_7560.objectCompare (var_minSource_7630)).boolEnum () ;
  if (kBoolTrue == test_0) {
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  %").add_operation (var_compareMinVar_7439, inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 174)).add_operation (GALGAS_string (" = icmp "), inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 174)), inCompiler  COMMA_SOURCE_FILE ("expression-convert.galgas", 174)) ;
    GALGAS_string temp_1 ;
    const enumGalgasBool test_2 = var_operandIsUnsigned_7669.boolEnum () ;
    if (kBoolTrue == test_2) {
    ...
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string (" ").add_operation (var_operandType_7692, inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 176)).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 176)).add_operation (extensionGetter_llvmName (object->mProperty_mOperand, inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 176)), inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 176)).add_operation (GALGAS_string (", "), inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 176)).add_operation (var_minTarget_7560.getter_string (SOURCE_FILE ("expression-convert.galgas", 176)), inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 176)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 176)), inCompiler  COMMA_SOURCE_FILE ("expression-convert.galgas", 176)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  br i1 %").add_operation (var_compareMinVar_7439, inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 177)).add_operation (GALGAS_string (", label %"), inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 177)).add_operation (var_convertMinOkLabel_7309, inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 177)).add_operation (GALGAS_string (", label %"), inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 177)).add_operation (var_convertFailLabel_7402, inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 177)).add_operation (GALGAS_string ("\n"
      "\n"), inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 177)), inCompiler  COMMA_SOURCE_FILE ("expression-convert.galgas", 177)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(var_convertMinOkLabel_7309.add_operation (GALGAS_string (":\n"), inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 178)), inCompiler  COMMA_SOURCE_FILE ("expression-convert.galgas", 178)) ;
  }
  ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  %").add_operation (var_compareMaxVar_7487, inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 180)).add_operation (GALGAS_string (" = icmp "), inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 180)), inCompiler  COMMA_SOURCE_FILE ("expression-convert.galgas", 180)) ;
  GALGAS_string temp_3 ;
  const enumGalgasBool test_4 = var_operandIsUnsigned_7669.boolEnum () ;
  if (kBoolTrue == test_4) {
  ...
  ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string (" ").add_operation (var_operandType_7692, inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 182)).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 182)).add_operation (extensionGetter_llvmName (object->mProperty_mOperand, inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 182)), inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 182)).add_operation (GALGAS_string (", "), inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 182)).add_operation (var_maxTarget_7579.getter_string (SOURCE_FILE ("expression-convert.galgas", 182)), inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 182)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 182)), inCompiler  COMMA_SOURCE_FILE ("expression-convert.galgas", 182)) ;
  ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  br i1 %").add_operation (var_compareMaxVar_7487, inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 183)).add_operation (GALGAS_string (", label %"), inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 183)).add_operation (var_convertMaxOkLabel_7356, inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 183)).add_operation (GALGAS_string (", label %"), inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 183)).add_operation (var_convertFailLabel_7402, inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 183)).add_operation (GALGAS_string ("\n"
    "\n"), inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 183)), inCompiler  COMMA_SOURCE_FILE ("expression-convert.galgas", 183)) ;
  ioArgument_ioLLVMcode.plusAssign_operation(var_convertFailLabel_7402.add_operation (GALGAS_string (":\n"), inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 184)), inCompiler  COMMA_SOURCE_FILE ("expression-convert.galgas", 184)) ;
  ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  call void @raise.panic.").add_operation (var_staticStringIndex_7234.getter_string (SOURCE_FILE ("expression-convert.galgas", 185)), inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 185)).add_operation (GALGAS_string (" ("), inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 185)), inCompiler  COMMA_SOURCE_FILE ("expression-convert.galgas", 185)) ;
  ...
  ioArgument_ioLLVMcode.plusAssign_operation(var_convertMaxOkLabel_7356.add_operation (GALGAS_string (":\n"), inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 189)), inCompiler  COMMA_SOURCE_FILE ("expression-convert.galgas", 189)) ;
  ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  ").add_operation (extensionGetter_llvmName (object->mProperty_mTarget, inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 190)), inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 190)).add_operation (GALGAS_string (" = trunc "), inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 190)).add_operation (var_operandType_7692, inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 190)).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 190)).add_operation (extensionGetter_llvmName (object->mProperty_mOperand, inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 190)), inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 190)).add_operation (GALGAS_string (" to "), inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 190)).add_operation (extensionGetter_llvmTypeName (object->mProperty_mTarget, inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 190)), inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 190)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 190)), inCompiler  COMMA_SOURCE_FILE ("expression-convert.galgas", 190)) ;
}
...
static void extensionMethod_extendExpressionAST_analyzeExpression (const cPtr_expressionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_2) {
      ...
      {
      routine_getNewTempVariable (var_resultType_4614, object->mProperty_mTypeName.getter_location (SOURCE_FILE ("expression-extend.galgas", 128)), ioArgument_ioTemporaries, outArgument_outResult, inCompiler  COMMA_SOURCE_FILE ("expression-extend.galgas", 128)) ;
      }
      {
...
static void extensionMethod_truncateExpressionAST_analyzeExpression (const cPtr_expressionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_2) {
      ...
      if (kBoolTrue == test_7) {
        {
        routine_getNewTempVariable (var_resultType_4620, object->mProperty_mEndOfExpression, ioArgument_ioTemporaries, outArgument_outResult, inCompiler  COMMA_SOURCE_FILE ("expression-truncate.galgas", 114)) ;
        }
...
static void extensionMethod_truncateInstructionIR_llvmInstructionCode (const cPtr_abstractInstructionIR * inObject,
  ...
  GALGAS_string var_operandType_6882 = extensionGetter_llvmTypeName (object->mProperty_mOperand, inCompiler COMMA_SOURCE_FILE ("expression-truncate.galgas", 151)) ;
  ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  ").add_operation (extensionGetter_llvmName (object->mProperty_mTarget, inCompiler COMMA_SOURCE_FILE ("expression-truncate.galgas", 152)), inCompiler COMMA_SOURCE_FILE ("expression-truncate.galgas", 152)).add_operation (GALGAS_string (" = trunc "), inCompiler COMMA_SOURCE_FILE ("expression-truncate.galgas", 152)).add_operation (var_operandType_6882, inCompiler COMMA_SOURCE_FILE ("expression-truncate.galgas", 152)).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("expression-truncate.galgas", 152)).add_operation (extensionGetter_llvmName (object->mProperty_mOperand, inCompiler COMMA_SOURCE_FILE ("expression-truncate.galgas", 152)), inCompiler COMMA_SOURCE_FILE ("expression-truncate.galgas", 152)).add_operation (GALGAS_string (" to "), inCompiler COMMA_SOURCE_FILE ("expression-truncate.galgas", 152)).add_operation (extensionGetter_llvmTypeName (object->mProperty_mTarget, inCompiler COMMA_SOURCE_FILE ("expression-truncate.galgas", 153)), inCompiler COMMA_SOURCE_FILE ("expression-truncate.galgas", 153)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("expression-truncate.galgas", 153)), inCompiler  COMMA_SOURCE_FILE ("expression-truncate.galgas", 152)) ;
}
...
static void extensionMethod_ifExpressionAST_analyzeExpression (const cPtr_expressionAST * inObject,
  ...
  if (kBoolTrue == test_2) {
    ...
    {
    routine_getNewTempVariable (extensionGetter_type (var_elseExpressionResult_6730, inCompiler COMMA_SOURCE_FILE ("expression-if.galgas", 168)), object->mProperty_mIfExpressionEndLocation, ioArgument_ioTemporaries, outArgument_outResult, inCompiler  COMMA_SOURCE_FILE ("expression-if.galgas", 168)) ;
    }
    {
...
static void extensionMethod_infixOperatorExpressionAST_analyzeExpression (const cPtr_expressionAST * inObject,
  ...
  GALGAS_objectIR var_leftOperand_4956 ;
  {
  extensionSetter_appendLoadFromReference (ioArgument_ioInstructionGenerationList, ioArgument_ioTemporaries, var_leftOperandPossibleReference_4820, var_leftOperand_4956, inCompiler COMMA_SOURCE_FILE ("expression-infix-operators.galgas", 118)) ;
  }
  GALGAS_objectIR var_rightOperandPossibleReference_5488 ;
  callExtensionMethod_analyzeExpression ((const cPtr_expressionAST *) object->mProperty_mRightExpression.ptr (), constinArgument_inSelfType, constinArgument_inGuard, constinArgument_inCallerNameForInvocationGraph, extensionGetter_type (var_leftOperand_4956, inCompiler COMMA_SOURCE_FILE ("expression-infix-operators.galgas", 128)), constinArgument_inContext, constinArgument_inCurrentMode, ioArgument_ioTemporaries, ioArgument_ioGlobalLiteralStringMap, ioArgument_ioUniversalMap, ioArgument_ioAllocaList, ioArgument_ioInstructionGenerationList, var_rightOperandPossibleReference_5488, inCompiler COMMA_SOURCE_FILE ("expression-infix-operators.galgas", 124)) ;
  GALGAS_objectIR var_rightOperand_5626 ;
  {
  extensionSetter_appendLoadFromReference (ioArgument_ioInstructionGenerationList, ioArgument_ioTemporaries, var_rightOperandPossibleReference_5488, var_rightOperand_5626, inCompiler COMMA_SOURCE_FILE ("expression-infix-operators.galgas", 138)) ;
  }
  GALGAS_infixOperatorMap var_operatorMap_5688 = function_getInfixOperatorMap (object->mProperty_mOp, constinArgument_inContext, constinArgument_inCurrentMode, object->mProperty_mOperatorLocation, inCompiler COMMA_SOURCE_FILE ("expression-infix-operators.galgas", 144)) ;
  GALGAS_PLMType var_resultType_5995 ;
  GALGAS_infixOperatorDescription var_binaryOperator_6048 ;
  extensionMethod_checkBinaryOperationWith (var_operatorMap_5688, extensionGetter_type (var_leftOperand_4956, inCompiler COMMA_SOURCE_FILE ("expression-infix-operators.galgas", 147)), extensionGetter_type (var_rightOperand_5626, inCompiler COMMA_SOURCE_FILE ("expression-infix-operators.galgas", 148)), object->mProperty_mOperatorLocation, var_resultType_5995, var_binaryOperator_6048, inCompiler COMMA_SOURCE_FILE ("expression-infix-operators.galgas", 146)) ;
  callExtensionMethod_generateInfixOperatorCode ((const cPtr_infixOperatorDescription *) var_binaryOperator_6048.ptr (), ioArgument_ioTemporaries, ioArgument_ioInstructionGenerationList, var_leftOperand_4956, object->mProperty_mOperatorLocation, var_rightOperand_5626, var_resultType_5995, outArgument_outResult, inCompiler COMMA_SOURCE_FILE ("expression-infix-operators.galgas", 154)) ;
}
...
GALGAS_infixOperatorMap function_getInfixOperatorMap (const GALGAS_infixOperator & constinArgument_inOp,
  ...
  case GALGAS_infixOperator::kEnum_addOp:
    {
      const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, constinArgument_inCurrentMode.objectCompare (GALGAS_mode::constructor_panicMode (SOURCE_FILE ("expression-infix-operators.galgas", 196)))).boolEnum () ;
      if (kBoolTrue == test_0) {
        TC_Array <C_FixItDescription> fixItArray1 ;
        inCompiler->emitSemanticError (constinArgument_inOperatorLocation, GALGAS_string ("operations that can generate panic are not allowed in `").add_operation (function_panicModeName (inCompiler COMMA_SOURCE_FILE ("expression-infix-operators.galgas", 197)), inCompiler COMMA_SOURCE_FILE ("expression-infix-operators.galgas", 197)).add_operation (GALGAS_string (" mode"), inCompiler COMMA_SOURCE_FILE ("expression-infix-operators.galgas", 197)), fixItArray1  COMMA_SOURCE_FILE ("expression-infix-operators.galgas", 197)) ;
      }
  ...
  case GALGAS_infixOperator::kEnum_subOp:
    {
      const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, constinArgument_inCurrentMode.objectCompare (GALGAS_mode::constructor_panicMode (SOURCE_FILE ("expression-infix-operators.galgas", 207)))).boolEnum () ;
      if (kBoolTrue == test_3) {
        TC_Array <C_FixItDescription> fixItArray4 ;
        inCompiler->emitSemanticError (constinArgument_inOperatorLocation, GALGAS_string ("operations that can generate panic are not allowed in `").add_operation (function_panicModeName (inCompiler COMMA_SOURCE_FILE ("expression-infix-operators.galgas", 208)), inCompiler COMMA_SOURCE_FILE ("expression-infix-operators.galgas", 208)).add_operation (GALGAS_string (" mode"), inCompiler COMMA_SOURCE_FILE ("expression-infix-operators.galgas", 208)), fixItArray4  COMMA_SOURCE_FILE ("expression-infix-operators.galgas", 208)) ;
      }
  ...
  case GALGAS_infixOperator::kEnum_mulOp:
    {
      const enumGalgasBool test_6 = GALGAS_bool (kIsEqual, constinArgument_inCurrentMode.objectCompare (GALGAS_mode::constructor_panicMode (SOURCE_FILE ("expression-infix-operators.galgas", 218)))).boolEnum () ;
      if (kBoolTrue == test_6) {
        TC_Array <C_FixItDescription> fixItArray7 ;
        inCompiler->emitSemanticError (constinArgument_inOperatorLocation, GALGAS_string ("operations that can generate panic are not allowed in `").add_operation (function_panicModeName (inCompiler COMMA_SOURCE_FILE ("expression-infix-operators.galgas", 219)), inCompiler COMMA_SOURCE_FILE ("expression-infix-operators.galgas", 219)).add_operation (GALGAS_string (" mode"), inCompiler COMMA_SOURCE_FILE ("expression-infix-operators.galgas", 219)), fixItArray7  COMMA_SOURCE_FILE ("expression-infix-operators.galgas", 219)) ;
      }
  ...
  case GALGAS_infixOperator::kEnum_divOp:
    {
      const enumGalgasBool test_9 = GALGAS_bool (kIsEqual, constinArgument_inCurrentMode.objectCompare (GALGAS_mode::constructor_panicMode (SOURCE_FILE ("expression-infix-operators.galgas", 229)))).boolEnum () ;
      if (kBoolTrue == test_9) {
        TC_Array <C_FixItDescription> fixItArray10 ;
        inCompiler->emitSemanticError (constinArgument_inOperatorLocation, GALGAS_string ("operations that can generate panic are not allowed in `").add_operation (function_panicModeName (inCompiler COMMA_SOURCE_FILE ("expression-infix-operators.galgas", 230)), inCompiler COMMA_SOURCE_FILE ("expression-infix-operators.galgas", 230)).add_operation (GALGAS_string (" mode"), inCompiler COMMA_SOURCE_FILE ("expression-infix-operators.galgas", 230)), fixItArray10  COMMA_SOURCE_FILE ("expression-infix-operators.galgas", 230)) ;
      }
  ...
  case GALGAS_infixOperator::kEnum_modOp:
    {
      const enumGalgasBool test_12 = GALGAS_bool (kIsEqual, constinArgument_inCurrentMode.objectCompare (GALGAS_mode::constructor_panicMode (SOURCE_FILE ("expression-infix-operators.galgas", 240)))).boolEnum () ;
      if (kBoolTrue == test_12) {
        TC_Array <C_FixItDescription> fixItArray13 ;
        inCompiler->emitSemanticError (constinArgument_inOperatorLocation, GALGAS_string ("operations that can generate panic are not allowed in `").add_operation (function_panicModeName (inCompiler COMMA_SOURCE_FILE ("expression-infix-operators.galgas", 241)), inCompiler COMMA_SOURCE_FILE ("expression-infix-operators.galgas", 241)).add_operation (GALGAS_string (" mode"), inCompiler COMMA_SOURCE_FILE ("expression-infix-operators.galgas", 241)), fixItArray13  COMMA_SOURCE_FILE ("expression-infix-operators.galgas", 241)) ;
      }
