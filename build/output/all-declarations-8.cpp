...
void extensionMethod_llvmCodeGeneration (const GALGAS_routineMapIR_2D_element inObject,
  ...
  GALGAS_string var_routineName_6395 ;
  switch (inObject.mProperty_mKind.enumValue ()) {
  case GALGAS_routineKind::kNotBuilt:
    break ;
  case GALGAS_routineKind::kEnum_function:
    {
      var_routineName_6395 = function_llvmNameForFunction (inObject.mProperty_mRoutineNameForGeneration.getter_string (HERE), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 165)) ;
    }
    break ;
  case GALGAS_routineKind::kEnum_section:
    {
      var_routineName_6395 = function_llvmNameForSectionImplementation (inObject.mProperty_mRoutineNameForGeneration.getter_string (HERE), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 166)) ;
    }
    break ;
  case GALGAS_routineKind::kEnum_safe:
    {
      var_routineName_6395 = function_llvmNameForSafeImplementation (inObject.mProperty_mRoutineNameForGeneration.getter_string (HERE), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 167)) ;
    }
    break ;
  case GALGAS_routineKind::kEnum_service:
    {
      var_routineName_6395 = function_llvmNameForServiceImplementation (inObject.mProperty_mRoutineNameForGeneration.getter_string (HERE), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 168)) ;
    }
    break ;
  case GALGAS_routineKind::kEnum_primitive:
    {
      var_routineName_6395 = function_llvmNameForPrimitiveImplementation (inObject.mProperty_mRoutineNameForGeneration.getter_string (HERE), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 169)) ;
    }
    break ;
  }
  ioArgument_ioLLVMcode.plusAssign_operation(function_llvmTitleComment (var_routineName_6395, inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 171)), inCompiler  COMMA_SOURCE_FILE ("semantic-routines.galgas", 171)) ;
  ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("define"), inCompiler  COMMA_SOURCE_FILE ("semantic-routines.galgas", 172)) ;
  const enumGalgasBool test_0 = inObject.mProperty_mGlobal.operator_not (SOURCE_FILE ("semantic-routines.galgas", 173)).boolEnum () ;
  if (kBoolTrue == test_0) {
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string (" internal"), inCompiler  COMMA_SOURCE_FILE ("semantic-routines.galgas", 174)) ;
  }
  ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string (" ").add_operation (extensionGetter_llvmTypeName (inObject.mProperty_mReturnType, inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 176)), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 176)), inCompiler  COMMA_SOURCE_FILE ("semantic-routines.galgas", 176)) ;
  ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string (" @").add_operation (var_routineName_6395, inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 177)).add_operation (GALGAS_string (" ("), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 177)), inCompiler  COMMA_SOURCE_FILE ("semantic-routines.galgas", 177)) ;
  GALGAS_string temp_1 ;
  const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, inObject.mProperty_mReceiverType.objectCompare (GALGAS_PLMType::constructor_void (SOURCE_FILE ("semantic-routines.galgas", 178)))).boolEnum () ;
  if (kBoolTrue == test_2) {
    temp_1 = GALGAS_string::makeEmptyString () ;
  }else if (kBoolFalse == test_2) {
    temp_1 = GALGAS_string ("$").add_operation (extensionGetter_key (inObject.mProperty_mReceiverType, inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 178)), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 178)) ;
  }
  GALGAS_string var_receiverTypeName_7151 = temp_1 ;
  GALGAS_bool var_first_7234 = GALGAS_bool (true) ;
  const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, var_receiverTypeName_7151.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
  if (kBoolTrue == test_3) {
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("%").add_operation (var_receiverTypeName_7151.getter_assemblerRepresentation (SOURCE_FILE ("semantic-routines.galgas", 181)), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 181)).add_operation (GALGAS_string (" * %self"), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 181)), inCompiler  COMMA_SOURCE_FILE ("semantic-routines.galgas", 181)) ;
    var_first_7234 = GALGAS_bool (false) ;
  }
  cEnumerator_routineFormalArgumentListForGeneration enumerator_7423 (inObject.mProperty_mFormalArgumentListForGeneration, kENUMERATION_UP) ;
  while (enumerator_7423.hasCurrentObject ()) {
    ...
    switch (enumerator_7423.current_mFormalArgumentKind (HERE).enumValue ()) {
    case GALGAS_procFormalArgumentPassingMode::kNotBuilt:
      break ;
    case GALGAS_procFormalArgumentPassingMode::kEnum_input:
      {
        ioArgument_ioLLVMcode.plusAssign_operation(extensionGetter_llvmTypeName (enumerator_7423.current_mFormalArgumentType (HERE), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 192)).add_operation (GALGAS_string (" %in."), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 192)).add_operation (enumerator_7423.current_mFormalArgumentName (HERE), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 192)), inCompiler  COMMA_SOURCE_FILE ("semantic-routines.galgas", 192)) ;
      }
      break ;
    case GALGAS_procFormalArgumentPassingMode::kEnum_output:
      {
        ioArgument_ioLLVMcode.plusAssign_operation(extensionGetter_llvmTypeName (enumerator_7423.current_mFormalArgumentType (HERE), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 194)).add_operation (GALGAS_string (" * "), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 194)).add_operation (function_llvmNameForLocalVariable (enumerator_7423.current_mFormalArgumentName (HERE), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 194)), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 194)), inCompiler  COMMA_SOURCE_FILE ("semantic-routines.galgas", 194)) ;
      }
      break ;
    case GALGAS_procFormalArgumentPassingMode::kEnum_inputOutput:
      {
        ioArgument_ioLLVMcode.plusAssign_operation(extensionGetter_llvmTypeName (enumerator_7423.current_mFormalArgumentType (HERE), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 196)).add_operation (GALGAS_string (" * "), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 196)).add_operation (function_llvmNameForLocalVariable (enumerator_7423.current_mFormalArgumentName (HERE), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 196)), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 196)), inCompiler  COMMA_SOURCE_FILE ("semantic-routines.galgas", 196)) ;
      }
      break ;
    }
  ...
  if (kBoolTrue == test_6) {
    const enumGalgasBool test_7 = var_first_7234.operator_not (SOURCE_FILE ("semantic-routines.galgas", 200)).boolEnum () ;
    if (kBoolTrue == test_7) {
  ...
  const enumGalgasBool test_8 = GALGAS_bool (kIsNotEqual, inObject.mProperty_mReturnType.objectCompare (GALGAS_PLMType::constructor_void (SOURCE_FILE ("semantic-routines.galgas", 207)))).boolEnum () ;
  if (kBoolTrue == test_8) {
  ...
  cEnumerator_allocaList enumerator_8480 (inObject.mProperty_mAllocaList, kENUMERATION_UP) ;
  while (enumerator_8480.hasCurrentObject ()) {
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  ").add_operation (function_llvmNameForLocalVariable (enumerator_8480.current_mVarName (HERE), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 212)), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 212)).add_operation (GALGAS_string (" = alloca "), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 212)).add_operation (enumerator_8480.current_mLLVMTypeName (HERE), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 212)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 212)), inCompiler  COMMA_SOURCE_FILE ("semantic-routines.galgas", 212)) ;
    enumerator_8480.gotoNextObject () ;
  }
  cEnumerator_routineFormalArgumentListForGeneration enumerator_8670 (inObject.mProperty_mFormalArgumentListForGeneration, kENUMERATION_UP) ;
  while (enumerator_8670.hasCurrentObject ()) {
    switch (enumerator_8670.current_mFormalArgumentKind (HERE).enumValue ()) {
    case GALGAS_procFormalArgumentPassingMode::kNotBuilt:
      break ;
    case GALGAS_procFormalArgumentPassingMode::kEnum_input:
      {
        GALGAS_string var_llvmType_8740 = extensionGetter_llvmTypeName (enumerator_8670.current_mFormalArgumentType (HERE), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 218)) ;
        ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  ").add_operation (function_llvmNameForLocalVariable (enumerator_8670.current_mFormalArgumentName (HERE), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 219)), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 219)).add_operation (GALGAS_string (" = alloca "), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 219)).add_operation (var_llvmType_8740, inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 219)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 219)), inCompiler  COMMA_SOURCE_FILE ("semantic-routines.galgas", 219)) ;
      }
      break ;
    case GALGAS_procFormalArgumentPassingMode::kEnum_output:
    case GALGAS_procFormalArgumentPassingMode::kEnum_inputOutput:
  ...
  cEnumerator_routineFormalArgumentListForGeneration enumerator_8975 (inObject.mProperty_mFormalArgumentListForGeneration, kENUMERATION_UP) ;
  while (enumerator_8975.hasCurrentObject ()) {
    switch (enumerator_8975.current_mFormalArgumentKind (HERE).enumValue ()) {
    case GALGAS_procFormalArgumentPassingMode::kNotBuilt:
      break ;
    case GALGAS_procFormalArgumentPassingMode::kEnum_input:
      {
        GALGAS_string var_llvmType_9045 = extensionGetter_llvmTypeName (enumerator_8975.current_mFormalArgumentType (HERE), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 226)) ;
        ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  store ").add_operation (var_llvmType_9045, inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 227)).add_operation (GALGAS_string (" %in."), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 227)).add_operation (enumerator_8975.current_mFormalArgumentName (HERE), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 227)).add_operation (GALGAS_string (", "), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 227)).add_operation (var_llvmType_9045, inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 227)).add_operation (GALGAS_string (" * "), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 227)).add_operation (function_llvmNameForLocalVariable (enumerator_8975.current_mFormalArgumentName (HERE), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 228)), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 227)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 228)), inCompiler  COMMA_SOURCE_FILE ("semantic-routines.galgas", 227)) ;
      }
      break ;
    case GALGAS_procFormalArgumentPassingMode::kEnum_output:
    case GALGAS_procFormalArgumentPassingMode::kEnum_inputOutput:
  ...
  const enumGalgasBool test_9 = GALGAS_bool (kIsEqual, inObject.mProperty_mReturnType.objectCompare (GALGAS_PLMType::constructor_void (SOURCE_FILE ("semantic-routines.galgas", 235)))).boolEnum () ;
  if (kBoolTrue == test_9) {
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  ret void\n"), inCompiler  COMMA_SOURCE_FILE ("semantic-routines.galgas", 236)) ;
  }else if (kBoolFalse == test_9) {
    GALGAS_string var_resultVarLLVMName_9540 = function_llvmNameForLocalVariable (function_functionResultVariableName (inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 238)), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 238)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  %result = load ").add_operation (extensionGetter_llvmTypeName (inObject.mProperty_mReturnType, inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 239)), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 239)).add_operation (GALGAS_string (", "), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 239)).add_operation (extensionGetter_llvmTypeName (inObject.mProperty_mReturnType, inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 239)), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 239)).add_operation (GALGAS_string (" * "), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 239)).add_operation (var_resultVarLLVMName_9540, inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 239)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 239)), inCompiler  COMMA_SOURCE_FILE ("semantic-routines.galgas", 239)) ;
...
static void extensionMethod_structureDeclarationAST_enterInContext (const cPtr_abstractDeclarationAST * inObject,
  ...
  GALGAS_routineMapForContext var_methodMap_10018 = GALGAS_routineMapForContext::constructor_default (SOURCE_FILE ("type-structure-declaration.galgas", 253)) ;
  GALGAS_sortedOperandIRList var_sortedOperandIRList_10072 = GALGAS_sortedOperandIRList::constructor_emptySortedList (SOURCE_FILE ("type-structure-declaration.galgas", 254)) ;
  GALGAS_constructorSignature var_constructorSignature_10122 = GALGAS_constructorSignature::constructor_emptyList (SOURCE_FILE ("type-structure-declaration.galgas", 255)) ;
  GALGAS_bool var_canBeCopied_10145 = GALGAS_bool (true) ;
  cEnumerator_structurePropertyListAST enumerator_10196 (object->mProperty_mStructurePropertyListAST, kENUMERATION_UP) ;
  while (enumerator_10196.hasCurrentObject ()) {
    extensionMethod_enterInContext (enumerator_10196.current (HERE), object->mProperty_mStructureName, ioArgument_ioContext, ioArgument_ioGlobalLiteralStringMap, var_universalPropertyAndRoutineMapForContext_9907, var_propertyList_9947, var_propertyMap_9979, var_sortedOperandIRList_10072, var_constructorSignature_10122, var_canBeCopied_10145, inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 258)) ;
    enumerator_10196.gotoNextObject () ;
  }
  {
  ioArgument_ioContext.mProperty_mConstructorMap.setter_insertKey (object->mProperty_mStructureName, GALGAS_constructorValue::constructor_structure (var_constructorSignature_10122, var_sortedOperandIRList_10072  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 273)), inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 271)) ;
  }
  GALGAS_PLMTypeFlags var_flags_10773 = GALGAS_PLMTypeFlags::constructor_instanciable (SOURCE_FILE ("type-structure-declaration.galgas", 276)) ;
  cEnumerator_lstringlist enumerator_10833 (object->mProperty_mAttributeListAST, kENUMERATION_UP) ;
  while (enumerator_10833.hasCurrentObject ()) {
    const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, enumerator_10833.current_mValue (HERE).getter_string (HERE).objectCompare (GALGAS_string ("copyable"))).boolEnum () ;
    if (kBoolTrue == test_0) {
      const enumGalgasBool test_1 = var_flags_10773.getter_copyable (SOURCE_FILE ("type-structure-declaration.galgas", 279)).boolEnum () ;
      if (kBoolTrue == test_1) {
        TC_Array <C_FixItDescription> fixItArray2 ;
        inCompiler->emitSemanticError (enumerator_10833.current_mValue (HERE).getter_location (SOURCE_FILE ("type-structure-declaration.galgas", 280)), GALGAS_string ("duplicated attribute"), fixItArray2  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 280)) ;
      }else if (kBoolFalse == test_1) {
        const enumGalgasBool test_3 = var_canBeCopied_10145.operator_not (SOURCE_FILE ("type-structure-declaration.galgas", 281)).boolEnum () ;
        if (kBoolTrue == test_3) {
          TC_Array <C_FixItDescription> fixItArray4 ;
          inCompiler->emitSemanticError (object->mProperty_mStructureName.getter_location (SOURCE_FILE ("type-structure-declaration.galgas", 282)), GALGAS_string ("this structure cannot be copied, one field is not copyable"), fixItArray4  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 282)) ;
        }else if (kBoolFalse == test_3) {
          var_flags_10773 = var_flags_10773.operator_or (GALGAS_PLMTypeFlags::constructor_copyable (SOURCE_FILE ("type-structure-declaration.galgas", 284)) COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 284)) ;
        }
      }
    }else if (kBoolFalse == test_0) {
      TC_Array <C_FixItDescription> fixItArray5 ;
      inCompiler->emitSemanticError (enumerator_10833.current_mValue (HERE).getter_location (SOURCE_FILE ("type-structure-declaration.galgas", 287)), GALGAS_string ("only @copyable attribute is allowed here"), fixItArray5  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 287)) ;
    }
    enumerator_10833.gotoNextObject () ;
  }
  cEnumerator_functionDeclarationListAST enumerator_11337 (object->mProperty_mFunctionDeclarationListAST, kENUMERATION_UP) ;
  while (enumerator_11337.hasCurrentObject ()) {
    GALGAS_stringset var_attributeSet_11389 = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("type-structure-declaration.galgas", 293)) ;
    cEnumerator_lstringlist enumerator_11447 (enumerator_11337.current (HERE).getter_mFunctionAttributeList (HERE), kENUMERATION_UP) ;
    while (enumerator_11447.hasCurrentObject ()) {
      var_attributeSet_11389.addAssign_operation (enumerator_11447.current (HERE).getter_mValue (HERE).getter_string (HERE)  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 295)) ;
      enumerator_11447.gotoNextObject () ;
    }
    GALGAS_lstring var_signature_11540 = extensionGetter_routineSignature (enumerator_11337.current (HERE).getter_mFunctionFormalArgumentList (HERE), enumerator_11337.current (HERE).getter_mFunctionName (HERE).getter_location (SOURCE_FILE ("type-structure-declaration.galgas", 298)), inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 298)) ;
    GALGAS_routineTypedSignature var_typedSignature_11723 ;
    {
    routine_routineSignature (ioArgument_ioContext.mProperty_mTypeMap, enumerator_11337.current (HERE).getter_mFunctionFormalArgumentList (HERE), var_typedSignature_11723, inCompiler  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 299)) ;
    }
    GALGAS_unifiedTypeMap_2D_proxy var_returnTypeProxy_11864 ;
    {
    GALGAS_unifiedTypeMap_2D_proxy::class_method_makeOptionalProxy (ioArgument_ioContext.mProperty_mTypeMap, enumerator_11337.current (HERE).getter_mFunctionReturnTypeName (HERE), var_returnTypeProxy_11864 COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 301)) ;
    }
    GALGAS_lstring var_invocationName_11920 = function_routineMangledNameFromAST (GALGAS_string ("$").add_operation (object->mProperty_mStructureName.getter_string (SOURCE_FILE ("type-structure-declaration.galgas", 304)), inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 304)), enumerator_11337.current (HERE).getter_mFunctionName (HERE), enumerator_11337.current (HERE).getter_mFunctionFormalArgumentList (HERE), inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 303)) ;
    GALGAS_routineDescriptor var_functionDescriptor_12113 = GALGAS_routineDescriptor::constructor_new (enumerator_11337.current (HERE).getter_mPublicFunction (HERE), var_attributeSet_11389.getter_hasKey (function_exportedAttribute (inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 311)) COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 311)), GALGAS_routineKind::constructor_function (enumerator_11337.current (HERE).getter_mMode (HERE)  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 312)), var_typedSignature_11723, var_returnTypeProxy_11864, var_attributeSet_11389.getter_hasKey (function_accessAttribute (inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 315)) COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 315)), var_attributeSet_11389.getter_hasKey (function_mutatingAttribute (inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 316)) COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 316)), GALGAS_routineCallingSheme::constructor_staticCall (SOURCE_FILE ("type-structure-declaration.galgas", 317))  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 309)) ;
    {
    var_universalPropertyAndRoutineMapForContext_9907.insulate (HERE) ;
    cPtr_universalPropertyAndRoutineMapForContext * ptr_12497 = (cPtr_universalPropertyAndRoutineMapForContext *) var_universalPropertyAndRoutineMapForContext_9907.ptr () ;
    callExtensionSetter_insertRoutine ((cPtr_universalPropertyAndRoutineMapForContext *) ptr_12497, enumerator_11337.current (HERE).getter_mFunctionName (HERE), var_signature_11540, var_invocationName_11920, var_functionDescriptor_12113, inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 320)) ;
    }
    enumerator_11337.gotoNextObject () ;
  }
  cEnumerator_systemRoutineDeclarationListAST enumerator_12656 (object->mProperty_mSystemRoutineListAST, kENUMERATION_UP) ;
  while (enumerator_12656.hasCurrentObject ()) {
    GALGAS_stringset var_attributeSet_12708 = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("type-structure-declaration.galgas", 329)) ;
    cEnumerator_lstringlist enumerator_12756 (enumerator_12656.current (HERE).getter_mAttributeList (HERE), kENUMERATION_UP) ;
    while (enumerator_12756.hasCurrentObject ()) {
      var_attributeSet_12708.addAssign_operation (enumerator_12756.current (HERE).getter_mValue (HERE).getter_string (HERE)  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 331)) ;
      enumerator_12756.gotoNextObject () ;
    }
    GALGAS_lstring var_signature_12849 = extensionGetter_routineSignature (enumerator_12656.current (HERE).getter_mFormalArgumentList (HERE), enumerator_12656.current (HERE).getter_mName (HERE).getter_location (SOURCE_FILE ("type-structure-declaration.galgas", 334)), inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 334)) ;
    GALGAS_routineTypedSignature var_typedSignature_13025 ;
    {
    routine_routineSignature (ioArgument_ioContext.mProperty_mTypeMap, enumerator_12656.current (HERE).getter_mFormalArgumentList (HERE), var_typedSignature_13025, inCompiler  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 335)) ;
    }
    GALGAS_unifiedTypeMap_2D_proxy var_returnTypeProxy_13156 ;
    {
    GALGAS_unifiedTypeMap_2D_proxy::class_method_makeOptionalProxy (ioArgument_ioContext.mProperty_mTypeMap, enumerator_12656.current (HERE).getter_mReturnTypeName (HERE), var_returnTypeProxy_13156 COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 337)) ;
    }
    GALGAS_lstring var_invocationName_13212 = function_routineMangledNameFromAST (GALGAS_string ("$").add_operation (object->mProperty_mStructureName.getter_string (SOURCE_FILE ("type-structure-declaration.galgas", 340)), inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 340)), enumerator_12656.current (HERE).getter_mName (HERE), enumerator_12656.current (HERE).getter_mFormalArgumentList (HERE), inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 339)) ;
    GALGAS_routineDescriptor var_descriptor_13377 = GALGAS_routineDescriptor::constructor_new (enumerator_12656.current (HERE).getter_mPublic (HERE), var_attributeSet_12708.getter_hasKey (function_exportedAttribute (inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 347)) COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 347)), enumerator_12656.current (HERE).getter_mRoutineKind (HERE), var_typedSignature_13025, var_returnTypeProxy_13156, var_attributeSet_12708.getter_hasKey (function_accessAttribute (inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 351)) COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 351)), var_attributeSet_12708.getter_hasKey (function_mutatingAttribute (inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 352)) COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 352)), GALGAS_routineCallingSheme::constructor_staticCall (SOURCE_FILE ("type-structure-declaration.galgas", 353))  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 345)) ;
    {
    var_universalPropertyAndRoutineMapForContext_9907.insulate (HERE) ;
    cPtr_universalPropertyAndRoutineMapForContext * ptr_13729 = (cPtr_universalPropertyAndRoutineMapForContext *) var_universalPropertyAndRoutineMapForContext_9907.ptr () ;
    callExtensionSetter_insertRoutine ((cPtr_universalPropertyAndRoutineMapForContext *) ptr_13729, enumerator_12656.current (HERE).getter_mName (HERE), var_signature_12849, var_invocationName_13212, var_descriptor_13377, inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 356)) ;
    }
    enumerator_12656.gotoNextObject () ;
  }
  {
  ioArgument_ioContext.mProperty_mTypeMap.setter_insertType (object->mProperty_mStructureName, GALGAS_PLMType::constructor_structure (object->mProperty_mStructureName, var_propertyMap_9979, var_methodMap_10018, var_universalPropertyAndRoutineMapForContext_9907, var_propertyList_9947, var_flags_10773, object->mProperty_mStructureName.getter_string (SOURCE_FILE ("type-structure-declaration.galgas", 373))  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 366)), ioArgument_ioContext.getter_mTypeMap (HERE).getter_count (SOURCE_FILE ("type-structure-declaration.galgas", 375)), inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 364)) ;
  }
}
...
static void extensionMethod_structureDeclarationAST_enterRoutinesInContext (const cPtr_abstractDeclarationAST * inObject,
  ...
  const cPtr_structureDeclarationAST * object = (const cPtr_structureDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_structureDeclarationAST) ;
  extensionMethod_enterFunctionInContext (object->mProperty_mFunctionDeclarationListAST, function_llvmRegularTypeMangledNameFromName (object->mProperty_mStructureName, inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 505)).getter_string (HERE), ioArgument_ioContext, inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 504)) ;
  extensionMethod_enterInContext (object->mProperty_mSystemRoutineListAST, function_llvmRegularTypeMangledNameFromName (object->mProperty_mStructureName, inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 509)).getter_string (HERE), ioArgument_ioContext, inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 508)) ;
  extensionMethod_enterInContext (object->mProperty_mGuardListAST, function_llvmRegularTypeMangledNameFromName (object->mProperty_mStructureName, inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 513)).getter_string (HERE), ioArgument_ioContext, inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 512)) ;
}
...
static void extensionMethod_structureDeclarationAST_semanticAnalysis (const cPtr_abstractDeclarationAST * inObject,
  ...
  const cPtr_structureDeclarationAST * object = (const cPtr_structureDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_structureDeclarationAST) ;
  GALGAS_PLMType var_structureType_20129 = GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inContext.getter_mTypeMap (HERE), object->mProperty_mStructureName, inCompiler  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 527)).getter_type (inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 527)) ;
  const GALGAS_structureDeclarationAST temp_0 = object ;
  callExtensionMethod_functionSemanticAnalysis ((const cPtr_structureDeclarationAST *) temp_0.ptr (), var_structureType_20129, constinArgument_inContext, ioArgument_ioTemporaries, ioArgument_ioIntermediateCodeStruct, inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 529)) ;
  extensionMethod_systemRoutineSemanticAnalysis (object->mProperty_mSystemRoutineListAST, var_structureType_20129, constinArgument_inContext, ioArgument_ioTemporaries, ioArgument_ioIntermediateCodeStruct, inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 536)) ;
  extensionMethod_guardSemanticAnalysis (object->mProperty_mGuardListAST, var_structureType_20129, constinArgument_inContext, ioArgument_ioTemporaries, ioArgument_ioIntermediateCodeStruct, inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 543)) ;
  {
  routine_generatePropertyAccess (var_structureType_20129, ioArgument_ioIntermediateCodeStruct, inCompiler  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 550)) ;
  }
}
...
void routine_generatePropertyAccess (const GALGAS_PLMType constinArgument_inType,
                                     ...
                                     C_Compiler * inCompiler
                                     COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_propertyMap var_propertyMap_23923 ;
  GALGAS_lstring joker_23879_1 ; // Joker input parameter
  GALGAS_routineMapForContext joker_23925_5 ; // Joker input parameter
  GALGAS_universalPropertyAndRoutineMapForContext joker_23925_4 ; // Joker input parameter
  GALGAS_propertyList joker_23925_3 ; // Joker input parameter
  GALGAS_PLMTypeFlags joker_23925_2 ; // Joker input parameter
  GALGAS_string joker_23925_1 ; // Joker input parameter
  constinArgument_inType.method_structure (joker_23879_1, var_propertyMap_23923, joker_23925_5, joker_23925_4, joker_23925_3, joker_23925_2, joker_23925_1, inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 624)) ;
  cEnumerator_propertyMap enumerator_23979 (var_propertyMap_23923, kENUMERATION_UP) ;
  while (enumerator_23979.hasCurrentObject ()) {
    GALGAS_PLMType var_propertyType_24028 ;
    GALGAS_propertyAccessKind var_access_24058 ;
    GALGAS_lstring joker_24038 ; // Joker input parameter
    enumerator_23979.current_mPropertyObject (HERE).method_property (var_propertyType_24028, joker_24038, var_access_24058, inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 626)) ;
    ioArgument_ioIntermediateCodeStruct.mProperty_mPropertyAccessRoutineList.addAssign_operation (constinArgument_inType, var_propertyType_24028, enumerator_23979.current_lkey (HERE).getter_string (HERE), var_access_24058  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 627)) ;
    enumerator_23979.gotoNextObject () ;
  }
}
...
void routine_buildControlRegisterMapHTMLFile (const GALGAS_controlRegisterMap constinArgument_inControlRegisterMap,
                                              ...
                                              C_Compiler * inCompiler
                                              COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_typeDumpFilePath_16983 = constinArgument_inSourceFile.getter_string (HERE).add_operation (GALGAS_string (".control-registers.html"), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 444)) ;
  const enumGalgasBool test_0 = GALGAS_bool (gOption_plm_5F_options_writeControlRegisterHTMLDumpFile.getter_value ()).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_stringset var_firstLetterSet_17133 = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("declaration-control-register.galgas", 446)) ;
    cEnumerator_controlRegisterMap enumerator_17173 (constinArgument_inControlRegisterMap, kENUMERATION_UP) ;
    while (enumerator_17173.hasCurrentObject ()) {
      var_firstLetterSet_17133.addAssign_operation (enumerator_17173.current_lkey (HERE).getter_string (HERE).getter_characterAtIndex (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 448)).getter_string (SOURCE_FILE ("declaration-control-register.galgas", 448))  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 448)) ;
      enumerator_17173.gotoNextObject () ;
    }
    GALGAS_string var_tableOfTypeString_17281 = GALGAS_string::makeEmptyString () ;
    GALGAS_char var_currentFirstLetter_17315 = GALGAS_char (TO_UNICODE (32)) ;
    cEnumerator_controlRegisterMap enumerator_17362 (constinArgument_inControlRegisterMap, kENUMERATION_UP) ;
    while (enumerator_17362.hasCurrentObject ()) {
      const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, var_currentFirstLetter_17315.objectCompare (enumerator_17362.current_lkey (HERE).getter_string (HERE).getter_characterAtIndex (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 453)))).boolEnum () ;
      if (kBoolTrue == test_1) {
        var_currentFirstLetter_17315 = enumerator_17362.current_lkey (HERE).getter_string (HERE).getter_characterAtIndex (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 454)) ;
        var_tableOfTypeString_17281.plusAssign_operation(GALGAS_string ("<br><a name=\"").add_operation (var_currentFirstLetter_17315.getter_uint (SOURCE_FILE ("declaration-control-register.galgas", 455)).getter_string (SOURCE_FILE ("declaration-control-register.galgas", 455)), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 455)).add_operation (GALGAS_string ("\"><b>"), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 455)).add_operation (var_currentFirstLetter_17315.getter_string (SOURCE_FILE ("declaration-control-register.galgas", 455)), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 455)).add_operation (GALGAS_string ("</b></a><br>"), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 455)), inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 455)) ;
      }
      const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, enumerator_17362.current_mArraySize (HERE).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_2) {
        var_tableOfTypeString_17281.plusAssign_operation(function_linkForControlRegister (enumerator_17362.current_lkey (HERE).getter_string (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 458)).add_operation (GALGAS_string ("<br>"), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 458)), inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 458)) ;
      }else if (kBoolFalse == test_2) {
        cEnumerator_range enumerator_17807 (GALGAS_range (GALGAS_uint ((uint32_t) 0U), enumerator_17362.current_mArraySize (HERE).substract_operation (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 460))), kENUMERATION_UP) ;
        while (enumerator_17807.hasCurrentObject ()) {
          var_tableOfTypeString_17281.plusAssign_operation(function_linkForControlRegister (enumerator_17362.current_lkey (HERE).getter_string (HERE).add_operation (GALGAS_string (" ["), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 461)).add_operation (enumerator_17807.current (HERE).getter_string (SOURCE_FILE ("declaration-control-register.galgas", 461)), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 461)).add_operation (GALGAS_string ("]"), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 461)), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 461)).add_operation (GALGAS_string ("<br/>"), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 461)), inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 461)) ;
          enumerator_17807.gotoNextObject () ;
        }
      }
      enumerator_17362.gotoNextObject () ;
    }
    GALGAS_string var_typeDumpString_17972 = GALGAS_string (filewrapperTemplate_controlRegisterDumpGenerationTemplate_dump (inCompiler, constinArgument_inSourceFile.getter_string (HERE).getter_lastPathComponent (SOURCE_FILE ("declaration-control-register.galgas", 466)), constinArgument_inControlRegisterMap, var_firstLetterSet_17133, var_tableOfTypeString_17281 COMMA_SOURCE_FILE ("declaration-control-register.galgas", 465))) ;
    GALGAS_bool joker_18224 ; // Joker input parameter
    var_typeDumpString_17972.method_writeToFileWhenDifferentContents (var_typeDumpFilePath_16983, joker_18224, inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 471)) ;
  }else if (kBoolFalse == test_0) {
    {
    GALGAS_string::class_method_deleteFileIfExists (var_typeDumpFilePath_16983, inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 473)) ;
    }
  }
}
...
GALGAS_string function_fieldIndexColumns (const GALGAS_uint & constinArgument_inBitCount,
  ...
  cEnumerator_range enumerator_19275 (GALGAS_range (GALGAS_uint ((uint32_t) 0U), constinArgument_inBitCount.substract_operation (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 499))), kENUMERATION_DOWN) ;
  while (enumerator_19275.hasCurrentObject ()) {
    result_outResult.plusAssign_operation(GALGAS_string ("<td class=\"fields\">").add_operation (enumerator_19275.current (HERE).getter_string (SOURCE_FILE ("declaration-control-register.galgas", 500)), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 500)).add_operation (GALGAS_string ("</td>"), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 500)), inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 500)) ;
...
GALGAS_uintlist function_arrayIndexListFor (const GALGAS_uint & constinArgument_inSize,
  ...
  cEnumerator_range enumerator_19576 (GALGAS_range (GALGAS_uint ((uint32_t) 0U), constinArgument_inSize.substract_operation (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 508))), kENUMERATION_UP) ;
  while (enumerator_19576.hasCurrentObject ()) {
    result_outResult.addAssign_operation (enumerator_19576.current (HERE)  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 509)) ;
...
static void extensionMethod_staticArrayAST_enterInContext (const cPtr_abstractDeclarationAST * inObject,
  ...
  GALGAS_PLMType var_kind_8989 = GALGAS_PLMType::constructor_structure (function_llvmNameForStaticListElementType (object->mProperty_mStaticListName, inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 222)), var_staticlistPropertyMap_6011, GALGAS_routineMapForContext::constructor_default (SOURCE_FILE ("declaration-static-array.galgas", 224)), var_universalMap_6073, var_propertyList_5969, GALGAS_PLMTypeFlags::constructor_none (SOURCE_FILE ("declaration-static-array.galgas", 227)), object->mProperty_mStaticListName.getter_string (SOURCE_FILE ("declaration-static-array.galgas", 228))  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 221)) ;
  {
  ioArgument_ioContext.mProperty_mTypeMap.setter_insertType (var_plmTypeName_6136, var_kind_8989, ioArgument_ioContext.getter_mTypeMap (HERE).getter_count (SOURCE_FILE ("declaration-static-array.galgas", 233)), inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 230)) ;
  }
}
...
static void extensionMethod_staticArrayAST_semanticAnalysis (const cPtr_abstractDeclarationAST * inObject,
  ...
  const cPtr_staticArrayAST * object = (const cPtr_staticArrayAST *) inObject ;
  macroValidSharedObject (object, cPtr_staticArrayAST) ;
  GALGAS_lstring var_plmTypeName_10394 = function_plmNameForStaticListElementType (object->mProperty_mStaticListName, inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 256)) ;
  GALGAS_PLMType var_type_10512 ;
  GALGAS_uint joker_10514_1 ; // Joker input parameter
  constinArgument_inContext.getter_mTypeMap (HERE).method_searchKey (var_plmTypeName_10394, var_type_10512, joker_10514_1, inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 257)) ;
  {
  routine_generatePropertyAccess (var_type_10512, ioArgument_ioIntermediateCodeStruct, inCompiler  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 258)) ;
  }
}
...
static void extensionMethod_complexCallNoSelfInstructionAST_baseGuardAnalyze (const cPtr_callInstructionAST * inObject,
  ...
  GALGAS_allocaList var_baseGuardAllocaList_11890 = GALGAS_allocaList::constructor_emptyList (SOURCE_FILE ("declaration-guard.galgas", 321)) ;
  GALGAS_instructionListIR var_baseGuardInstructionGenerationList_11951 = GALGAS_instructionListIR::constructor_emptyList (SOURCE_FILE ("declaration-guard.galgas", 322)) ;
  GALGAS_objectIR var_currentObject_12082 ;
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_1) {
      TC_Array <C_FixItDescription> fixItArray2 ;
      inCompiler->emitSemanticError (object->mProperty_mAssignmentTargetAST_32_.getter_mIdentifier (HERE).getter_location (SOURCE_FILE ("declaration-guard.galgas", 327)), GALGAS_string ("self is not available in this context"), fixItArray2  COMMA_SOURCE_FILE ("declaration-guard.galgas", 327)) ;
      var_currentObject_12082.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_1) {
      var_currentObject_12082 = GALGAS_objectIR::constructor_temporaryReference (constinArgument_inSelfType, GALGAS_lstring::constructor_new (GALGAS_string ("%self"), object->mProperty_mAssignmentTargetAST_32_.getter_mIdentifier (HERE).getter_location (HERE)  COMMA_SOURCE_FILE ("declaration-guard.galgas", 329))  COMMA_SOURCE_FILE ("declaration-guard.galgas", 329)) ;
    }
  }else if (kBoolFalse == test_0) {
    callExtensionMethod_searchValuedObject ((const cPtr_universalPropertyAndRoutineMapForContext *) ioArgument_ioUniversalMap.ptr (), object->mProperty_mAssignmentTargetAST_32_.getter_mIdentifier (HERE), var_currentObject_12082, inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 332)) ;
  }
  GALGAS_location var_currentErrorLocation_12671 = object->mProperty_mAssignmentTargetAST_32_.getter_mIdentifier (HERE).getter_location (HERE) ;
  GALGAS_universalPropertyAndRoutineMapForContext var_currentMap_12733 = ioArgument_ioUniversalMap ;
  GALGAS_accessInAssignmentListAST var_accessList_12793 = object->mProperty_mAssignmentTargetAST_32_.getter_mAccessList (HERE) ;
  GALGAS_accessInAssignmentAST var_lastAccess_12869 ;
  {
  var_accessList_12793.setter_popLast (var_lastAccess_12869, inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 339)) ;
  }
  cEnumerator_accessInAssignmentListAST enumerator_12925 (var_accessList_12793, kENUMERATION_UP) ;
  while (enumerator_12925.hasCurrentObject ()) {
    GALGAS_PLMType var_currentType_12948 = extensionGetter_type (var_currentObject_12082, inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 342)) ;
    switch (enumerator_12925.current_mAccess (HERE).enumValue ()) {
    case GALGAS_accessInAssignmentAST::kNotBuilt:
      break ;
    case GALGAS_accessInAssignmentAST::kEnum_property:
      {
        const cEnumAssociatedValues_accessInAssignmentAST_property * extractPtr_13694 = (const cEnumAssociatedValues_accessInAssignmentAST_property *) (enumerator_12925.current_mAccess (HERE).unsafePointer ()) ;
        const GALGAS_lstring extractedValue_propertyName = extractPtr_13694->mAssociatedValue0 ;
        const enumGalgasBool test_3 = var_currentType_12948.getter_isStructure (SOURCE_FILE ("declaration-guard.galgas", 345)).boolEnum () ;
        if (kBoolTrue == test_3) {
          GALGAS_universalPropertyAndRoutineMapForContext var_universalMap_13139 ;
          GALGAS_lstring joker_13106_3 ; // Joker input parameter
          GALGAS_propertyMap joker_13106_2 ; // Joker input parameter
          GALGAS_routineMapForContext joker_13106_1 ; // Joker input parameter
          GALGAS_propertyList joker_13141_3 ; // Joker input parameter
          GALGAS_PLMTypeFlags joker_13141_2 ; // Joker input parameter
          GALGAS_string joker_13141_1 ; // Joker input parameter
          var_currentType_12948.method_structure (joker_13106_3, joker_13106_2, joker_13106_1, var_universalMap_13139, joker_13141_3, joker_13141_2, joker_13141_1, inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 346)) ;
          GALGAS_objectIR var_propertyObject_13219 ;
          callExtensionMethod_searchValuedObject ((const cPtr_universalPropertyAndRoutineMapForContext *) var_universalMap_13139.ptr (), extractedValue_propertyName, var_propertyObject_13219, inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 347)) ;
          var_currentMap_12733 = var_universalMap_13139 ;
          var_currentErrorLocation_12671 = extractedValue_propertyName.getter_location (HERE) ;
          GALGAS_objectIR var_newObject_13403 ;
          {
          routine_getNewTempVariable (extensionGetter_type (var_propertyObject_13219, inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 350)), extractedValue_propertyName.getter_location (SOURCE_FILE ("declaration-guard.galgas", 350)), ioArgument_ioTemporaries, var_newObject_13403, inCompiler  COMMA_SOURCE_FILE ("declaration-guard.galgas", 350)) ;
          }
          {
          extensionSetter_appendGetPropertyReference (var_baseGuardInstructionGenerationList_11951, var_newObject_13403, var_currentObject_12082, extractedValue_propertyName.getter_string (SOURCE_FILE ("declaration-guard.galgas", 354)), inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 351)) ;
          }
          var_currentObject_12082 = var_newObject_13403 ;
        }else if (kBoolFalse == test_3) {
          TC_Array <C_FixItDescription> fixItArray4 ;
          inCompiler->emitSemanticError (var_currentErrorLocation_12671, GALGAS_string ("this object has no property"), fixItArray4  COMMA_SOURCE_FILE ("declaration-guard.galgas", 358)) ;
          var_currentObject_12082.drop () ; // Release error dropped variable
        }
      }
      break ;
    case GALGAS_accessInAssignmentAST::kEnum_arrayAccess:
      {
        const cEnumAssociatedValues_accessInAssignmentAST_arrayAccess * extractPtr_13837 = (const cEnumAssociatedValues_accessInAssignmentAST_arrayAccess *) (enumerator_12925.current_mAccess (HERE).unsafePointer ()) ;
        const GALGAS_expressionAST extractedValue_indexExpression = extractPtr_13837->mAssociatedValue0 ;
        const GALGAS_location extractedValue_endOfIndex = extractPtr_13837->mAssociatedValue1 ;
        TC_Array <C_FixItDescription> fixItArray5 ;
        inCompiler->emitSemanticError (extractedValue_endOfIndex, GALGAS_string ("not handled yet"), fixItArray5  COMMA_SOURCE_FILE ("declaration-guard.galgas", 361)) ;
        var_currentObject_12082.drop () ; // Release error dropped variable
      }
      break ;
    }
  ...
  GALGAS_lstring var_methodName_13897 ;
  switch (var_lastAccess_12869.enumValue ()) {
  case GALGAS_accessInAssignmentAST::kNotBuilt:
    break ;
  case GALGAS_accessInAssignmentAST::kEnum_property:
    {
      const cEnumAssociatedValues_accessInAssignmentAST_property * extractPtr_14332 = (const cEnumAssociatedValues_accessInAssignmentAST_property *) (var_lastAccess_12869.unsafePointer ()) ;
      const GALGAS_lstring extractedValue_propertyName = extractPtr_14332->mAssociatedValue0 ;
      var_methodName_13897 = extractedValue_propertyName ;
      GALGAS_PLMType var_currentType_14009 = extensionGetter_type (var_currentObject_12082, inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 369)) ;
      const enumGalgasBool test_6 = var_currentType_14009.getter_isStructure (SOURCE_FILE ("declaration-guard.galgas", 370)).boolEnum () ;
      if (kBoolTrue == test_6) {
        GALGAS_universalPropertyAndRoutineMapForContext var_universalMap_14134 ;
        GALGAS_lstring joker_14101_3 ; // Joker input parameter
        GALGAS_propertyMap joker_14101_2 ; // Joker input parameter
        GALGAS_routineMapForContext joker_14101_1 ; // Joker input parameter
        GALGAS_propertyList joker_14136_3 ; // Joker input parameter
        GALGAS_PLMTypeFlags joker_14136_2 ; // Joker input parameter
        GALGAS_string joker_14136_1 ; // Joker input parameter
        var_currentType_14009.method_structure (joker_14101_3, joker_14101_2, joker_14101_1, var_universalMap_14134, joker_14136_3, joker_14136_2, joker_14136_1, inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 371)) ;
        var_currentMap_12733 = var_universalMap_14134 ;
        var_currentErrorLocation_12671 = extractedValue_propertyName.getter_location (HERE) ;
      }else if (kBoolFalse == test_6) {
        TC_Array <C_FixItDescription> fixItArray7 ;
        inCompiler->emitSemanticError (var_currentErrorLocation_12671, GALGAS_string ("this object has no property"), fixItArray7  COMMA_SOURCE_FILE ("declaration-guard.galgas", 375)) ;
        var_currentObject_12082.drop () ; // Release error dropped variable
        var_methodName_13897.drop () ; // Release error dropped variable
      }
    }
    break ;
  case GALGAS_accessInAssignmentAST::kEnum_arrayAccess:
    {
      const cEnumAssociatedValues_accessInAssignmentAST_arrayAccess * extractPtr_14466 = (const cEnumAssociatedValues_accessInAssignmentAST_arrayAccess *) (var_lastAccess_12869.unsafePointer ()) ;
      const GALGAS_location extractedValue_endOfIndex = extractPtr_14466->mAssociatedValue1 ;
      TC_Array <C_FixItDescription> fixItArray8 ;
      inCompiler->emitSemanticError (extractedValue_endOfIndex, GALGAS_string ("a property access is required here"), fixItArray8  COMMA_SOURCE_FILE ("declaration-guard.galgas", 378)) ;
      var_currentObject_12082.drop () ; // Release error dropped variable
      var_methodName_13897.drop () ; // Release error dropped variable
    }
    break ;
  }
  GALGAS_lstring var_routineMangledName_14563 = function_routineMangledNameFromCall (GALGAS_string ("$").add_operation (extensionGetter_key (extensionGetter_type (var_currentObject_12082, inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 381)), inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 381)), inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 381)), var_methodName_13897, object->mProperty_mArguments, inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 381)) ;
  GALGAS_lstring var_signature_14703 = extensionGetter_routineSignature (object->mProperty_mArguments, var_methodName_13897.getter_location (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 383)) ;
  GALGAS_routineDescriptor var_routineDescriptor_14933 ;
  GALGAS_lstring joker_14849 ; // Joker input parameter
  callExtensionMethod_searchRoutine ((const cPtr_universalPropertyAndRoutineMapForContext *) var_currentMap_12733.ptr (), var_methodName_13897, var_signature_14703, joker_14849, var_routineDescriptor_14933, inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 385)) ;
  GALGAS_procCallEffectiveParameterListIR var_effectiveParameterListIR_15035 = GALGAS_procCallEffectiveParameterListIR::constructor_emptyList (SOURCE_FILE ("declaration-guard.galgas", 392)) ;
  switch (var_routineDescriptor_14933.getter_mRoutineCallingScheme (HERE).enumValue ()) {
  case GALGAS_routineCallingSheme::kNotBuilt:
    break ;
  case GALGAS_routineCallingSheme::kEnum_staticCall:
    {
      var_effectiveParameterListIR_15035.addAssign_operation (GALGAS_procEffectiveParameterPassingModeIR::constructor_outputInput (SOURCE_FILE ("declaration-guard.galgas", 395)), var_currentObject_12082  COMMA_SOURCE_FILE ("declaration-guard.galgas", 395)) ;
    }
    break ;
  ...
  GALGAS_routineTypedSignature var_formalSignature_15416 = var_routineDescriptor_14933.getter_mSignature (HERE) ;
  const enumGalgasBool test_9 = GALGAS_bool (kIsNotEqual, var_routineDescriptor_14933.getter_mReturnTypeProxy (HERE).objectCompare (GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("declaration-guard.galgas", 404)))).boolEnum () ;
  if (kBoolTrue == test_9) {
    TC_Array <C_FixItDescription> fixItArray10 ;
    inCompiler->emitSemanticError (var_methodName_13897.getter_location (SOURCE_FILE ("declaration-guard.galgas", 405)), GALGAS_string ("not a procedure (returns a value)"), fixItArray10  COMMA_SOURCE_FILE ("declaration-guard.galgas", 405)) ;
    var_routineDescriptor_14933.drop () ; // Release error dropped variable
    outArgument_outConvenienceGuardGenerationIR.drop () ; // Release error dropped variable
  }else if (kBoolFalse == test_9) {
    {
    routine_analyzeEffectiveParametersNew (constinArgument_inSelfType, var_formalSignature_15416, object->mProperty_mArguments, var_methodName_13897.getter_location (HERE), constinArgument_inCallerNameForInvocationGraph, constinArgument_inContext, constinArgument_inMode, ioArgument_ioTemporaries, ioArgument_ioGlobalLiteralStringMap, ioArgument_ioUniversalMap, var_baseGuardAllocaList_11890, var_baseGuardInstructionGenerationList_11951, var_effectiveParameterListIR_15035, inCompiler  COMMA_SOURCE_FILE ("declaration-guard.galgas", 415)) ;
    }
    switch (var_routineDescriptor_14933.getter_mRoutineCallingScheme (HERE).enumValue ()) {
    case GALGAS_routineCallingSheme::kNotBuilt:
      break ;
    case GALGAS_routineCallingSheme::kEnum_staticCall:
      {
        outArgument_outConvenienceGuardGenerationIR = GALGAS_guardKindGenerationIR::constructor_convenienceGuard (var_baseGuardAllocaList_11890, var_baseGuardInstructionGenerationList_11951, var_routineMangledName_14563.getter_string (HERE), var_effectiveParameterListIR_15035  COMMA_SOURCE_FILE ("declaration-guard.galgas", 433)) ;
      }
      break ;
    case GALGAS_routineCallingSheme::kEnum_propertyIndirectCall:
      {
        TC_Array <C_FixItDescription> fixItArray11 ;
        inCompiler->emitSemanticError (GALGAS_location::constructor_nowhere (SOURCE_FILE ("declaration-guard.galgas", 440)), GALGAS_string ("NOT HANDLED YET"), fixItArray11  COMMA_SOURCE_FILE ("declaration-guard.galgas", 440)) ;
        outArgument_outConvenienceGuardGenerationIR.drop () ; // Release error dropped variable
      }
      break ;
    }
...
static void extensionMethod_complexCallSelfInstructionAST_baseGuardAnalyze (const cPtr_callInstructionAST * inObject,
  ...
  GALGAS_allocaList var_baseGuardAllocaList_17602 = GALGAS_allocaList::constructor_emptyList (SOURCE_FILE ("declaration-guard.galgas", 457)) ;
  GALGAS_instructionListIR var_baseGuardInstructionGenerationList_17663 = GALGAS_instructionListIR::constructor_emptyList (SOURCE_FILE ("declaration-guard.galgas", 458)) ;
  GALGAS_location var_currentErrorLocation_17700 = object->mProperty_mAssignmentTargetAST.getter_mSelfLocation (HERE) ;
  GALGAS_universalPropertyAndRoutineMapForContext var_currentMap_17852 = GALGAS_universalPropertyAndRoutineMapForContext::constructor_default (SOURCE_FILE ("declaration-guard.galgas", 462)) ;
  GALGAS_objectIR var_currentObject_18059 ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, object->mProperty_mAssignmentTargetAST.getter_mIdentifier (HERE).getter_string (HERE).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
  if (kBoolTrue == test_0) {
    const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, constinArgument_inSelfType.objectCompare (GALGAS_PLMType::constructor_void (SOURCE_FILE ("declaration-guard.galgas", 467)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      TC_Array <C_FixItDescription> fixItArray2 ;
      inCompiler->emitSemanticError (object->mProperty_mAssignmentTargetAST.getter_mIdentifier (HERE).getter_location (SOURCE_FILE ("declaration-guard.galgas", 468)), GALGAS_string ("self is not available in this context"), fixItArray2  COMMA_SOURCE_FILE ("declaration-guard.galgas", 468)) ;
      var_currentObject_18059.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_1) {
      var_currentObject_18059 = GALGAS_objectIR::constructor_temporaryReference (constinArgument_inSelfType, GALGAS_lstring::constructor_new (GALGAS_string ("%self"), object->mProperty_mAssignmentTargetAST.getter_mIdentifier (HERE).getter_location (HERE)  COMMA_SOURCE_FILE ("declaration-guard.galgas", 470))  COMMA_SOURCE_FILE ("declaration-guard.galgas", 470)) ;
    }
  }else if (kBoolFalse == test_0) {
    callExtensionMethod_searchValuedObject ((const cPtr_universalPropertyAndRoutineMapForContext *) ioArgument_ioUniversalMap.ptr (), object->mProperty_mAssignmentTargetAST.getter_mIdentifier (HERE), var_currentObject_18059, inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 473)) ;
  }
  GALGAS_accessInAssignmentListAST var_accessList_18561 = object->mProperty_mAssignmentTargetAST.getter_mAccessList (HERE) ;
  GALGAS_accessInAssignmentAST var_lastAccess_18723 ;
  {
  var_accessList_18561.setter_popLast (var_lastAccess_18723, inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 478)) ;
  }
  cEnumerator_accessInAssignmentListAST enumerator_18779 (var_accessList_18561, kENUMERATION_UP) ;
  while (enumerator_18779.hasCurrentObject ()) {
    GALGAS_PLMType var_currentType_18802 = extensionGetter_type (var_currentObject_18059, inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 481)) ;
    switch (enumerator_18779.current_mAccess (HERE).enumValue ()) {
    case GALGAS_accessInAssignmentAST::kNotBuilt:
      break ;
    case GALGAS_accessInAssignmentAST::kEnum_property:
      {
        const cEnumAssociatedValues_accessInAssignmentAST_property * extractPtr_19548 = (const cEnumAssociatedValues_accessInAssignmentAST_property *) (enumerator_18779.current_mAccess (HERE).unsafePointer ()) ;
        const GALGAS_lstring extractedValue_propertyName = extractPtr_19548->mAssociatedValue0 ;
        const enumGalgasBool test_3 = var_currentType_18802.getter_isStructure (SOURCE_FILE ("declaration-guard.galgas", 484)).boolEnum () ;
        if (kBoolTrue == test_3) {
          GALGAS_universalPropertyAndRoutineMapForContext var_universalMap_18993 ;
          GALGAS_lstring joker_18960_3 ; // Joker input parameter
          GALGAS_propertyMap joker_18960_2 ; // Joker input parameter
          GALGAS_routineMapForContext joker_18960_1 ; // Joker input parameter
          GALGAS_propertyList joker_18995_3 ; // Joker input parameter
          GALGAS_PLMTypeFlags joker_18995_2 ; // Joker input parameter
          GALGAS_string joker_18995_1 ; // Joker input parameter
          var_currentType_18802.method_structure (joker_18960_3, joker_18960_2, joker_18960_1, var_universalMap_18993, joker_18995_3, joker_18995_2, joker_18995_1, inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 485)) ;
          GALGAS_objectIR var_propertyObject_19073 ;
          callExtensionMethod_searchValuedObject ((const cPtr_universalPropertyAndRoutineMapForContext *) var_universalMap_18993.ptr (), extractedValue_propertyName, var_propertyObject_19073, inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 486)) ;
          var_currentMap_17852 = var_universalMap_18993 ;
          var_currentErrorLocation_17700 = extractedValue_propertyName.getter_location (HERE) ;
          GALGAS_objectIR var_newObject_19257 ;
          {
          routine_getNewTempVariable (extensionGetter_type (var_propertyObject_19073, inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 489)), extractedValue_propertyName.getter_location (SOURCE_FILE ("declaration-guard.galgas", 489)), ioArgument_ioTemporaries, var_newObject_19257, inCompiler  COMMA_SOURCE_FILE ("declaration-guard.galgas", 489)) ;
          }
          {
          extensionSetter_appendGetPropertyReference (var_baseGuardInstructionGenerationList_17663, var_newObject_19257, var_currentObject_18059, extractedValue_propertyName.getter_string (SOURCE_FILE ("declaration-guard.galgas", 493)), inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 490)) ;
          }
          var_currentObject_18059 = var_newObject_19257 ;
        }else if (kBoolFalse == test_3) {
          TC_Array <C_FixItDescription> fixItArray4 ;
          inCompiler->emitSemanticError (var_currentErrorLocation_17700, GALGAS_string ("this object has no property"), fixItArray4  COMMA_SOURCE_FILE ("declaration-guard.galgas", 497)) ;
          var_currentObject_18059.drop () ; // Release error dropped variable
        }
      }
      break ;
    case GALGAS_accessInAssignmentAST::kEnum_arrayAccess:
      {
        const cEnumAssociatedValues_accessInAssignmentAST_arrayAccess * extractPtr_19691 = (const cEnumAssociatedValues_accessInAssignmentAST_arrayAccess *) (enumerator_18779.current_mAccess (HERE).unsafePointer ()) ;
        const GALGAS_expressionAST extractedValue_indexExpression = extractPtr_19691->mAssociatedValue0 ;
        const GALGAS_location extractedValue_endOfIndex = extractPtr_19691->mAssociatedValue1 ;
        TC_Array <C_FixItDescription> fixItArray5 ;
        inCompiler->emitSemanticError (extractedValue_endOfIndex, GALGAS_string ("not handled yet"), fixItArray5  COMMA_SOURCE_FILE ("declaration-guard.galgas", 500)) ;
        var_currentObject_18059.drop () ; // Release error dropped variable
      }
      break ;
    }
  ...
  GALGAS_lstring var_methodName_19751 ;
  switch (var_lastAccess_18723.enumValue ()) {
  case GALGAS_accessInAssignmentAST::kNotBuilt:
    break ;
  case GALGAS_accessInAssignmentAST::kEnum_property:
    {
      const cEnumAssociatedValues_accessInAssignmentAST_property * extractPtr_20186 = (const cEnumAssociatedValues_accessInAssignmentAST_property *) (var_lastAccess_18723.unsafePointer ()) ;
      const GALGAS_lstring extractedValue_propertyName = extractPtr_20186->mAssociatedValue0 ;
      var_methodName_19751 = extractedValue_propertyName ;
      GALGAS_PLMType var_currentType_19863 = extensionGetter_type (var_currentObject_18059, inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 508)) ;
      const enumGalgasBool test_6 = var_currentType_19863.getter_isStructure (SOURCE_FILE ("declaration-guard.galgas", 509)).boolEnum () ;
      if (kBoolTrue == test_6) {
        GALGAS_universalPropertyAndRoutineMapForContext var_universalMap_19988 ;
        GALGAS_lstring joker_19955_3 ; // Joker input parameter
        GALGAS_propertyMap joker_19955_2 ; // Joker input parameter
        GALGAS_routineMapForContext joker_19955_1 ; // Joker input parameter
        GALGAS_propertyList joker_19990_3 ; // Joker input parameter
        GALGAS_PLMTypeFlags joker_19990_2 ; // Joker input parameter
        GALGAS_string joker_19990_1 ; // Joker input parameter
        var_currentType_19863.method_structure (joker_19955_3, joker_19955_2, joker_19955_1, var_universalMap_19988, joker_19990_3, joker_19990_2, joker_19990_1, inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 510)) ;
        var_currentMap_17852 = var_universalMap_19988 ;
        var_currentErrorLocation_17700 = extractedValue_propertyName.getter_location (HERE) ;
      }else if (kBoolFalse == test_6) {
        TC_Array <C_FixItDescription> fixItArray7 ;
        inCompiler->emitSemanticError (var_currentErrorLocation_17700, GALGAS_string ("this object has no property"), fixItArray7  COMMA_SOURCE_FILE ("declaration-guard.galgas", 514)) ;
        var_currentObject_18059.drop () ; // Release error dropped variable
        var_methodName_19751.drop () ; // Release error dropped variable
      }
    }
    break ;
  case GALGAS_accessInAssignmentAST::kEnum_arrayAccess:
    {
      const cEnumAssociatedValues_accessInAssignmentAST_arrayAccess * extractPtr_20320 = (const cEnumAssociatedValues_accessInAssignmentAST_arrayAccess *) (var_lastAccess_18723.unsafePointer ()) ;
      const GALGAS_location extractedValue_endOfIndex = extractPtr_20320->mAssociatedValue1 ;
      TC_Array <C_FixItDescription> fixItArray8 ;
      inCompiler->emitSemanticError (extractedValue_endOfIndex, GALGAS_string ("a property access is required here"), fixItArray8  COMMA_SOURCE_FILE ("declaration-guard.galgas", 517)) ;
      var_currentObject_18059.drop () ; // Release error dropped variable
      var_methodName_19751.drop () ; // Release error dropped variable
    }
    break ;
  }
  GALGAS_lstring var_routineMangledName_20417 = function_routineMangledNameFromCall (GALGAS_string ("$").add_operation (extensionGetter_key (extensionGetter_type (var_currentObject_18059, inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 520)), inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 520)), inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 520)), var_methodName_19751, object->mProperty_mArguments, inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 520)) ;
  GALGAS_lstring var_signature_20557 = extensionGetter_routineSignature (object->mProperty_mArguments, var_methodName_19751.getter_location (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 522)) ;
  GALGAS_routineDescriptor var_routineDescriptor_20786 ;
  GALGAS_lstring joker_20703 ; // Joker input parameter
  callExtensionMethod_searchRoutine ((const cPtr_universalPropertyAndRoutineMapForContext *) var_currentMap_17852.ptr (), var_methodName_19751, var_signature_20557, joker_20703, var_routineDescriptor_20786, inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 524)) ;
  GALGAS_procCallEffectiveParameterListIR var_effectiveParameterListIR_20888 = GALGAS_procCallEffectiveParameterListIR::constructor_emptyList (SOURCE_FILE ("declaration-guard.galgas", 531)) ;
  switch (var_routineDescriptor_20786.getter_mRoutineCallingScheme (HERE).enumValue ()) {
  case GALGAS_routineCallingSheme::kNotBuilt:
    break ;
  case GALGAS_routineCallingSheme::kEnum_staticCall:
    {
      var_effectiveParameterListIR_20888.addAssign_operation (GALGAS_procEffectiveParameterPassingModeIR::constructor_outputInput (SOURCE_FILE ("declaration-guard.galgas", 534)), var_currentObject_18059  COMMA_SOURCE_FILE ("declaration-guard.galgas", 534)) ;
    }
    break ;
  case GALGAS_routineCallingSheme::kEnum_propertyIndirectCall:
    {
  ...
  GALGAS_routineTypedSignature var_formalSignature_21269 = var_routineDescriptor_20786.getter_mSignature (HERE) ;
  const enumGalgasBool test_9 = GALGAS_bool (kIsNotEqual, var_routineDescriptor_20786.getter_mReturnTypeProxy (HERE).objectCompare (GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("declaration-guard.galgas", 543)))).boolEnum () ;
  if (kBoolTrue == test_9) {
    TC_Array <C_FixItDescription> fixItArray10 ;
    inCompiler->emitSemanticError (var_methodName_19751.getter_location (SOURCE_FILE ("declaration-guard.galgas", 544)), GALGAS_string ("not a procedure (returns a value)"), fixItArray10  COMMA_SOURCE_FILE ("declaration-guard.galgas", 544)) ;
    var_routineDescriptor_20786.drop () ; // Release error dropped variable
    outArgument_outConvenienceGuardGenerationIR.drop () ; // Release error dropped variable
  }else if (kBoolFalse == test_9) {
    {
    routine_analyzeEffectiveParametersNew (constinArgument_inSelfType, var_formalSignature_21269, object->mProperty_mArguments, var_methodName_19751.getter_location (HERE), constinArgument_inCallerNameForInvocationGraph, constinArgument_inContext, constinArgument_inCurrentMode, ioArgument_ioTemporaries, ioArgument_ioGlobalLiteralStringMap, ioArgument_ioUniversalMap, var_baseGuardAllocaList_17602, var_baseGuardInstructionGenerationList_17663, var_effectiveParameterListIR_20888, inCompiler  COMMA_SOURCE_FILE ("declaration-guard.galgas", 554)) ;
    }
    switch (var_routineDescriptor_20786.getter_mRoutineCallingScheme (HERE).enumValue ()) {
    case GALGAS_routineCallingSheme::kNotBuilt:
      break ;
    case GALGAS_routineCallingSheme::kEnum_staticCall:
      {
        outArgument_outConvenienceGuardGenerationIR = GALGAS_guardKindGenerationIR::constructor_convenienceGuard (var_baseGuardAllocaList_17602, var_baseGuardInstructionGenerationList_17663, var_routineMangledName_20417.getter_string (HERE), var_effectiveParameterListIR_20888  COMMA_SOURCE_FILE ("declaration-guard.galgas", 572)) ;
      }
      break ;
    case GALGAS_routineCallingSheme::kEnum_propertyIndirectCall:
      {
        TC_Array <C_FixItDescription> fixItArray11 ;
        inCompiler->emitSemanticError (GALGAS_location::constructor_nowhere (SOURCE_FILE ("declaration-guard.galgas", 579)), GALGAS_string ("NOT HANDLED YET"), fixItArray11  COMMA_SOURCE_FILE ("declaration-guard.galgas", 579)) ;
        outArgument_outConvenienceGuardGenerationIR.drop () ; // Release error dropped variable
      }
      break ;
    }
