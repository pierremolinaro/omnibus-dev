...
static void categoryMethod_onInstructionIR_llvmInstructionCode (const cPtr_abstractInstructionIR * inObject,
  ...
  ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  call void @").add_operation (var_enterInGuard, inCompiler COMMA_SOURCE_FILE ("instruction-on.galgas", 243)).add_operation (GALGAS_string (" ()\n"), inCompiler COMMA_SOURCE_FILE ("instruction-on.galgas", 243)), inCompiler  COMMA_SOURCE_FILE ("instruction-on.galgas", 243)) ;
  ...
  cEnumerator_onInstructionBranchListIR enumerator_10368 (object->mAttribute_mOnInstructionBranchListIR, kEnumeration_up) ;
  GALGAS_uint index_10331 ((uint32_t) 0) ;
  while (enumerator_10368.hasCurrentObject ()) {
    categoryMethod_instructionListLLVMCode (enumerator_10368.current (HERE).mAttribute_mGuardInstructionGenerationList, ioArgument_ioLLVMcode, constinArgument_inGenerationContext, ioArgument_ioGenerationAdds, inCompiler COMMA_SOURCE_FILE ("instruction-on.galgas", 246)) ;
    GALGAS_string var_acceptanceVarName = GALGAS_string ("%").add_operation (var_onLabel, inCompiler COMMA_SOURCE_FILE ("instruction-on.galgas", 247)).add_operation (GALGAS_string (".accept."), inCompiler COMMA_SOURCE_FILE ("instruction-on.galgas", 247)).add_operation (index_10331.getter_string (SOURCE_FILE ("instruction-on.galgas", 247)), inCompiler COMMA_SOURCE_FILE ("instruction-on.galgas", 247)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  ").add_operation (var_acceptanceVarName, inCompiler COMMA_SOURCE_FILE ("instruction-on.galgas", 248)).add_operation (GALGAS_string (" = call i1 @"), inCompiler COMMA_SOURCE_FILE ("instruction-on.galgas", 248)).add_operation (function_llvmNameForGuardCall (enumerator_10368.current (HERE).mAttribute_mGuardMangledName, inCompiler COMMA_SOURCE_FILE ("instruction-on.galgas", 248)), inCompiler COMMA_SOURCE_FILE ("instruction-on.galgas", 248)), inCompiler  COMMA_SOURCE_FILE ("instruction-on.galgas", 248)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string (" ("), inCompiler  COMMA_SOURCE_FILE ("instruction-on.galgas", 249)) ;
    cEnumerator_procCallEffectiveParameterListIR enumerator_10742 (enumerator_10368.current (HERE).mAttribute_mEffectiveParameterListIR, kEnumeration_up) ;
    while (enumerator_10742.hasCurrentObject ()) {
      switch (enumerator_10742.current_mEffectiveParameterPassingMode (HERE).enumValue ()) {
      case GALGAS_procEffectiveParameterPassingModeIR::kNotBuilt:
        break ;
      case GALGAS_procEffectiveParameterPassingModeIR::kEnum_input:
        {
          ioArgument_ioLLVMcode.plusAssign_operation(enumerator_10742.current_mParameter (HERE).mAttribute_mType.getter_llvmTypeName (inCompiler COMMA_SOURCE_FILE ("instruction-on.galgas", 253)).add_operation (GALGAS_string ("* "), inCompiler COMMA_SOURCE_FILE ("instruction-on.galgas", 253)).add_operation (extensionGetter_llvmName (enumerator_10742.current_mParameter (HERE).mAttribute_mValue, inCompiler COMMA_SOURCE_FILE ("instruction-on.galgas", 253)), inCompiler COMMA_SOURCE_FILE ("instruction-on.galgas", 253)), inCompiler  COMMA_SOURCE_FILE ("instruction-on.galgas", 253)) ;
        }
        break ;
      case GALGAS_procEffectiveParameterPassingModeIR::kEnum_output:
        {
          ioArgument_ioLLVMcode.plusAssign_operation(enumerator_10742.current_mParameter (HERE).mAttribute_mType.getter_llvmTypeName (inCompiler COMMA_SOURCE_FILE ("instruction-on.galgas", 255)).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("instruction-on.galgas", 255)).add_operation (extensionGetter_llvmName (enumerator_10742.current_mParameter (HERE).mAttribute_mValue, inCompiler COMMA_SOURCE_FILE ("instruction-on.galgas", 255)), inCompiler COMMA_SOURCE_FILE ("instruction-on.galgas", 255)), inCompiler  COMMA_SOURCE_FILE ("instruction-on.galgas", 255)) ;
        }
        break ;
      case GALGAS_procEffectiveParameterPassingModeIR::kEnum_outputInput:
        {
          ioArgument_ioLLVMcode.plusAssign_operation(enumerator_10742.current_mParameter (HERE).mAttribute_mType.getter_llvmTypeName (inCompiler COMMA_SOURCE_FILE ("instruction-on.galgas", 257)).add_operation (GALGAS_string ("* "), inCompiler COMMA_SOURCE_FILE ("instruction-on.galgas", 257)).add_operation (extensionGetter_llvmName (enumerator_10742.current_mParameter (HERE).mAttribute_mValue, inCompiler COMMA_SOURCE_FILE ("instruction-on.galgas", 257)), inCompiler COMMA_SOURCE_FILE ("instruction-on.galgas", 257)), inCompiler  COMMA_SOURCE_FILE ("instruction-on.galgas", 257)) ;
        }
        break ;
      }
      if (enumerator_10742.hasNextObject ()) {
    ...
    GALGAS_string var_acceptedLabelName = var_onLabel.add_operation (GALGAS_string (".accepted."), inCompiler COMMA_SOURCE_FILE ("instruction-on.galgas", 263)).add_operation (index_10331.getter_string (SOURCE_FILE ("instruction-on.galgas", 263)), inCompiler COMMA_SOURCE_FILE ("instruction-on.galgas", 263)) ;
    GALGAS_string var_rejectedLabelName = var_onLabel.add_operation (GALGAS_string (".rejected."), inCompiler COMMA_SOURCE_FILE ("instruction-on.galgas", 264)).add_operation (index_10331.getter_string (SOURCE_FILE ("instruction-on.galgas", 264)), inCompiler COMMA_SOURCE_FILE ("instruction-on.galgas", 264)) ;
    ...
    categoryMethod_instructionListLLVMCode (enumerator_10368.current (HERE).mAttribute_mInstructionGenerationList, ioArgument_ioLLVMcode, constinArgument_inGenerationContext, ioArgument_ioGenerationAdds, inCompiler COMMA_SOURCE_FILE ("instruction-on.galgas", 267)) ;
    ...
    index_10331.increment_operation (inCompiler  COMMA_SOURCE_FILE ("instruction-on.galgas", 245)) ;
  }
...
static void categoryMethod_onInstructionIR_enterAccessibleEntities (const cPtr_abstractInstructionIR * inObject,
  ...
  const cPtr_onInstructionIR * object = (const cPtr_onInstructionIR *) inObject ;
  macroValidSharedObject (object, cPtr_onInstructionIR) ;
  GALGAS_uint var_branchCount = object->mAttribute_mOnInstructionBranchListIR.getter_length (SOURCE_FILE ("instruction-on.galgas", 282)) ;
  ...
  cEnumerator_onInstructionBranchListIR enumerator_12382 (object->mAttribute_mOnInstructionBranchListIR, kEnumeration_up) ;
  while (enumerator_12382.hasCurrentObject ()) {
    categoryMethod_enterAccessibleEntities (enumerator_12382.current (HERE).mAttribute_mGuardInstructionGenerationList, ioArgument_ioAccessibleEntities, ioArgument_ioMaxBranchOfOnInstructions, inCompiler COMMA_SOURCE_FILE ("instruction-on.galgas", 287)) ;
    categoryMethod_enterAccessibleEntities (enumerator_12382.current (HERE).mAttribute_mGuardInstructionGenerationList, ioArgument_ioAccessibleEntities, ioArgument_ioMaxBranchOfOnInstructions, inCompiler COMMA_SOURCE_FILE ("instruction-on.galgas", 288)) ;
    categoryMethod_enterAccessibleEntities (enumerator_12382.current (HERE).mAttribute_mInstructionGenerationList, ioArgument_ioAccessibleEntities, ioArgument_ioMaxBranchOfOnInstructions, inCompiler COMMA_SOURCE_FILE ("instruction-on.galgas", 289)) ;
    ioArgument_ioAccessibleEntities.mAttribute_mGuardSet.addAssign_operation (enumerator_12382.current (HERE).mAttribute_mGuardMangledName  COMMA_SOURCE_FILE ("instruction-on.galgas", 290)) ;
