...
void extensionMethod_llvmCodeGeneration (const GALGAS_routineMapIR_2D_element inObject,
  ...
  cEnumerator_allocaList enumerator_8483 (inObject.mProperty_mAllocaList, kENUMERATION_UP) ;
  while (enumerator_8483.hasCurrentObject ()) {
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  %").add_operation (function_llvmNameForLocalVariable (enumerator_8483.current_mVarName (HERE), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 212)), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 212)).add_operation (GALGAS_string (" = alloca "), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 212)).add_operation (enumerator_8483.current_mLLVMTypeName (HERE), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 212)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 212)), inCompiler  COMMA_SOURCE_FILE ("semantic-routines.galgas", 212)) ;
    enumerator_8483.gotoNextObject () ;
  }
  cEnumerator_routineFormalArgumentListForGeneration enumerator_8674 (inObject.mProperty_mFormalArgumentListForGeneration, kENUMERATION_UP) ;
  while (enumerator_8674.hasCurrentObject ()) {
    switch (enumerator_8674.current_mFormalArgumentKind (HERE).enumValue ()) {
    case GALGAS_procFormalArgumentPassingMode::kNotBuilt:
      break ;
    case GALGAS_procFormalArgumentPassingMode::kEnum_input:
      {
        GALGAS_string var_llvmType_8744 = extensionGetter_llvmTypeName (enumerator_8674.current_mFormalArgumentType (HERE), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 218)) ;
        ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  %").add_operation (function_llvmNameForLocalVariable (enumerator_8674.current_mFormalArgumentName (HERE), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 219)), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 219)).add_operation (GALGAS_string (" = alloca "), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 219)).add_operation (var_llvmType_8744, inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 219)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 219)), inCompiler  COMMA_SOURCE_FILE ("semantic-routines.galgas", 219)) ;
      }
      break ;
    case GALGAS_procFormalArgumentPassingMode::kEnum_output:
    case GALGAS_procFormalArgumentPassingMode::kEnum_inputOutput:
  ...
  cEnumerator_routineFormalArgumentListForGeneration enumerator_8980 (inObject.mProperty_mFormalArgumentListForGeneration, kENUMERATION_UP) ;
  while (enumerator_8980.hasCurrentObject ()) {
    switch (enumerator_8980.current_mFormalArgumentKind (HERE).enumValue ()) {
    case GALGAS_procFormalArgumentPassingMode::kNotBuilt:
      break ;
    case GALGAS_procFormalArgumentPassingMode::kEnum_input:
      {
        GALGAS_string var_llvmType_9050 = extensionGetter_llvmTypeName (enumerator_8980.current_mFormalArgumentType (HERE), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 226)) ;
        ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  store ").add_operation (var_llvmType_9050, inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 227)).add_operation (GALGAS_string (" %in."), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 227)).add_operation (enumerator_8980.current_mFormalArgumentName (HERE), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 227)).add_operation (GALGAS_string (", "), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 227)).add_operation (var_llvmType_9050, inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 227)).add_operation (GALGAS_string (" * %"), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 227)).add_operation (function_llvmNameForLocalVariable (enumerator_8980.current_mFormalArgumentName (HERE), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 228)), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 227)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 228)), inCompiler  COMMA_SOURCE_FILE ("semantic-routines.galgas", 227)) ;
      }
      break ;
    case GALGAS_procFormalArgumentPassingMode::kEnum_output:
    case GALGAS_procFormalArgumentPassingMode::kEnum_inputOutput:
  ...
  if (kBoolTrue == test_9) {
    ...
    GALGAS_string var_resultVarLLVMName_9546 = GALGAS_string ("%").add_operation (function_llvmNameForLocalVariable (function_functionResultVariableName (inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 238)), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 238)), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 238)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  %result = load ").add_operation (extensionGetter_llvmTypeName (inObject.mProperty_mReturnType, inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 239)), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 239)).add_operation (GALGAS_string (", "), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 239)).add_operation (extensionGetter_llvmTypeName (inObject.mProperty_mReturnType, inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 239)), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 239)).add_operation (GALGAS_string (" * "), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 239)).add_operation (var_resultVarLLVMName_9546, inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 239)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("semantic-routines.galgas", 239)), inCompiler  COMMA_SOURCE_FILE ("semantic-routines.galgas", 239)) ;
...
static void extensionMethod_structureDeclarationAST_enterInContext (const cPtr_abstractDeclarationAST * inObject,
  ...
  const cPtr_structureDeclarationAST * object = (const cPtr_structureDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_structureDeclarationAST) ;
  GALGAS_universalPropertyAndRoutineMapForContext var_universalPropertyAndRoutineMapForContext_9860 = GALGAS_universalPropertyAndRoutineMapForContext::constructor_default (SOURCE_FILE ("type-structure-declaration.galgas", 248)) ;
  GALGAS_propertyList var_propertyList_9900 = GALGAS_propertyList::constructor_emptyList (SOURCE_FILE ("type-structure-declaration.galgas", 249)) ;
  GALGAS_propertyMap var_propertyMap_9932 = GALGAS_propertyMap::constructor_emptyMap (SOURCE_FILE ("type-structure-declaration.galgas", 250)) ;
  GALGAS_sortedOperandIRList var_sortedOperandIRList_9980 = GALGAS_sortedOperandIRList::constructor_emptySortedList (SOURCE_FILE ("type-structure-declaration.galgas", 251)) ;
  GALGAS_constructorSignature var_constructorSignature_10030 = GALGAS_constructorSignature::constructor_emptyList (SOURCE_FILE ("type-structure-declaration.galgas", 252)) ;
  GALGAS_bool var_canBeCopied_10053 = GALGAS_bool (true) ;
  cEnumerator_structurePropertyListAST enumerator_10104 (object->mProperty_mStructurePropertyListAST, kENUMERATION_UP) ;
  while (enumerator_10104.hasCurrentObject ()) {
    extensionMethod_enterInContext (enumerator_10104.current (HERE), object->mProperty_mStructureName, ioArgument_ioContext, ioArgument_ioGlobalLiteralStringMap, var_universalPropertyAndRoutineMapForContext_9860, var_propertyList_9900, var_propertyMap_9932, var_sortedOperandIRList_9980, var_constructorSignature_10030, var_canBeCopied_10053, inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 255)) ;
    enumerator_10104.gotoNextObject () ;
  }
  {
  ioArgument_ioContext.mProperty_mConstructorMap.setter_insertKey (object->mProperty_mStructureName, GALGAS_constructorValue::constructor_structure (var_constructorSignature_10030, var_sortedOperandIRList_9980  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 270)), inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 268)) ;
  }
  GALGAS_PLMTypeFlags var_flags_10681 = GALGAS_PLMTypeFlags::constructor_instanciable (SOURCE_FILE ("type-structure-declaration.galgas", 273)) ;
  cEnumerator_lstringlist enumerator_10741 (object->mProperty_mAttributeListAST, kENUMERATION_UP) ;
  while (enumerator_10741.hasCurrentObject ()) {
    const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, enumerator_10741.current_mValue (HERE).getter_string (HERE).objectCompare (GALGAS_string ("copyable"))).boolEnum () ;
    if (kBoolTrue == test_0) {
      const enumGalgasBool test_1 = var_flags_10681.getter_copyable (SOURCE_FILE ("type-structure-declaration.galgas", 276)).boolEnum () ;
      if (kBoolTrue == test_1) {
        TC_Array <C_FixItDescription> fixItArray2 ;
        inCompiler->emitSemanticError (enumerator_10741.current_mValue (HERE).getter_location (SOURCE_FILE ("type-structure-declaration.galgas", 277)), GALGAS_string ("duplicated attribute"), fixItArray2  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 277)) ;
      }else if (kBoolFalse == test_1) {
        const enumGalgasBool test_3 = var_canBeCopied_10053.operator_not (SOURCE_FILE ("type-structure-declaration.galgas", 278)).boolEnum () ;
        if (kBoolTrue == test_3) {
          TC_Array <C_FixItDescription> fixItArray4 ;
          inCompiler->emitSemanticError (object->mProperty_mStructureName.getter_location (SOURCE_FILE ("type-structure-declaration.galgas", 279)), GALGAS_string ("this structure cannot be copied, one field is not copyable"), fixItArray4  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 279)) ;
        }else if (kBoolFalse == test_3) {
          var_flags_10681 = var_flags_10681.operator_or (GALGAS_PLMTypeFlags::constructor_copyable (SOURCE_FILE ("type-structure-declaration.galgas", 281)) COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 281)) ;
        }
      }
    }else if (kBoolFalse == test_0) {
      TC_Array <C_FixItDescription> fixItArray5 ;
      inCompiler->emitSemanticError (enumerator_10741.current_mValue (HERE).getter_location (SOURCE_FILE ("type-structure-declaration.galgas", 284)), GALGAS_string ("only @copyable attribute is allowed here"), fixItArray5  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 284)) ;
    }
  ...
  while (enumerator_11245.hasCurrentObject ()) {
    GALGAS_stringset var_attributeSet_11297 = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("type-structure-declaration.galgas", 290)) ;
    cEnumerator_lstringlist enumerator_11355 (enumerator_11245.current (HERE).getter_mFunctionAttributeList (HERE), kENUMERATION_UP) ;
    while (enumerator_11355.hasCurrentObject ()) {
      var_attributeSet_11297.addAssign_operation (enumerator_11355.current (HERE).getter_mValue (HERE).getter_string (HERE)  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 292)) ;
      enumerator_11355.gotoNextObject () ;
    }
    GALGAS_lstring var_signature_11448 = extensionGetter_routineSignature (enumerator_11245.current (HERE).getter_mFunctionFormalArgumentList (HERE), enumerator_11245.current (HERE).getter_mFunctionName (HERE).getter_location (SOURCE_FILE ("type-structure-declaration.galgas", 295)), inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 295)) ;
    GALGAS_routineTypedSignature var_typedSignature_11631 ;
    {
    routine_routineSignature (ioArgument_ioContext.mProperty_mTypeMap, enumerator_11245.current (HERE).getter_mFunctionFormalArgumentList (HERE), var_typedSignature_11631, inCompiler  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 296)) ;
    }
    GALGAS_unifiedTypeMap_2D_proxy var_returnTypeProxy_11772 ;
    {
    GALGAS_unifiedTypeMap_2D_proxy::class_method_makeOptionalProxy (ioArgument_ioContext.mProperty_mTypeMap, enumerator_11245.current (HERE).getter_mFunctionReturnTypeName (HERE), var_returnTypeProxy_11772 COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 298)) ;
    }
    GALGAS_lstring var_invocationName_11828 = function_routineMangledNameFromAST (GALGAS_string ("$").add_operation (object->mProperty_mStructureName.getter_string (SOURCE_FILE ("type-structure-declaration.galgas", 301)), inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 301)), enumerator_11245.current (HERE).getter_mFunctionName (HERE), enumerator_11245.current (HERE).getter_mFunctionFormalArgumentList (HERE), inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 300)) ;
    GALGAS_routineDescriptor var_functionDescriptor_12021 = GALGAS_routineDescriptor::constructor_new (enumerator_11245.current (HERE).getter_mPublicFunction (HERE), var_attributeSet_11297.getter_hasKey (function_exportedAttribute (inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 308)) COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 308)), GALGAS_routineKind::constructor_function (enumerator_11245.current (HERE).getter_mMode (HERE)  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 309)), var_typedSignature_11631, var_returnTypeProxy_11772, var_attributeSet_11297.getter_hasKey (function_accessAttribute (inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 312)) COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 312)), var_attributeSet_11297.getter_hasKey (function_mutatingAttribute (inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 313)) COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 313)), GALGAS_routineCallingSheme::constructor_staticCall (SOURCE_FILE ("type-structure-declaration.galgas", 314))  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 306)) ;
    {
    var_universalPropertyAndRoutineMapForContext_9860.insulate (HERE) ;
    cPtr_universalPropertyAndRoutineMapForContext * ptr_12405 = (cPtr_universalPropertyAndRoutineMapForContext *) var_universalPropertyAndRoutineMapForContext_9860.ptr () ;
    callExtensionSetter_insertRoutine ((cPtr_universalPropertyAndRoutineMapForContext *) ptr_12405, enumerator_11245.current (HERE).getter_mFunctionName (HERE), var_signature_11448, var_invocationName_11828, var_functionDescriptor_12021, inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 317)) ;
    }
    enumerator_11245.gotoNextObject () ;
  }
  cEnumerator_systemRoutineDeclarationListAST enumerator_12564 (object->mProperty_mSystemRoutineListAST, kENUMERATION_UP) ;
  while (enumerator_12564.hasCurrentObject ()) {
    GALGAS_stringset var_attributeSet_12616 = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("type-structure-declaration.galgas", 326)) ;
    cEnumerator_lstringlist enumerator_12664 (enumerator_12564.current (HERE).getter_mAttributeList (HERE), kENUMERATION_UP) ;
    while (enumerator_12664.hasCurrentObject ()) {
      var_attributeSet_12616.addAssign_operation (enumerator_12664.current (HERE).getter_mValue (HERE).getter_string (HERE)  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 328)) ;
      enumerator_12664.gotoNextObject () ;
    }
    GALGAS_lstring var_signature_12757 = extensionGetter_routineSignature (enumerator_12564.current (HERE).getter_mFormalArgumentList (HERE), enumerator_12564.current (HERE).getter_mName (HERE).getter_location (SOURCE_FILE ("type-structure-declaration.galgas", 331)), inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 331)) ;
    GALGAS_routineTypedSignature var_typedSignature_12933 ;
    {
    routine_routineSignature (ioArgument_ioContext.mProperty_mTypeMap, enumerator_12564.current (HERE).getter_mFormalArgumentList (HERE), var_typedSignature_12933, inCompiler  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 332)) ;
    }
    GALGAS_unifiedTypeMap_2D_proxy var_returnTypeProxy_13064 ;
    {
    GALGAS_unifiedTypeMap_2D_proxy::class_method_makeOptionalProxy (ioArgument_ioContext.mProperty_mTypeMap, enumerator_12564.current (HERE).getter_mReturnTypeName (HERE), var_returnTypeProxy_13064 COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 334)) ;
    }
    GALGAS_lstring var_invocationName_13120 = function_routineMangledNameFromAST (GALGAS_string ("$").add_operation (object->mProperty_mStructureName.getter_string (SOURCE_FILE ("type-structure-declaration.galgas", 337)), inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 337)), enumerator_12564.current (HERE).getter_mName (HERE), enumerator_12564.current (HERE).getter_mFormalArgumentList (HERE), inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 336)) ;
    GALGAS_routineDescriptor var_descriptor_13285 = GALGAS_routineDescriptor::constructor_new (enumerator_12564.current (HERE).getter_mPublic (HERE), var_attributeSet_12616.getter_hasKey (function_exportedAttribute (inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 344)) COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 344)), enumerator_12564.current (HERE).getter_mRoutineKind (HERE), var_typedSignature_12933, var_returnTypeProxy_13064, var_attributeSet_12616.getter_hasKey (function_accessAttribute (inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 348)) COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 348)), var_attributeSet_12616.getter_hasKey (function_mutatingAttribute (inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 349)) COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 349)), GALGAS_routineCallingSheme::constructor_staticCall (SOURCE_FILE ("type-structure-declaration.galgas", 350))  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 342)) ;
    {
    var_universalPropertyAndRoutineMapForContext_9860.insulate (HERE) ;
    cPtr_universalPropertyAndRoutineMapForContext * ptr_13637 = (cPtr_universalPropertyAndRoutineMapForContext *) var_universalPropertyAndRoutineMapForContext_9860.ptr () ;
    callExtensionSetter_insertRoutine ((cPtr_universalPropertyAndRoutineMapForContext *) ptr_13637, enumerator_12564.current (HERE).getter_mName (HERE), var_signature_12757, var_invocationName_13120, var_descriptor_13285, inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 353)) ;
    }
    enumerator_12564.gotoNextObject () ;
  }
  {
  ioArgument_ioContext.mProperty_mTypeMap.setter_insertType (object->mProperty_mStructureName, GALGAS_PLMType::constructor_structure (object->mProperty_mStructureName, var_propertyMap_9932, var_universalPropertyAndRoutineMapForContext_9860, var_propertyList_9900, var_flags_10681, object->mProperty_mStructureName.getter_string (SOURCE_FILE ("type-structure-declaration.galgas", 369))  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 363)), ioArgument_ioContext.getter_mTypeMap (HERE).getter_count (SOURCE_FILE ("type-structure-declaration.galgas", 371)), inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 361)) ;
  }
}
...
static void extensionMethod_structureDeclarationAST_enterRoutinesInContext (const cPtr_abstractDeclarationAST * inObject,
  ...
  const cPtr_structureDeclarationAST * object = (const cPtr_structureDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_structureDeclarationAST) ;
  extensionMethod_enterFunctionInContext (object->mProperty_mFunctionDeclarationListAST, function_llvmRegularTypeMangledNameFromName (object->mProperty_mStructureName, inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 495)).getter_string (HERE), ioArgument_ioContext, inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 494)) ;
  extensionMethod_enterInContext (object->mProperty_mSystemRoutineListAST, function_llvmRegularTypeMangledNameFromName (object->mProperty_mStructureName, inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 499)).getter_string (HERE), ioArgument_ioContext, inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 498)) ;
  extensionMethod_enterInContext (object->mProperty_mGuardListAST, function_llvmRegularTypeMangledNameFromName (object->mProperty_mStructureName, inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 503)).getter_string (HERE), ioArgument_ioContext, inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 502)) ;
}
...
static void extensionMethod_structureDeclarationAST_semanticAnalysis (const cPtr_abstractDeclarationAST * inObject,
  ...
  const cPtr_structureDeclarationAST * object = (const cPtr_structureDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_structureDeclarationAST) ;
  GALGAS_PLMType var_structureType_19837 = GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inContext.getter_mTypeMap (HERE), object->mProperty_mStructureName, inCompiler  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 517)).getter_type (inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 517)) ;
  const GALGAS_structureDeclarationAST temp_0 = object ;
  callExtensionMethod_functionSemanticAnalysis ((const cPtr_structureDeclarationAST *) temp_0.ptr (), var_structureType_19837, constinArgument_inContext, ioArgument_ioTemporaries, ioArgument_ioIntermediateCodeStruct, inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 519)) ;
  extensionMethod_systemRoutineSemanticAnalysis (object->mProperty_mSystemRoutineListAST, var_structureType_19837, constinArgument_inContext, ioArgument_ioTemporaries, ioArgument_ioIntermediateCodeStruct, inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 526)) ;
  extensionMethod_guardSemanticAnalysis (object->mProperty_mGuardListAST, var_structureType_19837, constinArgument_inContext, ioArgument_ioTemporaries, ioArgument_ioIntermediateCodeStruct, inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 533)) ;
  {
  routine_generatePropertyAccess (var_structureType_19837, ioArgument_ioIntermediateCodeStruct, inCompiler  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 540)) ;
  }
}
...
void routine_generatePropertyAccess (const GALGAS_PLMType constinArgument_inType,
                                     ...
                                     C_Compiler * inCompiler
                                     COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_propertyMap var_propertyMap_23631 ;
  GALGAS_lstring joker_23587_1 ; // Joker input parameter
  GALGAS_universalPropertyAndRoutineMapForContext joker_23633_4 ; // Joker input parameter
  GALGAS_propertyList joker_23633_3 ; // Joker input parameter
  GALGAS_PLMTypeFlags joker_23633_2 ; // Joker input parameter
  GALGAS_string joker_23633_1 ; // Joker input parameter
  constinArgument_inType.method_structure (joker_23587_1, var_propertyMap_23631, joker_23633_4, joker_23633_3, joker_23633_2, joker_23633_1, inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 614)) ;
  cEnumerator_propertyMap enumerator_23683 (var_propertyMap_23631, kENUMERATION_UP) ;
  while (enumerator_23683.hasCurrentObject ()) {
    GALGAS_PLMType var_propertyType_23732 ;
    GALGAS_propertyAccessKind var_access_23762 ;
    GALGAS_lstring joker_23742 ; // Joker input parameter
    enumerator_23683.current_mPropertyObject (HERE).method_property (var_propertyType_23732, joker_23742, var_access_23762, inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 616)) ;
    ioArgument_ioIntermediateCodeStruct.mProperty_mPropertyAccessRoutineList.addAssign_operation (constinArgument_inType, var_propertyType_23732, enumerator_23683.current_lkey (HERE).getter_string (HERE), var_access_23762  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 617)) ;
...
static void extensionMethod_staticArrayAST_enterInContext (const cPtr_abstractDeclarationAST * inObject,
  ...
  while (enumerator_6232.hasCurrentObject ()) {
    ...
    case GALGAS_staticArrayPropertyTypeAST::kEnum_valueType:
      {
        const cEnumAssociatedValues_staticArrayPropertyTypeAST_valueType * extractPtr_7047 = (const cEnumAssociatedValues_staticArrayPropertyTypeAST_valueType *) (enumerator_6232.current_mPropertyType (HERE).unsafePointer ()) ;
        const GALGAS_lstring extractedValue_propertyTypeName = extractPtr_7047->mAssociatedValue0 ;
        ...
        {
        var_staticlistPropertyMap_6011.setter_insertKey (enumerator_6232.current_mPropertyName (HERE), GALGAS_bool (true), var_objectIR_6647, inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 162)) ;
        }
      }
      break ;
    case GALGAS_staticArrayPropertyTypeAST::kEnum_function:
      {
        const cEnumAssociatedValues_staticArrayPropertyTypeAST_function * extractPtr_8732 = (const cEnumAssociatedValues_staticArrayPropertyTypeAST_function *) (enumerator_6232.current_mPropertyType (HERE).unsafePointer ()) ;
        const GALGAS_mode extractedValue_mode = extractPtr_8732->mAssociatedValue0 ;
        const GALGAS_routineFormalArgumentList extractedValue_formalArgs = extractPtr_8732->mAssociatedValue1 ;
        const GALGAS_lstring extractedValue_returnTypeName = extractPtr_8732->mAssociatedValue2 ;
        GALGAS_lstring var_routineMangledName_7201 = function_routineMangledNameFromAST (GALGAS_string::makeEmptyString (), enumerator_6232.current_mPropertyName (HERE), extractedValue_formalArgs, inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 169)) ;
        GALGAS_routineTypedSignature var_signature_7385 ;
        {
        routine_routineSignature (ioArgument_ioContext.mProperty_mTypeMap, extractedValue_formalArgs, var_signature_7385, inCompiler  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 175)) ;
        }
        ...
        if (kBoolTrue == test_3) {
          temp_2 = GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("declaration-static-array.galgas", 177)) ;
        }else if (kBoolFalse == test_3) {
          temp_2 = GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (ioArgument_ioContext.getter_mTypeMap (HERE), extractedValue_returnTypeName, inCompiler  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 179)) ;
        }
        GALGAS_unifiedTypeMap_2D_proxy var_returnTypeProxy_7434 = temp_2 ;
        GALGAS_PLMType var_type_7600 = GALGAS_PLMType::constructor_function (var_signature_7385, extractedValue_mode, var_returnTypeProxy_7434  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 181)) ;
        GALGAS_routineDescriptor var_descriptor_7708 = GALGAS_routineDescriptor::constructor_new (GALGAS_bool (true), GALGAS_bool (false), GALGAS_routineKind::constructor_function (extractedValue_mode  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 185)), var_signature_7385, var_returnTypeProxy_7434, GALGAS_bool (false), GALGAS_bool (false), GALGAS_routineCallingSheme::constructor_propertyIndirectCall (var_type_7600  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 190))  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 182)) ;
        {
        var_universalMap_6073.insulate (HERE) ;
        cPtr_universalPropertyAndRoutineMapForContext * ptr_7953 = (cPtr_universalPropertyAndRoutineMapForContext *) var_universalMap_6073.ptr () ;
        callExtensionSetter_insertRoutine ((cPtr_universalPropertyAndRoutineMapForContext *) ptr_7953, enumerator_6232.current_mPropertyName (HERE), extensionGetter_routineSignature (extractedValue_formalArgs, enumerator_6232.current_mPropertyName (HERE).getter_location (SOURCE_FILE ("declaration-static-array.galgas", 194)), inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 194)), var_routineMangledName_7201, var_descriptor_7708, inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 192)) ;
        }
        const enumGalgasBool test_4 = ioArgument_ioContext.getter_mTypeMap (HERE).getter_hasKey (var_routineMangledName_7201.getter_string (SOURCE_FILE ("declaration-static-array.galgas", 198)) COMMA_SOURCE_FILE ("declaration-static-array.galgas", 198)).operator_not (SOURCE_FILE ("declaration-static-array.galgas", 198)).boolEnum () ;
        if (kBoolTrue == test_4) {
          {
          ioArgument_ioContext.mProperty_mTypeMap.setter_insertType (var_routineMangledName_7201, var_type_7600, ioArgument_ioContext.getter_mTypeMap (HERE).getter_count (SOURCE_FILE ("declaration-static-array.galgas", 202)), inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 199)) ;
          }
        }
        GALGAS_PLMType var_propertyType_8348 = GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (ioArgument_ioContext.getter_mTypeMap (HERE), var_routineMangledName_7201, inCompiler  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 205)).getter_type (inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 205)) ;
        var_propertyList_5969.addAssign_operation (enumerator_6232.current_mPropertyName (HERE).getter_string (SOURCE_FILE ("declaration-static-array.galgas", 206)), var_propertyType_8348  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 206)) ;
        GALGAS_uint var_propertyIndex_8505 = var_staticlistPropertyMap_6011.getter_count (SOURCE_FILE ("declaration-static-array.galgas", 207)) ;
        {
        var_staticlistPropertyMap_6011.setter_insertKey (enumerator_6232.current_mPropertyName (HERE), GALGAS_bool (true), GALGAS_objectIR::constructor_property (var_propertyType_8348, enumerator_6232.current_mPropertyName (HERE), GALGAS_propertyAccessKind::constructor_indexed (var_propertyIndex_8505  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 211))  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 211)), inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 208)) ;
        }
      }
      break ;
    }
  ...
  {
  ioArgument_ioContext.mProperty_mStaticlistMap.setter_insertKey (object->mProperty_mStaticListName, var_propertyList_5969, inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 215)) ;
  }
  GALGAS_PLMType var_kind_8865 = GALGAS_PLMType::constructor_structure (function_llvmNameForStaticListElementType (object->mProperty_mStaticListName, inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 218)), var_staticlistPropertyMap_6011, var_universalMap_6073, var_propertyList_5969, GALGAS_PLMTypeFlags::constructor_none (SOURCE_FILE ("declaration-static-array.galgas", 222)), object->mProperty_mStaticListName.getter_string (SOURCE_FILE ("declaration-static-array.galgas", 223))  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 217)) ;
  {
  ioArgument_ioContext.mProperty_mTypeMap.setter_insertType (var_plmTypeName_6136, var_kind_8865, ioArgument_ioContext.getter_mTypeMap (HERE).getter_count (SOURCE_FILE ("declaration-static-array.galgas", 228)), inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 225)) ;
  }
}
...
static void extensionMethod_staticArrayAST_semanticAnalysis (const cPtr_abstractDeclarationAST * inObject,
  ...
  const cPtr_staticArrayAST * object = (const cPtr_staticArrayAST *) inObject ;
  macroValidSharedObject (object, cPtr_staticArrayAST) ;
  GALGAS_lstring var_plmTypeName_10246 = function_plmNameForStaticListElementType (object->mProperty_mStaticListName, inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 251)) ;
  GALGAS_PLMType var_type_10364 ;
  GALGAS_uint joker_10366_1 ; // Joker input parameter
  constinArgument_inContext.getter_mTypeMap (HERE).method_searchKey (var_plmTypeName_10246, var_type_10364, joker_10366_1, inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 252)) ;
  {
  routine_generatePropertyAccess (var_type_10364, ioArgument_ioIntermediateCodeStruct, inCompiler  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 253)) ;
  }
}
...
static void extensionMethod_complexCallNoSelfInstructionAST_baseGuardAnalyze (const cPtr_callInstructionAST * inObject,
  ...
  GALGAS_objectIR var_currentObject_12152 ;
  callExtensionMethod_searchValuedObject ((const cPtr_universalPropertyAndRoutineMapForContext *) ioArgument_ioUniversalMap.ptr (), object->mProperty_mAssignmentTargetAST.getter_mIdentifier (HERE), var_currentObject_12152, inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 324)) ;
  GALGAS_location var_currentErrorLocation_12180 = object->mProperty_mAssignmentTargetAST.getter_mIdentifier (HERE).getter_location (HERE) ;
  GALGAS_universalPropertyAndRoutineMapForContext var_currentMap_12241 = ioArgument_ioUniversalMap ;
  GALGAS_accessInAssignmentListAST var_accessList_12301 = object->mProperty_mAssignmentTargetAST.getter_mAccessList (HERE) ;
  GALGAS_accessInAssignmentAST var_lastAccess_12376 ;
  {
  var_accessList_12301.setter_popLast (var_lastAccess_12376, inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 329)) ;
  }
  cEnumerator_accessInAssignmentListAST enumerator_12432 (var_accessList_12301, kENUMERATION_UP) ;
  while (enumerator_12432.hasCurrentObject ()) {
    GALGAS_PLMType var_currentType_12455 = extensionGetter_type (var_currentObject_12152, inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 332)) ;
    switch (enumerator_12432.current_mAccess (HERE).enumValue ()) {
    case GALGAS_accessInAssignmentAST::kNotBuilt:
      break ;
    case GALGAS_accessInAssignmentAST::kEnum_property:
      {
        const cEnumAssociatedValues_accessInAssignmentAST_property * extractPtr_13383 = (const cEnumAssociatedValues_accessInAssignmentAST_property *) (enumerator_12432.current_mAccess (HERE).unsafePointer ()) ;
        const GALGAS_lstring extractedValue_propertyName = extractPtr_13383->mAssociatedValue0 ;
        const enumGalgasBool test_0 = var_currentType_12455.getter_isStructure (SOURCE_FILE ("declaration-guard.galgas", 335)).boolEnum () ;
        if (kBoolTrue == test_0) {
          GALGAS_universalPropertyAndRoutineMapForContext var_universalMap_12646 ;
          GALGAS_lstring joker_12613_2 ; // Joker input parameter
          GALGAS_propertyMap joker_12613_1 ; // Joker input parameter
          GALGAS_propertyList joker_12648_3 ; // Joker input parameter
          GALGAS_PLMTypeFlags joker_12648_2 ; // Joker input parameter
          GALGAS_string joker_12648_1 ; // Joker input parameter
          var_currentType_12455.method_structure (joker_12613_2, joker_12613_1, var_universalMap_12646, joker_12648_3, joker_12648_2, joker_12648_1, inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 336)) ;
          GALGAS_objectIR var_propertyObject_12726 ;
          callExtensionMethod_searchValuedObject ((const cPtr_universalPropertyAndRoutineMapForContext *) var_universalMap_12646.ptr (), extractedValue_propertyName, var_propertyObject_12726, inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 337)) ;
          var_currentMap_12241 = var_universalMap_12646 ;
          var_currentErrorLocation_12180 = extractedValue_propertyName.getter_location (HERE) ;
          GALGAS_objectIR var_newObject_12836 = GALGAS_objectIR::constructor_temporaryReference (extensionGetter_type (var_propertyObject_12726, inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 341)), GALGAS_lstring::constructor_new (GALGAS_string ("temp.").add_operation (ioArgument_ioTemporaries.getter_mTemporaryIndex (HERE).getter_string (SOURCE_FILE ("declaration-guard.galgas", 342)), inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 342)), extractedValue_propertyName.getter_location (SOURCE_FILE ("declaration-guard.galgas", 342))  COMMA_SOURCE_FILE ("declaration-guard.galgas", 342)), GALGAS_sliceMap::constructor_emptyMap (SOURCE_FILE ("declaration-guard.galgas", 343)), GALGAS_bool (false)  COMMA_SOURCE_FILE ("declaration-guard.galgas", 340)) ;
          ioArgument_ioTemporaries.mProperty_mTemporaryIndex.increment_operation (inCompiler  COMMA_SOURCE_FILE ("declaration-guard.galgas", 346)) ;
          {
          extensionSetter_appendGetPropertyReference (var_baseGuardInstructionGenerationList_11951, var_newObject_12836, var_currentObject_12152, extractedValue_propertyName.getter_string (SOURCE_FILE ("declaration-guard.galgas", 350)), inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 347)) ;
          }
          var_currentObject_12152 = var_newObject_12836 ;
        }else if (kBoolFalse == test_0) {
          TC_Array <C_FixItDescription> fixItArray1 ;
          inCompiler->emitSemanticError (var_currentErrorLocation_12180, GALGAS_string ("this object has no property"), fixItArray1  COMMA_SOURCE_FILE ("declaration-guard.galgas", 354)) ;
          var_currentObject_12152.drop () ; // Release error dropped variable
        }
      }
      break ;
    case GALGAS_accessInAssignmentAST::kEnum_arrayAccess:
      {
        const cEnumAssociatedValues_accessInAssignmentAST_arrayAccess * extractPtr_13526 = (const cEnumAssociatedValues_accessInAssignmentAST_arrayAccess *) (enumerator_12432.current_mAccess (HERE).unsafePointer ()) ;
        const GALGAS_expressionAST extractedValue_indexExpression = extractPtr_13526->mAssociatedValue0 ;
        const GALGAS_location extractedValue_endOfIndex = extractPtr_13526->mAssociatedValue1 ;
        TC_Array <C_FixItDescription> fixItArray2 ;
        inCompiler->emitSemanticError (extractedValue_endOfIndex, GALGAS_string ("not handled yet"), fixItArray2  COMMA_SOURCE_FILE ("declaration-guard.galgas", 357)) ;
        var_currentObject_12152.drop () ; // Release error dropped variable
      }
      break ;
    }
  ...
  GALGAS_lstring var_methodName_13586 ;
  switch (var_lastAccess_12376.enumValue ()) {
  case GALGAS_accessInAssignmentAST::kNotBuilt:
    break ;
  case GALGAS_accessInAssignmentAST::kEnum_property:
    {
      const cEnumAssociatedValues_accessInAssignmentAST_property * extractPtr_14021 = (const cEnumAssociatedValues_accessInAssignmentAST_property *) (var_lastAccess_12376.unsafePointer ()) ;
      const GALGAS_lstring extractedValue_propertyName = extractPtr_14021->mAssociatedValue0 ;
      var_methodName_13586 = extractedValue_propertyName ;
      GALGAS_PLMType var_currentType_13698 = extensionGetter_type (var_currentObject_12152, inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 365)) ;
      const enumGalgasBool test_3 = var_currentType_13698.getter_isStructure (SOURCE_FILE ("declaration-guard.galgas", 366)).boolEnum () ;
      if (kBoolTrue == test_3) {
        GALGAS_universalPropertyAndRoutineMapForContext var_universalMap_13823 ;
        GALGAS_lstring joker_13790_2 ; // Joker input parameter
        GALGAS_propertyMap joker_13790_1 ; // Joker input parameter
        GALGAS_propertyList joker_13825_3 ; // Joker input parameter
        GALGAS_PLMTypeFlags joker_13825_2 ; // Joker input parameter
        GALGAS_string joker_13825_1 ; // Joker input parameter
        var_currentType_13698.method_structure (joker_13790_2, joker_13790_1, var_universalMap_13823, joker_13825_3, joker_13825_2, joker_13825_1, inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 367)) ;
        var_currentMap_12241 = var_universalMap_13823 ;
        var_currentErrorLocation_12180 = extractedValue_propertyName.getter_location (HERE) ;
      }else if (kBoolFalse == test_3) {
        TC_Array <C_FixItDescription> fixItArray4 ;
        inCompiler->emitSemanticError (var_currentErrorLocation_12180, GALGAS_string ("this object has no property"), fixItArray4  COMMA_SOURCE_FILE ("declaration-guard.galgas", 371)) ;
        var_currentObject_12152.drop () ; // Release error dropped variable
        var_methodName_13586.drop () ; // Release error dropped variable
      }
    }
    break ;
  case GALGAS_accessInAssignmentAST::kEnum_arrayAccess:
    {
      const cEnumAssociatedValues_accessInAssignmentAST_arrayAccess * extractPtr_14155 = (const cEnumAssociatedValues_accessInAssignmentAST_arrayAccess *) (var_lastAccess_12376.unsafePointer ()) ;
      const GALGAS_location extractedValue_endOfIndex = extractPtr_14155->mAssociatedValue1 ;
      TC_Array <C_FixItDescription> fixItArray5 ;
      inCompiler->emitSemanticError (extractedValue_endOfIndex, GALGAS_string ("a property access is required here"), fixItArray5  COMMA_SOURCE_FILE ("declaration-guard.galgas", 374)) ;
      var_currentObject_12152.drop () ; // Release error dropped variable
      var_methodName_13586.drop () ; // Release error dropped variable
    }
    break ;
  }
  GALGAS_lstring var_routineMangledName_14252 = function_routineMangledNameFromCall (GALGAS_string ("$").add_operation (extensionGetter_key (extensionGetter_type (var_currentObject_12152, inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 377)), inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 377)), inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 377)), var_methodName_13586, object->mProperty_mArguments, inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 377)) ;
  GALGAS_lstring var_signature_14392 = extensionGetter_routineSignature (object->mProperty_mArguments, var_methodName_13586.getter_location (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 379)) ;
  GALGAS_routineDescriptor var_routineDescriptor_14622 ;
  GALGAS_lstring joker_14538 ; // Joker input parameter
  callExtensionMethod_searchRoutine ((const cPtr_universalPropertyAndRoutineMapForContext *) var_currentMap_12241.ptr (), var_methodName_13586, var_signature_14392, joker_14538, var_routineDescriptor_14622, inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 381)) ;
  GALGAS_procCallEffectiveParameterListIR var_effectiveParameterListIR_14724 = GALGAS_procCallEffectiveParameterListIR::constructor_emptyList (SOURCE_FILE ("declaration-guard.galgas", 388)) ;
  switch (var_routineDescriptor_14622.getter_mRoutineCallingScheme (HERE).enumValue ()) {
  case GALGAS_routineCallingSheme::kNotBuilt:
    break ;
  case GALGAS_routineCallingSheme::kEnum_staticCall:
    {
      var_effectiveParameterListIR_14724.addAssign_operation (GALGAS_procEffectiveParameterPassingModeIR::constructor_outputInput (SOURCE_FILE ("declaration-guard.galgas", 391)), var_currentObject_12152  COMMA_SOURCE_FILE ("declaration-guard.galgas", 391)) ;
    }
    break ;
  ...
  GALGAS_routineTypedSignature var_formalSignature_15105 = var_routineDescriptor_14622.getter_mSignature (HERE) ;
  const enumGalgasBool test_6 = GALGAS_bool (kIsNotEqual, var_routineDescriptor_14622.getter_mReturnTypeProxy (HERE).objectCompare (GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("declaration-guard.galgas", 400)))).boolEnum () ;
  if (kBoolTrue == test_6) {
    TC_Array <C_FixItDescription> fixItArray7 ;
    inCompiler->emitSemanticError (var_methodName_13586.getter_location (SOURCE_FILE ("declaration-guard.galgas", 401)), GALGAS_string ("not a procedure (returns a value)"), fixItArray7  COMMA_SOURCE_FILE ("declaration-guard.galgas", 401)) ;
    var_routineDescriptor_14622.drop () ; // Release error dropped variable
    outArgument_outConvenienceGuardGenerationIR.drop () ; // Release error dropped variable
  }else if (kBoolFalse == test_6) {
    {
    routine_analyzeEffectiveParametersNew (constinArgument_inSelfType, var_formalSignature_15105, object->mProperty_mArguments, var_methodName_13586.getter_location (HERE), constinArgument_inCallerNameForInvocationGraph, constinArgument_inContext, constinArgument_inMode, ioArgument_ioTemporaries, ioArgument_ioGlobalLiteralStringMap, ioArgument_ioUniversalMap, var_baseGuardAllocaList_11890, var_baseGuardInstructionGenerationList_11951, var_effectiveParameterListIR_14724, inCompiler  COMMA_SOURCE_FILE ("declaration-guard.galgas", 411)) ;
    }
    switch (var_routineDescriptor_14622.getter_mRoutineCallingScheme (HERE).enumValue ()) {
    case GALGAS_routineCallingSheme::kNotBuilt:
      break ;
    case GALGAS_routineCallingSheme::kEnum_staticCall:
      {
        outArgument_outConvenienceGuardGenerationIR = GALGAS_guardKindGenerationIR::constructor_convenienceGuard (var_baseGuardAllocaList_11890, var_baseGuardInstructionGenerationList_11951, var_routineMangledName_14252.getter_string (HERE), var_effectiveParameterListIR_14724  COMMA_SOURCE_FILE ("declaration-guard.galgas", 429)) ;
      }
      break ;
    case GALGAS_routineCallingSheme::kEnum_propertyIndirectCall:
      {
        TC_Array <C_FixItDescription> fixItArray8 ;
        inCompiler->emitSemanticError (GALGAS_location::constructor_nowhere (SOURCE_FILE ("declaration-guard.galgas", 436)), GALGAS_string ("NOT HANDLED YET"), fixItArray8  COMMA_SOURCE_FILE ("declaration-guard.galgas", 436)) ;
        outArgument_outConvenienceGuardGenerationIR.drop () ; // Release error dropped variable
      }
      break ;
    }
...
static void extensionMethod_complexCallSelfInstructionAST_baseGuardAnalyze (const cPtr_callInstructionAST * inObject,
  ...
  GALGAS_allocaList var_baseGuardAllocaList_17291 = GALGAS_allocaList::constructor_emptyList (SOURCE_FILE ("declaration-guard.galgas", 453)) ;
  GALGAS_instructionListIR var_baseGuardInstructionGenerationList_17352 = GALGAS_instructionListIR::constructor_emptyList (SOURCE_FILE ("declaration-guard.galgas", 454)) ;
  GALGAS_location var_currentErrorLocation_17389 = object->mProperty_mAssignmentTargetAST.getter_mSelfLocation (HERE) ;
  GALGAS_objectIR var_currentObject_17452 = GALGAS_objectIR::constructor_selfObject (constinArgument_inSelfType  COMMA_SOURCE_FILE ("declaration-guard.galgas", 457)) ;
  GALGAS_universalPropertyAndRoutineMapForContext var_currentMap_17540 = GALGAS_universalPropertyAndRoutineMapForContext::constructor_default (SOURCE_FILE ("declaration-guard.galgas", 458)) ;
  GALGAS_accessInAssignmentListAST var_accessList_17594 = object->mProperty_mAssignmentTargetAST.getter_mAccessList (HERE) ;
  {
  var_accessList_17594.setter_insertAtIndex (GALGAS_accessInAssignmentAST::constructor_property (object->mProperty_mAssignmentTargetAST.getter_mIdentifier (HERE)  COMMA_SOURCE_FILE ("declaration-guard.galgas", 461)), GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 461)) ;
  }
  GALGAS_accessInAssignmentAST var_lastAccess_17755 ;
  {
  var_accessList_17594.setter_popLast (var_lastAccess_17755, inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 462)) ;
  }
  cEnumerator_accessInAssignmentListAST enumerator_17811 (var_accessList_17594, kENUMERATION_UP) ;
  while (enumerator_17811.hasCurrentObject ()) {
    GALGAS_PLMType var_currentType_17834 = extensionGetter_type (var_currentObject_17452, inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 465)) ;
    switch (enumerator_17811.current_mAccess (HERE).enumValue ()) {
    case GALGAS_accessInAssignmentAST::kNotBuilt:
      break ;
    case GALGAS_accessInAssignmentAST::kEnum_property:
      {
        const cEnumAssociatedValues_accessInAssignmentAST_property * extractPtr_18762 = (const cEnumAssociatedValues_accessInAssignmentAST_property *) (enumerator_17811.current_mAccess (HERE).unsafePointer ()) ;
        const GALGAS_lstring extractedValue_propertyName = extractPtr_18762->mAssociatedValue0 ;
        const enumGalgasBool test_0 = var_currentType_17834.getter_isStructure (SOURCE_FILE ("declaration-guard.galgas", 468)).boolEnum () ;
        if (kBoolTrue == test_0) {
          GALGAS_universalPropertyAndRoutineMapForContext var_universalMap_18025 ;
          GALGAS_lstring joker_17992_2 ; // Joker input parameter
          GALGAS_propertyMap joker_17992_1 ; // Joker input parameter
          GALGAS_propertyList joker_18027_3 ; // Joker input parameter
          GALGAS_PLMTypeFlags joker_18027_2 ; // Joker input parameter
          GALGAS_string joker_18027_1 ; // Joker input parameter
          var_currentType_17834.method_structure (joker_17992_2, joker_17992_1, var_universalMap_18025, joker_18027_3, joker_18027_2, joker_18027_1, inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 469)) ;
          GALGAS_objectIR var_propertyObject_18105 ;
          callExtensionMethod_searchValuedObject ((const cPtr_universalPropertyAndRoutineMapForContext *) var_universalMap_18025.ptr (), extractedValue_propertyName, var_propertyObject_18105, inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 470)) ;
          var_currentMap_17540 = var_universalMap_18025 ;
          var_currentErrorLocation_17389 = extractedValue_propertyName.getter_location (HERE) ;
          GALGAS_objectIR var_newObject_18215 = GALGAS_objectIR::constructor_temporaryReference (extensionGetter_type (var_propertyObject_18105, inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 474)), GALGAS_lstring::constructor_new (GALGAS_string ("temp.").add_operation (ioArgument_ioTemporaries.getter_mTemporaryIndex (HERE).getter_string (SOURCE_FILE ("declaration-guard.galgas", 475)), inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 475)), extractedValue_propertyName.getter_location (SOURCE_FILE ("declaration-guard.galgas", 475))  COMMA_SOURCE_FILE ("declaration-guard.galgas", 475)), GALGAS_sliceMap::constructor_emptyMap (SOURCE_FILE ("declaration-guard.galgas", 476)), GALGAS_bool (false)  COMMA_SOURCE_FILE ("declaration-guard.galgas", 473)) ;
          ioArgument_ioTemporaries.mProperty_mTemporaryIndex.increment_operation (inCompiler  COMMA_SOURCE_FILE ("declaration-guard.galgas", 479)) ;
          {
          extensionSetter_appendGetPropertyReference (var_baseGuardInstructionGenerationList_17352, var_newObject_18215, var_currentObject_17452, extractedValue_propertyName.getter_string (SOURCE_FILE ("declaration-guard.galgas", 483)), inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 480)) ;
          }
          var_currentObject_17452 = var_newObject_18215 ;
        }else if (kBoolFalse == test_0) {
          TC_Array <C_FixItDescription> fixItArray1 ;
          inCompiler->emitSemanticError (var_currentErrorLocation_17389, GALGAS_string ("this object has no property"), fixItArray1  COMMA_SOURCE_FILE ("declaration-guard.galgas", 487)) ;
          var_currentObject_17452.drop () ; // Release error dropped variable
        }
      }
      break ;
    case GALGAS_accessInAssignmentAST::kEnum_arrayAccess:
      {
        const cEnumAssociatedValues_accessInAssignmentAST_arrayAccess * extractPtr_18905 = (const cEnumAssociatedValues_accessInAssignmentAST_arrayAccess *) (enumerator_17811.current_mAccess (HERE).unsafePointer ()) ;
        const GALGAS_expressionAST extractedValue_indexExpression = extractPtr_18905->mAssociatedValue0 ;
        const GALGAS_location extractedValue_endOfIndex = extractPtr_18905->mAssociatedValue1 ;
        TC_Array <C_FixItDescription> fixItArray2 ;
        inCompiler->emitSemanticError (extractedValue_endOfIndex, GALGAS_string ("not handled yet"), fixItArray2  COMMA_SOURCE_FILE ("declaration-guard.galgas", 490)) ;
        var_currentObject_17452.drop () ; // Release error dropped variable
      }
      break ;
    }
    enumerator_17811.gotoNextObject () ;
  }
  GALGAS_lstring var_methodName_18965 ;
  switch (var_lastAccess_17755.enumValue ()) {
  case GALGAS_accessInAssignmentAST::kNotBuilt:
    break ;
  case GALGAS_accessInAssignmentAST::kEnum_property:
    {
      const cEnumAssociatedValues_accessInAssignmentAST_property * extractPtr_19400 = (const cEnumAssociatedValues_accessInAssignmentAST_property *) (var_lastAccess_17755.unsafePointer ()) ;
      const GALGAS_lstring extractedValue_propertyName = extractPtr_19400->mAssociatedValue0 ;
      var_methodName_18965 = extractedValue_propertyName ;
      GALGAS_PLMType var_currentType_19077 = extensionGetter_type (var_currentObject_17452, inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 498)) ;
      const enumGalgasBool test_3 = var_currentType_19077.getter_isStructure (SOURCE_FILE ("declaration-guard.galgas", 499)).boolEnum () ;
      if (kBoolTrue == test_3) {
        GALGAS_universalPropertyAndRoutineMapForContext var_universalMap_19202 ;
        GALGAS_lstring joker_19169_2 ; // Joker input parameter
        GALGAS_propertyMap joker_19169_1 ; // Joker input parameter
        GALGAS_propertyList joker_19204_3 ; // Joker input parameter
        GALGAS_PLMTypeFlags joker_19204_2 ; // Joker input parameter
        GALGAS_string joker_19204_1 ; // Joker input parameter
        var_currentType_19077.method_structure (joker_19169_2, joker_19169_1, var_universalMap_19202, joker_19204_3, joker_19204_2, joker_19204_1, inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 500)) ;
        var_currentMap_17540 = var_universalMap_19202 ;
        var_currentErrorLocation_17389 = extractedValue_propertyName.getter_location (HERE) ;
      }else if (kBoolFalse == test_3) {
        TC_Array <C_FixItDescription> fixItArray4 ;
        inCompiler->emitSemanticError (var_currentErrorLocation_17389, GALGAS_string ("this object has no property"), fixItArray4  COMMA_SOURCE_FILE ("declaration-guard.galgas", 504)) ;
        var_currentObject_17452.drop () ; // Release error dropped variable
        var_methodName_18965.drop () ; // Release error dropped variable
      }
    }
    break ;
  case GALGAS_accessInAssignmentAST::kEnum_arrayAccess:
    {
      const cEnumAssociatedValues_accessInAssignmentAST_arrayAccess * extractPtr_19534 = (const cEnumAssociatedValues_accessInAssignmentAST_arrayAccess *) (var_lastAccess_17755.unsafePointer ()) ;
      const GALGAS_location extractedValue_endOfIndex = extractPtr_19534->mAssociatedValue1 ;
      TC_Array <C_FixItDescription> fixItArray5 ;
      inCompiler->emitSemanticError (extractedValue_endOfIndex, GALGAS_string ("a property access is required here"), fixItArray5  COMMA_SOURCE_FILE ("declaration-guard.galgas", 507)) ;
      var_currentObject_17452.drop () ; // Release error dropped variable
      var_methodName_18965.drop () ; // Release error dropped variable
    }
    break ;
  }
  GALGAS_lstring var_routineMangledName_19631 = function_routineMangledNameFromCall (GALGAS_string ("$").add_operation (extensionGetter_key (extensionGetter_type (var_currentObject_17452, inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 510)), inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 510)), inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 510)), var_methodName_18965, object->mProperty_mArguments, inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 510)) ;
  GALGAS_lstring var_signature_19771 = extensionGetter_routineSignature (object->mProperty_mArguments, var_methodName_18965.getter_location (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 512)) ;
  GALGAS_routineDescriptor var_routineDescriptor_20000 ;
  GALGAS_lstring joker_19917 ; // Joker input parameter
  callExtensionMethod_searchRoutine ((const cPtr_universalPropertyAndRoutineMapForContext *) var_currentMap_17540.ptr (), var_methodName_18965, var_signature_19771, joker_19917, var_routineDescriptor_20000, inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 514)) ;
  GALGAS_procCallEffectiveParameterListIR var_effectiveParameterListIR_20102 = GALGAS_procCallEffectiveParameterListIR::constructor_emptyList (SOURCE_FILE ("declaration-guard.galgas", 521)) ;
  switch (var_routineDescriptor_20000.getter_mRoutineCallingScheme (HERE).enumValue ()) {
  case GALGAS_routineCallingSheme::kNotBuilt:
    break ;
  case GALGAS_routineCallingSheme::kEnum_staticCall:
    {
      var_effectiveParameterListIR_20102.addAssign_operation (GALGAS_procEffectiveParameterPassingModeIR::constructor_outputInput (SOURCE_FILE ("declaration-guard.galgas", 524)), var_currentObject_17452  COMMA_SOURCE_FILE ("declaration-guard.galgas", 524)) ;
    }
    break ;
  case GALGAS_routineCallingSheme::kEnum_propertyIndirectCall:
    {
  ...
  GALGAS_routineTypedSignature var_formalSignature_20483 = var_routineDescriptor_20000.getter_mSignature (HERE) ;
  const enumGalgasBool test_6 = GALGAS_bool (kIsNotEqual, var_routineDescriptor_20000.getter_mReturnTypeProxy (HERE).objectCompare (GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("declaration-guard.galgas", 533)))).boolEnum () ;
  if (kBoolTrue == test_6) {
    TC_Array <C_FixItDescription> fixItArray7 ;
    inCompiler->emitSemanticError (var_methodName_18965.getter_location (SOURCE_FILE ("declaration-guard.galgas", 534)), GALGAS_string ("not a procedure (returns a value)"), fixItArray7  COMMA_SOURCE_FILE ("declaration-guard.galgas", 534)) ;
    var_routineDescriptor_20000.drop () ; // Release error dropped variable
    outArgument_outConvenienceGuardGenerationIR.drop () ; // Release error dropped variable
  }else if (kBoolFalse == test_6) {
    {
    routine_analyzeEffectiveParametersNew (constinArgument_inSelfType, var_formalSignature_20483, object->mProperty_mArguments, var_methodName_18965.getter_location (HERE), constinArgument_inCallerNameForInvocationGraph, constinArgument_inContext, constinArgument_inCurrentMode, ioArgument_ioTemporaries, ioArgument_ioGlobalLiteralStringMap, ioArgument_ioUniversalMap, var_baseGuardAllocaList_17291, var_baseGuardInstructionGenerationList_17352, var_effectiveParameterListIR_20102, inCompiler  COMMA_SOURCE_FILE ("declaration-guard.galgas", 544)) ;
    }
    switch (var_routineDescriptor_20000.getter_mRoutineCallingScheme (HERE).enumValue ()) {
    case GALGAS_routineCallingSheme::kNotBuilt:
      break ;
    case GALGAS_routineCallingSheme::kEnum_staticCall:
      {
        outArgument_outConvenienceGuardGenerationIR = GALGAS_guardKindGenerationIR::constructor_convenienceGuard (var_baseGuardAllocaList_17291, var_baseGuardInstructionGenerationList_17352, var_routineMangledName_19631.getter_string (HERE), var_effectiveParameterListIR_20102  COMMA_SOURCE_FILE ("declaration-guard.galgas", 562)) ;
      }
      break ;
    case GALGAS_routineCallingSheme::kEnum_propertyIndirectCall:
      {
        TC_Array <C_FixItDescription> fixItArray8 ;
        inCompiler->emitSemanticError (GALGAS_location::constructor_nowhere (SOURCE_FILE ("declaration-guard.galgas", 569)), GALGAS_string ("NOT HANDLED YET"), fixItArray8  COMMA_SOURCE_FILE ("declaration-guard.galgas", 569)) ;
        outArgument_outConvenienceGuardGenerationIR.drop () ; // Release error dropped variable
      }
      break ;
    }
