...
static const char * gSyntaxErrorMessage_plm_5F_lexique_continue = "the 'continue' keyword" ;
...
C_String C_Lexique_plm_5F_lexique::getMessageForTerminal (const int16_t inTerminalIndex) const {
  static const char * syntaxErrorMessageArray [120] = {kEndOfSourceLexicalErrorMessage,
    ...
    gSyntaxErrorMessage_plm_5F_lexique_continue,
...
static const utf32 kUnicodeString_plm_5F_lexique_continue [] = {
  TO_UNICODE ('c'),
  TO_UNICODE ('o'),
  TO_UNICODE ('n'),
  TO_UNICODE ('t'),
...
static const C_unicode_lexique_table_entry ktable_for_plm_5F_lexique_keyWordList [ktable_size_plm_5F_lexique_keyWordList] = {
  ...
  C_unicode_lexique_table_entry (kUnicodeString_plm_5F_lexique_continue, 8, C_Lexique_plm_5F_lexique::kToken_continue),
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_module_5F_property_i17_ (GALGAS_modulePropertyListAST & ioArgument_ioPropertyList,
  ...
  case 1: {
    ...
    var_constant_2471 = GALGAS_bool (false) ;
  } break ;
  case 2: {
    ...
    var_constant_2471 = GALGAS_bool (true) ;
  } break ;
  default:
    break ;
  }
  GALGAS_lstring var_fieldName_2598 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  case 1: {
    GALGAS_lstring var_typeName_2638 = inCompiler->synthetizedAttribute_tokenString () ;
    ...
    case 1: {
      ioArgument_ioPropertyList.addAssign_operation (var_fieldName_2598, var_constant_2471, var_typeName_2638, GALGAS_structurePropertyInitOptionalExpressionAST::constructor_noExpression (SOURCE_FILE ("declaration-module.galgas", 70))  COMMA_SOURCE_FILE ("declaration-module.galgas", 70)) ;
    } break ;
    case 2: {
      ...
      GALGAS_expressionAST var_initExpression_2785 ;
      nt_expression_ (var_initExpression_2785, inCompiler) ;
      ioArgument_ioPropertyList.addAssign_operation (var_fieldName_2598, var_constant_2471, var_typeName_2638, GALGAS_structurePropertyInitOptionalExpressionAST::constructor_expression (var_initExpression_2785  COMMA_SOURCE_FILE ("declaration-module.galgas", 74))  COMMA_SOURCE_FILE ("declaration-module.galgas", 74)) ;
    } break ;
    default:
      break ;
    }
  ...
  case 2: {
    ...
    GALGAS_expressionAST var_initExpression_2954 ;
    nt_expression_ (var_initExpression_2954, inCompiler) ;
    ioArgument_ioPropertyList.addAssign_operation (var_fieldName_2598, var_constant_2471, GALGAS_string::makeEmptyString ().getter_nowhere (SOURCE_FILE ("declaration-module.galgas", 79)), GALGAS_structurePropertyInitOptionalExpressionAST::constructor_expression (var_initExpression_2954  COMMA_SOURCE_FILE ("declaration-module.galgas", 79))  COMMA_SOURCE_FILE ("declaration-module.galgas", 79)) ;
  } break ;
  default:
    break ;
  }
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_i18_ (GALGAS_ast & ioArgument_ioAST,
  ...
  GALGAS_lstring var_moduleName_3278 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GALGAS_functionDeclarationListAST var_functionDeclarationListAST_3345 = GALGAS_functionDeclarationListAST::constructor_emptyList (SOURCE_FILE ("declaration-module.galgas", 89)) ;
  GALGAS_modulePropertyListAST var_modulePropertyListAST_3399 = GALGAS_modulePropertyListAST::constructor_emptyList (SOURCE_FILE ("declaration-module.galgas", 90)) ;
  GALGAS_guardDeclarationListAST var_guardListAST_3446 = GALGAS_guardDeclarationListAST::constructor_emptyList (SOURCE_FILE ("declaration-module.galgas", 91)) ;
  GALGAS_systemRoutineDeclarationListAST var_svcListAST_3499 = GALGAS_systemRoutineDeclarationListAST::constructor_emptyList (SOURCE_FILE ("declaration-module.galgas", 92)) ;
  GALGAS_initListAST var_initList_3530 = GALGAS_initListAST::constructor_emptyList (SOURCE_FILE ("declaration-module.galgas", 93)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_plm_5F_syntax_24 (inCompiler)) {
    case 2: {
      GALGAS_initAST var_init_3591 ;
      nt_declaration_5F_init_ (var_init_3591, var_moduleName_3278, inCompiler) ;
      var_initList_3530.addAssign_operation (var_init_3591  COMMA_SOURCE_FILE ("declaration-module.galgas", 97)) ;
    } break ;
    case 3: {
      nt_isr_ (ioArgument_ioAST.mProperty_mISRDeclarationListAST, var_moduleName_3278, inCompiler) ;
    } break ;
    case 4: {
      nt_module_5F_property_ (var_modulePropertyListAST_3399, inCompiler) ;
    } break ;
    case 5: {
      nt_function_ (var_functionDeclarationListAST_3345, inCompiler) ;
    } break ;
    case 6: {
      nt_system_5F_routine_ (var_svcListAST_3499, inCompiler) ;
    } break ;
    case 7: {
      nt_guard_ (var_guardListAST_3446, inCompiler) ;
    } break ;
    case 8: {
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__3B_) COMMA_SOURCE_FILE ("declaration-module.galgas", 109)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__7D_) COMMA_SOURCE_FILE ("declaration-module.galgas", 111)) ;
  ioArgument_ioAST.mProperty_mModuleDeclarationListAST.addAssign_operation (GALGAS_moduleDeclarationAST::constructor_new (var_moduleName_3278, var_modulePropertyListAST_3399, var_functionDeclarationListAST_3345, var_svcListAST_3499, var_guardListAST_3446, var_initList_3530  COMMA_SOURCE_FILE ("declaration-module.galgas", 113))  COMMA_SOURCE_FILE ("declaration-module.galgas", 113)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_i19_ (GALGAS_ast & ioArgument_ioAST,
                                                                 C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_module) COMMA_SOURCE_FILE ("declaration-module.galgas", 126)) ;
  GALGAS_lstring var_moduleName_4366 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_identifier) COMMA_SOURCE_FILE ("declaration-module.galgas", 127)) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__28_) COMMA_SOURCE_FILE ("declaration-module.galgas", 128)) ;
  GALGAS_moduleInstanciationArgumentListAST var_moduleInstanciationArgumentList_4446 = GALGAS_moduleInstanciationArgumentListAST::constructor_emptyList (SOURCE_FILE ("declaration-module.galgas", 129)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_plm_5F_syntax_25 (inCompiler)) {
    case 2: {
      GALGAS_lstring var_selector_4505 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__21_selector_3A_) COMMA_SOURCE_FILE ("declaration-module.galgas", 132)) ;
      GALGAS_expressionAST var_expression_4540 ;
      nt_expression_ (var_expression_4540, inCompiler) ;
      var_moduleInstanciationArgumentList_4446.addAssign_operation (var_selector_4505, var_expression_4540  COMMA_SOURCE_FILE ("declaration-module.galgas", 134)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__29_) COMMA_SOURCE_FILE ("declaration-module.galgas", 136)) ;
  ioArgument_ioAST.mProperty_mRequiredModuleListAST.addAssign_operation (var_moduleName_4366, var_moduleInstanciationArgumentList_4446  COMMA_SOURCE_FILE ("declaration-module.galgas", 137)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_guarded_5F_command_i88_ (GALGAS_guardedCommandAST & outArgument_outGuardedCommand,
  ...
  case 1: {
    GALGAS_expressionAST var_expression_2079 ;
    GALGAS_location var_endOfExp_2104 ;
    GALGAS_bool var_warnsOnStaticExpression_2140 ;
    switch (select_plm_5F_syntax_75 (inCompiler)) {
    case 1: {
      var_expression_2079 = GALGAS_literalBooleanInExpressionAST::constructor_new (GALGAS_bool (true)  COMMA_SOURCE_FILE ("instruction-sync.galgas", 49)) ;
      var_endOfExp_2104 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("instruction-sync.galgas", 50)) ;
      var_warnsOnStaticExpression_2140 = GALGAS_bool (false) ;
    } break ;
    case 2: {
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__28_) COMMA_SOURCE_FILE ("instruction-sync.galgas", 53)) ;
      nt_expression_ (var_expression_2079, inCompiler) ;
      var_endOfExp_2104 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("instruction-sync.galgas", 55)) ;
      var_warnsOnStaticExpression_2140 = GALGAS_bool (true) ;
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__29_) COMMA_SOURCE_FILE ("instruction-sync.galgas", 57)) ;
    } break ;
    default:
      break ;
    }
    GALGAS_lstring var_receiverName_2459 = inCompiler->synthetizedAttribute_tokenString () ;
    ...
    GALGAS_lstring var_guardName_2484 ;
    switch (select_plm_5F_syntax_76 (inCompiler)) {
    case 1: {
      var_guardName_2484 = var_receiverName_2459 ;
      var_receiverName_2459 = GALGAS_string::makeEmptyString ().getter_here (inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 63)) ;
    } break ;
    case 2: {
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__2E_) COMMA_SOURCE_FILE ("instruction-sync.galgas", 65)) ;
      var_guardName_2484 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_identifier) COMMA_SOURCE_FILE ("instruction-sync.galgas", 66)) ;
    } break ;
    default:
      break ;
    }
    GALGAS_effectiveArgumentListAST var_effectiveParameterList_2684 ;
    GALGAS_location joker_2686 ; // Joker input parameter
    nt_effective_5F_parameters_ (var_effectiveParameterList_2684, joker_2686, inCompiler) ;
    joker_2686.drop () ; // Release temporary input variables (joker in source)
    GALGAS_bool var_isWhileCommand_2714 ;
    switch (select_plm_5F_syntax_77 (inCompiler)) {
    case 1: {
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_exit) COMMA_SOURCE_FILE ("instruction-sync.galgas", 71)) ;
      var_isWhileCommand_2714 = GALGAS_bool (false) ;
    } break ;
    case 2: {
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_continue) COMMA_SOURCE_FILE ("instruction-sync.galgas", 74)) ;
      var_isWhileCommand_2714 = GALGAS_bool (true) ;
    } break ;
    default:
      break ;
    }
    outArgument_outGuardedCommand = GALGAS_guardedCommandAST::constructor_boolAndSync (var_isWhileCommand_2714, var_expression_2079, var_warnsOnStaticExpression_2140, var_endOfExp_2104, var_receiverName_2459, var_guardName_2484, var_effectiveParameterList_2684  COMMA_SOURCE_FILE ("instruction-sync.galgas", 77)) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__28_) COMMA_SOURCE_FILE ("instruction-sync.galgas", 87)) ;
    GALGAS_expressionAST var_expression_3233 ;
    nt_expression_ (var_expression_3233, inCompiler) ;
    GALGAS_location var_endOfExp_3252 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("instruction-sync.galgas", 89)) ;
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__29_) COMMA_SOURCE_FILE ("instruction-sync.galgas", 90)) ;
    GALGAS_bool var_isWhileCommand_3306 ;
    switch (select_plm_5F_syntax_78 (inCompiler)) {
    case 1: {
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_exit) COMMA_SOURCE_FILE ("instruction-sync.galgas", 93)) ;
      var_isWhileCommand_3306 = GALGAS_bool (false) ;
    } break ;
    case 2: {
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_continue) COMMA_SOURCE_FILE ("instruction-sync.galgas", 96)) ;
      var_isWhileCommand_3306 = GALGAS_bool (true) ;
    } break ;
    default:
      break ;
    }
    outArgument_outGuardedCommand = GALGAS_guardedCommandAST::constructor_boolean (var_isWhileCommand_3306, var_expression_3233, var_endOfExp_3252  COMMA_SOURCE_FILE ("instruction-sync.galgas", 99)) ;
  } break ;
  default:
    break ;
  }
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_instruction_i89_ (GALGAS_instructionListAST & ioArgument_ioInstructionList,
                                                                 C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_sync) COMMA_SOURCE_FILE ("instruction-sync.galgas", 110)) ;
  GALGAS_location var_startLocation_3813 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("instruction-sync.galgas", 111)) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__7B_) COMMA_SOURCE_FILE ("instruction-sync.galgas", 112)) ;
  GALGAS_syncInstructionBranchListAST var_onInstructionBranchList_3896 = GALGAS_syncInstructionBranchListAST::constructor_emptyList (SOURCE_FILE ("instruction-sync.galgas", 113)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    GALGAS_guardedCommandAST var_guardedCommand_3975 ;
    nt_guarded_5F_command_ (var_guardedCommand_3975, inCompiler) ;
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__3A_) COMMA_SOURCE_FILE ("instruction-sync.galgas", 116)) ;
    GALGAS_instructionListAST var_instructionList_4030 ;
    nt_instructionList_ (var_instructionList_4030, inCompiler) ;
    var_onInstructionBranchList_3896.addAssign_operation (var_guardedCommand_3975, var_instructionList_4030, GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("instruction-sync.galgas", 118))  COMMA_SOURCE_FILE ("instruction-sync.galgas", 118)) ;
  ...
  ioArgument_ioInstructionList.addAssign_operation (GALGAS_syncInstructionAST::constructor_new (var_startLocation_3813, var_onInstructionBranchList_3896, GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("instruction-sync.galgas", 121))  COMMA_SOURCE_FILE ("instruction-sync.galgas", 121))  COMMA_SOURCE_FILE ("instruction-sync.galgas", 121)) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__7D_) COMMA_SOURCE_FILE ("instruction-sync.galgas", 122)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_procedure_5F_call_i94_ (GALGAS_callInstructionAST & outArgument_outInstruction,
                                                                       C_Lexique_plm_5F_lexique * inCompiler) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_lvalue_i96_ (GALGAS_LValueAST & outArgument_outAssignmentTargetAST,
                                                            C_Lexique_plm_5F_lexique * inCompiler) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_effective_5F_parameters_i97_ (GALGAS_effectiveArgumentListAST & outArgument_outEffectiveParameterList,
