...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_i16_ (GALGAS_ast & ioArgument_ioAST,
                                                                 C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_registers COMMA_SOURCE_FILE ("declaration-control-register.galgas", 75)) ;
  GALGAS_registerGroupListAST var_registerGroupListAST_3163 = GALGAS_registerGroupListAST::constructor_emptyList (SOURCE_FILE ("declaration-control-register.galgas", 76)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    GALGAS_lstring var_registerGroupName_3221 = inCompiler->synthetizedAttribute_tokenString () ;
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__23_groupName COMMA_SOURCE_FILE ("declaration-control-register.galgas", 78)) ;
    switch (select_plm_5F_syntax_17 (inCompiler)) {
    case 1: {
      GALGAS_lbigint var_registerGroupBaseAddress_3291 = inCompiler->synthetizedAttribute_bigInteger () ;
      ...
      GALGAS_controlRegisterGroupKindAST var_groupKind_3313 = GALGAS_controlRegisterGroupKindAST::constructor_single (var_registerGroupBaseAddress_3291  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 81)) ;
      var_registerGroupListAST_3163.addAssign_operation (var_registerGroupName_3221, var_groupKind_3313  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 82)) ;
    } break ;
    case 2: {
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__5B_ COMMA_SOURCE_FILE ("declaration-control-register.galgas", 84)) ;
      GALGAS_lbigint var_groupSize_3529 = inCompiler->synthetizedAttribute_bigInteger () ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_integer COMMA_SOURCE_FILE ("declaration-control-register.galgas", 85)) ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__5D_ COMMA_SOURCE_FILE ("declaration-control-register.galgas", 86)) ;
      GALGAS_lbigintlist var_groupBaseAddresses_3581 = GALGAS_lbigintlist::constructor_emptyList (SOURCE_FILE ("declaration-control-register.galgas", 87)) ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__7B_ COMMA_SOURCE_FILE ("declaration-control-register.galgas", 88)) ;
      bool repeatFlag_1 = true ;
      while (repeatFlag_1) {
        GALGAS_lbigint var_baseAddress_3659 = inCompiler->synthetizedAttribute_bigInteger () ;
        inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_integer COMMA_SOURCE_FILE ("declaration-control-register.galgas", 90)) ;
        var_groupBaseAddresses_3581.addAssign_operation (var_baseAddress_3659  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 91)) ;
        switch (select_plm_5F_syntax_18 (inCompiler)) {
        case 2: {
          inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__2C_ COMMA_SOURCE_FILE ("declaration-control-register.galgas", 93)) ;
        } break ;
        default:
          repeatFlag_1 = false ;
          break ;
      ...
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__7D_ COMMA_SOURCE_FILE ("declaration-control-register.galgas", 95)) ;
      GALGAS_controlRegisterGroupKindAST var_groupKind_3778 = GALGAS_controlRegisterGroupKindAST::constructor_groupArray (var_groupSize_3529, var_groupBaseAddresses_3581  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 96)) ;
      var_registerGroupListAST_3163.addAssign_operation (var_registerGroupName_3221, var_groupKind_3778  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 97)) ;
    } break ;
    default:
      break ;
    }
  ...
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__7B_ COMMA_SOURCE_FILE ("declaration-control-register.galgas", 102)) ;
  GALGAS_controlRegisterDeclarationList var_controlRegisterDeclarationList_4047 = GALGAS_controlRegisterDeclarationList::constructor_emptyList (SOURCE_FILE ("declaration-control-register.galgas", 103)) ;
  bool repeatFlag_2 = true ;
  while (repeatFlag_2) {
    switch (select_plm_5F_syntax_19 (inCompiler)) {
    case 2: {
      GALGAS_controlRegisterNameListAST var_registerDeclarationList_4131 = GALGAS_controlRegisterNameListAST::constructor_emptyList (SOURCE_FILE ("declaration-control-register.galgas", 106)) ;
      bool repeatFlag_3 = true ;
      while (repeatFlag_3) {
        nt_registerDeclaration_ (ioArgument_ioAST, var_registerDeclarationList_4131, inCompiler) ;
      ...
      GALGAS_lstring var_registerTypeName_4272 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__24_type COMMA_SOURCE_FILE ("declaration-control-register.galgas", 111)) ;
      GALGAS_controlRegisterBitSliceList var_registerBitSliceList_4328 = GALGAS_controlRegisterBitSliceList::constructor_emptyList (SOURCE_FILE ("declaration-control-register.galgas", 112)) ;
      switch (select_plm_5F_syntax_21 (inCompiler)) {
      case 1: {
      } break ;
      case 2: {
        inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__7B_ COMMA_SOURCE_FILE ("declaration-control-register.galgas", 115)) ;
        bool repeatFlag_4 = true ;
        while (repeatFlag_4) {
          GALGAS_controlRegisterBitSlice var_registerBitSlice_4434 ;
          switch (select_plm_5F_syntax_23 (inCompiler)) {
          case 1: {
            GALGAS_lbigint var_unusedBitCount_4502 = inCompiler->synthetizedAttribute_bigInteger () ;
            inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_integer COMMA_SOURCE_FILE ("declaration-control-register.galgas", 119)) ;
            var_registerBitSlice_4434 = GALGAS_controlRegisterBitSlice::constructor_unusedBits (var_unusedBitCount_4502  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 120)) ;
          } break ;
          case 2: {
            GALGAS_lstring var_bitName_4620 = inCompiler->synthetizedAttribute_tokenString () ;
            ...
            case 1: {
              var_registerBitSlice_4434 = GALGAS_controlRegisterBitSlice::constructor_namedBit (var_bitName_4620, GALGAS_lbigint::constructor_new (GALGAS_bigint ("1", inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 124)), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 124))  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 124))  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 124)) ;
            } break ;
            case 2: {
              inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__3A_ COMMA_SOURCE_FILE ("declaration-control-register.galgas", 126)) ;
              GALGAS_lbigint var_bitCount_4802 = inCompiler->synthetizedAttribute_bigInteger () ;
              ...
              var_registerBitSlice_4434 = GALGAS_controlRegisterBitSlice::constructor_namedBit (var_bitName_4620, var_bitCount_4802  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 128)) ;
            } break ;
            default:
              break ;
            }
          ...
          var_registerBitSliceList_4328.addAssign_operation (var_registerBitSlice_4434  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 131)) ;
          switch (select_plm_5F_syntax_22 (inCompiler)) {
          case 2: {
            inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__2C_ COMMA_SOURCE_FILE ("declaration-control-register.galgas", 133)) ;
          } break ;
          default:
            repeatFlag_4 = false ;
            break ;
        ...
        inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__7D_ COMMA_SOURCE_FILE ("declaration-control-register.galgas", 135)) ;
      } break ;
      default:
        break ;
      }
      GALGAS_location var_endOfBitSlice_5045 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 137)) ;
      var_controlRegisterDeclarationList_4047.addAssign_operation (var_registerDeclarationList_4131, var_registerTypeName_4272, var_registerBitSliceList_4328, var_endOfBitSlice_5045  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 138)) ;
    } break ;
    default:
      repeatFlag_2 = false ;
      break ;
  ...
  ioArgument_ioAST.mProperty_mDeclarationListAST.addAssign_operation (GALGAS_controlRegisterGroupDeclarationAST::constructor_new (var_registerGroupListAST_3163, var_controlRegisterDeclarationList_4047  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 140))  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 140)) ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_registerDeclaration_i17_ (GALGAS_ast & ioArgument_ioAST,
                                                                         ...
                                                                         C_Lexique_plm_5F_lexique * inCompiler) {
  GALGAS_lstring var_registerName_5608 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("declaration-control-register.galgas", 150)) ;
  GALGAS_lstringlist var_attributeList_5639 = GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("declaration-control-register.galgas", 151)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_plm_5F_syntax_25 (inCompiler)) {
    case 2: {
      GALGAS_lstring var_attribute_5699 = inCompiler->synthetizedAttribute_tokenString () ;
      ...
      var_attributeList_5639.addAssign_operation (var_attribute_5699  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 155)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  case 1: {
    GALGAS_expressionAST var_registerAddress_5800 ;
    nt_expression_ (ioArgument_ioAST, var_registerAddress_5800, inCompiler) ;
    ioArgument_ioRegisterDeclarationList.addAssign_operation (var_registerName_5608, GALGAS_controlRegisterKind::constructor_scalar (SOURCE_FILE ("declaration-control-register.galgas", 161)), var_attributeList_5639, var_registerAddress_5800, GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 164))  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 159)) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__5B_ COMMA_SOURCE_FILE ("declaration-control-register.galgas", 166)) ;
    GALGAS_expressionAST var_sizeExpression_6002 ;
    nt_expression_ (ioArgument_ioAST, var_sizeExpression_6002, inCompiler) ;
    GALGAS_location var_sizeExpressionLocation_6035 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 168)) ;
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__5D_ COMMA_SOURCE_FILE ("declaration-control-register.galgas", 169)) ;
    GALGAS_expressionAST var_baseAddressExpression_6116 ;
    nt_expression_ (ioArgument_ioAST, var_baseAddressExpression_6116, inCompiler) ;
    GALGAS_location var_baseAddressExpressionLocation_6156 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 171)) ;
    GALGAS_lstring var_attribute_6207 = inCompiler->synthetizedAttribute_tokenString () ;
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__40_attribute COMMA_SOURCE_FILE ("declaration-control-register.galgas", 172)) ;
    const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, var_attribute_6207.getter_string (HERE).objectCompare (GALGAS_string ("inc"))).boolEnum () ;
    if (kBoolTrue == test_1) {
      TC_Array <C_FixItDescription> fixItArray2 ;
      appendFixItActions (fixItArray2, kFixItReplace, GALGAS_string ("@inc")) ;
      inCompiler->emitSemanticError (var_attribute_6207.getter_location (SOURCE_FILE ("declaration-control-register.galgas", 174)), GALGAS_string ("attribute should be @inc"), fixItArray2  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 174)) ;
    }
    GALGAS_expressionAST var_arrayElementSizeExpression_6394 ;
    nt_expression_ (ioArgument_ioAST, var_arrayElementSizeExpression_6394, inCompiler) ;
    GALGAS_location var_arrayElementSizeExpressionLocation_6439 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 177)) ;
    ioArgument_ioRegisterDeclarationList.addAssign_operation (var_registerName_5608, GALGAS_controlRegisterKind::constructor_registerArray (var_sizeExpression_6002, var_sizeExpressionLocation_6035, var_arrayElementSizeExpression_6394, var_arrayElementSizeExpressionLocation_6439  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 180)), var_attributeList_5639, var_baseAddressExpression_6116, var_baseAddressExpressionLocation_6156  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 178)) ;
  } break ;
  default:
    break ;
  }
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_primary_i63_ (GALGAS_ast & ioArgument_ioAST,
                                                             ...
                                                             C_Lexique_plm_5F_lexique * inCompiler) {
  outArgument_outExpression.drop () ; // Release 'out' argument
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_addressof COMMA_SOURCE_FILE ("expression-addressof-control-register.galgas", 20)) ;
  ...
  GALGAS_lstring var_registerGroupName_1175 ;
  GALGAS_registerGroupIndexAST var_groupIndex_1191 ;
  GALGAS_lstring var_registerName_1209 ;
  GALGAS_registerIndexAST var_registerIndex_1228 ;
  nt_control_5F_register_5F_lvalue_ (ioArgument_ioAST, var_registerGroupName_1175, var_groupIndex_1191, var_registerName_1209, var_registerIndex_1228, inCompiler) ;
  ...
  outArgument_outExpression = GALGAS_addressofControlRegisterAST::constructor_new (var_registerGroupName_1175, var_registerName_1209, var_registerIndex_1228  COMMA_SOURCE_FILE ("expression-addressof-control-register.galgas", 24)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_expression_5F_if_i70_ (GALGAS_ast & ioArgument_ioAST,
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_expression_5F_if_i70_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_if COMMA_SOURCE_FILE ("expression-if.galgas", 30)) ;
  nt_expression_parse (inCompiler) ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__7B_ COMMA_SOURCE_FILE ("expression-if.galgas", 33)) ;
  nt_expression_parse (inCompiler) ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_primary_i76_ (GALGAS_ast & ioArgument_ioAST,
                                                             ...
                                                             C_Lexique_plm_5F_lexique * inCompiler) {
  outArgument_outExpression.drop () ; // Release 'out' argument
  GALGAS_lstring var_registerGroupName_1679 ;
  GALGAS_registerGroupIndexAST var_groupIndex_1695 ;
  GALGAS_lstring var_registerName_1713 ;
  GALGAS_registerIndexAST var_registerIndex_1732 ;
  nt_control_5F_register_5F_lvalue_ (ioArgument_ioAST, var_registerGroupName_1679, var_groupIndex_1695, var_registerName_1713, var_registerIndex_1732, inCompiler) ;
  GALGAS_lstring var_fieldName_1755 ;
  switch (select_plm_5F_syntax_81 (inCompiler)) {
  case 1: {
    var_fieldName_1755 = GALGAS_string::makeEmptyString ().getter_nowhere (SOURCE_FILE ("expression-control-register.galgas", 39)) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__3A_ COMMA_SOURCE_FILE ("expression-control-register.galgas", 41)) ;
    var_fieldName_1755 = inCompiler->synthetizedAttribute_tokenString () ;
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("expression-control-register.galgas", 42)) ;
  } break ;
  default:
    break ;
  }
  outArgument_outExpression = GALGAS_registerInExpressionAST::constructor_new (var_registerGroupName_1679, var_groupIndex_1695, var_registerName_1713, var_registerIndex_1732, var_fieldName_1755  COMMA_SOURCE_FILE ("expression-control-register.galgas", 45)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_control_5F_register_5F_lvalue_i85_ (GALGAS_ast & ioArgument_ioAST,
                                                                                   GALGAS_lstring & outArgument_outRegisterGroupName,
                                                                                   GALGAS_registerGroupIndexAST & outArgument_outGroupIndex,
                                                                                   GALGAS_lstring & outArgument_outRegisterName,
                                                                                   GALGAS_registerIndexAST & outArgument_outRegisterIndex,
                                                                                   C_Lexique_plm_5F_lexique * inCompiler) {
  outArgument_outRegisterGroupName.drop () ; // Release 'out' argument
  outArgument_outGroupIndex.drop () ; // Release 'out' argument
  outArgument_outRegisterName.drop () ; // Release 'out' argument
  outArgument_outRegisterIndex.drop () ; // Release 'out' argument
  outArgument_outRegisterGroupName = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__23_groupName COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 35)) ;
  switch (select_plm_5F_syntax_87 (inCompiler)) {
  case 1: {
    outArgument_outGroupIndex = GALGAS_registerGroupIndexAST::constructor_noIndex (SOURCE_FILE ("instruction-assignment-control-register.galgas", 37)) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__5B_ COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 39)) ;
    GALGAS_expressionAST var_expression_1750 ;
    nt_expression_ (ioArgument_ioAST, var_expression_1750, inCompiler) ;
    GALGAS_location var_endOfIndex_1771 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 41)) ;
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__5D_ COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 42)) ;
    outArgument_outGroupIndex = GALGAS_registerGroupIndexAST::constructor_index (var_expression_1750, var_endOfIndex_1771  COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 43)) ;
  } break ;
  default:
    break ;
  }
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__3A_ COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 45)) ;
  outArgument_outRegisterName = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 46)) ;
  switch (select_plm_5F_syntax_88 (inCompiler)) {
  case 1: {
    outArgument_outRegisterIndex = GALGAS_registerIndexAST::constructor_noIndex (SOURCE_FILE ("instruction-assignment-control-register.galgas", 48)) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__5B_ COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 50)) ;
    GALGAS_expressionAST var_expression_2025 ;
    nt_expression_ (ioArgument_ioAST, var_expression_2025, inCompiler) ;
    GALGAS_location var_endOfIndex_2046 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 52)) ;
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__5D_ COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 53)) ;
    outArgument_outRegisterIndex = GALGAS_registerIndexAST::constructor_index (var_expression_2025, var_endOfIndex_2046  COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 54)) ;
  } break ;
  default:
    break ;
  }
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_control_5F_register_5F_lvalue_i85_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__23_groupName COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 35)) ;
  switch (select_plm_5F_syntax_87 (inCompiler)) {
  case 1: {
  } break ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_instruction_i86_ (GALGAS_ast & ioArgument_ioAST,
                                                                 GALGAS_instructionListAST & ioArgument_ioInstructionList,
                                                                 C_Lexique_plm_5F_lexique * inCompiler) {
  GALGAS_lstring var_registerGroupName_2420 ;
  GALGAS_registerGroupIndexAST var_groupIndex_2436 ;
  GALGAS_lstring var_registerName_2454 ;
  GALGAS_registerIndexAST var_registerIndexAST_2476 ;
  nt_control_5F_register_5F_lvalue_ (ioArgument_ioAST, var_registerGroupName_2420, var_groupIndex_2436, var_registerName_2454, var_registerIndexAST_2476, inCompiler) ;
  GALGAS_controlRegisterAssignmentOperatorKind var_assignmentKind_2575 ;
  switch (select_plm_5F_syntax_89 (inCompiler)) {
  case 1: {
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__3D_ COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 65)) ;
    var_assignmentKind_2575 = GALGAS_controlRegisterAssignmentOperatorKind::constructor_assignment (SOURCE_FILE ("instruction-assignment-control-register.galgas", 66)) ;
  } break ;
  case 2: {
    GALGAS_infixOperator var_infixOperator_2699 ;
    GALGAS_location var_operatorLocation_2721 ;
    nt_assignment_5F_combined_5F_with_5F_operator_ (var_infixOperator_2699, var_operatorLocation_2721, inCompiler) ;
    var_assignmentKind_2575 = GALGAS_controlRegisterAssignmentOperatorKind::constructor_assignmentWithOperator (var_infixOperator_2699, var_operatorLocation_2721  COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 69)) ;
  } break ;
  default:
    break ;
  }
  GALGAS_expressionAST var_sourceExpression_2914 ;
  nt_expression_ (ioArgument_ioAST, var_sourceExpression_2914, inCompiler) ;
  ioArgument_ioInstructionList.addAssign_operation (GALGAS_controlRegisterAssignmentInstructionAST::constructor_new (var_registerGroupName_2420.getter_location (HERE), var_registerGroupName_2420, var_registerName_2454, var_registerIndexAST_2476, var_assignmentKind_2575, var_sourceExpression_2914  COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 74))  COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 74)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_instruction_i88_ (GALGAS_ast & ioArgument_ioAST,
                                                                 GALGAS_instructionListAST & ioArgument_ioInstructionList,
                                                                 C_Lexique_plm_5F_lexique * inCompiler) {
  GALGAS_lstring var_registerGroupName_1263 ;
  GALGAS_registerGroupIndexAST var_groupIndex_1279 ;
  GALGAS_lstring var_registerName_1297 ;
  GALGAS_registerIndexAST var_registerIndex_1316 ;
  nt_control_5F_register_5F_lvalue_ (ioArgument_ioAST, var_registerGroupName_1263, var_groupIndex_1279, var_registerName_1297, var_registerIndex_1316, inCompiler) ;
  GALGAS_lstring var_attribute_1348 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_attribute_1348.getter_string (HERE).objectCompare (GALGAS_string ("bit"))).boolEnum () ;
  if (kBoolTrue == test_0) {
    TC_Array <C_FixItDescription> fixItArray1 ;
    appendFixItActions (fixItArray1, kFixItReplace, GALGAS_string ("@bit")) ;
    inCompiler->emitSemanticError (var_attribute_1348.getter_location (SOURCE_FILE ("instruction-bit-banding.galgas", 26)), GALGAS_string ("attribute should be @bit"), fixItArray1  COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 26)) ;
  }
  GALGAS_expressionAST var_bitExpression_1514 ;
  nt_expression_ (ioArgument_ioAST, var_bitExpression_1514, inCompiler) ;
  GALGAS_location var_bitExpressionLocation_1544 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 29)) ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__3D_ COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 30)) ;
  GALGAS_expressionAST var_sourceExpression_1616 ;
  nt_expression_ (ioArgument_ioAST, var_sourceExpression_1616, inCompiler) ;
  ioArgument_ioInstructionList.addAssign_operation (GALGAS_bitbandInstructionAST::constructor_new (var_registerGroupName_1263.getter_location (HERE), var_registerGroupName_1263, var_registerName_1297, var_bitExpression_1514, var_bitExpressionLocation_1544, var_sourceExpression_1616, GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 40))  COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 33))  COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 33)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_effective_5F_parameters_i108_ (GALGAS_ast & ioArgument_ioAST,
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_effective_5F_parameters_i108_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__28_ COMMA_SOURCE_FILE ("effective-parameters.galgas", 42)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_plm_5F_syntax_110 (inCompiler)) {
