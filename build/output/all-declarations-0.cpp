...
//---------------------------------------------------------------------------------------------------------------------*
//                                                                                                                     *
//                  Abstract extension method '@abstractDeclarationAST solveEntitiesForDeclarations'                   *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*

static TC_UniqueArray <extensionMethodSignature_abstractDeclarationAST_solveEntitiesForDeclarations> gExtensionMethodTable_abstractDeclarationAST_solveEntitiesForDeclarations ;

//---------------------------------------------------------------------------------------------------------------------*

void enterExtensionMethod_solveEntitiesForDeclarations (const int32_t inClassIndex,
                                                        extensionMethodSignature_abstractDeclarationAST_solveEntitiesForDeclarations inMethod) {
  gExtensionMethodTable_abstractDeclarationAST_solveEntitiesForDeclarations.forceObjectAtIndex (inClassIndex, inMethod, NULL COMMA_HERE) ;
}

//---------------------------------------------------------------------------------------------------------------------*

static void freeExtensionMethod_abstractDeclarationAST_solveEntitiesForDeclarations (void) {
  gExtensionMethodTable_abstractDeclarationAST_solveEntitiesForDeclarations.free () ;
}

//---------------------------------------------------------------------------------------------------------------------*

C_PrologueEpilogue gMethod_abstractDeclarationAST_solveEntitiesForDeclarations (NULL,
                                                                                freeExtensionMethod_abstractDeclarationAST_solveEntitiesForDeclarations) ;

//---------------------------------------------------------------------------------------------------------------------*

void callExtensionMethod_solveEntitiesForDeclarations (const cPtr_abstractDeclarationAST * inObject,
...
//--- Find method
  if (NULL != inObject) {
    ...
    const C_galgas_type_descriptor * info = inObject->classDescriptor () ;
    const int32_t classIndex = info->mSlotID ;
    extensionMethodSignature_abstractDeclarationAST_solveEntitiesForDeclarations f = NULL ;
    if (classIndex < gExtensionMethodTable_abstractDeclarationAST_solveEntitiesForDeclarations.count ()) {
      f = gExtensionMethodTable_abstractDeclarationAST_solveEntitiesForDeclarations (classIndex COMMA_HERE) ;
    }
    if (NULL == f) {
      const C_galgas_type_descriptor * p = info->mSuperclassDescriptor ;
      while ((NULL == f) && (NULL != p)) {
        if (p->mSlotID < gExtensionMethodTable_abstractDeclarationAST_solveEntitiesForDeclarations.count ()) {
          f = gExtensionMethodTable_abstractDeclarationAST_solveEntitiesForDeclarations (p->mSlotID COMMA_HERE) ;
        }
        p = p->mSuperclassDescriptor ;
      }
      gExtensionMethodTable_abstractDeclarationAST_solveEntitiesForDeclarations.forceObjectAtIndex (classIndex, f, NULL COMMA_HERE) ;
    }
    if (NULL == f) {
      fatalError ("FATAL CATEGORY METHOD CALL ERROR", __FILE__, __LINE__) ;
    }else{
      f (inObject, constin_inSemanticContext, inCompiler COMMA_THERE) ;
    }
  }
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_struct_5F_var_5F_declaration_i5_ (GALGAS_structurePropertyListAST & ioArgument_ioFieldListAST,
  ...
  GALGAS_lstring var_fieldName_2208 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  case 1: {
    GALGAS_lstring var_typeName_2248 = inCompiler->synthetizedAttribute_tokenString () ;
    ...
    case 1: {
      ioArgument_ioFieldListAST.addAssign_operation (var_fieldName_2208, var_public_2084, var_typeName_2248, GALGAS_structurePropertyInitOptionalExpressionAST::constructor_noExpression (SOURCE_FILE ("type-structure-declaration.galgas", 57))  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 57)) ;
    } break ;
    case 2: {
      ...
      GALGAS_expressionAST var_initExpression_2393 ;
      nt_expression_ (var_initExpression_2393, inCompiler) ;
      ioArgument_ioFieldListAST.addAssign_operation (var_fieldName_2208, var_public_2084, var_typeName_2248, GALGAS_structurePropertyInitOptionalExpressionAST::constructor_expression (var_initExpression_2393  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 61))  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 61)) ;
    } break ;
    default:
      break ;
    }
  ...
  case 2: {
    ...
    GALGAS_expressionAST var_initExpression_2559 ;
    nt_expression_ (var_initExpression_2559, inCompiler) ;
    ioArgument_ioFieldListAST.addAssign_operation (var_fieldName_2208, var_public_2084, GALGAS_string::makeEmptyString ().getter_nowhere (SOURCE_FILE ("type-structure-declaration.galgas", 66)), GALGAS_structurePropertyInitOptionalExpressionAST::constructor_expression (var_initExpression_2559  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 66))  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 66)) ;
  } break ;
  default:
    break ;
  }
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_struct_5F_var_5F_declaration_i5_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  switch (select_plm_5F_syntax_2 (inCompiler)) {
  case 1: {
  } break ;
  case 2: {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_i6_ (GALGAS_ast & ioArgument_ioAST,
  ...
  GALGAS_lstring var_structureName_2877 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GALGAS_lstringlist var_attributeList_2908 = GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("type-structure-declaration.galgas", 75)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_plm_5F_syntax_5 (inCompiler)) {
    case 2: {
      GALGAS_lstring var_attribute_2968 = inCompiler->synthetizedAttribute_tokenString () ;
      ...
      var_attributeList_2908.addAssign_operation (var_attribute_2968  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 79)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  GALGAS_functionDeclarationListAST var_procedureDeclarationListAST_3079 = GALGAS_functionDeclarationListAST::constructor_emptyList (SOURCE_FILE ("type-structure-declaration.galgas", 82)) ;
  GALGAS_structurePropertyListAST var_fieldList_3124 = GALGAS_structurePropertyListAST::constructor_emptyList (SOURCE_FILE ("type-structure-declaration.galgas", 83)) ;
  GALGAS_systemRoutineDeclarationListAST var_systemRoutineListAST_3187 = GALGAS_systemRoutineDeclarationListAST::constructor_emptyList (SOURCE_FILE ("type-structure-declaration.galgas", 84)) ;
  GALGAS_guardDeclarationListAST var_guardListAST_3234 = GALGAS_guardDeclarationListAST::constructor_emptyList (SOURCE_FILE ("type-structure-declaration.galgas", 85)) ;
  bool repeatFlag_1 = true ;
  while (repeatFlag_1) {
    switch (select_plm_5F_syntax_6 (inCompiler)) {
    case 2: {
      nt_struct_5F_var_5F_declaration_ (var_fieldList_3124, inCompiler) ;
    } break ;
    case 3: {
      nt_function_ (var_procedureDeclarationListAST_3079, inCompiler) ;
    } break ;
    case 4: {
      nt_system_5F_routine_ (var_systemRoutineListAST_3187, inCompiler) ;
    } break ;
    case 5: {
      nt_guard_ (var_guardListAST_3234, inCompiler) ;
    } break ;
    case 6: {
  ...
  ioArgument_ioAST.mProperty_mDeclarationListAST.addAssign_operation (GALGAS_structureDeclarationAST::constructor_new (var_structureName_2877, var_attributeList_2908, var_fieldList_3124, var_procedureDeclarationListAST_3079, var_systemRoutineListAST_3187, var_guardListAST_3234  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 99))  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 99)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_i6_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  ...
  while (repeatFlag_1) {
    switch (select_plm_5F_syntax_6 (inCompiler)) {
    case 2: {
      nt_struct_5F_var_5F_declaration_parse (inCompiler) ;
    } break ;
    case 3: {
      nt_function_parse (inCompiler) ;
    } break ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_i11_ (GALGAS_ast & ioArgument_ioAST,
  ...
  GALGAS_lstring var_registerTypeName_3739 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__24_type) COMMA_SOURCE_FILE ("declaration-control-register.galgas", 100)) ;
  GALGAS_controlRegisterBitSliceList var_registerBitSliceList_3793 = GALGAS_controlRegisterBitSliceList::constructor_emptyList (SOURCE_FILE ("declaration-control-register.galgas", 101)) ;
  switch (select_plm_5F_syntax_11 (inCompiler)) {
  case 1: {
  } break ;
  case 2: {
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__7B_) COMMA_SOURCE_FILE ("declaration-control-register.galgas", 104)) ;
    bool repeatFlag_1 = true ;
    while (repeatFlag_1) {
      GALGAS_controlRegisterBitSlice var_registerBitSlice_3889 ;
      switch (select_plm_5F_syntax_13 (inCompiler)) {
      case 1: {
        GALGAS_lbigint var_unusedBitCount_3953 = inCompiler->synthetizedAttribute_bigInteger () ;
        inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_integer) COMMA_SOURCE_FILE ("declaration-control-register.galgas", 108)) ;
        var_registerBitSlice_3889 = GALGAS_controlRegisterBitSlice::constructor_unusedBits (var_unusedBitCount_3953  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 109)) ;
      } break ;
      case 2: {
        GALGAS_lstring var_bitName_4065 = inCompiler->synthetizedAttribute_tokenString () ;
        inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_identifier) COMMA_SOURCE_FILE ("declaration-control-register.galgas", 111)) ;
        switch (select_plm_5F_syntax_14 (inCompiler)) {
        case 1: {
          var_registerBitSlice_3889 = GALGAS_controlRegisterBitSlice::constructor_namedBit (var_bitName_4065, GALGAS_lbigint::constructor_new (GALGAS_bigint ("1", inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 113)), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 113))  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 113))  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 113)) ;
        } break ;
        case 2: {
          ...
          GALGAS_lbigint var_bitCount_4237 = inCompiler->synthetizedAttribute_bigInteger () ;
          inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_integer) COMMA_SOURCE_FILE ("declaration-control-register.galgas", 116)) ;
          inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__5D_) COMMA_SOURCE_FILE ("declaration-control-register.galgas", 117)) ;
          var_registerBitSlice_3889 = GALGAS_controlRegisterBitSlice::constructor_namedBit (var_bitName_4065, var_bitCount_4237  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 118)) ;
        } break ;
        default:
          break ;
        }
      ...
      var_registerBitSliceList_3793.addAssign_operation (var_registerBitSlice_3889  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 121)) ;
      switch (select_plm_5F_syntax_12 (inCompiler)) {
      case 2: {
        inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__2C_) COMMA_SOURCE_FILE ("declaration-control-register.galgas", 123)) ;
      } break ;
      default:
        repeatFlag_1 = false ;
        break ;
    ...
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__7D_) COMMA_SOURCE_FILE ("declaration-control-register.galgas", 125)) ;
  } break ;
  default:
    break ;
  }
  ioArgument_ioAST.mProperty_mControlRegisterDeclarationListAST.addAssign_operation (var_registerDeclarationList_2368, var_registerTypeName_3739, var_registerBitSliceList_3793, GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 131))  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 127)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_registerDeclaration_i12_ (GALGAS_controlRegisterNameList & ioArgument_ioRegisterDeclarationList,
                                                                         C_Lexique_plm_5F_lexique * inCompiler) {
  GALGAS_lstring var_registerName_4844 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_identifier) COMMA_SOURCE_FILE ("declaration-control-register.galgas", 137)) ;
  GALGAS_lstringlist var_attributeList_4875 = GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("declaration-control-register.galgas", 138)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_plm_5F_syntax_15 (inCompiler)) {
    case 2: {
      GALGAS_lstring var_attribute_4935 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__40_attribute) COMMA_SOURCE_FILE ("declaration-control-register.galgas", 141)) ;
      var_attributeList_4875.addAssign_operation (var_attribute_4935  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 142)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  case 1: {
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_at) COMMA_SOURCE_FILE ("declaration-control-register.galgas", 145)) ;
    GALGAS_expressionAST var_registerAddress_5039 ;
    nt_expression_ (var_registerAddress_5039, inCompiler) ;
    ioArgument_ioRegisterDeclarationList.addAssign_operation (var_registerName_4844, GALGAS_controlRegisterKind::constructor_scalar (SOURCE_FILE ("declaration-control-register.galgas", 149)), var_attributeList_4875, var_registerAddress_5039, GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 152))  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 147)) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__5B_) COMMA_SOURCE_FILE ("declaration-control-register.galgas", 154)) ;
    GALGAS_expressionAST var_sizeExpression_5233 ;
    nt_expression_ (var_sizeExpression_5233, inCompiler) ;
    GALGAS_location var_sizeExpressionLocation_5266 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 156)) ;
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__5D_) COMMA_SOURCE_FILE ("declaration-control-register.galgas", 157)) ;
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_at) COMMA_SOURCE_FILE ("declaration-control-register.galgas", 158)) ;
    GALGAS_expressionAST var_baseAddressExpression_5350 ;
    nt_expression_ (var_baseAddressExpression_5350, inCompiler) ;
    GALGAS_location var_baseAddressExpressionLocation_5390 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 160)) ;
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__3A_) COMMA_SOURCE_FILE ("declaration-control-register.galgas", 161)) ;
    GALGAS_expressionAST var_arrayElementSizeExpression_5468 ;
    nt_expression_ (var_arrayElementSizeExpression_5468, inCompiler) ;
    GALGAS_location var_arrayElementSizeExpressionLocation_5513 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 163)) ;
    ioArgument_ioRegisterDeclarationList.addAssign_operation (var_registerName_4844, GALGAS_controlRegisterKind::constructor_registerArray (var_sizeExpression_5233, var_sizeExpressionLocation_5266, var_arrayElementSizeExpression_5468, var_arrayElementSizeExpressionLocation_5513  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 166)), var_attributeList_4875, var_baseAddressExpression_5350, var_baseAddressExpressionLocation_5390  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 164)) ;
  } break ;
  default:
    break ;
  }
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_registerDeclaration_i12_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_identifier) COMMA_SOURCE_FILE ("declaration-control-register.galgas", 137)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_plm_5F_syntax_15 (inCompiler)) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_module_5F_variable_i15_ (GALGAS_modulePropertyListAST & ioArgument_ioPropertyList,
  ...
  GALGAS_lstring var_fieldName_2441 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  case 1: {
    GALGAS_lstring var_typeName_2481 = inCompiler->synthetizedAttribute_tokenString () ;
    ...
    case 1: {
      ioArgument_ioPropertyList.addAssign_operation (var_fieldName_2441, var_typeName_2481, GALGAS_structurePropertyInitOptionalExpressionAST::constructor_noExpression (SOURCE_FILE ("declaration-module.galgas", 62))  COMMA_SOURCE_FILE ("declaration-module.galgas", 62)) ;
    } break ;
    case 2: {
      ...
      GALGAS_expressionAST var_initExpression_2618 ;
      nt_expression_ (var_initExpression_2618, inCompiler) ;
      ioArgument_ioPropertyList.addAssign_operation (var_fieldName_2441, var_typeName_2481, GALGAS_structurePropertyInitOptionalExpressionAST::constructor_expression (var_initExpression_2618  COMMA_SOURCE_FILE ("declaration-module.galgas", 66))  COMMA_SOURCE_FILE ("declaration-module.galgas", 66)) ;
    } break ;
    default:
      break ;
    }
  ...
  case 2: {
    ...
    GALGAS_expressionAST var_initExpression_2777 ;
    nt_expression_ (var_initExpression_2777, inCompiler) ;
    ioArgument_ioPropertyList.addAssign_operation (var_fieldName_2441, GALGAS_string::makeEmptyString ().getter_nowhere (SOURCE_FILE ("declaration-module.galgas", 71)), GALGAS_structurePropertyInitOptionalExpressionAST::constructor_expression (var_initExpression_2777  COMMA_SOURCE_FILE ("declaration-module.galgas", 71))  COMMA_SOURCE_FILE ("declaration-module.galgas", 71)) ;
  } break ;
  default:
    break ;
  }
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_i16_ (GALGAS_ast & ioArgument_ioAST,
  ...
  GALGAS_lstring var_moduleName_3091 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__7B_) COMMA_SOURCE_FILE ("declaration-module.galgas", 80)) ;
  GALGAS_functionDeclarationListAST var_functionDeclarationListAST_3158 = GALGAS_functionDeclarationListAST::constructor_emptyList (SOURCE_FILE ("declaration-module.galgas", 81)) ;
  GALGAS_modulePropertyListAST var_modulePropertyListAST_3212 = GALGAS_modulePropertyListAST::constructor_emptyList (SOURCE_FILE ("declaration-module.galgas", 82)) ;
  GALGAS_guardDeclarationListAST var_guardListAST_3259 = GALGAS_guardDeclarationListAST::constructor_emptyList (SOURCE_FILE ("declaration-module.galgas", 83)) ;
  GALGAS_systemRoutineDeclarationListAST var_svcListAST_3312 = GALGAS_systemRoutineDeclarationListAST::constructor_emptyList (SOURCE_FILE ("declaration-module.galgas", 84)) ;
  GALGAS_initList var_initList_3340 = GALGAS_initList::constructor_emptySortedList (SOURCE_FILE ("declaration-module.galgas", 85)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_plm_5F_syntax_21 (inCompiler)) {
    case 2: {
      nt_declaration_5F_init_ (var_initList_3340, inCompiler) ;
    } break ;
    case 3: {
      nt_isr_ (ioArgument_ioAST.mProperty_mISRDeclarationListAST, var_moduleName_3091, inCompiler) ;
    } break ;
    case 4: {
      nt_module_5F_variable_ (var_modulePropertyListAST_3212, inCompiler) ;
    } break ;
    case 5: {
      nt_function_ (var_functionDeclarationListAST_3158, inCompiler) ;
    } break ;
    case 6: {
      nt_system_5F_routine_ (var_svcListAST_3312, inCompiler) ;
    } break ;
    case 7: {
      nt_guard_ (var_guardListAST_3259, inCompiler) ;
    } break ;
    case 8: {
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__3B_) COMMA_SOURCE_FILE ("declaration-module.galgas", 100)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__7D_) COMMA_SOURCE_FILE ("declaration-module.galgas", 102)) ;
  ioArgument_ioAST.mProperty_mModuleDeclarationListAST.addAssign_operation (GALGAS_moduleDeclarationAST::constructor_new (var_moduleName_3091, var_modulePropertyListAST_3212, var_functionDeclarationListAST_3158, var_svcListAST_3312, var_guardListAST_3259, var_initList_3340  COMMA_SOURCE_FILE ("declaration-module.galgas", 104))  COMMA_SOURCE_FILE ("declaration-module.galgas", 104)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_i17_ (GALGAS_ast & ioArgument_ioAST,
                                                                 C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_module) COMMA_SOURCE_FILE ("declaration-module.galgas", 117)) ;
  GALGAS_lstring var_moduleName_4141 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_identifier) COMMA_SOURCE_FILE ("declaration-module.galgas", 118)) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__28_) COMMA_SOURCE_FILE ("declaration-module.galgas", 119)) ;
  GALGAS_moduleInstanciationArgumentListAST var_moduleInstanciationArgumentList_4221 = GALGAS_moduleInstanciationArgumentListAST::constructor_emptyList (SOURCE_FILE ("declaration-module.galgas", 120)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_plm_5F_syntax_22 (inCompiler)) {
    case 2: {
      GALGAS_lstring var_selector_4271 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__21_) COMMA_SOURCE_FILE ("declaration-module.galgas", 123)) ;
      GALGAS_expressionAST var_expression_4306 ;
      nt_expression_ (var_expression_4306, inCompiler) ;
      var_moduleInstanciationArgumentList_4221.addAssign_operation (var_selector_4271, var_expression_4306  COMMA_SOURCE_FILE ("declaration-module.galgas", 125)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__29_) COMMA_SOURCE_FILE ("declaration-module.galgas", 127)) ;
  ioArgument_ioAST.mProperty_mRequiredModuleListAST.addAssign_operation (var_moduleName_4141, var_moduleInstanciationArgumentList_4221  COMMA_SOURCE_FILE ("declaration-module.galgas", 128)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_staticArrayProperty_i19_ (GALGAS_staticArrayPropertyListAST & ioArgument_ioPropertyList,
                                                                         C_Lexique_plm_5F_lexique * inCompiler) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_staticArrayProperty_i19_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_let) COMMA_SOURCE_FILE ("declaration-static-array.galgas", 60)) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_identifier) COMMA_SOURCE_FILE ("declaration-static-array.galgas", 61)) ;
  switch (select_plm_5F_syntax_24 (inCompiler)) {
  case 1: {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_staticArray_5F_exp_i21_ (GALGAS_extendStaticArrayExpressionListAST & ioArgument_ioExpressions,
                                                                        C_Lexique_plm_5F_lexique * inCompiler) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_staticArray_5F_exp_i21_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  switch (select_plm_5F_syntax_28 (inCompiler)) {
  case 1: {
    nt_expression_parse (inCompiler) ;
  } break ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_i22_ (GALGAS_ast & ioArgument_ioAST,
  ...
  GALGAS_syncInstructionBranchListAST var_branchList_2325 = GALGAS_syncInstructionBranchListAST::constructor_emptyList (SOURCE_FILE ("declaration-task.galgas", 62)) ;
  nt_taskBody_ (var_taskVarList_2183, var_taskProcList_2233, var_taskInitListAST_2275, var_branchList_2325, inCompiler) ;
  GALGAS_location var_endOfTask_3762 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-task.galgas", 109)) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__7D_) COMMA_SOURCE_FILE ("declaration-task.galgas", 110)) ;
  ioArgument_ioAST.mProperty_mTaskListAST.addAssign_operation (var_taskName_2037, var_priority_2089, var_stackSize_2143, var_taskVarList_2183, var_taskProcList_2233, var_taskInitListAST_2275, var_branchList_2325, var_endOfTask_3762  COMMA_SOURCE_FILE ("declaration-task.galgas", 111)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_taskBody_i23_ (GALGAS_taskVarListAST & ioArgument_taskVarList,
  ...
  while (repeatFlag_0) {
    ...
    case 2: {
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_var) COMMA_SOURCE_FILE ("declaration-task.galgas", 131)) ;
      GALGAS_lstring var_varName_4376 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_identifier) COMMA_SOURCE_FILE ("declaration-task.galgas", 132)) ;
      GALGAS_lstring var_typeName_4400 ;
      switch (select_plm_5F_syntax_30 (inCompiler)) {
      case 1: {
        var_typeName_4400 = GALGAS_string::makeEmptyString ().getter_nowhere (SOURCE_FILE ("declaration-task.galgas", 135)) ;
      } break ;
      case 2: {
        var_typeName_4400 = inCompiler->synthetizedAttribute_tokenString () ;
        inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__24_type) COMMA_SOURCE_FILE ("declaration-task.galgas", 137)) ;
      } break ;
      default:
        break ;
      }
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__3D_) COMMA_SOURCE_FILE ("declaration-task.galgas", 139)) ;
      GALGAS_expressionAST var_initExpression_4540 ;
      nt_expression_ (var_initExpression_4540, inCompiler) ;
      ioArgument_taskVarList.addAssign_operation (var_varName_4376, var_typeName_4400, var_initExpression_4540  COMMA_SOURCE_FILE ("declaration-task.galgas", 141)) ;
    } break ;
    case 3: {
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_func) COMMA_SOURCE_FILE ("declaration-task.galgas", 143)) ;
      GALGAS_lstring var_procName_4652 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_identifier) COMMA_SOURCE_FILE ("declaration-task.galgas", 144)) ;
      GALGAS_routineFormalArgumentList var_formalArgumentList_4754 ;
      nt_procedure_5F_formal_5F_arguments_ (var_formalArgumentList_4754, inCompiler) ;
      GALGAS_lstring var_returnTypeName_4784 ;
      switch (select_plm_5F_syntax_31 (inCompiler)) {
      case 1: {
        var_returnTypeName_4784 = GALGAS_string::makeEmptyString ().getter_here (inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 148)) ;
      } break ;
      case 2: {
        inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__2D__3E_) COMMA_SOURCE_FILE ("declaration-task.galgas", 150)) ;
        var_returnTypeName_4784 = inCompiler->synthetizedAttribute_tokenString () ;
        inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__24_type) COMMA_SOURCE_FILE ("declaration-task.galgas", 151)) ;
      } break ;
      default:
        break ;
      }
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__7B_) COMMA_SOURCE_FILE ("declaration-task.galgas", 153)) ;
      GALGAS_instructionListAST var_instructionList_4952 ;
      nt_instructionList_ (var_instructionList_4952, inCompiler) ;
      GALGAS_location var_endOfProc_4972 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-task.galgas", 155)) ;
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__7D_) COMMA_SOURCE_FILE ("declaration-task.galgas", 156)) ;
      ioArgument_taskProcList.addAssign_operation (GALGAS_mode::constructor_userMode (SOURCE_FILE ("declaration-task.galgas", 157)), GALGAS_bool (false), var_procName_4652, GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("declaration-task.galgas", 157)), var_formalArgumentList_4754, var_returnTypeName_4784, var_instructionList_4952, var_endOfProc_4972  COMMA_SOURCE_FILE ("declaration-task.galgas", 157)) ;
    } break ;
    case 4: {
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_setup) COMMA_SOURCE_FILE ("declaration-task.galgas", 159)) ;
      GALGAS_lbigint var_priority_5180 = inCompiler->synthetizedAttribute_bigInteger () ;
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_integer) COMMA_SOURCE_FILE ("declaration-task.galgas", 160)) ;
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__7B_) COMMA_SOURCE_FILE ("declaration-task.galgas", 161)) ;
      GALGAS_instructionListAST var_instructionList_5235 ;
      nt_instructionList_ (var_instructionList_5235, inCompiler) ;
      GALGAS_location var_endOfInit_5255 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-task.galgas", 163)) ;
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__7D_) COMMA_SOURCE_FILE ("declaration-task.galgas", 164)) ;
      ioArgument_taskInitListAST.addAssign_operation (var_priority_5180, var_instructionList_5235, var_endOfInit_5255  COMMA_SOURCE_FILE ("declaration-task.galgas", 165)) ;
    } break ;
    case 5: {
      GALGAS_guardedCommandAST var_guardedCommand_5418 ;
      nt_guarded_5F_command_ (var_guardedCommand_5418, inCompiler) ;
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__7B_) COMMA_SOURCE_FILE ("declaration-task.galgas", 168)) ;
      GALGAS_instructionListAST var_instructionList_5473 ;
      nt_instructionList_ (var_instructionList_5473, inCompiler) ;
      GALGAS_location var_endOfInstructions_5501 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-task.galgas", 170)) ;
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__7D_) COMMA_SOURCE_FILE ("declaration-task.galgas", 171)) ;
      ioArgument_branchList.addAssign_operation (var_guardedCommand_5418, var_instructionList_5473, var_endOfInstructions_5501  COMMA_SOURCE_FILE ("declaration-task.galgas", 172)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_taskBody_i23_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_plm_5F_syntax_29 (inCompiler)) {
    case 2: {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_system_5F_routine_i26_ (GALGAS_systemRoutineDeclarationListAST & ioArgument_ioSVCListAST,
                                                                       C_Lexique_plm_5F_lexique * inCompiler) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_system_5F_routine_i26_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  switch (select_plm_5F_syntax_32 (inCompiler)) {
  case 1: {
  } break ;
  case 2: {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_5F_init_i29_ (GALGAS_initList & ioArgument_ioInitList,
                                                                         C_Lexique_plm_5F_lexique * inCompiler) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_5F_init_i29_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_init) COMMA_SOURCE_FILE ("declaration-init.galgas", 31)) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_integer) COMMA_SOURCE_FILE ("declaration-init.galgas", 32)) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__7B_) COMMA_SOURCE_FILE ("declaration-init.galgas", 33)) ;
  nt_instructionList_parse (inCompiler) ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_function_i30_ (GALGAS_functionDeclarationListAST & ioArgument_ioProcListAST,
                                                              C_Lexique_plm_5F_lexique * inCompiler) {
  GALGAS_bool var_public_2607 ;
  switch (select_plm_5F_syntax_36 (inCompiler)) {
  case 1: {
    var_public_2607 = GALGAS_bool (false) ;
  } break ;
  case 2: {
    ...
    var_public_2607 = GALGAS_bool (true) ;
  } break ;
  default:
    break ;
  }
  GALGAS_mode var_mode_2738 ;
  GALGAS_lstring var_procName_2763 ;
  GALGAS_lstringlist var_attributeList_2799 ;
  GALGAS_routineFormalArgumentList var_procFormalArgumentList_2849 ;
  nt_function_5F_header_ (var_mode_2738, var_procName_2763, var_attributeList_2799, var_procFormalArgumentList_2849, inCompiler) ;
  GALGAS_lstring var_returnTypeName_2877 ;
  switch (select_plm_5F_syntax_37 (inCompiler)) {
  case 1: {
    var_returnTypeName_2877 = GALGAS_string::makeEmptyString ().getter_here (inCompiler COMMA_SOURCE_FILE ("declaration-func.galgas", 80)) ;
  } break ;
  case 2: {
    ...
    var_returnTypeName_2877 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GALGAS_instructionListAST var_instructionList_3029 ;
  nt_instructionList_ (var_instructionList_3029, inCompiler) ;
  ...
  ioArgument_ioProcListAST.addAssign_operation (var_mode_2738, var_public_2607, var_procName_2763, var_attributeList_2799, var_procFormalArgumentList_2849, var_returnTypeName_2877, var_instructionList_3029, GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-func.galgas", 96))  COMMA_SOURCE_FILE ("declaration-func.galgas", 88)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_function_5F_header_i32_ (GALGAS_mode & outArgument_outMode,
  ...
  while (repeatFlag_0) {
    ...
    case 2: {
      GALGAS_lstring var_attribute_4331 = inCompiler->synthetizedAttribute_tokenString () ;
      ...
      outArgument_outAttributeList.addAssign_operation (var_attribute_4331  COMMA_SOURCE_FILE ("declaration-func.galgas", 150)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_procedure_5F_formal_5F_arguments_i33_ (GALGAS_routineFormalArgumentList & outArgument_outProcFormalArgumentList,
                                                                                      C_Lexique_plm_5F_lexique * inCompiler) {
  outArgument_outProcFormalArgumentList.drop () ; // Release 'out' argument
  ...
  while (repeatFlag_0) {
    ...
    case 2: {
      GALGAS_lstring var_selector_4775 = inCompiler->synthetizedAttribute_tokenString () ;
      ...
      GALGAS_lstring var_formalArgumentName_4818 = inCompiler->synthetizedAttribute_tokenString () ;
      ...
      GALGAS_lstring var_formalArgumentTypeName_4861 = inCompiler->synthetizedAttribute_tokenString () ;
      ...
      outArgument_outProcFormalArgumentList.addAssign_operation (GALGAS_procFormalArgumentPassingMode::constructor_output (SOURCE_FILE ("declaration-func.galgas", 166)), var_selector_4775, var_formalArgumentTypeName_4861, var_formalArgumentName_4818  COMMA_SOURCE_FILE ("declaration-func.galgas", 165)) ;
    } break ;
    case 3: {
      GALGAS_lstring var_selector_5056 = inCompiler->synthetizedAttribute_tokenString () ;
      ...
      GALGAS_lstring var_formalArgumentName_5099 = inCompiler->synthetizedAttribute_tokenString () ;
      ...
      GALGAS_lstring var_formalArgumentTypeName_5142 = inCompiler->synthetizedAttribute_tokenString () ;
      ...
      outArgument_outProcFormalArgumentList.addAssign_operation (GALGAS_procFormalArgumentPassingMode::constructor_inputOutput (SOURCE_FILE ("declaration-func.galgas", 175)), var_selector_5056, var_formalArgumentTypeName_5142, var_formalArgumentName_5099  COMMA_SOURCE_FILE ("declaration-func.galgas", 174)) ;
    } break ;
    case 4: {
      GALGAS_lstring var_selector_5341 = inCompiler->synthetizedAttribute_tokenString () ;
      ...
      GALGAS_lstring var_formalArgumentName_5384 = inCompiler->synthetizedAttribute_tokenString () ;
      ...
      GALGAS_lstring var_formalArgumentTypeName_5427 = inCompiler->synthetizedAttribute_tokenString () ;
      ...
      outArgument_outProcFormalArgumentList.addAssign_operation (GALGAS_procFormalArgumentPassingMode::constructor_input (SOURCE_FILE ("declaration-func.galgas", 184)), var_selector_5341, var_formalArgumentTypeName_5427, var_formalArgumentName_5384  COMMA_SOURCE_FILE ("declaration-func.galgas", 183)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_procedure_5F_formal_5F_arguments_i33_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__28_) COMMA_SOURCE_FILE ("declaration-func.galgas", 159)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_plm_5F_syntax_40 (inCompiler)) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_i34_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_required) COMMA_SOURCE_FILE ("declaration-required-proc.galgas", 22)) ;
  nt_function_5F_header_parse (inCompiler) ;
  inCompiler->resetTemplateString () ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_i35_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_extern) COMMA_SOURCE_FILE ("declaration-extern-proc.galgas", 23)) ;
  nt_function_5F_header_parse (inCompiler) ;
  switch (select_plm_5F_syntax_41 (inCompiler)) {
  case 1: {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_isr_i36_ (GALGAS_isrDeclarationListAST & ioArgument_ioISRListAST,
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_isr_i36_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_isr) COMMA_SOURCE_FILE ("declaration-isr.galgas", 22)) ;
  switch (select_plm_5F_syntax_42 (inCompiler)) {
  case 1: {
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_service) COMMA_SOURCE_FILE ("declaration-isr.galgas", 25)) ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_guard_i37_ (GALGAS_guardDeclarationListAST & ioArgument_ioGuardListAST,
                                                           C_Lexique_plm_5F_lexique * inCompiler) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_guard_i37_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  switch (select_plm_5F_syntax_43 (inCompiler)) {
  case 1: {
  } break ;
  case 2: {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_i38_ (GALGAS_ast & ioArgument_ioAST,
                                                                 C_Lexique_plm_5F_lexique * inCompiler) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_i38_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  nt_guard_parse (inCompiler) ;
  inCompiler->resetTemplateString () ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_expression_i39_ (GALGAS_expressionAST & outArgument_outExpression,
                                                                C_Lexique_plm_5F_lexique * inCompiler) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_expression_i39_parse (C_Lexique_plm_5F_lexique * inCompiler) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_expression_5F_logical_5F_xor_i40_ (GALGAS_expressionAST & outArgument_outExpression,
                                                                                  C_Lexique_plm_5F_lexique * inCompiler) {
  outArgument_outExpression.drop () ; // Release 'out' argument
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_expression_5F_logical_5F_xor_i40_parse (C_Lexique_plm_5F_lexique * inCompiler) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_expression_5F_logical_5F_and_i41_ (GALGAS_expressionAST & outArgument_outExpression,
                                                                                  C_Lexique_plm_5F_lexique * inCompiler) {
  outArgument_outExpression.drop () ; // Release 'out' argument
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_expression_5F_logical_5F_and_i41_parse (C_Lexique_plm_5F_lexique * inCompiler) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_expression_5F_bitwise_5F_or_i42_ (GALGAS_expressionAST & outArgument_outExpression,
                                                                                 C_Lexique_plm_5F_lexique * inCompiler) {
  outArgument_outExpression.drop () ; // Release 'out' argument
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_expression_5F_bitwise_5F_or_i42_parse (C_Lexique_plm_5F_lexique * inCompiler) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_expression_5F_bitwise_5F_xor_i43_ (GALGAS_expressionAST & outArgument_outExpression,
                                                                                  C_Lexique_plm_5F_lexique * inCompiler) {
  outArgument_outExpression.drop () ; // Release 'out' argument
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_expression_5F_bitwise_5F_xor_i43_parse (C_Lexique_plm_5F_lexique * inCompiler) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_expression_5F_bitwise_5F_and_i44_ (GALGAS_expressionAST & outArgument_outExpression,
                                                                                  C_Lexique_plm_5F_lexique * inCompiler) {
  outArgument_outExpression.drop () ; // Release 'out' argument
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_expression_5F_bitwise_5F_and_i44_parse (C_Lexique_plm_5F_lexique * inCompiler) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_expression_5F_equality_i45_ (GALGAS_expressionAST & outArgument_outExpression,
                                                                            C_Lexique_plm_5F_lexique * inCompiler) {
  outArgument_outExpression.drop () ; // Release 'out' argument
  ...
  case 3: {
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__21__3D_) COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 142)) ;
    GALGAS_location var_operatorLocation_4806 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 143)) ;
    GALGAS_expressionAST var_rightExpression_4874 ;
    nt_expression_5F_comparison_ (var_rightExpression_4874, inCompiler) ;
    outArgument_outExpression = GALGAS_infixOperatorExpressionAST::constructor_new (outArgument_outExpression, var_operatorLocation_4806, GALGAS_infixOperator::constructor_nonEqual (SOURCE_FILE ("expression-operator-priority.galgas", 148)), var_rightExpression_4874  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 145)) ;
  } break ;
  default:
    break ;
  }
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_expression_5F_equality_i45_parse (C_Lexique_plm_5F_lexique * inCompiler) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_expression_5F_comparison_i46_ (GALGAS_expressionAST & outArgument_outExpression,
                                                                              C_Lexique_plm_5F_lexique * inCompiler) {
  outArgument_outExpression.drop () ; // Release 'out' argument
  ...
  case 2: {
    ...
    GALGAS_location var_operatorLocation_5323 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 161)) ;
    GALGAS_expressionAST var_rightExpression_5386 ;
    nt_expression_5F_shift_ (var_rightExpression_5386, inCompiler) ;
    outArgument_outExpression = GALGAS_infixOperatorExpressionAST::constructor_new (outArgument_outExpression, var_operatorLocation_5323, GALGAS_infixOperator::constructor_infEqual (SOURCE_FILE ("expression-operator-priority.galgas", 166)), var_rightExpression_5386  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 163)) ;
  } break ;
  case 3: {
    ...
    GALGAS_location var_operatorLocation_5588 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 171)) ;
    GALGAS_expressionAST var_rightExpression_5651 ;
    nt_expression_5F_shift_ (var_rightExpression_5651, inCompiler) ;
    outArgument_outExpression = GALGAS_infixOperatorExpressionAST::constructor_new (outArgument_outExpression, var_operatorLocation_5588, GALGAS_infixOperator::constructor_supEqual (SOURCE_FILE ("expression-operator-priority.galgas", 176)), var_rightExpression_5651  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 173)) ;
  } break ;
  case 4: {
    ...
    GALGAS_location var_operatorLocation_5852 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 181)) ;
    GALGAS_expressionAST var_rightExpression_5915 ;
    nt_expression_5F_shift_ (var_rightExpression_5915, inCompiler) ;
    outArgument_outExpression = GALGAS_infixOperatorExpressionAST::constructor_new (outArgument_outExpression, var_operatorLocation_5852, GALGAS_infixOperator::constructor_strictInf (SOURCE_FILE ("expression-operator-priority.galgas", 186)), var_rightExpression_5915  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 183)) ;
  } break ;
  case 5: {
    ...
    GALGAS_location var_operatorLocation_6117 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 191)) ;
    GALGAS_expressionAST var_rightExpression_6180 ;
    nt_expression_5F_shift_ (var_rightExpression_6180, inCompiler) ;
    outArgument_outExpression = GALGAS_infixOperatorExpressionAST::constructor_new (outArgument_outExpression, var_operatorLocation_6117, GALGAS_infixOperator::constructor_strictSup (SOURCE_FILE ("expression-operator-priority.galgas", 196)), var_rightExpression_6180  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 193)) ;
  } break ;
  default:
    break ;
  }
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_expression_5F_comparison_i46_parse (C_Lexique_plm_5F_lexique * inCompiler) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_expression_5F_shift_i47_ (GALGAS_expressionAST & outArgument_outExpression,
                                                                         C_Lexique_plm_5F_lexique * inCompiler) {
  outArgument_outExpression.drop () ; // Release 'out' argument
  ...
  while (repeatFlag_0) {
    ...
    case 2: {
      ...
      GALGAS_location var_operatorLocation_6631 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 209)) ;
      GALGAS_expressionAST var_rightExpression_6697 ;
      nt_expression_5F_addition_ (var_rightExpression_6697, inCompiler) ;
      outArgument_outExpression = GALGAS_infixOperatorExpressionAST::constructor_new (outArgument_outExpression, var_operatorLocation_6631, GALGAS_infixOperator::constructor_leftShiftOp (SOURCE_FILE ("expression-operator-priority.galgas", 214)), var_rightExpression_6697  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 211)) ;
    } break ;
    case 3: {
      ...
      GALGAS_location var_operatorLocation_6905 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 219)) ;
      GALGAS_expressionAST var_rightExpression_6971 ;
      nt_expression_5F_addition_ (var_rightExpression_6971, inCompiler) ;
      outArgument_outExpression = GALGAS_infixOperatorExpressionAST::constructor_new (outArgument_outExpression, var_operatorLocation_6905, GALGAS_infixOperator::constructor_rightShiftOp (SOURCE_FILE ("expression-operator-priority.galgas", 224)), var_rightExpression_6971  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 221)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_expression_5F_shift_i47_parse (C_Lexique_plm_5F_lexique * inCompiler) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_expression_5F_addition_i48_ (GALGAS_expressionAST & outArgument_outExpression,
                                                                            C_Lexique_plm_5F_lexique * inCompiler) {
  outArgument_outExpression.drop () ; // Release 'out' argument
  ...
  while (repeatFlag_0) {
    ...
    case 2: {
      ...
      GALGAS_location var_operatorLocation_7426 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 237)) ;
      GALGAS_expressionAST var_rightExpression_7491 ;
      nt_expression_5F_product_ (var_rightExpression_7491, inCompiler) ;
      outArgument_outExpression = GALGAS_infixOperatorExpressionAST::constructor_new (outArgument_outExpression, var_operatorLocation_7426, GALGAS_infixOperator::constructor_addOp (SOURCE_FILE ("expression-operator-priority.galgas", 242)), var_rightExpression_7491  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 239)) ;
    } break ;
    case 3: {
      ...
      GALGAS_location var_operatorLocation_7693 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 247)) ;
      GALGAS_expressionAST var_rightExpression_7758 ;
      nt_expression_5F_product_ (var_rightExpression_7758, inCompiler) ;
      outArgument_outExpression = GALGAS_infixOperatorExpressionAST::constructor_new (outArgument_outExpression, var_operatorLocation_7693, GALGAS_infixOperator::constructor_addOpNoOvf (SOURCE_FILE ("expression-operator-priority.galgas", 252)), var_rightExpression_7758  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 249)) ;
    } break ;
    case 4: {
      ...
      GALGAS_location var_operatorLocation_7964 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 257)) ;
      GALGAS_expressionAST var_rightExpression_8029 ;
      nt_expression_5F_product_ (var_rightExpression_8029, inCompiler) ;
      outArgument_outExpression = GALGAS_infixOperatorExpressionAST::constructor_new (outArgument_outExpression, var_operatorLocation_7964, GALGAS_infixOperator::constructor_subOp (SOURCE_FILE ("expression-operator-priority.galgas", 262)), var_rightExpression_8029  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 259)) ;
    } break ;
    case 5: {
      ...
      GALGAS_location var_operatorLocation_8231 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 267)) ;
      GALGAS_expressionAST var_rightExpression_8296 ;
      nt_expression_5F_product_ (var_rightExpression_8296, inCompiler) ;
      outArgument_outExpression = GALGAS_infixOperatorExpressionAST::constructor_new (outArgument_outExpression, var_operatorLocation_8231, GALGAS_infixOperator::constructor_subOpNoOvf (SOURCE_FILE ("expression-operator-priority.galgas", 272)), var_rightExpression_8296  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 269)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_expression_5F_addition_i48_parse (C_Lexique_plm_5F_lexique * inCompiler) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_expression_5F_product_i49_ (GALGAS_expressionAST & outArgument_outExpression,
                                                                           C_Lexique_plm_5F_lexique * inCompiler) {
  outArgument_outExpression.drop () ; // Release 'out' argument
  ...
  while (repeatFlag_0) {
    ...
    case 2: {
      ...
      GALGAS_location var_operatorLocation_8737 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 285)) ;
      GALGAS_expressionAST var_rightExpression_8791 ;
      nt_primary_ (var_rightExpression_8791, inCompiler) ;
      outArgument_outExpression = GALGAS_infixOperatorExpressionAST::constructor_new (outArgument_outExpression, var_operatorLocation_8737, GALGAS_infixOperator::constructor_mulOp (SOURCE_FILE ("expression-operator-priority.galgas", 290)), var_rightExpression_8791  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 287)) ;
    } break ;
    case 3: {
      ...
      GALGAS_location var_operatorLocation_8993 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 295)) ;
      GALGAS_expressionAST var_rightExpression_9047 ;
      nt_primary_ (var_rightExpression_9047, inCompiler) ;
      outArgument_outExpression = GALGAS_infixOperatorExpressionAST::constructor_new (outArgument_outExpression, var_operatorLocation_8993, GALGAS_infixOperator::constructor_mulOpNoOvf (SOURCE_FILE ("expression-operator-priority.galgas", 300)), var_rightExpression_9047  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 297)) ;
    } break ;
    case 4: {
      ...
      GALGAS_location var_operatorLocation_9253 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 305)) ;
      GALGAS_expressionAST var_rightExpression_9307 ;
      nt_primary_ (var_rightExpression_9307, inCompiler) ;
      outArgument_outExpression = GALGAS_infixOperatorExpressionAST::constructor_new (outArgument_outExpression, var_operatorLocation_9253, GALGAS_infixOperator::constructor_modOp (SOURCE_FILE ("expression-operator-priority.galgas", 310)), var_rightExpression_9307  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 307)) ;
    } break ;
    case 5: {
      ...
      GALGAS_location var_operatorLocation_9509 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 315)) ;
      GALGAS_expressionAST var_rightExpression_9563 ;
      nt_primary_ (var_rightExpression_9563, inCompiler) ;
      outArgument_outExpression = GALGAS_infixOperatorExpressionAST::constructor_new (outArgument_outExpression, var_operatorLocation_9509, GALGAS_infixOperator::constructor_modOpNoOvf (SOURCE_FILE ("expression-operator-priority.galgas", 320)), var_rightExpression_9563  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 317)) ;
    } break ;
    case 6: {
      ...
      GALGAS_location var_operatorLocation_9769 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 325)) ;
      GALGAS_expressionAST var_rightExpression_9823 ;
      nt_primary_ (var_rightExpression_9823, inCompiler) ;
      outArgument_outExpression = GALGAS_infixOperatorExpressionAST::constructor_new (outArgument_outExpression, var_operatorLocation_9769, GALGAS_infixOperator::constructor_divOp (SOURCE_FILE ("expression-operator-priority.galgas", 330)), var_rightExpression_9823  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 327)) ;
    } break ;
    case 7: {
      ...
      GALGAS_location var_operatorLocation_10025 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 335)) ;
      GALGAS_expressionAST var_rightExpression_10079 ;
      nt_primary_ (var_rightExpression_10079, inCompiler) ;
      outArgument_outExpression = GALGAS_infixOperatorExpressionAST::constructor_new (outArgument_outExpression, var_operatorLocation_10025, GALGAS_infixOperator::constructor_divOpNoOvf (SOURCE_FILE ("expression-operator-priority.galgas", 340)), var_rightExpression_10079  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 337)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_expression_5F_product_i49_parse (C_Lexique_plm_5F_lexique * inCompiler) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_primary_i50_ (GALGAS_expressionAST & outArgument_outExpression,
  ...
  GALGAS_location var_operatorLocation_10455 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 350)) ;
  GALGAS_expressionAST var_expression_10502 ;
  nt_primary_ (var_expression_10502, inCompiler) ;
  outArgument_outExpression = GALGAS_prefixOperatorExpressionAST::constructor_new (var_operatorLocation_10455, GALGAS_prefixOperator::constructor_unsignedComplement (SOURCE_FILE ("expression-operator-priority.galgas", 354)), var_expression_10502  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 352)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_primary_i51_ (GALGAS_expressionAST & outArgument_outExpression,
  ...
  GALGAS_location var_operatorLocation_10843 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 363)) ;
  GALGAS_expressionAST var_expression_10890 ;
  nt_primary_ (var_expression_10890, inCompiler) ;
  outArgument_outExpression = GALGAS_prefixOperatorExpressionAST::constructor_new (var_operatorLocation_10843, GALGAS_prefixOperator::constructor_notOperator (SOURCE_FILE ("expression-operator-priority.galgas", 367)), var_expression_10890  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 365)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_primary_i52_ (GALGAS_expressionAST & outArgument_outExpression,
  ...
  GALGAS_location var_operatorLocation_11222 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 376)) ;
  GALGAS_expressionAST var_expression_11269 ;
  nt_primary_ (var_expression_11269, inCompiler) ;
  outArgument_outExpression = GALGAS_prefixOperatorExpressionAST::constructor_new (var_operatorLocation_11222, GALGAS_prefixOperator::constructor_minus (SOURCE_FILE ("expression-operator-priority.galgas", 380)), var_expression_11269  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 378)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_primary_i53_ (GALGAS_expressionAST & outArgument_outExpression,
  ...
  GALGAS_location var_operatorLocation_11596 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 389)) ;
  GALGAS_expressionAST var_expression_11643 ;
  nt_primary_ (var_expression_11643, inCompiler) ;
  outArgument_outExpression = GALGAS_prefixOperatorExpressionAST::constructor_new (var_operatorLocation_11596, GALGAS_prefixOperator::constructor_minusNoOvf (SOURCE_FILE ("expression-operator-priority.galgas", 393)), var_expression_11643  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 391)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_primary_i55_ (GALGAS_expressionAST & outArgument_outExpression,
                                                             C_Lexique_plm_5F_lexique * inCompiler) {
  outArgument_outExpression.drop () ; // Release 'out' argument
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_convert) COMMA_SOURCE_FILE ("expression-convert.galgas", 42)) ;
  nt_expression_ (outArgument_outExpression, inCompiler) ;
  GALGAS_location var_endOfExpression_2056 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("expression-convert.galgas", 44)) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__3A_) COMMA_SOURCE_FILE ("expression-convert.galgas", 45)) ;
  GALGAS_lstring var_typeIdentifier_2114 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__24_type) COMMA_SOURCE_FILE ("expression-convert.galgas", 46)) ;
  outArgument_outExpression = GALGAS_convertExpressionAST::constructor_new (outArgument_outExpression, var_typeIdentifier_2114, var_endOfExpression_2056  COMMA_SOURCE_FILE ("expression-convert.galgas", 47)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_primary_i56_ (GALGAS_expressionAST & outArgument_outExpression,
                                                             C_Lexique_plm_5F_lexique * inCompiler) {
  outArgument_outExpression.drop () ; // Release 'out' argument
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_extend) COMMA_SOURCE_FILE ("expression-extend.galgas", 43)) ;
  nt_expression_ (outArgument_outExpression, inCompiler) ;
  GALGAS_location var_endOfExpression_2054 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("expression-extend.galgas", 45)) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__3A_) COMMA_SOURCE_FILE ("expression-extend.galgas", 46)) ;
  GALGAS_lstring var_typeIdentifier_2112 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__24_type) COMMA_SOURCE_FILE ("expression-extend.galgas", 47)) ;
  outArgument_outExpression = GALGAS_extendExpressionAST::constructor_new (outArgument_outExpression, var_typeIdentifier_2112, var_endOfExpression_2054  COMMA_SOURCE_FILE ("expression-extend.galgas", 48)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_primary_i57_ (GALGAS_expressionAST & outArgument_outExpression,
                                                             C_Lexique_plm_5F_lexique * inCompiler) {
  outArgument_outExpression.drop () ; // Release 'out' argument
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_truncate) COMMA_SOURCE_FILE ("expression-truncate.galgas", 43)) ;
  nt_expression_ (outArgument_outExpression, inCompiler) ;
  GALGAS_location var_endOfExpression_2064 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("expression-truncate.galgas", 45)) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__3A_) COMMA_SOURCE_FILE ("expression-truncate.galgas", 46)) ;
  GALGAS_lstring var_typeIdentifier_2122 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__24_type) COMMA_SOURCE_FILE ("expression-truncate.galgas", 47)) ;
  outArgument_outExpression = GALGAS_truncateExpressionAST::constructor_new (outArgument_outExpression, var_typeIdentifier_2122, var_endOfExpression_2064  COMMA_SOURCE_FILE ("expression-truncate.galgas", 48)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_primary_i58_ (GALGAS_expressionAST & outArgument_outExpression,
                                                             C_Lexique_plm_5F_lexique * inCompiler) {
  outArgument_outExpression.drop () ; // Release 'out' argument
  GALGAS_lstring var_typeName_2545 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__24_type) COMMA_SOURCE_FILE ("expression-constructor-call.galgas", 59)) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__28_) COMMA_SOURCE_FILE ("expression-constructor-call.galgas", 60)) ;
  GALGAS_functionCallEffectiveParameterListAST var_parameterList_2610 = GALGAS_functionCallEffectiveParameterListAST::constructor_emptyList (SOURCE_FILE ("expression-constructor-call.galgas", 61)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_plm_5F_syntax_57 (inCompiler)) {
    case 2: {
      GALGAS_lstring var_selector_2660 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__21_) COMMA_SOURCE_FILE ("expression-constructor-call.galgas", 64)) ;
      GALGAS_expressionAST var_expression_2695 ;
      nt_expression_ (var_expression_2695, inCompiler) ;
      var_parameterList_2610.addAssign_operation (var_selector_2660, var_expression_2695  COMMA_SOURCE_FILE ("expression-constructor-call.galgas", 66)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  GALGAS_location var_errorLocation_2770 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("expression-constructor-call.galgas", 68)) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__29_) COMMA_SOURCE_FILE ("expression-constructor-call.galgas", 69)) ;
  outArgument_outExpression = GALGAS_constructorCallAST::constructor_new (var_typeName_2545, var_parameterList_2610, var_errorLocation_2770  COMMA_SOURCE_FILE ("expression-constructor-call.galgas", 70)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_primary_i59_ (GALGAS_expressionAST & outArgument_outExpression,
                                                             C_Lexique_plm_5F_lexique * inCompiler) {
  outArgument_outExpression.drop () ; // Release 'out' argument
  GALGAS_lstring var_optionalTypeName_1894 ;
  switch (select_plm_5F_syntax_58 (inCompiler)) {
  case 1: {
    var_optionalTypeName_1894 = GALGAS_lstring::constructor_new (GALGAS_string::makeEmptyString (), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("expression-typed-constant.galgas", 39))  COMMA_SOURCE_FILE ("expression-typed-constant.galgas", 39)) ;
  } break ;
  case 2: {
    var_optionalTypeName_1894 = inCompiler->synthetizedAttribute_tokenString () ;
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__24_type) COMMA_SOURCE_FILE ("expression-typed-constant.galgas", 41)) ;
  } break ;
  default:
    break ;
  }
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__2E_) COMMA_SOURCE_FILE ("expression-typed-constant.galgas", 43)) ;
  GALGAS_lstring var_constantName_2039 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_identifier) COMMA_SOURCE_FILE ("expression-typed-constant.galgas", 44)) ;
  outArgument_outExpression = GALGAS_typedConstantCallAST::constructor_new (var_optionalTypeName_1894, var_constantName_2039  COMMA_SOURCE_FILE ("expression-typed-constant.galgas", 45)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_primary_i60_ (GALGAS_expressionAST & outArgument_outExpression,
                                                             C_Lexique_plm_5F_lexique * inCompiler) {
  outArgument_outExpression.drop () ; // Release 'out' argument
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_if) COMMA_SOURCE_FILE ("expression-if.galgas", 64)) ;
  GALGAS_expressionAST var_ifExpression_2584 ;
  nt_expression_ (var_ifExpression_2584, inCompiler) ;
  GALGAS_location var_ifExpressionEndLocation_2626 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("expression-if.galgas", 66)) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__7B_) COMMA_SOURCE_FILE ("expression-if.galgas", 67)) ;
  GALGAS_expressionAST var_thenExpression_2679 ;
  nt_expression_ (var_thenExpression_2679, inCompiler) ;
  GALGAS_location var_thenExpressionEndLocation_2723 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("expression-if.galgas", 69)) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__7D_) COMMA_SOURCE_FILE ("expression-if.galgas", 70)) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_else) COMMA_SOURCE_FILE ("expression-if.galgas", 71)) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__7B_) COMMA_SOURCE_FILE ("expression-if.galgas", 72)) ;
  GALGAS_expressionAST var_elseExpression_2795 ;
  nt_expression_ (var_elseExpression_2795, inCompiler) ;
  GALGAS_location var_elseExpressionEndLocation_2839 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("expression-if.galgas", 74)) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__7D_) COMMA_SOURCE_FILE ("expression-if.galgas", 75)) ;
  outArgument_outExpression = GALGAS_ifExpressionAST::constructor_new (var_ifExpression_2584, var_ifExpressionEndLocation_2626, var_thenExpression_2679, var_thenExpressionEndLocation_2723, var_elseExpression_2795, var_elseExpressionEndLocation_2839  COMMA_SOURCE_FILE ("expression-if.galgas", 76)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_primary_i61_ (GALGAS_expressionAST & outArgument_outExpression,
                                                             C_Lexique_plm_5F_lexique * inCompiler) {
  outArgument_outExpression.drop () ; // Release 'out' argument
  GALGAS_lbigint var_integerLiteral_1863 = inCompiler->synthetizedAttribute_bigInteger () ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_integer) COMMA_SOURCE_FILE ("expression-literal-integer.galgas", 35)) ;
  outArgument_outExpression = GALGAS_literalIntegerInExpressionAST::constructor_new (var_integerLiteral_1863  COMMA_SOURCE_FILE ("expression-literal-integer.galgas", 36)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_primary_i62_ (GALGAS_expressionAST & outArgument_outExpression,
                                                             C_Lexique_plm_5F_lexique * inCompiler) {
  outArgument_outExpression.drop () ; // Release 'out' argument
  GALGAS_lstring var_stringLiteral_1856 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__22_string_22_) COMMA_SOURCE_FILE ("expression-literal-string.galgas", 35)) ;
  outArgument_outExpression = GALGAS_literalStringInExpressionAST::constructor_new (var_stringLiteral_1856  COMMA_SOURCE_FILE ("expression-literal-string.galgas", 36)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_primary_i63_ (GALGAS_expressionAST & outArgument_outExpression,
                                                             C_Lexique_plm_5F_lexique * inCompiler) {
  outArgument_outExpression.drop () ; // Release 'out' argument
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_true) COMMA_SOURCE_FILE ("expression-true-false.galgas", 35)) ;
  outArgument_outExpression = GALGAS_literalBooleanInExpressionAST::constructor_new (GALGAS_bool (true)  COMMA_SOURCE_FILE ("expression-true-false.galgas", 36)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_primary_i64_ (GALGAS_expressionAST & outArgument_outExpression,
                                                             C_Lexique_plm_5F_lexique * inCompiler) {
  outArgument_outExpression.drop () ; // Release 'out' argument
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_false) COMMA_SOURCE_FILE ("expression-true-false.galgas", 42)) ;
  outArgument_outExpression = GALGAS_literalBooleanInExpressionAST::constructor_new (GALGAS_bool (false)  COMMA_SOURCE_FILE ("expression-true-false.galgas", 43)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_primary_i65_ (GALGAS_expressionAST & outArgument_outExpression,
                                                             C_Lexique_plm_5F_lexique * inCompiler) {
  outArgument_outExpression.drop () ; // Release 'out' argument
  GALGAS_lstring var_registerNameAsTypeName_2751 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__24_type) COMMA_SOURCE_FILE ("expression-cst-registre.galgas", 63)) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__7B_) COMMA_SOURCE_FILE ("expression-cst-registre.galgas", 64)) ;
  GALGAS_lstringlist var_booleanFieldNames_2794 = GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("expression-cst-registre.galgas", 65)) ;
  GALGAS_registerIntegerFieldListAST var_integerFieldValues_2851 = GALGAS_registerIntegerFieldListAST::constructor_emptyList (SOURCE_FILE ("expression-cst-registre.galgas", 66)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    GALGAS_lstring var_registerFieldName_2909 = inCompiler->synthetizedAttribute_tokenString () ;
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_identifier) COMMA_SOURCE_FILE ("expression-cst-registre.galgas", 68)) ;
    switch (select_plm_5F_syntax_60 (inCompiler)) {
    case 1: {
      var_booleanFieldNames_2794.addAssign_operation (var_registerFieldName_2909  COMMA_SOURCE_FILE ("expression-cst-registre.galgas", 70)) ;
    } break ;
    case 2: {
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__3A_) COMMA_SOURCE_FILE ("expression-cst-registre.galgas", 72)) ;
      GALGAS_expressionAST var_expression_3028 ;
      nt_expression_ (var_expression_3028, inCompiler) ;
      var_integerFieldValues_2851.addAssign_operation (var_registerFieldName_2909, var_expression_3028, GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("expression-cst-registre.galgas", 74))  COMMA_SOURCE_FILE ("expression-cst-registre.galgas", 74)) ;
    } break ;
    default:
      break ;
    }
    ...
    case 2: {
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__2C_) COMMA_SOURCE_FILE ("expression-cst-registre.galgas", 77)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__7D_) COMMA_SOURCE_FILE ("expression-cst-registre.galgas", 79)) ;
  outArgument_outExpression = GALGAS_registerConstantExpressionAST::constructor_new (var_registerNameAsTypeName_2751, var_booleanFieldNames_2794, var_integerFieldValues_2851  COMMA_SOURCE_FILE ("expression-cst-registre.galgas", 80)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_primary_i66_ (GALGAS_expressionAST & outArgument_outExpression,
                                                             C_Lexique_plm_5F_lexique * inCompiler) {
  outArgument_outExpression.drop () ; // Release 'out' argument
  GALGAS_selfInExpressionAST var_selfInExpression_7871 ;
  switch (select_plm_5F_syntax_61 (inCompiler)) {
  case 1: {
    var_selfInExpression_7871 = GALGAS_selfInExpressionAST::constructor_noSelf (SOURCE_FILE ("expression-primary.galgas", 186)) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_self) COMMA_SOURCE_FILE ("expression-primary.galgas", 188)) ;
    var_selfInExpression_7871 = GALGAS_selfInExpressionAST::constructor_selfAt (GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("expression-primary.galgas", 189))  COMMA_SOURCE_FILE ("expression-primary.galgas", 189)) ;
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__2E_) COMMA_SOURCE_FILE ("expression-primary.galgas", 190)) ;
  } break ;
  default:
    break ;
  }
  GALGAS_lstring var_objectName_8051 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_identifier) COMMA_SOURCE_FILE ("expression-primary.galgas", 193)) ;
  GALGAS_primaryInExpressionAccessListAST var_accessListAST_8132 = GALGAS_primaryInExpressionAccessListAST::constructor_emptyList (SOURCE_FILE ("expression-primary.galgas", 195)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_plm_5F_syntax_62 (inCompiler)) {
    case 2: {
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__2E_) COMMA_SOURCE_FILE ("expression-primary.galgas", 198)) ;
      GALGAS_lstring var_propertyName_8205 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_identifier) COMMA_SOURCE_FILE ("expression-primary.galgas", 199)) ;
      var_accessListAST_8132.addAssign_operation (GALGAS_primaryInExpressionAccessAST::constructor_property (var_propertyName_8205  COMMA_SOURCE_FILE ("expression-primary.galgas", 200))  COMMA_SOURCE_FILE ("expression-primary.galgas", 200)) ;
    } break ;
    case 3: {
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__5B_) COMMA_SOURCE_FILE ("expression-primary.galgas", 202)) ;
      GALGAS_expressionAST var_expression_8315 ;
      nt_expression_ (var_expression_8315, inCompiler) ;
      GALGAS_location var_endOfIndex_8336 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("expression-primary.galgas", 204)) ;
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__5D_) COMMA_SOURCE_FILE ("expression-primary.galgas", 205)) ;
      var_accessListAST_8132.addAssign_operation (GALGAS_primaryInExpressionAccessAST::constructor_arrayAccess (var_expression_8315, var_endOfIndex_8336  COMMA_SOURCE_FILE ("expression-primary.galgas", 206))  COMMA_SOURCE_FILE ("expression-primary.galgas", 206)) ;
    } break ;
    case 4: {
      GALGAS_effectiveArgumentListAST var_arguments_8497 ;
      GALGAS_location var_endOfArguments_8517 ;
      nt_effective_5F_parameters_ (var_arguments_8497, var_endOfArguments_8517, inCompiler) ;
      var_accessListAST_8132.addAssign_operation (GALGAS_primaryInExpressionAccessAST::constructor_funcCall (var_arguments_8497, var_endOfArguments_8517  COMMA_SOURCE_FILE ("expression-primary.galgas", 209))  COMMA_SOURCE_FILE ("expression-primary.galgas", 209)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  outArgument_outExpression = GALGAS_primaryInExpressionAST::constructor_new (var_selfInExpression_7871, var_objectName_8051, var_accessListAST_8132  COMMA_SOURCE_FILE ("expression-primary.galgas", 212)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_effective_5F_parameters_i67_ (GALGAS_effectiveArgumentListAST & outArgument_outEffectiveParameterList,
  ...
  outArgument_outEffectiveParameterList = GALGAS_effectiveArgumentListAST::constructor_emptyList (SOURCE_FILE ("expression-primary.galgas", 218)) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__28_) COMMA_SOURCE_FILE ("expression-primary.galgas", 219)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_plm_5F_syntax_63 (inCompiler)) {
    case 2: {
      GALGAS_lstring var_selector_9043 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__21_) COMMA_SOURCE_FILE ("expression-primary.galgas", 222)) ;
      GALGAS_expressionAST var_expression_9078 ;
      nt_expression_ (var_expression_9078, inCompiler) ;
      outArgument_outEffectiveParameterList.addAssign_operation (GALGAS_effectiveArgumentPassingModeAST::constructor_output (var_expression_9078, GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("expression-primary.galgas", 224))  COMMA_SOURCE_FILE ("expression-primary.galgas", 224)), var_selector_9043  COMMA_SOURCE_FILE ("expression-primary.galgas", 224)) ;
    } break ;
    case 3: {
      GALGAS_lstring var_selector_9200 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__21__3F_) COMMA_SOURCE_FILE ("expression-primary.galgas", 226)) ;
      GALGAS_lstring var_effectiveParameterName_9247 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_identifier) COMMA_SOURCE_FILE ("expression-primary.galgas", 227)) ;
      outArgument_outEffectiveParameterList.addAssign_operation (GALGAS_effectiveArgumentPassingModeAST::constructor_outputInput (var_effectiveParameterName_9247  COMMA_SOURCE_FILE ("expression-primary.galgas", 228)), var_selector_9200  COMMA_SOURCE_FILE ("expression-primary.galgas", 228)) ;
    } break ;
    case 4: {
      GALGAS_lstring var_selector_9371 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__21__3F_) COMMA_SOURCE_FILE ("expression-primary.galgas", 230)) ;
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_self) COMMA_SOURCE_FILE ("expression-primary.galgas", 231)) ;
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__2E_) COMMA_SOURCE_FILE ("expression-primary.galgas", 232)) ;
      GALGAS_lstring var_effectiveParameterName_9441 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_identifier) COMMA_SOURCE_FILE ("expression-primary.galgas", 233)) ;
      outArgument_outEffectiveParameterList.addAssign_operation (GALGAS_effectiveArgumentPassingModeAST::constructor_outputInputSelfVariable (var_effectiveParameterName_9441  COMMA_SOURCE_FILE ("expression-primary.galgas", 234)), var_selector_9371  COMMA_SOURCE_FILE ("expression-primary.galgas", 234)) ;
    } break ;
    case 5: {
      GALGAS_lstring var_selector_9576 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__3F_) COMMA_SOURCE_FILE ("expression-primary.galgas", 236)) ;
      GALGAS_lstring var_effectiveParameterName_9623 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_identifier) COMMA_SOURCE_FILE ("expression-primary.galgas", 237)) ;
      outArgument_outEffectiveParameterList.addAssign_operation (GALGAS_effectiveArgumentPassingModeAST::constructor_input (var_effectiveParameterName_9623  COMMA_SOURCE_FILE ("expression-primary.galgas", 238)), var_selector_9576  COMMA_SOURCE_FILE ("expression-primary.galgas", 238)) ;
    } break ;
    case 6: {
      GALGAS_lstring var_selector_9740 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__3F_) COMMA_SOURCE_FILE ("expression-primary.galgas", 240)) ;
      GALGAS_bool var_constant_9761 ;
      switch (select_plm_5F_syntax_64 (inCompiler)) {
      case 1: {
        inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_var) COMMA_SOURCE_FILE ("expression-primary.galgas", 243)) ;
        var_constant_9761 = GALGAS_bool (false) ;
      } break ;
      case 2: {
        inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_let) COMMA_SOURCE_FILE ("expression-primary.galgas", 246)) ;
        var_constant_9761 = GALGAS_bool (true) ;
      } break ;
      default:
        break ;
      }
      GALGAS_lstring var_effectiveParameterName_9917 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_identifier) COMMA_SOURCE_FILE ("expression-primary.galgas", 249)) ;
      GALGAS_lstring var_typeName_9941 ;
      switch (select_plm_5F_syntax_65 (inCompiler)) {
      case 1: {
        var_typeName_9941 = GALGAS_string::makeEmptyString ().getter_nowhere (SOURCE_FILE ("expression-primary.galgas", 252)) ;
      } break ;
      case 2: {
        var_typeName_9941 = inCompiler->synthetizedAttribute_tokenString () ;
        inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__24_type) COMMA_SOURCE_FILE ("expression-primary.galgas", 254)) ;
      } break ;
      default:
        break ;
      }
      outArgument_outEffectiveParameterList.addAssign_operation (GALGAS_effectiveArgumentPassingModeAST::constructor_inputWithType (var_constant_9761, var_typeName_9941, var_effectiveParameterName_9917  COMMA_SOURCE_FILE ("expression-primary.galgas", 257)), var_selector_9740  COMMA_SOURCE_FILE ("expression-primary.galgas", 256)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  outArgument_outEndOfArgs = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("expression-primary.galgas", 260)) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__29_) COMMA_SOURCE_FILE ("expression-primary.galgas", 261)) ;
}

//---------------------------------------------------------------------------------------------------------------------*

void cParser_plm_5F_syntax::rule_plm_5F_syntax_effective_5F_parameters_i67_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__28_) COMMA_SOURCE_FILE ("expression-primary.galgas", 219)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_plm_5F_syntax_63 (inCompiler)) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_instructionList_i68_ (GALGAS_instructionListAST & outArgument_outInstructionList,
                                                                     C_Lexique_plm_5F_lexique * inCompiler) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_instructionList_i68_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_plm_5F_syntax_66 (inCompiler)) {
    case 2: {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_instruction_i70_ (GALGAS_instructionListAST & ioArgument_ioInstructionList,
                                                                 C_Lexique_plm_5F_lexique * inCompiler) {
  GALGAS_assignmentTargetNoSelfAST var_assignmentTargetAST_1135 ;
  nt_assignment_5F_target_5F_noself_ (var_assignmentTargetAST_1135, inCompiler) ;
  ...
  GALGAS_expressionAST var_sourceExpression_1207 ;
  nt_expression_ (var_sourceExpression_1207, inCompiler) ;
  ioArgument_ioInstructionList.addAssign_operation (GALGAS_varAssignmentInstructionAST::constructor_new (var_assignmentTargetAST_1135.getter_mIdentifier (SOURCE_FILE ("instruction-assignment.galgas", 25)).getter_location (HERE), var_assignmentTargetAST_1135, var_sourceExpression_1207  COMMA_SOURCE_FILE ("instruction-assignment.galgas", 24))  COMMA_SOURCE_FILE ("instruction-assignment.galgas", 24)) ;
}

//---------------------------------------------------------------------------------------------------------------------*

void cParser_plm_5F_syntax::rule_plm_5F_syntax_instruction_i70_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  nt_assignment_5F_target_5F_noself_parse (inCompiler) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__3D_) COMMA_SOURCE_FILE ("instruction-assignment.galgas", 21)) ;
  nt_expression_parse (inCompiler) ;
  inCompiler->resetTemplateString () ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_instruction_i71_ (GALGAS_instructionListAST & ioArgument_ioInstructionList,
                                                                 C_Lexique_plm_5F_lexique * inCompiler) {
  GALGAS_assignmentTargetSelfAST var_assignmentTargetAST_1630 ;
  nt_assignment_5F_target_5F_self_ (var_assignmentTargetAST_1630, inCompiler) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__3D_) COMMA_SOURCE_FILE ("instruction-assignment.galgas", 36)) ;
  GALGAS_expressionAST var_sourceExpression_1702 ;
  nt_expression_ (var_sourceExpression_1702, inCompiler) ;
  ioArgument_ioInstructionList.addAssign_operation (GALGAS_varAssignmentInstructionAST::constructor_new (var_assignmentTargetAST_1630.getter_mIdentifier (SOURCE_FILE ("instruction-assignment.galgas", 40)).getter_location (HERE), var_assignmentTargetAST_1630, var_sourceExpression_1702  COMMA_SOURCE_FILE ("instruction-assignment.galgas", 39))  COMMA_SOURCE_FILE ("instruction-assignment.galgas", 39)) ;
}

//---------------------------------------------------------------------------------------------------------------------*

void cParser_plm_5F_syntax::rule_plm_5F_syntax_instruction_i71_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  nt_assignment_5F_target_5F_self_parse (inCompiler) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__3D_) COMMA_SOURCE_FILE ("instruction-assignment.galgas", 36)) ;
  nt_expression_parse (inCompiler) ;
  inCompiler->resetTemplateString () ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_assignment_5F_operator_i72_ (GALGAS_operatorAssignmentKind & outArgument_outOp,
                                                                            GALGAS_infixOperator & outArgument_outInfixOperator,
  ...
  case 1: {
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__7C__3D_) COMMA_SOURCE_FILE ("instruction-assignment-operator.galgas", 42)) ;
    outArgument_outOp = GALGAS_operatorAssignmentKind::constructor_bitWiseOrAssign (SOURCE_FILE ("instruction-assignment-operator.galgas", 43)) ;
    outArgument_outInfixOperator = GALGAS_infixOperator::constructor_orOp (SOURCE_FILE ("instruction-assignment-operator.galgas", 44)) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__26__3D_) COMMA_SOURCE_FILE ("instruction-assignment-operator.galgas", 46)) ;
    outArgument_outOp = GALGAS_operatorAssignmentKind::constructor_bitWiseAndAssign (SOURCE_FILE ("instruction-assignment-operator.galgas", 47)) ;
    outArgument_outInfixOperator = GALGAS_infixOperator::constructor_andOp (SOURCE_FILE ("instruction-assignment-operator.galgas", 48)) ;
  } break ;
  case 3: {
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__5E__3D_) COMMA_SOURCE_FILE ("instruction-assignment-operator.galgas", 50)) ;
    outArgument_outOp = GALGAS_operatorAssignmentKind::constructor_bitWiseXorAssign (SOURCE_FILE ("instruction-assignment-operator.galgas", 51)) ;
    outArgument_outInfixOperator = GALGAS_infixOperator::constructor_xorOp (SOURCE_FILE ("instruction-assignment-operator.galgas", 52)) ;
  } break ;
  case 4: {
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__2B__3D_) COMMA_SOURCE_FILE ("instruction-assignment-operator.galgas", 54)) ;
    outArgument_outOp = GALGAS_operatorAssignmentKind::constructor_addAssign (SOURCE_FILE ("instruction-assignment-operator.galgas", 55)) ;
    outArgument_outInfixOperator = GALGAS_infixOperator::constructor_addOp (SOURCE_FILE ("instruction-assignment-operator.galgas", 56)) ;
  } break ;
  case 5: {
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__2B__25__3D_) COMMA_SOURCE_FILE ("instruction-assignment-operator.galgas", 58)) ;
    outArgument_outOp = GALGAS_operatorAssignmentKind::constructor_addModuloAssign (SOURCE_FILE ("instruction-assignment-operator.galgas", 59)) ;
    outArgument_outInfixOperator = GALGAS_infixOperator::constructor_addOpNoOvf (SOURCE_FILE ("instruction-assignment-operator.galgas", 60)) ;
  } break ;
  case 6: {
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__2D__3D_) COMMA_SOURCE_FILE ("instruction-assignment-operator.galgas", 62)) ;
    outArgument_outOp = GALGAS_operatorAssignmentKind::constructor_subAssign (SOURCE_FILE ("instruction-assignment-operator.galgas", 63)) ;
    outArgument_outInfixOperator = GALGAS_infixOperator::constructor_subOp (SOURCE_FILE ("instruction-assignment-operator.galgas", 64)) ;
  } break ;
  case 7: {
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__2D__25__3D_) COMMA_SOURCE_FILE ("instruction-assignment-operator.galgas", 66)) ;
    outArgument_outOp = GALGAS_operatorAssignmentKind::constructor_subModuloAssign (SOURCE_FILE ("instruction-assignment-operator.galgas", 67)) ;
    outArgument_outInfixOperator = GALGAS_infixOperator::constructor_subOpNoOvf (SOURCE_FILE ("instruction-assignment-operator.galgas", 68)) ;
  } break ;
  case 8: {
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__2A__3D_) COMMA_SOURCE_FILE ("instruction-assignment-operator.galgas", 70)) ;
    outArgument_outOp = GALGAS_operatorAssignmentKind::constructor_mulAssign (SOURCE_FILE ("instruction-assignment-operator.galgas", 71)) ;
    outArgument_outInfixOperator = GALGAS_infixOperator::constructor_mulOp (SOURCE_FILE ("instruction-assignment-operator.galgas", 72)) ;
  } break ;
  case 9: {
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__2A__25__3D_) COMMA_SOURCE_FILE ("instruction-assignment-operator.galgas", 74)) ;
    outArgument_outOp = GALGAS_operatorAssignmentKind::constructor_mulModuloAssign (SOURCE_FILE ("instruction-assignment-operator.galgas", 75)) ;
    outArgument_outInfixOperator = GALGAS_infixOperator::constructor_mulOpNoOvf (SOURCE_FILE ("instruction-assignment-operator.galgas", 76)) ;
  } break ;
  default:
    break ;
  }
  outArgument_outOperatorLocation = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("instruction-assignment-operator.galgas", 78)) ;
}

//---------------------------------------------------------------------------------------------------------------------*

void cParser_plm_5F_syntax::rule_plm_5F_syntax_assignment_5F_operator_i72_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  switch (select_plm_5F_syntax_67 (inCompiler)) {
  case 1: {
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__7C__3D_) COMMA_SOURCE_FILE ("instruction-assignment-operator.galgas", 42)) ;
  } break ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_instruction_i73_ (GALGAS_instructionListAST & ioArgument_ioInstructionList,
                                                                 C_Lexique_plm_5F_lexique * inCompiler) {
  GALGAS_assignmentTargetNoSelfAST var_assignmentTargetAST_2726 ;
  nt_assignment_5F_target_5F_noself_ (var_assignmentTargetAST_2726, inCompiler) ;
  GALGAS_location var_instructionLocation_2754 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("instruction-assignment-operator.galgas", 85)) ;
  GALGAS_operatorAssignmentKind var_operatorAssign_2817 ;
  GALGAS_infixOperator var_infixOperator_2836 ;
  GALGAS_location var_operatorLocation_2858 ;
  nt_assignment_5F_operator_ (var_operatorAssign_2817, var_infixOperator_2836, var_operatorLocation_2858, inCompiler) ;
  GALGAS_expressionAST var_expression_2906 ;
  nt_expression_ (var_expression_2906, inCompiler) ;
  ioArgument_ioInstructionList.addAssign_operation (GALGAS_varOperatorAssignInstructionAST::constructor_new (var_instructionLocation_2754, var_assignmentTargetAST_2726, var_operatorAssign_2817, var_infixOperator_2836, var_operatorLocation_2858, var_expression_2906, GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("instruction-assignment-operator.galgas", 95))  COMMA_SOURCE_FILE ("instruction-assignment-operator.galgas", 88))  COMMA_SOURCE_FILE ("instruction-assignment-operator.galgas", 88)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_instruction_i74_ (GALGAS_instructionListAST & ioArgument_ioInstructionList,
                                                                 C_Lexique_plm_5F_lexique * inCompiler) {
  GALGAS_assignmentTargetSelfAST var_assignmentTargetAST_3373 ;
  nt_assignment_5F_target_5F_self_ (var_assignmentTargetAST_3373, inCompiler) ;
  GALGAS_location var_instructionLocation_3401 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("instruction-assignment-operator.galgas", 103)) ;
  GALGAS_operatorAssignmentKind var_operatorAssign_3464 ;
  GALGAS_infixOperator var_infixOperator_3483 ;
  GALGAS_location var_operatorLocation_3505 ;
  nt_assignment_5F_operator_ (var_operatorAssign_3464, var_infixOperator_3483, var_operatorLocation_3505, inCompiler) ;
  GALGAS_expressionAST var_expression_3553 ;
  nt_expression_ (var_expression_3553, inCompiler) ;
  ioArgument_ioInstructionList.addAssign_operation (GALGAS_varOperatorAssignInstructionAST::constructor_new (var_instructionLocation_3401, var_assignmentTargetAST_3373, var_operatorAssign_3464, var_infixOperator_3483, var_operatorLocation_3505, var_expression_3553, GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("instruction-assignment-operator.galgas", 113))  COMMA_SOURCE_FILE ("instruction-assignment-operator.galgas", 106))  COMMA_SOURCE_FILE ("instruction-assignment-operator.galgas", 106)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_if_5F_instruction_i82_ (GALGAS_ifInstructionAST & outArgument_outIfInstruction,
                                                                       C_Lexique_plm_5F_lexique * inCompiler) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_if_5F_instruction_i82_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_if) COMMA_SOURCE_FILE ("instruction-if.galgas", 32)) ;
  switch (select_plm_5F_syntax_70 (inCompiler)) {
  case 1: {
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__40_attribute) COMMA_SOURCE_FILE ("instruction-if.galgas", 36)) ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_guarded_5F_command_i83_ (GALGAS_guardedCommandAST & outArgument_outGuardedCommand,
                                                                        C_Lexique_plm_5F_lexique * inCompiler) {
  ...
  case 1: {
    ...
    case 1: {
      GALGAS_effectiveArgumentListAST var_effectiveParameterList_2597 ;
      GALGAS_location joker_2599 ; // Joker input parameter
      nt_effective_5F_parameters_ (var_effectiveParameterList_2597, joker_2599, inCompiler) ;
      joker_2599.drop () ; // Release temporary input variables (joker in source)
      outArgument_outGuardedCommand = GALGAS_guardedCommandAST::constructor_boolAndSync (var_isWhileCommand_2371, var_expression_2308, var_endOfExp_2327, GALGAS_string::makeEmptyString ().getter_here (inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 66)), var_name_2525, var_effectiveParameterList_2597  COMMA_SOURCE_FILE ("instruction-sync.galgas", 62)) ;
    } break ;
    case 2: {
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__2E_) COMMA_SOURCE_FILE ("instruction-sync.galgas", 71)) ;
      GALGAS_lstring var_guardName_2948 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_identifier) COMMA_SOURCE_FILE ("instruction-sync.galgas", 72)) ;
      GALGAS_effectiveArgumentListAST var_effectiveParameterList_3007 ;
      GALGAS_location joker_3009 ; // Joker input parameter
      nt_effective_5F_parameters_ (var_effectiveParameterList_3007, joker_3009, inCompiler) ;
      joker_3009.drop () ; // Release temporary input variables (joker in source)
      outArgument_outGuardedCommand = GALGAS_guardedCommandAST::constructor_boolAndSync (var_isWhileCommand_2371, var_expression_2308, var_endOfExp_2327, var_name_2525, var_guardName_2948, var_effectiveParameterList_3007  COMMA_SOURCE_FILE ("instruction-sync.galgas", 74)) ;
    } break ;
    default:
      break ;
    }
  ...
  case 2: {
    GALGAS_bool var_isWhileCommand_3345 ;
    switch (select_plm_5F_syntax_75 (inCompiler)) {
    case 1: {
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_until) COMMA_SOURCE_FILE ("instruction-sync.galgas", 86)) ;
      var_isWhileCommand_3345 = GALGAS_bool (false) ;
    } break ;
    case 2: {
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_while) COMMA_SOURCE_FILE ("instruction-sync.galgas", 89)) ;
      var_isWhileCommand_3345 = GALGAS_bool (true) ;
    } break ;
    default:
      break ;
    }
    GALGAS_lstring var_name_3499 = inCompiler->synthetizedAttribute_tokenString () ;
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_identifier) COMMA_SOURCE_FILE ("instruction-sync.galgas", 92)) ;
    switch (select_plm_5F_syntax_76 (inCompiler)) {
    case 1: {
      GALGAS_effectiveArgumentListAST var_effectiveParameterList_3571 ;
      GALGAS_location joker_3573 ; // Joker input parameter
      nt_effective_5F_parameters_ (var_effectiveParameterList_3571, joker_3573, inCompiler) ;
      joker_3573.drop () ; // Release temporary input variables (joker in source)
      outArgument_outGuardedCommand = GALGAS_guardedCommandAST::constructor_synchronization (var_isWhileCommand_3345, GALGAS_string::makeEmptyString ().getter_here (inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 97)), var_name_3499, var_effectiveParameterList_3571  COMMA_SOURCE_FILE ("instruction-sync.galgas", 95)) ;
    } break ;
    case 2: {
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__2E_) COMMA_SOURCE_FILE ("instruction-sync.galgas", 102)) ;
      GALGAS_lstring var_guardName_3857 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_identifier) COMMA_SOURCE_FILE ("instruction-sync.galgas", 103)) ;
      GALGAS_effectiveArgumentListAST var_effectiveParameterList_3916 ;
      GALGAS_location joker_3918 ; // Joker input parameter
      nt_effective_5F_parameters_ (var_effectiveParameterList_3916, joker_3918, inCompiler) ;
      joker_3918.drop () ; // Release temporary input variables (joker in source)
      outArgument_outGuardedCommand = GALGAS_guardedCommandAST::constructor_synchronization (var_isWhileCommand_3345, var_name_3499, var_guardName_3857, var_effectiveParameterList_3916  COMMA_SOURCE_FILE ("instruction-sync.galgas", 105)) ;
    } break ;
    default:
      break ;
    }
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_guarded_5F_command_i83_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  switch (select_plm_5F_syntax_72 (inCompiler)) {
  case 1: {
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_when) COMMA_SOURCE_FILE ("instruction-sync.galgas", 48)) ;
    nt_expression_parse (inCompiler) ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_instruction_i84_ (GALGAS_instructionListAST & ioArgument_ioInstructionList,
                                                                 C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_sync) COMMA_SOURCE_FILE ("instruction-sync.galgas", 118)) ;
  GALGAS_location var_startLocation_4386 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("instruction-sync.galgas", 119)) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__7B_) COMMA_SOURCE_FILE ("instruction-sync.galgas", 120)) ;
  GALGAS_syncInstructionBranchListAST var_onInstructionBranchList_4469 = GALGAS_syncInstructionBranchListAST::constructor_emptyList (SOURCE_FILE ("instruction-sync.galgas", 121)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    GALGAS_guardedCommandAST var_guardedCommand_4548 ;
    nt_guarded_5F_command_ (var_guardedCommand_4548, inCompiler) ;
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__3A_) COMMA_SOURCE_FILE ("instruction-sync.galgas", 124)) ;
    GALGAS_instructionListAST var_instructionList_4603 ;
    nt_instructionList_ (var_instructionList_4603, inCompiler) ;
    var_onInstructionBranchList_4469.addAssign_operation (var_guardedCommand_4548, var_instructionList_4603, GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("instruction-sync.galgas", 126))  COMMA_SOURCE_FILE ("instruction-sync.galgas", 126)) ;
  ...
  ioArgument_ioInstructionList.addAssign_operation (GALGAS_syncInstructionAST::constructor_new (var_startLocation_4386, var_onInstructionBranchList_4469, GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("instruction-sync.galgas", 129))  COMMA_SOURCE_FILE ("instruction-sync.galgas", 129))  COMMA_SOURCE_FILE ("instruction-sync.galgas", 129)) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__7D_) COMMA_SOURCE_FILE ("instruction-sync.galgas", 130)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_instruction_i86_ (GALGAS_instructionListAST & ioArgument_ioInstructionList,
  ...
  GALGAS_bool var_staticWhileExpression_1449 = GALGAS_bool (false) ;
  GALGAS_expressionAST var_whileExpression_1492 ;
  switch (select_plm_5F_syntax_78 (inCompiler)) {
  case 1: {
    var_whileExpression_1492 = GALGAS_literalBooleanInExpressionAST::constructor_new (GALGAS_bool (true)  COMMA_SOURCE_FILE ("instruction-for-in-do.galgas", 33)) ;
    var_staticWhileExpression_1449 = GALGAS_bool (true) ;
  } break ;
  case 2: {
    ...
    case 1: {
      GALGAS_lstring var_attributeValue_1681 = inCompiler->synthetizedAttribute_tokenString () ;
      ...
      const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, var_attributeValue_1681.getter_string (HERE).objectCompare (function_staticAttribute (inCompiler COMMA_SOURCE_FILE ("instruction-for-in-do.galgas", 39)))).boolEnum () ;
      if (kBoolTrue == test_0) {
        var_staticWhileExpression_1449 = GALGAS_bool (true) ;
      }else if (kBoolFalse == test_0) {
        TC_Array <C_FixItDescription> fixItArray1 ;
        ...
        inCompiler->emitSemanticError (var_attributeValue_1681.getter_location (SOURCE_FILE ("instruction-for-in-do.galgas", 42)), GALGAS_string ("the attribute should be \"@").add_operation (function_staticAttribute (inCompiler COMMA_SOURCE_FILE ("instruction-for-in-do.galgas", 42)), inCompiler COMMA_SOURCE_FILE ("instruction-for-in-do.galgas", 42)).add_operation (GALGAS_string ("\""), inCompiler COMMA_SOURCE_FILE ("instruction-for-in-do.galgas", 42)), fixItArray1  COMMA_SOURCE_FILE ("instruction-for-in-do.galgas", 42)) ;
      }
    } break ;
    case 2: {
    } break ;
    ...
    nt_expression_ (var_whileExpression_1492, inCompiler) ;
  } break ;
  default:
    break ;
  }
  GALGAS_location var_endOf_5F_whileExpression_5F_instruction_2055 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("instruction-for-in-do.galgas", 49)) ;
  ...
  GALGAS_instructionListAST var_instructionList_2123 ;
  nt_instructionList_ (var_instructionList_2123, inCompiler) ;
  GALGAS_location var_endOfInstruction_2148 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("instruction-for-in-do.galgas", 52)) ;
  ...
  ioArgument_ioInstructionList.addAssign_operation (GALGAS_forInstructionAST::constructor_new (var_varName_1253.getter_location (HERE), var_varName_1253, var_iteratedObject_1299, var_whileExpression_1492, var_endOf_5F_whileExpression_5F_instruction_2055, var_staticWhileExpression_1449, var_instructionList_2123, var_endOfInstruction_2148  COMMA_SOURCE_FILE ("instruction-for-in-do.galgas", 54))  COMMA_SOURCE_FILE ("instruction-for-in-do.galgas", 54)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_instruction_i88_ (GALGAS_instructionListAST & ioArgument_ioInstructionList,
                                                                 C_Lexique_plm_5F_lexique * inCompiler) {
  GALGAS_callInstructionAST var_routineCallInstruction_1556 ;
  nt_procedure_5F_call_ (var_routineCallInstruction_1556, inCompiler) ;
  ioArgument_ioInstructionList.addAssign_operation (var_routineCallInstruction_1556  COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 32)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_procedure_5F_call_i89_ (GALGAS_callInstructionAST & outArgument_outInstruction,
  ...
  GALGAS_location var_instructionLocation_1822 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 38)) ;
  GALGAS_assignmentTargetNoSelfAST var_assignmentTargetAST_1895 ;
  nt_assignment_5F_target_5F_noself_ (var_assignmentTargetAST_1895, inCompiler) ;
  GALGAS_effectiveArgumentListAST var_arguments_1937 ;
  GALGAS_location var_endOfArguments_1957 ;
  nt_effective_5F_parameters_ (var_arguments_1937, var_endOfArguments_1957, inCompiler) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, var_assignmentTargetAST_1895.getter_mAccessList (SOURCE_FILE ("instruction-procedure-call.galgas", 41)).getter_length (SOURCE_FILE ("instruction-procedure-call.galgas", 41)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    outArgument_outInstruction = GALGAS_simpleCallInstructionAST::constructor_new (var_instructionLocation_1822, var_arguments_1937, var_endOfArguments_1957, var_assignmentTargetAST_1895.getter_mIdentifier (SOURCE_FILE ("instruction-procedure-call.galgas", 42))  COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 42)) ;
  }else if (kBoolFalse == test_0) {
    outArgument_outInstruction = GALGAS_complexCallInstructionAST::constructor_new (var_instructionLocation_1822, var_arguments_1937, var_endOfArguments_1957, var_assignmentTargetAST_1895  COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 44)) ;
  }
}

//---------------------------------------------------------------------------------------------------------------------*

void cParser_plm_5F_syntax::rule_plm_5F_syntax_procedure_5F_call_i89_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  nt_assignment_5F_target_5F_noself_parse (inCompiler) ;
  nt_effective_5F_parameters_parse (inCompiler) ;
  inCompiler->resetTemplateString () ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_procedure_5F_call_i90_ (GALGAS_callInstructionAST & outArgument_outInstruction,
                                                                       C_Lexique_plm_5F_lexique * inCompiler) {
  outArgument_outInstruction.drop () ; // Release 'out' argument
  GALGAS_location var_instructionLocation_2514 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 51)) ;
  GALGAS_assignmentTargetSelfAST var_assignmentTargetAST_2585 ;
  nt_assignment_5F_target_5F_self_ (var_assignmentTargetAST_2585, inCompiler) ;
  GALGAS_effectiveArgumentListAST var_arguments_2627 ;
  GALGAS_location var_endOfArguments_2647 ;
  nt_effective_5F_parameters_ (var_arguments_2627, var_endOfArguments_2647, inCompiler) ;
  outArgument_outInstruction = GALGAS_complexCallInstructionAST::constructor_new (var_instructionLocation_2514, var_arguments_2627, var_endOfArguments_2647, var_assignmentTargetAST_2585  COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 54)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_assignment_5F_target_5F_noself_i92_ (GALGAS_assignmentTargetNoSelfAST & outArgument_outAssignmentTargetAST,
                                                                                    C_Lexique_plm_5F_lexique * inCompiler) {
  outArgument_outAssignmentTargetAST.drop () ; // Release 'out' argument
  GALGAS_lstring var_identifier_1950 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_identifier) COMMA_SOURCE_FILE ("assignment-target.galgas", 44)) ;
  GALGAS_accessInAssignmentListAST var_accessListAST_2027 = GALGAS_accessInAssignmentListAST::constructor_emptyList (SOURCE_FILE ("assignment-target.galgas", 46)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_plm_5F_syntax_83 (inCompiler)) {
    case 2: {
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__2E_) COMMA_SOURCE_FILE ("assignment-target.galgas", 49)) ;
      GALGAS_lstring var_propertyName_2100 = inCompiler->synthetizedAttribute_tokenString () ;
      ...
      var_accessListAST_2027.addAssign_operation (GALGAS_accessInAssignmentAST::constructor_property (var_propertyName_2100  COMMA_SOURCE_FILE ("assignment-target.galgas", 51))  COMMA_SOURCE_FILE ("assignment-target.galgas", 51)) ;
    } break ;
    case 3: {
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__5B_) COMMA_SOURCE_FILE ("assignment-target.galgas", 53)) ;
      GALGAS_expressionAST var_expression_2210 ;
      nt_expression_ (var_expression_2210, inCompiler) ;
      GALGAS_location var_endOfIndex_2231 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("assignment-target.galgas", 55)) ;
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__5D_) COMMA_SOURCE_FILE ("assignment-target.galgas", 56)) ;
      var_accessListAST_2027.addAssign_operation (GALGAS_accessInAssignmentAST::constructor_arrayAccess (var_expression_2210, var_endOfIndex_2231  COMMA_SOURCE_FILE ("assignment-target.galgas", 57))  COMMA_SOURCE_FILE ("assignment-target.galgas", 57)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  outArgument_outAssignmentTargetAST = GALGAS_assignmentTargetNoSelfAST::constructor_new (var_identifier_1950, var_accessListAST_2027  COMMA_SOURCE_FILE ("assignment-target.galgas", 59)) ;
}

//---------------------------------------------------------------------------------------------------------------------*

void cParser_plm_5F_syntax::rule_plm_5F_syntax_assignment_5F_target_5F_noself_i92_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_identifier) COMMA_SOURCE_FILE ("assignment-target.galgas", 44)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_plm_5F_syntax_83 (inCompiler)) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_assignment_5F_target_5F_self_i93_ (GALGAS_assignmentTargetSelfAST & outArgument_outAssignmentTargetAST,
                                                                                  C_Lexique_plm_5F_lexique * inCompiler) {
  outArgument_outAssignmentTargetAST.drop () ; // Release 'out' argument
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_self) COMMA_SOURCE_FILE ("assignment-target.galgas", 66)) ;
  GALGAS_location var_selfLocation_2689 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("assignment-target.galgas", 67)) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__2E_) COMMA_SOURCE_FILE ("assignment-target.galgas", 68)) ;
  GALGAS_lstring var_identifier_2761 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_identifier) COMMA_SOURCE_FILE ("assignment-target.galgas", 70)) ;
  GALGAS_accessInAssignmentListAST var_accessListAST_2838 = GALGAS_accessInAssignmentListAST::constructor_emptyList (SOURCE_FILE ("assignment-target.galgas", 72)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_plm_5F_syntax_84 (inCompiler)) {
    case 2: {
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__2E_) COMMA_SOURCE_FILE ("assignment-target.galgas", 75)) ;
      GALGAS_lstring var_propertyName_2911 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_identifier) COMMA_SOURCE_FILE ("assignment-target.galgas", 76)) ;
      var_accessListAST_2838.addAssign_operation (GALGAS_accessInAssignmentAST::constructor_property (var_propertyName_2911  COMMA_SOURCE_FILE ("assignment-target.galgas", 77))  COMMA_SOURCE_FILE ("assignment-target.galgas", 77)) ;
    } break ;
    case 3: {
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__5B_) COMMA_SOURCE_FILE ("assignment-target.galgas", 79)) ;
      GALGAS_expressionAST var_expression_3021 ;
      nt_expression_ (var_expression_3021, inCompiler) ;
      GALGAS_location var_endOfIndex_3042 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("assignment-target.galgas", 81)) ;
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__5D_) COMMA_SOURCE_FILE ("assignment-target.galgas", 82)) ;
      var_accessListAST_2838.addAssign_operation (GALGAS_accessInAssignmentAST::constructor_arrayAccess (var_expression_3021, var_endOfIndex_3042  COMMA_SOURCE_FILE ("assignment-target.galgas", 83))  COMMA_SOURCE_FILE ("assignment-target.galgas", 83)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  outArgument_outAssignmentTargetAST = GALGAS_assignmentTargetSelfAST::constructor_new (var_identifier_2761, var_accessListAST_2838, var_selfLocation_2689  COMMA_SOURCE_FILE ("assignment-target.galgas", 85)) ;
}

//---------------------------------------------------------------------------------------------------------------------*

void cParser_plm_5F_syntax::rule_plm_5F_syntax_assignment_5F_target_5F_self_i93_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_self) COMMA_SOURCE_FILE ("assignment-target.galgas", 66)) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__2E_) COMMA_SOURCE_FILE ("assignment-target.galgas", 68)) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_identifier) COMMA_SOURCE_FILE ("assignment-target.galgas", 70)) ;
  bool repeatFlag_0 = true ;
