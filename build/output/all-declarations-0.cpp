...
//--- Syntax error message for terminal '$$$' :
static const char * gSyntaxErrorMessage_plm_5F_lexique__24_ = "the '$' delimitor" ;
...
C_String C_Lexique_plm_5F_lexique::getMessageForTerminal (const int16_t inTerminalIndex) const {
  ...
  if ((inTerminalIndex >= 0) && (inTerminalIndex < 116)) {
    static const char * syntaxErrorMessageArray [116] = {kEndOfSourceLexicalErrorMessage,
        ...
        gSyntaxErrorMessage_plm_5F_lexique__24_,
...
//--- Unicode string for '$_24_$'
static const utf32 kUnicodeString_plm_5F_lexique__24_ [] = {
  TO_UNICODE ('$'),
  TO_UNICODE (0)
} ;
...
static const int32_t ktable_size_plm_5F_lexique_delimitorsList = 54 ;
...
static const C_unicode_lexique_table_entry ktable_for_plm_5F_lexique_delimitorsList [ktable_size_plm_5F_lexique_delimitorsList] = {
  C_unicode_lexique_table_entry (kUnicodeString_plm_5F_lexique__24_, 1, C_Lexique_plm_5F_lexique::kToken__24_),
  ...
  while ((token.mTokenCode < 0) && (UNICODE_VALUE (mCurrentChar) != '\0')) {
    ...
    try{
      if (testForCharWithFunction (isUnicodeLetter)) {
        ...
        enterToken (token) ;
      }else if (testForInputUTF32String (kUnicodeString_plm_5F_lexique__24_, 1, true)) {
        token.mTokenCode = kToken__24_ ;
        enterToken (token) ;
      }else if (testForInputUTF32Char (TO_UNICODE ('\?'))) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_type_5F_definition_5F_enclosed_5F_in_5F_square_5F_breackets_i4_ (GALGAS_ast & ioArgument_ioAST,
  ...
  GALGAS_lstring var_attribute_1238 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__40_attribute COMMA_SOURCE_FILE ("type-static-array.galgas", 22)) ;
  enumGalgasBool test_0 = kBoolTrue ;
  if (kBoolTrue == test_0) {
    test_0 = GALGAS_bool (kIsNotEqual, var_attribute_1238.getter_string (HERE).objectCompare (GALGAS_string ("x"))).boolEnum () ;
    if (kBoolTrue == test_0) {
      TC_Array <C_FixItDescription> fixItArray1 ;
      inCompiler->emitSemanticError (var_attribute_1238.getter_location (SOURCE_FILE ("type-static-array.galgas", 24)), GALGAS_string ("attribute should be @x"), fixItArray1  COMMA_SOURCE_FILE ("type-static-array.galgas", 24)) ;
    }
  }
  GALGAS_lstring var_elementTypeName_1382 ;
  nt_type_5F_definition_ (ioArgument_ioAST, var_elementTypeName_1382, inCompiler) ;
  GALGAS_location var_sizeExpressionLocation_1413 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("type-static-array.galgas", 27)) ;
  ...
  ioArgument_ioAST.mProperty_mDeclarationListAST.addAssign_operation (GALGAS_staticArrayTypeDeclarationAST::constructor_new (outArgument_outTypeName, var_elementTypeName_1382, var_sizeExpression_1206, var_sizeExpressionLocation_1413  COMMA_SOURCE_FILE ("type-static-array.galgas", 30))  COMMA_SOURCE_FILE ("type-static-array.galgas", 30)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_type_5F_definition_5F_enclosed_5F_in_5F_square_5F_breackets_i5_ (GALGAS_ast & ioArgument_ioAST,
                                                                                                                ...
                                                                                                                C_Lexique_plm_5F_lexique * inCompiler) {
  outArgument_outTypeName.drop () ; // Release 'out' argument
  GALGAS_lstring var_elementTypeName_1151 ;
  nt_type_5F_definition_ (ioArgument_ioAST, var_elementTypeName_1151, inCompiler) ;
  outArgument_outTypeName = GALGAS_string ("anonymous.").add_operation (ioArgument_ioAST.getter_mTypeDeclarationIndex (HERE).getter_string (SOURCE_FILE ("type-dynamic-array.galgas", 20)), inCompiler COMMA_SOURCE_FILE ("type-dynamic-array.galgas", 20)).getter_here (inCompiler COMMA_SOURCE_FILE ("type-dynamic-array.galgas", 20)) ;
  ioArgument_ioAST.mProperty_mTypeDeclarationIndex.increment_operation (inCompiler  COMMA_SOURCE_FILE ("type-dynamic-array.galgas", 21)) ;
  ioArgument_ioAST.mProperty_mDeclarationListAST.addAssign_operation (GALGAS_typeDynamicArrayDeclarationAST::constructor_new (outArgument_outTypeName, var_elementTypeName_1151  COMMA_SOURCE_FILE ("type-dynamic-array.galgas", 22))  COMMA_SOURCE_FILE ("type-dynamic-array.galgas", 22)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_propertyGetterSetter_i11_ (GALGAS_ast & ioArgument_ioAST,
  ...
  case 1: {
    GALGAS_bool var_getterDefined_5796 = GALGAS_bool (false) ;
    GALGAS_bool var_setterDefined_5828 = GALGAS_bool (false) ;
    bool repeatFlag_0 = true ;
    while (repeatFlag_0) {
      GALGAS_lstring var_getterOrSetter_5890 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 179)) ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__7B_ COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 180)) ;
      GALGAS_instructionListAST var_instructionList_5957 ;
      nt_instructionList_ (ioArgument_ioAST, var_instructionList_5957, inCompiler) ;
      GALGAS_location var_endOfInstructionList_5990 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 182)) ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__7D_ COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 183)) ;
      enumGalgasBool test_1 = kBoolTrue ;
      if (kBoolTrue == test_1) {
        test_1 = GALGAS_bool (kIsEqual, var_getterOrSetter_5890.getter_string (HERE).objectCompare (GALGAS_string ("get"))).boolEnum () ;
        if (kBoolTrue == test_1) {
          ioArgument_ioPropertyListAST.addAssign_operation (constinArgument_inPropertyName, constinArgument_inPropertyAttributeList, constinArgument_inIsPublic, constinArgument_inTypeName, GALGAS_propertyKindAST::constructor_readOnlyComputedProperty (var_instructionList_5957, var_endOfInstructionList_5990  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 190))  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 185)) ;
          enumGalgasBool test_2 = kBoolTrue ;
          if (kBoolTrue == test_2) {
            test_2 = var_getterDefined_5796.boolEnum () ;
            if (kBoolTrue == test_2) {
              TC_Array <C_FixItDescription> fixItArray3 ;
              inCompiler->emitSemanticError (var_getterOrSetter_5890.getter_location (SOURCE_FILE ("type-structure-declaration.galgas", 195)), GALGAS_string ("duplicate getter definition"), fixItArray3  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 195)) ;
            }
          }
          var_getterDefined_5796 = GALGAS_bool (true) ;
        }
      }
      if (kBoolFalse == test_1) {
        enumGalgasBool test_4 = kBoolTrue ;
        if (kBoolTrue == test_4) {
          test_4 = GALGAS_bool (kIsEqual, var_getterOrSetter_5890.getter_string (HERE).objectCompare (GALGAS_string ("set"))).boolEnum () ;
          if (kBoolTrue == test_4) {
            ioArgument_ioPropertyListAST.addAssign_operation (constinArgument_inPropertyName, constinArgument_inPropertyAttributeList, constinArgument_inIsPublic, constinArgument_inTypeName, GALGAS_propertyKindAST::constructor_writeComputedProperty (var_instructionList_5957, var_endOfInstructionList_5990  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 204))  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 199)) ;
            enumGalgasBool test_5 = kBoolTrue ;
            if (kBoolTrue == test_5) {
              test_5 = var_setterDefined_5828.boolEnum () ;
              if (kBoolTrue == test_5) {
                TC_Array <C_FixItDescription> fixItArray6 ;
                inCompiler->emitSemanticError (var_getterOrSetter_5890.getter_location (SOURCE_FILE ("type-structure-declaration.galgas", 209)), GALGAS_string ("duplicate setter definition"), fixItArray6  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 209)) ;
              }
            }
            var_setterDefined_5828 = GALGAS_bool (true) ;
          }
        }
        if (kBoolFalse == test_4) {
          ...
          inCompiler->emitSemanticError (var_getterOrSetter_5890.getter_location (SOURCE_FILE ("type-structure-declaration.galgas", 213)), GALGAS_string ("invalid identifier"), fixItArray7  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 213)) ;
        }
      }
    ...
    if (kBoolTrue == test_8) {
      GALGAS_bool test_9 = var_setterDefined_5828 ;
      if (kBoolTrue == test_9.boolEnum ()) {
        test_9 = var_getterDefined_5796.operator_not (SOURCE_FILE ("type-structure-declaration.galgas", 217)) ;
      }
      test_8 = test_9.boolEnum () ;
      if (kBoolTrue == test_8) {
        TC_Array <C_FixItDescription> fixItArray10 ;
        inCompiler->emitSemanticError (GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 218)), GALGAS_string ("a getter should be defined"), fixItArray10  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 218)) ;
      }
    }
    if (kBoolFalse == test_8) {
      enumGalgasBool test_11 = kBoolTrue ;
      if (kBoolTrue == test_11) {
        GALGAS_bool test_12 = var_setterDefined_5828.operator_not (SOURCE_FILE ("type-structure-declaration.galgas", 219)) ;
        if (kBoolTrue == test_12.boolEnum ()) {
          test_12 = var_getterDefined_5796.operator_not (SOURCE_FILE ("type-structure-declaration.galgas", 219)) ;
        }
        test_11 = test_12.boolEnum () ;
        if (kBoolTrue == test_11) {
          TC_Array <C_FixItDescription> fixItArray13 ;
          inCompiler->emitSemanticError (GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 220)), GALGAS_string ("a getter should be defined, and optionaly a setter"), fixItArray13  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 220)) ;
        }
      }
    }
  } break ;
  case 2: {
    GALGAS_instructionListAST var_readInstructionList_7458 ;
    nt_instructionList_ (ioArgument_ioAST, var_readInstructionList_7458, inCompiler) ;
    GALGAS_location var_endOfReadInstructionList_7493 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 224)) ;
    ioArgument_ioPropertyListAST.addAssign_operation (constinArgument_inPropertyName, constinArgument_inPropertyAttributeList, constinArgument_inIsPublic, constinArgument_inTypeName, GALGAS_propertyKindAST::constructor_readOnlyComputedProperty (var_readInstructionList_7458, var_endOfReadInstructionList_7493  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 230))  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 225)) ;
  } break ;
  default:
    break ;
  }
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_structure_5F_function_i12_ (GALGAS_ast & ioArgument_ioAST,
  ...
  GALGAS_lstringlist var_attributeList_8191 = GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("type-structure-declaration.galgas", 250)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_plm_5F_syntax_12 (inCompiler)) {
    case 2: {
      GALGAS_lstring var_attribute_8251 = inCompiler->synthetizedAttribute_tokenString () ;
      ...
      var_attributeList_8191.addAssign_operation (var_attribute_8251  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 254)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  GALGAS_routineFormalArgumentListAST var_procFormalArgumentList_8363 ;
  nt_procedure_5F_formal_5F_arguments_ (ioArgument_ioAST, var_procFormalArgumentList_8363, inCompiler) ;
  GALGAS_lstring var_returnTypeName_8391 ;
  switch (select_plm_5F_syntax_13 (inCompiler)) {
  case 1: {
    var_returnTypeName_8391 = GALGAS_string::makeEmptyString ().getter_here (inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 259)) ;
  } break ;
  case 2: {
    ...
    nt_type_5F_definition_ (ioArgument_ioAST, var_returnTypeName_8391, inCompiler) ;
  } break ;
  default:
    break ;
  }
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__7B_ COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 264)) ;
  GALGAS_instructionListAST var_instructionList_8568 ;
  nt_instructionList_ (ioArgument_ioAST, var_instructionList_8568, inCompiler) ;
  ioArgument_ioProcListAST.addAssign_operation (GALGAS_mode::constructor_anyMode (SOURCE_FILE ("type-structure-declaration.galgas", 267)), var_public_8036, var_procName_8160, var_attributeList_8191, var_procFormalArgumentList_8363, var_returnTypeName_8391, var_instructionList_8568, GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 274))  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 266)) ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_i13_ (GALGAS_ast & ioArgument_ioAST,
  ...
  GALGAS_lstring var_structureName_8964 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GALGAS_lstringlist var_attributeList_8995 = GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("type-structure-declaration.galgas", 283)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_plm_5F_syntax_14 (inCompiler)) {
    case 2: {
      GALGAS_lstring var_attribute_9055 = inCompiler->synthetizedAttribute_tokenString () ;
      ...
      var_attributeList_8995.addAssign_operation (var_attribute_9055  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 287)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  GALGAS_functionDeclarationListAST var_procedureDeclarationListAST_9166 = GALGAS_functionDeclarationListAST::constructor_emptyList (SOURCE_FILE ("type-structure-declaration.galgas", 290)) ;
  GALGAS_structurePropertyListAST var_fieldList_9211 = GALGAS_structurePropertyListAST::constructor_emptyList (SOURCE_FILE ("type-structure-declaration.galgas", 291)) ;
  bool repeatFlag_1 = true ;
  while (repeatFlag_1) {
    switch (select_plm_5F_syntax_15 (inCompiler)) {
    case 2: {
      nt_private_5F_or_5F_public_5F_struct_5F_property_5F_declaration_ (ioArgument_ioAST, var_fieldList_9211, inCompiler) ;
    } break ;
    case 3: {
      nt_structure_5F_function_ (ioArgument_ioAST, var_procedureDeclarationListAST_9166, inCompiler) ;
    } break ;
    default:
      repeatFlag_1 = false ;
      break ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_i16_ (GALGAS_ast & ioArgument_ioAST,
  ...
  while (repeatFlag_6) {
    ...
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__3A_ COMMA_SOURCE_FILE ("declaration-control-register.galgas", 131)) ;
    GALGAS_lstring var_registerTypeName_5211 = inCompiler->synthetizedAttribute_tokenString () ;
    ...
    GALGAS_controlRegisterBitSliceList var_registerBitSliceList_5267 = GALGAS_controlRegisterBitSliceList::constructor_emptyList (SOURCE_FILE ("declaration-control-register.galgas", 133)) ;
    switch (select_plm_5F_syntax_23 (inCompiler)) {
    case 1: {
    } break ;
    case 2: {
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__7B_ COMMA_SOURCE_FILE ("declaration-control-register.galgas", 136)) ;
      bool repeatFlag_8 = true ;
      while (repeatFlag_8) {
        GALGAS_controlRegisterBitSlice var_registerBitSlice_5373 ;
        switch (select_plm_5F_syntax_25 (inCompiler)) {
        case 1: {
          GALGAS_lbigint var_unusedBitCount_5441 = inCompiler->synthetizedAttribute_bigInteger () ;
          inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_integer COMMA_SOURCE_FILE ("declaration-control-register.galgas", 140)) ;
          var_registerBitSlice_5373 = GALGAS_controlRegisterBitSlice::constructor_unusedBits (var_unusedBitCount_5441  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 141)) ;
        } break ;
        case 2: {
          GALGAS_lstring var_bitName_5559 = inCompiler->synthetizedAttribute_tokenString () ;
          inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("declaration-control-register.galgas", 143)) ;
          switch (select_plm_5F_syntax_26 (inCompiler)) {
          case 1: {
            var_registerBitSlice_5373 = GALGAS_controlRegisterBitSlice::constructor_namedBit (var_bitName_5559, GALGAS_lbigint::constructor_new (GALGAS_bigint ("1", inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 145)), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 145))  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 145))  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 145)) ;
          } break ;
          case 2: {
            inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__3A_ COMMA_SOURCE_FILE ("declaration-control-register.galgas", 147)) ;
            GALGAS_lbigint var_bitCount_5741 = inCompiler->synthetizedAttribute_bigInteger () ;
            inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_integer COMMA_SOURCE_FILE ("declaration-control-register.galgas", 148)) ;
            var_registerBitSlice_5373 = GALGAS_controlRegisterBitSlice::constructor_namedBit (var_bitName_5559, var_bitCount_5741  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 149)) ;
          } break ;
          default:
            break ;
          }
        ...
        var_registerBitSliceList_5267.addAssign_operation (var_registerBitSlice_5373  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 152)) ;
        switch (select_plm_5F_syntax_24 (inCompiler)) {
        case 2: {
          inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__2C_ COMMA_SOURCE_FILE ("declaration-control-register.galgas", 154)) ;
        } break ;
        default:
          repeatFlag_8 = false ;
          break ;
      ...
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__7D_ COMMA_SOURCE_FILE ("declaration-control-register.galgas", 156)) ;
    } break ;
    default:
      break ;
    }
    GALGAS_location var_endOfBitSlice_5984 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 158)) ;
    var_controlRegisterDeclarationList_4970.addAssign_operation (var_registerDeclarationList_5044, var_registerTypeName_5211, var_registerBitSliceList_5267, var_endOfBitSlice_5984  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 159)) ;
  ...
  ioArgument_ioAST.mProperty_mDeclarationListAST.addAssign_operation (GALGAS_controlRegisterGroupDeclarationAST::constructor_new (var_registerGroupListAST_3664, var_controlRegisterDeclarationList_4970  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 162))  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 162)) ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__7D_ COMMA_SOURCE_FILE ("declaration-control-register.galgas", 166)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_registerDeclaration_i17_ (GALGAS_ast & ioArgument_ioAST,
                                                                         ...
                                                                         C_Lexique_plm_5F_lexique * inCompiler) {
  GALGAS_lstring var_registerName_6705 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("declaration-control-register.galgas", 174)) ;
  switch (select_plm_5F_syntax_27 (inCompiler)) {
  case 1: {
    GALGAS_lstring var_attributeOffset_6756 = inCompiler->synthetizedAttribute_tokenString () ;
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__40_attribute COMMA_SOURCE_FILE ("declaration-control-register.galgas", 176)) ;
    enumGalgasBool test_0 = kBoolTrue ;
    if (kBoolTrue == test_0) {
      test_0 = GALGAS_bool (kIsNotEqual, var_attributeOffset_6756.getter_string (HERE).objectCompare (GALGAS_string ("offset"))).boolEnum () ;
      if (kBoolTrue == test_0) {
        TC_Array <C_FixItDescription> fixItArray1 ;
        appendFixItActions (fixItArray1, kFixItReplace, GALGAS_string ("@offset")) ;
        inCompiler->emitSemanticError (var_attributeOffset_6756.getter_location (SOURCE_FILE ("declaration-control-register.galgas", 178)), GALGAS_string ("attribute should be @offset"), fixItArray1  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 178)) ;
      }
    }
    GALGAS_expressionAST var_registerOffset_6952 ;
    nt_expression_ (ioArgument_ioAST, var_registerOffset_6952, inCompiler) ;
    GALGAS_bool var_isReadOnly_6975 ;
    switch (select_plm_5F_syntax_28 (inCompiler)) {
    case 1: {
      var_isReadOnly_6975 = GALGAS_bool (false) ;
    } break ;
    case 2: {
      GALGAS_lstring var_attribute_7060 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__40_attribute COMMA_SOURCE_FILE ("declaration-control-register.galgas", 185)) ;
      enumGalgasBool test_2 = kBoolTrue ;
      if (kBoolTrue == test_2) {
        test_2 = GALGAS_bool (kIsNotEqual, var_attribute_7060.getter_string (HERE).objectCompare (GALGAS_string ("ro"))).boolEnum () ;
        if (kBoolTrue == test_2) {
          TC_Array <C_FixItDescription> fixItArray3 ;
          appendFixItActions (fixItArray3, kFixItReplace, GALGAS_string ("@ro")) ;
          inCompiler->emitSemanticError (var_attribute_7060.getter_location (SOURCE_FILE ("declaration-control-register.galgas", 187)), GALGAS_string ("attribute should be @ro"), fixItArray3  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 187)) ;
        }
      }
      var_isReadOnly_6975 = GALGAS_bool (true) ;
    } break ;
    default:
      break ;
    }
    ioArgument_ioRegisterDeclarationList.addAssign_operation (var_registerName_6705, GALGAS_controlRegisterKind::constructor_scalar (SOURCE_FILE ("declaration-control-register.galgas", 193)), var_isReadOnly_6975, var_registerOffset_6952, GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 196))  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 191)) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__5B_ COMMA_SOURCE_FILE ("declaration-control-register.galgas", 198)) ;
    GALGAS_expressionAST var_sizeExpression_7425 ;
    nt_expression_ (ioArgument_ioAST, var_sizeExpression_7425, inCompiler) ;
    GALGAS_location var_sizeExpressionLocation_7458 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 200)) ;
    GALGAS_lstring var_attributeOffset_7515 = inCompiler->synthetizedAttribute_tokenString () ;
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__40_attribute COMMA_SOURCE_FILE ("declaration-control-register.galgas", 201)) ;
    enumGalgasBool test_4 = kBoolTrue ;
    if (kBoolTrue == test_4) {
      test_4 = GALGAS_bool (kIsNotEqual, var_attributeOffset_7515.getter_string (HERE).objectCompare (GALGAS_string ("offset"))).boolEnum () ;
      if (kBoolTrue == test_4) {
        TC_Array <C_FixItDescription> fixItArray5 ;
        appendFixItActions (fixItArray5, kFixItReplace, GALGAS_string ("@offset")) ;
        inCompiler->emitSemanticError (var_attributeOffset_7515.getter_location (SOURCE_FILE ("declaration-control-register.galgas", 203)), GALGAS_string ("attribute should be @offset"), fixItArray5  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 203)) ;
      }
    }
    GALGAS_expressionAST var_baseAddressExpression_7718 ;
    nt_expression_ (ioArgument_ioAST, var_baseAddressExpression_7718, inCompiler) ;
    GALGAS_location var_baseAddressExpressionLocation_7758 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 206)) ;
    GALGAS_lstring var_attributeInc_7812 = inCompiler->synthetizedAttribute_tokenString () ;
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__40_attribute COMMA_SOURCE_FILE ("declaration-control-register.galgas", 207)) ;
    enumGalgasBool test_6 = kBoolTrue ;
    if (kBoolTrue == test_6) {
      test_6 = GALGAS_bool (kIsNotEqual, var_attributeInc_7812.getter_string (HERE).objectCompare (GALGAS_string ("inc"))).boolEnum () ;
      if (kBoolTrue == test_6) {
        TC_Array <C_FixItDescription> fixItArray7 ;
        appendFixItActions (fixItArray7, kFixItReplace, GALGAS_string ("@inc")) ;
        inCompiler->emitSemanticError (var_attributeInc_7812.getter_location (SOURCE_FILE ("declaration-control-register.galgas", 209)), GALGAS_string ("attribute should be @inc"), fixItArray7  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 209)) ;
      }
    }
    GALGAS_expressionAST var_arrayElementSizeExpression_8005 ;
    nt_expression_ (ioArgument_ioAST, var_arrayElementSizeExpression_8005, inCompiler) ;
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__5D_ COMMA_SOURCE_FILE ("declaration-control-register.galgas", 212)) ;
    GALGAS_bool var_isReadOnly_8038 ;
    switch (select_plm_5F_syntax_29 (inCompiler)) {
    case 1: {
      var_isReadOnly_8038 = GALGAS_bool (false) ;
    } break ;
    case 2: {
      GALGAS_lstring var_attribute_8123 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__40_attribute COMMA_SOURCE_FILE ("declaration-control-register.galgas", 217)) ;
      enumGalgasBool test_8 = kBoolTrue ;
      if (kBoolTrue == test_8) {
        test_8 = GALGAS_bool (kIsNotEqual, var_attribute_8123.getter_string (HERE).objectCompare (GALGAS_string ("ro"))).boolEnum () ;
        if (kBoolTrue == test_8) {
          TC_Array <C_FixItDescription> fixItArray9 ;
          appendFixItActions (fixItArray9, kFixItReplace, GALGAS_string ("@ro")) ;
          inCompiler->emitSemanticError (var_attribute_8123.getter_location (SOURCE_FILE ("declaration-control-register.galgas", 219)), GALGAS_string ("attribute should be @ro"), fixItArray9  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 219)) ;
        }
      }
      var_isReadOnly_8038 = GALGAS_bool (true) ;
    } break ;
    default:
      break ;
    }
    GALGAS_location var_arrayElementSizeExpressionLocation_8335 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 223)) ;
    ioArgument_ioRegisterDeclarationList.addAssign_operation (var_registerName_6705, GALGAS_controlRegisterKind::constructor_registerArray (var_sizeExpression_7425, var_sizeExpressionLocation_7458, var_arrayElementSizeExpression_8005, var_arrayElementSizeExpressionLocation_8335  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 226)), var_isReadOnly_8038, var_baseAddressExpression_7718, var_baseAddressExpressionLocation_7758  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 224)) ;
  } break ;
  default:
    break ;
  }
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_i18_ (GALGAS_ast & ioArgument_ioAST,
                                                                 C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_registers COMMA_SOURCE_FILE ("declaration-control-register.galgas", 243)) ;
  GALGAS_lstring var_attribute_9140 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__40_attribute COMMA_SOURCE_FILE ("declaration-control-register.galgas", 244)) ;
  enumGalgasBool test_0 = kBoolTrue ;
  if (kBoolTrue == test_0) {
    test_0 = GALGAS_bool (kIsNotEqual, var_attribute_9140.getter_string (HERE).objectCompare (function_userAttributeForRegister (inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 245)))).boolEnum () ;
    if (kBoolTrue == test_0) {
      TC_Array <C_FixItDescription> fixItArray1 ;
      inCompiler->emitSemanticError (var_attribute_9140.getter_location (SOURCE_FILE ("declaration-control-register.galgas", 246)), GALGAS_string ("this attribute should be @").add_operation (function_userAttributeForRegister (inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 246)), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 246)), fixItArray1  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 246)) ;
    }
  }
  GALGAS_lstring var_registerGroupName_9331 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("declaration-control-register.galgas", 248)) ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__28_ COMMA_SOURCE_FILE ("declaration-control-register.galgas", 249)) ;
  bool repeatFlag_2 = true ;
  while (repeatFlag_2) {
    GALGAS_lstring var_registerName_9387 = inCompiler->synthetizedAttribute_tokenString () ;
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("declaration-control-register.galgas", 251)) ;
    GALGAS_lstring var_key_9401 = GALGAS_lstring::constructor_new (GALGAS_string ("#").add_operation (var_registerGroupName_9331.getter_string (SOURCE_FILE ("declaration-control-register.galgas", 252)), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 252)).add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 252)).add_operation (var_registerName_9387.getter_string (SOURCE_FILE ("declaration-control-register.galgas", 252)), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 252)), var_registerName_9387.getter_location (HERE)  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 252)) ;
    {
    ioArgument_ioAST.mProperty_mControlRegisterUserAccesMapAST.setter_insertKey (var_key_9401, inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 253)) ;
    }
    switch (select_plm_5F_syntax_30 (inCompiler)) {
    case 2: {
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__2C_ COMMA_SOURCE_FILE ("declaration-control-register.galgas", 255)) ;
    } break ;
    default:
      repeatFlag_2 = false ;
      break ;
  ...
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__29_ COMMA_SOURCE_FILE ("declaration-control-register.galgas", 257)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_staticArrayProperty_i25_ (GALGAS_ast & ioArgument_ioAST,
  ...
  case 1: {
    GALGAS_lstring var_typeName_3180 ;
    nt_type_5F_definition_ (ioArgument_ioAST, var_typeName_3180, inCompiler) ;
    ioArgument_ioPropertyList.addAssign_operation (var_propertyName_3115, GALGAS_staticListPropertyTypeAST::constructor_valueType (var_typeName_3180  COMMA_SOURCE_FILE ("declaration-static-list.galgas", 81))  COMMA_SOURCE_FILE ("declaration-static-list.galgas", 81)) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_func COMMA_SOURCE_FILE ("declaration-static-list.galgas", 83)) ;
    GALGAS_mode var_mode_3289 ;
    nt_mode_ (var_mode_3289, inCompiler) ;
    GALGAS_lstringlist var_attributeList_3322 = GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("declaration-static-list.galgas", 85)) ;
    bool repeatFlag_0 = true ;
    while (repeatFlag_0) {
      switch (select_plm_5F_syntax_40 (inCompiler)) {
      case 2: {
        GALGAS_lstring var_attribute_3388 = inCompiler->synthetizedAttribute_tokenString () ;
        ...
        var_attributeList_3322.addAssign_operation (var_attribute_3388  COMMA_SOURCE_FILE ("declaration-static-list.galgas", 89)) ;
      } break ;
      default:
        repeatFlag_0 = false ;
        break ;
    ...
    GALGAS_routineFormalArgumentListAST var_formalArgs_3493 ;
    nt_procedure_5F_formal_5F_arguments_ (ioArgument_ioAST, var_formalArgs_3493, inCompiler) ;
    GALGAS_lstring var_returnType_3519 ;
    switch (select_plm_5F_syntax_41 (inCompiler)) {
    case 1: {
      var_returnType_3519 = GALGAS_string::makeEmptyString ().getter_here (inCompiler COMMA_SOURCE_FILE ("declaration-static-list.galgas", 94)) ;
    } break ;
    case 2: {
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__2D__3E_ COMMA_SOURCE_FILE ("declaration-static-list.galgas", 96)) ;
      nt_type_5F_definition_ (ioArgument_ioAST, var_returnType_3519, inCompiler) ;
    } break ;
    default:
      break ;
    }
    ioArgument_ioPropertyList.addAssign_operation (var_propertyName_3115, GALGAS_staticListPropertyTypeAST::constructor_function (var_mode_3289, var_formalArgs_3493, var_returnType_3519  COMMA_SOURCE_FILE ("declaration-static-list.galgas", 99))  COMMA_SOURCE_FILE ("declaration-static-list.galgas", 99)) ;
  } break ;
  default:
    break ;
  }
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_i26_ (GALGAS_ast & ioArgument_ioAST,
  ...
  GALGAS_lstring var_staticListName_4130 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    GALGAS_extendStaticListElementAST var_expressions_4195 = GALGAS_extendStaticListElementAST::constructor_emptyList (SOURCE_FILE ("declaration-static-list.galgas", 113)) ;
    bool repeatFlag_1 = true ;
    while (repeatFlag_1) {
      nt_staticArray_5F_exp_ (ioArgument_ioAST, var_expressions_4195, inCompiler) ;
    ...
    GALGAS_staticListValueListAST var_expressionList_4340 = GALGAS_staticListValueListAST::constructor_emptyList (SOURCE_FILE ("declaration-static-list.galgas", 119)) ;
    enumGalgasBool test_2 = kBoolTrue ;
    if (kBoolTrue == test_2) {
      test_2 = ioArgument_ioAST.getter_mExtendStaticArrayDeclarationAST (HERE).getter_hasKey (var_staticListName_4130.getter_string (SOURCE_FILE ("declaration-static-list.galgas", 120)) COMMA_SOURCE_FILE ("declaration-static-list.galgas", 120)).boolEnum () ;
      if (kBoolTrue == test_2) {
        ioArgument_ioAST.getter_mExtendStaticArrayDeclarationAST (HERE).method_searchKey (var_staticListName_4130.getter_string (SOURCE_FILE ("declaration-static-list.galgas", 121)), var_expressionList_4340, inCompiler COMMA_SOURCE_FILE ("declaration-static-list.galgas", 121)) ;
      }
    }
    var_expressionList_4340.addAssign_operation (var_expressions_4195, GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-static-list.galgas", 123))  COMMA_SOURCE_FILE ("declaration-static-list.galgas", 123)) ;
    ioArgument_ioAST.mProperty_mExtendStaticArrayDeclarationAST.addAssign_operation (var_staticListName_4130.getter_string (SOURCE_FILE ("declaration-static-list.galgas", 124)), var_expressionList_4340, inCompiler  COMMA_SOURCE_FILE ("declaration-static-list.galgas", 124)) ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_staticArray_5F_exp_i27_ (GALGAS_ast & ioArgument_ioAST,
  ...
  case 1: {
    GALGAS_expressionAST var_exp_4943 ;
    nt_expression_ (ioArgument_ioAST, var_exp_4943, inCompiler) ;
    ioArgument_ioExpressions.addAssign_operation (GALGAS_extendStaticListExpressionAST::constructor_expression (var_exp_4943  COMMA_SOURCE_FILE ("declaration-static-list.galgas", 136)), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-static-list.galgas", 136))  COMMA_SOURCE_FILE ("declaration-static-list.galgas", 136)) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_func COMMA_SOURCE_FILE ("declaration-static-list.galgas", 138)) ;
    GALGAS_lstring var_functionName_5054 = inCompiler->synthetizedAttribute_tokenString () ;
    ...
    GALGAS_routineFormalArgumentListAST var_formalArgs_5113 ;
    nt_procedure_5F_formal_5F_arguments_ (ioArgument_ioAST, var_formalArgs_5113, inCompiler) ;
    ioArgument_ioExpressions.addAssign_operation (GALGAS_extendStaticListExpressionAST::constructor_function (var_functionName_5054, var_formalArgs_5113  COMMA_SOURCE_FILE ("declaration-static-list.galgas", 142)), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-static-list.galgas", 143))  COMMA_SOURCE_FILE ("declaration-static-list.galgas", 141)) ;
  } break ;
  default:
    break ;
  }
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_primary_i62_ (GALGAS_ast & ioArgument_ioAST,
  ...
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__24_ COMMA_SOURCE_FILE ("expression-addressof-control-register.galgas", 20)) ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__28_ COMMA_SOURCE_FILE ("expression-addressof-control-register.galgas", 21)) ;
  GALGAS_controlRegisterLValueAST var_registerLValue_1153 ;
  nt_control_5F_register_5F_lvalue_ (ioArgument_ioAST, var_registerLValue_1153, inCompiler) ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__29_ COMMA_SOURCE_FILE ("expression-addressof-control-register.galgas", 23)) ;
  outArgument_outExpression = GALGAS_addressofControlRegisterAST::constructor_new (var_registerLValue_1153  COMMA_SOURCE_FILE ("expression-addressof-control-register.galgas", 24)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_primary_i74_ (GALGAS_ast & ioArgument_ioAST,
                                                             ...
                                                             C_Lexique_plm_5F_lexique * inCompiler) {
  outArgument_outExpression.drop () ; // Release 'out' argument
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__24_ COMMA_SOURCE_FILE ("expression-control-register.galgas", 20)) ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__28_ COMMA_SOURCE_FILE ("expression-control-register.galgas", 21)) ;
  GALGAS_controlRegisterLValueAST var_registerLValue_1187 ;
  nt_control_5F_register_5F_lvalue_ (ioArgument_ioAST, var_registerLValue_1187, inCompiler) ;
  GALGAS_lstring var_fieldName_1210 ;
  switch (select_plm_5F_syntax_90 (inCompiler)) {
  case 1: {
    var_fieldName_1210 = GALGAS_string::makeEmptyString ().getter_nowhere (SOURCE_FILE ("expression-control-register.galgas", 25)) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__3A_ COMMA_SOURCE_FILE ("expression-control-register.galgas", 27)) ;
    var_fieldName_1210 = inCompiler->synthetizedAttribute_tokenString () ;
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("expression-control-register.galgas", 28)) ;
  } break ;
  default:
    break ;
  }
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__29_ COMMA_SOURCE_FILE ("expression-control-register.galgas", 30)) ;
  outArgument_outExpression = GALGAS_registerInExpressionAST::constructor_new (var_registerLValue_1187, var_fieldName_1210  COMMA_SOURCE_FILE ("expression-control-register.galgas", 32)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_primary_i75_ (GALGAS_ast & ioArgument_ioAST,
                                                             ...
                                                             C_Lexique_plm_5F_lexique * inCompiler) {
  outArgument_outExpression.drop () ; // Release 'out' argument
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__24_ COMMA_SOURCE_FILE ("expression-register-value-from-slices.galgas", 29)) ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__7B_ COMMA_SOURCE_FILE ("expression-register-value-from-slices.galgas", 30)) ;
  GALGAS_lstring var_registerGroupName_1411 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__3A_ COMMA_SOURCE_FILE ("expression-register-value-from-slices.galgas", 32)) ;
  GALGAS_lstring var_registerName_1454 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("expression-register-value-from-slices.galgas", 33)) ;
  GALGAS_registerIntegerFieldListAST var_integerFieldValues_1506 = GALGAS_registerIntegerFieldListAST::constructor_emptyList (SOURCE_FILE ("expression-register-value-from-slices.galgas", 34)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    GALGAS_lstring var_registerFieldName_1564 = inCompiler->synthetizedAttribute_tokenString () ;
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__21_selector_3A_ COMMA_SOURCE_FILE ("expression-register-value-from-slices.galgas", 36)) ;
    GALGAS_expressionAST var_expression_1607 ;
    nt_expression_ (ioArgument_ioAST, var_expression_1607, inCompiler) ;
    var_integerFieldValues_1506.addAssign_operation (var_registerFieldName_1564, var_expression_1607, GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("expression-register-value-from-slices.galgas", 38))  COMMA_SOURCE_FILE ("expression-register-value-from-slices.galgas", 38)) ;
  ...
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__7D_ COMMA_SOURCE_FILE ("expression-register-value-from-slices.galgas", 41)) ;
  outArgument_outExpression = GALGAS_registerConstantExpressionAST::constructor_new (var_registerGroupName_1411, var_registerName_1454, var_integerFieldValues_1506  COMMA_SOURCE_FILE ("expression-register-value-from-slices.galgas", 42)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_instruction_i84_ (GALGAS_ast & ioArgument_ioAST,
                                                                 GALGAS_instructionListAST & ioArgument_ioInstructionList,
                                                                 C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__24_ COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 28)) ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__28_ COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 29)) ;
  GALGAS_controlRegisterLValueAST var_registerLValue_1531 ;
  nt_control_5F_register_5F_lvalue_ (ioArgument_ioAST, var_registerLValue_1531, inCompiler) ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__29_ COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 31)) ;
  GALGAS_controlRegisterAssignmentOperatorKind var_assignmentKind_1638 ;
  switch (select_plm_5F_syntax_96 (inCompiler)) {
  case 1: {
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__3D_ COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 35)) ;
    var_assignmentKind_1638 = GALGAS_controlRegisterAssignmentOperatorKind::constructor_assignment (SOURCE_FILE ("instruction-assignment-control-register.galgas", 36)) ;
  } break ;
  case 2: {
    GALGAS_infixOperator var_infixOperator_1762 ;
    GALGAS_location var_operatorLocation_1784 ;
    nt_assignment_5F_combined_5F_with_5F_operator_ (var_infixOperator_1762, var_operatorLocation_1784, inCompiler) ;
    var_assignmentKind_1638 = GALGAS_controlRegisterAssignmentOperatorKind::constructor_assignmentWithOperator (var_infixOperator_1762, var_operatorLocation_1784  COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 39)) ;
  } break ;
  default:
    break ;
  }
  ...
  ioArgument_ioInstructionList.addAssign_operation (GALGAS_controlRegisterAssignmentInstructionAST::constructor_new (var_registerLValue_1531.getter_mRegisterGroupName (HERE).getter_location (HERE), var_registerLValue_1531, var_assignmentKind_1638, var_sourceExpression_1977  COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 44))  COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 44)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_instruction_i86_ (GALGAS_ast & ioArgument_ioAST,
                                                                 GALGAS_instructionListAST & ioArgument_ioInstructionList,
                                                                 C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__24_ COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 23)) ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__28_ COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 24)) ;
  GALGAS_controlRegisterLValueAST var_registerLValue_1284 ;
  nt_control_5F_register_5F_lvalue_ (ioArgument_ioAST, var_registerLValue_1284, inCompiler) ;
  GALGAS_lstring var_attribute_1316 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  enumGalgasBool test_0 = kBoolTrue ;
  if (kBoolTrue == test_0) {
    test_0 = GALGAS_bool (kIsNotEqual, var_attribute_1316.getter_string (HERE).objectCompare (GALGAS_string ("bit"))).boolEnum () ;
    if (kBoolTrue == test_0) {
      TC_Array <C_FixItDescription> fixItArray1 ;
      appendFixItActions (fixItArray1, kFixItReplace, GALGAS_string ("@bit")) ;
      inCompiler->emitSemanticError (var_attribute_1316.getter_location (SOURCE_FILE ("instruction-bit-banding.galgas", 28)), GALGAS_string ("attribute should be @bit"), fixItArray1  COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 28)) ;
    }
  }
  GALGAS_expressionAST var_bitExpression_1482 ;
  nt_expression_ (ioArgument_ioAST, var_bitExpression_1482, inCompiler) ;
  GALGAS_location var_bitExpressionLocation_1512 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 31)) ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__29_ COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 32)) ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__3D_ COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 33)) ;
  GALGAS_expressionAST var_sourceExpression_1592 ;
  nt_expression_ (ioArgument_ioAST, var_sourceExpression_1592, inCompiler) ;
  ioArgument_ioInstructionList.addAssign_operation (GALGAS_bitbandInstructionAST::constructor_new (var_registerLValue_1284.getter_mRegisterGroupName (HERE).getter_location (HERE), var_registerLValue_1284, var_bitExpression_1482, var_bitExpressionLocation_1512, var_sourceExpression_1592, GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 42))  COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 36))  COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 36)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_lvalue_5F_operand_i105_ (GALGAS_ast & /* ioArgument_ioAST */,
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_lvalue_5F_operand_i105_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->resetTemplateString () ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_control_5F_register_5F_lvalue_i108_ (GALGAS_ast & ioArgument_ioAST,
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_control_5F_register_5F_lvalue_i108_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("lvalue-control-register.galgas", 35)) ;
  switch (select_plm_5F_syntax_117 (inCompiler)) {
  case 1: {
  } break ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_effective_5F_parameters_i109_ (GALGAS_ast & ioArgument_ioAST,
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_effective_5F_parameters_i109_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__28_ COMMA_SOURCE_FILE ("effective-parameters.galgas", 53)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_plm_5F_syntax_121 (inCompiler)) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_i110_ (GALGAS_ast & ioArgument_ioAST,
                                                                  C_Lexique_plm_5F_lexique * inCompiler) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_i110_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_target COMMA_SOURCE_FILE ("target-generation.galgas", 10)) ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__22_string_22_ COMMA_SOURCE_FILE ("target-generation.galgas", 11)) ;
  inCompiler->resetTemplateString () ;
}
