...
//--- Syntax error message for terminal '$new$' :
static const char * gSyntaxErrorMessage_plm_5F_lexique_new = "the 'new' keyword" ;
...
C_String C_Lexique_plm_5F_lexique::getMessageForTerminal (const int16_t inTerminalIndex) const {
  ...
  if ((inTerminalIndex >= 0) && (inTerminalIndex < 120)) {
    static const char * syntaxErrorMessageArray [120] = {kEndOfSourceLexicalErrorMessage,
        ...
        gSyntaxErrorMessage_plm_5F_lexique_new,
...
//--- Unicode string for '$new$'
static const utf32 kUnicodeString_plm_5F_lexique_new [] = {
  TO_UNICODE ('n'),
  TO_UNICODE ('e'),
  TO_UNICODE ('w'),
  TO_UNICODE (0)
...
static const C_unicode_lexique_table_entry ktable_for_plm_5F_lexique_keyWordList [ktable_size_plm_5F_lexique_keyWordList] = {
  ...
  C_unicode_lexique_table_entry (kUnicodeString_plm_5F_lexique_new, 3, C_Lexique_plm_5F_lexique::kToken_new),
...
GALGAS_stringlist C_Lexique_plm_5F_lexique::symbols (LOCATION_ARGS) {
  ...
  result.addAssign_operation (GALGAS_string ("new") COMMA_THERE) ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_type_5F_definition_i3_ (GALGAS_ast & /* ioArgument_ioAST */,
  ...
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("type-alias.galgas", 35)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_type_5F_definition_i4_ (GALGAS_ast & ioArgument_ioAST,
  ...
  GALGAS_expressionAST var_sizeExpression_1193 ;
  nt_expression_ (ioArgument_ioAST, var_sizeExpression_1193, inCompiler) ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__2022_ COMMA_SOURCE_FILE ("type-static-array.galgas", 24)) ;
  GALGAS_lstring var_elementTypeName_1252 ;
  nt_type_5F_definition_ (ioArgument_ioAST, var_elementTypeName_1252, inCompiler) ;
  ...
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__5D_ COMMA_SOURCE_FILE ("type-static-array.galgas", 27)) ;
  outArgument_outTypeName = GALGAS_string ("anonymous.").add_operation (ioArgument_ioAST.getter_mTypeDeclarationIndex (HERE).getter_string (SOURCE_FILE ("type-static-array.galgas", 28)), inCompiler COMMA_SOURCE_FILE ("type-static-array.galgas", 28)).getter_here (inCompiler COMMA_SOURCE_FILE ("type-static-array.galgas", 28)) ;
  ioArgument_ioAST.mProperty_mTypeDeclarationIndex.increment_operation (inCompiler  COMMA_SOURCE_FILE ("type-static-array.galgas", 29)) ;
  ioArgument_ioAST.mProperty_mDeclarationListAST.addAssign_operation (GALGAS_staticArrayTypeDeclarationAST::constructor_new (outArgument_outTypeName, var_elementTypeName_1252, var_sizeExpression_1193, var_sizeExpressionLocation_1283  COMMA_SOURCE_FILE ("type-static-array.galgas", 30))  COMMA_SOURCE_FILE ("type-static-array.galgas", 30)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_i16_ (GALGAS_ast & ioArgument_ioAST,
  ...
  while (repeatFlag_2) {
    ...
    case 2: {
      ...
      GALGAS_lstring var_registerTypeName_4615 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("declaration-control-register.galgas", 120)) ;
      GALGAS_controlRegisterBitSliceList var_registerBitSliceList_4671 = GALGAS_controlRegisterBitSliceList::constructor_emptyList (SOURCE_FILE ("declaration-control-register.galgas", 121)) ;
      switch (select_plm_5F_syntax_23 (inCompiler)) {
      case 1: {
      } break ;
      case 2: {
        inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__7B_ COMMA_SOURCE_FILE ("declaration-control-register.galgas", 124)) ;
        bool repeatFlag_4 = true ;
        while (repeatFlag_4) {
          GALGAS_controlRegisterBitSlice var_registerBitSlice_4777 ;
          switch (select_plm_5F_syntax_25 (inCompiler)) {
          case 1: {
            GALGAS_lbigint var_unusedBitCount_4845 = inCompiler->synthetizedAttribute_bigInteger () ;
            inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_integer COMMA_SOURCE_FILE ("declaration-control-register.galgas", 128)) ;
            var_registerBitSlice_4777 = GALGAS_controlRegisterBitSlice::constructor_unusedBits (var_unusedBitCount_4845  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 129)) ;
          } break ;
          case 2: {
            GALGAS_lstring var_bitName_4963 = inCompiler->synthetizedAttribute_tokenString () ;
            inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("declaration-control-register.galgas", 131)) ;
            switch (select_plm_5F_syntax_26 (inCompiler)) {
            case 1: {
              var_registerBitSlice_4777 = GALGAS_controlRegisterBitSlice::constructor_namedBit (var_bitName_4963, GALGAS_lbigint::constructor_new (GALGAS_bigint ("1", inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 133)), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 133))  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 133))  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 133)) ;
            } break ;
            case 2: {
              inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__3A_ COMMA_SOURCE_FILE ("declaration-control-register.galgas", 135)) ;
              GALGAS_lbigint var_bitCount_5145 = inCompiler->synthetizedAttribute_bigInteger () ;
              inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_integer COMMA_SOURCE_FILE ("declaration-control-register.galgas", 136)) ;
              var_registerBitSlice_4777 = GALGAS_controlRegisterBitSlice::constructor_namedBit (var_bitName_4963, var_bitCount_5145  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 137)) ;
            } break ;
            default:
              break ;
            }
          ...
          var_registerBitSliceList_4671.addAssign_operation (var_registerBitSlice_4777  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 140)) ;
          switch (select_plm_5F_syntax_24 (inCompiler)) {
          case 2: {
            inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__2C_ COMMA_SOURCE_FILE ("declaration-control-register.galgas", 142)) ;
          } break ;
          default:
            repeatFlag_4 = false ;
            break ;
        ...
        inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__7D_ COMMA_SOURCE_FILE ("declaration-control-register.galgas", 144)) ;
      } break ;
      default:
        break ;
      }
      GALGAS_location var_endOfBitSlice_5388 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 146)) ;
      var_controlRegisterDeclarationList_4359.addAssign_operation (var_registerDeclarationList_4443, var_registerTypeName_4615, var_registerBitSliceList_4671, var_endOfBitSlice_5388  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 147)) ;
    } break ;
    default:
      repeatFlag_2 = false ;
      break ;
  ...
  ioArgument_ioAST.mProperty_mDeclarationListAST.addAssign_operation (GALGAS_controlRegisterGroupDeclarationAST::constructor_new (var_registerGroupListAST_3475, var_controlRegisterDeclarationList_4359  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 149))  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 149)) ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__7D_ COMMA_SOURCE_FILE ("declaration-control-register.galgas", 153)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_registerDeclaration_i17_ (GALGAS_ast & ioArgument_ioAST,
                                                                         ...
                                                                         C_Lexique_plm_5F_lexique * inCompiler) {
  GALGAS_lstring var_registerName_5951 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("declaration-control-register.galgas", 159)) ;
  GALGAS_lstringlist var_attributeList_5982 = GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("declaration-control-register.galgas", 160)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_plm_5F_syntax_27 (inCompiler)) {
    case 2: {
      GALGAS_lstring var_attribute_6042 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__40_attribute COMMA_SOURCE_FILE ("declaration-control-register.galgas", 163)) ;
      var_attributeList_5982.addAssign_operation (var_attribute_6042  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 164)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  case 1: {
    GALGAS_expressionAST var_registerAddress_6143 ;
    nt_expression_ (ioArgument_ioAST, var_registerAddress_6143, inCompiler) ;
    ioArgument_ioRegisterDeclarationList.addAssign_operation (var_registerName_5951, GALGAS_controlRegisterKind::constructor_scalar (SOURCE_FILE ("declaration-control-register.galgas", 170)), var_attributeList_5982, var_registerAddress_6143, GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 173))  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 168)) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__5B_ COMMA_SOURCE_FILE ("declaration-control-register.galgas", 175)) ;
    GALGAS_expressionAST var_sizeExpression_6345 ;
    nt_expression_ (ioArgument_ioAST, var_sizeExpression_6345, inCompiler) ;
    GALGAS_location var_sizeExpressionLocation_6378 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 177)) ;
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__5D_ COMMA_SOURCE_FILE ("declaration-control-register.galgas", 178)) ;
    GALGAS_expressionAST var_baseAddressExpression_6459 ;
    nt_expression_ (ioArgument_ioAST, var_baseAddressExpression_6459, inCompiler) ;
    GALGAS_location var_baseAddressExpressionLocation_6499 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 180)) ;
    GALGAS_lstring var_attribute_6550 = inCompiler->synthetizedAttribute_tokenString () ;
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__40_attribute COMMA_SOURCE_FILE ("declaration-control-register.galgas", 181)) ;
    enumGalgasBool test_1 = kBoolTrue ;
    if (kBoolTrue == test_1) {
      test_1 = GALGAS_bool (kIsNotEqual, var_attribute_6550.getter_string (HERE).objectCompare (GALGAS_string ("inc"))).boolEnum () ;
      if (kBoolTrue == test_1) {
        TC_Array <C_FixItDescription> fixItArray2 ;
        appendFixItActions (fixItArray2, kFixItReplace, GALGAS_string ("@inc")) ;
        inCompiler->emitSemanticError (var_attribute_6550.getter_location (SOURCE_FILE ("declaration-control-register.galgas", 183)), GALGAS_string ("attribute should be @inc"), fixItArray2  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 183)) ;
      }
    }
    GALGAS_expressionAST var_arrayElementSizeExpression_6737 ;
    nt_expression_ (ioArgument_ioAST, var_arrayElementSizeExpression_6737, inCompiler) ;
    GALGAS_location var_arrayElementSizeExpressionLocation_6782 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 186)) ;
    ioArgument_ioRegisterDeclarationList.addAssign_operation (var_registerName_5951, GALGAS_controlRegisterKind::constructor_registerArray (var_sizeExpression_6345, var_sizeExpressionLocation_6378, var_arrayElementSizeExpression_6737, var_arrayElementSizeExpressionLocation_6782  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 189)), var_attributeList_5982, var_baseAddressExpression_6459, var_baseAddressExpressionLocation_6499  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 187)) ;
  } break ;
  default:
    break ;
  }
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_i18_ (GALGAS_ast & ioArgument_ioAST,
                                                                 C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_registers COMMA_SOURCE_FILE ("declaration-control-register.galgas", 204)) ;
  GALGAS_lstring var_attribute_7424 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__40_attribute COMMA_SOURCE_FILE ("declaration-control-register.galgas", 205)) ;
  enumGalgasBool test_0 = kBoolTrue ;
  if (kBoolTrue == test_0) {
    test_0 = GALGAS_bool (kIsNotEqual, var_attribute_7424.getter_string (HERE).objectCompare (function_userAttributeForRegister (inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 206)))).boolEnum () ;
    if (kBoolTrue == test_0) {
      TC_Array <C_FixItDescription> fixItArray1 ;
      inCompiler->emitSemanticError (var_attribute_7424.getter_location (SOURCE_FILE ("declaration-control-register.galgas", 207)), GALGAS_string ("this attribute should be @").add_operation (function_userAttributeForRegister (inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 207)), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 207)), fixItArray1  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 207)) ;
    }
  }
  bool repeatFlag_2 = true ;
  while (repeatFlag_2) {
    GALGAS_lstring var_registerGroupName_7628 = inCompiler->synthetizedAttribute_tokenString () ;
    ...
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__3A_ COMMA_SOURCE_FILE ("declaration-control-register.galgas", 211)) ;
    GALGAS_lstring var_registerName_7675 = inCompiler->synthetizedAttribute_tokenString () ;
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("declaration-control-register.galgas", 212)) ;
    GALGAS_lstring var_key_7689 = GALGAS_lstring::constructor_new (GALGAS_string ("#").add_operation (var_registerGroupName_7628.getter_string (SOURCE_FILE ("declaration-control-register.galgas", 213)), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 213)).add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 213)).add_operation (var_registerName_7675.getter_string (SOURCE_FILE ("declaration-control-register.galgas", 213)), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 213)), var_registerName_7675.getter_location (HERE)  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 213)) ;
    {
    ioArgument_ioAST.mProperty_mControlRegisterUserAccesMapAST.setter_insertKey (var_key_7689, inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 214)) ;
    }
    switch (select_plm_5F_syntax_29 (inCompiler)) {
    case 2: {
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__2C_ COMMA_SOURCE_FILE ("declaration-control-register.galgas", 216)) ;
    } break ;
    default:
      repeatFlag_2 = false ;
      break ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_i26_ (GALGAS_ast & ioArgument_ioAST,
  ...
  while (repeatFlag_0) {
    ...
    enumGalgasBool test_2 = kBoolTrue ;
    if (kBoolTrue == test_2) {
      test_2 = ioArgument_ioAST.getter_mExtendStaticArrayDeclarationAST (HERE).getter_hasKey (var_staticListName_4523.getter_string (SOURCE_FILE ("declaration-static-list.galgas", 131)) COMMA_SOURCE_FILE ("declaration-static-list.galgas", 131)).boolEnum () ;
      if (kBoolTrue == test_2) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_primary_i66_ (GALGAS_ast & ioArgument_ioAST,
                                                             ...
                                                             C_Lexique_plm_5F_lexique * inCompiler) {
  outArgument_outExpression.drop () ; // Release 'out' argument
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_new COMMA_SOURCE_FILE ("expression-constructor-call.galgas", 25)) ;
  GALGAS_lstring var_typeName_1246 ;
  nt_type_5F_definition_ (ioArgument_ioAST, var_typeName_1246, inCompiler) ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__28_ COMMA_SOURCE_FILE ("expression-constructor-call.galgas", 27)) ;
  GALGAS_functionCallEffectiveParameterListAST var_parameterList_1311 = GALGAS_functionCallEffectiveParameterListAST::constructor_emptyList (SOURCE_FILE ("expression-constructor-call.galgas", 28)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_plm_5F_syntax_87 (inCompiler)) {
    case 2: {
      GALGAS_lstring var_selector_1370 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__21_selector_3A_ COMMA_SOURCE_FILE ("expression-constructor-call.galgas", 31)) ;
      GALGAS_expressionAST var_expression_1413 ;
      nt_expression_ (ioArgument_ioAST, var_expression_1413, inCompiler) ;
      var_parameterList_1311.addAssign_operation (var_selector_1370, var_expression_1413  COMMA_SOURCE_FILE ("expression-constructor-call.galgas", 33)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  GALGAS_location var_errorLocation_1488 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("expression-constructor-call.galgas", 35)) ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__29_ COMMA_SOURCE_FILE ("expression-constructor-call.galgas", 36)) ;
  outArgument_outExpression = GALGAS_constructorCallAST::constructor_new (var_typeName_1246, var_parameterList_1311, var_errorLocation_1488  COMMA_SOURCE_FILE ("expression-constructor-call.galgas", 37)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_primary_i67_ (GALGAS_ast & ioArgument_ioAST,
  ...
  case 2: {
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__3A_ COMMA_SOURCE_FILE ("expression-typed-constant.galgas", 24)) ;
    nt_type_5F_definition_ (ioArgument_ioAST, var_optionalTypeName_1126, inCompiler) ;
  } break ;
  default:
    break ;
  }
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__2E_ COMMA_SOURCE_FILE ("expression-typed-constant.galgas", 27)) ;
  GALGAS_lstring var_constantName_1302 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("expression-typed-constant.galgas", 28)) ;
  GALGAS_primaryInExpressionAccessListAST var_accessList_1384 ;
  nt_expression_5F_access_5F_list_ (ioArgument_ioAST, var_accessList_1384, inCompiler) ;
  outArgument_outExpression = GALGAS_typedConstantCallAST::constructor_new (var_optionalTypeName_1126, var_constantName_1302, var_accessList_1384  COMMA_SOURCE_FILE ("expression-typed-constant.galgas", 32)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_expression_5F_access_5F_list_i79_ (GALGAS_ast & ioArgument_ioAST,
  ...
  while (repeatFlag_0) {
    ...
    case 2: {
      ...
      case 1: {
        outArgument_outAccessList.addAssign_operation (GALGAS_primaryInExpressionAccessAST::constructor_property (var_propertyName_2613  COMMA_SOURCE_FILE ("expression-primary.galgas", 61))  COMMA_SOURCE_FILE ("expression-primary.galgas", 61)) ;
      } break ;
      case 2: {
        GALGAS_effectiveArgumentListAST var_arguments_2746 ;
        GALGAS_location var_endOfArguments_2766 ;
        nt_effective_5F_parameters_ (ioArgument_ioAST, var_arguments_2746, var_endOfArguments_2766, inCompiler) ;
        outArgument_outAccessList.addAssign_operation (GALGAS_primaryInExpressionAccessAST::constructor_funcCall (var_propertyName_2613, var_arguments_2746, var_endOfArguments_2766  COMMA_SOURCE_FILE ("expression-primary.galgas", 64))  COMMA_SOURCE_FILE ("expression-primary.galgas", 64)) ;
      } break ;
      default:
        break ;
      }
    ...
    case 3: {
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__5B_ COMMA_SOURCE_FILE ("expression-primary.galgas", 67)) ;
      GALGAS_lbigint var_low_2936 = inCompiler->synthetizedAttribute_bigInteger () ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_integer COMMA_SOURCE_FILE ("expression-primary.galgas", 68)) ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__2E__2E__2E_ COMMA_SOURCE_FILE ("expression-primary.galgas", 69)) ;
      GALGAS_lbigint var_high_2974 = inCompiler->synthetizedAttribute_bigInteger () ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_integer COMMA_SOURCE_FILE ("expression-primary.galgas", 70)) ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__5D_ COMMA_SOURCE_FILE ("expression-primary.galgas", 71)) ;
      outArgument_outAccessList.addAssign_operation (GALGAS_primaryInExpressionAccessAST::constructor_integerSlice (var_low_2936, var_high_2974  COMMA_SOURCE_FILE ("expression-primary.galgas", 72))  COMMA_SOURCE_FILE ("expression-primary.galgas", 72)) ;
    } break ;
    case 4: {
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__5B_ COMMA_SOURCE_FILE ("expression-primary.galgas", 74)) ;
      GALGAS_expressionAST var_expression_3107 ;
      nt_expression_ (ioArgument_ioAST, var_expression_3107, inCompiler) ;
      GALGAS_location var_endOfIndex_3128 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("expression-primary.galgas", 76)) ;
      GALGAS_bool var_checkIndexExpression_3178 ;
      switch (select_plm_5F_syntax_95 (inCompiler)) {
      case 1: {
        inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__5D_ COMMA_SOURCE_FILE ("expression-primary.galgas", 79)) ;
        var_checkIndexExpression_3178 = GALGAS_bool (true) ;
      } break ;
      case 2: {
        inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__5D__21_ COMMA_SOURCE_FILE ("expression-primary.galgas", 82)) ;
        var_checkIndexExpression_3178 = GALGAS_bool (false) ;
      } break ;
      default:
        break ;
      }
      outArgument_outAccessList.addAssign_operation (GALGAS_primaryInExpressionAccessAST::constructor_arrayAccess (var_expression_3107, var_endOfIndex_3128, var_checkIndexExpression_3178  COMMA_SOURCE_FILE ("expression-primary.galgas", 85))  COMMA_SOURCE_FILE ("expression-primary.galgas", 85)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_expression_5F_access_5F_list_i79_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_plm_5F_syntax_93 (inCompiler)) {
    case 2: {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_if_5F_instruction_i96_ (GALGAS_ast & ioArgument_ioAST,
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_if_5F_instruction_i96_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_if COMMA_SOURCE_FILE ("instruction-if.galgas", 32)) ;
  switch (select_plm_5F_syntax_105 (inCompiler)) {
  case 1: {
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__40_attribute COMMA_SOURCE_FILE ("instruction-if.galgas", 36)) ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_guarded_5F_command_i98_ (GALGAS_ast & ioArgument_ioAST,
                                                                        GALGAS_guardedCommandAST & outArgument_outGuardedCommand,
                                                                        C_Lexique_plm_5F_lexique * inCompiler) {
  outArgument_outGuardedCommand.drop () ; // Release 'out' argument
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_guarded_5F_command_i98_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_on COMMA_SOURCE_FILE ("instruction-sync.galgas", 95)) ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__28_ COMMA_SOURCE_FILE ("instruction-sync.galgas", 96)) ;
  nt_expression_parse (inCompiler) ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__29_ COMMA_SOURCE_FILE ("instruction-sync.galgas", 99)) ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_procedure_5F_call_i104_ (GALGAS_ast & ioArgument_ioAST,
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_procedure_5F_call_i104_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  nt_lvalue_parse (inCompiler) ;
  nt_effective_5F_parameters_parse (inCompiler) ;
  inCompiler->resetTemplateString () ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_instruction_i105_ (GALGAS_ast & ioArgument_ioAST,
                                                                  GALGAS_instructionListAST & ioArgument_ioInstructionList,
                                                                  C_Lexique_plm_5F_lexique * inCompiler) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_instruction_i105_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_switch COMMA_SOURCE_FILE ("instruction-switch.galgas", 28)) ;
  nt_expression_parse (inCompiler) ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__7B_ COMMA_SOURCE_FILE ("instruction-switch.galgas", 32)) ;
  bool repeatFlag_0 = true ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_lvalue_i106_ (GALGAS_ast & ioArgument_ioAST,
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_lvalue_i106_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  switch (select_plm_5F_syntax_118 (inCompiler)) {
  case 1: {
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("lvalue.galgas", 43)) ;
  } break ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_lvalue_5F_operand_i109_ (GALGAS_ast & ioArgument_ioAST,
                                                                        GALGAS_LValueOperandAST & outArgument_outOperand,
                                                                        C_Lexique_plm_5F_lexique * inCompiler) {
  outArgument_outOperand.drop () ; // Release 'out' argument
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_lvalue_5F_operand_i109_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__5B_ COMMA_SOURCE_FILE ("lvalue.galgas", 70)) ;
  nt_expression_parse (inCompiler) ;
  switch (select_plm_5F_syntax_119 (inCompiler)) {
  case 1: {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_control_5F_register_5F_lvalue_i110_ (GALGAS_ast & ioArgument_ioAST,
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_control_5F_register_5F_lvalue_i110_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__23_groupName COMMA_SOURCE_FILE ("lvalue-control-register.galgas", 35)) ;
  switch (select_plm_5F_syntax_120 (inCompiler)) {
  case 1: {
  } break ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_effective_5F_parameters_i111_ (GALGAS_ast & ioArgument_ioAST,
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_effective_5F_parameters_i111_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__28_ COMMA_SOURCE_FILE ("effective-parameters.galgas", 53)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_plm_5F_syntax_124 (inCompiler)) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_i113_ (GALGAS_ast & ioArgument_ioAST,
                                                                  C_Lexique_plm_5F_lexique * inCompiler) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_i113_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_check COMMA_SOURCE_FILE ("declaration-check-target.galgas", 10)) ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_target COMMA_SOURCE_FILE ("declaration-check-target.galgas", 11)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
