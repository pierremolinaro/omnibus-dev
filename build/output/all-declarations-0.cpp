...
typeComparisonResult cPtr_basicTypeGraphNodeDeclarationAST::dynamicObjectCompare (const acPtr_class * /* inOperandPtr */) const {
...
typeComparisonResult GALGAS_basicTypeGraphNodeDeclarationAST::objectCompare (const GALGAS_basicTypeGraphNodeDeclarationAST & inOperand) const {
  typeComparisonResult result = kOperandNotValid ;
  if (isValid () && inOperand.isValid ()) {
    const int32_t mySlot = mObjectPtr->classDescriptor ()->mSlotID ;
    const int32_t operandSlot = inOperand.mObjectPtr->classDescriptor ()->mSlotID ;
...
GALGAS_basicTypeGraphNodeDeclarationAST::GALGAS_basicTypeGraphNodeDeclarationAST (void) :
GALGAS_abstractDeclarationAST () {
}

//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*

GALGAS_basicTypeGraphNodeDeclarationAST GALGAS_basicTypeGraphNodeDeclarationAST::constructor_default (LOCATION_ARGS) {
  return GALGAS_basicTypeGraphNodeDeclarationAST::constructor_new (THERE) ;
}

//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*

GALGAS_basicTypeGraphNodeDeclarationAST::GALGAS_basicTypeGraphNodeDeclarationAST (const cPtr_basicTypeGraphNodeDeclarationAST * inSourcePtr) :
GALGAS_abstractDeclarationAST (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, cPtr_basicTypeGraphNodeDeclarationAST) ;
}

//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*

GALGAS_basicTypeGraphNodeDeclarationAST GALGAS_basicTypeGraphNodeDeclarationAST::constructor_new (LOCATION_ARGS) {
  GALGAS_basicTypeGraphNodeDeclarationAST result ;
  macroMyNew (result.mObjectPtr, cPtr_basicTypeGraphNodeDeclarationAST (THERE)) ;
  return result ;
}
...
cPtr_basicTypeGraphNodeDeclarationAST::cPtr_basicTypeGraphNodeDeclarationAST (LOCATION_ARGS) :
cPtr_abstractDeclarationAST (THERE) {
}

//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*

const C_galgas_type_descriptor * cPtr_basicTypeGraphNodeDeclarationAST::classDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_basicTypeGraphNodeDeclarationAST ;
}

void cPtr_basicTypeGraphNodeDeclarationAST::description (C_String & ioString,
                                                         const int32_t /* inIndentation */) const {
  ioString << "[@basicTypeGraphNodeDeclarationAST]" ;
}

//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*

acPtr_class * cPtr_basicTypeGraphNodeDeclarationAST::duplicate (LOCATION_ARGS) const {
  acPtr_class * ptr = NULL ;
  macroMyNew (ptr, cPtr_basicTypeGraphNodeDeclarationAST (THERE)) ;
  return ptr ;
}
...
//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*
//                                                                                                                     *
//                                       @basicTypeGraphNodeDeclarationAST type                                        *
//                                                                                                                     *
//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*

const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_basicTypeGraphNodeDeclarationAST ("basicTypeGraphNodeDeclarationAST",
                                                         & kTypeDescriptor_GALGAS_abstractDeclarationAST) ;

//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*

const C_galgas_type_descriptor * GALGAS_basicTypeGraphNodeDeclarationAST::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_basicTypeGraphNodeDeclarationAST ;
}

//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*

AC_GALGAS_root * GALGAS_basicTypeGraphNodeDeclarationAST::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_basicTypeGraphNodeDeclarationAST (*this)) ;
  }
  return result ;
}
...
GALGAS_basicTypeGraphNodeDeclarationAST GALGAS_basicTypeGraphNodeDeclarationAST::extractObject (const GALGAS_object & inObject,
                                                                                                C_Compiler * inCompiler
                                                                                                COMMA_LOCATION_ARGS) {
  GALGAS_basicTypeGraphNodeDeclarationAST result ;
  const GALGAS_basicTypeGraphNodeDeclarationAST * p = (const GALGAS_basicTypeGraphNodeDeclarationAST *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_basicTypeGraphNodeDeclarationAST *> (p)) {
      result = *p ;
    }else{
      inCompiler->castError ("basicTypeGraphNodeDeclarationAST", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
static TC_UniqueArray <enterExtensionGetter_basicTypeGraphNodeDeclarationAST_typeName> gExtensionGetterTable_basicTypeGraphNodeDeclarationAST_typeName ;
...
void enterExtensionGetter_typeName (const int32_t inClassIndex,
  ...
  gExtensionGetterTable_basicTypeGraphNodeDeclarationAST_typeName.forceObjectAtIndex (inClassIndex, inGetter, NULL COMMA_HERE) ;
}

//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*

GALGAS_string callExtensionGetter_typeName (const cPtr_basicTypeGraphNodeDeclarationAST * inObject,
                                            C_Compiler * inCompiler
                                            COMMA_LOCATION_ARGS) {
  GALGAS_string result ;
//--- Find Reader
  if (NULL != inObject) {
    macroValidSharedObject (inObject, cPtr_basicTypeGraphNodeDeclarationAST) ;
    const C_galgas_type_descriptor * info = inObject->classDescriptor () ;
    const int32_t classIndex = info->mSlotID ;
    enterExtensionGetter_basicTypeGraphNodeDeclarationAST_typeName f = NULL ;
    if (classIndex < gExtensionGetterTable_basicTypeGraphNodeDeclarationAST_typeName.count ()) {
      f = gExtensionGetterTable_basicTypeGraphNodeDeclarationAST_typeName (classIndex COMMA_HERE) ;
    }
    if (NULL == f) {
       const C_galgas_type_descriptor * p = info->mSuperclassDescriptor ;
       while ((NULL == f) && (NULL != p)) {
         if (p->mSlotID < gExtensionGetterTable_basicTypeGraphNodeDeclarationAST_typeName.count ()) {
           f = gExtensionGetterTable_basicTypeGraphNodeDeclarationAST_typeName (p->mSlotID COMMA_HERE) ;
         }
         p = p->mSuperclassDescriptor ;
       }
       gExtensionGetterTable_basicTypeGraphNodeDeclarationAST_typeName.forceObjectAtIndex (classIndex, f, NULL COMMA_HERE) ;
    }
    if (NULL == f) {
...
static GALGAS_string extensionGetter_basicTypeGraphNodeDeclarationAST_typeName (const cPtr_basicTypeGraphNodeDeclarationAST * /* inObject */,
                                                                                C_Compiler * /* inCompiler */
                                                                                COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_outName ; // Returned variable
  result_outName = GALGAS_string ("BASIC TYPE") ;
//---
...
static void defineExtensionGetter_basicTypeGraphNodeDeclarationAST_typeName (void) {
  enterExtensionGetter_typeName (kTypeDescriptor_GALGAS_basicTypeGraphNodeDeclarationAST.mSlotID,
                                 extensionGetter_basicTypeGraphNodeDeclarationAST_typeName) ;
}

//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*

static void freeExtensionGetter_basicTypeGraphNodeDeclarationAST_typeName (void) {
  gExtensionGetterTable_basicTypeGraphNodeDeclarationAST_typeName.free () ;
}

//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*

C_PrologueEpilogue gGetter_basicTypeGraphNodeDeclarationAST_typeName (defineExtensionGetter_basicTypeGraphNodeDeclarationAST_typeName,
                                                                      freeExtensionGetter_basicTypeGraphNodeDeclarationAST_typeName) ;
