...
//--- Syntax error message for terminal '$svc$' :
static const char * gSyntaxErrorMessage_plm_5F_lexique_svc = "the 'svc' keyword" ;
...
C_String C_Lexique_plm_5F_lexique::getMessageForTerminal (const int16_t inTerminalIndex) const {
  static const char * syntaxErrorMessageArray [114] = {kEndOfSourceLexicalErrorMessage,
    ...
    gSyntaxErrorMessage_plm_5F_lexique_svc,
...
//--- Unicode string for '$svc$'
static const utf32 kUnicodeString_plm_5F_lexique_svc [] = {
  TO_UNICODE ('s'),
  TO_UNICODE ('v'),
  TO_UNICODE ('c'),
  TO_UNICODE (0)
...
static const C_unicode_lexique_table_entry ktable_for_plm_5F_lexique_keyWordList [ktable_size_plm_5F_lexique_keyWordList] = {
  ...
  C_unicode_lexique_table_entry (kUnicodeString_plm_5F_lexique_svc, 3, C_Lexique_plm_5F_lexique::kToken_svc),
...
GALGAS_stringlist C_Lexique_plm_5F_lexique::symbols (LOCATION_ARGS) {
  ...
  result.addAssign_operation (GALGAS_string ("svc") COMMA_THERE) ;
...
//--- Constructor
  public : cCollectionElement_extensionDeclarationListAST (const GALGAS_lstring & in_mTypeName,
                                                           ...
                                                           const GALGAS_svcDeclarationListAST & in_mSectionListAST,
...
GALGAS_extensionDeclarationListAST GALGAS_extensionDeclarationListAST::constructor_listWithValue (const GALGAS_lstring & inOperand0,
                                                                                                  ...
                                                                                                  const GALGAS_svcDeclarationListAST & inOperand4,
...
void GALGAS_extensionDeclarationListAST::setter_removeAtIndex (GALGAS_lstring & outOperand0,
                                                               ...
                                                               GALGAS_svcDeclarationListAST & outOperand4,
...
GALGAS_svcDeclarationListAST GALGAS_extensionDeclarationListAST::getter_mSectionListASTAtIndex (const GALGAS_uint & inIndex,
                                                                                                C_Compiler * inCompiler
                                                                                                COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_extensionDeclarationListAST * p = (cCollectionElement_extensionDeclarationListAST *) attributes.ptr () ;
...
GALGAS_svcDeclarationListAST cEnumerator_extensionDeclarationListAST::current_mSectionListAST (LOCATION_ARGS) const {
  const cCollectionElement_extensionDeclarationListAST * p = (const cCollectionElement_extensionDeclarationListAST *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, cCollectionElement_extensionDeclarationListAST) ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_import_5F_file_i0_ (GALGAS_lstringlist & ioArgument_ioImportedFileList,
  ...
  GALGAS_lstring var_importedFile_989 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  ioArgument_ioImportedFileList.addAssign_operation (var_importedFile_989  COMMA_SOURCE_FILE ("syntax-grammar.galgas", 22)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_importedFile_989.mAttribute_string.getter_pathExtension (SOURCE_FILE ("syntax-grammar.galgas", 23)).objectCompare (GALGAS_string ("plm"))).boolEnum () ;
  if (kBoolTrue == test_0) {
    TC_Array <C_FixItDescription> fixItArray1 ;
    inCompiler->emitSemanticError (var_importedFile_989.getter_location (SOURCE_FILE ("syntax-grammar.galgas", 24)), GALGAS_string ("the pah extension should be .plm"), fixItArray1  COMMA_SOURCE_FILE ("syntax-grammar.galgas", 24)) ;
  }
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_5F_struct_5F_var_i5_ (GALGAS_structurePropertyListAST & ioArgument_ioFieldListAST,
                                                                                 C_Lexique_plm_5F_lexique * inCompiler) {
  GALGAS_bool var_public_2092 ;
  switch (select_plm_5F_syntax_2 (inCompiler)) {
  case 1: {
    var_public_2092 = GALGAS_bool (false) ;
  } break ;
  case 2: {
    ...
    var_public_2092 = GALGAS_bool (true) ;
  } break ;
  default:
    break ;
  }
  ...
  GALGAS_lstring var_fieldName_2216 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  case 1: {
    ...
    case 1: {
      ioArgument_ioFieldListAST.addAssign_operation (var_fieldName_2216, var_public_2092, var_typeName_2256, GALGAS_structureVarInit::constructor_noExpression (SOURCE_FILE ("type-structure-declaration.galgas", 59))  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 59)) ;
    } break ;
    case 2: {
      ...
      ioArgument_ioFieldListAST.addAssign_operation (var_fieldName_2216, var_public_2092, var_typeName_2256, GALGAS_structureVarInit::constructor_expression (var_initExpression_2401  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 63))  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 63)) ;
    } break ;
    default:
      break ;
    }
  ...
  case 2: {
    ...
    ioArgument_ioFieldListAST.addAssign_operation (var_fieldName_2216, var_public_2092, GALGAS_string::makeEmptyString ().getter_nowhere (SOURCE_FILE ("type-structure-declaration.galgas", 68)), GALGAS_structureVarInit::constructor_expression (var_initExpression_2567  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 68))  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 68)) ;
  } break ;
  default:
    break ;
  }
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_i6_ (GALGAS_ast & ioArgument_ioAST,
  ...
  GALGAS_lstring var_structureName_2885 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GALGAS_lstringlist var_attributeList_2916 = GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("type-structure-declaration.galgas", 77)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_plm_5F_syntax_5 (inCompiler)) {
    case 2: {
      GALGAS_lstring var_attribute_2976 = inCompiler->synthetizedAttribute_tokenString () ;
      ...
      var_attributeList_2916.addAssign_operation (var_attribute_2976  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 81)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  GALGAS_functionDeclarationListAST var_procedureDeclarationListAST_3087 = GALGAS_functionDeclarationListAST::constructor_emptyList (SOURCE_FILE ("type-structure-declaration.galgas", 84)) ;
  GALGAS_structurePropertyListAST var_fieldList_3132 = GALGAS_structurePropertyListAST::constructor_emptyList (SOURCE_FILE ("type-structure-declaration.galgas", 85)) ;
  GALGAS_serviceDeclarationListAST var_serviceListAST_3183 = GALGAS_serviceDeclarationListAST::constructor_emptyList (SOURCE_FILE ("type-structure-declaration.galgas", 86)) ;
  GALGAS_svcDeclarationListAST var_svcListAST_3226 = GALGAS_svcDeclarationListAST::constructor_emptyList (SOURCE_FILE ("type-structure-declaration.galgas", 87)) ;
  ...
  while (repeatFlag_1) {
    ...
    case 2: {
      nt_declaration_5F_struct_5F_var_ (var_fieldList_3132, inCompiler) ;
    } break ;
    case 3: {
      nt_function_ (var_procedureDeclarationListAST_3087, inCompiler) ;
    } break ;
    case 4: {
      nt_section_ (var_svcListAST_3226, inCompiler) ;
    } break ;
    case 5: {
      nt_service_ (var_serviceListAST_3183, inCompiler) ;
    } break ;
    case 6: {
  ...
  ioArgument_ioAST.mAttribute_mDeclarationList.addAssign_operation (GALGAS_structureDeclaration::constructor_new (var_structureName_2885, var_attributeList_2916, var_fieldList_3132, var_procedureDeclarationListAST_3087, var_serviceListAST_3183, var_svcListAST_3226, var_primitiveListAST_3281, var_guardListAST_3328  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 107))  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 107)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_i8_ (GALGAS_ast & ioArgument_ioAST,
  ...
  GALGAS_lstring var_typeName_1295 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GALGAS_functionDeclarationListAST var_procedureDeclarationListAST_1363 = GALGAS_functionDeclarationListAST::constructor_emptyList (SOURCE_FILE ("type-extension-declaration.galgas", 27)) ;
  GALGAS_structurePropertyListAST var_propertyList_1411 = GALGAS_structurePropertyListAST::constructor_emptyList (SOURCE_FILE ("type-extension-declaration.galgas", 28)) ;
  GALGAS_serviceDeclarationListAST var_serviceListAST_1462 = GALGAS_serviceDeclarationListAST::constructor_emptyList (SOURCE_FILE ("type-extension-declaration.galgas", 29)) ;
  GALGAS_svcDeclarationListAST var_sectionListAST_1509 = GALGAS_svcDeclarationListAST::constructor_emptyList (SOURCE_FILE ("type-extension-declaration.galgas", 30)) ;
  GALGAS_primitiveDeclarationListAST var_primitiveListAST_1564 = GALGAS_primitiveDeclarationListAST::constructor_emptyList (SOURCE_FILE ("type-extension-declaration.galgas", 31)) ;
  GALGAS_guardDeclarationListAST var_guardListAST_1611 = GALGAS_guardDeclarationListAST::constructor_emptyList (SOURCE_FILE ("type-extension-declaration.galgas", 32)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_plm_5F_syntax_7 (inCompiler)) {
    case 2: {
      nt_property_5F_in_5F_extension_ (var_propertyList_1411, inCompiler) ;
    } break ;
    case 3: {
      nt_function_ (var_procedureDeclarationListAST_1363, inCompiler) ;
    } break ;
    case 4: {
      nt_section_ (var_sectionListAST_1509, inCompiler) ;
    } break ;
    case 5: {
      nt_service_ (var_serviceListAST_1462, inCompiler) ;
    } break ;
    case 6: {
      nt_guard_ (var_guardListAST_1611, inCompiler) ;
    } break ;
    case 7: {
      nt_primitive_ (var_primitiveListAST_1564, inCompiler) ;
    } break ;
    case 8: {
  ...
  ioArgument_ioAST.mAttribute_mExtensionDeclarationListAST.addAssign_operation (var_typeName_1295, var_procedureDeclarationListAST_1363, var_propertyList_1411, var_serviceListAST_1462, var_sectionListAST_1509, var_primitiveListAST_1564, var_guardListAST_1611  COMMA_SOURCE_FILE ("type-extension-declaration.galgas", 50)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_property_5F_in_5F_extension_i9_ (GALGAS_structurePropertyListAST & ioArgument_ioPropertyList,
                                                                                C_Lexique_plm_5F_lexique * inCompiler) {
  GALGAS_bool var_public_2367 ;
  switch (select_plm_5F_syntax_8 (inCompiler)) {
  case 1: {
    var_public_2367 = GALGAS_bool (false) ;
  } break ;
  case 2: {
    ...
    var_public_2367 = GALGAS_bool (true) ;
  } break ;
  default:
    break ;
  }
  ...
  GALGAS_lstring var_fieldName_2491 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GALGAS_lstring var_typeName_2518 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GALGAS_expressionAST var_initExpression_2563 ;
  nt_expression_ (var_initExpression_2563, inCompiler) ;
  ioArgument_ioPropertyList.addAssign_operation (var_fieldName_2491, var_public_2367, var_typeName_2518, GALGAS_structureVarInit::constructor_expression (var_initExpression_2563  COMMA_SOURCE_FILE ("type-extension-declaration.galgas", 75))  COMMA_SOURCE_FILE ("type-extension-declaration.galgas", 75)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_i13_ (GALGAS_ast & ioArgument_ioAST,
  ...
  ioArgument_ioAST.mAttribute_mGlobalVarDeclarationList.addAssign_operation (var_typeName_2672, var_varName_2650, var_expression_2809, GALGAS_bool (true)  COMMA_SOURCE_FILE ("declaration-global-variable.galgas", 103)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_i15_ (GALGAS_ast & ioArgument_ioAST,
  ...
  GALGAS_svcDeclarationListAST var_sectionListAST_1922 = GALGAS_svcDeclarationListAST::constructor_emptyList (SOURCE_FILE ("declaration-module.galgas", 43)) ;
  GALGAS_initList var_initList_1950 = GALGAS_initList::constructor_emptySortedList (SOURCE_FILE ("declaration-module.galgas", 44)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_plm_5F_syntax_20 (inCompiler)) {
    case 2: {
      nt_declaration_5F_init_ (var_initList_1950, inCompiler) ;
    } break ;
    case 3: {
    ...
    case 5: {
      nt_function_ (var_functionDeclarationListAST_1677, inCompiler) ;
    } break ;
    case 6: {
      nt_service_ (var_serviceListAST_1773, inCompiler) ;
    } break ;
    case 7: {
      nt_section_ (var_sectionListAST_1922, inCompiler) ;
    } break ;
    case 8: {
  ...
  GALGAS_lstringlist var_requiredByList_2466 = GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("declaration-module.galgas", 67)) ;
  cEnumerator_functionDeclarationListAST enumerator_2518 (var_functionDeclarationListAST_1677, kEnumeration_up) ;
  while (enumerator_2518.hasCurrentObject ()) {
    const enumGalgasBool test_1 = enumerator_2518.current (HERE).mAttribute_mPublicFunction.boolEnum () ;
    if (kBoolTrue == test_1) {
      GALGAS_lstring var_routineMangledName_2591 = GALGAS_lstring::constructor_new (GALGAS_string ("$").add_operation (var_moduleTypeName_1547.getter_string (SOURCE_FILE ("declaration-module.galgas", 71)), inCompiler COMMA_SOURCE_FILE ("declaration-module.galgas", 71)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("declaration-module.galgas", 71)).add_operation (enumerator_2518.current (HERE).mAttribute_mFunctionName.getter_string (SOURCE_FILE ("declaration-module.galgas", 71)), inCompiler COMMA_SOURCE_FILE ("declaration-module.galgas", 71)), enumerator_2518.current (HERE).mAttribute_mFunctionName.mAttribute_location  COMMA_SOURCE_FILE ("declaration-module.galgas", 70)) ;
      var_routineMangledName_2591.mAttribute_string.plusAssign_operation(GALGAS_string ("("), inCompiler  COMMA_SOURCE_FILE ("declaration-module.galgas", 74)) ;
      cEnumerator_procFormalArgumentList enumerator_2844 (enumerator_2518.current (HERE).mAttribute_mFunctionFormalArgumentList, kEnumeration_up) ;
      while (enumerator_2844.hasCurrentObject ()) {
        var_routineMangledName_2591.mAttribute_string.plusAssign_operation(extensionGetter_formalPassingModeString (enumerator_2844.current_mFormalArgumentPassingMode (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-module.galgas", 76)), inCompiler  COMMA_SOURCE_FILE ("declaration-module.galgas", 76)) ;
        var_routineMangledName_2591.mAttribute_string.plusAssign_operation(enumerator_2844.current_mSelector (HERE).mAttribute_string, inCompiler  COMMA_SOURCE_FILE ("declaration-module.galgas", 77)) ;
        var_routineMangledName_2591.mAttribute_string.plusAssign_operation(GALGAS_string (":"), inCompiler  COMMA_SOURCE_FILE ("declaration-module.galgas", 78)) ;
        enumerator_2844.gotoNextObject () ;
      }
      var_routineMangledName_2591.mAttribute_string.plusAssign_operation(GALGAS_string (")"), inCompiler  COMMA_SOURCE_FILE ("declaration-module.galgas", 80)) ;
      var_requiredByList_2466.addAssign_operation (var_routineMangledName_2591  COMMA_SOURCE_FILE ("declaration-module.galgas", 81)) ;
    }
    enumerator_2518.gotoNextObject () ;
  }
  cEnumerator_serviceDeclarationListAST enumerator_3173 (var_serviceListAST_1773, kEnumeration_up) ;
  while (enumerator_3173.hasCurrentObject ()) {
    GALGAS_lstring var_routineMangledName_3205 = GALGAS_lstring::constructor_new (GALGAS_string ("$").add_operation (var_moduleTypeName_1547.getter_string (SOURCE_FILE ("declaration-module.galgas", 86)), inCompiler COMMA_SOURCE_FILE ("declaration-module.galgas", 86)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("declaration-module.galgas", 86)).add_operation (enumerator_3173.current (HERE).mAttribute_mServiceName.getter_string (SOURCE_FILE ("declaration-module.galgas", 86)), inCompiler COMMA_SOURCE_FILE ("declaration-module.galgas", 86)), enumerator_3173.current (HERE).mAttribute_mServiceName.mAttribute_location  COMMA_SOURCE_FILE ("declaration-module.galgas", 85)) ;
    var_routineMangledName_3205.mAttribute_string.plusAssign_operation(GALGAS_string ("("), inCompiler  COMMA_SOURCE_FILE ("declaration-module.galgas", 89)) ;
    cEnumerator_procFormalArgumentList enumerator_3442 (enumerator_3173.current (HERE).mAttribute_mServiceFormalArgumentList, kEnumeration_up) ;
    while (enumerator_3442.hasCurrentObject ()) {
      var_routineMangledName_3205.mAttribute_string.plusAssign_operation(extensionGetter_formalPassingModeString (enumerator_3442.current_mFormalArgumentPassingMode (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-module.galgas", 91)), inCompiler  COMMA_SOURCE_FILE ("declaration-module.galgas", 91)) ;
      var_routineMangledName_3205.mAttribute_string.plusAssign_operation(enumerator_3442.current_mSelector (HERE).mAttribute_string, inCompiler  COMMA_SOURCE_FILE ("declaration-module.galgas", 92)) ;
      var_routineMangledName_3205.mAttribute_string.plusAssign_operation(GALGAS_string (":"), inCompiler  COMMA_SOURCE_FILE ("declaration-module.galgas", 93)) ;
      enumerator_3442.gotoNextObject () ;
    }
    var_routineMangledName_3205.mAttribute_string.plusAssign_operation(GALGAS_string (")"), inCompiler  COMMA_SOURCE_FILE ("declaration-module.galgas", 95)) ;
    var_requiredByList_2466.addAssign_operation (var_routineMangledName_3205  COMMA_SOURCE_FILE ("declaration-module.galgas", 96)) ;
    enumerator_3173.gotoNextObject () ;
  }
  cEnumerator_guardDeclarationListAST enumerator_3745 (var_guardListAST_1875, kEnumeration_up) ;
  while (enumerator_3745.hasCurrentObject ()) {
    GALGAS_lstring var_routineMangledName_3777 = GALGAS_lstring::constructor_new (GALGAS_string ("$").add_operation (var_moduleTypeName_1547.getter_string (SOURCE_FILE ("declaration-module.galgas", 100)), inCompiler COMMA_SOURCE_FILE ("declaration-module.galgas", 100)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("declaration-module.galgas", 100)).add_operation (enumerator_3745.current (HERE).mAttribute_mGuardName.getter_string (SOURCE_FILE ("declaration-module.galgas", 100)), inCompiler COMMA_SOURCE_FILE ("declaration-module.galgas", 100)), enumerator_3745.current (HERE).mAttribute_mGuardName.mAttribute_location  COMMA_SOURCE_FILE ("declaration-module.galgas", 99)) ;
    var_routineMangledName_3777.mAttribute_string.plusAssign_operation(GALGAS_string ("("), inCompiler  COMMA_SOURCE_FILE ("declaration-module.galgas", 103)) ;
    cEnumerator_procFormalArgumentList enumerator_4002 (enumerator_3745.current (HERE).mAttribute_mGuardFormalArgumentList, kEnumeration_up) ;
    while (enumerator_4002.hasCurrentObject ()) {
      var_routineMangledName_3777.mAttribute_string.plusAssign_operation(extensionGetter_formalPassingModeString (enumerator_4002.current_mFormalArgumentPassingMode (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-module.galgas", 105)), inCompiler  COMMA_SOURCE_FILE ("declaration-module.galgas", 105)) ;
      var_routineMangledName_3777.mAttribute_string.plusAssign_operation(enumerator_4002.current_mSelector (HERE).mAttribute_string, inCompiler  COMMA_SOURCE_FILE ("declaration-module.galgas", 106)) ;
      var_routineMangledName_3777.mAttribute_string.plusAssign_operation(GALGAS_string (":"), inCompiler  COMMA_SOURCE_FILE ("declaration-module.galgas", 107)) ;
      enumerator_4002.gotoNextObject () ;
    }
    var_routineMangledName_3777.mAttribute_string.plusAssign_operation(GALGAS_string (")"), inCompiler  COMMA_SOURCE_FILE ("declaration-module.galgas", 109)) ;
    var_requiredByList_2466.addAssign_operation (var_routineMangledName_3777  COMMA_SOURCE_FILE ("declaration-module.galgas", 110)) ;
    enumerator_3745.gotoNextObject () ;
  }
  cEnumerator_primitiveDeclarationListAST enumerator_4313 (var_primitiveListAST_1828, kEnumeration_up) ;
  while (enumerator_4313.hasCurrentObject ()) {
    GALGAS_lstring var_routineMangledName_4345 = GALGAS_lstring::constructor_new (GALGAS_string ("$").add_operation (var_moduleTypeName_1547.getter_string (SOURCE_FILE ("declaration-module.galgas", 114)), inCompiler COMMA_SOURCE_FILE ("declaration-module.galgas", 114)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("declaration-module.galgas", 114)).add_operation (enumerator_4313.current (HERE).mAttribute_mPrimitiveName.getter_string (SOURCE_FILE ("declaration-module.galgas", 114)), inCompiler COMMA_SOURCE_FILE ("declaration-module.galgas", 114)), enumerator_4313.current (HERE).mAttribute_mPrimitiveName.mAttribute_location  COMMA_SOURCE_FILE ("declaration-module.galgas", 113)) ;
    var_routineMangledName_4345.mAttribute_string.plusAssign_operation(GALGAS_string ("("), inCompiler  COMMA_SOURCE_FILE ("declaration-module.galgas", 117)) ;
    cEnumerator_procFormalArgumentList enumerator_4594 (enumerator_4313.current (HERE).mAttribute_mPrimitiveFormalArgumentList, kEnumeration_up) ;
    while (enumerator_4594.hasCurrentObject ()) {
      var_routineMangledName_4345.mAttribute_string.plusAssign_operation(extensionGetter_formalPassingModeString (enumerator_4594.current_mFormalArgumentPassingMode (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-module.galgas", 119)), inCompiler  COMMA_SOURCE_FILE ("declaration-module.galgas", 119)) ;
      var_routineMangledName_4345.mAttribute_string.plusAssign_operation(enumerator_4594.current_mSelector (HERE).mAttribute_string, inCompiler  COMMA_SOURCE_FILE ("declaration-module.galgas", 120)) ;
      var_routineMangledName_4345.mAttribute_string.plusAssign_operation(GALGAS_string (":"), inCompiler  COMMA_SOURCE_FILE ("declaration-module.galgas", 121)) ;
      enumerator_4594.gotoNextObject () ;
    }
    var_routineMangledName_4345.mAttribute_string.plusAssign_operation(GALGAS_string (")"), inCompiler  COMMA_SOURCE_FILE ("declaration-module.galgas", 123)) ;
    var_requiredByList_2466.addAssign_operation (var_routineMangledName_4345  COMMA_SOURCE_FILE ("declaration-module.galgas", 124)) ;
    enumerator_4313.gotoNextObject () ;
  }
  cEnumerator_initList enumerator_4892 (var_initList_1950, kEnumeration_up) ;
  while (enumerator_4892.hasCurrentObject ()) {
    ioArgument_ioAST.mAttribute_mInitList.addAssign_operation (enumerator_4892.current (HERE).mAttribute_mInitLocation, var_moduleTypeName_1547, var_moduleName_1524.mAttribute_string, var_requiredByList_2466, enumerator_4892.current (HERE).mAttribute_mInstructionList, enumerator_4892.current (HERE).mAttribute_mEndOfInitLocation, enumerator_4892.current (HERE).mAttribute_mPriority  COMMA_SOURCE_FILE ("declaration-module.galgas", 127)) ;
    enumerator_4892.gotoNextObject () ;
  }
  ioArgument_ioAST.mAttribute_mDeclarationList.addAssign_operation (GALGAS_structureDeclaration::constructor_new (var_moduleTypeName_1547, GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("declaration-module.galgas", 139)), var_fieldList_1722, var_functionDeclarationListAST_1677, var_serviceListAST_1773, var_sectionListAST_1922, var_primitiveListAST_1828, var_guardListAST_1875  COMMA_SOURCE_FILE ("declaration-module.galgas", 137))  COMMA_SOURCE_FILE ("declaration-module.galgas", 137)) ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_i16_ (GALGAS_ast & ioArgument_ioAST,
  ...
  ioArgument_ioAST.mAttribute_mTaskList.addAssign_operation (var_taskName_2034, var_priority_2086, var_stackSize_2140, var_taskVarList_2180, var_taskProcList_2230, var_taskInitListAST_2272, var_branchList_2319, var_endOfTask_3633  COMMA_SOURCE_FILE ("declaration-task.galgas", 110)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_i17_ (GALGAS_ast & ioArgument_ioAST,
  ...
  ioArgument_ioAST.mAttribute_mPanicClauses.addAssign_operation (GALGAS_bool (true), var_instructionList_1216, var_endOfInstructionList_1245, var_priority_1165  COMMA_SOURCE_FILE ("panic.galgas", 30)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_i18_ (GALGAS_ast & ioArgument_ioAST,
  ...
  GALGAS_lbigint var_priority_1590 = inCompiler->synthetizedAttribute_bigInteger () ;
  ...
  GALGAS_instructionListAST var_instructionList_1641 ;
  nt_instructionList_ (var_instructionList_1641, inCompiler) ;
  GALGAS_location var_endOfInstructionList_1670 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("panic.galgas", 45)) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__7D_) COMMA_SOURCE_FILE ("panic.galgas", 46)) ;
  ioArgument_ioAST.mAttribute_mPanicClauses.addAssign_operation (GALGAS_bool (false), var_instructionList_1641, var_endOfInstructionList_1670, var_priority_1590  COMMA_SOURCE_FILE ("panic.galgas", 47)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_svc_5F_declaration_i19_ (GALGAS_bool & outArgument_outPublic,
                                                                        C_Lexique_plm_5F_lexique * inCompiler) {
  ...
  case 2: {
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_public) COMMA_SOURCE_FILE ("declaration-svc.galgas", 13)) ;
    outArgument_outPublic = GALGAS_bool (true) ;
  } break ;
  default:
    break ;
  }
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_svc) COMMA_SOURCE_FILE ("declaration-svc.galgas", 16)) ;
}

//---------------------------------------------------------------------------------------------------------------------*

void cParser_plm_5F_syntax::rule_plm_5F_syntax_svc_5F_declaration_i19_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  switch (select_plm_5F_syntax_24 (inCompiler)) {
  case 1: {
  } break ;
  case 2: {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_5F_init_i22_ (GALGAS_initList & ioArgument_ioInitList,
                                                                         C_Lexique_plm_5F_lexique * inCompiler) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_5F_init_i22_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_init) COMMA_SOURCE_FILE ("declaration-init.galgas", 32)) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_integer) COMMA_SOURCE_FILE ("declaration-init.galgas", 33)) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__7B_) COMMA_SOURCE_FILE ("declaration-init.galgas", 34)) ;
  nt_instructionList_parse (inCompiler) ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_function_i23_ (GALGAS_functionDeclarationListAST & ioArgument_ioProcListAST,
                                                              C_Lexique_plm_5F_lexique * inCompiler) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_function_i23_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  switch (select_plm_5F_syntax_25 (inCompiler)) {
  case 1: {
  } break ;
  case 2: {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_mode_i24_ (GALGAS_mode & outArgument_outMode,
                                                          C_Lexique_plm_5F_lexique * inCompiler) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_mode_i24_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  switch (select_plm_5F_syntax_27 (inCompiler)) {
  case 1: {
  } break ;
  case 2: {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_function_5F_header_i25_ (GALGAS_mode & outArgument_outMode,
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_function_5F_header_i25_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_func) COMMA_SOURCE_FILE ("declaration-func.galgas", 143)) ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_procedure_5F_formal_5F_arguments_i26_ (GALGAS_procFormalArgumentList & outArgument_outProcFormalArgumentList,
                                                                                      C_Lexique_plm_5F_lexique * inCompiler) {
  outArgument_outProcFormalArgumentList.drop () ; // Release 'out' argument
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_procedure_5F_formal_5F_arguments_i26_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__28_) COMMA_SOURCE_FILE ("declaration-func.galgas", 159)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_plm_5F_syntax_29 (inCompiler)) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_isr_i29_ (GALGAS_isrDeclarationListAST & ioArgument_ioISRListAST,
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_section_i30_ (GALGAS_svcDeclarationListAST & ioArgument_ioSVCListAST,
                                                             C_Lexique_plm_5F_lexique * inCompiler) {
  GALGAS_bool var_public_1469 ;
  nt_svc_5F_declaration_ (var_public_1469, inCompiler) ;
  GALGAS_routineKind var_routineKind_1498 ;
  switch (select_plm_5F_syntax_32 (inCompiler)) {
  case 1: {
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_section) COMMA_SOURCE_FILE ("declaration-section.galgas", 39)) ;
    var_routineKind_1498 = GALGAS_routineKind::constructor_section (SOURCE_FILE ("declaration-section.galgas", 40)) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_safe) COMMA_SOURCE_FILE ("declaration-section.galgas", 42)) ;
    var_routineKind_1498 = GALGAS_routineKind::constructor_safe (SOURCE_FILE ("declaration-section.galgas", 43)) ;
  } break ;
  default:
    break ;
  }
  GALGAS_lstring var_name_1635 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_identifier) COMMA_SOURCE_FILE ("declaration-section.galgas", 45)) ;
  GALGAS_lstringlist var_attributeList_1666 = GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("declaration-section.galgas", 46)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_plm_5F_syntax_33 (inCompiler)) {
    case 2: {
      GALGAS_lstring var_attribute_1726 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__40_attribute) COMMA_SOURCE_FILE ("declaration-section.galgas", 49)) ;
      var_attributeList_1666.addAssign_operation (var_attribute_1726  COMMA_SOURCE_FILE ("declaration-section.galgas", 50)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  GALGAS_procFormalArgumentList var_formalArgumentList_1841 ;
  nt_procedure_5F_formal_5F_arguments_ (var_formalArgumentList_1841, inCompiler) ;
  GALGAS_lstring var_returnTypeName_1869 ;
  switch (select_plm_5F_syntax_34 (inCompiler)) {
  case 1: {
    var_returnTypeName_1869 = GALGAS_string::makeEmptyString ().getter_here (inCompiler COMMA_SOURCE_FILE ("declaration-section.galgas", 55)) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__2D__3E_) COMMA_SOURCE_FILE ("declaration-section.galgas", 57)) ;
    var_returnTypeName_1869 = inCompiler->synthetizedAttribute_tokenString () ;
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__24_type) COMMA_SOURCE_FILE ("declaration-section.galgas", 58)) ;
  } break ;
  default:
    break ;
  }
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__7B_) COMMA_SOURCE_FILE ("declaration-section.galgas", 60)) ;
  GALGAS_instructionListAST var_instructionList_2021 ;
  nt_instructionList_ (var_instructionList_2021, inCompiler) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__7D_) COMMA_SOURCE_FILE ("declaration-section.galgas", 62)) ;
  ioArgument_ioSVCListAST.addAssign_operation (var_name_1635, var_routineKind_1498, var_public_1469, var_attributeList_1666, var_formalArgumentList_1841, var_returnTypeName_1869, var_instructionList_2021, GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-section.galgas", 71))  COMMA_SOURCE_FILE ("declaration-section.galgas", 63)) ;
}

//---------------------------------------------------------------------------------------------------------------------*

void cParser_plm_5F_syntax::rule_plm_5F_syntax_section_i30_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  nt_svc_5F_declaration_parse (inCompiler) ;
  switch (select_plm_5F_syntax_32 (inCompiler)) {
  case 1: {
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_section) COMMA_SOURCE_FILE ("declaration-section.galgas", 39)) ;
  } break ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_service_i31_ (GALGAS_serviceDeclarationListAST & ioArgument_ioServiceListAST,
                                                             C_Lexique_plm_5F_lexique * inCompiler) {
  GALGAS_bool var_public_1369 ;
  nt_svc_5F_declaration_ (var_public_1369, inCompiler) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_service) COMMA_SOURCE_FILE ("declaration-service.galgas", 33)) ;
  GALGAS_lstring var_serviceName_1417 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_identifier) COMMA_SOURCE_FILE ("declaration-service.galgas", 34)) ;
  GALGAS_lstringlist var_attributeList_1448 = GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("declaration-service.galgas", 35)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_plm_5F_syntax_35 (inCompiler)) {
    case 2: {
      GALGAS_lstring var_attribute_1508 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__40_attribute) COMMA_SOURCE_FILE ("declaration-service.galgas", 38)) ;
      var_attributeList_1448.addAssign_operation (var_attribute_1508  COMMA_SOURCE_FILE ("declaration-service.galgas", 39)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  GALGAS_procFormalArgumentList var_serviceFormalArgumentList_1630 ;
  nt_procedure_5F_formal_5F_arguments_ (var_serviceFormalArgumentList_1630, inCompiler) ;
  GALGAS_lstring var_returnTypeName_1658 ;
  switch (select_plm_5F_syntax_36 (inCompiler)) {
  case 1: {
    var_returnTypeName_1658 = GALGAS_string::makeEmptyString ().getter_here (inCompiler COMMA_SOURCE_FILE ("declaration-service.galgas", 44)) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__2D__3E_) COMMA_SOURCE_FILE ("declaration-service.galgas", 46)) ;
    var_returnTypeName_1658 = inCompiler->synthetizedAttribute_tokenString () ;
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__24_type) COMMA_SOURCE_FILE ("declaration-service.galgas", 47)) ;
  } break ;
  default:
    break ;
  }
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__7B_) COMMA_SOURCE_FILE ("declaration-service.galgas", 49)) ;
  GALGAS_instructionListAST var_instructionList_1810 ;
  nt_instructionList_ (var_instructionList_1810, inCompiler) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__7D_) COMMA_SOURCE_FILE ("declaration-service.galgas", 51)) ;
  ioArgument_ioServiceListAST.addAssign_operation (var_serviceName_1417, var_public_1369, var_attributeList_1448, var_serviceFormalArgumentList_1630, var_returnTypeName_1658, var_instructionList_1810, GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-service.galgas", 59))  COMMA_SOURCE_FILE ("declaration-service.galgas", 52)) ;
}

//---------------------------------------------------------------------------------------------------------------------*

void cParser_plm_5F_syntax::rule_plm_5F_syntax_service_i31_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  nt_svc_5F_declaration_parse (inCompiler) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_service) COMMA_SOURCE_FILE ("declaration-service.galgas", 33)) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_identifier) COMMA_SOURCE_FILE ("declaration-service.galgas", 34)) ;
  bool repeatFlag_0 = true ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_primitive_i32_ (GALGAS_primitiveDeclarationListAST & ioArgument_ioPrimitiveListAST,
                                                               C_Lexique_plm_5F_lexique * inCompiler) {
  GALGAS_bool var_public_1394 ;
  nt_svc_5F_declaration_ (var_public_1394, inCompiler) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_primitive) COMMA_SOURCE_FILE ("declaration-primitive.galgas", 33)) ;
  GALGAS_lstring var_primitiveName_1446 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_identifier) COMMA_SOURCE_FILE ("declaration-primitive.galgas", 34)) ;
  GALGAS_lstringlist var_attributeList_1477 = GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("declaration-primitive.galgas", 35)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_plm_5F_syntax_37 (inCompiler)) {
    case 2: {
      GALGAS_lstring var_attribute_1537 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__40_attribute) COMMA_SOURCE_FILE ("declaration-primitive.galgas", 38)) ;
      var_attributeList_1477.addAssign_operation (var_attribute_1537  COMMA_SOURCE_FILE ("declaration-primitive.galgas", 39)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  GALGAS_procFormalArgumentList var_primitiveFormalArgumentList_1661 ;
  nt_procedure_5F_formal_5F_arguments_ (var_primitiveFormalArgumentList_1661, inCompiler) ;
  GALGAS_lstring var_returnTypeName_1689 ;
  switch (select_plm_5F_syntax_38 (inCompiler)) {
  case 1: {
    var_returnTypeName_1689 = GALGAS_string::makeEmptyString ().getter_here (inCompiler COMMA_SOURCE_FILE ("declaration-primitive.galgas", 44)) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__2D__3E_) COMMA_SOURCE_FILE ("declaration-primitive.galgas", 46)) ;
    var_returnTypeName_1689 = inCompiler->synthetizedAttribute_tokenString () ;
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__24_type) COMMA_SOURCE_FILE ("declaration-primitive.galgas", 47)) ;
  } break ;
  default:
    break ;
  }
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__7B_) COMMA_SOURCE_FILE ("declaration-primitive.galgas", 49)) ;
  GALGAS_instructionListAST var_instructionList_1841 ;
  nt_instructionList_ (var_instructionList_1841, inCompiler) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__7D_) COMMA_SOURCE_FILE ("declaration-primitive.galgas", 51)) ;
  ioArgument_ioPrimitiveListAST.addAssign_operation (var_primitiveName_1446, var_public_1394, var_attributeList_1477, var_primitiveFormalArgumentList_1661, var_returnTypeName_1689, var_instructionList_1841, GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-primitive.galgas", 59))  COMMA_SOURCE_FILE ("declaration-primitive.galgas", 52)) ;
}

//---------------------------------------------------------------------------------------------------------------------*

void cParser_plm_5F_syntax::rule_plm_5F_syntax_primitive_i32_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  nt_svc_5F_declaration_parse (inCompiler) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_primitive) COMMA_SOURCE_FILE ("declaration-primitive.galgas", 33)) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_identifier) COMMA_SOURCE_FILE ("declaration-primitive.galgas", 34)) ;
  bool repeatFlag_0 = true ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_guard_i33_ (GALGAS_guardDeclarationListAST & ioArgument_ioGuardListAST,
                                                           C_Lexique_plm_5F_lexique * inCompiler) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_guard_i33_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  switch (select_plm_5F_syntax_39 (inCompiler)) {
  case 1: {
  } break ;
  case 2: {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_expression_i35_ (GALGAS_expressionAST & outArgument_outExpression,
                                                                C_Lexique_plm_5F_lexique * inCompiler) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_expression_i35_parse (C_Lexique_plm_5F_lexique * inCompiler) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_expression_5F__31__32__i36_ (GALGAS_expressionAST & outArgument_outExpression,
                                                                            C_Lexique_plm_5F_lexique * inCompiler) {
  outArgument_outExpression.drop () ; // Release 'out' argument
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_expression_5F__31__32__i36_parse (C_Lexique_plm_5F_lexique * inCompiler) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_expression_5F__31__31__i37_ (GALGAS_expressionAST & outArgument_outExpression,
                                                                            C_Lexique_plm_5F_lexique * inCompiler) {
  outArgument_outExpression.drop () ; // Release 'out' argument
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_expression_5F__31__31__i37_parse (C_Lexique_plm_5F_lexique * inCompiler) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_expression_5F__31__30__i38_ (GALGAS_expressionAST & outArgument_outExpression,
                                                                            C_Lexique_plm_5F_lexique * inCompiler) {
  outArgument_outExpression.drop () ; // Release 'out' argument
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_expression_5F__31__30__i38_parse (C_Lexique_plm_5F_lexique * inCompiler) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_expression_5F__39__i39_ (GALGAS_expressionAST & outArgument_outExpression,
                                                                        C_Lexique_plm_5F_lexique * inCompiler) {
  outArgument_outExpression.drop () ; // Release 'out' argument
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_expression_5F__39__i39_parse (C_Lexique_plm_5F_lexique * inCompiler) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_expression_5F__38__i40_ (GALGAS_expressionAST & outArgument_outExpression,
                                                                        C_Lexique_plm_5F_lexique * inCompiler) {
  outArgument_outExpression.drop () ; // Release 'out' argument
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_expression_5F__38__i40_parse (C_Lexique_plm_5F_lexique * inCompiler) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_expression_5F__37__i41_ (GALGAS_expressionAST & outArgument_outExpression,
                                                                        C_Lexique_plm_5F_lexique * inCompiler) {
  outArgument_outExpression.drop () ; // Release 'out' argument
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_expression_5F__37__i41_parse (C_Lexique_plm_5F_lexique * inCompiler) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_expression_5F__36__i42_ (GALGAS_expressionAST & outArgument_outExpression,
                                                                        C_Lexique_plm_5F_lexique * inCompiler) {
  outArgument_outExpression.drop () ; // Release 'out' argument
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_expression_5F__36__i42_parse (C_Lexique_plm_5F_lexique * inCompiler) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_expression_5F__35__i43_ (GALGAS_expressionAST & outArgument_outExpression,
                                                                        C_Lexique_plm_5F_lexique * inCompiler) {
  outArgument_outExpression.drop () ; // Release 'out' argument
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_expression_5F__35__i43_parse (C_Lexique_plm_5F_lexique * inCompiler) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_expression_5F__34__i44_ (GALGAS_expressionAST & outArgument_outExpression,
                                                                        C_Lexique_plm_5F_lexique * inCompiler) {
  outArgument_outExpression.drop () ; // Release 'out' argument
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_expression_5F__34__i44_parse (C_Lexique_plm_5F_lexique * inCompiler) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_expression_5F__33__i45_ (GALGAS_expressionAST & outArgument_outExpression,
                                                                        C_Lexique_plm_5F_lexique * inCompiler) {
  outArgument_outExpression.drop () ; // Release 'out' argument
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_expression_5F__33__i45_parse (C_Lexique_plm_5F_lexique * inCompiler) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_expression_5F__32__i46_ (GALGAS_expressionAST & outArgument_outExpression,
                                                                        C_Lexique_plm_5F_lexique * inCompiler) {
  outArgument_outExpression.drop () ; // Release 'out' argument
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_expression_5F__32__i46_parse (C_Lexique_plm_5F_lexique * inCompiler) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_expression_5F__31__i47_ (GALGAS_expressionAST & outArgument_outExpression,
                                                                        C_Lexique_plm_5F_lexique * inCompiler) {
  outArgument_outExpression.drop () ; // Release 'out' argument
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_expression_5F__31__i47_parse (C_Lexique_plm_5F_lexique * inCompiler) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_effective_5F_parameters_i65_ (GALGAS_effectiveParameterListAST & outArgument_outEffectiveParameterList,
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_assignment_5F_operator_i69_ (GALGAS_operatorAssignmentKind & outArgument_outOp,
                                                                            C_Lexique_plm_5F_lexique * inCompiler) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_assignment_5F_operator_i69_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  switch (select_plm_5F_syntax_63 (inCompiler)) {
  case 1: {
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__7C__3D_) COMMA_SOURCE_FILE ("instruction-assignment-operator.galgas", 39)) ;
  } break ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_if_5F_instruction_i77_ (GALGAS_ifInstructionAST & outArgument_outIfInstruction,
                                                                       C_Lexique_plm_5F_lexique * inCompiler) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_if_5F_instruction_i77_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_if) COMMA_SOURCE_FILE ("instruction-if.galgas", 32)) ;
  nt_expression_parse (inCompiler) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__7B_) COMMA_SOURCE_FILE ("instruction-if.galgas", 36)) ;
  nt_instructionList_parse (inCompiler) ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_guarded_5F_command_i78_ (GALGAS_guardedCommand & outArgument_outGuardedCommand,
                                                                        C_Lexique_plm_5F_lexique * inCompiler) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_guarded_5F_command_i78_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  switch (select_plm_5F_syntax_67 (inCompiler)) {
  case 1: {
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_when) COMMA_SOURCE_FILE ("instruction-sync.galgas", 49)) ;
    nt_expression_parse (inCompiler) ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_assignment_5F_target_i86_ (GALGAS_assignmentTargetAST & outArgument_outAssignmentTargetAST,
                                                                          C_Lexique_plm_5F_lexique * inCompiler) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_assignment_5F_target_i86_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  switch (select_plm_5F_syntax_75 (inCompiler)) {
  case 1: {
  } break ;
  case 2: {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_i88_ (GALGAS_ast & ioArgument_ioAST,
  ...
  ioArgument_ioAST.mAttribute_mCheckTargetList.addAssign_operation (var_targetName_607  COMMA_SOURCE_FILE ("declaration-check-target.galgas", 13)) ;
}
