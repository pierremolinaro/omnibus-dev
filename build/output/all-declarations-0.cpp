...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_start_5F_symbol_i1_ (GALGAS_ast & ioArgument_ioAST,
  ...
  while (repeatFlag_0) {
    ...
    case 2: {
      ...
      case 1: {
        inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__3B_ COMMA_SOURCE_FILE ("syntax-grammar.galgas", 30)) ;
      } break ;
      case 2: {
        GALGAS_string var_s_1211 = GALGAS_string::constructor_separatorString (inCompiler  COMMA_SOURCE_FILE ("syntax-grammar.galgas", 33)) ;
        enumGalgasBool test_1 = kBoolTrue ;
        if (kBoolTrue == test_1) {
          test_1 = var_s_1211.getter_containsCharacter (GALGAS_char (TO_UNICODE (10)) COMMA_SOURCE_FILE ("syntax-grammar.galgas", 34)).operator_not (SOURCE_FILE ("syntax-grammar.galgas", 34)).boolEnum () ;
          if (kBoolTrue == test_1) {
    ...
    case 3: {
      GALGAS_systemRoutineDeclarationListAST var_standAloneSystemRoutineListAST_1474 = GALGAS_systemRoutineDeclarationListAST::constructor_emptyList (SOURCE_FILE ("syntax-grammar.galgas", 39)) ;
      nt_system_5F_routine_ (ioArgument_ioAST, var_standAloneSystemRoutineListAST_1474, inCompiler) ;
      ioArgument_ioAST.mProperty_mStandAloneSystemRoutineListAST.plusAssign_operation(var_standAloneSystemRoutineListAST_1474, inCompiler  COMMA_SOURCE_FILE ("syntax-grammar.galgas", 41)) ;
      ...
      case 2: {
        GALGAS_string var_s_1669 = GALGAS_string::constructor_separatorString (inCompiler  COMMA_SOURCE_FILE ("syntax-grammar.galgas", 45)) ;
        enumGalgasBool test_3 = kBoolTrue ;
        if (kBoolTrue == test_3) {
          test_3 = var_s_1669.getter_containsCharacter (GALGAS_char (TO_UNICODE (10)) COMMA_SOURCE_FILE ("syntax-grammar.galgas", 46)).operator_not (SOURCE_FILE ("syntax-grammar.galgas", 46)).boolEnum () ;
          if (kBoolTrue == test_3) {
    ...
    case 4: {
      ...
      case 2: {
        GALGAS_string var_s_1952 = GALGAS_string::constructor_separatorString (inCompiler  COMMA_SOURCE_FILE ("syntax-grammar.galgas", 55)) ;
        enumGalgasBool test_5 = kBoolTrue ;
        if (kBoolTrue == test_5) {
          test_5 = var_s_1952.getter_containsCharacter (GALGAS_char (TO_UNICODE (10)) COMMA_SOURCE_FILE ("syntax-grammar.galgas", 56)).operator_not (SOURCE_FILE ("syntax-grammar.galgas", 56)).boolEnum () ;
          if (kBoolTrue == test_5) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_i2_ (GALGAS_ast & ioArgument_ioAST,
  ...
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("type-alias.galgas", 26)) ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_type_5F_definition_i3_ (GALGAS_ast & ioArgument_ioAST,
  ...
  case 1: {
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__5B_ COMMA_SOURCE_FILE ("type-alias.galgas", 36)) ;
    nt_type_5F_definition_5F_enclosed_5F_in_5F_square_5F_breackets_ (ioArgument_ioAST, outArgument_outTypeName, inCompiler) ;
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__5D_ COMMA_SOURCE_FILE ("type-alias.galgas", 38)) ;
  } break ;
  case 2: {
    outArgument_outTypeName = inCompiler->synthetizedAttribute_tokenString () ;
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("type-alias.galgas", 40)) ;
  } break ;
  default:
    break ;
  }
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_type_5F_definition_i3_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  ...
  case 1: {
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__5B_ COMMA_SOURCE_FILE ("type-alias.galgas", 36)) ;
    nt_type_5F_definition_5F_enclosed_5F_in_5F_square_5F_breackets_parse (inCompiler) ;
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__5D_ COMMA_SOURCE_FILE ("type-alias.galgas", 38)) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("type-alias.galgas", 40)) ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_type_5F_definition_5F_enclosed_5F_in_5F_square_5F_breackets_i4_ (GALGAS_ast & ioArgument_ioAST,
                                                                                                                GALGAS_lstring & outArgument_outTypeName,
                                                                                                                C_Lexique_plm_5F_lexique * inCompiler) {
  outArgument_outTypeName.drop () ; // Release 'out' argument
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_type_5F_definition_5F_enclosed_5F_in_5F_square_5F_breackets_i5_ (GALGAS_ast & ioArgument_ioAST,
                                                                                                                GALGAS_lstring & outArgument_outTypeName,
                                                                                                                C_Lexique_plm_5F_lexique * inCompiler) {
  outArgument_outTypeName.drop () ; // Release 'out' argument
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_type_5F_definition_5F_enclosed_5F_in_5F_square_5F_breackets_i5_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__5B_ COMMA_SOURCE_FILE ("type-dynamic-array.galgas", 19)) ;
  nt_type_5F_definition_parse (inCompiler) ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__5D_ COMMA_SOURCE_FILE ("type-dynamic-array.galgas", 21)) ;
  inCompiler->resetTemplateString () ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_i6_ (GALGAS_ast & ioArgument_ioAST,
  ...
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("type-enumeration-declaration.galgas", 27)) ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_struct_5F_property_5F_declaration_i9_ (GALGAS_ast & ioArgument_ioAST,
  ...
  case 1: {
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__3A_ COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 95)) ;
    nt_type_5F_definition_ (ioArgument_ioAST, var_typeName_3669, inCompiler) ;
  } break ;
  case 2: {
    var_typeName_3669 = GALGAS_string::makeEmptyString ().getter_nowhere (SOURCE_FILE ("type-structure-declaration.galgas", 98)) ;
  } break ;
  default:
    break ;
  }
  ...
  case 1: {
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__3D_ COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 101)) ;
    GALGAS_expressionAST var_initExpression_3845 ;
    nt_expression_ (ioArgument_ioAST, var_initExpression_3845, inCompiler) ;
    ioArgument_ioPropertyListAST.addAssign_operation (var_propertyName_3447, GALGAS_propertyAttributeList::constructor_emptyList (SOURCE_FILE ("type-structure-declaration.galgas", 105)), constinArgument_isPublic, var_typeName_3669, GALGAS_propertyKindAST::constructor_initializedConstantProperty (var_initExpression_3845  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 108))  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 103)) ;
  } break ;
  case 2: {
    ioArgument_ioPropertyListAST.addAssign_operation (var_propertyName_3447, GALGAS_propertyAttributeList::constructor_emptyList (SOURCE_FILE ("type-structure-declaration.galgas", 112)), constinArgument_isPublic, var_typeName_3669, GALGAS_propertyKindAST::constructor_uninitializedConstantProperty (SOURCE_FILE ("type-structure-declaration.galgas", 115))  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 110)) ;
  } break ;
  default:
    break ;
  }
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_struct_5F_property_5F_declaration_i10_ (GALGAS_ast & ioArgument_ioAST,
                                                                                       ...
                                                                                       GALGAS_structurePropertyListAST & ioArgument_ioPropertyListAST,
                                                                                       C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_var COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 126)) ;
  GALGAS_lstring var_propertyName_4470 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 127)) ;
  GALGAS_propertyAttributeList var_propertyAttributeList_4519 = GALGAS_propertyAttributeList::constructor_emptyList (SOURCE_FILE ("type-structure-declaration.galgas", 128)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_plm_5F_syntax_9 (inCompiler)) {
    case 2: {
      GALGAS_lstring var_attribute_4579 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__40_attribute COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 131)) ;
      GALGAS_lbigint var_value_4606 = inCompiler->synthetizedAttribute_bigInteger () ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_integer COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 132)) ;
      var_propertyAttributeList_4519.addAssign_operation (var_attribute_4579, var_value_4606  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 133)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  case 1: {
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__3A_ COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 136)) ;
    GALGAS_lstring var_typeName_4731 ;
    nt_type_5F_definition_ (ioArgument_ioAST, var_typeName_4731, inCompiler) ;
    switch (select_plm_5F_syntax_11 (inCompiler)) {
    case 1: {
      ioArgument_ioPropertyListAST.addAssign_operation (var_propertyName_4470, GALGAS_propertyAttributeList::constructor_emptyList (SOURCE_FILE ("type-structure-declaration.galgas", 139)), constinArgument_isPublic, var_typeName_4731, GALGAS_propertyKindAST::constructor_uninitializedStoredProperty (SOURCE_FILE ("type-structure-declaration.galgas", 139))  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 139)) ;
    } break ;
    case 2: {
      nt_propertyGetterSetter_ (ioArgument_ioAST, constinArgument_isPublic, var_propertyName_4470, var_propertyAttributeList_4519, var_typeName_4731, ioArgument_ioPropertyListAST, inCompiler) ;
    } break ;
    case 3: {
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__3D_ COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 149)) ;
      GALGAS_expressionAST var_initExpression_5090 ;
      nt_expression_ (ioArgument_ioAST, var_initExpression_5090, inCompiler) ;
      ioArgument_ioPropertyListAST.addAssign_operation (var_propertyName_4470, var_propertyAttributeList_4519, constinArgument_isPublic, var_typeName_4731, GALGAS_propertyKindAST::constructor_initializedStoredProperty (var_initExpression_5090  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 156))  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 151)) ;
    } break ;
    default:
      break ;
    }
  ...
  case 2: {
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__3D_ COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 159)) ;
    GALGAS_expressionAST var_initExpression_5361 ;
    nt_expression_ (ioArgument_ioAST, var_initExpression_5361, inCompiler) ;
    ioArgument_ioPropertyListAST.addAssign_operation (var_propertyName_4470, var_propertyAttributeList_4519, constinArgument_isPublic, GALGAS_string::makeEmptyString ().getter_nowhere (SOURCE_FILE ("type-structure-declaration.galgas", 165)), GALGAS_propertyKindAST::constructor_initializedStoredProperty (var_initExpression_5361  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 166))  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 161)) ;
  } break ;
  default:
    break ;
  }
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_propertyGetterSetter_i11_ (GALGAS_ast & ioArgument_ioAST,
                                                                          ...
                                                                          GALGAS_structurePropertyListAST & ioArgument_ioPropertyListAST,
                                                                          C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__7B_ COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 181)) ;
  GALGAS_instructionListAST var_readInstructionList_7706 ;
  nt_instructionList_ (ioArgument_ioAST, var_readInstructionList_7706, inCompiler) ;
  GALGAS_location var_endOfReadInstructionList_7741 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 231)) ;
  ioArgument_ioPropertyListAST.addAssign_operation (constinArgument_inPropertyName, constinArgument_inPropertyAttributeList, constinArgument_inIsPublic, constinArgument_inTypeName, GALGAS_propertyKindAST::constructor_readOnlyComputedProperty (var_readInstructionList_7706, var_endOfReadInstructionList_7741  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 237))  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 232)) ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__7D_ COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 242)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_structure_5F_function_i12_ (GALGAS_ast & ioArgument_ioAST,
                                                                           ...
                                                                           C_Lexique_plm_5F_lexique * inCompiler) {
  GALGAS_bool var_public_8285 ;
  switch (select_plm_5F_syntax_12 (inCompiler)) {
  case 1: {
    var_public_8285 = GALGAS_bool (false) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_public COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 252)) ;
    var_public_8285 = GALGAS_bool (true) ;
  } break ;
  default:
    break ;
  }
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_func COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 255)) ;
  GALGAS_lstring var_procName_8409 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 256)) ;
  GALGAS_lstringlist var_attributeList_8440 = GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("type-structure-declaration.galgas", 257)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_plm_5F_syntax_13 (inCompiler)) {
    case 2: {
      GALGAS_lstring var_attribute_8500 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__40_attribute COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 260)) ;
      var_attributeList_8440.addAssign_operation (var_attribute_8500  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 261)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  GALGAS_routineFormalArgumentListAST var_procFormalArgumentList_8612 ;
  nt_procedure_5F_formal_5F_arguments_ (ioArgument_ioAST, var_procFormalArgumentList_8612, inCompiler) ;
  GALGAS_lstring var_returnTypeName_8640 ;
  switch (select_plm_5F_syntax_14 (inCompiler)) {
  case 1: {
    var_returnTypeName_8640 = GALGAS_string::makeEmptyString ().getter_here (inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 266)) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__2D__3E_ COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 268)) ;
    nt_type_5F_definition_ (ioArgument_ioAST, var_returnTypeName_8640, inCompiler) ;
  } break ;
  default:
    break ;
  }
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__7B_ COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 271)) ;
  GALGAS_instructionListAST var_instructionList_8817 ;
  nt_instructionList_ (ioArgument_ioAST, var_instructionList_8817, inCompiler) ;
  ioArgument_ioProcListAST.addAssign_operation (GALGAS_mode::constructor_anyMode (SOURCE_FILE ("type-structure-declaration.galgas", 274)), var_public_8285, var_procName_8409, var_attributeList_8440, var_procFormalArgumentList_8612, var_returnTypeName_8640, var_instructionList_8817, GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 281))  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 273)) ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__7D_ COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 282)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_i13_ (GALGAS_ast & ioArgument_ioAST,
                                                                 C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_struct COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 288)) ;
  GALGAS_lstring var_structureName_9213 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 289)) ;
  GALGAS_lstringlist var_attributeList_9244 = GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("type-structure-declaration.galgas", 290)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_plm_5F_syntax_15 (inCompiler)) {
    case 2: {
      GALGAS_lstring var_attribute_9304 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__40_attribute COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 293)) ;
      var_attributeList_9244.addAssign_operation (var_attribute_9304  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 294)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__7B_ COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 296)) ;
  GALGAS_functionDeclarationListAST var_procedureDeclarationListAST_9415 = GALGAS_functionDeclarationListAST::constructor_emptyList (SOURCE_FILE ("type-structure-declaration.galgas", 297)) ;
  GALGAS_structurePropertyListAST var_fieldList_9460 = GALGAS_structurePropertyListAST::constructor_emptyList (SOURCE_FILE ("type-structure-declaration.galgas", 298)) ;
  bool repeatFlag_1 = true ;
  while (repeatFlag_1) {
    switch (select_plm_5F_syntax_16 (inCompiler)) {
    case 2: {
      nt_private_5F_or_5F_public_5F_struct_5F_property_5F_declaration_ (ioArgument_ioAST, var_fieldList_9460, inCompiler) ;
    } break ;
    case 3: {
      nt_structure_5F_function_ (ioArgument_ioAST, var_procedureDeclarationListAST_9415, inCompiler) ;
    } break ;
    default:
      repeatFlag_1 = false ;
      break ;
  ...
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__7D_ COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 305)) ;
  ioArgument_ioAST.mProperty_mDeclarationListAST.addAssign_operation (GALGAS_structureDeclarationAST::constructor_new (var_structureName_9213, var_structureName_9213, var_structureName_9213, var_attributeList_9244, GALGAS_bool (true), var_fieldList_9460, var_procedureDeclarationListAST_9415, GALGAS_systemRoutineDeclarationListAST::constructor_emptyList (SOURCE_FILE ("type-structure-declaration.galgas", 314)), GALGAS_guardDeclarationListAST::constructor_emptyList (SOURCE_FILE ("type-structure-declaration.galgas", 315)), GALGAS_bool (true)  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 306))  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 306)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_i14_ (GALGAS_ast & ioArgument_ioAST,
  ...
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("type-sync-declaration.galgas", 23)) ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_i15_ (GALGAS_ast & ioArgument_ioAST,
  ...
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("type-opaque-declaration.galgas", 22)) ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_i16_ (GALGAS_ast & ioArgument_ioAST,
  ...
  GALGAS_registerGroupListAST var_registerGroupListAST_3461 = GALGAS_registerGroupListAST::constructor_emptyList (SOURCE_FILE ("declaration-control-register.galgas", 83)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    GALGAS_lstring var_registerGroupName_3519 = inCompiler->synthetizedAttribute_tokenString () ;
    ...
    GALGAS_lstring var_attribute_3553 = inCompiler->synthetizedAttribute_tokenString () ;
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__40_attribute COMMA_SOURCE_FILE ("declaration-control-register.galgas", 86)) ;
    enumGalgasBool test_1 = kBoolTrue ;
    if (kBoolTrue == test_1) {
      test_1 = GALGAS_bool (kIsNotEqual, var_attribute_3553.getter_string (HERE).objectCompare (GALGAS_string ("at"))).boolEnum () ;
      if (kBoolTrue == test_1) {
        TC_Array <C_FixItDescription> fixItArray2 ;
        inCompiler->emitSemanticError (var_attribute_3553.getter_location (SOURCE_FILE ("declaration-control-register.galgas", 88)), GALGAS_string ("attribute should be @at"), fixItArray2  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 88)) ;
      }
    }
    switch (select_plm_5F_syntax_20 (inCompiler)) {
    case 1: {
      GALGAS_lbigint var_registerGroupBaseAddress_3724 = inCompiler->synthetizedAttribute_bigInteger () ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_integer COMMA_SOURCE_FILE ("declaration-control-register.galgas", 91)) ;
      GALGAS_controlRegisterGroupKindAST var_groupKind_3746 = GALGAS_controlRegisterGroupKindAST::constructor_single (var_registerGroupBaseAddress_3724  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 92)) ;
      var_registerGroupListAST_3461.addAssign_operation (var_registerGroupName_3519, var_groupKind_3746  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 93)) ;
    } break ;
    case 2: {
      GALGAS_lbigintlist var_groupBaseAddresses_3948 = GALGAS_lbigintlist::constructor_emptyList (SOURCE_FILE ("declaration-control-register.galgas", 95)) ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__5B_ COMMA_SOURCE_FILE ("declaration-control-register.galgas", 96)) ;
      bool repeatFlag_3 = true ;
      while (repeatFlag_3) {
        GALGAS_lbigint var_baseAddress_4026 = inCompiler->synthetizedAttribute_bigInteger () ;
        inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_integer COMMA_SOURCE_FILE ("declaration-control-register.galgas", 98)) ;
        var_groupBaseAddresses_3948.addAssign_operation (var_baseAddress_4026  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 99)) ;
        switch (select_plm_5F_syntax_21 (inCompiler)) {
        case 2: {
          inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__2C_ COMMA_SOURCE_FILE ("declaration-control-register.galgas", 101)) ;
        } break ;
        default:
          repeatFlag_3 = false ;
          break ;
      ...
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__5D_ COMMA_SOURCE_FILE ("declaration-control-register.galgas", 103)) ;
      GALGAS_controlRegisterGroupKindAST var_groupKind_4145 = GALGAS_controlRegisterGroupKindAST::constructor_groupArray (var_groupBaseAddresses_3948  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 104)) ;
      var_registerGroupListAST_3461.addAssign_operation (var_registerGroupName_3519, var_groupKind_4145  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 105)) ;
    } break ;
    default:
      break ;
    }
    ...
    case 2: {
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__2C_ COMMA_SOURCE_FILE ("declaration-control-register.galgas", 108)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__7B_ COMMA_SOURCE_FILE ("declaration-control-register.galgas", 110)) ;
  GALGAS_controlRegisterDeclarationList var_controlRegisterDeclarationList_4398 = GALGAS_controlRegisterDeclarationList::constructor_emptyList (SOURCE_FILE ("declaration-control-register.galgas", 111)) ;
  bool repeatFlag_4 = true ;
  while (repeatFlag_4) {
    switch (select_plm_5F_syntax_22 (inCompiler)) {
    case 2: {
      GALGAS_controlRegisterNameListAST var_registerDeclarationList_4482 = GALGAS_controlRegisterNameListAST::constructor_emptyList (SOURCE_FILE ("declaration-control-register.galgas", 114)) ;
      bool repeatFlag_5 = true ;
      while (repeatFlag_5) {
        nt_registerDeclaration_ (ioArgument_ioAST, var_registerDeclarationList_4482, inCompiler) ;
        switch (select_plm_5F_syntax_23 (inCompiler)) {
        case 2: {
          inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__2C_ COMMA_SOURCE_FILE ("declaration-control-register.galgas", 118)) ;
        } break ;
        default:
          repeatFlag_5 = false ;
          break ;
      ...
      GALGAS_lstring var_registerTypeName_4654 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("declaration-control-register.galgas", 121)) ;
      GALGAS_controlRegisterBitSliceList var_registerBitSliceList_4710 = GALGAS_controlRegisterBitSliceList::constructor_emptyList (SOURCE_FILE ("declaration-control-register.galgas", 122)) ;
      switch (select_plm_5F_syntax_24 (inCompiler)) {
      case 1: {
      } break ;
      case 2: {
        inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__7B_ COMMA_SOURCE_FILE ("declaration-control-register.galgas", 125)) ;
        bool repeatFlag_6 = true ;
        while (repeatFlag_6) {
          GALGAS_controlRegisterBitSlice var_registerBitSlice_4816 ;
          switch (select_plm_5F_syntax_26 (inCompiler)) {
          case 1: {
            GALGAS_lbigint var_unusedBitCount_4884 = inCompiler->synthetizedAttribute_bigInteger () ;
            inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_integer COMMA_SOURCE_FILE ("declaration-control-register.galgas", 129)) ;
            var_registerBitSlice_4816 = GALGAS_controlRegisterBitSlice::constructor_unusedBits (var_unusedBitCount_4884  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 130)) ;
          } break ;
          case 2: {
            GALGAS_lstring var_bitName_5002 = inCompiler->synthetizedAttribute_tokenString () ;
            ...
            case 1: {
              var_registerBitSlice_4816 = GALGAS_controlRegisterBitSlice::constructor_namedBit (var_bitName_5002, GALGAS_lbigint::constructor_new (GALGAS_bigint ("1", inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 134)), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 134))  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 134))  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 134)) ;
            } break ;
            case 2: {
              inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__3A_ COMMA_SOURCE_FILE ("declaration-control-register.galgas", 136)) ;
              GALGAS_lbigint var_bitCount_5184 = inCompiler->synthetizedAttribute_bigInteger () ;
              inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_integer COMMA_SOURCE_FILE ("declaration-control-register.galgas", 137)) ;
              var_registerBitSlice_4816 = GALGAS_controlRegisterBitSlice::constructor_namedBit (var_bitName_5002, var_bitCount_5184  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 138)) ;
            } break ;
            default:
              break ;
            }
          ...
          var_registerBitSliceList_4710.addAssign_operation (var_registerBitSlice_4816  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 141)) ;
          switch (select_plm_5F_syntax_25 (inCompiler)) {
          case 2: {
            inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__2C_ COMMA_SOURCE_FILE ("declaration-control-register.galgas", 143)) ;
          } break ;
          default:
            repeatFlag_6 = false ;
            break ;
        ...
        inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__7D_ COMMA_SOURCE_FILE ("declaration-control-register.galgas", 145)) ;
      } break ;
      default:
        break ;
      }
      GALGAS_location var_endOfBitSlice_5427 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 147)) ;
      var_controlRegisterDeclarationList_4398.addAssign_operation (var_registerDeclarationList_4482, var_registerTypeName_4654, var_registerBitSliceList_4710, var_endOfBitSlice_5427  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 148)) ;
    } break ;
    default:
      repeatFlag_4 = false ;
      break ;
  ...
  ioArgument_ioAST.mProperty_mDeclarationListAST.addAssign_operation (GALGAS_controlRegisterGroupDeclarationAST::constructor_new (var_registerGroupListAST_3461, var_controlRegisterDeclarationList_4398  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 150))  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 150)) ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__7D_ COMMA_SOURCE_FILE ("declaration-control-register.galgas", 154)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_registerDeclaration_i17_ (GALGAS_ast & ioArgument_ioAST,
                                                                         ...
                                                                         C_Lexique_plm_5F_lexique * inCompiler) {
  GALGAS_lstring var_registerName_5990 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("declaration-control-register.galgas", 160)) ;
  GALGAS_lstringlist var_attributeList_6021 = GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("declaration-control-register.galgas", 161)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_plm_5F_syntax_28 (inCompiler)) {
    case 2: {
      GALGAS_lstring var_attribute_6081 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__40_attribute COMMA_SOURCE_FILE ("declaration-control-register.galgas", 164)) ;
      var_attributeList_6021.addAssign_operation (var_attribute_6081  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 165)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  case 1: {
    GALGAS_expressionAST var_registerAddress_6182 ;
    nt_expression_ (ioArgument_ioAST, var_registerAddress_6182, inCompiler) ;
    ioArgument_ioRegisterDeclarationList.addAssign_operation (var_registerName_5990, GALGAS_controlRegisterKind::constructor_scalar (SOURCE_FILE ("declaration-control-register.galgas", 171)), var_attributeList_6021, var_registerAddress_6182, GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 174))  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 169)) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__5B_ COMMA_SOURCE_FILE ("declaration-control-register.galgas", 176)) ;
    GALGAS_expressionAST var_sizeExpression_6384 ;
    nt_expression_ (ioArgument_ioAST, var_sizeExpression_6384, inCompiler) ;
    GALGAS_location var_sizeExpressionLocation_6417 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 178)) ;
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__5D_ COMMA_SOURCE_FILE ("declaration-control-register.galgas", 179)) ;
    GALGAS_expressionAST var_baseAddressExpression_6498 ;
    nt_expression_ (ioArgument_ioAST, var_baseAddressExpression_6498, inCompiler) ;
    GALGAS_location var_baseAddressExpressionLocation_6538 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 181)) ;
    GALGAS_lstring var_attribute_6589 = inCompiler->synthetizedAttribute_tokenString () ;
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__40_attribute COMMA_SOURCE_FILE ("declaration-control-register.galgas", 182)) ;
    enumGalgasBool test_1 = kBoolTrue ;
    if (kBoolTrue == test_1) {
      test_1 = GALGAS_bool (kIsNotEqual, var_attribute_6589.getter_string (HERE).objectCompare (GALGAS_string ("inc"))).boolEnum () ;
      if (kBoolTrue == test_1) {
        TC_Array <C_FixItDescription> fixItArray2 ;
        appendFixItActions (fixItArray2, kFixItReplace, GALGAS_string ("@inc")) ;
        inCompiler->emitSemanticError (var_attribute_6589.getter_location (SOURCE_FILE ("declaration-control-register.galgas", 184)), GALGAS_string ("attribute should be @inc"), fixItArray2  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 184)) ;
      }
    }
    GALGAS_expressionAST var_arrayElementSizeExpression_6776 ;
    nt_expression_ (ioArgument_ioAST, var_arrayElementSizeExpression_6776, inCompiler) ;
    GALGAS_location var_arrayElementSizeExpressionLocation_6821 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 187)) ;
    ioArgument_ioRegisterDeclarationList.addAssign_operation (var_registerName_5990, GALGAS_controlRegisterKind::constructor_registerArray (var_sizeExpression_6384, var_sizeExpressionLocation_6417, var_arrayElementSizeExpression_6776, var_arrayElementSizeExpressionLocation_6821  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 190)), var_attributeList_6021, var_baseAddressExpression_6498, var_baseAddressExpressionLocation_6538  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 188)) ;
  } break ;
  default:
    break ;
  }
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_i18_ (GALGAS_ast & ioArgument_ioAST,
                                                                 C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_registers COMMA_SOURCE_FILE ("declaration-control-register.galgas", 205)) ;
  GALGAS_lstring var_attribute_7463 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  enumGalgasBool test_0 = kBoolTrue ;
  if (kBoolTrue == test_0) {
    test_0 = GALGAS_bool (kIsNotEqual, var_attribute_7463.getter_string (HERE).objectCompare (function_userAttributeForRegister (inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 207)))).boolEnum () ;
    if (kBoolTrue == test_0) {
      TC_Array <C_FixItDescription> fixItArray1 ;
      inCompiler->emitSemanticError (var_attribute_7463.getter_location (SOURCE_FILE ("declaration-control-register.galgas", 208)), GALGAS_string ("this attribute should be @").add_operation (function_userAttributeForRegister (inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 208)), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 208)), fixItArray1  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 208)) ;
    }
  }
  bool repeatFlag_2 = true ;
  while (repeatFlag_2) {
    GALGAS_lstring var_registerGroupName_7667 = inCompiler->synthetizedAttribute_tokenString () ;
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__23_groupName COMMA_SOURCE_FILE ("declaration-control-register.galgas", 211)) ;
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__3A_ COMMA_SOURCE_FILE ("declaration-control-register.galgas", 212)) ;
    GALGAS_lstring var_registerName_7714 = inCompiler->synthetizedAttribute_tokenString () ;
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("declaration-control-register.galgas", 213)) ;
    GALGAS_lstring var_key_7728 = GALGAS_lstring::constructor_new (GALGAS_string ("#").add_operation (var_registerGroupName_7667.getter_string (SOURCE_FILE ("declaration-control-register.galgas", 214)), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 214)).add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 214)).add_operation (var_registerName_7714.getter_string (SOURCE_FILE ("declaration-control-register.galgas", 214)), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 214)), var_registerName_7714.getter_location (HERE)  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 214)) ;
    {
    ioArgument_ioAST.mProperty_mControlRegisterUserAccesMapAST.setter_insertKey (var_key_7728, inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 215)) ;
    }
    switch (select_plm_5F_syntax_30 (inCompiler)) {
    case 2: {
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__2C_ COMMA_SOURCE_FILE ("declaration-control-register.galgas", 217)) ;
    } break ;
    default:
      repeatFlag_2 = false ;
      break ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_i19_ (GALGAS_ast & ioArgument_ioAST,
  ...
  case 2: {
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__3A_ COMMA_SOURCE_FILE ("declaration-global-constant.galgas", 39)) ;
    nt_type_5F_definition_ (ioArgument_ioAST, var_typeName_1603, inCompiler) ;
  } break ;
  default:
    break ;
  }
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__3D_ COMMA_SOURCE_FILE ("declaration-global-constant.galgas", 42)) ;
  GALGAS_expressionAST var_expression_1775 ;
  nt_expression_ (ioArgument_ioAST, var_expression_1775, inCompiler) ;
  ioArgument_ioAST.mProperty_mDeclarationListAST.addAssign_operation (GALGAS_globalConstantDeclarationAST::constructor_new (var_constantName_1448, var_attributeList_1479, var_typeName_1603, var_expression_1775  COMMA_SOURCE_FILE ("declaration-global-constant.galgas", 44))  COMMA_SOURCE_FILE ("declaration-global-constant.galgas", 44)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_i21_ (GALGAS_ast & ioArgument_ioAST,
                                                                 C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_driver COMMA_SOURCE_FILE ("declaration-driver.galgas", 78)) ;
  GALGAS_lstring var_driverName_3113 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("declaration-driver.galgas", 79)) ;
  GALGAS_lstringlist var_driverDependenceList_3151 = GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("declaration-driver.galgas", 80)) ;
  switch (select_plm_5F_syntax_34 (inCompiler)) {
  case 1: {
  } break ;
  case 2: {
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__3E_ COMMA_SOURCE_FILE ("declaration-driver.galgas", 83)) ;
    bool repeatFlag_0 = true ;
    while (repeatFlag_0) {
      GALGAS_lstring var_dependenceName_3238 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("declaration-driver.galgas", 85)) ;
      var_driverDependenceList_3151.addAssign_operation (var_dependenceName_3238  COMMA_SOURCE_FILE ("declaration-driver.galgas", 86)) ;
      switch (select_plm_5F_syntax_35 (inCompiler)) {
      case 2: {
        inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__2C_ COMMA_SOURCE_FILE ("declaration-driver.galgas", 88)) ;
      } break ;
      default:
        repeatFlag_0 = false ;
        break ;
  ...
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__7B_ COMMA_SOURCE_FILE ("declaration-driver.galgas", 91)) ;
  GALGAS_functionDeclarationListAST var_functionDeclarationListAST_3402 = GALGAS_functionDeclarationListAST::constructor_emptyList (SOURCE_FILE ("declaration-driver.galgas", 92)) ;
  GALGAS_structurePropertyListAST var_propertyListAST_3508 = GALGAS_structurePropertyListAST::constructor_emptyList (SOURCE_FILE ("declaration-driver.galgas", 94)) ;
  GALGAS_guardDeclarationListAST var_guardListAST_3555 = GALGAS_guardDeclarationListAST::constructor_emptyList (SOURCE_FILE ("declaration-driver.galgas", 95)) ;
  GALGAS_systemRoutineDeclarationListAST var_svcListAST_3608 = GALGAS_systemRoutineDeclarationListAST::constructor_emptyList (SOURCE_FILE ("declaration-driver.galgas", 96)) ;
  GALGAS_bool var_bootHandled_3633 = GALGAS_bool (false) ;
  GALGAS_location var_bootLocation_3662 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-driver.galgas", 98)) ;
  GALGAS_instructionListAST var_bootInstructionList_3723 = GALGAS_instructionListAST::constructor_emptyList (SOURCE_FILE ("declaration-driver.galgas", 99)) ;
  GALGAS_location var_bootEndLocation_3752 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-driver.galgas", 100)) ;
  GALGAS_bool var_startupHandled_3792 = GALGAS_bool (false) ;
  GALGAS_location var_startupLocation_3824 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-driver.galgas", 102)) ;
  GALGAS_instructionListAST var_startupInstructionList_3888 = GALGAS_instructionListAST::constructor_emptyList (SOURCE_FILE ("declaration-driver.galgas", 103)) ;
  GALGAS_location var_startupEndLocation_3920 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-driver.galgas", 104)) ;
  bool repeatFlag_1 = true ;
  while (repeatFlag_1) {
    switch (select_plm_5F_syntax_36 (inCompiler)) {
    case 2: {
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_boot COMMA_SOURCE_FILE ("declaration-driver.galgas", 107)) ;
      var_bootLocation_3662 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-driver.galgas", 108)) ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__7B_ COMMA_SOURCE_FILE ("declaration-driver.galgas", 109)) ;
      nt_instructionList_ (ioArgument_ioAST, var_bootInstructionList_3723, inCompiler) ;
      var_bootEndLocation_3752 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-driver.galgas", 111)) ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__7D_ COMMA_SOURCE_FILE ("declaration-driver.galgas", 112)) ;
      enumGalgasBool test_2 = kBoolTrue ;
      if (kBoolTrue == test_2) {
        test_2 = var_bootHandled_3633.boolEnum () ;
        if (kBoolTrue == test_2) {
          TC_Array <C_FixItDescription> fixItArray3 ;
          inCompiler->emitSemanticError (var_bootLocation_3662, GALGAS_string ("a driver supports at most one boot routine"), fixItArray3  COMMA_SOURCE_FILE ("declaration-driver.galgas", 114)) ;
        }
      }
      var_bootHandled_3633 = GALGAS_bool (true) ;
    } break ;
    case 3: {
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_startup COMMA_SOURCE_FILE ("declaration-driver.galgas", 118)) ;
      var_startupLocation_3824 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-driver.galgas", 119)) ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__7B_ COMMA_SOURCE_FILE ("declaration-driver.galgas", 120)) ;
      nt_instructionList_ (ioArgument_ioAST, var_startupInstructionList_3888, inCompiler) ;
      var_startupEndLocation_3920 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-driver.galgas", 122)) ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__7D_ COMMA_SOURCE_FILE ("declaration-driver.galgas", 123)) ;
      enumGalgasBool test_4 = kBoolTrue ;
      if (kBoolTrue == test_4) {
        test_4 = var_startupHandled_3792.boolEnum () ;
        if (kBoolTrue == test_4) {
          TC_Array <C_FixItDescription> fixItArray5 ;
          inCompiler->emitSemanticError (var_startupLocation_3824, GALGAS_string ("a driver supports at most one startup routine"), fixItArray5  COMMA_SOURCE_FILE ("declaration-driver.galgas", 125)) ;
        }
      }
      var_startupHandled_3792 = GALGAS_bool (true) ;
    } break ;
    case 4: {
      nt_isr_ (ioArgument_ioAST, var_driverName_3113, inCompiler) ;
    } break ;
    case 5: {
      nt_struct_5F_property_5F_declaration_ (ioArgument_ioAST, GALGAS_bool (false), var_propertyListAST_3508, inCompiler) ;
    } break ;
    case 6: {
      nt_function_ (ioArgument_ioAST, var_functionDeclarationListAST_3402, inCompiler) ;
    } break ;
    case 7: {
      nt_system_5F_routine_ (ioArgument_ioAST, var_svcListAST_3608, inCompiler) ;
    } break ;
    case 8: {
      nt_guard_ (ioArgument_ioAST, var_guardListAST_3555, inCompiler) ;
    } break ;
    default:
      repeatFlag_1 = false ;
      break ;
  ...
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__7D_ COMMA_SOURCE_FILE ("declaration-driver.galgas", 139)) ;
  ioArgument_ioAST.mProperty_mDriverDeclarationListAST.addAssign_operation (GALGAS_driverDeclarationAST::constructor_new (var_driverName_3113, var_driverDependenceList_3151, var_propertyListAST_3508, var_functionDeclarationListAST_3402, var_svcListAST_3608, var_guardListAST_3555, var_bootLocation_3662, var_bootInstructionList_3723, var_bootEndLocation_3752, var_startupLocation_3824, var_startupInstructionList_3888, var_startupEndLocation_3920  COMMA_SOURCE_FILE ("declaration-driver.galgas", 141))  COMMA_SOURCE_FILE ("declaration-driver.galgas", 141)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_i22_ (GALGAS_ast & ioArgument_ioAST,
                                                                 C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_driver COMMA_SOURCE_FILE ("declaration-driver.galgas", 160)) ;
  GALGAS_lstring var_driverName_5463 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("declaration-driver.galgas", 161)) ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__28_ COMMA_SOURCE_FILE ("declaration-driver.galgas", 162)) ;
  GALGAS_driverInstanciationArgumentListAST var_driverInstanciationArgumentList_5543 = GALGAS_driverInstanciationArgumentListAST::constructor_emptyList (SOURCE_FILE ("declaration-driver.galgas", 163)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_plm_5F_syntax_37 (inCompiler)) {
    case 2: {
      GALGAS_lstring var_selector_5602 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__21_selector_3A_ COMMA_SOURCE_FILE ("declaration-driver.galgas", 166)) ;
      GALGAS_expressionAST var_expression_5645 ;
      nt_expression_ (ioArgument_ioAST, var_expression_5645, inCompiler) ;
      var_driverInstanciationArgumentList_5543.addAssign_operation (var_selector_5602, var_expression_5645  COMMA_SOURCE_FILE ("declaration-driver.galgas", 168)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__29_ COMMA_SOURCE_FILE ("declaration-driver.galgas", 170)) ;
  ioArgument_ioAST.mProperty_mRequiredDriverListAST.addAssign_operation (var_driverName_5463, var_driverInstanciationArgumentList_5543  COMMA_SOURCE_FILE ("declaration-driver.galgas", 171)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_staticArrayProperty_i25_ (GALGAS_ast & ioArgument_ioAST,
  ...
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__3A_ COMMA_SOURCE_FILE ("declaration-static-list.galgas", 78)) ;
  switch (select_plm_5F_syntax_39 (inCompiler)) {
  case 1: {
    GALGAS_lstring var_typeName_3176 ;
    nt_type_5F_definition_ (ioArgument_ioAST, var_typeName_3176, inCompiler) ;
    ioArgument_ioPropertyList.addAssign_operation (var_propertyName_3111, GALGAS_staticListPropertyTypeAST::constructor_valueType (var_typeName_3176  COMMA_SOURCE_FILE ("declaration-static-list.galgas", 81))  COMMA_SOURCE_FILE ("declaration-static-list.galgas", 81)) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_func COMMA_SOURCE_FILE ("declaration-static-list.galgas", 83)) ;
    GALGAS_mode var_mode_3285 ;
    nt_mode_ (var_mode_3285, inCompiler) ;
    GALGAS_lstringlist var_attributeList_3318 = GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("declaration-static-list.galgas", 85)) ;
    bool repeatFlag_0 = true ;
    while (repeatFlag_0) {
      switch (select_plm_5F_syntax_40 (inCompiler)) {
      case 2: {
        GALGAS_lstring var_attribute_3384 = inCompiler->synthetizedAttribute_tokenString () ;
        inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__40_attribute COMMA_SOURCE_FILE ("declaration-static-list.galgas", 88)) ;
        var_attributeList_3318.addAssign_operation (var_attribute_3384  COMMA_SOURCE_FILE ("declaration-static-list.galgas", 89)) ;
      } break ;
      default:
        repeatFlag_0 = false ;
        break ;
    ...
    GALGAS_routineFormalArgumentListAST var_formalArgs_3489 ;
    nt_procedure_5F_formal_5F_arguments_ (ioArgument_ioAST, var_formalArgs_3489, inCompiler) ;
    GALGAS_lstring var_returnType_3515 ;
    switch (select_plm_5F_syntax_41 (inCompiler)) {
    case 1: {
      var_returnType_3515 = GALGAS_string::makeEmptyString ().getter_here (inCompiler COMMA_SOURCE_FILE ("declaration-static-list.galgas", 94)) ;
    } break ;
    case 2: {
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__2D__3E_ COMMA_SOURCE_FILE ("declaration-static-list.galgas", 96)) ;
      nt_type_5F_definition_ (ioArgument_ioAST, var_returnType_3515, inCompiler) ;
    } break ;
    default:
      break ;
    }
    ioArgument_ioPropertyList.addAssign_operation (var_propertyName_3111, GALGAS_staticListPropertyTypeAST::constructor_function (var_mode_3285, var_formalArgs_3489, var_returnType_3515  COMMA_SOURCE_FILE ("declaration-static-list.galgas", 99))  COMMA_SOURCE_FILE ("declaration-static-list.galgas", 99)) ;
  } break ;
  default:
    break ;
  }
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_i26_ (GALGAS_ast & ioArgument_ioAST,
                                                                 C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_extend COMMA_SOURCE_FILE ("declaration-static-list.galgas", 108)) ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_staticArray COMMA_SOURCE_FILE ("declaration-static-list.galgas", 109)) ;
  GALGAS_lstring var_staticListName_4126 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("declaration-static-list.galgas", 110)) ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__28_ COMMA_SOURCE_FILE ("declaration-static-list.galgas", 111)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    GALGAS_extendStaticListElementAST var_expressions_4191 = GALGAS_extendStaticListElementAST::constructor_emptyList (SOURCE_FILE ("declaration-static-list.galgas", 113)) ;
    bool repeatFlag_1 = true ;
    while (repeatFlag_1) {
      nt_staticArray_5F_exp_ (ioArgument_ioAST, var_expressions_4191, inCompiler) ;
      switch (select_plm_5F_syntax_43 (inCompiler)) {
      case 2: {
        inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__2C_ COMMA_SOURCE_FILE ("declaration-static-list.galgas", 117)) ;
      } break ;
      default:
        repeatFlag_1 = false ;
        break ;
    ...
    GALGAS_staticListValueListAST var_expressionList_4336 = GALGAS_staticListValueListAST::constructor_emptyList (SOURCE_FILE ("declaration-static-list.galgas", 119)) ;
    enumGalgasBool test_2 = kBoolTrue ;
    if (kBoolTrue == test_2) {
      test_2 = ioArgument_ioAST.getter_mExtendStaticArrayDeclarationAST (HERE).getter_hasKey (var_staticListName_4126.getter_string (SOURCE_FILE ("declaration-static-list.galgas", 120)) COMMA_SOURCE_FILE ("declaration-static-list.galgas", 120)).boolEnum () ;
      if (kBoolTrue == test_2) {
        ioArgument_ioAST.getter_mExtendStaticArrayDeclarationAST (HERE).method_searchKey (var_staticListName_4126.getter_string (SOURCE_FILE ("declaration-static-list.galgas", 121)), var_expressionList_4336, inCompiler COMMA_SOURCE_FILE ("declaration-static-list.galgas", 121)) ;
      }
    }
    var_expressionList_4336.addAssign_operation (var_expressions_4191, GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-static-list.galgas", 123))  COMMA_SOURCE_FILE ("declaration-static-list.galgas", 123)) ;
    ioArgument_ioAST.mProperty_mExtendStaticArrayDeclarationAST.addAssign_operation (var_staticListName_4126.getter_string (SOURCE_FILE ("declaration-static-list.galgas", 124)), var_expressionList_4336, inCompiler  COMMA_SOURCE_FILE ("declaration-static-list.galgas", 124)) ;
    switch (select_plm_5F_syntax_42 (inCompiler)) {
    case 2: {
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__3A__3A_ COMMA_SOURCE_FILE ("declaration-static-list.galgas", 126)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__29_ COMMA_SOURCE_FILE ("declaration-static-list.galgas", 128)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_staticArray_5F_exp_i27_ (GALGAS_ast & ioArgument_ioAST,
  ...
  case 1: {
    GALGAS_expressionAST var_exp_4939 ;
    nt_expression_ (ioArgument_ioAST, var_exp_4939, inCompiler) ;
    ioArgument_ioExpressions.addAssign_operation (GALGAS_extendStaticListExpressionAST::constructor_expression (var_exp_4939  COMMA_SOURCE_FILE ("declaration-static-list.galgas", 136)), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-static-list.galgas", 136))  COMMA_SOURCE_FILE ("declaration-static-list.galgas", 136)) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_func COMMA_SOURCE_FILE ("declaration-static-list.galgas", 138)) ;
    GALGAS_lstring var_functionName_5050 = inCompiler->synthetizedAttribute_tokenString () ;
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("declaration-static-list.galgas", 139)) ;
    GALGAS_routineFormalArgumentListAST var_formalArgs_5109 ;
    nt_procedure_5F_formal_5F_arguments_ (ioArgument_ioAST, var_formalArgs_5109, inCompiler) ;
    ioArgument_ioExpressions.addAssign_operation (GALGAS_extendStaticListExpressionAST::constructor_function (var_functionName_5050, var_formalArgs_5109  COMMA_SOURCE_FILE ("declaration-static-list.galgas", 142)), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-static-list.galgas", 143))  COMMA_SOURCE_FILE ("declaration-static-list.galgas", 141)) ;
  } break ;
  default:
    break ;
  }
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_i29_ (GALGAS_ast & ioArgument_ioAST,
  ...
  while (repeatFlag_5) {
    ...
    case 4: {
      ...
      if (kBoolTrue == test_7) {
        test_7 = GALGAS_bool (kIsEqual, var_attribute_3292.getter_string (HERE).objectCompare (GALGAS_string ("setup"))).boolEnum () ;
        if (kBoolTrue == test_7) {
      ...
      if (kBoolFalse == test_7) {
        ...
        if (kBoolTrue == test_8) {
          test_8 = GALGAS_bool (kIsEqual, var_attribute_3292.getter_string (HERE).objectCompare (GALGAS_string ("activate"))).boolEnum () ;
          if (kBoolTrue == test_8) {
        ...
        if (kBoolFalse == test_8) {
          ...
          if (kBoolTrue == test_9) {
            test_9 = GALGAS_bool (kIsEqual, var_attribute_3292.getter_string (HERE).objectCompare (GALGAS_string ("deactivate"))).boolEnum () ;
            if (kBoolTrue == test_9) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_procedure_5F_formal_5F_arguments_i40_ (GALGAS_ast & ioArgument_ioAST,
  ...
  while (repeatFlag_0) {
    ...
    case 2: {
      ...
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__3A_ COMMA_SOURCE_FILE ("formal-arguments.galgas", 58)) ;
      GALGAS_lstring var_formalArgumentTypeName_2321 ;
      nt_type_5F_definition_ (ioArgument_ioAST, var_formalArgumentTypeName_2321, inCompiler) ;
      outArgument_outProcFormalArgumentList.addAssign_operation (GALGAS_procFormalArgumentPassingMode::constructor_output (SOURCE_FILE ("formal-arguments.galgas", 61)), var_selector_2207, var_formalArgumentTypeName_2321, var_formalArgumentName_2250  COMMA_SOURCE_FILE ("formal-arguments.galgas", 60)) ;
    } break ;
    case 3: {
      GALGAS_lstring var_selector_2525 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__3F__21_selector_3A_ COMMA_SOURCE_FILE ("formal-arguments.galgas", 66)) ;
      GALGAS_lstring var_formalArgumentName_2568 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("formal-arguments.galgas", 67)) ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__3A_ COMMA_SOURCE_FILE ("formal-arguments.galgas", 68)) ;
      GALGAS_lstring var_formalArgumentTypeName_2638 ;
      nt_type_5F_definition_ (ioArgument_ioAST, var_formalArgumentTypeName_2638, inCompiler) ;
      outArgument_outProcFormalArgumentList.addAssign_operation (GALGAS_procFormalArgumentPassingMode::constructor_inputOutput (SOURCE_FILE ("formal-arguments.galgas", 71)), var_selector_2525, var_formalArgumentTypeName_2638, var_formalArgumentName_2568  COMMA_SOURCE_FILE ("formal-arguments.galgas", 70)) ;
    } break ;
    case 4: {
      GALGAS_lstring var_selector_2846 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__3F_selector_3A_ COMMA_SOURCE_FILE ("formal-arguments.galgas", 76)) ;
      GALGAS_lstring var_formalArgumentName_2889 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("formal-arguments.galgas", 77)) ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__3A_ COMMA_SOURCE_FILE ("formal-arguments.galgas", 78)) ;
      GALGAS_lstring var_formalArgumentTypeName_2960 ;
      nt_type_5F_definition_ (ioArgument_ioAST, var_formalArgumentTypeName_2960, inCompiler) ;
      outArgument_outProcFormalArgumentList.addAssign_operation (GALGAS_procFormalArgumentPassingMode::constructor_input (SOURCE_FILE ("formal-arguments.galgas", 81)), var_selector_2846, var_formalArgumentTypeName_2960, var_formalArgumentName_2889  COMMA_SOURCE_FILE ("formal-arguments.galgas", 80)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__29_ COMMA_SOURCE_FILE ("formal-arguments.galgas", 86)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_procedure_5F_input_5F_formal_5F_arguments_i41_ (GALGAS_ast & ioArgument_ioAST,
                                                                                               ...
                                                                                               C_Lexique_plm_5F_lexique * inCompiler) {
  outArgument_outProcFormalArgumentList.drop () ; // Release 'out' argument
  outArgument_outProcFormalArgumentList = GALGAS_routineFormalArgumentListAST::constructor_emptyList (SOURCE_FILE ("formal-arguments.galgas", 92)) ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__28_ COMMA_SOURCE_FILE ("formal-arguments.galgas", 93)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_plm_5F_syntax_73 (inCompiler)) {
    case 2: {
      GALGAS_lstring var_selector_3473 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__3F_selector_3A_ COMMA_SOURCE_FILE ("formal-arguments.galgas", 96)) ;
      GALGAS_lstring var_formalArgumentName_3516 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("formal-arguments.galgas", 97)) ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__3A_ COMMA_SOURCE_FILE ("formal-arguments.galgas", 98)) ;
      GALGAS_lstring var_formalArgumentTypeName_3587 ;
      nt_type_5F_definition_ (ioArgument_ioAST, var_formalArgumentTypeName_3587, inCompiler) ;
      outArgument_outProcFormalArgumentList.addAssign_operation (GALGAS_procFormalArgumentPassingMode::constructor_input (SOURCE_FILE ("formal-arguments.galgas", 101)), var_selector_3473, var_formalArgumentTypeName_3587, var_formalArgumentName_3516  COMMA_SOURCE_FILE ("formal-arguments.galgas", 100)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__29_ COMMA_SOURCE_FILE ("formal-arguments.galgas", 106)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_expression_5F_equality_i49_ (GALGAS_ast & ioArgument_ioAST,
  ...
  case 3: {
    ...
    GALGAS_infixOperatorExpressionAST var_expression_5268 = GALGAS_infixOperatorExpressionAST::constructor_new (outArgument_outExpression, var_operatorLocation_5008, GALGAS_infixOperator::constructor_equal (SOURCE_FILE ("expression-operator-priority.galgas", 154)), var_rightExpression_5084  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 151)) ;
    outArgument_outExpression = GALGAS_prefixOperatorExpressionAST::constructor_new (var_operatorLocation_5008, GALGAS_prefixOperator::constructor_notOperator (SOURCE_FILE ("expression-operator-priority.galgas", 159)), var_expression_5268  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 157)) ;
  } break ;
  default:
    break ;
  }
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_expression_5F_comparison_i50_ (GALGAS_ast & ioArgument_ioAST,
  ...
  case 2: {
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__2264_ COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 171)) ;
    GALGAS_location var_operatorLocation_5847 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 172)) ;
    GALGAS_expressionAST var_rightExpression_5918 ;
    nt_expression_5F_shift_ (ioArgument_ioAST, var_rightExpression_5918, inCompiler) ;
    outArgument_outExpression = GALGAS_infixOperatorExpressionAST::constructor_new (outArgument_outExpression, var_operatorLocation_5847, GALGAS_infixOperator::constructor_infEqual (SOURCE_FILE ("expression-operator-priority.galgas", 177)), var_rightExpression_5918  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 174)) ;
  } break ;
  case 3: {
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__2265_ COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 181)) ;
    GALGAS_location var_operatorLocation_6119 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 182)) ;
    GALGAS_expressionAST var_rightExpression_6190 ;
    nt_expression_5F_shift_ (ioArgument_ioAST, var_rightExpression_6190, inCompiler) ;
    GALGAS_infixOperatorExpressionAST var_expression_6374 = GALGAS_infixOperatorExpressionAST::constructor_new (outArgument_outExpression, var_operatorLocation_6119, GALGAS_infixOperator::constructor_strictInf (SOURCE_FILE ("expression-operator-priority.galgas", 193)), var_rightExpression_6190  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 190)) ;
    outArgument_outExpression = GALGAS_prefixOperatorExpressionAST::constructor_new (var_operatorLocation_6119, GALGAS_prefixOperator::constructor_notOperator (SOURCE_FILE ("expression-operator-priority.galgas", 198)), var_expression_6374  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 196)) ;
  } break ;
  case 4: {
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__3C_ COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 202)) ;
    GALGAS_location var_operatorLocation_6689 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 203)) ;
    GALGAS_expressionAST var_rightExpression_6760 ;
    nt_expression_5F_shift_ (ioArgument_ioAST, var_rightExpression_6760, inCompiler) ;
    outArgument_outExpression = GALGAS_infixOperatorExpressionAST::constructor_new (outArgument_outExpression, var_operatorLocation_6689, GALGAS_infixOperator::constructor_strictInf (SOURCE_FILE ("expression-operator-priority.galgas", 208)), var_rightExpression_6760  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 205)) ;
  } break ;
  case 5: {
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__3E_ COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 212)) ;
    GALGAS_location var_operatorLocation_6962 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 213)) ;
    GALGAS_expressionAST var_rightExpression_7033 ;
    nt_expression_5F_shift_ (ioArgument_ioAST, var_rightExpression_7033, inCompiler) ;
    GALGAS_infixOperatorExpressionAST var_expression_7218 = GALGAS_infixOperatorExpressionAST::constructor_new (outArgument_outExpression, var_operatorLocation_6962, GALGAS_infixOperator::constructor_infEqual (SOURCE_FILE ("expression-operator-priority.galgas", 224)), var_rightExpression_7033  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 221)) ;
    outArgument_outExpression = GALGAS_prefixOperatorExpressionAST::constructor_new (var_operatorLocation_6962, GALGAS_prefixOperator::constructor_notOperator (SOURCE_FILE ("expression-operator-priority.galgas", 229)), var_expression_7218  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 227)) ;
  } break ;
  default:
    break ;
  }
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_expression_5F_shift_i51_ (GALGAS_ast & ioArgument_ioAST,
  ...
  while (repeatFlag_0) {
    ...
    case 2: {
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__3C__3C_ COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 241)) ;
      GALGAS_location var_operatorLocation_7802 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 242)) ;
      GALGAS_expressionAST var_rightExpression_7876 ;
      nt_expression_5F_addition_ (ioArgument_ioAST, var_rightExpression_7876, inCompiler) ;
      outArgument_outExpression = GALGAS_infixOperatorExpressionAST::constructor_new (outArgument_outExpression, var_operatorLocation_7802, GALGAS_infixOperator::constructor_leftShiftOp (SOURCE_FILE ("expression-operator-priority.galgas", 247)), var_rightExpression_7876  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 244)) ;
    } break ;
    case 3: {
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__3E__3E_ COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 251)) ;
      GALGAS_location var_operatorLocation_8084 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 252)) ;
      GALGAS_expressionAST var_rightExpression_8158 ;
      nt_expression_5F_addition_ (ioArgument_ioAST, var_rightExpression_8158, inCompiler) ;
      outArgument_outExpression = GALGAS_infixOperatorExpressionAST::constructor_new (outArgument_outExpression, var_operatorLocation_8084, GALGAS_infixOperator::constructor_rightShiftOp (SOURCE_FILE ("expression-operator-priority.galgas", 257)), var_rightExpression_8158  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 254)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_expression_5F_addition_i52_ (GALGAS_ast & ioArgument_ioAST,
  ...
  while (repeatFlag_0) {
    ...
    case 2: {
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__2B_ COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 269)) ;
      GALGAS_location var_operatorLocation_8634 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 270)) ;
      GALGAS_expressionAST var_rightExpression_8707 ;
      nt_expression_5F_product_ (ioArgument_ioAST, var_rightExpression_8707, inCompiler) ;
      outArgument_outExpression = GALGAS_infixOperatorExpressionAST::constructor_new (outArgument_outExpression, var_operatorLocation_8634, GALGAS_infixOperator::constructor_addOp (SOURCE_FILE ("expression-operator-priority.galgas", 275)), var_rightExpression_8707  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 272)) ;
    } break ;
    case 3: {
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__2B__25_ COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 279)) ;
      GALGAS_location var_operatorLocation_8909 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 280)) ;
      GALGAS_expressionAST var_rightExpression_8982 ;
      nt_expression_5F_product_ (ioArgument_ioAST, var_rightExpression_8982, inCompiler) ;
      outArgument_outExpression = GALGAS_infixOperatorExpressionAST::constructor_new (outArgument_outExpression, var_operatorLocation_8909, GALGAS_infixOperator::constructor_addOpNoOvf (SOURCE_FILE ("expression-operator-priority.galgas", 285)), var_rightExpression_8982  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 282)) ;
    } break ;
    case 4: {
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__2D_ COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 289)) ;
      GALGAS_location var_operatorLocation_9188 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 290)) ;
      GALGAS_expressionAST var_rightExpression_9261 ;
      nt_expression_5F_product_ (ioArgument_ioAST, var_rightExpression_9261, inCompiler) ;
      outArgument_outExpression = GALGAS_infixOperatorExpressionAST::constructor_new (outArgument_outExpression, var_operatorLocation_9188, GALGAS_infixOperator::constructor_subOp (SOURCE_FILE ("expression-operator-priority.galgas", 295)), var_rightExpression_9261  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 292)) ;
    } break ;
    case 5: {
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__2D__25_ COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 299)) ;
      GALGAS_location var_operatorLocation_9463 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 300)) ;
      GALGAS_expressionAST var_rightExpression_9536 ;
      nt_expression_5F_product_ (ioArgument_ioAST, var_rightExpression_9536, inCompiler) ;
      outArgument_outExpression = GALGAS_infixOperatorExpressionAST::constructor_new (outArgument_outExpression, var_operatorLocation_9463, GALGAS_infixOperator::constructor_subOpNoOvf (SOURCE_FILE ("expression-operator-priority.galgas", 305)), var_rightExpression_9536  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 302)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_expression_5F_product_i53_ (GALGAS_ast & ioArgument_ioAST,
  ...
  while (repeatFlag_0) {
    ...
    case 2: {
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__2A_ COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 317)) ;
      GALGAS_location var_operatorLocation_9998 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 318)) ;
      GALGAS_expressionAST var_rightExpression_10060 ;
      nt_primary_ (ioArgument_ioAST, var_rightExpression_10060, inCompiler) ;
      outArgument_outExpression = GALGAS_infixOperatorExpressionAST::constructor_new (outArgument_outExpression, var_operatorLocation_9998, GALGAS_infixOperator::constructor_mulOp (SOURCE_FILE ("expression-operator-priority.galgas", 323)), var_rightExpression_10060  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 320)) ;
    } break ;
    case 3: {
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__2A__25_ COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 327)) ;
      GALGAS_location var_operatorLocation_10262 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 328)) ;
      GALGAS_expressionAST var_rightExpression_10324 ;
      nt_primary_ (ioArgument_ioAST, var_rightExpression_10324, inCompiler) ;
      outArgument_outExpression = GALGAS_infixOperatorExpressionAST::constructor_new (outArgument_outExpression, var_operatorLocation_10262, GALGAS_infixOperator::constructor_mulOpNoOvf (SOURCE_FILE ("expression-operator-priority.galgas", 333)), var_rightExpression_10324  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 330)) ;
    } break ;
    case 4: {
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__25_ COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 337)) ;
      GALGAS_location var_operatorLocation_10530 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 338)) ;
      GALGAS_expressionAST var_rightExpression_10592 ;
      nt_primary_ (ioArgument_ioAST, var_rightExpression_10592, inCompiler) ;
      outArgument_outExpression = GALGAS_infixOperatorExpressionAST::constructor_new (outArgument_outExpression, var_operatorLocation_10530, GALGAS_infixOperator::constructor_modOp (SOURCE_FILE ("expression-operator-priority.galgas", 343)), var_rightExpression_10592  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 340)) ;
    } break ;
    case 5: {
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__21__25_ COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 347)) ;
      GALGAS_location var_operatorLocation_10794 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 348)) ;
      GALGAS_expressionAST var_rightExpression_10856 ;
      nt_primary_ (ioArgument_ioAST, var_rightExpression_10856, inCompiler) ;
      outArgument_outExpression = GALGAS_infixOperatorExpressionAST::constructor_new (outArgument_outExpression, var_operatorLocation_10794, GALGAS_infixOperator::constructor_modOpNoOvf (SOURCE_FILE ("expression-operator-priority.galgas", 353)), var_rightExpression_10856  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 350)) ;
    } break ;
    case 6: {
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__2F_ COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 357)) ;
      GALGAS_location var_operatorLocation_11062 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 358)) ;
      GALGAS_expressionAST var_rightExpression_11124 ;
      nt_primary_ (ioArgument_ioAST, var_rightExpression_11124, inCompiler) ;
      outArgument_outExpression = GALGAS_infixOperatorExpressionAST::constructor_new (outArgument_outExpression, var_operatorLocation_11062, GALGAS_infixOperator::constructor_divOp (SOURCE_FILE ("expression-operator-priority.galgas", 363)), var_rightExpression_11124  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 360)) ;
    } break ;
    case 7: {
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__21__2F_ COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 367)) ;
      GALGAS_location var_operatorLocation_11326 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 368)) ;
      GALGAS_expressionAST var_rightExpression_11388 ;
      nt_primary_ (ioArgument_ioAST, var_rightExpression_11388, inCompiler) ;
      outArgument_outExpression = GALGAS_infixOperatorExpressionAST::constructor_new (outArgument_outExpression, var_operatorLocation_11326, GALGAS_infixOperator::constructor_divOpNoOvf (SOURCE_FILE ("expression-operator-priority.galgas", 373)), var_rightExpression_11388  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 370)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_primary_i54_ (GALGAS_ast & ioArgument_ioAST,
                                                             ...
                                                             C_Lexique_plm_5F_lexique * inCompiler) {
  outArgument_outExpression.drop () ; // Release 'out' argument
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__7E_ COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 382)) ;
  GALGAS_location var_operatorLocation_11777 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 383)) ;
  GALGAS_expressionAST var_expression_11832 ;
  nt_primary_ (ioArgument_ioAST, var_expression_11832, inCompiler) ;
  outArgument_outExpression = GALGAS_prefixOperatorExpressionAST::constructor_new (var_operatorLocation_11777, GALGAS_prefixOperator::constructor_unsignedComplement (SOURCE_FILE ("expression-operator-priority.galgas", 387)), var_expression_11832  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 385)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_primary_i55_ (GALGAS_ast & ioArgument_ioAST,
                                                             ...
                                                             C_Lexique_plm_5F_lexique * inCompiler) {
  outArgument_outExpression.drop () ; // Release 'out' argument
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_not COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 395)) ;
  GALGAS_location var_operatorLocation_12186 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 396)) ;
  GALGAS_expressionAST var_expression_12241 ;
  nt_primary_ (ioArgument_ioAST, var_expression_12241, inCompiler) ;
  outArgument_outExpression = GALGAS_prefixOperatorExpressionAST::constructor_new (var_operatorLocation_12186, GALGAS_prefixOperator::constructor_notOperator (SOURCE_FILE ("expression-operator-priority.galgas", 400)), var_expression_12241  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 398)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_primary_i56_ (GALGAS_ast & ioArgument_ioAST,
                                                             ...
                                                             C_Lexique_plm_5F_lexique * inCompiler) {
  outArgument_outExpression.drop () ; // Release 'out' argument
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__2D_ COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 408)) ;
  GALGAS_location var_operatorLocation_12586 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 409)) ;
  GALGAS_expressionAST var_expression_12641 ;
  nt_primary_ (ioArgument_ioAST, var_expression_12641, inCompiler) ;
  outArgument_outExpression = GALGAS_prefixOperatorExpressionAST::constructor_new (var_operatorLocation_12586, GALGAS_prefixOperator::constructor_minus (SOURCE_FILE ("expression-operator-priority.galgas", 413)), var_expression_12641  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 411)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_primary_i57_ (GALGAS_ast & ioArgument_ioAST,
                                                             ...
                                                             C_Lexique_plm_5F_lexique * inCompiler) {
  outArgument_outExpression.drop () ; // Release 'out' argument
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__2D__25_ COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 421)) ;
  GALGAS_location var_operatorLocation_12981 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 422)) ;
  GALGAS_expressionAST var_expression_13036 ;
  nt_primary_ (ioArgument_ioAST, var_expression_13036, inCompiler) ;
  outArgument_outExpression = GALGAS_prefixOperatorExpressionAST::constructor_new (var_operatorLocation_12981, GALGAS_prefixOperator::constructor_minusNoOvf (SOURCE_FILE ("expression-operator-priority.galgas", 426)), var_expression_13036  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 424)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_primary_i58_ (GALGAS_ast & ioArgument_ioAST,
                                                             ...
                                                             C_Lexique_plm_5F_lexique * inCompiler) {
  outArgument_outExpression.drop () ; // Release 'out' argument
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__28_ COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 434)) ;
  nt_expression_ (ioArgument_ioAST, outArgument_outExpression, inCompiler) ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__29_ COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 436)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_primary_i65_ (GALGAS_ast & ioArgument_ioAST,
  ...
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__3A_ COMMA_SOURCE_FILE ("expression-sizeof.galgas", 36)) ;
  GALGAS_lstring var_typeName_1580 ;
  nt_type_5F_definition_ (ioArgument_ioAST, var_typeName_1580, inCompiler) ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__29_ COMMA_SOURCE_FILE ("expression-sizeof.galgas", 38)) ;
  outArgument_outExpression = GALGAS_sizeofTypeAST::constructor_new (var_typeName_1580  COMMA_SOURCE_FILE ("expression-sizeof.galgas", 39)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_primary_i66_ (GALGAS_ast & ioArgument_ioAST,
                                                             ...
                                                             C_Lexique_plm_5F_lexique * inCompiler) {
  outArgument_outExpression.drop () ; // Release 'out' argument
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__2E_ COMMA_SOURCE_FILE ("expression-typed-constant.galgas", 19)) ;
  GALGAS_lstring var_constantName_1110 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("expression-typed-constant.galgas", 20)) ;
  GALGAS_primaryInExpressionAccessListAST var_accessList_1192 ;
  nt_expression_5F_access_5F_list_ (ioArgument_ioAST, var_accessList_1192, inCompiler) ;
  outArgument_outExpression = GALGAS_typedConstantCallAST::constructor_new (var_constantName_1110, var_accessList_1192  COMMA_SOURCE_FILE ("expression-typed-constant.galgas", 24)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_primary_i79_ (GALGAS_ast & ioArgument_ioAST,
                                                             ...
                                                             C_Lexique_plm_5F_lexique * inCompiler) {
  outArgument_outExpression.drop () ; // Release 'out' argument
  GALGAS_lstring var_standaloneFunctionName_1164 ;
  nt_type_5F_definition_ (ioArgument_ioAST, var_standaloneFunctionName_1164, inCompiler) ;
  GALGAS_effectiveArgumentListAST var_arguments_1214 ;
  GALGAS_location var_endOfArguments_1234 ;
  nt_effective_5F_parameters_ (ioArgument_ioAST, var_arguments_1214, var_endOfArguments_1234, inCompiler) ;
  outArgument_outExpression = GALGAS_standaloneFunctionInExpressionAST::constructor_new (var_standaloneFunctionName_1164, var_arguments_1214, var_endOfArguments_1234  COMMA_SOURCE_FILE ("expression-standalone-function-call.galgas", 22)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_instructionList_i80_ (GALGAS_ast & ioArgument_ioAST,
  ...
  while (repeatFlag_0) {
    ...
    case 2: {
      ...
      case 1: {
        inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__3B_ COMMA_SOURCE_FILE ("instructionList.galgas", 30)) ;
      } break ;
      case 2: {
        GALGAS_string var_s_1369 = GALGAS_string::constructor_separatorString (inCompiler  COMMA_SOURCE_FILE ("instructionList.galgas", 32)) ;
        enumGalgasBool test_1 = kBoolTrue ;
        if (kBoolTrue == test_1) {
          test_1 = var_s_1369.getter_containsCharacter (GALGAS_char (TO_UNICODE (10)) COMMA_SOURCE_FILE ("instructionList.galgas", 33)).operator_not (SOURCE_FILE ("instructionList.galgas", 33)).boolEnum () ;
          if (kBoolTrue == test_1) {
            TC_Array <C_FixItDescription> fixItArray2 ;
            inCompiler->emitSemanticError (GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("instructionList.galgas", 34)), GALGAS_string ("instruction should be terminated by an end of line or a ';'"), fixItArray2  COMMA_SOURCE_FILE ("instructionList.galgas", 34)) ;
          }
        }
      } break ;
      default:
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_instruction_i86_ (GALGAS_ast & ioArgument_ioAST,
  ...
  enumGalgasBool test_0 = kBoolTrue ;
  if (kBoolTrue == test_0) {
    test_0 = GALGAS_bool (kIsNotEqual, var_attribute_1288.getter_string (HERE).objectCompare (GALGAS_string ("bit"))).boolEnum () ;
    if (kBoolTrue == test_0) {
      TC_Array <C_FixItDescription> fixItArray1 ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_instruction_i89_ (GALGAS_ast & ioArgument_ioAST,
  ...
  case 2: {
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__3A_ COMMA_SOURCE_FILE ("instruction-var.galgas", 33)) ;
    nt_type_5F_definition_ (ioArgument_ioAST, var_optionalTypeName_1382, inCompiler) ;
  } break ;
  default:
    break ;
  }
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__3D_ COMMA_SOURCE_FILE ("instruction-var.galgas", 36)) ;
  GALGAS_expressionAST var_expression_1570 ;
  nt_expression_ (ioArgument_ioAST, var_expression_1570, inCompiler) ;
  ioArgument_ioInstructionList.addAssign_operation (GALGAS_varInstructionWithAssignmentAST::constructor_new (var_varName_1352.getter_location (HERE), var_varName_1352, var_optionalTypeName_1382, var_expression_1570  COMMA_SOURCE_FILE ("instruction-var.galgas", 38))  COMMA_SOURCE_FILE ("instruction-var.galgas", 38)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_instruction_i90_ (GALGAS_ast & ioArgument_ioAST,
                                                                 GALGAS_instructionListAST & ioArgument_ioInstructionList,
                                                                 C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_var COMMA_SOURCE_FILE ("instruction-var.galgas", 49)) ;
  GALGAS_lstring var_varName_1965 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("instruction-var.galgas", 50)) ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__3A_ COMMA_SOURCE_FILE ("instruction-var.galgas", 51)) ;
  GALGAS_lstring var_typeName_2017 ;
  nt_type_5F_definition_ (ioArgument_ioAST, var_typeName_2017, inCompiler) ;
  ioArgument_ioInstructionList.addAssign_operation (GALGAS_varInstructionAST::constructor_new (var_varName_1965.getter_location (HERE), var_varName_1965, var_typeName_2017  COMMA_SOURCE_FILE ("instruction-var.galgas", 53))  COMMA_SOURCE_FILE ("instruction-var.galgas", 53)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_instruction_i91_ (GALGAS_ast & ioArgument_ioAST,
  ...
  case 2: {
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__3A_ COMMA_SOURCE_FILE ("instruction-let.galgas", 26)) ;
    nt_type_5F_definition_ (ioArgument_ioAST, var_optionalTypeName_1176, inCompiler) ;
  } break ;
  default:
    break ;
  }
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__3D_ COMMA_SOURCE_FILE ("instruction-let.galgas", 29)) ;
  GALGAS_expressionAST var_expression_1364 ;
  nt_expression_ (ioArgument_ioAST, var_expression_1364, inCompiler) ;
  ioArgument_ioInstructionList.addAssign_operation (GALGAS_letInstructionWithAssignmentAST::constructor_new (var_varName_1146.getter_location (HERE), var_varName_1146, var_optionalTypeName_1176, var_expression_1364  COMMA_SOURCE_FILE ("instruction-let.galgas", 31))  COMMA_SOURCE_FILE ("instruction-let.galgas", 31)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_instruction_i101_ (GALGAS_ast & ioArgument_ioAST,
  ...
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__3A_ COMMA_SOURCE_FILE ("instruction-for-in-lower-upper-bounds.galgas", 33)) ;
  GALGAS_lstring var_typeName_1489 ;
  nt_type_5F_definition_ (ioArgument_ioAST, var_typeName_1489, inCompiler) ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_in COMMA_SOURCE_FILE ("instruction-for-in-lower-upper-bounds.galgas", 35)) ;
  GALGAS_expressionAST var_lowerBoundExpression_1565 ;
  nt_expression_ (ioArgument_ioAST, var_lowerBoundExpression_1565, inCompiler) ;
  GALGAS_location var_endOf_5F_lowerBoundExpression_5F_instruction_1612 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("instruction-for-in-lower-upper-bounds.galgas", 37)) ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__2E__2E__3C_ COMMA_SOURCE_FILE ("instruction-for-in-lower-upper-bounds.galgas", 38)) ;
  GALGAS_expressionAST var_upperBoundExpression_1706 ;
  nt_expression_ (ioArgument_ioAST, var_upperBoundExpression_1706, inCompiler) ;
  GALGAS_location var_endOf_5F_upperBoundExpression_5F_instruction_1753 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("instruction-for-in-lower-upper-bounds.galgas", 40)) ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__7B_ COMMA_SOURCE_FILE ("instruction-for-in-lower-upper-bounds.galgas", 41)) ;
  GALGAS_instructionListAST var_instructionList_1829 ;
  nt_instructionList_ (ioArgument_ioAST, var_instructionList_1829, inCompiler) ;
  GALGAS_location var_endOfInstruction_1854 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("instruction-for-in-lower-upper-bounds.galgas", 43)) ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__7D_ COMMA_SOURCE_FILE ("instruction-for-in-lower-upper-bounds.galgas", 44)) ;
  ioArgument_ioInstructionList.addAssign_operation (GALGAS_forLowerUpperBoundInstructionAST::constructor_new (var_varName_1347.getter_location (HERE), var_varName_1347, var_typeName_1489, var_lowerBoundExpression_1565, var_endOf_5F_lowerBoundExpression_5F_instruction_1612, var_upperBoundExpression_1706, var_endOf_5F_upperBoundExpression_5F_instruction_1753, var_instructionList_1829, var_endOfInstruction_1854  COMMA_SOURCE_FILE ("instruction-for-in-lower-upper-bounds.galgas", 45))  COMMA_SOURCE_FILE ("instruction-for-in-lower-upper-bounds.galgas", 45)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_effective_5F_parameters_i110_ (GALGAS_ast & ioArgument_ioAST,
  ...
  while (repeatFlag_0) {
    ...
    case 6: {
      ...
      case 2: {
        inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__3A_ COMMA_SOURCE_FILE ("effective-parameters.galgas", 88)) ;
        nt_type_5F_definition_ (ioArgument_ioAST, var_typeName_3427, inCompiler) ;
      } break ;
      default:
        break ;
      }
      outArgument_outEffectiveParameterList.addAssign_operation (GALGAS_effectiveArgumentPassingModeAST::constructor_inputWithType (var_constant_3247, var_typeName_3427, var_effectiveParameterName_3403  COMMA_SOURCE_FILE ("effective-parameters.galgas", 92)), var_selector_3226  COMMA_SOURCE_FILE ("effective-parameters.galgas", 91)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  outArgument_outEndOfArgs = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("effective-parameters.galgas", 95)) ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__29_ COMMA_SOURCE_FILE ("effective-parameters.galgas", 96)) ;
}
...
void cParser_plm_5F_target_5F_specific_5F_syntax::rule_plm_5F_target_5F_specific_5F_syntax_configuration_5F_start_5F_symbol_i2_ (GALGAS_ast & ioArgument_ioAST,
  ...
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("configuration.galgas", 117)) ;
  nt_configuration_5F_key_ (GALGAS_string ("PANIC_LINE_TYPE_NAME"), inCompiler) ;
  GALGAS_lstring var_panicLineTypeName_4260 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("configuration.galgas", 119)) ;
  nt_configuration_5F_key_ (GALGAS_string ("POINTER_BIT_COUNT"), inCompiler) ;
  GALGAS_lbigint var_pointerSize_4336 = inCompiler->synthetizedAttribute_bigInteger () ;
  ...
  GALGAS_bool var_handleDynamicArray_4406 ;
  ...
  case 1: {
    ...
    var_handleDynamicArray_4406 = GALGAS_bool (true) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_no COMMA_SOURCE_FILE ("configuration.galgas", 128)) ;
    var_handleDynamicArray_4406 = GALGAS_bool (false) ;
  } break ;
  default:
    break ;
  }
  nt_configuration_5F_key_ (GALGAS_string ("SYSTEM_STACK_SIZE"), inCompiler) ;
  GALGAS_lbigint var_systemStackSize_4600 = inCompiler->synthetizedAttribute_bigInteger () ;
  ...
  GALGAS_lstring var_nopInstructionStringInLLVM_4678 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GALGAS_lbigint var_bitbandRegisterBaseAddress_4754 ;
  GALGAS_lbigint var_bitbandRegisterEndAddress_4793 ;
  GALGAS_lbigint var_bitbandRegisterRelocationAddress_4839 ;
  GALGAS_lbigint var_bitbandRegisterOffsetMultiplier_4884 ;
  GALGAS_lbigint var_bitbandRegisterBitMultiplier_4926 ;
  ...
  case 1: {
    ...
    var_bitbandRegisterBaseAddress_4754 = GALGAS_lbigint::constructor_new (GALGAS_bigint ("0", inCompiler  COMMA_SOURCE_FILE ("configuration.galgas", 143)), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("configuration.galgas", 143))  COMMA_SOURCE_FILE ("configuration.galgas", 143)) ;
    var_bitbandRegisterEndAddress_4793 = GALGAS_lbigint::constructor_new (GALGAS_bigint ("0", inCompiler  COMMA_SOURCE_FILE ("configuration.galgas", 144)), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("configuration.galgas", 144))  COMMA_SOURCE_FILE ("configuration.galgas", 144)) ;
    var_bitbandRegisterRelocationAddress_4839 = GALGAS_lbigint::constructor_new (GALGAS_bigint ("0", inCompiler  COMMA_SOURCE_FILE ("configuration.galgas", 145)), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("configuration.galgas", 145))  COMMA_SOURCE_FILE ("configuration.galgas", 145)) ;
    var_bitbandRegisterOffsetMultiplier_4884 = GALGAS_lbigint::constructor_new (GALGAS_bigint ("0", inCompiler  COMMA_SOURCE_FILE ("configuration.galgas", 146)), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("configuration.galgas", 146))  COMMA_SOURCE_FILE ("configuration.galgas", 146)) ;
    var_bitbandRegisterBitMultiplier_4926 = GALGAS_lbigint::constructor_new (GALGAS_bigint ("0", inCompiler  COMMA_SOURCE_FILE ("configuration.galgas", 147)), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("configuration.galgas", 147))  COMMA_SOURCE_FILE ("configuration.galgas", 147)) ;
  } break ;
  case 2: {
    var_bitbandRegisterBaseAddress_4754 = inCompiler->synthetizedAttribute_bigInteger () ;
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_integer COMMA_SOURCE_FILE ("configuration.galgas", 149)) ;
    var_bitbandRegisterEndAddress_4793 = inCompiler->synthetizedAttribute_bigInteger () ;
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_integer COMMA_SOURCE_FILE ("configuration.galgas", 150)) ;
    var_bitbandRegisterRelocationAddress_4839 = inCompiler->synthetizedAttribute_bigInteger () ;
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_integer COMMA_SOURCE_FILE ("configuration.galgas", 151)) ;
    var_bitbandRegisterOffsetMultiplier_4884 = inCompiler->synthetizedAttribute_bigInteger () ;
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_integer COMMA_SOURCE_FILE ("configuration.galgas", 152)) ;
    var_bitbandRegisterBitMultiplier_4926 = inCompiler->synthetizedAttribute_bigInteger () ;
  ...
  GALGAS_lstring var_serviceHandler_5549 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GALGAS_lbigint var_servicePushedRegisterByteSize_5651 = inCompiler->synthetizedAttribute_bigInteger () ;
  ...
  GALGAS_lstring var_serviceDispatcherHeader_5748 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GALGAS_lstring var_serviceDispatcherEntry_5843 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GALGAS_lstring var_serviceEntryNoReturnedValue_5950 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GALGAS_lstring var_serviceEntryReturnValue_6055 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GALGAS_lstring var_sectionHandler_6133 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GALGAS_lbigint var_sectionPushedRegisterByteSize_6235 = inCompiler->synthetizedAttribute_bigInteger () ;
  ...
  GALGAS_lstring var_sectionDispatcherHeader_6332 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GALGAS_lstring var_sectionDispatcherEntry_6427 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GALGAS_lstring var_sectionDispatcherInvocationFromAnyMode_6545 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GALGAS_lstring var_sectionDispatcherInvocationFromUserMode_6661 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GALGAS_lstring var_xtrInterruptHandler_6746 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GALGAS_lbigint var_stackedUserRegisterOnInterruptByteSize_6857 = inCompiler->synthetizedAttribute_bigInteger () ;
  ...
  GALGAS_lstring var_undefinedInterruptHandler_6947 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GALGAS_lstringlist var_C_5F_definitionFiles_7019 = GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("configuration.galgas", 186)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_plm_5F_target_5F_specific_5F_syntax_3 (inCompiler)) {
    case 2: {
      GALGAS_lstring var_fileRelativePath_7084 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__22_string_22_ COMMA_SOURCE_FILE ("configuration.galgas", 189)) ;
      var_C_5F_definitionFiles_7019.addAssign_operation (var_fileRelativePath_7084  COMMA_SOURCE_FILE ("configuration.galgas", 190)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  GALGAS_lstringlist var_S_5F_definitionFiles_7207 = GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("configuration.galgas", 193)) ;
  bool repeatFlag_1 = true ;
  while (repeatFlag_1) {
    switch (select_plm_5F_target_5F_specific_5F_syntax_4 (inCompiler)) {
    case 2: {
      GALGAS_lstring var_fileRelativePath_7272 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__22_string_22_ COMMA_SOURCE_FILE ("configuration.galgas", 196)) ;
      var_S_5F_definitionFiles_7207.addAssign_operation (var_fileRelativePath_7272  COMMA_SOURCE_FILE ("configuration.galgas", 197)) ;
    } break ;
    default:
      repeatFlag_1 = false ;
      break ;
  ...
  GALGAS_lstringlist var_LL_5F_definitionFiles_7397 = GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("configuration.galgas", 200)) ;
  bool repeatFlag_2 = true ;
  while (repeatFlag_2) {
    switch (select_plm_5F_target_5F_specific_5F_syntax_5 (inCompiler)) {
    case 2: {
      GALGAS_lstring var_fileRelativePath_7462 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__22_string_22_ COMMA_SOURCE_FILE ("configuration.galgas", 203)) ;
      var_LL_5F_definitionFiles_7397.addAssign_operation (var_fileRelativePath_7462  COMMA_SOURCE_FILE ("configuration.galgas", 204)) ;
    } break ;
    default:
      repeatFlag_2 = false ;
      break ;
  ...
  enumGalgasBool test_4 = kBoolTrue ;
  if (kBoolTrue == test_4) {
    test_4 = GALGAS_bool (kIsEqual, var_pointerSize_4336.getter_bigint (HERE).objectCompare (GALGAS_bigint ("0", inCompiler  COMMA_SOURCE_FILE ("configuration.galgas", 215)))).boolEnum () ;
    if (kBoolTrue == test_4) {
      TC_Array <C_FixItDescription> fixItArray5 ;
      inCompiler->emitSemanticError (var_pointerSize_4336.getter_location (SOURCE_FILE ("configuration.galgas", 216)), GALGAS_string ("zero size pointer is invalid"), fixItArray5  COMMA_SOURCE_FILE ("configuration.galgas", 216)) ;
      var_ptrSize_7803.drop () ; // Release error dropped variable
    }
  }
  if (kBoolFalse == test_4) {
    var_ptrSize_7803 = var_pointerSize_4336.getter_bigint (HERE).getter_uint (inCompiler COMMA_SOURCE_FILE ("configuration.galgas", 218)) ;
  }
  GALGAS_targetParameters var_parameters_7985 = GALGAS_targetParameters::constructor_new (var_loc_3860, var_python_5F_utilityToolList_3936, var_python_5F_build_4009, var_linkerScript_4083, var_ptrSize_7803, var_handleDynamicArray_4406, var_systemStackSize_4600, var_stackedUserRegisterOnInterruptByteSize_6857, var_nopInstructionStringInLLVM_4678, var_bitbandRegisterBaseAddress_4754, var_bitbandRegisterEndAddress_4793, var_bitbandRegisterRelocationAddress_4839, var_bitbandRegisterOffsetMultiplier_4884, var_bitbandRegisterBitMultiplier_4926, var_sectionHandler_6133, var_sectionPushedRegisterByteSize_6235, var_sectionDispatcherHeader_6332, var_sectionDispatcherEntry_6427, var_sectionDispatcherInvocationFromAnyMode_6545, var_sectionDispatcherInvocationFromUserMode_6661, var_C_5F_definitionFiles_7019, var_S_5F_definitionFiles_7207, var_LL_5F_definitionFiles_7397, var_xtrInterruptHandler_6746, var_undefinedInterruptHandler_6947, var_serviceHandler_5549, var_servicePushedRegisterByteSize_5651, var_serviceDispatcherEntry_5843, var_serviceDispatcherHeader_5748, var_serviceEntryNoReturnedValue_5950, var_serviceEntryReturnValue_6055  COMMA_SOURCE_FILE ("configuration.galgas", 220)) ;
  ioArgument_ioAST.mProperty_mDeclarationListAST.addAssign_operation (GALGAS_configurationDeclarationAST::constructor_new (var_panicCodeTypeName_4171, var_panicLineTypeName_4260, var_parameters_7985, var_interruptionConfigurationList_7758  COMMA_SOURCE_FILE ("configuration.galgas", 253))  COMMA_SOURCE_FILE ("configuration.galgas", 253)) ;
  outArgument_outEndOfSourceFile = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("configuration.galgas", 259)) ;
  ioArgument_ioAST.mProperty_mDeclarationListAST.addAssign_operation (GALGAS_enumerationDeclarationAST::constructor_new (GALGAS_lstring::constructor_new (function_isrSlotTypeName (inCompiler COMMA_SOURCE_FILE ("configuration.galgas", 261)), var_xtrInterruptHandler_6746.getter_location (HERE)  COMMA_SOURCE_FILE ("configuration.galgas", 261)), var_interruptConstantList_7785  COMMA_SOURCE_FILE ("configuration.galgas", 260))  COMMA_SOURCE_FILE ("configuration.galgas", 260)) ;
}
