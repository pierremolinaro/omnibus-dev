...
GALGAS_taskSetupListAST GALGAS_taskList::getter_mTaskSetupListASTAtIndex (const GALGAS_uint & inIndex,
                                                                          C_Compiler * inCompiler
                                                                          COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_taskList * p = (cCollectionElement_taskList *) attributes.ptr () ;
...
GALGAS_taskSetupListAST cEnumerator_taskList::current_mTaskSetupListAST (LOCATION_ARGS) const {
  const cCollectionElement_taskList * p = (const cCollectionElement_taskList *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, cCollectionElement_taskList) ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_i4_ (GALGAS_ast & ioArgument_ioAST,
  ...
  GALGAS_lstring var_enumName_1292 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GALGAS_enumerationConstantList var_enumCaseList_1342 = GALGAS_enumerationConstantList::constructor_emptyList (SOURCE_FILE ("type-enumeration-declaration.galgas", 29)) ;
  GALGAS_bigint var_idx_1359 = GALGAS_bigint ("0", inCompiler  COMMA_SOURCE_FILE ("type-enumeration-declaration.galgas", 30)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    ...
    GALGAS_lstring var_constantName_1425 = inCompiler->synthetizedAttribute_tokenString () ;
    ...
    var_enumCaseList_1342.addAssign_operation (var_constantName_1425, var_idx_1359  COMMA_SOURCE_FILE ("type-enumeration-declaration.galgas", 34)) ;
    var_idx_1359 = var_idx_1359.add_operation (GALGAS_uint ((uint32_t) 1U).getter_bigint (SOURCE_FILE ("type-enumeration-declaration.galgas", 35)), inCompiler COMMA_SOURCE_FILE ("type-enumeration-declaration.galgas", 35)) ;
  ...
  ioArgument_ioAST.mProperty_mDeclarationListAST.addAssign_operation (GALGAS_enumerationDeclaration::constructor_new (var_enumName_1292, var_enumCaseList_1342  COMMA_SOURCE_FILE ("type-enumeration-declaration.galgas", 39))  COMMA_SOURCE_FILE ("type-enumeration-declaration.galgas", 39)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_i19_ (GALGAS_ast & ioArgument_ioAST,
  ...
  while (repeatFlag_0) {
    ...
    case 2: {
      ...
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__21_selector_3A_) COMMA_SOURCE_FILE ("declaration-module.galgas", 131)) ;
      GALGAS_expressionAST var_expression_4499 ;
      nt_expression_ (var_expression_4499, inCompiler) ;
      var_moduleInstanciationArgumentList_4405.addAssign_operation (var_selector_4464, var_expression_4499  COMMA_SOURCE_FILE ("declaration-module.galgas", 133)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_i20_ (GALGAS_ast & ioArgument_ioAST,
  ...
  GALGAS_lstring var_staticListName_2597 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GALGAS_staticListPropertyListAST var_propertyList_2649 = GALGAS_staticListPropertyListAST::constructor_emptyList (SOURCE_FILE ("declaration-static-array.galgas", 64)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    nt_staticArrayProperty_ (var_propertyList_2649, inCompiler) ;
  ...
  ioArgument_ioAST.mProperty_mDeclarationListAST.addAssign_operation (GALGAS_staticListAST::constructor_new (var_staticListName_2597, var_propertyList_2649, GALGAS_staticListValueListAST::constructor_emptyList (SOURCE_FILE ("declaration-static-array.galgas", 70))  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 70))  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 70)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_staticArrayProperty_i21_ (GALGAS_staticListPropertyListAST & ioArgument_ioPropertyList,
  ...
  GALGAS_lstring var_propertyName_3070 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  case 1: {
    GALGAS_lstring var_typeName_3110 = inCompiler->synthetizedAttribute_tokenString () ;
    ...
    ioArgument_ioPropertyList.addAssign_operation (var_propertyName_3070, GALGAS_staticListPropertyTypeAST::constructor_valueType (var_typeName_3110  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 80))  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 80)) ;
  } break ;
  case 2: {
    ...
    GALGAS_mode var_mode_3219 ;
    nt_mode_ (var_mode_3219, inCompiler) ;
    GALGAS_routineFormalArgumentList var_formalArgs_3286 ;
    nt_procedure_5F_formal_5F_arguments_ (var_formalArgs_3286, inCompiler) ;
    GALGAS_lstring var_returnType_3312 ;
    switch (select_plm_5F_syntax_28 (inCompiler)) {
    case 1: {
      var_returnType_3312 = GALGAS_string::makeEmptyString ().getter_here (inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 87)) ;
    } break ;
    case 2: {
      ...
      var_returnType_3312 = inCompiler->synthetizedAttribute_tokenString () ;
    ...
    ioArgument_ioPropertyList.addAssign_operation (var_propertyName_3070, GALGAS_staticListPropertyTypeAST::constructor_function (var_mode_3219, var_formalArgs_3286, var_returnType_3312  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 92))  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 92)) ;
  } break ;
  default:
    break ;
  }
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_i22_ (GALGAS_ast & ioArgument_ioAST,
  ...
  GALGAS_lstring var_staticListName_3907 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    GALGAS_extendStaticListElementListAST var_expressions_3976 = GALGAS_extendStaticListElementListAST::constructor_emptyList (SOURCE_FILE ("declaration-static-array.galgas", 106)) ;
    bool repeatFlag_1 = true ;
    while (repeatFlag_1) {
      nt_staticArray_5F_exp_ (var_expressions_3976, inCompiler) ;
    ...
    ioArgument_ioAST.mProperty_mExtendStaticArrayDeclarationAST.addAssign_operation (var_staticListName_3907, var_expressions_3976  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 112)) ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_staticArray_5F_exp_i23_ (GALGAS_extendStaticListElementListAST & ioArgument_ioExpressions,
  ...
  case 1: {
    GALGAS_expressionAST var_exp_4422 ;
    nt_expression_ (var_exp_4422, inCompiler) ;
    ioArgument_ioExpressions.addAssign_operation (GALGAS_extendStaticListExpressionAST::constructor_expression (var_exp_4422  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 124)), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 124))  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 124)) ;
  } break ;
  case 2: {
    ...
    GALGAS_lstring var_functionName_4533 = inCompiler->synthetizedAttribute_tokenString () ;
    ...
    GALGAS_routineFormalArgumentList var_formalArgs_4600 ;
    nt_procedure_5F_formal_5F_arguments_ (var_formalArgs_4600, inCompiler) ;
    ioArgument_ioExpressions.addAssign_operation (GALGAS_extendStaticListExpressionAST::constructor_function (var_functionName_4533, var_formalArgs_4600  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 130)), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 131))  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 129)) ;
  } break ;
  default:
    break ;
  }
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_i24_ (GALGAS_ast & ioArgument_ioAST,
  ...
  GALGAS_lstring var_taskName_1841 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GALGAS_lbigint var_priority_1893 = inCompiler->synthetizedAttribute_bigInteger () ;
  ...
  GALGAS_lbigint var_stackSize_1947 = inCompiler->synthetizedAttribute_bigInteger () ;
  ...
  GALGAS_structurePropertyListAST var_taskVarList_1997 = GALGAS_structurePropertyListAST::constructor_emptyList (SOURCE_FILE ("declaration-task.galgas", 51)) ;
  GALGAS_functionDeclarationListAST var_taskProcList_2047 = GALGAS_functionDeclarationListAST::constructor_emptyList (SOURCE_FILE ("declaration-task.galgas", 52)) ;
  GALGAS_taskSetupListAST var_taskInitListAST_2090 = GALGAS_taskSetupListAST::constructor_emptyList (SOURCE_FILE ("declaration-task.galgas", 53)) ;
  GALGAS_syncInstructionBranchListAST var_branchList_2140 = GALGAS_syncInstructionBranchListAST::constructor_emptyList (SOURCE_FILE ("declaration-task.galgas", 54)) ;
  nt_taskBody_ (var_taskVarList_1997, var_taskProcList_2047, var_taskInitListAST_2090, var_branchList_2140, inCompiler) ;
  GALGAS_location var_endOfTask_2238 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-task.galgas", 56)) ;
  ...
  ioArgument_ioAST.mProperty_mTaskListAST.addAssign_operation (var_taskName_1841, var_priority_1893, var_stackSize_1947, var_taskVarList_1997, var_taskProcList_2047, var_taskInitListAST_2090, var_branchList_2140, var_endOfTask_2238  COMMA_SOURCE_FILE ("declaration-task.galgas", 58)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_taskBody_i25_ (GALGAS_structurePropertyListAST & ioArgument_taskVarList,
  ...
  while (repeatFlag_0) {
    ...
    case 3: {
      ...
      GALGAS_lstring var_procName_2933 = inCompiler->synthetizedAttribute_tokenString () ;
      ...
      GALGAS_routineFormalArgumentList var_formalArgumentList_3035 ;
      nt_procedure_5F_formal_5F_arguments_ (var_formalArgumentList_3035, inCompiler) ;
      GALGAS_lstring var_returnTypeName_3065 ;
      switch (select_plm_5F_syntax_33 (inCompiler)) {
      case 1: {
        var_returnTypeName_3065 = GALGAS_string::makeEmptyString ().getter_here (inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 85)) ;
      } break ;
      case 2: {
        ...
        var_returnTypeName_3065 = inCompiler->synthetizedAttribute_tokenString () ;
      ...
      GALGAS_instructionListAST var_instructionList_3233 ;
      nt_instructionList_ (var_instructionList_3233, inCompiler) ;
      GALGAS_location var_endOfProc_3253 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-task.galgas", 92)) ;
      ...
      ioArgument_taskProcList.addAssign_operation (GALGAS_mode::constructor_userMode (SOURCE_FILE ("declaration-task.galgas", 94)), GALGAS_bool (false), var_procName_2933, GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("declaration-task.galgas", 94)), var_formalArgumentList_3035, var_returnTypeName_3065, var_instructionList_3233, var_endOfProc_3253  COMMA_SOURCE_FILE ("declaration-task.galgas", 94)) ;
    } break ;
    case 4: {
      ...
      GALGAS_lbigint var_priority_3461 = inCompiler->synthetizedAttribute_bigInteger () ;
      ...
      GALGAS_instructionListAST var_instructionList_3516 ;
      nt_instructionList_ (var_instructionList_3516, inCompiler) ;
      GALGAS_location var_endOfInit_3536 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-task.galgas", 100)) ;
      ...
      ioArgument_taskInitListAST.addAssign_operation (var_priority_3461, var_instructionList_3516, var_endOfInit_3536  COMMA_SOURCE_FILE ("declaration-task.galgas", 102)) ;
    } break ;
    case 5: {
      GALGAS_guardedCommandAST var_guardedCommand_3699 ;
      nt_guarded_5F_command_ (var_guardedCommand_3699, inCompiler) ;
      ...
      GALGAS_instructionListAST var_instructionList_3754 ;
      nt_instructionList_ (var_instructionList_3754, inCompiler) ;
      GALGAS_location var_endOfInstructions_3782 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-task.galgas", 107)) ;
      ...
      ioArgument_branchList.addAssign_operation (var_guardedCommand_3699, var_instructionList_3754, var_endOfInstructions_3782  COMMA_SOURCE_FILE ("declaration-task.galgas", 109)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_procedure_5F_formal_5F_arguments_i35_ (GALGAS_routineFormalArgumentList & outArgument_outProcFormalArgumentList,
  ...
  while (repeatFlag_0) {
    ...
    case 2: {
      GALGAS_lstring var_selector_4743 = inCompiler->synthetizedAttribute_tokenString () ;
      ...
      GALGAS_lstring var_formalArgumentName_4786 = inCompiler->synthetizedAttribute_tokenString () ;
      ...
      GALGAS_lstring var_formalArgumentTypeName_4829 = inCompiler->synthetizedAttribute_tokenString () ;
      ...
      outArgument_outProcFormalArgumentList.addAssign_operation (GALGAS_procFormalArgumentPassingMode::constructor_output (SOURCE_FILE ("declaration-func.galgas", 166)), var_selector_4743, var_formalArgumentTypeName_4829, var_formalArgumentName_4786  COMMA_SOURCE_FILE ("declaration-func.galgas", 165)) ;
    } break ;
    case 3: {
      GALGAS_lstring var_selector_5033 = inCompiler->synthetizedAttribute_tokenString () ;
      ...
      GALGAS_lstring var_formalArgumentName_5076 = inCompiler->synthetizedAttribute_tokenString () ;
      ...
      GALGAS_lstring var_formalArgumentTypeName_5119 = inCompiler->synthetizedAttribute_tokenString () ;
      ...
      outArgument_outProcFormalArgumentList.addAssign_operation (GALGAS_procFormalArgumentPassingMode::constructor_inputOutput (SOURCE_FILE ("declaration-func.galgas", 175)), var_selector_5033, var_formalArgumentTypeName_5119, var_formalArgumentName_5076  COMMA_SOURCE_FILE ("declaration-func.galgas", 174)) ;
    } break ;
    case 4: {
      GALGAS_lstring var_selector_5327 = inCompiler->synthetizedAttribute_tokenString () ;
      ...
      GALGAS_lstring var_formalArgumentName_5370 = inCompiler->synthetizedAttribute_tokenString () ;
      ...
      GALGAS_lstring var_formalArgumentTypeName_5413 = inCompiler->synthetizedAttribute_tokenString () ;
      ...
      outArgument_outProcFormalArgumentList.addAssign_operation (GALGAS_procFormalArgumentPassingMode::constructor_input (SOURCE_FILE ("declaration-func.galgas", 184)), var_selector_5327, var_formalArgumentTypeName_5413, var_formalArgumentName_5370  COMMA_SOURCE_FILE ("declaration-func.galgas", 183)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_primary_i57_ (GALGAS_expressionAST & outArgument_outExpression,
  ...
  GALGAS_lstring var_typeIdentifier_1104 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__24_type) COMMA_SOURCE_FILE ("expression-convert.galgas", 21)) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__28_) COMMA_SOURCE_FILE ("expression-convert.galgas", 22)) ;
  nt_expression_ (outArgument_outExpression, inCompiler) ;
  GALGAS_location var_endOfExpression_1168 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("expression-convert.galgas", 24)) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__29_) COMMA_SOURCE_FILE ("expression-convert.galgas", 25)) ;
  outArgument_outExpression = GALGAS_convertExpressionAST::constructor_new (outArgument_outExpression, var_typeIdentifier_1104, var_endOfExpression_1168  COMMA_SOURCE_FILE ("expression-convert.galgas", 26)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_primary_i59_ (GALGAS_expressionAST & outArgument_outExpression,
  ...
  GALGAS_lstring var_typeIdentifier_1106 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__24_type) COMMA_SOURCE_FILE ("expression-truncate.galgas", 21)) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__28_) COMMA_SOURCE_FILE ("expression-truncate.galgas", 22)) ;
  nt_expression_ (outArgument_outExpression, inCompiler) ;
  GALGAS_location var_endOfExpression_1170 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("expression-truncate.galgas", 24)) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__29_) COMMA_SOURCE_FILE ("expression-truncate.galgas", 25)) ;
  outArgument_outExpression = GALGAS_truncateExpressionAST::constructor_new (outArgument_outExpression, var_typeIdentifier_1106, var_endOfExpression_1170  COMMA_SOURCE_FILE ("expression-truncate.galgas", 26)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_expression_5F_if_i64_ (GALGAS_ifExpressionAST & outArgument_outExpression,
                                                                      C_Lexique_plm_5F_lexique * inCompiler) {
  outArgument_outExpression.drop () ; // Release 'out' argument
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_expression_5F_access_5F_list_i71_ (GALGAS_primaryInExpressionAccessListAST & outArgument_outAccessList,
                                                                                  C_Lexique_plm_5F_lexique * inCompiler) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_instructionList_i73_ (GALGAS_instructionListAST & outArgument_outInstructionList,
                                                                     C_Lexique_plm_5F_lexique * inCompiler) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_if_5F_instruction_i85_ (GALGAS_ifInstructionAST & outArgument_outIfInstruction,
                                                                       C_Lexique_plm_5F_lexique * inCompiler) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_guarded_5F_command_i86_ (GALGAS_guardedCommandAST & outArgument_outGuardedCommand,
                                                                        C_Lexique_plm_5F_lexique * inCompiler) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_lvalue_i94_ (GALGAS_LValueAST & outArgument_outAssignmentTargetAST,
                                                            C_Lexique_plm_5F_lexique * inCompiler) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_lvalue_i94_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  switch (select_plm_5F_syntax_83 (inCompiler)) {
  case 1: {
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_identifier) COMMA_SOURCE_FILE ("lvalue.galgas", 35)) ;
  } break ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_effective_5F_parameters_i95_ (GALGAS_effectiveArgumentListAST & outArgument_outEffectiveParameterList,
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_effective_5F_parameters_i95_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__28_) COMMA_SOURCE_FILE ("effective-parameters.galgas", 42)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_plm_5F_syntax_85 (inCompiler)) {
