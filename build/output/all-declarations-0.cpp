...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_i9_ (GALGAS_ast & ioArgument_ioAST,
                                                                C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_struct) COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 88)) ;
  GALGAS_lstring var_structureName_3567 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__24_type) COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 89)) ;
  GALGAS_lstringlist var_attributeList_3598 = GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("type-structure-declaration.galgas", 90)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_plm_5F_syntax_6 (inCompiler)) {
    case 2: {
      GALGAS_lstring var_attribute_3658 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__40_attribute) COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 93)) ;
      var_attributeList_3598.addAssign_operation (var_attribute_3658  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 94)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__7B_) COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 96)) ;
  GALGAS_functionDeclarationListAST var_procedureDeclarationListAST_3769 = GALGAS_functionDeclarationListAST::constructor_emptyList (SOURCE_FILE ("type-structure-declaration.galgas", 97)) ;
  GALGAS_structurePropertyListAST var_fieldList_3814 = GALGAS_structurePropertyListAST::constructor_emptyList (SOURCE_FILE ("type-structure-declaration.galgas", 98)) ;
  GALGAS_systemRoutineDeclarationListAST var_systemRoutineListAST_3877 = GALGAS_systemRoutineDeclarationListAST::constructor_emptyList (SOURCE_FILE ("type-structure-declaration.galgas", 99)) ;
  GALGAS_guardDeclarationListAST var_guardListAST_3924 = GALGAS_guardDeclarationListAST::constructor_emptyList (SOURCE_FILE ("type-structure-declaration.galgas", 100)) ;
  bool repeatFlag_1 = true ;
  while (repeatFlag_1) {
    switch (select_plm_5F_syntax_7 (inCompiler)) {
    case 2: {
      nt_private_5F_or_5F_public_5F_struct_5F_property_5F_declaration_ (ioArgument_ioAST, var_fieldList_3814, inCompiler) ;
    } break ;
    case 3: {
      nt_function_ (ioArgument_ioAST, var_procedureDeclarationListAST_3769, inCompiler) ;
    } break ;
    case 4: {
      nt_system_5F_routine_ (ioArgument_ioAST, var_systemRoutineListAST_3877, inCompiler) ;
    } break ;
    case 5: {
      nt_guard_ (ioArgument_ioAST, var_guardListAST_3924, inCompiler) ;
    } break ;
    case 6: {
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__3B_) COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 111)) ;
    } break ;
    default:
      repeatFlag_1 = false ;
      break ;
  ...
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__7D_) COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 113)) ;
  ioArgument_ioAST.mProperty_mDeclarationListAST.addAssign_operation (GALGAS_structureDeclarationAST::constructor_new (var_structureName_3567, var_attributeList_3598, GALGAS_bool (true), var_fieldList_3814, var_procedureDeclarationListAST_3769, var_systemRoutineListAST_3877, var_guardListAST_3924  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 114))  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 114)) ;
}

//---------------------------------------------------------------------------------------------------------------------*

void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_i9_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_struct) COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 88)) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__24_type) COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 89)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_property_5F_in_5F_extension_i12_ (GALGAS_ast & ioArgument_ioAST,
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_property_5F_in_5F_extension_i12_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  switch (select_plm_5F_syntax_10 (inCompiler)) {
  case 1: {
  } break ;
  case 2: {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_type_5F_definition_i13_ (GALGAS_ast & ioArgument_ioAST,
                                                                        GALGAS_lstring & outArgument_outTypeName,
                                                                        C_Lexique_plm_5F_lexique * inCompiler) {
  outArgument_outTypeName.drop () ; // Release 'out' argument
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_type_5F_definition_i13_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__5B_) COMMA_SOURCE_FILE ("type-opaque-declaration.galgas", 21)) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__5B_) COMMA_SOURCE_FILE ("type-opaque-declaration.galgas", 22)) ;
  nt_expression_parse (inCompiler) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__5D_) COMMA_SOURCE_FILE ("type-opaque-declaration.galgas", 25)) ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_registerDeclaration_i15_ (GALGAS_ast & ioArgument_ioAST,
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_registerDeclaration_i15_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_identifier) COMMA_SOURCE_FILE ("declaration-control-register.galgas", 109)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_plm_5F_syntax_19 (inCompiler)) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_driver_5F_property_i18_ (GALGAS_ast & ioArgument_ioAST,
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_driver_5F_property_i18_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  switch (select_plm_5F_syntax_23 (inCompiler)) {
  case 1: {
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_var) COMMA_SOURCE_FILE ("declaration-driver.galgas", 70)) ;
  } break ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_i21_ (GALGAS_ast & ioArgument_ioAST,
  ...
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    nt_staticArrayProperty_ (ioArgument_ioAST, var_propertyList_2655, inCompiler) ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_staticArrayProperty_i22_ (GALGAS_ast & ioArgument_ioAST,
  ...
  GALGAS_lstring var_propertyName_3096 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  case 1: {
    GALGAS_lstring var_typeName_3153 ;
    nt_type_5F_definition_ (ioArgument_ioAST, var_typeName_3153, inCompiler) ;
    ioArgument_ioPropertyList.addAssign_operation (var_propertyName_3096, GALGAS_staticListPropertyTypeAST::constructor_valueType (var_typeName_3153  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 80))  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 80)) ;
  } break ;
  case 2: {
    ...
    GALGAS_mode var_mode_3262 ;
    nt_mode_ (var_mode_3262, inCompiler) ;
    GALGAS_routineFormalArgumentListAST var_formalArgs_3321 ;
    nt_procedure_5F_formal_5F_arguments_ (ioArgument_ioAST, var_formalArgs_3321, inCompiler) ;
    GALGAS_lstring var_returnType_3347 ;
    switch (select_plm_5F_syntax_32 (inCompiler)) {
    case 1: {
      var_returnType_3347 = GALGAS_string::makeEmptyString ().getter_here (inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 87)) ;
    } break ;
    case 2: {
      ...
      nt_type_5F_definition_ (ioArgument_ioAST, var_returnType_3347, inCompiler) ;
    } break ;
    default:
      break ;
    }
    ioArgument_ioPropertyList.addAssign_operation (var_propertyName_3096, GALGAS_staticListPropertyTypeAST::constructor_function (var_mode_3262, var_formalArgs_3321, var_returnType_3347  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 92))  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 92)) ;
  } break ;
  default:
    break ;
  }
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_staticArrayProperty_i22_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_let) COMMA_SOURCE_FILE ("declaration-static-array.galgas", 76)) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_identifier) COMMA_SOURCE_FILE ("declaration-static-array.galgas", 77)) ;
  switch (select_plm_5F_syntax_31 (inCompiler)) {
  case 1: {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_i23_ (GALGAS_ast & ioArgument_ioAST,
  ...
  GALGAS_lstring var_staticListName_3958 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    GALGAS_extendStaticListElementListAST var_expressions_4027 = GALGAS_extendStaticListElementListAST::constructor_emptyList (SOURCE_FILE ("declaration-static-array.galgas", 106)) ;
    bool repeatFlag_1 = true ;
    while (repeatFlag_1) {
      nt_staticArray_5F_exp_ (ioArgument_ioAST, var_expressions_4027, inCompiler) ;
    ...
    ioArgument_ioAST.mProperty_mExtendStaticArrayDeclarationAST.addAssign_operation (var_staticListName_3958, var_expressions_4027  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 112)) ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_staticArray_5F_exp_i24_ (GALGAS_ast & ioArgument_ioAST,
                                                                        GALGAS_extendStaticListElementListAST & ioArgument_ioExpressions,
                                                                        C_Lexique_plm_5F_lexique * inCompiler) {
  switch (select_plm_5F_syntax_35 (inCompiler)) {
  case 1: {
    GALGAS_expressionAST var_exp_4502 ;
    nt_expression_ (ioArgument_ioAST, var_exp_4502, inCompiler) ;
    ioArgument_ioExpressions.addAssign_operation (GALGAS_extendStaticListExpressionAST::constructor_expression (var_exp_4502  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 124)), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 124))  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 124)) ;
  } break ;
  case 2: {
    ...
    GALGAS_lstring var_functionName_4613 = inCompiler->synthetizedAttribute_tokenString () ;
    ...
    GALGAS_routineFormalArgumentListAST var_formalArgs_4672 ;
    nt_procedure_5F_formal_5F_arguments_ (ioArgument_ioAST, var_formalArgs_4672, inCompiler) ;
    ioArgument_ioExpressions.addAssign_operation (GALGAS_extendStaticListExpressionAST::constructor_function (var_functionName_4613, var_formalArgs_4672  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 130)), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 131))  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 129)) ;
  } break ;
  default:
    break ;
  }
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_staticArray_5F_exp_i24_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  switch (select_plm_5F_syntax_35 (inCompiler)) {
  case 1: {
    nt_expression_parse (inCompiler) ;
  } break ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_i25_ (GALGAS_ast & ioArgument_ioAST,
                                                                 C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_task) COMMA_SOURCE_FILE ("task-declaration.galgas", 45)) ;
  GALGAS_lstring var_taskName_1886 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_identifier) COMMA_SOURCE_FILE ("task-declaration.galgas", 46)) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_priority) COMMA_SOURCE_FILE ("task-declaration.galgas", 47)) ;
  GALGAS_lbigint var_priority_1938 = inCompiler->synthetizedAttribute_bigInteger () ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_integer) COMMA_SOURCE_FILE ("task-declaration.galgas", 48)) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_stackSize) COMMA_SOURCE_FILE ("task-declaration.galgas", 49)) ;
  GALGAS_lbigint var_stackSize_1992 = inCompiler->synthetizedAttribute_bigInteger () ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_integer) COMMA_SOURCE_FILE ("task-declaration.galgas", 50)) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__7B_) COMMA_SOURCE_FILE ("task-declaration.galgas", 51)) ;
  GALGAS_structurePropertyListAST var_taskVarList_2042 = GALGAS_structurePropertyListAST::constructor_emptyList (SOURCE_FILE ("task-declaration.galgas", 52)) ;
  GALGAS_functionDeclarationListAST var_taskProcList_2092 = GALGAS_functionDeclarationListAST::constructor_emptyList (SOURCE_FILE ("task-declaration.galgas", 53)) ;
  GALGAS_taskSetupListAST var_taskInitListAST_2135 = GALGAS_taskSetupListAST::constructor_emptyList (SOURCE_FILE ("task-declaration.galgas", 54)) ;
  GALGAS_syncInstructionBranchListAST var_branchList_2185 = GALGAS_syncInstructionBranchListAST::constructor_emptyList (SOURCE_FILE ("task-declaration.galgas", 55)) ;
  GALGAS_taskGuardListAST var_taskGuardListAST_2229 = GALGAS_taskGuardListAST::constructor_emptyList (SOURCE_FILE ("task-declaration.galgas", 56)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_plm_5F_syntax_36 (inCompiler)) {
    case 2: {
      nt_private_5F_struct_5F_property_5F_declaration_ (ioArgument_ioAST, var_taskVarList_2042, inCompiler) ;
    } break ;
    case 3: {
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_func) COMMA_SOURCE_FILE ("task-declaration.galgas", 61)) ;
      GALGAS_lstring var_procName_2377 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_identifier) COMMA_SOURCE_FILE ("task-declaration.galgas", 62)) ;
      GALGAS_routineFormalArgumentListAST var_formalArgumentList_2474 ;
      nt_procedure_5F_formal_5F_arguments_ (ioArgument_ioAST, var_formalArgumentList_2474, inCompiler) ;
      GALGAS_lstring var_returnTypeName_2504 ;
      switch (select_plm_5F_syntax_37 (inCompiler)) {
      case 1: {
        var_returnTypeName_2504 = GALGAS_string::makeEmptyString ().getter_here (inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 66)) ;
      } break ;
      case 2: {
        inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__2D__3E_) COMMA_SOURCE_FILE ("task-declaration.galgas", 68)) ;
        nt_type_5F_definition_ (ioArgument_ioAST, var_returnTypeName_2504, inCompiler) ;
      } break ;
      default:
        break ;
      }
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__7B_) COMMA_SOURCE_FILE ("task-declaration.galgas", 71)) ;
      GALGAS_instructionListAST var_instructionList_2697 ;
      nt_instructionList_ (ioArgument_ioAST, var_instructionList_2697, inCompiler) ;
      GALGAS_location var_endOfProc_2717 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 73)) ;
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__7D_) COMMA_SOURCE_FILE ("task-declaration.galgas", 74)) ;
      var_taskProcList_2092.addAssign_operation (GALGAS_mode::constructor_userMode (SOURCE_FILE ("task-declaration.galgas", 75)), GALGAS_bool (false), var_procName_2377, GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("task-declaration.galgas", 75)), var_formalArgumentList_2474, var_returnTypeName_2504, var_instructionList_2697, var_endOfProc_2717  COMMA_SOURCE_FILE ("task-declaration.galgas", 75)) ;
    } break ;
    case 4: {
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_setup) COMMA_SOURCE_FILE ("task-declaration.galgas", 77)) ;
      GALGAS_lbigint var_priority_2925 = inCompiler->synthetizedAttribute_bigInteger () ;
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_integer) COMMA_SOURCE_FILE ("task-declaration.galgas", 78)) ;
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__7B_) COMMA_SOURCE_FILE ("task-declaration.galgas", 79)) ;
      GALGAS_instructionListAST var_instructionList_2988 ;
      nt_instructionList_ (ioArgument_ioAST, var_instructionList_2988, inCompiler) ;
      GALGAS_location var_endOfInit_3008 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 81)) ;
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__7D_) COMMA_SOURCE_FILE ("task-declaration.galgas", 82)) ;
      var_taskInitListAST_2135.addAssign_operation (var_priority_2925, var_instructionList_2988, var_endOfInit_3008  COMMA_SOURCE_FILE ("task-declaration.galgas", 83)) ;
    } break ;
    case 5: {
      GALGAS_guardedCommandAST var_guardedCommand_3179 ;
      nt_guarded_5F_command_ (ioArgument_ioAST, var_guardedCommand_3179, inCompiler) ;
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__7B_) COMMA_SOURCE_FILE ("task-declaration.galgas", 86)) ;
      GALGAS_instructionListAST var_instructionList_3242 ;
      nt_instructionList_ (ioArgument_ioAST, var_instructionList_3242, inCompiler) ;
      GALGAS_location var_endOfInstructions_3270 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 88)) ;
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__7D_) COMMA_SOURCE_FILE ("task-declaration.galgas", 89)) ;
      var_branchList_2185.addAssign_operation (var_guardedCommand_3179, var_instructionList_3242, var_endOfInstructions_3270  COMMA_SOURCE_FILE ("task-declaration.galgas", 90)) ;
    } break ;
    case 6: {
      nt_task_5F_guard_5F_declaration_ (ioArgument_ioAST, var_taskGuardListAST_2229, inCompiler) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  GALGAS_location var_endOfTask_3463 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 94)) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__7D_) COMMA_SOURCE_FILE ("task-declaration.galgas", 95)) ;
  ioArgument_ioAST.mProperty_mTaskListAST.addAssign_operation (var_taskName_1886, var_priority_1938, var_stackSize_1992, var_taskVarList_2042, var_taskProcList_2092, var_taskInitListAST_2135, var_branchList_2185, var_taskGuardListAST_2229, var_endOfTask_3463  COMMA_SOURCE_FILE ("task-declaration.galgas", 96)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_i25_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  ...
  while (repeatFlag_0) {
    ...
    case 6: {
      nt_task_5F_guard_5F_declaration_parse (inCompiler) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_task_5F_guard_5F_declaration_i26_ (GALGAS_ast & ioArgument_ioAST,
                                                                                  GALGAS_taskGuardListAST & ioArgument_ioTaskEntryListAST,
                                                                                  C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_guard) COMMA_SOURCE_FILE ("task-guard-declaration.galgas", 21)) ;
  GALGAS_lstring var_guardName_1145 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_identifier) COMMA_SOURCE_FILE ("task-guard-declaration.galgas", 22)) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__3A_) COMMA_SOURCE_FILE ("task-guard-declaration.galgas", 23)) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_self) COMMA_SOURCE_FILE ("task-guard-declaration.galgas", 24)) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__2E_) COMMA_SOURCE_FILE ("task-guard-declaration.galgas", 25)) ;
  GALGAS_lstringlist var_guardPath_1199 = GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("task-guard-declaration.galgas", 26)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    GALGAS_lstring var_propertyName_1252 = inCompiler->synthetizedAttribute_tokenString () ;
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_identifier) COMMA_SOURCE_FILE ("task-guard-declaration.galgas", 28)) ;
    var_guardPath_1199.addAssign_operation (var_propertyName_1252  COMMA_SOURCE_FILE ("task-guard-declaration.galgas", 29)) ;
    switch (select_plm_5F_syntax_38 (inCompiler)) {
    case 2: {
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__2E_) COMMA_SOURCE_FILE ("task-guard-declaration.galgas", 31)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  GALGAS_routineFormalArgumentListAST var_formalArgumentList_1408 ;
  nt_procedure_5F_formal_5F_arguments_ (ioArgument_ioAST, var_formalArgumentList_1408, inCompiler) ;
  ioArgument_ioTaskEntryListAST.addAssign_operation (var_guardName_1145, var_formalArgumentList_1408, var_guardPath_1199  COMMA_SOURCE_FILE ("task-guard-declaration.galgas", 34)) ;
}

//---------------------------------------------------------------------------------------------------------------------*

void cParser_plm_5F_syntax::rule_plm_5F_syntax_task_5F_guard_5F_declaration_i26_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_guard) COMMA_SOURCE_FILE ("task-guard-declaration.galgas", 21)) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_identifier) COMMA_SOURCE_FILE ("task-guard-declaration.galgas", 22)) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__3A_) COMMA_SOURCE_FILE ("task-guard-declaration.galgas", 23)) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_self) COMMA_SOURCE_FILE ("task-guard-declaration.galgas", 24)) ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_system_5F_routine_i30_ (GALGAS_ast & ioArgument_ioAST,
  ...
  GALGAS_routineKind var_routineKind_1599 ;
  switch (select_plm_5F_syntax_40 (inCompiler)) {
  case 1: {
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_section) COMMA_SOURCE_FILE ("declaration-svc.galgas", 40)) ;
    var_routineKind_1599 = GALGAS_routineKind::constructor_section (SOURCE_FILE ("declaration-svc.galgas", 41)) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_safe) COMMA_SOURCE_FILE ("declaration-svc.galgas", 43)) ;
    var_routineKind_1599 = GALGAS_routineKind::constructor_safe (SOURCE_FILE ("declaration-svc.galgas", 44)) ;
  } break ;
  default:
    break ;
  }
  GALGAS_lstring var_name_1736 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_identifier) COMMA_SOURCE_FILE ("declaration-svc.galgas", 46)) ;
  GALGAS_lstringlist var_attributeList_1767 = GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("declaration-svc.galgas", 47)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_plm_5F_syntax_41 (inCompiler)) {
    case 2: {
      GALGAS_lstring var_attribute_1827 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__40_attribute) COMMA_SOURCE_FILE ("declaration-svc.galgas", 50)) ;
      var_attributeList_1767.addAssign_operation (var_attribute_1827  COMMA_SOURCE_FILE ("declaration-svc.galgas", 51)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  GALGAS_routineFormalArgumentListAST var_formalArgumentList_1934 ;
  nt_procedure_5F_formal_5F_arguments_ (ioArgument_ioAST, var_formalArgumentList_1934, inCompiler) ;
  GALGAS_lstring var_returnTypeName_1962 ;
  switch (select_plm_5F_syntax_42 (inCompiler)) {
  case 1: {
    var_returnTypeName_1962 = GALGAS_string::makeEmptyString ().getter_here (inCompiler COMMA_SOURCE_FILE ("declaration-svc.galgas", 56)) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__2D__3E_) COMMA_SOURCE_FILE ("declaration-svc.galgas", 58)) ;
    nt_type_5F_definition_ (ioArgument_ioAST, var_returnTypeName_1962, inCompiler) ;
  } break ;
  default:
    break ;
  }
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__7B_) COMMA_SOURCE_FILE ("declaration-svc.galgas", 61)) ;
  GALGAS_instructionListAST var_instructionList_2139 ;
  nt_instructionList_ (ioArgument_ioAST, var_instructionList_2139, inCompiler) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__7D_) COMMA_SOURCE_FILE ("declaration-svc.galgas", 63)) ;
  ioArgument_ioSVCListAST.addAssign_operation (var_name_1736, var_routineKind_1599, var_public_1570, var_attributeList_1767, var_formalArgumentList_1934, var_returnTypeName_1962, var_instructionList_2139, GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-svc.galgas", 72))  COMMA_SOURCE_FILE ("declaration-svc.galgas", 64)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_system_5F_routine_i31_ (GALGAS_ast & ioArgument_ioAST,
                                                                       GALGAS_systemRoutineDeclarationListAST & ioArgument_ioSVCListAST,
                                                                       C_Lexique_plm_5F_lexique * inCompiler) {
  GALGAS_bool var_public_2626 ;
  nt_system_5F_routine_5F_prefix_ (var_public_2626, inCompiler) ;
  GALGAS_routineKind var_routineKind_2655 ;
  switch (select_plm_5F_syntax_43 (inCompiler)) {
  case 1: {
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_primitive) COMMA_SOURCE_FILE ("declaration-svc.galgas", 83)) ;
    var_routineKind_2655 = GALGAS_routineKind::constructor_primitive (SOURCE_FILE ("declaration-svc.galgas", 84)) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_service) COMMA_SOURCE_FILE ("declaration-svc.galgas", 86)) ;
    var_routineKind_2655 = GALGAS_routineKind::constructor_service (SOURCE_FILE ("declaration-svc.galgas", 87)) ;
  } break ;
  default:
    break ;
  }
  GALGAS_lstring var_name_2802 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_identifier) COMMA_SOURCE_FILE ("declaration-svc.galgas", 89)) ;
  GALGAS_lstringlist var_attributeList_2833 = GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("declaration-svc.galgas", 90)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_plm_5F_syntax_44 (inCompiler)) {
    case 2: {
      GALGAS_lstring var_attribute_2893 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__40_attribute) COMMA_SOURCE_FILE ("declaration-svc.galgas", 93)) ;
      var_attributeList_2833.addAssign_operation (var_attribute_2893  COMMA_SOURCE_FILE ("declaration-svc.galgas", 94)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  GALGAS_routineFormalArgumentListAST var_formalArgumentList_3000 ;
  nt_procedure_5F_formal_5F_arguments_ (ioArgument_ioAST, var_formalArgumentList_3000, inCompiler) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__7B_) COMMA_SOURCE_FILE ("declaration-svc.galgas", 97)) ;
  GALGAS_instructionListAST var_instructionList_3059 ;
  nt_instructionList_ (ioArgument_ioAST, var_instructionList_3059, inCompiler) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__7D_) COMMA_SOURCE_FILE ("declaration-svc.galgas", 99)) ;
  ioArgument_ioSVCListAST.addAssign_operation (var_name_2802, var_routineKind_2655, var_public_2626, var_attributeList_2833, var_formalArgumentList_3000, GALGAS_string::makeEmptyString ().getter_here (inCompiler COMMA_SOURCE_FILE ("declaration-svc.galgas", 106)), var_instructionList_3059, GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-svc.galgas", 108))  COMMA_SOURCE_FILE ("declaration-svc.galgas", 100)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_mode_i35_ (GALGAS_mode & outArgument_outMode,
  ...
  case 10: {
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_safe) COMMA_SOURCE_FILE ("declaration-func.galgas", 130)) ;
    outArgument_outMode = GALGAS_mode::constructor_safeMode (SOURCE_FILE ("declaration-func.galgas", 131)) ;
  } break ;
  default:
    break ;
  }
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_function_5F_header_i36_ (GALGAS_ast & ioArgument_ioAST,
  ...
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_func) COMMA_SOURCE_FILE ("declaration-func.galgas", 145)) ;
  ...
  outArgument_outAttributeList = GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("declaration-func.galgas", 148)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_plm_5F_syntax_48 (inCompiler)) {
    case 2: {
      GALGAS_lstring var_attribute_4368 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__40_attribute) COMMA_SOURCE_FILE ("declaration-func.galgas", 151)) ;
      outArgument_outAttributeList.addAssign_operation (var_attribute_4368  COMMA_SOURCE_FILE ("declaration-func.galgas", 152)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_procedure_5F_formal_5F_arguments_i37_ (GALGAS_ast & ioArgument_ioAST,
                                                                                      ...
                                                                                      C_Lexique_plm_5F_lexique * inCompiler) {
  outArgument_outProcFormalArgumentList.drop () ; // Release 'out' argument
  outArgument_outProcFormalArgumentList = GALGAS_routineFormalArgumentListAST::constructor_emptyList (SOURCE_FILE ("declaration-func.galgas", 160)) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__28_) COMMA_SOURCE_FILE ("declaration-func.galgas", 161)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_plm_5F_syntax_49 (inCompiler)) {
    case 2: {
      GALGAS_lstring var_selector_4814 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__21_selector_3A_) COMMA_SOURCE_FILE ("declaration-func.galgas", 164)) ;
      GALGAS_lstring var_formalArgumentName_4857 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_identifier) COMMA_SOURCE_FILE ("declaration-func.galgas", 165)) ;
      GALGAS_lstring var_formalArgumentTypeName_4918 ;
      nt_type_5F_definition_ (ioArgument_ioAST, var_formalArgumentTypeName_4918, inCompiler) ;
      outArgument_outProcFormalArgumentList.addAssign_operation (GALGAS_procFormalArgumentPassingMode::constructor_output (SOURCE_FILE ("declaration-func.galgas", 168)), var_selector_4814, var_formalArgumentTypeName_4918, var_formalArgumentName_4857  COMMA_SOURCE_FILE ("declaration-func.galgas", 167)) ;
    } break ;
    case 3: {
      GALGAS_lstring var_selector_5122 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__3F__21_selector_3A_) COMMA_SOURCE_FILE ("declaration-func.galgas", 173)) ;
      GALGAS_lstring var_formalArgumentName_5165 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_identifier) COMMA_SOURCE_FILE ("declaration-func.galgas", 174)) ;
      GALGAS_lstring var_formalArgumentTypeName_5225 ;
      nt_type_5F_definition_ (ioArgument_ioAST, var_formalArgumentTypeName_5225, inCompiler) ;
      outArgument_outProcFormalArgumentList.addAssign_operation (GALGAS_procFormalArgumentPassingMode::constructor_inputOutput (SOURCE_FILE ("declaration-func.galgas", 177)), var_selector_5122, var_formalArgumentTypeName_5225, var_formalArgumentName_5165  COMMA_SOURCE_FILE ("declaration-func.galgas", 176)) ;
    } break ;
    case 4: {
      GALGAS_lstring var_selector_5433 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__3F_selector_3A_) COMMA_SOURCE_FILE ("declaration-func.galgas", 182)) ;
      GALGAS_lstring var_formalArgumentName_5476 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_identifier) COMMA_SOURCE_FILE ("declaration-func.galgas", 183)) ;
      GALGAS_lstring var_formalArgumentTypeName_5537 ;
      nt_type_5F_definition_ (ioArgument_ioAST, var_formalArgumentTypeName_5537, inCompiler) ;
      outArgument_outProcFormalArgumentList.addAssign_operation (GALGAS_procFormalArgumentPassingMode::constructor_input (SOURCE_FILE ("declaration-func.galgas", 186)), var_selector_5433, var_formalArgumentTypeName_5537, var_formalArgumentName_5476  COMMA_SOURCE_FILE ("declaration-func.galgas", 185)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__29_) COMMA_SOURCE_FILE ("declaration-func.galgas", 191)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_i38_ (GALGAS_ast & ioArgument_ioAST,
  ...
  GALGAS_mode var_mode_1183 ;
  GALGAS_lstring var_procName_1208 ;
  GALGAS_lstringlist var_attributeList_1244 ;
  GALGAS_routineFormalArgumentListAST var_procFormalArgumentList_1294 ;
  nt_function_5F_header_ (ioArgument_ioAST, var_mode_1183, var_procName_1208, var_attributeList_1244, var_procFormalArgumentList_1294, inCompiler) ;
  GALGAS_bool var_isGlobal_1311 = GALGAS_bool (false) ;
  cEnumerator_lstringlist enumerator_1356 (var_attributeList_1244, kENUMERATION_UP) ;
  while (enumerator_1356.hasCurrentObject ()) {
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, enumerator_1356.current_mValue (HERE).getter_string (HERE).objectCompare (function_exportedAttribute (inCompiler COMMA_SOURCE_FILE ("declaration-required-proc.galgas", 31)))).boolEnum () ;
    if (kBoolTrue == test_0) {
      TC_Array <C_FixItDescription> fixItArray1 ;
      appendFixItActions (fixItArray1, kFixItReplace, GALGAS_string ("@").add_operation (function_exportedAttribute (inCompiler COMMA_SOURCE_FILE ("declaration-required-proc.galgas", 32)), inCompiler COMMA_SOURCE_FILE ("declaration-required-proc.galgas", 32))) ;
      inCompiler->emitSemanticError (enumerator_1356.current_mValue (HERE).getter_location (SOURCE_FILE ("declaration-required-proc.galgas", 32)), GALGAS_string ("invalid attribute"), fixItArray1  COMMA_SOURCE_FILE ("declaration-required-proc.galgas", 32)) ;
    }else if (kBoolFalse == test_0) {
      const enumGalgasBool test_2 = var_isGlobal_1311.boolEnum () ;
      if (kBoolTrue == test_2) {
        TC_Array <C_FixItDescription> fixItArray3 ;
        fixItArray3.appendObject (C_FixItDescription (kFixItRemove, "")) ;
        inCompiler->emitSemanticError (enumerator_1356.current_mValue (HERE).getter_location (SOURCE_FILE ("declaration-required-proc.galgas", 34)), GALGAS_string ("duplicated attribute"), fixItArray3  COMMA_SOURCE_FILE ("declaration-required-proc.galgas", 34)) ;
      }else if (kBoolFalse == test_2) {
        var_isGlobal_1311 = GALGAS_bool (true) ;
      }
    }
    enumerator_1356.gotoNextObject () ;
  }
  ioArgument_ioAST.mProperty_mRequiredProcListAST.addAssign_operation (var_procName_1208, var_mode_1183, var_isGlobal_1311, var_procFormalArgumentList_1294, GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-required-proc.galgas", 44))  COMMA_SOURCE_FILE ("declaration-required-proc.galgas", 39)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_i39_ (GALGAS_ast & ioArgument_ioAST,
  ...
  GALGAS_mode var_mode_1233 ;
  GALGAS_lstring var_procName_1258 ;
  GALGAS_lstringlist var_attributeList_1301 ;
  GALGAS_routineFormalArgumentListAST var_procFormalArgumentList_1351 ;
  nt_function_5F_header_ (ioArgument_ioAST, var_mode_1233, var_procName_1258, var_attributeList_1301, var_procFormalArgumentList_1351, inCompiler) ;
  GALGAS_lstring var_returnTypeName_1379 ;
  switch (select_plm_5F_syntax_50 (inCompiler)) {
  case 1: {
    var_returnTypeName_1379 = GALGAS_string::makeEmptyString ().getter_here (inCompiler COMMA_SOURCE_FILE ("declaration-extern-proc.galgas", 32)) ;
  } break ;
  case 2: {
    ...
    nt_type_5F_definition_ (ioArgument_ioAST, var_returnTypeName_1379, inCompiler) ;
  } break ;
  default:
    break ;
  }
  ...
  GALGAS_lstring var_llvmName_1534 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  ioArgument_ioAST.mProperty_mExternProcListAST.addAssign_operation (var_procName_1258, var_mode_1233, var_procFormalArgumentList_1351, var_returnTypeName_1379, var_llvmName_1534, GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-extern-proc.galgas", 39))  COMMA_SOURCE_FILE ("declaration-extern-proc.galgas", 39)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_isr_i40_ (GALGAS_ast & ioArgument_ioAST,
  ...
  case 3: {
    ...
    var_mode_1143 = GALGAS_mode::constructor_safeMode (SOURCE_FILE ("declaration-isr.galgas", 32)) ;
  } break ;
  default:
    break ;
  }
  GALGAS_lstring var_isrName_1327 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  ioArgument_ioAST.mProperty_mISRDeclarationListAST.addAssign_operation (var_isrName_1327, var_mode_1143, constinArgument_inModuleName, var_instructionList_1386, GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-isr.galgas", 43))  COMMA_SOURCE_FILE ("declaration-isr.galgas", 38)) ;
}
