...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_import_5F_file_i0_ (GALGAS_lstringlist & ioArgument_ioImportedFileList,
  ...
  GALGAS_lstring var_importedFile_993 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  ioArgument_ioImportedFileList.addAssign_operation (var_importedFile_993  COMMA_SOURCE_FILE ("syntax-grammar.galgas", 22)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_importedFile_993.mAttribute_string.getter_pathExtension (SOURCE_FILE ("syntax-grammar.galgas", 23)).objectCompare (GALGAS_string ("plm"))).boolEnum () ;
  if (kBoolTrue == test_0) {
    TC_Array <C_FixItDescription> fixItArray1 ;
    inCompiler->emitSemanticError (var_importedFile_993.getter_location (SOURCE_FILE ("syntax-grammar.galgas", 24)), GALGAS_string ("the pah extension should be .plm"), fixItArray1  COMMA_SOURCE_FILE ("syntax-grammar.galgas", 24)) ;
  }
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_i6_ (GALGAS_ast & ioArgument_ioAST,
  ...
  while (repeatFlag_1) {
    ...
    case 3: {
      nt_function_ (var_procedureDeclarationListAST_3091, inCompiler) ;
    } break ;
    case 4: {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_i8_ (GALGAS_ast & ioArgument_ioAST,
  ...
  while (repeatFlag_0) {
    ...
    case 3: {
      nt_function_ (var_procedureDeclarationListAST_1367, inCompiler) ;
    } break ;
    case 4: {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_property_5F_in_5F_extension_i9_ (GALGAS_structurePropertyListAST & ioArgument_ioPropertyList,
                                                                                C_Lexique_plm_5F_lexique * inCompiler) {
  GALGAS_bool var_public_2375 ;
  switch (select_plm_5F_syntax_8 (inCompiler)) {
  case 1: {
    var_public_2375 = GALGAS_bool (false) ;
  } break ;
  case 2: {
    ...
    var_public_2375 = GALGAS_bool (true) ;
  } break ;
  default:
    break ;
  }
  ...
  GALGAS_lstring var_fieldName_2499 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GALGAS_lstring var_typeName_2526 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GALGAS_expressionAST var_initExpression_2571 ;
  nt_expression_ (var_initExpression_2571, inCompiler) ;
  ioArgument_ioPropertyList.addAssign_operation (var_fieldName_2499, var_public_2375, var_typeName_2526, GALGAS_structureVarInit::constructor_expression (var_initExpression_2571  COMMA_SOURCE_FILE ("type-extension-declaration.galgas", 75))  COMMA_SOURCE_FILE ("type-extension-declaration.galgas", 75)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_i15_ (GALGAS_ast & ioArgument_ioAST,
  ...
  cEnumerator_functionDeclarationListAST enumerator_2522 (var_functionDeclarationListAST_1677, kEnumeration_up) ;
  while (enumerator_2522.hasCurrentObject ()) {
    const enumGalgasBool test_1 = enumerator_2522.current (HERE).mAttribute_mPublicFunction.boolEnum () ;
    if (kBoolTrue == test_1) {
      GALGAS_lstring var_routineMangledName_2595 = GALGAS_lstring::constructor_new (GALGAS_string ("$").add_operation (var_moduleTypeName_1547.getter_string (SOURCE_FILE ("declaration-module.galgas", 71)), inCompiler COMMA_SOURCE_FILE ("declaration-module.galgas", 71)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("declaration-module.galgas", 71)).add_operation (enumerator_2522.current (HERE).mAttribute_mFunctionName.getter_string (SOURCE_FILE ("declaration-module.galgas", 71)), inCompiler COMMA_SOURCE_FILE ("declaration-module.galgas", 71)), enumerator_2522.current (HERE).mAttribute_mFunctionName.mAttribute_location  COMMA_SOURCE_FILE ("declaration-module.galgas", 70)) ;
      ...
      cEnumerator_procFormalArgumentList enumerator_2848 (enumerator_2522.current (HERE).mAttribute_mFunctionFormalArgumentList, kEnumeration_up) ;
      while (enumerator_2848.hasCurrentObject ()) {
        var_routineMangledName_2595.mAttribute_string.plusAssign_operation(extensionGetter_formalPassingModeString (enumerator_2848.current_mFormalArgumentPassingMode (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-module.galgas", 76)), inCompiler  COMMA_SOURCE_FILE ("declaration-module.galgas", 76)) ;
        var_routineMangledName_2595.mAttribute_string.plusAssign_operation(enumerator_2848.current_mSelector (HERE).mAttribute_string, inCompiler  COMMA_SOURCE_FILE ("declaration-module.galgas", 77)) ;
  ...
  cEnumerator_serviceDeclarationListAST enumerator_3177 (var_serviceListAST_1773, kEnumeration_up) ;
  while (enumerator_3177.hasCurrentObject ()) {
    GALGAS_lstring var_routineMangledName_3209 = GALGAS_lstring::constructor_new (GALGAS_string ("$").add_operation (var_moduleTypeName_1547.getter_string (SOURCE_FILE ("declaration-module.galgas", 86)), inCompiler COMMA_SOURCE_FILE ("declaration-module.galgas", 86)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("declaration-module.galgas", 86)).add_operation (enumerator_3177.current (HERE).mAttribute_mServiceName.getter_string (SOURCE_FILE ("declaration-module.galgas", 86)), inCompiler COMMA_SOURCE_FILE ("declaration-module.galgas", 86)), enumerator_3177.current (HERE).mAttribute_mServiceName.mAttribute_location  COMMA_SOURCE_FILE ("declaration-module.galgas", 85)) ;
    ...
    cEnumerator_procFormalArgumentList enumerator_3446 (enumerator_3177.current (HERE).mAttribute_mServiceFormalArgumentList, kEnumeration_up) ;
    while (enumerator_3446.hasCurrentObject ()) {
      var_routineMangledName_3209.mAttribute_string.plusAssign_operation(extensionGetter_formalPassingModeString (enumerator_3446.current_mFormalArgumentPassingMode (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-module.galgas", 91)), inCompiler  COMMA_SOURCE_FILE ("declaration-module.galgas", 91)) ;
      var_routineMangledName_3209.mAttribute_string.plusAssign_operation(enumerator_3446.current_mSelector (HERE).mAttribute_string, inCompiler  COMMA_SOURCE_FILE ("declaration-module.galgas", 92)) ;
  ...
  cEnumerator_guardDeclarationListAST enumerator_3749 (var_guardListAST_1875, kEnumeration_up) ;
  while (enumerator_3749.hasCurrentObject ()) {
    GALGAS_lstring var_routineMangledName_3781 = GALGAS_lstring::constructor_new (GALGAS_string ("$").add_operation (var_moduleTypeName_1547.getter_string (SOURCE_FILE ("declaration-module.galgas", 100)), inCompiler COMMA_SOURCE_FILE ("declaration-module.galgas", 100)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("declaration-module.galgas", 100)).add_operation (enumerator_3749.current (HERE).mAttribute_mGuardName.getter_string (SOURCE_FILE ("declaration-module.galgas", 100)), inCompiler COMMA_SOURCE_FILE ("declaration-module.galgas", 100)), enumerator_3749.current (HERE).mAttribute_mGuardName.mAttribute_location  COMMA_SOURCE_FILE ("declaration-module.galgas", 99)) ;
    ...
    cEnumerator_procFormalArgumentList enumerator_4006 (enumerator_3749.current (HERE).mAttribute_mGuardFormalArgumentList, kEnumeration_up) ;
    while (enumerator_4006.hasCurrentObject ()) {
      var_routineMangledName_3781.mAttribute_string.plusAssign_operation(extensionGetter_formalPassingModeString (enumerator_4006.current_mFormalArgumentPassingMode (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-module.galgas", 105)), inCompiler  COMMA_SOURCE_FILE ("declaration-module.galgas", 105)) ;
      var_routineMangledName_3781.mAttribute_string.plusAssign_operation(enumerator_4006.current_mSelector (HERE).mAttribute_string, inCompiler  COMMA_SOURCE_FILE ("declaration-module.galgas", 106)) ;
  ...
  while (enumerator_4317.hasCurrentObject ()) {
    ...
    cEnumerator_procFormalArgumentList enumerator_4598 (enumerator_4317.current (HERE).mAttribute_mPrimitiveFormalArgumentList, kEnumeration_up) ;
    while (enumerator_4598.hasCurrentObject ()) {
      var_routineMangledName_4349.mAttribute_string.plusAssign_operation(extensionGetter_formalPassingModeString (enumerator_4598.current_mFormalArgumentPassingMode (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-module.galgas", 119)), inCompiler  COMMA_SOURCE_FILE ("declaration-module.galgas", 119)) ;
      var_routineMangledName_4349.mAttribute_string.plusAssign_operation(enumerator_4598.current_mSelector (HERE).mAttribute_string, inCompiler  COMMA_SOURCE_FILE ("declaration-module.galgas", 120)) ;
  ...
  cEnumerator_initList enumerator_4896 (var_initList_1954, kEnumeration_up) ;
  while (enumerator_4896.hasCurrentObject ()) {
    ioArgument_ioAST.mAttribute_mInitList.addAssign_operation (enumerator_4896.current (HERE).mAttribute_mInitLocation, var_moduleTypeName_1547, var_moduleName_1524.mAttribute_string, var_requiredByList_2470, enumerator_4896.current (HERE).mAttribute_mInstructionList, enumerator_4896.current (HERE).mAttribute_mEndOfInitLocation, enumerator_4896.current (HERE).mAttribute_mPriority  COMMA_SOURCE_FILE ("declaration-module.galgas", 127)) ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_function_i22_ (GALGAS_functionDeclarationListAST & ioArgument_ioProcListAST,
                                                              C_Lexique_plm_5F_lexique * inCompiler) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_function_i22_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  switch (select_plm_5F_syntax_24 (inCompiler)) {
  case 1: {
  } break ;
  case 2: {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_mode_i23_ (GALGAS_mode & outArgument_outMode,
                                                          C_Lexique_plm_5F_lexique * inCompiler) {
  outArgument_outMode.drop () ; // Release 'out' argument
  switch (select_plm_5F_syntax_26 (inCompiler)) {
  case 1: {
    outArgument_outMode = GALGAS_mode::constructor_userMode (SOURCE_FILE ("declaration-func.galgas", 103)) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_panic) COMMA_SOURCE_FILE ("declaration-func.galgas", 105)) ;
    outArgument_outMode = GALGAS_mode::constructor_panicMode (SOURCE_FILE ("declaration-func.galgas", 106)) ;
  } break ;
  case 3: {
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_boot) COMMA_SOURCE_FILE ("declaration-func.galgas", 108)) ;
    outArgument_outMode = GALGAS_mode::constructor_bootMode (SOURCE_FILE ("declaration-func.galgas", 109)) ;
  } break ;
  case 4: {
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_init) COMMA_SOURCE_FILE ("declaration-func.galgas", 111)) ;
    outArgument_outMode = GALGAS_mode::constructor_initMode (SOURCE_FILE ("declaration-func.galgas", 112)) ;
  } break ;
  case 5: {
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_section) COMMA_SOURCE_FILE ("declaration-func.galgas", 114)) ;
    outArgument_outMode = GALGAS_mode::constructor_sectionMode (SOURCE_FILE ("declaration-func.galgas", 115)) ;
  } break ;
  case 6: {
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_service) COMMA_SOURCE_FILE ("declaration-func.galgas", 117)) ;
    outArgument_outMode = GALGAS_mode::constructor_serviceMode (SOURCE_FILE ("declaration-func.galgas", 118)) ;
  } break ;
  case 7: {
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_primitive) COMMA_SOURCE_FILE ("declaration-func.galgas", 120)) ;
    outArgument_outMode = GALGAS_mode::constructor_primitiveMode (SOURCE_FILE ("declaration-func.galgas", 121)) ;
  } break ;
  case 8: {
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_guard) COMMA_SOURCE_FILE ("declaration-func.galgas", 123)) ;
    outArgument_outMode = GALGAS_mode::constructor_guardMode (SOURCE_FILE ("declaration-func.galgas", 124)) ;
  } break ;
  case 9: {
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_safe) COMMA_SOURCE_FILE ("declaration-func.galgas", 126)) ;
    outArgument_outMode = GALGAS_mode::constructor_safeMode (SOURCE_FILE ("declaration-func.galgas", 127)) ;
  } break ;
  default:
    break ;
  }
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_mode_i23_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  switch (select_plm_5F_syntax_26 (inCompiler)) {
  case 1: {
  } break ;
  case 2: {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_function_5F_header_i24_ (GALGAS_mode & outArgument_outMode,
  ...
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_func) COMMA_SOURCE_FILE ("declaration-func.galgas", 140)) ;
  nt_mode_ (outArgument_outMode, inCompiler) ;
  outArgument_outProcName = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_identifier) COMMA_SOURCE_FILE ("declaration-func.galgas", 142)) ;
  outArgument_outAttributeList = GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("declaration-func.galgas", 143)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_plm_5F_syntax_27 (inCompiler)) {
    case 2: {
      GALGAS_lstring var_attribute_4277 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__40_attribute) COMMA_SOURCE_FILE ("declaration-func.galgas", 146)) ;
      outArgument_outAttributeList.addAssign_operation (var_attribute_4277  COMMA_SOURCE_FILE ("declaration-func.galgas", 147)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_function_5F_header_i24_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_func) COMMA_SOURCE_FILE ("declaration-func.galgas", 140)) ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_procedure_5F_formal_5F_arguments_i25_ (GALGAS_procFormalArgumentList & outArgument_outProcFormalArgumentList,
                                                                                      C_Lexique_plm_5F_lexique * inCompiler) {
  outArgument_outProcFormalArgumentList.drop () ; // Release 'out' argument
  outArgument_outProcFormalArgumentList = GALGAS_procFormalArgumentList::constructor_emptyList (SOURCE_FILE ("declaration-func.galgas", 155)) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__28_) COMMA_SOURCE_FILE ("declaration-func.galgas", 156)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_plm_5F_syntax_28 (inCompiler)) {
    case 2: {
      GALGAS_lstring var_selector_4718 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__21_) COMMA_SOURCE_FILE ("declaration-func.galgas", 159)) ;
      GALGAS_lstring var_formalArgumentName_4761 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_identifier) COMMA_SOURCE_FILE ("declaration-func.galgas", 160)) ;
      GALGAS_lstring var_formalArgumentTypeName_4804 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__24_type) COMMA_SOURCE_FILE ("declaration-func.galgas", 161)) ;
      outArgument_outProcFormalArgumentList.addAssign_operation (GALGAS_procFormalArgumentPassingMode::constructor_output (SOURCE_FILE ("declaration-func.galgas", 163)), var_selector_4718, var_formalArgumentTypeName_4804, var_formalArgumentName_4761  COMMA_SOURCE_FILE ("declaration-func.galgas", 162)) ;
    } break ;
    case 3: {
      GALGAS_lstring var_selector_4999 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__3F__21_) COMMA_SOURCE_FILE ("declaration-func.galgas", 168)) ;
      GALGAS_lstring var_formalArgumentName_5042 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_identifier) COMMA_SOURCE_FILE ("declaration-func.galgas", 169)) ;
      GALGAS_lstring var_formalArgumentTypeName_5085 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__24_type) COMMA_SOURCE_FILE ("declaration-func.galgas", 170)) ;
      outArgument_outProcFormalArgumentList.addAssign_operation (GALGAS_procFormalArgumentPassingMode::constructor_inputOutput (SOURCE_FILE ("declaration-func.galgas", 172)), var_selector_4999, var_formalArgumentTypeName_5085, var_formalArgumentName_5042  COMMA_SOURCE_FILE ("declaration-func.galgas", 171)) ;
    } break ;
    case 4: {
      GALGAS_lstring var_selector_5284 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__3F_) COMMA_SOURCE_FILE ("declaration-func.galgas", 177)) ;
      GALGAS_lstring var_formalArgumentName_5327 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_identifier) COMMA_SOURCE_FILE ("declaration-func.galgas", 178)) ;
      GALGAS_lstring var_formalArgumentTypeName_5370 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__24_type) COMMA_SOURCE_FILE ("declaration-func.galgas", 179)) ;
      outArgument_outProcFormalArgumentList.addAssign_operation (GALGAS_procFormalArgumentPassingMode::constructor_input (SOURCE_FILE ("declaration-func.galgas", 181)), var_selector_5284, var_formalArgumentTypeName_5370, var_formalArgumentName_5327  COMMA_SOURCE_FILE ("declaration-func.galgas", 180)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__29_) COMMA_SOURCE_FILE ("declaration-func.galgas", 186)) ;
}

//---------------------------------------------------------------------------------------------------------------------*

void cParser_plm_5F_syntax::rule_plm_5F_syntax_procedure_5F_formal_5F_arguments_i25_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__28_) COMMA_SOURCE_FILE ("declaration-func.galgas", 156)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_plm_5F_syntax_28 (inCompiler)) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_isr_i28_ (GALGAS_isrDeclarationListAST & ioArgument_ioISRListAST,
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_isr_i28_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_isr) COMMA_SOURCE_FILE ("declaration-isr.galgas", 23)) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_identifier) COMMA_SOURCE_FILE ("declaration-isr.galgas", 24)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_section_i29_ (GALGAS_sectionDeclarationListAST & ioArgument_ioSectionListAST,
                                                             C_Lexique_plm_5F_lexique * inCompiler) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_section_i29_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  switch (select_plm_5F_syntax_31 (inCompiler)) {
  case 1: {
  } break ;
  case 2: {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_service_i30_ (GALGAS_serviceDeclarationListAST & ioArgument_ioServiceListAST,
                                                             C_Lexique_plm_5F_lexique * inCompiler) {
  GALGAS_bool var_public_1235 ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_service_i30_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  switch (select_plm_5F_syntax_34 (inCompiler)) {
  case 1: {
  } break ;
  case 2: {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_primitive_i31_ (GALGAS_primitiveDeclarationListAST & ioArgument_ioPrimitiveListAST,
                                                               C_Lexique_plm_5F_lexique * inCompiler) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_primitive_i31_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  switch (select_plm_5F_syntax_37 (inCompiler)) {
  case 1: {
  } break ;
  case 2: {
