...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_i28_ (GALGAS_ast & ioArgument_ioAST,
  ...
  GALGAS_lstring var_prioriryAttribute_1926 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__40_attribute COMMA_SOURCE_FILE ("task-declaration.galgas", 46)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_prioriryAttribute_1926.getter_string (HERE).objectCompare (GALGAS_string ("priority"))).boolEnum () ;
  if (kBoolTrue == test_0) {
    TC_Array <C_FixItDescription> fixItArray1 ;
    inCompiler->emitSemanticError (var_prioriryAttribute_1926.getter_location (SOURCE_FILE ("task-declaration.galgas", 48)), GALGAS_string ("this attribute should be @priority"), fixItArray1  COMMA_SOURCE_FILE ("task-declaration.galgas", 48)) ;
  }
  GALGAS_lbigint var_priority_2091 = inCompiler->synthetizedAttribute_bigInteger () ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_integer COMMA_SOURCE_FILE ("task-declaration.galgas", 50)) ;
  GALGAS_lstring var_stackSizeAttribute_2132 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__40_attribute COMMA_SOURCE_FILE ("task-declaration.galgas", 51)) ;
  const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, var_stackSizeAttribute_2132.getter_string (HERE).objectCompare (GALGAS_string ("stacksize"))).boolEnum () ;
  if (kBoolTrue == test_2) {
    TC_Array <C_FixItDescription> fixItArray3 ;
    inCompiler->emitSemanticError (var_stackSizeAttribute_2132.getter_location (SOURCE_FILE ("task-declaration.galgas", 53)), GALGAS_string ("this attribute should be @stacksize"), fixItArray3  COMMA_SOURCE_FILE ("task-declaration.galgas", 53)) ;
  }
  GALGAS_lbigint var_stackSize_2302 = inCompiler->synthetizedAttribute_bigInteger () ;
  ...
  GALGAS_structurePropertyListAST var_taskVarList_2352 = GALGAS_structurePropertyListAST::constructor_emptyList (SOURCE_FILE ("task-declaration.galgas", 57)) ;
  GALGAS_functionDeclarationListAST var_taskProcList_2402 = GALGAS_functionDeclarationListAST::constructor_emptyList (SOURCE_FILE ("task-declaration.galgas", 58)) ;
  GALGAS_taskSetupListAST var_taskSetupListAST_2446 = GALGAS_taskSetupListAST::constructor_emptyList (SOURCE_FILE ("task-declaration.galgas", 59)) ;
  GALGAS_taskSetupListAST var_taskActivateListAST_2493 = GALGAS_taskSetupListAST::constructor_emptyList (SOURCE_FILE ("task-declaration.galgas", 60)) ;
  GALGAS_taskSetupListAST var_taskDeactivateListAST_2542 = GALGAS_taskSetupListAST::constructor_emptyList (SOURCE_FILE ("task-declaration.galgas", 61)) ;
  GALGAS_syncInstructionBranchListAST var_branchList_2592 = GALGAS_syncInstructionBranchListAST::constructor_emptyList (SOURCE_FILE ("task-declaration.galgas", 62)) ;
  bool repeatFlag_4 = true ;
  while (repeatFlag_4) {
    switch (select_plm_5F_syntax_46 (inCompiler)) {
    case 2: {
      nt_private_5F_struct_5F_property_5F_declaration_ (ioArgument_ioAST, var_taskVarList_2352, GALGAS_bool (true), inCompiler) ;
    } break ;
    case 3: {
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_func COMMA_SOURCE_FILE ("task-declaration.galgas", 67)) ;
      GALGAS_lstring var_procName_2746 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("task-declaration.galgas", 68)) ;
      GALGAS_routineFormalArgumentListAST var_formalArgumentList_2843 ;
      nt_procedure_5F_formal_5F_arguments_ (ioArgument_ioAST, var_formalArgumentList_2843, inCompiler) ;
      GALGAS_lstring var_returnTypeName_2873 ;
      switch (select_plm_5F_syntax_47 (inCompiler)) {
      case 1: {
        var_returnTypeName_2873 = GALGAS_string::makeEmptyString ().getter_here (inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 72)) ;
      } break ;
      case 2: {
        inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__2D__3E_ COMMA_SOURCE_FILE ("task-declaration.galgas", 74)) ;
        nt_type_5F_definition_ (ioArgument_ioAST, var_returnTypeName_2873, inCompiler) ;
      } break ;
      default:
        break ;
      }
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__7B_ COMMA_SOURCE_FILE ("task-declaration.galgas", 77)) ;
      ...
      var_taskProcList_2402.addAssign_operation (GALGAS_mode::constructor_userMode (SOURCE_FILE ("task-declaration.galgas", 79)), GALGAS_bool (false), var_procName_2746, GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("task-declaration.galgas", 79)), var_formalArgumentList_2843, var_returnTypeName_2873, var_instructionList_3066, GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 79))  COMMA_SOURCE_FILE ("task-declaration.galgas", 79)) ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__7D_ COMMA_SOURCE_FILE ("task-declaration.galgas", 80)) ;
    } break ;
    case 4: {
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_on COMMA_SOURCE_FILE ("task-declaration.galgas", 82)) ;
      GALGAS_lstring var_attribute_3245 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__40_attribute COMMA_SOURCE_FILE ("task-declaration.galgas", 83)) ;
      GALGAS_lstring var_name_3274 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("task-declaration.galgas", 84)) ;
      GALGAS_lstringlist var_dependenceList_3308 = GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("task-declaration.galgas", 85)) ;
      switch (select_plm_5F_syntax_48 (inCompiler)) {
      case 1: {
      } break ;
      case 2: {
        inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__3E_ COMMA_SOURCE_FILE ("task-declaration.galgas", 88)) ;
        bool repeatFlag_5 = true ;
        while (repeatFlag_5) {
          GALGAS_lstring var_dependenceName_3405 = inCompiler->synthetizedAttribute_tokenString () ;
          inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("task-declaration.galgas", 90)) ;
          var_dependenceList_3308.addAssign_operation (var_dependenceName_3405  COMMA_SOURCE_FILE ("task-declaration.galgas", 91)) ;
          switch (select_plm_5F_syntax_49 (inCompiler)) {
          case 2: {
            inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__2C_ COMMA_SOURCE_FILE ("task-declaration.galgas", 93)) ;
          } break ;
          default:
            repeatFlag_5 = false ;
            break ;
      ...
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__7B_ COMMA_SOURCE_FILE ("task-declaration.galgas", 96)) ;
      GALGAS_instructionListAST var_instructionList_3562 ;
      nt_instructionList_ (ioArgument_ioAST, var_instructionList_3562, inCompiler) ;
      GALGAS_location var_endOfInit_3582 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 98)) ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__7D_ COMMA_SOURCE_FILE ("task-declaration.galgas", 99)) ;
      const enumGalgasBool test_6 = GALGAS_bool (kIsEqual, var_attribute_3245.getter_string (HERE).objectCompare (GALGAS_string ("setup"))).boolEnum () ;
      if (kBoolTrue == test_6) {
        var_taskSetupListAST_2446.addAssign_operation (var_name_3274, var_dependenceList_3308, var_instructionList_3562, var_endOfInit_3582  COMMA_SOURCE_FILE ("task-declaration.galgas", 101)) ;
      }else if (kBoolFalse == test_6) {
        const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, var_attribute_3245.getter_string (HERE).objectCompare (GALGAS_string ("activate"))).boolEnum () ;
        if (kBoolTrue == test_7) {
          var_taskActivateListAST_2493.addAssign_operation (var_name_3274, var_dependenceList_3308, var_instructionList_3562, var_endOfInit_3582  COMMA_SOURCE_FILE ("task-declaration.galgas", 103)) ;
        }else if (kBoolFalse == test_7) {
          const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, var_attribute_3245.getter_string (HERE).objectCompare (GALGAS_string ("deactivate"))).boolEnum () ;
          if (kBoolTrue == test_8) {
            var_taskDeactivateListAST_2542.addAssign_operation (var_name_3274, var_dependenceList_3308, var_instructionList_3562, var_endOfInit_3582  COMMA_SOURCE_FILE ("task-declaration.galgas", 105)) ;
          }else if (kBoolFalse == test_8) {
            TC_Array <C_FixItDescription> fixItArray9 ;
            inCompiler->emitSemanticError (var_attribute_3245.getter_location (SOURCE_FILE ("task-declaration.galgas", 107)), GALGAS_string ("attribute should be @setup, @activate or @deactivate"), fixItArray9  COMMA_SOURCE_FILE ("task-declaration.galgas", 107)) ;
          }
        }
      }
    } break ;
    case 5: {
      GALGAS_guardedCommandAST var_guardedCommand_4174 ;
      nt_guarded_5F_command_ (ioArgument_ioAST, var_guardedCommand_4174, inCompiler) ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__7B_ COMMA_SOURCE_FILE ("task-declaration.galgas", 111)) ;
      GALGAS_instructionListAST var_instructionList_4237 ;
      nt_instructionList_ (ioArgument_ioAST, var_instructionList_4237, inCompiler) ;
      GALGAS_location var_endOfInstructions_4265 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 113)) ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__7D_ COMMA_SOURCE_FILE ("task-declaration.galgas", 114)) ;
      var_branchList_2592.addAssign_operation (var_guardedCommand_4174, var_instructionList_4237, var_endOfInstructions_4265  COMMA_SOURCE_FILE ("task-declaration.galgas", 115)) ;
    } break ;
    default:
      repeatFlag_4 = false ;
      break ;
  ...
  GALGAS_location var_endOfTask_4390 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 117)) ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__7D_ COMMA_SOURCE_FILE ("task-declaration.galgas", 118)) ;
  ioArgument_ioAST.mProperty_mTaskListAST.addAssign_operation (var_taskName_1886, var_priority_2091, var_stackSize_2302, var_taskVarList_2352, var_taskProcList_2402, var_taskSetupListAST_2446, var_taskActivateListAST_2493, var_taskDeactivateListAST_2542, var_branchList_2592, var_endOfTask_4390  COMMA_SOURCE_FILE ("task-declaration.galgas", 119)) ;
}
