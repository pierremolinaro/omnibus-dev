...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_start_5F_symbol_i1_ (GALGAS_ast & ioArgument_ioAST,
  ...
  while (repeatFlag_0) {
    ...
    case 3: {
      GALGAS_systemRoutineDeclarationListAST var_standAloneSystemRoutineListAST_1237 = GALGAS_systemRoutineDeclarationListAST::constructor_emptyList (SOURCE_FILE ("syntax-grammar.galgas", 31)) ;
      nt_system_5F_routine_ (ioArgument_ioAST, var_standAloneSystemRoutineListAST_1237, inCompiler) ;
      ioArgument_ioAST.mProperty_mStandAloneSystemRoutineListAST.plusAssign_operation(var_standAloneSystemRoutineListAST_1237, inCompiler  COMMA_SOURCE_FILE ("syntax-grammar.galgas", 33)) ;
    } break ;
    case 4: {
  ...
  outArgument_outEndOfSourceFile = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("syntax-grammar.galgas", 37)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_private_5F_or_5F_public_5F_struct_5F_property_5F_declaration_i7_ (GALGAS_ast & ioArgument_ioAST,
                                                                                                                 ...
                                                                                                                 C_Lexique_plm_5F_lexique * inCompiler) {
  GALGAS_bool var_public_2497 ;
  switch (select_plm_5F_syntax_2 (inCompiler)) {
  case 1: {
    var_public_2497 = GALGAS_bool (false) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_public COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 61)) ;
    var_public_2497 = GALGAS_bool (true) ;
  } break ;
  default:
    break ;
  }
  nt_struct_5F_property_5F_declaration_ (ioArgument_ioAST, var_public_2497, ioArgument_ioFieldListAST, constinArgument_isSingletonObject, inCompiler) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_struct_5F_property_5F_declaration_i9_ (GALGAS_ast & ioArgument_ioAST,
                                                                                      ...
                                                                                      const GALGAS_bool constinArgument_isSingletonObject,
                                                                                      C_Lexique_plm_5F_lexique * inCompiler) {
  GALGAS_bool var_constant_3331 ;
  switch (select_plm_5F_syntax_3 (inCompiler)) {
  case 1: {
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_var COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 87)) ;
    var_constant_3331 = GALGAS_bool (false) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_let COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 90)) ;
    var_constant_3331 = GALGAS_bool (true) ;
  } break ;
  default:
    break ;
  }
  GALGAS_lstring var_fieldName_3458 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 93)) ;
  switch (select_plm_5F_syntax_4 (inCompiler)) {
  case 1: {
    GALGAS_lstring var_typeName_3516 ;
    nt_type_5F_definition_ (ioArgument_ioAST, var_typeName_3516, inCompiler) ;
    switch (select_plm_5F_syntax_5 (inCompiler)) {
    case 1: {
      ioArgument_ioFieldListAST.addAssign_operation (var_fieldName_3458, GALGAS_propertyAttributeList::constructor_emptyList (SOURCE_FILE ("type-structure-declaration.galgas", 97)), var_constant_3331, constinArgument_isPublic, var_typeName_3516, GALGAS_structurePropertyInitOptionalExpressionAST::constructor_noExpression (SOURCE_FILE ("type-structure-declaration.galgas", 97)), constinArgument_isSingletonObject  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 97)) ;
    } break ;
    case 2: {
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__3D_ COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 99)) ;
      GALGAS_expressionAST var_initExpression_3704 ;
      nt_expression_ (ioArgument_ioAST, var_initExpression_3704, inCompiler) ;
      ioArgument_ioFieldListAST.addAssign_operation (var_fieldName_3458, GALGAS_propertyAttributeList::constructor_emptyList (SOURCE_FILE ("type-structure-declaration.galgas", 103)), var_constant_3331, constinArgument_isPublic, var_typeName_3516, GALGAS_structurePropertyInitOptionalExpressionAST::constructor_expression (var_initExpression_3704  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 107)), constinArgument_isSingletonObject  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 101)) ;
    } break ;
    default:
      break ;
    }
  ...
  case 2: {
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__3D_ COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 111)) ;
    GALGAS_expressionAST var_initExpression_3984 ;
    nt_expression_ (ioArgument_ioAST, var_initExpression_3984, inCompiler) ;
    ioArgument_ioFieldListAST.addAssign_operation (var_fieldName_3458, GALGAS_propertyAttributeList::constructor_emptyList (SOURCE_FILE ("type-structure-declaration.galgas", 115)), var_constant_3331, constinArgument_isPublic, GALGAS_string::makeEmptyString ().getter_nowhere (SOURCE_FILE ("type-structure-declaration.galgas", 118)), GALGAS_structurePropertyInitOptionalExpressionAST::constructor_expression (var_initExpression_3984  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 119)), constinArgument_isSingletonObject  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 113)) ;
  } break ;
  default:
    break ;
  }
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_structure_5F_function_i10_ (GALGAS_ast & ioArgument_ioAST,
                                                                           ...
                                                                           C_Lexique_plm_5F_lexique * inCompiler) {
  GALGAS_bool var_public_4415 ;
  switch (select_plm_5F_syntax_6 (inCompiler)) {
  case 1: {
    var_public_4415 = GALGAS_bool (false) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_public COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 131)) ;
    var_public_4415 = GALGAS_bool (true) ;
  } break ;
  default:
    break ;
  }
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_func COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 134)) ;
  GALGAS_lstring var_procName_4539 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 135)) ;
  GALGAS_lstringlist var_attributeList_4570 = GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("type-structure-declaration.galgas", 136)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_plm_5F_syntax_7 (inCompiler)) {
    case 2: {
      GALGAS_lstring var_attribute_4630 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__40_attribute COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 139)) ;
      var_attributeList_4570.addAssign_operation (var_attribute_4630  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 140)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  GALGAS_routineFormalArgumentListAST var_procFormalArgumentList_4742 ;
  nt_procedure_5F_formal_5F_arguments_ (ioArgument_ioAST, var_procFormalArgumentList_4742, inCompiler) ;
  GALGAS_lstring var_returnTypeName_4770 ;
  switch (select_plm_5F_syntax_8 (inCompiler)) {
  case 1: {
    var_returnTypeName_4770 = GALGAS_string::makeEmptyString ().getter_here (inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 145)) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__2D__3E_ COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 147)) ;
    nt_type_5F_definition_ (ioArgument_ioAST, var_returnTypeName_4770, inCompiler) ;
  } break ;
  default:
    break ;
  }
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__7B_ COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 150)) ;
  GALGAS_instructionListAST var_instructionList_4947 ;
  nt_instructionList_ (ioArgument_ioAST, var_instructionList_4947, inCompiler) ;
  ioArgument_ioProcListAST.addAssign_operation (GALGAS_mode::constructor_anyMode (SOURCE_FILE ("type-structure-declaration.galgas", 153)), var_public_4415, var_procName_4539, var_attributeList_4570, var_procFormalArgumentList_4742, var_returnTypeName_4770, var_instructionList_4947, GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 160))  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 152)) ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__7D_ COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 161)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_i11_ (GALGAS_ast & ioArgument_ioAST,
                                                                 C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_struct COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 167)) ;
  GALGAS_lstring var_structureName_5339 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__24_type COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 168)) ;
  GALGAS_lstringlist var_attributeList_5370 = GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("type-structure-declaration.galgas", 169)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_plm_5F_syntax_9 (inCompiler)) {
    case 2: {
      GALGAS_lstring var_attribute_5430 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__40_attribute COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 172)) ;
      var_attributeList_5370.addAssign_operation (var_attribute_5430  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 173)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__7B_ COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 175)) ;
  GALGAS_functionDeclarationListAST var_procedureDeclarationListAST_5541 = GALGAS_functionDeclarationListAST::constructor_emptyList (SOURCE_FILE ("type-structure-declaration.galgas", 176)) ;
  GALGAS_structurePropertyListAST var_fieldList_5586 = GALGAS_structurePropertyListAST::constructor_emptyList (SOURCE_FILE ("type-structure-declaration.galgas", 177)) ;
  bool repeatFlag_1 = true ;
  while (repeatFlag_1) {
    switch (select_plm_5F_syntax_10 (inCompiler)) {
    case 2: {
      nt_private_5F_or_5F_public_5F_struct_5F_property_5F_declaration_ (ioArgument_ioAST, var_fieldList_5586, GALGAS_bool (false), inCompiler) ;
    } break ;
    case 3: {
      nt_structure_5F_function_ (ioArgument_ioAST, var_procedureDeclarationListAST_5541, inCompiler) ;
    } break ;
    default:
      repeatFlag_1 = false ;
      break ;
  ...
  ioArgument_ioAST.mProperty_mDeclarationListAST.addAssign_operation (GALGAS_structureDeclarationAST::constructor_new (var_structureName_5339, var_structureName_5339, var_structureName_5339, var_attributeList_5370, GALGAS_bool (true), var_fieldList_5586, var_procedureDeclarationListAST_5541, GALGAS_systemRoutineDeclarationListAST::constructor_emptyList (SOURCE_FILE ("type-structure-declaration.galgas", 193)), GALGAS_guardDeclarationListAST::constructor_emptyList (SOURCE_FILE ("type-structure-declaration.galgas", 194)), GALGAS_bool (true)  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 185))  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 185)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_driver_5F_property_i19_ (GALGAS_ast & ioArgument_ioAST,
                                                                        ...
                                                                        C_Lexique_plm_5F_lexique * inCompiler) {
  GALGAS_bool var_constant_3077 ;
  switch (select_plm_5F_syntax_28 (inCompiler)) {
  case 1: {
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_var COMMA_SOURCE_FILE ("declaration-driver.galgas", 79)) ;
    var_constant_3077 = GALGAS_bool (false) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_let COMMA_SOURCE_FILE ("declaration-driver.galgas", 82)) ;
    var_constant_3077 = GALGAS_bool (true) ;
  } break ;
  default:
    break ;
  }
  GALGAS_lstring var_fieldName_3204 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("declaration-driver.galgas", 85)) ;
  GALGAS_propertyAttributeList var_propertyAttributeList_3253 = GALGAS_propertyAttributeList::constructor_emptyList (SOURCE_FILE ("declaration-driver.galgas", 86)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_plm_5F_syntax_29 (inCompiler)) {
    case 2: {
      GALGAS_lstring var_attribute_3313 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__40_attribute COMMA_SOURCE_FILE ("declaration-driver.galgas", 89)) ;
      GALGAS_lbigint var_value_3340 = inCompiler->synthetizedAttribute_bigInteger () ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_integer COMMA_SOURCE_FILE ("declaration-driver.galgas", 90)) ;
      var_propertyAttributeList_3253.addAssign_operation (var_attribute_3313, var_value_3340  COMMA_SOURCE_FILE ("declaration-driver.galgas", 91)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  case 1: {
    GALGAS_lstring var_typeName_3454 ;
    nt_type_5F_definition_ (ioArgument_ioAST, var_typeName_3454, inCompiler) ;
    switch (select_plm_5F_syntax_31 (inCompiler)) {
    case 1: {
      ioArgument_ioPropertyList.addAssign_operation (var_fieldName_3204, var_propertyAttributeList_3253, var_constant_3077, var_typeName_3454, GALGAS_structurePropertyInitOptionalExpressionAST::constructor_noExpression (SOURCE_FILE ("declaration-driver.galgas", 96))  COMMA_SOURCE_FILE ("declaration-driver.galgas", 96)) ;
    } break ;
    case 2: {
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__3D_ COMMA_SOURCE_FILE ("declaration-driver.galgas", 98)) ;
      GALGAS_expressionAST var_initExpression_3632 ;
      nt_expression_ (ioArgument_ioAST, var_initExpression_3632, inCompiler) ;
      ioArgument_ioPropertyList.addAssign_operation (var_fieldName_3204, var_propertyAttributeList_3253, var_constant_3077, var_typeName_3454, GALGAS_structurePropertyInitOptionalExpressionAST::constructor_expression (var_initExpression_3632  COMMA_SOURCE_FILE ("declaration-driver.galgas", 100))  COMMA_SOURCE_FILE ("declaration-driver.galgas", 100)) ;
    } break ;
    default:
      break ;
    }
  ...
  case 2: {
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__3D_ COMMA_SOURCE_FILE ("declaration-driver.galgas", 103)) ;
    GALGAS_expressionAST var_initExpression_3832 ;
    nt_expression_ (ioArgument_ioAST, var_initExpression_3832, inCompiler) ;
    ioArgument_ioPropertyList.addAssign_operation (var_fieldName_3204, var_propertyAttributeList_3253, var_constant_3077, GALGAS_string::makeEmptyString ().getter_nowhere (SOURCE_FILE ("declaration-driver.galgas", 105)), GALGAS_structurePropertyInitOptionalExpressionAST::constructor_expression (var_initExpression_3832  COMMA_SOURCE_FILE ("declaration-driver.galgas", 105))  COMMA_SOURCE_FILE ("declaration-driver.galgas", 105)) ;
  } break ;
  default:
    break ;
  }
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_i20_ (GALGAS_ast & ioArgument_ioAST,
                                                                 C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_driver COMMA_SOURCE_FILE ("declaration-driver.galgas", 112)) ;
  GALGAS_lstring var_driverName_4179 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("declaration-driver.galgas", 113)) ;
  GALGAS_lstringlist var_driverDependenceList_4217 = GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("declaration-driver.galgas", 114)) ;
  switch (select_plm_5F_syntax_32 (inCompiler)) {
  case 1: {
  } break ;
  case 2: {
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__3E_ COMMA_SOURCE_FILE ("declaration-driver.galgas", 117)) ;
    bool repeatFlag_0 = true ;
    while (repeatFlag_0) {
      GALGAS_lstring var_dependenceName_4304 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("declaration-driver.galgas", 119)) ;
      var_driverDependenceList_4217.addAssign_operation (var_dependenceName_4304  COMMA_SOURCE_FILE ("declaration-driver.galgas", 120)) ;
      switch (select_plm_5F_syntax_33 (inCompiler)) {
      case 2: {
        inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__2C_ COMMA_SOURCE_FILE ("declaration-driver.galgas", 122)) ;
      } break ;
      default:
        repeatFlag_0 = false ;
        break ;
  ...
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__7B_ COMMA_SOURCE_FILE ("declaration-driver.galgas", 125)) ;
  GALGAS_functionDeclarationListAST var_functionDeclarationListAST_4468 = GALGAS_functionDeclarationListAST::constructor_emptyList (SOURCE_FILE ("declaration-driver.galgas", 126)) ;
  GALGAS_driverPropertyListAST var_driverPropertyListAST_4522 = GALGAS_driverPropertyListAST::constructor_emptyList (SOURCE_FILE ("declaration-driver.galgas", 127)) ;
  GALGAS_guardDeclarationListAST var_guardListAST_4569 = GALGAS_guardDeclarationListAST::constructor_emptyList (SOURCE_FILE ("declaration-driver.galgas", 128)) ;
  GALGAS_systemRoutineDeclarationListAST var_svcListAST_4622 = GALGAS_systemRoutineDeclarationListAST::constructor_emptyList (SOURCE_FILE ("declaration-driver.galgas", 129)) ;
  GALGAS_bool var_bootHandled_4647 = GALGAS_bool (false) ;
  GALGAS_location var_bootLocation_4676 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-driver.galgas", 131)) ;
  GALGAS_instructionListAST var_bootInstructionList_4737 = GALGAS_instructionListAST::constructor_emptyList (SOURCE_FILE ("declaration-driver.galgas", 132)) ;
  GALGAS_location var_bootEndLocation_4766 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-driver.galgas", 133)) ;
  GALGAS_bool var_startupHandled_4806 = GALGAS_bool (false) ;
  GALGAS_location var_startupLocation_4838 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-driver.galgas", 135)) ;
  GALGAS_instructionListAST var_startupInstructionList_4902 = GALGAS_instructionListAST::constructor_emptyList (SOURCE_FILE ("declaration-driver.galgas", 136)) ;
  GALGAS_location var_startupEndLocation_4934 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-driver.galgas", 137)) ;
  bool repeatFlag_1 = true ;
  while (repeatFlag_1) {
    switch (select_plm_5F_syntax_34 (inCompiler)) {
    case 2: {
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_boot COMMA_SOURCE_FILE ("declaration-driver.galgas", 140)) ;
      var_bootLocation_4676 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-driver.galgas", 141)) ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__7B_ COMMA_SOURCE_FILE ("declaration-driver.galgas", 142)) ;
      nt_instructionList_ (ioArgument_ioAST, var_bootInstructionList_4737, inCompiler) ;
      var_bootEndLocation_4766 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-driver.galgas", 144)) ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__7D_ COMMA_SOURCE_FILE ("declaration-driver.galgas", 145)) ;
      const enumGalgasBool test_2 = var_bootHandled_4647.boolEnum () ;
      if (kBoolTrue == test_2) {
        TC_Array <C_FixItDescription> fixItArray3 ;
        inCompiler->emitSemanticError (var_bootLocation_4676, GALGAS_string ("a driver supports at most one boot routine"), fixItArray3  COMMA_SOURCE_FILE ("declaration-driver.galgas", 147)) ;
      }
      var_bootHandled_4647 = GALGAS_bool (true) ;
    } break ;
    case 3: {
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_startup COMMA_SOURCE_FILE ("declaration-driver.galgas", 151)) ;
      var_startupLocation_4838 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-driver.galgas", 152)) ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__7B_ COMMA_SOURCE_FILE ("declaration-driver.galgas", 153)) ;
      nt_instructionList_ (ioArgument_ioAST, var_startupInstructionList_4902, inCompiler) ;
      var_startupEndLocation_4934 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-driver.galgas", 155)) ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__7D_ COMMA_SOURCE_FILE ("declaration-driver.galgas", 156)) ;
      const enumGalgasBool test_4 = var_startupHandled_4806.boolEnum () ;
      if (kBoolTrue == test_4) {
        TC_Array <C_FixItDescription> fixItArray5 ;
        inCompiler->emitSemanticError (var_startupLocation_4838, GALGAS_string ("a driver supports at most one startup routine"), fixItArray5  COMMA_SOURCE_FILE ("declaration-driver.galgas", 158)) ;
      }
      var_startupHandled_4806 = GALGAS_bool (true) ;
    } break ;
    case 4: {
      nt_isr_ (ioArgument_ioAST, var_driverName_4179, inCompiler) ;
    } break ;
    case 5: {
      nt_driver_5F_property_ (ioArgument_ioAST, var_driverPropertyListAST_4522, inCompiler) ;
    } break ;
    case 6: {
      nt_function_ (ioArgument_ioAST, var_functionDeclarationListAST_4468, inCompiler) ;
    } break ;
    case 7: {
      nt_system_5F_routine_ (ioArgument_ioAST, var_svcListAST_4622, inCompiler) ;
    } break ;
    case 8: {
      nt_guard_ (ioArgument_ioAST, var_guardListAST_4569, inCompiler) ;
    } break ;
    default:
      repeatFlag_1 = false ;
      break ;
  ...
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__7D_ COMMA_SOURCE_FILE ("declaration-driver.galgas", 172)) ;
  ioArgument_ioAST.mProperty_mDriverDeclarationListAST.addAssign_operation (GALGAS_driverDeclarationAST::constructor_new (var_driverName_4179, var_driverDependenceList_4217, var_driverPropertyListAST_4522, var_functionDeclarationListAST_4468, var_svcListAST_4622, var_guardListAST_4569, var_bootLocation_4676, var_bootInstructionList_4737, var_bootEndLocation_4766, var_startupLocation_4838, var_startupInstructionList_4902, var_startupEndLocation_4934  COMMA_SOURCE_FILE ("declaration-driver.galgas", 174))  COMMA_SOURCE_FILE ("declaration-driver.galgas", 174)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_i21_ (GALGAS_ast & ioArgument_ioAST,
                                                                 C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_driver COMMA_SOURCE_FILE ("declaration-driver.galgas", 193)) ;
  GALGAS_lstring var_driverName_6469 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("declaration-driver.galgas", 194)) ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__28_ COMMA_SOURCE_FILE ("declaration-driver.galgas", 195)) ;
  GALGAS_driverInstanciationArgumentListAST var_driverInstanciationArgumentList_6549 = GALGAS_driverInstanciationArgumentListAST::constructor_emptyList (SOURCE_FILE ("declaration-driver.galgas", 196)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_plm_5F_syntax_35 (inCompiler)) {
    case 2: {
      GALGAS_lstring var_selector_6608 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__21_selector_3A_ COMMA_SOURCE_FILE ("declaration-driver.galgas", 199)) ;
      GALGAS_expressionAST var_expression_6651 ;
      nt_expression_ (ioArgument_ioAST, var_expression_6651, inCompiler) ;
      var_driverInstanciationArgumentList_6549.addAssign_operation (var_selector_6608, var_expression_6651  COMMA_SOURCE_FILE ("declaration-driver.galgas", 201)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__29_ COMMA_SOURCE_FILE ("declaration-driver.galgas", 203)) ;
  ioArgument_ioAST.mProperty_mRequiredDriverListAST.addAssign_operation (var_driverName_6469, var_driverInstanciationArgumentList_6549  COMMA_SOURCE_FILE ("declaration-driver.galgas", 204)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_i23_ (GALGAS_ast & ioArgument_ioAST,
  ...
  GALGAS_staticListPropertyListAST var_propertyList_2666 = GALGAS_staticListPropertyListAST::constructor_emptyList (SOURCE_FILE ("declaration-static-list.galgas", 64)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_staticArrayProperty_i24_ (GALGAS_ast & ioArgument_ioAST,
  ...
  case 1: {
    ...
    ioArgument_ioPropertyList.addAssign_operation (var_propertyName_3107, GALGAS_staticListPropertyTypeAST::constructor_valueType (var_typeName_3164  COMMA_SOURCE_FILE ("declaration-static-list.galgas", 80))  COMMA_SOURCE_FILE ("declaration-static-list.galgas", 80)) ;
  } break ;
  case 2: {
    ...
    GALGAS_lstringlist var_attributeList_3306 = GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("declaration-static-list.galgas", 84)) ;
    bool repeatFlag_0 = true ;
    while (repeatFlag_0) {
      ...
      case 2: {
        ...
        var_attributeList_3306.addAssign_operation (var_attribute_3372  COMMA_SOURCE_FILE ("declaration-static-list.galgas", 88)) ;
      } break ;
      default:
        repeatFlag_0 = false ;
        break ;
    ...
    case 1: {
      var_returnType_3503 = GALGAS_string::makeEmptyString ().getter_here (inCompiler COMMA_SOURCE_FILE ("declaration-static-list.galgas", 93)) ;
    } break ;
    case 2: {
    ...
    while (enumerator_3688.hasCurrentObject ()) {
      const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_3688.current_mValue (HERE).getter_string (HERE).objectCompare (function_safeAttribute (inCompiler COMMA_SOURCE_FILE ("declaration-static-list.galgas", 100)))).boolEnum () ;
      if (kBoolTrue == test_1) {
        const enumGalgasBool test_2 = var_isSafe_3641.boolEnum () ;
        if (kBoolTrue == test_2) {
          TC_Array <C_FixItDescription> fixItArray3 ;
          fixItArray3.appendObject (C_FixItDescription (kFixItRemove, "")) ;
          inCompiler->emitSemanticError (enumerator_3688.current_mValue (HERE).getter_location (SOURCE_FILE ("declaration-static-list.galgas", 102)), GALGAS_string ("duplicated attribute"), fixItArray3  COMMA_SOURCE_FILE ("declaration-static-list.galgas", 102)) ;
        }else if (kBoolFalse == test_2) {
          var_isSafe_3641 = GALGAS_bool (true) ;
        }
      }else if (kBoolFalse == test_1) {
        TC_Array <C_FixItDescription> fixItArray4 ;
        appendFixItActions (fixItArray4, kFixItReplace, GALGAS_string ("@").add_operation (function_safeAttribute (inCompiler COMMA_SOURCE_FILE ("declaration-static-list.galgas", 107)), inCompiler COMMA_SOURCE_FILE ("declaration-static-list.galgas", 107))) ;
        inCompiler->emitSemanticError (enumerator_3688.current_mValue (HERE).getter_location (SOURCE_FILE ("declaration-static-list.galgas", 107)), GALGAS_string ("invalid attribute"), fixItArray4  COMMA_SOURCE_FILE ("declaration-static-list.galgas", 107)) ;
      }
      enumerator_3688.gotoNextObject () ;
    }
    ioArgument_ioPropertyList.addAssign_operation (var_propertyName_3107, GALGAS_staticListPropertyTypeAST::constructor_function (var_mode_3273, var_isSafe_3641, var_formalArgs_3477, var_returnType_3503  COMMA_SOURCE_FILE ("declaration-static-list.galgas", 110))  COMMA_SOURCE_FILE ("declaration-static-list.galgas", 110)) ;
  } break ;
  default:
    break ;
  }
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_i25_ (GALGAS_ast & ioArgument_ioAST,
  ...
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    GALGAS_extendStaticListElementListAST var_expressions_4589 = GALGAS_extendStaticListElementListAST::constructor_emptyList (SOURCE_FILE ("declaration-static-list.galgas", 124)) ;
    bool repeatFlag_1 = true ;
    while (repeatFlag_1) {
    ...
    ioArgument_ioAST.mProperty_mExtendStaticArrayDeclarationAST.addAssign_operation (var_staticListName_4520, var_expressions_4589  COMMA_SOURCE_FILE ("declaration-static-list.galgas", 130)) ;
    switch (select_plm_5F_syntax_40 (inCompiler)) {
    case 2: {
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__3A__3A_ COMMA_SOURCE_FILE ("declaration-static-list.galgas", 132)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__29_ COMMA_SOURCE_FILE ("declaration-static-list.galgas", 134)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_staticArray_5F_exp_i26_ (GALGAS_ast & ioArgument_ioAST,
  ...
  case 1: {
    GALGAS_expressionAST var_exp_5065 ;
    nt_expression_ (ioArgument_ioAST, var_exp_5065, inCompiler) ;
    ioArgument_ioExpressions.addAssign_operation (GALGAS_extendStaticListExpressionAST::constructor_expression (var_exp_5065  COMMA_SOURCE_FILE ("declaration-static-list.galgas", 142)), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-static-list.galgas", 142))  COMMA_SOURCE_FILE ("declaration-static-list.galgas", 142)) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_func COMMA_SOURCE_FILE ("declaration-static-list.galgas", 144)) ;
    GALGAS_lstring var_functionName_5176 = inCompiler->synthetizedAttribute_tokenString () ;
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("declaration-static-list.galgas", 145)) ;
    GALGAS_routineFormalArgumentListAST var_formalArgs_5235 ;
    nt_procedure_5F_formal_5F_arguments_ (ioArgument_ioAST, var_formalArgs_5235, inCompiler) ;
    ioArgument_ioExpressions.addAssign_operation (GALGAS_extendStaticListExpressionAST::constructor_function (var_functionName_5176, var_formalArgs_5235  COMMA_SOURCE_FILE ("declaration-static-list.galgas", 148)), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-static-list.galgas", 149))  COMMA_SOURCE_FILE ("declaration-static-list.galgas", 147)) ;
  } break ;
  default:
    break ;
  }
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_declaration_i28_ (GALGAS_ast & ioArgument_ioAST,
                                                                 C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_task COMMA_SOURCE_FILE ("task-declaration.galgas", 45)) ;
  GALGAS_lstring var_taskName_1921 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("task-declaration.galgas", 46)) ;
  GALGAS_lstringlist var_higherPriorityTaskList_1961 = GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("task-declaration.galgas", 47)) ;
  switch (select_plm_5F_syntax_43 (inCompiler)) {
  case 1: {
  } break ;
  case 2: {
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__3E_ COMMA_SOURCE_FILE ("task-declaration.galgas", 50)) ;
    bool repeatFlag_0 = true ;
    while (repeatFlag_0) {
      GALGAS_lstring var_aTaskName_2043 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("task-declaration.galgas", 52)) ;
      var_higherPriorityTaskList_1961.addAssign_operation (var_aTaskName_2043  COMMA_SOURCE_FILE ("task-declaration.galgas", 53)) ;
      switch (select_plm_5F_syntax_44 (inCompiler)) {
      case 2: {
        inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__2C_ COMMA_SOURCE_FILE ("task-declaration.galgas", 55)) ;
      } break ;
      default:
        repeatFlag_0 = false ;
        break ;
  ...
  GALGAS_lstring var_stackSizeAttribute_2171 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__40_attribute COMMA_SOURCE_FILE ("task-declaration.galgas", 58)) ;
  const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, var_stackSizeAttribute_2171.getter_string (HERE).objectCompare (GALGAS_string ("stacksize"))).boolEnum () ;
  if (kBoolTrue == test_1) {
    TC_Array <C_FixItDescription> fixItArray2 ;
    inCompiler->emitSemanticError (var_stackSizeAttribute_2171.getter_location (SOURCE_FILE ("task-declaration.galgas", 60)), GALGAS_string ("this attribute should be @stacksize"), fixItArray2  COMMA_SOURCE_FILE ("task-declaration.galgas", 60)) ;
  }
  GALGAS_lbigint var_stackSize_2341 = inCompiler->synthetizedAttribute_bigInteger () ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_integer COMMA_SOURCE_FILE ("task-declaration.galgas", 62)) ;
  GALGAS_bool var_activate_2385 = GALGAS_bool (false) ;
  switch (select_plm_5F_syntax_45 (inCompiler)) {
  case 1: {
  } break ;
  case 2: {
    GALGAS_lstring var_activateAttribute_2453 = inCompiler->synthetizedAttribute_tokenString () ;
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__40_attribute COMMA_SOURCE_FILE ("task-declaration.galgas", 67)) ;
    const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, var_activateAttribute_2453.getter_string (HERE).objectCompare (GALGAS_string ("activate"))).boolEnum () ;
    if (kBoolTrue == test_3) {
      TC_Array <C_FixItDescription> fixItArray4 ;
      inCompiler->emitSemanticError (var_activateAttribute_2453.getter_location (SOURCE_FILE ("task-declaration.galgas", 69)), GALGAS_string ("this attribute should be @activate"), fixItArray4  COMMA_SOURCE_FILE ("task-declaration.galgas", 69)) ;
    }
    var_activate_2385 = GALGAS_bool (true) ;
  } break ;
  default:
    break ;
  }
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__7B_ COMMA_SOURCE_FILE ("task-declaration.galgas", 73)) ;
  GALGAS_structurePropertyListAST var_taskVarList_2667 = GALGAS_structurePropertyListAST::constructor_emptyList (SOURCE_FILE ("task-declaration.galgas", 74)) ;
  GALGAS_functionDeclarationListAST var_taskProcList_2717 = GALGAS_functionDeclarationListAST::constructor_emptyList (SOURCE_FILE ("task-declaration.galgas", 75)) ;
  GALGAS_taskSetupListAST var_taskSetupListAST_2761 = GALGAS_taskSetupListAST::constructor_emptyList (SOURCE_FILE ("task-declaration.galgas", 76)) ;
  GALGAS_taskSetupListAST var_taskActivateListAST_2808 = GALGAS_taskSetupListAST::constructor_emptyList (SOURCE_FILE ("task-declaration.galgas", 77)) ;
  GALGAS_taskSetupListAST var_taskDeactivateListAST_2857 = GALGAS_taskSetupListAST::constructor_emptyList (SOURCE_FILE ("task-declaration.galgas", 78)) ;
  GALGAS_syncInstructionBranchListAST var_branchList_2907 = GALGAS_syncInstructionBranchListAST::constructor_emptyList (SOURCE_FILE ("task-declaration.galgas", 79)) ;
  bool repeatFlag_5 = true ;
  while (repeatFlag_5) {
    switch (select_plm_5F_syntax_46 (inCompiler)) {
    case 2: {
      nt_private_5F_struct_5F_property_5F_declaration_ (ioArgument_ioAST, var_taskVarList_2667, GALGAS_bool (true), inCompiler) ;
    } break ;
    case 3: {
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_func COMMA_SOURCE_FILE ("task-declaration.galgas", 84)) ;
      GALGAS_lstring var_procName_3061 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("task-declaration.galgas", 85)) ;
      GALGAS_routineFormalArgumentListAST var_formalArgumentList_3158 ;
      nt_procedure_5F_formal_5F_arguments_ (ioArgument_ioAST, var_formalArgumentList_3158, inCompiler) ;
      GALGAS_lstring var_returnTypeName_3188 ;
      switch (select_plm_5F_syntax_47 (inCompiler)) {
      case 1: {
        var_returnTypeName_3188 = GALGAS_string::makeEmptyString ().getter_here (inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 89)) ;
      } break ;
      case 2: {
        inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__2D__3E_ COMMA_SOURCE_FILE ("task-declaration.galgas", 91)) ;
        nt_type_5F_definition_ (ioArgument_ioAST, var_returnTypeName_3188, inCompiler) ;
      } break ;
      default:
        break ;
      }
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__7B_ COMMA_SOURCE_FILE ("task-declaration.galgas", 94)) ;
      GALGAS_instructionListAST var_instructionList_3381 ;
      nt_instructionList_ (ioArgument_ioAST, var_instructionList_3381, inCompiler) ;
      var_taskProcList_2717.addAssign_operation (GALGAS_mode::constructor_userMode (SOURCE_FILE ("task-declaration.galgas", 96)), GALGAS_bool (false), var_procName_3061, GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("task-declaration.galgas", 96)), var_formalArgumentList_3158, var_returnTypeName_3188, var_instructionList_3381, GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 96))  COMMA_SOURCE_FILE ("task-declaration.galgas", 96)) ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__7D_ COMMA_SOURCE_FILE ("task-declaration.galgas", 97)) ;
    } break ;
    case 4: {
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_on COMMA_SOURCE_FILE ("task-declaration.galgas", 99)) ;
      GALGAS_lstring var_attribute_3560 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__40_attribute COMMA_SOURCE_FILE ("task-declaration.galgas", 100)) ;
      GALGAS_lstring var_name_3589 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("task-declaration.galgas", 101)) ;
      GALGAS_lstringlist var_dependenceList_3623 = GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("task-declaration.galgas", 102)) ;
      switch (select_plm_5F_syntax_48 (inCompiler)) {
      case 1: {
      } break ;
      case 2: {
        inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__3E_ COMMA_SOURCE_FILE ("task-declaration.galgas", 105)) ;
        bool repeatFlag_6 = true ;
        while (repeatFlag_6) {
          GALGAS_lstring var_dependenceName_3720 = inCompiler->synthetizedAttribute_tokenString () ;
          inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("task-declaration.galgas", 107)) ;
          var_dependenceList_3623.addAssign_operation (var_dependenceName_3720  COMMA_SOURCE_FILE ("task-declaration.galgas", 108)) ;
          switch (select_plm_5F_syntax_49 (inCompiler)) {
          case 2: {
            inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__2C_ COMMA_SOURCE_FILE ("task-declaration.galgas", 110)) ;
          } break ;
          default:
            repeatFlag_6 = false ;
            break ;
      ...
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__7B_ COMMA_SOURCE_FILE ("task-declaration.galgas", 113)) ;
      GALGAS_instructionListAST var_instructionList_3877 ;
      nt_instructionList_ (ioArgument_ioAST, var_instructionList_3877, inCompiler) ;
      GALGAS_location var_endOfInit_3897 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 115)) ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__7D_ COMMA_SOURCE_FILE ("task-declaration.galgas", 116)) ;
      const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, var_attribute_3560.getter_string (HERE).objectCompare (GALGAS_string ("setup"))).boolEnum () ;
      if (kBoolTrue == test_7) {
        var_taskSetupListAST_2761.addAssign_operation (var_name_3589, var_dependenceList_3623, var_instructionList_3877, var_endOfInit_3897  COMMA_SOURCE_FILE ("task-declaration.galgas", 118)) ;
      }else if (kBoolFalse == test_7) {
        const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, var_attribute_3560.getter_string (HERE).objectCompare (GALGAS_string ("activate"))).boolEnum () ;
        if (kBoolTrue == test_8) {
          var_taskActivateListAST_2808.addAssign_operation (var_name_3589, var_dependenceList_3623, var_instructionList_3877, var_endOfInit_3897  COMMA_SOURCE_FILE ("task-declaration.galgas", 120)) ;
        }else if (kBoolFalse == test_8) {
          const enumGalgasBool test_9 = GALGAS_bool (kIsEqual, var_attribute_3560.getter_string (HERE).objectCompare (GALGAS_string ("deactivate"))).boolEnum () ;
          if (kBoolTrue == test_9) {
            var_taskDeactivateListAST_2857.addAssign_operation (var_name_3589, var_dependenceList_3623, var_instructionList_3877, var_endOfInit_3897  COMMA_SOURCE_FILE ("task-declaration.galgas", 122)) ;
          }else if (kBoolFalse == test_9) {
            TC_Array <C_FixItDescription> fixItArray10 ;
            inCompiler->emitSemanticError (var_attribute_3560.getter_location (SOURCE_FILE ("task-declaration.galgas", 124)), GALGAS_string ("attribute should be @setup, @activate or @deactivate"), fixItArray10  COMMA_SOURCE_FILE ("task-declaration.galgas", 124)) ;
          }
        }
      }
    } break ;
    case 5: {
      GALGAS_guardedCommandAST var_guardedCommand_4489 ;
      nt_guarded_5F_command_ (ioArgument_ioAST, var_guardedCommand_4489, inCompiler) ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__7B_ COMMA_SOURCE_FILE ("task-declaration.galgas", 128)) ;
      GALGAS_instructionListAST var_instructionList_4552 ;
      nt_instructionList_ (ioArgument_ioAST, var_instructionList_4552, inCompiler) ;
      GALGAS_location var_endOfInstructions_4580 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 130)) ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__7D_ COMMA_SOURCE_FILE ("task-declaration.galgas", 131)) ;
      var_branchList_2907.addAssign_operation (var_guardedCommand_4489, var_instructionList_4552, var_endOfInstructions_4580  COMMA_SOURCE_FILE ("task-declaration.galgas", 132)) ;
    } break ;
    default:
      repeatFlag_5 = false ;
      break ;
  ...
  GALGAS_location var_endOfTask_4705 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 134)) ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__7D_ COMMA_SOURCE_FILE ("task-declaration.galgas", 135)) ;
  ioArgument_ioAST.mProperty_mTaskListAST.addAssign_operation (var_taskName_1921, var_higherPriorityTaskList_1961, var_stackSize_2341, var_taskVarList_2667, var_taskProcList_2717, var_taskSetupListAST_2761, var_taskActivateListAST_2808, var_taskDeactivateListAST_2857, var_branchList_2907, var_endOfTask_4705, var_activate_2385  COMMA_SOURCE_FILE ("task-declaration.galgas", 136)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_function_i29_ (GALGAS_ast & ioArgument_ioAST,
                                                              GALGAS_functionDeclarationListAST & ioArgument_ioProcListAST,
                                                              C_Lexique_plm_5F_lexique * inCompiler) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_mode_i30_ (GALGAS_mode & outArgument_outMode,
  ...
  case 5: {
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_startup COMMA_SOURCE_FILE ("declaration-func.galgas", 115)) ;
    outArgument_outMode = GALGAS_mode::constructor_startupMode (SOURCE_FILE ("declaration-func.galgas", 116)) ;
  } break ;
  case 6: {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_function_5F_header_i31_ (GALGAS_ast & ioArgument_ioAST,
  ...
  while (repeatFlag_0) {
    ...
    case 2: {
      GALGAS_lstring var_attribute_4328 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__40_attribute COMMA_SOURCE_FILE ("declaration-func.galgas", 148)) ;
      outArgument_outAttributeList.addAssign_operation (var_attribute_4328  COMMA_SOURCE_FILE ("declaration-func.galgas", 149)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_procedure_5F_formal_5F_arguments_i32_ (GALGAS_ast & ioArgument_ioAST,
                                                                                      GALGAS_routineFormalArgumentListAST & outArgument_outProcFormalArgumentList,
                                                                                      C_Lexique_plm_5F_lexique * inCompiler) {
  outArgument_outProcFormalArgumentList.drop () ; // Release 'out' argument
  ...
  while (repeatFlag_0) {
    ...
    case 2: {
      GALGAS_lstring var_selector_4774 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__21_selector_3A_ COMMA_SOURCE_FILE ("declaration-func.galgas", 161)) ;
      GALGAS_lstring var_formalArgumentName_4817 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("declaration-func.galgas", 162)) ;
      GALGAS_lstring var_formalArgumentTypeName_4878 ;
      nt_type_5F_definition_ (ioArgument_ioAST, var_formalArgumentTypeName_4878, inCompiler) ;
      outArgument_outProcFormalArgumentList.addAssign_operation (GALGAS_procFormalArgumentPassingMode::constructor_output (SOURCE_FILE ("declaration-func.galgas", 165)), var_selector_4774, var_formalArgumentTypeName_4878, var_formalArgumentName_4817  COMMA_SOURCE_FILE ("declaration-func.galgas", 164)) ;
    } break ;
    case 3: {
      ...
      GALGAS_lstring var_formalArgumentTypeName_5185 ;
      nt_type_5F_definition_ (ioArgument_ioAST, var_formalArgumentTypeName_5185, inCompiler) ;
      outArgument_outProcFormalArgumentList.addAssign_operation (GALGAS_procFormalArgumentPassingMode::constructor_inputOutput (SOURCE_FILE ("declaration-func.galgas", 174)), var_selector_5082, var_formalArgumentTypeName_5185, var_formalArgumentName_5125  COMMA_SOURCE_FILE ("declaration-func.galgas", 173)) ;
    } break ;
    case 4: {
      GALGAS_lstring var_selector_5393 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__3F_selector_3A_ COMMA_SOURCE_FILE ("declaration-func.galgas", 179)) ;
      GALGAS_lstring var_formalArgumentName_5436 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("declaration-func.galgas", 180)) ;
      GALGAS_lstring var_formalArgumentTypeName_5497 ;
      nt_type_5F_definition_ (ioArgument_ioAST, var_formalArgumentTypeName_5497, inCompiler) ;
      outArgument_outProcFormalArgumentList.addAssign_operation (GALGAS_procFormalArgumentPassingMode::constructor_input (SOURCE_FILE ("declaration-func.galgas", 183)), var_selector_5393, var_formalArgumentTypeName_5497, var_formalArgumentName_5436  COMMA_SOURCE_FILE ("declaration-func.galgas", 182)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_system_5F_routine_i33_ (GALGAS_ast & ioArgument_ioAST,
  ...
  GALGAS_lstring var_name_1399 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("declaration-svc.galgas", 33)) ;
  GALGAS_lstringlist var_attributeList_1430 = GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("declaration-svc.galgas", 34)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_plm_5F_syntax_56 (inCompiler)) {
    case 2: {
      GALGAS_lstring var_attribute_1490 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__40_attribute COMMA_SOURCE_FILE ("declaration-svc.galgas", 37)) ;
      var_attributeList_1430.addAssign_operation (var_attribute_1490  COMMA_SOURCE_FILE ("declaration-svc.galgas", 38)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  GALGAS_routineFormalArgumentListAST var_formalArgumentList_1597 ;
  nt_procedure_5F_formal_5F_arguments_ (ioArgument_ioAST, var_formalArgumentList_1597, inCompiler) ;
  GALGAS_lstring var_returnTypeName_1625 ;
  switch (select_plm_5F_syntax_57 (inCompiler)) {
  case 1: {
    var_returnTypeName_1625 = GALGAS_string::makeEmptyString ().getter_here (inCompiler COMMA_SOURCE_FILE ("declaration-svc.galgas", 43)) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__2D__3E_ COMMA_SOURCE_FILE ("declaration-svc.galgas", 45)) ;
    nt_type_5F_definition_ (ioArgument_ioAST, var_returnTypeName_1625, inCompiler) ;
  } break ;
  default:
    break ;
  }
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__7B_ COMMA_SOURCE_FILE ("declaration-svc.galgas", 48)) ;
  GALGAS_instructionListAST var_instructionList_1802 ;
  nt_instructionList_ (ioArgument_ioAST, var_instructionList_1802, inCompiler) ;
  ioArgument_ioSVCListAST.addAssign_operation (var_name_1399, GALGAS_routineKind::constructor_section (SOURCE_FILE ("declaration-svc.galgas", 52)), var_public_1276, var_attributeList_1430, var_formalArgumentList_1597, var_returnTypeName_1625, var_instructionList_1802, GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-svc.galgas", 58))  COMMA_SOURCE_FILE ("declaration-svc.galgas", 50)) ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__7D_ COMMA_SOURCE_FILE ("declaration-svc.galgas", 59)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_system_5F_routine_i34_ (GALGAS_ast & ioArgument_ioAST,
                                                                       GALGAS_systemRoutineDeclarationListAST & ioArgument_ioSVCListAST,
                                                                       C_Lexique_plm_5F_lexique * inCompiler) {
  GALGAS_bool var_public_2296 ;
  switch (select_plm_5F_syntax_58 (inCompiler)) {
  case 1: {
    var_public_2296 = GALGAS_bool (false) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_public COMMA_SOURCE_FILE ("declaration-svc.galgas", 71)) ;
    var_public_2296 = GALGAS_bool (true) ;
  } break ;
  default:
    break ;
  }
  GALGAS_routineKind var_routineKind_2407 ;
  ...
  case 1: {
    ...
    var_routineKind_2407 = GALGAS_routineKind::constructor_primitive (SOURCE_FILE ("declaration-svc.galgas", 77)) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_service COMMA_SOURCE_FILE ("declaration-svc.galgas", 79)) ;
    var_routineKind_2407 = GALGAS_routineKind::constructor_service (SOURCE_FILE ("declaration-svc.galgas", 80)) ;
  } break ;
  default:
    break ;
  }
  GALGAS_lstring var_name_2554 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("declaration-svc.galgas", 82)) ;
  GALGAS_lstringlist var_attributeList_2585 = GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("declaration-svc.galgas", 83)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_plm_5F_syntax_60 (inCompiler)) {
    case 2: {
      GALGAS_lstring var_attribute_2645 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__40_attribute COMMA_SOURCE_FILE ("declaration-svc.galgas", 86)) ;
      var_attributeList_2585.addAssign_operation (var_attribute_2645  COMMA_SOURCE_FILE ("declaration-svc.galgas", 87)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  GALGAS_routineFormalArgumentListAST var_formalArgumentList_2758 ;
  nt_procedure_5F_input_5F_formal_5F_arguments_ (ioArgument_ioAST, var_formalArgumentList_2758, inCompiler) ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__7B_ COMMA_SOURCE_FILE ("declaration-svc.galgas", 90)) ;
  GALGAS_instructionListAST var_instructionList_2817 ;
  nt_instructionList_ (ioArgument_ioAST, var_instructionList_2817, inCompiler) ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__7D_ COMMA_SOURCE_FILE ("declaration-svc.galgas", 92)) ;
  ioArgument_ioSVCListAST.addAssign_operation (var_name_2554, var_routineKind_2407, var_public_2296, var_attributeList_2585, var_formalArgumentList_2758, GALGAS_string::makeEmptyString ().getter_here (inCompiler COMMA_SOURCE_FILE ("declaration-svc.galgas", 99)), var_instructionList_2817, GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("declaration-svc.galgas", 101))  COMMA_SOURCE_FILE ("declaration-svc.galgas", 93)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_procedure_5F_input_5F_formal_5F_arguments_i35_ (GALGAS_ast & ioArgument_ioAST,
                                                                                               GALGAS_routineFormalArgumentListAST & outArgument_outProcFormalArgumentList,
                                                                                               C_Lexique_plm_5F_lexique * inCompiler) {
  outArgument_outProcFormalArgumentList.drop () ; // Release 'out' argument
  ...
  while (repeatFlag_0) {
    ...
    case 2: {
      GALGAS_lstring var_selector_3328 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__3F_selector_3A_ COMMA_SOURCE_FILE ("declaration-svc.galgas", 111)) ;
      GALGAS_lstring var_formalArgumentName_3371 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("declaration-svc.galgas", 112)) ;
      GALGAS_lstring var_formalArgumentTypeName_3432 ;
      nt_type_5F_definition_ (ioArgument_ioAST, var_formalArgumentTypeName_3432, inCompiler) ;
      outArgument_outProcFormalArgumentList.addAssign_operation (GALGAS_procFormalArgumentPassingMode::constructor_input (SOURCE_FILE ("declaration-svc.galgas", 115)), var_selector_3328, var_formalArgumentTypeName_3432, var_formalArgumentName_3371  COMMA_SOURCE_FILE ("declaration-svc.galgas", 114)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_procedure_5F_input_5F_formal_5F_arguments_i35_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__28_ COMMA_SOURCE_FILE ("declaration-svc.galgas", 108)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_plm_5F_syntax_61 (inCompiler)) {
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_primary_i75_ (GALGAS_ast & ioArgument_ioAST,
                                                             ...
                                                             C_Lexique_plm_5F_lexique * inCompiler) {
  outArgument_outExpression.drop () ; // Release 'out' argument
  GALGAS_lstring var_receiver_1699 ;
  switch (select_plm_5F_syntax_87 (inCompiler)) {
  case 1: {
    var_receiver_1699 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  case 2: {
    ...
    var_receiver_1699 = GALGAS_string::makeEmptyString ().getter_here (inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 40)) ;
  } break ;
  default:
    break ;
  }
  GALGAS_primaryInExpressionAccessListAST var_accessList_1904 ;
  nt_expression_5F_access_5F_list_ (ioArgument_ioAST, var_accessList_1904, inCompiler) ;
  outArgument_outExpression = GALGAS_primaryInExpressionAST::constructor_new (var_receiver_1699, var_accessList_1904  COMMA_SOURCE_FILE ("expression-primary.galgas", 45)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_expression_5F_access_5F_list_i76_ (GALGAS_ast & ioArgument_ioAST,
  ...
  while (repeatFlag_0) {
    ...
    case 2: {
      ...
      GALGAS_lstring var_propertyName_2302 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("expression-primary.galgas", 55)) ;
      outArgument_outAccessList.addAssign_operation (GALGAS_primaryInExpressionAccessAST::constructor_property (var_propertyName_2302  COMMA_SOURCE_FILE ("expression-primary.galgas", 56))  COMMA_SOURCE_FILE ("expression-primary.galgas", 56)) ;
    } break ;
    case 3: {
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__5B_ COMMA_SOURCE_FILE ("expression-primary.galgas", 58)) ;
      GALGAS_lbigint var_low_2402 = inCompiler->synthetizedAttribute_bigInteger () ;
      ...
      GALGAS_lbigint var_high_2440 = inCompiler->synthetizedAttribute_bigInteger () ;
      ...
      outArgument_outAccessList.addAssign_operation (GALGAS_primaryInExpressionAccessAST::constructor_integerSlice (var_low_2402, var_high_2440  COMMA_SOURCE_FILE ("expression-primary.galgas", 63))  COMMA_SOURCE_FILE ("expression-primary.galgas", 63)) ;
    } break ;
    case 4: {
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__5B_ COMMA_SOURCE_FILE ("expression-primary.galgas", 65)) ;
      GALGAS_expressionAST var_expression_2573 ;
      nt_expression_ (ioArgument_ioAST, var_expression_2573, inCompiler) ;
      GALGAS_location var_endOfIndex_2594 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("expression-primary.galgas", 67)) ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__5D_ COMMA_SOURCE_FILE ("expression-primary.galgas", 68)) ;
      outArgument_outAccessList.addAssign_operation (GALGAS_primaryInExpressionAccessAST::constructor_arrayAccess (var_expression_2573, var_endOfIndex_2594  COMMA_SOURCE_FILE ("expression-primary.galgas", 69))  COMMA_SOURCE_FILE ("expression-primary.galgas", 69)) ;
    } break ;
    case 5: {
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__2E_ COMMA_SOURCE_FILE ("expression-primary.galgas", 71)) ;
      GALGAS_lstring var_methodName_2756 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("expression-primary.galgas", 72)) ;
      GALGAS_effectiveArgumentListAST var_arguments_2808 ;
      GALGAS_location var_endOfArguments_2828 ;
      nt_effective_5F_parameters_ (ioArgument_ioAST, var_arguments_2808, var_endOfArguments_2828, inCompiler) ;
      outArgument_outAccessList.addAssign_operation (GALGAS_primaryInExpressionAccessAST::constructor_funcCall (var_methodName_2756, var_arguments_2808, var_endOfArguments_2828  COMMA_SOURCE_FILE ("expression-primary.galgas", 74))  COMMA_SOURCE_FILE ("expression-primary.galgas", 74)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_assignment_5F_combined_5F_with_5F_operator_i85_ (GALGAS_infixOperator & outArgument_outInfixOperator,
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_assignment_5F_combined_5F_with_5F_operator_i85_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  switch (select_plm_5F_syntax_95 (inCompiler)) {
  case 1: {
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__7C__3D_ COMMA_SOURCE_FILE ("instruction-assignment-operator.galgas", 11)) ;
  } break ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_instruction_i86_ (GALGAS_ast & ioArgument_ioAST,
  ...
  while (enumerator_1872.hasCurrentObject ()) {
    ...
    case GALGAS_accessInAssignmentAST::kEnum_arrayAccess:
      {
        const cEnumAssociatedValues_accessInAssignmentAST_arrayAccess * extractPtr_2142 = (const cEnumAssociatedValues_accessInAssignmentAST_arrayAccess *) (enumerator_1872.current_mAccess (HERE).unsafePointer ()) ;
        const GALGAS_expressionAST extractedValue_index = extractPtr_2142->mAssociatedValue0 ;
        const GALGAS_location extractedValue_endOfIndex = extractPtr_2142->mAssociatedValue1 ;
        var_expressionAccessList_1828.addAssign_operation (GALGAS_primaryInExpressionAccessAST::constructor_arrayAccess (extractedValue_index, extractedValue_endOfIndex  COMMA_SOURCE_FILE ("instruction-assignment-operator.galgas", 64))  COMMA_SOURCE_FILE ("instruction-assignment-operator.galgas", 64)) ;
      }
      break ;
    }
    enumerator_1872.gotoNextObject () ;
  }
  GALGAS_primaryInExpressionAST var_leftExpression_2183 = GALGAS_primaryInExpressionAST::constructor_new (var_lvalue_1500.getter_mIdentifier (HERE), var_expressionAccessList_1828  COMMA_SOURCE_FILE ("instruction-assignment-operator.galgas", 67)) ;
  GALGAS_infixOperatorExpressionAST var_expression_2276 = GALGAS_infixOperatorExpressionAST::constructor_new (var_leftExpression_2183, var_operatorLocation_1653, var_infixOperator_1631, var_rightExpression_1738  COMMA_SOURCE_FILE ("instruction-assignment-operator.galgas", 68)) ;
  ioArgument_ioInstructionList.addAssign_operation (GALGAS_assignmentInstructionAST::constructor_new (var_instructionLocation_1528, var_lvalue_1500, var_expression_2276  COMMA_SOURCE_FILE ("instruction-assignment-operator.galgas", 75))  COMMA_SOURCE_FILE ("instruction-assignment-operator.galgas", 75)) ;
}
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_lvalue_i103_ (GALGAS_ast & ioArgument_ioAST,
  ...
  while (repeatFlag_0) {
    ...
    case 3: {
      ...
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__5D_ COMMA_SOURCE_FILE ("lvalue.galgas", 51)) ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_control_5F_register_5F_lvalue_i104_ (GALGAS_ast & ioArgument_ioAST,
                                                                                    GALGAS_controlRegisterLValueAST & outArgument_outRegisterLValue,
                                                                                    C_Lexique_plm_5F_lexique * inCompiler) {
  outArgument_outRegisterLValue.drop () ; // Release 'out' argument
  GALGAS_lstring var_registerGroupName_1626 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GALGAS_registerGroupIndexAST var_groupIndex_1664 ;
  switch (select_plm_5F_syntax_113 (inCompiler)) {
  case 1: {
    var_groupIndex_1664 = GALGAS_registerGroupIndexAST::constructor_noIndex (SOURCE_FILE ("lvalue-control-register.galgas", 38)) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__5B_ COMMA_SOURCE_FILE ("lvalue-control-register.galgas", 40)) ;
    GALGAS_expressionAST var_expression_1763 ;
    nt_expression_ (ioArgument_ioAST, var_expression_1763, inCompiler) ;
    GALGAS_location var_endOfIndex_1784 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("lvalue-control-register.galgas", 42)) ;
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__5D_ COMMA_SOURCE_FILE ("lvalue-control-register.galgas", 43)) ;
    var_groupIndex_1664 = GALGAS_registerGroupIndexAST::constructor_index (var_expression_1763, var_endOfIndex_1784  COMMA_SOURCE_FILE ("lvalue-control-register.galgas", 44)) ;
  } break ;
  default:
    break ;
  }
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__3A_ COMMA_SOURCE_FILE ("lvalue-control-register.galgas", 46)) ;
  GALGAS_lstring var_registerName_1931 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("lvalue-control-register.galgas", 47)) ;
  GALGAS_registerIndexAST var_registerIndex_1967 ;
  switch (select_plm_5F_syntax_114 (inCompiler)) {
  case 1: {
    var_registerIndex_1967 = GALGAS_registerIndexAST::constructor_noIndex (SOURCE_FILE ("lvalue-control-register.galgas", 50)) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__5B_ COMMA_SOURCE_FILE ("lvalue-control-register.galgas", 52)) ;
    GALGAS_expressionAST var_expression_2069 ;
    nt_expression_ (ioArgument_ioAST, var_expression_2069, inCompiler) ;
    GALGAS_location var_endOfIndex_2090 = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("lvalue-control-register.galgas", 54)) ;
    inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__5D_ COMMA_SOURCE_FILE ("lvalue-control-register.galgas", 55)) ;
    var_registerIndex_1967 = GALGAS_registerIndexAST::constructor_index (var_expression_2069, var_endOfIndex_2090  COMMA_SOURCE_FILE ("lvalue-control-register.galgas", 56)) ;
  } break ;
  default:
    break ;
  }
  outArgument_outRegisterLValue = GALGAS_controlRegisterLValueAST::constructor_new (var_registerGroupName_1626, var_groupIndex_1664, var_registerName_1931, var_registerIndex_1967  COMMA_SOURCE_FILE ("lvalue-control-register.galgas", 58)) ;
}

//---------------------------------------------------------------------------------------------------------------------*

void cParser_plm_5F_syntax::rule_plm_5F_syntax_control_5F_register_5F_lvalue_i104_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__23_groupName COMMA_SOURCE_FILE ("lvalue-control-register.galgas", 35)) ;
  switch (select_plm_5F_syntax_113 (inCompiler)) {
  case 1: {
  } break ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_effective_5F_parameters_i105_ (GALGAS_ast & ioArgument_ioAST,
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_effective_5F_parameters_i105_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__28_ COMMA_SOURCE_FILE ("effective-parameters.galgas", 42)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_plm_5F_syntax_115 (inCompiler)) {
...
void cParser_plm_5F_target_5F_specific_5F_syntax::rule_plm_5F_target_5F_specific_5F_syntax_configuration_5F_start_5F_symbol_i2_ (GALGAS_ast & ioArgument_ioAST,
  ...
  GALGAS_lstring var_undefinedInterruptHandler_6935 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GALGAS_lstringlist var_C_5F_definitionFiles_7007 = GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("configuration.galgas", 186)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_plm_5F_target_5F_specific_5F_syntax_3 (inCompiler)) {
    case 2: {
      GALGAS_lstring var_fileRelativePath_7072 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__22_string_22_ COMMA_SOURCE_FILE ("configuration.galgas", 189)) ;
      var_C_5F_definitionFiles_7007.addAssign_operation (var_fileRelativePath_7072  COMMA_SOURCE_FILE ("configuration.galgas", 190)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  GALGAS_lstringlist var_S_5F_definitionFiles_7195 = GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("configuration.galgas", 193)) ;
  bool repeatFlag_1 = true ;
  while (repeatFlag_1) {
    switch (select_plm_5F_target_5F_specific_5F_syntax_4 (inCompiler)) {
    case 2: {
      GALGAS_lstring var_fileRelativePath_7260 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__22_string_22_ COMMA_SOURCE_FILE ("configuration.galgas", 196)) ;
      var_S_5F_definitionFiles_7195.addAssign_operation (var_fileRelativePath_7260  COMMA_SOURCE_FILE ("configuration.galgas", 197)) ;
    } break ;
    default:
      repeatFlag_1 = false ;
      break ;
  ...
  GALGAS_lstringlist var_LL_5F_definitionFiles_7385 = GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("configuration.galgas", 200)) ;
  bool repeatFlag_2 = true ;
  while (repeatFlag_2) {
    switch (select_plm_5F_target_5F_specific_5F_syntax_5 (inCompiler)) {
    case 2: {
      GALGAS_lstring var_fileRelativePath_7450 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__22_string_22_ COMMA_SOURCE_FILE ("configuration.galgas", 203)) ;
      var_LL_5F_definitionFiles_7385.addAssign_operation (var_fileRelativePath_7450  COMMA_SOURCE_FILE ("configuration.galgas", 204)) ;
    } break ;
    default:
      repeatFlag_2 = false ;
      break ;
  ...
  while (repeatFlag_3) {
    ...
    case 2: {
      GALGAS_lstring var_relativeFilePath_7630 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__22_string_22_ COMMA_SOURCE_FILE ("configuration.galgas", 210)) ;
      outArgument_outImportedFileList.addAssign_operation (var_relativeFilePath_7630  COMMA_SOURCE_FILE ("configuration.galgas", 211)) ;
    } break ;
    default:
      repeatFlag_3 = false ;
      break ;
  ...
  GALGAS_interruptionConfigurationList var_interruptionConfigurationList_7746 ;
  GALGAS_enumerationConstantList var_interruptConstantList_7773 ;
  nt_interruptConfigList_ (var_interruptionConfigurationList_7746, var_interruptConstantList_7773, inCompiler) ;
  GALGAS_uint var_ptrSize_7791 ;
  ...
  if (kBoolTrue == test_4) {
    ...
    var_ptrSize_7791.drop () ; // Release error dropped variable
  }else if (kBoolFalse == test_4) {
    var_ptrSize_7791 = var_pointerSize_4328.getter_bigint (HERE).getter_uint (inCompiler COMMA_SOURCE_FILE ("configuration.galgas", 218)) ;
  }
  GALGAS_targetParameters var_parameters_7973 = GALGAS_targetParameters::constructor_new (var_loc_3860, var_python_5F_utilityToolList_3936, var_python_5F_build_4009, var_linkerScript_4083, var_ptrSize_7791, var_handleDynamicArray_4398, var_systemStackSize_4592, var_stackedUserRegisterOnInterruptByteSize_6845, var_nopInstructionStringInLLVM_4670, var_bitbandRegisterBaseAddress_4746, var_bitbandRegisterEndAddress_4785, var_bitbandRegisterRelocationAddress_4831, var_bitbandRegisterOffsetMultiplier_4876, var_bitbandRegisterBitMultiplier_4918, var_sectionHandler_6125, var_sectionPushedRegisterByteSize_6227, var_sectionDispatcherHeader_6324, var_sectionDispatcherEntry_6419, var_sectionDispatcherInvocationFromAnyMode_6533, var_sectionDispatcherInvocationFromUserMode_6649, var_C_5F_definitionFiles_7007, var_S_5F_definitionFiles_7195, var_LL_5F_definitionFiles_7385, var_xtrInterruptHandler_6734, var_undefinedInterruptHandler_6935, var_serviceHandler_5541, var_servicePushedRegisterByteSize_5643, var_serviceDispatcherEntry_5835, var_serviceDispatcherHeader_5740, var_serviceEntryNoReturnedValue_5942, var_serviceEntryReturnValue_6047  COMMA_SOURCE_FILE ("configuration.galgas", 220)) ;
  ioArgument_ioAST.mProperty_mDeclarationListAST.addAssign_operation (GALGAS_configurationDeclarationAST::constructor_new (var_panicCodeTypeName_4167, var_panicLineTypeName_4252, var_parameters_7973, var_interruptionConfigurationList_7746  COMMA_SOURCE_FILE ("configuration.galgas", 253))  COMMA_SOURCE_FILE ("configuration.galgas", 253)) ;
  outArgument_outEndOfSourceFile = GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("configuration.galgas", 259)) ;
  ioArgument_ioAST.mProperty_mDeclarationListAST.addAssign_operation (GALGAS_enumerationDeclarationAST::constructor_new (GALGAS_lstring::constructor_new (function_isrSlotTypeName (inCompiler COMMA_SOURCE_FILE ("configuration.galgas", 261)), var_xtrInterruptHandler_6734.getter_location (HERE)  COMMA_SOURCE_FILE ("configuration.galgas", 261)), var_interruptConstantList_7773  COMMA_SOURCE_FILE ("configuration.galgas", 260))  COMMA_SOURCE_FILE ("configuration.galgas", 260)) ;
}
...
void cParser_plm_5F_target_5F_specific_5F_syntax::rule_plm_5F_target_5F_specific_5F_syntax_interruptConfigList_i3_ (GALGAS_interruptionConfigurationList & outArgument_interruptionConfigurationList,
  ...
  while (repeatFlag_0) {
    ...
    case 2: {
      GALGAS_lstring var_interruptName_9777 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("configuration.galgas", 277)) ;
      GALGAS_interruptionPanicCode var_interruptionPanicCode_9828 ;
      switch (select_plm_5F_target_5F_specific_5F_syntax_8 (inCompiler)) {
      case 1: {
        var_interruptionPanicCode_9828 = GALGAS_interruptionPanicCode::constructor_noCode (SOURCE_FILE ("configuration.galgas", 280)) ;
      } break ;
      case 2: {
        inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken__2D__3E_ COMMA_SOURCE_FILE ("configuration.galgas", 282)) ;
        GALGAS_lbigint var_panicCode_9936 = inCompiler->synthetizedAttribute_bigInteger () ;
        inCompiler->acceptTerminal (C_Lexique_plm_5F_lexique::kToken_integer COMMA_SOURCE_FILE ("configuration.galgas", 283)) ;
        var_interruptionPanicCode_9828 = GALGAS_interruptionPanicCode::constructor_code (var_panicCode_9936  COMMA_SOURCE_FILE ("configuration.galgas", 284)) ;
        outArgument_outEnumerationConstantList.addAssign_operation (var_interruptName_9777, var_panicCode_9936.getter_bigint (SOURCE_FILE ("configuration.galgas", 285))  COMMA_SOURCE_FILE ("configuration.galgas", 285)) ;
      } break ;
      default:
        break ;
      }
      outArgument_interruptionConfigurationList.addAssign_operation (var_interruptName_9777, var_interruptionPanicCode_9828  COMMA_SOURCE_FILE ("configuration.galgas", 287)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
...
cCollectionElement (THERE),
mObject (inElement.mProperty_mPropertyName, inElement.mProperty_mPropertyAttributeList, inElement.mProperty_mIsConstant, inElement.mProperty_mIsPublic, inElement.mProperty_mPropertyTypeName, inElement.mProperty_mInitialisation, inElement.mProperty_mIsSingletonObject) {
}
...
cCollectionElement (THERE),
mObject (inElement.mProperty_mName, inElement.mProperty_mRoutineKind, inElement.mProperty_mPublic, inElement.mProperty_mAttributeList, inElement.mProperty_mFormalArgumentList, inElement.mProperty_mReturnTypeName, inElement.mProperty_mInstructionList, inElement.mProperty_mEndOfInstructionListLocation) {
}
