...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_task_5F_entry_5F_declaration_i26_ (GALGAS_ast & ioArgument_ioAST,
  ...
  inCompiler->emitSemanticWarning (var_entryName_1177.getter_location (SOURCE_FILE ("task-entry-declaration.galgas", 24)), GALGAS_string ("obsolete"), fixItArray0  COMMA_SOURCE_FILE ("task-entry-declaration.galgas", 24)) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__3A_) COMMA_SOURCE_FILE ("task-entry-declaration.galgas", 25)) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_self) COMMA_SOURCE_FILE ("task-entry-declaration.galgas", 26)) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__2E_) COMMA_SOURCE_FILE ("task-entry-declaration.galgas", 27)) ;
  GALGAS_lstringlist var_entryPath_1266 = GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("task-entry-declaration.galgas", 28)) ;
  bool repeatFlag_1 = true ;
  while (repeatFlag_1) {
    GALGAS_lstring var_propertyName_1319 = inCompiler->synthetizedAttribute_tokenString () ;
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_identifier) COMMA_SOURCE_FILE ("task-entry-declaration.galgas", 30)) ;
    var_entryPath_1266.addAssign_operation (var_propertyName_1319  COMMA_SOURCE_FILE ("task-entry-declaration.galgas", 31)) ;
    switch (select_plm_5F_syntax_38 (inCompiler)) {
    case 2: {
      inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__2E_) COMMA_SOURCE_FILE ("task-entry-declaration.galgas", 33)) ;
    } break ;
    default:
      repeatFlag_1 = false ;
      break ;
  ...
  GALGAS_routineFormalArgumentListAST var_formalArgumentList_1475 ;
  nt_procedure_5F_formal_5F_arguments_ (ioArgument_ioAST, var_formalArgumentList_1475, inCompiler) ;
  GALGAS_lstring var_returnTypeName_1503 ;
  switch (select_plm_5F_syntax_39 (inCompiler)) {
  case 1: {
    var_returnTypeName_1503 = GALGAS_string::makeEmptyString ().getter_here (inCompiler COMMA_SOURCE_FILE ("task-entry-declaration.galgas", 38)) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__2D__3E_) COMMA_SOURCE_FILE ("task-entry-declaration.galgas", 40)) ;
    nt_type_5F_definition_ (ioArgument_ioAST, var_returnTypeName_1503, inCompiler) ;
  } break ;
  default:
    break ;
  }
  ioArgument_ioTaskEntryListAST.addAssign_operation (var_entryName_1177, var_formalArgumentList_1475, var_returnTypeName_1503, var_entryPath_1266  COMMA_SOURCE_FILE ("task-entry-declaration.galgas", 43)) ;
}

//---------------------------------------------------------------------------------------------------------------------*

void cParser_plm_5F_syntax::rule_plm_5F_syntax_task_5F_entry_5F_declaration_i26_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_entry) COMMA_SOURCE_FILE ("task-entry-declaration.galgas", 22)) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_identifier) COMMA_SOURCE_FILE ("task-entry-declaration.galgas", 23)) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__3A_) COMMA_SOURCE_FILE ("task-entry-declaration.galgas", 25)) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_self) COMMA_SOURCE_FILE ("task-entry-declaration.galgas", 26)) ;
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_task_5F_guard_5F_declaration_i27_ (GALGAS_ast & ioArgument_ioAST,
...
void cParser_plm_5F_syntax::rule_plm_5F_syntax_task_5F_guard_5F_declaration_i27_parse (C_Lexique_plm_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_guard) COMMA_SOURCE_FILE ("task-guard-declaration.galgas", 21)) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_identifier) COMMA_SOURCE_FILE ("task-guard-declaration.galgas", 22)) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken__3A_) COMMA_SOURCE_FILE ("task-guard-declaration.galgas", 23)) ;
  inCompiler->acceptTerminal (ACCEPT_TERMINAL (C_Lexique_plm_5F_lexique::kToken_self) COMMA_SOURCE_FILE ("task-guard-declaration.galgas", 24)) ;
