...
GALGAS_PLMType GALGAS_PLMType::constructor_new (const GALGAS_propertyMap & inOperand0,
  ...
  if (inOperand0.isValid () && inOperand1.isValid ()) {
    result = GALGAS_PLMType (inOperand0, inOperand1) ;
  }
  return result ;
}
...
bool GALGAS_PLMType::isValid (void) const {
  return mProperty_mPropertyMap.isValid () && mProperty_mKind.isValid () ;
}
...
static void extensionMethod_structureDeclarationAST_functionSemanticAnalysis (const cPtr_structureDeclarationAST * inObject,
  ...
  cEnumerator_functionDeclarationListAST enumerator_20140 (object->mProperty_mFunctionDeclarationListAST, kENUMERATION_UP) ;
  while (enumerator_20140.hasCurrentObject ()) {
    GALGAS_bool var_warnIfUnused_20164 = GALGAS_bool (true) ;
    GALGAS_bool var_mutating_20188 = GALGAS_bool (false) ;
    GALGAS_bool var_accessProperties_20221 = GALGAS_bool (false) ;
    cEnumerator_lstringlist enumerator_20284 (enumerator_20140.current (HERE).getter_mFunctionAttributeList (HERE), kENUMERATION_UP) ;
    while (enumerator_20284.hasCurrentObject ()) {
      const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, enumerator_20284.current_mValue (HERE).getter_string (HERE).objectCompare (function_noUnusedWarningAttribute (inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 541)))).boolEnum () ;
      if (kBoolTrue == test_0) {
        const enumGalgasBool test_1 = var_warnIfUnused_20164.operator_not (SOURCE_FILE ("type-structure-declaration.galgas", 542)).boolEnum () ;
        if (kBoolTrue == test_1) {
          TC_Array <C_FixItDescription> fixItArray2 ;
          inCompiler->emitSemanticError (enumerator_20284.current_mValue (HERE).getter_location (SOURCE_FILE ("type-structure-declaration.galgas", 543)), GALGAS_string ("duplicated @").add_operation (function_noUnusedWarningAttribute (inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 543)), inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 543)).add_operation (GALGAS_string (" attribute"), inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 543)), fixItArray2  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 543)) ;
        }
        var_warnIfUnused_20164 = GALGAS_bool (false) ;
      }else if (kBoolFalse == test_0) {
        const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, enumerator_20284.current_mValue (HERE).getter_string (HERE).objectCompare (function_userAccessAttribute (inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 546)))).boolEnum () ;
        if (kBoolTrue == test_3) {
          const enumGalgasBool test_4 = var_accessProperties_20221.boolEnum () ;
          if (kBoolTrue == test_4) {
          ...
          var_accessProperties_20221 = GALGAS_bool (true) ;
        }else if (kBoolFalse == test_3) {
          const enumGalgasBool test_6 = GALGAS_bool (kIsEqual, enumerator_20284.current_mValue (HERE).getter_string (HERE).objectCompare (function_mutatingAttribute (inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 551)))).boolEnum () ;
          if (kBoolTrue == test_6) {
            const enumGalgasBool test_7 = var_mutating_20188.boolEnum () ;
            if (kBoolTrue == test_7) {
              TC_Array <C_FixItDescription> fixItArray8 ;
              inCompiler->emitSemanticError (enumerator_20284.current_mValue (HERE).getter_location (SOURCE_FILE ("type-structure-declaration.galgas", 553)), GALGAS_string ("duplicated @").add_operation (function_mutatingAttribute (inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 553)), inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 553)).add_operation (GALGAS_string (" attribute"), inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 553)), fixItArray8  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 553)) ;
            }
            var_mutating_20188 = GALGAS_bool (true) ;
          }else if (kBoolFalse == test_6) {
            TC_Array <C_FixItDescription> fixItArray9 ;
            inCompiler->emitSemanticError (enumerator_20284.current_mValue (HERE).getter_location (SOURCE_FILE ("type-structure-declaration.galgas", 557)), GALGAS_string ("unknown attribute; available attributes are @").add_operation (function_noUnusedWarningAttribute (inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 557)), inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 557)).add_operation (GALGAS_string (", @"), inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 557)).add_operation (function_mutatingAttribute (inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 558)), inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 558)).add_operation (GALGAS_string (" and @"), inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 558)).add_operation (function_userAccessAttribute (inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 558)), inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 558)), fixItArray9  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 557)) ;
          }
        }
      }
      enumerator_20284.gotoNextObject () ;
    }
    var_accessProperties_20221 = GALGAS_bool (kIsNotEqual, enumerator_20140.current (HERE).getter_mMode (HERE).objectCompare (GALGAS_mode::constructor_userMode (SOURCE_FILE ("type-structure-declaration.galgas", 561)))) ;
    {
    routine_routineSemanticAnalysis (constinArgument_inStructureType, GALGAS_routineKind::constructor_function (enumerator_20140.current (HERE).getter_mMode (HERE)  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 564)), enumerator_20140.current (HERE).getter_mMode (HERE), enumerator_20140.current (HERE).getter_mFunctionName (HERE), enumerator_20140.current (HERE).getter_mFunctionFormalArgumentList (HERE), enumerator_20140.current (HERE).getter_mFunctionReturnTypeName (HERE), enumerator_20140.current (HERE).getter_mFunctionInstructionList (HERE), enumerator_20140.current (HERE).getter_mEndOfFunctionDeclaration (HERE), var_accessProperties_20221, var_mutating_20188, var_warnIfUnused_20164, GALGAS_bool (false), constinArgument_inContext, ioArgument_ioTemporaries, ioArgument_ioIntermediateCodeStruct, inCompiler  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 562)) ;
    }
...
static void extensionMethod_controlRegisterDeclarationAST_controlRegisterType (const cPtr_controlRegisterDeclarationAST * inObject,
  ...
  case GALGAS_typeKind::kEnum_integer:
    {
      const cEnumAssociatedValues_typeKind_integer * extractPtr_10519 = (const cEnumAssociatedValues_typeKind_integer *) (outArgument_outRegisterType.getter_mKind (SOURCE_FILE ("declaration-control-register.galgas", 269)).unsafePointer ()) ;
      const GALGAS_uint extractedValue_bitCount = extractPtr_10519->mAssociatedValue3 ;
...
static void extensionMethod_controlRegisterDeclarationAST_buildControlRegisterSliceMap (const cPtr_controlRegisterDeclarationAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    GALGAS_uint var_shiftCount_12308 = GALGAS_uint ((uint32_t) 0U) ;
    cEnumerator_controlRegisterBitSliceList enumerator_12350 (object->mProperty_mRegisterBitSliceList, kENUMERATION_DOWN) ;
    while (enumerator_12350.hasCurrentObject ()) {
      switch (enumerator_12350.current_mRegisterBitSlice (HERE).enumValue ()) {
      case GALGAS_controlRegisterBitSlice::kNotBuilt:
        break ;
      case GALGAS_controlRegisterBitSlice::kEnum_unusedBits:
        {
          const cEnumAssociatedValues_controlRegisterBitSlice_unusedBits * extractPtr_12545 = (const cEnumAssociatedValues_controlRegisterBitSlice_unusedBits *) (enumerator_12350.current_mRegisterBitSlice (HERE).unsafePointer ()) ;
          const GALGAS_lbigint extractedValue_count = extractPtr_12545->mAssociatedValue0 ;
          var_shiftCount_12308 = var_shiftCount_12308.add_operation (extractedValue_count.getter_bigint (HERE).getter_uint (inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 312)), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 312)) ;
      ...
      case GALGAS_controlRegisterBitSlice::kEnum_namedBit:
        {
          const cEnumAssociatedValues_controlRegisterBitSlice_namedBit * extractPtr_13532 = (const cEnumAssociatedValues_controlRegisterBitSlice_namedBit *) (enumerator_12350.current_mRegisterBitSlice (HERE).unsafePointer ()) ;
          const GALGAS_lstring extractedValue_name = extractPtr_13532->mAssociatedValue0 ;
          const GALGAS_lbigint extractedValue_count = extractPtr_13532->mAssociatedValue1 ;
          GALGAS_uint var_bitCount_12619 = extractedValue_count.getter_bigint (HERE).getter_uint (inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 315)) ;
          outArgument_outControlRegisterFieldList.addAssign_operation (var_bitCount_12619, extractedValue_name.getter_string (HERE)  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 316)) ;
          {
          outArgument_outRegisterFieldMap.setter_insertKey (extractedValue_name, var_shiftCount_12308, var_bitCount_12619, inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 317)) ;
          }
          GALGAS_sliceMap var_registerSubMap_12845 = GALGAS_sliceMap::constructor_emptyMap (SOURCE_FILE ("declaration-control-register.galgas", 322)) ;
          {
          var_registerSubMap_12845.setter_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("shifted"), extractedValue_name.getter_location (HERE)  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 325)), GALGAS_llvmBinaryOperation::constructor_lshr (SOURCE_FILE ("declaration-control-register.galgas", 326)), var_shiftCount_12308.getter_bigint (SOURCE_FILE ("declaration-control-register.galgas", 327)), GALGAS_sliceMap::constructor_emptyMap (SOURCE_FILE ("declaration-control-register.galgas", 328)), ioArgument_ioRegisterType, inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 324)) ;
          }
          {
          ...
          GALGAS_bigint var_mask_13295 = GALGAS_bigint ("1", inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 340)).left_shift_operation (var_bitCount_12619 COMMA_SOURCE_FILE ("declaration-control-register.galgas", 340)).substract_operation (GALGAS_bigint ("1", inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 340)), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 340)).left_shift_operation (var_shiftCount_12308 COMMA_SOURCE_FILE ("declaration-control-register.galgas", 340)) ;
          {
          outArgument_outRegisterBitSliceMap.setter_insertKey (extractedValue_name, GALGAS_llvmBinaryOperation::constructor_and (SOURCE_FILE ("declaration-control-register.galgas", 343)), var_mask_13295, var_registerSubMap_12845, ioArgument_ioRegisterType, inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 341)) ;
          }
          var_shiftCount_12308 = var_shiftCount_12308.add_operation (var_bitCount_12619, inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 348)) ;
        }
        break ;
      }
      enumerator_12350.gotoNextObject () ;
    }
    const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, constinArgument_inRegisterBitCount.objectCompare (var_shiftCount_12308)).boolEnum () ;
    if (kBoolTrue == test_1) {
      TC_Array <C_FixItDescription> fixItArray2 ;
      inCompiler->emitSemanticError (object->mProperty_mRegisterBitSliceListLocation, GALGAS_string ("total bit slice count is ").add_operation (var_shiftCount_12308.getter_string (SOURCE_FILE ("declaration-control-register.galgas", 354)), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 354)).add_operation (GALGAS_string (" (should be "), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 354)).add_operation (constinArgument_inRegisterBitCount.getter_string (SOURCE_FILE ("declaration-control-register.galgas", 354)), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 354)).add_operation (GALGAS_string (")"), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 354)), fixItArray2  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 353)) ;
    }
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
void extensionMethod_enterAccessibleEntities (const GALGAS_guardMapIR_2D_element inObject,
  ...
  case GALGAS_guardKindGenerationIR::kEnum_convenienceGuard:
    {
      const cEnumAssociatedValues_guardKindGenerationIR_convenienceGuard * extractPtr_26041 = (const cEnumAssociatedValues_guardKindGenerationIR_convenienceGuard *) (inObject.mProperty_mGuardKindGenerationIR.unsafePointer ()) ;
      const GALGAS_instructionListIR extractedValue_baseGuardInstructionGenerationList = extractPtr_26041->mAssociatedValue1 ;
      const GALGAS_string extractedValue_baseGuardMangledName = extractPtr_26041->mAssociatedValue2 ;
    ...
    case GALGAS_accessInAssignmentAST::kEnum_arrayAccess:
      {
        ...
        if (kBoolTrue == test_2) {
          GALGAS_lstring joker_4868_1 ; // Joker input parameter
          GALGAS_bigint joker_4893_5 ; // Joker input parameter
          GALGAS_constantMap joker_4893_4 ; // Joker input parameter
          GALGAS_PLMTypeAttributes joker_4893_3 ; // Joker input parameter
          GALGAS_string joker_4893_2 ; // Joker input parameter
          GALGAS_constructorMap joker_4893_1 ; // Joker input parameter
          outArgument_outType.getter_mKind (SOURCE_FILE ("lvalue.galgas", 125)).method_arrayType (joker_4868_1, outArgument_outType, joker_4893_5, joker_4893_4, joker_4893_3, joker_4893_2, joker_4893_1, inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 125)) ;
        }
      }
      break ;
    }
...
void extensionMethod_analyzeLValue (const GALGAS_LValueAST inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    GALGAS_valuedObject var_entity_6451 ;
    callExtensionMethod_searchEntity ((const cPtr_universalValuedObjectMapForContext *) ioArgument_ioUniversalMap.ptr (), inObject.mProperty_mIdentifier, var_entity_6451, inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 166)) ;
    switch (var_entity_6451.enumValue ()) {
    case GALGAS_valuedObject::kNotBuilt:
      break ;
    case GALGAS_valuedObject::kEnum_module:
      {
    ...
    case GALGAS_valuedObject::kEnum_register:
      {
        const cEnumAssociatedValues_valuedObject_register * extractPtr_7544 = (const cEnumAssociatedValues_valuedObject_register *) (var_entity_6451.unsafePointer ()) ;
        const GALGAS_bool extractedValue_writable = extractPtr_7544->mAssociatedValue1 ;
        const GALGAS_PLMType extractedValue_registerType = extractPtr_7544->mAssociatedValue2 ;
        const GALGAS_bigint extractedValue_registerAddress = extractPtr_7544->mAssociatedValue3 ;
        const GALGAS_uint extractedValue_arraySize = extractPtr_7544->mAssociatedValue5 ;
        const GALGAS_uint extractedValue_elementSize = extractPtr_7544->mAssociatedValue6 ;
    ...
    case GALGAS_valuedObject::kEnum_globalVariable:
      {
        const cEnumAssociatedValues_valuedObject_globalVariable * extractPtr_8723 = (const cEnumAssociatedValues_valuedObject_globalVariable *) (var_entity_6451.unsafePointer ()) ;
        const GALGAS_bool extractedValue_writable = extractPtr_8723->mAssociatedValue0 ;
        const GALGAS_PLMType extractedValue_variableType = extractPtr_8723->mAssociatedValue1 ;
    ...
    case GALGAS_valuedObject::kEnum_localVariable:
      {
        const cEnumAssociatedValues_valuedObject_localVariable * extractPtr_9381 = (const cEnumAssociatedValues_valuedObject_localVariable *) (var_entity_6451.unsafePointer ()) ;
        const GALGAS_PLMType extractedValue_variableType = extractPtr_9381->mAssociatedValue0 ;
        const GALGAS_lstring extractedValue_plmName = extractPtr_9381->mAssociatedValue1 ;
        {
