...
GALGAS_lstring GALGAS_functionCallInExpressionAST::getter_mFunctionVarName (UNUSED_LOCATION_ARGS) const {
  GALGAS_lstring result ;
  if (NULL != mObjectPtr) {
...
GALGAS_lstring cPtr_functionCallInExpressionAST::getter_mFunctionVarName (UNUSED_LOCATION_ARGS) const {
...
//--- Find method
  if (NULL != inObject) {
    ...
    if (NULL == f) {
      ...
      f (inObject, constin_inProcedureListAST, constin_inExtensionDeclarationListAST, io_ioContext, io_ioGlobalLiteralStringMap, inCompiler COMMA_THERE) ;
    }
  }
}
...
//--- Find method
  if (NULL != inObject) {
    ...
    if (NULL == f) {
      ...
      f (inObject, constin_inExtensionDeclarationListAST, constin_inContext, io_ioTemporaries, io_ioIntermediateCodeStruct, inCompiler COMMA_THERE) ;
    }
  }
}
...
GALGAS_ast::GALGAS_ast (const GALGAS_globalVarDeclarationList & inOperand0,
                        ...
                        const GALGAS_procedureDeclarationListAST & inOperand3,
                        const GALGAS_requiredProcedureDeclarationListAST & inOperand4,
                        const GALGAS_functionDeclarationListAST & inOperand5,
                        const GALGAS_lstringlist & inOperand6,
                        const GALGAS_bootList & inOperand7,
                        const GALGAS_initList & inOperand8,
                        const GALGAS_exceptionClauseListAST & inOperand9,
                        const GALGAS_exceptionTypesAST & inOperand10) :
...
mAttribute_mProcedureListAST (inOperand3),
mAttribute_mRequiredProcList (inOperand4),
mAttribute_mFunctionListAST (inOperand5),
mAttribute_mTargetList (inOperand6),
mAttribute_mBootList (inOperand7),
mAttribute_mInitList (inOperand8),
mAttribute_mExceptionClauses (inOperand9),
mAttribute_mExceptionTypes (inOperand10) {
}
...
GALGAS_lstringlist GALGAS_globalVarDeclarationList_2D_element::getter_mAllowedFunctionList (UNUSED_LOCATION_ARGS) const {
...
void categoryMethod_semanticAnalysis (const GALGAS_globalVarDeclarationList_2D_element inObject,
  ...
  GALGAS_allowedFunctionMap var_allowedFunctionMap ;
  GALGAS_valueIR var_expressionGeneratedCode ;
  GALGAS_bool var_isConstant ;
  constinArgument_inContext.mAttribute_mGlobalVariableMap.method_searchKey (inObject.mAttribute_mVarName, var_inferredType, var_executionModeSet, var_allowedProcedureMap, var_allowedFunctionMap, var_expressionGeneratedCode, var_isConstant, inCompiler COMMA_SOURCE_FILE ("global-variable-declaration.galgas", 252)) ;
  {
  ioArgument_ioIntermediateCodeStruct.mAttribute_mGlobalVariableMap.setter_insertKey (inObject.mAttribute_mVarName, var_inferredType, GALGAS_bool (kIsStrictSup, var_executionModeSet.getter_count (SOURCE_FILE ("global-variable-declaration.galgas", 264)).objectCompare (GALGAS_uint ((uint32_t) 1U))), var_expressionGeneratedCode, inCompiler COMMA_SOURCE_FILE ("global-variable-declaration.galgas", 261)) ;
  }
}
