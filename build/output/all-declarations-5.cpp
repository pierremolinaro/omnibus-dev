...
void categoryMethod_enterAccessibleEntities (const GALGAS_instructionListIR inObject,
                                             ...
                                             COMMA_UNUSED_LOCATION_ARGS) {
  const GALGAS_instructionListIR temp_0 = inObject ;
  cEnumerator_instructionListIR enumerator_2487 (temp_0, kEnumeration_up) ;
  while (enumerator_2487.hasCurrentObject ()) {
    callCategoryMethod_enterAccessibleEntities ((const cPtr_abstractInstructionIR *) enumerator_2487.current_mInstructionGeneration (HERE).ptr (), ioArgument_ioAccessibleEntities, inCompiler COMMA_SOURCE_FILE ("code-optimisation.galgas", 53)) ;
...
mAttribute_mIncOperatorMap (inOperand15),
mAttribute_mDecOperatorMap (inOperand16),
...
mAttribute_mInitializedStructConstantList (),
...
GALGAS_intermediateCodeStruct::GALGAS_intermediateCodeStruct (const GALGAS_initializedStructConstantList & inOperand0,
                                                              const GALGAS_globalLiteralStringMap & inOperand1,
                                                              const GALGAS_registerMapIR & inOperand2,
                                                              const GALGAS_globalVariableMapIR & inOperand3,
                                                              const GALGAS_globalConstantMapIR & inOperand4,
...
mAttribute_mInitializedStructConstantList (inOperand0),
mAttribute_mGlobalLiteralStringMap (inOperand1),
mAttribute_mRegisterMap (inOperand2),
mAttribute_mGlobalVariableMap (inOperand3),
mAttribute_mGlobalConstantMap (inOperand4),
...
GALGAS_intermediateCodeStruct GALGAS_intermediateCodeStruct::constructor_default (UNUSED_LOCATION_ARGS) {
  return GALGAS_intermediateCodeStruct (GALGAS_initializedStructConstantList::constructor_emptyList (HERE),
                                        GALGAS_globalLiteralStringMap::constructor_emptyMap (HERE),
...
GALGAS_intermediateCodeStruct GALGAS_intermediateCodeStruct::constructor_new (const GALGAS_initializedStructConstantList & inOperand0,
                                                                              const GALGAS_globalLiteralStringMap & inOperand1,
                                                                              const GALGAS_registerMapIR & inOperand2,
                                                                              const GALGAS_globalVariableMapIR & inOperand3,
                                                                              const GALGAS_globalConstantMapIR & inOperand4,
...
typeComparisonResult GALGAS_intermediateCodeStruct::objectCompare (const GALGAS_intermediateCodeStruct & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
    result = mAttribute_mInitializedStructConstantList.objectCompare (inOperand.mAttribute_mInitializedStructConstantList) ;
  }
  if (result == kOperandEqual) {
...
void GALGAS_intermediateCodeStruct::description (C_String & ioString,
  ...
  if (! isValid ()) {
    ...
    mAttribute_mInitializedStructConstantList.description (ioString, inIndentation+1) ;
    ioString << ", " ;
...
GALGAS_initializedStructConstantList GALGAS_intermediateCodeStruct::reader_mInitializedStructConstantList (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mInitializedStructConstantList ;
}
...
void categoryMethod_storeInMemory (const GALGAS_objectInMemoryIR inObject,
  ...
  case GALGAS_objectInMemoryIR::kEnum_register:
    {
      const cEnumAssociatedValues_objectInMemoryIR_register * extractPtr_2513 = (const cEnumAssociatedValues_objectInMemoryIR_register *) (temp_0.unsafePointer ()) ;
      const GALGAS_unifiedTypeMap_2D_proxy extractedValue_type = extractPtr_2513->mAssociatedValue0 ;
      const GALGAS_lstring extractedValue_registerName = extractPtr_2513->mAssociatedValue1 ;
      const GALGAS_bigint extractedValue_address = extractPtr_2513->mAssociatedValue2 ;
      {
  ...
  case GALGAS_objectInMemoryIR::kEnum_globalVariable:
    {
      const cEnumAssociatedValues_objectInMemoryIR_globalVariable * extractPtr_2700 = (const cEnumAssociatedValues_objectInMemoryIR_globalVariable *) (temp_0.unsafePointer ()) ;
      const GALGAS_unifiedTypeMap_2D_proxy extractedValue_type = extractPtr_2700->mAssociatedValue0 ;
      const GALGAS_string extractedValue_name = extractPtr_2700->mAssociatedValue1 ;
      const GALGAS_bool extractedValue_isVolatile = extractPtr_2700->mAssociatedValue2 ;
      {
  ...
  case GALGAS_objectInMemoryIR::kEnum_localValue:
    {
      const cEnumAssociatedValues_objectInMemoryIR_localValue * extractPtr_2859 = (const cEnumAssociatedValues_objectInMemoryIR_localValue *) (temp_0.unsafePointer ()) ;
      const GALGAS_unifiedTypeMap_2D_proxy extractedValue_type = extractPtr_2859->mAssociatedValue0 ;
      const GALGAS_lstring extractedValue_name = extractPtr_2859->mAssociatedValue1 ;
      {
  ...
  case GALGAS_objectInMemoryIR::kEnum_localAccess:
    {
      const cEnumAssociatedValues_objectInMemoryIR_localAccess * extractPtr_3082 = (const cEnumAssociatedValues_objectInMemoryIR_localAccess *) (temp_0.unsafePointer ()) ;
      const GALGAS_lstring extractedValue_access = extractPtr_3082->mAssociatedValue0 ;
...
void categoryMethod_enterAccessibleEntities (const GALGAS_objectInMemoryIR inObject,
  ...
  case GALGAS_objectInMemoryIR::kEnum_register:
    {
      const cEnumAssociatedValues_objectInMemoryIR_register * extractPtr_1614 = (const cEnumAssociatedValues_objectInMemoryIR_register *) (temp_0.unsafePointer ()) ;
      const GALGAS_lstring extractedValue_name = extractPtr_1614->mAssociatedValue1 ;
  ...
  case GALGAS_objectInMemoryIR::kEnum_globalVariable:
    {
      const cEnumAssociatedValues_objectInMemoryIR_globalVariable * extractPtr_1710 = (const cEnumAssociatedValues_objectInMemoryIR_globalVariable *) (temp_0.unsafePointer ()) ;
  ...
  case GALGAS_objectInMemoryIR::kEnum_localValue:
    {
      const cEnumAssociatedValues_objectInMemoryIR_localValue * extractPtr_1755 = (const cEnumAssociatedValues_objectInMemoryIR_localValue *) (temp_0.unsafePointer ()) ;
      const GALGAS_lstring extractedValue_name = extractPtr_1755->mAssociatedValue1 ;
    }
    break ;
  case GALGAS_objectInMemoryIR::kEnum_globalConstant:
    {
      const cEnumAssociatedValues_objectInMemoryIR_globalConstant * extractPtr_1849 = (const cEnumAssociatedValues_objectInMemoryIR_globalConstant *) (temp_0.unsafePointer ()) ;
      const GALGAS_string extractedValue_name = extractPtr_1849->mAssociatedValue1 ;
  ...
  case GALGAS_objectInMemoryIR::kEnum_localAccess:
    {
      const cEnumAssociatedValues_objectInMemoryIR_localAccess * extractPtr_1895 = (const cEnumAssociatedValues_objectInMemoryIR_localAccess *) (temp_0.unsafePointer ()) ;
      const GALGAS_lstring extractedValue_access = extractPtr_1895->mAssociatedValue0 ;
    }
    break ;
  }
}
...
GALGAS_string categoryReader_mangledName (const GALGAS_objectInMemoryIR & inObject,
  ...
  case GALGAS_objectInMemoryIR::kEnum_register:
    {
      const cEnumAssociatedValues_objectInMemoryIR_register * extractPtr_1383 = (const cEnumAssociatedValues_objectInMemoryIR_register *) (temp_0.unsafePointer ()) ;
      const GALGAS_lstring extractedValue_name = extractPtr_1383->mAssociatedValue1 ;
  ...
  case GALGAS_objectInMemoryIR::kEnum_globalVariable:
    {
      const cEnumAssociatedValues_objectInMemoryIR_globalVariable * extractPtr_1479 = (const cEnumAssociatedValues_objectInMemoryIR_globalVariable *) (temp_0.unsafePointer ()) ;
      const GALGAS_string extractedValue_name = extractPtr_1479->mAssociatedValue1 ;
  ...
  case GALGAS_objectInMemoryIR::kEnum_localValue:
    {
      const cEnumAssociatedValues_objectInMemoryIR_localValue * extractPtr_1576 = (const cEnumAssociatedValues_objectInMemoryIR_localValue *) (temp_0.unsafePointer ()) ;
      const GALGAS_lstring extractedValue_name = extractPtr_1576->mAssociatedValue1 ;
  ...
  case GALGAS_objectInMemoryIR::kEnum_globalConstant:
    {
      const cEnumAssociatedValues_objectInMemoryIR_globalConstant * extractPtr_1670 = (const cEnumAssociatedValues_objectInMemoryIR_globalConstant *) (temp_0.unsafePointer ()) ;
      const GALGAS_string extractedValue_name = extractPtr_1670->mAssociatedValue1 ;
  ...
  case GALGAS_objectInMemoryIR::kEnum_localAccess:
    {
      const cEnumAssociatedValues_objectInMemoryIR_localAccess * extractPtr_1739 = (const cEnumAssociatedValues_objectInMemoryIR_localAccess *) (temp_0.unsafePointer ()) ;
      const GALGAS_lstring extractedValue_access = extractPtr_1739->mAssociatedValue0 ;
...
GALGAS_initializedStructConstantList_2D_element::GALGAS_initializedStructConstantList_2D_element (void) :
mAttribute_mStructureName (),
mAttribute_mStructureType (),
...
GALGAS_initializedStructConstantList_2D_element::GALGAS_initializedStructConstantList_2D_element (const GALGAS_string & inOperand0,
                                                                                                  const GALGAS_unifiedTypeMap_2D_proxy & inOperand1,
                                                                                                  const GALGAS_operandIRList & inOperand2) :
mAttribute_mStructureName (inOperand0),
mAttribute_mStructureType (inOperand1),
mAttribute_mInitValue (inOperand2) {
}

//---------------------------------------------------------------------------------------------------------------------*

GALGAS_initializedStructConstantList_2D_element GALGAS_initializedStructConstantList_2D_element::constructor_default (UNUSED_LOCATION_ARGS) {
  return GALGAS_initializedStructConstantList_2D_element (GALGAS_string::constructor_default (HERE),
                                                          GALGAS_unifiedTypeMap_2D_proxy::constructor_null (HERE),
...
GALGAS_initializedStructConstantList_2D_element GALGAS_initializedStructConstantList_2D_element::constructor_new (const GALGAS_string & inOperand0,
                                                                                                                  const GALGAS_unifiedTypeMap_2D_proxy & inOperand1,
                                                                                                                  const GALGAS_operandIRList & inOperand2 
                                                                                                                  COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_initializedStructConstantList_2D_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid ()) {
    result = GALGAS_initializedStructConstantList_2D_element (inOperand0, inOperand1, inOperand2) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_initializedStructConstantList_2D_element::objectCompare (const GALGAS_initializedStructConstantList_2D_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
    result = mAttribute_mStructureName.objectCompare (inOperand.mAttribute_mStructureName) ;
  }
  if (result == kOperandEqual) {
    result = mAttribute_mStructureType.objectCompare (inOperand.mAttribute_mStructureType) ;
  }
  if (result == kOperandEqual) {
...
bool GALGAS_initializedStructConstantList_2D_element::isValid (void) const {
  return mAttribute_mStructureName.isValid () && mAttribute_mStructureType.isValid () && mAttribute_mInitValue.isValid () ;
}

//---------------------------------------------------------------------------------------------------------------------*

void GALGAS_initializedStructConstantList_2D_element::drop (void) {
  mAttribute_mStructureName.drop () ;
  mAttribute_mStructureType.drop () ;
  mAttribute_mInitValue.drop () ;
}

//---------------------------------------------------------------------------------------------------------------------*

void GALGAS_initializedStructConstantList_2D_element::description (C_String & ioString,
                                                                   const int32_t inIndentation) const {
  ioString << "<struct @initializedStructConstantList-element:" ;
  if (! isValid ()) {
    ioString << " not built" ;
  }else{
    mAttribute_mStructureName.description (ioString, inIndentation+1) ;
    ioString << ", " ;
    mAttribute_mStructureType.description (ioString, inIndentation+1) ;
    ioString << ", " ;
...
GALGAS_string GALGAS_initializedStructConstantList_2D_element::reader_mStructureName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mStructureName ;
}

//---------------------------------------------------------------------------------------------------------------------*

GALGAS_unifiedTypeMap_2D_proxy GALGAS_initializedStructConstantList_2D_element::reader_mStructureType (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mStructureType ;
}

//---------------------------------------------------------------------------------------------------------------------*

GALGAS_operandIRList GALGAS_initializedStructConstantList_2D_element::reader_mInitValue (UNUSED_LOCATION_ARGS) const {
...
//---------------------------------------------------------------------------------------------------------------------*
//                                                                                                                     *
//                                     @initializedStructConstantList-element type                                     *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*

const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_initializedStructConstantList_2D_element ("initializedStructConstantList-element",
                                                                 NULL) ;

//---------------------------------------------------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_initializedStructConstantList_2D_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_initializedStructConstantList_2D_element ;
}

//---------------------------------------------------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_initializedStructConstantList_2D_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_initializedStructConstantList_2D_element (*this)) ;
  }
  return result ;
}
...
GALGAS_initializedStructConstantList_2D_element GALGAS_initializedStructConstantList_2D_element::extractObject (const GALGAS_object & inObject,
                                                                                                                C_Compiler * inCompiler
                                                                                                                COMMA_LOCATION_ARGS) {
  GALGAS_initializedStructConstantList_2D_element result ;
  const GALGAS_initializedStructConstantList_2D_element * p = (const GALGAS_initializedStructConstantList_2D_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_initializedStructConstantList_2D_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->castError ("initializedStructConstantList-element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
