...
static const char * gNonTerminalNames_plm_target_grammar [15] = {
  ...
  "<select_plm_5F_target_5F_specific_5F_syntax_3>",// Index 6
  "<select_plm_5F_target_5F_specific_5F_syntax_4>",// Index 7
  "<select_plm_5F_target_5F_specific_5F_syntax_5>",// Index 8
  "<select_plm_5F_target_5F_specific_5F_syntax_6>",// Index 9
...
, END
// State S1 (index = 3)
, C_Lexique_plm_5F_lexique::kToken__3A_, SHIFT (4)
, END
// State S2 (index = 6)
, C_Lexique_plm_5F_lexique::kToken_identifier, REDUCE (3)
, C_Lexique_plm_5F_lexique::kToken__22_string_22_, SHIFT (5)
, END
// State S3 (index = 11)
...
, END
// State S5 (index = 25)
, C_Lexique_plm_5F_lexique::kToken__2D__3E_, SHIFT (7)
, END
// State S6 (index = 28)
, C_Lexique_plm_5F_lexique::kToken_identifier, SHIFT (1)
, END
...
, C_Lexique_plm_5F_lexique::kToken__2C_, SHIFT (11)
, END
// State S10 (index = 42)
, C_Lexique_plm_5F_lexique::kToken_identifier, SHIFT (1)
, END
...
, END
// State S14 (index = 54)
, C_Lexique_plm_5F_lexique::kToken__2D__3E_, SHIFT (16)
, END
// State S15 (index = 57)
, C_Lexique_plm_5F_lexique::kToken_identifier, SHIFT (1)
, END
// State S16 (index = 60)
, C_Lexique_plm_5F_lexique::kToken__22_string_22_, SHIFT (18)
, END
// State S17 (index = 63)
...
, END
// State S21 (index = 77)
, C_Lexique_plm_5F_lexique::kToken__24_type, SHIFT (22)
, END
// State S22 (index = 80)
, C_Lexique_plm_5F_lexique::kToken__3B_, SHIFT (23)
, END
// State S23 (index = 83)
, C_Lexique_plm_5F_lexique::kToken__22_string_22_, SHIFT (24)
, END
// State S24 (index = 86)
, C_Lexique_plm_5F_lexique::kToken_identifier, SHIFT (1)
, END
...
, END
// State S29 (index = 101)
, C_Lexique_plm_5F_lexique::kToken__22_string_22_, SHIFT (30)
, END
// State S30 (index = 104)
, C_Lexique_plm_5F_lexique::kToken_identifier, SHIFT (1)
, END
...
, END
// State S32 (index = 110)
, C_Lexique_plm_5F_lexique::kToken__3B_, SHIFT (33)
, END
// State S33 (index = 113)
, C_Lexique_plm_5F_lexique::kToken_integer, SHIFT (34)
, END
// State S34 (index = 116)
, C_Lexique_plm_5F_lexique::kToken__3B_, SHIFT (35)
, END
// State S35 (index = 119)
, C_Lexique_plm_5F_lexique::kToken__22_string_22_, SHIFT (36)
, END
// State S36 (index = 122)
, C_Lexique_plm_5F_lexique::kToken__3B_, SHIFT (37)
, END
// State S37 (index = 125)
, C_Lexique_plm_5F_lexique::kToken__22_string_22_, SHIFT (38)
, END
// State S38 (index = 128)
, C_Lexique_plm_5F_lexique::kToken__3B_, SHIFT (39)
, END
// State S39 (index = 131)
, C_Lexique_plm_5F_lexique::kToken__22_string_22_, SHIFT (40)
, END
// State S40 (index = 134)
, C_Lexique_plm_5F_lexique::kToken_identifier, SHIFT (1)
, END
...
, C_Lexique_plm_5F_lexique::kToken__2C_, SHIFT (50)
, END
// State S49 (index = 165)
...
, C_Lexique_plm_5F_lexique::kToken__2C_, SHIFT (67)
, END
// State S67 (index = 227)
...
, C_Lexique_plm_5F_lexique::kToken__2C_, SHIFT (74)
, END
// State S73 (index = 251)
, C_Lexique_plm_5F_lexique::kToken_identifier, SHIFT (1)
, END
...
, END
// State S76 (index = 260)
, C_Lexique_plm_5F_lexique::kToken__22_string_22_, SHIFT (78)
, END
// State S77 (index = 263)
, C_Lexique_plm_5F_lexique::kToken_identifier, REDUCE (17)
, C_Lexique_plm_5F_lexique::kToken__2C_, SHIFT (74)
...
, END
// State S82 (index = 280)
, C_Lexique_plm_5F_lexique::kToken__22_string_22_, SHIFT (83)
, END
// State S83 (index = 283)
, C_Lexique_plm_5F_lexique::kToken_identifier, SHIFT (1)
, END
...
, END
// State S86 (index = 294)
, C_Lexique_plm_5F_lexique::kToken__2D__3E_, SHIFT (88)
...
, END
// State S89 (index = 307)
, C_Lexique_plm_5F_lexique::kToken__2C_, SHIFT (91)
...
static const uint32_t gActionTableIndex_plm_target_grammar [96] = {
  0  // S0
, 3  // S1
, 6  // S2
, 11  // S3
...
static const int16_t gSuccessorTable_plm_target_grammar_2 [3] = {3, 6, -1} ;

static const int16_t gSuccessorTable_plm_target_grammar_6 [3] = {0, 8, -1} ;

static const int16_t gSuccessorTable_plm_target_grammar_9 [3] = {4, 12, -1} ;

static const int16_t gSuccessorTable_plm_target_grammar_10 [3] = {0, 13, -1} ;

static const int16_t gSuccessorTable_plm_target_grammar_15 [3] = {0, 17, -1} ;

static const int16_t gSuccessorTable_plm_target_grammar_18 [3] = {4, 20, -1} ;
...
static const int16_t gSuccessorTable_plm_target_grammar_30 [3] = {0, 31, -1} ;
...
static const int16_t gSuccessorTable_plm_target_grammar_48 [3] = {6, 51, -1} ;

static const int16_t gSuccessorTable_plm_target_grammar_51 [3] = {0, 54, -1} ;

static const int16_t gSuccessorTable_plm_target_grammar_53 [3] = {6, 56, -1} ;

static const int16_t gSuccessorTable_plm_target_grammar_57 [3] = {7, 60, -1} ;

static const int16_t gSuccessorTable_plm_target_grammar_60 [3] = {0, 63, -1} ;

static const int16_t gSuccessorTable_plm_target_grammar_62 [3] = {7, 65, -1} ;

static const int16_t gSuccessorTable_plm_target_grammar_66 [3] = {8, 68, -1} ;

static const int16_t gSuccessorTable_plm_target_grammar_68 [3] = {0, 70, -1} ;

static const int16_t gSuccessorTable_plm_target_grammar_69 [3] = {8, 71, -1} ;

static const int16_t gSuccessorTable_plm_target_grammar_70 [3] = {9, 73, -1} ;

static const int16_t gSuccessorTable_plm_target_grammar_72 [3] = {10, 75, -1} ;

static const int16_t gSuccessorTable_plm_target_grammar_73 [3] = {0, 76, -1} ;

static const int16_t gSuccessorTable_plm_target_grammar_77 [3] = {10, 79, -1} ;

static const int16_t gSuccessorTable_plm_target_grammar_83 [5] = {0, 84,
  2, 85, -1} ;

static const int16_t gSuccessorTable_plm_target_grammar_84 [3] = {11, 87, -1} ;

static const int16_t gSuccessorTable_plm_target_grammar_86 [3] = {13, 89, -1} ;

static const int16_t gSuccessorTable_plm_target_grammar_89 [3] = {12, 92, -1} ;

static const int16_t gSuccessorTable_plm_target_grammar_93 [3] = {13, 94, -1} ;

static const int16_t gSuccessorTable_plm_target_grammar_94 [3] = {12, 95, -1} ;

static const int16_t * gSuccessorTable_plm_target_grammar [96] = {
gSuccessorTable_plm_target_grammar_0, NULL, gSuccessorTable_plm_target_grammar_2, NULL, 
  ...
  NULL, NULL, gSuccessorTable_plm_target_grammar_18, NULL, 
  NULL, NULL, NULL, NULL, 
  ...
  NULL, NULL, NULL, NULL, 
  gSuccessorTable_plm_target_grammar_48, NULL, NULL, gSuccessorTable_plm_target_grammar_51, 
  NULL, gSuccessorTable_plm_target_grammar_53, NULL, NULL, 
  ...
  NULL, NULL, gSuccessorTable_plm_target_grammar_66, NULL, 
  gSuccessorTable_plm_target_grammar_68, gSuccessorTable_plm_target_grammar_69, gSuccessorTable_plm_target_grammar_70, NULL, 
  gSuccessorTable_plm_target_grammar_72, gSuccessorTable_plm_target_grammar_73, NULL, NULL, 
  NULL, gSuccessorTable_plm_target_grammar_77, NULL, NULL, 
  ...
  NULL, gSuccessorTable_plm_target_grammar_93, gSuccessorTable_plm_target_grammar_94, NULL} ;
...
static void extensionMethod_structureDeclaration_functionSemanticAnalysis (const cPtr_structureDeclaration * inObject,
  ...
  cEnumerator_functionDeclarationListAST enumerator_18092 (object->mProperty_mFunctionDeclarationListAST, kENUMERATION_UP) ;
  while (enumerator_18092.hasCurrentObject ()) {
    GALGAS_bool var_warnIfUnused_18116 = GALGAS_bool (true) ;
    GALGAS_bool var_mutating_18140 = GALGAS_bool (false) ;
    GALGAS_bool var_accessProperties_18173 = GALGAS_bool (false) ;
    cEnumerator_lstringlist enumerator_18236 (enumerator_18092.current (HERE).getter_mFunctionAttributeList (HERE), kENUMERATION_UP) ;
    while (enumerator_18236.hasCurrentObject ()) {
      const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, enumerator_18236.current_mValue (HERE).getter_string (HERE).objectCompare (function_noUnusedWarningAttribute (inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 474)))).boolEnum () ;
      if (kBoolTrue == test_0) {
        const enumGalgasBool test_1 = var_warnIfUnused_18116.operator_not (SOURCE_FILE ("type-structure-declaration.galgas", 475)).boolEnum () ;
        if (kBoolTrue == test_1) {
          TC_Array <C_FixItDescription> fixItArray2 ;
          inCompiler->emitSemanticError (enumerator_18236.current_mValue (HERE).getter_location (SOURCE_FILE ("type-structure-declaration.galgas", 476)), GALGAS_string ("duplicated @").add_operation (function_noUnusedWarningAttribute (inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 476)), inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 476)).add_operation (GALGAS_string (" attribute"), inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 476)), fixItArray2  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 476)) ;
        }
        var_warnIfUnused_18116 = GALGAS_bool (false) ;
      }else if (kBoolFalse == test_0) {
        const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, enumerator_18236.current_mValue (HERE).getter_string (HERE).objectCompare (function_userAccessAttribute (inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 479)))).boolEnum () ;
        if (kBoolTrue == test_3) {
          const enumGalgasBool test_4 = var_accessProperties_18173.boolEnum () ;
          if (kBoolTrue == test_4) {
          ...
          var_accessProperties_18173 = GALGAS_bool (true) ;
        }else if (kBoolFalse == test_3) {
          const enumGalgasBool test_6 = GALGAS_bool (kIsEqual, enumerator_18236.current_mValue (HERE).getter_string (HERE).objectCompare (function_mutatingAttribute (inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 484)))).boolEnum () ;
          if (kBoolTrue == test_6) {
            const enumGalgasBool test_7 = var_mutating_18140.boolEnum () ;
            if (kBoolTrue == test_7) {
            ...
            var_mutating_18140 = GALGAS_bool (true) ;
    ...
    var_accessProperties_18173 = GALGAS_bool (kIsNotEqual, enumerator_18092.current (HERE).getter_mMode (HERE).objectCompare (GALGAS_mode::constructor_userMode (SOURCE_FILE ("type-structure-declaration.galgas", 494)))) ;
    {
    routine_routineSemanticAnalysis (constinArgument_inStructureType, GALGAS_routineKind::constructor_function (enumerator_18092.current (HERE).getter_mMode (HERE)  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 497)), enumerator_18092.current (HERE).getter_mMode (HERE), enumerator_18092.current (HERE).getter_mFunctionName (HERE), enumerator_18092.current (HERE).getter_mFunctionFormalArgumentList (HERE), enumerator_18092.current (HERE).getter_mFunctionReturnTypeName (HERE), enumerator_18092.current (HERE).getter_mFunctionInstructionList (HERE), enumerator_18092.current (HERE).getter_mEndOfFunctionDeclaration (HERE), var_accessProperties_18173, var_mutating_18140, var_warnIfUnused_18116, GALGAS_bool (false), constinArgument_inContext, ioArgument_ioTemporaries, ioArgument_ioIntermediateCodeStruct, inCompiler  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 495)) ;
    }
...
void extensionMethod_buildControlRegisterSliceMap (const GALGAS_controlRegisterDeclarationListAST_2D_element inObject,
  ...
  GALGAS_classConstantMap var_classConstantMap_11035 = GALGAS_classConstantMap::constructor_emptyMap (SOURCE_FILE ("declaration-control-register.galgas", 292)) ;
  outArgument_outRegisterFieldMap = GALGAS_controlRegisterFieldMap::constructor_emptyMap (SOURCE_FILE ("declaration-control-register.galgas", 293)) ;
  outArgument_outRegisterBitSliceMap = GALGAS_sliceMap::constructor_emptyMap (SOURCE_FILE ("declaration-control-register.galgas", 294)) ;
  outArgument_outControlRegisterFieldList = GALGAS_controlRegisterFieldList::constructor_emptyList (SOURCE_FILE ("declaration-control-register.galgas", 295)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, inObject.mProperty_mRegisterBitSliceList.getter_length (SOURCE_FILE ("declaration-control-register.galgas", 296)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_uint var_shiftCount_11219 = GALGAS_uint ((uint32_t) 0U) ;
    cEnumerator_controlRegisterBitSliceList enumerator_11261 (inObject.mProperty_mRegisterBitSliceList, kENUMERATION_DOWN) ;
    while (enumerator_11261.hasCurrentObject ()) {
      switch (enumerator_11261.current_mRegisterBitSlice (HERE).enumValue ()) {
      case GALGAS_controlRegisterBitSlice::kNotBuilt:
        break ;
      case GALGAS_controlRegisterBitSlice::kEnum_unusedBits:
        {
          const cEnumAssociatedValues_controlRegisterBitSlice_unusedBits * extractPtr_11456 = (const cEnumAssociatedValues_controlRegisterBitSlice_unusedBits *) (enumerator_11261.current_mRegisterBitSlice (HERE).unsafePointer ()) ;
          const GALGAS_lbigint extractedValue_count = extractPtr_11456->mAssociatedValue0 ;
          var_shiftCount_11219 = var_shiftCount_11219.add_operation (extractedValue_count.getter_bigint (HERE).getter_uint (inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 301)), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 301)) ;
          outArgument_outControlRegisterFieldList.addAssign_operation (extractedValue_count.getter_bigint (HERE).getter_uint (inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 302)), GALGAS_string ("\xE2""\x80""\x94""")  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 302)) ;
        }
        break ;
      case GALGAS_controlRegisterBitSlice::kEnum_namedBit:
        {
          const cEnumAssociatedValues_controlRegisterBitSlice_namedBit * extractPtr_12604 = (const cEnumAssociatedValues_controlRegisterBitSlice_namedBit *) (enumerator_11261.current_mRegisterBitSlice (HERE).unsafePointer ()) ;
          const GALGAS_lstring extractedValue_name = extractPtr_12604->mAssociatedValue0 ;
          const GALGAS_lbigint extractedValue_count = extractPtr_12604->mAssociatedValue1 ;
          GALGAS_uint var_bitCount_11530 = extractedValue_count.getter_bigint (HERE).getter_uint (inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 304)) ;
          const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, var_bitCount_11530.objectCompare (GALGAS_uint ((uint32_t) 1U))).boolEnum () ;
          if (kBoolTrue == test_1) {
            {
            var_classConstantMap_11035.setter_insertKey (extractedValue_name, GALGAS_objectIR::constructor_literalInteger (ioArgument_ioRegisterType, GALGAS_bigint ("1", inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 306)).left_shift_operation (var_shiftCount_11219 COMMA_SOURCE_FILE ("declaration-control-register.galgas", 306))  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 306)), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 306)) ;
            }
          }
          outArgument_outControlRegisterFieldList.addAssign_operation (var_bitCount_11530, extractedValue_name.getter_string (HERE)  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 308)) ;
          {
          outArgument_outRegisterFieldMap.setter_insertKey (extractedValue_name, var_shiftCount_11219, var_bitCount_11530, inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 309)) ;
          }
          GALGAS_sliceMap var_registerSubMap_11909 = GALGAS_sliceMap::constructor_emptyMap (SOURCE_FILE ("declaration-control-register.galgas", 314)) ;
          {
          var_registerSubMap_11909.setter_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("shifted"), extractedValue_name.getter_location (HERE)  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 317)), GALGAS_llvmBinaryOperation::constructor_lshr (SOURCE_FILE ("declaration-control-register.galgas", 318)), var_shiftCount_11219.getter_bigint (SOURCE_FILE ("declaration-control-register.galgas", 319)), GALGAS_sliceMap::constructor_emptyMap (SOURCE_FILE ("declaration-control-register.galgas", 320)), ioArgument_ioRegisterType, inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 316)) ;
          }
          {
          var_registerSubMap_11909.setter_insertKey (GALGAS_lstring::constructor_new (function_boolTypeName (inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 325)), extractedValue_name.getter_location (HERE)  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 325)), GALGAS_llvmBinaryOperation::constructor_icmp_5F_ne (SOURCE_FILE ("declaration-control-register.galgas", 326)), GALGAS_bigint ("0", inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 327)), GALGAS_sliceMap::constructor_emptyMap (SOURCE_FILE ("declaration-control-register.galgas", 328)), ioArgument_ioContext.getter_mBooleanType (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 324)) ;
          }
          GALGAS_bigint var_mask_12367 = GALGAS_bigint ("1", inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 332)).left_shift_operation (var_bitCount_11530 COMMA_SOURCE_FILE ("declaration-control-register.galgas", 332)).substract_operation (GALGAS_bigint ("1", inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 332)), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 332)).left_shift_operation (var_shiftCount_11219 COMMA_SOURCE_FILE ("declaration-control-register.galgas", 332)) ;
          {
          outArgument_outRegisterBitSliceMap.setter_insertKey (extractedValue_name, GALGAS_llvmBinaryOperation::constructor_and (SOURCE_FILE ("declaration-control-register.galgas", 335)), var_mask_12367, var_registerSubMap_11909, ioArgument_ioRegisterType, inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 333)) ;
          }
          var_shiftCount_11219 = var_shiftCount_11219.add_operation (var_bitCount_11530, inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 340)) ;
        }
        break ;
      }
      enumerator_11261.gotoNextObject () ;
    }
    const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, constinArgument_inRegisterBitCount.objectCompare (var_shiftCount_11219)).boolEnum () ;
    if (kBoolTrue == test_2) {
      TC_Array <C_FixItDescription> fixItArray3 ;
      inCompiler->emitSemanticError (inObject.mProperty_mRegisterBitSliceListLocation, GALGAS_string ("total bit slice count is ").add_operation (var_shiftCount_11219.getter_string (SOURCE_FILE ("declaration-control-register.galgas", 346)), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 346)).add_operation (GALGAS_string (" (should be "), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 346)).add_operation (constinArgument_inRegisterBitCount.getter_string (SOURCE_FILE ("declaration-control-register.galgas", 346)), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 346)).add_operation (GALGAS_string (")"), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 346)), fixItArray3  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 345)) ;
    }
  }
}
...
void extensionMethod_enterControlRegistersInContext (const GALGAS_controlRegisterDeclarationListAST_2D_element inObject,
                                                     ...
                                                     C_Compiler * inCompiler
                                                     COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_unifiedTypeMap_2D_proxy var_registerType_13231 ;
  GALGAS_uint var_registerBitCount_13262 ;
  const GALGAS_controlRegisterDeclarationListAST_2D_element temp_0 = inObject ;
  extensionMethod_controlRegisterType (temp_0, ioArgument_ioContext, var_registerType_13231, var_registerBitCount_13262, inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 357)) ;
  GALGAS_controlRegisterFieldMap var_registerFieldMap_13430 ;
  GALGAS_sliceMap var_registerBitSliceMap_13459 ;
  GALGAS_controlRegisterFieldList var_controlRegisterFieldList_13493 ;
  const GALGAS_controlRegisterDeclarationListAST_2D_element temp_1 = inObject ;
  extensionMethod_buildControlRegisterSliceMap (temp_1, ioArgument_ioContext, var_registerType_13231, var_registerBitCount_13262, var_registerFieldMap_13430, var_registerBitSliceMap_13459, var_controlRegisterFieldList_13493, inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 359)) ;
  GALGAS_bigint var_maxRegisterAddress_13559 = GALGAS_bigint ("1", inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 368)).left_shift_operation (ioArgument_ioContext.getter_mPointerSize (HERE) COMMA_SOURCE_FILE ("declaration-control-register.galgas", 368)).substract_operation (GALGAS_bigint ("1", inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 368)), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 368)) ;
  cEnumerator_controlRegisterNameList enumerator_13633 (inObject.mProperty_mRegisterNameList, kENUMERATION_UP) ;
  while (enumerator_13633.hasCurrentObject ()) {
    GALGAS_bool var_isReadOnly_13681 = GALGAS_bool (false) ;
    GALGAS_bool var_isAccessibleInUserMode_13720 = GALGAS_bool (false) ;
    cEnumerator_lstringlist enumerator_13769 (enumerator_13633.current (HERE).getter_mAttributeList (HERE), kENUMERATION_UP) ;
    while (enumerator_13769.hasCurrentObject ()) {
      const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, enumerator_13769.current_mValue (HERE).getter_string (HERE).objectCompare (GALGAS_string ("ro"))).boolEnum () ;
      if (kBoolTrue == test_2) {
        const enumGalgasBool test_3 = var_isReadOnly_13681.boolEnum () ;
        if (kBoolTrue == test_3) {
          TC_Array <C_FixItDescription> fixItArray4 ;
          inCompiler->emitSemanticError (enumerator_13769.current_mValue (HERE).getter_location (SOURCE_FILE ("declaration-control-register.galgas", 376)), GALGAS_string ("duplicated attribute"), fixItArray4  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 376)) ;
        }else if (kBoolFalse == test_3) {
          var_isReadOnly_13681 = GALGAS_bool (true) ;
        }
      }else if (kBoolFalse == test_2) {
        const enumGalgasBool test_5 = GALGAS_bool (kIsEqual, enumerator_13769.current_mValue (HERE).getter_string (HERE).objectCompare (function_userModeName (inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 380)))).boolEnum () ;
        if (kBoolTrue == test_5) {
          const enumGalgasBool test_6 = var_isAccessibleInUserMode_13720.boolEnum () ;
          if (kBoolTrue == test_6) {
            TC_Array <C_FixItDescription> fixItArray7 ;
            inCompiler->emitSemanticError (enumerator_13769.current_mValue (HERE).getter_location (SOURCE_FILE ("declaration-control-register.galgas", 382)), GALGAS_string ("duplicated attribute"), fixItArray7  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 382)) ;
          }else if (kBoolFalse == test_6) {
            var_isAccessibleInUserMode_13720 = GALGAS_bool (true) ;
          }
        }else if (kBoolFalse == test_5) {
          TC_Array <C_FixItDescription> fixItArray8 ;
          inCompiler->emitSemanticError (enumerator_13769.current_mValue (HERE).getter_location (SOURCE_FILE ("declaration-control-register.galgas", 387)), GALGAS_string ("only @ro (read only) and @user (accessible in `user mode) attributes are accepted here"), fixItArray8  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 387)) ;
        }
      }
      enumerator_13769.gotoNextObject () ;
    }
    GALGAS_objectIR var_addressExpressionResult_14543 ;
    callExtensionMethod_analyzeStaticExpression ((const cPtr_expressionAST *) enumerator_13633.current (HERE).getter_mRegisterAddress (HERE).ptr (), enumerator_13633.current (HERE).getter_mRegisterAddressLocation (HERE), ioArgument_ioContext, ioArgument_ioGlobalLiteralStringMap, var_addressExpressionResult_14543, inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 391)) ;
    GALGAS_bigint var_registerAddress_14577 ;
    const enumGalgasBool test_9 = var_addressExpressionResult_14543.getter_isLiteralInteger (SOURCE_FILE ("declaration-control-register.galgas", 398)).operator_not (SOURCE_FILE ("declaration-control-register.galgas", 398)).boolEnum () ;
    if (kBoolTrue == test_9) {
      TC_Array <C_FixItDescription> fixItArray10 ;
      inCompiler->emitSemanticError (enumerator_13633.current (HERE).getter_mRegisterAddressLocation (HERE), GALGAS_string ("control register address is not a static integer expression"), fixItArray10  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 399)) ;
      var_registerAddress_14577.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_9) {
      GALGAS_unifiedTypeMap_2D_proxy joker_14837_1 ; // Joker input parameter
      var_addressExpressionResult_14543.method_literalInteger (joker_14837_1, var_registerAddress_14577, inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 403)) ;
      const enumGalgasBool test_11 = GALGAS_bool (kIsStrictSup, var_registerAddress_14577.objectCompare (var_maxRegisterAddress_13559)).boolEnum () ;
      if (kBoolTrue == test_11) {
        TC_Array <C_FixItDescription> fixItArray12 ;
        inCompiler->emitSemanticError (enumerator_13633.current (HERE).getter_mRegisterAddressLocation (HERE), GALGAS_string ("register address should be lower or equal to ").add_operation (var_maxRegisterAddress_13559.getter_hexString (SOURCE_FILE ("declaration-control-register.galgas", 407)), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 407)), fixItArray12  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 406)) ;
      }
    }
    GALGAS_bigint var_arraySize_15122 ;
    GALGAS_uint var_elementArraySize_15149 ;
    switch (enumerator_13633.current (HERE).getter_mControlRegisterKind (HERE).enumValue ()) {
    case GALGAS_controlRegisterKind::kNotBuilt:
      break ;
    case GALGAS_controlRegisterKind::kEnum_scalar:
      {
        var_arraySize_15122 = GALGAS_bigint ("0", inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 414)) ;
        var_elementArraySize_15149 = GALGAS_uint ((uint32_t) 0U) ;
      }
      break ;
    case GALGAS_controlRegisterKind::kEnum_registerArray:
      {
        const cEnumAssociatedValues_controlRegisterKind_registerArray * extractPtr_17222 = (const cEnumAssociatedValues_controlRegisterKind_registerArray *) (enumerator_13633.current (HERE).getter_mControlRegisterKind (HERE).unsafePointer ()) ;
        const GALGAS_expressionAST extractedValue_arraySizeExpression = extractPtr_17222->mAssociatedValue0 ;
        const GALGAS_location extractedValue_arraySizeLocation = extractPtr_17222->mAssociatedValue1 ;
        const GALGAS_expressionAST extractedValue_arrayElementSizeExpression = extractPtr_17222->mAssociatedValue2 ;
        const GALGAS_location extractedValue_arrayElementSizeLocation = extractPtr_17222->mAssociatedValue3 ;
        GALGAS_objectIR var_sizeExpressionResult_15716 ;
        callExtensionMethod_analyzeStaticExpression ((const cPtr_expressionAST *) extractedValue_arraySizeExpression.ptr (), extractedValue_arraySizeLocation, ioArgument_ioContext, ioArgument_ioGlobalLiteralStringMap, var_sizeExpressionResult_15716, inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 419)) ;
        const enumGalgasBool test_13 = var_sizeExpressionResult_15716.getter_isLiteralInteger (SOURCE_FILE ("declaration-control-register.galgas", 425)).operator_not (SOURCE_FILE ("declaration-control-register.galgas", 425)).boolEnum () ;
        if (kBoolTrue == test_13) {
          TC_Array <C_FixItDescription> fixItArray14 ;
          inCompiler->emitSemanticError (extractedValue_arraySizeLocation, GALGAS_string ("control register address is not a static integer expression"), fixItArray14  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 426)) ;
          var_arraySize_15122.drop () ; // Release error dropped variable
        }else if (kBoolFalse == test_13) {
          GALGAS_unifiedTypeMap_2D_proxy joker_15948_1 ; // Joker input parameter
          var_sizeExpressionResult_15716.method_literalInteger (joker_15948_1, var_arraySize_15122, inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 428)) ;
          const enumGalgasBool test_15 = GALGAS_bool (kIsStrictInf, var_arraySize_15122.objectCompare (GALGAS_bigint ("2", inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 429)))).boolEnum () ;
          if (kBoolTrue == test_15) {
            TC_Array <C_FixItDescription> fixItArray16 ;
            inCompiler->emitSemanticError (extractedValue_arraySizeLocation, GALGAS_string ("control register array size should be a static integer expression >= 2, equal to a power of 2"), fixItArray16  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 430)) ;
            var_arraySize_15122.drop () ; // Release error dropped variable
          }else if (kBoolFalse == test_15) {
            GALGAS_uint var_powerOfTwoForArraySize_16217 = var_arraySize_15122.substract_operation (GALGAS_bigint ("1", inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 434)), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 434)).getter_bitCountForUnsignedRepresentation (SOURCE_FILE ("declaration-control-register.galgas", 434)) ;
            const enumGalgasBool test_17 = GALGAS_bool (kIsNotEqual, var_arraySize_15122.objectCompare (GALGAS_bigint ("1", inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 435)).left_shift_operation (var_powerOfTwoForArraySize_16217 COMMA_SOURCE_FILE ("declaration-control-register.galgas", 435)))).boolEnum () ;
            if (kBoolTrue == test_17) {
              TC_Array <C_FixItDescription> fixItArray18 ;
              inCompiler->emitSemanticError (extractedValue_arraySizeLocation, GALGAS_string ("control register array size should be a static integer expression >= 2, equal to a power of 2"), fixItArray18  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 436)) ;
              var_arraySize_15122.drop () ; // Release error dropped variable
            }
          }
        }
        GALGAS_objectIR var_elementArraySizeExpressionResult_16836 ;
        callExtensionMethod_analyzeStaticExpression ((const cPtr_expressionAST *) extractedValue_arrayElementSizeExpression.ptr (), extractedValue_arrayElementSizeLocation, ioArgument_ioContext, ioArgument_ioGlobalLiteralStringMap, var_elementArraySizeExpressionResult_16836, inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 443)) ;
        const enumGalgasBool test_19 = var_elementArraySizeExpressionResult_16836.getter_isLiteralInteger (SOURCE_FILE ("declaration-control-register.galgas", 449)).operator_not (SOURCE_FILE ("declaration-control-register.galgas", 449)).boolEnum () ;
        if (kBoolTrue == test_19) {
          TC_Array <C_FixItDescription> fixItArray20 ;
          inCompiler->emitSemanticError (extractedValue_arrayElementSizeLocation, GALGAS_string ("element size is not a static integer expression"), fixItArray20  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 450)) ;
          var_elementArraySize_15149.drop () ; // Release error dropped variable
        }else if (kBoolFalse == test_19) {
          GALGAS_bigint var_elementArraySizeAsBigInt_17152 ;
          GALGAS_unifiedTypeMap_2D_proxy joker_17114_1 ; // Joker input parameter
          var_elementArraySizeExpressionResult_16836.method_literalInteger (joker_17114_1, var_elementArraySizeAsBigInt_17152, inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 454)) ;
          var_elementArraySize_15149 = var_elementArraySizeAsBigInt_17152.getter_uint (inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 455)) ;
        }
      }
      break ;
    }
    {
    ioArgument_ioContext.mProperty_mControlRegisterMap.setter_insertKey (enumerator_13633.current (HERE).getter_mRegisterName (HERE), var_registerType_13231, var_isReadOnly_13681, var_isAccessibleInUserMode_13720, var_registerBitSliceMap_13459, var_registerFieldMap_13430, var_registerAddress_14577, var_controlRegisterFieldList_13493, var_registerBitCount_13262, var_arraySize_15122.getter_uint (inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 468)), var_elementArraySize_15149, inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 458)) ;
    }
...
void extensionMethod_semanticAnalysis (const GALGAS_globalVarDeclarationList_2D_element inObject,
                                       ...
                                       C_Compiler * inCompiler
                                       COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_unifiedTypeMap_2D_proxy var_inferredType_14266 ;
  GALGAS_stringset var_executionModeSet_14309 ;
  GALGAS_allowedGuardMap var_allowedGuardMap_14412 ;
  GALGAS_objectIR var_expressionGeneratedCode_14551 ;
  GALGAS_bool var_isConstant_14589 ;
  GALGAS_bool joker_14614 ; // Joker input parameter
  constinArgument_inContext.getter_mGlobalVariableMap (HERE).method_searchKey (inObject.mProperty_mVarName, var_inferredType_14266, var_executionModeSet_14309, var_allowedGuardMap_14412, var_expressionGeneratedCode_14551, var_isConstant_14589, joker_14614, inCompiler COMMA_SOURCE_FILE ("declaration-global-variable.galgas", 394)) ;
  {
  ioArgument_ioIntermediateCodeStruct.mProperty_mGlobalVariableMap.setter_insertKey (inObject.mProperty_mVarName, var_inferredType_14266, GALGAS_bool (kIsStrictSup, var_executionModeSet_14309.getter_count (SOURCE_FILE ("declaration-global-variable.galgas", 409)).objectCompare (GALGAS_uint ((uint32_t) 1U))), var_expressionGeneratedCode_14551, inCompiler COMMA_SOURCE_FILE ("declaration-global-variable.galgas", 406)) ;
  }
}
...
void extensionMethod_generateLLVM (const GALGAS_staticlistValues_5F_listMap inObject,
                                   ...
                                   C_Compiler * inCompiler
                                   COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_bool var_first_13683 = GALGAS_bool (true) ;
  const GALGAS_staticlistValues_5F_listMap temp_0 = inObject ;
  cEnumerator_staticlistValues_5F_listMap enumerator_13719 (temp_0, kENUMERATION_UP) ;
  while (enumerator_13719.hasCurrentObject ()) {
    const enumGalgasBool test_1 = constinArgument_inUsefulStaticArrayMap.getter_hasKey (enumerator_13719.current_key (HERE) COMMA_SOURCE_FILE ("declaration-extend-static-array.galgas", 304)).boolEnum () ;
    if (kBoolTrue == test_1) {
      const enumGalgasBool test_2 = var_first_13683.boolEnum () ;
      if (kBoolTrue == test_2) {
        var_first_13683 = GALGAS_bool (false) ;
...
void extensionMethod_panicSemanticAnalysis (const GALGAS_panicClauseListAST_2D_element inObject,
  ...
  GALGAS_unifiedTypeMap_2D_proxy var_StaticStringType_4964 = GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inContext.getter_mTypeMap (HERE), function_staticStringTypeName (inCompiler COMMA_SOURCE_FILE ("panic.galgas", 117)).getter_nowhere (SOURCE_FILE ("panic.galgas", 117)), inCompiler  COMMA_SOURCE_FILE ("panic.galgas", 117)) ;
  GALGAS_lstring var_codeArg_5069 = GALGAS_lstring::constructor_new (GALGAS_string ("CODE"), inObject.mProperty_mPriority.getter_location (HERE)  COMMA_SOURCE_FILE ("panic.galgas", 118)) ;
  {
  var_universalMap_4898.insulate (HERE) ;
  cPtr_universalPropertyAndRoutineMapForContext * ptr_5132 = (cPtr_universalPropertyAndRoutineMapForContext *) var_universalMap_4898.ptr () ;
  callExtensionSetter_insertUsedLocalConstant ((cPtr_universalPropertyAndRoutineMapForContext *) ptr_5132, var_codeArg_5069, GALGAS_objectIR::constructor_localVariableReference (constinArgument_inContext.getter_mPanicCodeType (HERE), var_codeArg_5069  COMMA_SOURCE_FILE ("panic.galgas", 119)), inCompiler COMMA_SOURCE_FILE ("panic.galgas", 119)) ;
  }
  {
  var_variableMap_4838.setter_insertUsedConstantInputFormalArgument (var_codeArg_5069, constinArgument_inContext.getter_mPanicCodeType (HERE), GALGAS_bool (true), GALGAS_objectIR::constructor_localVariableReference (constinArgument_inContext.getter_mPanicCodeType (HERE), var_codeArg_5069  COMMA_SOURCE_FILE ("panic.galgas", 124)), extensionGetter_copyable (constinArgument_inContext.getter_mPanicCodeType (HERE), inCompiler COMMA_SOURCE_FILE ("panic.galgas", 125)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE ("panic.galgas", 120)) ;
  }
  GALGAS_lstring var_fileArg_5570 = GALGAS_lstring::constructor_new (GALGAS_string ("FILE"), inObject.mProperty_mPriority.getter_location (HERE)  COMMA_SOURCE_FILE ("panic.galgas", 128)) ;
  {
  var_universalMap_4898.insulate (HERE) ;
  cPtr_universalPropertyAndRoutineMapForContext * ptr_5633 = (cPtr_universalPropertyAndRoutineMapForContext *) var_universalMap_4898.ptr () ;
  callExtensionSetter_insertUsedLocalConstant ((cPtr_universalPropertyAndRoutineMapForContext *) ptr_5633, var_fileArg_5570, GALGAS_objectIR::constructor_localVariableReference (var_StaticStringType_4964, var_fileArg_5570  COMMA_SOURCE_FILE ("panic.galgas", 129)), inCompiler COMMA_SOURCE_FILE ("panic.galgas", 129)) ;
  }
  {
  var_variableMap_4838.setter_insertUsedConstantInputFormalArgument (var_fileArg_5570, var_StaticStringType_4964, GALGAS_bool (true), GALGAS_objectIR::constructor_localVariableReference (var_StaticStringType_4964, var_fileArg_5570  COMMA_SOURCE_FILE ("panic.galgas", 134)), extensionGetter_copyable (var_StaticStringType_4964, inCompiler COMMA_SOURCE_FILE ("panic.galgas", 135)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE ("panic.galgas", 130)) ;
  }
  GALGAS_lstring var_lineArg_6039 = GALGAS_lstring::constructor_new (GALGAS_string ("LINE"), inObject.mProperty_mPriority.getter_location (HERE)  COMMA_SOURCE_FILE ("panic.galgas", 138)) ;
  {
  var_universalMap_4898.insulate (HERE) ;
  cPtr_universalPropertyAndRoutineMapForContext * ptr_6102 = (cPtr_universalPropertyAndRoutineMapForContext *) var_universalMap_4898.ptr () ;
  callExtensionSetter_insertUsedLocalConstant ((cPtr_universalPropertyAndRoutineMapForContext *) ptr_6102, var_lineArg_6039, GALGAS_objectIR::constructor_localVariableReference (constinArgument_inContext.getter_mPanicLineType (HERE), var_lineArg_6039  COMMA_SOURCE_FILE ("panic.galgas", 139)), inCompiler COMMA_SOURCE_FILE ("panic.galgas", 139)) ;
  }
  {
  var_variableMap_4838.setter_insertUsedConstantInputFormalArgument (var_lineArg_6039, constinArgument_inContext.getter_mPanicLineType (HERE), GALGAS_bool (true), GALGAS_objectIR::constructor_localVariableReference (constinArgument_inContext.getter_mPanicLineType (HERE), var_lineArg_6039  COMMA_SOURCE_FILE ("panic.galgas", 144)), extensionGetter_copyable (constinArgument_inContext.getter_mPanicLineType (HERE), inCompiler COMMA_SOURCE_FILE ("panic.galgas", 145)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE ("panic.galgas", 140)) ;
  }
  ...
  GALGAS_instructionListIR var_instructionGenerationList_6859 = GALGAS_instructionListIR::constructor_emptyList (SOURCE_FILE ("panic.galgas", 156)) ;
  GALGAS_allocaList var_initAllocaList_6893 = GALGAS_allocaList::constructor_emptyList (SOURCE_FILE ("panic.galgas", 157)) ;
  extensionMethod_analyzeRoutineInstructionList (inObject.mProperty_mPanicInstructionList, GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("panic.galgas", 159)), GALGAS_bool (false), GALGAS_bool (false), var_routineNameForInvocationGraph_4568, constinArgument_inContext, GALGAS_mode::constructor_panicMode (SOURCE_FILE ("panic.galgas", 164)), ioArgument_ioTemporaries, ioArgument_ioIntermediateCodeStruct.mProperty_mStaticStringMap, var_variableMap_4838, var_universalMap_4898, var_initAllocaList_6893, var_instructionGenerationList_6859, inCompiler COMMA_SOURCE_FILE ("panic.galgas", 158)) ;
  ...
  if (kBoolTrue == test_3) {
    ...
    ioArgument_ioIntermediateCodeStruct.mProperty_mPanicSetupInstructionListIR.plusAssign_operation(var_instructionGenerationList_6859, inCompiler  COMMA_SOURCE_FILE ("panic.galgas", 180)) ;
  }else if (kBoolFalse == test_3) {
    {
    ...
    ioArgument_ioIntermediateCodeStruct.mProperty_mPanicLoopInstructionListIR.plusAssign_operation(var_instructionGenerationList_6859, inCompiler  COMMA_SOURCE_FILE ("panic.galgas", 183)) ;
  }
}
...
void extensionMethod_svcCodeGeneration (const GALGAS_routineMapIR inObject,
  ...
  cEnumerator_routineMapIR enumerator_10613 (temp_0, kENUMERATION_UP) ;
  while (enumerator_10613.hasCurrentObject ()) {
    const enumGalgasBool test_1 = enumerator_10613.current (HERE).getter_mKind (HERE).getter_isFunction (SOURCE_FILE ("declaration-svc.galgas", 294)).operator_not (SOURCE_FILE ("declaration-svc.galgas", 294)).boolEnum () ;
    if (kBoolTrue == test_1) {
      GALGAS_string var_svcCallName_10677 = function_llvmNameForSVCCall (enumerator_10613.current (HERE).getter_mRoutineNameForGeneration (HERE), enumerator_10613.current (HERE).getter_mKind (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-svc.galgas", 295)) ;
      GALGAS_string var_svcImplementationName_10774 = function_llvmNameForSVCImplementation (enumerator_10613.current (HERE).getter_mRoutineNameForGeneration (HERE), enumerator_10613.current (HERE).getter_mKind (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-svc.galgas", 296)) ;
      switch (enumerator_10613.current (HERE).getter_mKind (HERE).enumValue ()) {
      case GALGAS_routineKind::kNotBuilt:
        break ;
      case GALGAS_routineKind::kEnum_section:
      case GALGAS_routineKind::kEnum_safe:
        {
          ioArgument_ioSectionList.addAssign_operation (var_svcCallName_10677, var_svcImplementationName_10774, enumerator_10613.current (HERE).getter_mReceiverType (HERE), enumerator_10613.current (HERE).getter_mFormalArgumentListForGeneration (HERE), enumerator_10613.current (HERE).getter_mReturnType (HERE)  COMMA_SOURCE_FILE ("declaration-svc.galgas", 299)) ;
        }
        break ;
      case GALGAS_routineKind::kEnum_primitive:
      case GALGAS_routineKind::kEnum_service:
        {
          ioArgument_ioLLVMcode.plusAssign_operation(function_llvmTitleComment (var_svcCallName_10677, inCompiler COMMA_SOURCE_FILE ("declaration-svc.galgas", 306)), inCompiler  COMMA_SOURCE_FILE ("declaration-svc.galgas", 306)) ;
          GALGAS_string var_prototype_11192 = function_llvmFunctionPrototype (enumerator_10613.current (HERE).getter_mReturnType (HERE), var_svcCallName_10677, enumerator_10613.current (HERE).getter_mReceiverType (HERE), enumerator_10613.current (HERE).getter_mFormalArgumentListForGeneration (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-svc.galgas", 307)) ;
          ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("declare ").add_operation (var_prototype_11192, inCompiler COMMA_SOURCE_FILE ("declaration-svc.galgas", 313)).add_operation (GALGAS_string ("\n"
            "\n"), inCompiler COMMA_SOURCE_FILE ("declaration-svc.galgas", 313)), inCompiler  COMMA_SOURCE_FILE ("declaration-svc.galgas", 313)) ;
          ioArgument_ioPrimitiveAndServiceList.addAssign_operation (var_svcCallName_10677, var_svcImplementationName_10774  COMMA_SOURCE_FILE ("declaration-svc.galgas", 314)) ;
        }
        break ;
...
void extensionMethod_externProcedureSemanticAnalysis (const GALGAS_externProcedureDeclarationListAST_2D_element inObject,
                                                      ...
                                                      C_Compiler * inCompiler
                                                      COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_lstring var_routineMangledName_5268 = function_routineMangledNameFromAST (GALGAS_string::makeEmptyString (), inObject.mProperty_mExternProcedureName, inObject.mProperty_mProcFormalArgumentList, inCompiler COMMA_SOURCE_FILE ("declaration-extern-proc.galgas", 125)) ;
  GALGAS_unifiedSymbolMapEx var_variableMap_5546 ;
  GALGAS_universalPropertyAndRoutineMapForContext var_universalMap_5606 ;
  {
  routine_initialVariableMap (constinArgument_inContext, inObject.mProperty_mMode, GALGAS_bool (false), GALGAS_string::makeEmptyString ().getter_nowhere (SOURCE_FILE ("declaration-extern-proc.galgas", 135)), var_variableMap_5546, var_universalMap_5606, inCompiler  COMMA_SOURCE_FILE ("declaration-extern-proc.galgas", 131)) ;
  }
  GALGAS_routineFormalArgumentListForGeneration var_formalArguments_5698 = GALGAS_routineFormalArgumentListForGeneration::constructor_emptyList (SOURCE_FILE ("declaration-extern-proc.galgas", 140)) ;
  {
  routine_enterFormalArguments (constinArgument_inContext, inObject.mProperty_mProcFormalArgumentList, var_variableMap_5546, var_universalMap_5606, var_formalArguments_5698, inCompiler  COMMA_SOURCE_FILE ("declaration-extern-proc.galgas", 141)) ;
  }
  const enumGalgasBool test_0 = ioArgument_ioTemporaries.getter_mSubprogramInvocationGraph (HERE).getter_isNodeDefined (var_routineMangledName_5268.getter_string (HERE) COMMA_SOURCE_FILE ("declaration-extern-proc.galgas", 151)).operator_not (SOURCE_FILE ("declaration-extern-proc.galgas", 151)).boolEnum () ;
  if (kBoolTrue == test_0) {
    {
    ioArgument_ioTemporaries.mProperty_mSubprogramInvocationGraph.setter_addNode (var_routineMangledName_5268, var_routineMangledName_5268, inCompiler COMMA_SOURCE_FILE ("declaration-extern-proc.galgas", 152)) ;
    }
  }
  ...
  if (kBoolTrue == test_2) {
    ...
    temp_1 = GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inContext.getter_mTypeMap (HERE), inObject.mProperty_mReturnTypeName, inCompiler  COMMA_SOURCE_FILE ("declaration-extern-proc.galgas", 161)) ;
  }
  GALGAS_unifiedTypeMap_2D_proxy var_returnType_6177 = temp_1 ;
  {
  ioArgument_ioIntermediateCodeStruct.mProperty_mExternProcedureMapIR.setter_insertKey (inObject.mProperty_mRoutineNameForGeneration, var_formalArguments_5698, var_returnType_6177, inCompiler COMMA_SOURCE_FILE ("declaration-extern-proc.galgas", 164)) ;
  }
}
...
void extensionMethod_enterAccessibleEntities (const GALGAS_interruptMapIR inObject,
  ...
  cEnumerator_interruptMapIR enumerator_6055 (temp_0, kENUMERATION_UP) ;
  while (enumerator_6055.hasCurrentObject ()) {
    extensionMethod_enterAccessibleEntities (enumerator_6055.current (HERE).getter_mInstructionGenerationList (HERE), ioArgument_ioAccessibleEntities, ioArgument_ioMaxBranchOfOnInstructions, inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 157)) ;
...
void extensionMethod_enterAccessibleEntities (const GALGAS_guardMapIR_2D_element inObject,
  ...
  case GALGAS_guardKindGenerationIR::kEnum_convenienceGuard:
    {
      const cEnumAssociatedValues_guardKindGenerationIR_convenienceGuard * extractPtr_23589 = (const cEnumAssociatedValues_guardKindGenerationIR_convenienceGuard *) (inObject.mProperty_mGuardKindGenerationIR.unsafePointer ()) ;
      const GALGAS_instructionListIR extractedValue_baseGuardInstructionGenerationList = extractPtr_23589->mAssociatedValue1 ;
      const GALGAS_string extractedValue_baseGuardMangledName = extractPtr_23589->mAssociatedValue2 ;
