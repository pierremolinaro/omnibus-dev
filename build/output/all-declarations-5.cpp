...
void GGS_panicSortedListIR::plusPlusAssignOperation (const GGS_panicSortedListIR_2E_element & inValue
                                                     COMMA_LOCATION_ARGS) {
...
void GGS_panicSortedListIR::plusAssignOperation (const GGS_panicSortedListIR inOperand,
                                                 Compiler * /* inCompiler */
                                                 COMMA_UNUSED_LOCATION_ARGS) {
  if (isValid ()) {
...
void GGS_llvmGenerationInstructionList::plusAssignOperation (const GGS_llvmGenerationInstructionList inOperand,
                                                             Compiler * /* inCompiler */
                                                             COMMA_UNUSED_LOCATION_ARGS) {
...
void GGS_primaryInExpressionAccessListAST::plusAssignOperation (const GGS_primaryInExpressionAccessListAST inOperand,
                                                                Compiler * /* inCompiler */
                                                                COMMA_UNUSED_LOCATION_ARGS) {
  appendList (inOperand) ;
}
...
void GGS_integerSliceFieldListAST::plusAssignOperation (const GGS_integerSliceFieldListAST inOperand,
                                                        Compiler * /* inCompiler */
                                                        COMMA_UNUSED_LOCATION_ARGS) {
  appendList (inOperand) ;
}
...
void GGS_registerIntegerFieldListAST::plusAssignOperation (const GGS_registerIntegerFieldListAST inOperand,
                                                           Compiler * /* inCompiler */
                                                           COMMA_UNUSED_LOCATION_ARGS) {
  appendList (inOperand) ;
}
...
void GGS_functionCallEffectiveParameterListAST::plusAssignOperation (const GGS_functionCallEffectiveParameterListAST inOperand,
                                                                     Compiler * /* inCompiler */
                                                                     COMMA_UNUSED_LOCATION_ARGS) {
  appendList (inOperand) ;
}
...
void GGS_genericFormalParameterList::plusAssignOperation (const GGS_genericFormalParameterList inOperand,
                                                          Compiler * /* inCompiler */
                                                          COMMA_UNUSED_LOCATION_ARGS) {
  appendList (inOperand) ;
}
...
void GGS_sliceAssignmentListAST::plusAssignOperation (const GGS_sliceAssignmentListAST inOperand,
                                                      Compiler * /* inCompiler */
                                                      COMMA_UNUSED_LOCATION_ARGS) {
  appendList (inOperand) ;
}
