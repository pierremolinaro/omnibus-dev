...
void extensionMethod_noteInstructionTypesInPrecedenceGraph (const GALGAS_assignmentTargetAST inObject,
                                                            ...
                                                            C_Compiler * inCompiler
                                                            COMMA_UNUSED_LOCATION_ARGS) {
  cEnumerator_accessInAssignmentListAST enumerator_3107 (inObject.mProperty_mAccessList, kENUMERATION_UP) ;
...
void extensionMethod_analyzeAssignmentTarget (const GALGAS_assignmentTargetAST inObject,
  ...
  case GALGAS_assignmentSelfAccessAST::kEnum_noSelfAccess:
    {
      ...
      if (kBoolTrue == test_0) {
        ...
        case GALGAS_targetAccessKind::kEnum_read:
          {
            {
            GALGAS_unifiedTypeMap_2D_proxy joker_4919_2 ; // Joker input parameter
            GALGAS_bool joker_4919_1 ; // Joker input parameter
            GALGAS_bool joker_4950_2 ; // Joker input parameter
            GALGAS_bool joker_4950_1 ; // Joker input parameter
            ioArgument_ioVariableMap.setter_searchForReadAccess (inObject.mProperty_mIdentifier, joker_4919_2, joker_4919_1, outArgument_outCurrentObject, joker_4950_2, joker_4950_1, inCompiler COMMA_SOURCE_FILE ("assignment-target.galgas", 121)) ;
            }
          }
          break ;
        case GALGAS_targetAccessKind::kEnum_write:
          {
            {
            GALGAS_unifiedTypeMap_2D_proxy joker_5038_2 ; // Joker input parameter
            GALGAS_bool joker_5038_1 ; // Joker input parameter
            GALGAS_bool joker_5069_2 ; // Joker input parameter
            GALGAS_bool joker_5069_1 ; // Joker input parameter
            ioArgument_ioVariableMap.setter_searchForWriteAccess (inObject.mProperty_mIdentifier, joker_5038_2, joker_5038_1, outArgument_outCurrentObject, joker_5069_2, joker_5069_1, inCompiler COMMA_SOURCE_FILE ("assignment-target.galgas", 123)) ;
            }
          }
          break ;
        case GALGAS_targetAccessKind::kEnum_readWrite:
          {
            {
            GALGAS_unifiedTypeMap_2D_proxy joker_5165_2 ; // Joker input parameter
            GALGAS_bool joker_5165_1 ; // Joker input parameter
            GALGAS_bool joker_5196_2 ; // Joker input parameter
            GALGAS_bool joker_5196_1 ; // Joker input parameter
            ioArgument_ioVariableMap.setter_searchForReadWriteAccess (inObject.mProperty_mIdentifier, joker_5165_2, joker_5165_1, outArgument_outCurrentObject, joker_5196_2, joker_5196_1, inCompiler COMMA_SOURCE_FILE ("assignment-target.galgas", 125)) ;
            }
          }
          break ;
        }
  ...
  case GALGAS_assignmentSelfAccessAST::kEnum_selfAccess:
    {
      const cEnumAssociatedValues_assignmentSelfAccessAST_selfAccess * extractPtr_6525 = (const cEnumAssociatedValues_assignmentSelfAccessAST_selfAccess *) (inObject.mProperty_mSelfAccess.unsafePointer ()) ;
      const GALGAS_location extractedValue_selfLocation = extractPtr_6525->mAssociatedValue0 ;
      outArgument_outGlobalVariableReceiverName = GALGAS_string::makeEmptyString () ;
      ...
      if (kBoolTrue == test_3) {
        ...
        if (kBoolTrue == test_5) {
          GALGAS_propertyMap var_structureObjectMap_5876 ;
          GALGAS_lstring joker_5839 ; // Joker input parameter
          GALGAS_propertyList joker_5878_2 ; // Joker input parameter
          GALGAS_uint joker_5878_1 ; // Joker input parameter
          constinArgument_inSelfType.getter_kind (inCompiler COMMA_SOURCE_FILE ("assignment-target.galgas", 137)).method_structure (joker_5839, var_structureObjectMap_5876, joker_5878_2, joker_5878_1, inCompiler COMMA_SOURCE_FILE ("assignment-target.galgas", 137)) ;
          const enumGalgasBool test_6 = var_structureObjectMap_5876.getter_hasKey (inObject.mProperty_mIdentifier.getter_string (SOURCE_FILE ("assignment-target.galgas", 138)) COMMA_SOURCE_FILE ("assignment-target.galgas", 138)).boolEnum () ;
          if (kBoolTrue == test_6) {
            GALGAS_objectIR var_object_6032 ;
            GALGAS_bool joker_6009 ; // Joker input parameter
            GALGAS_uint joker_6044 ; // Joker input parameter
            var_structureObjectMap_5876.method_searchKey (inObject.mProperty_mIdentifier, joker_6009, var_object_6032, joker_6044, inCompiler COMMA_SOURCE_FILE ("assignment-target.galgas", 139)) ;
            {
            routine_handleSelfAccessInAssignment (constinArgument_inSelfType, var_object_6032, ioArgument_ioTemporaries, ioArgument_ioInstructionGenerationList, outArgument_outCurrentObject, inCompiler  COMMA_SOURCE_FILE ("assignment-target.galgas", 145)) ;
            }
  ...
  cEnumerator_accessInAssignmentListAST enumerator_6597 (inObject.mProperty_mAccessList, kENUMERATION_UP) ;
  while (enumerator_6597.hasCurrentObject ()) {
    switch (enumerator_6597.current_mAccess (HERE).enumValue ()) {
    case GALGAS_accessInAssignmentAST::kNotBuilt:
      break ;
    case GALGAS_accessInAssignmentAST::kEnum_property:
      {
        const cEnumAssociatedValues_accessInAssignmentAST_property * extractPtr_6813 = (const cEnumAssociatedValues_accessInAssignmentAST_property *) (enumerator_6597.current_mAccess (HERE).unsafePointer ()) ;
        const GALGAS_lstring extractedValue_propertyName = extractPtr_6813->mAssociatedValue0 ;
        {
    ...
    case GALGAS_accessInAssignmentAST::kEnum_arrayAccess:
      {
        const cEnumAssociatedValues_accessInAssignmentAST_arrayAccess * extractPtr_7441 = (const cEnumAssociatedValues_accessInAssignmentAST_arrayAccess *) (enumerator_6597.current_mAccess (HERE).unsafePointer ()) ;
        const GALGAS_expressionAST extractedValue_indexExpression = extractPtr_7441->mAssociatedValue0 ;
        const GALGAS_location extractedValue_endOfExpression = extractPtr_7441->mAssociatedValue1 ;
        {
...
bool GALGAS_routineDescriptor::isValid (void) const {
  return mProperty_mIsPublic.isValid () && mProperty_mGlobal.isValid () && mProperty_mRoutineKind.isValid () && mProperty_mMode.isValid () && mProperty_mSignature.isValid () && mProperty_mReturnType.isValid () && mProperty_mCanAccessProperties.isValid () && mProperty_mCanMutateProperties.isValid () ;
}
...
GALGAS_bool GALGAS_routineDescriptor::getter_mGlobal (UNUSED_LOCATION_ARGS) const {
...
GALGAS_procedureSignature GALGAS_routineDescriptor::getter_mSignature (UNUSED_LOCATION_ARGS) const {
...
GALGAS_bool extensionGetter_equatable (const GALGAS_unifiedTypeMap_2D_proxy & inObject,
  ...
  result_result = extensionGetter_equatable (temp_0.getter_kind (inCompiler COMMA_SOURCE_FILE ("types.galgas", 36)), inCompiler COMMA_SOURCE_FILE ("types.galgas", 36)) ;
//---
...
GALGAS_bool extensionGetter_equatable (const GALGAS_typeKind & inObject,
  ...
  case GALGAS_typeKind::kEnum_structure:
    {
      const cEnumAssociatedValues_typeKind_structure * extractPtr_2198 = (const cEnumAssociatedValues_typeKind_structure *) (temp_0.unsafePointer ()) ;
      const GALGAS_uint extractedValue_flags = extractPtr_2198->mAssociatedValue3 ;
      result_result = GALGAS_bool (kIsNotEqual, extractedValue_flags.operator_and (function_equatableFlag (inCompiler COMMA_SOURCE_FILE ("types.galgas", 50)) COMMA_SOURCE_FILE ("types.galgas", 50)).objectCompare (GALGAS_uint ((uint32_t) 0U))) ;
    }
    break ;
  ...
  case GALGAS_typeKind::kEnum_opaque:
    {
      const cEnumAssociatedValues_typeKind_opaque * extractPtr_2320 = (const cEnumAssociatedValues_typeKind_opaque *) (temp_0.unsafePointer ()) ;
      const GALGAS_uint extractedValue_flags = extractPtr_2320->mAssociatedValue1 ;
      result_result = GALGAS_bool (kIsNotEqual, extractedValue_flags.operator_and (function_equatableFlag (inCompiler COMMA_SOURCE_FILE ("types.galgas", 54)) COMMA_SOURCE_FILE ("types.galgas", 54)).objectCompare (GALGAS_uint ((uint32_t) 0U))) ;
    }
    break ;
  case GALGAS_typeKind::kEnum_arrayType:
    {
      const cEnumAssociatedValues_typeKind_arrayType * extractPtr_2406 = (const cEnumAssociatedValues_typeKind_arrayType *) (temp_0.unsafePointer ()) ;
      const GALGAS_uint extractedValue_flags = extractPtr_2406->mAssociatedValue4 ;
      result_result = GALGAS_bool (kIsNotEqual, extractedValue_flags.operator_and (function_equatableFlag (inCompiler COMMA_SOURCE_FILE ("types.galgas", 56)) COMMA_SOURCE_FILE ("types.galgas", 56)).objectCompare (GALGAS_uint ((uint32_t) 0U))) ;
    }
    break ;
...
GALGAS_bool extensionGetter_instanciable (const GALGAS_unifiedTypeMap_2D_proxy & inObject,
  ...
  GALGAS_bool result_result ; // Returned variable
  const GALGAS_unifiedTypeMap_2D_proxy temp_0 = inObject ;
  result_result = extensionGetter_instanciable (temp_0.getter_kind (inCompiler COMMA_SOURCE_FILE ("types.galgas", 65)), inCompiler COMMA_SOURCE_FILE ("types.galgas", 65)) ;
//---
  return result_result ;
}
...
GALGAS_bool extensionGetter_instanciable (const GALGAS_typeKind & inObject,
  ...
  case GALGAS_typeKind::kEnum_structure:
    {
      const cEnumAssociatedValues_typeKind_structure * extractPtr_3074 = (const cEnumAssociatedValues_typeKind_structure *) (temp_0.unsafePointer ()) ;
      const GALGAS_uint extractedValue_flags = extractPtr_3074->mAssociatedValue3 ;
      result_result = GALGAS_bool (kIsNotEqual, extractedValue_flags.operator_and (function_instanciableFlag (inCompiler COMMA_SOURCE_FILE ("types.galgas", 79)) COMMA_SOURCE_FILE ("types.galgas", 79)).objectCompare (GALGAS_uint ((uint32_t) 0U))) ;
    }
    break ;
  case GALGAS_typeKind::kEnum_integer:
    {
  ...
  case GALGAS_typeKind::kEnum_opaque:
    {
      const cEnumAssociatedValues_typeKind_opaque * extractPtr_3199 = (const cEnumAssociatedValues_typeKind_opaque *) (temp_0.unsafePointer ()) ;
      const GALGAS_uint extractedValue_flags = extractPtr_3199->mAssociatedValue1 ;
      result_result = GALGAS_bool (kIsNotEqual, extractedValue_flags.operator_and (function_instanciableFlag (inCompiler COMMA_SOURCE_FILE ("types.galgas", 83)) COMMA_SOURCE_FILE ("types.galgas", 83)).objectCompare (GALGAS_uint ((uint32_t) 0U))) ;
    }
    break ;
  case GALGAS_typeKind::kEnum_arrayType:
    {
      const cEnumAssociatedValues_typeKind_arrayType * extractPtr_3288 = (const cEnumAssociatedValues_typeKind_arrayType *) (temp_0.unsafePointer ()) ;
      const GALGAS_uint extractedValue_flags = extractPtr_3288->mAssociatedValue4 ;
      result_result = GALGAS_bool (kIsNotEqual, extractedValue_flags.operator_and (function_instanciableFlag (inCompiler COMMA_SOURCE_FILE ("types.galgas", 85)) COMMA_SOURCE_FILE ("types.galgas", 85)).objectCompare (GALGAS_uint ((uint32_t) 0U))) ;
    }
    break ;
  case GALGAS_typeKind::kEnum_function:
    {
...
GALGAS_bool extensionGetter_copyable (const GALGAS_unifiedTypeMap_2D_proxy & inObject,
  ...
  GALGAS_bool result_result ; // Returned variable
  const GALGAS_unifiedTypeMap_2D_proxy temp_0 = inObject ;
  result_result = extensionGetter_copyable (temp_0.getter_kind (inCompiler COMMA_SOURCE_FILE ("types.galgas", 94)), inCompiler COMMA_SOURCE_FILE ("types.galgas", 94)) ;
//---
  return result_result ;
}
...
GALGAS_bool extensionGetter_copyable (const GALGAS_typeKind & inObject,
  ...
  case GALGAS_typeKind::kEnum_structure:
    {
      const cEnumAssociatedValues_typeKind_structure * extractPtr_3940 = (const cEnumAssociatedValues_typeKind_structure *) (temp_0.unsafePointer ()) ;
      const GALGAS_uint extractedValue_flags = extractPtr_3940->mAssociatedValue3 ;
      result_result = GALGAS_bool (kIsNotEqual, extractedValue_flags.operator_and (function_copyableFlag (inCompiler COMMA_SOURCE_FILE ("types.galgas", 108)) COMMA_SOURCE_FILE ("types.galgas", 108)).objectCompare (GALGAS_uint ((uint32_t) 0U))) ;
    }
    break ;
  case GALGAS_typeKind::kEnum_integer:
    {
  ...
  case GALGAS_typeKind::kEnum_opaque:
    {
      const cEnumAssociatedValues_typeKind_opaque * extractPtr_4061 = (const cEnumAssociatedValues_typeKind_opaque *) (temp_0.unsafePointer ()) ;
      const GALGAS_uint extractedValue_flags = extractPtr_4061->mAssociatedValue1 ;
      result_result = GALGAS_bool (kIsNotEqual, extractedValue_flags.operator_and (function_copyableFlag (inCompiler COMMA_SOURCE_FILE ("types.galgas", 112)) COMMA_SOURCE_FILE ("types.galgas", 112)).objectCompare (GALGAS_uint ((uint32_t) 0U))) ;
    }
    break ;
  case GALGAS_typeKind::kEnum_arrayType:
    {
      const cEnumAssociatedValues_typeKind_arrayType * extractPtr_4146 = (const cEnumAssociatedValues_typeKind_arrayType *) (temp_0.unsafePointer ()) ;
      const GALGAS_uint extractedValue_flags = extractPtr_4146->mAssociatedValue4 ;
      result_result = GALGAS_bool (kIsNotEqual, extractedValue_flags.operator_and (function_copyableFlag (inCompiler COMMA_SOURCE_FILE ("types.galgas", 114)) COMMA_SOURCE_FILE ("types.galgas", 114)).objectCompare (GALGAS_uint ((uint32_t) 0U))) ;
    }
    break ;
  case GALGAS_typeKind::kEnum_function:
    {
...
GALGAS_classConstantMap extensionGetter_classConstantMap (const GALGAS_unifiedTypeMap_2D_proxy & inObject,
  ...
  const GALGAS_unifiedTypeMap_2D_proxy temp_0 = inObject ;
  switch (temp_0.getter_kind (inCompiler COMMA_SOURCE_FILE ("types.galgas", 123)).enumValue ()) {
  case GALGAS_typeKind::kNotBuilt:
    break ;
  case GALGAS_typeKind::kEnum_boolean:
  case GALGAS_typeKind::kEnum_literalString:
  case GALGAS_typeKind::kEnum_staticInteger:
    {
      result_result = GALGAS_classConstantMap::constructor_emptyMap (SOURCE_FILE ("types.galgas", 125)) ;
    }
    break ;
  case GALGAS_typeKind::kEnum_enumeration:
    {
      const cEnumAssociatedValues_typeKind_enumeration * extractPtr_4563 = (const cEnumAssociatedValues_typeKind_enumeration *) (temp_0.getter_kind (inCompiler COMMA_SOURCE_FILE ("types.galgas", 123)).unsafePointer ()) ;
      const GALGAS_classConstantMap extractedValue_classConstantMap = extractPtr_4563->mAssociatedValue1 ;
      result_result = extractedValue_classConstantMap ;
    }
    break ;
  case GALGAS_typeKind::kEnum_structure:
    {
      result_result = GALGAS_classConstantMap::constructor_emptyMap (SOURCE_FILE ("types.galgas", 129)) ;
    }
    break ;
  case GALGAS_typeKind::kEnum_integer:
    {
      result_result = GALGAS_classConstantMap::constructor_emptyMap (SOURCE_FILE ("types.galgas", 131)) ;
    }
    break ;
  case GALGAS_typeKind::kEnum_opaque:
    {
      result_result = GALGAS_classConstantMap::constructor_emptyMap (SOURCE_FILE ("types.galgas", 133)) ;
    }
    break ;
  case GALGAS_typeKind::kEnum_arrayType:
    {
      const cEnumAssociatedValues_typeKind_arrayType * extractPtr_4783 = (const cEnumAssociatedValues_typeKind_arrayType *) (temp_0.getter_kind (inCompiler COMMA_SOURCE_FILE ("types.galgas", 123)).unsafePointer ()) ;
      const GALGAS_classConstantMap extractedValue_classConstantMap = extractPtr_4783->mAssociatedValue3 ;
      result_result = extractedValue_classConstantMap ;
    }
    break ;
  case GALGAS_typeKind::kEnum_function:
    {
      result_result = GALGAS_classConstantMap::constructor_emptyMap (SOURCE_FILE ("types.galgas", 137)) ;
    }
    break ;
  }
//---
...
GALGAS_string extensionGetter_llvmTypeName (const GALGAS_typeKind & inObject,
  ...
  case GALGAS_typeKind::kEnum_enumeration:
    {
      const cEnumAssociatedValues_typeKind_enumeration * extractPtr_5207 = (const cEnumAssociatedValues_typeKind_enumeration *) (temp_0.unsafePointer ()) ;
      const GALGAS_enumConstantMap extractedValue_constantMap = extractPtr_5207->mAssociatedValue0 ;
      result_result = GALGAS_string ("i").add_operation (extractedValue_constantMap.getter_count (SOURCE_FILE ("types.galgas", 150)).substract_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("types.galgas", 150)).getter_significantBitCount (SOURCE_FILE ("types.galgas", 150)).getter_string (SOURCE_FILE ("types.galgas", 150)), inCompiler COMMA_SOURCE_FILE ("types.galgas", 150)) ;
    }
    break ;
  case GALGAS_typeKind::kEnum_structure:
    {
      const cEnumAssociatedValues_typeKind_structure * extractPtr_5344 = (const cEnumAssociatedValues_typeKind_structure *) (temp_0.unsafePointer ()) ;
      const GALGAS_lstring extractedValue_typeName = extractPtr_5344->mAssociatedValue0 ;
      result_result = GALGAS_string ("%").add_operation (function_llvmRegularTypeMangledNameFromName (extractedValue_typeName, inCompiler COMMA_SOURCE_FILE ("types.galgas", 152)).mProperty_string.getter_assemblerRepresentation (SOURCE_FILE ("types.galgas", 152)), inCompiler COMMA_SOURCE_FILE ("types.galgas", 152)) ;
    }
    break ;
  case GALGAS_typeKind::kEnum_integer:
    {
      const cEnumAssociatedValues_typeKind_integer * extractPtr_5466 = (const cEnumAssociatedValues_typeKind_integer *) (temp_0.unsafePointer ()) ;
      const GALGAS_bigint extractedValue_min = extractPtr_5466->mAssociatedValue0 ;
      const GALGAS_bigint extractedValue_max = extractPtr_5466->mAssociatedValue1 ;
      const GALGAS_bool extractedValue_unsigned = extractPtr_5466->mAssociatedValue2 ;
      const GALGAS_uint extractedValue_bitCount = extractPtr_5466->mAssociatedValue3 ;
  ...
  case GALGAS_typeKind::kEnum_staticInteger:
    {
      ...
      inCompiler->emitSemanticError (GALGAS_location::constructor_nowhere (SOURCE_FILE ("types.galgas", 156)), GALGAS_string ("INTERNAL ERROR"), fixItArray1  COMMA_SOURCE_FILE ("types.galgas", 156)) ;
      result_result.drop () ; // Release error dropped variable
    }
    break ;
  case GALGAS_typeKind::kEnum_opaque:
    {
      const cEnumAssociatedValues_typeKind_opaque * extractPtr_5601 = (const cEnumAssociatedValues_typeKind_opaque *) (temp_0.unsafePointer ()) ;
      const GALGAS_bigint extractedValue_bitCount = extractPtr_5601->mAssociatedValue0 ;
  ...
  case GALGAS_typeKind::kEnum_arrayType:
    {
      const cEnumAssociatedValues_typeKind_arrayType * extractPtr_5702 = (const cEnumAssociatedValues_typeKind_arrayType *) (temp_0.unsafePointer ()) ;
      const GALGAS_lstring extractedValue_typeName = extractPtr_5702->mAssociatedValue0 ;
      result_result = GALGAS_string ("%").add_operation (extractedValue_typeName.mProperty_string.getter_assemblerRepresentation (SOURCE_FILE ("types.galgas", 160)), inCompiler COMMA_SOURCE_FILE ("types.galgas", 160)) ;
    }
    break ;
  case GALGAS_typeKind::kEnum_function:
    {
      const cEnumAssociatedValues_typeKind_function * extractPtr_6152 = (const cEnumAssociatedValues_typeKind_function *) (temp_0.unsafePointer ()) ;
      const GALGAS_routineDescriptor extractedValue_descriptor = extractPtr_6152->mAssociatedValue0 ;
      const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, extractedValue_descriptor.mProperty_mReturnType.objectCompare (GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("types.galgas", 162)))).boolEnum () ;
      if (kBoolTrue == test_2) {
        result_result = GALGAS_string ("void") ;
      }else if (kBoolFalse == test_2) {
        result_result = extensionGetter_llvmTypeName (extractedValue_descriptor.mProperty_mReturnType.getter_kind (inCompiler COMMA_SOURCE_FILE ("types.galgas", 165)), inCompiler COMMA_SOURCE_FILE ("types.galgas", 165)) ;
      }
      result_result.plusAssign_operation(GALGAS_string ("("), inCompiler  COMMA_SOURCE_FILE ("types.galgas", 167)) ;
      cEnumerator_procedureSignature enumerator_5930 (extractedValue_descriptor.mProperty_mSignature, kENUMERATION_UP) ;
      while (enumerator_5930.hasCurrentObject ()) {
        result_result.plusAssign_operation(extensionGetter_llvmTypeName (enumerator_5930.current_mType (HERE).getter_kind (inCompiler COMMA_SOURCE_FILE ("types.galgas", 170)), inCompiler COMMA_SOURCE_FILE ("types.galgas", 170)), inCompiler  COMMA_SOURCE_FILE ("types.galgas", 170)) ;
        switch (enumerator_5930.current_mFormalArgumentPassingMode (HERE).enumValue ()) {
        ...
        if (enumerator_5930.hasNextObject ()) {
...
GALGAS_routineMapIR_2D_element::GALGAS_routineMapIR_2D_element (const GALGAS_lstring & inOperand0,
                                                                ...
                                                                const GALGAS_procFormalArgumentListForGeneration & inOperand3,
...
GALGAS_location extensionGetter_location (const GALGAS_objectIR & inObject,
  ...
  case GALGAS_objectIR::kEnum_possibleFunction:
    {
      const cEnumAssociatedValues_objectIR_possibleFunction * extractPtr_1990 = (const cEnumAssociatedValues_objectIR_possibleFunction *) (temp_0.unsafePointer ()) ;
      const GALGAS_lstring extractedValue_functionName = extractPtr_1990->mAssociatedValue1 ;
  ...
  case GALGAS_objectIR::kEnum_property:
    {
      const cEnumAssociatedValues_objectIR_property * extractPtr_2043 = (const cEnumAssociatedValues_objectIR_property *) (temp_0.unsafePointer ()) ;
      const GALGAS_lstring extractedValue_plmName = extractPtr_2043->mAssociatedValue1 ;
  ...
  case GALGAS_objectIR::kEnum_globalVariableReference:
    {
      const cEnumAssociatedValues_objectIR_globalVariableReference * extractPtr_2109 = (const cEnumAssociatedValues_objectIR_globalVariableReference *) (temp_0.unsafePointer ()) ;
      const GALGAS_lstring extractedValue_plmName = extractPtr_2109->mAssociatedValue1 ;
  ...
  case GALGAS_objectIR::kEnum_localVariableReference:
    {
      const cEnumAssociatedValues_objectIR_localVariableReference * extractPtr_2174 = (const cEnumAssociatedValues_objectIR_localVariableReference *) (temp_0.unsafePointer ()) ;
      const GALGAS_lstring extractedValue_plmName = extractPtr_2174->mAssociatedValue1 ;
  ...
  case GALGAS_objectIR::kEnum_registerReference:
    {
      const cEnumAssociatedValues_objectIR_registerReference * extractPtr_2240 = (const cEnumAssociatedValues_objectIR_registerReference *) (temp_0.unsafePointer ()) ;
      const GALGAS_lstring extractedValue_plmName = extractPtr_2240->mAssociatedValue1 ;
  ...
  case GALGAS_objectIR::kEnum_llvmTemporaryValue:
    {
      const cEnumAssociatedValues_objectIR_llvmTemporaryValue * extractPtr_2573 = (const cEnumAssociatedValues_objectIR_llvmTemporaryValue *) (temp_0.unsafePointer ()) ;
  ...
  case GALGAS_objectIR::kEnum_temporaryReference:
    {
      const cEnumAssociatedValues_objectIR_temporaryReference * extractPtr_2640 = (const cEnumAssociatedValues_objectIR_temporaryReference *) (temp_0.unsafePointer ()) ;
      const GALGAS_lstring extractedValue_llvmName = extractPtr_2640->mAssociatedValue1 ;
  ...
  case GALGAS_objectIR::kEnum_literalString:
    ...
    break ;
  case GALGAS_objectIR::kEnum_functionProperty:
    {
      const cEnumAssociatedValues_objectIR_functionProperty * extractPtr_2908 = (const cEnumAssociatedValues_objectIR_functionProperty *) (temp_0.unsafePointer ()) ;
      const GALGAS_lstring extractedValue_name = extractPtr_2908->mAssociatedValue1 ;
      result_result = extractedValue_name.getter_location (SOURCE_FILE ("intermediate-value-representation.galgas", 65)) ;
    }
    break ;
  }
//---
...
GALGAS_string extensionGetter_llvmName (const GALGAS_objectIR & inObject,
  ...
  case GALGAS_objectIR::kEnum_globalVariableReference:
    {
      const cEnumAssociatedValues_objectIR_globalVariableReference * extractPtr_3672 = (const cEnumAssociatedValues_objectIR_globalVariableReference *) (temp_0.unsafePointer ()) ;
      const GALGAS_lstring extractedValue_plmName = extractPtr_3672->mAssociatedValue1 ;
  ...
  case GALGAS_objectIR::kEnum_localVariableReference:
    {
      const cEnumAssociatedValues_objectIR_localVariableReference * extractPtr_3767 = (const cEnumAssociatedValues_objectIR_localVariableReference *) (temp_0.unsafePointer ()) ;
      const GALGAS_lstring extractedValue_plmName = extractPtr_3767->mAssociatedValue1 ;
  ...
  case GALGAS_objectIR::kEnum_literalInteger:
    {
      const cEnumAssociatedValues_objectIR_literalInteger * extractPtr_4014 = (const cEnumAssociatedValues_objectIR_literalInteger *) (temp_0.unsafePointer ()) ;
      const GALGAS_bigint extractedValue_value = extractPtr_4014->mAssociatedValue1 ;
      result_result = extractedValue_value.getter_string (SOURCE_FILE ("intermediate-value-representation.galgas", 88)) ;
    }
    break ;
  case GALGAS_objectIR::kEnum_llvmTemporaryValue:
    {
      const cEnumAssociatedValues_objectIR_llvmTemporaryValue * extractPtr_4081 = (const cEnumAssociatedValues_objectIR_llvmTemporaryValue *) (temp_0.unsafePointer ()) ;
      const GALGAS_lstring extractedValue_llvmName = extractPtr_4081->mAssociatedValue1 ;
  ...
  case GALGAS_objectIR::kEnum_temporaryReference:
    {
      const cEnumAssociatedValues_objectIR_temporaryReference * extractPtr_4150 = (const cEnumAssociatedValues_objectIR_temporaryReference *) (temp_0.unsafePointer ()) ;
      const GALGAS_lstring extractedValue_llvmName = extractPtr_4150->mAssociatedValue1 ;
  ...
  case GALGAS_objectIR::kEnum_llvmStructureConstant:
    {
      const cEnumAssociatedValues_objectIR_llvmStructureConstant * extractPtr_4375 = (const cEnumAssociatedValues_objectIR_llvmStructureConstant *) (temp_0.unsafePointer ()) ;
      const GALGAS_operandIRList extractedValue_inValues = extractPtr_4375->mAssociatedValue1 ;
      result_result = GALGAS_string ("{") ;
      cEnumerator_operandIRList enumerator_4249 (extractedValue_inValues, kENUMERATION_UP) ;
      while (enumerator_4249.hasCurrentObject ()) {
        result_result.plusAssign_operation(extensionGetter_llvmTypeName (enumerator_4249.current_mOperand (HERE), inCompiler COMMA_SOURCE_FILE ("intermediate-value-representation.galgas", 94)).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("intermediate-value-representation.galgas", 94)).add_operation (extensionGetter_llvmName (enumerator_4249.current_mOperand (HERE), inCompiler COMMA_SOURCE_FILE ("intermediate-value-representation.galgas", 94)), inCompiler COMMA_SOURCE_FILE ("intermediate-value-representation.galgas", 94)), inCompiler  COMMA_SOURCE_FILE ("intermediate-value-representation.galgas", 94)) ;
        if (enumerator_4249.hasNextObject ()) {
  ...
  case GALGAS_objectIR::kEnum_literalString:
    {
      const cEnumAssociatedValues_objectIR_literalString * extractPtr_4615 = (const cEnumAssociatedValues_objectIR_literalString *) (temp_0.unsafePointer ()) ;
      const GALGAS_uint extractedValue_size = extractPtr_4615->mAssociatedValue1 ;
      const GALGAS_uint extractedValue_index = extractPtr_4615->mAssociatedValue2 ;
      GALGAS_string var_sizeStr_4442 = extractedValue_size.getter_string (SOURCE_FILE ("intermediate-value-representation.galgas", 99)) ;
      result_result = GALGAS_string ("getelementptr inbounds ([").add_operation (var_sizeStr_4442, inCompiler COMMA_SOURCE_FILE ("intermediate-value-representation.galgas", 100)).add_operation (GALGAS_string (" x i8], ["), inCompiler COMMA_SOURCE_FILE ("intermediate-value-representation.galgas", 100)).add_operation (var_sizeStr_4442, inCompiler COMMA_SOURCE_FILE ("intermediate-value-representation.galgas", 100)).add_operation (GALGAS_string (" x i8]* "), inCompiler COMMA_SOURCE_FILE ("intermediate-value-representation.galgas", 100)) ;
...
GALGAS_sliceMap extensionGetter_sliceMap (const GALGAS_objectIR & inObject,
  ...
  case GALGAS_objectIR::kEnum_registerReference:
    {
      const cEnumAssociatedValues_objectIR_registerReference * extractPtr_5468 = (const cEnumAssociatedValues_objectIR_registerReference *) (temp_0.unsafePointer ()) ;
      const GALGAS_sliceMap extractedValue_sliceMap = extractPtr_5468->mAssociatedValue5 ;
  ...
  case GALGAS_objectIR::kEnum_llvmTemporaryValue:
    {
      const cEnumAssociatedValues_objectIR_llvmTemporaryValue * extractPtr_5775 = (const cEnumAssociatedValues_objectIR_llvmTemporaryValue *) (temp_0.unsafePointer ()) ;
      const GALGAS_sliceMap extractedValue_sliceMap = extractPtr_5775->mAssociatedValue2 ;
      result_result = extractedValue_sliceMap ;
    }
    break ;
  case GALGAS_objectIR::kEnum_temporaryReference:
    {
      const cEnumAssociatedValues_objectIR_temporaryReference * extractPtr_5838 = (const cEnumAssociatedValues_objectIR_temporaryReference *) (temp_0.unsafePointer ()) ;
      const GALGAS_sliceMap extractedValue_sliceMap = extractPtr_5838->mAssociatedValue2 ;
      result_result = extractedValue_sliceMap ;
    }
    break ;
  case GALGAS_objectIR::kEnum_llvmStructureConstant:
...
GALGAS_unifiedTypeMap_2D_proxy extensionGetter_type (const GALGAS_objectIR & inObject,
  ...
  case GALGAS_objectIR::kEnum_temporaryReference:
    {
      const cEnumAssociatedValues_objectIR_temporaryReference * extractPtr_6519 = (const cEnumAssociatedValues_objectIR_temporaryReference *) (temp_0.unsafePointer ()) ;
  ...
  case GALGAS_objectIR::kEnum_property:
    {
      const cEnumAssociatedValues_objectIR_property * extractPtr_6561 = (const cEnumAssociatedValues_objectIR_property *) (temp_0.unsafePointer ()) ;
      const GALGAS_unifiedTypeMap_2D_proxy extractedValue_type = extractPtr_6561->mAssociatedValue0 ;
      result_result = extractedValue_type ;
    }
    break ;
  case GALGAS_objectIR::kEnum_registerReference:
    {
      const cEnumAssociatedValues_objectIR_registerReference * extractPtr_6617 = (const cEnumAssociatedValues_objectIR_registerReference *) (temp_0.unsafePointer ()) ;
      const GALGAS_unifiedTypeMap_2D_proxy extractedValue_type = extractPtr_6617->mAssociatedValue0 ;
      result_result = extractedValue_type ;
    }
    break ;
  case GALGAS_objectIR::kEnum_globalVariableReference:
    {
      const cEnumAssociatedValues_objectIR_globalVariableReference * extractPtr_6673 = (const cEnumAssociatedValues_objectIR_globalVariableReference *) (temp_0.unsafePointer ()) ;
  ...
  case GALGAS_objectIR::kEnum_localVariableReference:
    {
      const cEnumAssociatedValues_objectIR_localVariableReference * extractPtr_6728 = (const cEnumAssociatedValues_objectIR_localVariableReference *) (temp_0.unsafePointer ()) ;
      const GALGAS_unifiedTypeMap_2D_proxy extractedValue_type = extractPtr_6728->mAssociatedValue0 ;
      result_result = extractedValue_type ;
    }
    break ;
  case GALGAS_objectIR::kEnum_zero:
    {
      const cEnumAssociatedValues_objectIR_zero * extractPtr_6763 = (const cEnumAssociatedValues_objectIR_zero *) (temp_0.unsafePointer ()) ;
      const GALGAS_unifiedTypeMap_2D_proxy extractedValue_type = extractPtr_6763->mAssociatedValue0 ;
      result_result = extractedValue_type ;
    }
    break ;
  case GALGAS_objectIR::kEnum_selfObject:
    {
      const cEnumAssociatedValues_objectIR_selfObject * extractPtr_6804 = (const cEnumAssociatedValues_objectIR_selfObject *) (temp_0.unsafePointer ()) ;
      const GALGAS_unifiedTypeMap_2D_proxy extractedValue_type = extractPtr_6804->mAssociatedValue0 ;
      result_result = extractedValue_type ;
    }
    break ;
  case GALGAS_objectIR::kEnum_literalInteger:
    {
      const cEnumAssociatedValues_objectIR_literalInteger * extractPtr_6851 = (const cEnumAssociatedValues_objectIR_literalInteger *) (temp_0.unsafePointer ()) ;
      const GALGAS_unifiedTypeMap_2D_proxy extractedValue_type = extractPtr_6851->mAssociatedValue0 ;
      result_result = extractedValue_type ;
    }
    break ;
  case GALGAS_objectIR::kEnum_llvmTemporaryValue:
    {
      const cEnumAssociatedValues_objectIR_llvmTemporaryValue * extractPtr_6904 = (const cEnumAssociatedValues_objectIR_llvmTemporaryValue *) (temp_0.unsafePointer ()) ;
      const GALGAS_unifiedTypeMap_2D_proxy extractedValue_type = extractPtr_6904->mAssociatedValue0 ;
      result_result = extractedValue_type ;
    }
    break ;
  case GALGAS_objectIR::kEnum_llvmStructureConstant:
    {
      const cEnumAssociatedValues_objectIR_llvmStructureConstant * extractPtr_6958 = (const cEnumAssociatedValues_objectIR_llvmStructureConstant *) (temp_0.unsafePointer ()) ;
      const GALGAS_unifiedTypeMap_2D_proxy extractedValue_type = extractPtr_6958->mAssociatedValue0 ;
      result_result = extractedValue_type ;
    }
    break ;
  case GALGAS_objectIR::kEnum_literalString:
    {
      const cEnumAssociatedValues_objectIR_literalString * extractPtr_7007 = (const cEnumAssociatedValues_objectIR_literalString *) (temp_0.unsafePointer ()) ;
      const GALGAS_unifiedTypeMap_2D_proxy extractedValue_type = extractPtr_7007->mAssociatedValue0 ;
      result_result = extractedValue_type ;
    }
    break ;
  case GALGAS_objectIR::kEnum_functionProperty:
...
GALGAS_objectIR extensionGetter_withType (const GALGAS_objectIR & inObject,
  ...
  case GALGAS_objectIR::kEnum_temporaryReference:
    {
      const cEnumAssociatedValues_objectIR_temporaryReference * extractPtr_8278 = (const cEnumAssociatedValues_objectIR_temporaryReference *) (temp_0.unsafePointer ()) ;
      const GALGAS_lstring extractedValue_llvmName = extractPtr_8278->mAssociatedValue1 ;
      const GALGAS_sliceMap extractedValue_sliceMap = extractPtr_8278->mAssociatedValue2 ;
      const GALGAS_bool extractedValue_volatile = extractPtr_8278->mAssociatedValue3 ;
  ...
  case GALGAS_objectIR::kEnum_property:
    {
      const cEnumAssociatedValues_objectIR_property * extractPtr_8382 = (const cEnumAssociatedValues_objectIR_property *) (temp_0.unsafePointer ()) ;
      const GALGAS_lstring extractedValue_plmName = extractPtr_8382->mAssociatedValue1 ;
      const GALGAS_uint extractedValue_index = extractPtr_8382->mAssociatedValue2 ;
  ...
  case GALGAS_objectIR::kEnum_registerReference:
    {
      const cEnumAssociatedValues_objectIR_registerReference * extractPtr_8724 = (const cEnumAssociatedValues_objectIR_registerReference *) (temp_0.unsafePointer ()) ;
      const GALGAS_lstring extractedValue_plmName = extractPtr_8724->mAssociatedValue1 ;
      const GALGAS_bool extractedValue_readable = extractPtr_8724->mAssociatedValue2 ;
      const GALGAS_bool extractedValue_writable = extractPtr_8724->mAssociatedValue3 ;
      const GALGAS_bigint extractedValue_address = extractPtr_8724->mAssociatedValue4 ;
      const GALGAS_sliceMap extractedValue_sliceMap = extractPtr_8724->mAssociatedValue5 ;
      const GALGAS_uint extractedValue_arraySize = extractPtr_8724->mAssociatedValue6 ;
      const GALGAS_uint extractedValue_elementSize = extractPtr_8724->mAssociatedValue7 ;
  ...
  case GALGAS_objectIR::kEnum_localVariableReference:
    {
      const cEnumAssociatedValues_objectIR_localVariableReference * extractPtr_8833 = (const cEnumAssociatedValues_objectIR_localVariableReference *) (temp_0.unsafePointer ()) ;
      const GALGAS_lstring extractedValue_name = extractPtr_8833->mAssociatedValue1 ;
  ...
  case GALGAS_objectIR::kEnum_globalVariableReference:
    {
      const cEnumAssociatedValues_objectIR_globalVariableReference * extractPtr_8944 = (const cEnumAssociatedValues_objectIR_globalVariableReference *) (temp_0.unsafePointer ()) ;
      const GALGAS_lstring extractedValue_name = extractPtr_8944->mAssociatedValue1 ;
  ...
  case GALGAS_objectIR::kEnum_literalInteger:
    {
      const cEnumAssociatedValues_objectIR_literalInteger * extractPtr_9045 = (const cEnumAssociatedValues_objectIR_literalInteger *) (temp_0.unsafePointer ()) ;
      const GALGAS_bigint extractedValue_value = extractPtr_9045->mAssociatedValue1 ;
  ...
  case GALGAS_objectIR::kEnum_llvmTemporaryValue:
    {
      const cEnumAssociatedValues_objectIR_llvmTemporaryValue * extractPtr_9183 = (const cEnumAssociatedValues_objectIR_llvmTemporaryValue *) (temp_0.unsafePointer ()) ;
      const GALGAS_lstring extractedValue_llvmName = extractPtr_9183->mAssociatedValue1 ;
      const GALGAS_sliceMap extractedValue_sliceMap = extractPtr_9183->mAssociatedValue2 ;
  ...
  case GALGAS_objectIR::kEnum_llvmStructureConstant:
    {
      const cEnumAssociatedValues_objectIR_llvmStructureConstant * extractPtr_9426 = (const cEnumAssociatedValues_objectIR_llvmStructureConstant *) (temp_0.unsafePointer ()) ;
      const GALGAS_operandIRList extractedValue_values = extractPtr_9426->mAssociatedValue1 ;
  ...
  case GALGAS_objectIR::kEnum_literalString:
    {
      const cEnumAssociatedValues_objectIR_literalString * extractPtr_9547 = (const cEnumAssociatedValues_objectIR_literalString *) (temp_0.unsafePointer ()) ;
      const GALGAS_uint extractedValue_size = extractPtr_9547->mAssociatedValue1 ;
      const GALGAS_uint extractedValue_index = extractPtr_9547->mAssociatedValue2 ;
...
GALGAS_string extensionGetter_name (const GALGAS_objectIR & inObject,
  ...
  case GALGAS_objectIR::kEnum_temporaryReference:
    {
      const cEnumAssociatedValues_objectIR_temporaryReference * extractPtr_10014 = (const cEnumAssociatedValues_objectIR_temporaryReference *) (temp_0.unsafePointer ()) ;
      const GALGAS_lstring extractedValue_llvmName = extractPtr_10014->mAssociatedValue1 ;
      result_result = extractedValue_llvmName.getter_string (SOURCE_FILE ("intermediate-value-representation.galgas", 219)) ;
    }
    break ;
  case GALGAS_objectIR::kEnum_property:
    {
      const cEnumAssociatedValues_objectIR_property * extractPtr_10057 = (const cEnumAssociatedValues_objectIR_property *) (temp_0.unsafePointer ()) ;
      const GALGAS_lstring extractedValue_name = extractPtr_10057->mAssociatedValue1 ;
      result_result = extractedValue_name.getter_string (SOURCE_FILE ("intermediate-value-representation.galgas", 220)) ;
    }
    break ;
  case GALGAS_objectIR::kEnum_registerReference:
    {
      const cEnumAssociatedValues_objectIR_registerReference * extractPtr_10114 = (const cEnumAssociatedValues_objectIR_registerReference *) (temp_0.unsafePointer ()) ;
      const GALGAS_lstring extractedValue_name = extractPtr_10114->mAssociatedValue1 ;
      result_result = extractedValue_name.getter_string (SOURCE_FILE ("intermediate-value-representation.galgas", 221)) ;
    }
    break ;
  case GALGAS_objectIR::kEnum_localVariableReference:
    {
      const cEnumAssociatedValues_objectIR_localVariableReference * extractPtr_10169 = (const cEnumAssociatedValues_objectIR_localVariableReference *) (temp_0.unsafePointer ()) ;
      const GALGAS_lstring extractedValue_name = extractPtr_10169->mAssociatedValue1 ;
      result_result = extractedValue_name.getter_string (SOURCE_FILE ("intermediate-value-representation.galgas", 222)) ;
    }
    break ;
  case GALGAS_objectIR::kEnum_globalVariableReference:
    {
      const cEnumAssociatedValues_objectIR_globalVariableReference * extractPtr_10225 = (const cEnumAssociatedValues_objectIR_globalVariableReference *) (temp_0.unsafePointer ()) ;
      const GALGAS_lstring extractedValue_name = extractPtr_10225->mAssociatedValue1 ;
  ...
  case GALGAS_objectIR::kEnum_literalInteger:
    {
      const cEnumAssociatedValues_objectIR_literalInteger * extractPtr_10376 = (const cEnumAssociatedValues_objectIR_literalInteger *) (temp_0.unsafePointer ()) ;
      const GALGAS_bigint extractedValue_value = extractPtr_10376->mAssociatedValue1 ;
      result_result = extractedValue_value.getter_string (SOURCE_FILE ("intermediate-value-representation.galgas", 226)) ;
    }
    break ;
  case GALGAS_objectIR::kEnum_llvmTemporaryValue:
    {
      const cEnumAssociatedValues_objectIR_llvmTemporaryValue * extractPtr_10429 = (const cEnumAssociatedValues_objectIR_llvmTemporaryValue *) (temp_0.unsafePointer ()) ;
      const GALGAS_lstring extractedValue_name = extractPtr_10429->mAssociatedValue1 ;
  ...
  case GALGAS_objectIR::kEnum_literalString:
    {
      const cEnumAssociatedValues_objectIR_literalString * extractPtr_10561 = (const cEnumAssociatedValues_objectIR_literalString *) (temp_0.unsafePointer ()) ;
      const GALGAS_uint extractedValue_index = extractPtr_10561->mAssociatedValue2 ;
  ...
  case GALGAS_objectIR::kEnum_functionProperty:
    {
      const cEnumAssociatedValues_objectIR_functionProperty * extractPtr_10610 = (const cEnumAssociatedValues_objectIR_functionProperty *) (temp_0.unsafePointer ()) ;
      const GALGAS_lstring extractedValue_name = extractPtr_10610->mAssociatedValue1 ;
...
bool GALGAS_propertyMap_2D_element::isValid (void) const {
  return mProperty_lkey.isValid () && mProperty_mIsPublic.isValid () && mProperty_mPropertyObject.isValid () && mProperty_mIndex.isValid () ;
}
...
GALGAS_svcDeclarationListAST GALGAS_extensionDeclarationListAST_2D_element::getter_mSVCListAST (UNUSED_LOCATION_ARGS) const {
...
GALGAS_svcDeclarationListAST_2D_element::GALGAS_svcDeclarationListAST_2D_element (void) :
mProperty_mName (),
mProperty_mRoutineKind (),
mProperty_mPublic (),
mProperty_mAttributeList (),
...
GALGAS_svcDeclarationListAST_2D_element::GALGAS_svcDeclarationListAST_2D_element (const GALGAS_lstring & inOperand0,
...
GALGAS_svcDeclarationListAST_2D_element GALGAS_svcDeclarationListAST_2D_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                                  const GALGAS_routineKind & inOperand1,
                                                                                                  const GALGAS_bool & inOperand2,
                                                                                                  const GALGAS_lstringlist & inOperand3,
                                                                                                  const GALGAS_procFormalArgumentList & inOperand4,
                                                                                                  ...
                                                                                                  const GALGAS_location & inOperand7 
                                                                                                  COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_svcDeclarationListAST_2D_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid () && inOperand5.isValid () && inOperand6.isValid () && inOperand7.isValid ()) {
    result = GALGAS_svcDeclarationListAST_2D_element (inOperand0, inOperand1, inOperand2, inOperand3, inOperand4, inOperand5, inOperand6, inOperand7) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_svcDeclarationListAST_2D_element::objectCompare (const GALGAS_svcDeclarationListAST_2D_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
...
bool GALGAS_svcDeclarationListAST_2D_element::isValid (void) const {
...
void GALGAS_svcDeclarationListAST_2D_element::drop (void) {
...
void GALGAS_svcDeclarationListAST_2D_element::description (C_String & ioString,
                                                           const int32_t inIndentation) const {
  ioString << "<struct @svcDeclarationListAST-element:" ;
  if (! isValid ()) {
    ioString << " not built" ;
  }else{
...
GALGAS_lstring GALGAS_svcDeclarationListAST_2D_element::getter_mName (UNUSED_LOCATION_ARGS) const {
  return mProperty_mName ;
}

//---------------------------------------------------------------------------------------------------------------------*

GALGAS_routineKind GALGAS_svcDeclarationListAST_2D_element::getter_mRoutineKind (UNUSED_LOCATION_ARGS) const {
  return mProperty_mRoutineKind ;
}

//---------------------------------------------------------------------------------------------------------------------*

GALGAS_bool GALGAS_svcDeclarationListAST_2D_element::getter_mPublic (UNUSED_LOCATION_ARGS) const {
  return mProperty_mPublic ;
}

//---------------------------------------------------------------------------------------------------------------------*

GALGAS_lstringlist GALGAS_svcDeclarationListAST_2D_element::getter_mAttributeList (UNUSED_LOCATION_ARGS) const {
  return mProperty_mAttributeList ;
}

//---------------------------------------------------------------------------------------------------------------------*

GALGAS_procFormalArgumentList GALGAS_svcDeclarationListAST_2D_element::getter_mFormalArgumentList (UNUSED_LOCATION_ARGS) const {
  return mProperty_mFormalArgumentList ;
}

//---------------------------------------------------------------------------------------------------------------------*

GALGAS_lstring GALGAS_svcDeclarationListAST_2D_element::getter_mReturnTypeName (UNUSED_LOCATION_ARGS) const {
  return mProperty_mReturnTypeName ;
}

//---------------------------------------------------------------------------------------------------------------------*

GALGAS_instructionListAST GALGAS_svcDeclarationListAST_2D_element::getter_mInstructionList (UNUSED_LOCATION_ARGS) const {
  return mProperty_mInstructionList ;
}

//---------------------------------------------------------------------------------------------------------------------*

GALGAS_location GALGAS_svcDeclarationListAST_2D_element::getter_mEndOfInstructionListLocation (UNUSED_LOCATION_ARGS) const {
...
//---------------------------------------------------------------------------------------------------------------------*
//                                                                                                                     *
//                                         @svcDeclarationListAST-element type                                         *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*

const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_svcDeclarationListAST_2D_element ("svcDeclarationListAST-element",
                                                         NULL) ;

//---------------------------------------------------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_svcDeclarationListAST_2D_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_svcDeclarationListAST_2D_element ;
}

//---------------------------------------------------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_svcDeclarationListAST_2D_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_svcDeclarationListAST_2D_element (*this)) ;
  }
  return result ;
}
...
GALGAS_svcDeclarationListAST_2D_element GALGAS_svcDeclarationListAST_2D_element::extractObject (const GALGAS_object & inObject,
                                                                                                C_Compiler * inCompiler
                                                                                                COMMA_LOCATION_ARGS) {
  GALGAS_svcDeclarationListAST_2D_element result ;
  const GALGAS_svcDeclarationListAST_2D_element * p = (const GALGAS_svcDeclarationListAST_2D_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_svcDeclarationListAST_2D_element *> (p)) {
      result = *p ;
    }else{
      inCompiler->castError ("svcDeclarationListAST-element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
