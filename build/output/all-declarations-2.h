...
//--------------------------------- GALGAS constructors
  public : static class GALGAS_semanticContext constructor_new (const class GALGAS_targetParameters & inOperand0,
                                                                ...
                                                                const class GALGAS_prefixOperatorMap & inOperand17,
                                                                const class GALGAS_assignmentOperatorMap & inOperand18,
                                                                const class GALGAS_implicitConversionToBooleanMap & inOperand19,
                                                                const class GALGAS_taskMap & inOperand20,
                                                                const class GALGAS_globalTaskVariableList & inOperand21,
                                                                const class GALGAS_universalValuedObjectMap & inOperand22
                                                                COMMA_LOCATION_ARGS) ;
