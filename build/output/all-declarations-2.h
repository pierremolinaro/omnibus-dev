...
//---------------------------------------------------------------------------------------------------------------------*
//                                                                                                                     *
//                                             @routineKindForContext enum                                             *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*

class GALGAS_routineKindForContext : public AC_GALGAS_root {
//--------------------------------- Default constructor
  public : GALGAS_routineKindForContext (void) ;
...
//--------------------------------- Object extraction
  public : static GALGAS_routineKindForContext extractObject (const GALGAS_object & inObject,
                                                              C_Compiler * inCompiler
                                                              COMMA_LOCATION_ARGS) ;

//--------------------------------- GALGAS constructors
  public : static GALGAS_routineKindForContext constructor_procedure (LOCATION_ARGS) ;

  public : static GALGAS_routineKindForContext constructor_section (LOCATION_ARGS) ;

  public : static GALGAS_routineKindForContext constructor_service (LOCATION_ARGS) ;

//--------------------------------- Implementation of getter 'description'
  public : VIRTUAL_IN_DEBUG void description (C_String & ioString,
                                              const int32_t inIndentation) const ;
//--------------------------------- Comparison
  public : typeComparisonResult objectCompare (const GALGAS_routineKindForContext & inOperand) const ;
...
} ; // End of GALGAS_routineKindForContext class


//---------------------------------------------------------------------------------------------------------------------*

extern const C_galgas_type_descriptor kTypeDescriptor_GALGAS_routineKindForContext ;
...
//--------------------------------- += operator (with list of field expressions)
  public : VIRTUAL_IN_DEBUG void addAssign_operation (const class GALGAS_lstring & inOperand0,
                                                      ...
                                                      const class GALGAS_routineKindForContext & inOperand4,
                                                      C_Compiler * inCompiler
                                                      COMMA_LOCATION_ARGS) ;
...
//--------------------------------- Setters
  public : VIRTUAL_IN_DEBUG void setter_insertKey (class GALGAS_lstring constinArgument0,
                                                   ...
                                                   class GALGAS_routineKindForContext constinArgument4,
                                                   C_Compiler * inCompiler
                                                   COMMA_LOCATION_ARGS) ;
  ...
  public : VIRTUAL_IN_DEBUG void setter_removeKey (class GALGAS_lstring constinArgument0,
                                                   ...
                                                   class GALGAS_routineKindForContext & outArgument4,
                                                   C_Compiler * inCompiler
                                                   COMMA_LOCATION_ARGS) ;
  ...
  public : VIRTUAL_IN_DEBUG void setter_setMRoutineKindForKey (class GALGAS_routineKindForContext constinArgument0,
                                                               class GALGAS_string constinArgument1,
                                                               C_Compiler * inCompiler
                                                               COMMA_LOCATION_ARGS) ;
...
//--------------------------------- Getters
  ...
  public : VIRTUAL_IN_DEBUG class GALGAS_routineKindForContext getter_mRoutineKindForKey (const class GALGAS_string & constinOperand0,
                                                                                          C_Compiler * inCompiler
                                                                                          COMMA_LOCATION_ARGS) const ;
...
//--- Current element access
  ...
  public : class GALGAS_procedureSignature current_mSignature (LOCATION_ARGS) const ;
  public : class GALGAS_routineKindForContext current_mRoutineKind (LOCATION_ARGS) const ;
//--- Current element access
...
//--- Map attributes
  ...
  public : GALGAS_procedureSignature mAttribute_mSignature ;
  public : GALGAS_routineKindForContext mAttribute_mRoutineKind ;
...
//--------------------------------- Getters
  ...
  public : VIRTUAL_IN_DEBUG class GALGAS_routineKindForContext getter_mRoutineKind (LOCATION_ARGS) const ;
...
//--------------------------------- GALGAS constructors
  ...
  public : static GALGAS_constructorValue constructor_structure (const class GALGAS_operandIRList & inOperand0
                                                                 COMMA_LOCATION_ARGS) ;
...
//--------------------------------- Instance Methods
  ...
  public : VIRTUAL_IN_DEBUG void method_structure (class GALGAS_operandIRList & outArgument0,
                                                   C_Compiler * inCompiler
                                                   COMMA_LOCATION_ARGS) const ;
...
//--- Constructor
  public : cEnumAssociatedValues_constructorValue_structure (const GALGAS_operandIRList & inAssociatedValue0
                                                             COMMA_LOCATION_ARGS) ;
