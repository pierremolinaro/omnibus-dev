...
//--------------------------------- GALGAS constructors
  public : static class GALGAS_decoratedTaskList constructor_new (const class GALGAS_taskListAST & inOperand0
                                                                  COMMA_LOCATION_ARGS) ;
...
//--------------------------------- Getters
  public : VIRTUAL_IN_DEBUG class GALGAS_taskListAST getter_mTaskList (LOCATION_ARGS) const ;
...
//--- Attributes
  public : GALGAS_taskListAST mProperty_mTaskList ;

//--- Constructor
  public : cPtr_decoratedTaskList (const GALGAS_taskListAST & in_mTaskList
                                   COMMA_LOCATION_ARGS) ;
...
//--- Attribute accessors
  public : VIRTUAL_IN_DEBUG GALGAS_taskListAST getter_mTaskList (LOCATION_ARGS) const ;
//--- Description
...
//---------------------------------------------------------------------------------------------------------------------*
//                                                                                                                     *
//                                     Extension method '@bootList enterInContext'                                     *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*

void extensionMethod_enterInContext (const class GALGAS_bootList inObject,
                                     class GALGAS_declarationDecorationList & io_ioDecoratedDeclarationList,
                                     class C_Compiler * inCompiler
                                     COMMA_LOCATION_ARGS) ;
...
//--------------------------------- GALGAS constructors
  public : static class GALGAS_decoratedBootRoutine constructor_new (const class GALGAS_location & inOperand0,
                                                                     const class GALGAS_instructionListAST & inOperand1,
                                                                     const class GALGAS_location & inOperand2,
                                                                     const class GALGAS_lbigint & inOperand3
                                                                     COMMA_LOCATION_ARGS) ;
...
//--- Constructor
  public : cPtr_decoratedBootRoutine (const GALGAS_location & in_mBootLocation,
                                      const GALGAS_instructionListAST & in_mInstructionList,
                                      const GALGAS_location & in_mEndOfBootLocation,
                                      const GALGAS_lbigint & in_mPriority
                                      COMMA_LOCATION_ARGS) ;
