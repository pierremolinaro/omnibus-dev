...
//--------------------------------- GALGAS constructors
  public : static class GALGAS_propertyGetterKind constructor_computedProperty (const class GALGAS_PLMType & inOperand0
                                                                                COMMA_LOCATION_ARGS) ;
...
//--------------------------------- Instance Methods
  public : VIRTUAL_IN_DEBUG void method_computedProperty (class GALGAS_PLMType & outArgument0,
                                                          C_Compiler * inCompiler
                                                          COMMA_LOCATION_ARGS) const ;
...
//--------------------------------- GALGAS constructors
  public : static class GALGAS_propertySetterKind constructor_other (LOCATION_ARGS) ;

  public : static class GALGAS_propertySetterKind constructor_storedProperty (const class GALGAS_PLMType & inOperand0,
                                                                              const class GALGAS_uint & inOperand1
                                                                              COMMA_LOCATION_ARGS) ;
...
//--------------------------------- Getters
  public : VIRTUAL_IN_DEBUG class GALGAS_bool getter_isOther (LOCATION_ARGS) const ;
