...
//---------------------------------------------------------------------------------------------------------------------*
//                                                                                                                     *
//                          Extension method '@systemRoutineDeclarationListAST solveEntities'                          *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*

void extensionMethod_solveEntities (const class GALGAS_systemRoutineDeclarationListAST inObject,
...
typedef void (*extensionMethodSignature_instructionAST_solveEntities) (const class cPtr_instructionAST * inObject,
                                                                       ...
                                                                       class GALGAS_instructionListSE & ioArgument1,
                                                                       class C_Compiler * inCompiler
                                                                       COMMA_LOCATION_ARGS) ;
