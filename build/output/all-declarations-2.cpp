...
void extensionMethod_generateLLVMForStaticLists (const GALGAS_staticListInitializationMap inObject,
  ...
  GALGAS_bool var_first_22934 = GALGAS_bool (true) ;
  const GALGAS_staticListInitializationMap temp_0 = inObject ;
  cEnumerator_staticListInitializationMap enumerator_22970 (temp_0, kENUMERATION_UP) ;
  while (enumerator_22970.hasCurrentObject ()) {
    const enumGalgasBool test_1 = constinArgument_inUsefulStaticArrayMap.getter_hasKey (enumerator_22970.current_lkey (HERE).getter_string (SOURCE_FILE ("declaration-static-array.galgas", 539)) COMMA_SOURCE_FILE ("declaration-static-array.galgas", 539)).boolEnum () ;
    if (kBoolTrue == test_1) {
      const enumGalgasBool test_2 = var_first_22934.boolEnum () ;
      if (kBoolTrue == test_2) {
        var_first_22934 = GALGAS_bool (false) ;
        ioArgument_ioLLVMcode.plusAssign_operation(function_llvmTitleComment (GALGAS_string ("Static Arraies"), inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 542)), inCompiler  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 542)) ;
      }
      ioArgument_ioLLVMcode.plusAssign_operation(function_llvmNameForGlobalVariable (enumerator_22970.current_lkey (HERE).getter_string (SOURCE_FILE ("declaration-static-array.galgas", 544)), inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 544)).add_operation (GALGAS_string (" = private unnamed_addr constant ["), inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 544)), inCompiler  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 544)) ;
      ioArgument_ioLLVMcode.plusAssign_operation(enumerator_22970.current_mInitializationList (HERE).getter_length (SOURCE_FILE ("declaration-static-array.galgas", 545)).getter_string (SOURCE_FILE ("declaration-static-array.galgas", 545)).add_operation (GALGAS_string (" x %"), inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 545)).add_operation (function_llvmTypeStringFromPLMname (function_llvmNameForStaticListElementType (enumerator_22970.current_lkey (HERE).getter_string (HERE).getter_nowhere (SOURCE_FILE ("declaration-static-array.galgas", 545)), inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 545)).getter_string (SOURCE_FILE ("declaration-static-array.galgas", 545)), inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 545)), inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 545)).add_operation (GALGAS_string ("] [\n"), inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 545)), inCompiler  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 545)) ;
      cEnumerator_stringlist enumerator_23402 (enumerator_22970.current_mInitializationList (HERE), kENUMERATION_UP) ;
      while (enumerator_23402.hasCurrentObject ()) {
        ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  %").add_operation (function_llvmTypeStringFromPLMname (function_llvmNameForStaticListElementType (enumerator_22970.current_lkey (HERE).getter_string (HERE).getter_nowhere (SOURCE_FILE ("declaration-static-array.galgas", 548)), inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 548)).getter_string (SOURCE_FILE ("declaration-static-array.galgas", 548)), inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 548)), inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 548)).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 548)).add_operation (enumerator_23402.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 548)), inCompiler  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 548)) ;
        if (enumerator_23402.hasNextObject ()) {
          ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string (",\n"), inCompiler  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 550)) ;
        }
        enumerator_23402.gotoNextObject () ;
      }
      ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("\n"
        "]\n"
        "\n"), inCompiler  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 552)) ;
    }
...
void extensionMethod_enterInContext (const GALGAS_taskListAST inObject,
                                     ...
                                     C_Compiler * inCompiler
                                     COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_decoratedTaskList var_decoratedTaskList_6058 = GALGAS_decoratedTaskList::constructor_emptyList (SOURCE_FILE ("task-declaration.galgas", 155)) ;
  const GALGAS_taskListAST temp_0 = inObject ;
  cEnumerator_taskListAST enumerator_6082 (temp_0, kENUMERATION_UP) ;
  while (enumerator_6082.hasCurrentObject ()) {
    GALGAS_propertyList var_propertyList_6138 = GALGAS_propertyList::constructor_emptyList (SOURCE_FILE ("task-declaration.galgas", 158)) ;
    GALGAS_propertyMap var_propertyMap_6172 = GALGAS_propertyMap::constructor_emptyMap (SOURCE_FILE ("task-declaration.galgas", 159)) ;
    GALGAS_sortedOperandIRList var_initialValueList_6219 = GALGAS_sortedOperandIRList::constructor_emptySortedList (SOURCE_FILE ("task-declaration.galgas", 160)) ;
    cEnumerator_structurePropertyListAST enumerator_6258 (enumerator_6082.current (HERE).getter_mVarList (HERE), kENUMERATION_UP) ;
    while (enumerator_6258.hasCurrentObject ()) {
      GALGAS_constructorSignature joker_6479 = GALGAS_constructorSignature::constructor_emptyList (SOURCE_FILE ("task-declaration.galgas", 169)) ;
      GALGAS_string joker_6491 = GALGAS_string::constructor_default (SOURCE_FILE ("task-declaration.galgas", 170)) ;
      GALGAS_bool joker_6503 = GALGAS_bool::constructor_default (SOURCE_FILE ("task-declaration.galgas", 171)) ;
      extensionMethod_enterPropertyInContext (enumerator_6258.current (HERE), enumerator_6082.current (HERE).getter_mTaskName (HERE), ioArgument_ioContext, ioArgument_ioStaticEntityMap, var_propertyList_6138, var_propertyMap_6172, var_initialValueList_6219, joker_6479, joker_6491, joker_6503, ioArgument_ioGlobalVariableIRList, inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 162)) ;
      enumerator_6258.gotoNextObject () ;
    }
    extensionMethod_enterFunctionsInPropertyMap (enumerator_6082.current (HERE).getter_mTaskFunctionList (HERE), ioArgument_ioContext, var_propertyMap_6172, inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 176)) ;
    GALGAS_PLMType var_taskType_6792 = GALGAS_PLMType::constructor_new (var_propertyMap_6172, GALGAS_classConstantMap::constructor_emptyMap (SOURCE_FILE ("task-declaration.galgas", 180)), GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE ("task-declaration.galgas", 181)), GALGAS_guardMapForContext::constructor_emptyMap (SOURCE_FILE ("task-declaration.galgas", 182)), GALGAS_PLMTypeAttributes::constructor_none (SOURCE_FILE ("task-declaration.galgas", 183)), enumerator_6082.current (HERE).getter_mTaskName (HERE).getter_string (SOURCE_FILE ("task-declaration.galgas", 184)), GALGAS_typeKind::constructor_structure (var_propertyList_6138  COMMA_SOURCE_FILE ("task-declaration.galgas", 185)), enumerator_6082.current (HERE).getter_mTaskName (HERE).getter_string (SOURCE_FILE ("task-declaration.galgas", 186))  COMMA_SOURCE_FILE ("task-declaration.galgas", 178)) ;
    {
    ioArgument_ioContext.mProperty_mTypeMap.setter_insertType (enumerator_6082.current (HERE).getter_mTaskName (HERE), var_taskType_6792, ioArgument_ioContext.getter_mTypeMap (HERE).getter_count (SOURCE_FILE ("task-declaration.galgas", 191)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 188)) ;
    }
    {
    ioArgument_ioContext.mProperty_mTaskMap.setter_insertKey (enumerator_6082.current (HERE).getter_mTaskName (HERE), var_taskType_6792, inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 193)) ;
    }
    {
    extensionSetter_insertTask (ioArgument_ioContext.mProperty_mValuedObjectMap, enumerator_6082.current (HERE).getter_mTaskName (HERE), var_taskType_6792, inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 194)) ;
    }
    ioArgument_ioContext.mProperty_mGlobalTaskVariableList.addAssign_operation (enumerator_6082.current (HERE).getter_mTaskName (HERE).getter_string (HERE), enumerator_6082.current (HERE).getter_mTaskName (HERE).getter_string (HERE), GALGAS_objectIR::constructor_llvmStructureValue (var_taskType_6792, var_initialValueList_6219  COMMA_SOURCE_FILE ("task-declaration.galgas", 198))  COMMA_SOURCE_FILE ("task-declaration.galgas", 195)) ;
    extensionMethod_enterFunctionInContext (enumerator_6082.current (HERE).getter_mTaskFunctionList (HERE), enumerator_6082.current (HERE).getter_mTaskName (HERE).getter_string (SOURCE_FILE ("task-declaration.galgas", 201)), ioArgument_ioContext, ioArgument_ioDecoratedDeclarationList, inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 200)) ;
    var_decoratedTaskList_6058.addAssign_operation (enumerator_6082.current (HERE).getter_mTaskName (HERE), enumerator_6082.current (HERE).getter_mPriority (HERE), enumerator_6082.current (HERE).getter_mStackSize (HERE), enumerator_6082.current (HERE).getter_mVarList (HERE), enumerator_6082.current (HERE).getter_mTaskFunctionList (HERE), enumerator_6082.current (HERE).getter_mTaskSetupListAST (HERE), enumerator_6082.current (HERE).getter_mGuardedCommandList (HERE), enumerator_6082.current (HERE).getter_mEndOfTaskDeclaration (HERE)  COMMA_SOURCE_FILE ("task-declaration.galgas", 206)) ;
    enumerator_6082.gotoNextObject () ;
  }
  ioArgument_ioDecoratedDeclarationList.addAssign_operation (GALGAS_decoratedTaskListDeclaration::constructor_new (var_decoratedTaskList_6058  COMMA_SOURCE_FILE ("task-declaration.galgas", 217))  COMMA_SOURCE_FILE ("task-declaration.galgas", 217)) ;
}
...
void extensionMethod_generateCode (const GALGAS_taskMapIR inObject,
  ...
  GALGAS_string var_selfTerminateImplementationName_16453 = function_llvmNameForServiceImplementation (function_llvmNameForTaskAutoBlockService (inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 428)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 428)) ;
  GALGAS_string var_selfTerminateCallName_16554 = function_llvmNameForServiceCall (function_llvmNameForTaskAutoBlockService (inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 429)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 429)) ;
  ioArgument_ioServiceList.addAssign_operation (var_selfTerminateCallName_16554, var_selfTerminateImplementationName_16453, GALGAS_bool (false)  COMMA_SOURCE_FILE ("task-declaration.galgas", 430)) ;
  ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("declare void @").add_operation (var_selfTerminateCallName_16554, inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 431)).add_operation (GALGAS_string (" () nounwind noreturn\n"
  ...
  cEnumerator_globalTaskVariableList enumerator_16965 (constinArgument_inGenerationContext.getter_mGlobalTaskVariableList (HERE), kENUMERATION_UP) ;
  while (enumerator_16965.hasCurrentObject ()) {
    ioArgument_ioLLVMcode.plusAssign_operation(function_llvmNameForGlobalVariable (enumerator_16965.current_mTaskName (HERE), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 435)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 435)) ;
    ...
    ioArgument_ioLLVMcode.plusAssign_operation(function_llvmTypeStringFromPLMname (enumerator_16965.current_mTaskTypeName (HERE), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 437)).getter_assemblerRepresentation (SOURCE_FILE ("task-declaration.galgas", 437)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 437)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string (" ").add_operation (extensionGetter_llvmValue (enumerator_16965.current_mInitialValue (HERE), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 438)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 438)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 438)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 438)) ;
    enumerator_16965.gotoNextObject () ;
  }
  ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("\n"), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 440)) ;
  GALGAS_taskSortedListIR var_orderedTaskList_17307 = GALGAS_taskSortedListIR::constructor_emptySortedList (SOURCE_FILE ("task-declaration.galgas", 442)) ;
  const GALGAS_taskMapIR temp_0 = inObject ;
  cEnumerator_taskMapIR enumerator_17331 (temp_0, kENUMERATION_UP) ;
  while (enumerator_17331.hasCurrentObject ()) {
    var_orderedTaskList_17307.addAssign_operation (enumerator_17331.current (HERE).getter_lkey (HERE).getter_string (HERE), enumerator_17331.current (HERE).getter_mPriority (HERE), enumerator_17331.current (HERE).getter_mStackSize (HERE), enumerator_17331.current (HERE).getter_mAllocaList (HERE), enumerator_17331.current (HERE).getter_mInitInstructionListIR (HERE), enumerator_17331.current (HERE).getter_mTaskNameStringIndex (HERE)  COMMA_SOURCE_FILE ("task-declaration.galgas", 444)) ;
  ...
  cEnumerator_taskSortedListIR enumerator_17864 (var_orderedTaskList_17307, kENUMERATION_UP) ;
  while (enumerator_17864.hasCurrentObject ()) {
    ioArgument_ioLLVMcode.plusAssign_operation(function_llvmTitleComment (GALGAS_string ("Task ").add_operation (enumerator_17864.current (HERE).getter_mTaskName (HERE), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 457)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 457)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 457)) ;
    GALGAS_string var_assemblerTaskName_17956 = function_llvmTypeStringFromPLMname (enumerator_17864.current (HERE).getter_mTaskName (HERE), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 458)).getter_assemblerRepresentation (SOURCE_FILE ("task-declaration.galgas", 458)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(function_stackNameForTask (enumerator_17864.current (HERE).getter_mTaskName (HERE), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 459)).add_operation (GALGAS_string (" = global ["), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 459)).add_operation (enumerator_17864.current (HERE).getter_mStackSize (HERE).divide_operation (GALGAS_uint ((uint32_t) 4U).getter_bigint (SOURCE_FILE ("task-declaration.galgas", 459)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 459)).getter_string (SOURCE_FILE ("task-declaration.galgas", 459)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 459)).add_operation (GALGAS_string (" x i32] zeroinitializer\n"), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 459)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 459)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("\n"), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 460)) ;
    GALGAS_string var_effectiveParameter_18201 = GALGAS_string ("(%").add_operation (var_assemblerTaskName_17956, inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 461)).add_operation (GALGAS_string ("* "), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 461)).add_operation (function_llvmNameForGlobalVariable (enumerator_17864.current (HERE).getter_mTaskName (HERE), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 461)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 461)).add_operation (GALGAS_string (")"), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 461)) ;
    GALGAS_string var_formalArgument_18310 = GALGAS_string ("(%").add_operation (var_assemblerTaskName_17956, inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 462)).add_operation (GALGAS_string ("* "), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 462)).add_operation (function_llvmNameForSelf (inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 462)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 462)).add_operation (GALGAS_string (")"), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 462)) ;
    ...
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("define internal void ").add_operation (function_initNameForTaskType (enumerator_17864.current (HERE).getter_mTaskName (HERE), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 465)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 465)).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 465)).add_operation (var_formalArgument_18310, inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 465)).add_operation (function_llvmAttributeFunction (inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 465)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 465)).add_operation (GALGAS_string ("{\n"), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 465)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 465)) ;
    extensionMethod_generateAllocaList (enumerator_17864.current (HERE).getter_mAllocaList (HERE), ioArgument_ioLLVMcode, inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 466)) ;
    extensionMethod_instructionListLLVMCode (enumerator_17864.current (HERE).getter_mSetupInstructionListIR (HERE), ioArgument_ioLLVMcode, constinArgument_inGenerationContext, ioArgument_ioGenerationAdds, inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 467)) ;
  ...
  cEnumerator_taskSortedListIR enumerator_19614 (var_orderedTaskList_17307, kENUMERATION_UP) ;
  GALGAS_uint index_19590 ((uint32_t) 0) ;
  while (enumerator_19614.hasCurrentObject ()) {
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  ").add_operation (function_stackAddressForTask (enumerator_19614.current (HERE).getter_mTaskName (HERE), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 483)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 483)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 483)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string (" = getelementptr inbounds [").add_operation (enumerator_19614.current (HERE).getter_mStackSize (HERE).divide_operation (GALGAS_uint ((uint32_t) 4U).getter_bigint (SOURCE_FILE ("task-declaration.galgas", 484)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 484)).getter_string (SOURCE_FILE ("task-declaration.galgas", 484)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 484)).add_operation (GALGAS_string (" x i32], "), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 484)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 484)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("[").add_operation (enumerator_19614.current (HERE).getter_mStackSize (HERE).divide_operation (GALGAS_uint ((uint32_t) 4U).getter_bigint (SOURCE_FILE ("task-declaration.galgas", 485)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 485)).getter_string (SOURCE_FILE ("task-declaration.galgas", 485)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 485)).add_operation (GALGAS_string (" x i32]* "), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 485)).add_operation (function_stackNameForTask (enumerator_19614.current (HERE).getter_mTaskName (HERE), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 485)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 485)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 485)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string (", i32 0, i32 0\n"), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 486)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  %task.name.").add_operation (index_19590.getter_string (SOURCE_FILE ("task-declaration.galgas", 487)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 487)).add_operation (GALGAS_string (" = load i8*, i8** "), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 487)).add_operation (function_literalStringName (enumerator_19614.current (HERE).getter_mTaskNameStringIndex (HERE), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 487)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 487)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 487)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 487)) ;
    ...
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("i32 ").add_operation (index_19590.getter_string (SOURCE_FILE ("task-declaration.galgas", 489)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 489)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 489)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string (", i8* %task.name.").add_operation (index_19590.getter_string (SOURCE_FILE ("task-declaration.galgas", 490)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 490)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 490)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string (", i32* ").add_operation (function_stackAddressForTask (enumerator_19614.current (HERE).getter_mTaskName (HERE), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 491)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 491)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 491)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string (", i32 ").add_operation (enumerator_19614.current (HERE).getter_mStackSize (HERE).getter_string (SOURCE_FILE ("task-declaration.galgas", 492)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 492)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 492)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string (", void ()* ").add_operation (function_mainRoutineNameForTask (enumerator_19614.current (HERE).getter_mTaskName (HERE), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 493)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 493)).add_operation (GALGAS_string (")\n"), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 493)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 493)) ;
    enumerator_19614.gotoNextObject () ;
    index_19590.increment_operation (inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 482)) ;
  }
...
void extensionMethod_generateCode (const GALGAS_bootListIR inObject,
  ...
  cEnumerator_bootListIR enumerator_8177 (temp_0, kENUMERATION_UP) ;
  while (enumerator_8177.hasCurrentObject ()) {
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  call void @boot.").add_operation (enumerator_8177.current (HERE).getter_mDriverName (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-boot.galgas", 184)).add_operation (GALGAS_string (" ()\n"), inCompiler COMMA_SOURCE_FILE ("declaration-boot.galgas", 184)), inCompiler  COMMA_SOURCE_FILE ("declaration-boot.galgas", 184)) ;
  ...
  cEnumerator_bootListIR enumerator_8328 (temp_1, kENUMERATION_UP) ;
  while (enumerator_8328.hasCurrentObject ()) {
    ...
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("define internal void @boot.").add_operation (enumerator_8328.current (HERE).getter_mDriverName (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-boot.galgas", 190)).add_operation (GALGAS_string (" ()"), inCompiler COMMA_SOURCE_FILE ("declaration-boot.galgas", 190)).add_operation (function_llvmAttributeFunction (inCompiler COMMA_SOURCE_FILE ("declaration-boot.galgas", 190)), inCompiler COMMA_SOURCE_FILE ("declaration-boot.galgas", 190)).add_operation (GALGAS_string ("{\n"), inCompiler COMMA_SOURCE_FILE ("declaration-boot.galgas", 190)), inCompiler  COMMA_SOURCE_FILE ("declaration-boot.galgas", 190)) ;
    extensionMethod_generateAllocaList (enumerator_8328.current (HERE).getter_mAllocaList (HERE), ioArgument_ioLLVMcode, inCompiler COMMA_SOURCE_FILE ("declaration-boot.galgas", 191)) ;
    extensionMethod_instructionListLLVMCode (enumerator_8328.current (HERE).getter_mInstructionListIR (HERE), ioArgument_ioLLVMcode, constinArgument_inGenerationContext, ioArgument_ioGenerationAdds, inCompiler COMMA_SOURCE_FILE ("declaration-boot.galgas", 192)) ;
...
void extensionMethod_generateLLVMinitCode (const GALGAS_initListIR inObject,
                                           ...
                                           C_Compiler * inCompiler
                                           COMMA_UNUSED_LOCATION_ARGS) {
  ioArgument_ioLLVMcode.plusAssign_operation(function_llvmTitleComment (GALGAS_string ("Init"), inCompiler COMMA_SOURCE_FILE ("declaration-init.galgas", 212)), inCompiler  COMMA_SOURCE_FILE ("declaration-init.galgas", 212)) ;
  ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("define internal void @init ()").add_operation (function_llvmAttributeFunction (inCompiler COMMA_SOURCE_FILE ("declaration-init.galgas", 213)), inCompiler COMMA_SOURCE_FILE ("declaration-init.galgas", 213)).add_operation (GALGAS_string ("{\n"), inCompiler COMMA_SOURCE_FILE ("declaration-init.galgas", 213)), inCompiler  COMMA_SOURCE_FILE ("declaration-init.galgas", 213)) ;
  const GALGAS_initListIR temp_0 = inObject ;
  cEnumerator_initListIR enumerator_9713 (temp_0, kENUMERATION_UP) ;
  while (enumerator_9713.hasCurrentObject ()) {
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  call void @init.").add_operation (enumerator_9713.current (HERE).getter_mDriverName (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-init.galgas", 215)).add_operation (GALGAS_string (" ("), inCompiler COMMA_SOURCE_FILE ("declaration-init.galgas", 215)), inCompiler  COMMA_SOURCE_FILE ("declaration-init.galgas", 215)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(extensionGetter_llvmTypeName (enumerator_9713.current (HERE).getter_mSelfType (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-init.galgas", 216)).add_operation (GALGAS_string ("* "), inCompiler COMMA_SOURCE_FILE ("declaration-init.galgas", 216)).add_operation (function_llvmNameForGlobalVariable (enumerator_9713.current (HERE).getter_mDriverName (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-init.galgas", 216)), inCompiler COMMA_SOURCE_FILE ("declaration-init.galgas", 216)), inCompiler  COMMA_SOURCE_FILE ("declaration-init.galgas", 216)) ;
  ...
  cEnumerator_initListIR enumerator_9988 (temp_1, kENUMERATION_UP) ;
  while (enumerator_9988.hasCurrentObject ()) {
    ioArgument_ioLLVMcode.plusAssign_operation(function_llvmSeparatorLine (inCompiler COMMA_SOURCE_FILE ("declaration-init.galgas", 222)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("declaration-init.galgas", 222)), inCompiler  COMMA_SOURCE_FILE ("declaration-init.galgas", 222)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("define internal void @init.").add_operation (enumerator_9988.current (HERE).getter_mDriverName (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-init.galgas", 223)).add_operation (GALGAS_string (" ("), inCompiler COMMA_SOURCE_FILE ("declaration-init.galgas", 223)), inCompiler  COMMA_SOURCE_FILE ("declaration-init.galgas", 223)) ;
    const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, enumerator_9988.current (HERE).getter_mSelfType (HERE).getter_kind (HERE).objectCompare (GALGAS_typeKind::constructor_void (SOURCE_FILE ("declaration-init.galgas", 224)))).boolEnum () ;
    if (kBoolTrue == test_2) {
      ioArgument_ioLLVMcode.plusAssign_operation(extensionGetter_llvmTypeName (enumerator_9988.current (HERE).getter_mSelfType (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-init.galgas", 225)).add_operation (GALGAS_string ("* "), inCompiler COMMA_SOURCE_FILE ("declaration-init.galgas", 225)).add_operation (function_llvmNameForSelf (inCompiler COMMA_SOURCE_FILE ("declaration-init.galgas", 225)), inCompiler COMMA_SOURCE_FILE ("declaration-init.galgas", 225)), inCompiler  COMMA_SOURCE_FILE ("declaration-init.galgas", 225)) ;
    }
    ...
    extensionMethod_generateAllocaList (enumerator_9988.current (HERE).getter_mAllocaList (HERE), ioArgument_ioLLVMcode, inCompiler COMMA_SOURCE_FILE ("declaration-init.galgas", 228)) ;
    extensionMethod_instructionListLLVMCode (enumerator_9988.current (HERE).getter_mInstructionListIR (HERE), ioArgument_ioLLVMcode, constinArgument_inGenerationContext, ioArgument_ioGenerationAdds, inCompiler COMMA_SOURCE_FILE ("declaration-init.galgas", 229)) ;
