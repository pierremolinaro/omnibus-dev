...
void extensionMethod_generateLLVMForStaticLists (const GALGAS_staticListInitializationMap inObject,
                                                 ...
                                                 C_Compiler * inCompiler
                                                 COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_bool var_first_23146 = GALGAS_bool (true) ;
  const GALGAS_staticListInitializationMap temp_0 = inObject ;
  cEnumerator_staticListInitializationMap enumerator_23182 (temp_0, kENUMERATION_UP) ;
  while (enumerator_23182.hasCurrentObject ()) {
    enumGalgasBool test_1 = kBoolTrue ;
    if (kBoolTrue == test_1) {
      test_1 = constinArgument_inUsefulStaticArrayMap.getter_hasKey (enumerator_23182.current_lkey (HERE).getter_string (SOURCE_FILE ("declaration-static-list.galgas", 562)) COMMA_SOURCE_FILE ("declaration-static-list.galgas", 562)).boolEnum () ;
      if (kBoolTrue == test_1) {
        enumGalgasBool test_2 = kBoolTrue ;
        if (kBoolTrue == test_2) {
          test_2 = var_first_23146.boolEnum () ;
          if (kBoolTrue == test_2) {
            var_first_23146 = GALGAS_bool (false) ;
        ...
        ioArgument_ioLLVMcode.plusAssign_operation(function_llvmNameForGlobalVariable (enumerator_23182.current_lkey (HERE).getter_string (SOURCE_FILE ("declaration-static-list.galgas", 567)), inCompiler COMMA_SOURCE_FILE ("declaration-static-list.galgas", 567)).add_operation (GALGAS_string (" = private unnamed_addr constant ["), inCompiler COMMA_SOURCE_FILE ("declaration-static-list.galgas", 567)), inCompiler  COMMA_SOURCE_FILE ("declaration-static-list.galgas", 567)) ;
        ioArgument_ioLLVMcode.plusAssign_operation(enumerator_23182.current_mInitializationList (HERE).getter_length (SOURCE_FILE ("declaration-static-list.galgas", 568)).getter_string (SOURCE_FILE ("declaration-static-list.galgas", 568)).add_operation (GALGAS_string (" x %"), inCompiler COMMA_SOURCE_FILE ("declaration-static-list.galgas", 568)).add_operation (function_llvmNameForStaticListElementType (enumerator_23182.current_lkey (HERE).getter_string (HERE).getter_nowhere (SOURCE_FILE ("declaration-static-list.galgas", 568)), inCompiler COMMA_SOURCE_FILE ("declaration-static-list.galgas", 568)).getter_string (SOURCE_FILE ("declaration-static-list.galgas", 568)), inCompiler COMMA_SOURCE_FILE ("declaration-static-list.galgas", 568)).add_operation (GALGAS_string ("] [\n"), inCompiler COMMA_SOURCE_FILE ("declaration-static-list.galgas", 568)), inCompiler  COMMA_SOURCE_FILE ("declaration-static-list.galgas", 568)) ;
        cEnumerator_stringlist enumerator_23585 (enumerator_23182.current_mInitializationList (HERE), kENUMERATION_UP) ;
        while (enumerator_23585.hasCurrentObject ()) {
          ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  %").add_operation (function_llvmNameForStaticListElementType (enumerator_23182.current_lkey (HERE).getter_string (HERE).getter_nowhere (SOURCE_FILE ("declaration-static-list.galgas", 571)), inCompiler COMMA_SOURCE_FILE ("declaration-static-list.galgas", 571)).getter_string (SOURCE_FILE ("declaration-static-list.galgas", 571)), inCompiler COMMA_SOURCE_FILE ("declaration-static-list.galgas", 571)).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("declaration-static-list.galgas", 571)).add_operation (enumerator_23585.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-static-list.galgas", 571)), inCompiler  COMMA_SOURCE_FILE ("declaration-static-list.galgas", 571)) ;
...
void extensionMethod_enterInContext (const GALGAS_taskListAST inObject,
  ...
  while (enumerator_9384.hasCurrentObject ()) {
    ...
    while (enumerator_9666.hasCurrentObject ()) {
      GALGAS_constructorSignature joker_10021 = GALGAS_constructorSignature::constructor_emptyList (SOURCE_FILE ("task-declaration.galgas", 271)) ;
      GALGAS_string joker_10033 = GALGAS_string::constructor_default (SOURCE_FILE ("task-declaration.galgas", 272)) ;
      GALGAS_bool joker_10045 = GALGAS_bool::constructor_default (SOURCE_FILE ("task-declaration.galgas", 273)) ;
      extensionMethod_enterPropertyInContext (enumerator_9666.current (HERE), ioArgument_ioContext, ioArgument_ioStaticEntityMap, enumerator_9384.current (HERE).getter_mTaskName (HERE), enumerator_9384.current (HERE).getter_mTaskName (HERE).getter_string (SOURCE_FILE ("task-declaration.galgas", 265)), ioArgument_ioDecoratedRoutineList, var_propertyList_9488, var_propertyGetterMap_9534, var_propertySetterMap_9580, var_initialValueList_9627, joker_10021, joker_10033, joker_10045, inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 261)) ;
      enumerator_9666.gotoNextObject () ;
    }
    {
    GALGAS_lstring joker_10308 ; // Joker input parameter
    extensionSetter_addFunctionWithoutArgument (var_routineMap_9452, enumerator_9384.current (HERE).getter_mTaskName (HERE).getter_string (SOURCE_FILE ("task-declaration.galgas", 278)), GALGAS_lstring::constructor_new (GALGAS_string ("activate"), enumerator_9384.current (HERE).getter_mTaskName (HERE).getter_location (SOURCE_FILE ("task-declaration.galgas", 279))  COMMA_SOURCE_FILE ("task-declaration.galgas", 279)), GALGAS_mode::constructor_safeUserMode (SOURCE_FILE ("task-declaration.galgas", 280)), GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("task-declaration.galgas", 281)), joker_10308, inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 277)) ;
    }
    GALGAS_string var_assemblerTaskName_10341 = enumerator_9384.current (HERE).getter_mTaskName (HERE).getter_string (HERE).getter_assemblerRepresentation (SOURCE_FILE ("task-declaration.galgas", 284)) ;
    GALGAS_string var_activateTaskCallName_10413 = function_llvmNameForServiceCall (function_llvmNameForActivateTask (inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 285)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 285)) ;
    ioArgument_ioRoutineListIR.addAssign_operation (GALGAS_taskActivateFunctionIR::constructor_new (function_routineMangledNameFromAST (enumerator_9384.current (HERE).getter_mTaskName (HERE).getter_string (SOURCE_FILE ("task-declaration.galgas", 287)), GALGAS_string ("activate").getter_nowhere (SOURCE_FILE ("task-declaration.galgas", 287)), GALGAS_routineFormalArgumentListAST::constructor_emptyList (SOURCE_FILE ("task-declaration.galgas", 287)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 287)), GALGAS_bool (false), GALGAS_bool (false), var_assemblerTaskName_10341, var_activateTaskCallName_10413, index_9361  COMMA_SOURCE_FILE ("task-declaration.galgas", 286))  COMMA_SOURCE_FILE ("task-declaration.galgas", 286)) ;
    cEnumerator_taskSetupListAST enumerator_10841 (enumerator_9384.current (HERE).getter_mTaskSetupListAST (HERE), kENUMERATION_UP) ;
    while (enumerator_10841.hasCurrentObject ()) {
      GALGAS_string var_mangledName_10866 = GALGAS_string ("task.setup.").add_operation (enumerator_9384.current (HERE).getter_mTaskName (HERE).getter_string (SOURCE_FILE ("task-declaration.galgas", 296)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 296)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 296)).add_operation (enumerator_10841.current (HERE).getter_mName (HERE).getter_string (SOURCE_FILE ("task-declaration.galgas", 296)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 296)) ;
      ioArgument_ioDecoratedRoutineList.addAssign_operation (enumerator_9384.current (HERE).getter_mTaskName (HERE), GALGAS_mode::constructor_userMode (SOURCE_FILE ("task-declaration.galgas", 299)), GALGAS_bool (true), GALGAS_routineKind::constructor_function (SOURCE_FILE ("task-declaration.galgas", 301)), GALGAS_bool (true), GALGAS_bool (false), GALGAS_routineAttributes::constructor_mutating (SOURCE_FILE ("task-declaration.galgas", 304)), GALGAS_lstring::constructor_new (var_mangledName_10866, enumerator_10841.current (HERE).getter_mName (HERE).getter_location (HERE)  COMMA_SOURCE_FILE ("task-declaration.galgas", 305)), GALGAS_routineFormalArgumentListAST::constructor_emptyList (SOURCE_FILE ("task-declaration.galgas", 306)), GALGAS_bool (true), enumerator_10841.current (HERE).getter_mTaskSetupInstructionList (HERE), enumerator_10841.current (HERE).getter_mEndOfTaskSetupDeclaration (HERE), GALGAS_string::makeEmptyString ().getter_nowhere (SOURCE_FILE ("task-declaration.galgas", 310))  COMMA_SOURCE_FILE ("task-declaration.galgas", 297)) ;
      enumerator_10841.gotoNextObject () ;
    }
    cEnumerator_taskSetupListAST enumerator_11521 (enumerator_9384.current (HERE).getter_mTaskActivateListAST (HERE), kENUMERATION_UP) ;
    while (enumerator_11521.hasCurrentObject ()) {
      GALGAS_string var_mangledName_11546 = GALGAS_string ("task.activate.").add_operation (enumerator_9384.current (HERE).getter_mTaskName (HERE).getter_string (SOURCE_FILE ("task-declaration.galgas", 313)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 313)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 313)).add_operation (enumerator_11521.current (HERE).getter_mName (HERE).getter_string (SOURCE_FILE ("task-declaration.galgas", 313)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 313)) ;
      ioArgument_ioDecoratedRoutineList.addAssign_operation (enumerator_9384.current (HERE).getter_mTaskName (HERE), GALGAS_mode::constructor_safeUserMode (SOURCE_FILE ("task-declaration.galgas", 316)), GALGAS_bool (true), GALGAS_routineKind::constructor_function (SOURCE_FILE ("task-declaration.galgas", 318)), GALGAS_bool (true), GALGAS_bool (false), GALGAS_routineAttributes::constructor_mutating (SOURCE_FILE ("task-declaration.galgas", 321)), GALGAS_lstring::constructor_new (var_mangledName_11546, enumerator_11521.current (HERE).getter_mName (HERE).getter_location (HERE)  COMMA_SOURCE_FILE ("task-declaration.galgas", 322)), GALGAS_routineFormalArgumentListAST::constructor_emptyList (SOURCE_FILE ("task-declaration.galgas", 323)), GALGAS_bool (true), enumerator_11521.current (HERE).getter_mTaskSetupInstructionList (HERE), enumerator_11521.current (HERE).getter_mEndOfTaskSetupDeclaration (HERE), GALGAS_string::makeEmptyString ().getter_nowhere (SOURCE_FILE ("task-declaration.galgas", 327))  COMMA_SOURCE_FILE ("task-declaration.galgas", 314)) ;
      enumerator_11521.gotoNextObject () ;
    }
    cEnumerator_taskSetupListAST enumerator_12210 (enumerator_9384.current (HERE).getter_mTaskDeactivateListAST (HERE), kENUMERATION_UP) ;
    while (enumerator_12210.hasCurrentObject ()) {
      GALGAS_string var_mangledName_12235 = GALGAS_string ("task.deactivate.").add_operation (enumerator_9384.current (HERE).getter_mTaskName (HERE).getter_string (SOURCE_FILE ("task-declaration.galgas", 330)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 330)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 330)).add_operation (enumerator_12210.current (HERE).getter_mName (HERE).getter_string (SOURCE_FILE ("task-declaration.galgas", 330)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 330)) ;
      ioArgument_ioDecoratedRoutineList.addAssign_operation (enumerator_9384.current (HERE).getter_mTaskName (HERE), GALGAS_mode::constructor_safeUserMode (SOURCE_FILE ("task-declaration.galgas", 333)), GALGAS_bool (true), GALGAS_routineKind::constructor_function (SOURCE_FILE ("task-declaration.galgas", 335)), GALGAS_bool (true), GALGAS_bool (false), GALGAS_routineAttributes::constructor_mutating (SOURCE_FILE ("task-declaration.galgas", 338)), GALGAS_lstring::constructor_new (var_mangledName_12235, enumerator_12210.current (HERE).getter_mName (HERE).getter_location (HERE)  COMMA_SOURCE_FILE ("task-declaration.galgas", 339)), GALGAS_routineFormalArgumentListAST::constructor_emptyList (SOURCE_FILE ("task-declaration.galgas", 340)), GALGAS_bool (true), enumerator_12210.current (HERE).getter_mTaskSetupInstructionList (HERE), enumerator_12210.current (HERE).getter_mEndOfTaskSetupDeclaration (HERE), GALGAS_string::makeEmptyString ().getter_nowhere (SOURCE_FILE ("task-declaration.galgas", 344))  COMMA_SOURCE_FILE ("task-declaration.galgas", 331)) ;
      enumerator_12210.gotoNextObject () ;
    }
    GALGAS_instructionListAST var_taskListInstructionList_13048 = GALGAS_instructionListAST::constructor_emptyList (SOURCE_FILE ("task-declaration.galgas", 348)) ;
    enumGalgasBool test_9 = kBoolTrue ;
    if (kBoolTrue == test_9) {
      test_9 = GALGAS_bool (kIsStrictSup, enumerator_9384.current (HERE).getter_mGuardedCommandList (HERE).getter_length (SOURCE_FILE ("task-declaration.galgas", 349)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_9) {
        GALGAS_syncInstructionAST var_syncInstruction_13129 = GALGAS_syncInstructionAST::constructor_new (enumerator_9384.current (HERE).getter_mTaskName (HERE).getter_location (HERE), enumerator_9384.current (HERE).getter_mGuardedCommandList (HERE), enumerator_9384.current (HERE).getter_mTaskName (HERE).getter_location (HERE)  COMMA_SOURCE_FILE ("task-declaration.galgas", 350)) ;
        var_taskListInstructionList_13048.addAssign_operation (var_syncInstruction_13129  COMMA_SOURCE_FILE ("task-declaration.galgas", 351)) ;
      }
    }
    GALGAS_lstring var_routineMangledName_13318 = function_routineMangledNameFromAST (enumerator_9384.current (HERE).getter_mTaskName (HERE).getter_string (SOURCE_FILE ("task-declaration.galgas", 353)), function_llvmNameForTaskLoopFunction (inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 353)).getter_nowhere (SOURCE_FILE ("task-declaration.galgas", 353)), GALGAS_routineFormalArgumentListAST::constructor_emptyList (SOURCE_FILE ("task-declaration.galgas", 353)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 353)) ;
    ioArgument_ioDecoratedRoutineList.addAssign_operation (enumerator_9384.current (HERE).getter_mTaskName (HERE), GALGAS_mode::constructor_userMode (SOURCE_FILE ("task-declaration.galgas", 356)), GALGAS_bool (true), GALGAS_routineKind::constructor_function (SOURCE_FILE ("task-declaration.galgas", 358)), GALGAS_bool (true), GALGAS_bool (false), GALGAS_routineAttributes::constructor_mutating (SOURCE_FILE ("task-declaration.galgas", 361)), var_routineMangledName_13318, GALGAS_routineFormalArgumentListAST::constructor_emptyList (SOURCE_FILE ("task-declaration.galgas", 363)), GALGAS_bool (true), var_taskListInstructionList_13048, enumerator_9384.current (HERE).getter_mTaskName (HERE).getter_location (HERE), GALGAS_string::makeEmptyString ().getter_nowhere (SOURCE_FILE ("task-declaration.galgas", 367))  COMMA_SOURCE_FILE ("task-declaration.galgas", 354)) ;
    extensionMethod_enterFunctionsInPropertyMap (enumerator_9384.current (HERE).getter_mTaskFunctionList (HERE), enumerator_9384.current (HERE).getter_mTaskName (HERE), enumerator_9384.current (HERE).getter_mTaskName (HERE).getter_string (SOURCE_FILE ("task-declaration.galgas", 371)), var_routineMap_9452, ioArgument_ioContext, ioArgument_ioDecoratedRoutineList, ioArgument_ioRoutineListIR, inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 369)) ;
    GALGAS_omnibusType var_taskType_14270 = GALGAS_omnibusType::constructor_new (var_propertyGetterMap_9534, var_propertySetterMap_9580, var_routineMap_9452, GALGAS_classConstantMap::constructor_emptyMap (SOURCE_FILE ("task-declaration.galgas", 382)), GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE ("task-declaration.galgas", 383)), GALGAS_guardMapCTXT::constructor_emptyMap (SOURCE_FILE ("task-declaration.galgas", 384)), GALGAS_subscript::constructor_noSubscript (SOURCE_FILE ("task-declaration.galgas", 385)), GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("task-declaration.galgas", 386)), GALGAS_omnibusTypeAttributes::constructor_none (SOURCE_FILE ("task-declaration.galgas", 387)), enumerator_9384.current (HERE).getter_mTaskName (HERE).getter_string (SOURCE_FILE ("task-declaration.galgas", 388)), GALGAS_typeKind::constructor_structure (var_propertyList_9488  COMMA_SOURCE_FILE ("task-declaration.galgas", 389)), enumerator_9384.current (HERE).getter_mTaskName (HERE).getter_string (SOURCE_FILE ("task-declaration.galgas", 390))  COMMA_SOURCE_FILE ("task-declaration.galgas", 378)) ;
    {
    ioArgument_ioContext.mProperty_mTypeMap.setter_insertType (enumerator_9384.current (HERE).getter_mTaskName (HERE), var_taskType_14270, inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 392)) ;
    }
    {
    ioArgument_ioContext.mProperty_mTaskMap.setter_insertKey (enumerator_9384.current (HERE).getter_mTaskName (HERE), var_taskType_14270, inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 396)) ;
    }
    {
    extensionSetter_insertTask (ioArgument_ioContext.mProperty_mValuedObjectMap, enumerator_9384.current (HERE).getter_mTaskName (HERE), var_taskType_14270, inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 397)) ;
    }
    ioArgument_ioContext.mProperty_mGlobalTaskVariableList.addAssign_operation (enumerator_9384.current (HERE).getter_mTaskName (HERE).getter_string (HERE), enumerator_9384.current (HERE).getter_mTaskName (HERE).getter_string (HERE), GALGAS_objectIR::constructor_llvmStructureValue (var_taskType_14270, var_initialValueList_9627  COMMA_SOURCE_FILE ("task-declaration.galgas", 401))  COMMA_SOURCE_FILE ("task-declaration.galgas", 398)) ;
    ...
    ioArgument_ioUserLLVMTypeDefinitionListIR.addAssign_operation (GALGAS_userLLVMSructureTypeDefinitionIR::constructor_new (callExtensionGetter_llvmTypeName ((const cPtr_omnibusType *) var_taskType_14270.ptr (), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 415)), var_propertyList_9488  COMMA_SOURCE_FILE ("task-declaration.galgas", 414))  COMMA_SOURCE_FILE ("task-declaration.galgas", 414)) ;
    enumerator_9384.gotoNextObject () ;
    index_9361.increment_operation (inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 253)) ;
  }
  ioArgument_ioDecoratedDeclarationList.addAssign_operation (GALGAS_decoratedTaskListDeclaration::constructor_new (var_decoratedTaskList_9350  COMMA_SOURCE_FILE ("task-declaration.galgas", 420))  COMMA_SOURCE_FILE ("task-declaration.galgas", 420)) ;
}
...
void extensionMethod_generateCode (const GALGAS_taskMapIR inObject,
  ...
  GALGAS_string var_activateTaskImplementationName_22863 = function_llvmNameForServiceImplementation (function_llvmNameForActivateTask (inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 614)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 614)) ;
  GALGAS_string var_activateTaskCallName_22955 = function_llvmNameForServiceCall (function_llvmNameForActivateTask (inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 615)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 615)) ;
  ioArgument_ioServiceList.addAssign_operation (var_activateTaskCallName_22955, var_activateTaskImplementationName_22863, GALGAS_bool (false)  COMMA_SOURCE_FILE ("task-declaration.galgas", 616)) ;
  ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("declare void @").add_operation (var_activateTaskCallName_22955, inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 617)).add_operation (GALGAS_string (" (i8 %inTaskIndex) nounwind\n"
  ...
  GALGAS_string var_waitForActivationImplementationName_23340 = function_llvmNameForServiceImplementation (function_llvmNameForTaskWaitsForActivation (inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 620)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 620)) ;
  GALGAS_string var_waitForActivationCallName_23447 = function_llvmNameForServiceCall (function_llvmNameForTaskWaitsForActivation (inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 621)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 621)) ;
  ioArgument_ioServiceList.addAssign_operation (var_waitForActivationCallName_23447, var_waitForActivationImplementationName_23340, GALGAS_bool (false)  COMMA_SOURCE_FILE ("task-declaration.galgas", 622)) ;
  ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("declare void @").add_operation (var_waitForActivationCallName_23447, inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 623)).add_operation (GALGAS_string (" () nounwind\n"
  ...
  cEnumerator_globalTaskVariableList enumerator_23863 (constinArgument_inGenerationContext.getter_mGlobalTaskVariableList (HERE), kENUMERATION_UP) ;
  while (enumerator_23863.hasCurrentObject ()) {
    ioArgument_ioLLVMcode.plusAssign_operation(function_llvmNameForGlobalVariable (enumerator_23863.current_mTaskName (HERE), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 627)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 627)) ;
    ...
    ioArgument_ioLLVMcode.plusAssign_operation(enumerator_23863.current_mTaskTypeName (HERE).getter_assemblerRepresentation (SOURCE_FILE ("task-declaration.galgas", 629)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 629)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string (" ").add_operation (extensionGetter_llvmValue (enumerator_23863.current_mInitialValue (HERE), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 630)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 630)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 630)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 630)) ;
    enumerator_23863.gotoNextObject () ;
  }
  ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("\n"), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 632)) ;
  GALGAS_taskSortedListIR var_orderedTaskList_24176 = GALGAS_taskSortedListIR::constructor_emptySortedList (SOURCE_FILE ("task-declaration.galgas", 634)) ;
  const GALGAS_taskMapIR temp_0 = inObject ;
  cEnumerator_taskMapIR enumerator_24200 (temp_0, kENUMERATION_UP) ;
  while (enumerator_24200.hasCurrentObject ()) {
    var_orderedTaskList_24176.addAssign_operation (enumerator_24200.current (HERE).getter_lkey (HERE).getter_string (HERE), enumerator_24200.current (HERE).getter_mPriority (HERE), enumerator_24200.current (HERE).getter_mStackSize (HERE), enumerator_24200.current (HERE).getter_mSetupOrderedList (HERE), enumerator_24200.current (HERE).getter_mActivateOrderedList (HERE), enumerator_24200.current (HERE).getter_mDeactivateOrderedList (HERE), enumerator_24200.current (HERE).getter_mTaskNameStringIndex (HERE), enumerator_24200.current (HERE).getter_mActivate (HERE)  COMMA_SOURCE_FILE ("task-declaration.galgas", 636)) ;
  ...
  cEnumerator_taskSortedListIR enumerator_24794 (var_orderedTaskList_24176, kENUMERATION_UP) ;
  while (enumerator_24794.hasCurrentObject ()) {
    ioArgument_ioLLVMcode.plusAssign_operation(function_llvmTitleComment (GALGAS_string ("Task ").add_operation (enumerator_24794.current (HERE).getter_mTaskName (HERE), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 651)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 651)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 651)) ;
    GALGAS_string var_assemblerTaskName_24886 = enumerator_24794.current (HERE).getter_mTaskName (HERE).getter_assemblerRepresentation (SOURCE_FILE ("task-declaration.galgas", 652)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(function_stackNameForTask (enumerator_24794.current (HERE).getter_mTaskName (HERE), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 653)).add_operation (GALGAS_string (" = global ["), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 653)).add_operation (enumerator_24794.current (HERE).getter_mStackSize (HERE).divide_operation (GALGAS_uint ((uint32_t) 4U).getter_bigint (SOURCE_FILE ("task-declaration.galgas", 653)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 653)).getter_string (SOURCE_FILE ("task-declaration.galgas", 653)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 653)).add_operation (GALGAS_string (" x i32] zeroinitializer\n"), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 653)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 653)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("\n"), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 654)) ;
    GALGAS_string var_effectiveParameter_25102 = GALGAS_string ("(%").add_operation (var_assemblerTaskName_24886, inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 655)).add_operation (GALGAS_string ("* "), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 655)).add_operation (function_llvmNameForGlobalVariable (enumerator_24794.current (HERE).getter_mTaskName (HERE), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 655)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 655)).add_operation (GALGAS_string (")"), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 655)) ;
    GALGAS_string var_formalArgument_25211 = GALGAS_string (" (%").add_operation (var_assemblerTaskName_24886, inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 656)).add_operation (GALGAS_string ("* "), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 656)).add_operation (function_llvmNameForSelf (inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 656)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 656)).add_operation (GALGAS_string (")"), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 656)) ;
    ...
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("define internal void ").add_operation (function_setupNameForTaskType (enumerator_24794.current (HERE).getter_mTaskName (HERE), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 659)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 659)).add_operation (var_formalArgument_25211, inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 659)).add_operation (function_llvmAttributeFunction (inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 659)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 659)).add_operation (GALGAS_string ("{\n"), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 659)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 659)) ;
    cEnumerator_stringlist enumerator_25520 (enumerator_24794.current (HERE).getter_mSetupOrderedList (HERE), kENUMERATION_UP) ;
    while (enumerator_25520.hasCurrentObject ()) {
      GALGAS_string var_mangledName_25545 = GALGAS_string ("task.setup.").add_operation (enumerator_24794.current (HERE).getter_mTaskName (HERE), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 661)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 661)).add_operation (enumerator_25520.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 661)) ;
      ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  call void @").add_operation (var_mangledName_25545.getter_assemblerRepresentation (SOURCE_FILE ("task-declaration.galgas", 662)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 662)).add_operation (var_formalArgument_25211, inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 662)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 662)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 662)) ;
    ...
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("define internal void @").add_operation (function_activateNameForTaskType (enumerator_24794.current (HERE).getter_mTaskName (HERE), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 669)).getter_assemblerRepresentation (SOURCE_FILE ("task-declaration.galgas", 669)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 669)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 669)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(var_formalArgument_25211.add_operation (function_llvmAttributeFunction (inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 670)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 670)).add_operation (GALGAS_string ("{\n"), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 670)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 670)) ;
    cEnumerator_stringlist enumerator_26081 (enumerator_24794.current (HERE).getter_mActivateOrderedList (HERE), kENUMERATION_UP) ;
    while (enumerator_26081.hasCurrentObject ()) {
      GALGAS_string var_mangledName_26106 = GALGAS_string ("task.activate.").add_operation (enumerator_24794.current (HERE).getter_mTaskName (HERE), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 672)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 672)).add_operation (enumerator_26081.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 672)) ;
      ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  call void @").add_operation (var_mangledName_26106.getter_assemblerRepresentation (SOURCE_FILE ("task-declaration.galgas", 673)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 673)).add_operation (var_formalArgument_25211, inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 673)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 673)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 673)) ;
    ...
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("define internal void ").add_operation (function_deactivateNameForTaskType (enumerator_24794.current (HERE).getter_mTaskName (HERE), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 680)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 680)).add_operation (var_formalArgument_25211, inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 680)).add_operation (function_llvmAttributeFunction (inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 680)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 680)).add_operation (GALGAS_string ("{\n"), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 680)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 680)) ;
    cEnumerator_stringlist enumerator_26613 (enumerator_24794.current (HERE).getter_mDeactivateOrderedList (HERE), kENUMERATION_UP) ;
    while (enumerator_26613.hasCurrentObject ()) {
      GALGAS_string var_mangledName_26638 = GALGAS_string ("task.deactivate.").add_operation (enumerator_24794.current (HERE).getter_mTaskName (HERE), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 682)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 682)).add_operation (enumerator_26613.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 682)) ;
      ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  call void @").add_operation (var_mangledName_26638.getter_assemblerRepresentation (SOURCE_FILE ("task-declaration.galgas", 683)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 683)).add_operation (var_formalArgument_25211, inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 683)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 683)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 683)) ;
      enumerator_26613.gotoNextObject () ;
    }
    ...
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("define internal void ").add_operation (function_mainRoutineNameForTask (enumerator_24794.current (HERE).getter_mTaskName (HERE), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 690)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 690)).add_operation (GALGAS_string (" ()"), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 690)).add_operation (function_llvmAttributeFunction (inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 690)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 690)).add_operation (GALGAS_string ("noreturn {\n"), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 690)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 690)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  call void ").add_operation (function_setupNameForTaskType (enumerator_24794.current (HERE).getter_mTaskName (HERE), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 691)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 691)).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 691)).add_operation (var_effectiveParameter_25102, inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 691)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 691)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 691)) ;
    GALGAS_string var_taskLoopLabel_27222 = GALGAS_string ("loop.").add_operation (enumerator_24794.current (HERE).getter_mTaskName (HERE).getter_assemblerRepresentation (SOURCE_FILE ("task-declaration.galgas", 692)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 692)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  br label %").add_operation (var_taskLoopLabel_27222, inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 693)).add_operation (GALGAS_string ("\n"
      "\n"), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 693)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 693)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(var_taskLoopLabel_27222.add_operation (GALGAS_string (":\n"), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 694)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 694)) ;
    enumGalgasBool test_1 = kBoolTrue ;
    if (kBoolTrue == test_1) {
      test_1 = enumerator_24794.current (HERE).getter_mActivate (HERE).operator_not (SOURCE_FILE ("task-declaration.galgas", 695)).boolEnum () ;
      if (kBoolTrue == test_1) {
        ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  call void @").add_operation (var_waitForActivationCallName_23447, inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 696)).add_operation (GALGAS_string (" ()\n"), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 696)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 696)) ;
      }
    }
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  call void @").add_operation (function_activateNameForTaskType (enumerator_24794.current (HERE).getter_mTaskName (HERE), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 698)).getter_assemblerRepresentation (SOURCE_FILE ("task-declaration.galgas", 698)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 698)).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 698)).add_operation (var_effectiveParameter_25102, inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 698)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 698)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 698)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  call void @func.").add_operation (function_llvmNameForFunction (enumerator_24794.current (HERE).getter_mTaskName (HERE).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 699)).add_operation (function_llvmNameForTaskLoopFunction (inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 699)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 699)).add_operation (GALGAS_string ("()"), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 699)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 699)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 699)).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 699)).add_operation (var_effectiveParameter_25102, inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 699)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 699)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 699)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  call void ").add_operation (function_deactivateNameForTaskType (enumerator_24794.current (HERE).getter_mTaskName (HERE), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 700)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 700)).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 700)).add_operation (var_effectiveParameter_25102, inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 700)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 700)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 700)) ;
    enumGalgasBool test_2 = kBoolTrue ;
    if (kBoolTrue == test_2) {
      test_2 = enumerator_24794.current (HERE).getter_mActivate (HERE).boolEnum () ;
      if (kBoolTrue == test_2) {
        ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  call void @").add_operation (var_waitForActivationCallName_23447, inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 702)).add_operation (GALGAS_string (" ()\n"), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 702)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 702)) ;
      }
    }
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  br label %").add_operation (var_taskLoopLabel_27222, inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 704)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 704)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 704)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("}\n"
  ...
  while (enumerator_28314.hasCurrentObject ()) {
    ...
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("i32 ").add_operation (index_28290.getter_string (SOURCE_FILE ("task-declaration.galgas", 717)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 717)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 717)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string (", i8* %task.name.").add_operation (index_28290.getter_string (SOURCE_FILE ("task-declaration.galgas", 718)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 718)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 718)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string (", i32* ").add_operation (function_stackAddressForTask (enumerator_28314.current (HERE).getter_mTaskName (HERE), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 719)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 719)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 719)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string (", i32 ").add_operation (enumerator_28314.current (HERE).getter_mStackSize (HERE).getter_string (SOURCE_FILE ("task-declaration.galgas", 720)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 720)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 720)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string (", void ()* ").add_operation (function_mainRoutineNameForTask (enumerator_28314.current (HERE).getter_mTaskName (HERE), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 721)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 721)).add_operation (GALGAS_string (")\n"), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 721)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 721)) ;
    enumerator_28314.gotoNextObject () ;
    index_28290.increment_operation (inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 710)) ;
  }
...
void extensionMethod_enterStandaloneFunctionsInContext (const GALGAS_functionDeclarationListAST inObject,
  ...
  while (enumerator_5077.hasCurrentObject ()) {
    ...
    GALGAS_lstring var_routineMangledName_6721 = extensionGetter_mangledName (var_signature_5198, enumerator_5077.current (HERE).getter_mFunctionName (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-func-EX.galgas", 199)) ;
    {
...
void extensionMethod_enterFunctionsInPropertyMap (const GALGAS_functionDeclarationListAST inObject,
                                                  ...
                                                  COMMA_UNUSED_LOCATION_ARGS) {
  const GALGAS_functionDeclarationListAST temp_0 = inObject ;
  cEnumerator_functionDeclarationListAST enumerator_8220 (temp_0, kENUMERATION_UP) ;
  while (enumerator_8220.hasCurrentObject ()) {
    GALGAS_stringset var_attributeSet_8269 = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("declaration-func-EX.galgas", 240)) ;
    cEnumerator_lstringlist enumerator_8327 (enumerator_8220.current (HERE).getter_mFunctionAttributeList (HERE), kENUMERATION_UP) ;
    while (enumerator_8327.hasCurrentObject ()) {
      var_attributeSet_8269.addAssign_operation (enumerator_8327.current (HERE).getter_mValue (HERE).getter_string (HERE)  COMMA_SOURCE_FILE ("declaration-func-EX.galgas", 242)) ;
      enumerator_8327.gotoNextObject () ;
    }
    GALGAS_bool var_exportedFunction_8410 = var_attributeSet_8269.getter_hasKey (function_exportedAttribute (inCompiler COMMA_SOURCE_FILE ("declaration-func-EX.galgas", 244)) COMMA_SOURCE_FILE ("declaration-func-EX.galgas", 244)) ;
    GALGAS_routineTypedSignature var_signature_8574 ;
    {
    routine_routineTypedSignature (ioArgument_ioContext.mProperty_mTypeMap, enumerator_8220.current (HERE).getter_mFunctionFormalArgumentList (HERE), var_signature_8574, inCompiler  COMMA_SOURCE_FILE ("declaration-func-EX.galgas", 246)) ;
    }
    GALGAS_unifiedTypeMap_2D_proxy var_returnTypeProxy_8715 ;
    {
    GALGAS_unifiedTypeMap_2D_proxy::class_method_makeOptionalProxy (ioArgument_ioContext.mProperty_mTypeMap, enumerator_8220.current (HERE).getter_mFunctionReturnTypeName (HERE), var_returnTypeProxy_8715 COMMA_SOURCE_FILE ("declaration-func-EX.galgas", 248)) ;
    }
    GALGAS_lstring var_functionLLVMName_8771 = function_routineMangledNameFromAST (constinArgument_inReceiverLLVMBaseTypeName, enumerator_8220.current (HERE).getter_mFunctionName (HERE), enumerator_8220.current (HERE).getter_mFunctionFormalArgumentList (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-func-EX.galgas", 250)) ;
    GALGAS_bool var_warnIfUnused_8961 = GALGAS_bool (true) ;
    GALGAS_routineAttributes var_functionAttributes_8995 = GALGAS_routineAttributes::constructor_none (SOURCE_FILE ("declaration-func-EX.galgas", 257)) ;
    cEnumerator_lstringlist enumerator_9076 (enumerator_8220.current (HERE).getter_mFunctionAttributeList (HERE), kENUMERATION_UP) ;
    while (enumerator_9076.hasCurrentObject ()) {
      enumGalgasBool test_1 = kBoolTrue ;
      if (kBoolTrue == test_1) {
        test_1 = GALGAS_bool (kIsEqual, enumerator_9076.current_mValue (HERE).getter_string (HERE).objectCompare (function_noUnusedWarningAttribute (inCompiler COMMA_SOURCE_FILE ("declaration-func-EX.galgas", 259)))).boolEnum () ;
        if (kBoolTrue == test_1) {
          enumGalgasBool test_2 = kBoolTrue ;
          if (kBoolTrue == test_2) {
            test_2 = var_warnIfUnused_8961.operator_not (SOURCE_FILE ("declaration-func-EX.galgas", 260)).boolEnum () ;
            if (kBoolTrue == test_2) {
              TC_Array <C_FixItDescription> fixItArray3 ;
              inCompiler->emitSemanticError (enumerator_9076.current_mValue (HERE).getter_location (SOURCE_FILE ("declaration-func-EX.galgas", 261)), GALGAS_string ("duplicated @").add_operation (function_noUnusedWarningAttribute (inCompiler COMMA_SOURCE_FILE ("declaration-func-EX.galgas", 261)), inCompiler COMMA_SOURCE_FILE ("declaration-func-EX.galgas", 261)).add_operation (GALGAS_string (" attribute"), inCompiler COMMA_SOURCE_FILE ("declaration-func-EX.galgas", 261)), fixItArray3  COMMA_SOURCE_FILE ("declaration-func-EX.galgas", 261)) ;
            }
          }
          var_warnIfUnused_8961 = GALGAS_bool (false) ;
        }
      }
      if (kBoolFalse == test_1) {
        enumGalgasBool test_4 = kBoolTrue ;
        if (kBoolTrue == test_4) {
          test_4 = GALGAS_bool (kIsEqual, enumerator_9076.current_mValue (HERE).getter_string (HERE).objectCompare (function_mutatingAttribute (inCompiler COMMA_SOURCE_FILE ("declaration-func-EX.galgas", 264)))).boolEnum () ;
          if (kBoolTrue == test_4) {
            enumGalgasBool test_5 = kBoolTrue ;
            if (kBoolTrue == test_5) {
              test_5 = var_functionAttributes_8995.getter_mutating (SOURCE_FILE ("declaration-func-EX.galgas", 265)).boolEnum () ;
              if (kBoolTrue == test_5) {
                TC_Array <C_FixItDescription> fixItArray6 ;
            ...
            var_functionAttributes_8995 = var_functionAttributes_8995.operator_or (GALGAS_routineAttributes::constructor_mutating (SOURCE_FILE ("declaration-func-EX.galgas", 268)) COMMA_SOURCE_FILE ("declaration-func-EX.galgas", 268)) ;
          }
        }
        if (kBoolFalse == test_4) {
    ...
    GALGAS_routineLLVMNameDict var_routineLLVMNameDict_9801 = extensionGetter_routineLLVMDictionaryForFunction (enumerator_8220.current (HERE).getter_mMode (HERE), var_functionLLVMName_8771.getter_string (SOURCE_FILE ("declaration-func-EX.galgas", 275)), inCompiler COMMA_SOURCE_FILE ("declaration-func-EX.galgas", 275)) ;
    GALGAS_lstring var_routineMangledName_9898 = extensionGetter_mangledName (var_signature_8574, enumerator_8220.current (HERE).getter_mFunctionName (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-func-EX.galgas", 276)) ;
    {
    ioArgument_ioRoutineMapCTXT.setter_insertKey (var_routineMangledName_9898, enumerator_8220.current (HERE).getter_mPublicFunction (HERE), var_signature_8574, var_returnTypeProxy_8715, var_routineLLVMNameDict_9801, var_exportedFunction_8410, enumerator_8220.current (HERE).getter_mMode (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-func-EX.galgas", 277)) ;
    }
    ioArgument_ioDecoratedRoutineList.addAssign_operation (constinArgument_inReceiverTypeName, enumerator_8220.current (HERE).getter_mMode (HERE), GALGAS_bool (false), GALGAS_routineKind::constructor_function (SOURCE_FILE ("declaration-func-EX.galgas", 290)), var_warnIfUnused_8961, GALGAS_bool (false), var_functionAttributes_8995, var_functionLLVMName_8771, enumerator_8220.current (HERE).getter_mFunctionFormalArgumentList (HERE), GALGAS_bool (true), enumerator_8220.current (HERE).getter_mFunctionInstructionList (HERE), enumerator_8220.current (HERE).getter_mEndOfFunctionDeclaration (HERE), enumerator_8220.current (HERE).getter_mFunctionReturnTypeName (HERE)  COMMA_SOURCE_FILE ("declaration-func-EX.galgas", 286)) ;
...
void extensionSetter_addFunctionWithoutArgument (GALGAS_routineMapCTXT & ioObject,
  ...
  GALGAS_routineFormalArgumentListAST var_formalArguments_12775 = GALGAS_routineFormalArgumentListAST::constructor_emptyList (SOURCE_FILE ("declaration-func-EX.galgas", 353)) ;
  GALGAS_lstring var_routineMangledName_12805 = GALGAS_lstring::constructor_new (constinArgument_inMethodName.getter_string (HERE).add_operation (extensionGetter_routineSignature (var_formalArguments_12775, constinArgument_inMethodName.getter_location (SOURCE_FILE ("declaration-func-EX.galgas", 355)), inCompiler COMMA_SOURCE_FILE ("declaration-func-EX.galgas", 355)).getter_string (SOURCE_FILE ("declaration-func-EX.galgas", 355)), inCompiler COMMA_SOURCE_FILE ("declaration-func-EX.galgas", 355)), constinArgument_inMethodName.getter_location (SOURCE_FILE ("declaration-func-EX.galgas", 356))  COMMA_SOURCE_FILE ("declaration-func-EX.galgas", 354)) ;
  outArgument_outRoutineLLVMName = function_routineMangledNameFromAST (constinArgument_inLLVMBaseTypeName, constinArgument_inMethodName, var_formalArguments_12775, inCompiler COMMA_SOURCE_FILE ("declaration-func-EX.galgas", 358)) ;
  GALGAS_routineLLVMNameDict var_modeDictionary_13043 = extensionGetter_routineLLVMDictionaryForFunction (constinArgument_inMode, outArgument_outRoutineLLVMName.getter_string (SOURCE_FILE ("declaration-func-EX.galgas", 359)), inCompiler COMMA_SOURCE_FILE ("declaration-func-EX.galgas", 359)) ;
  {
  ioObject.setter_insertKey (var_routineMangledName_12805, GALGAS_bool (true), GALGAS_routineTypedSignature::constructor_emptyList (SOURCE_FILE ("declaration-func-EX.galgas", 363)), constinArgument_inResultType, var_modeDictionary_13043, GALGAS_bool (false), constinArgument_inMode, inCompiler COMMA_SOURCE_FILE ("declaration-func-EX.galgas", 360)) ;
  }
}
...
void extensionSetter_addFunctionWithInputArgument (GALGAS_routineMapCTXT & ioObject,
                                                   ...
                                                   COMMA_UNUSED_LOCATION_ARGS) {
  outArgument_outRoutineLLVMName.drop () ; // Release 'out' argument
  GALGAS_routineFormalArgumentListAST temp_0 = GALGAS_routineFormalArgumentListAST::constructor_emptyList (SOURCE_FILE ("declaration-func-EX.galgas", 388)) ;
  temp_0.addAssign_operation (GALGAS_procFormalArgumentPassingMode::constructor_input (SOURCE_FILE ("declaration-func-EX.galgas", 385)), constinArgument_inInputSelector.getter_nowhere (SOURCE_FILE ("declaration-func-EX.galgas", 386)), constinArgument_inInputArgumentTypeProxy.getter_key (inCompiler COMMA_SOURCE_FILE ("declaration-func-EX.galgas", 387)).getter_nowhere (SOURCE_FILE ("declaration-func-EX.galgas", 387)), constinArgument_inInputArgumentName.getter_nowhere (SOURCE_FILE ("declaration-func-EX.galgas", 388))  COMMA_SOURCE_FILE ("declaration-func-EX.galgas", 388)) ;
  GALGAS_routineFormalArgumentListAST var_argumentList_13876 = temp_0 ;
  GALGAS_routineTypedSignature var_signature_14113 ;
  {
  routine_routineTypedSignature (ioArgument_ioContext.mProperty_mTypeMap, var_argumentList_13876, var_signature_14113, inCompiler  COMMA_SOURCE_FILE ("declaration-func-EX.galgas", 390)) ;
  }
  GALGAS_lstring var_routineMangledName_14139 = GALGAS_lstring::constructor_new (constinArgument_inMethodName.getter_string (HERE).add_operation (extensionGetter_routineSignature (var_argumentList_13876, constinArgument_inMethodName.getter_location (SOURCE_FILE ("declaration-func-EX.galgas", 392)), inCompiler COMMA_SOURCE_FILE ("declaration-func-EX.galgas", 392)).getter_string (SOURCE_FILE ("declaration-func-EX.galgas", 392)), inCompiler COMMA_SOURCE_FILE ("declaration-func-EX.galgas", 392)), constinArgument_inMethodName.getter_location (SOURCE_FILE ("declaration-func-EX.galgas", 393))  COMMA_SOURCE_FILE ("declaration-func-EX.galgas", 391)) ;
  outArgument_outRoutineLLVMName = function_routineMangledNameFromAST (constinArgument_inLLVMBaseTypeName, constinArgument_inMethodName, var_argumentList_13876, inCompiler COMMA_SOURCE_FILE ("declaration-func-EX.galgas", 395)) ;
  GALGAS_routineLLVMNameDict var_modeDictionary_14371 = extensionGetter_routineLLVMDictionaryForFunction (constinArgument_inMode, outArgument_outRoutineLLVMName.getter_string (SOURCE_FILE ("declaration-func-EX.galgas", 396)), inCompiler COMMA_SOURCE_FILE ("declaration-func-EX.galgas", 396)) ;
  {
  ioObject.setter_insertKey (var_routineMangledName_14139, GALGAS_bool (true), var_signature_14113, constinArgument_inResultType, var_modeDictionary_14371, GALGAS_bool (false), constinArgument_inMode, inCompiler COMMA_SOURCE_FILE ("declaration-func-EX.galgas", 397)) ;
  }
}
...
void extensionSetter_addFunctionWithTwoInputArguments (GALGAS_routineMapCTXT & ioObject,
                                                       ...
                                                       COMMA_UNUSED_LOCATION_ARGS) {
  outArgument_outRoutineLLVMName.drop () ; // Release 'out' argument
  GALGAS_routineFormalArgumentListAST temp_0 = GALGAS_routineFormalArgumentListAST::constructor_emptyList (SOURCE_FILE ("declaration-func-EX.galgas", 433)) ;
  temp_0.addAssign_operation (GALGAS_procFormalArgumentPassingMode::constructor_input (SOURCE_FILE ("declaration-func-EX.galgas", 425)), constinArgument_inInputSelector_31_.getter_nowhere (SOURCE_FILE ("declaration-func-EX.galgas", 426)), constinArgument_inInputArgumentTypeProxy_31_.getter_key (inCompiler COMMA_SOURCE_FILE ("declaration-func-EX.galgas", 427)).getter_nowhere (SOURCE_FILE ("declaration-func-EX.galgas", 427)), constinArgument_inInputArgumentName_31_.getter_nowhere (SOURCE_FILE ("declaration-func-EX.galgas", 428))  COMMA_SOURCE_FILE ("declaration-func-EX.galgas", 428)) ;
  temp_0.addAssign_operation (GALGAS_procFormalArgumentPassingMode::constructor_input (SOURCE_FILE ("declaration-func-EX.galgas", 430)), constinArgument_inInputSelector_32_.getter_nowhere (SOURCE_FILE ("declaration-func-EX.galgas", 431)), constinArgument_inInputArgumentTypeProxy_32_.getter_key (inCompiler COMMA_SOURCE_FILE ("declaration-func-EX.galgas", 432)).getter_nowhere (SOURCE_FILE ("declaration-func-EX.galgas", 432)), constinArgument_inInputArgumentName_32_.getter_nowhere (SOURCE_FILE ("declaration-func-EX.galgas", 433))  COMMA_SOURCE_FILE ("declaration-func-EX.galgas", 433)) ;
  GALGAS_routineFormalArgumentListAST var_argumentList_15411 = temp_0 ;
  outArgument_outRoutineLLVMName = function_routineMangledNameFromAST (constinArgument_inLLVMBaseTypeName, GALGAS_lstring::constructor_new (constinArgument_inMethodName.getter_string (SOURCE_FILE ("declaration-func-EX.galgas", 437)), GALGAS_location::constructor_nowhere (SOURCE_FILE ("declaration-func-EX.galgas", 437))  COMMA_SOURCE_FILE ("declaration-func-EX.galgas", 437)), var_argumentList_15411, inCompiler COMMA_SOURCE_FILE ("declaration-func-EX.galgas", 435)) ;
  GALGAS_routineTypedSignature var_signature_15915 ;
  {
  routine_routineTypedSignature (ioArgument_ioContext.mProperty_mTypeMap, var_argumentList_15411, var_signature_15915, inCompiler  COMMA_SOURCE_FILE ("declaration-func-EX.galgas", 440)) ;
  }
  GALGAS_lstring var_routineMangledName_15941 = GALGAS_lstring::constructor_new (constinArgument_inMethodName.getter_string (HERE).add_operation (extensionGetter_routineSignature (var_argumentList_15411, constinArgument_inMethodName.getter_location (SOURCE_FILE ("declaration-func-EX.galgas", 442)), inCompiler COMMA_SOURCE_FILE ("declaration-func-EX.galgas", 442)).getter_string (SOURCE_FILE ("declaration-func-EX.galgas", 442)), inCompiler COMMA_SOURCE_FILE ("declaration-func-EX.galgas", 442)), constinArgument_inMethodName.getter_location (SOURCE_FILE ("declaration-func-EX.galgas", 443))  COMMA_SOURCE_FILE ("declaration-func-EX.galgas", 441)) ;
  GALGAS_routineLLVMNameDict var_modeDictionary_16074 = extensionGetter_routineLLVMDictionaryForFunction (constinArgument_inMode, outArgument_outRoutineLLVMName.getter_string (SOURCE_FILE ("declaration-func-EX.galgas", 445)), inCompiler COMMA_SOURCE_FILE ("declaration-func-EX.galgas", 445)) ;
  {
  ioObject.setter_insertKey (var_routineMangledName_15941, GALGAS_bool (true), var_signature_15915, constinArgument_inResultType, var_modeDictionary_16074, GALGAS_bool (false), constinArgument_inMode, inCompiler COMMA_SOURCE_FILE ("declaration-func-EX.galgas", 446)) ;
  }
}
