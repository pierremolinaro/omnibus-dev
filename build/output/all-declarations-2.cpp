...
void extensionMethod_generateLLVMForStaticLists (const GALGAS_staticListInitializationMap inObject,
                                                 ...
                                                 C_Compiler * inCompiler
                                                 COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_bool var_first_23130 = GALGAS_bool (true) ;
  const GALGAS_staticListInitializationMap temp_0 = inObject ;
  cEnumerator_staticListInitializationMap enumerator_23166 (temp_0, kENUMERATION_UP) ;
  while (enumerator_23166.hasCurrentObject ()) {
    const enumGalgasBool test_1 = constinArgument_inUsefulStaticArrayMap.getter_hasKey (enumerator_23166.current_lkey (HERE).getter_string (SOURCE_FILE ("declaration-static-list.galgas", 543)) COMMA_SOURCE_FILE ("declaration-static-list.galgas", 543)).boolEnum () ;
    if (kBoolTrue == test_1) {
      const enumGalgasBool test_2 = var_first_23130.boolEnum () ;
      if (kBoolTrue == test_2) {
        var_first_23130 = GALGAS_bool (false) ;
      ...
      ioArgument_ioLLVMcode.plusAssign_operation(function_llvmNameForGlobalVariable (enumerator_23166.current_lkey (HERE).getter_string (SOURCE_FILE ("declaration-static-list.galgas", 548)), inCompiler COMMA_SOURCE_FILE ("declaration-static-list.galgas", 548)).add_operation (GALGAS_string (" = private unnamed_addr constant ["), inCompiler COMMA_SOURCE_FILE ("declaration-static-list.galgas", 548)), inCompiler  COMMA_SOURCE_FILE ("declaration-static-list.galgas", 548)) ;
      ioArgument_ioLLVMcode.plusAssign_operation(enumerator_23166.current_mInitializationList (HERE).getter_length (SOURCE_FILE ("declaration-static-list.galgas", 549)).getter_string (SOURCE_FILE ("declaration-static-list.galgas", 549)).add_operation (GALGAS_string (" x %"), inCompiler COMMA_SOURCE_FILE ("declaration-static-list.galgas", 549)).add_operation (function_llvmNameForStaticListElementType (enumerator_23166.current_lkey (HERE).getter_string (HERE).getter_nowhere (SOURCE_FILE ("declaration-static-list.galgas", 549)), inCompiler COMMA_SOURCE_FILE ("declaration-static-list.galgas", 549)).getter_string (SOURCE_FILE ("declaration-static-list.galgas", 549)), inCompiler COMMA_SOURCE_FILE ("declaration-static-list.galgas", 549)).add_operation (GALGAS_string ("] [\n"), inCompiler COMMA_SOURCE_FILE ("declaration-static-list.galgas", 549)), inCompiler  COMMA_SOURCE_FILE ("declaration-static-list.galgas", 549)) ;
      cEnumerator_stringlist enumerator_23569 (enumerator_23166.current_mInitializationList (HERE), kENUMERATION_UP) ;
      while (enumerator_23569.hasCurrentObject ()) {
        ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  %").add_operation (function_llvmNameForStaticListElementType (enumerator_23166.current_lkey (HERE).getter_string (HERE).getter_nowhere (SOURCE_FILE ("declaration-static-list.galgas", 552)), inCompiler COMMA_SOURCE_FILE ("declaration-static-list.galgas", 552)).getter_string (SOURCE_FILE ("declaration-static-list.galgas", 552)), inCompiler COMMA_SOURCE_FILE ("declaration-static-list.galgas", 552)).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("declaration-static-list.galgas", 552)).add_operation (enumerator_23569.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-static-list.galgas", 552)), inCompiler  COMMA_SOURCE_FILE ("declaration-static-list.galgas", 552)) ;
        if (enumerator_23569.hasNextObject ()) {
...
void extensionMethod_enterInContext (const GALGAS_taskListAST inObject,
                                     ...
                                     COMMA_UNUSED_LOCATION_ARGS) {
  const GALGAS_taskListAST temp_0 = inObject ;
  GALGAS_taskListAST var_taskList_7461 = temp_0 ;
  GALGAS_taskListAST var_sortedTaskList_7498 = GALGAS_taskListAST::constructor_emptyList (SOURCE_FILE ("task-declaration.galgas", 204)) ;
  GALGAS_stringset var_handledTaskSet_7531 = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("task-declaration.galgas", 205)) ;
  GALGAS_bool var_continue_7551 = GALGAS_bool (true) ;
  if (var_taskList_7461.getter_length (SOURCE_FILE ("task-declaration.galgas", 207)).isValid ()) {
    uint32_t variant_7565 = var_taskList_7461.getter_length (SOURCE_FILE ("task-declaration.galgas", 207)).uintValue () ;
    bool loop_7565 = true ;
    while (loop_7565) {
      GALGAS_bool test_1 = var_continue_7551 ;
      if (kBoolTrue == test_1.boolEnum ()) {
        test_1 = GALGAS_bool (kIsStrictSup, var_taskList_7461.getter_length (SOURCE_FILE ("task-declaration.galgas", 207)).objectCompare (GALGAS_uint ((uint32_t) 0U))) ;
      }
      loop_7565 = test_1.isValid () ;
      if (loop_7565) {
        loop_7565 = test_1.boolValue () ;
      }
      ...
      if (loop_7565) {
        variant_7565 -- ;
        var_continue_7551 = GALGAS_bool (false) ;
        GALGAS_taskListAST var_candidateTaskList_7686 = GALGAS_taskListAST::constructor_emptyList (SOURCE_FILE ("task-declaration.galgas", 209)) ;
        GALGAS_uint var_idx_7703 = GALGAS_uint ((uint32_t) 0U) ;
        cEnumerator_taskListAST enumerator_7732 (var_taskList_7461, kENUMERATION_UP) ;
        while (enumerator_7732.hasCurrentObject ()) {
          GALGAS_bool var_allPrecedenceDefined_7766 = GALGAS_bool (true) ;
          cEnumerator_lstringlist enumerator_7831 (enumerator_7732.current (HERE).getter_mLowerPriorityTaskList (HERE), kENUMERATION_UP) ;
          bool bool_2 = var_allPrecedenceDefined_7766.isValidAndTrue () ;
          if (enumerator_7831.hasCurrentObject () && bool_2) {
            while (enumerator_7831.hasCurrentObject () && bool_2) {
              var_allPrecedenceDefined_7766 = var_handledTaskSet_7531.getter_hasKey (enumerator_7831.current_mValue (HERE).getter_string (HERE) COMMA_SOURCE_FILE ("task-declaration.galgas", 214)) ;
              enumerator_7831.gotoNextObject () ;
              if (enumerator_7831.hasCurrentObject ()) {
                bool_2 = var_allPrecedenceDefined_7766.isValidAndTrue () ;
              }
            }
          }
          const enumGalgasBool test_3 = var_allPrecedenceDefined_7766.boolEnum () ;
          if (kBoolTrue == test_3) {
            var_candidateTaskList_7686.addAssign_operation (enumerator_7732.current (HERE).getter_mTaskName (HERE), enumerator_7732.current (HERE).getter_mLowerPriorityTaskList (HERE), enumerator_7732.current (HERE).getter_mStackSize (HERE), enumerator_7732.current (HERE).getter_mVarList (HERE), enumerator_7732.current (HERE).getter_mTaskFunctionList (HERE), enumerator_7732.current (HERE).getter_mTaskSetupListAST (HERE), enumerator_7732.current (HERE).getter_mTaskActivateListAST (HERE), enumerator_7732.current (HERE).getter_mTaskDeactivateListAST (HERE), enumerator_7732.current (HERE).getter_mGuardedCommandList (HERE), enumerator_7732.current (HERE).getter_mEndOfTaskDeclaration (HERE), enumerator_7732.current (HERE).getter_mActivate (HERE)  COMMA_SOURCE_FILE ("task-declaration.galgas", 217)) ;
            var_continue_7551 = GALGAS_bool (true) ;
            {
            GALGAS_lstring joker_8434_11 ; // Joker input parameter
            GALGAS_lstringlist joker_8434_10 ; // Joker input parameter
            GALGAS_lbigint joker_8434_9 ; // Joker input parameter
            GALGAS_structurePropertyListAST joker_8434_8 ; // Joker input parameter
            GALGAS_functionDeclarationListAST joker_8434_7 ; // Joker input parameter
            GALGAS_taskSetupListAST joker_8434_6 ; // Joker input parameter
            GALGAS_taskSetupListAST joker_8434_5 ; // Joker input parameter
            GALGAS_taskSetupListAST joker_8434_4 ; // Joker input parameter
            GALGAS_syncInstructionBranchListAST joker_8434_3 ; // Joker input parameter
            GALGAS_location joker_8434_2 ; // Joker input parameter
            GALGAS_bool joker_8434_1 ; // Joker input parameter
            var_taskList_7461.setter_removeAtIndex (joker_8434_11, joker_8434_10, joker_8434_9, joker_8434_8, joker_8434_7, joker_8434_6, joker_8434_5, joker_8434_4, joker_8434_3, joker_8434_2, joker_8434_1, var_idx_7703, inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 230)) ;
            }
          }else if (kBoolFalse == test_3) {
            var_idx_7703 = var_idx_7703.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 232)) ;
          }
        ...
        if (kBoolTrue == test_4.boolEnum ()) {
          test_4 = GALGAS_bool (kIsStrictSup, var_candidateTaskList_7686.getter_length (SOURCE_FILE ("task-declaration.galgas", 235)).objectCompare (GALGAS_uint ((uint32_t) 1U))) ;
        }
        const enumGalgasBool test_5 = test_4.boolEnum () ;
        if (kBoolTrue == test_5) {
          cEnumerator_taskListAST enumerator_8629 (var_candidateTaskList_7686, kENUMERATION_UP) ;
          while (enumerator_8629.hasCurrentObject ()) {
            TC_Array <C_FixItDescription> fixItArray6 ;
            inCompiler->emitSemanticError (enumerator_8629.current (HERE).getter_mTaskName (HERE).getter_location (SOURCE_FILE ("task-declaration.galgas", 237)), GALGAS_string ("this task does not respect a strict priority order"), fixItArray6  COMMA_SOURCE_FILE ("task-declaration.galgas", 237)) ;
            enumerator_8629.gotoNextObject () ;
          }
        }
        const enumGalgasBool test_7 = GALGAS_bool (kIsStrictSup, var_candidateTaskList_7686.getter_length (SOURCE_FILE ("task-declaration.galgas", 240)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
        if (kBoolTrue == test_7) {
          var_continue_7551 = GALGAS_bool (true) ;
          cEnumerator_taskListAST enumerator_8835 (var_candidateTaskList_7686, kENUMERATION_UP) ;
          while (enumerator_8835.hasCurrentObject ()) {
            var_handledTaskSet_7531.addAssign_operation (enumerator_8835.current (HERE).getter_mTaskName (HERE).getter_string (HERE)  COMMA_SOURCE_FILE ("task-declaration.galgas", 243)) ;
            enumerator_8835.gotoNextObject () ;
          }
          var_sortedTaskList_7498.plusAssign_operation(var_candidateTaskList_7686, inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 245)) ;
        }
      }
    }
  }
  cEnumerator_taskListAST enumerator_9020 (var_taskList_7461, kENUMERATION_UP) ;
  while (enumerator_9020.hasCurrentObject ()) {
    TC_Array <C_FixItDescription> fixItArray8 ;
    inCompiler->emitSemanticError (enumerator_9020.current_mTaskName (HERE).getter_location (SOURCE_FILE ("task-declaration.galgas", 250)), GALGAS_string ("this task is out of priority order"), fixItArray8  COMMA_SOURCE_FILE ("task-declaration.galgas", 250)) ;
    enumerator_9020.gotoNextObject () ;
  }
  GALGAS_decoratedTaskList var_decoratedTaskList_9127 = GALGAS_decoratedTaskList::constructor_emptyList (SOURCE_FILE ("task-declaration.galgas", 253)) ;
  cEnumerator_taskListAST enumerator_9161 (var_sortedTaskList_7498, kENUMERATION_UP) ;
  while (enumerator_9161.hasCurrentObject ()) {
    GALGAS_propertyList var_propertyList_9217 = GALGAS_propertyList::constructor_emptyList (SOURCE_FILE ("task-declaration.galgas", 256)) ;
    GALGAS_propertyMap var_propertyMap_9251 = GALGAS_propertyMap::constructor_emptyMap (SOURCE_FILE ("task-declaration.galgas", 257)) ;
    GALGAS_sortedOperandIRList var_initialValueList_9298 = GALGAS_sortedOperandIRList::constructor_emptySortedList (SOURCE_FILE ("task-declaration.galgas", 258)) ;
    cEnumerator_structurePropertyListAST enumerator_9337 (enumerator_9161.current (HERE).getter_mVarList (HERE), kENUMERATION_UP) ;
    while (enumerator_9337.hasCurrentObject ()) {
      GALGAS_constructorSignature joker_9558 = GALGAS_constructorSignature::constructor_emptyList (SOURCE_FILE ("task-declaration.galgas", 267)) ;
      GALGAS_string joker_9570 = GALGAS_string::constructor_default (SOURCE_FILE ("task-declaration.galgas", 268)) ;
      GALGAS_bool joker_9582 = GALGAS_bool::constructor_default (SOURCE_FILE ("task-declaration.galgas", 269)) ;
      extensionMethod_enterPropertyInContext (enumerator_9337.current (HERE), enumerator_9161.current (HERE).getter_mTaskName (HERE), ioArgument_ioContext, ioArgument_ioStaticEntityMap, var_propertyList_9217, var_propertyMap_9251, var_initialValueList_9298, joker_9558, joker_9570, joker_9582, ioArgument_ioGlobalVariableIRList, inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 260)) ;
      enumerator_9337.gotoNextObject () ;
    }
    {
    extensionSetter_addFunctionWithoutArgument (var_propertyMap_9251, ioArgument_ioSubprogramInvocationGraph, enumerator_9161.current (HERE).getter_mTaskName (HERE).getter_string (SOURCE_FILE ("task-declaration.galgas", 276)), GALGAS_string ("activate"), GALGAS_bool (true), GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("task-declaration.galgas", 279)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 274)) ;
    }
    extensionMethod_enterFunctionsInPropertyMap (enumerator_9161.current (HERE).getter_mTaskFunctionList (HERE), enumerator_9161.current (HERE).getter_mTaskName (HERE).getter_string (SOURCE_FILE ("task-declaration.galgas", 283)), ioArgument_ioContext, var_propertyMap_9251, inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 283)) ;
    GALGAS_PLMType var_taskType_10152 = GALGAS_PLMType::constructor_new (var_propertyMap_9251, GALGAS_classConstantMap::constructor_emptyMap (SOURCE_FILE ("task-declaration.galgas", 287)), GALGAS_constructorMap::constructor_emptyMap (SOURCE_FILE ("task-declaration.galgas", 288)), GALGAS_guardMapForContext::constructor_emptyMap (SOURCE_FILE ("task-declaration.galgas", 289)), GALGAS_PLMTypeAttributes::constructor_none (SOURCE_FILE ("task-declaration.galgas", 290)), enumerator_9161.current (HERE).getter_mTaskName (HERE).getter_string (SOURCE_FILE ("task-declaration.galgas", 291)), GALGAS_typeKind::constructor_structure (var_propertyList_9217  COMMA_SOURCE_FILE ("task-declaration.galgas", 292)), enumerator_9161.current (HERE).getter_mTaskName (HERE).getter_string (SOURCE_FILE ("task-declaration.galgas", 293))  COMMA_SOURCE_FILE ("task-declaration.galgas", 285)) ;
    {
    ioArgument_ioContext.mProperty_mTypeMap.setter_insertType (enumerator_9161.current (HERE).getter_mTaskName (HERE), var_taskType_10152, ioArgument_ioContext.getter_mTypeMap (HERE).getter_count (SOURCE_FILE ("task-declaration.galgas", 298)), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 295)) ;
    }
    {
    ioArgument_ioContext.mProperty_mTaskMap.setter_insertKey (enumerator_9161.current (HERE).getter_mTaskName (HERE), var_taskType_10152, inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 301)) ;
    }
    {
    extensionSetter_insertTask (ioArgument_ioContext.mProperty_mValuedObjectMap, enumerator_9161.current (HERE).getter_mTaskName (HERE), var_taskType_10152, inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 302)) ;
    }
    ioArgument_ioContext.mProperty_mGlobalTaskVariableList.addAssign_operation (enumerator_9161.current (HERE).getter_mTaskName (HERE).getter_string (HERE), enumerator_9161.current (HERE).getter_mTaskName (HERE).getter_string (HERE), GALGAS_objectIR::constructor_llvmStructureValue (var_taskType_10152, var_initialValueList_9298  COMMA_SOURCE_FILE ("task-declaration.galgas", 306))  COMMA_SOURCE_FILE ("task-declaration.galgas", 303)) ;
    extensionMethod_enterFunctionInContext (enumerator_9161.current (HERE).getter_mTaskFunctionList (HERE), enumerator_9161.current (HERE).getter_mTaskName (HERE), ioArgument_ioContext, ioArgument_ioDecoratedRoutineList, inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 308)) ;
    var_decoratedTaskList_9127.addAssign_operation (enumerator_9161.current (HERE).getter_mTaskName (HERE), enumerator_9161.current (HERE).getter_mStackSize (HERE), enumerator_9161.current (HERE).getter_mVarList (HERE), enumerator_9161.current (HERE).getter_mTaskFunctionList (HERE), enumerator_9161.current (HERE).getter_mTaskSetupListAST (HERE), enumerator_9161.current (HERE).getter_mTaskActivateListAST (HERE), enumerator_9161.current (HERE).getter_mTaskDeactivateListAST (HERE), enumerator_9161.current (HERE).getter_mGuardedCommandList (HERE), enumerator_9161.current (HERE).getter_mEndOfTaskDeclaration (HERE), enumerator_9161.current (HERE).getter_mActivate (HERE)  COMMA_SOURCE_FILE ("task-declaration.galgas", 314)) ;
    enumerator_9161.gotoNextObject () ;
  }
  ioArgument_ioDecoratedDeclarationList.addAssign_operation (GALGAS_decoratedTaskListDeclaration::constructor_new (var_decoratedTaskList_9127  COMMA_SOURCE_FILE ("task-declaration.galgas", 327))  COMMA_SOURCE_FILE ("task-declaration.galgas", 327)) ;
}
...
void extensionMethod_generateCode (const GALGAS_taskMapIR inObject,
  ...
  GALGAS_string var_activateTaskImplementationName_23415 = function_llvmNameForServiceImplementation (function_llvmNameForActivateTask (inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 637)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 637)) ;
  GALGAS_string var_activateTaskCallName_23507 = function_llvmNameForServiceCall (function_llvmNameForActivateTask (inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 638)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 638)) ;
  ioArgument_ioServiceList.addAssign_operation (var_activateTaskCallName_23507, var_activateTaskImplementationName_23415, GALGAS_bool (false)  COMMA_SOURCE_FILE ("task-declaration.galgas", 639)) ;
  ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("declare void @").add_operation (var_activateTaskCallName_23507, inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 640)).add_operation (GALGAS_string (" (i8 %inTaskIndex) nounwind\n"
  ...
  GALGAS_string var_waitForActivationImplementationName_23892 = function_llvmNameForServiceImplementation (function_llvmNameForTaskWaitsForActivation (inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 643)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 643)) ;
  GALGAS_string var_waitForActivationCallName_23999 = function_llvmNameForServiceCall (function_llvmNameForTaskWaitsForActivation (inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 644)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 644)) ;
  ioArgument_ioServiceList.addAssign_operation (var_waitForActivationCallName_23999, var_waitForActivationImplementationName_23892, GALGAS_bool (false)  COMMA_SOURCE_FILE ("task-declaration.galgas", 645)) ;
  ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("declare void @").add_operation (var_waitForActivationCallName_23999, inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 646)).add_operation (GALGAS_string (" () nounwind\n"
  ...
  cEnumerator_globalTaskVariableList enumerator_24415 (constinArgument_inGenerationContext.getter_mGlobalTaskVariableList (HERE), kENUMERATION_UP) ;
  while (enumerator_24415.hasCurrentObject ()) {
    ioArgument_ioLLVMcode.plusAssign_operation(function_llvmNameForGlobalVariable (enumerator_24415.current_mTaskName (HERE), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 650)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 650)) ;
    ...
    ioArgument_ioLLVMcode.plusAssign_operation(enumerator_24415.current_mTaskTypeName (HERE).getter_assemblerRepresentation (SOURCE_FILE ("task-declaration.galgas", 652)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 652)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string (" ").add_operation (extensionGetter_llvmValue (enumerator_24415.current_mInitialValue (HERE), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 653)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 653)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 653)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 653)) ;
    enumerator_24415.gotoNextObject () ;
  }
  ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("\n"), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 655)) ;
  GALGAS_taskSortedListIR var_orderedTaskList_24728 = GALGAS_taskSortedListIR::constructor_emptySortedList (SOURCE_FILE ("task-declaration.galgas", 657)) ;
  const GALGAS_taskMapIR temp_0 = inObject ;
  cEnumerator_taskMapIR enumerator_24752 (temp_0, kENUMERATION_UP) ;
  while (enumerator_24752.hasCurrentObject ()) {
    var_orderedTaskList_24728.addAssign_operation (enumerator_24752.current (HERE).getter_lkey (HERE).getter_string (HERE), enumerator_24752.current (HERE).getter_mPriority (HERE), enumerator_24752.current (HERE).getter_mStackSize (HERE), enumerator_24752.current (HERE).getter_mSetupAllocaList (HERE), enumerator_24752.current (HERE).getter_mSetupInstructionListIR (HERE), enumerator_24752.current (HERE).getter_mActivateAllocaList (HERE), enumerator_24752.current (HERE).getter_mActivateInstructionListIR (HERE), enumerator_24752.current (HERE).getter_mDeactivateAllocaList (HERE), enumerator_24752.current (HERE).getter_mDeactivateInstructionListIR (HERE), enumerator_24752.current (HERE).getter_mTaskNameStringIndex (HERE), enumerator_24752.current (HERE).getter_mActivate (HERE)  COMMA_SOURCE_FILE ("task-declaration.galgas", 659)) ;
  ...
  while (enumerator_25459.hasCurrentObject ()) {
    ...
    GALGAS_lstring var_activateFunctionName_26054 = function_routineMangledNameFromAST (enumerator_25459.current (HERE).getter_mTaskName (HERE), GALGAS_string ("activate").getter_nowhere (SOURCE_FILE ("task-declaration.galgas", 687)), GALGAS_routineFormalArgumentListAST::constructor_emptyList (SOURCE_FILE ("task-declaration.galgas", 688)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 685)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("define internal void @").add_operation (function_llvmNameForFunction (var_activateFunctionName_26054.getter_string (SOURCE_FILE ("task-declaration.galgas", 690)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 690)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 690)).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 690)).add_operation (var_formalArgument_25888, inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 690)).add_operation (function_llvmAttributeFunction (inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 690)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 690)).add_operation (GALGAS_string ("{\n"), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 690)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 690)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  call void @").add_operation (var_activateTaskCallName_23507, inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 691)).add_operation (GALGAS_string (" (i8 "), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 691)).add_operation (index_25435.getter_string (SOURCE_FILE ("task-declaration.galgas", 691)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 691)).add_operation (GALGAS_string (")\n"), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 691)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 691)) ;
    ...
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("define internal void ").add_operation (function_setupNameForTaskType (enumerator_25459.current (HERE).getter_mTaskName (HERE), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 697)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 697)).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 697)).add_operation (var_formalArgument_25888, inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 697)).add_operation (function_llvmAttributeFunction (inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 697)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 697)).add_operation (GALGAS_string ("{\n"), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 697)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 697)) ;
    extensionMethod_generateAllocaList (enumerator_25459.current (HERE).getter_mSetupAllocaList (HERE), ioArgument_ioLLVMcode, inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 698)) ;
    extensionMethod_instructionListLLVMCode (enumerator_25459.current (HERE).getter_mSetupInstructionListIR (HERE), ioArgument_ioLLVMcode, constinArgument_inGenerationContext, ioArgument_ioGenerationAdds, inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 699)) ;
    ...
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("define internal void ").add_operation (function_activateNameForTaskType (enumerator_25459.current (HERE).getter_mTaskName (HERE), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 705)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 705)).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 705)).add_operation (var_formalArgument_25888, inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 705)).add_operation (function_llvmAttributeFunction (inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 705)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 705)).add_operation (GALGAS_string ("{\n"), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 705)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 705)) ;
    extensionMethod_generateAllocaList (enumerator_25459.current (HERE).getter_mActivateAllocaList (HERE), ioArgument_ioLLVMcode, inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 706)) ;
    extensionMethod_instructionListLLVMCode (enumerator_25459.current (HERE).getter_mActivateInstructionListIR (HERE), ioArgument_ioLLVMcode, constinArgument_inGenerationContext, ioArgument_ioGenerationAdds, inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 707)) ;
    ...
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("define internal void ").add_operation (function_deactivateNameForTaskType (enumerator_25459.current (HERE).getter_mTaskName (HERE), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 713)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 713)).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 713)).add_operation (var_formalArgument_25888, inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 713)).add_operation (function_llvmAttributeFunction (inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 713)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 713)).add_operation (GALGAS_string ("{\n"), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 713)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 713)) ;
    extensionMethod_generateAllocaList (enumerator_25459.current (HERE).getter_mDeactivateAllocaList (HERE), ioArgument_ioLLVMcode, inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 714)) ;
    extensionMethod_instructionListLLVMCode (enumerator_25459.current (HERE).getter_mDeactivateInstructionListIR (HERE), ioArgument_ioLLVMcode, constinArgument_inGenerationContext, ioArgument_ioGenerationAdds, inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 715)) ;
    ...
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("define internal void ").add_operation (function_mainRoutineNameForTask (enumerator_25459.current (HERE).getter_mTaskName (HERE), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 721)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 721)).add_operation (GALGAS_string (" ()"), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 721)).add_operation (function_llvmAttributeFunction (inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 721)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 721)).add_operation (GALGAS_string ("noreturn {\n"), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 721)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 721)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  call void ").add_operation (function_setupNameForTaskType (enumerator_25459.current (HERE).getter_mTaskName (HERE), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 722)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 722)).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 722)).add_operation (var_effectiveParameter_25779, inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 722)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 722)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 722)) ;
    GALGAS_string var_taskLoopLabel_28193 = GALGAS_string ("loop.").add_operation (enumerator_25459.current (HERE).getter_mTaskName (HERE).getter_assemblerRepresentation (SOURCE_FILE ("task-declaration.galgas", 723)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 723)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  br label %").add_operation (var_taskLoopLabel_28193, inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 724)).add_operation (GALGAS_string ("\n"
      "\n"), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 724)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 724)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(var_taskLoopLabel_28193.add_operation (GALGAS_string (":\n"), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 725)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 725)) ;
    const enumGalgasBool test_1 = enumerator_25459.current (HERE).getter_mActivate (HERE).operator_not (SOURCE_FILE ("task-declaration.galgas", 726)).boolEnum () ;
    if (kBoolTrue == test_1) {
      ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  call void @").add_operation (var_waitForActivationCallName_23999, inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 727)).add_operation (GALGAS_string (" ()\n"), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 727)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 727)) ;
    }
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  call void ").add_operation (function_activateNameForTaskType (enumerator_25459.current (HERE).getter_mTaskName (HERE), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 729)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 729)).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 729)).add_operation (var_effectiveParameter_25779, inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 729)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 729)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 729)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  call void @func.").add_operation (function_llvmNameForFunction (enumerator_25459.current (HERE).getter_mTaskName (HERE).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 730)).add_operation (function_llvmNameForTaskLoopFunction (inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 730)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 730)).add_operation (GALGAS_string ("()"), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 730)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 730)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 730)).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 730)).add_operation (var_effectiveParameter_25779, inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 730)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 730)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 730)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  call void ").add_operation (function_deactivateNameForTaskType (enumerator_25459.current (HERE).getter_mTaskName (HERE), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 731)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 731)).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 731)).add_operation (var_effectiveParameter_25779, inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 731)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 731)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 731)) ;
    const enumGalgasBool test_2 = enumerator_25459.current (HERE).getter_mActivate (HERE).boolEnum () ;
    if (kBoolTrue == test_2) {
      ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  call void @").add_operation (var_waitForActivationCallName_23999, inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 733)).add_operation (GALGAS_string (" ()\n"), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 733)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 733)) ;
    }
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  br label %").add_operation (var_taskLoopLabel_28193, inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 735)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 735)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 735)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("}\n"
      "\n"), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 736)) ;
    enumerator_25459.gotoNextObject () ;
    index_25435.increment_operation (inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 676)) ;
  }
  ...
  cEnumerator_taskSortedListIR enumerator_29258 (var_orderedTaskList_24728, kENUMERATION_UP) ;
  GALGAS_uint index_29234 ((uint32_t) 0) ;
  while (enumerator_29258.hasCurrentObject ()) {
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  ").add_operation (function_stackAddressForTask (enumerator_29258.current (HERE).getter_mTaskName (HERE), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 742)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 742)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 742)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string (" = getelementptr inbounds [").add_operation (enumerator_29258.current (HERE).getter_mStackSize (HERE).divide_operation (GALGAS_uint ((uint32_t) 4U).getter_bigint (SOURCE_FILE ("task-declaration.galgas", 743)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 743)).getter_string (SOURCE_FILE ("task-declaration.galgas", 743)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 743)).add_operation (GALGAS_string (" x i32], "), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 743)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 743)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("[").add_operation (enumerator_29258.current (HERE).getter_mStackSize (HERE).divide_operation (GALGAS_uint ((uint32_t) 4U).getter_bigint (SOURCE_FILE ("task-declaration.galgas", 744)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 744)).getter_string (SOURCE_FILE ("task-declaration.galgas", 744)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 744)).add_operation (GALGAS_string (" x i32]* "), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 744)).add_operation (function_stackNameForTask (enumerator_29258.current (HERE).getter_mTaskName (HERE), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 744)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 744)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 744)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string (", i32 0, i32 0\n"), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 745)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  %task.name.").add_operation (index_29234.getter_string (SOURCE_FILE ("task-declaration.galgas", 746)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 746)).add_operation (GALGAS_string (" = load i8*, i8** "), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 746)).add_operation (function_literalStringName (enumerator_29258.current (HERE).getter_mTaskNameStringIndex (HERE), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 746)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 746)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 746)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 746)) ;
    ...
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("i32 ").add_operation (index_29234.getter_string (SOURCE_FILE ("task-declaration.galgas", 748)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 748)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 748)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string (", i8* %task.name.").add_operation (index_29234.getter_string (SOURCE_FILE ("task-declaration.galgas", 749)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 749)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 749)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string (", i32* ").add_operation (function_stackAddressForTask (enumerator_29258.current (HERE).getter_mTaskName (HERE), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 750)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 750)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 750)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string (", i32 ").add_operation (enumerator_29258.current (HERE).getter_mStackSize (HERE).getter_string (SOURCE_FILE ("task-declaration.galgas", 751)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 751)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 751)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string (", void ()* ").add_operation (function_mainRoutineNameForTask (enumerator_29258.current (HERE).getter_mTaskName (HERE), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 752)), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 752)).add_operation (GALGAS_string (")\n"), inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 752)), inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 752)) ;
    enumerator_29258.gotoNextObject () ;
    index_29234.increment_operation (inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 741)) ;
  }
...
void extensionMethod_enterFunctionInContext (const GALGAS_functionDeclarationListAST inObject,
  ...
  while (enumerator_7202.hasCurrentObject ()) {
    ...
    ioArgument_ioDecoratedRoutineList.addAssign_operation (constinArgument_inSelfTypeName, enumerator_7202.current (HERE).getter_mMode (HERE), GALGAS_routineKind::constructor_function (enumerator_7202.current (HERE).getter_mMode (HERE)  COMMA_SOURCE_FILE ("declaration-func.galgas", 286)), var_warnIfUnused_7499, var_globalFunction_7529, GALGAS_routineAttributes::constructor_directPropertyAccess (SOURCE_FILE ("declaration-func.galgas", 289)), var_routineMangledName_8861, enumerator_7202.current (HERE).getter_mFunctionFormalArgumentList (HERE), enumerator_7202.current (HERE).getter_mFunctionInstructionList (HERE), enumerator_7202.current (HERE).getter_mEndOfFunctionDeclaration (HERE), enumerator_7202.current (HERE).getter_mFunctionReturnTypeName (HERE)  COMMA_SOURCE_FILE ("declaration-func.galgas", 283)) ;
...
void extensionMethod_enterFunctionsInPropertyMap (const GALGAS_functionDeclarationListAST inObject,
                                                  ...
                                                  COMMA_UNUSED_LOCATION_ARGS) {
  const GALGAS_functionDeclarationListAST temp_0 = inObject ;
  cEnumerator_functionDeclarationListAST enumerator_10493 (temp_0, kENUMERATION_UP) ;
  while (enumerator_10493.hasCurrentObject ()) {
    GALGAS_stringset var_attributeSet_10542 = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("declaration-func.galgas", 308)) ;
    cEnumerator_lstringlist enumerator_10600 (enumerator_10493.current (HERE).getter_mFunctionAttributeList (HERE), kENUMERATION_UP) ;
    while (enumerator_10600.hasCurrentObject ()) {
      var_attributeSet_10542.addAssign_operation (enumerator_10600.current (HERE).getter_mValue (HERE).getter_string (HERE)  COMMA_SOURCE_FILE ("declaration-func.galgas", 310)) ;
      enumerator_10600.gotoNextObject () ;
    }
    GALGAS_bool var_exportedFunction_10683 = var_attributeSet_10542.getter_hasKey (function_exportedAttribute (inCompiler COMMA_SOURCE_FILE ("declaration-func.galgas", 312)) COMMA_SOURCE_FILE ("declaration-func.galgas", 312)) ;
    GALGAS_bool var_canMutateProperties_10757 = var_attributeSet_10542.getter_hasKey (function_mutatingAttribute (inCompiler COMMA_SOURCE_FILE ("declaration-func.galgas", 313)) COMMA_SOURCE_FILE ("declaration-func.galgas", 313)) ;
    GALGAS_bool var_safe_10816 = var_attributeSet_10542.getter_hasKey (function_safeAttribute (inCompiler COMMA_SOURCE_FILE ("declaration-func.galgas", 314)) COMMA_SOURCE_FILE ("declaration-func.galgas", 314)) ;
    GALGAS_bool var_canAccessProperties_10886 = GALGAS_bool (kIsNotEqual, enumerator_10493.current (HERE).getter_mMode (HERE).objectCompare (GALGAS_mode::constructor_userMode (SOURCE_FILE ("declaration-func.galgas", 315)))) ;
    GALGAS_routineTypedSignature var_signature_11029 ;
    {
    routine_routineSignature (ioArgument_ioContext.mProperty_mTypeMap, enumerator_10493.current (HERE).getter_mFunctionFormalArgumentList (HERE), var_signature_11029, inCompiler  COMMA_SOURCE_FILE ("declaration-func.galgas", 317)) ;
    }
    GALGAS_unifiedTypeMap_2D_proxy var_returnTypeProxy_11170 ;
    {
    GALGAS_unifiedTypeMap_2D_proxy::class_method_makeOptionalProxy (ioArgument_ioContext.mProperty_mTypeMap, enumerator_10493.current (HERE).getter_mFunctionReturnTypeName (HERE), var_returnTypeProxy_11170 COMMA_SOURCE_FILE ("declaration-func.galgas", 319)) ;
    }
    GALGAS_lstring var_routineMangledName_11226 = function_routineMangledNameFromAST (constinArgument_inReceiverLLVMBaseTypeName, enumerator_10493.current (HERE).getter_mFunctionName (HERE), enumerator_10493.current (HERE).getter_mFunctionFormalArgumentList (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-func.galgas", 321)) ;
    GALGAS_routineDescriptor var_descriptor_11415 = GALGAS_routineDescriptor::constructor_new (enumerator_10493.current (HERE).getter_mPublicFunction (HERE), var_exportedFunction_10683, enumerator_10493.current (HERE).getter_mFunctionName (HERE).getter_string (SOURCE_FILE ("declaration-func.galgas", 330)), GALGAS_routineKind::constructor_function (enumerator_10493.current (HERE).getter_mMode (HERE)  COMMA_SOURCE_FILE ("declaration-func.galgas", 331)), var_signature_11029, var_returnTypeProxy_11170, var_canAccessProperties_10886, var_canMutateProperties_10757, var_safe_10816  COMMA_SOURCE_FILE ("declaration-func.galgas", 327)) ;
    {
    ioArgument_ioPropertyMap.setter_insertKey (var_routineMangledName_11226, enumerator_10493.current (HERE).getter_mPublicFunction (HERE), GALGAS_propertyAccessKind::constructor_nonVirtualMethod (var_descriptor_11415  COMMA_SOURCE_FILE ("declaration-func.galgas", 339)), inCompiler COMMA_SOURCE_FILE ("declaration-func.galgas", 339)) ;
    }
...
//--- Constructors
  public : cCollectionElement_routineListIR (const GALGAS_lstring & in_mRoutineMangledName,
...
cCollectionElement_routineListIR::cCollectionElement_routineListIR (const GALGAS_lstring & in_mRoutineMangledName,
                                                                    const GALGAS_PLMType & in_mReceiverType,
                                                                    const GALGAS_lstring & in_mRoutineNameForGeneration,
                                                                    const GALGAS_routineFormalArgumentListIR & in_mFormalArgumentListForGeneration,
                                                                    const GALGAS_allocaList & in_mAllocaList,
                                                                    ...
                                                                    COMMA_LOCATION_ARGS) :
cCollectionElement (THERE),
mObject (in_mRoutineMangledName, in_mReceiverType, in_mRoutineNameForGeneration, in_mFormalArgumentListForGeneration, in_mAllocaList, in_mInstructionGenerationList, in_mIsRequired, in_mWarnIfUnused, in_mExportedFunction, in_mKind, in_mReturnType, in_mAppendFileAndLineArgumentForPanicLocation) {
}
...
cCollectionElement (THERE),
mObject (inElement.mProperty_mRoutineMangledName, inElement.mProperty_mReceiverType, inElement.mProperty_mRoutineNameForGeneration, inElement.mProperty_mFormalArgumentListForGeneration, inElement.mProperty_mAllocaList, inElement.mProperty_mInstructionGenerationList, inElement.mProperty_mIsRequired, inElement.mProperty_mWarnIfUnused, inElement.mProperty_mExportedFunction, inElement.mProperty_mKind, inElement.mProperty_mReturnType, inElement.mProperty_mAppendFileAndLineArgumentForPanicLocation) {
}
...
cCollectionElement * cCollectionElement_routineListIR::copy (void) {
  cCollectionElement * result = NULL ;
  macroMyNew (result, cCollectionElement_routineListIR (mObject.mProperty_mRoutineMangledName, mObject.mProperty_mReceiverType, mObject.mProperty_mRoutineNameForGeneration, mObject.mProperty_mFormalArgumentListForGeneration, mObject.mProperty_mAllocaList, mObject.mProperty_mInstructionGenerationList, mObject.mProperty_mIsRequired, mObject.mProperty_mWarnIfUnused, mObject.mProperty_mExportedFunction, mObject.mProperty_mKind, mObject.mProperty_mReturnType, mObject.mProperty_mAppendFileAndLineArgumentForPanicLocation COMMA_HERE)) ;
  return result ;
}
...
void cCollectionElement_routineListIR::description (C_String & ioString, const int32_t inIndentation) const {
  ...
  mObject.mProperty_mExportedFunction.description (ioString, inIndentation) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "mKind" ":" ;
  ...
  mObject.mProperty_mAppendFileAndLineArgumentForPanicLocation.description (ioString, inIndentation) ;
}
...
GALGAS_routineListIR GALGAS_routineListIR::constructor_listWithValue (const GALGAS_lstring & inOperand0,
                                                                      const GALGAS_PLMType & inOperand1,
                                                                      const GALGAS_lstring & inOperand2,
  ...
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid () && inOperand5.isValid () && inOperand6.isValid () && inOperand7.isValid () && inOperand8.isValid () && inOperand9.isValid () && inOperand10.isValid () && inOperand11.isValid ()) {
    ...
    capCollectionElement attributes ;
    GALGAS_routineListIR::makeAttributesFromObjects (attributes, inOperand0, inOperand1, inOperand2, inOperand3, inOperand4, inOperand5, inOperand6, inOperand7, inOperand8, inOperand9, inOperand10, inOperand11 COMMA_THERE) ;
    result.appendObject (attributes) ;
  }
  return result ;
}
...
void GALGAS_routineListIR::makeAttributesFromObjects (capCollectionElement & outAttributes,
  ...
  macroMyNew (p, cCollectionElement_routineListIR (in_mRoutineMangledName,
                                                   in_mReceiverType,
                                                   ...
                                                   in_mIsRequired,
                                                   in_mWarnIfUnused,
                                                   in_mExportedFunction,
                                                   in_mKind,
                                                   in_mReturnType,
                                                   in_mAppendFileAndLineArgumentForPanicLocation COMMA_THERE)) ;
  outAttributes.setPointer (p) ;
  macroDetachSharedObject (p) ;
}
...
void GALGAS_routineListIR::addAssign_operation (const GALGAS_lstring & inOperand0,
                                                const GALGAS_PLMType & inOperand1,
                                                const GALGAS_lstring & inOperand2,
                                                const GALGAS_routineFormalArgumentListIR & inOperand3,
                                                const GALGAS_allocaList & inOperand4,
  ...
  if (isValid () && inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid () && inOperand5.isValid () && inOperand6.isValid () && inOperand7.isValid () && inOperand8.isValid () && inOperand9.isValid () && inOperand10.isValid () && inOperand11.isValid ()) {
    cCollectionElement * p = NULL ;
    macroMyNew (p, cCollectionElement_routineListIR (inOperand0, inOperand1, inOperand2, inOperand3, inOperand4, inOperand5, inOperand6, inOperand7, inOperand8, inOperand9, inOperand10, inOperand11 COMMA_THERE)) ;
    capCollectionElement attributes ;
    attributes.setPointer (p) ;
    macroDetachSharedObject (p) ;
    appendObject (attributes) ;
...
void GALGAS_routineListIR::setter_insertAtIndex (const GALGAS_lstring inOperand0,
                                                 const GALGAS_PLMType inOperand1,
                                                 const GALGAS_lstring inOperand2,
                                                 const GALGAS_routineFormalArgumentListIR inOperand3,
                                                 const GALGAS_allocaList inOperand4,
...
void GALGAS_routineListIR::setter_removeAtIndex (GALGAS_lstring & outOperand0,
                                                 GALGAS_PLMType & outOperand1,
                                                 GALGAS_lstring & outOperand2,
                                                 ...
                                                 GALGAS_routineKind & outOperand9,
                                                 GALGAS_PLMType & outOperand10,
                                                 GALGAS_bool & outOperand11,
                                                 const GALGAS_uint inRemoveIndex,
                                                 C_Compiler * inCompiler
                                                 COMMA_LOCATION_ARGS) {
  if (isValid () && inRemoveIndex.isValid ()) {
    ...
    if (NULL == p) {
      ...
      outOperand0 = p->mObject.mProperty_mRoutineMangledName ;
      outOperand1 = p->mObject.mProperty_mReceiverType ;
      outOperand2 = p->mObject.mProperty_mRoutineNameForGeneration ;
      ...
      outOperand6 = p->mObject.mProperty_mIsRequired ;
      outOperand7 = p->mObject.mProperty_mWarnIfUnused ;
      outOperand8 = p->mObject.mProperty_mExportedFunction ;
      outOperand9 = p->mObject.mProperty_mKind ;
      outOperand10 = p->mObject.mProperty_mReturnType ;
      outOperand11 = p->mObject.mProperty_mAppendFileAndLineArgumentForPanicLocation ;
    }
  }
}
...
void GALGAS_routineListIR::setter_popFirst (GALGAS_lstring & outOperand0,
                                            GALGAS_PLMType & outOperand1,
                                            GALGAS_lstring & outOperand2,
                                            GALGAS_routineFormalArgumentListIR & outOperand3,
                                            GALGAS_allocaList & outOperand4,
...
void GALGAS_routineListIR::setter_popLast (GALGAS_lstring & outOperand0,
                                           GALGAS_PLMType & outOperand1,
                                           GALGAS_lstring & outOperand2,
                                           GALGAS_routineFormalArgumentListIR & outOperand3,
                                           GALGAS_allocaList & outOperand4,
...
void GALGAS_routineListIR::method_first (GALGAS_lstring & outOperand0,
                                         GALGAS_PLMType & outOperand1,
                                         GALGAS_lstring & outOperand2,
                                         GALGAS_routineFormalArgumentListIR & outOperand3,
                                         GALGAS_allocaList & outOperand4,
...
void GALGAS_routineListIR::method_last (GALGAS_lstring & outOperand0,
                                        GALGAS_PLMType & outOperand1,
                                        GALGAS_lstring & outOperand2,
                                        GALGAS_routineFormalArgumentListIR & outOperand3,
                                        GALGAS_allocaList & outOperand4,
...
GALGAS_lstring GALGAS_routineListIR::getter_mRoutineMangledNameAtIndex (const GALGAS_uint & inIndex,
                                                                        C_Compiler * inCompiler
                                                                        COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_routineListIR * p = (cCollectionElement_routineListIR *) attributes.ptr () ;
...
GALGAS_PLMType GALGAS_routineListIR::getter_mReceiverTypeAtIndex (const GALGAS_uint & inIndex,
                                                                  C_Compiler * inCompiler
                                                                  COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_routineListIR * p = (cCollectionElement_routineListIR *) attributes.ptr () ;
...
GALGAS_lstring GALGAS_routineListIR::getter_mRoutineNameForGenerationAtIndex (const GALGAS_uint & inIndex,
                                                                              C_Compiler * inCompiler
                                                                              COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_routineListIR * p = (cCollectionElement_routineListIR *) attributes.ptr () ;
...
GALGAS_routineFormalArgumentListIR GALGAS_routineListIR::getter_mFormalArgumentListForGenerationAtIndex (const GALGAS_uint & inIndex,
                                                                                                         C_Compiler * inCompiler
                                                                                                         COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_routineListIR * p = (cCollectionElement_routineListIR *) attributes.ptr () ;
...
GALGAS_allocaList GALGAS_routineListIR::getter_mAllocaListAtIndex (const GALGAS_uint & inIndex,
                                                                   C_Compiler * inCompiler
                                                                   COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_routineListIR * p = (cCollectionElement_routineListIR *) attributes.ptr () ;
...
GALGAS_instructionListIR GALGAS_routineListIR::getter_mInstructionGenerationListAtIndex (const GALGAS_uint & inIndex,
                                                                                         C_Compiler * inCompiler
                                                                                         COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_routineListIR * p = (cCollectionElement_routineListIR *) attributes.ptr () ;
...
GALGAS_bool GALGAS_routineListIR::getter_mIsRequiredAtIndex (const GALGAS_uint & inIndex,
                                                             C_Compiler * inCompiler
                                                             COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_routineListIR * p = (cCollectionElement_routineListIR *) attributes.ptr () ;
...
GALGAS_bool GALGAS_routineListIR::getter_mWarnIfUnusedAtIndex (const GALGAS_uint & inIndex,
                                                               C_Compiler * inCompiler
                                                               COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_routineListIR * p = (cCollectionElement_routineListIR *) attributes.ptr () ;
...
GALGAS_bool GALGAS_routineListIR::getter_mExportedFunctionAtIndex (const GALGAS_uint & inIndex,
                                                                   C_Compiler * inCompiler
                                                                   COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_routineListIR * p = (cCollectionElement_routineListIR *) attributes.ptr () ;
  ...
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_routineListIR) ;
    result = p->mObject.mProperty_mExportedFunction ;
  }
  return result ;
}
...
GALGAS_routineKind GALGAS_routineListIR::getter_mKindAtIndex (const GALGAS_uint & inIndex,
                                                              C_Compiler * inCompiler
                                                              COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_routineListIR * p = (cCollectionElement_routineListIR *) attributes.ptr () ;
...
GALGAS_PLMType GALGAS_routineListIR::getter_mReturnTypeAtIndex (const GALGAS_uint & inIndex,
                                                                C_Compiler * inCompiler
                                                                COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_routineListIR * p = (cCollectionElement_routineListIR *) attributes.ptr () ;
...
GALGAS_bool GALGAS_routineListIR::getter_mAppendFileAndLineArgumentForPanicLocationAtIndex (const GALGAS_uint & inIndex,
                                                                                            C_Compiler * inCompiler
                                                                                            COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_routineListIR * p = (cCollectionElement_routineListIR *) attributes.ptr () ;
  ...
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_routineListIR) ;
    result = p->mObject.mProperty_mAppendFileAndLineArgumentForPanicLocation ;
  }
  return result ;
}
...
GALGAS_lstring cEnumerator_routineListIR::current_mRoutineMangledName (LOCATION_ARGS) const {
  const cCollectionElement_routineListIR * p = (const cCollectionElement_routineListIR *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, cCollectionElement_routineListIR) ;
...
GALGAS_PLMType cEnumerator_routineListIR::current_mReceiverType (LOCATION_ARGS) const {
  const cCollectionElement_routineListIR * p = (const cCollectionElement_routineListIR *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, cCollectionElement_routineListIR) ;
...
GALGAS_lstring cEnumerator_routineListIR::current_mRoutineNameForGeneration (LOCATION_ARGS) const {
  const cCollectionElement_routineListIR * p = (const cCollectionElement_routineListIR *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, cCollectionElement_routineListIR) ;
...
GALGAS_routineFormalArgumentListIR cEnumerator_routineListIR::current_mFormalArgumentListForGeneration (LOCATION_ARGS) const {
  const cCollectionElement_routineListIR * p = (const cCollectionElement_routineListIR *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, cCollectionElement_routineListIR) ;
...
GALGAS_allocaList cEnumerator_routineListIR::current_mAllocaList (LOCATION_ARGS) const {
  const cCollectionElement_routineListIR * p = (const cCollectionElement_routineListIR *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, cCollectionElement_routineListIR) ;
...
GALGAS_instructionListIR cEnumerator_routineListIR::current_mInstructionGenerationList (LOCATION_ARGS) const {
  const cCollectionElement_routineListIR * p = (const cCollectionElement_routineListIR *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, cCollectionElement_routineListIR) ;
...
GALGAS_bool cEnumerator_routineListIR::current_mIsRequired (LOCATION_ARGS) const {
  const cCollectionElement_routineListIR * p = (const cCollectionElement_routineListIR *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, cCollectionElement_routineListIR) ;
...
GALGAS_bool cEnumerator_routineListIR::current_mWarnIfUnused (LOCATION_ARGS) const {
  const cCollectionElement_routineListIR * p = (const cCollectionElement_routineListIR *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, cCollectionElement_routineListIR) ;
...
GALGAS_bool cEnumerator_routineListIR::current_mExportedFunction (LOCATION_ARGS) const {
  const cCollectionElement_routineListIR * p = (const cCollectionElement_routineListIR *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, cCollectionElement_routineListIR) ;
  return p->mObject.mProperty_mExportedFunction ;
}

//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*

GALGAS_routineKind cEnumerator_routineListIR::current_mKind (LOCATION_ARGS) const {
  const cCollectionElement_routineListIR * p = (const cCollectionElement_routineListIR *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, cCollectionElement_routineListIR) ;
...
GALGAS_PLMType cEnumerator_routineListIR::current_mReturnType (LOCATION_ARGS) const {
  const cCollectionElement_routineListIR * p = (const cCollectionElement_routineListIR *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, cCollectionElement_routineListIR) ;
...
GALGAS_bool cEnumerator_routineListIR::current_mAppendFileAndLineArgumentForPanicLocation (LOCATION_ARGS) const {
  const cCollectionElement_routineListIR * p = (const cCollectionElement_routineListIR *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, cCollectionElement_routineListIR) ;
  return p->mObject.mProperty_mAppendFileAndLineArgumentForPanicLocation ;
}
