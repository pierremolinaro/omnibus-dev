...
void extensionMethod_generateLLVMForStaticLists (const GALGAS_staticListInitializationMap inObject,
  ...
  GALGAS_bool var_first_21000 = GALGAS_bool (true) ;
  const GALGAS_staticListInitializationMap temp_0 = inObject ;
  cEnumerator_staticListInitializationMap enumerator_21036 (temp_0, kENUMERATION_UP) ;
  while (enumerator_21036.hasCurrentObject ()) {
    const enumGalgasBool test_1 = constinArgument_inUsefulStaticArrayMap.getter_hasKey (enumerator_21036.current_lkey (HERE).getter_string (SOURCE_FILE ("declaration-static-array.galgas", 495)) COMMA_SOURCE_FILE ("declaration-static-array.galgas", 495)).boolEnum () ;
    if (kBoolTrue == test_1) {
      const enumGalgasBool test_2 = var_first_21000.boolEnum () ;
      if (kBoolTrue == test_2) {
        var_first_21000 = GALGAS_bool (false) ;
        ioArgument_ioLLVMcode.plusAssign_operation(function_llvmTitleComment (GALGAS_string ("Static Arraies"), inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 498)), inCompiler  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 498)) ;
      }
      ioArgument_ioLLVMcode.plusAssign_operation(function_llvmNameForGlobalVariable (enumerator_21036.current_lkey (HERE).getter_string (SOURCE_FILE ("declaration-static-array.galgas", 500)), inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 500)).add_operation (GALGAS_string (" = private unnamed_addr constant ["), inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 500)), inCompiler  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 500)) ;
      ioArgument_ioLLVMcode.plusAssign_operation(enumerator_21036.current_mInitializationList (HERE).getter_length (SOURCE_FILE ("declaration-static-array.galgas", 501)).getter_string (SOURCE_FILE ("declaration-static-array.galgas", 501)).add_operation (GALGAS_string (" x %$"), inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 501)).add_operation (function_llvmNameForStaticListElementType (enumerator_21036.current_lkey (HERE).getter_string (HERE).getter_nowhere (SOURCE_FILE ("declaration-static-array.galgas", 501)), inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 501)).getter_string (SOURCE_FILE ("declaration-static-array.galgas", 501)), inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 501)).add_operation (GALGAS_string ("] [\n"), inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 501)), inCompiler  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 501)) ;
      cEnumerator_stringlist enumerator_21440 (enumerator_21036.current_mInitializationList (HERE), kENUMERATION_UP) ;
      while (enumerator_21440.hasCurrentObject ()) {
        ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  %$").add_operation (function_llvmNameForStaticListElementType (enumerator_21036.current_lkey (HERE).getter_string (HERE).getter_nowhere (SOURCE_FILE ("declaration-static-array.galgas", 504)), inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 504)).getter_string (SOURCE_FILE ("declaration-static-array.galgas", 504)), inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 504)).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 504)).add_operation (enumerator_21440.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 504)), inCompiler  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 504)) ;
        if (enumerator_21440.hasNextObject ()) {
          ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string (",\n"), inCompiler  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 506)) ;
        }
        enumerator_21440.gotoNextObject () ;
      }
      ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("\n"
        "]\n"
        "\n"), inCompiler  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 508)) ;
    }
...
void extensionMethod_noteTypesInPrecedenceGraph (const GALGAS_taskList inObject,
  ...
  cEnumerator_taskList enumerator_4461 (temp_0, kENUMERATION_UP) ;
  while (enumerator_4461.hasCurrentObject ()) {
    cEnumerator_structurePropertyListAST enumerator_4493 (enumerator_4461.current_mVarList (HERE), kENUMERATION_UP) ;
    while (enumerator_4493.hasCurrentObject ()) {
      const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, enumerator_4493.current (HERE).getter_mPropertyTypeName (HERE).getter_string (HERE).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
      if (kBoolTrue == test_1) {
        GALGAS_lstring var_typeName_4571 = function_llvmRegularTypeMangledNameFromName (enumerator_4493.current (HERE).getter_mPropertyTypeName (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 125)) ;
        {
        ioArgument_ioGraph.setter_noteNode (var_typeName_4571 COMMA_SOURCE_FILE ("declaration-task.galgas", 126)) ;
        }
      }
      enumerator_4493.gotoNextObject () ;
    }
    cEnumerator_functionDeclarationListAST enumerator_4730 (enumerator_4461.current_mTaskProcList (HERE), kENUMERATION_UP) ;
    while (enumerator_4730.hasCurrentObject ()) {
      extensionMethod_noteInstructionListTypesInPrecedenceGraph (enumerator_4730.current (HERE).getter_mFunctionInstructionList (HERE), ioArgument_ioGraph, inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 130)) ;
      enumerator_4730.gotoNextObject () ;
    }
    cEnumerator_syncInstructionBranchListAST enumerator_4882 (enumerator_4461.current_mGuardedCommandList (HERE), kENUMERATION_UP) ;
    while (enumerator_4882.hasCurrentObject ()) {
      extensionMethod_noteInstructionListTypesInPrecedenceGraph (enumerator_4882.current (HERE).getter_mInstructionList (HERE), ioArgument_ioGraph, inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 133)) ;
...
void extensionMethod_enterInContext (const GALGAS_taskList inObject,
                                     ...
                                     COMMA_UNUSED_LOCATION_ARGS) {
  const GALGAS_taskList temp_0 = inObject ;
  cEnumerator_taskList enumerator_6103 (temp_0, kENUMERATION_UP) ;
  while (enumerator_6103.hasCurrentObject ()) {
    GALGAS_propertyList var_propertyList_6159 = GALGAS_propertyList::constructor_emptyList (SOURCE_FILE ("declaration-task.galgas", 163)) ;
    GALGAS_propertyMap var_propertyMap_6193 = GALGAS_propertyMap::constructor_emptyMap (SOURCE_FILE ("declaration-task.galgas", 164)) ;
    GALGAS_sortedOperandIRList var_initialValueList_6240 = GALGAS_sortedOperandIRList::constructor_emptySortedList (SOURCE_FILE ("declaration-task.galgas", 165)) ;
    cEnumerator_structurePropertyListAST enumerator_6279 (enumerator_6103.current (HERE).getter_mVarList (HERE), kENUMERATION_UP) ;
    while (enumerator_6279.hasCurrentObject ()) {
      GALGAS_constructorSignature joker_6499 = GALGAS_constructorSignature::constructor_emptyList (SOURCE_FILE ("declaration-task.galgas", 174)) ;
      GALGAS_bool joker_6511 = GALGAS_bool::constructor_default (SOURCE_FILE ("declaration-task.galgas", 175)) ;
      extensionMethod_enterInContext (enumerator_6279.current (HERE), enumerator_6103.current (HERE).getter_mTaskName (HERE), ioArgument_ioContext, ioArgument_ioGlobalLiteralStringMap, var_propertyList_6159, var_propertyMap_6193, var_initialValueList_6240, joker_6499, joker_6511, inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 167)) ;
      enumerator_6279.gotoNextObject () ;
    }
    GALGAS_PLMType var_taskType_6606 = GALGAS_PLMType::constructor_structure (enumerator_6103.current (HERE).getter_mTaskName (HERE), var_propertyMap_6193, var_propertyList_6159, GALGAS_PLMTypeFlags::constructor_none (SOURCE_FILE ("declaration-task.galgas", 183)), GALGAS_guardMapForContext::constructor_emptyMap (SOURCE_FILE ("declaration-task.galgas", 184))  COMMA_SOURCE_FILE ("declaration-task.galgas", 179)) ;
    {
    ioArgument_ioContext.mProperty_mTypeMap.setter_insertType (enumerator_6103.current (HERE).getter_mTaskName (HERE), var_taskType_6606, ioArgument_ioContext.getter_mTypeMap (HERE).getter_count (SOURCE_FILE ("declaration-task.galgas", 189)), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 186)) ;
    }
    ioArgument_ioContext.mProperty_mGlobalTaskVariableList.addAssign_operation (enumerator_6103.current (HERE).getter_mTaskName (HERE).getter_string (HERE), enumerator_6103.current (HERE).getter_mTaskName (HERE).getter_string (HERE), GALGAS_objectIR::constructor_llvmStructureConstant (var_taskType_6606, var_initialValueList_6240  COMMA_SOURCE_FILE ("declaration-task.galgas", 194))  COMMA_SOURCE_FILE ("declaration-task.galgas", 191)) ;
    extensionMethod_enterFunctionInContext (enumerator_6103.current (HERE).getter_mTaskProcList (HERE), GALGAS_string ("$").add_operation (enumerator_6103.current (HERE).getter_mTaskName (HERE).getter_string (SOURCE_FILE ("declaration-task.galgas", 196)), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 196)), ioArgument_ioContext, inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 196)) ;
...
void extensionMethod_semanticAnalysis (const GALGAS_taskList inObject,
                                       ...
                                       C_Compiler * inCompiler
                                       COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_stringset var_prioritySet_7797 = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("declaration-task.galgas", 209)) ;
  const GALGAS_taskList temp_0 = inObject ;
  cEnumerator_taskList enumerator_7821 (temp_0, kENUMERATION_UP) ;
  while (enumerator_7821.hasCurrentObject ()) {
    extensionMethod_semanticAnalysis (enumerator_7821.current (HERE), constinArgument_inContext, ioArgument_ioTemporaries, ioArgument_ioIntermediateCodeStruct, inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 211)) ;
    GALGAS_string var_priorityString_7987 = enumerator_7821.current (HERE).getter_mPriority (HERE).getter_bigint (HERE).getter_string (SOURCE_FILE ("declaration-task.galgas", 216)) ;
    const enumGalgasBool test_1 = var_prioritySet_7797.getter_hasKey (var_priorityString_7987 COMMA_SOURCE_FILE ("declaration-task.galgas", 217)).boolEnum () ;
    if (kBoolTrue == test_1) {
      TC_Array <C_FixItDescription> fixItArray2 ;
      inCompiler->emitSemanticError (enumerator_7821.current (HERE).getter_mPriority (HERE).getter_location (SOURCE_FILE ("declaration-task.galgas", 218)), GALGAS_string ("duplicate priority"), fixItArray2  COMMA_SOURCE_FILE ("declaration-task.galgas", 218)) ;
    }
    var_prioritySet_7797.addAssign_operation (var_priorityString_7987  COMMA_SOURCE_FILE ("declaration-task.galgas", 220)) ;
...
cSortedListElement_taskSortedListIR::cSortedListElement_taskSortedListIR (const GALGAS_string & in_mTaskName,
                                                                          ...
                                                                          COMMA_LOCATION_ARGS) :
cSortedListElement (THERE),
mObject (in_mTaskName, in_mPriority, in_mStackSize, in_mAllocaList, in_mInitInstructionListIR, in_mTaskNameStringIndex) {
}
...
cSortedListElement * cSortedListElement_taskSortedListIR::copy (void) {
  cSortedListElement * result = NULL ;
  macroMyNew (result, cSortedListElement_taskSortedListIR (mObject.mProperty_mTaskName, mObject.mProperty_mPriority, mObject.mProperty_mStackSize, mObject.mProperty_mAllocaList, mObject.mProperty_mInitInstructionListIR, mObject.mProperty_mTaskNameStringIndex COMMA_HERE)) ;
  return result ;
}
...
void extensionMethod_generateCode (const GALGAS_taskMapIR inObject,
                                   ...
                                   C_Compiler * inCompiler
                                   COMMA_UNUSED_LOCATION_ARGS) {
  ioArgument_ioLLVMcode.plusAssign_operation(function_llvmTitleComment (GALGAS_string ("Task self terminate service"), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 356)), inCompiler  COMMA_SOURCE_FILE ("declaration-task.galgas", 356)) ;
  GALGAS_string var_selfTerminateImplementationName_13391 = function_llvmNameForServiceImplementation (function_llvmNameForTaskSelfTerminateService (inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 357)), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 357)) ;
  GALGAS_string var_selfTerminateCallName_13496 = function_llvmNameForServiceCall (function_llvmNameForTaskSelfTerminateService (inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 358)), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 358)) ;
  ioArgument_ioServiceList.addAssign_operation (var_selfTerminateCallName_13496, var_selfTerminateImplementationName_13391  COMMA_SOURCE_FILE ("declaration-task.galgas", 359)) ;
  ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("declare void @").add_operation (var_selfTerminateCallName_13496, inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 360)).add_operation (GALGAS_string (" () nounwind noreturn\n"
    "\n"), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 360)), inCompiler  COMMA_SOURCE_FILE ("declaration-task.galgas", 360)) ;
  ioArgument_ioLLVMcode.plusAssign_operation(function_llvmTitleComment (GALGAS_string ("Task variables"), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 362)), inCompiler  COMMA_SOURCE_FILE ("declaration-task.galgas", 362)) ;
  cEnumerator_globalTaskVariableList enumerator_13897 (constinArgument_inGenerationContext.getter_mGlobalTaskVariableList (HERE), kENUMERATION_UP) ;
  while (enumerator_13897.hasCurrentObject ()) {
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("@").add_operation (function_llvmNameForTaskGlobalVar (enumerator_13897.current_mTaskName (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 364)), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 364)), inCompiler  COMMA_SOURCE_FILE ("declaration-task.galgas", 364)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string (" = internal global %"), inCompiler  COMMA_SOURCE_FILE ("declaration-task.galgas", 365)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("$").add_operation (enumerator_13897.current_mTaskTypeName (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 366)).getter_assemblerRepresentation (SOURCE_FILE ("declaration-task.galgas", 366)).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 366)), inCompiler  COMMA_SOURCE_FILE ("declaration-task.galgas", 366)) ;
    GALGAS_string var_initialString_14093 = extensionGetter_llvmName (enumerator_13897.current_mInitialValue (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 367)) ;
    const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, var_initialString_14093.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("zeroinitializer"), inCompiler  COMMA_SOURCE_FILE ("declaration-task.galgas", 369)) ;
    }else if (kBoolFalse == test_0) {
      ioArgument_ioLLVMcode.plusAssign_operation(var_initialString_14093, inCompiler  COMMA_SOURCE_FILE ("declaration-task.galgas", 371)) ;
    }
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("\n"), inCompiler  COMMA_SOURCE_FILE ("declaration-task.galgas", 373)) ;
    enumerator_13897.gotoNextObject () ;
  }
  ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("\n"), inCompiler  COMMA_SOURCE_FILE ("declaration-task.galgas", 375)) ;
  GALGAS_taskSortedListIR var_orderedTaskList_14356 = GALGAS_taskSortedListIR::constructor_emptySortedList (SOURCE_FILE ("declaration-task.galgas", 377)) ;
  const GALGAS_taskMapIR temp_1 = inObject ;
  cEnumerator_taskMapIR enumerator_14380 (temp_1, kENUMERATION_UP) ;
  while (enumerator_14380.hasCurrentObject ()) {
    var_orderedTaskList_14356.addAssign_operation (enumerator_14380.current (HERE).getter_lkey (HERE).getter_string (HERE), enumerator_14380.current (HERE).getter_mPriority (HERE), enumerator_14380.current (HERE).getter_mStackSize (HERE), enumerator_14380.current (HERE).getter_mAllocaList (HERE), enumerator_14380.current (HERE).getter_mInitInstructionListIR (HERE), enumerator_14380.current (HERE).getter_mTaskNameStringIndex (HERE)  COMMA_SOURCE_FILE ("declaration-task.galgas", 379)) ;
    enumerator_14380.gotoNextObject () ;
  }
  ioArgument_ioLLVMcode.plusAssign_operation(function_llvmTitleComment (GALGAS_string ("Create task extern routine"), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 388)), inCompiler  COMMA_SOURCE_FILE ("declaration-task.galgas", 388)) ;
  ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("declare void @kernel_create_task (i32 %inTaskIndex, i8* %inTaskName, i32* %inStackBufferAddress, "), inCompiler  COMMA_SOURCE_FILE ("declaration-task.galgas", 389)) ;
  ...
  cEnumerator_taskSortedListIR enumerator_14906 (var_orderedTaskList_14356, kENUMERATION_UP) ;
  while (enumerator_14906.hasCurrentObject ()) {
    ioArgument_ioLLVMcode.plusAssign_operation(function_llvmTitleComment (GALGAS_string ("Task ").add_operation (enumerator_14906.current (HERE).getter_mTaskName (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 392)), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 392)), inCompiler  COMMA_SOURCE_FILE ("declaration-task.galgas", 392)) ;
    GALGAS_string var_assemblerTaskName_14998 = GALGAS_string ("$").add_operation (enumerator_14906.current (HERE).getter_mTaskName (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 393)).getter_assemblerRepresentation (SOURCE_FILE ("declaration-task.galgas", 393)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(function_stackNameForTask (enumerator_14906.current (HERE).getter_mTaskName (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 394)).add_operation (GALGAS_string (" = global ["), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 394)).add_operation (enumerator_14906.current (HERE).getter_mStackSize (HERE).divide_operation (GALGAS_uint ((uint32_t) 4U).getter_bigint (SOURCE_FILE ("declaration-task.galgas", 394)), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 394)).getter_string (SOURCE_FILE ("declaration-task.galgas", 394)), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 394)).add_operation (GALGAS_string (" x i32] zeroinitializer\n"), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 394)), inCompiler  COMMA_SOURCE_FILE ("declaration-task.galgas", 394)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("\n"), inCompiler  COMMA_SOURCE_FILE ("declaration-task.galgas", 395)) ;
    GALGAS_string var_effectiveParameter_15220 = GALGAS_string ("(%").add_operation (var_assemblerTaskName_14998, inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 396)).add_operation (GALGAS_string (" * @"), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 396)).add_operation (function_llvmNameForTaskGlobalVar (enumerator_14906.current (HERE).getter_mTaskName (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 396)), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 396)).add_operation (GALGAS_string (")"), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 396)) ;
    GALGAS_string var_formalArgument_15330 = GALGAS_string ("(%").add_operation (var_assemblerTaskName_14998, inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 397)).add_operation (GALGAS_string (" * %self)"), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 397)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(function_llvmSeparatorLine (inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 398)), inCompiler  COMMA_SOURCE_FILE ("declaration-task.galgas", 398)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("\n"), inCompiler  COMMA_SOURCE_FILE ("declaration-task.galgas", 399)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("define internal void ").add_operation (function_initNameForTaskType (enumerator_14906.current (HERE).getter_mTaskName (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 400)), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 400)).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 400)).add_operation (var_formalArgument_15330, inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 400)).add_operation (function_llvmAttributeFunction (inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 400)), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 400)).add_operation (GALGAS_string ("{\n"), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 400)), inCompiler  COMMA_SOURCE_FILE ("declaration-task.galgas", 400)) ;
    cEnumerator_allocaList enumerator_15625 (enumerator_14906.current (HERE).getter_mAllocaList (HERE), kENUMERATION_UP) ;
    while (enumerator_15625.hasCurrentObject ()) {
      ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  ").add_operation (function_llvmNameForLocalVariable (enumerator_15625.current_mVarName (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 402)), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 402)).add_operation (GALGAS_string (" = alloca "), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 402)).add_operation (enumerator_15625.current_mLLVMTypeName (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 402)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 402)), inCompiler  COMMA_SOURCE_FILE ("declaration-task.galgas", 402)) ;
      enumerator_15625.gotoNextObject () ;
    }
    extensionMethod_instructionListLLVMCode (enumerator_14906.current (HERE).getter_mInitInstructionListIR (HERE), ioArgument_ioLLVMcode, constinArgument_inGenerationContext, ioArgument_ioGenerationAdds, inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 404)) ;
    ...
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("define internal void ").add_operation (function_mainRoutineNameForTask (enumerator_14906.current (HERE).getter_mTaskName (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 409)), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 409)).add_operation (GALGAS_string (" ()"), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 409)).add_operation (function_llvmAttributeFunction (inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 409)), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 409)).add_operation (GALGAS_string ("noreturn {\n"), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 409)), inCompiler  COMMA_SOURCE_FILE ("declaration-task.galgas", 409)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  call void ").add_operation (function_initNameForTaskType (enumerator_14906.current (HERE).getter_mTaskName (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 410)), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 410)).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 410)).add_operation (var_effectiveParameter_15220, inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 410)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 410)), inCompiler  COMMA_SOURCE_FILE ("declaration-task.galgas", 410)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  call void @").add_operation (function_llvmNameForFunction (GALGAS_string ("$").add_operation (enumerator_14906.current (HERE).getter_mTaskName (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 411)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 411)).add_operation (function_llvmNameForTaskLoopFunction (inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 411)), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 411)).add_operation (GALGAS_string ("()"), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 411)), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 411)), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 411)).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 411)).add_operation (var_effectiveParameter_15220, inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 411)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 411)), inCompiler  COMMA_SOURCE_FILE ("declaration-task.galgas", 411)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  call void @").add_operation (var_selfTerminateCallName_13496, inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 412)).add_operation (GALGAS_string (" ()\n"), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 412)), inCompiler  COMMA_SOURCE_FILE ("declaration-task.galgas", 412)) ;
  ...
  ioArgument_ioLLVMcode.plusAssign_operation(function_llvmTitleComment (GALGAS_string ("Start tasks"), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 417)), inCompiler  COMMA_SOURCE_FILE ("declaration-task.galgas", 417)) ;
  ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("define internal void @start.tasks ()").add_operation (function_llvmAttributeFunction (inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 418)), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 418)).add_operation (GALGAS_string ("{\n"), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 418)), inCompiler  COMMA_SOURCE_FILE ("declaration-task.galgas", 418)) ;
  cEnumerator_taskSortedListIR enumerator_16696 (var_orderedTaskList_14356, kENUMERATION_UP) ;
  GALGAS_uint index_16672 ((uint32_t) 0) ;
  while (enumerator_16696.hasCurrentObject ()) {
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  ").add_operation (function_stackAddressForTask (enumerator_16696.current (HERE).getter_mTaskName (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 420)), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 420)), inCompiler  COMMA_SOURCE_FILE ("declaration-task.galgas", 420)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string (" = getelementptr inbounds [").add_operation (enumerator_16696.current (HERE).getter_mStackSize (HERE).divide_operation (GALGAS_uint ((uint32_t) 4U).getter_bigint (SOURCE_FILE ("declaration-task.galgas", 421)), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 421)).getter_string (SOURCE_FILE ("declaration-task.galgas", 421)), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 421)).add_operation (GALGAS_string (" x i32], "), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 421)), inCompiler  COMMA_SOURCE_FILE ("declaration-task.galgas", 421)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("[").add_operation (enumerator_16696.current (HERE).getter_mStackSize (HERE).divide_operation (GALGAS_uint ((uint32_t) 4U).getter_bigint (SOURCE_FILE ("declaration-task.galgas", 422)), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 422)).getter_string (SOURCE_FILE ("declaration-task.galgas", 422)), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 422)).add_operation (GALGAS_string (" x i32]* "), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 422)).add_operation (function_stackNameForTask (enumerator_16696.current (HERE).getter_mTaskName (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 422)), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 422)), inCompiler  COMMA_SOURCE_FILE ("declaration-task.galgas", 422)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string (", i32 0, i32 0\n"), inCompiler  COMMA_SOURCE_FILE ("declaration-task.galgas", 423)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  %task.name.").add_operation (index_16672.getter_string (SOURCE_FILE ("declaration-task.galgas", 424)), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 424)).add_operation (GALGAS_string (" = load i8*, i8** "), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 424)).add_operation (function_literalStringName (enumerator_16696.current (HERE).getter_mTaskNameStringIndex (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 424)), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 424)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 424)), inCompiler  COMMA_SOURCE_FILE ("declaration-task.galgas", 424)) ;
    ...
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("i32 ").add_operation (index_16672.getter_string (SOURCE_FILE ("declaration-task.galgas", 426)), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 426)), inCompiler  COMMA_SOURCE_FILE ("declaration-task.galgas", 426)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string (", i8* %task.name.").add_operation (index_16672.getter_string (SOURCE_FILE ("declaration-task.galgas", 427)), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 427)), inCompiler  COMMA_SOURCE_FILE ("declaration-task.galgas", 427)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string (", i32* ").add_operation (function_stackAddressForTask (enumerator_16696.current (HERE).getter_mTaskName (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 428)), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 428)), inCompiler  COMMA_SOURCE_FILE ("declaration-task.galgas", 428)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string (", i32 ").add_operation (enumerator_16696.current (HERE).getter_mStackSize (HERE).getter_string (SOURCE_FILE ("declaration-task.galgas", 429)), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 429)), inCompiler  COMMA_SOURCE_FILE ("declaration-task.galgas", 429)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string (", void ()* ").add_operation (function_mainRoutineNameForTask (enumerator_16696.current (HERE).getter_mTaskName (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 430)), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 430)).add_operation (GALGAS_string (")\n"), inCompiler COMMA_SOURCE_FILE ("declaration-task.galgas", 430)), inCompiler  COMMA_SOURCE_FILE ("declaration-task.galgas", 430)) ;
    enumerator_16696.gotoNextObject () ;
    index_16672.increment_operation (inCompiler  COMMA_SOURCE_FILE ("declaration-task.galgas", 419)) ;
  }
...
void extensionMethod_enterSystemRoutineInContext (const GALGAS_systemRoutineDeclarationListAST inObject,
                                                  ...
                                                  COMMA_UNUSED_LOCATION_ARGS) {
  const GALGAS_systemRoutineDeclarationListAST temp_0 = inObject ;
  cEnumerator_systemRoutineDeclarationListAST enumerator_3630 (temp_0, kENUMERATION_UP) ;
  while (enumerator_3630.hasCurrentObject ()) {
    GALGAS_lstring var_routineMangledName_3688 = function_routineMangledNameFromAST (constinArgument_inReceiverTypeName, enumerator_3630.current (HERE).getter_mName (HERE), enumerator_3630.current (HERE).getter_mFormalArgumentList (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-svc.galgas", 104)) ;
    GALGAS_routineTypedSignature var_signature_3899 ;
    {
    routine_routineSignature (ioArgument_ioContext.mProperty_mTypeMap, enumerator_3630.current (HERE).getter_mFormalArgumentList (HERE), var_signature_3899, inCompiler  COMMA_SOURCE_FILE ("declaration-svc.galgas", 110)) ;
    }
    GALGAS_unifiedTypeMap_2D_proxy var_returnTypeProxy_4027 ;
    {
    GALGAS_unifiedTypeMap_2D_proxy::class_method_makeOptionalProxy (ioArgument_ioContext.mProperty_mTypeMap, enumerator_3630.current (HERE).getter_mReturnTypeName (HERE), var_returnTypeProxy_4027 COMMA_SOURCE_FILE ("declaration-svc.galgas", 112)) ;
    }
    GALGAS_bool var_mutating_4063 = GALGAS_bool (false) ;
    cEnumerator_lstringlist enumerator_4113 (enumerator_3630.current (HERE).getter_mAttributeList (HERE), kENUMERATION_UP) ;
    while (enumerator_4113.hasCurrentObject ()) {
      const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_4113.current_mValue (HERE).getter_string (HERE).objectCompare (function_mutatingAttribute (inCompiler COMMA_SOURCE_FILE ("declaration-svc.galgas", 116)))).boolEnum () ;
      if (kBoolTrue == test_1) {
        var_mutating_4063 = GALGAS_bool (true) ;
      }
      enumerator_4113.gotoNextObject () ;
    }
    {
    extensionSetter_insertKey (ioArgument_ioContext.mProperty_mRoutineMapForContext, enumerator_3630.current (HERE).getter_mName (HERE), extensionGetter_routineSignature (enumerator_3630.current (HERE).getter_mFormalArgumentList (HERE), enumerator_3630.current (HERE).getter_mName (HERE).getter_location (SOURCE_FILE ("declaration-svc.galgas", 123)), inCompiler COMMA_SOURCE_FILE ("declaration-svc.galgas", 123)), var_routineMangledName_3688, GALGAS_routineDescriptor::constructor_new (enumerator_3630.current (HERE).getter_mPublic (HERE), GALGAS_bool (false), enumerator_3630.current (HERE).getter_mRoutineKind (HERE), var_signature_3899, var_returnTypeProxy_4027, var_mutating_4063, GALGAS_bool (true)  COMMA_SOURCE_FILE ("declaration-svc.galgas", 125)), inCompiler COMMA_SOURCE_FILE ("declaration-svc.galgas", 121)) ;
    }
...
void extensionMethod_systemRoutineSemanticAnalysis (const GALGAS_systemRoutineDeclarationListAST inObject,
                                                    ...
                                                    COMMA_UNUSED_LOCATION_ARGS) {
  const GALGAS_systemRoutineDeclarationListAST temp_0 = inObject ;
  cEnumerator_systemRoutineDeclarationListAST enumerator_5292 (temp_0, kENUMERATION_UP) ;
  while (enumerator_5292.hasCurrentObject ()) {
    GALGAS_bool var_mutating_5312 = GALGAS_bool (false) ;
    GALGAS_bool var_noUnusedWarning_5344 = GALGAS_bool (false) ;
    cEnumerator_lstringlist enumerator_5394 (enumerator_5292.current (HERE).getter_mAttributeList (HERE), kENUMERATION_UP) ;
    while (enumerator_5394.hasCurrentObject ()) {
      const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_5394.current_mValue (HERE).getter_string (HERE).objectCompare (function_noUnusedWarningAttribute (inCompiler COMMA_SOURCE_FILE ("declaration-svc.galgas", 152)))).boolEnum () ;
      if (kBoolTrue == test_1) {
        const enumGalgasBool test_2 = var_noUnusedWarning_5344.boolEnum () ;
        if (kBoolTrue == test_2) {
        ...
        var_noUnusedWarning_5344 = GALGAS_bool (true) ;
      }else if (kBoolFalse == test_1) {
        const enumGalgasBool test_4 = GALGAS_bool (kIsEqual, enumerator_5394.current_mValue (HERE).getter_string (HERE).objectCompare (function_mutatingAttribute (inCompiler COMMA_SOURCE_FILE ("declaration-svc.galgas", 157)))).boolEnum () ;
        if (kBoolTrue == test_4) {
          const enumGalgasBool test_5 = var_mutating_5312.boolEnum () ;
          if (kBoolTrue == test_5) {
          ...
          var_mutating_5312 = GALGAS_bool (true) ;
    ...
    GALGAS_mode var_mode_6070 ;
    switch (enumerator_5292.current (HERE).getter_mRoutineKind (HERE).enumValue ()) {
    case GALGAS_routineKind::kNotBuilt:
      break ;
    case GALGAS_routineKind::kEnum_section:
      {
        var_mode_6070 = GALGAS_mode::constructor_sectionMode (SOURCE_FILE ("declaration-svc.galgas", 170)) ;
      }
      break ;
    case GALGAS_routineKind::kEnum_primitive:
      {
        var_mode_6070 = GALGAS_mode::constructor_primitiveMode (SOURCE_FILE ("declaration-svc.galgas", 171)) ;
      }
      break ;
    case GALGAS_routineKind::kEnum_service:
      {
        var_mode_6070 = GALGAS_mode::constructor_serviceMode (SOURCE_FILE ("declaration-svc.galgas", 172)) ;
      }
      break ;
    case GALGAS_routineKind::kEnum_safe:
      {
        var_mode_6070 = GALGAS_mode::constructor_safeMode (SOURCE_FILE ("declaration-svc.galgas", 173)) ;
      }
      break ;
    case GALGAS_routineKind::kEnum_function:
      {
        TC_Array <C_FixItDescription> fixItArray8 ;
        inCompiler->emitSemanticError (enumerator_5292.current (HERE).getter_mEndOfInstructionListLocation (HERE), GALGAS_string ("INTERNAL ERROR"), fixItArray8  COMMA_SOURCE_FILE ("declaration-svc.galgas", 174)) ;
        var_mode_6070.drop () ; // Release error dropped variable
      }
      break ;
    }
    {
    routine_routineSemanticAnalysis (inArgument_inReceiverType, enumerator_5292.current (HERE).getter_mRoutineKind (HERE), var_mode_6070, enumerator_5292.current (HERE).getter_mName (HERE), enumerator_5292.current (HERE).getter_mFormalArgumentList (HERE), enumerator_5292.current (HERE).getter_mReturnTypeName (HERE), enumerator_5292.current (HERE).getter_mInstructionList (HERE), enumerator_5292.current (HERE).getter_mEndOfInstructionListLocation (HERE), GALGAS_bool (true), var_mutating_5312, var_noUnusedWarning_5344.operator_not (SOURCE_FILE ("declaration-svc.galgas", 187)), GALGAS_bool (true), constinArgument_inSemanticContext, ioArgument_ioTemporaries, ioArgument_ioIntermediateCodeStruct, inCompiler  COMMA_SOURCE_FILE ("declaration-svc.galgas", 176)) ;
    }
...
void extensionMethod_generateLLVMinitCode (const GALGAS_initListIR inObject,
  ...
  cEnumerator_initListIR enumerator_7701 (temp_0, kENUMERATION_UP) ;
  while (enumerator_7701.hasCurrentObject ()) {
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("define internal void @init.").add_operation (enumerator_7701.current (HERE).getter_mPriority (HERE).getter_string (SOURCE_FILE ("declaration-init.galgas", 197)), inCompiler COMMA_SOURCE_FILE ("declaration-init.galgas", 197)).add_operation (GALGAS_string (" ("), inCompiler COMMA_SOURCE_FILE ("declaration-init.galgas", 197)), inCompiler  COMMA_SOURCE_FILE ("declaration-init.galgas", 197)) ;
    const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, enumerator_7701.current (HERE).getter_mSelfType (HERE).objectCompare (GALGAS_PLMType::constructor_void (SOURCE_FILE ("declaration-init.galgas", 198)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      ioArgument_ioLLVMcode.plusAssign_operation(extensionGetter_llvmTypeName (enumerator_7701.current (HERE).getter_mSelfType (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-init.galgas", 199)).add_operation (GALGAS_string (" * %self"), inCompiler COMMA_SOURCE_FILE ("declaration-init.galgas", 199)), inCompiler  COMMA_SOURCE_FILE ("declaration-init.galgas", 199)) ;
    }
    ...
    cEnumerator_allocaList enumerator_7992 (enumerator_7701.current (HERE).getter_mAllocaList (HERE), kENUMERATION_UP) ;
    while (enumerator_7992.hasCurrentObject ()) {
      ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  ").add_operation (function_llvmNameForLocalVariable (enumerator_7992.current_mVarName (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-init.galgas", 203)), inCompiler COMMA_SOURCE_FILE ("declaration-init.galgas", 203)).add_operation (GALGAS_string (" = alloca "), inCompiler COMMA_SOURCE_FILE ("declaration-init.galgas", 203)).add_operation (enumerator_7992.current_mLLVMTypeName (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-init.galgas", 203)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("declaration-init.galgas", 203)), inCompiler  COMMA_SOURCE_FILE ("declaration-init.galgas", 203)) ;
      enumerator_7992.gotoNextObject () ;
    }
    extensionMethod_instructionListLLVMCode (enumerator_7701.current (HERE).getter_mInstructionListIR (HERE), ioArgument_ioLLVMcode, constinArgument_inGenerationContext, ioArgument_ioGenerationAdds, inCompiler COMMA_SOURCE_FILE ("declaration-init.galgas", 205)) ;
  ...
  cEnumerator_initListIR enumerator_8424 (temp_2, kENUMERATION_UP) ;
  while (enumerator_8424.hasCurrentObject ()) {
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  call void @init.").add_operation (enumerator_8424.current (HERE).getter_mPriority (HERE).getter_string (SOURCE_FILE ("declaration-init.galgas", 212)), inCompiler COMMA_SOURCE_FILE ("declaration-init.galgas", 212)).add_operation (GALGAS_string (" ("), inCompiler COMMA_SOURCE_FILE ("declaration-init.galgas", 212)), inCompiler  COMMA_SOURCE_FILE ("declaration-init.galgas", 212)) ;
    const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, enumerator_8424.current (HERE).getter_mSelfType (HERE).objectCompare (GALGAS_PLMType::constructor_void (SOURCE_FILE ("declaration-init.galgas", 213)))).boolEnum () ;
    if (kBoolTrue == test_3) {
      ioArgument_ioLLVMcode.plusAssign_operation(extensionGetter_llvmTypeName (enumerator_8424.current (HERE).getter_mSelfType (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-init.galgas", 214)).add_operation (GALGAS_string (" * "), inCompiler COMMA_SOURCE_FILE ("declaration-init.galgas", 214)).add_operation (function_llvmNameForGlobalVariable (enumerator_8424.current (HERE).getter_mGlobalVariable (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-init.galgas", 214)), inCompiler COMMA_SOURCE_FILE ("declaration-init.galgas", 214)), inCompiler  COMMA_SOURCE_FILE ("declaration-init.galgas", 214)) ;
    }
...
void extensionMethod_noteTypesInPrecedenceGraph (const GALGAS_functionDeclarationListAST inObject,
  ...
  cEnumerator_functionDeclarationListAST enumerator_6202 (temp_0, kENUMERATION_UP) ;
  while (enumerator_6202.hasCurrentObject ()) {
    cEnumerator_routineFormalArgumentList enumerator_6275 (enumerator_6202.current_mFunctionFormalArgumentList (HERE), kENUMERATION_UP) ;
    while (enumerator_6275.hasCurrentObject ()) {
      GALGAS_lstring var_typeName_6297 = function_llvmRegularTypeMangledNameFromName (enumerator_6275.current_mFormalArgumentTypeName (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-func.galgas", 203)) ;
      {
      ioArgument_ioGraph.setter_noteNode (var_typeName_6297 COMMA_SOURCE_FILE ("declaration-func.galgas", 204)) ;
      }
      enumerator_6275.gotoNextObject () ;
    }
    extensionMethod_noteInstructionListTypesInPrecedenceGraph (enumerator_6202.current_mFunctionInstructionList (HERE), ioArgument_ioGraph, inCompiler COMMA_SOURCE_FILE ("declaration-func.galgas", 206)) ;
    const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, enumerator_6202.current_mFunctionReturnTypeName (HERE).getter_string (HERE).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_1) {
      GALGAS_lstring var_typeName_6556 = function_llvmRegularTypeMangledNameFromName (enumerator_6202.current_mFunctionReturnTypeName (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-func.galgas", 208)) ;
      {
      ioArgument_ioGraph.setter_noteNode (var_typeName_6556 COMMA_SOURCE_FILE ("declaration-func.galgas", 209)) ;
      }
    }
...
void extensionMethod_enterFunctionInContext (const GALGAS_functionDeclarationListAST inObject,
                                             ...
                                             COMMA_UNUSED_LOCATION_ARGS) {
  const GALGAS_functionDeclarationListAST temp_0 = inObject ;
  cEnumerator_functionDeclarationListAST enumerator_7204 (temp_0, kENUMERATION_UP) ;
  while (enumerator_7204.hasCurrentObject ()) {
    GALGAS_routineTypedSignature var_signature_7320 ;
    {
    routine_routineSignature (ioArgument_ioContext.mProperty_mTypeMap, enumerator_7204.current (HERE).getter_mFunctionFormalArgumentList (HERE), var_signature_7320, inCompiler  COMMA_SOURCE_FILE ("declaration-func.galgas", 224)) ;
    }
    GALGAS_unifiedTypeMap_2D_proxy var_returnTypeProxy_7461 ;
    {
    GALGAS_unifiedTypeMap_2D_proxy::class_method_makeOptionalProxy (ioArgument_ioContext.mProperty_mTypeMap, enumerator_7204.current (HERE).getter_mFunctionReturnTypeName (HERE), var_returnTypeProxy_7461 COMMA_SOURCE_FILE ("declaration-func.galgas", 226)) ;
    }
    GALGAS_bool var_globalFunction_7503 = GALGAS_bool (false) ;
    GALGAS_bool var_canMutateProperties_7539 = GALGAS_bool (false) ;
    cEnumerator_lstringlist enumerator_7602 (enumerator_7204.current (HERE).getter_mFunctionAttributeList (HERE), kENUMERATION_UP) ;
    while (enumerator_7602.hasCurrentObject ()) {
      const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_7602.current_mValue (HERE).getter_string (HERE).objectCompare (function_exportedAttribute (inCompiler COMMA_SOURCE_FILE ("declaration-func.galgas", 231)))).boolEnum () ;
      if (kBoolTrue == test_1) {
        var_globalFunction_7503 = GALGAS_bool (true) ;
      }else if (kBoolFalse == test_1) {
        const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, enumerator_7602.current_mValue (HERE).getter_string (HERE).objectCompare (function_mutatingAttribute (inCompiler COMMA_SOURCE_FILE ("declaration-func.galgas", 233)))).boolEnum () ;
        if (kBoolTrue == test_2) {
          var_canMutateProperties_7539 = GALGAS_bool (true) ;
        }
      }
      enumerator_7602.gotoNextObject () ;
    }
    GALGAS_bool var_canAccessProperties_7829 = GALGAS_bool (kIsNotEqual, enumerator_7204.current (HERE).getter_mMode (HERE).objectCompare (GALGAS_mode::constructor_userMode (SOURCE_FILE ("declaration-func.galgas", 237)))) ;
    GALGAS_lstring var_routineMangledName_7914 = function_routineMangledNameFromAST (constinArgument_inSelfTypeName, enumerator_7204.current (HERE).getter_mFunctionName (HERE), enumerator_7204.current (HERE).getter_mFunctionFormalArgumentList (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-func.galgas", 239)) ;
    {
    extensionSetter_insertKey (ioArgument_ioContext.mProperty_mRoutineMapForContext, enumerator_7204.current (HERE).getter_mFunctionName (HERE), extensionGetter_routineSignature (enumerator_7204.current (HERE).getter_mFunctionFormalArgumentList (HERE), enumerator_7204.current (HERE).getter_mFunctionName (HERE).getter_location (SOURCE_FILE ("declaration-func.galgas", 247)), inCompiler COMMA_SOURCE_FILE ("declaration-func.galgas", 247)), var_routineMangledName_7914, GALGAS_routineDescriptor::constructor_new (enumerator_7204.current (HERE).getter_mPublicFunction (HERE), var_globalFunction_7503, GALGAS_routineKind::constructor_function (enumerator_7204.current (HERE).getter_mMode (HERE)  COMMA_SOURCE_FILE ("declaration-func.galgas", 252)), var_signature_7320, var_returnTypeProxy_7461, var_canMutateProperties_7539, var_canAccessProperties_7829  COMMA_SOURCE_FILE ("declaration-func.galgas", 249)), inCompiler COMMA_SOURCE_FILE ("declaration-func.galgas", 245)) ;
    }
...
void extensionMethod_functionSemanticAnalysis (const GALGAS_functionDeclarationListAST inObject,
                                               ...
                                               COMMA_UNUSED_LOCATION_ARGS) {
  const GALGAS_functionDeclarationListAST temp_0 = inObject ;
  cEnumerator_functionDeclarationListAST enumerator_9205 (temp_0, kENUMERATION_UP) ;
  while (enumerator_9205.hasCurrentObject ()) {
    GALGAS_bool var_warnIfUnused_9229 = GALGAS_bool (true) ;
    GALGAS_bool var_globalProcedure_9260 = GALGAS_bool (false) ;
    cEnumerator_lstringlist enumerator_9324 (enumerator_9205.current (HERE).getter_mFunctionAttributeList (HERE), kENUMERATION_UP) ;
    while (enumerator_9324.hasCurrentObject ()) {
      const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_9324.current_mValue (HERE).getter_string (HERE).objectCompare (function_noUnusedWarningAttribute (inCompiler COMMA_SOURCE_FILE ("declaration-func.galgas", 276)))).boolEnum () ;
      if (kBoolTrue == test_1) {
        const enumGalgasBool test_2 = var_warnIfUnused_9229.operator_not (SOURCE_FILE ("declaration-func.galgas", 277)).boolEnum () ;
        if (kBoolTrue == test_2) {
          TC_Array <C_FixItDescription> fixItArray3 ;
          inCompiler->emitSemanticError (enumerator_9324.current_mValue (HERE).getter_location (SOURCE_FILE ("declaration-func.galgas", 278)), GALGAS_string ("duplicated @").add_operation (function_noUnusedWarningAttribute (inCompiler COMMA_SOURCE_FILE ("declaration-func.galgas", 278)), inCompiler COMMA_SOURCE_FILE ("declaration-func.galgas", 278)).add_operation (GALGAS_string (" attribute"), inCompiler COMMA_SOURCE_FILE ("declaration-func.galgas", 278)), fixItArray3  COMMA_SOURCE_FILE ("declaration-func.galgas", 278)) ;
        }
        var_warnIfUnused_9229 = GALGAS_bool (false) ;
      }else if (kBoolFalse == test_1) {
        const enumGalgasBool test_4 = GALGAS_bool (kIsEqual, enumerator_9324.current_mValue (HERE).getter_string (HERE).objectCompare (function_exportedAttribute (inCompiler COMMA_SOURCE_FILE ("declaration-func.galgas", 281)))).boolEnum () ;
        if (kBoolTrue == test_4) {
          const enumGalgasBool test_5 = var_globalProcedure_9260.boolEnum () ;
          if (kBoolTrue == test_5) {
            TC_Array <C_FixItDescription> fixItArray6 ;
          ...
          var_globalProcedure_9260 = GALGAS_bool (true) ;
        }else if (kBoolFalse == test_4) {
          TC_Array <C_FixItDescription> fixItArray7 ;
    ...
    {
    routine_routineSemanticAnalysis (inArgument_inReceiverType, GALGAS_routineKind::constructor_function (enumerator_9205.current (HERE).getter_mMode (HERE)  COMMA_SOURCE_FILE ("declaration-func.galgas", 293)), enumerator_9205.current (HERE).getter_mMode (HERE), enumerator_9205.current (HERE).getter_mFunctionName (HERE), enumerator_9205.current (HERE).getter_mFunctionFormalArgumentList (HERE), enumerator_9205.current (HERE).getter_mFunctionReturnTypeName (HERE), enumerator_9205.current (HERE).getter_mFunctionInstructionList (HERE), enumerator_9205.current (HERE).getter_mEndOfFunctionDeclaration (HERE), GALGAS_bool (true), GALGAS_bool (true), var_warnIfUnused_9229, var_globalProcedure_9260, constinArgument_inSemanticContext, ioArgument_ioTemporaries, ioArgument_ioIntermediateCodeStruct, inCompiler  COMMA_SOURCE_FILE ("declaration-func.galgas", 291)) ;
    }
...
void extensionMethod_externProcedureSemanticAnalysis (const GALGAS_externProcedureDeclarationListAST inObject,
                                                      ...
                                                      COMMA_UNUSED_LOCATION_ARGS) {
  const GALGAS_externProcedureDeclarationListAST temp_0 = inObject ;
  cEnumerator_externProcedureDeclarationListAST enumerator_4689 (temp_0, kENUMERATION_UP) ;
  while (enumerator_4689.hasCurrentObject ()) {
    extensionMethod_externProcedureSemanticAnalysis (enumerator_4689.current (HERE), constinArgument_inContext, ioArgument_ioTemporaries, ioArgument_ioIntermediateCodeStruct, inCompiler COMMA_SOURCE_FILE ("declaration-extern-proc.galgas", 107)) ;
...
void extensionMethod_llvmPrototypeGeneration (const GALGAS_externProcedureMapIR inObject,
  ...
  cEnumerator_externProcedureMapIR enumerator_7259 (temp_0, kENUMERATION_UP) ;
  while (enumerator_7259.hasCurrentObject ()) {
    extensionMethod_llvmPrototypeGeneration (enumerator_7259.current (HERE), ioArgument_ioLLVMcode, inCompiler COMMA_SOURCE_FILE ("declaration-extern-proc.galgas", 181)) ;
...
void extensionMethod_isrSemanticAnalysis (const GALGAS_isrDeclarationListAST inObject,
  ...
  while (enumerator_2798.hasCurrentObject ()) {
    ...
    GALGAS_universalPropertyAndRoutineMapForContext var_universalMap_3415 ;
    {
    routine_initialVariableMap (constinArgument_inSemanticContext, enumerator_2798.current (HERE).getter_mMode (HERE), GALGAS_bool (false), GALGAS_string::makeEmptyString ().getter_nowhere (SOURCE_FILE ("declaration-isr.galgas", 83)), var_universalMap_3415, inCompiler  COMMA_SOURCE_FILE ("declaration-isr.galgas", 79)) ;
    }
    ...
    GALGAS_PLMType var_selfType_3464 = temp_2 ;
    GALGAS_allocaList var_allocaList_3718 = GALGAS_allocaList::constructor_emptyList (SOURCE_FILE ("declaration-isr.galgas", 94)) ;
    GALGAS_instructionListIR var_instructionGenerationList_3772 = GALGAS_instructionListIR::constructor_emptyList (SOURCE_FILE ("declaration-isr.galgas", 95)) ;
    extensionMethod_analyzeRoutineInstructionList (enumerator_2798.current (HERE).getter_mISRInstructionList (HERE), var_selfType_3464, GALGAS_bool (true), GALGAS_bool (true), var_routineNameForInvocationGraph_2863, constinArgument_inSemanticContext, enumerator_2798.current (HERE).getter_mMode (HERE), ioArgument_ioTemporaries, ioArgument_ioIntermediateCodeStruct.mProperty_mStaticStringMap, var_universalMap_3415, var_allocaList_3718, var_instructionGenerationList_3772, inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 96)) ;
    callExtensionMethod_checkLocalVariableFinalState ((const cPtr_universalPropertyAndRoutineMapForContext *) var_universalMap_3415.ptr (), inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 111)) ;
    GALGAS_interruptionPanicCode joker_4557 ; // Joker input parameter
    constinArgument_inSemanticContext.getter_mAvailableInterruptMap (HERE).method_searchKey (enumerator_2798.current (HERE).getter_mISRName (HERE), joker_4557, inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 115)) ;
    {
    ioArgument_ioIntermediateCodeStruct.mProperty_mInterruptMapIR.setter_insertKey (enumerator_2798.current (HERE).getter_mISRName (HERE), var_selfType_3464, enumerator_2798.current (HERE).getter_mModuleName (HERE).getter_string (SOURCE_FILE ("declaration-isr.galgas", 119)), var_allocaList_3718, var_instructionGenerationList_3772, enumerator_2798.current (HERE).getter_mMode (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 116)) ;
    }
...
void extensionMethod_interruptCodeGeneration (const GALGAS_interruptMapIR inObject,
                                              ...
                                              C_Compiler * inCompiler
                                              COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_stringset var_definedInterrupts_5856 = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("declaration-isr.galgas", 148)) ;
  const GALGAS_interruptMapIR temp_0 = inObject ;
  cEnumerator_interruptMapIR enumerator_5885 (temp_0, kENUMERATION_UP) ;
  while (enumerator_5885.hasCurrentObject ()) {
    var_definedInterrupts_5856.addAssign_operation (enumerator_5885.current (HERE).getter_lkey (HERE).getter_string (HERE)  COMMA_SOURCE_FILE ("declaration-isr.galgas", 150)) ;
    GALGAS_string temp_1 ;
    const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, enumerator_5885.current (HERE).getter_mMode (HERE).objectCompare (GALGAS_mode::constructor_serviceMode (SOURCE_FILE ("declaration-isr.galgas", 151)))).boolEnum () ;
    if (kBoolTrue == test_2) {
      temp_1 = function_llvmNameForServiceInterrupt (enumerator_5885.current (HERE).getter_lkey (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 152)).getter_string (HERE) ;
    }else if (kBoolFalse == test_2) {
      temp_1 = function_llvmNameForSectionOrSafeInterrupt (enumerator_5885.current (HERE).getter_lkey (HERE).getter_string (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 154)) ;
    }
    GALGAS_string var_interruptImplementationName_5972 = temp_1 ;
    ioArgument_ioLLVMcode.plusAssign_operation(function_llvmTitleComment (var_interruptImplementationName_5972, inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 156)), inCompiler  COMMA_SOURCE_FILE ("declaration-isr.galgas", 156)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("define void @").add_operation (var_interruptImplementationName_5972, inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 157)).add_operation (GALGAS_string (" ()"), inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 157)).add_operation (function_llvmAttributeFunction (inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 157)), inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 157)).add_operation (GALGAS_string (" {\n"), inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 157)), inCompiler  COMMA_SOURCE_FILE ("declaration-isr.galgas", 157)) ;
    cEnumerator_allocaList enumerator_6400 (enumerator_5885.current (HERE).getter_mAllocaList (HERE), kENUMERATION_UP) ;
    while (enumerator_6400.hasCurrentObject ()) {
      ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  ").add_operation (function_llvmNameForLocalVariable (enumerator_6400.current_mVarName (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 160)), inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 160)).add_operation (GALGAS_string (" = alloca "), inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 160)).add_operation (enumerator_6400.current_mLLVMTypeName (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 160)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 160)), inCompiler  COMMA_SOURCE_FILE ("declaration-isr.galgas", 160)) ;
      enumerator_6400.gotoNextObject () ;
    }
    const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, enumerator_5885.current (HERE).getter_mSelfType (HERE).objectCompare (GALGAS_PLMType::constructor_void (SOURCE_FILE ("declaration-isr.galgas", 163)))).boolEnum () ;
    if (kBoolTrue == test_3) {
      GALGAS_string var_varName_6590 = function_llvmNameForGlobalVariable (enumerator_5885.current (HERE).getter_mGlobalVariableName (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 164)) ;
      GALGAS_string var_typeName_6670 = extensionGetter_llvmTypeName (enumerator_5885.current (HERE).getter_mSelfType (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 165)) ;
      ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  %self = getelementptr inbounds ").add_operation (var_typeName_6670, inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 166)).add_operation (GALGAS_string (", "), inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 166)).add_operation (var_typeName_6670, inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 166)).add_operation (GALGAS_string (" * "), inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 166)).add_operation (var_varName_6590, inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 166)), inCompiler  COMMA_SOURCE_FILE ("declaration-isr.galgas", 166)) ;
      ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string (", i32 0 ; Perform %self = @").add_operation (var_varName_6590, inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 167)).add_operation (GALGAS_string (" \n"), inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 167)), inCompiler  COMMA_SOURCE_FILE ("declaration-isr.galgas", 167)) ;
    }
    extensionMethod_instructionListLLVMCode (enumerator_5885.current (HERE).getter_mInstructionGenerationList (HERE), ioArgument_ioLLVMcode, constinArgument_inGenerationContext, ioArgument_ioGenerationAdds, inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 170)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  ret void\n"), inCompiler  COMMA_SOURCE_FILE ("declaration-isr.galgas", 172)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("}\n"
      "\n"), inCompiler  COMMA_SOURCE_FILE ("declaration-isr.galgas", 173)) ;
    const enumGalgasBool test_4 = GALGAS_bool (kIsEqual, enumerator_5885.current (HERE).getter_mMode (HERE).objectCompare (GALGAS_mode::constructor_serviceMode (SOURCE_FILE ("declaration-isr.galgas", 175)))).boolEnum () ;
    if (kBoolTrue == test_4) {
      GALGAS_string var_interruptHandlerName_7221 = function_llvmNameForServiceInterrupt (enumerator_5885.current (HERE).getter_lkey (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 176)).getter_string (HERE) ;
      GALGAS_string var_isrName_7293 = function_llvmNameForSectionOrSafeInterrupt (enumerator_5885.current (HERE).getter_lkey (HERE).getter_string (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 177)) ;
      GALGAS_string var_s_31__7366 = constinArgument_inXTRInterruptHandlerString.getter_stringByReplacingStringByString (GALGAS_string ("!ISR!"), var_isrName_7293, inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 178)) ;
      GALGAS_string var_s_32__7460 = var_s_31__7366.getter_stringByReplacingStringByString (GALGAS_string ("!HANDLER!"), var_interruptHandlerName_7221, inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 179)) ;
      ioArgument_ioAScode.plusAssign_operation(var_s_32__7460, inCompiler  COMMA_SOURCE_FILE ("declaration-isr.galgas", 180)) ;
    }
    enumerator_5885.gotoNextObject () ;
  }
  cEnumerator_availableInterruptMap enumerator_7689 (constinArgument_inGenerationContext.getter_mAvailableInterruptMap (HERE), kENUMERATION_UP) ;
  while (enumerator_7689.hasCurrentObject ()) {
    const enumGalgasBool test_5 = var_definedInterrupts_5856.getter_hasKey (enumerator_7689.current_lkey (HERE).getter_string (HERE) COMMA_SOURCE_FILE ("declaration-isr.galgas", 185)).operator_not (SOURCE_FILE ("declaration-isr.galgas", 185)).boolEnum () ;
    if (kBoolTrue == test_5) {
      switch (enumerator_7689.current_mInterruptionPanicCode (HERE).enumValue ()) {
      case GALGAS_interruptionPanicCode::kNotBuilt:
        break ;
      case GALGAS_interruptionPanicCode::kEnum_noPanicCode:
        {
          GALGAS_string var_s_7810 = constinArgument_inUndefinedInterruptString.getter_stringByReplacingStringByString (GALGAS_string ("!ISR!"), function_llvmNameForSectionOrSafeInterrupt (enumerator_7689.current_lkey (HERE).getter_string (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 188)), inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 188)) ;
          ioArgument_ioAScode.plusAssign_operation(var_s_7810, inCompiler  COMMA_SOURCE_FILE ("declaration-isr.galgas", 189)) ;
        }
        break ;
      case GALGAS_interruptionPanicCode::kEnum_panicCode:
        {
          const cEnumAssociatedValues_interruptionPanicCode_panicCode * extractPtr_8686 = (const cEnumAssociatedValues_interruptionPanicCode_panicCode *) (enumerator_7689.current_mInterruptionPanicCode (HERE).unsafePointer ()) ;
          const GALGAS_lbigint extractedValue_value = extractPtr_8686->mAssociatedValue0 ;
          const enumGalgasBool test_6 = GALGAS_bool (gOption_plm_5F_options_noPanicGeneration.getter_value ()).boolEnum () ;
          if (kBoolTrue == test_6) {
            GALGAS_string var_s_8071 = constinArgument_inUndefinedInterruptString.getter_stringByReplacingStringByString (GALGAS_string ("!ISR!"), function_llvmNameForSectionOrSafeInterrupt (enumerator_7689.current_lkey (HERE).getter_string (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 192)), inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 192)) ;
            ioArgument_ioAScode.plusAssign_operation(var_s_8071, inCompiler  COMMA_SOURCE_FILE ("declaration-isr.galgas", 193)) ;
          }else if (kBoolFalse == test_6) {
            GALGAS_string var_name_8249 = function_llvmNameForSectionOrSafeInterrupt (enumerator_7689.current_lkey (HERE).getter_string (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 195)) ;
            ioArgument_ioLLVMcode.plusAssign_operation(function_llvmTitleComment (GALGAS_string ("Panic code for ").add_operation (var_name_8249, inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 196)), inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 196)), inCompiler  COMMA_SOURCE_FILE ("declaration-isr.galgas", 196)) ;
            ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("define void @").add_operation (var_name_8249, inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 197)).add_operation (GALGAS_string (" ()"), inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 197)).add_operation (function_llvmAttributeFunction (inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 197)), inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 197)).add_operation (GALGAS_string (" noreturn {\n"), inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 197)), inCompiler  COMMA_SOURCE_FILE ("declaration-isr.galgas", 197)) ;
...
void extensionMethod_noteTypesInPrecedenceGraph (const GALGAS_guardDeclarationListAST inObject,
  ...
  cEnumerator_guardDeclarationListAST enumerator_2985 (temp_0, kENUMERATION_UP) ;
  while (enumerator_2985.hasCurrentObject ()) {
    cEnumerator_routineFormalArgumentList enumerator_3055 (enumerator_2985.current_mGuardFormalArgumentList (HERE), kENUMERATION_UP) ;
    while (enumerator_3055.hasCurrentObject ()) {
      GALGAS_lstring var_typeName_3077 = function_llvmRegularTypeMangledNameFromName (enumerator_3055.current_mFormalArgumentTypeName (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 85)) ;
      {
      ioArgument_ioGraph.setter_noteNode (var_typeName_3077 COMMA_SOURCE_FILE ("declaration-guard.galgas", 86)) ;
      }
      enumerator_3055.gotoNextObject () ;
    }
    extensionMethod_noteInstructionListTypesInPrecedenceGraph (enumerator_2985.current_mGuardInstructionList (HERE), ioArgument_ioGraph, inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 88)) ;
...
void extensionMethod_enterInContext (const GALGAS_guardDeclarationListAST inObject,
                                     ...
                                     COMMA_UNUSED_LOCATION_ARGS) {
  const GALGAS_guardDeclarationListAST temp_0 = inObject ;
  cEnumerator_guardDeclarationListAST enumerator_3793 (temp_0, kENUMERATION_UP) ;
  while (enumerator_3793.hasCurrentObject ()) {
    GALGAS_lstring var_guardMangledName_3847 = function_routineMangledNameFromAST (constinArgument_inReceiverTypeName, enumerator_3793.current (HERE).getter_mGuardName (HERE), enumerator_3793.current (HERE).getter_mGuardFormalArgumentList (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 102)) ;
    GALGAS_routineTypedSignature var_signature_4079 ;
    {
    routine_routineSignature (ioArgument_ioContext.mProperty_mTypeMap, enumerator_3793.current (HERE).getter_mGuardFormalArgumentList (HERE), var_signature_4079, inCompiler  COMMA_SOURCE_FILE ("declaration-guard.galgas", 108)) ;
    }
    {
    ioArgument_ioContext.mProperty_mGuardMapForContext.setter_insertKey (var_guardMangledName_3847, enumerator_3793.current (HERE).getter_mIsPublic (HERE), var_signature_4079, inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 110)) ;
    }
...
void extensionMethod_guardSemanticAnalysis (const GALGAS_guardDeclarationListAST inObject,
                                            ...
                                            COMMA_UNUSED_LOCATION_ARGS) {
  const GALGAS_guardDeclarationListAST temp_0 = inObject ;
  cEnumerator_guardDeclarationListAST enumerator_4886 (temp_0, kENUMERATION_UP) ;
  while (enumerator_4886.hasCurrentObject ()) {
    GALGAS_bool var_warnIfUnused_4910 = GALGAS_bool (true) ;
    cEnumerator_lstringlist enumerator_4966 (enumerator_4886.current (HERE).getter_mGuardAttributeList (HERE), kENUMERATION_UP) ;
    while (enumerator_4966.hasCurrentObject ()) {
      const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_4966.current_mValue (HERE).getter_string (HERE).objectCompare (function_noUnusedWarningAttribute (inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 131)))).boolEnum () ;
      if (kBoolTrue == test_1) {
        const enumGalgasBool test_2 = var_warnIfUnused_4910.operator_not (SOURCE_FILE ("declaration-guard.galgas", 132)).boolEnum () ;
        if (kBoolTrue == test_2) {
          TC_Array <C_FixItDescription> fixItArray3 ;
          inCompiler->emitSemanticError (enumerator_4966.current_mValue (HERE).getter_location (SOURCE_FILE ("declaration-guard.galgas", 133)), GALGAS_string ("duplicate @").add_operation (function_noUnusedWarningAttribute (inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 133)), inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 133)).add_operation (GALGAS_string (" attribute"), inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 133)), fixItArray3  COMMA_SOURCE_FILE ("declaration-guard.galgas", 133)) ;
        }
        var_warnIfUnused_4910 = GALGAS_bool (false) ;
      }else if (kBoolFalse == test_1) {
    ...
    {
    routine_guardSemanticAnalysis (inArgument_inReceiverType, enumerator_4886.current (HERE).getter_mGuardName (HERE), enumerator_4886.current (HERE).getter_mGuardFormalArgumentList (HERE), enumerator_4886.current (HERE).getter_mGuardKind (HERE), enumerator_4886.current (HERE).getter_mGuardInstructionList (HERE), enumerator_4886.current (HERE).getter_mEndOfGuardDeclaration (HERE), var_warnIfUnused_4910, constinArgument_inSemanticContext, ioArgument_ioTemporaries, ioArgument_ioIntermediateCodeStruct, inCompiler  COMMA_SOURCE_FILE ("declaration-guard.galgas", 140)) ;
    }
...
void extensionMethod_guardCodeGeneration (const GALGAS_guardMapIR inObject,
  ...
  cEnumerator_guardMapIR enumerator_19441 (temp_0, kENUMERATION_UP) ;
  while (enumerator_19441.hasCurrentObject ()) {
    switch (enumerator_19441.current (HERE).getter_mGuardKindGenerationIR (HERE).enumValue ()) {
    ...
    case GALGAS_guardKindGenerationIR::kEnum_baseGuard:
      {
        GALGAS_string var_guardImplementationName_19577 = function_llvmNameForGuardImplementation (enumerator_19441.current (HERE).getter_lkey (HERE).getter_string (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 490)) ;
        GALGAS_string var_guardCallName_19655 = function_llvmNameForGuardCall (enumerator_19441.current (HERE).getter_lkey (HERE).getter_string (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 491)) ;
        ioArgument_ioServiceList.addAssign_operation (var_guardCallName_19655, var_guardImplementationName_19577  COMMA_SOURCE_FILE ("declaration-guard.galgas", 492)) ;
        ioArgument_ioLLVMcode.plusAssign_operation(function_llvmTitleComment (var_guardImplementationName_19577, inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 493)), inCompiler  COMMA_SOURCE_FILE ("declaration-guard.galgas", 493)) ;
        ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("declare i1 @").add_operation (var_guardCallName_19655, inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 494)).add_operation (GALGAS_string (" ("), inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 494)), inCompiler  COMMA_SOURCE_FILE ("declaration-guard.galgas", 494)) ;
        GALGAS_string temp_1 ;
        const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, enumerator_19441.current (HERE).getter_mReceiverType (HERE).objectCompare (GALGAS_PLMType::constructor_void (SOURCE_FILE ("declaration-guard.galgas", 495)))).boolEnum () ;
        if (kBoolTrue == test_2) {
          temp_1 = GALGAS_string::makeEmptyString () ;
        }else if (kBoolFalse == test_2) {
          temp_1 = GALGAS_string ("$").add_operation (extensionGetter_key (enumerator_19441.current (HERE).getter_mReceiverType (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 495)), inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 495)) ;
        }
        GALGAS_string var_typeName_19903 = temp_1 ;
        GALGAS_bool var_first_20002 = GALGAS_bool (kIsEqual, var_typeName_19903.objectCompare (GALGAS_string::makeEmptyString ())) ;
        const enumGalgasBool test_3 = var_first_20002.operator_not (SOURCE_FILE ("declaration-guard.galgas", 497)).boolEnum () ;
        if (kBoolTrue == test_3) {
          ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("%").add_operation (var_typeName_19903.getter_assemblerRepresentation (SOURCE_FILE ("declaration-guard.galgas", 498)), inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 498)).add_operation (GALGAS_string (" * %self"), inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 498)), inCompiler  COMMA_SOURCE_FILE ("declaration-guard.galgas", 498)) ;
        }
        cEnumerator_routineFormalArgumentListForGeneration enumerator_20186 (enumerator_19441.current (HERE).getter_mFormalArgumentListForGeneration (HERE), kENUMERATION_UP) ;
        while (enumerator_20186.hasCurrentObject ()) {
          const enumGalgasBool test_4 = var_first_20002.boolEnum () ;
          if (kBoolTrue == test_4) {
            var_first_20002 = GALGAS_bool (false) ;
          }else if (kBoolFalse == test_4) {
            ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string (", "), inCompiler  COMMA_SOURCE_FILE ("declaration-guard.galgas", 501)) ;
          }
          switch (enumerator_20186.current_mFormalArgumentKind (HERE).enumValue ()) {
          case GALGAS_procFormalArgumentPassingMode::kNotBuilt:
            break ;
          case GALGAS_procFormalArgumentPassingMode::kEnum_input:
            {
              ioArgument_ioLLVMcode.plusAssign_operation(extensionGetter_llvmTypeName (enumerator_20186.current_mFormalArgumentType (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 504)).add_operation (GALGAS_string (" %in."), inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 504)).add_operation (enumerator_20186.current_mFormalArgumentName (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 504)), inCompiler  COMMA_SOURCE_FILE ("declaration-guard.galgas", 504)) ;
            }
            break ;
          case GALGAS_procFormalArgumentPassingMode::kEnum_output:
            {
              ioArgument_ioLLVMcode.plusAssign_operation(extensionGetter_llvmTypeName (enumerator_20186.current_mFormalArgumentType (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 506)).add_operation (GALGAS_string (" * "), inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 506)).add_operation (function_llvmNameForLocalVariable (enumerator_20186.current_mFormalArgumentName (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 506)), inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 506)), inCompiler  COMMA_SOURCE_FILE ("declaration-guard.galgas", 506)) ;
            }
            break ;
          case GALGAS_procFormalArgumentPassingMode::kEnum_inputOutput:
            {
              ioArgument_ioLLVMcode.plusAssign_operation(extensionGetter_llvmTypeName (enumerator_20186.current_mFormalArgumentType (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 508)).add_operation (GALGAS_string (" * "), inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 508)).add_operation (function_llvmNameForLocalVariable (enumerator_20186.current_mFormalArgumentName (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 508)), inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 508)), inCompiler  COMMA_SOURCE_FILE ("declaration-guard.galgas", 508)) ;
            }
            break ;
          }
          enumerator_20186.gotoNextObject () ;
        }
        ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string (")").add_operation (function_llvmAttributeFunction (inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 511)), inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 511)).add_operation (GALGAS_string ("\n"
          "\n"), inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 511)), inCompiler  COMMA_SOURCE_FILE ("declaration-guard.galgas", 511)) ;
      }
      break ;
    }
    extensionMethod_llvmCodeGeneration (enumerator_19441.current (HERE), ioArgument_ioLLVMcode, constinArgument_inGenerationContext, ioArgument_ioGenerationAdds, inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 513)) ;
...
static void extensionMethod_expressionAST_analyzeStaticExpression (const cPtr_expressionAST * inObject,
  ...
  GALGAS_instructionListIR var_instructionGenerationList_13985 = GALGAS_instructionListIR::constructor_emptyList (SOURCE_FILE ("expression-operator-priority.galgas", 442)) ;
  GALGAS_allocaList var_allocaList_14015 = GALGAS_allocaList::constructor_emptyList (SOURCE_FILE ("expression-operator-priority.galgas", 443)) ;
  GALGAS_semanticTemporariesStruct joker_14227 = GALGAS_semanticTemporariesStruct::constructor_default (SOURCE_FILE ("expression-operator-priority.galgas", 451)) ;
  GALGAS_universalPropertyAndRoutineMapForContext joker_14294 = GALGAS_universalPropertyAndRoutineMapForContext::constructor_default (SOURCE_FILE ("expression-operator-priority.galgas", 453)) ;
  const GALGAS_expressionAST temp_0 = object ;
  callExtensionMethod_analyzeExpression ((const cPtr_expressionAST *) temp_0.ptr (), GALGAS_PLMType::constructor_void (SOURCE_FILE ("expression-operator-priority.galgas", 445)), GALGAS_bool (false), GALGAS_string ("compiler").getter_nowhere (SOURCE_FILE ("expression-operator-priority.galgas", 447)), GALGAS_PLMType::constructor_void (SOURCE_FILE ("expression-operator-priority.galgas", 448)), constinArgument_inContext, GALGAS_mode::constructor_bootMode (SOURCE_FILE ("expression-operator-priority.galgas", 450)), joker_14227, ioArgument_ioGlobalLiteralStringMap, joker_14294, var_allocaList_14015, var_instructionGenerationList_13985, outArgument_outResult, inCompiler COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 444)) ;
  GALGAS_bool test_1 = GALGAS_bool (kIsStrictSup, var_allocaList_14015.getter_length (SOURCE_FILE ("expression-operator-priority.galgas", 458)).objectCompare (GALGAS_uint ((uint32_t) 0U))) ;
  if (kBoolTrue != test_1.boolEnum ()) {
    test_1 = GALGAS_bool (kIsStrictSup, var_instructionGenerationList_13985.getter_length (SOURCE_FILE ("expression-operator-priority.galgas", 458)).objectCompare (GALGAS_uint ((uint32_t) 0U))) ;
  }
