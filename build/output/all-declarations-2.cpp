...
void extensionMethod_generateLLVMForStaticLists (const GALGAS_staticListInitializationMap inObject,
  ...
  while (enumerator_22067.hasCurrentObject ()) {
    const enumGalgasBool test_1 = constinArgument_inUsefulStaticArrayMap.getter_hasKey (enumerator_22067.current_lkey (HERE).getter_string (SOURCE_FILE ("declaration-static-array.galgas", 522)) COMMA_SOURCE_FILE ("declaration-static-array.galgas", 522)).boolEnum () ;
    if (kBoolTrue == test_1) {
      const enumGalgasBool test_2 = var_first_22031.boolEnum () ;
      if (kBoolTrue == test_2) {
        var_first_22031 = GALGAS_bool (false) ;
        ioArgument_ioLLVMcode.plusAssign_operation(function_llvmTitleComment (GALGAS_string ("Static Arraies"), inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 525)), inCompiler  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 525)) ;
      }
      ...
      ioArgument_ioLLVMcode.plusAssign_operation(enumerator_22067.current_mInitializationList (HERE).getter_length (SOURCE_FILE ("declaration-static-array.galgas", 528)).getter_string (SOURCE_FILE ("declaration-static-array.galgas", 528)).add_operation (GALGAS_string (" x %"), inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 528)).add_operation (function_llvmNameForStaticListElementType (enumerator_22067.current_lkey (HERE).getter_string (HERE).getter_nowhere (SOURCE_FILE ("declaration-static-array.galgas", 528)), inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 528)).getter_string (SOURCE_FILE ("declaration-static-array.galgas", 528)), inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 528)).add_operation (GALGAS_string ("] [\n"), inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 528)), inCompiler  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 528)) ;
      ...
      while (enumerator_22470.hasCurrentObject ()) {
        ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  %").add_operation (function_llvmNameForStaticListElementType (enumerator_22067.current_lkey (HERE).getter_string (HERE).getter_nowhere (SOURCE_FILE ("declaration-static-array.galgas", 531)), inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 531)).getter_string (SOURCE_FILE ("declaration-static-array.galgas", 531)), inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 531)).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 531)).add_operation (enumerator_22470.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 531)), inCompiler  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 531)) ;
        if (enumerator_22470.hasNextObject ()) {
          ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string (",\n"), inCompiler  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 533)) ;
        }
        enumerator_22470.gotoNextObject () ;
      }
      ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("\n"
        "]\n"
        "\n"), inCompiler  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 535)) ;
    }
