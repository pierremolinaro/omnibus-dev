...
void extensionMethod_generateLLVMForStaticLists (const GALGAS_staticListInitializationMap inObject,
                                                 ...
                                                 C_Compiler * inCompiler
                                                 COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_bool var_first_22876 = GALGAS_bool (true) ;
  const GALGAS_staticListInitializationMap temp_0 = inObject ;
  cEnumerator_staticListInitializationMap enumerator_22912 (temp_0, kENUMERATION_UP) ;
  while (enumerator_22912.hasCurrentObject ()) {
    const enumGalgasBool test_1 = constinArgument_inUsefulStaticArrayMap.getter_hasKey (enumerator_22912.current_lkey (HERE).getter_string (SOURCE_FILE ("declaration-static-array.galgas", 538)) COMMA_SOURCE_FILE ("declaration-static-array.galgas", 538)).boolEnum () ;
    if (kBoolTrue == test_1) {
      const enumGalgasBool test_2 = var_first_22876.boolEnum () ;
      if (kBoolTrue == test_2) {
        var_first_22876 = GALGAS_bool (false) ;
        ioArgument_ioLLVMcode.plusAssign_operation(function_llvmTitleComment (GALGAS_string ("Static Arraies"), inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 541)), inCompiler  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 541)) ;
      }
      ioArgument_ioLLVMcode.plusAssign_operation(function_llvmNameForGlobalVariable (enumerator_22912.current_lkey (HERE).getter_string (SOURCE_FILE ("declaration-static-array.galgas", 543)), inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 543)).add_operation (GALGAS_string (" = private unnamed_addr constant ["), inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 543)), inCompiler  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 543)) ;
      ioArgument_ioLLVMcode.plusAssign_operation(enumerator_22912.current_mInitializationList (HERE).getter_length (SOURCE_FILE ("declaration-static-array.galgas", 544)).getter_string (SOURCE_FILE ("declaration-static-array.galgas", 544)).add_operation (GALGAS_string (" x %"), inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 544)).add_operation (function_llvmTypeStringFromPLMname (function_llvmNameForStaticListElementType (enumerator_22912.current_lkey (HERE).getter_string (HERE).getter_nowhere (SOURCE_FILE ("declaration-static-array.galgas", 544)), inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 544)).getter_string (SOURCE_FILE ("declaration-static-array.galgas", 544)), inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 544)), inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 544)).add_operation (GALGAS_string ("] [\n"), inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 544)), inCompiler  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 544)) ;
      cEnumerator_stringlist enumerator_23344 (enumerator_22912.current_mInitializationList (HERE), kENUMERATION_UP) ;
      while (enumerator_23344.hasCurrentObject ()) {
        ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  %").add_operation (function_llvmTypeStringFromPLMname (function_llvmNameForStaticListElementType (enumerator_22912.current_lkey (HERE).getter_string (HERE).getter_nowhere (SOURCE_FILE ("declaration-static-array.galgas", 547)), inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 547)).getter_string (SOURCE_FILE ("declaration-static-array.galgas", 547)), inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 547)), inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 547)).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 547)).add_operation (enumerator_23344.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-static-array.galgas", 547)), inCompiler  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 547)) ;
        if (enumerator_23344.hasNextObject ()) {
          ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string (",\n"), inCompiler  COMMA_SOURCE_FILE ("declaration-static-array.galgas", 549)) ;
        }
