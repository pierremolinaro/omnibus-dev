...
//--------------------------------- Setters
  public : VIRTUAL_IN_DEBUG void modifier_insertAtIndex (class GALGAS_initRequiredByProcList constinArgument0,
  ...
  public : VIRTUAL_IN_DEBUG void modifier_popFirst (class GALGAS_initRequiredByProcList & outArgument0,
  ...
  public : VIRTUAL_IN_DEBUG void modifier_popLast (class GALGAS_initRequiredByProcList & outArgument0,
                                                   class GALGAS_location & outArgument1,
                                                   class GALGAS_instructionListIR & outArgument2,
                                                   class GALGAS_location & outArgument3,
                                                   C_Compiler * inCompiler
  ...
  public : VIRTUAL_IN_DEBUG void modifier_removeAtIndex (class GALGAS_initRequiredByProcList & outArgument0,
                                                         class GALGAS_location & outArgument1,
                                                         class GALGAS_instructionListIR & outArgument2,
                                                         class GALGAS_location & outArgument3,
                                                         class GALGAS_uint constinArgument4,
...
//--------------------------------- Getters
  ...
  public : VIRTUAL_IN_DEBUG class GALGAS_initRequiredByProcList reader_mInitRequiredByProcListAtIndex (const class GALGAS_uint & constinOperand0,
                                                                                                       C_Compiler * inCompiler
                                                                                                       COMMA_LOCATION_ARGS) const ;
...
//--------------------------------- Getters
  ...
  public : VIRTUAL_IN_DEBUG class GALGAS_initRequiredByProcList reader_mInitRequiredByProcList (LOCATION_ARGS) const ;
...
//--------------------------------- Getters
  ...
  public : VIRTUAL_IN_DEBUG class GALGAS_bool reader_isLlvmStructureConstant (LOCATION_ARGS) const ;
...
//--------------------------------- Setters
  ...
  public : VIRTUAL_IN_DEBUG void modifier_setMReadAccessAllowedForKey (class GALGAS_bool constinArgument0,
                                                                       class GALGAS_string constinArgument1,
                                                                       C_Compiler * inCompiler
                                                                       COMMA_LOCATION_ARGS) ;
  ...
  public : VIRTUAL_IN_DEBUG void modifier_setMVariableKindForKey (class GALGAS_objectInMemoryIR constinArgument0,
                                                                  class GALGAS_string constinArgument1,
                                                                  C_Compiler * inCompiler
                                                                  COMMA_LOCATION_ARGS) ;
...
//--------------------------------- Getters
  ...
  public : VIRTUAL_IN_DEBUG class GALGAS_bool reader_mReadAccessAllowedForKey (const class GALGAS_string & constinOperand0,
                                                                               C_Compiler * inCompiler
                                                                               COMMA_LOCATION_ARGS) const ;
  ...
  public : VIRTUAL_IN_DEBUG class GALGAS_objectInMemoryIR reader_mVariableKindForKey (const class GALGAS_string & constinOperand0,
                                                                                      C_Compiler * inCompiler
                                                                                      COMMA_LOCATION_ARGS) const ;
