...
//--------------------------------- Setters
  public : VIRTUAL_IN_DEBUG void setter_insertKey (class GALGAS_lstring constinArgument0,
                                                   class GALGAS_internalRoutineArgumentSignatureMapForContext constinArgument1,
                                                   C_Compiler * inCompiler
                                                   COMMA_LOCATION_ARGS) ;

  public : VIRTUAL_IN_DEBUG void setter_setMInternalRoutineArgumentSignatureMapForContextForKey (class GALGAS_internalRoutineArgumentSignatureMapForContext constinArgument0,
                                                                                                 class GALGAS_string constinArgument1,
                                                                                                 C_Compiler * inCompiler
                                                                                                 COMMA_LOCATION_ARGS) ;
...
//--------------------------------- Instance Methods
  public : VIRTUAL_IN_DEBUG void method_searchKey (class GALGAS_lstring constinArgument0,
                                                   class GALGAS_internalRoutineArgumentSignatureMapForContext & outArgument1,
                                                   C_Compiler * inCompiler
                                                   COMMA_LOCATION_ARGS) const ;
...
//--------------------------------- Getters
  public : VIRTUAL_IN_DEBUG class GALGAS_internalRoutineArgumentSignatureMapForContext getter_mInternalRoutineArgumentSignatureMapForContextForKey (const class GALGAS_string & constinOperand0,
                                                                                                                                                    C_Compiler * inCompiler
                                                                                                                                                    COMMA_LOCATION_ARGS) const ;
...
//--- Current element access
  public : class GALGAS_lstring current_lkey (LOCATION_ARGS) const ;
  public : class GALGAS_internalRoutineArgumentSignatureMapForContext current_mInternalRoutineArgumentSignatureMapForContext (LOCATION_ARGS) const ;
//--- Current element access
