...
static void extensionMethod_syncInstructionIR_llvmInstructionCode (const cPtr_abstractInstructionIR * inObject,
  ...
  while (enumerator_19018.hasCurrentObject ()) {
    ...
    case GALGAS_guardedCommandIR::kEnum_booleanGuard:
      {
        ...
        GALGAS_string var_acceptedLabelName_20363 = var_startLabel_18565.add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 482)).add_operation (index_18981.getter_string (SOURCE_FILE ("instruction-sync.galgas", 482)), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 482)).add_operation (GALGAS_string (".true"), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 482)) ;
        GALGAS_string var_rejectedLabelName_20426 = var_startLabel_18565.add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 483)).add_operation (index_18981.getter_string (SOURCE_FILE ("instruction-sync.galgas", 483)), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 483)).add_operation (GALGAS_string (".false"), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 483)) ;
        ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  br i1 ").add_operation (extensionGetter_llvmName (extractedValue_result.mAttribute_mValue, inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 484)), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 484)).add_operation (GALGAS_string (", label %"), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 484)).add_operation (var_acceptedLabelName_20363, inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 484)).add_operation (GALGAS_string (", label %"), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 484)).add_operation (var_rejectedLabelName_20426, inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 484)).add_operation (GALGAS_string ("\n"
          "\n"), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 484)), inCompiler  COMMA_SOURCE_FILE ("instruction-sync.galgas", 484)) ;
        ioArgument_ioLLVMcode.plusAssign_operation(var_acceptedLabelName_20363.add_operation (GALGAS_string (":\n"), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 485)), inCompiler  COMMA_SOURCE_FILE ("instruction-sync.galgas", 485)) ;
        ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  call void @noteGuardHasBeenAccepted ()\n"), inCompiler  COMMA_SOURCE_FILE ("instruction-sync.galgas", 486)) ;
        ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  br label %").add_operation (var_rejectedLabelName_20426, inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 487)).add_operation (GALGAS_string ("\n"
          "\n"), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 487)), inCompiler  COMMA_SOURCE_FILE ("instruction-sync.galgas", 487)) ;
        ioArgument_ioLLVMcode.plusAssign_operation(var_rejectedLabelName_20426.add_operation (GALGAS_string (":\n"), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 488)), inCompiler  COMMA_SOURCE_FILE ("instruction-sync.galgas", 488)) ;
    ...
    case GALGAS_guardedCommandIR::kEnum_boolAndSync:
      {
        ...
        GALGAS_string var_testOkLabelName_21234 = var_startLabel_18565.add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 493)).add_operation (index_18981.getter_string (SOURCE_FILE ("instruction-sync.galgas", 493)), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 493)).add_operation (GALGAS_string (".boolexp.true"), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 493)) ;
        GALGAS_string var_testExitLabelName_21305 = var_startLabel_18565.add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 494)).add_operation (index_18981.getter_string (SOURCE_FILE ("instruction-sync.galgas", 494)), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 494)).add_operation (GALGAS_string (".test.exit"), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 494)) ;
        ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  br i1 ").add_operation (extensionGetter_llvmName (extractedValue_expResult.mAttribute_mValue, inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 495)), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 495)).add_operation (GALGAS_string (", label %"), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 495)).add_operation (var_testOkLabelName_21234, inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 495)).add_operation (GALGAS_string (", label %"), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 495)).add_operation (var_testExitLabelName_21305, inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 495)).add_operation (GALGAS_string ("\n"
          "\n"), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 495)), inCompiler  COMMA_SOURCE_FILE ("instruction-sync.galgas", 495)) ;
        ioArgument_ioLLVMcode.plusAssign_operation(var_testOkLabelName_21234.add_operation (GALGAS_string (":\n"), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 496)), inCompiler  COMMA_SOURCE_FILE ("instruction-sync.galgas", 496)) ;
        ...
        GALGAS_string var_guardAcceptationLabelName_21667 = var_startLabel_18565.add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 498)).add_operation (index_18981.getter_string (SOURCE_FILE ("instruction-sync.galgas", 498)), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 498)).add_operation (GALGAS_string (".guard.acceptation"), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 498)) ;
        ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  %").add_operation (var_guardAcceptationLabelName_21667, inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 499)).add_operation (GALGAS_string (" = call i1 @"), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 499)).add_operation (function_llvmNameForGuardCall (extractedValue_guardMangledName, inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 499)), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 499)), inCompiler  COMMA_SOURCE_FILE ("instruction-sync.galgas", 499)) ;
        ...
        ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  br label %").add_operation (var_testExitLabelName_21305, inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 514)).add_operation (GALGAS_string ("\n"
          "\n"), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 514)), inCompiler  COMMA_SOURCE_FILE ("instruction-sync.galgas", 514)) ;
        ioArgument_ioLLVMcode.plusAssign_operation(var_testExitLabelName_21305.add_operation (GALGAS_string (":\n"), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 515)), inCompiler  COMMA_SOURCE_FILE ("instruction-sync.galgas", 515)) ;
        ...
        ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("[%").add_operation (var_guardAcceptationLabelName_21667, inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 517)).add_operation (GALGAS_string (", %"), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 517)).add_operation (var_testOkLabelName_21234, inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 517)).add_operation (GALGAS_string ("], "), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 517)), inCompiler  COMMA_SOURCE_FILE ("instruction-sync.galgas", 517)) ;
    ...
    GALGAS_string var_acceptedLabelName_22736 = var_startLabel_18565.add_operation (GALGAS_string (".accepted."), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 520)).add_operation (index_18981.getter_string (SOURCE_FILE ("instruction-sync.galgas", 520)), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 520)) ;
    GALGAS_string var_rejectedLabelName_22796 = var_startLabel_18565.add_operation (GALGAS_string (".rejected."), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 521)).add_operation (index_18981.getter_string (SOURCE_FILE ("instruction-sync.galgas", 521)), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 521)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  br i1 ").add_operation (var_acceptanceVarName_19053, inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 522)).add_operation (GALGAS_string (", label %"), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 522)).add_operation (var_acceptedLabelName_22736, inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 522)).add_operation (GALGAS_string (", label %"), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 522)).add_operation (var_rejectedLabelName_22796, inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 522)).add_operation (GALGAS_string ("\n"
      "\n"), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 522)), inCompiler  COMMA_SOURCE_FILE ("instruction-sync.galgas", 522)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(var_acceptedLabelName_22736.add_operation (GALGAS_string (":\n"), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 523)), inCompiler  COMMA_SOURCE_FILE ("instruction-sync.galgas", 523)) ;
    ...
    ioArgument_ioLLVMcode.plusAssign_operation(var_rejectedLabelName_22796.add_operation (GALGAS_string (":\n"), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 526)), inCompiler  COMMA_SOURCE_FILE ("instruction-sync.galgas", 526)) ;
    var_currentStartBranchLabel_18958 = var_rejectedLabelName_22796 ;
  ...
  if (kBoolTrue == test_2) {
    ...
    GALGAS_uint var_staticStringIndex_23988 ;
    {
    extensionSetter_findOrAddStaticString (ioArgument_ioGenerationAdds.mAttribute_mStaticStringMap, object->mAttribute_mSelectInstructionLocation.getter_file (inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 536)).getter_lastPathComponent (SOURCE_FILE ("instruction-sync.galgas", 536)).getter_stringByDeletingPathExtension (SOURCE_FILE ("instruction-sync.galgas", 536)), var_staticStringIndex_23988, inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 535)) ;
    }
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  call void @raise_panic.").add_operation (var_staticStringIndex_23988.getter_string (SOURCE_FILE ("instruction-sync.galgas", 539)), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 539)).add_operation (GALGAS_string (" ("), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 539)), inCompiler  COMMA_SOURCE_FILE ("instruction-sync.galgas", 539)) ;
...
static void extensionMethod_syncInstructionIR_enterAccessibleEntities (const cPtr_abstractInstructionIR * inObject,
  ...
  const cPtr_syncInstructionIR * object = (const cPtr_syncInstructionIR *) inObject ;
  macroValidSharedObject (object, cPtr_syncInstructionIR) ;
  GALGAS_uint var_branchCount_24641 = object->mAttribute_mOnInstructionBranchListIR.getter_length (SOURCE_FILE ("instruction-sync.galgas", 553)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictInf, ioArgument_ioMaxBranchOfOnInstructions.objectCompare (var_branchCount_24641)).boolEnum () ;
  if (kBoolTrue == test_0) {
    ioArgument_ioMaxBranchOfOnInstructions = var_branchCount_24641 ;
  }
...
static void extensionMethod_remoteRoutineCallInstructionAST_analyze (const cPtr_instructionAST * inObject,
  ...
  if (kBoolTrue == test_2) {
    ...
    GALGAS_bool var_isPublic_11264 ;
    GALGAS_modeMap var_modeMap_11283 ;
    GALGAS_procedureSignature var_formalSignature_11330 ;
    GALGAS_routineKind var_routineKind_11366 ;
    GALGAS_unifiedTypeMap_2D_proxy var_returnedType_11399 ;
    GALGAS_bool var_appendFileAndLineArgumentForPanicLocation_11452 ;
    GALGAS_bool var_canMutateProperties_11490 ;
    GALGAS_bool var_canAccessPropertiesInUserMode_11538 ;
    GALGAS_bool joker_11374 ; // Joker input parameter
    constinArgument_inContext.mAttribute_mRoutineMapForContext.method_searchKey (var_routineMangledName_10970, var_isPublic_11264, var_modeMap_11283, var_formalSignature_11330, var_routineKind_11366, joker_11374, var_returnedType_11399, var_appendFileAndLineArgumentForPanicLocation_11452, var_canMutateProperties_11490, var_canAccessPropertiesInUserMode_11538, inCompiler COMMA_SOURCE_FILE ("instruction-proc-call.galgas", 266)) ;
    const enumGalgasBool test_3 = var_isPublic_11264.operator_not (SOURCE_FILE ("instruction-proc-call.galgas", 279)).boolEnum () ;
    if (kBoolTrue == test_3) {
    ...
    GALGAS_objectInMemoryIR var_variableKind_11701 ;
    const enumGalgasBool test_5 = var_canMutateProperties_11490.boolEnum () ;
    if (kBoolTrue == test_5) {
      {
      ...
      ioArgument_ioVariableMap.setter_searchForMethodCall (var_baseName_10798, joker_11809_1, joker_11839, var_variableKind_11701, joker_11894, joker_11905_1, inCompiler COMMA_SOURCE_FILE ("instruction-proc-call.galgas", 284)) ;
      }
      ...
      ioArgument_ioVariableMap.setter_searchForConstantMethodCall (var_baseName_10798, joker_12008_1, joker_12038, var_variableKind_11701, joker_12093, joker_12104_1, inCompiler COMMA_SOURCE_FILE ("instruction-proc-call.galgas", 293)) ;
      }
    }
    GALGAS_lstring var_routineNameForInvocationGraph_12198 ;
    switch (var_routineKind_11366.enumValue ()) {
    case GALGAS_routineKind::kNotBuilt:
      break ;
    case GALGAS_routineKind::kEnum_function:
      {
        var_routineNameForInvocationGraph_12198 = function_procNameForInvocationGraph (var_receiverType_10850, var_routineName_9320, inCompiler COMMA_SOURCE_FILE ("instruction-proc-call.galgas", 306)) ;
      }
      break ;
    case GALGAS_routineKind::kEnum_section:
      {
        var_routineNameForInvocationGraph_12198 = function_sectionNameForInvocationGraph (var_receiverType_10850, var_routineName_9320, inCompiler COMMA_SOURCE_FILE ("instruction-proc-call.galgas", 308)) ;
      }
      break ;
    case GALGAS_routineKind::kEnum_service:
      {
        var_routineNameForInvocationGraph_12198 = function_serviceNameForInvocationGraph (var_receiverType_10850, var_routineName_9320, inCompiler COMMA_SOURCE_FILE ("instruction-proc-call.galgas", 310)) ;
      }
      break ;
    case GALGAS_routineKind::kEnum_primitive:
      {
        var_routineNameForInvocationGraph_12198 = function_primitiveNameForInvocationGraph (var_receiverType_10850, var_routineName_9320, inCompiler COMMA_SOURCE_FILE ("instruction-proc-call.galgas", 312)) ;
      }
      break ;
    }
    {
    ioArgument_ioTemporaries.mAttribute_mSubprogramInvocationGraph.setter_addEdge (constinArgument_inCallerNameForInvocationGraph, var_routineNameForInvocationGraph_12198 COMMA_SOURCE_FILE ("instruction-proc-call.galgas", 314)) ;
    }
    GALGAS_routineKindIR var_routineKindIR_12856 = function_checkMode (constinArgument_inRequiredModeSet, var_modeMap_11283.getter_keySet (SOURCE_FILE ("instruction-proc-call.galgas", 318)), var_routineKind_11366, var_routineName_9320.mAttribute_location, inCompiler COMMA_SOURCE_FILE ("instruction-proc-call.galgas", 316)) ;
    {
    routine_analyzeEffectiveParameters (constinArgument_inSelfType, constinArgument_inDirectAccessToPropertiesAllowed, constinArgument_inRoutineCanMutateProperties, var_formalSignature_11330, object->mAttribute_mEffectiveParameterList, var_routineName_9320.mAttribute_location, constinArgument_inCallerNameForInvocationGraph, constinArgument_inContext, constinArgument_inRequiredModeSet, constinArgument_inAllowPanic, ioArgument_ioTemporaries, ioArgument_ioGlobalLiteralStringMap, ioArgument_ioVariableMap, ioArgument_ioAllocaList, ioArgument_ioInstructionGenerationList, var_effectiveParameterListIR_10938, inCompiler  COMMA_SOURCE_FILE ("instruction-proc-call.galgas", 323)) ;
    }
    const enumGalgasBool test_6 = GALGAS_bool (kIsNotEqual, var_returnedType_11399.objectCompare (GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("instruction-proc-call.galgas", 341)))).boolEnum () ;
    if (kBoolTrue == test_6) {
    ...
    const enumGalgasBool test_9 = var_variableKind_11701.getter_isGlobalVariable (SOURCE_FILE ("instruction-proc-call.galgas", 345)).boolEnum () ;
    if (kBoolTrue == test_9) {
      temp_8 = var_baseName_10798.mAttribute_string ;
    }else if (kBoolFalse == test_9) {
      temp_8 = GALGAS_string::makeEmptyString () ;
    }
    GALGAS_string var_baseGlobalVariableName_13924 = temp_8 ;
    ioArgument_ioInstructionGenerationList.addAssign_operation (GALGAS_procCallInstructionIR::constructor_new (var_baseGlobalVariableName_13924, var_routineMangledName_10970, var_routineKindIR_12856, var_effectiveParameterListIR_10938, var_appendFileAndLineArgumentForPanicLocation_11452  COMMA_SOURCE_FILE ("instruction-proc-call.galgas", 346))  COMMA_SOURCE_FILE ("instruction-proc-call.galgas", 346)) ;
  }
}
...
static void extensionMethod_procCallInstructionIR_llvmInstructionCode (const cPtr_abstractInstructionIR * inObject,
  ...
  GALGAS_bool var_first_29697 = GALGAS_bool (true) ;
  ...
  while (enumerator_29749.hasCurrentObject ()) {
    const enumGalgasBool test_0 = var_first_29697.boolEnum () ;
    if (kBoolTrue == test_0) {
      var_first_29697 = GALGAS_bool (false) ;
    }else if (kBoolFalse == test_0) {
  ...
  if (kBoolTrue == test_2) {
    GALGAS_string var_sourceFileName_30340 = object->mAttribute_mProcName.mAttribute_location.getter_file (inCompiler COMMA_SOURCE_FILE ("instruction-proc-call.galgas", 718)).getter_lastPathComponent (SOURCE_FILE ("instruction-proc-call.galgas", 718)).getter_stringByDeletingPathExtension (SOURCE_FILE ("instruction-proc-call.galgas", 718)) ;
    GALGAS_uint var_staticStringIndex_30534 ;
    {
    extensionSetter_findOrAddStaticString (ioArgument_ioGenerationAdds.mAttribute_mStaticStringMap, var_sourceFileName_30340, var_staticStringIndex_30534, inCompiler COMMA_SOURCE_FILE ("instruction-proc-call.galgas", 719)) ;
    }
    const enumGalgasBool test_3 = var_first_29697.operator_not (SOURCE_FILE ("instruction-proc-call.galgas", 723)).boolEnum () ;
    if (kBoolTrue == test_3) {
    ...
    GALGAS_uint var_sourceFileNameSize_30713 = var_sourceFileName_30340.getter_length (SOURCE_FILE ("instruction-proc-call.galgas", 727)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("instruction-proc-call.galgas", 727)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string (", i8* getelementptr inbounds ([").add_operation (var_sourceFileNameSize_30713.getter_string (SOURCE_FILE ("instruction-proc-call.galgas", 728)), inCompiler COMMA_SOURCE_FILE ("instruction-proc-call.galgas", 728)).add_operation (GALGAS_string (" x i8], ["), inCompiler COMMA_SOURCE_FILE ("instruction-proc-call.galgas", 728)).add_operation (var_sourceFileNameSize_30713.getter_string (SOURCE_FILE ("instruction-proc-call.galgas", 728)), inCompiler COMMA_SOURCE_FILE ("instruction-proc-call.galgas", 728)).add_operation (GALGAS_string (" x i8]* @str.array."), inCompiler COMMA_SOURCE_FILE ("instruction-proc-call.galgas", 728)).add_operation (var_staticStringIndex_30534.getter_string (SOURCE_FILE ("instruction-proc-call.galgas", 728)), inCompiler COMMA_SOURCE_FILE ("instruction-proc-call.galgas", 728)).add_operation (GALGAS_string (", i32 0, i32 0)"), inCompiler COMMA_SOURCE_FILE ("instruction-proc-call.galgas", 728)), inCompiler  COMMA_SOURCE_FILE ("instruction-proc-call.galgas", 728)) ;
  }
...
static void extensionMethod_unifiedSelfCallInstructionAST_analyze (const cPtr_instructionAST * inObject,
  ...
  GALGAS_bool var_isPublic_3853 ;
  GALGAS_modeMap var_modeMap_3870 ;
  GALGAS_procedureSignature var_formalSignature_3915 ;
  GALGAS_routineKind var_routineKind_3949 ;
  GALGAS_unifiedTypeMap_2D_proxy var_returnedType_3978 ;
  GALGAS_bool var_appendFileAndLineArgumentForPanicLocation_4029 ;
  GALGAS_bool var_canMutateProperties_4058 ;
  GALGAS_bool var_canAccessPropertiesInUserMode_4097 ;
  GALGAS_bool joker_3955 ; // Joker input parameter
  constinArgument_inContext.mAttribute_mRoutineMapForContext.method_searchKey (var_routineMangledName_3496, var_isPublic_3853, var_modeMap_3870, var_formalSignature_3915, var_routineKind_3949, joker_3955, var_returnedType_3978, var_appendFileAndLineArgumentForPanicLocation_4029, var_canMutateProperties_4058, var_canAccessPropertiesInUserMode_4097, inCompiler COMMA_SOURCE_FILE ("instruction-self-call.galgas", 78)) ;
  GALGAS_bool test_2 = var_canAccessPropertiesInUserMode_4097 ;
  ...
  GALGAS_bool test_5 = var_canMutateProperties_4058 ;
  ...
  GALGAS_bool test_8 = GALGAS_bool (kIsStrictSup, var_fieldList_2644.getter_length (SOURCE_FILE ("instruction-self-call.galgas", 96)).objectCompare (GALGAS_uint ((uint32_t) 0U))) ;
  if (kBoolTrue == test_8.boolEnum ()) {
    test_8 = var_isPublic_3853.operator_not (SOURCE_FILE ("instruction-self-call.galgas", 96)) ;
  }
  ...
  GALGAS_lstring var_routineNameForInvocationGraph_4724 ;
  switch (var_routineKind_3949.enumValue ()) {
  case GALGAS_routineKind::kNotBuilt:
    break ;
  case GALGAS_routineKind::kEnum_function:
    {
      var_routineNameForInvocationGraph_4724 = function_procNameForInvocationGraph (var_receiverType_3439, var_methodName_2696, inCompiler COMMA_SOURCE_FILE ("instruction-self-call.galgas", 103)) ;
    }
    break ;
  case GALGAS_routineKind::kEnum_section:
    {
      var_routineNameForInvocationGraph_4724 = function_sectionNameForInvocationGraph (var_receiverType_3439, var_methodName_2696, inCompiler COMMA_SOURCE_FILE ("instruction-self-call.galgas", 105)) ;
    }
    break ;
  case GALGAS_routineKind::kEnum_service:
    {
      var_routineNameForInvocationGraph_4724 = function_serviceNameForInvocationGraph (var_receiverType_3439, var_methodName_2696, inCompiler COMMA_SOURCE_FILE ("instruction-self-call.galgas", 107)) ;
    }
    break ;
  case GALGAS_routineKind::kEnum_primitive:
    {
      var_routineNameForInvocationGraph_4724 = function_primitiveNameForInvocationGraph (var_receiverType_3439, var_methodName_2696, inCompiler COMMA_SOURCE_FILE ("instruction-self-call.galgas", 109)) ;
    }
    break ;
  }
  {
  ioArgument_ioTemporaries.mAttribute_mSubprogramInvocationGraph.setter_addEdge (constinArgument_inCallerNameForInvocationGraph, var_routineNameForInvocationGraph_4724 COMMA_SOURCE_FILE ("instruction-self-call.galgas", 111)) ;
  }
  GALGAS_routineKindIR var_routineKindIR_5352 = function_checkMode (constinArgument_inRequiredModeSet, var_modeMap_3870.getter_keySet (SOURCE_FILE ("instruction-self-call.galgas", 115)), var_routineKind_3949, var_methodName_2696.mAttribute_location, inCompiler COMMA_SOURCE_FILE ("instruction-self-call.galgas", 113)) ;
  {
  routine_analyzeEffectiveParameters (constinArgument_inSelfType, constinArgument_inDirectAccessToPropertiesAllowed, constinArgument_inRoutineCanMutateProperties, var_formalSignature_3915, object->mAttribute_mEffectiveParameterList, var_methodName_2696.mAttribute_location, constinArgument_inCallerNameForInvocationGraph, constinArgument_inContext, constinArgument_inRequiredModeSet, constinArgument_inAllowPanic, ioArgument_ioTemporaries, ioArgument_ioGlobalLiteralStringMap, ioArgument_ioVariableMap, ioArgument_ioAllocaList, ioArgument_ioInstructionGenerationList, var_effectiveParameterListIR_3640, inCompiler  COMMA_SOURCE_FILE ("instruction-self-call.galgas", 120)) ;
  }
  const enumGalgasBool test_11 = GALGAS_bool (kIsNotEqual, var_returnedType_3978.objectCompare (GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("instruction-self-call.galgas", 138)))).boolEnum () ;
  ...
  ioArgument_ioInstructionGenerationList.addAssign_operation (GALGAS_procCallInstructionIR::constructor_new (GALGAS_string::makeEmptyString (), var_routineMangledName_3496, var_routineKindIR_5352, var_effectiveParameterListIR_3640, var_appendFileAndLineArgumentForPanicLocation_4029  COMMA_SOURCE_FILE ("instruction-self-call.galgas", 142))  COMMA_SOURCE_FILE ("instruction-self-call.galgas", 142)) ;
}
...
static void extensionMethod_forLowerUpperBoundInstructionIR_llvmInstructionCode (const cPtr_abstractInstructionIR * inObject,
  ...
  GALGAS_string var_loadedVarName_9585 = GALGAS_string ("%").add_operation (function_llvmNameForLocalVariable (object->mAttribute_mVarName, inCompiler COMMA_SOURCE_FILE ("instruction-for-in-lower-upper-bounds.galgas", 225)), inCompiler COMMA_SOURCE_FILE ("instruction-for-in-lower-upper-bounds.galgas", 225)).add_operation (GALGAS_string (".loaded"), inCompiler COMMA_SOURCE_FILE ("instruction-for-in-lower-upper-bounds.galgas", 225)) ;
  GALGAS_string var_currentVarName_9663 = GALGAS_string ("%").add_operation (function_llvmNameForLocalVariable (object->mAttribute_mVarName, inCompiler COMMA_SOURCE_FILE ("instruction-for-in-lower-upper-bounds.galgas", 226)), inCompiler COMMA_SOURCE_FILE ("instruction-for-in-lower-upper-bounds.galgas", 226)).add_operation (GALGAS_string (".current"), inCompiler COMMA_SOURCE_FILE ("instruction-for-in-lower-upper-bounds.galgas", 226)) ;
  GALGAS_string var_nextVarName_9739 = GALGAS_string ("%").add_operation (function_llvmNameForLocalVariable (object->mAttribute_mVarName, inCompiler COMMA_SOURCE_FILE ("instruction-for-in-lower-upper-bounds.galgas", 227)), inCompiler COMMA_SOURCE_FILE ("instruction-for-in-lower-upper-bounds.galgas", 227)).add_operation (GALGAS_string (".next"), inCompiler COMMA_SOURCE_FILE ("instruction-for-in-lower-upper-bounds.galgas", 227)) ;
