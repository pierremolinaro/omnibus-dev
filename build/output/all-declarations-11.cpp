...
static void extensionMethod_forLowerUpperBoundInstructionAST_analyze (const cPtr_instructionAST * inObject,
  ...
  case GALGAS_typeKind::kEnum_integer:
    {
      const cEnumAssociatedValues_typeKind_integer * extractPtr_8111 = (const cEnumAssociatedValues_typeKind_integer *) (var_type_4193.getter_kind (inCompiler COMMA_SOURCE_FILE ("instruction-for-in-lower-upper-bounds.galgas", 88)).unsafePointer ()) ;
      const GALGAS_bigint extractedValue_min = extractPtr_8111->mAssociatedValue0 ;
      const GALGAS_bigint extractedValue_max = extractPtr_8111->mAssociatedValue1 ;
      const GALGAS_bool extractedValue_unsigned = extractPtr_8111->mAssociatedValue2 ;
      const GALGAS_uint extractedValue_bitCount = extractPtr_8111->mAssociatedValue3 ;
