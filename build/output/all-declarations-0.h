...
//---------------------------------------------------------------------------------------------------------------------*
//                                                                                                                     *
//                                               @asExpressionAST class                                                *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*

class GALGAS_asExpressionAST : public GALGAS_expressionAST {
//--- Constructor
  public : GALGAS_asExpressionAST (void) ;

//---
  public : inline const class cPtr_asExpressionAST * ptr (void) const { return (const cPtr_asExpressionAST *) mObjectPtr ; }

//--------------------------------- Constructor from pointer
  public : GALGAS_asExpressionAST (const cPtr_asExpressionAST * inSourcePtr) ;
...
//--------------------------------- Object extraction
  public : static GALGAS_asExpressionAST extractObject (const GALGAS_object & inObject,
                                                        C_Compiler * inCompiler
                                                        COMMA_LOCATION_ARGS) ;

//--------------------------------- GALGAS constructors
  public : static GALGAS_asExpressionAST constructor_new (const class GALGAS_expressionAST & inOperand0,
                                                          const class GALGAS_lstring & inOperand1
                                                          COMMA_LOCATION_ARGS) ;

//--------------------------------- Comparison
  public : typeComparisonResult objectCompare (const GALGAS_asExpressionAST & inOperand) const ;
...
} ; // End of GALGAS_asExpressionAST class


//---------------------------------------------------------------------------------------------------------------------*

extern const C_galgas_type_descriptor kTypeDescriptor_GALGAS_asExpressionAST ;
...
class cPtr_asExpressionAST : public cPtr_expressionAST {
//--- Attributes
  public : GALGAS_expressionAST mAttribute_mExpression ;
  public : GALGAS_lstring mAttribute_mTypeName ;

//--- Constructor
  public : cPtr_asExpressionAST (const GALGAS_expressionAST & in_mExpression,
...
class GALGAS_exceptionAST : public AC_GALGAS_root {
//--------------------------------- Public data members
  public : GALGAS_location mAttribute_mExceptionLocation ;
  ...
  public : GALGAS_bool mAttribute_mExceptionDefined ;
...
//--------------------------------- Default GALGAS constructor
  public : static GALGAS_exceptionAST constructor_default (LOCATION_ARGS) ;

//--------------------------------- Default constructor
  public : GALGAS_exceptionAST (void) ;

//--------------------------------- Virtual destructor (in debug mode)
  public : VIRTUAL_IN_DEBUG ~ GALGAS_exceptionAST (void) ;

//--------------------------------- Native constructor
  public : GALGAS_exceptionAST (const GALGAS_location & in_mExceptionLocation,
                                const GALGAS_instructionListAST & in_mExceptionInstructionList,
                                const GALGAS_location & in_mEndOfExceptionInstructions,
                                const GALGAS_bool & in_mExceptionDefined) ;
...
//--------------------------------- Object extraction
  public : static GALGAS_exceptionAST extractObject (const GALGAS_object & inObject,
                                                     C_Compiler * inCompiler
                                                     COMMA_LOCATION_ARGS) ;

//--------------------------------- GALGAS constructors
  public : static GALGAS_exceptionAST constructor_new (const class GALGAS_location & inOperand0,
                                                       const class GALGAS_instructionListAST & inOperand1,
                                                       const class GALGAS_location & inOperand2,
...
//--------------------------------- Implementation of reader 'description'
  public : VIRTUAL_IN_DEBUG void description (C_String & ioString,
                                              const int32_t inIndentation) const ;
//--------------------------------- Comparison
  public : typeComparisonResult objectCompare (const GALGAS_exceptionAST & inOperand) const ;
...
//--------------------------------- Getters
  ...
  public : VIRTUAL_IN_DEBUG class GALGAS_bool reader_mExceptionDefined (LOCATION_ARGS) const ;

  public : VIRTUAL_IN_DEBUG class GALGAS_instructionListAST reader_mExceptionInstructionList (LOCATION_ARGS) const ;

  public : VIRTUAL_IN_DEBUG class GALGAS_location reader_mExceptionLocation (LOCATION_ARGS) const ;


//--------------------------------- Introspection
  public : VIRTUAL_IN_DEBUG const C_galgas_type_descriptor * staticTypeDescriptor (void) const ;
 
} ; // End of GALGAS_exceptionAST class


//---------------------------------------------------------------------------------------------------------------------*

extern const C_galgas_type_descriptor kTypeDescriptor_GALGAS_exceptionAST ;
...
//--------------------------------- Public data members
  ...
  public : GALGAS_exceptionAST mAttribute_mException ;
...
//--------------------------------- Native constructor
  public : GALGAS_ast (const GALGAS_declarationListAST & in_mDeclarationList,
                       ...
                       const GALGAS_exceptionAST & in_mException) ;
...
//--------------------------------- GALGAS constructors
  public : static GALGAS_ast constructor_new (const class GALGAS_declarationListAST & inOperand0,
                                              ...
                                              const class GALGAS_exceptionAST & inOperand6
                                              COMMA_LOCATION_ARGS) ;
...
//--------------------------------- Getters
  ...
  public : VIRTUAL_IN_DEBUG class GALGAS_exceptionAST reader_mException (LOCATION_ARGS) const ;
...
//---------------------------------------------------------------------------------------------------------------------*
//                                                                                                                     *
//                                              @registerBitSliceMap map                                               *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*

class cMapElement_registerBitSliceMap ;

//---------------------------------------------------------------------------------------------------------------------*

extern const char * kSearchErrorMessage_registerBitSliceMap_searchKey ;

//---------------------------------------------------------------------------------------------------------------------*

class GALGAS_registerBitSliceMap : public AC_GALGAS_map {
//--------------------------------- Default constructor
  public : GALGAS_registerBitSliceMap (void) ;

//--------------------------------- Handle copy
  public : GALGAS_registerBitSliceMap (const GALGAS_registerBitSliceMap & inSource) ;
  public : GALGAS_registerBitSliceMap & operator = (const GALGAS_registerBitSliceMap & inSource) ;
...
//--------------------------------- Object extraction
  public : static GALGAS_registerBitSliceMap extractObject (const GALGAS_object & inObject,
                                                            C_Compiler * inCompiler
                                                            COMMA_LOCATION_ARGS) ;

//--------------------------------- GALGAS constructors
  public : static GALGAS_registerBitSliceMap constructor_emptyMap (LOCATION_ARGS) ;

  public : static GALGAS_registerBitSliceMap constructor_mapWithMapToOverride (const class GALGAS_registerBitSliceMap & inOperand0
                                                                               COMMA_LOCATION_ARGS) ;
...
//--------------------------------- Setters
  ...
  public : VIRTUAL_IN_DEBUG void modifier_setMAccessOperatorForKey (class GALGAS_infixOperatorIR constinArgument0,
                                                                    class GALGAS_string constinArgument1,
                                                                    C_Compiler * inCompiler
                                                                    COMMA_LOCATION_ARGS) ;

  public : VIRTUAL_IN_DEBUG void modifier_setMAccessRightOperandForKey (class GALGAS_variableKindIR constinArgument0,
                                                                        class GALGAS_string constinArgument1,
                                                                        C_Compiler * inCompiler
                                                                        COMMA_LOCATION_ARGS) ;
...
//--------------------------------- Getters
  public : VIRTUAL_IN_DEBUG class GALGAS_infixOperatorIR reader_mAccessOperatorForKey (const class GALGAS_string & constinOperand0,
                                                                                       C_Compiler * inCompiler
                                                                                       COMMA_LOCATION_ARGS) const ;
...
//--------------------------------- Introspection
  public : VIRTUAL_IN_DEBUG const C_galgas_type_descriptor * staticTypeDescriptor (void) const ;
  public : VIRTUAL_IN_DEBUG cMapElement_registerBitSliceMap * readWriteAccessForWithInstruction (C_Compiler * inCompiler,
                                                                                                 const GALGAS_string & inKey
                                                                                                 COMMA_LOCATION_ARGS) ;

//--------------------------------- Friend

  friend class cEnumerator_registerBitSliceMap ;
 
} ; // End of GALGAS_registerBitSliceMap class

//---------------------------------------------------------------------------------------------------------------------*
//   Enumerator declaration                                                    *
//---------------------------------------------------------------------------------------------------------------------*

class cEnumerator_registerBitSliceMap : public cGenericAbstractEnumerator {
  public : cEnumerator_registerBitSliceMap (const GALGAS_registerBitSliceMap & inEnumeratedObject,
                                            const typeEnumerationOrder inOrder) ;
...
extern const C_galgas_type_descriptor kTypeDescriptor_GALGAS_registerBitSliceMap ;
...
//--------------------------------- GALGAS constructors
  public : static GALGAS_infixOperatorIR constructor_infix (const class GALGAS_string & inOperand0
                                                            COMMA_LOCATION_ARGS) ;
...
//--------------------------------- Instance Methods
  public : VIRTUAL_IN_DEBUG void method_infix (class GALGAS_string & outArgument0,
                                               C_Compiler * inCompiler
                                               COMMA_LOCATION_ARGS) const ;
...
//--------------------------------- Getters
  public : VIRTUAL_IN_DEBUG class GALGAS_bool reader_isInfix (LOCATION_ARGS) const ;
...
//---------------------------------------------------------------------------------------------------------------------*
//                                                                                                                     *
//                                   Class for element of '@registerBitSliceMap' map                                   *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*

class cMapElement_registerBitSliceMap : public cMapElement {
//--- Map attributes
...
//---------------------------------------------------------------------------------------------------------------------*
//                                                                                                                     *
//                                       @registerBitSliceMap_2D_element struct                                        *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*

class GALGAS_registerBitSliceMap_2D_element : public AC_GALGAS_root {
//--------------------------------- Public data members
  public : GALGAS_lstring mAttribute_lkey ;
  public : GALGAS_infixOperatorIR mAttribute_mAccessOperator ;
  public : GALGAS_variableKindIR mAttribute_mAccessRightOperand ;
...
//--------------------------------- Default constructor
  public : GALGAS_registerBitSliceMap_2D_element (void) ;

//--------------------------------- Virtual destructor (in debug mode)
  public : VIRTUAL_IN_DEBUG ~ GALGAS_registerBitSliceMap_2D_element (void) ;
...
//--------------------------------- Object extraction
  public : static GALGAS_registerBitSliceMap_2D_element extractObject (const GALGAS_object & inObject,
                                                                       C_Compiler * inCompiler
                                                                       COMMA_LOCATION_ARGS) ;
...
//--------------------------------- Implementation of reader 'description'
  public : VIRTUAL_IN_DEBUG void description (C_String & ioString,
                                              const int32_t inIndentation) const ;
//--------------------------------- Comparison
  public : typeComparisonResult objectCompare (const GALGAS_registerBitSliceMap_2D_element & inOperand) const ;
...
} ; // End of GALGAS_registerBitSliceMap_2D_element class


//---------------------------------------------------------------------------------------------------------------------*

extern const C_galgas_type_descriptor kTypeDescriptor_GALGAS_registerBitSliceMap_2D_element ;
...
class cEnumAssociatedValues_infixOperatorIR_infix : public cEnumAssociatedValues {
  public : const GALGAS_string mAssociatedValue0 ;

//--- Constructor
  public : cEnumAssociatedValues_infixOperatorIR_infix (const GALGAS_string & inAssociatedValue0
                                                        COMMA_LOCATION_ARGS) ;
  ...
  public : virtual ~ cEnumAssociatedValues_infixOperatorIR_infix (void) {}
} ;
...
//--------------------------------- Setters
  ...
  public : VIRTUAL_IN_DEBUG void modifier_setMRegisterBitSliceMapForKey (class GALGAS_registerBitSliceMap constinArgument0,
                                                                         class GALGAS_string constinArgument1,
                                                                         C_Compiler * inCompiler
                                                                         COMMA_LOCATION_ARGS) ;
...
//--------------------------------- Getters
  ...
  public : VIRTUAL_IN_DEBUG class GALGAS_registerBitSliceMap reader_mRegisterBitSliceMapForKey (const class GALGAS_string & constinOperand0,
                                                                                                C_Compiler * inCompiler
                                                                                                COMMA_LOCATION_ARGS) const ;
...
//--- Current element access
  ...
  public : class GALGAS_registerBitSliceMap current_mRegisterBitSliceMap (LOCATION_ARGS) const ;
//--- Current element access
...
//--- Map attributes
  ...
  public : GALGAS_registerBitSliceMap mAttribute_mRegisterBitSliceMap ;
...
//--------------------------------- Getters
  ...
  public : VIRTUAL_IN_DEBUG class GALGAS_registerBitSliceMap reader_mRegisterBitSliceMap (LOCATION_ARGS) const ;
...
//--------------------------------- Setters
  ...
  public : VIRTUAL_IN_DEBUG void modifier_insertConstantInputFormalArgument (class GALGAS_lstring constinArgument0,
                                                                             ...
                                                                             class GALGAS_registerBitSliceMap constinArgument6,
                                                                             C_Compiler * inCompiler
                                                                             COMMA_LOCATION_ARGS) ;
  ...
  public : VIRTUAL_IN_DEBUG void modifier_neutralAccess (class GALGAS_lstring constinArgument0,
                                                         ...
                                                         class GALGAS_registerBitSliceMap & outArgument6,
                                                         C_Compiler * inCompiler
                                                         COMMA_LOCATION_ARGS) ;
  ...
  public : VIRTUAL_IN_DEBUG void modifier_setFieldMapForKey (class GALGAS_registerBitSliceMap constinArgument0,
                                                             class GALGAS_string constinArgument1,
                                                             C_Compiler * inCompiler
                                                             COMMA_LOCATION_ARGS) ;
...
//--------------------------------- Getters
  ...
  public : VIRTUAL_IN_DEBUG class GALGAS_registerBitSliceMap reader_fieldMapForKey (const class GALGAS_string & constinOperand0,
                                                                                    C_Compiler * inCompiler
                                                                                    COMMA_LOCATION_ARGS) const ;
...
//--- Current element access
  ...
  public : class GALGAS_registerBitSliceMap current_fieldMap (LOCATION_ARGS) const ;
} ;
...
//--- Map attributes
  ...
  public : GALGAS_registerBitSliceMap mAttribute_fieldMap ;
