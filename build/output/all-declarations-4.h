...
//--------------------------------- Public data members
  ...
  public : GALGAS_taskListIR mAttribute_mTaskListIR ;
...
//--------------------------------- Native constructor
  public : GALGAS_intermediateCodeStruct (const GALGAS_staticStringMap & in_mStaticStringMap,
                                          ...
                                          const GALGAS_taskListIR & in_mTaskListIR) ;
...
//--------------------------------- GALGAS constructors
  public : static GALGAS_intermediateCodeStruct constructor_new (const class GALGAS_staticStringMap & inOperand0,
                                                                 ...
                                                                 const class GALGAS_taskListIR & inOperand14
                                                                 COMMA_LOCATION_ARGS) ;
...
//--------------------------------- Getters
  ...
  public : VIRTUAL_IN_DEBUG class GALGAS_taskListIR getter_mTaskListIR (LOCATION_ARGS) const ;
...
void categoryMethod_generateCode (const class GALGAS_taskListIR inObject,
                                  class GALGAS_string & io_ioLLVMcode,
                                  class C_Compiler * inCompiler
                                  COMMA_LOCATION_ARGS) ;
