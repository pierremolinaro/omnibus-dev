...
//---------------------------------------------------------------------------------------------------------------------*
//                                                                                                                     *
//                                Extension setter '@instructionListIR generateRetain'                                 *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*

void extensionSetter_generateRetain (class GALGAS_instructionListIR & ioObject,
...
class GALGAS_retainIR : public GALGAS_abstractInstructionIR {
//--- Constructor
  public : GALGAS_retainIR (void) ;

//---
  public : inline const class cPtr_retainIR * ptr (void) const { return (const cPtr_retainIR *) mObjectPtr ; }

//--------------------------------- Constructor from pointer
  public : GALGAS_retainIR (const cPtr_retainIR * inSourcePtr) ;
...
//--------------------------------- Object extraction
  public : static GALGAS_retainIR extractObject (const GALGAS_object & inObject,
                                                 C_Compiler * inCompiler
                                                 COMMA_LOCATION_ARGS) ;

//--------------------------------- GALGAS constructors
  public : static class GALGAS_retainIR constructor_new (const class GALGAS_PLMType & inOperand0,
                                                         const class GALGAS_lstring & inOperand1
                                                         COMMA_LOCATION_ARGS) ;

//--------------------------------- Comparison
  public : typeComparisonResult objectCompare (const GALGAS_retainIR & inOperand) const ;
...
} ; // End of GALGAS_retainIR class


//---------------------------------------------------------------------------------------------------------------------*

extern const C_galgas_type_descriptor kTypeDescriptor_GALGAS_retainIR ;

//---------------------------------------------------------------------------------------------------------------------*
//                                                                                                                     *
//                                          Pointer class for @retainIR class                                          *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*

class cPtr_retainIR : public cPtr_abstractInstructionIR {
//--- Attributes
  public : GALGAS_PLMType mProperty_mType ;
  public : GALGAS_lstring mProperty_mPLMName ;

//--- Constructor
  public : cPtr_retainIR (const GALGAS_PLMType & in_mType,
