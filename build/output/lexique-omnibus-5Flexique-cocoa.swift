...
@MainActor fileprivate let gFont_omnibus_lexique = EBPreferenceProperty <NSFont> (
...
@MainActor fileprivate let gLineHeight_omnibus_lexique = EBPreferenceProperty <Int> (
  defaultValue: 12,
...
@MainActor fileprivate let gColors_omnibus_lexique : [EBPreferenceProperty <NSColor>] = [
  EBPreferenceProperty <NSColor> (defaultValue: .black, prefKey: "ColorFor_omnibus_lexique"),
  EBPreferenceProperty <NSColor> (defaultValue: .black, prefKey: "ColorFor_omnibus_lexique-keywordsStyle"),
  EBPreferenceProperty <NSColor> (defaultValue: .black, prefKey: "ColorFor_omnibus_lexique-attributeStyle"),
  EBPreferenceProperty <NSColor> (defaultValue: .black, prefKey: "ColorFor_omnibus_lexique-integerStyle"),
  EBPreferenceProperty <NSColor> (defaultValue: .black, prefKey: "ColorFor_omnibus_lexique-stringStyle"),
  EBPreferenceProperty <NSColor> (defaultValue: .black, prefKey: "ColorFor_omnibus_lexique-commentStyle"),
  EBPreferenceProperty <NSColor> (defaultValue: .black, prefKey: "ColorFor_omnibus_lexique-delimitersStyle"),
  EBPreferenceProperty <NSColor> (defaultValue: .black, prefKey: "ColorFor_omnibus_lexique-selectorStyle"),
  EBPreferenceProperty <NSColor> (defaultValue: .black, prefKey: "ColorFor_omnibus_lexique-typeStyle"),
  EBPreferenceProperty <NSColor> (defaultValue: .black, prefKey: "ColorFor_omnibus_lexique-groupStyle"),
  EBPreferenceProperty <NSColor> (defaultValue: .red, prefKey: "ColorFor_omnibus_lexique_lexical_error"),
  EBPreferenceProperty <NSColor> (defaultValue: .gray, prefKey: "ColorFor_omnibus_lexique_template")
]

//--------------------------------------------------------------------------------------------------

@MainActor fileprivate let gBoldStyle_omnibus_lexique : [EBPreferenceProperty <Bool>] = [
  EBPreferenceProperty <Bool> (defaultValue: false, prefKey: "BoldFor_omnibus_lexique"),
  EBPreferenceProperty <Bool> (defaultValue: false, prefKey: "BoldFor_omnibus_lexique-keywordsStyle"),
  EBPreferenceProperty <Bool> (defaultValue: false, prefKey: "BoldFor_omnibus_lexique-attributeStyle"),
  EBPreferenceProperty <Bool> (defaultValue: false, prefKey: "BoldFor_omnibus_lexique-integerStyle"),
  EBPreferenceProperty <Bool> (defaultValue: false, prefKey: "BoldFor_omnibus_lexique-stringStyle"),
  EBPreferenceProperty <Bool> (defaultValue: false, prefKey: "BoldFor_omnibus_lexique-commentStyle"),
  EBPreferenceProperty <Bool> (defaultValue: false, prefKey: "BoldFor_omnibus_lexique-delimitersStyle"),
  EBPreferenceProperty <Bool> (defaultValue: false, prefKey: "BoldFor_omnibus_lexique-selectorStyle"),
  EBPreferenceProperty <Bool> (defaultValue: false, prefKey: "BoldFor_omnibus_lexique-typeStyle"),
  EBPreferenceProperty <Bool> (defaultValue: false, prefKey: "BoldFor_omnibus_lexique-groupStyle"),
  EBPreferenceProperty <Bool> (defaultValue: true, prefKey: "BoldFor_omnibus_lexique_lexical_error"),
  EBPreferenceProperty <Bool> (defaultValue: false, prefKey: "BoldFor_omnibus_lexique_template")
]

//--------------------------------------------------------------------------------------------------

@MainActor fileprivate let gItalicStyle_omnibus_lexique : [EBPreferenceProperty <Bool>] = [
  EBPreferenceProperty <Bool> (defaultValue: false, prefKey: "ItalicFor_omnibus_lexique"),
  EBPreferenceProperty <Bool> (defaultValue: false, prefKey: "ItalicFor_omnibus_lexique-keywordsStyle"),
  EBPreferenceProperty <Bool> (defaultValue: false, prefKey: "ItalicFor_omnibus_lexique-attributeStyle"),
  EBPreferenceProperty <Bool> (defaultValue: false, prefKey: "ItalicFor_omnibus_lexique-integerStyle"),
  EBPreferenceProperty <Bool> (defaultValue: false, prefKey: "ItalicFor_omnibus_lexique-stringStyle"),
  EBPreferenceProperty <Bool> (defaultValue: false, prefKey: "ItalicFor_omnibus_lexique-commentStyle"),
  EBPreferenceProperty <Bool> (defaultValue: false, prefKey: "ItalicFor_omnibus_lexique-delimitersStyle"),
  EBPreferenceProperty <Bool> (defaultValue: false, prefKey: "ItalicFor_omnibus_lexique-selectorStyle"),
  EBPreferenceProperty <Bool> (defaultValue: false, prefKey: "ItalicFor_omnibus_lexique-typeStyle"),
  EBPreferenceProperty <Bool> (defaultValue: false, prefKey: "ItalicFor_omnibus_lexique-groupStyle"),
  EBPreferenceProperty <Bool> (defaultValue: false, prefKey: "ItalicFor_omnibus_lexique_lexical_error"),
  EBPreferenceProperty <Bool> (defaultValue: false, prefKey: "ItalicFor_omnibus_lexique_template")
]
...
class SWIFT_Lexique_omnibus_lexique : SWIFT_Lexique {
  ...
  var font : EBPreferenceProperty <NSFont> { return gFont_omnibus_lexique }

  // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

  var lineHeight : EBPreferenceProperty <Int> { return gLineHeight_omnibus_lexique }
