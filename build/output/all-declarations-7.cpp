...
void extensionSetter_addFunctionWithoutArgument (GGS_routineMapForContext & ioObject,
  ...
  GGS_routineFormalArgumentListAST var_formalArguments_10869 = temp_0 ;
  GGS_lstring var_routineMangledName_10897 = GGS_lstring::init_21__21_ (constinArgument_inOmnibusTypeDescriptionName.add_operation (GGS_string ("."), inCompiler COMMA_SOURCE_FILE ("declaration-function.galgas", 301)).add_operation (constinArgument_inMethodName.readProperty_string (), inCompiler COMMA_SOURCE_FILE ("declaration-function.galgas", 301)).add_operation (extensionGetter_routineSignature (var_formalArguments_10869, constinArgument_inMethodName.readProperty_location (), inCompiler COMMA_SOURCE_FILE ("declaration-function.galgas", 301)).readProperty_string (), inCompiler COMMA_SOURCE_FILE ("declaration-function.galgas", 301)), constinArgument_inMethodName.readProperty_location (), inCompiler COMMA_HERE) ;
  outArgument_outRoutineLLVMName = function_routineMangledNameFromAST (constinArgument_inLLVMBaseTypeName, constinArgument_inMethodName, var_formalArguments_10869, inCompiler COMMA_SOURCE_FILE ("declaration-function.galgas", 304)) ;
  GGS_routineLLVMNameDict var_modeDictionary_11172 = extensionGetter_routineLLVMDictionaryForFunction (constinArgument_inMode, outArgument_outRoutineLLVMName.readProperty_string (), inCompiler COMMA_SOURCE_FILE ("declaration-function.galgas", 305)) ;
  {
  ...
  ioObject.setter_insertKey (var_routineMangledName_10897, GGS_bool (true), temp_1, constinArgument_inResultType, var_modeDictionary_11172, GGS_bool (false), constinArgument_inMode, inCompiler COMMA_SOURCE_FILE ("declaration-function.galgas", 306)) ;
  }
}
...
void extensionSetter_addFunctionWithInputArgument (GGS_routineMapForContext & ioObject,
  ...
  GGS_routineFormalArgumentListAST var_argumentList_12085 = temp_0 ;
  GGS_routineTypedSignature var_signature_12338 ;
  {
  routine_routineTypedSignature_26__3F__21_ (ioArgument_ioContext.mProperty_mTypeMap, var_argumentList_12085, var_signature_12338, inCompiler  COMMA_SOURCE_FILE ("declaration-function.galgas", 339)) ;
  }
  GGS_lstring var_routineMangledName_12355 = GGS_lstring::init_21__21_ (constinArgument_inOmnibusTypeDescriptionName.add_operation (GGS_string ("."), inCompiler COMMA_SOURCE_FILE ("declaration-function.galgas", 341)).add_operation (constinArgument_inMethodName.readProperty_string (), inCompiler COMMA_SOURCE_FILE ("declaration-function.galgas", 341)).add_operation (extensionGetter_routineSignature (var_argumentList_12085, constinArgument_inMethodName.readProperty_location (), inCompiler COMMA_SOURCE_FILE ("declaration-function.galgas", 341)).readProperty_string (), inCompiler COMMA_SOURCE_FILE ("declaration-function.galgas", 341)), constinArgument_inMethodName.readProperty_location (), inCompiler COMMA_HERE) ;
  outArgument_outRoutineLLVMName = function_routineMangledNameFromAST (constinArgument_inLLVMBaseTypeName, constinArgument_inMethodName, var_argumentList_12085, inCompiler COMMA_SOURCE_FILE ("declaration-function.galgas", 344)) ;
  GGS_routineLLVMNameDict var_modeDictionary_12624 = extensionGetter_routineLLVMDictionaryForFunction (constinArgument_inMode, outArgument_outRoutineLLVMName.readProperty_string (), inCompiler COMMA_SOURCE_FILE ("declaration-function.galgas", 345)) ;
  {
  ioObject.setter_insertKey (var_routineMangledName_12355, GGS_bool (true), var_signature_12338, constinArgument_inResultType, var_modeDictionary_12624, GGS_bool (false), constinArgument_inMode, inCompiler COMMA_SOURCE_FILE ("declaration-function.galgas", 346)) ;
  }
}
...
void extensionSetter_addFunctionWithTwoInputArguments (GGS_routineMapForContext & ioObject,
  ...
  GGS_routineFormalArgumentListAST var_argumentList_13742 = temp_0 ;
  outArgument_outRoutineLLVMName = function_routineMangledNameFromAST (constinArgument_inLLVMBaseTypeName, GGS_lstring::init_21__21_ (constinArgument_inMethodName.readProperty_string (), GGS_location::class_func_nowhere (SOURCE_FILE ("declaration-function.galgas", 390)), inCompiler COMMA_HERE), var_argumentList_13742, inCompiler COMMA_SOURCE_FILE ("declaration-function.galgas", 388)) ;
  GGS_routineTypedSignature var_signature_14268 ;
  {
  routine_routineTypedSignature_26__3F__21_ (ioArgument_ioContext.mProperty_mTypeMap, var_argumentList_13742, var_signature_14268, inCompiler  COMMA_SOURCE_FILE ("declaration-function.galgas", 393)) ;
  }
  GGS_lstring var_routineMangledName_14285 = GGS_lstring::init_21__21_ (constinArgument_inOmnibusTypeDescriptionName.add_operation (GGS_string ("."), inCompiler COMMA_SOURCE_FILE ("declaration-function.galgas", 395)).add_operation (constinArgument_inMethodName.readProperty_string (), inCompiler COMMA_SOURCE_FILE ("declaration-function.galgas", 395)).add_operation (extensionGetter_routineSignature (var_argumentList_13742, constinArgument_inMethodName.readProperty_location (), inCompiler COMMA_SOURCE_FILE ("declaration-function.galgas", 395)).readProperty_string (), inCompiler COMMA_SOURCE_FILE ("declaration-function.galgas", 395)), constinArgument_inMethodName.readProperty_location (), inCompiler COMMA_HERE) ;
  GGS_routineLLVMNameDict var_modeDictionary_14455 = extensionGetter_routineLLVMDictionaryForFunction (constinArgument_inMode, outArgument_outRoutineLLVMName.readProperty_string (), inCompiler COMMA_SOURCE_FILE ("declaration-function.galgas", 398)) ;
  {
  ioObject.setter_insertKey (var_routineMangledName_14285, GGS_bool (true), var_signature_14268, constinArgument_inResultType, var_modeDictionary_14455, GGS_bool (false), constinArgument_inMode, inCompiler COMMA_SOURCE_FILE ("declaration-function.galgas", 399)) ;
  }
}
...
AbstractPtrClass * cPtr_integerDeclarationAST::duplicate (Compiler * inCompiler COMMA_LOCATION_ARGS) const {
...
AbstractPtrClass * cPtr_inlineInfix_5F_integer_5F_compileTimeInt_5F_operatorUsage::duplicate (Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  AbstractPtrClass * ptr = nullptr ;
...
AbstractPtrClass * cPtr_inlineInfix_5F_compileTimeInt_5F_integer_5F_operatorUsage::duplicate (Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  AbstractPtrClass * ptr = nullptr ;
...
void extensionSetter_referenceFromPossibleValue (GGS_instructionListIR & ioObject,
                                                 ...
                                                 Compiler * inCompiler
                                                 COMMA_UNUSED_LOCATION_ARGS) {
  GGS_bool var_performStore_298 ;
  switch (ioArgument_ioObjectIR.enumValue ()) {
  case GGS_objectIR::Enumeration::invalid:
    break ;
  case GGS_objectIR::Enumeration::enum_void:
    {
      var_performStore_298 = GGS_bool (false) ;
    }
    break ;
  case GGS_objectIR::Enumeration::enum_reference:
    {
      GGS_omnibusType extractedValue_402__0 ;
      GGS_string extractedValue_404__1 ;
      ioArgument_ioObjectIR.getAssociatedValuesFor_reference (extractedValue_402__0, extractedValue_404__1) ;
      var_performStore_298 = GGS_bool (false) ;
    }
    break ;
  case GGS_objectIR::Enumeration::enum_llvmNamedValue:
    {
      GGS_omnibusType extractedValue_492__0 ;
      GGS_string extractedValue_494__1 ;
      ioArgument_ioObjectIR.getAssociatedValuesFor_llvmNamedValue (extractedValue_492__0, extractedValue_494__1) ;
      var_performStore_298 = GGS_bool (true) ;
    }
    break ;
  case GGS_objectIR::Enumeration::enum_literalInteger:
    {
      GGS_omnibusType extractedValue_547__0 ;
      GGS_bigint extractedValue_549__1 ;
      ioArgument_ioObjectIR.getAssociatedValuesFor_literalInteger (extractedValue_547__0, extractedValue_549__1) ;
      var_performStore_298 = GGS_bool (true) ;
    }
    break ;
  case GGS_objectIR::Enumeration::enum_null:
    {
      GGS_omnibusType extractedValue_591__0 ;
      ioArgument_ioObjectIR.getAssociatedValuesFor_null (extractedValue_591__0) ;
      var_performStore_298 = GGS_bool (true) ;
    }
    break ;
  case GGS_objectIR::Enumeration::enum_llvmStructureValue:
    {
      GGS_omnibusType extractedValue_647__0 ;
      GGS_sortedOperandIRList extractedValue_649__1 ;
      ioArgument_ioObjectIR.getAssociatedValuesFor_llvmStructureValue (extractedValue_647__0, extractedValue_649__1) ;
      var_performStore_298 = GGS_bool (true) ;
    }
    break ;
  case GGS_objectIR::Enumeration::enum_llvmArrayStaticValues:
    {
      GGS_omnibusType extractedValue_709__0 ;
      GGS_operandIRList extractedValue_709__1 ;
      GGS_uint extractedValue_709__2 ;
      ioArgument_ioObjectIR.getAssociatedValuesFor_llvmArrayStaticValues (extractedValue_709__0, extractedValue_709__1, extractedValue_709__2) ;
      var_performStore_298 = GGS_bool (true) ;
    }
    break ;
  case GGS_objectIR::Enumeration::enum_literalString:
    {
      GGS_uint extractedValue_761__0 ;
      GGS_uint extractedValue_763__1 ;
      ioArgument_ioObjectIR.getAssociatedValuesFor_literalString (extractedValue_761__0, extractedValue_763__1) ;
      var_performStore_298 = GGS_bool (true) ;
    }
    break ;
  case GGS_objectIR::Enumeration::enum_zero:
    {
      GGS_omnibusType extractedValue_805__0 ;
      ioArgument_ioObjectIR.getAssociatedValuesFor_zero (extractedValue_805__0) ;
      var_performStore_298 = GGS_bool (true) ;
    }
    break ;
  case GGS_objectIR::Enumeration::enum_llvmArrayRepeatedStaticValue:
    {
      GGS_omnibusType extractedValue_872__0 ;
      GGS_uint extractedValue_872__1 ;
      GGS_objectIR extractedValue_872__2 ;
      GGS_uint extractedValue_872__3 ;
      ioArgument_ioObjectIR.getAssociatedValuesFor_llvmArrayRepeatedStaticValue (extractedValue_872__0, extractedValue_872__1, extractedValue_872__2, extractedValue_872__3) ;
      var_performStore_298 = GGS_bool (true) ;
    }
    break ;
  case GGS_objectIR::Enumeration::enum_llvmArrayRepeatedDynamicValue:
    {
      GGS_omnibusType extractedValue_940__0 ;
      GGS_uint extractedValue_940__1 ;
      GGS_objectIR extractedValue_940__2 ;
      ioArgument_ioObjectIR.getAssociatedValuesFor_llvmArrayRepeatedDynamicValue (extractedValue_940__0, extractedValue_940__1, extractedValue_940__2) ;
      var_performStore_298 = GGS_bool (true) ;
    }
    break ;
  case GGS_objectIR::Enumeration::enum_llvmArrayDynamicValues:
    {
      GGS_omnibusType extractedValue_1001__0 ;
      GGS_operandIRList extractedValue_1001__1 ;
      ioArgument_ioObjectIR.getAssociatedValuesFor_llvmArrayDynamicValues (extractedValue_1001__0, extractedValue_1001__1) ;
      var_performStore_298 = GGS_bool (true) ;
    }
    break ;
  }
  ...
  if (GalgasBool::boolTrue == test_0) {
    ...
    if (GalgasBool::boolTrue == test_0) {
      ...
      ioArgument_ioAllocaList.addAssignOperation (var_llvmTemporaryName_1129, extensionGetter_type (ioArgument_ioObjectIR, inCompiler COMMA_SOURCE_FILE ("intermediate-reference-from-possible-value.galgas", 41)), GGS_bool (false)  COMMA_SOURCE_FILE ("intermediate-reference-from-possible-value.galgas", 41)) ;
      {
      extensionSetter_appendStoreTemporaryReference (ioObject, extensionGetter_type (ioArgument_ioObjectIR, inCompiler COMMA_SOURCE_FILE ("intermediate-reference-from-possible-value.galgas", 43)), var_llvmTemporaryName_1129, ioArgument_ioObjectIR, inCompiler COMMA_SOURCE_FILE ("intermediate-reference-from-possible-value.galgas", 43)) ;
      }
      ioArgument_ioObjectIR = GGS_objectIR::class_func_reference (extensionGetter_type (ioArgument_ioObjectIR, inCompiler COMMA_SOURCE_FILE ("intermediate-reference-from-possible-value.galgas", 44)), var_llvmTemporaryName_1129  COMMA_SOURCE_FILE ("intermediate-reference-from-possible-value.galgas", 44)) ;
    }
  }
}
...
AbstractPtrClass * cPtr_freeCommentIR::duplicate (Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  AbstractPtrClass * ptr = nullptr ;
...
AbstractPtrClass * cPtr_loadFromReferenceIR::duplicate (Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  AbstractPtrClass * ptr = nullptr ;
...
void extensionSetter_appendCopyFromReferences (GGS_instructionListIR & ioObject,
  ...
  if (GalgasBool::boolFalse == test_0) {
    GGS_omnibusType var_sourceType_1035 ;
    GGS_string var_sourceLLVMName_1060 ;
    constinArgument_inSourcePossibleReference.method_extractReference (var_sourceType_1035, var_sourceLLVMName_1060, inCompiler COMMA_SOURCE_FILE ("intermediate-copy-from-references.galgas", 26)) ;
    GalgasBool test_1 = GalgasBool::boolTrue ;
    if (GalgasBool::boolTrue == test_1) {
      test_1 = GGS_bool (ComparisonKind::notEqual, var_sourceType_1035.readProperty_omnibusTypeDescriptionName ().objectCompare (constinArgument_inTargetReference.readProperty_type ().readProperty_omnibusTypeDescriptionName ())).boolEnum () ;
      if (GalgasBool::boolTrue == test_1) {
        GenericArray <FixItDescription> fixItArray2 ;
        inCompiler->emitSemanticError (constinArgument_inErrorLocation, GGS_string ("object of type ").add_operation (constinArgument_inTargetReference.readProperty_type ().readProperty_omnibusTypeDescriptionName (), inCompiler COMMA_SOURCE_FILE ("intermediate-copy-from-references.galgas", 29)).add_operation (GGS_string (" cannot be assigned from expression of type "), inCompiler COMMA_SOURCE_FILE ("intermediate-copy-from-references.galgas", 29)).add_operation (var_sourceType_1035.readProperty_omnibusTypeDescriptionName (), inCompiler COMMA_SOURCE_FILE ("intermediate-copy-from-references.galgas", 30)), fixItArray2  COMMA_SOURCE_FILE ("intermediate-copy-from-references.galgas", 28)) ;
      }
    }
    ioObject.addAssignOperation (GGS_copyFromReferencesIR::init_21__21_ (constinArgument_inTargetReference, var_sourceLLVMName_1060, inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("intermediate-copy-from-references.galgas", 32)) ;
  }
}
...
class CollectionElementPtr_propertyAttributeList : public CollectionElementPtr {
  public: GGS_propertyAttributeList_2E_element mObject ;

//--- Class functions
  public: CollectionElementPtr_propertyAttributeList (const GGS_lstring & in_mAttributeName,
                                                      const GGS_lbigint & in_mAttributeValue
                                                      COMMA_LOCATION_ARGS) ;
  public: CollectionElementPtr_propertyAttributeList (const GGS_propertyAttributeList_2E_element & inElement COMMA_LOCATION_ARGS) ;
...
CollectionElementPtr_propertyAttributeList::CollectionElementPtr_propertyAttributeList (const GGS_lstring & in_mAttributeName,
                                                                                        const GGS_lbigint & in_mAttributeValue
                                                                                        COMMA_LOCATION_ARGS) :
...
CollectionElementPtr_propertyAttributeList::CollectionElementPtr_propertyAttributeList (const GGS_propertyAttributeList_2E_element & inElement COMMA_LOCATION_ARGS) :
CollectionElementPtr (THERE),
...
bool CollectionElementPtr_propertyAttributeList::isValid (void) const {
  return true ;
}

//--------------------------------------------------------------------------------------------------

CollectionElementPtr * CollectionElementPtr_propertyAttributeList::copy (void) {
  CollectionElementPtr * result = nullptr ;
  macroMyNew (result, CollectionElementPtr_propertyAttributeList (mObject.mProperty_mAttributeName, mObject.mProperty_mAttributeValue COMMA_HERE)) ;
  return result ;
}
...
GGS_propertyAttributeList::GGS_propertyAttributeList (const CollectionElementArray & inArray) :
mArray () {
  mArray.setCapacity (std::max (16, int32_t (inArray.count ()))) ;
  for (uint32_t i = 0 ; i < inArray.count () ; i++) {
    const CollectionElement v = inArray.objectAtIndex (i COMMA_HERE) ;
    CollectionElementPtr_propertyAttributeList * p = (CollectionElementPtr_propertyAttributeList *) v.ptr () ;
    macroValidSharedObject (p, CollectionElementPtr_propertyAttributeList) ;
...
void GGS_propertyAttributeList::makeAttributesFromObjects (CollectionElement & outAttributes,
                                                           const GGS_lstring & in_mAttributeName,
                                                           const GGS_lbigint & in_mAttributeValue
                                                           COMMA_LOCATION_ARGS) {
  CollectionElementPtr_propertyAttributeList * p = nullptr ;
  macroMyNew (p, CollectionElementPtr_propertyAttributeList (in_mAttributeName, in_mAttributeValue COMMA_THERE)) ;
...
GGS_sortedOperandIRList GGS_sortedOperandIRList::class_func_sortedListWithValue (const GGS_objectIR & inOperand0,
                                                                                 ...
                                                                                 COMMA_LOCATION_ARGS) {
  GGS_sortedOperandIRList result = init (nullptr COMMA_THERE) ;
...
AbstractPtrClass * cPtr_userLLVMSructureTypeDefinitionIR::duplicate (Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  AbstractPtrClass * ptr = nullptr ;
...
AbstractPtrClass * cPtr_enterRegisterGroupSubscriptedAddressIR::duplicate (Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  AbstractPtrClass * ptr = nullptr ;
