...
static GALGAS_string categoryReader_structureDeclaration_keyRepresentation (const cPtr_abstractDeclaration * inObject,
  ...
  const cPtr_structureDeclaration * object = (const cPtr_structureDeclaration *) inObject ;
  macroValidSharedObject (object, cPtr_structureDeclaration) ;
  result_outRepresentation = GALGAS_string ("struct ").add_operation (object->mAttribute_mStructureName.reader_string (SOURCE_FILE ("structure-declaration.galgas", 94)), inCompiler COMMA_SOURCE_FILE ("structure-declaration.galgas", 94)) ;
//---
  return result_outRepresentation ;
}
...
static void categoryMethod_structureDeclaration_enterInContext (const cPtr_abstractDeclaration * inObject,
  ...
  while (enumerator_5293.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_0) {
      ...
      if (kBoolTrue == test_1) {
        GALGAS_location location_2 (enumerator_5293.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      GALGAS_location location_3 (enumerator_5293.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
  ...
  while (enumerator_5606.hasCurrentObject ()) {
    ...
    {
    var_propertyMap.modifier_insertKey (enumerator_5606.current_mFieldName (HERE), var_fieldTypeNameProxy, var_propertyMap.reader_count (SOURCE_FILE ("structure-declaration.galgas", 155)), inCompiler COMMA_SOURCE_FILE ("structure-declaration.galgas", 155)) ;
    }
  ...
  while (enumerator_5944.hasCurrentObject ()) {
    ...
    case GALGAS_procedureKindAST::kEnum_structureProc:
      {
        const cEnumAssociatedValues_procedureKindAST_structureProc * extractPtr_6689 = (const cEnumAssociatedValues_procedureKindAST_structureProc *) (enumerator_5944.current (HERE).mAttribute_mProcedureKind.unsafePointer ()) ;
        const GALGAS_lstring extractedValue_structureTypeName = extractPtr_6689->mAssociatedValue0 ;
        const GALGAS_bool extractedValue_mutating = extractPtr_6689->mAssociatedValue1 ;
        ...
        if (kBoolTrue == test_4) {
          ...
          while (enumerator_6281.hasCurrentObject ()) {
            ...
            var_signature.addAssign_operation (enumerator_6281.current_mFormalArgumentPassingMode (HERE), enumerator_6281.current_mSelector (HERE), var_typeProxy  COMMA_SOURCE_FILE ("structure-declaration.galgas", 167)) ;
            enumerator_6281.gotoNextObject () ;
          }
          {
          var_procedureMap.modifier_insertKey (GALGAS_lstring::constructor_new (categoryReader_getMangledName (enumerator_5944.current (HERE), inCompiler COMMA_SOURCE_FILE ("structure-declaration.galgas", 170)), enumerator_5944.current (HERE).mAttribute_mProcedureName.mAttribute_location  COMMA_SOURCE_FILE ("structure-declaration.galgas", 170)), extractedValue_mutating, GALGAS_modeMap::constructor_emptyMap (SOURCE_FILE ("structure-declaration.galgas", 172)), var_signature, GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE ("structure-declaration.galgas", 169)) ;
          }
        }
      }
      break ;
...
static void categoryMethod_structureDeclaration_initAnalysis (const cPtr_abstractDeclaration * inObject,
  ...
  cEnumerator_structureFieldListAST enumerator_7649 (object->mAttribute_mStructureFieldListAST, kEnumeration_up) ;
  while (enumerator_7649.hasCurrentObject ()) {
    GALGAS_unifiedTypeMap_2D_proxy temp_0 ;
    const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_7649.current_mFieldTypeName (HERE).mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_1) {
      temp_0 = GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("structure-declaration.galgas", 204)) ;
    }else if (kBoolFalse == test_1) {
      temp_0 = GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (ioArgument_ioContext.mAttribute_mTypeMap, enumerator_7649.current_mFieldTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("structure-declaration.galgas", 205)) ;
    }
    ...
    GALGAS_variableMap joker_8347 = GALGAS_variableMap::constructor_emptyMap (SOURCE_FILE ("structure-declaration.galgas", 219)) ;
    GALGAS_operandIR var_expressionIR ;
    callCategoryMethod_analyzeExpression ((const cPtr_expressionAST *) enumerator_7649.current_mInitExpression (HERE).ptr (), GALGAS_lstring::constructor_new (object->mAttribute_mStructureName.mAttribute_string.add_operation (GALGAS_string (" init"), inCompiler COMMA_SOURCE_FILE ("structure-declaration.galgas", 211)), object->mAttribute_mStructureName.mAttribute_location  COMMA_SOURCE_FILE ("structure-declaration.galgas", 211)), GALGAS_receiverType::constructor_noReceiver (SOURCE_FILE ("structure-declaration.galgas", 212)), var_fieldType, ioArgument_ioContext, GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("structure-declaration.galgas", 215)), GALGAS_bool (false), var_temporaries, var_globalLiteralStringMap, joker_8347, var_initInstructionGenerationList, var_expressionIR, inCompiler COMMA_SOURCE_FILE ("structure-declaration.galgas", 210)) ;
    const enumGalgasBool test_2 = categoryReader_isStatic (var_expressionIR.mAttribute_mValue, inCompiler COMMA_SOURCE_FILE ("structure-declaration.galgas", 223)).operator_not (SOURCE_FILE ("structure-declaration.galgas", 223)).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_location location_3 (enumerator_7649.current_mFieldName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
