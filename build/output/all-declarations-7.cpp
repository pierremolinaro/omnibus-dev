...
void extensionSetter_appendCopyFromReferences (GALGAS_instructionListIR & ioObject,
  ...
  if (kBoolFalse == test_0) {
    ...
    if (kBoolTrue == test_1) {
      test_1 = GALGAS_bool (kIsNotEqual, var_sourceType_1049.readProperty_omnibusTypeDescriptionName ().objectCompare (constinArgument_inTargetReference.readProperty_type ().readProperty_omnibusTypeDescriptionName ())).boolEnum () ;
      if (kBoolTrue == test_1) {
    ...
    ioObject.addAssign_operation (GALGAS_copyFromReferencesIR::constructor_new (constinArgument_inTargetReference, var_sourceLLVMName_1074  COMMA_SOURCE_FILE ("intermediate-copy-from-references.galgas", 32))  COMMA_SOURCE_FILE ("intermediate-copy-from-references.galgas", 32)) ;
  }
}
...
void extensionSetter_referenceFromPossibleValue (GALGAS_instructionListIR & ioObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_0) {
      ...
      ioArgument_ioObjectIR = GALGAS_objectIR::constructor_reference (extensionGetter_type (ioArgument_ioObjectIR, inCompiler COMMA_SOURCE_FILE ("intermediate-reference-from-possible-value.galgas", 44)), var_llvmTemporaryName_1145  COMMA_SOURCE_FILE ("intermediate-reference-from-possible-value.galgas", 44)) ;
    }
  }
}
...
void extensionSetter_appendGetComputedPropertyValue (GALGAS_instructionListIR & ioObject,
  ...
  outArgument_outResultValueIR = GALGAS_objectIR::constructor_llvmNamedValue (constinArgument_inResultType, var_result_5F_llvmName_268  COMMA_SOURCE_FILE ("intermediate-get-computed-property-value.galgas", 10)) ;
...
void extensionSetter_appendGetArrayElementReference (GALGAS_instructionListIR & ioObject,
  ...
  outArgument_outElementPtr = GALGAS_objectIR::constructor_reference (constinArgument_inElementType, var_llvmName_313  COMMA_SOURCE_FILE ("intermediate-get-array-element-reference.galgas", 11)) ;
...
void extensionMethod_enterAccessibleEntities (const GALGAS_instructionListIR inObject,
  ...
  cEnumerator_instructionListIR enumerator_759 (temp_0, kENUMERATION_UP) ;
...
GALGAS_ctCheckMap GALGAS_ctCheckMap::add_operation (const GALGAS_ctCheckMap & inOperand,
  ...
  cEnumerator_ctCheckMap enumerator (inOperand, kENUMERATION_UP) ;
...
GALGAS_ctMap GALGAS_ctMap::add_operation (const GALGAS_ctMap & inOperand,
  ...
  cEnumerator_ctMap enumerator (inOperand, kENUMERATION_UP) ;
  while (enumerator.hasCurrentObject ()) {
...
void extensionMethod_buildFormalGenericConstantMap (const GALGAS_genericFormalParameterList inObject,
  ...
  cEnumerator_genericFormalParameterList enumerator_6669 (temp_0, kENUMERATION_UP) ;
...
void extensionMethod_checkCompileTimeExpression (const GALGAS_llvmStringDefinition inObject,
  ...
  cEnumerator_llvmStringDefinition enumerator_7031 (temp_0, kENUMERATION_UP) ;
...
void extensionSetter_appendAssignmentIR (GALGAS_instructionListIR & ioObject,
                                         ...
                                         C_Compiler * inCompiler
                                         COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_lstring var_key_16065 = function_assignmentOperatorKey (constinArgument_inTargetType, constinArgument_inErrorLocation, extensionGetter_type (constinArgument_inSourcePossibleReference, inCompiler COMMA_SOURCE_FILE ("assignment-operator-definition.galgas", 345)), inCompiler COMMA_SOURCE_FILE ("assignment-operator-definition.galgas", 345)) ;
  GALGAS_abstractAssignmentOperatorUsage var_operatorUsage_16207 ;
  constinArgument_inAssignmentOperatorMap.method_searchKey (var_key_16065, var_operatorUsage_16207, inCompiler COMMA_SOURCE_FILE ("assignment-operator-definition.galgas", 346)) ;
  GALGAS_instructionListIR var_instructions_16247 = GALGAS_instructionListIR::constructor_emptyList (SOURCE_FILE ("assignment-operator-definition.galgas", 347)) ;
  callExtensionMethod_generateCode ((cPtr_abstractAssignmentOperatorUsage *) var_operatorUsage_16207.ptr (), ioArgument_ioTemporaries, var_instructions_16247, ioArgument_ioAllocaList, constinArgument_inTargetType, constinArgument_inTargetLLVMName, constinArgument_inSourcePossibleReference, constinArgument_inErrorLocation, constinArgument_inTargetIsInitialized, inCompiler COMMA_SOURCE_FILE ("assignment-operator-definition.galgas", 348)) ;
  ioObject.plusAssign_operation(var_instructions_16247, inCompiler  COMMA_SOURCE_FILE ("assignment-operator-definition.galgas", 358)) ;
}
...
void extensionSetter_appendReturn (GALGAS_llvmGenerationInstructionList & ioObject,
                                   ...
                                   C_Compiler * /* inCompiler */
                                   COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_llvmGenerationInstructionElementList var_elements_1857 = GALGAS_llvmGenerationInstructionElementList::constructor_emptyList (SOURCE_FILE ("llvm-instructions.galgas", 43)) ;
  var_elements_1857.addAssign_operation (GALGAS_llvmGenerationInstructionElement::constructor_string (GALGAS_string ("ret ")  COMMA_SOURCE_FILE ("llvm-instructions.galgas", 44))  COMMA_SOURCE_FILE ("llvm-instructions.galgas", 44)) ;
  var_elements_1857.addAssign_operation (GALGAS_llvmGenerationInstructionElement::constructor_type (constinArgument_inReturnType  COMMA_SOURCE_FILE ("llvm-instructions.galgas", 45))  COMMA_SOURCE_FILE ("llvm-instructions.galgas", 45)) ;
  var_elements_1857.addAssign_operation (GALGAS_llvmGenerationInstructionElement::constructor_string (GALGAS_string (" ")  COMMA_SOURCE_FILE ("llvm-instructions.galgas", 46))  COMMA_SOURCE_FILE ("llvm-instructions.galgas", 46)) ;
  var_elements_1857.addAssign_operation (GALGAS_llvmGenerationInstructionElement::constructor_symbol (constinArgument_inReturnValue  COMMA_SOURCE_FILE ("llvm-instructions.galgas", 47))  COMMA_SOURCE_FILE ("llvm-instructions.galgas", 47)) ;
  ioObject.addAssign_operation (GALGAS_llvmGenerationInstruction::constructor_new (var_elements_1857  COMMA_SOURCE_FILE ("llvm-instructions.galgas", 48))  COMMA_SOURCE_FILE ("llvm-instructions.galgas", 48)) ;
}
...
void extensionMethod_checkInstructionList (const GALGAS_llvmGenerationInstructionList inObject,
  ...
  cEnumerator_llvmGenerationInstructionList enumerator_4397 (temp_0, kENUMERATION_UP) ;
...
GALGAS_assignmentGenerationVarMap GALGAS_assignmentGenerationVarMap::add_operation (const GALGAS_assignmentGenerationVarMap & inOperand,
  ...
  cEnumerator_assignmentGenerationVarMap enumerator (inOperand, kENUMERATION_UP) ;
  while (enumerator.hasCurrentObject ()) {
    result.addAssign_operation (enumerator.current_lkey (HERE), enumerator.current_mValue (HERE), inCompiler COMMA_THERE) ;
    enumerator.gotoNextObject () ;
  }
...
void extensionMethod_generateIRCode (const GALGAS_llvmGenerationInstructionList inObject,
                                     ...
                                     C_Compiler * inCompiler
                                     COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_assignmentGenerationVarMap var_varMap_6175 = constinArgument_inVarMap ;
  GALGAS_assignmentGenerationVarMap var_typeMap_6199 = constinArgument_inTypeMap ;
  const GALGAS_llvmGenerationInstructionList temp_0 = inObject ;
  cEnumerator_llvmGenerationInstructionList enumerator_6226 (temp_0, kENUMERATION_UP) ;
  while (enumerator_6226.hasCurrentObject ()) {
    callExtensionMethod_generateIRCode ((cPtr_abstractLLVMInstruction *) enumerator_6226.current_mInstruction (HERE).ptr (), var_varMap_6175, var_typeMap_6199, ioArgument_ioInstructionAsStringListIR, ioArgument_ioTemporaryIndex, ioArgument_ioAllocaList, inCompiler COMMA_SOURCE_FILE ("llvm-instructions.galgas", 159)) ;
...
GALGAS_sortedOperandIRList_2D_element GALGAS_sortedOperandIRList_2D_element::constructor_new (const GALGAS_objectIR & in_mOperand,
...
GALGAS_controlRegisterBitSliceList_2D_element GALGAS_controlRegisterBitSliceList_2D_element::constructor_new (const GALGAS_controlRegisterBitSlice & in_mRegisterBitSlice,
                                                                                                              C_Compiler * /* inCompiler */
                                                                                                              COMMA_UNUSED_LOCATION_ARGS) {
