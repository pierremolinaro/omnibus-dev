...
void callExtensionMethod_analyzePrimaryExpressionNoSelf (const cPtr_primaryInExpressionAST * inObject,
  ...
  if (NULL != inObject) {
    ...
    if (NULL == f) {
      ...
      f (inObject, constin_inSelfType, constin_inRoutineAttributes, constin_inOptionalTargetType, constin_inContext, constin_inMode, constin_inIsSafe, io_ioTemporaries, io_ioStaticEntityMap, io_ioUniversalMap, io_ioAllocaList, io_ioInstructionGenerationList, out_outResult, inCompiler COMMA_THERE) ;
    }
  }
}
...
static void extensionMethod_primaryInExpressionAST_analyzePrimaryExpressionNoSelf (const cPtr_primaryInExpressionAST * inObject,
  ...
  GALGAS_valuedObject var_entity_8918 ;
  extensionMethod_searchEntity (ioArgument_ioUniversalMap, object->mProperty_mReceiverName, var_entity_8918, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 221)) ;
  switch (var_entity_8918.enumValue ()) {
  case GALGAS_valuedObject::kNotBuilt:
    break ;
  case GALGAS_valuedObject::kEnum_task:
    {
      const cEnumAssociatedValues_valuedObject_task * extractPtr_9520 = (const cEnumAssociatedValues_valuedObject_task *) (var_entity_8918.unsafePointer ()) ;
      const GALGAS_PLMType extractedValue_type = extractPtr_9520->mAssociatedValue0 ;
  ...
  case GALGAS_valuedObject::kEnum_driver:
    {
      const cEnumAssociatedValues_valuedObject_driver * extractPtr_10215 = (const cEnumAssociatedValues_valuedObject_driver *) (var_entity_8918.unsafePointer ()) ;
      const GALGAS_PLMType extractedValue_type = extractPtr_10215->mAssociatedValue0 ;
      const GALGAS_bool extractedValue_instancied = extractPtr_10215->mAssociatedValue1 ;
  ...
  case GALGAS_valuedObject::kEnum_globalConstant:
    {
      const cEnumAssociatedValues_valuedObject_globalConstant * extractPtr_10874 = (const cEnumAssociatedValues_valuedObject_globalConstant *) (var_entity_8918.unsafePointer ()) ;
      const GALGAS_objectIR extractedValue_objectIR = extractPtr_10874->mAssociatedValue0 ;
  ...
  case GALGAS_valuedObject::kEnum_localConstant:
    {
      const cEnumAssociatedValues_valuedObject_localConstant * extractPtr_11537 = (const cEnumAssociatedValues_valuedObject_localConstant *) (var_entity_8918.unsafePointer ()) ;
      const GALGAS_PLMType extractedValue_type = extractPtr_11537->mAssociatedValue0 ;
      const GALGAS_lstring extractedValue_plmName = extractPtr_11537->mAssociatedValue1 ;
      {
  ...
  case GALGAS_valuedObject::kEnum_localVariable:
    {
      const cEnumAssociatedValues_valuedObject_localVariable * extractPtr_12199 = (const cEnumAssociatedValues_valuedObject_localVariable *) (var_entity_8918.unsafePointer ()) ;
      const GALGAS_PLMType extractedValue_type = extractPtr_12199->mAssociatedValue0 ;
      const GALGAS_lstring extractedValue_plmName = extractPtr_12199->mAssociatedValue1 ;
  ...
  case GALGAS_valuedObject::kEnum_globalSyncInstance:
    {
      const cEnumAssociatedValues_valuedObject_globalSyncInstance * extractPtr_12822 = (const cEnumAssociatedValues_valuedObject_globalSyncInstance *) (var_entity_8918.unsafePointer ()) ;
      const GALGAS_PLMType extractedValue_type = extractPtr_12822->mAssociatedValue0 ;
      const GALGAS_lstring extractedValue_plmName = extractPtr_12822->mAssociatedValue1 ;
...
static void extensionMethod_primaryInExpressionAST_analyzePrimaryExpressionWithSelf (const cPtr_primaryInExpressionAST * inObject,
  ...
  const cPtr_primaryInExpressionAST * object = inObject ;
  macroValidSharedObject (object, cPtr_primaryInExpressionAST) ;
  outArgument_outResult = GALGAS_objectIR::constructor_reference (constinArgument_inSelfType, function_llvmNameForSelf (inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 429))  COMMA_SOURCE_FILE ("expression-primary.galgas", 429)) ;
  cEnumerator_primaryInExpressionAccessListAST enumerator_16337 (object->mProperty_mAccessList, kENUMERATION_UP) ;
  while (enumerator_16337.hasCurrentObject ()) {
    switch (enumerator_16337.current_mAccess (HERE).enumValue ()) {
    case GALGAS_primaryInExpressionAccessAST::kNotBuilt:
      break ;
    case GALGAS_primaryInExpressionAccessAST::kEnum_integerSlice:
      {
        const cEnumAssociatedValues_primaryInExpressionAccessAST_integerSlice * extractPtr_16618 = (const cEnumAssociatedValues_primaryInExpressionAccessAST_integerSlice *) (enumerator_16337.current_mAccess (HERE).unsafePointer ()) ;
        const GALGAS_lbigint extractedValue_low = extractPtr_16618->mAssociatedValue0 ;
        const GALGAS_lbigint extractedValue_high = extractPtr_16618->mAssociatedValue1 ;
        {
        routine_handleSliceInExpression (constinArgument_inContext, outArgument_outResult, extractedValue_low, extractedValue_high, ioArgument_ioTemporaries, ioArgument_ioInstructionGenerationList, inCompiler  COMMA_SOURCE_FILE ("expression-primary.galgas", 434)) ;
        }
      }
      break ;
    case GALGAS_primaryInExpressionAccessAST::kEnum_property:
      {
        const cEnumAssociatedValues_primaryInExpressionAccessAST_property * extractPtr_16843 = (const cEnumAssociatedValues_primaryInExpressionAccessAST_property *) (enumerator_16337.current_mAccess (HERE).unsafePointer ()) ;
        const GALGAS_lstring extractedValue_propertyName = extractPtr_16843->mAssociatedValue0 ;
        {
        routine_handlePropertyAccessInExpression (outArgument_outResult, extractedValue_propertyName, ioArgument_ioTemporaries, ioArgument_ioInstructionGenerationList, inCompiler  COMMA_SOURCE_FILE ("expression-primary.galgas", 443)) ;
        }
      }
      break ;
    case GALGAS_primaryInExpressionAccessAST::kEnum_arrayAccess:
      {
        const cEnumAssociatedValues_primaryInExpressionAccessAST_arrayAccess * extractPtr_17425 = (const cEnumAssociatedValues_primaryInExpressionAccessAST_arrayAccess *) (enumerator_16337.current_mAccess (HERE).unsafePointer ()) ;
        const GALGAS_expressionAST extractedValue_indexExpression = extractPtr_17425->mAssociatedValue0 ;
        const GALGAS_location extractedValue_endOfIndex = extractPtr_17425->mAssociatedValue1 ;
        {
    ...
    case GALGAS_primaryInExpressionAccessAST::kEnum_funcCall:
      {
        const cEnumAssociatedValues_primaryInExpressionAccessAST_funcCall * extractPtr_18133 = (const cEnumAssociatedValues_primaryInExpressionAccessAST_funcCall *) (enumerator_16337.current_mAccess (HERE).unsafePointer ()) ;
        const GALGAS_lstring extractedValue_methodName = extractPtr_18133->mAssociatedValue0 ;
        const GALGAS_effectiveArgumentListAST extractedValue_arguments = extractPtr_18133->mAssociatedValue1 ;
        const GALGAS_location extractedValue_errorLocation = extractPtr_18133->mAssociatedValue2 ;
        const enumGalgasBool test_0 = constinArgument_inRoutineAttributes.getter_guard (SOURCE_FILE ("expression-primary.galgas", 467)).boolEnum () ;
        if (kBoolTrue == test_0) {
          TC_Array <C_FixItDescription> fixItArray1 ;
          inCompiler->emitSemanticError (extractedValue_errorLocation, GALGAS_string ("a method cannot be called in guard"), fixItArray1  COMMA_SOURCE_FILE ("expression-primary.galgas", 468)) ;
          outArgument_outResult.drop () ; // Release error dropped variable
...
void extensionMethod_analyzeLValue (const GALGAS_LValueAST inObject,
  ...
  if (kBoolTrue == test_0) {
    const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, constinArgument_inSelfType.getter_kind (HERE).objectCompare (GALGAS_typeKind::constructor_void (SOURCE_FILE ("lvalue.galgas", 101)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      TC_Array <C_FixItDescription> fixItArray2 ;
      inCompiler->emitSemanticError (inObject.mProperty_mIdentifier.getter_location (SOURCE_FILE ("lvalue.galgas", 102)), GALGAS_string ("self is not available in this context"), fixItArray2  COMMA_SOURCE_FILE ("lvalue.galgas", 102)) ;
      outArgument_outInternalRepresentation.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_1) {
      GALGAS_bool test_3 = constinArgument_inRoutineAttributes.getter_mutating (SOURCE_FILE ("lvalue.galgas", 103)).operator_not (SOURCE_FILE ("lvalue.galgas", 103)) ;
      if (kBoolTrue == test_3.boolEnum ()) {
        test_3 = constinArgument_inIsReadAccess.operator_not (SOURCE_FILE ("lvalue.galgas", 103)) ;
      }
      const enumGalgasBool test_4 = test_3.boolEnum () ;
      if (kBoolTrue == test_4) {
        TC_Array <C_FixItDescription> fixItArray5 ;
        inCompiler->emitSemanticError (inObject.mProperty_mIdentifier.getter_location (SOURCE_FILE ("lvalue.galgas", 104)), GALGAS_string ("cannot mutate properties, current method is not declared with @").add_operation (function_mutatingAttribute (inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 105)), inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 105)).add_operation (GALGAS_string (" attribute"), inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 105)), fixItArray5  COMMA_SOURCE_FILE ("lvalue.galgas", 104)) ;
        outArgument_outInternalRepresentation.drop () ; // Release error dropped variable
      }else if (kBoolFalse == test_4) {
        {
        routine_analyzeSelfAssignmentTarget (constinArgument_inSelfType, constinArgument_inRoutineAttributes, constinArgument_inContext, constinArgument_inMode, constinArgument_inIsSafe, ioArgument_ioTemporaries, ioArgument_ioStaticEntityMap, ioArgument_ioUniversalMap, ioArgument_ioAllocaList, ioArgument_ioInstructionGenerationList, inObject.mProperty_mIdentifier.getter_location (HERE), inObject.mProperty_mAccessList, outArgument_outInternalRepresentation, inCompiler  COMMA_SOURCE_FILE ("lvalue.galgas", 108)) ;
        }
      }
    }
  }else if (kBoolFalse == test_0) {
    GALGAS_valuedObject var_entity_5046 ;
    extensionMethod_searchEntity (ioArgument_ioUniversalMap, inObject.mProperty_mIdentifier, var_entity_5046, inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 125)) ;
    switch (var_entity_5046.enumValue ()) {
    case GALGAS_valuedObject::kNotBuilt:
      break ;
    case GALGAS_valuedObject::kEnum_task:
      {
        TC_Array <C_FixItDescription> fixItArray6 ;
        inCompiler->emitSemanticError (inObject.mProperty_mIdentifier.getter_location (SOURCE_FILE ("lvalue.galgas", 128)), GALGAS_string ("a task has no value"), fixItArray6  COMMA_SOURCE_FILE ("lvalue.galgas", 128)) ;
        outArgument_outInternalRepresentation.drop () ; // Release error dropped variable
      }
      break ;
    case GALGAS_valuedObject::kEnum_driver:
      {
        ...
        inCompiler->emitSemanticError (inObject.mProperty_mIdentifier.getter_location (SOURCE_FILE ("lvalue.galgas", 130)), GALGAS_string ("a driver has no value"), fixItArray7  COMMA_SOURCE_FILE ("lvalue.galgas", 130)) ;
        outArgument_outInternalRepresentation.drop () ; // Release error dropped variable
      }
      break ;
    case GALGAS_valuedObject::kEnum_registerGroup:
      {
        ...
        inCompiler->emitSemanticError (inObject.mProperty_mIdentifier.getter_location (SOURCE_FILE ("lvalue.galgas", 132)), GALGAS_string ("INTERNAL ERROR"), fixItArray8  COMMA_SOURCE_FILE ("lvalue.galgas", 132)) ;
        outArgument_outInternalRepresentation.drop () ; // Release error dropped variable
      }
      break ;
    case GALGAS_valuedObject::kEnum_globalConstant:
      {
        ...
        inCompiler->emitSemanticError (inObject.mProperty_mIdentifier.getter_location (SOURCE_FILE ("lvalue.galgas", 134)), GALGAS_string ("a global constant cannot be written"), fixItArray9  COMMA_SOURCE_FILE ("lvalue.galgas", 134)) ;
        outArgument_outInternalRepresentation.drop () ; // Release error dropped variable
      }
      break ;
    case GALGAS_valuedObject::kEnum_localConstant:
      {
        ...
        inCompiler->emitSemanticError (inObject.mProperty_mIdentifier.getter_location (SOURCE_FILE ("lvalue.galgas", 136)), GALGAS_string ("a local constant cannot be written"), fixItArray10  COMMA_SOURCE_FILE ("lvalue.galgas", 136)) ;
        outArgument_outInternalRepresentation.drop () ; // Release error dropped variable
      }
      break ;
    case GALGAS_valuedObject::kEnum_globalSyncInstance:
      {
        ...
        inCompiler->emitSemanticError (inObject.mProperty_mIdentifier.getter_location (SOURCE_FILE ("lvalue.galgas", 138)), GALGAS_string ("a global sync instance is not allowed here"), fixItArray11  COMMA_SOURCE_FILE ("lvalue.galgas", 138)) ;
        outArgument_outInternalRepresentation.drop () ; // Release error dropped variable
      }
      break ;
    case GALGAS_valuedObject::kEnum_localVariable:
      {
        const cEnumAssociatedValues_valuedObject_localVariable * extractPtr_6407 = (const cEnumAssociatedValues_valuedObject_localVariable *) (var_entity_5046.unsafePointer ()) ;
        const GALGAS_PLMType extractedValue_variableType = extractPtr_6407->mAssociatedValue0 ;
        const GALGAS_lstring extractedValue_plmName = extractPtr_6407->mAssociatedValue1 ;
        {
        routine_analyzeVariableInLValue (constinArgument_inSelfType, constinArgument_inIsReadAccess, constinArgument_inRoutineAttributes, constinArgument_inContext, constinArgument_inMode, constinArgument_inIsSafe, ioArgument_ioTemporaries, ioArgument_ioStaticEntityMap, ioArgument_ioUniversalMap, ioArgument_ioAllocaList, ioArgument_ioInstructionGenerationList, inObject.mProperty_mIdentifier, function_llvmNameForLocalVariable (extractedValue_plmName.getter_string (SOURCE_FILE ("lvalue.galgas", 153)), inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 153)), extractedValue_variableType, inObject.mProperty_mAccessList, outArgument_outInternalRepresentation, inCompiler  COMMA_SOURCE_FILE ("lvalue.galgas", 140)) ;
        }
      }
      break ;
    }
...
void extensionMethod_controlRegisterLValueSemanticAnalysis (const GALGAS_controlRegisterLValueAST inObject,
  ...
  GALGAS_valuedObject var_entity_5381 ;
  extensionMethod_searchEntity (ioArgument_ioUniversalMap, inObject.mProperty_mRegisterGroupName, var_entity_5381, inCompiler COMMA_SOURCE_FILE ("lvalue-control-register.galgas", 127)) ;
  GALGAS_controlRegisterMap var_registerMap_5481 ;
  GALGAS_registerGroupKind var_groupKind_5512 ;
  switch (var_entity_5381.enumValue ()) {
  case GALGAS_valuedObject::kNotBuilt:
    break ;
  case GALGAS_valuedObject::kEnum_task:
    {
      ...
      var_registerMap_5481.drop () ; // Release error dropped variable
      var_groupKind_5512.drop () ; // Release error dropped variable
    }
    break ;
  case GALGAS_valuedObject::kEnum_driver:
    {
  ...
  case GALGAS_valuedObject::kEnum_registerGroup:
    {
      const cEnumAssociatedValues_valuedObject_registerGroup * extractPtr_6441 = (const cEnumAssociatedValues_valuedObject_registerGroup *) (var_entity_5381.unsafePointer ()) ;
      const GALGAS_controlRegisterMap extractedValue_theRegisterMap = extractPtr_6441->mAssociatedValue0 ;
      const GALGAS_registerGroupKind extractedValue_theGroupKind = extractPtr_6441->mAssociatedValue1 ;
      var_registerMap_5481 = extractedValue_theRegisterMap ;
      var_groupKind_5512 = extractedValue_theGroupKind ;
    }
    break ;
  }
  GALGAS_bool var_readOnly_6536 ;
  GALGAS_bool var_userAccess_6562 ;
  GALGAS_bigint var_addressOffset_6617 ;
  GALGAS_uint var_registerArraySize_6686 ;
  GALGAS_uint var_registerElementSize_6741 ;
  GALGAS_controlRegisterFieldMap joker_6585 ; // Joker input parameter
  GALGAS_controlRegisterFieldList joker_6623 ; // Joker input parameter
  var_registerMap_5481.method_searchKey (inObject.mProperty_mRegisterName, outArgument_outRegisterType, var_readOnly_6536, var_userAccess_6562, outArgument_outSliceMap, joker_6585, var_addressOffset_6617, joker_6623, outArgument_outRegisterTypeBitCount, var_registerArraySize_6686, var_registerElementSize_6741, inCompiler COMMA_SOURCE_FILE ("lvalue-control-register.galgas", 148)) ;
  const enumGalgasBool test_6 = constinArgument_inWriteAccess.operator_and (var_readOnly_6536 COMMA_SOURCE_FILE ("lvalue-control-register.galgas", 162)).boolEnum () ;
  if (kBoolTrue == test_6) {
    TC_Array <C_FixItDescription> fixItArray7 ;
    ...
    GALGAS_bool test_8 = var_userAccess_6562.operator_not (SOURCE_FILE ("lvalue-control-register.galgas", 165)) ;
  ...
  GALGAS_string var_registerAddress_7164 ;
  switch (var_groupKind_5512.enumValue ()) {
  case GALGAS_registerGroupKind::kNotBuilt:
    break ;
  case GALGAS_registerGroupKind::kEnum_single:
    {
      const cEnumAssociatedValues_registerGroupKind_single * extractPtr_7628 = (const cEnumAssociatedValues_registerGroupKind_single *) (var_groupKind_5512.unsafePointer ()) ;
      const GALGAS_bigint extractedValue_baseAddress = extractPtr_7628->mAssociatedValue0 ;
      ...
      if (kBoolTrue == test_12) {
        ...
        var_registerAddress_7164.drop () ; // Release error dropped variable
      }else if (kBoolFalse == test_12) {
        GALGAS_string var_regName_7383 = inObject.mProperty_mRegisterGroupName.getter_string (HERE).add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("lvalue-control-register.galgas", 175)).add_operation (inObject.mProperty_mRegisterName.getter_string (SOURCE_FILE ("lvalue-control-register.galgas", 175)), inCompiler COMMA_SOURCE_FILE ("lvalue-control-register.galgas", 175)) ;
        {
        extensionSetter_appendEnterRegisterAddress (ioArgument_ioInstructionGenerationList, ioArgument_ioTemporaries, var_registerAddress_7164, extractedValue_baseAddress, var_addressOffset_6617, var_regName_7383, inCompiler COMMA_SOURCE_FILE ("lvalue-control-register.galgas", 176)) ;
        }
      }
    }
    break ;
  case GALGAS_registerGroupKind::kEnum_arrayGroup:
    {
      const cEnumAssociatedValues_registerGroupKind_arrayGroup * extractPtr_8627 = (const cEnumAssociatedValues_registerGroupKind_arrayGroup *) (var_groupKind_5512.unsafePointer ()) ;
      const GALGAS_lbigintlist extractedValue_baseAddresses = extractPtr_8627->mAssociatedValue0 ;
      switch (inObject.mProperty_mGroupIndex.enumValue ()) {
      case GALGAS_registerGroupIndexAST::kNotBuilt:
        break ;
      case GALGAS_registerGroupIndexAST::kEnum_noIndex:
      ...
      case GALGAS_registerGroupIndexAST::kEnum_index:
        {
          const cEnumAssociatedValues_registerGroupIndexAST_index * extractPtr_8619 = (const cEnumAssociatedValues_registerGroupIndexAST_index *) (inObject.mProperty_mGroupIndex.unsafePointer ()) ;
          const GALGAS_expressionAST extractedValue_indexExpression = extractPtr_8619->mAssociatedValue0 ;
          const GALGAS_location extractedValue_endOfIndex = extractPtr_8619->mAssociatedValue1 ;
          GALGAS_objectIR var_groupIndexIR_8385 ;
          {
          routine_handleArraySubscriptNew (constinArgument_inSelfType, constinArgument_inRoutineAttributes, constinArgument_inContext, constinArgument_inMode, constinArgument_inIsSafe, ioArgument_ioTemporaries, ioArgument_ioStaticEntityMap, ioArgument_ioUniversalMap, ioArgument_ioAllocaList, extractedValue_indexExpression, extractedValue_endOfIndex, extractedValue_baseAddresses.getter_length (SOURCE_FILE ("lvalue-control-register.galgas", 201)).getter_bigint (SOURCE_FILE ("lvalue-control-register.galgas", 201)), outArgument_outRegisterType, ioArgument_ioInstructionGenerationList, var_groupIndexIR_8385, inCompiler  COMMA_SOURCE_FILE ("lvalue-control-register.galgas", 189)) ;
          }
          {
          extensionSetter_appendEnterRegisterGroupSubscriptedAddress (ioArgument_ioInstructionGenerationList, ioArgument_ioTemporaries, var_registerAddress_7164, inObject.mProperty_mRegisterGroupName.getter_string (HERE), extractedValue_baseAddresses.getter_length (SOURCE_FILE ("lvalue-control-register.galgas", 210)), var_groupIndexIR_8385, inCompiler COMMA_SOURCE_FILE ("lvalue-control-register.galgas", 206)) ;
          }
        }
        break ;
      }
  ...
  case GALGAS_registerIndexAST::kEnum_noIndex:
    {
      const enumGalgasBool test_15 = GALGAS_bool (kIsEqual, var_registerArraySize_6686.objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_15) {
        outArgument_outllvmRegisterAddressName = var_registerAddress_7164 ;
  ...
  case GALGAS_registerIndexAST::kEnum_index:
    {
      const cEnumAssociatedValues_registerIndexAST_index * extractPtr_9667 = (const cEnumAssociatedValues_registerIndexAST_index *) (inObject.mProperty_mRegisterIndex.unsafePointer ()) ;
      const GALGAS_expressionAST extractedValue_indexExpression = extractPtr_9667->mAssociatedValue0 ;
      const GALGAS_location extractedValue_endOfIndex = extractPtr_9667->mAssociatedValue1 ;
      GALGAS_objectIR var_indexIR_9451 ;
      {
      routine_handleArraySubscriptNew (constinArgument_inSelfType, constinArgument_inRoutineAttributes, constinArgument_inContext, constinArgument_inMode, constinArgument_inIsSafe, ioArgument_ioTemporaries, ioArgument_ioStaticEntityMap, ioArgument_ioUniversalMap, ioArgument_ioAllocaList, extractedValue_indexExpression, extractedValue_endOfIndex, var_registerArraySize_6686.getter_bigint (SOURCE_FILE ("lvalue-control-register.galgas", 236)), outArgument_outRegisterType, ioArgument_ioInstructionGenerationList, var_indexIR_9451, inCompiler  COMMA_SOURCE_FILE ("lvalue-control-register.galgas", 224)) ;
      }
      {
      extensionSetter_appendComputeSubscriptedVolatileRegisterAddress (ioArgument_ioInstructionGenerationList, ioArgument_ioTemporaries, outArgument_outllvmRegisterAddressName, var_indexIR_9451, var_registerAddress_7164, var_registerElementSize_6741, inCompiler COMMA_SOURCE_FILE ("lvalue-control-register.galgas", 241)) ;
      }
    }
    break ;
  }
