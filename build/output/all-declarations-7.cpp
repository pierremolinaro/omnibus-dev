  ...
  while (enumerator_7289.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_4) {
      ...
      case GALGAS_interruptionPanicCode::kEnum_panicCode:
        {
          const cEnumAssociatedValues_interruptionPanicCode_panicCode * extractPtr_8176 = (const cEnumAssociatedValues_interruptionPanicCode_panicCode *) (enumerator_7289.current_mInterruptionPanicCode (HERE).unsafePointer ()) ;
          const GALGAS_lbigint extractedValue_value = extractPtr_8176->mAssociatedValue0 ;
          ...
          if (kBoolTrue == test_5) {
            ...
            ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  call void @panic.isr (i32 ").add_operation (extractedValue_value.mAttribute_bigint.getter_string (SOURCE_FILE ("declaration-isr.galgas", 186)), inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 186)).add_operation (GALGAS_string (")\n"), inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 186)), inCompiler  COMMA_SOURCE_FILE ("declaration-isr.galgas", 186)) ;
