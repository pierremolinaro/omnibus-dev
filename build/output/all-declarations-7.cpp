...
void categoryMethod_llvmPrototypeGeneration (const GALGAS_externProcedureMapIR_2D_element inObject,
                                             ...
                                             C_Compiler * inCompiler
                                             COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_procName = function_llvmNameForProcedure (inObject.mAttribute_lkey.mAttribute_string, inCompiler COMMA_SOURCE_FILE ("extern-proc-declaration.galgas", 167)) ;
  ...
  ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("declare void @").add_operation (var_procName, inCompiler COMMA_SOURCE_FILE ("extern-proc-declaration.galgas", 169)).add_operation (GALGAS_string (" ("), inCompiler COMMA_SOURCE_FILE ("extern-proc-declaration.galgas", 169)), inCompiler  COMMA_SOURCE_FILE ("extern-proc-declaration.galgas", 169)) ;
  ...
  while (enumerator_7381.hasCurrentObject ()) {
    ...
    case GALGAS_procFormalArgumentPassingMode::kEnum_input:
      {
        ioArgument_ioLLVMcode.plusAssign_operation(enumerator_7381.current_mFormalArgumentType (HERE).getter_llvmTypeName (inCompiler COMMA_SOURCE_FILE ("extern-proc-declaration.galgas", 174)).add_operation (GALGAS_string (" %in."), inCompiler COMMA_SOURCE_FILE ("extern-proc-declaration.galgas", 174)).add_operation (enumerator_7381.current_mFormalArgumentName (HERE), inCompiler COMMA_SOURCE_FILE ("extern-proc-declaration.galgas", 174)), inCompiler  COMMA_SOURCE_FILE ("extern-proc-declaration.galgas", 174)) ;
      }
      break ;
    case GALGAS_procFormalArgumentPassingMode::kEnum_output:
      {
        ioArgument_ioLLVMcode.plusAssign_operation(enumerator_7381.current_mFormalArgumentType (HERE).getter_llvmTypeName (inCompiler COMMA_SOURCE_FILE ("extern-proc-declaration.galgas", 176)).add_operation (GALGAS_string ("* %"), inCompiler COMMA_SOURCE_FILE ("extern-proc-declaration.galgas", 176)).add_operation (enumerator_7381.current_mFormalArgumentName (HERE), inCompiler COMMA_SOURCE_FILE ("extern-proc-declaration.galgas", 176)), inCompiler  COMMA_SOURCE_FILE ("extern-proc-declaration.galgas", 176)) ;
      }
      break ;
    case GALGAS_procFormalArgumentPassingMode::kEnum_inputOutput:
      {
        ioArgument_ioLLVMcode.plusAssign_operation(enumerator_7381.current_mFormalArgumentType (HERE).getter_llvmTypeName (inCompiler COMMA_SOURCE_FILE ("extern-proc-declaration.galgas", 178)).add_operation (GALGAS_string ("* %"), inCompiler COMMA_SOURCE_FILE ("extern-proc-declaration.galgas", 178)).add_operation (enumerator_7381.current_mFormalArgumentName (HERE), inCompiler COMMA_SOURCE_FILE ("extern-proc-declaration.galgas", 178)), inCompiler  COMMA_SOURCE_FILE ("extern-proc-declaration.galgas", 178)) ;
      }
      break ;
    }
    if (enumerator_7381.hasNextObject ()) {
      ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string (", "), inCompiler  COMMA_SOURCE_FILE ("extern-proc-declaration.galgas", 181)) ;
    }
    enumerator_7381.gotoNextObject () ;
  }
  ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string (") nounwind ; defined in C\n"
    "\n"), inCompiler  COMMA_SOURCE_FILE ("extern-proc-declaration.galgas", 183)) ;
}
...
void categoryMethod_enterInContext (const GALGAS_serviceDeclarationListAST_2D_element inObject,
                                    ...
                                    C_Compiler * inCompiler
                                    COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_procedureSignature var_signature = GALGAS_procedureSignature::constructor_emptyList (SOURCE_FILE ("service-declaration.galgas", 98)) ;
  ...
  while (enumerator_4098.hasCurrentObject ()) {
    GALGAS_unifiedTypeMap_2D_proxy var_typeProxy = GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (ioArgument_ioContext.mAttribute_mTypeMap, enumerator_4098.current_mFormalArgumentTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("service-declaration.galgas", 100)) ;
    var_signature.addAssign_operation (enumerator_4098.current_mFormalArgumentPassingMode (HERE), enumerator_4098.current_mSelector (HERE).mAttribute_string, var_typeProxy  COMMA_SOURCE_FILE ("service-declaration.galgas", 101)) ;
    enumerator_4098.gotoNextObject () ;
  }
  {
  ioArgument_ioContext.mAttribute_mServiceMap.setter_insertKey (inObject.mAttribute_mServiceName, inObject.mAttribute_mMutating, var_signature, inCompiler COMMA_SOURCE_FILE ("service-declaration.galgas", 104)) ;
  }
  {
  ioArgument_ioContext.mAttribute_mSubProgramMap.setter_insertKey (inObject.mAttribute_mServiceName, inCompiler COMMA_SOURCE_FILE ("service-declaration.galgas", 109)) ;
  }
}
...
void categoryMethod_llvmCodeGeneration (const GALGAS_serviceMapIR_2D_element inObject,
                                        ...
                                        C_Compiler * inCompiler
                                        COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_serviceImplementationName = function_llvmNameForServiceImplementation (inObject.mAttribute_lkey.mAttribute_string, inCompiler COMMA_SOURCE_FILE ("service-declaration.galgas", 246)) ;
  ioArgument_ioLLVMcode.plusAssign_operation(function_llvmTitleComment (var_serviceImplementationName, inCompiler COMMA_SOURCE_FILE ("service-declaration.galgas", 247)), inCompiler  COMMA_SOURCE_FILE ("service-declaration.galgas", 247)) ;
  ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("declare void @").add_operation (function_llvmNameForServiceCall (inObject.mAttribute_lkey.mAttribute_string, inCompiler COMMA_SOURCE_FILE ("service-declaration.galgas", 248)), inCompiler COMMA_SOURCE_FILE ("service-declaration.galgas", 248)).add_operation (GALGAS_string (" ("), inCompiler COMMA_SOURCE_FILE ("service-declaration.galgas", 248)), inCompiler  COMMA_SOURCE_FILE ("service-declaration.galgas", 248)) ;
  ...
  while (enumerator_10100.hasCurrentObject ()) {
    ...
    case GALGAS_procFormalArgumentPassingMode::kEnum_input:
      {
        ioArgument_ioLLVMcode.plusAssign_operation(enumerator_10100.current_mFormalArgumentType (HERE).getter_llvmTypeName (inCompiler COMMA_SOURCE_FILE ("service-declaration.galgas", 253)).add_operation (GALGAS_string (" %in."), inCompiler COMMA_SOURCE_FILE ("service-declaration.galgas", 253)).add_operation (enumerator_10100.current_mFormalArgumentName (HERE), inCompiler COMMA_SOURCE_FILE ("service-declaration.galgas", 253)), inCompiler  COMMA_SOURCE_FILE ("service-declaration.galgas", 253)) ;
      }
      break ;
    case GALGAS_procFormalArgumentPassingMode::kEnum_output:
      {
        ioArgument_ioLLVMcode.plusAssign_operation(enumerator_10100.current_mFormalArgumentType (HERE).getter_llvmTypeName (inCompiler COMMA_SOURCE_FILE ("service-declaration.galgas", 255)).add_operation (GALGAS_string ("* %"), inCompiler COMMA_SOURCE_FILE ("service-declaration.galgas", 255)).add_operation (enumerator_10100.current_mFormalArgumentName (HERE), inCompiler COMMA_SOURCE_FILE ("service-declaration.galgas", 255)), inCompiler  COMMA_SOURCE_FILE ("service-declaration.galgas", 255)) ;
      }
      break ;
    case GALGAS_procFormalArgumentPassingMode::kEnum_inputOutput:
      {
        ioArgument_ioLLVMcode.plusAssign_operation(enumerator_10100.current_mFormalArgumentType (HERE).getter_llvmTypeName (inCompiler COMMA_SOURCE_FILE ("service-declaration.galgas", 257)).add_operation (GALGAS_string ("* %"), inCompiler COMMA_SOURCE_FILE ("service-declaration.galgas", 257)).add_operation (enumerator_10100.current_mFormalArgumentName (HERE), inCompiler COMMA_SOURCE_FILE ("service-declaration.galgas", 257)), inCompiler  COMMA_SOURCE_FILE ("service-declaration.galgas", 257)) ;
      }
      break ;
    }
    if (enumerator_10100.hasNextObject ()) {
      ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string (", "), inCompiler  COMMA_SOURCE_FILE ("service-declaration.galgas", 260)) ;
    }
    enumerator_10100.gotoNextObject () ;
  }
  ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string (") nounwind \n"
    "\n"), inCompiler  COMMA_SOURCE_FILE ("service-declaration.galgas", 262)) ;
  ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("define void @").add_operation (var_serviceImplementationName, inCompiler COMMA_SOURCE_FILE ("service-declaration.galgas", 263)).add_operation (GALGAS_string (" ("), inCompiler COMMA_SOURCE_FILE ("service-declaration.galgas", 263)), inCompiler  COMMA_SOURCE_FILE ("service-declaration.galgas", 263)) ;
  ...
  while (enumerator_10643.hasCurrentObject ()) {
    ...
    case GALGAS_procFormalArgumentPassingMode::kEnum_input:
      {
        ioArgument_ioLLVMcode.plusAssign_operation(enumerator_10643.current_mFormalArgumentType (HERE).getter_llvmTypeName (inCompiler COMMA_SOURCE_FILE ("service-declaration.galgas", 268)).add_operation (GALGAS_string (" %in."), inCompiler COMMA_SOURCE_FILE ("service-declaration.galgas", 268)).add_operation (enumerator_10643.current_mFormalArgumentName (HERE), inCompiler COMMA_SOURCE_FILE ("service-declaration.galgas", 268)), inCompiler  COMMA_SOURCE_FILE ("service-declaration.galgas", 268)) ;
      }
      break ;
    case GALGAS_procFormalArgumentPassingMode::kEnum_output:
      {
        ioArgument_ioLLVMcode.plusAssign_operation(enumerator_10643.current_mFormalArgumentType (HERE).getter_llvmTypeName (inCompiler COMMA_SOURCE_FILE ("service-declaration.galgas", 270)).add_operation (GALGAS_string ("* %"), inCompiler COMMA_SOURCE_FILE ("service-declaration.galgas", 270)).add_operation (enumerator_10643.current_mFormalArgumentName (HERE), inCompiler COMMA_SOURCE_FILE ("service-declaration.galgas", 270)), inCompiler  COMMA_SOURCE_FILE ("service-declaration.galgas", 270)) ;
      }
      break ;
    case GALGAS_procFormalArgumentPassingMode::kEnum_inputOutput:
      {
        ioArgument_ioLLVMcode.plusAssign_operation(enumerator_10643.current_mFormalArgumentType (HERE).getter_llvmTypeName (inCompiler COMMA_SOURCE_FILE ("service-declaration.galgas", 272)).add_operation (GALGAS_string ("* %"), inCompiler COMMA_SOURCE_FILE ("service-declaration.galgas", 272)).add_operation (enumerator_10643.current_mFormalArgumentName (HERE), inCompiler COMMA_SOURCE_FILE ("service-declaration.galgas", 272)), inCompiler  COMMA_SOURCE_FILE ("service-declaration.galgas", 272)) ;
      }
      break ;
    }
    if (enumerator_10643.hasNextObject ()) {
      ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string (", "), inCompiler  COMMA_SOURCE_FILE ("service-declaration.galgas", 275)) ;
    }
    enumerator_10643.gotoNextObject () ;
  }
  ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string (") nounwind {\n"), inCompiler  COMMA_SOURCE_FILE ("service-declaration.galgas", 277)) ;
  ...
  while (enumerator_11155.hasCurrentObject ()) {
    ...
    case GALGAS_procFormalArgumentPassingMode::kEnum_input:
      {
        GALGAS_string var_llvmType = enumerator_11155.current_mFormalArgumentType (HERE).getter_llvmTypeName (inCompiler COMMA_SOURCE_FILE ("service-declaration.galgas", 282)) ;
        ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  %").add_operation (enumerator_11155.current_mFormalArgumentName (HERE), inCompiler COMMA_SOURCE_FILE ("service-declaration.galgas", 283)).add_operation (GALGAS_string (" = alloca "), inCompiler COMMA_SOURCE_FILE ("service-declaration.galgas", 283)).add_operation (enumerator_11155.current_mFormalArgumentType (HERE).getter_llvmTypeName (inCompiler COMMA_SOURCE_FILE ("service-declaration.galgas", 283)), inCompiler COMMA_SOURCE_FILE ("service-declaration.galgas", 283)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("service-declaration.galgas", 283)), inCompiler  COMMA_SOURCE_FILE ("service-declaration.galgas", 283)) ;
        ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  store ").add_operation (var_llvmType, inCompiler COMMA_SOURCE_FILE ("service-declaration.galgas", 284)).add_operation (GALGAS_string (" %in."), inCompiler COMMA_SOURCE_FILE ("service-declaration.galgas", 284)).add_operation (enumerator_11155.current_mFormalArgumentName (HERE), inCompiler COMMA_SOURCE_FILE ("service-declaration.galgas", 284)).add_operation (GALGAS_string (", "), inCompiler COMMA_SOURCE_FILE ("service-declaration.galgas", 284)).add_operation (var_llvmType, inCompiler COMMA_SOURCE_FILE ("service-declaration.galgas", 284)).add_operation (GALGAS_string ("* %"), inCompiler COMMA_SOURCE_FILE ("service-declaration.galgas", 284)).add_operation (enumerator_11155.current_mFormalArgumentName (HERE), inCompiler COMMA_SOURCE_FILE ("service-declaration.galgas", 284)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("service-declaration.galgas", 284)), inCompiler  COMMA_SOURCE_FILE ("service-declaration.galgas", 284)) ;
      }
      break ;
    case GALGAS_procFormalArgumentPassingMode::kEnum_output:
    case GALGAS_procFormalArgumentPassingMode::kEnum_inputOutput:
  ...
  categoryMethod_instructionListLLVMCode (inObject.mAttribute_mInstructionGenerationList, ioArgument_ioLLVMcode, constinArgument_inGenerationContext, ioArgument_ioGenerationAdds, inCompiler COMMA_SOURCE_FILE ("service-declaration.galgas", 289)) ;
  ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  ret void\n"), inCompiler  COMMA_SOURCE_FILE ("service-declaration.galgas", 291)) ;
  ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("}\n"
    "\n"), inCompiler  COMMA_SOURCE_FILE ("service-declaration.galgas", 292)) ;
}
...
static void categoryMethod_structureDeclaration_semanticAnalysis (const cPtr_abstractDeclaration * inObject,
  ...
  cEnumerator_procedureDeclarationListAST enumerator_11492 (object->mAttribute_mProcedureDeclarationListAST, kEnumeration_up) ;
  while (enumerator_11492.hasCurrentObject ()) {
    GALGAS_lstring var_procNameForInvocationGraph = function_procNameForInvocationGraph (var_structureType, enumerator_11492.current (HERE).mAttribute_mProcedureName, inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 294)) ;
    ...
    if (kBoolTrue == test_0) {
      {
      ioArgument_ioTemporaries.mAttribute_mSubprogramInvocationGraph.setter_addNode (var_procNameForInvocationGraph, enumerator_11492.current (HERE).mAttribute_mProcedureName, inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 296)) ;
      }
    }
    ...
    cEnumerator_lstringlist enumerator_11996 (enumerator_11492.current (HERE).mAttribute_mProcedureModeList, kEnumeration_up) ;
    while (enumerator_11996.hasCurrentObject ()) {
      constinArgument_inContext.mAttribute_mModeMap.method_searchKey (enumerator_11996.current (HERE).mAttribute_mValue, inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 304)) ;
      var_procedureModeSet.addAssign_operation (enumerator_11996.current (HERE).mAttribute_mValue.mAttribute_string  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 305)) ;
      enumerator_11996.gotoNextObject () ;
    }
    GALGAS_variableMap var_variableMap = function_initialVariableMap (function_procNameForInvocationGraph (var_structureType, enumerator_11492.current (HERE).mAttribute_mProcedureName, inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 309)).mAttribute_string, constinArgument_inContext, var_procedureModeSet.getter_hasKey (GALGAS_string ("user") COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 311)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 308)) ;
    const enumGalgasBool test_1 = enumerator_11492.current (HERE).mAttribute_mMutating.boolEnum () ;
    if (kBoolTrue == test_1) {
      {
    ...
    {
    routine_enterFormalArguments (constinArgument_inContext, enumerator_11492.current (HERE).mAttribute_mProcFormalArgumentList, var_variableMap, var_formalArguments, inCompiler  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 341)) ;
    }
    ...
    categoryMethod_analyzeRoutineInstructionList (enumerator_11492.current (HERE).mAttribute_mInstructionList, var_procNameForInvocationGraph, constinArgument_inContext, var_procedureModeSet, var_procedureModeSet.getter_hasKey (function_panicModeName (inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 353)) COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 353)).operator_not (SOURCE_FILE ("type-structure-declaration.galgas", 353)), ioArgument_ioTemporaries, ioArgument_ioIntermediateCodeStruct.mAttribute_mStaticStringMap, var_variableMap, var_instructionGenerationList, inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 349)) ;
    var_variableMap.method_checkAutomatonStates (enumerator_11492.current (HERE).mAttribute_mEndOfProcLocation, inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 359)) ;
    GALGAS_bool var_warnIfUnused = GALGAS_bool (true) ;
    cEnumerator_lstringlist enumerator_14145 (enumerator_11492.current (HERE).mAttribute_mProcedureAttributeList, kEnumeration_up) ;
    while (enumerator_14145.hasCurrentObject ()) {
      const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, enumerator_14145.current_mValue (HERE).mAttribute_string.objectCompare (function_noWarningIfUnusedAttribute (inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 363)))).boolEnum () ;
      if (kBoolTrue == test_2) {
        const enumGalgasBool test_3 = var_warnIfUnused.operator_not (SOURCE_FILE ("type-structure-declaration.galgas", 364)).boolEnum () ;
        if (kBoolTrue == test_3) {
          GALGAS_location location_4 (enumerator_14145.current_mValue (HERE).getter_location (HERE)) ; // Implicit use of 'location' getter
        ...
        GALGAS_location location_5 (enumerator_14145.current_mValue (HERE).getter_location (HERE)) ; // Implicit use of 'location' getter
    ...
    {
    ioArgument_ioIntermediateCodeStruct.mAttribute_mProcedureMapIR.setter_insertKey (GALGAS_lstring::constructor_new (object->mAttribute_mStructureName.mAttribute_string.add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 374)).add_operation (enumerator_11492.current (HERE).mAttribute_mProcedureName.getter_string (SOURCE_FILE ("type-structure-declaration.galgas", 374)), inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 374)), enumerator_11492.current (HERE).mAttribute_mProcedureName.mAttribute_location  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 374)), var_formalArguments, var_instructionGenerationList, GALGAS_bool (false), var_warnIfUnused, GALGAS_bool (false), GALGAS_bool (false), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 373)) ;
    }
    enumerator_11492.gotoNextObject () ;
  }
  cEnumerator_functionDeclarationListAST enumerator_14887 (object->mAttribute_mFunctionDeclarationListAST, kEnumeration_up) ;
  while (enumerator_14887.hasCurrentObject ()) {
    ...
    cEnumerator_lstringlist enumerator_14988 (enumerator_14887.current (HERE).mAttribute_mFunctionModeList, kEnumeration_up) ;
    while (enumerator_14988.hasCurrentObject ()) {
      constinArgument_inContext.mAttribute_mModeMap.method_searchKey (enumerator_14988.current (HERE).mAttribute_mValue, inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 389)) ;
      var_functionModeSet.addAssign_operation (enumerator_14988.current (HERE).mAttribute_mValue.mAttribute_string  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 390)) ;
      enumerator_14988.gotoNextObject () ;
    }
    GALGAS_bool var_warnIfUnused = GALGAS_bool (true) ;
    cEnumerator_lstringlist enumerator_15203 (enumerator_14887.current (HERE).mAttribute_mFunctionAttributeList, kEnumeration_up) ;
    while (enumerator_15203.hasCurrentObject ()) {
      const enumGalgasBool test_6 = GALGAS_bool (kIsEqual, enumerator_15203.current_mValue (HERE).mAttribute_string.objectCompare (function_noWarningIfUnusedAttribute (inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 395)))).boolEnum () ;
      if (kBoolTrue == test_6) {
        const enumGalgasBool test_7 = var_warnIfUnused.operator_not (SOURCE_FILE ("type-structure-declaration.galgas", 396)).boolEnum () ;
        if (kBoolTrue == test_7) {
          GALGAS_location location_8 (enumerator_15203.current_mValue (HERE).getter_location (HERE)) ; // Implicit use of 'location' getter
        ...
        GALGAS_location location_9 (enumerator_15203.current_mValue (HERE).getter_location (HERE)) ; // Implicit use of 'location' getter
    ...
    GALGAS_variableMap var_variableMap = function_initialVariableMap (function_funcNameForInvocationGraph (var_structureType, enumerator_14887.current (HERE).mAttribute_mFunctionName, inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 406)).mAttribute_string, constinArgument_inContext, var_functionModeSet.getter_hasKey (GALGAS_string ("user") COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 408)), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 405)) ;
    {
    ...
    GALGAS_lstring var_resultVarName = GALGAS_lstring::constructor_new (GALGAS_string ("result"), enumerator_14887.current (HERE).mAttribute_mResultTypeName.mAttribute_location  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 423)) ;
    GALGAS_unifiedTypeMap_2D_proxy var_resultType = GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inContext.mAttribute_mTypeMap, enumerator_14887.current (HERE).mAttribute_mResultTypeName, inCompiler  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 424)) ;
    {
    ...
    cEnumerator_funcFormalArgumentList enumerator_16820 (enumerator_14887.current (HERE).mAttribute_mFuncFormalArgumentList, kEnumeration_up) ;
    while (enumerator_16820.hasCurrentObject ()) {
      GALGAS_unifiedTypeMap_2D_proxy var_typeProxy = GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inContext.mAttribute_mTypeMap, enumerator_16820.current_mFormalArgumentTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 439)) ;
      {
      var_variableMap.setter_insertConstantInputFormalArgument (enumerator_16820.current_mFormalArgumentName (HERE), var_typeProxy, GALGAS_bool (true), GALGAS_objectInMemoryIR::constructor_localValue (var_typeProxy, enumerator_16820.current_mFormalArgumentName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 444)), var_typeProxy.getter_copiable (inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 445)), GALGAS_controlRegisterBitSliceAccessMap::constructor_emptyMap (SOURCE_FILE ("type-structure-declaration.galgas", 446)), GALGAS_bool (false), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 440)) ;
      }
      var_formalArguments.addAssign_operation (GALGAS_procFormalArgumentPassingMode::constructor_input (SOURCE_FILE ("type-structure-declaration.galgas", 450)), var_typeProxy, function_llvmNameForLocalVariable (enumerator_16820.current_mFormalArgumentName (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 450))  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 450)) ;
      enumerator_16820.gotoNextObject () ;
    }
    GALGAS_lstring var_routineNameForInvocationGraph = function_funcNameForInvocationGraph (var_structureType, enumerator_14887.current (HERE).mAttribute_mFunctionName, inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 453)) ;
...
static GALGAS_string extensionGetter_opaqueTypeDeclaration_keyRepresentationForErrorSignaling (const cPtr_abstractDeclaration * inObject,
  ...
  const cPtr_opaqueTypeDeclaration * object = (const cPtr_opaqueTypeDeclaration *) inObject ;
  macroValidSharedObject (object, cPtr_opaqueTypeDeclaration) ;
  result_outRepresentation = GALGAS_string ("opaqueType $").add_operation (object->mAttribute_mOpaqueTypeName.getter_string (SOURCE_FILE ("type-opaque-declaration.galgas", 61)), inCompiler COMMA_SOURCE_FILE ("type-opaque-declaration.galgas", 61)) ;
//---
  return result_outRepresentation ;
}
...
static void categoryMethod_opaqueTypeDeclaration_enterInContext (const cPtr_abstractDeclaration * inObject,
  ...
  const cPtr_opaqueTypeDeclaration * object = (const cPtr_opaqueTypeDeclaration *) inObject ;
  macroValidSharedObject (object, cPtr_opaqueTypeDeclaration) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, object->mAttribute_mSize.mAttribute_bigint.objectCompare (GALGAS_bigint ("0", inCompiler  COMMA_SOURCE_FILE ("type-opaque-declaration.galgas", 74)))).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mSize.getter_location (HERE)) ; // Implicit use of 'location' getter
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the opaque type size should be > 0")  COMMA_SOURCE_FILE ("type-opaque-declaration.galgas", 75)) ;
  }
  {
  ioArgument_ioContext.mAttribute_mTypeMap.setter_insertKey (object->mAttribute_mOpaqueTypeName, GALGAS_string ("i").add_operation (object->mAttribute_mSize.mAttribute_bigint.getter_string (SOURCE_FILE ("type-opaque-declaration.galgas", 79)), inCompiler COMMA_SOURCE_FILE ("type-opaque-declaration.galgas", 79)), GALGAS_typeKind::constructor_opaque (SOURCE_FILE ("type-opaque-declaration.galgas", 80)), GALGAS_typedConstantMap::constructor_emptyMap (SOURCE_FILE ("type-opaque-declaration.galgas", 81)), GALGAS_procedureMap::constructor_emptyMap (SOURCE_FILE ("type-opaque-declaration.galgas", 82)), GALGAS_functionMap::constructor_emptyMap (SOURCE_FILE ("type-opaque-declaration.galgas", 83)), GALGAS_bool (false), GALGAS_bool (false), GALGAS_bool (false), GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("type-opaque-declaration.galgas", 87)), inCompiler COMMA_SOURCE_FILE ("type-opaque-declaration.galgas", 77)) ;
  }
}
//---------------------------------------------------------------------------------------------------------------------*
