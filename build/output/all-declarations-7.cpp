...
static void categoryMethod_functionCallInExpressionAST_analyzeExpression (const cPtr_expressionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    while (enumerator_3918.hasCurrentObject () && enumerator_3944.hasCurrentObject ()) {
      ...
      var_argumentList.addAssign_operation (var_argumentIR  COMMA_SOURCE_FILE ("expression-func-call.galgas", 110)) ;
      const enumGalgasBool test_5 = GALGAS_bool (kIsNotEqual, var_argumentIR.mAttribute_mType.getter_key (inCompiler COMMA_SOURCE_FILE ("expression-func-call.galgas", 111)).objectCompare (enumerator_3918.current (HERE).mAttribute_mArgumentType.getter_key (inCompiler COMMA_SOURCE_FILE ("expression-func-call.galgas", 111)))).boolEnum () ;
      if (kBoolTrue == test_5) {
        GALGAS_location location_6 (enumerator_3944.current (HERE).mAttribute_mSelector.getter_location (HERE)) ; // Implicit use of 'location' getter
        inCompiler->emitSemanticError (location_6, GALGAS_string ("the actual parameter has the ").add_operation (var_argumentIR.mAttribute_mType.getter_key (inCompiler COMMA_SOURCE_FILE ("expression-func-call.galgas", 112)), inCompiler COMMA_SOURCE_FILE ("expression-func-call.galgas", 112)).add_operation (GALGAS_string (", but the formal argument has the "), inCompiler COMMA_SOURCE_FILE ("expression-func-call.galgas", 112)).add_operation (enumerator_3918.current (HERE).mAttribute_mArgumentType.getter_key (inCompiler COMMA_SOURCE_FILE ("expression-func-call.galgas", 113)), inCompiler COMMA_SOURCE_FILE ("expression-func-call.galgas", 113)).add_operation (GALGAS_string (" type"), inCompiler COMMA_SOURCE_FILE ("expression-func-call.galgas", 113))  COMMA_SOURCE_FILE ("expression-func-call.galgas", 112)) ;
      }
      if (enumerator_3918.hasNextObject () && enumerator_3944.hasNextObject ()) {
        var_s.plusAssign_operation(GALGAS_string (", "), inCompiler  COMMA_SOURCE_FILE ("expression-func-call.galgas", 116)) ;
      }
      enumerator_3918.gotoNextObject () ;
      enumerator_3944.gotoNextObject () ;
    }
  }
  var_s.plusAssign_operation(GALGAS_string (")"), inCompiler  COMMA_SOURCE_FILE ("expression-func-call.galgas", 119)) ;
  {
  routine_getNewTempVariable (var_functionResultType, ioArgument_ioTemporaries, outArgument_outResult, inCompiler  COMMA_SOURCE_FILE ("expression-func-call.galgas", 121)) ;
  }
  ioArgument_ioInstructionGenerationList.addAssign_operation (GALGAS_functionCallIR::constructor_new (outArgument_outResult, object->mAttribute_mFunctionVarName.mAttribute_string, var_argumentList  COMMA_SOURCE_FILE ("expression-func-call.galgas", 123))  COMMA_SOURCE_FILE ("expression-func-call.galgas", 123)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_functionCallIR_llvmInstructionCode (const cPtr_abstractInstructionIR * inObject,
  ...
  ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  ").add_operation (extensionGetter_string (object->mAttribute_mResult.mAttribute_mValue, inCompiler COMMA_SOURCE_FILE ("expression-func-call.galgas", 145)), inCompiler COMMA_SOURCE_FILE ("expression-func-call.galgas", 145)).add_operation (GALGAS_string (" = call "), inCompiler COMMA_SOURCE_FILE ("expression-func-call.galgas", 145)).add_operation (extensionGetter_llvmTypeName (object->mAttribute_mResult.mAttribute_mType, inCompiler COMMA_SOURCE_FILE ("expression-func-call.galgas", 145)), inCompiler COMMA_SOURCE_FILE ("expression-func-call.galgas", 145)), inCompiler  COMMA_SOURCE_FILE ("expression-func-call.galgas", 145)) ;
  ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string (" @").add_operation (function_mangledNameForFunction (object->mAttribute_mFunctionName, inCompiler COMMA_SOURCE_FILE ("expression-func-call.galgas", 146)), inCompiler COMMA_SOURCE_FILE ("expression-func-call.galgas", 146)).add_operation (GALGAS_string (" ("), inCompiler COMMA_SOURCE_FILE ("expression-func-call.galgas", 146)), inCompiler  COMMA_SOURCE_FILE ("expression-func-call.galgas", 146)) ;
  cEnumerator_operandIRlist enumerator_6057 (object->mAttribute_mArgumentList, kEnumeration_up) ;
  while (enumerator_6057.hasCurrentObject ()) {
    ioArgument_ioLLVMcode.plusAssign_operation(extensionGetter_llvmTypeName (enumerator_6057.current_mOperand (HERE).mAttribute_mType, inCompiler COMMA_SOURCE_FILE ("expression-func-call.galgas", 148)).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("expression-func-call.galgas", 148)).add_operation (extensionGetter_string (enumerator_6057.current_mOperand (HERE).mAttribute_mValue, inCompiler COMMA_SOURCE_FILE ("expression-func-call.galgas", 148)), inCompiler COMMA_SOURCE_FILE ("expression-func-call.galgas", 148)), inCompiler  COMMA_SOURCE_FILE ("expression-func-call.galgas", 148)) ;
    if (enumerator_6057.hasNextObject ()) {
      ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string (", "), inCompiler  COMMA_SOURCE_FILE ("expression-func-call.galgas", 149)) ;
    }
    enumerator_6057.gotoNextObject () ;
  }
  ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string (")\n"), inCompiler  COMMA_SOURCE_FILE ("expression-func-call.galgas", 151)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_functionCallIR_enterAccessibleEntities (const cPtr_abstractInstructionIR * inObject,
  ...
  const cPtr_functionCallIR * object = (const cPtr_functionCallIR *) inObject ;
  macroValidSharedObject (object, cPtr_functionCallIR) ;
  ioArgument_ioAccessibleEntities.mAttribute_mFunctionSet.addAssign_operation (object->mAttribute_mFunctionName  COMMA_SOURCE_FILE ("expression-func-call.galgas", 157)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
