...
//--------------------------------- GALGAS constructors
  ...
  public : static class GALGAS_getElementPtrIndexKind constructor_indirect (const class GALGAS_objectIR & inOperand0
                                                                            COMMA_LOCATION_ARGS) ;
...
//--------------------------------- Instance Methods
  ...
  public : VIRTUAL_IN_DEBUG void method_indirect (class GALGAS_objectIR & outArgument0,
                                                  C_Compiler * inCompiler
                                                  COMMA_LOCATION_ARGS) const ;
...
//--- Constructor
  public : cEnumAssociatedValues_getElementPtrIndexKind_indirect (const GALGAS_objectIR & inAssociatedValue0
                                                                  COMMA_LOCATION_ARGS) ;
