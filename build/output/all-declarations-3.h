...
class GALGAS_scopeHandler : public AC_GALGAS_root {
//--------------------------------- Public data members
...
//--------------------------------- Default GALGAS constructor
  public : static GALGAS_scopeHandler constructor_default (LOCATION_ARGS) ;

//--------------------------------- Default constructor
  public : GALGAS_scopeHandler (void) ;

//--------------------------------- Virtual destructor (in debug mode)
  public : VIRTUAL_IN_DEBUG ~ GALGAS_scopeHandler (void) ;

//--------------------------------- Native constructor
  public : GALGAS_scopeHandler (const GALGAS_scopeStack & in_mScopeStack) ;
...
//--------------------------------- Object extraction
  public : static GALGAS_scopeHandler extractObject (const GALGAS_object & inObject,
                                                     C_Compiler * inCompiler
                                                     COMMA_LOCATION_ARGS) ;

//--------------------------------- GALGAS constructors
  public : static class GALGAS_scopeHandler constructor_new (const class GALGAS_scopeStack & inOperand0
                                                             COMMA_LOCATION_ARGS) ;
...
//--------------------------------- Implementation of getter 'description'
  public : VIRTUAL_IN_DEBUG void description (C_String & ioString,
                                              const int32_t inIndentation) const ;
//--------------------------------- Comparison
  public : typeComparisonResult objectCompare (const GALGAS_scopeHandler & inOperand) const ;
...
} ; // End of GALGAS_scopeHandler class


//---------------------------------------------------------------------------------------------------------------------*

extern const C_galgas_type_descriptor kTypeDescriptor_GALGAS_scopeHandler ;
