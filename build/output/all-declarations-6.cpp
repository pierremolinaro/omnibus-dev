...
void extensionMethod_generateLLVMcode (const GALGAS_controlRegisterGroupArrayList inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    test_0 = GALGAS_bool (kIsStrictSup, temp_1.getter_length (SOURCE_FILE ("declaration-control-register.galgas", 632)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_0) {
      ioArgument_ioLLVMcode.plusAssign_operation(function_llvmTitleComment (GALGAS_string ("Control Register Group Arraies"), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 633)), inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 633)) ;
      GALGAS_string var_int_25635 = GALGAS_string ("i").add_operation (constinArgument_inPointerSize.getter_string (SOURCE_FILE ("declaration-control-register.galgas", 634)), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 634)) ;
      const GALGAS_controlRegisterGroupArrayList temp_2 = inObject ;
      cEnumerator_controlRegisterGroupArrayList enumerator_25699 (temp_2, kENUMERATION_UP) ;
      while (enumerator_25699.hasCurrentObject ()) {
        ioArgument_ioLLVMcode.plusAssign_operation(function_registerGroupAddressArrayLLVMname (enumerator_25699.current_mGroupName (HERE).getter_string (SOURCE_FILE ("declaration-control-register.galgas", 636)), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 636)).add_operation (GALGAS_string (" = private unnamed_addr constant ["), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 636)).add_operation (enumerator_25699.current_mBaseAddresses (HERE).getter_length (SOURCE_FILE ("declaration-control-register.galgas", 637)).getter_string (SOURCE_FILE ("declaration-control-register.galgas", 637)), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 637)).add_operation (GALGAS_string (" x "), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 637)).add_operation (var_int_25635, inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 637)).add_operation (GALGAS_string ("] ["), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 637)), inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 636)) ;
        cEnumerator_lbigintlist enumerator_25906 (enumerator_25699.current_mBaseAddresses (HERE), kENUMERATION_UP) ;
        while (enumerator_25906.hasCurrentObject ()) {
          ioArgument_ioLLVMcode.plusAssign_operation(var_int_25635.add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 640)).add_operation (enumerator_25906.current_mValue (HERE).getter_bigint (HERE).getter_string (SOURCE_FILE ("declaration-control-register.galgas", 640)), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 640)), inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 640)) ;
          if (enumerator_25906.hasNextObject ()) {
        ...
        ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("] ; "), inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 644)) ;
        cEnumerator_lbigintlist enumerator_26082 (enumerator_25699.current_mBaseAddresses (HERE), kENUMERATION_UP) ;
        while (enumerator_26082.hasCurrentObject ()) {
          ioArgument_ioLLVMcode.plusAssign_operation(enumerator_26082.current_mValue (HERE).getter_bigint (HERE).getter_hexString (SOURCE_FILE ("declaration-control-register.galgas", 647)), inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 647)) ;
          if (enumerator_26082.hasNextObject ()) {
        ...
        ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("\n"), inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 651)) ;
        enumerator_25699.gotoNextObject () ;
      }
