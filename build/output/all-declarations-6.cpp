...
static void extensionMethod_structureDeclarationAST_functionSemanticAnalysis (const cPtr_structureDeclarationAST * inObject,
  ...
  cEnumerator_functionDeclarationListAST enumerator_20011 (object->mProperty_mFunctionDeclarationListAST, kENUMERATION_UP) ;
  while (enumerator_20011.hasCurrentObject ()) {
    GALGAS_bool var_warnIfUnused_20035 = GALGAS_bool (true) ;
    GALGAS_bool var_mutating_20059 = GALGAS_bool (false) ;
    GALGAS_bool var_accessProperties_20092 = GALGAS_bool (false) ;
    cEnumerator_lstringlist enumerator_20155 (enumerator_20011.current (HERE).getter_mFunctionAttributeList (HERE), kENUMERATION_UP) ;
    while (enumerator_20155.hasCurrentObject ()) {
      const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, enumerator_20155.current_mValue (HERE).getter_string (HERE).objectCompare (function_noUnusedWarningAttribute (inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 537)))).boolEnum () ;
      if (kBoolTrue == test_0) {
        const enumGalgasBool test_1 = var_warnIfUnused_20035.operator_not (SOURCE_FILE ("type-structure-declaration.galgas", 538)).boolEnum () ;
        if (kBoolTrue == test_1) {
          TC_Array <C_FixItDescription> fixItArray2 ;
          inCompiler->emitSemanticError (enumerator_20155.current_mValue (HERE).getter_location (SOURCE_FILE ("type-structure-declaration.galgas", 539)), GALGAS_string ("duplicated @").add_operation (function_noUnusedWarningAttribute (inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 539)), inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 539)).add_operation (GALGAS_string (" attribute"), inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 539)), fixItArray2  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 539)) ;
        }
        var_warnIfUnused_20035 = GALGAS_bool (false) ;
      }else if (kBoolFalse == test_0) {
        const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, enumerator_20155.current_mValue (HERE).getter_string (HERE).objectCompare (function_userAccessAttribute (inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 542)))).boolEnum () ;
        if (kBoolTrue == test_3) {
          const enumGalgasBool test_4 = var_accessProperties_20092.boolEnum () ;
          if (kBoolTrue == test_4) {
            TC_Array <C_FixItDescription> fixItArray5 ;
            inCompiler->emitSemanticError (enumerator_20155.current_mValue (HERE).getter_location (SOURCE_FILE ("type-structure-declaration.galgas", 544)), GALGAS_string ("duplicated @").add_operation (function_userAccessAttribute (inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 544)), inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 544)).add_operation (GALGAS_string (" attribute"), inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 544)), fixItArray5  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 544)) ;
          }
          var_accessProperties_20092 = GALGAS_bool (true) ;
        }else if (kBoolFalse == test_3) {
          const enumGalgasBool test_6 = GALGAS_bool (kIsEqual, enumerator_20155.current_mValue (HERE).getter_string (HERE).objectCompare (function_mutatingAttribute (inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 547)))).boolEnum () ;
          if (kBoolTrue == test_6) {
            const enumGalgasBool test_7 = var_mutating_20059.boolEnum () ;
            if (kBoolTrue == test_7) {
              TC_Array <C_FixItDescription> fixItArray8 ;
              inCompiler->emitSemanticError (enumerator_20155.current_mValue (HERE).getter_location (SOURCE_FILE ("type-structure-declaration.galgas", 549)), GALGAS_string ("duplicated @").add_operation (function_mutatingAttribute (inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 549)), inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 549)).add_operation (GALGAS_string (" attribute"), inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 549)), fixItArray8  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 549)) ;
            }
            var_mutating_20059 = GALGAS_bool (true) ;
          }else if (kBoolFalse == test_6) {
            TC_Array <C_FixItDescription> fixItArray9 ;
            inCompiler->emitSemanticError (enumerator_20155.current_mValue (HERE).getter_location (SOURCE_FILE ("type-structure-declaration.galgas", 553)), GALGAS_string ("unknown attribute; available attributes are @").add_operation (function_noUnusedWarningAttribute (inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 553)), inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 553)).add_operation (GALGAS_string (", @"), inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 553)).add_operation (function_mutatingAttribute (inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 554)), inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 554)).add_operation (GALGAS_string (" and @"), inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 554)).add_operation (function_userAccessAttribute (inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 554)), inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 554)), fixItArray9  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 553)) ;
          }
        }
      }
      enumerator_20155.gotoNextObject () ;
    }
    var_accessProperties_20092 = GALGAS_bool (kIsNotEqual, enumerator_20011.current (HERE).getter_mMode (HERE).objectCompare (GALGAS_mode::constructor_userMode (SOURCE_FILE ("type-structure-declaration.galgas", 557)))) ;
    {
    routine_routineSemanticAnalysis (constinArgument_inStructureType, GALGAS_routineKind::constructor_function (enumerator_20011.current (HERE).getter_mMode (HERE)  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 560)), enumerator_20011.current (HERE).getter_mMode (HERE), enumerator_20011.current (HERE).getter_mFunctionName (HERE), enumerator_20011.current (HERE).getter_mFunctionFormalArgumentList (HERE), enumerator_20011.current (HERE).getter_mFunctionReturnTypeName (HERE), enumerator_20011.current (HERE).getter_mFunctionInstructionList (HERE), enumerator_20011.current (HERE).getter_mEndOfFunctionDeclaration (HERE), var_accessProperties_20092, var_mutating_20059, var_warnIfUnused_20035, GALGAS_bool (false), constinArgument_inContext, ioArgument_ioTemporaries, ioArgument_ioIntermediateCodeStruct, inCompiler  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 558)) ;
    }
...
static void extensionMethod_controlRegisterDeclarationAST_buildControlRegisterSliceMap (const cPtr_controlRegisterDeclarationAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    GALGAS_uint var_shiftCount_12304 = GALGAS_uint ((uint32_t) 0U) ;
    cEnumerator_controlRegisterBitSliceList enumerator_12346 (object->mProperty_mRegisterBitSliceList, kENUMERATION_DOWN) ;
    while (enumerator_12346.hasCurrentObject ()) {
      switch (enumerator_12346.current_mRegisterBitSlice (HERE).enumValue ()) {
      case GALGAS_controlRegisterBitSlice::kNotBuilt:
        break ;
      case GALGAS_controlRegisterBitSlice::kEnum_unusedBits:
        {
          const cEnumAssociatedValues_controlRegisterBitSlice_unusedBits * extractPtr_12541 = (const cEnumAssociatedValues_controlRegisterBitSlice_unusedBits *) (enumerator_12346.current_mRegisterBitSlice (HERE).unsafePointer ()) ;
          const GALGAS_lbigint extractedValue_count = extractPtr_12541->mAssociatedValue0 ;
          var_shiftCount_12304 = var_shiftCount_12304.add_operation (extractedValue_count.getter_bigint (HERE).getter_uint (inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 312)), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 312)) ;
      ...
      case GALGAS_controlRegisterBitSlice::kEnum_namedBit:
        {
          const cEnumAssociatedValues_controlRegisterBitSlice_namedBit * extractPtr_13522 = (const cEnumAssociatedValues_controlRegisterBitSlice_namedBit *) (enumerator_12346.current_mRegisterBitSlice (HERE).unsafePointer ()) ;
          const GALGAS_lstring extractedValue_name = extractPtr_13522->mAssociatedValue0 ;
          const GALGAS_lbigint extractedValue_count = extractPtr_13522->mAssociatedValue1 ;
          GALGAS_uint var_bitCount_12615 = extractedValue_count.getter_bigint (HERE).getter_uint (inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 315)) ;
          outArgument_outControlRegisterFieldList.addAssign_operation (var_bitCount_12615, extractedValue_name.getter_string (HERE)  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 316)) ;
          {
          outArgument_outRegisterFieldMap.setter_insertKey (extractedValue_name, var_shiftCount_12304, var_bitCount_12615, inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 317)) ;
          }
          GALGAS_sliceMap var_registerSubMap_12841 = GALGAS_sliceMap::constructor_emptyMap (SOURCE_FILE ("declaration-control-register.galgas", 322)) ;
          {
          var_registerSubMap_12841.setter_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("shifted"), extractedValue_name.getter_location (HERE)  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 325)), GALGAS_llvmBinaryOperation::constructor_lshr (SOURCE_FILE ("declaration-control-register.galgas", 326)), var_shiftCount_12304.getter_bigint (SOURCE_FILE ("declaration-control-register.galgas", 327)), GALGAS_sliceMap::constructor_emptyMap (SOURCE_FILE ("declaration-control-register.galgas", 328)), ioArgument_ioRegisterType, inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 324)) ;
          }
          {
          var_registerSubMap_12841.setter_insertKey (GALGAS_lstring::constructor_new (function_boolTypeName (inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 333)), extractedValue_name.getter_location (HERE)  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 333)), GALGAS_llvmBinaryOperation::constructor_icmp_5F_ne (SOURCE_FILE ("declaration-control-register.galgas", 334)), GALGAS_bigint ("0", inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 335)), GALGAS_sliceMap::constructor_emptyMap (SOURCE_FILE ("declaration-control-register.galgas", 336)), GALGAS_PLMType::constructor_boolean (SOURCE_FILE ("declaration-control-register.galgas", 337)), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 332)) ;
          }
          GALGAS_bigint var_mask_13285 = GALGAS_bigint ("1", inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 340)).left_shift_operation (var_bitCount_12615 COMMA_SOURCE_FILE ("declaration-control-register.galgas", 340)).substract_operation (GALGAS_bigint ("1", inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 340)), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 340)).left_shift_operation (var_shiftCount_12304 COMMA_SOURCE_FILE ("declaration-control-register.galgas", 340)) ;
          {
          outArgument_outRegisterBitSliceMap.setter_insertKey (extractedValue_name, GALGAS_llvmBinaryOperation::constructor_and (SOURCE_FILE ("declaration-control-register.galgas", 343)), var_mask_13285, var_registerSubMap_12841, ioArgument_ioRegisterType, inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 341)) ;
          }
          var_shiftCount_12304 = var_shiftCount_12304.add_operation (var_bitCount_12615, inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 348)) ;
        }
        break ;
      }
      enumerator_12346.gotoNextObject () ;
    }
    const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, constinArgument_inRegisterBitCount.objectCompare (var_shiftCount_12304)).boolEnum () ;
    if (kBoolTrue == test_1) {
      TC_Array <C_FixItDescription> fixItArray2 ;
      inCompiler->emitSemanticError (object->mProperty_mRegisterBitSliceListLocation, GALGAS_string ("total bit slice count is ").add_operation (var_shiftCount_12304.getter_string (SOURCE_FILE ("declaration-control-register.galgas", 354)), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 354)).add_operation (GALGAS_string (" (should be "), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 354)).add_operation (constinArgument_inRegisterBitCount.getter_string (SOURCE_FILE ("declaration-control-register.galgas", 354)), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 354)).add_operation (GALGAS_string (")"), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 354)), fixItArray2  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 353)) ;
    }
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
void extensionMethod_semanticAnalysis (const GALGAS_globalVarDeclarationList_2D_element inObject,
                                       ...
                                       C_Compiler * inCompiler
                                       COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_PLMType var_inferredType_13317 ;
  GALGAS_stringset var_executionModeSet_13360 ;
  GALGAS_allowedGuardMap var_allowedGuardMap_13463 ;
  GALGAS_objectIR var_expressionGeneratedCode_13602 ;
  GALGAS_bool var_isConstant_13640 ;
  GALGAS_bool joker_13665 ; // Joker input parameter
  constinArgument_inContext.getter_mGlobalVariableMap (HERE).method_searchKey (inObject.mProperty_mVarName, var_inferredType_13317, var_executionModeSet_13360, var_allowedGuardMap_13463, var_expressionGeneratedCode_13602, var_isConstant_13640, joker_13665, inCompiler COMMA_SOURCE_FILE ("declaration-global-variable.galgas", 370)) ;
  {
  ioArgument_ioIntermediateCodeStruct.mProperty_mGlobalVariableMap.setter_insertKey (inObject.mProperty_mVarName, var_inferredType_13317, GALGAS_bool (kIsStrictSup, var_executionModeSet_13360.getter_count (SOURCE_FILE ("declaration-global-variable.galgas", 385)).objectCompare (GALGAS_uint ((uint32_t) 1U))), var_expressionGeneratedCode_13602, inCompiler COMMA_SOURCE_FILE ("declaration-global-variable.galgas", 382)) ;
  }
}
...
void extensionMethod_panicSemanticAnalysis (const GALGAS_panicClauseListAST_2D_element inObject,
  ...
  callExtensionMethod_checkLocalVariableFinalState ((const cPtr_universalValuedObjectMapForContext *) var_universalMap_4855.ptr (), inCompiler COMMA_SOURCE_FILE ("panic.galgas", 149)) ;
  ...
  if (kBoolTrue == test_3) {
    ...
    ioArgument_ioIntermediateCodeStruct.mProperty_mPanicSetupInstructionListIR.plusAssign_operation(var_instructionGenerationList_5796, inCompiler  COMMA_SOURCE_FILE ("panic.galgas", 155)) ;
  }else if (kBoolFalse == test_3) {
    {
    ...
    ioArgument_ioIntermediateCodeStruct.mProperty_mPanicLoopInstructionListIR.plusAssign_operation(var_instructionGenerationList_5796, inCompiler  COMMA_SOURCE_FILE ("panic.galgas", 158)) ;
  }
}
...
void extensionMethod_externProcedureSemanticAnalysis (const GALGAS_externProcedureDeclarationListAST_2D_element inObject,
  ...
  GALGAS_universalValuedObjectMapForContext var_universalMap_5589 ;
  {
  routine_initialVariableMap (constinArgument_inContext, inObject.mProperty_mMode, GALGAS_bool (false), GALGAS_string::makeEmptyString ().getter_nowhere (SOURCE_FILE ("declaration-extern-proc.galgas", 133)), var_universalMap_5589, inCompiler  COMMA_SOURCE_FILE ("declaration-extern-proc.galgas", 129)) ;
  }
  GALGAS_routineFormalArgumentListForGeneration var_formalArguments_5681 = GALGAS_routineFormalArgumentListForGeneration::constructor_emptyList (SOURCE_FILE ("declaration-extern-proc.galgas", 138)) ;
  {
  routine_enterFormalArguments (constinArgument_inContext, inObject.mProperty_mProcFormalArgumentList, var_universalMap_5589, var_formalArguments_5681, inCompiler  COMMA_SOURCE_FILE ("declaration-extern-proc.galgas", 139)) ;
  }
  ...
  GALGAS_unifiedTypeMap_2D_proxy var_returnType_6118 = temp_1 ;
  {
  ioArgument_ioIntermediateCodeStruct.mProperty_mExternProcedureMapIR.setter_insertKey (inObject.mProperty_mRoutineNameForGeneration, var_formalArguments_5681, var_returnType_6118, inCompiler COMMA_SOURCE_FILE ("declaration-extern-proc.galgas", 160)) ;
  }
}
...
void extensionMethod_enterAccessibleEntities (const GALGAS_interruptMapIR inObject,
  ...
  cEnumerator_interruptMapIR enumerator_5271 (temp_0, kENUMERATION_UP) ;
  while (enumerator_5271.hasCurrentObject ()) {
    extensionMethod_enterAccessibleEntities (enumerator_5271.current (HERE).getter_mInstructionGenerationList (HERE), ioArgument_ioAccessibleEntities, ioArgument_ioMaxBranchOfOnInstructions, inCompiler COMMA_SOURCE_FILE ("declaration-isr.galgas", 133)) ;
...
void extensionMethod_enterAccessibleEntities (const GALGAS_guardMapIR_2D_element inObject,
  ...
  case GALGAS_guardKindGenerationIR::kEnum_convenienceGuard:
    {
      const cEnumAssociatedValues_guardKindGenerationIR_convenienceGuard * extractPtr_26007 = (const cEnumAssociatedValues_guardKindGenerationIR_convenienceGuard *) (inObject.mProperty_mGuardKindGenerationIR.unsafePointer ()) ;
      const GALGAS_instructionListIR extractedValue_baseGuardInstructionGenerationList = extractPtr_26007->mAssociatedValue1 ;
      const GALGAS_string extractedValue_baseGuardMangledName = extractPtr_26007->mAssociatedValue2 ;
...
static void extensionMethod_primaryInExpressionAST_analyzePrimaryExpressionNoSelf (const cPtr_primaryInExpressionAST * inObject,
  ...
  GALGAS_valuedObject var_entity_8698 ;
  callExtensionMethod_searchEntity ((const cPtr_universalValuedObjectMapForContext *) ioArgument_ioUniversalMap.ptr (), object->mProperty_mReceiverName, var_entity_8698, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 208)) ;
  switch (var_entity_8698.enumValue ()) {
  case GALGAS_valuedObject::kNotBuilt:
    break ;
  case GALGAS_valuedObject::kEnum_module:
    {
      const cEnumAssociatedValues_valuedObject_module * extractPtr_9359 = (const cEnumAssociatedValues_valuedObject_module *) (var_entity_8698.unsafePointer ()) ;
      const GALGAS_PLMType extractedValue_type = extractPtr_9359->mAssociatedValue0 ;
  ...
  case GALGAS_valuedObject::kEnum_register:
    {
      const cEnumAssociatedValues_valuedObject_register * extractPtr_10260 = (const cEnumAssociatedValues_valuedObject_register *) (var_entity_8698.unsafePointer ()) ;
      const GALGAS_bool extractedValue_readable = extractPtr_10260->mAssociatedValue0 ;
      const GALGAS_PLMType extractedValue_type = extractPtr_10260->mAssociatedValue2 ;
      const GALGAS_bigint extractedValue_address = extractPtr_10260->mAssociatedValue3 ;
      const GALGAS_sliceMap extractedValue_sliceMap = extractPtr_10260->mAssociatedValue4 ;
      const GALGAS_uint extractedValue_arraySize = extractPtr_10260->mAssociatedValue5 ;
      const GALGAS_uint extractedValue_elementSize = extractPtr_10260->mAssociatedValue6 ;
  ...
  case GALGAS_valuedObject::kEnum_globalConstant:
    {
      const cEnumAssociatedValues_valuedObject_globalConstant * extractPtr_10841 = (const cEnumAssociatedValues_valuedObject_globalConstant *) (var_entity_8698.unsafePointer ()) ;
      const GALGAS_objectIR extractedValue_objectIR = extractPtr_10841->mAssociatedValue0 ;
  ...
  case GALGAS_valuedObject::kEnum_localConstant:
    {
      const cEnumAssociatedValues_valuedObject_localConstant * extractPtr_11543 = (const cEnumAssociatedValues_valuedObject_localConstant *) (var_entity_8698.unsafePointer ()) ;
      const GALGAS_PLMType extractedValue_type = extractPtr_11543->mAssociatedValue0 ;
      const GALGAS_lstring extractedValue_plmName = extractPtr_11543->mAssociatedValue1 ;
      {
      ioArgument_ioUniversalMap.insulate (HERE) ;
      cPtr_universalValuedObjectMapForContext * ptr_10919 = (cPtr_universalValuedObjectMapForContext *) ioArgument_ioUniversalMap.ptr () ;
      callExtensionSetter_readAccess ((cPtr_universalValuedObjectMapForContext *) ptr_10919, object->mProperty_mReceiverName, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 270)) ;
      }
  ...
  case GALGAS_valuedObject::kEnum_globalVariable:
    {
      const cEnumAssociatedValues_valuedObject_globalVariable * extractPtr_12239 = (const cEnumAssociatedValues_valuedObject_globalVariable *) (var_entity_8698.unsafePointer ()) ;
      const GALGAS_PLMType extractedValue_type = extractPtr_12239->mAssociatedValue1 ;
      {
      ioArgument_ioUniversalMap.insulate (HERE) ;
      cPtr_universalValuedObjectMapForContext * ptr_11607 = (cPtr_universalValuedObjectMapForContext *) ioArgument_ioUniversalMap.ptr () ;
      callExtensionSetter_readAccess ((cPtr_universalValuedObjectMapForContext *) ptr_11607, object->mProperty_mReceiverName, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 288)) ;
      }
  ...
  case GALGAS_valuedObject::kEnum_localVariable:
    {
      const cEnumAssociatedValues_valuedObject_localVariable * extractPtr_12942 = (const cEnumAssociatedValues_valuedObject_localVariable *) (var_entity_8698.unsafePointer ()) ;
      const GALGAS_PLMType extractedValue_type = extractPtr_12942->mAssociatedValue0 ;
      const GALGAS_lstring extractedValue_plmName = extractPtr_12942->mAssociatedValue1 ;
      ...
      {
      ioArgument_ioUniversalMap.insulate (HERE) ;
      cPtr_universalValuedObjectMapForContext * ptr_12404 = (cPtr_universalValuedObjectMapForContext *) ioArgument_ioUniversalMap.ptr () ;
      callExtensionSetter_readAccess ((cPtr_universalValuedObjectMapForContext *) ptr_12404, object->mProperty_mReceiverName, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 307)) ;
      }
      {
...
static void extensionMethod_primaryInExpressionAST_analyzePrimaryExpressionWithSelf (const cPtr_primaryInExpressionAST * inObject,
  ...
  cEnumerator_primaryInExpressionAccessListAST enumerator_20535 (object->mProperty_mAccessList, kENUMERATION_UP) ;
  while (enumerator_20535.hasCurrentObject ()) {
    switch (enumerator_20535.current_mAccess (HERE).enumValue ()) {
    case GALGAS_primaryInExpressionAccessAST::kNotBuilt:
      break ;
    case GALGAS_primaryInExpressionAccessAST::kEnum_property:
      {
        const cEnumAssociatedValues_primaryInExpressionAccessAST_property * extractPtr_21036 = (const cEnumAssociatedValues_primaryInExpressionAccessAST_property *) (enumerator_20535.current_mAccess (HERE).unsafePointer ()) ;
        const GALGAS_lstring extractedValue_propertyName = extractPtr_21036->mAssociatedValue0 ;
        {
    ...
    case GALGAS_primaryInExpressionAccessAST::kEnum_arrayAccess:
      {
        const cEnumAssociatedValues_primaryInExpressionAccessAST_arrayAccess * extractPtr_21656 = (const cEnumAssociatedValues_primaryInExpressionAccessAST_arrayAccess *) (enumerator_20535.current_mAccess (HERE).unsafePointer ()) ;
        const GALGAS_expressionAST extractedValue_indexExpression = extractPtr_21656->mAssociatedValue0 ;
        const GALGAS_location extractedValue_endOfIndex = extractPtr_21656->mAssociatedValue1 ;
        {
    ...
    case GALGAS_primaryInExpressionAccessAST::kEnum_funcCall:
      {
        const cEnumAssociatedValues_primaryInExpressionAccessAST_funcCall * extractPtr_22355 = (const cEnumAssociatedValues_primaryInExpressionAccessAST_funcCall *) (enumerator_20535.current_mAccess (HERE).unsafePointer ()) ;
        const GALGAS_lstring extractedValue_methodName = extractPtr_22355->mAssociatedValue0 ;
        const GALGAS_effectiveArgumentListAST extractedValue_arguments = extractPtr_22355->mAssociatedValue1 ;
        const GALGAS_location extractedValue_errorLocation = extractPtr_22355->mAssociatedValue2 ;
...
void extensionMethod_type (const GALGAS_LValueAST inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    callExtensionMethod_searchValuedObjectType ((const cPtr_universalValuedObjectMapForContext *) constinArgument_inUniversalMap.ptr (), inObject.mProperty_mIdentifier, outArgument_outType, inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 95)) ;
  }
  cEnumerator_accessInAssignmentListAST enumerator_3901 (inObject.mProperty_mAccessList, kENUMERATION_UP) ;
  while (enumerator_3901.hasCurrentObject ()) {
    switch (enumerator_3901.current_mAccess (HERE).enumValue ()) {
    case GALGAS_accessInAssignmentAST::kNotBuilt:
      break ;
    case GALGAS_accessInAssignmentAST::kEnum_property:
      {
        const cEnumAssociatedValues_accessInAssignmentAST_property * extractPtr_4360 = (const cEnumAssociatedValues_accessInAssignmentAST_property *) (enumerator_3901.current_mAccess (HERE).unsafePointer ()) ;
        const GALGAS_lstring extractedValue_propertyName = extractPtr_4360->mAssociatedValue0 ;
        GALGAS_propertyMap var_propertyMap_4001 = extensionGetter_propertyMap (outArgument_outType, inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 100)) ;
        GALGAS_propertyAccessKind var_accessKind_4087 ;
        GALGAS_bool joker_4070 ; // Joker input parameter
        var_propertyMap_4001.method_searchKey (extractedValue_propertyName, joker_4070, var_accessKind_4087, inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 101)) ;
        switch (var_accessKind_4087.enumValue ()) {
        case GALGAS_propertyAccessKind::kNotBuilt:
          break ;
        case GALGAS_propertyAccessKind::kEnum_constantProperty:
          {
            const cEnumAssociatedValues_propertyAccessKind_constantProperty * extractPtr_4181 = (const cEnumAssociatedValues_propertyAccessKind_constantProperty *) (var_accessKind_4087.unsafePointer ()) ;
            const GALGAS_objectIR extractedValue_value = extractPtr_4181->mAssociatedValue0 ;
            outArgument_outType = extensionGetter_type (extractedValue_value, inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 104)) ;
          }
          break ;
        case GALGAS_propertyAccessKind::kEnum_indexed:
          {
            const cEnumAssociatedValues_propertyAccessKind_indexed * extractPtr_4235 = (const cEnumAssociatedValues_propertyAccessKind_indexed *) (var_accessKind_4087.unsafePointer ()) ;
    ...
    case GALGAS_accessInAssignmentAST::kEnum_arrayAccess:
      {
        ...
        if (kBoolTrue == test_2) {
          GALGAS_lstring joker_4454_2 ; // Joker input parameter
          GALGAS_propertyMap joker_4454_1 ; // Joker input parameter
          GALGAS_bigint joker_4479_5 ; // Joker input parameter
          GALGAS_constantMap joker_4479_4 ; // Joker input parameter
          GALGAS_PLMTypeFlags joker_4479_3 ; // Joker input parameter
          GALGAS_string joker_4479_2 ; // Joker input parameter
          GALGAS_constructorMap joker_4479_1 ; // Joker input parameter
          outArgument_outType.method_arrayType (joker_4454_2, joker_4454_1, outArgument_outType, joker_4479_5, joker_4479_4, joker_4479_3, joker_4479_2, joker_4479_1, inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 112)) ;
        }
      }
      break ;
    }
...
void extensionMethod_analyzeLValue (const GALGAS_LValueAST inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    GALGAS_valuedObject var_entity_6029 ;
    callExtensionMethod_searchEntity ((const cPtr_universalValuedObjectMapForContext *) ioArgument_ioUniversalMap.ptr (), inObject.mProperty_mIdentifier, var_entity_6029, inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 153)) ;
    switch (var_entity_6029.enumValue ()) {
    case GALGAS_valuedObject::kNotBuilt:
      break ;
    case GALGAS_valuedObject::kEnum_module:
      {
        TC_Array <C_FixItDescription> fixItArray3 ;
        inCompiler->emitSemanticError (inObject.mProperty_mIdentifier.getter_location (SOURCE_FILE ("lvalue.galgas", 156)), GALGAS_string ("a module cannot be written"), fixItArray3  COMMA_SOURCE_FILE ("lvalue.galgas", 156)) ;
        outArgument_outInternalRepresentation.drop () ; // Release error dropped variable
      }
      break ;
    case GALGAS_valuedObject::kEnum_register:
      {
        const cEnumAssociatedValues_valuedObject_register * extractPtr_7122 = (const cEnumAssociatedValues_valuedObject_register *) (var_entity_6029.unsafePointer ()) ;
        const GALGAS_bool extractedValue_writable = extractPtr_7122->mAssociatedValue1 ;
        const GALGAS_PLMType extractedValue_registerType = extractPtr_7122->mAssociatedValue2 ;
        const GALGAS_bigint extractedValue_registerAddress = extractPtr_7122->mAssociatedValue3 ;
        const GALGAS_uint extractedValue_arraySize = extractPtr_7122->mAssociatedValue5 ;
        const GALGAS_uint extractedValue_elementSize = extractPtr_7122->mAssociatedValue6 ;
        const enumGalgasBool test_4 = extractedValue_writable.operator_not (SOURCE_FILE ("lvalue.galgas", 158)).boolEnum () ;
        if (kBoolTrue == test_4) {
          TC_Array <C_FixItDescription> fixItArray5 ;
          inCompiler->emitSemanticError (inObject.mProperty_mIdentifier.getter_location (SOURCE_FILE ("lvalue.galgas", 159)), GALGAS_string ("the control register is not writable in this context"), fixItArray5  COMMA_SOURCE_FILE ("lvalue.galgas", 159)) ;
          outArgument_outInternalRepresentation.drop () ; // Release error dropped variable
        }else if (kBoolFalse == test_4) {
          {
          routine_analyzeControlRegisterInLValue (constinArgument_inSelfType, constinArgument_inCallerNameForInvocationGraph, constinArgument_inContext, constinArgument_inCurrentMode, ioArgument_ioTemporaries, ioArgument_ioGlobalLiteralStringMap, ioArgument_ioUniversalMap, ioArgument_ioAllocaList, ioArgument_ioInstructionGenerationList, inObject.mProperty_mIdentifier, extractedValue_registerType, extractedValue_registerAddress.getter_uint (inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 173)), extractedValue_arraySize, extractedValue_elementSize, inObject.mProperty_mAccessList, outArgument_outInternalRepresentation, inCompiler  COMMA_SOURCE_FILE ("lvalue.galgas", 161)) ;
          }
        }
      }
      break ;
    case GALGAS_valuedObject::kEnum_globalConstant:
      {
        TC_Array <C_FixItDescription> fixItArray6 ;
        inCompiler->emitSemanticError (inObject.mProperty_mIdentifier.getter_location (SOURCE_FILE ("lvalue.galgas", 181)), GALGAS_string ("a global constant cannot be written"), fixItArray6  COMMA_SOURCE_FILE ("lvalue.galgas", 181)) ;
        outArgument_outInternalRepresentation.drop () ; // Release error dropped variable
      }
      break ;
    case GALGAS_valuedObject::kEnum_localConstant:
      {
        TC_Array <C_FixItDescription> fixItArray7 ;
        inCompiler->emitSemanticError (inObject.mProperty_mIdentifier.getter_location (SOURCE_FILE ("lvalue.galgas", 183)), GALGAS_string ("a local constant cannot be written"), fixItArray7  COMMA_SOURCE_FILE ("lvalue.galgas", 183)) ;
        outArgument_outInternalRepresentation.drop () ; // Release error dropped variable
      }
      break ;
    case GALGAS_valuedObject::kEnum_globalVariable:
      {
        const cEnumAssociatedValues_valuedObject_globalVariable * extractPtr_8301 = (const cEnumAssociatedValues_valuedObject_globalVariable *) (var_entity_6029.unsafePointer ()) ;
        const GALGAS_bool extractedValue_writable = extractPtr_8301->mAssociatedValue0 ;
        const GALGAS_PLMType extractedValue_variableType = extractPtr_8301->mAssociatedValue1 ;
        const enumGalgasBool test_8 = extractedValue_writable.operator_not (SOURCE_FILE ("lvalue.galgas", 185)).boolEnum () ;
        if (kBoolTrue == test_8) {
          TC_Array <C_FixItDescription> fixItArray9 ;
          inCompiler->emitSemanticError (inObject.mProperty_mIdentifier.getter_location (SOURCE_FILE ("lvalue.galgas", 186)), GALGAS_string ("a global variable cannot be written in this context"), fixItArray9  COMMA_SOURCE_FILE ("lvalue.galgas", 186)) ;
          outArgument_outInternalRepresentation.drop () ; // Release error dropped variable
        }else if (kBoolFalse == test_8) {
          {
          extensionSetter_appendNoteGlobalVariableAccess (ioArgument_ioInstructionGenerationList, inObject.mProperty_mIdentifier.getter_string (SOURCE_FILE ("lvalue.galgas", 188)), inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 188)) ;
          }
          {
          routine_analyzeVariableInLValue (constinArgument_inSelfType, constinArgument_inCallerNameForInvocationGraph, constinArgument_inContext, constinArgument_inCurrentMode, ioArgument_ioTemporaries, ioArgument_ioGlobalLiteralStringMap, ioArgument_ioUniversalMap, ioArgument_ioAllocaList, ioArgument_ioInstructionGenerationList, inObject.mProperty_mIdentifier, function_llvmNameForGlobalVariable (inObject.mProperty_mIdentifier.getter_string (SOURCE_FILE ("lvalue.galgas", 200)), inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 200)), extractedValue_variableType, inObject.mProperty_mAccessList, outArgument_outInternalRepresentation, inCompiler  COMMA_SOURCE_FILE ("lvalue.galgas", 189)) ;
          }
        }
      }
      break ;
    case GALGAS_valuedObject::kEnum_localVariable:
      {
        const cEnumAssociatedValues_valuedObject_localVariable * extractPtr_8959 = (const cEnumAssociatedValues_valuedObject_localVariable *) (var_entity_6029.unsafePointer ()) ;
        const GALGAS_PLMType extractedValue_variableType = extractPtr_8959->mAssociatedValue0 ;
        const GALGAS_lstring extractedValue_plmName = extractPtr_8959->mAssociatedValue1 ;
        {
        routine_analyzeVariableInLValue (constinArgument_inSelfType, constinArgument_inCallerNameForInvocationGraph, constinArgument_inContext, constinArgument_inCurrentMode, ioArgument_ioTemporaries, ioArgument_ioGlobalLiteralStringMap, ioArgument_ioUniversalMap, ioArgument_ioAllocaList, ioArgument_ioInstructionGenerationList, inObject.mProperty_mIdentifier, function_llvmNameForLocalVariable (extractedValue_plmName.getter_string (SOURCE_FILE ("lvalue.galgas", 218)), inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 218)), extractedValue_variableType, inObject.mProperty_mAccessList, outArgument_outInternalRepresentation, inCompiler  COMMA_SOURCE_FILE ("lvalue.galgas", 207)) ;
        }
      }
      break ;
    }
