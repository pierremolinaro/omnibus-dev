...
static void categoryMethod_convertInstructionIR_llvmInstructionCode (const cPtr_abstractInstructionIR * inObject,
  ...
  GALGAS_string var_lbl = object->mAttribute_mLocation.reader_locationIndex (inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 142)).reader_string (SOURCE_FILE ("expression-convert.galgas", 142)) ;
  ...
  object->mAttribute_mTarget.mAttribute_mType.reader_kind (inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 148)).method_integer (var_minTarget, var_maxTarget, joker_6695, joker_6707, inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 148)) ;
  GALGAS_bigint var_minSource ;
  ...
  object->mAttribute_mOperand.mAttribute_mType.reader_kind (inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 149)).method_integer (var_minSource, joker_6767, var_operandIsUnsigned, joker_6811, inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 149)) ;
  GALGAS_string var_operandType = categoryReader_llvmTypeName (object->mAttribute_mOperand.mAttribute_mType, inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 150)) ;
  ...
  if (kBoolTrue == test_0) {
    ...
    ioArgument_ioLLVMcode.dotAssign_operation (GALGAS_string (" ").add_operation (var_operandType, inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 154)).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 154)).add_operation (categoryReader_string (object->mAttribute_mOperand.mAttribute_mValue, inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 154)), inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 154)).add_operation (GALGAS_string (", "), inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 154)).add_operation (var_minTarget.reader_string (SOURCE_FILE ("expression-convert.galgas", 154)), inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 154)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 154))  COMMA_SOURCE_FILE ("expression-convert.galgas", 154)) ;
  ...
  ioArgument_ioLLVMcode.dotAssign_operation (GALGAS_string (" ").add_operation (var_operandType, inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 160)).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 160)).add_operation (categoryReader_string (object->mAttribute_mOperand.mAttribute_mValue, inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 160)), inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 160)).add_operation (GALGAS_string (", "), inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 160)).add_operation (var_maxTarget.reader_string (SOURCE_FILE ("expression-convert.galgas", 160)), inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 160)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 160))  COMMA_SOURCE_FILE ("expression-convert.galgas", 160)) ;
  ...
  ioArgument_ioLLVMcode.dotAssign_operation (GALGAS_string ("  %str.").add_operation (var_lbl, inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 163)).add_operation (GALGAS_string (" = load i8*, i8** "), inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 163)).add_operation (function_literalStringName (var_staticStringIndex, inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 163)), inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 163)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 163))  COMMA_SOURCE_FILE ("expression-convert.galgas", 163)) ;
  ioArgument_ioLLVMcode.dotAssign_operation (GALGAS_string ("  call void @raise_exception (")  COMMA_SOURCE_FILE ("expression-convert.galgas", 164)) ;
  ioArgument_ioLLVMcode.dotAssign_operation (constinArgument_inGenerationContext.mAttribute_mExceptionCodeLLVMType.add_operation (GALGAS_string (" 5, "), inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 165))  COMMA_SOURCE_FILE ("expression-convert.galgas", 165)) ;
  ioArgument_ioLLVMcode.dotAssign_operation (GALGAS_string ("i8* %str.").add_operation (var_lbl, inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 166)).add_operation (GALGAS_string (", "), inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 166))  COMMA_SOURCE_FILE ("expression-convert.galgas", 166)) ;
  ioArgument_ioLLVMcode.dotAssign_operation (constinArgument_inGenerationContext.mAttribute_mExceptionLineLLVMType.add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 167)).add_operation (object->mAttribute_mLocation.reader_line (inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 167)).reader_string (SOURCE_FILE ("expression-convert.galgas", 167)), inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 167)).add_operation (GALGAS_string (")\n"), inCompiler COMMA_SOURCE_FILE ("expression-convert.galgas", 167))  COMMA_SOURCE_FILE ("expression-convert.galgas", 167)) ;
