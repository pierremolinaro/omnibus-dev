...
void routine_codeOptimisation (GALGAS_intermediateCodeStruct & ioArgument_ioIntermediateCodeStruct,
                               C_Compiler * inCompiler
                               COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_routineMapIR var_initialProcedureMap_2642 = ioArgument_ioIntermediateCodeStruct.mAttribute_mRoutineMapIR ;
  GALGAS_guardMapIR var_initialGuardMap_2705 = ioArgument_ioIntermediateCodeStruct.mAttribute_mGuardMapIR ;
  GALGAS_uint var_pass_2757 = GALGAS_uint ((uint32_t) 0U) ;
  GALGAS_bool var_optimizing_2780 = GALGAS_bool (true) ;
  if (ioArgument_ioIntermediateCodeStruct.mAttribute_mRoutineMapIR.getter_count (SOURCE_FILE ("code-optimisation.galgas", 57)).add_operation (ioArgument_ioIntermediateCodeStruct.mAttribute_mGuardMapIR.getter_count (SOURCE_FILE ("code-optimisation.galgas", 57)), inCompiler COMMA_SOURCE_FILE ("code-optimisation.galgas", 57)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("code-optimisation.galgas", 57)).isValid ()) {
    uint32_t variant_2794 = ioArgument_ioIntermediateCodeStruct.mAttribute_mRoutineMapIR.getter_count (SOURCE_FILE ("code-optimisation.galgas", 57)).add_operation (ioArgument_ioIntermediateCodeStruct.mAttribute_mGuardMapIR.getter_count (SOURCE_FILE ("code-optimisation.galgas", 57)), inCompiler COMMA_SOURCE_FILE ("code-optimisation.galgas", 57)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("code-optimisation.galgas", 57)).uintValue () ;
    bool loop_2794 = true ;
    while (loop_2794) {
      loop_2794 = var_optimizing_2780.isValid () ;
      if (loop_2794) {
        loop_2794 = var_optimizing_2780.boolValue () ;
      }
      if (loop_2794 && (0 == variant_2794)) {
        loop_2794 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE ("code-optimisation.galgas", 57)) ;
      }
      if (loop_2794) {
        variant_2794 -- ;
        var_optimizing_2780 = GALGAS_bool (false) ;
        var_pass_2757.increment_operation (inCompiler  COMMA_SOURCE_FILE ("code-optimisation.galgas", 60)) ;
        ...
        if (kBoolTrue == test_0) {
          GALGAS_string var_s_3057 = GALGAS_string ("Optimisation pass ").add_operation (var_pass_2757.getter_string (SOURCE_FILE ("code-optimisation.galgas", 63)), inCompiler COMMA_SOURCE_FILE ("code-optimisation.galgas", 63)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("code-optimisation.galgas", 63)) ;
          var_s_3057.plusAssign_operation(GALGAS_string ("  ").add_operation (ioArgument_ioIntermediateCodeStruct.mAttribute_mControlRegisterMap.getter_count (SOURCE_FILE ("code-optimisation.galgas", 64)).getter_string (SOURCE_FILE ("code-optimisation.galgas", 64)), inCompiler COMMA_SOURCE_FILE ("code-optimisation.galgas", 64)).add_operation (GALGAS_string (" registers\n"), inCompiler COMMA_SOURCE_FILE ("code-optimisation.galgas", 64)), inCompiler  COMMA_SOURCE_FILE ("code-optimisation.galgas", 64)) ;
          var_s_3057.plusAssign_operation(GALGAS_string ("  ").add_operation (ioArgument_ioIntermediateCodeStruct.mAttribute_mStaticStringMap.getter_count (SOURCE_FILE ("code-optimisation.galgas", 65)).getter_string (SOURCE_FILE ("code-optimisation.galgas", 65)), inCompiler COMMA_SOURCE_FILE ("code-optimisation.galgas", 65)).add_operation (GALGAS_string (" static strings\n"), inCompiler COMMA_SOURCE_FILE ("code-optimisation.galgas", 65)), inCompiler  COMMA_SOURCE_FILE ("code-optimisation.galgas", 65)) ;
          var_s_3057.plusAssign_operation(GALGAS_string ("  ").add_operation (ioArgument_ioIntermediateCodeStruct.mAttribute_mGlobalConstantMap.getter_count (SOURCE_FILE ("code-optimisation.galgas", 66)).getter_string (SOURCE_FILE ("code-optimisation.galgas", 66)), inCompiler COMMA_SOURCE_FILE ("code-optimisation.galgas", 66)).add_operation (GALGAS_string (" global constants\n"), inCompiler COMMA_SOURCE_FILE ("code-optimisation.galgas", 66)), inCompiler  COMMA_SOURCE_FILE ("code-optimisation.galgas", 66)) ;
          var_s_3057.plusAssign_operation(GALGAS_string ("  ").add_operation (ioArgument_ioIntermediateCodeStruct.mAttribute_mGlobalVariableMap.getter_count (SOURCE_FILE ("code-optimisation.galgas", 67)).getter_string (SOURCE_FILE ("code-optimisation.galgas", 67)), inCompiler COMMA_SOURCE_FILE ("code-optimisation.galgas", 67)).add_operation (GALGAS_string (" global variables\n"), inCompiler COMMA_SOURCE_FILE ("code-optimisation.galgas", 67)), inCompiler  COMMA_SOURCE_FILE ("code-optimisation.galgas", 67)) ;
          var_s_3057.plusAssign_operation(GALGAS_string ("  ").add_operation (ioArgument_ioIntermediateCodeStruct.mAttribute_mRoutineMapIR.getter_count (SOURCE_FILE ("code-optimisation.galgas", 68)).getter_string (SOURCE_FILE ("code-optimisation.galgas", 68)), inCompiler COMMA_SOURCE_FILE ("code-optimisation.galgas", 68)).add_operation (GALGAS_string (" routines\n"), inCompiler COMMA_SOURCE_FILE ("code-optimisation.galgas", 68)), inCompiler  COMMA_SOURCE_FILE ("code-optimisation.galgas", 68)) ;
          var_s_3057.plusAssign_operation(GALGAS_string ("  ").add_operation (ioArgument_ioIntermediateCodeStruct.mAttribute_mGuardMapIR.getter_count (SOURCE_FILE ("code-optimisation.galgas", 69)).getter_string (SOURCE_FILE ("code-optimisation.galgas", 69)), inCompiler COMMA_SOURCE_FILE ("code-optimisation.galgas", 69)).add_operation (GALGAS_string (" guards\n"), inCompiler COMMA_SOURCE_FILE ("code-optimisation.galgas", 69)), inCompiler  COMMA_SOURCE_FILE ("code-optimisation.galgas", 69)) ;
          inCompiler->printMessage (var_s_3057  COMMA_SOURCE_FILE ("code-optimisation.galgas", 70)) ;
        }
        GALGAS_accessibleEntities var_accessibleEntities_3849 ;
        {
        routine_suppressInaccessibleSubprograms (ioArgument_ioIntermediateCodeStruct, var_accessibleEntities_3849, var_optimizing_2780, inCompiler  COMMA_SOURCE_FILE ("code-optimisation.galgas", 73)) ;
        }
        GALGAS_controlRegisterMapIR var_usedRegisterMap_3949 = GALGAS_controlRegisterMapIR::constructor_emptyMap (SOURCE_FILE ("code-optimisation.galgas", 79)) ;
        cEnumerator_controlRegisterMapIR enumerator_4075 (ioArgument_ioIntermediateCodeStruct.mAttribute_mControlRegisterMap, kEnumeration_up) ;
        while (enumerator_4075.hasCurrentObject ()) {
          const enumGalgasBool test_1 = var_accessibleEntities_3849.mAttribute_mAccessibleRegisterSet.getter_hasKey (enumerator_4075.current_lkey (HERE).mAttribute_string COMMA_SOURCE_FILE ("code-optimisation.galgas", 81)).boolEnum () ;
          if (kBoolTrue == test_1) {
            {
            var_usedRegisterMap_3949.setter_insertKey (enumerator_4075.current_lkey (HERE), enumerator_4075.current_mRegisterTypeName (HERE), enumerator_4075.current_mRegisterAddress (HERE), inCompiler COMMA_SOURCE_FILE ("code-optimisation.galgas", 82)) ;
            }
          }else if (kBoolFalse == test_1) {
            var_optimizing_2780 = GALGAS_bool (true) ;
          }
          enumerator_4075.gotoNextObject () ;
        }
        ioArgument_ioIntermediateCodeStruct.mAttribute_mControlRegisterMap = var_usedRegisterMap_3949 ;
        GALGAS_globalConstantMapIR var_globalConstantMap_4432 = GALGAS_globalConstantMapIR::constructor_emptyMap (SOURCE_FILE ("code-optimisation.galgas", 89)) ;
        cEnumerator_globalConstantMapIR enumerator_4501 (ioArgument_ioIntermediateCodeStruct.mAttribute_mGlobalConstantMap, kEnumeration_up) ;
        while (enumerator_4501.hasCurrentObject ()) {
          const enumGalgasBool test_2 = var_accessibleEntities_3849.mAttribute_mGlobalVariableSet.getter_hasKey (enumerator_4501.current (HERE).mAttribute_lkey.mAttribute_string COMMA_SOURCE_FILE ("code-optimisation.galgas", 91)).boolEnum () ;
          if (kBoolTrue == test_2) {
            {
            var_globalConstantMap_4432.setter_insertKey (enumerator_4501.current (HERE).mAttribute_lkey, enumerator_4501.current (HERE).mAttribute_mType, enumerator_4501.current (HERE).mAttribute_mSourceExpression, inCompiler COMMA_SOURCE_FILE ("code-optimisation.galgas", 92)) ;
            }
        ...
        ioArgument_ioIntermediateCodeStruct.mAttribute_mGlobalConstantMap = var_globalConstantMap_4432 ;
        GALGAS_globalVariableMapIR var_globalVariableMap_4892 = GALGAS_globalVariableMapIR::constructor_emptyMap (SOURCE_FILE ("code-optimisation.galgas", 99)) ;
        cEnumerator_globalVariableMapIR enumerator_4967 (ioArgument_ioIntermediateCodeStruct.mAttribute_mGlobalVariableMap, kEnumeration_up) ;
        while (enumerator_4967.hasCurrentObject ()) {
          const enumGalgasBool test_3 = var_accessibleEntities_3849.mAttribute_mGlobalVariableSet.getter_hasKey (enumerator_4967.current (HERE).mAttribute_lkey.mAttribute_string COMMA_SOURCE_FILE ("code-optimisation.galgas", 101)).boolEnum () ;
          if (kBoolTrue == test_3) {
            {
            var_globalVariableMap_4892.setter_insertKey (enumerator_4967.current (HERE).mAttribute_lkey, enumerator_4967.current (HERE).mAttribute_mType, enumerator_4967.current (HERE).mAttribute_mGenerateVolatile, enumerator_4967.current (HERE).mAttribute_mInitialValue, inCompiler COMMA_SOURCE_FILE ("code-optimisation.galgas", 102)) ;
            }
        ...
        ioArgument_ioIntermediateCodeStruct.mAttribute_mGlobalVariableMap = var_globalVariableMap_4892 ;
      }
    }
  }
  cEnumerator_routineMapIR enumerator_5445 (var_initialProcedureMap_2642, kEnumeration_up) ;
  while (enumerator_5445.hasCurrentObject ()) {
    GALGAS_bool test_4 = ioArgument_ioIntermediateCodeStruct.mAttribute_mRoutineMapIR.getter_hasKey (enumerator_5445.current_lkey (HERE).mAttribute_string COMMA_SOURCE_FILE ("code-optimisation.galgas", 116)).operator_not (SOURCE_FILE ("code-optimisation.galgas", 116)) ;
    if (kBoolTrue == test_4.boolEnum ()) {
      test_4 = enumerator_5445.current_mWarnIfUnused (HERE) ;
    }
    const enumGalgasBool test_5 = test_4.boolEnum () ;
    if (kBoolTrue == test_5) {
      GALGAS_location location_6 (enumerator_5445.current_lkey (HERE).getter_location (HERE)) ; // Implicit use of 'location' getter
  ...
  cEnumerator_guardMapIR enumerator_5731 (var_initialGuardMap_2705, kEnumeration_up) ;
  while (enumerator_5731.hasCurrentObject ()) {
    GALGAS_bool test_7 = ioArgument_ioIntermediateCodeStruct.mAttribute_mGuardMapIR.getter_hasKey (enumerator_5731.current_lkey (HERE).mAttribute_string COMMA_SOURCE_FILE ("code-optimisation.galgas", 122)).operator_not (SOURCE_FILE ("code-optimisation.galgas", 122)) ;
    if (kBoolTrue == test_7.boolEnum ()) {
      test_7 = enumerator_5731.current_mWarnIfUnused (HERE) ;
    }
    const enumGalgasBool test_8 = test_7.boolEnum () ;
    if (kBoolTrue == test_8) {
      GALGAS_location location_9 (enumerator_5731.current_lkey (HERE).getter_location (HERE)) ; // Implicit use of 'location' getter
...
void routine_suppressInaccessibleSubprograms (GALGAS_intermediateCodeStruct & ioArgument_ioIntermediateCodeStruct,
  ...
  GALGAS_routineMapIR var_accessibleProcedureMap_6341 = GALGAS_routineMapIR::constructor_emptyMap (SOURCE_FILE ("code-optimisation.galgas", 136)) ;
  GALGAS_routineMapIR var_nonExploredProcedureMap_6386 = GALGAS_routineMapIR::constructor_emptyMap (SOURCE_FILE ("code-optimisation.galgas", 137)) ;
  GALGAS_guardMapIR var_accessibleGuardMap_6424 = GALGAS_guardMapIR::constructor_emptyMap (SOURCE_FILE ("code-optimisation.galgas", 138)) ;
  GALGAS_guardMapIR var_nonExploredGuardMap_6463 = ioArgument_ioIntermediateCodeStruct.mAttribute_mGuardMapIR ;
  cEnumerator_routineMapIR enumerator_6592 (ioArgument_ioIntermediateCodeStruct.mAttribute_mRoutineMapIR, kEnumeration_up) ;
  while (enumerator_6592.hasCurrentObject ()) {
    const enumGalgasBool test_0 = enumerator_6592.current (HERE).mAttribute_mIsRequired.boolEnum () ;
    if (kBoolTrue == test_0) {
      {
      var_accessibleProcedureMap_6341.setter_insertKey (enumerator_6592.current (HERE).mAttribute_lkey, enumerator_6592.current (HERE).mAttribute_mRoutineNameForGeneration, enumerator_6592.current (HERE).mAttribute_mFormalArgumentListForGeneration, enumerator_6592.current (HERE).mAttribute_mAllocaList, enumerator_6592.current (HERE).mAttribute_mInstructionGenerationList, enumerator_6592.current (HERE).mAttribute_mIsRequired, enumerator_6592.current (HERE).mAttribute_mWarnIfUnused, enumerator_6592.current (HERE).mAttribute_mWeak, enumerator_6592.current (HERE).mAttribute_mGlobal, enumerator_6592.current (HERE).mAttribute_mKind, enumerator_6592.current (HERE).mAttribute_mReturnType, enumerator_6592.current (HERE).mAttribute_mAppendFileAndLineArgumentForPanicLocation, inCompiler COMMA_SOURCE_FILE ("code-optimisation.galgas", 143)) ;
      }
      extensionMethod_enterAccessibleEntities (enumerator_6592.current (HERE), outArgument_outAccessibleEntities, ioArgument_ioIntermediateCodeStruct.mAttribute_mMaxBranchOfOnInstructions, inCompiler COMMA_SOURCE_FILE ("code-optimisation.galgas", 157)) ;
      outArgument_outAccessibleEntities.mAttribute_mRoutineSet.addAssign_operation (enumerator_6592.current (HERE).mAttribute_mRoutineNameForGeneration.mAttribute_string  COMMA_SOURCE_FILE ("code-optimisation.galgas", 158)) ;
    }else if (kBoolFalse == test_0) {
      {
      var_nonExploredProcedureMap_6386.setter_insertKey (enumerator_6592.current (HERE).mAttribute_lkey, enumerator_6592.current (HERE).mAttribute_mRoutineNameForGeneration, enumerator_6592.current (HERE).mAttribute_mFormalArgumentListForGeneration, enumerator_6592.current (HERE).mAttribute_mAllocaList, enumerator_6592.current (HERE).mAttribute_mInstructionGenerationList, enumerator_6592.current (HERE).mAttribute_mIsRequired, enumerator_6592.current (HERE).mAttribute_mWarnIfUnused, enumerator_6592.current (HERE).mAttribute_mWeak, enumerator_6592.current (HERE).mAttribute_mGlobal, enumerator_6592.current (HERE).mAttribute_mKind, enumerator_6592.current (HERE).mAttribute_mReturnType, enumerator_6592.current (HERE).mAttribute_mAppendFileAndLineArgumentForPanicLocation, inCompiler COMMA_SOURCE_FILE ("code-optimisation.galgas", 160)) ;
      }
    }
    enumerator_6592.gotoNextObject () ;
  }
  cEnumerator_bootListIR enumerator_7922 (ioArgument_ioIntermediateCodeStruct.mAttribute_mBootList, kEnumeration_up) ;
  while (enumerator_7922.hasCurrentObject ()) {
    extensionMethod_enterAccessibleEntities (enumerator_7922.current (HERE).mAttribute_mInstructionListIR, outArgument_outAccessibleEntities, ioArgument_ioIntermediateCodeStruct.mAttribute_mMaxBranchOfOnInstructions, inCompiler COMMA_SOURCE_FILE ("code-optimisation.galgas", 178)) ;
    enumerator_7922.gotoNextObject () ;
  }
  cEnumerator_initListIR enumerator_8112 (ioArgument_ioIntermediateCodeStruct.mAttribute_mInitList, kEnumeration_up) ;
  while (enumerator_8112.hasCurrentObject ()) {
    extensionMethod_enterAccessibleEntities (enumerator_8112.current (HERE).mAttribute_mInstructionListIR, outArgument_outAccessibleEntities, ioArgument_ioIntermediateCodeStruct.mAttribute_mMaxBranchOfOnInstructions, inCompiler COMMA_SOURCE_FILE ("code-optimisation.galgas", 181)) ;
    enumerator_8112.gotoNextObject () ;
  }
  cEnumerator_taskMapIR enumerator_8331 (ioArgument_ioIntermediateCodeStruct.mAttribute_mTaskMapIR, kEnumeration_up) ;
  while (enumerator_8331.hasCurrentObject ()) {
    extensionMethod_enterAccessibleEntities (enumerator_8331.current (HERE).mAttribute_mInitInstructionListIR, outArgument_outAccessibleEntities, ioArgument_ioIntermediateCodeStruct.mAttribute_mMaxBranchOfOnInstructions, inCompiler COMMA_SOURCE_FILE ("code-optimisation.galgas", 185)) ;
    outArgument_outAccessibleEntities.mAttribute_mRoutineSet.addAssign_operation (GALGAS_string ("$").add_operation (enumerator_8331.current (HERE).mAttribute_lkey.mAttribute_string, inCompiler COMMA_SOURCE_FILE ("code-optimisation.galgas", 186)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("code-optimisation.galgas", 186)).add_operation (function_llvmNameForTaskLoopFunction (inCompiler COMMA_SOURCE_FILE ("code-optimisation.galgas", 186)), inCompiler COMMA_SOURCE_FILE ("code-optimisation.galgas", 186)).add_operation (GALGAS_string ("()"), inCompiler COMMA_SOURCE_FILE ("code-optimisation.galgas", 186))  COMMA_SOURCE_FILE ("code-optimisation.galgas", 186)) ;
  ...
  GALGAS_bool var_continues_9269 = GALGAS_bool (true) ;
  GALGAS_uint var_bound_9288 = ioArgument_ioIntermediateCodeStruct.mAttribute_mRoutineMapIR.getter_count (SOURCE_FILE ("code-optimisation.galgas", 206)).add_operation (ioArgument_ioIntermediateCodeStruct.mAttribute_mGuardMapIR.getter_count (SOURCE_FILE ("code-optimisation.galgas", 207)), inCompiler COMMA_SOURCE_FILE ("code-optimisation.galgas", 206)) ;
  if (var_bound_9288.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("code-optimisation.galgas", 208)).isValid ()) {
    uint32_t variant_9395 = var_bound_9288.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("code-optimisation.galgas", 208)).uintValue () ;
    bool loop_9395 = true ;
    while (loop_9395) {
      loop_9395 = var_continues_9269.isValid () ;
      if (loop_9395) {
        loop_9395 = var_continues_9269.boolValue () ;
      }
      if (loop_9395 && (0 == variant_9395)) {
        loop_9395 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE ("code-optimisation.galgas", 208)) ;
      }
      if (loop_9395) {
        variant_9395 -- ;
        var_continues_9269 = GALGAS_bool (false) ;
        {
        routine_exploreProcs (var_accessibleProcedureMap_6341, outArgument_outAccessibleEntities, var_nonExploredProcedureMap_6386, var_continues_9269, ioArgument_ioIntermediateCodeStruct.mAttribute_mMaxBranchOfOnInstructions, inCompiler  COMMA_SOURCE_FILE ("code-optimisation.galgas", 210)) ;
        }
        {
        routine_exploreGuards (var_accessibleGuardMap_6424, outArgument_outAccessibleEntities, var_nonExploredGuardMap_6463, var_continues_9269, ioArgument_ioIntermediateCodeStruct.mAttribute_mMaxBranchOfOnInstructions, inCompiler  COMMA_SOURCE_FILE ("code-optimisation.galgas", 211)) ;
        }
      }
    }
  }
  const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, ioArgument_ioIntermediateCodeStruct.mAttribute_mRoutineMapIR.objectCompare (var_accessibleProcedureMap_6341)).boolEnum () ;
  if (kBoolTrue == test_2) {
    ioArgument_ioIntermediateCodeStruct.mAttribute_mRoutineMapIR = var_accessibleProcedureMap_6341 ;
    ioArgument_ioOptimizing = GALGAS_bool (true) ;
  }
  const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, ioArgument_ioIntermediateCodeStruct.mAttribute_mGuardMapIR.objectCompare (var_accessibleGuardMap_6424)).boolEnum () ;
  if (kBoolTrue == test_3) {
    ioArgument_ioIntermediateCodeStruct.mAttribute_mGuardMapIR = var_accessibleGuardMap_6424 ;
    ioArgument_ioOptimizing = GALGAS_bool (true) ;
  }
}
...
void routine_exploreProcs (GALGAS_routineMapIR & ioArgument_ioAccessibleProcedureMap,
                           ...
                           C_Compiler * inCompiler
                           COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_routineMapIR var_exNonExploredProcedureMap_10506 = ioArgument_ioNonExploredProcedureMap ;
  ioArgument_ioNonExploredProcedureMap = GALGAS_routineMapIR::constructor_emptyMap (SOURCE_FILE ("code-optimisation.galgas", 233)) ;
  cEnumerator_routineMapIR enumerator_10612 (var_exNonExploredProcedureMap_10506, kEnumeration_up) ;
  while (enumerator_10612.hasCurrentObject ()) {
    const enumGalgasBool test_0 = ioArgument_ioAccessibleEntities.mAttribute_mRoutineSet.getter_hasKey (enumerator_10612.current (HERE).mAttribute_mRoutineNameForGeneration.mAttribute_string COMMA_SOURCE_FILE ("code-optimisation.galgas", 235)).boolEnum () ;
    if (kBoolTrue == test_0) {
      {
      ioArgument_ioAccessibleProcedureMap.setter_insertKey (enumerator_10612.current (HERE).mAttribute_lkey, enumerator_10612.current (HERE).mAttribute_mRoutineNameForGeneration, enumerator_10612.current (HERE).mAttribute_mFormalArgumentListForGeneration, enumerator_10612.current (HERE).mAttribute_mAllocaList, enumerator_10612.current (HERE).mAttribute_mInstructionGenerationList, enumerator_10612.current (HERE).mAttribute_mIsRequired, enumerator_10612.current (HERE).mAttribute_mWarnIfUnused, enumerator_10612.current (HERE).mAttribute_mWeak, enumerator_10612.current (HERE).mAttribute_mGlobal, enumerator_10612.current (HERE).mAttribute_mKind, enumerator_10612.current (HERE).mAttribute_mReturnType, enumerator_10612.current (HERE).mAttribute_mAppendFileAndLineArgumentForPanicLocation, inCompiler COMMA_SOURCE_FILE ("code-optimisation.galgas", 236)) ;
      }
      extensionMethod_enterAccessibleEntities (enumerator_10612.current (HERE), ioArgument_ioAccessibleEntities, ioArgument_ioMaxBranchOfOnInstructions, inCompiler COMMA_SOURCE_FILE ("code-optimisation.galgas", 250)) ;
      ioArgument_ioContinueExploreRoutines = GALGAS_bool (true) ;
    }else if (kBoolFalse == test_0) {
      {
      ioArgument_ioNonExploredProcedureMap.setter_insertKey (enumerator_10612.current (HERE).mAttribute_lkey, enumerator_10612.current (HERE).mAttribute_mRoutineNameForGeneration, enumerator_10612.current (HERE).mAttribute_mFormalArgumentListForGeneration, enumerator_10612.current (HERE).mAttribute_mAllocaList, enumerator_10612.current (HERE).mAttribute_mInstructionGenerationList, enumerator_10612.current (HERE).mAttribute_mIsRequired, enumerator_10612.current (HERE).mAttribute_mWarnIfUnused, enumerator_10612.current (HERE).mAttribute_mWeak, enumerator_10612.current (HERE).mAttribute_mGlobal, enumerator_10612.current (HERE).mAttribute_mKind, enumerator_10612.current (HERE).mAttribute_mReturnType, enumerator_10612.current (HERE).mAttribute_mAppendFileAndLineArgumentForPanicLocation, inCompiler COMMA_SOURCE_FILE ("code-optimisation.galgas", 253)) ;
      }
    }
...
void routine_exploreGuards (GALGAS_guardMapIR & ioArgument_ioAccessibleGuardMap,
                            ...
                            C_Compiler * inCompiler
                            COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_guardMapIR var_exNonExploredGuardMap_12240 = ioArgument_ioNonExploredGuardMap ;
  ioArgument_ioNonExploredGuardMap = GALGAS_guardMapIR::constructor_emptyMap (SOURCE_FILE ("code-optimisation.galgas", 281)) ;
  cEnumerator_guardMapIR enumerator_12330 (var_exNonExploredGuardMap_12240, kEnumeration_up) ;
  while (enumerator_12330.hasCurrentObject ()) {
    const enumGalgasBool test_0 = ioArgument_ioAccessibleEntities.mAttribute_mGuardSet.getter_hasKey (enumerator_12330.current (HERE).mAttribute_lkey.mAttribute_string COMMA_SOURCE_FILE ("code-optimisation.galgas", 283)).boolEnum () ;
    if (kBoolTrue == test_0) {
      {
      ioArgument_ioAccessibleGuardMap.setter_insertKey (enumerator_12330.current (HERE).mAttribute_lkey, enumerator_12330.current (HERE).mAttribute_mFormalArgumentListForGeneration, enumerator_12330.current (HERE).mAttribute_mGuardKindGenerationIR, enumerator_12330.current (HERE).mAttribute_mAllocaList, enumerator_12330.current (HERE).mAttribute_mInstructionGenerationList, enumerator_12330.current (HERE).mAttribute_mWarnIfUnused, inCompiler COMMA_SOURCE_FILE ("code-optimisation.galgas", 284)) ;
      }
      extensionMethod_enterAccessibleEntities (enumerator_12330.current (HERE), ioArgument_ioAccessibleEntities, ioArgument_ioMaxBranchOfOnInstructions, inCompiler COMMA_SOURCE_FILE ("code-optimisation.galgas", 292)) ;
      ioArgument_ioContinueExploreRoutines = GALGAS_bool (true) ;
    }else if (kBoolFalse == test_0) {
      {
      ioArgument_ioNonExploredGuardMap.setter_insertKey (enumerator_12330.current (HERE).mAttribute_lkey, enumerator_12330.current (HERE).mAttribute_mFormalArgumentListForGeneration, enumerator_12330.current (HERE).mAttribute_mGuardKindGenerationIR, enumerator_12330.current (HERE).mAttribute_mAllocaList, enumerator_12330.current (HERE).mAttribute_mInstructionGenerationList, enumerator_12330.current (HERE).mAttribute_mWarnIfUnused, inCompiler COMMA_SOURCE_FILE ("code-optimisation.galgas", 295)) ;
      }
    }
...
void routine_codeGeneration (const GALGAS_string constinArgument_inCurrentDirectory,
                             ...
                             C_Compiler * inCompiler
                             COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_homeDir_4866 = GALGAS_string::constructor_homeDirectory (SOURCE_FILE ("code-generation.galgas", 106)).add_operation (GALGAS_string ("/plm-products/"), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 106)) ;
  ...
  GALGAS_string var_productDirectory_4981 = var_homeDir_4866.add_operation (temp_0, inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 108)).add_operation (constinArgument_inSourceFileName.getter_stringByDeletingPathExtension (SOURCE_FILE ("code-generation.galgas", 110)).getter_stringByReplacingStringByString (GALGAS_string ("/"), GALGAS_string ("+"), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 110)), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 109)) ;
  GALGAS_string var_sourceDirectory_5194 = var_productDirectory_4981.add_operation (GALGAS_string ("/sources"), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 111)) ;
  var_sourceDirectory_5194.method_makeDirectory (inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 112)) ;
  {
  routine_generateTarget (constinArgument_inCurrentDirectory, var_productDirectory_4981, constinArgument_inTargetName, constinArgument_inIntermediateCodeStruct.mAttribute_mTargetParameters, inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 114)) ;
  }
  {
  routine_generateCodeFiles (constinArgument_inCurrentDirectory, var_productDirectory_4981, constinArgument_inEndOfSourceFileLocation, constinArgument_inIntermediateCodeStruct, constinArgument_inTypeMap, constinArgument_inTargetName, constinArgument_inPanicCodeType, constinArgument_inPanicLineType, constinArgument_inAvailableInterruptMap, constinArgument_inSourceFileAbsolutePathSet, inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 121)) ;
  }
}
...
void routine_generateCodeFiles (const GALGAS_string constinArgument_inCurrentDirectory,
                                ...
                                C_Compiler * inCompiler
                                COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_generationAdds var_generationAdds_6933 = GALGAS_generationAdds::constructor_default (SOURCE_FILE ("code-generation.galgas", 158)) ;
  var_generationAdds_6933.mAttribute_mStaticStringMap = constinArgument_inIntermediateCodeStruct.mAttribute_mStaticStringMap ;
  GALGAS_generationContext var_generationContext_7065 = GALGAS_generationContext::constructor_new (constinArgument_inPanicCodeType.getter_llvmTypeName (inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 161)), constinArgument_inPanicLineType.getter_llvmTypeName (inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 162)), constinArgument_inIntermediateCodeStruct.mAttribute_mGlobalTaskVariableList, constinArgument_inAvailableInterruptMap  COMMA_SOURCE_FILE ("code-generation.galgas", 160)) ;
  GALGAS_string var_sourceDirectory_7255 = constinArgument_inProductDirectory.add_operation (GALGAS_string ("/sources"), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 166)) ;
  GALGAS_string var_asCode_7377 = function_asTitleComment (GALGAS_string ("Target specific code"), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 168)) ;
  GALGAS_string var_asFileContents_7441 = function_getTargetTextFile (constinArgument_inCurrentDirectory, constinArgument_inTargetName.mAttribute_string.add_operation (GALGAS_string ("/target.s"), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 171)), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 169)) ;
  GALGAS_string var_x_7556 = var_asFileContents_7441.getter_stringByReplacingStringByString (GALGAS_string ("!FUNC!"), function_llvmNameForFunction (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 173)), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 173)) ;
  var_asCode_7377.plusAssign_operation(var_x_7556.getter_stringByReplacingStringByString (GALGAS_string ("!ISR!"), function_llvmNameForISR (GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 174)), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 174)), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 174)) ;
  var_asCode_7377.plusAssign_operation(GALGAS_string ("\n"), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 175)) ;
  GALGAS_string var_llvmCode_7826 = function_llvmTitleComment (GALGAS_string ("Target specific code"), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 177)) ;
  GALGAS_string var_targetLLVMcode_7892 = function_getTargetTextFile (constinArgument_inCurrentDirectory, constinArgument_inTargetName.mAttribute_string.add_operation (GALGAS_string ("/target.ll"), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 180)), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 178)) ;
  var_llvmCode_7826.plusAssign_operation(var_targetLLVMcode_7892.getter_stringByReplacingStringByString (GALGAS_string ("!FUNC!"), function_llvmNameForFunction (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 182)), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 182)), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 182)) ;
  var_llvmCode_7826.plusAssign_operation(GALGAS_string ("\n"), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 183)) ;
  {
  routine_declareLLVMTypes (constinArgument_inTypeMap, var_llvmCode_7826, inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 185)) ;
  }
  cEnumerator_globalVariableMapIR enumerator_8362 (constinArgument_inIntermediateCodeStruct.mAttribute_mGlobalVariableMap, kEnumeration_up) ;
  const bool bool_0 = true ;
  if (enumerator_8362.hasCurrentObject () && bool_0) {
    var_llvmCode_7826.plusAssign_operation(function_llvmTitleComment (GALGAS_string ("Global variables"), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 188)), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 188)) ;
    while (enumerator_8362.hasCurrentObject () && bool_0) {
      extensionMethod_generateLLVM (enumerator_8362.current (HERE), var_llvmCode_7826, inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 189)) ;
      enumerator_8362.gotoNextObject () ;
    }
    var_llvmCode_7826.plusAssign_operation(GALGAS_string ("\n"), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 190)) ;
  }
  cEnumerator_moduleListIR enumerator_8609 (constinArgument_inIntermediateCodeStruct.mAttribute_mModuleList, kEnumeration_up) ;
  const bool bool_1 = true ;
  if (enumerator_8609.hasCurrentObject () && bool_1) {
    var_llvmCode_7826.plusAssign_operation(function_llvmTitleComment (GALGAS_string ("Modules"), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 194)), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 194)) ;
    while (enumerator_8609.hasCurrentObject () && bool_1) {
      extensionMethod_generateLLVM (enumerator_8609.current (HERE), var_llvmCode_7826, inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 195)) ;
      enumerator_8609.gotoNextObject () ;
    }
    var_llvmCode_7826.plusAssign_operation(GALGAS_string ("\n"), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 196)) ;
  }
  var_llvmCode_7826.plusAssign_operation(function_llvmTitleComment (GALGAS_string ("Boot routines"), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 199)), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 199)) ;
  var_llvmCode_7826.plusAssign_operation(GALGAS_string ("define internal void @boot ()").add_operation (function_llvmAttributeFunction (inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 200)), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 200)).add_operation (GALGAS_string ("{\n"), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 200)), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 200)) ;
  cEnumerator_bootListIR enumerator_8963 (constinArgument_inIntermediateCodeStruct.mAttribute_mBootList, kEnumeration_up) ;
  while (enumerator_8963.hasCurrentObject ()) {
    var_llvmCode_7826.plusAssign_operation(GALGAS_string ("  call void @boot.").add_operation (enumerator_8963.current (HERE).mAttribute_mBootIndex.getter_string (SOURCE_FILE ("code-generation.galgas", 202)), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 202)).add_operation (GALGAS_string (" ()\n"), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 202)), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 202)) ;
    enumerator_8963.gotoNextObject () ;
  }
  var_llvmCode_7826.plusAssign_operation(GALGAS_string ("  ret void\n"), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 204)) ;
  var_llvmCode_7826.plusAssign_operation(GALGAS_string ("}\n"
  ...
  while (enumerator_9137.hasCurrentObject ()) {
    var_llvmCode_7826.plusAssign_operation(function_llvmSeparatorLine (inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 207)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 207)), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 207)) ;
    var_llvmCode_7826.plusAssign_operation(GALGAS_string ("define internal void @boot.").add_operation (enumerator_9137.current (HERE).mAttribute_mBootIndex.getter_string (SOURCE_FILE ("code-generation.galgas", 208)), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 208)).add_operation (GALGAS_string (" ()"), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 208)).add_operation (function_llvmAttributeFunction (inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 208)), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 208)).add_operation (GALGAS_string ("{\n"), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 208)), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 208)) ;
    cEnumerator_allocaList enumerator_9335 (enumerator_9137.current (HERE).mAttribute_mAllocaList, kEnumeration_up) ;
    while (enumerator_9335.hasCurrentObject ()) {
      var_llvmCode_7826.plusAssign_operation(GALGAS_string ("  %").add_operation (function_llvmNameForLocalVariable (enumerator_9335.current_mVarName (HERE), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 210)), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 210)).add_operation (GALGAS_string (" = alloca "), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 210)).add_operation (enumerator_9335.current_mType (HERE).getter_llvmTypeName (inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 210)), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 210)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 210)), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 210)) ;
      enumerator_9335.gotoNextObject () ;
    }
    extensionMethod_instructionListLLVMCode (enumerator_9137.current (HERE).mAttribute_mInstructionListIR, var_llvmCode_7826, var_generationContext_7065, var_generationAdds_6933, inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 212)) ;
  ...
  extensionMethod_generateLLVMinitCode (constinArgument_inIntermediateCodeStruct.mAttribute_mInitList, var_llvmCode_7826, constinArgument_inIntermediateCodeStruct.mAttribute_mRoutineMapIR, var_generationContext_7065, var_generationAdds_6933, inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 217)) ;
  extensionMethod_llvmCodeGeneration (constinArgument_inIntermediateCodeStruct.mAttribute_mRoutineMapIR, var_llvmCode_7826, var_asCode_7377, var_generationContext_7065, var_generationAdds_6933, inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 224)) ;
  GALGAS_string var_undefinedInterruptString_10084 = function_getTargetTextFile (constinArgument_inCurrentDirectory, constinArgument_inTargetName.mAttribute_string.add_operation (GALGAS_string ("/undefined-interrupt.s"), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 228)), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 226)) ;
  GALGAS_string var_XTRInterruptHandlerString_10234 = function_getTargetTextFile (constinArgument_inCurrentDirectory, constinArgument_inTargetName.mAttribute_string.add_operation (GALGAS_string ("/xtr-interrupt-handler.s"), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 232)), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 230)) ;
  extensionMethod_interruptCodeGeneration (constinArgument_inIntermediateCodeStruct.mAttribute_mInterruptMapIR, var_llvmCode_7826, var_asCode_7377, var_undefinedInterruptString_10084, var_XTRInterruptHandlerString_10234, var_generationContext_7065, var_generationAdds_6933, inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 234)) ;
  extensionMethod_llvmPrototypeGeneration (constinArgument_inIntermediateCodeStruct.mAttribute_mExternProcedureMapIR, var_llvmCode_7826, inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 243)) ;
  GALGAS__32_stringlist var_serviceList_10733 = GALGAS__32_stringlist::constructor_emptyList (SOURCE_FILE ("code-generation.galgas", 244)) ;
  GALGAS__32_stringlist var_sectionList_10765 = GALGAS__32_stringlist::constructor_emptyList (SOURCE_FILE ("code-generation.galgas", 245)) ;
  const enumGalgasBool test_2 = var_generationAdds_6933.mAttribute_mUsesGuards.boolEnum () ;
  if (kBoolTrue == test_2) {
    GALGAS_string var_waitForGuardChange_10890 = function_waitForGuardChangeFunctionName (inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 248)) ;
    var_serviceList_10733.addAssign_operation (function_llvmNameForServiceCall (var_waitForGuardChange_10890, inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 249)), function_llvmNameForServiceImplementation (var_waitForGuardChange_10890, inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 249))  COMMA_SOURCE_FILE ("code-generation.galgas", 249)) ;
    var_generationAdds_6933.mAttribute_mExternFunctionDeclarationSet.addAssign_operation (GALGAS_string ("declare i1 @").add_operation (function_llvmNameForServiceCall (var_waitForGuardChange_10890, inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 250)), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 250)).add_operation (GALGAS_string (" ()\n"), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 250))  COMMA_SOURCE_FILE ("code-generation.galgas", 250)) ;
  }
  extensionMethod_sectionCodeGeneration (constinArgument_inIntermediateCodeStruct.mAttribute_mRoutineMapIR, var_llvmCode_7826, var_sectionList_10765, inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 253)) ;
  extensionMethod_serviceCodeGeneration (constinArgument_inIntermediateCodeStruct.mAttribute_mRoutineMapIR, var_llvmCode_7826, var_serviceList_10733, inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 258)) ;
  extensionMethod_primitiveCodeGeneration (constinArgument_inIntermediateCodeStruct.mAttribute_mRoutineMapIR, var_llvmCode_7826, var_serviceList_10733, inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 263)) ;
  extensionMethod_guardCodeGeneration (constinArgument_inIntermediateCodeStruct.mAttribute_mGuardMapIR, var_llvmCode_7826, var_serviceList_10733, var_generationContext_7065, var_generationAdds_6933, inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 268)) ;
  extensionMethod_generateCode (constinArgument_inIntermediateCodeStruct.mAttribute_mTaskMapIR, var_llvmCode_7826, var_generationContext_7065, var_generationAdds_6933, var_serviceList_10733, inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 275)) ;
  {
  routine_generateServiceDispatcher (constinArgument_inCurrentDirectory, constinArgument_inTargetName.mAttribute_string, var_asCode_7377, var_serviceList_10733, inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 277)) ;
  }
  {
  routine_generateSectionDispatcher (constinArgument_inCurrentDirectory, constinArgument_inTargetName.mAttribute_string, var_asCode_7377, var_sectionList_10765, inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 284)) ;
  }
  ...
  if (kBoolTrue == test_3) {
    GALGAS_string var_s_12463 = function_getTargetTextFile (constinArgument_inCurrentDirectory, constinArgument_inTargetName.mAttribute_string.add_operation (GALGAS_string ("/target-panic.ll"), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 294)), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 292)) ;
    GALGAS_string var_s_31__12594 = var_s_12463.getter_stringByReplacingStringByString (GALGAS_string ("!PANICCODE!"), var_generationContext_7065.mAttribute_mPanicCodeLLVMType, inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 296)) ;
    GALGAS_string var_s_32__12696 = var_s_31__12594.getter_stringByReplacingStringByString (GALGAS_string ("!PANICLINE!"), var_generationContext_7065.mAttribute_mPanicLineLLVMType, inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 297)) ;
    var_llvmCode_7826.plusAssign_operation(var_s_32__12696, inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 298)) ;
    var_llvmCode_7826.plusAssign_operation(function_llvmTitleComment (GALGAS_string ("Raise Panic internal"), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 299)), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 299)) ;
    var_llvmCode_7826.plusAssign_operation(GALGAS_string ("define internal void @raise_panic_internal ("), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 300)) ;
    var_llvmCode_7826.plusAssign_operation(var_generationContext_7065.mAttribute_mPanicLineLLVMType.add_operation (GALGAS_string (" %in.LINE, "), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 301)), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 301)) ;
    var_llvmCode_7826.plusAssign_operation(var_generationContext_7065.mAttribute_mPanicCodeLLVMType.add_operation (GALGAS_string (" %in.CODE, "), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 302)), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 302)) ;
    var_llvmCode_7826.plusAssign_operation(GALGAS_string ("i8* %in.FILE)").add_operation (function_llvmAttributeFunction (inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 303)), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 303)).add_operation (GALGAS_string ("noreturn {\n"), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 303)), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 303)) ;
    var_llvmCode_7826.plusAssign_operation(GALGAS_string ("  %").add_operation (function_llvmNameForLocalVariable (GALGAS_string ("LINE"), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 305)), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 305)).add_operation (GALGAS_string (" = alloca "), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 305)), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 305)) ;
    var_llvmCode_7826.plusAssign_operation(var_generationContext_7065.mAttribute_mPanicLineLLVMType.add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 306)), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 306)) ;
    var_llvmCode_7826.plusAssign_operation(GALGAS_string ("  store ").add_operation (var_generationContext_7065.mAttribute_mPanicLineLLVMType, inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 307)).add_operation (GALGAS_string (" %in.LINE, "), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 307)), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 307)) ;
    var_llvmCode_7826.plusAssign_operation(var_generationContext_7065.mAttribute_mPanicLineLLVMType.add_operation (GALGAS_string (" * %"), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 308)).add_operation (function_llvmNameForLocalVariable (GALGAS_string ("LINE"), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 308)), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 308)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 308)), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 308)) ;
    var_llvmCode_7826.plusAssign_operation(GALGAS_string ("  %").add_operation (function_llvmNameForLocalVariable (GALGAS_string ("CODE"), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 310)), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 310)), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 310)) ;
    var_llvmCode_7826.plusAssign_operation(GALGAS_string (" = alloca ").add_operation (var_generationContext_7065.mAttribute_mPanicCodeLLVMType, inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 311)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 311)), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 311)) ;
    var_llvmCode_7826.plusAssign_operation(GALGAS_string ("  store ").add_operation (var_generationContext_7065.mAttribute_mPanicCodeLLVMType, inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 312)).add_operation (GALGAS_string (" %in.CODE, "), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 312)), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 312)) ;
    var_llvmCode_7826.plusAssign_operation(var_generationContext_7065.mAttribute_mPanicCodeLLVMType.add_operation (GALGAS_string (" * %"), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 313)).add_operation (function_llvmNameForLocalVariable (GALGAS_string ("CODE"), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 313)), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 313)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 313)), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 313)) ;
    var_llvmCode_7826.plusAssign_operation(GALGAS_string ("  %").add_operation (function_llvmNameForLocalVariable (GALGAS_string ("FILE"), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 315)), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 315)).add_operation (GALGAS_string (" = alloca i8*\n"), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 315)), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 315)) ;
    var_llvmCode_7826.plusAssign_operation(GALGAS_string ("  store i8* %in.FILE, i8** %").add_operation (function_llvmNameForLocalVariable (GALGAS_string ("FILE"), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 316)), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 316)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 316)), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 316)) ;
    extensionMethod_instructionListLLVMCode (constinArgument_inIntermediateCodeStruct.mAttribute_mPanicSetupInstructionListIR, var_llvmCode_7826, var_generationContext_7065, var_generationAdds_6933, inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 317)) ;
    var_llvmCode_7826.plusAssign_operation(GALGAS_string ("  br label %panic.loop\n"
      "\n"), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 322)) ;
    var_llvmCode_7826.plusAssign_operation(GALGAS_string ("panic.loop:\n"), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 323)) ;
    extensionMethod_instructionListLLVMCode (constinArgument_inIntermediateCodeStruct.mAttribute_mPanicLoopInstructionListIR, var_llvmCode_7826, var_generationContext_7065, var_generationAdds_6933, inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 324)) ;
    var_llvmCode_7826.plusAssign_operation(GALGAS_string ("  br label %panic.loop\n"), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 329)) ;
    var_llvmCode_7826.plusAssign_operation(GALGAS_string ("}\n"
      "\n"), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 330)) ;
    GALGAS_uint var_staticStringIndex_14621 ;
    {
    extensionSetter_findOrAddStaticString (var_generationAdds_6933.mAttribute_mStaticStringMap, GALGAS_string ("-"), var_staticStringIndex_14621, inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 332)) ;
    }
    var_llvmCode_7826.plusAssign_operation(function_llvmTitleComment (GALGAS_string ("Panic for ISR"), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 336)), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 336)) ;
    var_llvmCode_7826.plusAssign_operation(GALGAS_string ("define internal void @panic.isr (").add_operation (var_generationContext_7065.mAttribute_mPanicCodeLLVMType, inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 337)).add_operation (GALGAS_string (" %in.CODE) "), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 337)).add_operation (function_llvmAttributeFunction (inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 337)), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 337)).add_operation (GALGAS_string ("noreturn {\n"), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 337)), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 337)) ;
    var_llvmCode_7826.plusAssign_operation(GALGAS_string ("  %str.FILE = load i8*, i8** @string.").add_operation (var_staticStringIndex_14621.getter_string (SOURCE_FILE ("code-generation.galgas", 338)), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 338)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 338)), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 338)) ;
    var_llvmCode_7826.plusAssign_operation(GALGAS_string ("  %isr.code = sub ").add_operation (var_generationContext_7065.mAttribute_mPanicCodeLLVMType, inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 339)).add_operation (GALGAS_string (" 0, %in.CODE\n"), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 339)), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 339)) ;
    var_llvmCode_7826.plusAssign_operation(GALGAS_string ("  call void @raise_panic_internal ("), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 340)) ;
    var_llvmCode_7826.plusAssign_operation(var_generationContext_7065.mAttribute_mPanicLineLLVMType.add_operation (GALGAS_string (" 0, "), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 341)), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 341)) ;
    var_llvmCode_7826.plusAssign_operation(var_generationContext_7065.mAttribute_mPanicCodeLLVMType.add_operation (GALGAS_string (" %isr.code, "), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 342)), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 342)) ;
    var_llvmCode_7826.plusAssign_operation(GALGAS_string ("i8* %str.FILE"), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 343)) ;
    var_llvmCode_7826.plusAssign_operation(GALGAS_string (" )\n"), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 344)) ;
    var_llvmCode_7826.plusAssign_operation(GALGAS_string ("  unreachable\n"), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 345)) ;
    var_llvmCode_7826.plusAssign_operation(GALGAS_string ("}\n"
      "\n"), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 346)) ;
    cEnumerator_stringset enumerator_15403 (constinArgument_inSourceFileAbsolutePathSet, kEnumeration_up) ;
    while (enumerator_15403.hasCurrentObject ()) {
      GALGAS_uint var_staticStringIndex_15570 ;
      {
      extensionSetter_findOrAddStaticString (var_generationAdds_6933.mAttribute_mStaticStringMap, enumerator_15403.current_key (HERE).getter_lastPathComponent (SOURCE_FILE ("code-generation.galgas", 350)).getter_stringByDeletingPathExtension (SOURCE_FILE ("code-generation.galgas", 350)), var_staticStringIndex_15570, inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 349)) ;
      }
      GALGAS_string var_routineName_15600 = GALGAS_string ("@raise_panic.").add_operation (var_staticStringIndex_15570.getter_string (SOURCE_FILE ("code-generation.galgas", 353)), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 353)) ;
      var_llvmCode_7826.plusAssign_operation(function_llvmTitleComment (var_routineName_15600.add_operation (GALGAS_string (" ("), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 354)).add_operation (enumerator_15403.current_key (HERE).getter_lastPathComponent (SOURCE_FILE ("code-generation.galgas", 354)), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 354)).add_operation (GALGAS_string (")"), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 354)), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 354)), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 354)) ;
      var_llvmCode_7826.plusAssign_operation(GALGAS_string ("define internal void ").add_operation (var_routineName_15600, inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 355)).add_operation (GALGAS_string (" ("), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 355)), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 355)) ;
      var_llvmCode_7826.plusAssign_operation(var_generationContext_7065.mAttribute_mPanicLineLLVMType.add_operation (GALGAS_string (" %inSourceLine, "), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 356)), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 356)) ;
      ...
      var_llvmCode_7826.plusAssign_operation(GALGAS_string ("  %str.FILE = load i8*, i8** @string.").add_operation (var_staticStringIndex_15570.getter_string (SOURCE_FILE ("code-generation.galgas", 358)), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 358)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 358)), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 358)) ;
      var_llvmCode_7826.plusAssign_operation(GALGAS_string ("  call void @raise_panic ("), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 359)) ;
      var_llvmCode_7826.plusAssign_operation(var_generationContext_7065.mAttribute_mPanicLineLLVMType.add_operation (GALGAS_string (" %inSourceLine, "), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 360)), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 360)) ;
      var_llvmCode_7826.plusAssign_operation(var_generationContext_7065.mAttribute_mPanicCodeLLVMType.add_operation (GALGAS_string (" %inCode, i8* %str.FILE)\n"), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 361)), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 361)) ;
  ...
  const enumGalgasBool test_4 = GALGAS_bool (kIsStrictSup, var_generationAdds_6933.mAttribute_mExternFunctionDeclarationSet.getter_count (SOURCE_FILE ("code-generation.galgas", 367)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_4) {
    var_llvmCode_7826.plusAssign_operation(function_llvmTitleComment (GALGAS_string ("LLVM extern functions"), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 368)), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 368)) ;
    cEnumerator_stringset enumerator_16595 (var_generationAdds_6933.mAttribute_mExternFunctionDeclarationSet, kEnumeration_up) ;
    while (enumerator_16595.hasCurrentObject ()) {
      var_llvmCode_7826.plusAssign_operation(enumerator_16595.current_key (HERE).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 370)), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 370)) ;
      enumerator_16595.gotoNextObject () ;
    }
    var_llvmCode_7826.plusAssign_operation(GALGAS_string ("\n"), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 372)) ;
  }
  const enumGalgasBool test_5 = GALGAS_bool (kIsStrictSup, var_generationAdds_6933.mAttribute_mStaticStringMap.getter_count (SOURCE_FILE ("code-generation.galgas", 375)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_5) {
    var_llvmCode_7826.plusAssign_operation(function_llvmTitleComment (GALGAS_string ("Static strings"), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 376)), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 376)) ;
    cEnumerator_staticStringMap enumerator_16871 (var_generationAdds_6933.mAttribute_mStaticStringMap, kEnumeration_up) ;
    while (enumerator_16871.hasCurrentObject ()) {
      GALGAS_string var_lgStr_16890 = enumerator_16871.current_lkey (HERE).mAttribute_string.getter_length (SOURCE_FILE ("code-generation.galgas", 378)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 378)).getter_string (SOURCE_FILE ("code-generation.galgas", 378)) ;
      var_llvmCode_7826.plusAssign_operation(function_literalCharacterArrayName (enumerator_16871.current_mIndex (HERE), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 379)).add_operation (GALGAS_string (" = private unnamed_addr constant ["), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 379)), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 379)) ;
      var_llvmCode_7826.plusAssign_operation(var_lgStr_16890.add_operation (GALGAS_string (" x i8] c\""), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 380)), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 380)) ;
      var_llvmCode_7826.plusAssign_operation(enumerator_16871.current_lkey (HERE).mAttribute_string.getter_utf_38_RepresentationWithoutDelimiters (SOURCE_FILE ("code-generation.galgas", 381)), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 381)) ;
      var_llvmCode_7826.plusAssign_operation(GALGAS_string ("\\00\", align 1\n"), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 382)) ;
      var_llvmCode_7826.plusAssign_operation(function_literalStringName (enumerator_16871.current_mIndex (HERE), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 383)).add_operation (GALGAS_string (" = private constant i8* getelementptr inbounds (["), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 383)), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 383)) ;
      var_llvmCode_7826.plusAssign_operation(var_lgStr_16890.add_operation (GALGAS_string (" x i8], ["), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 384)).add_operation (var_lgStr_16890, inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 384)).add_operation (GALGAS_string (" x i8]* "), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 384)), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 384)) ;
      var_llvmCode_7826.plusAssign_operation(function_literalCharacterArrayName (enumerator_16871.current_mIndex (HERE), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 385)).add_operation (GALGAS_string (", i32 0, i32 0), align 4\n"
        "\n"), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 385)), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 385)) ;
      enumerator_16871.gotoNextObject () ;
    }
  }
  var_llvmCode_7826.plusAssign_operation(function_llvmSeparatorLine (inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 389)), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 389)) ;
  GALGAS_bool joker_17594 ; // Joker input parameter
  var_llvmCode_7826.method_writeToFileWhenDifferentContents (var_sourceDirectory_7255.add_operation (GALGAS_string ("/src.ll"), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 390)), joker_17594, inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 390)) ;
  var_asCode_7377.plusAssign_operation(function_asSeparatorLine (inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 392)), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 392)) ;
  GALGAS_bool joker_17765 ; // Joker input parameter
  var_asCode_7377.method_writeToFileWhenDifferentContents (var_sourceDirectory_7255.add_operation (GALGAS_string ("/src.s"), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 393)), joker_17765, inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 393)) ;
  GALGAS_string var_cCode_17836 = function_getTargetTextFile (constinArgument_inCurrentDirectory, constinArgument_inTargetName.mAttribute_string.add_operation (GALGAS_string ("/target.c"), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 397)), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 395)) ;
  GALGAS_string var_s_31__17950 = var_cCode_17836.getter_stringByReplacingStringByString (GALGAS_string ("!TASKCOUNT!"), constinArgument_inIntermediateCodeStruct.mAttribute_mTaskMapIR.getter_count (SOURCE_FILE ("code-generation.galgas", 399)).getter_string (SOURCE_FILE ("code-generation.galgas", 399)), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 399)) ;
  GALGAS_string var_s_32__18070 = var_s_31__17950.getter_stringByReplacingStringByString (GALGAS_string ("!GUARDCOUNT!"), constinArgument_inIntermediateCodeStruct.mAttribute_mMaxBranchOfOnInstructions.getter_string (SOURCE_FILE ("code-generation.galgas", 400)), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 400)) ;
  GALGAS_string var_s_33__18196 = var_s_32__18070.getter_stringByReplacingStringByString (GALGAS_string ("!FUNC!"), function_llvmNameForFunction (GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 401)), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 401)) ;
  GALGAS_string var_s_34__18281 = var_s_33__18196.getter_stringByReplacingStringByString (GALGAS_string ("!SERVICEIMPLEMENTATION!"), function_llvmNameForServiceImplementation (GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 402)), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 402)) ;
  GALGAS_string var_s_35__18396 = var_s_34__18281.getter_stringByReplacingStringByString (GALGAS_string ("!SERVICECALL!"), function_llvmNameForServiceCall (GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 403)), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 403)) ;
  GALGAS_bool joker_18551 ; // Joker input parameter
  var_s_35__18396.method_writeToFileWhenDifferentContents (var_sourceDirectory_7255.add_operation (GALGAS_string ("/src.c"), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 404)), joker_18551, inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 404)) ;
  GALGAS_string var_json_18644 = GALGAS_string ("{\n") ;
  var_json_18644.plusAssign_operation(GALGAS_string ("  \"system-stack-size\" : ").add_operation (constinArgument_inIntermediateCodeStruct.mAttribute_mTargetParameters.mAttribute_mSystemStackSize.mAttribute_bigint.getter_string (SOURCE_FILE ("code-generation.galgas", 408)), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 408)).add_operation (GALGAS_string (",\n"), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 408)), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 408)) ;
  ...
  var_json_18644.plusAssign_operation(GALGAS_string ("  \"tasks\" : {"), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 414)) ;
  cEnumerator_taskMapIR enumerator_19308 (constinArgument_inIntermediateCodeStruct.mAttribute_mTaskMapIR, kEnumeration_up) ;
  while (enumerator_19308.hasCurrentObject ()) {
    var_json_18644.plusAssign_operation(GALGAS_string ("\n"
      "    \"").add_operation (enumerator_19308.current (HERE).mAttribute_lkey.mAttribute_string.getter_assemblerRepresentation (SOURCE_FILE ("code-generation.galgas", 416)), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 416)).add_operation (GALGAS_string ("\" : "), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 416)).add_operation (enumerator_19308.current (HERE).mAttribute_mStackSize.getter_string (SOURCE_FILE ("code-generation.galgas", 416)), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 416)), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 416)) ;
    if (enumerator_19308.hasNextObject ()) {
      var_json_18644.plusAssign_operation(GALGAS_string (","), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 417)) ;
    }
  ...
  var_json_18644.plusAssign_operation(GALGAS_string ("  \"services\" : ["), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 422)) ;
  cEnumerator__32_stringlist enumerator_19556 (var_serviceList_10733, kEnumeration_up) ;
  const bool bool_6 = true ;
  if (enumerator_19556.hasCurrentObject () && bool_6) {
    while (enumerator_19556.hasCurrentObject () && bool_6) {
      var_json_18644.plusAssign_operation(GALGAS_string ("\n"
        "    \"").add_operation (enumerator_19556.current_mValue_31_ (HERE), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 424)).add_operation (GALGAS_string ("\""), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 424)), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 424)) ;
      enumerator_19556.gotoNextObject () ;
      if (enumerator_19556.hasCurrentObject () && bool_6) {
        var_json_18644.plusAssign_operation(GALGAS_string (","), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 425)) ;
      }
    }
    var_json_18644.plusAssign_operation(GALGAS_string ("\n"), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 426)) ;
  }
  var_json_18644.plusAssign_operation(GALGAS_string ("  ],\n"), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 428)) ;
  var_json_18644.plusAssign_operation(GALGAS_string ("  \"sections\" : ["), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 430)) ;
  cEnumerator__32_stringlist enumerator_19777 (var_sectionList_10765, kEnumeration_up) ;
  const bool bool_7 = true ;
  if (enumerator_19777.hasCurrentObject () && bool_7) {
    while (enumerator_19777.hasCurrentObject () && bool_7) {
      var_json_18644.plusAssign_operation(GALGAS_string ("\n"
        "    \"").add_operation (enumerator_19777.current_mValue_31_ (HERE), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 432)).add_operation (GALGAS_string ("\""), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 432)), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 432)) ;
      enumerator_19777.gotoNextObject () ;
      if (enumerator_19777.hasCurrentObject () && bool_7) {
        var_json_18644.plusAssign_operation(GALGAS_string (","), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 433)) ;
      }
    }
    var_json_18644.plusAssign_operation(GALGAS_string ("\n"), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 434)) ;
  }
  var_json_18644.plusAssign_operation(GALGAS_string ("  ],\n"), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 436)) ;
  var_json_18644.plusAssign_operation(GALGAS_string ("  \"isr\" : ["), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 438)) ;
  GALGAS_bool var_first_19953 = GALGAS_bool (true) ;
  cEnumerator_interruptMapIR enumerator_20037 (constinArgument_inIntermediateCodeStruct.mAttribute_mInterruptMapIR, kEnumeration_up) ;
  while (enumerator_20037.hasCurrentObject ()) {
    const enumGalgasBool test_8 = var_first_19953.boolEnum () ;
    if (kBoolTrue == test_8) {
      var_first_19953 = GALGAS_bool (false) ;
    }else if (kBoolFalse == test_8) {
      var_json_18644.plusAssign_operation(GALGAS_string (","), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 444)) ;
    }
    GALGAS_string temp_9 ;
    const enumGalgasBool test_10 = enumerator_20037.current_mXTR (HERE).boolEnum () ;
    if (kBoolTrue == test_10) {
      temp_9 = function_llvmNameForInterrupt (enumerator_20037.current_lkey (HERE), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 447)).mAttribute_string ;
    }else if (kBoolFalse == test_10) {
      temp_9 = function_llvmNameForISR (enumerator_20037.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 449)) ;
    }
    GALGAS_string var_interruptImplementationName_20149 = temp_9 ;
    var_json_18644.plusAssign_operation(GALGAS_string ("\n"
      "    \"").add_operation (var_interruptImplementationName_20149, inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 451)).add_operation (GALGAS_string ("\""), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 451)), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 451)) ;
  ...
  if (kBoolTrue == test_11) {
    cEnumerator_availableInterruptMap enumerator_20457 (constinArgument_inAvailableInterruptMap, kEnumeration_up) ;
    while (enumerator_20457.hasCurrentObject ()) {
      const enumGalgasBool test_12 = constinArgument_inIntermediateCodeStruct.mAttribute_mInterruptMapIR.getter_hasKey (enumerator_20457.current_lkey (HERE).mAttribute_string COMMA_SOURCE_FILE ("code-generation.galgas", 455)).operator_not (SOURCE_FILE ("code-generation.galgas", 455)).boolEnum () ;
      if (kBoolTrue == test_12) {
        switch (enumerator_20457.current_mInterruptionPanicCode (HERE).enumValue ()) {
        ...
        case GALGAS_interruptionPanicCode::kEnum_panicCode:
          {
            const enumGalgasBool test_13 = var_first_19953.boolEnum () ;
            if (kBoolTrue == test_13) {
              var_first_19953 = GALGAS_bool (false) ;
            }else if (kBoolFalse == test_13) {
              var_json_18644.plusAssign_operation(GALGAS_string (","), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 462)) ;
            }
            var_json_18644.plusAssign_operation(GALGAS_string ("\n"
              "    \"").add_operation (function_llvmNameForISR (enumerator_20457.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 464)), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 464)).add_operation (GALGAS_string ("\""), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 464)), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 464)) ;
          }
          break ;
        }
      }
  ...
  GALGAS_bool joker_20967 ; // Joker input parameter
  var_json_18644.method_writeToFileWhenDifferentContents (var_sourceDirectory_7255.add_operation (GALGAS_string ("/provided-stacks.json"), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 472)), joker_20967, inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 472)) ;
  ...
  if (kBoolTrue == test_14) {
    ...
    GALGAS_string var_script_21085 = temp_15 ;
    GALGAS_string var_fullScript_21180 = GALGAS_string ("python ").add_operation (constinArgument_inProductDirectory, inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 476)).add_operation (GALGAS_string ("/"), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 476)).add_operation (var_script_21085, inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 476)).add_operation (GALGAS_string (".py"), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 476)) ;
    GALGAS_sint var_result_21253 = var_fullScript_21180.getter_system (SOURCE_FILE ("code-generation.galgas", 477)) ;
    const enumGalgasBool test_17 = GALGAS_bool (kIsNotEqual, var_result_21253.objectCompare (GALGAS_sint ((int32_t) 0L))).boolEnum () ;
...
void routine_declareLLVMTypes (const GALGAS_unifiedTypeMap constinArgument_inTypeMap,
  ...
  cEnumerator_unifiedTypeMap enumerator_21664 (constinArgument_inTypeMap, kEnumeration_up) ;
  while (enumerator_21664.hasCurrentObject ()) {
    switch (enumerator_21664.current_kind (HERE).enumValue ()) {
    ...
    case GALGAS_typeKind::kEnum_structure:
      {
        const cEnumAssociatedValues_typeKind_structure * extractPtr_22009 = (const cEnumAssociatedValues_typeKind_structure *) (enumerator_21664.current_kind (HERE).unsafePointer ()) ;
        const GALGAS_propertyList extractedValue_propertyList = extractPtr_22009->mAssociatedValue1 ;
        ioArgument_ioLLVMcode.plusAssign_operation(enumerator_21664.current_llvmTypeName (HERE).add_operation (GALGAS_string (" = type {"), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 495)), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 495)) ;
        cEnumerator_propertyList enumerator_21892 (extractedValue_propertyList, kEnumeration_up) ;
        while (enumerator_21892.hasCurrentObject ()) {
          ioArgument_ioLLVMcode.plusAssign_operation(enumerator_21892.current_mType (HERE).getter_llvmTypeName (inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 497)), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 497)) ;
          if (enumerator_21892.hasNextObject ()) {
