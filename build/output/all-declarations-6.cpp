...
static void extensionMethod_structureDeclarationAST_functionSemanticAnalysis (const cPtr_structureDeclarationAST * inObject,
  ...
  cEnumerator_functionDeclarationListAST enumerator_19938 (object->mProperty_mFunctionDeclarationListAST, kENUMERATION_UP) ;
  while (enumerator_19938.hasCurrentObject ()) {
    GALGAS_bool var_warnIfUnused_19962 = GALGAS_bool (true) ;
    GALGAS_bool var_mutating_19986 = GALGAS_bool (false) ;
    GALGAS_bool var_accessProperties_20019 = GALGAS_bool (false) ;
    cEnumerator_lstringlist enumerator_20082 (enumerator_19938.current (HERE).getter_mFunctionAttributeList (HERE), kENUMERATION_UP) ;
    while (enumerator_20082.hasCurrentObject ()) {
      const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, enumerator_20082.current_mValue (HERE).getter_string (HERE).objectCompare (function_noUnusedWarningAttribute (inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 531)))).boolEnum () ;
      if (kBoolTrue == test_0) {
        const enumGalgasBool test_1 = var_warnIfUnused_19962.operator_not (SOURCE_FILE ("type-structure-declaration.galgas", 532)).boolEnum () ;
        if (kBoolTrue == test_1) {
          TC_Array <C_FixItDescription> fixItArray2 ;
          inCompiler->emitSemanticError (enumerator_20082.current_mValue (HERE).getter_location (SOURCE_FILE ("type-structure-declaration.galgas", 533)), GALGAS_string ("duplicated @").add_operation (function_noUnusedWarningAttribute (inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 533)), inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 533)).add_operation (GALGAS_string (" attribute"), inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 533)), fixItArray2  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 533)) ;
        }
        var_warnIfUnused_19962 = GALGAS_bool (false) ;
      }else if (kBoolFalse == test_0) {
        const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, enumerator_20082.current_mValue (HERE).getter_string (HERE).objectCompare (function_userAccessAttribute (inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 536)))).boolEnum () ;
        if (kBoolTrue == test_3) {
          const enumGalgasBool test_4 = var_accessProperties_20019.boolEnum () ;
          if (kBoolTrue == test_4) {
            TC_Array <C_FixItDescription> fixItArray5 ;
            inCompiler->emitSemanticError (enumerator_20082.current_mValue (HERE).getter_location (SOURCE_FILE ("type-structure-declaration.galgas", 538)), GALGAS_string ("duplicated @").add_operation (function_userAccessAttribute (inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 538)), inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 538)).add_operation (GALGAS_string (" attribute"), inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 538)), fixItArray5  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 538)) ;
          }
          var_accessProperties_20019 = GALGAS_bool (true) ;
        }else if (kBoolFalse == test_3) {
          const enumGalgasBool test_6 = GALGAS_bool (kIsEqual, enumerator_20082.current_mValue (HERE).getter_string (HERE).objectCompare (function_mutatingAttribute (inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 541)))).boolEnum () ;
          if (kBoolTrue == test_6) {
            const enumGalgasBool test_7 = var_mutating_19986.boolEnum () ;
            if (kBoolTrue == test_7) {
              TC_Array <C_FixItDescription> fixItArray8 ;
              inCompiler->emitSemanticError (enumerator_20082.current_mValue (HERE).getter_location (SOURCE_FILE ("type-structure-declaration.galgas", 543)), GALGAS_string ("duplicated @").add_operation (function_mutatingAttribute (inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 543)), inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 543)).add_operation (GALGAS_string (" attribute"), inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 543)), fixItArray8  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 543)) ;
            }
            var_mutating_19986 = GALGAS_bool (true) ;
          }else if (kBoolFalse == test_6) {
            TC_Array <C_FixItDescription> fixItArray9 ;
            inCompiler->emitSemanticError (enumerator_20082.current_mValue (HERE).getter_location (SOURCE_FILE ("type-structure-declaration.galgas", 547)), GALGAS_string ("unknown attribute; available attributes are @").add_operation (function_noUnusedWarningAttribute (inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 547)), inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 547)).add_operation (GALGAS_string (", @"), inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 547)).add_operation (function_mutatingAttribute (inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 548)), inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 548)).add_operation (GALGAS_string (" and @"), inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 548)).add_operation (function_userAccessAttribute (inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 548)), inCompiler COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 548)), fixItArray9  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 547)) ;
          }
        }
      }
      enumerator_20082.gotoNextObject () ;
    }
    var_accessProperties_20019 = GALGAS_bool (kIsNotEqual, enumerator_19938.current (HERE).getter_mMode (HERE).objectCompare (GALGAS_mode::constructor_userMode (SOURCE_FILE ("type-structure-declaration.galgas", 551)))) ;
    {
    routine_routineSemanticAnalysis (constinArgument_inStructureType, GALGAS_routineKind::constructor_function (enumerator_19938.current (HERE).getter_mMode (HERE)  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 554)), enumerator_19938.current (HERE).getter_mMode (HERE), enumerator_19938.current (HERE).getter_mFunctionName (HERE), enumerator_19938.current (HERE).getter_mFunctionFormalArgumentList (HERE), enumerator_19938.current (HERE).getter_mFunctionReturnTypeName (HERE), enumerator_19938.current (HERE).getter_mFunctionInstructionList (HERE), enumerator_19938.current (HERE).getter_mEndOfFunctionDeclaration (HERE), var_accessProperties_20019, var_mutating_19986, var_warnIfUnused_19962, GALGAS_bool (false), constinArgument_inContext, ioArgument_ioTemporaries, ioArgument_ioIntermediateCodeStruct, inCompiler  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 552)) ;
    }
...
void extensionMethod_buildControlRegisterSliceMap (const GALGAS_controlRegisterDeclarationListAST_2D_element inObject,
  ...
  if (kBoolTrue == test_0) {
    GALGAS_uint var_shiftCount_10171 = GALGAS_uint ((uint32_t) 0U) ;
    cEnumerator_controlRegisterBitSliceList enumerator_10213 (inObject.mProperty_mRegisterBitSliceList, kENUMERATION_DOWN) ;
    while (enumerator_10213.hasCurrentObject ()) {
      switch (enumerator_10213.current_mRegisterBitSlice (HERE).enumValue ()) {
      case GALGAS_controlRegisterBitSlice::kNotBuilt:
        break ;
      case GALGAS_controlRegisterBitSlice::kEnum_unusedBits:
        {
          const cEnumAssociatedValues_controlRegisterBitSlice_unusedBits * extractPtr_10408 = (const cEnumAssociatedValues_controlRegisterBitSlice_unusedBits *) (enumerator_10213.current_mRegisterBitSlice (HERE).unsafePointer ()) ;
          const GALGAS_lbigint extractedValue_count = extractPtr_10408->mAssociatedValue0 ;
          var_shiftCount_10171 = var_shiftCount_10171.add_operation (extractedValue_count.getter_bigint (HERE).getter_uint (inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 265)), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 265)) ;
      ...
      case GALGAS_controlRegisterBitSlice::kEnum_namedBit:
        {
          const cEnumAssociatedValues_controlRegisterBitSlice_namedBit * extractPtr_11389 = (const cEnumAssociatedValues_controlRegisterBitSlice_namedBit *) (enumerator_10213.current_mRegisterBitSlice (HERE).unsafePointer ()) ;
          const GALGAS_lstring extractedValue_name = extractPtr_11389->mAssociatedValue0 ;
          const GALGAS_lbigint extractedValue_count = extractPtr_11389->mAssociatedValue1 ;
          GALGAS_uint var_bitCount_10482 = extractedValue_count.getter_bigint (HERE).getter_uint (inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 268)) ;
          outArgument_outControlRegisterFieldList.addAssign_operation (var_bitCount_10482, extractedValue_name.getter_string (HERE)  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 269)) ;
          {
          outArgument_outRegisterFieldMap.setter_insertKey (extractedValue_name, var_shiftCount_10171, var_bitCount_10482, inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 270)) ;
          }
          GALGAS_sliceMap var_registerSubMap_10708 = GALGAS_sliceMap::constructor_emptyMap (SOURCE_FILE ("declaration-control-register.galgas", 275)) ;
          {
          var_registerSubMap_10708.setter_insertKey (GALGAS_lstring::constructor_new (GALGAS_string ("shifted"), extractedValue_name.getter_location (HERE)  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 278)), GALGAS_llvmBinaryOperation::constructor_lshr (SOURCE_FILE ("declaration-control-register.galgas", 279)), var_shiftCount_10171.getter_bigint (SOURCE_FILE ("declaration-control-register.galgas", 280)), GALGAS_sliceMap::constructor_emptyMap (SOURCE_FILE ("declaration-control-register.galgas", 281)), ioArgument_ioRegisterType, inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 277)) ;
          }
          {
          ...
          GALGAS_bigint var_mask_11152 = GALGAS_bigint ("1", inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 293)).left_shift_operation (var_bitCount_10482 COMMA_SOURCE_FILE ("declaration-control-register.galgas", 293)).substract_operation (GALGAS_bigint ("1", inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 293)), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 293)).left_shift_operation (var_shiftCount_10171 COMMA_SOURCE_FILE ("declaration-control-register.galgas", 293)) ;
          {
          outArgument_outRegisterBitSliceMap.setter_insertKey (extractedValue_name, GALGAS_llvmBinaryOperation::constructor_and (SOURCE_FILE ("declaration-control-register.galgas", 296)), var_mask_11152, var_registerSubMap_10708, ioArgument_ioRegisterType, inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 294)) ;
          }
          var_shiftCount_10171 = var_shiftCount_10171.add_operation (var_bitCount_10482, inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 301)) ;
        }
        break ;
      }
      enumerator_10213.gotoNextObject () ;
    }
    const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, constinArgument_inRegisterBitCount.objectCompare (var_shiftCount_10171)).boolEnum () ;
    if (kBoolTrue == test_1) {
      TC_Array <C_FixItDescription> fixItArray2 ;
      inCompiler->emitSemanticError (inObject.mProperty_mRegisterBitSliceListLocation, GALGAS_string ("total bit slice count is ").add_operation (var_shiftCount_10171.getter_string (SOURCE_FILE ("declaration-control-register.galgas", 307)), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 307)).add_operation (GALGAS_string (" (should be "), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 307)).add_operation (constinArgument_inRegisterBitCount.getter_string (SOURCE_FILE ("declaration-control-register.galgas", 307)), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 307)).add_operation (GALGAS_string (")"), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 307)), fixItArray2  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 306)) ;
    }
  }
}
...
void extensionMethod_enterControlRegistersInContext (const GALGAS_controlRegisterDeclarationListAST_2D_element inObject,
                                                     ...
                                                     C_Compiler * inCompiler
                                                     COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_PLMType var_registerType_12022 ;
  GALGAS_uint var_registerBitCount_12053 ;
  const GALGAS_controlRegisterDeclarationListAST_2D_element temp_0 = inObject ;
  extensionMethod_controlRegisterType (temp_0, ioArgument_ioContext, var_registerType_12022, var_registerBitCount_12053, inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 318)) ;
  GALGAS_controlRegisterFieldMap var_registerFieldMap_12221 ;
  GALGAS_sliceMap var_registerBitSliceMap_12250 ;
  GALGAS_controlRegisterFieldList var_controlRegisterFieldList_12284 ;
  const GALGAS_controlRegisterDeclarationListAST_2D_element temp_1 = inObject ;
  extensionMethod_buildControlRegisterSliceMap (temp_1, ioArgument_ioContext, var_registerType_12022, var_registerBitCount_12053, var_registerFieldMap_12221, var_registerBitSliceMap_12250, var_controlRegisterFieldList_12284, inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 320)) ;
  GALGAS_bigint var_maxRegisterAddress_12350 = GALGAS_bigint ("1", inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 329)).left_shift_operation (ioArgument_ioContext.getter_mPointerSize (HERE) COMMA_SOURCE_FILE ("declaration-control-register.galgas", 329)).substract_operation (GALGAS_bigint ("1", inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 329)), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 329)) ;
  cEnumerator_controlRegisterNameList enumerator_12424 (inObject.mProperty_mRegisterNameList, kENUMERATION_UP) ;
  while (enumerator_12424.hasCurrentObject ()) {
    GALGAS_bool var_isReadOnly_12472 = GALGAS_bool (false) ;
    GALGAS_bool var_isAccessibleInUserMode_12511 = GALGAS_bool (false) ;
    cEnumerator_lstringlist enumerator_12560 (enumerator_12424.current (HERE).getter_mAttributeList (HERE), kENUMERATION_UP) ;
    while (enumerator_12560.hasCurrentObject ()) {
      const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, enumerator_12560.current_mValue (HERE).getter_string (HERE).objectCompare (GALGAS_string ("ro"))).boolEnum () ;
      if (kBoolTrue == test_2) {
        const enumGalgasBool test_3 = var_isReadOnly_12472.boolEnum () ;
        if (kBoolTrue == test_3) {
          TC_Array <C_FixItDescription> fixItArray4 ;
          inCompiler->emitSemanticError (enumerator_12560.current_mValue (HERE).getter_location (SOURCE_FILE ("declaration-control-register.galgas", 337)), GALGAS_string ("duplicated attribute"), fixItArray4  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 337)) ;
        }else if (kBoolFalse == test_3) {
          var_isReadOnly_12472 = GALGAS_bool (true) ;
        }
      }else if (kBoolFalse == test_2) {
        const enumGalgasBool test_5 = GALGAS_bool (kIsEqual, enumerator_12560.current_mValue (HERE).getter_string (HERE).objectCompare (function_userModeName (inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 341)))).boolEnum () ;
        if (kBoolTrue == test_5) {
          const enumGalgasBool test_6 = var_isAccessibleInUserMode_12511.boolEnum () ;
          if (kBoolTrue == test_6) {
            TC_Array <C_FixItDescription> fixItArray7 ;
            inCompiler->emitSemanticError (enumerator_12560.current_mValue (HERE).getter_location (SOURCE_FILE ("declaration-control-register.galgas", 343)), GALGAS_string ("duplicated attribute"), fixItArray7  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 343)) ;
          }else if (kBoolFalse == test_6) {
            var_isAccessibleInUserMode_12511 = GALGAS_bool (true) ;
          }
        }else if (kBoolFalse == test_5) {
          TC_Array <C_FixItDescription> fixItArray8 ;
          inCompiler->emitSemanticError (enumerator_12560.current_mValue (HERE).getter_location (SOURCE_FILE ("declaration-control-register.galgas", 348)), GALGAS_string ("only @ro (read only) and @user (accessible in `user mode) attributes are accepted here"), fixItArray8  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 348)) ;
        }
      }
      enumerator_12560.gotoNextObject () ;
    }
    GALGAS_objectIR var_addressExpressionResult_13334 ;
    callExtensionMethod_analyzeStaticExpression ((const cPtr_expressionAST *) enumerator_12424.current (HERE).getter_mRegisterAddress (HERE).ptr (), enumerator_12424.current (HERE).getter_mRegisterAddressLocation (HERE), ioArgument_ioContext, ioArgument_ioGlobalLiteralStringMap, var_addressExpressionResult_13334, inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 352)) ;
    GALGAS_bigint var_registerAddress_13368 ;
    const enumGalgasBool test_9 = var_addressExpressionResult_13334.getter_isLiteralInteger (SOURCE_FILE ("declaration-control-register.galgas", 359)).operator_not (SOURCE_FILE ("declaration-control-register.galgas", 359)).boolEnum () ;
    if (kBoolTrue == test_9) {
      TC_Array <C_FixItDescription> fixItArray10 ;
      inCompiler->emitSemanticError (enumerator_12424.current (HERE).getter_mRegisterAddressLocation (HERE), GALGAS_string ("control register address is not a static integer expression"), fixItArray10  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 360)) ;
      var_registerAddress_13368.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_9) {
      GALGAS_PLMType joker_13628_1 ; // Joker input parameter
      var_addressExpressionResult_13334.method_literalInteger (joker_13628_1, var_registerAddress_13368, inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 364)) ;
      const enumGalgasBool test_11 = GALGAS_bool (kIsStrictSup, var_registerAddress_13368.objectCompare (var_maxRegisterAddress_12350)).boolEnum () ;
      if (kBoolTrue == test_11) {
        TC_Array <C_FixItDescription> fixItArray12 ;
        inCompiler->emitSemanticError (enumerator_12424.current (HERE).getter_mRegisterAddressLocation (HERE), GALGAS_string ("register address should be lower or equal to ").add_operation (var_maxRegisterAddress_12350.getter_hexString (SOURCE_FILE ("declaration-control-register.galgas", 368)), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 368)), fixItArray12  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 367)) ;
      }
    }
    GALGAS_bigint var_arraySize_13913 ;
    GALGAS_uint var_elementArraySize_13940 ;
    switch (enumerator_12424.current (HERE).getter_mControlRegisterKind (HERE).enumValue ()) {
    case GALGAS_controlRegisterKind::kNotBuilt:
      break ;
    case GALGAS_controlRegisterKind::kEnum_scalar:
      {
        var_arraySize_13913 = GALGAS_bigint ("0", inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 375)) ;
        var_elementArraySize_13940 = GALGAS_uint ((uint32_t) 0U) ;
      }
      break ;
    case GALGAS_controlRegisterKind::kEnum_registerArray:
      {
        const cEnumAssociatedValues_controlRegisterKind_registerArray * extractPtr_16013 = (const cEnumAssociatedValues_controlRegisterKind_registerArray *) (enumerator_12424.current (HERE).getter_mControlRegisterKind (HERE).unsafePointer ()) ;
        const GALGAS_expressionAST extractedValue_arraySizeExpression = extractPtr_16013->mAssociatedValue0 ;
        const GALGAS_location extractedValue_arraySizeLocation = extractPtr_16013->mAssociatedValue1 ;
        const GALGAS_expressionAST extractedValue_arrayElementSizeExpression = extractPtr_16013->mAssociatedValue2 ;
        const GALGAS_location extractedValue_arrayElementSizeLocation = extractPtr_16013->mAssociatedValue3 ;
        GALGAS_objectIR var_sizeExpressionResult_14507 ;
        callExtensionMethod_analyzeStaticExpression ((const cPtr_expressionAST *) extractedValue_arraySizeExpression.ptr (), extractedValue_arraySizeLocation, ioArgument_ioContext, ioArgument_ioGlobalLiteralStringMap, var_sizeExpressionResult_14507, inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 380)) ;
        const enumGalgasBool test_13 = var_sizeExpressionResult_14507.getter_isLiteralInteger (SOURCE_FILE ("declaration-control-register.galgas", 386)).operator_not (SOURCE_FILE ("declaration-control-register.galgas", 386)).boolEnum () ;
        if (kBoolTrue == test_13) {
          ...
          var_arraySize_13913.drop () ; // Release error dropped variable
        }else if (kBoolFalse == test_13) {
          GALGAS_PLMType joker_14739_1 ; // Joker input parameter
          var_sizeExpressionResult_14507.method_literalInteger (joker_14739_1, var_arraySize_13913, inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 389)) ;
          const enumGalgasBool test_15 = GALGAS_bool (kIsStrictInf, var_arraySize_13913.objectCompare (GALGAS_bigint ("2", inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 390)))).boolEnum () ;
          if (kBoolTrue == test_15) {
            ...
            GALGAS_uint var_powerOfTwoForArraySize_15008 = var_arraySize_13913.substract_operation (GALGAS_bigint ("1", inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 395)), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 395)).getter_bitCountForUnsignedRepresentation (SOURCE_FILE ("declaration-control-register.galgas", 395)) ;
            const enumGalgasBool test_17 = GALGAS_bool (kIsNotEqual, var_arraySize_13913.objectCompare (GALGAS_bigint ("1", inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 396)).left_shift_operation (var_powerOfTwoForArraySize_15008 COMMA_SOURCE_FILE ("declaration-control-register.galgas", 396)))).boolEnum () ;
        ...
        GALGAS_objectIR var_elementArraySizeExpressionResult_15627 ;
        callExtensionMethod_analyzeStaticExpression ((const cPtr_expressionAST *) extractedValue_arrayElementSizeExpression.ptr (), extractedValue_arrayElementSizeLocation, ioArgument_ioContext, ioArgument_ioGlobalLiteralStringMap, var_elementArraySizeExpressionResult_15627, inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 404)) ;
        const enumGalgasBool test_19 = var_elementArraySizeExpressionResult_15627.getter_isLiteralInteger (SOURCE_FILE ("declaration-control-register.galgas", 410)).operator_not (SOURCE_FILE ("declaration-control-register.galgas", 410)).boolEnum () ;
        if (kBoolTrue == test_19) {
          ...
          var_elementArraySize_13940.drop () ; // Release error dropped variable
        }else if (kBoolFalse == test_19) {
          GALGAS_bigint var_elementArraySizeAsBigInt_15943 ;
          GALGAS_PLMType joker_15905_1 ; // Joker input parameter
          var_elementArraySizeExpressionResult_15627.method_literalInteger (joker_15905_1, var_elementArraySizeAsBigInt_15943, inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 415)) ;
          var_elementArraySize_13940 = var_elementArraySizeAsBigInt_15943.getter_uint (inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 416)) ;
        }
      }
      break ;
    }
    {
    ioArgument_ioContext.mProperty_mControlRegisterMap.setter_insertKey (enumerator_12424.current (HERE).getter_mRegisterName (HERE), var_registerType_12022, var_isReadOnly_12472, var_isAccessibleInUserMode_12511, var_registerBitSliceMap_12250, var_registerFieldMap_12221, var_registerAddress_13368, var_controlRegisterFieldList_12284, var_registerBitCount_12053, var_arraySize_13913.getter_uint (inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 429)), var_elementArraySize_13940, inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 419)) ;
    }
...
void extensionMethod_semanticAnalysis (const GALGAS_globalVarDeclarationList_2D_element inObject,
                                       ...
                                       C_Compiler * inCompiler
                                       COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_PLMType var_inferredType_13323 ;
  GALGAS_stringset var_executionModeSet_13366 ;
  GALGAS_allowedGuardMap var_allowedGuardMap_13469 ;
  GALGAS_objectIR var_expressionGeneratedCode_13608 ;
  GALGAS_bool var_isConstant_13646 ;
  GALGAS_bool joker_13671 ; // Joker input parameter
  constinArgument_inContext.getter_mGlobalVariableMap (HERE).method_searchKey (inObject.mProperty_mVarName, var_inferredType_13323, var_executionModeSet_13366, var_allowedGuardMap_13469, var_expressionGeneratedCode_13608, var_isConstant_13646, joker_13671, inCompiler COMMA_SOURCE_FILE ("declaration-global-variable.galgas", 370)) ;
  {
  ioArgument_ioIntermediateCodeStruct.mProperty_mGlobalVariableMap.setter_insertKey (inObject.mProperty_mVarName, var_inferredType_13323, GALGAS_bool (kIsStrictSup, var_executionModeSet_13366.getter_count (SOURCE_FILE ("declaration-global-variable.galgas", 385)).objectCompare (GALGAS_uint ((uint32_t) 1U))), var_expressionGeneratedCode_13608, inCompiler COMMA_SOURCE_FILE ("declaration-global-variable.galgas", 382)) ;
  }
}
...
void extensionMethod_generateLLVM (const GALGAS_staticlistValues_5F_listMap inObject,
                                   ...
                                   C_Compiler * inCompiler
                                   COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_bool var_first_13198 = GALGAS_bool (true) ;
  const GALGAS_staticlistValues_5F_listMap temp_0 = inObject ;
  cEnumerator_staticlistValues_5F_listMap enumerator_13234 (temp_0, kENUMERATION_UP) ;
  while (enumerator_13234.hasCurrentObject ()) {
    const enumGalgasBool test_1 = constinArgument_inUsefulStaticArrayMap.getter_hasKey (enumerator_13234.current_key (HERE) COMMA_SOURCE_FILE ("declaration-extend-static-array.galgas", 294)).boolEnum () ;
    if (kBoolTrue == test_1) {
      const enumGalgasBool test_2 = var_first_13198.boolEnum () ;
      if (kBoolTrue == test_2) {
        var_first_13198 = GALGAS_bool (false) ;
        ioArgument_ioLLVMcode.plusAssign_operation(function_llvmTitleComment (GALGAS_string ("Static Arraies"), inCompiler COMMA_SOURCE_FILE ("declaration-extend-static-array.galgas", 297)), inCompiler  COMMA_SOURCE_FILE ("declaration-extend-static-array.galgas", 297)) ;
      }
      ioArgument_ioLLVMcode.plusAssign_operation(function_llvmNameForGlobalVariable (enumerator_13234.current_key (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-extend-static-array.galgas", 299)).add_operation (GALGAS_string (" = private unnamed_addr constant ["), inCompiler COMMA_SOURCE_FILE ("declaration-extend-static-array.galgas", 299)), inCompiler  COMMA_SOURCE_FILE ("declaration-extend-static-array.galgas", 299)) ;
      ioArgument_ioLLVMcode.plusAssign_operation(enumerator_13234.current_mList (HERE).getter_length (SOURCE_FILE ("declaration-extend-static-array.galgas", 300)).getter_string (SOURCE_FILE ("declaration-extend-static-array.galgas", 300)).add_operation (GALGAS_string (" x %$"), inCompiler COMMA_SOURCE_FILE ("declaration-extend-static-array.galgas", 300)).add_operation (function_llvmNameForStaticListElementType (enumerator_13234.current_key (HERE).getter_nowhere (SOURCE_FILE ("declaration-extend-static-array.galgas", 300)), inCompiler COMMA_SOURCE_FILE ("declaration-extend-static-array.galgas", 300)).getter_string (SOURCE_FILE ("declaration-extend-static-array.galgas", 300)), inCompiler COMMA_SOURCE_FILE ("declaration-extend-static-array.galgas", 300)).add_operation (GALGAS_string ("] [\n"), inCompiler COMMA_SOURCE_FILE ("declaration-extend-static-array.galgas", 300)), inCompiler  COMMA_SOURCE_FILE ("declaration-extend-static-array.galgas", 300)) ;
      cEnumerator_stringlist enumerator_13638 (enumerator_13234.current_mList (HERE), kENUMERATION_UP) ;
      while (enumerator_13638.hasCurrentObject ()) {
        ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  %$").add_operation (function_llvmNameForStaticListElementType (enumerator_13234.current_key (HERE).getter_nowhere (SOURCE_FILE ("declaration-extend-static-array.galgas", 303)), inCompiler COMMA_SOURCE_FILE ("declaration-extend-static-array.galgas", 303)).getter_string (SOURCE_FILE ("declaration-extend-static-array.galgas", 303)), inCompiler COMMA_SOURCE_FILE ("declaration-extend-static-array.galgas", 303)).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("declaration-extend-static-array.galgas", 303)).add_operation (enumerator_13638.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-extend-static-array.galgas", 303)), inCompiler  COMMA_SOURCE_FILE ("declaration-extend-static-array.galgas", 303)) ;
        if (enumerator_13638.hasNextObject ()) {
          ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string (",\n"), inCompiler  COMMA_SOURCE_FILE ("declaration-extend-static-array.galgas", 305)) ;
        }
        enumerator_13638.gotoNextObject () ;
      }
      ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("\n"
        "]\n"
        "\n"), inCompiler  COMMA_SOURCE_FILE ("declaration-extend-static-array.galgas", 307)) ;
    }
...
void extensionMethod_svcCodeGeneration (const GALGAS_routineMapIR inObject,
  ...
  cEnumerator_routineMapIR enumerator_10200 (temp_0, kENUMERATION_UP) ;
  while (enumerator_10200.hasCurrentObject ()) {
    const enumGalgasBool test_1 = enumerator_10200.current (HERE).getter_mKind (HERE).getter_isFunction (SOURCE_FILE ("declaration-svc.galgas", 279)).operator_not (SOURCE_FILE ("declaration-svc.galgas", 279)).boolEnum () ;
    if (kBoolTrue == test_1) {
      GALGAS_string var_svcCallName_10264 = function_llvmNameForSVCCall (enumerator_10200.current (HERE).getter_mRoutineNameForGeneration (HERE), enumerator_10200.current (HERE).getter_mKind (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-svc.galgas", 280)) ;
      GALGAS_string var_svcImplementationName_10361 = function_llvmNameForSVCImplementation (enumerator_10200.current (HERE).getter_mRoutineNameForGeneration (HERE), enumerator_10200.current (HERE).getter_mKind (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-svc.galgas", 281)) ;
      switch (enumerator_10200.current (HERE).getter_mKind (HERE).enumValue ()) {
      case GALGAS_routineKind::kNotBuilt:
        break ;
      case GALGAS_routineKind::kEnum_section:
      case GALGAS_routineKind::kEnum_safe:
        {
          ioArgument_ioSectionList.addAssign_operation (var_svcCallName_10264, var_svcImplementationName_10361, enumerator_10200.current (HERE).getter_mReceiverType (HERE), enumerator_10200.current (HERE).getter_mFormalArgumentListForGeneration (HERE), enumerator_10200.current (HERE).getter_mReturnType (HERE)  COMMA_SOURCE_FILE ("declaration-svc.galgas", 284)) ;
        }
        break ;
      case GALGAS_routineKind::kEnum_primitive:
      case GALGAS_routineKind::kEnum_service:
        {
          ioArgument_ioLLVMcode.plusAssign_operation(function_llvmTitleComment (var_svcCallName_10264, inCompiler COMMA_SOURCE_FILE ("declaration-svc.galgas", 291)), inCompiler  COMMA_SOURCE_FILE ("declaration-svc.galgas", 291)) ;
          GALGAS_string var_prototype_10779 = function_llvmFunctionPrototype (enumerator_10200.current (HERE).getter_mReturnType (HERE), var_svcCallName_10264, enumerator_10200.current (HERE).getter_mReceiverType (HERE), enumerator_10200.current (HERE).getter_mFormalArgumentListForGeneration (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-svc.galgas", 292)) ;
          ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("declare ").add_operation (var_prototype_10779, inCompiler COMMA_SOURCE_FILE ("declaration-svc.galgas", 298)).add_operation (GALGAS_string ("\n"
            "\n"), inCompiler COMMA_SOURCE_FILE ("declaration-svc.galgas", 298)), inCompiler  COMMA_SOURCE_FILE ("declaration-svc.galgas", 298)) ;
          ioArgument_ioPrimitiveAndServiceList.addAssign_operation (var_svcCallName_10264, var_svcImplementationName_10361  COMMA_SOURCE_FILE ("declaration-svc.galgas", 299)) ;
        }
        break ;
...
void extensionMethod_externProcedureSemanticAnalysis (const GALGAS_externProcedureDeclarationListAST_2D_element inObject,
                                                      ...
                                                      C_Compiler * inCompiler
                                                      COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_lstring var_routineMangledName_5286 = function_routineMangledNameFromAST (GALGAS_string::makeEmptyString (), inObject.mProperty_mExternProcedureName, inObject.mProperty_mProcFormalArgumentList, inCompiler COMMA_SOURCE_FILE ("declaration-extern-proc.galgas", 123)) ;
  GALGAS_universalPropertyAndRoutineMapForContext var_universalMap_5595 ;
  {
  routine_initialVariableMap (constinArgument_inContext, inObject.mProperty_mMode, GALGAS_bool (false), GALGAS_string::makeEmptyString ().getter_nowhere (SOURCE_FILE ("declaration-extern-proc.galgas", 133)), var_universalMap_5595, inCompiler  COMMA_SOURCE_FILE ("declaration-extern-proc.galgas", 129)) ;
  }
  GALGAS_routineFormalArgumentListForGeneration var_formalArguments_5687 = GALGAS_routineFormalArgumentListForGeneration::constructor_emptyList (SOURCE_FILE ("declaration-extern-proc.galgas", 138)) ;
  {
  routine_enterFormalArguments (constinArgument_inContext, inObject.mProperty_mProcFormalArgumentList, var_universalMap_5595, var_formalArguments_5687, inCompiler  COMMA_SOURCE_FILE ("declaration-extern-proc.galgas", 139)) ;
  }
  const enumGalgasBool test_0 = ioArgument_ioTemporaries.getter_mSubprogramInvocationGraph (HERE).getter_isNodeDefined (var_routineMangledName_5286.getter_string (HERE) COMMA_SOURCE_FILE ("declaration-extern-proc.galgas", 147)).operator_not (SOURCE_FILE ("declaration-extern-proc.galgas", 147)).boolEnum () ;
  if (kBoolTrue == test_0) {
    {
    ioArgument_ioTemporaries.mProperty_mSubprogramInvocationGraph.setter_addNode (var_routineMangledName_5286, var_routineMangledName_5286, inCompiler COMMA_SOURCE_FILE ("declaration-extern-proc.galgas", 148)) ;
    }
  }
  ...
  GALGAS_unifiedTypeMap_2D_proxy var_returnType_6124 = temp_1 ;
  {
  ioArgument_ioIntermediateCodeStruct.mProperty_mExternProcedureMapIR.setter_insertKey (inObject.mProperty_mRoutineNameForGeneration, var_formalArguments_5687, var_returnType_6124, inCompiler COMMA_SOURCE_FILE ("declaration-extern-proc.galgas", 160)) ;
  }
}
...
void extensionMethod_enterAccessibleEntities (const GALGAS_guardMapIR_2D_element inObject,
                                              ...
                                              C_Compiler * inCompiler
                                              COMMA_UNUSED_LOCATION_ARGS) {
  extensionMethod_enterAccessibleEntities (inObject.mProperty_mInstructionGenerationList, ioArgument_ioAccessibleEntities, ioArgument_ioMaxBranchOfOnInstructions, inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 632)) ;
  ...
  case GALGAS_guardKindGenerationIR::kEnum_convenienceGuard:
    {
      const cEnumAssociatedValues_guardKindGenerationIR_convenienceGuard * extractPtr_26544 = (const cEnumAssociatedValues_guardKindGenerationIR_convenienceGuard *) (inObject.mProperty_mGuardKindGenerationIR.unsafePointer ()) ;
      const GALGAS_instructionListIR extractedValue_baseGuardInstructionGenerationList = extractPtr_26544->mAssociatedValue1 ;
      const GALGAS_string extractedValue_baseGuardMangledName = extractPtr_26544->mAssociatedValue2 ;
      extensionMethod_enterAccessibleEntities (extractedValue_baseGuardInstructionGenerationList, ioArgument_ioAccessibleEntities, ioArgument_ioMaxBranchOfOnInstructions, inCompiler COMMA_SOURCE_FILE ("declaration-guard.galgas", 636)) ;
      ioArgument_ioAccessibleEntities.mProperty_mGuardSet.addAssign_operation (extractedValue_baseGuardMangledName  COMMA_SOURCE_FILE ("declaration-guard.galgas", 637)) ;
    }
    break ;
  }
}
...
void extensionMethod_checkBinaryOperationWith (const GALGAS_infixOperatorMap inObject,
  ...
  GALGAS_lstring var_lkey_2980 = function_combineTypeNamesForInfixOperator (extensionGetter_key (constinArgument_inLeftType, inCompiler COMMA_SOURCE_FILE ("expression-infix-operators.galgas", 71)), extensionGetter_key (constinArgument_inRightType, inCompiler COMMA_SOURCE_FILE ("expression-infix-operators.galgas", 71)), inCompiler COMMA_SOURCE_FILE ("expression-infix-operators.galgas", 71)) ;
  ...
  if (kBoolTrue == test_1) {
    ...
    inCompiler->emitSemanticError (constinArgument_inOperatorLocation, GALGAS_string ("infix operation between $").add_operation (extensionGetter_key (constinArgument_inLeftType, inCompiler COMMA_SOURCE_FILE ("expression-infix-operators.galgas", 76)), inCompiler COMMA_SOURCE_FILE ("expression-infix-operators.galgas", 76)).add_operation (GALGAS_string (" and $"), inCompiler COMMA_SOURCE_FILE ("expression-infix-operators.galgas", 76)).add_operation (extensionGetter_key (constinArgument_inRightType, inCompiler COMMA_SOURCE_FILE ("expression-infix-operators.galgas", 76)), inCompiler COMMA_SOURCE_FILE ("expression-infix-operators.galgas", 76)).add_operation (GALGAS_string (" is not defined"), inCompiler COMMA_SOURCE_FILE ("expression-infix-operators.galgas", 76)), fixItArray3  COMMA_SOURCE_FILE ("expression-infix-operators.galgas", 75)) ;
...
static void extensionMethod_primaryInExpressionAST_analyzePrimaryExpressionNoSelf (const cPtr_primaryInExpressionAST * inObject,
  ...
  GALGAS_possibleValuedObject var_entity_8592 ;
  callExtensionMethod_searchEntity ((const cPtr_universalPropertyAndRoutineMapForContext *) ioArgument_ioUniversalMap.ptr (), object->mProperty_mReceiverName, var_entity_8592, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 204)) ;
  switch (var_entity_8592.enumValue ()) {
  case GALGAS_possibleValuedObject::kNotBuilt:
    break ;
  case GALGAS_possibleValuedObject::kEnum_module:
    {
      const cEnumAssociatedValues_possibleValuedObject_module * extractPtr_9249 = (const cEnumAssociatedValues_possibleValuedObject_module *) (var_entity_8592.unsafePointer ()) ;
      const GALGAS_PLMType extractedValue_type = extractPtr_9249->mAssociatedValue0 ;
      outArgument_outResult = GALGAS_objectIR::constructor_reference (extractedValue_type, function_llvmNameForGlobalVariable (object->mProperty_mReceiverName.getter_string (SOURCE_FILE ("expression-primary.galgas", 207)), inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 207))  COMMA_SOURCE_FILE ("expression-primary.galgas", 207)) ;
      {
      routine_procAnalyzePrimaryExpression (constinArgument_inSelfType, constinArgument_inGuard, constinArgument_inCallerNameForInvocationGraph, constinArgument_inOptionalTargetType, constinArgument_inContext, constinArgument_inCurrentMode, ioArgument_ioTemporaries, ioArgument_ioGlobalLiteralStringMap, ioArgument_ioUniversalMap, ioArgument_ioAllocaList, ioArgument_ioInstructionGenerationList, object->mProperty_mAccessList, outArgument_outResult, inCompiler  COMMA_SOURCE_FILE ("expression-primary.galgas", 208)) ;
      }
    }
    break ;
  case GALGAS_possibleValuedObject::kEnum_register:
    {
      const cEnumAssociatedValues_possibleValuedObject_register * extractPtr_10150 = (const cEnumAssociatedValues_possibleValuedObject_register *) (var_entity_8592.unsafePointer ()) ;
      const GALGAS_bool extractedValue_readable = extractPtr_10150->mAssociatedValue0 ;
      const GALGAS_PLMType extractedValue_type = extractPtr_10150->mAssociatedValue2 ;
      const GALGAS_bigint extractedValue_address = extractPtr_10150->mAssociatedValue3 ;
      const GALGAS_sliceMap extractedValue_sliceMap = extractPtr_10150->mAssociatedValue4 ;
      const GALGAS_uint extractedValue_arraySize = extractPtr_10150->mAssociatedValue5 ;
      const GALGAS_uint extractedValue_elementSize = extractPtr_10150->mAssociatedValue6 ;
      const enumGalgasBool test_0 = extractedValue_readable.operator_not (SOURCE_FILE ("expression-primary.galgas", 224)).boolEnum () ;
      if (kBoolTrue == test_0) {
        TC_Array <C_FixItDescription> fixItArray1 ;
        inCompiler->emitSemanticError (object->mProperty_mReceiverName.getter_location (SOURCE_FILE ("expression-primary.galgas", 225)), GALGAS_string ("control register is not readable in this context"), fixItArray1  COMMA_SOURCE_FILE ("expression-primary.galgas", 225)) ;
        outArgument_outResult.drop () ; // Release error dropped variable
      }else if (kBoolFalse == test_0) {
        const enumGalgasBool test_2 = constinArgument_inGuard.boolEnum () ;
        if (kBoolTrue == test_2) {
          TC_Array <C_FixItDescription> fixItArray3 ;
          inCompiler->emitSemanticError (object->mProperty_mReceiverName.getter_location (SOURCE_FILE ("expression-primary.galgas", 227)), GALGAS_string ("control register is not readable in guard"), fixItArray3  COMMA_SOURCE_FILE ("expression-primary.galgas", 227)) ;
          outArgument_outResult.drop () ; // Release error dropped variable
        }else if (kBoolFalse == test_2) {
          {
          routine_analyzeRegisterExpression (constinArgument_inSelfType, constinArgument_inCallerNameForInvocationGraph, constinArgument_inContext, constinArgument_inCurrentMode, ioArgument_ioTemporaries, ioArgument_ioGlobalLiteralStringMap, ioArgument_ioUniversalMap, ioArgument_ioAllocaList, ioArgument_ioInstructionGenerationList, extractedValue_type, extractedValue_address, extractedValue_sliceMap, extractedValue_arraySize, extractedValue_elementSize, object->mProperty_mAccessList, outArgument_outResult, inCompiler  COMMA_SOURCE_FILE ("expression-primary.galgas", 229)) ;
          }
        }
      }
    }
  ...
  case GALGAS_possibleValuedObject::kEnum_globalConstant:
    {
      const cEnumAssociatedValues_possibleValuedObject_globalConstant * extractPtr_10220 = (const cEnumAssociatedValues_possibleValuedObject_globalConstant *) (var_entity_8592.unsafePointer ()) ;
      const GALGAS_objectIR extractedValue_objectIR = extractPtr_10220->mAssociatedValue0 ;
      outArgument_outResult = extractedValue_objectIR ;
    }
    break ;
  case GALGAS_possibleValuedObject::kEnum_localConstant:
    {
      const cEnumAssociatedValues_possibleValuedObject_localConstant * extractPtr_10918 = (const cEnumAssociatedValues_possibleValuedObject_localConstant *) (var_entity_8592.unsafePointer ()) ;
      const GALGAS_PLMType extractedValue_type = extractPtr_10918->mAssociatedValue0 ;
      const GALGAS_lstring extractedValue_plmName = extractPtr_10918->mAssociatedValue1 ;
      {
      ioArgument_ioUniversalMap.insulate (HERE) ;
      cPtr_universalPropertyAndRoutineMapForContext * ptr_10298 = (cPtr_universalPropertyAndRoutineMapForContext *) ioArgument_ioUniversalMap.ptr () ;
      callExtensionSetter_readAccess ((cPtr_universalPropertyAndRoutineMapForContext *) ptr_10298, object->mProperty_mReceiverName, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 251)) ;
      }
      outArgument_outResult = GALGAS_objectIR::constructor_reference (extractedValue_type, function_llvmNameForLocalVariable (extractedValue_plmName.getter_string (SOURCE_FILE ("expression-primary.galgas", 252)), inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 252))  COMMA_SOURCE_FILE ("expression-primary.galgas", 252)) ;
      {
  ...
  case GALGAS_possibleValuedObject::kEnum_globalVariable:
    {
      const cEnumAssociatedValues_possibleValuedObject_globalVariable * extractPtr_11610 = (const cEnumAssociatedValues_possibleValuedObject_globalVariable *) (var_entity_8592.unsafePointer ()) ;
      const GALGAS_PLMType extractedValue_type = extractPtr_11610->mAssociatedValue1 ;
      {
      ioArgument_ioUniversalMap.insulate (HERE) ;
      cPtr_universalPropertyAndRoutineMapForContext * ptr_10982 = (cPtr_universalPropertyAndRoutineMapForContext *) ioArgument_ioUniversalMap.ptr () ;
      callExtensionSetter_readAccess ((cPtr_universalPropertyAndRoutineMapForContext *) ptr_10982, object->mProperty_mReceiverName, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 269)) ;
      }
  ...
  case GALGAS_possibleValuedObject::kEnum_localVariable:
    {
      const cEnumAssociatedValues_possibleValuedObject_localVariable * extractPtr_12309 = (const cEnumAssociatedValues_possibleValuedObject_localVariable *) (var_entity_8592.unsafePointer ()) ;
      const GALGAS_PLMType extractedValue_type = extractPtr_12309->mAssociatedValue0 ;
      const GALGAS_lstring extractedValue_plmName = extractPtr_12309->mAssociatedValue1 ;
      outArgument_outResult = GALGAS_objectIR::constructor_reference (extractedValue_type, function_llvmNameForLocalVariable (extractedValue_plmName.getter_string (SOURCE_FILE ("expression-primary.galgas", 287)), inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 287))  COMMA_SOURCE_FILE ("expression-primary.galgas", 287)) ;
      {
      ioArgument_ioUniversalMap.insulate (HERE) ;
      cPtr_universalPropertyAndRoutineMapForContext * ptr_11775 = (cPtr_universalPropertyAndRoutineMapForContext *) ioArgument_ioUniversalMap.ptr () ;
      callExtensionSetter_readAccess ((cPtr_universalPropertyAndRoutineMapForContext *) ptr_11775, object->mProperty_mReceiverName, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 288)) ;
      }
      {
      routine_procAnalyzePrimaryExpression (constinArgument_inSelfType, constinArgument_inGuard, constinArgument_inCallerNameForInvocationGraph, constinArgument_inOptionalTargetType, constinArgument_inContext, constinArgument_inCurrentMode, ioArgument_ioTemporaries, ioArgument_ioGlobalLiteralStringMap, ioArgument_ioUniversalMap, ioArgument_ioAllocaList, ioArgument_ioInstructionGenerationList, object->mProperty_mAccessList, outArgument_outResult, inCompiler  COMMA_SOURCE_FILE ("expression-primary.galgas", 289)) ;
      }
    }
    break ;
  case GALGAS_possibleValuedObject::kEnum_undefined:
    {
      TC_Array <C_FixItDescription> fixItArray4 ;
      inCompiler->emitSemanticError (object->mProperty_mReceiverName.getter_location (SOURCE_FILE ("expression-primary.galgas", 305)), GALGAS_string ("undefined \?\?\?"), fixItArray4  COMMA_SOURCE_FILE ("expression-primary.galgas", 305)) ;
      outArgument_outResult.drop () ; // Release error dropped variable
    }
    break ;
  }
...
static void extensionMethod_primaryInExpressionAST_analyzePrimaryExpressionWithSelf (const cPtr_primaryInExpressionAST * inObject,
  ...
  const cPtr_primaryInExpressionAST * object = inObject ;
  macroValidSharedObject (object, cPtr_primaryInExpressionAST) ;
  outArgument_outResult = GALGAS_objectIR::constructor_reference (constinArgument_inSelfType, function_llvmNameForSelf (inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 496))  COMMA_SOURCE_FILE ("expression-primary.galgas", 496)) ;
  cEnumerator_primaryInExpressionAccessListAST enumerator_19997 (object->mProperty_mAccessList, kENUMERATION_UP) ;
  while (enumerator_19997.hasCurrentObject ()) {
    switch (enumerator_19997.current_mAccess (HERE).enumValue ()) {
    case GALGAS_primaryInExpressionAccessAST::kNotBuilt:
      break ;
    case GALGAS_primaryInExpressionAccessAST::kEnum_property:
      {
        const cEnumAssociatedValues_primaryInExpressionAccessAST_property * extractPtr_20498 = (const cEnumAssociatedValues_primaryInExpressionAccessAST_property *) (enumerator_19997.current_mAccess (HERE).unsafePointer ()) ;
        const GALGAS_lstring extractedValue_propertyName = extractPtr_20498->mAssociatedValue0 ;
        {
    ...
    case GALGAS_primaryInExpressionAccessAST::kEnum_arrayAccess:
      {
        const cEnumAssociatedValues_primaryInExpressionAccessAST_arrayAccess * extractPtr_21118 = (const cEnumAssociatedValues_primaryInExpressionAccessAST_arrayAccess *) (enumerator_19997.current_mAccess (HERE).unsafePointer ()) ;
        const GALGAS_expressionAST extractedValue_indexExpression = extractPtr_21118->mAssociatedValue0 ;
        const GALGAS_location extractedValue_endOfIndex = extractPtr_21118->mAssociatedValue1 ;
        {
    ...
    case GALGAS_primaryInExpressionAccessAST::kEnum_funcCall:
      {
        const cEnumAssociatedValues_primaryInExpressionAccessAST_funcCall * extractPtr_21817 = (const cEnumAssociatedValues_primaryInExpressionAccessAST_funcCall *) (enumerator_19997.current_mAccess (HERE).unsafePointer ()) ;
        const GALGAS_lstring extractedValue_methodName = extractPtr_21817->mAssociatedValue0 ;
        const GALGAS_effectiveArgumentListAST extractedValue_arguments = extractPtr_21817->mAssociatedValue1 ;
        const GALGAS_location extractedValue_errorLocation = extractPtr_21817->mAssociatedValue2 ;
        const enumGalgasBool test_0 = constinArgument_inGuard.boolEnum () ;
        if (kBoolTrue == test_0) {
          TC_Array <C_FixItDescription> fixItArray1 ;
          inCompiler->emitSemanticError (extractedValue_errorLocation, GALGAS_string ("a method cannot be called in guard"), fixItArray1  COMMA_SOURCE_FILE ("expression-primary.galgas", 532)) ;
          outArgument_outResult.drop () ; // Release error dropped variable
        }else if (kBoolFalse == test_0) {
          {
...
void extensionMethod_type (const GALGAS_LValueAST inObject,
  ...
  while (enumerator_3907.hasCurrentObject ()) {
    ...
    case GALGAS_accessInAssignmentAST::kEnum_property:
      {
        const cEnumAssociatedValues_accessInAssignmentAST_property * extractPtr_4511 = (const cEnumAssociatedValues_accessInAssignmentAST_property *) (enumerator_3907.current_mAccess (HERE).unsafePointer ()) ;
        const GALGAS_lstring extractedValue_propertyName = extractPtr_4511->mAssociatedValue0 ;
        ...
        if (kBoolTrue == test_1) {
          ...
          GALGAS_guardMapForContext joker_4083_1 ; // Joker input parameter
          ...
          GALGAS_propertyAccessKind var_accessKind_4150 ;
          GALGAS_bool joker_4133 ; // Joker input parameter
          var_propertyMap_4081.method_searchKey (extractedValue_propertyName, joker_4133, var_accessKind_4150, inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 102)) ;
          switch (var_accessKind_4150.enumValue ()) {
          case GALGAS_propertyAccessKind::kNotBuilt:
            break ;
          case GALGAS_propertyAccessKind::kEnum_constant:
            {
              const cEnumAssociatedValues_propertyAccessKind_constant * extractPtr_4235 = (const cEnumAssociatedValues_propertyAccessKind_constant *) (var_accessKind_4150.unsafePointer ()) ;
              const GALGAS_PLMType extractedValue_type = extractPtr_4235->mAssociatedValue0 ;
              outArgument_outType = extractedValue_type ;
            }
            break ;
          case GALGAS_propertyAccessKind::kEnum_indexed:
            {
              const cEnumAssociatedValues_propertyAccessKind_indexed * extractPtr_4293 = (const cEnumAssociatedValues_propertyAccessKind_indexed *) (var_accessKind_4150.unsafePointer ()) ;
              const GALGAS_PLMType extractedValue_type = extractPtr_4293->mAssociatedValue0 ;
              outArgument_outType = extractedValue_type ;
            }
            break ;
          case GALGAS_propertyAccessKind::kEnum_nonVirtualMethod:
            {
              TC_Array <C_FixItDescription> fixItArray2 ;
              inCompiler->emitSemanticError (extractedValue_propertyName.getter_location (SOURCE_FILE ("lvalue.galgas", 109)), GALGAS_string ("a method cannot be used in this context"), fixItArray2  COMMA_SOURCE_FILE ("lvalue.galgas", 109)) ;
          ...
          TC_Array <C_FixItDescription> fixItArray3 ;
          inCompiler->emitSemanticError (extractedValue_propertyName.getter_location (SOURCE_FILE ("lvalue.galgas", 112)), GALGAS_string ("receiver has no property"), fixItArray3  COMMA_SOURCE_FILE ("lvalue.galgas", 112)) ;
          outArgument_outType.drop () ; // Release error dropped variable
        }
      }
      break ;
    case GALGAS_accessInAssignmentAST::kEnum_arrayAccess:
      {
        const enumGalgasBool test_4 = outArgument_outType.getter_isArrayType (SOURCE_FILE ("lvalue.galgas", 115)).boolEnum () ;
        if (kBoolTrue == test_4) {
          GALGAS_lstring joker_4605_1 ; // Joker input parameter
          GALGAS_bigint joker_4630_4 ; // Joker input parameter
          GALGAS_constantMap joker_4630_3 ; // Joker input parameter
          GALGAS_PLMTypeFlags joker_4630_2 ; // Joker input parameter
          GALGAS_string joker_4630_1 ; // Joker input parameter
          outArgument_outType.method_arrayType (joker_4605_1, outArgument_outType, joker_4630_4, joker_4630_3, joker_4630_2, joker_4630_1, inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 116)) ;
        }
      }
      break ;
    }
...
void extensionMethod_analyzeLValue (const GALGAS_LValueAST inObject,
  ...
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, inObject.mProperty_mIdentifier.getter_string (HERE).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
  if (kBoolTrue == test_0) {
    const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, constinArgument_inSelfType.objectCompare (GALGAS_PLMType::constructor_void (SOURCE_FILE ("lvalue.galgas", 138)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      TC_Array <C_FixItDescription> fixItArray2 ;
      inCompiler->emitSemanticError (inObject.mProperty_mIdentifier.getter_location (SOURCE_FILE ("lvalue.galgas", 139)), GALGAS_string ("self is not available in this context"), fixItArray2  COMMA_SOURCE_FILE ("lvalue.galgas", 139)) ;
      outArgument_outInternalRepresentation.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_1) {
      {
      routine_analyzeSelfAssignmentTarget (constinArgument_inSelfType, constinArgument_inCallerNameForInvocationGraph, constinArgument_inContext, constinArgument_inCurrentMode, ioArgument_ioTemporaries, ioArgument_ioGlobalLiteralStringMap, ioArgument_ioUniversalMap, ioArgument_ioAllocaList, ioArgument_ioInstructionGenerationList, inObject.mProperty_mIdentifier.getter_location (HERE), inObject.mProperty_mAccessList, outArgument_outInternalRepresentation, inCompiler  COMMA_SOURCE_FILE ("lvalue.galgas", 141)) ;
      }
    }
  }else if (kBoolFalse == test_0) {
    GALGAS_possibleValuedObject var_entity_6194 ;
    callExtensionMethod_searchEntity ((const cPtr_universalPropertyAndRoutineMapForContext *) ioArgument_ioUniversalMap.ptr (), inObject.mProperty_mIdentifier, var_entity_6194, inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 157)) ;
    switch (var_entity_6194.enumValue ()) {
    case GALGAS_possibleValuedObject::kNotBuilt:
      break ;
    case GALGAS_possibleValuedObject::kEnum_undefined:
      {
        TC_Array <C_FixItDescription> fixItArray3 ;
        inCompiler->emitSemanticError (inObject.mProperty_mIdentifier.getter_location (SOURCE_FILE ("lvalue.galgas", 160)), GALGAS_string ("undefined identifier"), fixItArray3  COMMA_SOURCE_FILE ("lvalue.galgas", 160)) ;
        outArgument_outInternalRepresentation.drop () ; // Release error dropped variable
      }
      break ;
    case GALGAS_possibleValuedObject::kEnum_module:
      {
        TC_Array <C_FixItDescription> fixItArray4 ;
        inCompiler->emitSemanticError (inObject.mProperty_mIdentifier.getter_location (SOURCE_FILE ("lvalue.galgas", 162)), GALGAS_string ("a module cannot be written"), fixItArray4  COMMA_SOURCE_FILE ("lvalue.galgas", 162)) ;
        outArgument_outInternalRepresentation.drop () ; // Release error dropped variable
      }
      break ;
    case GALGAS_possibleValuedObject::kEnum_register:
      {
        const cEnumAssociatedValues_possibleValuedObject_register * extractPtr_7216 = (const cEnumAssociatedValues_possibleValuedObject_register *) (var_entity_6194.unsafePointer ()) ;
        const GALGAS_bool extractedValue_writable = extractPtr_7216->mAssociatedValue1 ;
        const GALGAS_PLMType extractedValue_registerType = extractPtr_7216->mAssociatedValue2 ;
        const GALGAS_bigint extractedValue_registerAddress = extractPtr_7216->mAssociatedValue3 ;
        const GALGAS_uint extractedValue_arraySize = extractPtr_7216->mAssociatedValue5 ;
        const GALGAS_uint extractedValue_elementSize = extractPtr_7216->mAssociatedValue6 ;
        {
        routine_analyzeControlRegisterInLValue (constinArgument_inSelfType, constinArgument_inCallerNameForInvocationGraph, constinArgument_inContext, constinArgument_inCurrentMode, ioArgument_ioTemporaries, ioArgument_ioGlobalLiteralStringMap, ioArgument_ioUniversalMap, ioArgument_ioAllocaList, ioArgument_ioInstructionGenerationList, inObject.mProperty_mIdentifier, extractedValue_registerType, extractedValue_writable, extractedValue_registerAddress.getter_uint (inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 177)), extractedValue_arraySize, extractedValue_elementSize, inObject.mProperty_mAccessList, outArgument_outInternalRepresentation, inCompiler  COMMA_SOURCE_FILE ("lvalue.galgas", 164)) ;
        }
      }
      break ;
    case GALGAS_possibleValuedObject::kEnum_globalConstant:
      {
        TC_Array <C_FixItDescription> fixItArray5 ;
        inCompiler->emitSemanticError (inObject.mProperty_mIdentifier.getter_location (SOURCE_FILE ("lvalue.galgas", 184)), GALGAS_string ("a global constant cannot be written"), fixItArray5  COMMA_SOURCE_FILE ("lvalue.galgas", 184)) ;
        outArgument_outInternalRepresentation.drop () ; // Release error dropped variable
      }
      break ;
    case GALGAS_possibleValuedObject::kEnum_localConstant:
      {
        ...
        inCompiler->emitSemanticError (inObject.mProperty_mIdentifier.getter_location (SOURCE_FILE ("lvalue.galgas", 186)), GALGAS_string ("a local constant cannot be written"), fixItArray6  COMMA_SOURCE_FILE ("lvalue.galgas", 186)) ;
        outArgument_outInternalRepresentation.drop () ; // Release error dropped variable
      }
      break ;
    case GALGAS_possibleValuedObject::kEnum_globalVariable:
      {
        const cEnumAssociatedValues_possibleValuedObject_globalVariable * extractPtr_8395 = (const cEnumAssociatedValues_possibleValuedObject_globalVariable *) (var_entity_6194.unsafePointer ()) ;
        const GALGAS_bool extractedValue_writable = extractPtr_8395->mAssociatedValue0 ;
        const GALGAS_PLMType extractedValue_variableType = extractPtr_8395->mAssociatedValue1 ;
        const enumGalgasBool test_7 = extractedValue_writable.operator_not (SOURCE_FILE ("lvalue.galgas", 188)).boolEnum () ;
        if (kBoolTrue == test_7) {
          TC_Array <C_FixItDescription> fixItArray8 ;
          inCompiler->emitSemanticError (inObject.mProperty_mIdentifier.getter_location (SOURCE_FILE ("lvalue.galgas", 189)), GALGAS_string ("a global variable cannot be written in this context"), fixItArray8  COMMA_SOURCE_FILE ("lvalue.galgas", 189)) ;
          outArgument_outInternalRepresentation.drop () ; // Release error dropped variable
        }else if (kBoolFalse == test_7) {
          {
          extensionSetter_appendNoteGlobalVariableAccess (ioArgument_ioInstructionGenerationList, inObject.mProperty_mIdentifier.getter_string (SOURCE_FILE ("lvalue.galgas", 191)), inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 191)) ;
          }
          {
          routine_analyzeVariableInLValue (constinArgument_inSelfType, constinArgument_inCallerNameForInvocationGraph, constinArgument_inContext, constinArgument_inCurrentMode, ioArgument_ioTemporaries, ioArgument_ioGlobalLiteralStringMap, ioArgument_ioUniversalMap, ioArgument_ioAllocaList, ioArgument_ioInstructionGenerationList, inObject.mProperty_mIdentifier, function_llvmNameForGlobalVariable (inObject.mProperty_mIdentifier.getter_string (SOURCE_FILE ("lvalue.galgas", 203)), inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 203)), extractedValue_variableType, inObject.mProperty_mAccessList, outArgument_outInternalRepresentation, inCompiler  COMMA_SOURCE_FILE ("lvalue.galgas", 192)) ;
          }
        }
      }
      break ;
    case GALGAS_possibleValuedObject::kEnum_localVariable:
      {
        const cEnumAssociatedValues_possibleValuedObject_localVariable * extractPtr_9053 = (const cEnumAssociatedValues_possibleValuedObject_localVariable *) (var_entity_6194.unsafePointer ()) ;
        ...
        {
        routine_analyzeVariableInLValue (constinArgument_inSelfType, constinArgument_inCallerNameForInvocationGraph, constinArgument_inContext, constinArgument_inCurrentMode, ioArgument_ioTemporaries, ioArgument_ioGlobalLiteralStringMap, ioArgument_ioUniversalMap, ioArgument_ioAllocaList, ioArgument_ioInstructionGenerationList, inObject.mProperty_mIdentifier, function_llvmNameForLocalVariable (extractedValue_plmName.getter_string (SOURCE_FILE ("lvalue.galgas", 221)), inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 221)), extractedValue_variableType, inObject.mProperty_mAccessList, outArgument_outInternalRepresentation, inCompiler  COMMA_SOURCE_FILE ("lvalue.galgas", 210)) ;
        }
      }
      break ;
    }
...
static void extensionSetter_universalPropertyAndRoutineMapForContext_insertModule (cPtr_universalPropertyAndRoutineMapForContext * inObject,
  ...
  GALGAS_possibleValuedObject var_newValue_1036 = GALGAS_possibleValuedObject::constructor_module (constinArgument_inModuleType  COMMA_SOURCE_FILE ("universal-map.galgas", 22)) ;
  cMapElement_internalUniversalPropertyAndRoutineMapForContext * objectArray_1095 = (cMapElement_internalUniversalPropertyAndRoutineMapForContext *) object->mProperty_mInternalPropertyAndRoutineMapForContext.readWriteAccessForWithInstruction (inCompiler, constinArgument_inModuleName.getter_string (HERE)  COMMA_SOURCE_FILE ("universal-map.galgas", 23)) ;
  if (NULL != objectArray_1095) {
      macroValidSharedObject (objectArray_1095, cMapElement_internalUniversalPropertyAndRoutineMapForContext) ;
    const enumGalgasBool test_0 = objectArray_1095->mProperty_mPossibleValuedObject.getter_isUndefined (SOURCE_FILE ("universal-map.galgas", 24)).boolEnum () ;
    if (kBoolTrue == test_0) {
      objectArray_1095->mProperty_mPossibleValuedObject = var_newValue_1036 ;
    }else if (kBoolFalse == test_0) {
      TC_Array <C_FixItDescription> fixItArray1 ;
      inCompiler->emitSemanticError (constinArgument_inModuleName.getter_location (SOURCE_FILE ("universal-map.galgas", 27)), GALGAS_string ("object already defined in this context"), fixItArray1  COMMA_SOURCE_FILE ("universal-map.galgas", 27)) ;
    }
  }else{
    {
    object->mProperty_mInternalPropertyAndRoutineMapForContext.setter_insertKey (constinArgument_inModuleName, GALGAS_valuedObjectState::constructor_noValue (SOURCE_FILE ("universal-map.galgas", 32)), GALGAS_bool (false), var_newValue_1036, inCompiler COMMA_SOURCE_FILE ("universal-map.galgas", 30)) ;
    }
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void extensionSetter_universalPropertyAndRoutineMapForContext_insertRegister (cPtr_universalPropertyAndRoutineMapForContext * inObject,
  ...
  cPtr_universalPropertyAndRoutineMapForContext * object = inObject ;
  macroValidSharedObject (object, cPtr_universalPropertyAndRoutineMapForContext) ;
  GALGAS_possibleValuedObject var_newValue_1973 = GALGAS_possibleValuedObject::constructor_register (constinArgument_inReadable, constinArgument_inWritable, constinArgument_inType, constinArgument_inAddress, constinArgument_inSliceMap, constinArgument_inArraySize, constinArgument_inElementSize  COMMA_SOURCE_FILE ("universal-map.galgas", 51)) ;
  cMapElement_internalUniversalPropertyAndRoutineMapForContext * objectArray_2212 = (cMapElement_internalUniversalPropertyAndRoutineMapForContext *) object->mProperty_mInternalPropertyAndRoutineMapForContext.readWriteAccessForWithInstruction (inCompiler, constinArgument_inRegisterName.getter_string (HERE)  COMMA_SOURCE_FILE ("universal-map.galgas", 60)) ;
  if (NULL != objectArray_2212) {
      macroValidSharedObject (objectArray_2212, cMapElement_internalUniversalPropertyAndRoutineMapForContext) ;
    const enumGalgasBool test_0 = objectArray_2212->mProperty_mPossibleValuedObject.getter_isUndefined (SOURCE_FILE ("universal-map.galgas", 61)).boolEnum () ;
    if (kBoolTrue == test_0) {
      objectArray_2212->mProperty_mPossibleValuedObject = var_newValue_1973 ;
    }else if (kBoolFalse == test_0) {
      TC_Array <C_FixItDescription> fixItArray1 ;
      inCompiler->emitSemanticError (constinArgument_inRegisterName.getter_location (SOURCE_FILE ("universal-map.galgas", 64)), GALGAS_string ("object already defined in this context"), fixItArray1  COMMA_SOURCE_FILE ("universal-map.galgas", 64)) ;
    }
  }else{
    {
    object->mProperty_mInternalPropertyAndRoutineMapForContext.setter_insertKey (constinArgument_inRegisterName, GALGAS_valuedObjectState::constructor_noValue (SOURCE_FILE ("universal-map.galgas", 69)), GALGAS_bool (false), var_newValue_1973, inCompiler COMMA_SOURCE_FILE ("universal-map.galgas", 67)) ;
    }
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void extensionSetter_universalPropertyAndRoutineMapForContext_insertGlobalConstant (cPtr_universalPropertyAndRoutineMapForContext * inObject,
  ...
  cPtr_universalPropertyAndRoutineMapForContext * object = inObject ;
  macroValidSharedObject (object, cPtr_universalPropertyAndRoutineMapForContext) ;
  GALGAS_possibleValuedObject var_newValue_2880 = GALGAS_possibleValuedObject::constructor_globalConstant (constinArgument_inConstantObjectIR  COMMA_SOURCE_FILE ("universal-map.galgas", 82)) ;
  cMapElement_internalUniversalPropertyAndRoutineMapForContext * objectArray_2957 = (cMapElement_internalUniversalPropertyAndRoutineMapForContext *) object->mProperty_mInternalPropertyAndRoutineMapForContext.readWriteAccessForWithInstruction (inCompiler, constinArgument_inConstantName.getter_string (HERE)  COMMA_SOURCE_FILE ("universal-map.galgas", 83)) ;
  if (NULL != objectArray_2957) {
      macroValidSharedObject (objectArray_2957, cMapElement_internalUniversalPropertyAndRoutineMapForContext) ;
    const enumGalgasBool test_0 = objectArray_2957->mProperty_mPossibleValuedObject.getter_isUndefined (SOURCE_FILE ("universal-map.galgas", 84)).boolEnum () ;
    if (kBoolTrue == test_0) {
      objectArray_2957->mProperty_mPossibleValuedObject = var_newValue_2880 ;
    }else if (kBoolFalse == test_0) {
      TC_Array <C_FixItDescription> fixItArray1 ;
      inCompiler->emitSemanticError (constinArgument_inConstantName.getter_location (SOURCE_FILE ("universal-map.galgas", 87)), GALGAS_string ("object already defined in this context"), fixItArray1  COMMA_SOURCE_FILE ("universal-map.galgas", 87)) ;
    }
  }else{
    {
    object->mProperty_mInternalPropertyAndRoutineMapForContext.setter_insertKey (constinArgument_inConstantName, GALGAS_valuedObjectState::constructor_noValue (SOURCE_FILE ("universal-map.galgas", 92)), GALGAS_bool (false), var_newValue_2880, inCompiler COMMA_SOURCE_FILE ("universal-map.galgas", 90)) ;
    }
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void extensionSetter_universalPropertyAndRoutineMapForContext_insertLocalConstant (cPtr_universalPropertyAndRoutineMapForContext * inObject,
  ...
  cPtr_universalPropertyAndRoutineMapForContext * object = inObject ;
  macroValidSharedObject (object, cPtr_universalPropertyAndRoutineMapForContext) ;
  GALGAS_possibleValuedObject var_newValue_3650 = GALGAS_possibleValuedObject::constructor_localConstant (constinArgument_inType, constinArgument_inPLMConstantName  COMMA_SOURCE_FILE ("universal-map.galgas", 106)) ;
  cMapElement_internalUniversalPropertyAndRoutineMapForContext * objectArray_3737 = (cMapElement_internalUniversalPropertyAndRoutineMapForContext *) object->mProperty_mInternalPropertyAndRoutineMapForContext.readWriteAccessForWithInstruction (inCompiler, constinArgument_inLocalConstantName.getter_string (HERE)  COMMA_SOURCE_FILE ("universal-map.galgas", 107)) ;
  if (NULL != objectArray_3737) {
      macroValidSharedObject (objectArray_3737, cMapElement_internalUniversalPropertyAndRoutineMapForContext) ;
    const enumGalgasBool test_0 = objectArray_3737->mProperty_mPossibleValuedObject.getter_isUndefined (SOURCE_FILE ("universal-map.galgas", 108)).boolEnum () ;
    if (kBoolTrue == test_0) {
      objectArray_3737->mProperty_mObjectState = GALGAS_valuedObjectState::constructor_hasUnreadValue (SOURCE_FILE ("universal-map.galgas", 109)) ;
      objectArray_3737->mProperty_mPossibleValuedObject = var_newValue_3650 ;
    }else if (kBoolFalse == test_0) {
      TC_Array <C_FixItDescription> fixItArray1 ;
      inCompiler->emitSemanticError (constinArgument_inLocalConstantName.getter_location (SOURCE_FILE ("universal-map.galgas", 112)), GALGAS_string ("object already defined in this context"), fixItArray1  COMMA_SOURCE_FILE ("universal-map.galgas", 112)) ;
    }
  }else{
    {
    object->mProperty_mInternalPropertyAndRoutineMapForContext.setter_insertKey (constinArgument_inLocalConstantName, GALGAS_valuedObjectState::constructor_hasUnreadValue (SOURCE_FILE ("universal-map.galgas", 117)), GALGAS_bool (false), var_newValue_3650, inCompiler COMMA_SOURCE_FILE ("universal-map.galgas", 115)) ;
    }
  }
  object->mProperty_mLocalObjectList.addAssign_operation (constinArgument_inLocalConstantName  COMMA_SOURCE_FILE ("universal-map.galgas", 122)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void extensionSetter_universalPropertyAndRoutineMapForContext_insertUsedLocalConstant (cPtr_universalPropertyAndRoutineMapForContext * inObject,
  ...
  cPtr_universalPropertyAndRoutineMapForContext * object = inObject ;
  macroValidSharedObject (object, cPtr_universalPropertyAndRoutineMapForContext) ;
  GALGAS_possibleValuedObject var_newValue_4536 = GALGAS_possibleValuedObject::constructor_localConstant (constinArgument_inType, constinArgument_inPLMConstantName  COMMA_SOURCE_FILE ("universal-map.galgas", 132)) ;
  cMapElement_internalUniversalPropertyAndRoutineMapForContext * objectArray_4623 = (cMapElement_internalUniversalPropertyAndRoutineMapForContext *) object->mProperty_mInternalPropertyAndRoutineMapForContext.readWriteAccessForWithInstruction (inCompiler, constinArgument_inLocalConstantName.getter_string (HERE)  COMMA_SOURCE_FILE ("universal-map.galgas", 133)) ;
  if (NULL != objectArray_4623) {
      macroValidSharedObject (objectArray_4623, cMapElement_internalUniversalPropertyAndRoutineMapForContext) ;
    const enumGalgasBool test_0 = objectArray_4623->mProperty_mPossibleValuedObject.getter_isUndefined (SOURCE_FILE ("universal-map.galgas", 134)).boolEnum () ;
    if (kBoolTrue == test_0) {
      objectArray_4623->mProperty_mObjectState = GALGAS_valuedObjectState::constructor_hasReadValue (SOURCE_FILE ("universal-map.galgas", 135)) ;
      objectArray_4623->mProperty_mPossibleValuedObject = var_newValue_4536 ;
    }else if (kBoolFalse == test_0) {
      TC_Array <C_FixItDescription> fixItArray1 ;
      inCompiler->emitSemanticError (constinArgument_inLocalConstantName.getter_location (SOURCE_FILE ("universal-map.galgas", 138)), GALGAS_string ("object already defined in this context"), fixItArray1  COMMA_SOURCE_FILE ("universal-map.galgas", 138)) ;
    }
  }else{
    {
    object->mProperty_mInternalPropertyAndRoutineMapForContext.setter_insertKey (constinArgument_inLocalConstantName, GALGAS_valuedObjectState::constructor_hasReadValue (SOURCE_FILE ("universal-map.galgas", 143)), GALGAS_bool (false), var_newValue_4536, inCompiler COMMA_SOURCE_FILE ("universal-map.galgas", 141)) ;
    }
  }
  object->mProperty_mLocalObjectList.addAssign_operation (constinArgument_inLocalConstantName  COMMA_SOURCE_FILE ("universal-map.galgas", 148)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void extensionSetter_universalPropertyAndRoutineMapForContext_insertGlobalVariable (cPtr_universalPropertyAndRoutineMapForContext * inObject,
  ...
  cPtr_universalPropertyAndRoutineMapForContext * object = inObject ;
  macroValidSharedObject (object, cPtr_universalPropertyAndRoutineMapForContext) ;
  GALGAS_possibleValuedObject var_newValue_5406 = GALGAS_possibleValuedObject::constructor_globalVariable (constinArgument_inWritable, constinArgument_inType  COMMA_SOURCE_FILE ("universal-map.galgas", 158)) ;
  cMapElement_internalUniversalPropertyAndRoutineMapForContext * objectArray_5488 = (cMapElement_internalUniversalPropertyAndRoutineMapForContext *) object->mProperty_mInternalPropertyAndRoutineMapForContext.readWriteAccessForWithInstruction (inCompiler, constinArgument_inGlobalVariableName.getter_string (HERE)  COMMA_SOURCE_FILE ("universal-map.galgas", 159)) ;
  if (NULL != objectArray_5488) {
      macroValidSharedObject (objectArray_5488, cMapElement_internalUniversalPropertyAndRoutineMapForContext) ;
    const enumGalgasBool test_0 = objectArray_5488->mProperty_mPossibleValuedObject.getter_isUndefined (SOURCE_FILE ("universal-map.galgas", 160)).boolEnum () ;
    if (kBoolTrue == test_0) {
      objectArray_5488->mProperty_mPossibleValuedObject = var_newValue_5406 ;
    }else if (kBoolFalse == test_0) {
      TC_Array <C_FixItDescription> fixItArray1 ;
      inCompiler->emitSemanticError (constinArgument_inGlobalVariableName.getter_location (SOURCE_FILE ("universal-map.galgas", 163)), GALGAS_string ("object already defined in this context"), fixItArray1  COMMA_SOURCE_FILE ("universal-map.galgas", 163)) ;
    }
  }else{
    {
    object->mProperty_mInternalPropertyAndRoutineMapForContext.setter_insertKey (constinArgument_inGlobalVariableName, GALGAS_valuedObjectState::constructor_noValue (SOURCE_FILE ("universal-map.galgas", 168)), GALGAS_bool (false), var_newValue_5406, inCompiler COMMA_SOURCE_FILE ("universal-map.galgas", 166)) ;
    }
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void extensionSetter_universalPropertyAndRoutineMapForContext_insertLocalVariable (cPtr_universalPropertyAndRoutineMapForContext * inObject,
  ...
  cPtr_universalPropertyAndRoutineMapForContext * object = inObject ;
  macroValidSharedObject (object, cPtr_universalPropertyAndRoutineMapForContext) ;
  GALGAS_possibleValuedObject var_newValue_6288 = GALGAS_possibleValuedObject::constructor_localVariable (constinArgument_inType, constinArgument_inPLMName  COMMA_SOURCE_FILE ("universal-map.galgas", 184)) ;
  cMapElement_internalUniversalPropertyAndRoutineMapForContext * objectArray_6367 = (cMapElement_internalUniversalPropertyAndRoutineMapForContext *) object->mProperty_mInternalPropertyAndRoutineMapForContext.readWriteAccessForWithInstruction (inCompiler, constinArgument_inLocalVariableName.getter_string (HERE)  COMMA_SOURCE_FILE ("universal-map.galgas", 185)) ;
  if (NULL != objectArray_6367) {
      macroValidSharedObject (objectArray_6367, cMapElement_internalUniversalPropertyAndRoutineMapForContext) ;
    const enumGalgasBool test_0 = objectArray_6367->mProperty_mPossibleValuedObject.getter_isUndefined (SOURCE_FILE ("universal-map.galgas", 186)).boolEnum () ;
    if (kBoolTrue == test_0) {
      objectArray_6367->mProperty_mObjectState = constinArgument_inVariableInitialState ;
      objectArray_6367->mProperty_mObjectShouldBeValuedAtEndOfScope = constinArgument_inObjectShouldBeValuedAtEndOfScope ;
      objectArray_6367->mProperty_mPossibleValuedObject = var_newValue_6288 ;
    }else if (kBoolFalse == test_0) {
      TC_Array <C_FixItDescription> fixItArray1 ;
      inCompiler->emitSemanticError (constinArgument_inLocalVariableName.getter_location (SOURCE_FILE ("universal-map.galgas", 191)), GALGAS_string ("object already defined in this context"), fixItArray1  COMMA_SOURCE_FILE ("universal-map.galgas", 191)) ;
    }
  }else{
    {
    object->mProperty_mInternalPropertyAndRoutineMapForContext.setter_insertKey (constinArgument_inLocalVariableName, constinArgument_inVariableInitialState, constinArgument_inObjectShouldBeValuedAtEndOfScope, var_newValue_6288, inCompiler COMMA_SOURCE_FILE ("universal-map.galgas", 194)) ;
    }
  }
  object->mProperty_mLocalObjectList.addAssign_operation (constinArgument_inLocalVariableName  COMMA_SOURCE_FILE ("universal-map.galgas", 201)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void extensionMethod_universalPropertyAndRoutineMapForContext_searchEntity (const cPtr_universalPropertyAndRoutineMapForContext * inObject,
  ...
  macroValidSharedObject (object, cPtr_universalPropertyAndRoutineMapForContext) ;
  GALGAS_valuedObjectState joker_7452_2 ; // Joker input parameter
  GALGAS_bool joker_7452_1 ; // Joker input parameter
  object->mProperty_mInternalPropertyAndRoutineMapForContext.method_searchKey (constinArgument_inValuedObjectName, joker_7452_2, joker_7452_1, outArgument_outEntity, inCompiler COMMA_SOURCE_FILE ("universal-map.galgas", 212)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void extensionMethod_universalPropertyAndRoutineMapForContext_searchValuedObject (const cPtr_universalPropertyAndRoutineMapForContext * inObject,
  ...
  const cPtr_universalPropertyAndRoutineMapForContext * object = inObject ;
  macroValidSharedObject (object, cPtr_universalPropertyAndRoutineMapForContext) ;
  GALGAS_possibleValuedObject var_entity_7811 ;
  GALGAS_valuedObjectState joker_7797_2 ; // Joker input parameter
  GALGAS_bool joker_7797_1 ; // Joker input parameter
  object->mProperty_mInternalPropertyAndRoutineMapForContext.method_searchKey (constinArgument_inValuedObjectName, joker_7797_2, joker_7797_1, var_entity_7811, inCompiler COMMA_SOURCE_FILE ("universal-map.galgas", 221)) ;
  switch (var_entity_7811.enumValue ()) {
  case GALGAS_possibleValuedObject::kNotBuilt:
    break ;
  case GALGAS_possibleValuedObject::kEnum_undefined:
    {
      TC_Array <C_FixItDescription> fixItArray0 ;
      inCompiler->emitSemanticError (constinArgument_inValuedObjectName.getter_location (SOURCE_FILE ("universal-map.galgas", 224)), GALGAS_string ("undefined in this context"), fixItArray0  COMMA_SOURCE_FILE ("universal-map.galgas", 224)) ;
      outArgument_outObjectIR.drop () ; // Release error dropped variable
    }
    break ;
  case GALGAS_possibleValuedObject::kEnum_module:
    {
      const cEnumAssociatedValues_possibleValuedObject_module * extractPtr_8052 = (const cEnumAssociatedValues_possibleValuedObject_module *) (var_entity_7811.unsafePointer ()) ;
      const GALGAS_PLMType extractedValue_type = extractPtr_8052->mAssociatedValue0 ;
  ...
  case GALGAS_possibleValuedObject::kEnum_register:
    {
      TC_Array <C_FixItDescription> fixItArray1 ;
      inCompiler->emitSemanticError (constinArgument_inValuedObjectName.getter_location (SOURCE_FILE ("universal-map.galgas", 228)), GALGAS_string ("control register \?"), fixItArray1  COMMA_SOURCE_FILE ("universal-map.galgas", 228)) ;
      outArgument_outObjectIR.drop () ; // Release error dropped variable
    }
    break ;
  case GALGAS_possibleValuedObject::kEnum_globalConstant:
    {
      const cEnumAssociatedValues_possibleValuedObject_globalConstant * extractPtr_8224 = (const cEnumAssociatedValues_possibleValuedObject_globalConstant *) (var_entity_7811.unsafePointer ()) ;
      const GALGAS_objectIR extractedValue_objectIR = extractPtr_8224->mAssociatedValue0 ;
      outArgument_outObjectIR = extractedValue_objectIR ;
    }
    break ;
  case GALGAS_possibleValuedObject::kEnum_localConstant:
    {
      const cEnumAssociatedValues_possibleValuedObject_localConstant * extractPtr_8377 = (const cEnumAssociatedValues_possibleValuedObject_localConstant *) (var_entity_7811.unsafePointer ()) ;
      const GALGAS_PLMType extractedValue_type = extractPtr_8377->mAssociatedValue0 ;
      const GALGAS_lstring extractedValue_plmName = extractPtr_8377->mAssociatedValue1 ;
  ...
  case GALGAS_possibleValuedObject::kEnum_globalVariable:
    {
      const cEnumAssociatedValues_possibleValuedObject_globalVariable * extractPtr_8519 = (const cEnumAssociatedValues_possibleValuedObject_globalVariable *) (var_entity_7811.unsafePointer ()) ;
      const GALGAS_PLMType extractedValue_type = extractPtr_8519->mAssociatedValue1 ;
      outArgument_outObjectIR = GALGAS_objectIR::constructor_reference (extractedValue_type, function_llvmNameForGlobalVariable (constinArgument_inValuedObjectName.getter_string (SOURCE_FILE ("universal-map.galgas", 234)), inCompiler COMMA_SOURCE_FILE ("universal-map.galgas", 234))  COMMA_SOURCE_FILE ("universal-map.galgas", 234)) ;
    }
    break ;
  case GALGAS_possibleValuedObject::kEnum_localVariable:
    {
      const cEnumAssociatedValues_possibleValuedObject_localVariable * extractPtr_8672 = (const cEnumAssociatedValues_possibleValuedObject_localVariable *) (var_entity_7811.unsafePointer ()) ;
      const GALGAS_PLMType extractedValue_type = extractPtr_8672->mAssociatedValue0 ;
      const GALGAS_lstring extractedValue_plmName = extractPtr_8672->mAssociatedValue1 ;
      outArgument_outObjectIR = GALGAS_objectIR::constructor_reference (extractedValue_type, function_llvmNameForLocalVariable (extractedValue_plmName.getter_string (SOURCE_FILE ("universal-map.galgas", 236)), inCompiler COMMA_SOURCE_FILE ("universal-map.galgas", 236))  COMMA_SOURCE_FILE ("universal-map.galgas", 236)) ;
    }
    break ;
  }
}
...
static void extensionSetter_universalPropertyAndRoutineMapForContext_readAccess (cPtr_universalPropertyAndRoutineMapForContext * inObject,
  ...
  cPtr_universalPropertyAndRoutineMapForContext * object = inObject ;
  macroValidSharedObject (object, cPtr_universalPropertyAndRoutineMapForContext) ;
  GALGAS_valuedObjectState var_valueState_8988 ;
  GALGAS_possibleValuedObject var_property_9005 ;
  GALGAS_bool joker_8990 ; // Joker input parameter
  object->mProperty_mInternalPropertyAndRoutineMapForContext.method_searchKey (constinArgument_inValuedObjectName, var_valueState_8988, joker_8990, var_property_9005, inCompiler COMMA_SOURCE_FILE ("universal-map.galgas", 243)) ;
  switch (var_property_9005.enumValue ()) {
  case GALGAS_possibleValuedObject::kNotBuilt:
    break ;
  case GALGAS_possibleValuedObject::kEnum_undefined:
    {
      TC_Array <C_FixItDescription> fixItArray0 ;
      inCompiler->emitSemanticError (constinArgument_inValuedObjectName.getter_location (SOURCE_FILE ("universal-map.galgas", 246)), GALGAS_string ("undefined in this context"), fixItArray0  COMMA_SOURCE_FILE ("universal-map.galgas", 246)) ;
    }
    break ;
  case GALGAS_possibleValuedObject::kEnum_module:
    {
  ...
  case GALGAS_possibleValuedObject::kEnum_localConstant:
    {
      const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, var_valueState_8988.objectCompare (GALGAS_valuedObjectState::constructor_hasUnreadValue (SOURCE_FILE ("universal-map.galgas", 251)))).boolEnum () ;
      if (kBoolTrue == test_1) {
        {
        object->mProperty_mInternalPropertyAndRoutineMapForContext.setter_setMObjectStateForKey (GALGAS_valuedObjectState::constructor_hasReadValue (SOURCE_FILE ("universal-map.galgas", 252)), constinArgument_inValuedObjectName.getter_string (SOURCE_FILE ("universal-map.galgas", 252)), inCompiler COMMA_SOURCE_FILE ("universal-map.galgas", 252)) ;
        }
      }
    }
    break ;
  ...
  case GALGAS_possibleValuedObject::kEnum_localVariable:
    {
      switch (var_valueState_8988.enumValue ()) {
      case GALGAS_valuedObjectState::kNotBuilt:
        break ;
      case GALGAS_valuedObjectState::kEnum_noValue:
        {
          TC_Array <C_FixItDescription> fixItArray2 ;
          inCompiler->emitSemanticError (constinArgument_inValuedObjectName.getter_location (SOURCE_FILE ("universal-map.galgas", 258)), GALGAS_string ("'").add_operation (constinArgument_inValuedObjectName.getter_string (SOURCE_FILE ("universal-map.galgas", 258)), inCompiler COMMA_SOURCE_FILE ("universal-map.galgas", 258)).add_operation (GALGAS_string ("' has no value"), inCompiler COMMA_SOURCE_FILE ("universal-map.galgas", 258)), fixItArray2  COMMA_SOURCE_FILE ("universal-map.galgas", 258)) ;
        }
        break ;
      case GALGAS_valuedObjectState::kEnum_hasUnreadValue:
        {
          {
          object->mProperty_mInternalPropertyAndRoutineMapForContext.setter_setMObjectStateForKey (GALGAS_valuedObjectState::constructor_hasReadValue (SOURCE_FILE ("universal-map.galgas", 260)), constinArgument_inValuedObjectName.getter_string (SOURCE_FILE ("universal-map.galgas", 260)), inCompiler COMMA_SOURCE_FILE ("universal-map.galgas", 260)) ;
          }
        }
        break ;
...
static void extensionSetter_universalPropertyAndRoutineMapForContext_writeAccess (cPtr_universalPropertyAndRoutineMapForContext * inObject,
  ...
  GALGAS_possibleValuedObject var_property_10049 ;
  GALGAS_bool joker_10034 ; // Joker input parameter
  object->mProperty_mInternalPropertyAndRoutineMapForContext.method_searchKey (constinArgument_inValuedObjectName, var_valueState_10032, joker_10034, var_property_10049, inCompiler COMMA_SOURCE_FILE ("universal-map.galgas", 269)) ;
  ...
  case GALGAS_possibleValuedObject::kEnum_undefined:
    {
      TC_Array <C_FixItDescription> fixItArray0 ;
      inCompiler->emitSemanticError (constinArgument_inValuedObjectName.getter_location (SOURCE_FILE ("universal-map.galgas", 272)), GALGAS_string ("undefined in this context"), fixItArray0  COMMA_SOURCE_FILE ("universal-map.galgas", 272)) ;
    }
    break ;
  case GALGAS_possibleValuedObject::kEnum_module:
    {
      TC_Array <C_FixItDescription> fixItArray1 ;
      inCompiler->emitSemanticError (constinArgument_inValuedObjectName.getter_location (SOURCE_FILE ("universal-map.galgas", 274)), GALGAS_string ("a module cannot be written"), fixItArray1  COMMA_SOURCE_FILE ("universal-map.galgas", 274)) ;
    }
    break ;
  case GALGAS_possibleValuedObject::kEnum_register:
    {
      const cEnumAssociatedValues_possibleValuedObject_register * extractPtr_10380 = (const cEnumAssociatedValues_possibleValuedObject_register *) (var_property_10049.unsafePointer ()) ;
      const GALGAS_bool extractedValue_writable = extractPtr_10380->mAssociatedValue1 ;
      const enumGalgasBool test_2 = extractedValue_writable.operator_not (SOURCE_FILE ("universal-map.galgas", 276)).boolEnum () ;
      if (kBoolTrue == test_2) {
        TC_Array <C_FixItDescription> fixItArray3 ;
        inCompiler->emitSemanticError (constinArgument_inValuedObjectName.getter_location (SOURCE_FILE ("universal-map.galgas", 277)), GALGAS_string ("the control register cannot be written"), fixItArray3  COMMA_SOURCE_FILE ("universal-map.galgas", 277)) ;
      }
    }
    break ;
  case GALGAS_possibleValuedObject::kEnum_globalConstant:
    {
      TC_Array <C_FixItDescription> fixItArray4 ;
      inCompiler->emitSemanticError (constinArgument_inValuedObjectName.getter_location (SOURCE_FILE ("universal-map.galgas", 280)), GALGAS_string ("a constant cannot be written"), fixItArray4  COMMA_SOURCE_FILE ("universal-map.galgas", 280)) ;
    }
    break ;
  case GALGAS_possibleValuedObject::kEnum_localConstant:
    {
      TC_Array <C_FixItDescription> fixItArray5 ;
      inCompiler->emitSemanticError (constinArgument_inValuedObjectName.getter_location (SOURCE_FILE ("universal-map.galgas", 282)), GALGAS_string ("a constant cannot be written"), fixItArray5  COMMA_SOURCE_FILE ("universal-map.galgas", 282)) ;
    }
    break ;
  case GALGAS_possibleValuedObject::kEnum_globalVariable:
    {
      const cEnumAssociatedValues_possibleValuedObject_globalVariable * extractPtr_10708 = (const cEnumAssociatedValues_possibleValuedObject_globalVariable *) (var_property_10049.unsafePointer ()) ;
      const GALGAS_bool extractedValue_writable = extractPtr_10708->mAssociatedValue0 ;
      const enumGalgasBool test_6 = extractedValue_writable.operator_not (SOURCE_FILE ("universal-map.galgas", 284)).boolEnum () ;
      if (kBoolTrue == test_6) {
        TC_Array <C_FixItDescription> fixItArray7 ;
        inCompiler->emitSemanticError (constinArgument_inValuedObjectName.getter_location (SOURCE_FILE ("universal-map.galgas", 285)), GALGAS_string ("a global variable cannot be written"), fixItArray7  COMMA_SOURCE_FILE ("universal-map.galgas", 285)) ;
      }
    }
    break ;
  case GALGAS_possibleValuedObject::kEnum_localVariable:
    {
      ...
      case GALGAS_valuedObjectState::kEnum_hasReadValue:
        {
          {
          object->mProperty_mInternalPropertyAndRoutineMapForContext.setter_setMObjectStateForKey (GALGAS_valuedObjectState::constructor_hasUnreadValue (SOURCE_FILE ("universal-map.galgas", 290)), constinArgument_inValuedObjectName.getter_string (SOURCE_FILE ("universal-map.galgas", 290)), inCompiler COMMA_SOURCE_FILE ("universal-map.galgas", 290)) ;
          }
        }
        break ;
      case GALGAS_valuedObjectState::kEnum_hasUnreadValue:
        {
          TC_Array <C_FixItDescription> fixItArray8 ;
          inCompiler->emitSemanticWarning (constinArgument_inValuedObjectName.getter_location (SOURCE_FILE ("universal-map.galgas", 292)), GALGAS_string ("previous '").add_operation (constinArgument_inValuedObjectName.getter_string (SOURCE_FILE ("universal-map.galgas", 292)), inCompiler COMMA_SOURCE_FILE ("universal-map.galgas", 292)).add_operation (GALGAS_string ("' value has not been read"), inCompiler COMMA_SOURCE_FILE ("universal-map.galgas", 292)), fixItArray8  COMMA_SOURCE_FILE ("universal-map.galgas", 292)) ;
        }
        break ;
      }
    }
