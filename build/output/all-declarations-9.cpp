...
void routine_compileProject (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  GALGAS_declarationListAST var_declarationList_3713 = var_ast_2876.mProperty_mDeclarationListAST ;
  ...
  GALGAS_extensionDeclarationListAST var_extensionDeclarationListAST_3823 = var_ast_2876.mProperty_mExtensionDeclarationListAST ;
  ...
  var_ast_2876.mProperty_mDeclarationListAST = var_newDeclarationList_3784 ;
  ...
  {
  routine_buildOrderedDeclarationList (var_ast_2876, constinArgument_inSourceFile.mProperty_string, constinArgument_inEndOfSourceFile, var_orderedDeclarationListAST_4554, inCompiler  COMMA_SOURCE_FILE ("program.galgas", 111)) ;
  }
  cEnumerator_lstringlist enumerator_4707 (var_ast_2876.mProperty_mCheckTargetListAST, kENUMERATION_UP) ;
  while (enumerator_4707.hasCurrentObject ()) {
    const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, enumerator_4707.current_mValue (HERE).mProperty_string.objectCompare (constinArgument_inTargetName.getter_string (SOURCE_FILE ("program.galgas", 119)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      TC_Array <C_FixItDescription> fixItArray2 ;
  ...
  if (kBoolTrue == test_3) {
    ...
    if (kBoolTrue == test_4) {
      ...
      {
      routine_semanticAnalysis (constinArgument_inSourceFile.mProperty_string, var_ast_2876, var_semanticContext_5364, constinArgument_inEndOfSourceFile, var_globalLiteralStringMap_5033, var_intermediateCodeStruct_5708, inCompiler  COMMA_SOURCE_FILE ("program.galgas", 137)) ;
      }
      ...
      if (kBoolTrue == test_5) {
        ...
        {
        routine_codeGeneration (constinArgument_inCurrentDirectory, constinArgument_inSourceFile.mProperty_string, constinArgument_inEndOfSourceFile, var_intermediateCodeStruct_5708, var_semanticContext_5364.mProperty_mTypeMap, constinArgument_inTargetName, var_semanticContext_5364.mProperty_mPanicCodeType, var_semanticContext_5364.mProperty_mPanicLineType, var_semanticContext_5364.mProperty_mAvailableInterruptMap, var_staticListValueMap_5087, var_sourceFileAbsolutePathSet_2923, inCompiler  COMMA_SOURCE_FILE ("program.galgas", 148)) ;
        }
      }
    }
  }
...
void routine_addTargetSpecificFiles (const GALGAS_lstring constinArgument_inTargetName,
  ...
  ioArgument_ioAST.mProperty_mDeclarationListAST = var_ast_6768.mProperty_mDeclarationListAST.add_operation (ioArgument_ioAST.mProperty_mDeclarationListAST, inCompiler COMMA_SOURCE_FILE ("program.galgas", 194)) ;
  ioArgument_ioAST.mProperty_mGlobalVarDeclarationListAST = var_ast_6768.mProperty_mGlobalVarDeclarationListAST.add_operation (ioArgument_ioAST.mProperty_mGlobalVarDeclarationListAST, inCompiler COMMA_SOURCE_FILE ("program.galgas", 195)) ;
  ioArgument_ioAST.mProperty_mControlRegisterDeclarationListAST = var_ast_6768.mProperty_mControlRegisterDeclarationListAST.add_operation (ioArgument_ioAST.mProperty_mControlRegisterDeclarationListAST, inCompiler COMMA_SOURCE_FILE ("program.galgas", 196)) ;
  ioArgument_ioAST.mProperty_mExtensionDeclarationListAST = var_ast_6768.mProperty_mExtensionDeclarationListAST.add_operation (ioArgument_ioAST.mProperty_mExtensionDeclarationListAST, inCompiler COMMA_SOURCE_FILE ("program.galgas", 197)) ;
  ioArgument_ioAST.mProperty_mProcedureListAST = var_ast_6768.mProperty_mProcedureListAST.add_operation (ioArgument_ioAST.mProperty_mProcedureListAST, inCompiler COMMA_SOURCE_FILE ("program.galgas", 198)) ;
  ioArgument_ioAST.mProperty_mRequiredProcListAST = var_ast_6768.mProperty_mRequiredProcListAST.add_operation (ioArgument_ioAST.mProperty_mRequiredProcListAST, inCompiler COMMA_SOURCE_FILE ("program.galgas", 199)) ;
  ioArgument_ioAST.mProperty_mExternProcListAST = var_ast_6768.mProperty_mExternProcListAST.add_operation (ioArgument_ioAST.mProperty_mExternProcListAST, inCompiler COMMA_SOURCE_FILE ("program.galgas", 200)) ;
  ioArgument_ioAST.mProperty_mStandAloneSVCListAST = var_ast_6768.mProperty_mStandAloneSVCListAST.add_operation (ioArgument_ioAST.mProperty_mStandAloneSVCListAST, inCompiler COMMA_SOURCE_FILE ("program.galgas", 201)) ;
  ioArgument_ioAST.mProperty_mGuardListAST = var_ast_6768.mProperty_mGuardListAST.add_operation (ioArgument_ioAST.mProperty_mGuardListAST, inCompiler COMMA_SOURCE_FILE ("program.galgas", 202)) ;
  ioArgument_ioAST.mProperty_mTargetListAST.plusAssign_operation(var_ast_6768.mProperty_mTargetListAST, inCompiler  COMMA_SOURCE_FILE ("program.galgas", 203)) ;
  ioArgument_ioAST.mProperty_mInitListAST.plusAssign_operation(var_ast_6768.mProperty_mInitListAST, inCompiler  COMMA_SOURCE_FILE ("program.galgas", 204)) ;
  ioArgument_ioAST.mProperty_mBootListAST.plusAssign_operation(var_ast_6768.mProperty_mBootListAST, inCompiler  COMMA_SOURCE_FILE ("program.galgas", 205)) ;
  ioArgument_ioAST.mProperty_mPanicClauseListAST.plusAssign_operation(var_ast_6768.mProperty_mPanicClauseListAST, inCompiler  COMMA_SOURCE_FILE ("program.galgas", 206)) ;
  ioArgument_ioAST.mProperty_mISRDeclarationListAST = var_ast_6768.mProperty_mISRDeclarationListAST.add_operation (ioArgument_ioAST.mProperty_mISRDeclarationListAST, inCompiler COMMA_SOURCE_FILE ("program.galgas", 208)) ;
  ioArgument_ioAST.mProperty_mTaskListAST = var_ast_6768.mProperty_mTaskListAST.add_operation (ioArgument_ioAST.mProperty_mTaskListAST, inCompiler COMMA_SOURCE_FILE ("program.galgas", 209)) ;
}
...
void routine_recursiveImportFileSystemTargetFiles (GALGAS_ast & ioArgument_ioAST,
  ...
  while (enumerator_9271.hasCurrentObject ()) {
    GALGAS_string var_absolutePath_9295 = constinArgument_inTargetDirectory.add_operation (GALGAS_string ("/"), inCompiler COMMA_SOURCE_FILE ("program.galgas", 221)).add_operation (enumerator_9271.current_mValue (HERE).mProperty_string, inCompiler COMMA_SOURCE_FILE ("program.galgas", 221)) ;
    ...
    if (kBoolTrue == test_0) {
      ...
      if (kBoolTrue == test_1) {
        ...
        if (kBoolTrue == test_2) {
          ...
          cGrammar_plm_5F_grammar::_performSourceFileParsing_ (inCompiler, GALGAS_lstring::constructor_new (var_absolutePath_9295, enumerator_9271.current_mValue (HERE).mProperty_location  COMMA_SOURCE_FILE ("program.galgas", 226)), ioArgument_ioAST, var_importedFileList_9701, joker_9731  COMMA_SOURCE_FILE ("program.galgas", 226)) ;
          {
...
void routine_recursiveImportEmbeddedTargetFiles (GALGAS_ast & ioArgument_ioAST,
  ...
  while (enumerator_11025.hasCurrentObject ()) {
    ...
    const enumGalgasBool test_0 = var_fw_11052.getter_fileExistsAtPath (enumerator_11025.current_mValue (HERE).mProperty_string, inCompiler COMMA_SOURCE_FILE ("program.galgas", 266)).boolEnum () ;
    if (kBoolTrue == test_0) {
      ...
      if (kBoolTrue == test_1) {
        ...
        const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, enumerator_11025.current_mValue (HERE).mProperty_string.getter_pathExtension (SOURCE_FILE ("program.galgas", 270)).objectCompare (GALGAS_string ("plm"))).boolEnum () ;
        if (kBoolTrue == test_2) {
          ...
          cGrammar_plm_5F_grammar::_performSourceStringParsing_ (inCompiler, var_fw_11052.getter_textFileContentsAtPath (enumerator_11025.current_mValue (HERE).mProperty_string, inCompiler COMMA_SOURCE_FILE ("program.galgas", 271)), enumerator_11025.current_mValue (HERE).mProperty_string, ioArgument_ioAST, var_importedFileList_11499, joker_11529  COMMA_SOURCE_FILE ("program.galgas", 271)) ;
          {
          ...
          const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, enumerator_11025.current_mValue (HERE).mProperty_string.getter_pathExtension (SOURCE_FILE ("program.galgas", 280)).objectCompare (GALGAS_string ("plm-target"))).boolEnum () ;
          if (kBoolTrue == test_3) {
            ...
            cGrammar_plm_5F_target_5F_grammar::_performSourceStringParsing_ (inCompiler, var_fw_11052.getter_textFileContentsAtPath (enumerator_11025.current_mValue (HERE).mProperty_string, inCompiler COMMA_SOURCE_FILE ("program.galgas", 281)), enumerator_11025.current_mValue (HERE).mProperty_string, ioArgument_ioAST, var_importedFileList_11947, joker_11977  COMMA_SOURCE_FILE ("program.galgas", 281)) ;
            {
...
void routine_recursiveImportFiles (GALGAS_ast & ioArgument_ioAST,
  ...
  while (enumerator_12749.hasCurrentObject ()) {
    GALGAS_string var_absolutePath_12773 = enumerator_12749.current_mValue (HERE).mProperty_string.getter_absolutePathFromPath (inArgument_inCurrentDirectory COMMA_SOURCE_FILE ("program.galgas", 309)) ;
    ...
    if (kBoolTrue == test_0) {
      ...
      const enumGalgasBool test_5 = var_fw_14106.getter_fileExistsAtPath (enumerator_12749.current_mValue (HERE).mProperty_string, inCompiler COMMA_SOURCE_FILE ("program.galgas", 341)).boolEnum () ;
      if (kBoolTrue == test_5) {
        ...
        if (kBoolTrue == test_6) {
          ...
          const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, enumerator_12749.current_mValue (HERE).mProperty_string.getter_pathExtension (SOURCE_FILE ("program.galgas", 345)).objectCompare (GALGAS_string ("plm"))).boolEnum () ;
          if (kBoolTrue == test_7) {
            ...
            cGrammar_plm_5F_grammar::_performSourceStringParsing_ (inCompiler, var_fw_14106.getter_textFileContentsAtPath (enumerator_12749.current_mValue (HERE).mProperty_string, inCompiler COMMA_SOURCE_FILE ("program.galgas", 346)), enumerator_12749.current_mValue (HERE).mProperty_string, ioArgument_ioAST, var_importedFileList_14569, joker_14601  COMMA_SOURCE_FILE ("program.galgas", 346)) ;
            {
            ...
            const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, enumerator_12749.current_mValue (HERE).mProperty_string.getter_pathExtension (SOURCE_FILE ("program.galgas", 356)).objectCompare (GALGAS_string ("plm-target"))).boolEnum () ;
            if (kBoolTrue == test_8) {
              ...
              cGrammar_plm_5F_target_5F_grammar::_performSourceStringParsing_ (inCompiler, var_fw_14106.getter_textFileContentsAtPath (enumerator_12749.current_mValue (HERE).mProperty_string, inCompiler COMMA_SOURCE_FILE ("program.galgas", 357)), enumerator_12749.current_mValue (HERE).mProperty_string, ioArgument_ioAST, var_importedFileList_15074, joker_15106  COMMA_SOURCE_FILE ("program.galgas", 357)) ;
              {
