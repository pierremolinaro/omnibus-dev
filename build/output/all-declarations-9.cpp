...
void routine_compileProject (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  if (kBoolTrue == test_2) {
    {
    routine_retainRequiredModules (var_ast_2876, inCompiler  COMMA_SOURCE_FILE ("program.galgas", 114)) ;
    }
  }
  GALGAS_declarationListAST var_orderedDeclarationListAST_4636 = GALGAS_declarationListAST::constructor_emptyList (SOURCE_FILE ("program.galgas", 117)) ;
  ...
  if (kBoolTrue == test_3) {
    {
    routine_buildOrderedDeclarationList (var_ast_2876, constinArgument_inSourceFile.getter_string (HERE), constinArgument_inEndOfSourceFile, var_orderedDeclarationListAST_4636, inCompiler  COMMA_SOURCE_FILE ("program.galgas", 119)) ;
    }
  }
  const enumGalgasBool test_4 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("program.galgas", 127)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_4) {
    cEnumerator_checkTargetListAST enumerator_5074 (var_ast_2876.getter_mCheckTargetListAST (HERE), kENUMERATION_UP) ;
    while (enumerator_5074.hasCurrentObject ()) {
      GALGAS_bool var_accepted_5096 = GALGAS_bool (false) ;
      cEnumerator_lstringlist enumerator_5153 (enumerator_5074.current_mAcceptedTargetList (HERE), kENUMERATION_UP) ;
      bool bool_5 = var_accepted_5096.operator_not (SOURCE_FILE ("program.galgas", 130)).isValidAndTrue () ;
      if (enumerator_5153.hasCurrentObject () && bool_5) {
        while (enumerator_5153.hasCurrentObject () && bool_5) {
          var_accepted_5096 = GALGAS_bool (kIsNotEqual, enumerator_5153.current_mValue (HERE).getter_string (HERE).objectCompare (constinArgument_inTargetName.getter_string (SOURCE_FILE ("program.galgas", 131)))) ;
          enumerator_5153.gotoNextObject () ;
          if (enumerator_5153.hasCurrentObject ()) {
            bool_5 = var_accepted_5096.operator_not (SOURCE_FILE ("program.galgas", 130)).isValidAndTrue () ;
          }
        }
      }
      const enumGalgasBool test_6 = var_accepted_5096.operator_not (SOURCE_FILE ("program.galgas", 133)).boolEnum () ;
      if (kBoolTrue == test_6) {
        TC_Array <C_FixItDescription> fixItArray7 ;
        inCompiler->emitSemanticError (enumerator_5074.current_mTargetConstructLocation (HERE), GALGAS_string ("invalid target"), fixItArray7  COMMA_SOURCE_FILE ("program.galgas", 134)) ;
      }
      enumerator_5074.gotoNextObject () ;
    }
  }
  GALGAS_semanticContext var_semanticContext_5455 = GALGAS_semanticContext::constructor_default (SOURCE_FILE ("program.galgas", 139)) ;
  GALGAS_staticStringMap var_globalLiteralStringMap_5508 = GALGAS_staticStringMap::constructor_emptyMap (SOURCE_FILE ("program.galgas", 140)) ;
  GALGAS_staticlistValues_5F_listMap var_staticListValueMap_5560 = GALGAS_staticlistValues_5F_listMap::constructor_emptyMap (SOURCE_FILE ("program.galgas", 141)) ;
  const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("program.galgas", 142)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_8) {
    {
    routine_buildSemanticContext (var_orderedDeclarationListAST_4636, constinArgument_inSourceFile, var_ast_2876, var_globalLiteralStringMap_5508, var_staticListValueMap_5560, var_semanticContext_5455, inCompiler  COMMA_SOURCE_FILE ("program.galgas", 143)) ;
    }
  }
}
...
void routine_addTargetSpecificFiles (const GALGAS_lstring constinArgument_inTargetName,
                                     ...
                                     C_Compiler * inCompiler
                                     COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_ast var_ast_7695 = GALGAS_ast::constructor_default (SOURCE_FILE ("program.galgas", 199)) ;
  ...
  if (kBoolTrue == test_0) {
    GALGAS_string var_targetDirectory_7820 = GALGAS_string (gOption_plm_5F_options_useDirAsTargetDir.getter_value ()).getter_absolutePathFromPath (constinArgument_inCurrentDirectory COMMA_SOURCE_FILE ("program.galgas", 201)) ;
    const enumGalgasBool test_1 = var_targetDirectory_7820.getter_directoryExists (SOURCE_FILE ("program.galgas", 202)).boolEnum () ;
    if (kBoolTrue == test_1) {
      GALGAS_string var_targetDefinitionFullPath_7991 = var_targetDirectory_7820.add_operation (GALGAS_string ("/"), inCompiler COMMA_SOURCE_FILE ("program.galgas", 203)).add_operation (constinArgument_inTargetName.getter_string (HERE), inCompiler COMMA_SOURCE_FILE ("program.galgas", 203)).add_operation (GALGAS_string ("/+config.plm-target"), inCompiler COMMA_SOURCE_FILE ("program.galgas", 203)) ;
      const enumGalgasBool test_2 = var_targetDefinitionFullPath_7991.getter_fileExists (SOURCE_FILE ("program.galgas", 204)).boolEnum () ;
      if (kBoolTrue == test_2) {
        GALGAS_lstringlist var_importedFileList_8253 ;
        var_importedFileList_8253.drop () ;
        GALGAS_location joker_8281 ; // Joker input parameter
        cGrammar_plm_5F_target_5F_grammar::_performSourceFileParsing_ (inCompiler, var_targetDefinitionFullPath_7991.getter_nowhere (SOURCE_FILE ("program.galgas", 205)), ioArgument_ioAST, var_importedFileList_8253, joker_8281  COMMA_SOURCE_FILE ("program.galgas", 205)) ;
        {
        routine_recursiveImportFileSystemTargetFiles (var_ast_7695, var_targetDirectory_7820.add_operation (GALGAS_string ("/"), inCompiler COMMA_SOURCE_FILE ("program.galgas", 211)).add_operation (constinArgument_inTargetName.getter_string (HERE), inCompiler COMMA_SOURCE_FILE ("program.galgas", 211)), var_importedFileList_8253, ioArgument_ioImportedFileAbsolutePathSet, inCompiler  COMMA_SOURCE_FILE ("program.galgas", 209)) ;
        }
      }else if (kBoolFalse == test_2) {
        TC_Array <C_FixItDescription> fixItArray3 ;
        inCompiler->emitSemanticError (constinArgument_inTargetName.getter_location (SOURCE_FILE ("program.galgas", 216)), GALGAS_string ("This target is not defined in '").add_operation (GALGAS_string (gOption_plm_5F_options_useDirAsTargetDir.getter_value ()), inCompiler COMMA_SOURCE_FILE ("program.galgas", 217)).add_operation (GALGAS_string ("' directory"), inCompiler COMMA_SOURCE_FILE ("program.galgas", 217)), fixItArray3  COMMA_SOURCE_FILE ("program.galgas", 216)) ;
      }
    }else if (kBoolFalse == test_1) {
      TC_Array <C_FixItDescription> fixItArray4 ;
      inCompiler->emitSemanticError (GALGAS_string::makeEmptyString ().getter_nowhere (SOURCE_FILE ("program.galgas", 220)).getter_location (SOURCE_FILE ("program.galgas", 220)), GALGAS_string ("the '").add_operation (GALGAS_string (gOption_plm_5F_options_useDirAsTargetDir.getter_value ()), inCompiler COMMA_SOURCE_FILE ("program.galgas", 220)).add_operation (GALGAS_string ("' directory does not exist"), inCompiler COMMA_SOURCE_FILE ("program.galgas", 220)), fixItArray4  COMMA_SOURCE_FILE ("program.galgas", 220)) ;
    }
  }else if (kBoolFalse == test_0) {
    GALGAS_filewrapper var_fw_8928 = GALGAS_filewrapper (gWrapperDirectory_0_targetTemplates) ;
    const enumGalgasBool test_5 = var_fw_8928.getter_fileExistsAtPath (constinArgument_inTargetName.getter_string (HERE).add_operation (GALGAS_string ("/+config.plm-target"), inCompiler COMMA_SOURCE_FILE ("program.galgas", 225)), inCompiler COMMA_SOURCE_FILE ("program.galgas", 225)).boolEnum () ;
    if (kBoolTrue == test_5) {
      GALGAS_string var_source_9056 = var_fw_8928.getter_textFileContentsAtPath (constinArgument_inTargetName.getter_string (HERE).add_operation (GALGAS_string ("/+config.plm-target"), inCompiler COMMA_SOURCE_FILE ("program.galgas", 226)), inCompiler COMMA_SOURCE_FILE ("program.galgas", 226)) ;
      GALGAS_lstringlist var_importedFileList_9260 ;
      var_importedFileList_9260.drop () ;
      GALGAS_location joker_9286 ; // Joker input parameter
      cGrammar_plm_5F_target_5F_grammar::_performSourceStringParsing_ (inCompiler, var_source_9056, constinArgument_inTargetName.getter_string (HERE), ioArgument_ioAST, var_importedFileList_9260, joker_9286  COMMA_SOURCE_FILE ("program.galgas", 227)) ;
      {
      routine_recursiveImportEmbeddedTargetFiles (var_ast_7695, constinArgument_inTargetName.getter_string (HERE), var_importedFileList_9260, ioArgument_ioImportedFileAbsolutePathSet, inCompiler  COMMA_SOURCE_FILE ("program.galgas", 231)) ;
      }
    }else if (kBoolFalse == test_5) {
      TC_Array <C_FixItDescription> fixItArray6 ;
      inCompiler->emitSemanticError (constinArgument_inTargetName.getter_location (SOURCE_FILE ("program.galgas", 238)), GALGAS_string ("This target is not defined in embedded targets"), fixItArray6  COMMA_SOURCE_FILE ("program.galgas", 238)) ;
    }
  }
  ioArgument_ioAST.mProperty_mDeclarationListAST = var_ast_7695.getter_mDeclarationListAST (HERE).add_operation (ioArgument_ioAST.getter_mDeclarationListAST (HERE), inCompiler COMMA_SOURCE_FILE ("program.galgas", 242)) ;
  ioArgument_ioAST.mProperty_mGlobalVarDeclarationListAST = var_ast_7695.getter_mGlobalVarDeclarationListAST (HERE).add_operation (ioArgument_ioAST.getter_mGlobalVarDeclarationListAST (HERE), inCompiler COMMA_SOURCE_FILE ("program.galgas", 243)) ;
  ioArgument_ioAST.mProperty_mControlRegisterDeclarationListAST = var_ast_7695.getter_mControlRegisterDeclarationListAST (HERE).add_operation (ioArgument_ioAST.getter_mControlRegisterDeclarationListAST (HERE), inCompiler COMMA_SOURCE_FILE ("program.galgas", 244)) ;
  ioArgument_ioAST.mProperty_mExtensionDeclarationListAST = var_ast_7695.getter_mExtensionDeclarationListAST (HERE).add_operation (ioArgument_ioAST.getter_mExtensionDeclarationListAST (HERE), inCompiler COMMA_SOURCE_FILE ("program.galgas", 245)) ;
  ioArgument_ioAST.mProperty_mProcedureListAST = var_ast_7695.getter_mProcedureListAST (HERE).add_operation (ioArgument_ioAST.getter_mProcedureListAST (HERE), inCompiler COMMA_SOURCE_FILE ("program.galgas", 246)) ;
  ioArgument_ioAST.mProperty_mRequiredProcListAST = var_ast_7695.getter_mRequiredProcListAST (HERE).add_operation (ioArgument_ioAST.getter_mRequiredProcListAST (HERE), inCompiler COMMA_SOURCE_FILE ("program.galgas", 247)) ;
  ioArgument_ioAST.mProperty_mExternProcListAST = var_ast_7695.getter_mExternProcListAST (HERE).add_operation (ioArgument_ioAST.getter_mExternProcListAST (HERE), inCompiler COMMA_SOURCE_FILE ("program.galgas", 248)) ;
  ioArgument_ioAST.mProperty_mStandAloneSystemRoutineListAST = var_ast_7695.getter_mStandAloneSystemRoutineListAST (HERE).add_operation (ioArgument_ioAST.getter_mStandAloneSystemRoutineListAST (HERE), inCompiler COMMA_SOURCE_FILE ("program.galgas", 249)) ;
  ioArgument_ioAST.mProperty_mGuardListAST = var_ast_7695.getter_mGuardListAST (HERE).add_operation (ioArgument_ioAST.getter_mGuardListAST (HERE), inCompiler COMMA_SOURCE_FILE ("program.galgas", 250)) ;
  ioArgument_ioAST.mProperty_mTargetListAST.plusAssign_operation(var_ast_7695.getter_mTargetListAST (HERE), inCompiler  COMMA_SOURCE_FILE ("program.galgas", 251)) ;
  ioArgument_ioAST.mProperty_mInitListAST.plusAssign_operation(var_ast_7695.getter_mInitListAST (HERE), inCompiler  COMMA_SOURCE_FILE ("program.galgas", 252)) ;
  ioArgument_ioAST.mProperty_mBootListAST.plusAssign_operation(var_ast_7695.getter_mBootListAST (HERE), inCompiler  COMMA_SOURCE_FILE ("program.galgas", 253)) ;
  ioArgument_ioAST.mProperty_mPanicClauseListAST.plusAssign_operation(var_ast_7695.getter_mPanicClauseListAST (HERE), inCompiler  COMMA_SOURCE_FILE ("program.galgas", 254)) ;
  ioArgument_ioAST.mProperty_mISRDeclarationListAST = var_ast_7695.getter_mISRDeclarationListAST (HERE).add_operation (ioArgument_ioAST.getter_mISRDeclarationListAST (HERE), inCompiler COMMA_SOURCE_FILE ("program.galgas", 255)) ;
  ioArgument_ioAST.mProperty_mTaskListAST = var_ast_7695.getter_mTaskListAST (HERE).add_operation (ioArgument_ioAST.getter_mTaskListAST (HERE), inCompiler COMMA_SOURCE_FILE ("program.galgas", 256)) ;
  ioArgument_ioAST.mProperty_mModuleDeclarationListAST = var_ast_7695.getter_mModuleDeclarationListAST (HERE).add_operation (ioArgument_ioAST.getter_mModuleDeclarationListAST (HERE), inCompiler COMMA_SOURCE_FILE ("program.galgas", 257)) ;
  ioArgument_ioAST.mProperty_mRequiredModuleListAST = var_ast_7695.getter_mRequiredModuleListAST (HERE).add_operation (ioArgument_ioAST.getter_mRequiredModuleListAST (HERE), inCompiler COMMA_SOURCE_FILE ("program.galgas", 258)) ;
  ioArgument_ioAST.mProperty_mCheckTargetListAST = var_ast_7695.getter_mCheckTargetListAST (HERE).add_operation (ioArgument_ioAST.getter_mCheckTargetListAST (HERE), inCompiler COMMA_SOURCE_FILE ("program.galgas", 259)) ;
}
...
void routine_recursiveImportFileSystemTargetFiles (GALGAS_ast & ioArgument_ioAST,
                                                   ...
                                                   C_Compiler * inCompiler
                                                   COMMA_UNUSED_LOCATION_ARGS) {
  cEnumerator_lstringlist enumerator_11469 (inArgument_inImportedClauseList, kENUMERATION_UP) ;
  while (enumerator_11469.hasCurrentObject ()) {
    GALGAS_string var_absolutePath_11493 = constinArgument_inTargetDirectory.add_operation (GALGAS_string ("/"), inCompiler COMMA_SOURCE_FILE ("program.galgas", 271)).add_operation (enumerator_11469.current_mValue (HERE).getter_string (HERE), inCompiler COMMA_SOURCE_FILE ("program.galgas", 271)) ;
    const enumGalgasBool test_0 = var_absolutePath_11493.getter_fileExists (SOURCE_FILE ("program.galgas", 272)).boolEnum () ;
    if (kBoolTrue == test_0) {
      const enumGalgasBool test_1 = ioArgument_ioImportedFileAbsolutePathSet.getter_hasKey (var_absolutePath_11493 COMMA_SOURCE_FILE ("program.galgas", 273)).operator_not (SOURCE_FILE ("program.galgas", 273)).boolEnum () ;
      if (kBoolTrue == test_1) {
        ioArgument_ioImportedFileAbsolutePathSet.addAssign_operation (var_absolutePath_11493  COMMA_SOURCE_FILE ("program.galgas", 274)) ;
        const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, var_absolutePath_11493.getter_pathExtension (SOURCE_FILE ("program.galgas", 275)).objectCompare (GALGAS_string ("plm"))).boolEnum () ;
        if (kBoolTrue == test_2) {
          GALGAS_lstringlist var_importedFileList_11899 ;
          var_importedFileList_11899.drop () ;
          GALGAS_location joker_11929 ; // Joker input parameter
          cGrammar_plm_5F_grammar::_performSourceFileParsing_ (inCompiler, GALGAS_lstring::constructor_new (var_absolutePath_11493, enumerator_11469.current_mValue (HERE).getter_location (HERE)  COMMA_SOURCE_FILE ("program.galgas", 276)), ioArgument_ioAST, var_importedFileList_11899, joker_11929  COMMA_SOURCE_FILE ("program.galgas", 276)) ;
          {
          routine_recursiveImportFileSystemTargetFiles (ioArgument_ioAST, constinArgument_inTargetDirectory, var_importedFileList_11899, ioArgument_ioImportedFileAbsolutePathSet, inCompiler  COMMA_SOURCE_FILE ("program.galgas", 280)) ;
          }
        }else if (kBoolFalse == test_2) {
          const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, var_absolutePath_11493.getter_pathExtension (SOURCE_FILE ("program.galgas", 286)).objectCompare (GALGAS_string ("plm-target"))).boolEnum () ;
          if (kBoolTrue == test_3) {
            GALGAS_lstringlist var_importedFileList_12392 ;
            var_importedFileList_12392.drop () ;
            GALGAS_location joker_12422 ; // Joker input parameter
            cGrammar_plm_5F_target_5F_grammar::_performSourceFileParsing_ (inCompiler, GALGAS_lstring::constructor_new (var_absolutePath_11493, enumerator_11469.current_mValue (HERE).getter_location (HERE)  COMMA_SOURCE_FILE ("program.galgas", 287)), ioArgument_ioAST, var_importedFileList_12392, joker_12422  COMMA_SOURCE_FILE ("program.galgas", 287)) ;
            {
            routine_recursiveImportFileSystemTargetFiles (ioArgument_ioAST, constinArgument_inTargetDirectory, var_importedFileList_12392, ioArgument_ioImportedFileAbsolutePathSet, inCompiler  COMMA_SOURCE_FILE ("program.galgas", 291)) ;
            }
          }else if (kBoolFalse == test_3) {
            TC_Array <C_FixItDescription> fixItArray4 ;
            inCompiler->emitSemanticError (enumerator_11469.current_mValue (HERE).getter_location (SOURCE_FILE ("program.galgas", 298)), GALGAS_string ("invalid extension (should be .plm or .plm-target)"), fixItArray4  COMMA_SOURCE_FILE ("program.galgas", 298)) ;
          }
        }
      }
    }else if (kBoolFalse == test_0) {
      TC_Array <C_FixItDescription> fixItArray5 ;
      inCompiler->emitSemanticError (enumerator_11469.current_mValue (HERE).getter_location (SOURCE_FILE ("program.galgas", 302)), GALGAS_string ("file does not exist in file system target definition"), fixItArray5  COMMA_SOURCE_FILE ("program.galgas", 302)) ;
    }
...
void routine_recursiveImportEmbeddedTargetFiles (GALGAS_ast & ioArgument_ioAST,
                                                 ...
                                                 C_Compiler * inCompiler
                                                 COMMA_UNUSED_LOCATION_ARGS) {
  cEnumerator_lstringlist enumerator_13274 (inArgument_inImportedClauseList, kENUMERATION_UP) ;
  while (enumerator_13274.hasCurrentObject ()) {
    GALGAS_string var_fullPath_13294 = constinArgument_inCurrentDirectory.add_operation (GALGAS_string ("/"), inCompiler COMMA_SOURCE_FILE ("program.galgas", 316)).add_operation (enumerator_13274.current_mValue (HERE).getter_string (SOURCE_FILE ("program.galgas", 316)), inCompiler COMMA_SOURCE_FILE ("program.galgas", 316)) ;
    GALGAS_filewrapper var_fw_13352 = GALGAS_filewrapper (gWrapperDirectory_0_targetTemplates) ;
    const enumGalgasBool test_0 = var_fw_13352.getter_fileExistsAtPath (var_fullPath_13294, inCompiler COMMA_SOURCE_FILE ("program.galgas", 318)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_string var_embeddedPath_13451 = GALGAS_string (":").add_operation (var_fullPath_13294, inCompiler COMMA_SOURCE_FILE ("program.galgas", 319)) ;
      const enumGalgasBool test_1 = ioArgument_ioImportedFileAbsolutePathSet.getter_hasKey (var_embeddedPath_13451 COMMA_SOURCE_FILE ("program.galgas", 320)).operator_not (SOURCE_FILE ("program.galgas", 320)).boolEnum () ;
      if (kBoolTrue == test_1) {
        ioArgument_ioImportedFileAbsolutePathSet.addAssign_operation (var_embeddedPath_13451  COMMA_SOURCE_FILE ("program.galgas", 321)) ;
        GALGAS_lstringlist var_importedFileList_13745 ;
        var_importedFileList_13745.drop () ;
        GALGAS_location joker_13773 ; // Joker input parameter
        cGrammar_plm_5F_grammar::_performSourceStringParsing_ (inCompiler, var_fw_13352.getter_textFileContentsAtPath (var_fullPath_13294, inCompiler COMMA_SOURCE_FILE ("program.galgas", 322)), enumerator_13274.current_mValue (HERE).getter_string (HERE), ioArgument_ioAST, var_importedFileList_13745, joker_13773  COMMA_SOURCE_FILE ("program.galgas", 322)) ;
        {
        routine_recursiveImportEmbeddedTargetFiles (ioArgument_ioAST, var_fullPath_13294.getter_stringByDeletingLastPathComponent (SOURCE_FILE ("program.galgas", 328)), var_importedFileList_13745, ioArgument_ioImportedFileAbsolutePathSet, inCompiler  COMMA_SOURCE_FILE ("program.galgas", 326)) ;
        }
      }
    }else if (kBoolFalse == test_0) {
      TC_Array <C_FixItDescription> fixItArray2 ;
      inCompiler->emitSemanticError (enumerator_13274.current_mValue (HERE).getter_location (SOURCE_FILE ("program.galgas", 334)), GALGAS_string ("cannot find this file in embedded files"), fixItArray2  COMMA_SOURCE_FILE ("program.galgas", 334)) ;
    }
...
void routine_recursiveImportFiles (GALGAS_ast & ioArgument_ioAST,
                                   ...
                                   C_Compiler * inCompiler
                                   COMMA_UNUSED_LOCATION_ARGS) {
  cEnumerator_lstringlist enumerator_14508 (inArgument_inImportedClauseList, kENUMERATION_UP) ;
  while (enumerator_14508.hasCurrentObject ()) {
    GALGAS_string var_absolutePath_14532 = enumerator_14508.current_mValue (HERE).getter_string (HERE).getter_absolutePathFromPath (inArgument_inCurrentDirectory COMMA_SOURCE_FILE ("program.galgas", 348)) ;
    const enumGalgasBool test_0 = var_absolutePath_14532.getter_fileExists (SOURCE_FILE ("program.galgas", 349)).boolEnum () ;
    if (kBoolTrue == test_0) {
      const enumGalgasBool test_1 = ioArgument_ioImportedFileAbsolutePathSet.getter_hasKey (var_absolutePath_14532 COMMA_SOURCE_FILE ("program.galgas", 350)).operator_not (SOURCE_FILE ("program.galgas", 350)).boolEnum () ;
      if (kBoolTrue == test_1) {
        ioArgument_ioImportedFileAbsolutePathSet.addAssign_operation (var_absolutePath_14532  COMMA_SOURCE_FILE ("program.galgas", 351)) ;
        const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, var_absolutePath_14532.getter_pathExtension (SOURCE_FILE ("program.galgas", 352)).objectCompare (GALGAS_string ("plm"))).boolEnum () ;
        if (kBoolTrue == test_2) {
          GALGAS_lstringlist var_importedFileList_14981 ;
          var_importedFileList_14981.drop () ;
          GALGAS_location joker_15011 ; // Joker input parameter
          cGrammar_plm_5F_grammar::_performSourceFileParsing_ (inCompiler, GALGAS_lstring::constructor_new (var_absolutePath_14532, enumerator_14508.current_mValue (HERE).getter_location (HERE)  COMMA_SOURCE_FILE ("program.galgas", 353)), ioArgument_ioAST, var_importedFileList_14981, joker_15011  COMMA_SOURCE_FILE ("program.galgas", 353)) ;
          {
          routine_recursiveImportFiles (ioArgument_ioAST, inArgument_inCurrentDirectory, var_importedFileList_14981, ioArgument_ioImportedFileAbsolutePathSet, inCompiler  COMMA_SOURCE_FILE ("program.galgas", 357)) ;
          }
        }else if (kBoolFalse == test_2) {
          const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, var_absolutePath_14532.getter_pathExtension (SOURCE_FILE ("program.galgas", 363)).objectCompare (GALGAS_string ("plm-target"))).boolEnum () ;
          if (kBoolTrue == test_3) {
            GALGAS_lstringlist var_importedFileList_15460 ;
            var_importedFileList_15460.drop () ;
            GALGAS_location joker_15490 ; // Joker input parameter
            cGrammar_plm_5F_target_5F_grammar::_performSourceFileParsing_ (inCompiler, GALGAS_lstring::constructor_new (var_absolutePath_14532, enumerator_14508.current_mValue (HERE).getter_location (HERE)  COMMA_SOURCE_FILE ("program.galgas", 364)), ioArgument_ioAST, var_importedFileList_15460, joker_15490  COMMA_SOURCE_FILE ("program.galgas", 364)) ;
            {
            routine_recursiveImportFiles (ioArgument_ioAST, inArgument_inCurrentDirectory, var_importedFileList_15460, ioArgument_ioImportedFileAbsolutePathSet, inCompiler  COMMA_SOURCE_FILE ("program.galgas", 368)) ;
            }
          }else if (kBoolFalse == test_3) {
            TC_Array <C_FixItDescription> fixItArray4 ;
            inCompiler->emitSemanticError (enumerator_14508.current_mValue (HERE).getter_location (SOURCE_FILE ("program.galgas", 375)), GALGAS_string ("invalid extension (should be .plm or .plm-target)"), fixItArray4  COMMA_SOURCE_FILE ("program.galgas", 375)) ;
          }
        }
      }
    }else if (kBoolFalse == test_0) {
      GALGAS_filewrapper var_fw_15865 = GALGAS_filewrapper (gWrapperDirectory_0_targetTemplates) ;
      const enumGalgasBool test_5 = var_fw_15865.getter_fileExistsAtPath (enumerator_14508.current_mValue (HERE).getter_string (HERE), inCompiler COMMA_SOURCE_FILE ("program.galgas", 380)).boolEnum () ;
      if (kBoolTrue == test_5) {
        GALGAS_string var_embeddedPath_15971 = GALGAS_string (":").add_operation (enumerator_14508.current_mValue (HERE).getter_string (SOURCE_FILE ("program.galgas", 381)), inCompiler COMMA_SOURCE_FILE ("program.galgas", 381)) ;
        const enumGalgasBool test_6 = ioArgument_ioImportedFileAbsolutePathSet.getter_hasKey (var_embeddedPath_15971 COMMA_SOURCE_FILE ("program.galgas", 382)).operator_not (SOURCE_FILE ("program.galgas", 382)).boolEnum () ;
        if (kBoolTrue == test_6) {
          ioArgument_ioImportedFileAbsolutePathSet.addAssign_operation (var_embeddedPath_15971  COMMA_SOURCE_FILE ("program.galgas", 383)) ;
          const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, enumerator_14508.current_mValue (HERE).getter_string (HERE).getter_pathExtension (SOURCE_FILE ("program.galgas", 384)).objectCompare (GALGAS_string ("plm"))).boolEnum () ;
          if (kBoolTrue == test_7) {
            GALGAS_lstringlist var_importedFileList_16328 ;
            var_importedFileList_16328.drop () ;
            GALGAS_location joker_16360 ; // Joker input parameter
            cGrammar_plm_5F_grammar::_performSourceStringParsing_ (inCompiler, var_fw_15865.getter_textFileContentsAtPath (enumerator_14508.current_mValue (HERE).getter_string (HERE), inCompiler COMMA_SOURCE_FILE ("program.galgas", 385)), enumerator_14508.current_mValue (HERE).getter_string (HERE), ioArgument_ioAST, var_importedFileList_16328, joker_16360  COMMA_SOURCE_FILE ("program.galgas", 385)) ;
            {
            routine_recursiveImportFiles (ioArgument_ioAST, inArgument_inCurrentDirectory, var_importedFileList_16328, ioArgument_ioImportedFileAbsolutePathSet, inCompiler  COMMA_SOURCE_FILE ("program.galgas", 389)) ;
            }
          }else if (kBoolFalse == test_7) {
            const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, enumerator_14508.current_mValue (HERE).getter_string (HERE).getter_pathExtension (SOURCE_FILE ("program.galgas", 395)).objectCompare (GALGAS_string ("plm-target"))).boolEnum () ;
            if (kBoolTrue == test_8) {
              GALGAS_lstringlist var_importedFileList_16833 ;
              var_importedFileList_16833.drop () ;
              GALGAS_location joker_16865 ; // Joker input parameter
              cGrammar_plm_5F_target_5F_grammar::_performSourceStringParsing_ (inCompiler, var_fw_15865.getter_textFileContentsAtPath (enumerator_14508.current_mValue (HERE).getter_string (HERE), inCompiler COMMA_SOURCE_FILE ("program.galgas", 396)), enumerator_14508.current_mValue (HERE).getter_string (HERE), ioArgument_ioAST, var_importedFileList_16833, joker_16865  COMMA_SOURCE_FILE ("program.galgas", 396)) ;
              {
              routine_recursiveImportFiles (ioArgument_ioAST, inArgument_inCurrentDirectory, var_importedFileList_16833, ioArgument_ioImportedFileAbsolutePathSet, inCompiler  COMMA_SOURCE_FILE ("program.galgas", 400)) ;
              }
            }else if (kBoolFalse == test_8) {
              TC_Array <C_FixItDescription> fixItArray9 ;
              inCompiler->emitSemanticError (enumerator_14508.current_mValue (HERE).getter_location (SOURCE_FILE ("program.galgas", 407)), GALGAS_string ("invalid extension (should be .plm or .plm-target)"), fixItArray9  COMMA_SOURCE_FILE ("program.galgas", 407)) ;
            }
          }
        }
      }else if (kBoolFalse == test_5) {
        TC_Array <C_FixItDescription> fixItArray10 ;
        inCompiler->emitSemanticError (enumerator_14508.current_mValue (HERE).getter_location (SOURCE_FILE ("program.galgas", 411)), GALGAS_string ("cannot find this file in file system and in embedded files"), fixItArray10  COMMA_SOURCE_FILE ("program.galgas", 411)) ;
      }
    }
...
static const cRegularFileWrapper * gWrapperAllFiles_embeddedSampleCode_3 [3] = {
