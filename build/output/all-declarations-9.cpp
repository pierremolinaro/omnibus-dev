...
void extensionMethod_panicSemanticAnalysis (const GALGAS_panicClauseListAST_2D_element inObject,
  ...
  GALGAS_lstring var_fileArg_5652 = GALGAS_lstring::constructor_new (GALGAS_string ("FILE"), inObject.mAttribute_mPanicClauseName.mAttribute_location  COMMA_SOURCE_FILE ("panic.galgas", 122)) ;
  {
  var_variableMap_4955.setter_insertUsedConstantInputFormalArgument (var_fileArg_5652, var_StaticStringType_5057, GALGAS_bool (true), GALGAS_objectInMemoryIR::constructor_localVariable (var_StaticStringType_5057, var_fileArg_5652.mAttribute_string, GALGAS_bool (false)  COMMA_SOURCE_FILE ("panic.galgas", 127)), GALGAS_objectIR::constructor_localVariableReference (var_StaticStringType_5057, var_fileArg_5652.mAttribute_string  COMMA_SOURCE_FILE ("panic.galgas", 128)), var_StaticStringType_5057.getter_copyable (inCompiler COMMA_SOURCE_FILE ("panic.galgas", 129)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE ("panic.galgas", 123)) ;
  }
  GALGAS_lstring var_lineArg_6110 = GALGAS_lstring::constructor_new (GALGAS_string ("LINE"), inObject.mAttribute_mPanicClauseName.mAttribute_location  COMMA_SOURCE_FILE ("panic.galgas", 132)) ;
  {
  var_variableMap_4955.setter_insertUsedConstantInputFormalArgument (var_lineArg_6110, constinArgument_inContext.mAttribute_mPanicLineType, GALGAS_bool (true), GALGAS_objectInMemoryIR::constructor_localVariable (constinArgument_inContext.mAttribute_mPanicLineType, var_lineArg_6110.mAttribute_string, GALGAS_bool (false)  COMMA_SOURCE_FILE ("panic.galgas", 137)), GALGAS_objectIR::constructor_localVariableReference (constinArgument_inContext.mAttribute_mPanicLineType, var_lineArg_6110.mAttribute_string  COMMA_SOURCE_FILE ("panic.galgas", 138)), constinArgument_inContext.mAttribute_mPanicLineType.getter_copyable (inCompiler COMMA_SOURCE_FILE ("panic.galgas", 139)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE ("panic.galgas", 133)) ;
  }
  ...
  GALGAS_instructionListIR var_instructionGenerationList_6919 = GALGAS_instructionListIR::constructor_emptyList (SOURCE_FILE ("panic.galgas", 150)) ;
  GALGAS_allocaList var_initAllocaList_6953 = GALGAS_allocaList::constructor_emptyList (SOURCE_FILE ("panic.galgas", 151)) ;
  ...
  extensionMethod_analyzeRoutineInstructionList (inObject.mAttribute_mPanicInstructionList, GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("panic.galgas", 153)), GALGAS_bool (false), GALGAS_bool (false), var_routineNameForInvocationGraph_4606, constinArgument_inContext, temp_2, GALGAS_bool (false), ioArgument_ioTemporaries, ioArgument_ioIntermediateCodeStruct.mAttribute_mStaticStringMap, var_variableMap_4955, var_namedObjectMap_4991, var_initAllocaList_6953, var_instructionGenerationList_6919, inCompiler COMMA_SOURCE_FILE ("panic.galgas", 152)) ;
  ...
  if (kBoolTrue == test_3) {
    ...
    ioArgument_ioIntermediateCodeStruct.mAttribute_mPanicSetupInstructionListIR.plusAssign_operation(var_instructionGenerationList_6919, inCompiler  COMMA_SOURCE_FILE ("panic.galgas", 174)) ;
    ...
    if (kBoolTrue == test_4) {
      ...
      ioArgument_ioIntermediateCodeStruct.mAttribute_mPanicLoopInstructionListIR.plusAssign_operation(var_instructionGenerationList_6919, inCompiler  COMMA_SOURCE_FILE ("panic.galgas", 177)) ;
...
void extensionMethod_enterAccessibleEntities (const GALGAS_guardMapIR_2D_element inObject,
  ...
  case GALGAS_guardKindGenerationIR::kEnum_convenienceGuard:
    {
      const cEnumAssociatedValues_guardKindGenerationIR_convenienceGuard * extractPtr_36497 = (const cEnumAssociatedValues_guardKindGenerationIR_convenienceGuard *) (inObject.mAttribute_mGuardKindGenerationIR.unsafePointer ()) ;
      const GALGAS_instructionListIR extractedValue_baseGuardInstructionGenerationList = extractPtr_36497->mAssociatedValue1 ;
      const GALGAS_string extractedValue_baseGuardMangledName = extractPtr_36497->mAssociatedValue2 ;
...
void extensionMethod_noteInstructionTypesInPrecedenceGraph (const GALGAS_assignmentTargetAST inObject,
                                                            ...
                                                            C_Compiler * inCompiler
                                                            COMMA_UNUSED_LOCATION_ARGS) {
  cEnumerator_accessInAssignmentListAST enumerator_3109 (inObject.mAttribute_mAccessList, kEnumeration_up) ;
  while (enumerator_3109.hasCurrentObject ()) {
    switch (enumerator_3109.current_mAccess (HERE).enumValue ()) {
    ...
    case GALGAS_accessInAssignmentAST::kEnum_arrayAccess:
      {
        const cEnumAssociatedValues_accessInAssignmentAST_arrayAccess * extractPtr_3283 = (const cEnumAssociatedValues_accessInAssignmentAST_arrayAccess *) (enumerator_3109.current_mAccess (HERE).unsafePointer ()) ;
        const GALGAS_expressionAST extractedValue_indexExpression = extractPtr_3283->mAssociatedValue0 ;
...
void extensionMethod_analyzeAssignmentTarget (const GALGAS_assignmentTargetAST inObject,
  ...
  case GALGAS_assignmentSelfAccessAST::kEnum_noSelfAccess:
    {
      {
      GALGAS_unifiedTypeMap_2D_proxy joker_4601_3 ; // Joker input parameter
      GALGAS_bool joker_4601_2 ; // Joker input parameter
      GALGAS_objectInMemoryIR joker_4601_1 ; // Joker input parameter
      GALGAS_bool joker_4644_2 ; // Joker input parameter
      GALGAS_bool joker_4644_1 ; // Joker input parameter
      ioArgument_ioVariableMap.setter_searchForWriteAccess (inObject.mAttribute_mIdentifier, joker_4601_3, joker_4601_2, joker_4601_1, outArgument_outCurrentObject, joker_4644_2, joker_4644_1, inCompiler COMMA_SOURCE_FILE ("assignment-target.galgas", 111)) ;
      }
  ...
  case GALGAS_assignmentSelfAccessAST::kEnum_selfAccess:
    {
      const cEnumAssociatedValues_assignmentSelfAccessAST_selfAccess * extractPtr_5348 = (const cEnumAssociatedValues_assignmentSelfAccessAST_selfAccess *) (inObject.mAttribute_mSelfAccess.unsafePointer ()) ;
      const GALGAS_location extractedValue_selfLocation = extractPtr_5348->mAssociatedValue0 ;
      ...
      if (kBoolTrue == test_0) {
        ...
        if (kBoolTrue == test_1) {
          GALGAS_namedObjectMap var_structureObjectMap_4986 ;
          GALGAS_propertyMap joker_4988_2 ; // Joker input parameter
          GALGAS_propertyList joker_4988_1 ; // Joker input parameter
          constinArgument_inSelfType.getter_kind (inCompiler COMMA_SOURCE_FILE ("assignment-target.galgas", 121)).method_structure (var_structureObjectMap_4986, joker_4988_2, joker_4988_1, inCompiler COMMA_SOURCE_FILE ("assignment-target.galgas", 121)) ;
          GALGAS_objectIR var_object_5068 ;
          var_structureObjectMap_4986.method_searchKey (inObject.mAttribute_mIdentifier, var_object_5068, inCompiler COMMA_SOURCE_FILE ("assignment-target.galgas", 122)) ;
          {
          routine_handleSelfAccessInAssignment (constinArgument_inSelfType, var_object_5068, ioArgument_ioTemporaries, ioArgument_ioInstructionGenerationList, outArgument_outCurrentObject, inCompiler  COMMA_SOURCE_FILE ("assignment-target.galgas", 126)) ;
          }
        }else if (kBoolFalse == test_1) {
  ...
  cEnumerator_accessInAssignmentListAST enumerator_5420 (inObject.mAttribute_mAccessList, kEnumeration_up) ;
  while (enumerator_5420.hasCurrentObject ()) {
    switch (enumerator_5420.current_mAccess (HERE).enumValue ()) {
    case GALGAS_accessInAssignmentAST::kNotBuilt:
      break ;
    case GALGAS_accessInAssignmentAST::kEnum_property:
      {
        const cEnumAssociatedValues_accessInAssignmentAST_property * extractPtr_5636 = (const cEnumAssociatedValues_accessInAssignmentAST_property *) (enumerator_5420.current_mAccess (HERE).unsafePointer ()) ;
        const GALGAS_lstring extractedValue_propertyName = extractPtr_5636->mAssociatedValue0 ;
        {
    ...
    case GALGAS_accessInAssignmentAST::kEnum_arrayAccess:
      {
        const cEnumAssociatedValues_accessInAssignmentAST_arrayAccess * extractPtr_6337 = (const cEnumAssociatedValues_accessInAssignmentAST_arrayAccess *) (enumerator_5420.current_mAccess (HERE).unsafePointer ()) ;
        const GALGAS_expressionAST extractedValue_indexExpression = extractPtr_6337->mAssociatedValue0 ;
        const GALGAS_location extractedValue_endOfExpression = extractPtr_6337->mAssociatedValue1 ;
        {
