...
AbstractPtrClass * cPtr_guardUserRoutineIR::duplicate (Compiler * inCompiler COMMA_LOCATION_ARGS) const {
...
AbstractPtrClass * cPtr_guardImplementationRoutineIR::duplicate (Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  AbstractPtrClass * ptr = nullptr ;
...
AbstractPtrClass * cPtr_convertExpressionAST::duplicate (Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  AbstractPtrClass * ptr = nullptr ;
...
AbstractPtrClass * cPtr_decoratedControlRegisterArrayGroupDeclaration::duplicate (Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  AbstractPtrClass * ptr = nullptr ;
...
void extensionMethod_generateLLVMcode (const GGS_controlRegisterGroupArrayList inObject,
  ...
  if (GalgasBool::boolTrue == test_0) {
    ...
    if (GalgasBool::boolTrue == test_0) {
      ...
      GGS_string var_int_28058 = GGS_string ("i").add_operation (constinArgument_inPointerSize.getter_string (SOURCE_FILE ("declaration-control-register.galgas", 676)), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 676)) ;
      const GGS_controlRegisterGroupArrayList temp_2 = inObject ;
      UpEnumerator_controlRegisterGroupArrayList enumerator_28103 (temp_2) ;
      while (enumerator_28103.hasCurrentObject ()) {
        ioArgument_ioLLVMcode.plusAssignOperation(function_registerGroupAddressArrayLLVMname (enumerator_28103.current_mGroupName (HERE).readProperty_string (), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 678)).add_operation (GGS_string (" = private unnamed_addr constant ["), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 678)).add_operation (enumerator_28103.current_mBaseAddresses (HERE).getter_count (SOURCE_FILE ("declaration-control-register.galgas", 679)).getter_string (SOURCE_FILE ("declaration-control-register.galgas", 679)), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 679)).add_operation (GGS_string (" x "), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 679)).add_operation (var_int_28058, inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 679)).add_operation (GGS_string ("] ["), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 679)), inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 678)) ;
        UpEnumerator_lbigintlist enumerator_28307 (enumerator_28103.current_mBaseAddresses (HERE)) ;
        while (enumerator_28307.hasCurrentObject ()) {
          ioArgument_ioLLVMcode.plusAssignOperation(var_int_28058.add_operation (GGS_string (" "), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 682)).add_operation (enumerator_28307.current_mValue (HERE).readProperty_bigint ().getter_string (SOURCE_FILE ("declaration-control-register.galgas", 682)), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 682)), inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 682)) ;
          enumerator_28307.gotoNextObject () ;
          if (enumerator_28307.hasCurrentObject ()) {
        ...
        UpEnumerator_lbigintlist enumerator_28481 (enumerator_28103.current_mBaseAddresses (HERE)) ;
        while (enumerator_28481.hasCurrentObject ()) {
          ioArgument_ioLLVMcode.plusAssignOperation(enumerator_28481.current_mValue (HERE).readProperty_bigint ().getter_hexString (SOURCE_FILE ("declaration-control-register.galgas", 689)), inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 689)) ;
          enumerator_28481.gotoNextObject () ;
          if (enumerator_28481.hasCurrentObject ()) {
        ...
        enumerator_28103.gotoNextObject () ;
      }
...
AbstractPtrClass * cPtr_llvmAssignmentOperatorDeclarationAST::duplicate (Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  AbstractPtrClass * ptr = nullptr ;
...
AbstractPtrClass * cPtr_llvmAssignmentOperatorUsage::duplicate (Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  AbstractPtrClass * ptr = nullptr ;
...
AbstractPtrClass * cPtr_assignmentRoutineIR::duplicate (Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  AbstractPtrClass * ptr = nullptr ;
...
AbstractPtrClass * cPtr_simpleAssignmentCopyRoutineIR::duplicate (Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  AbstractPtrClass * ptr = nullptr ;
...
AbstractPtrClass * cPtr_typeOpaqueDeclarationAST::duplicate (Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  AbstractPtrClass * ptr = nullptr ;
...
AbstractPtrClass * cPtr_storeFromTemporaryReferenceIR::duplicate (Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  AbstractPtrClass * ptr = nullptr ;
...
AbstractPtrClass * cPtr_systemRoutineDeclarationAST::duplicate (Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  AbstractPtrClass * ptr = nullptr ;
...
AbstractPtrClass * cPtr_systemUserRoutineIR::duplicate (Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  AbstractPtrClass * ptr = nullptr ;
...
void cParser_omnibus_5F_syntax::rule_omnibus_5F_syntax_declaration_i3_ (GGS_ast & ioArgument_ioAST,
  ...
  GGS_lbigint var_stackSize_1952 = inCompiler->synthetizedAttribute_bigInteger () ;
  inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken_integer COMMA_SOURCE_FILE ("task-declaration.galgas", 50)) ;
  GGS_bool var_autoStart_1999 = GGS_bool (false) ;
  switch (select_omnibus_5F_syntax_4 (inCompiler)) {
  case 1: {
  } break ;
  case 2: {
    GGS_lstring var_activateAttribute_2059 = inCompiler->synthetizedAttribute_tokenString () ;
    ...
    if (GalgasBool::boolTrue == test_4) {
      test_4 = GGS_bool (ComparisonKind::notEqual, var_activateAttribute_2059.readProperty_string ().objectCompare (GGS_string ("autostart"))).boolEnum () ;
      if (GalgasBool::boolTrue == test_4) {
        GenericArray <FixItDescription> fixItArray5 ;
        inCompiler->emitSemanticError (var_activateAttribute_2059.readProperty_location (), GGS_string ("this attribute should be @autostart"), fixItArray5  COMMA_SOURCE_FILE ("task-declaration.galgas", 57)) ;
      }
    }
    var_autoStart_1999 = GGS_bool (true) ;
  } break ;
  default:
    break ;
  }
  ...
  GGS_syncInstructionBranchListAST var_branchList_2490 = temp_10 ;
  bool repeatFlag_11 = true ;
  while (repeatFlag_11) {
    switch (select_omnibus_5F_syntax_5 (inCompiler)) {
    case 2: {
      nt_private_5F_struct_5F_property_5F_declaration_ (ioArgument_ioAST, var_taskVarList_2288, inCompiler) ;
    } break ;
    case 3: {
      inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken_func COMMA_SOURCE_FILE ("task-declaration.galgas", 71)) ;
      GGS_lstring var_procName_2641 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("task-declaration.galgas", 72)) ;
      GGS_routineFormalArgumentListAST var_formalArgumentList_2728 ;
      nt_procedure_5F_formal_5F_arguments_ (ioArgument_ioAST, var_formalArgumentList_2728, inCompiler) ;
      GGS_lstring var_returnTypeName_2766 ;
      switch (select_omnibus_5F_syntax_6 (inCompiler)) {
      case 1: {
        var_returnTypeName_2766 = GGS_string::makeEmptyString ().getter_here (inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 76)) ;
      } break ;
      case 2: {
        inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__2D__3E_ COMMA_SOURCE_FILE ("task-declaration.galgas", 78)) ;
        nt_type_5F_definition_ (ioArgument_ioAST, var_returnTypeName_2766, inCompiler) ;
      } break ;
      default:
        break ;
      }
      inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__7B_ COMMA_SOURCE_FILE ("task-declaration.galgas", 81)) ;
      GGS_instructionListAST var_instructionList_2956 ;
      nt_instructionList_ (ioArgument_ioAST, var_instructionList_2956, inCompiler) ;
      GGS_lstringlist temp_12 = GGS_lstringlist::init (inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 88)) ;
      ioArgument_ioAST.mProperty_mDeclarationListAST.addAssignOperation (GGS_functionDeclarationAST::init_21__21__21__21__21__21__21__21__21_ (GGS_mode::class_func_userMode (SOURCE_FILE ("task-declaration.galgas", 84)), GGS_bool (false), var_taskName_1526, var_procName_2641, temp_12, var_formalArgumentList_2728, var_returnTypeName_2766, var_instructionList_2956, GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 92)), inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("task-declaration.galgas", 83)) ;
      inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__7D_ COMMA_SOURCE_FILE ("task-declaration.galgas", 94)) ;
    } break ;
    case 4: {
      nt_task_5F_event_ (ioArgument_ioAST, var_taskName_1526, var_taskSetupList_2332, var_taskActivateList_2378, var_taskDeactivateList_2427, inCompiler) ;
    } break ;
    case 5: {
      inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken_while COMMA_SOURCE_FILE ("task-declaration.galgas", 98)) ;
      GGS_guardedCommandAST var_guardedCommand_3456 ;
      nt_guarded_5F_command_ (ioArgument_ioAST, GGS_bool (false), var_guardedCommand_3456, inCompiler) ;
      inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__7B_ COMMA_SOURCE_FILE ("task-declaration.galgas", 100)) ;
      GGS_instructionListAST var_instructionList_3518 ;
      nt_instructionList_ (ioArgument_ioAST, var_instructionList_3518, inCompiler) ;
      GGS_location var_endOfInstructions_3544 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 102)) ;
      inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__7D_ COMMA_SOURCE_FILE ("task-declaration.galgas", 103)) ;
      var_branchList_2490.addAssignOperation (var_guardedCommand_3456, var_instructionList_3518, var_endOfInstructions_3544  COMMA_SOURCE_FILE ("task-declaration.galgas", 104)) ;
    } break ;
    default:
      repeatFlag_11 = false ;
      break ;
  ...
  GGS_location var_endOfTask_3984 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("task-declaration.galgas", 114)) ;
  inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__7D_ COMMA_SOURCE_FILE ("task-declaration.galgas", 115)) ;
  ioArgument_ioAST.mProperty_mTaskListAST.addAssignOperation (var_taskName_1526, var_higherPriorityTaskList_1556, var_stackSize_1952, var_taskSetupList_2332, var_taskActivateList_2378, var_taskDeactivateList_2427, var_branchList_2490, var_endOfTask_3984, var_autoStart_1999  COMMA_SOURCE_FILE ("task-declaration.galgas", 116)) ;
  GGS_lstringlist temp_13 = GGS_lstringlist::init (inCompiler COMMA_SOURCE_FILE ("task-declaration.galgas", 130)) ;
  ioArgument_ioAST.mProperty_mDeclarationListAST.addAssignOperation (GGS_structureDeclarationAST::init_21__21__21__21__21__21__21_ (var_taskName_1526, var_taskName_1526, var_taskName_1526, temp_13, GGS_bool (false), var_taskVarList_2288, GGS_bool (false), inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("task-declaration.galgas", 126)) ;
}
...
void cParser_omnibus_5F_syntax::rule_omnibus_5F_syntax_declaration_i7_ (GGS_ast & ioArgument_ioAST,
  ...
  GGS_lstring var_staticListName_4272 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  while (repeatFlag_0) {
    ...
    GGS_extendStaticListElementAST var_expressions_4344 = temp_1 ;
    bool repeatFlag_2 = true ;
    while (repeatFlag_2) {
      GGS_lstring var_selector_4401 = inCompiler->synthetizedAttribute_tokenString () ;
      ...
      GalgasBool test_3 = GalgasBool::boolTrue ;
      if (GalgasBool::boolTrue == test_3) {
        test_3 = GGS_bool (ComparisonKind::notEqual, var_selector_4401.readProperty_string ().objectCompare (GGS_string::makeEmptyString ())).boolEnum () ;
        if (GalgasBool::boolTrue == test_3) {
          GenericArray <FixItDescription> fixItArray4 ;
          inCompiler->emitSemanticError (var_selector_4401.readProperty_location (), GGS_string ("selector should be empty"), fixItArray4  COMMA_SOURCE_FILE ("declaration-static-list.galgas", 117)) ;
        }
      }
      nt_staticArray_5F_exp_ (ioArgument_ioAST, var_expressions_4344, inCompiler) ;
    ...
    if (GalgasBool::boolTrue == test_6) {
      test_6 = ioArgument_ioAST.readProperty_mExtendStaticArrayDeclarationAST ().getter_hasKey (var_staticListName_4272.readProperty_string () COMMA_SOURCE_FILE ("declaration-static-list.galgas", 123)).boolEnum () ;
      if (GalgasBool::boolTrue == test_6) {
        ioArgument_ioAST.readProperty_mExtendStaticArrayDeclarationAST ().method_searchKey (var_staticListName_4272.readProperty_string (), var_expressionList_4620, inCompiler COMMA_SOURCE_FILE ("declaration-static-list.galgas", 124)) ;
      }
    }
    var_expressionList_4620.addAssignOperation (var_expressions_4344, GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("declaration-static-list.galgas", 126))  COMMA_SOURCE_FILE ("declaration-static-list.galgas", 126)) ;
    ioArgument_ioAST.mProperty_mExtendStaticArrayDeclarationAST.addAssignOperation (var_staticListName_4272.readProperty_string (), var_expressionList_4620, inCompiler  COMMA_SOURCE_FILE ("declaration-static-list.galgas", 127)) ;
...
void cParser_omnibus_5F_syntax::rule_omnibus_5F_syntax_declaration_i10_ (GGS_ast & ioArgument_ioAST,
  ...
  GGS_lstring var_driverName_5012 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GGS_driverInstanciationArgumentListAST var_driverInstanciationArgumentList_5075 = temp_0 ;
  bool repeatFlag_1 = true ;
  while (repeatFlag_1) {
    if (select_omnibus_5F_syntax_19 (inCompiler) == 2) {
      GGS_lstring var_selector_5158 = inCompiler->synthetizedAttribute_tokenString () ;
      ...
      GGS_expressionAST var_expression_5199 ;
      nt_expression_ (ioArgument_ioAST, var_expression_5199, inCompiler) ;
      var_driverInstanciationArgumentList_5075.addAssignOperation (var_selector_5158, var_expression_5199  COMMA_SOURCE_FILE ("declaration-driver.galgas", 150)) ;
    }else{
      repeatFlag_1 = false ;
    }
  }
  inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__29_ COMMA_SOURCE_FILE ("declaration-driver.galgas", 152)) ;
  ioArgument_ioAST.mProperty_mRequiredDriverListAST.addAssignOperation (var_driverName_5012, var_driverInstanciationArgumentList_5075  COMMA_SOURCE_FILE ("declaration-driver.galgas", 153)) ;
}
...
void cParser_omnibus_5F_syntax::rule_omnibus_5F_syntax_declaration_i17_ (GGS_ast & ioArgument_ioAST,
  ...
  GGS_lstring var_targetName_439 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__22_string_22_ COMMA_SOURCE_FILE ("target-generation.galgas", 11)) ;
  ioArgument_ioAST.mProperty_mTargetListAST.addAssignOperation (var_targetName_439  COMMA_SOURCE_FILE ("target-generation.galgas", 12)) ;
}
...
void cParser_omnibus_5F_syntax::rule_omnibus_5F_syntax_declaration_i18_ (GGS_ast & ioArgument_ioAST,
  ...
  GGS_lbigint var_priority_1382 = inCompiler->synthetizedAttribute_bigInteger () ;
  ...
  GGS_instructionListAST var_instructionList_1434 ;
  nt_instructionList_ (ioArgument_ioAST, var_instructionList_1434, inCompiler) ;
  GGS_location var_endOfInstructionList_1458 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("panic.galgas", 34)) ;
  inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__7D_ COMMA_SOURCE_FILE ("panic.galgas", 35)) ;
  ioArgument_ioAST.mProperty_mDeclarationListAST.addAssignOperation (GGS_panicAST::init_21__21__21__21_ (var_isSetup_1135, var_instructionList_1434, var_endOfInstructionList_1458, var_priority_1382, inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("panic.galgas", 36)) ;
}
...
void cParser_omnibus_5F_syntax::rule_omnibus_5F_syntax_primary_i20_ (GGS_ast & ioArgument_ioAST,
  ...
  GGS_primaryInExpressionAccessListAST var_accessList_2223 ;
  nt_expression_5F_access_5F_list_ (ioArgument_ioAST, var_accessList_2223, inCompiler) ;
  outArgument_outExpression = GGS_primaryInExpressionAST::init_21__21_ (var_receiver_2132, var_accessList_2223, inCompiler COMMA_HERE) ;
}
...
void cParser_omnibus_5F_syntax::rule_omnibus_5F_syntax_expression_5F_access_5F_list_i21_ (GGS_ast & ioArgument_ioAST,
  ...
  while (repeatFlag_1) {
    ...
    case 2: {
      ...
      GGS_lstring var_propertyName_2618 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("expression-primary.galgas", 59)) ;
      outArgument_outAccessList.addAssignOperation (GGS_primaryInExpressionAccessAST::class_func_property (var_propertyName_2618  COMMA_SOURCE_FILE ("expression-primary.galgas", 60))  COMMA_SOURCE_FILE ("expression-primary.galgas", 60)) ;
    } break ;
    case 3: {
      inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__5B_ COMMA_SOURCE_FILE ("expression-primary.galgas", 62)) ;
      GGS_lbigint var_low_2727 = inCompiler->synthetizedAttribute_bigInteger () ;
      ...
      GGS_lbigint var_high_2764 = inCompiler->synthetizedAttribute_bigInteger () ;
      ...
      outArgument_outAccessList.addAssignOperation (GGS_primaryInExpressionAccessAST::class_func_integerSlice (var_low_2727, var_high_2764  COMMA_SOURCE_FILE ("expression-primary.galgas", 67))  COMMA_SOURCE_FILE ("expression-primary.galgas", 67)) ;
    } break ;
    case 4: {
      inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__5B_ COMMA_SOURCE_FILE ("expression-primary.galgas", 69)) ;
      GGS_expressionAST var_expression_2891 ;
      nt_expression_ (ioArgument_ioAST, var_expression_2891, inCompiler) ;
      GGS_location var_endOfIndex_2912 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("expression-primary.galgas", 71)) ;
      GGS_bool var_checkIndexExpression_2956 ;
      ...
      case 1: {
        ...
        var_checkIndexExpression_2956 = GGS_bool (true) ;
      } break ;
      case 2: {
        inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__5D__21_ COMMA_SOURCE_FILE ("expression-primary.galgas", 77)) ;
        var_checkIndexExpression_2956 = GGS_bool (false) ;
      } break ;
      default:
        break ;
      }
      outArgument_outAccessList.addAssignOperation (GGS_primaryInExpressionAccessAST::class_func_arrayAccess (var_expression_2891, var_endOfIndex_2912, var_checkIndexExpression_2956  COMMA_SOURCE_FILE ("expression-primary.galgas", 80))  COMMA_SOURCE_FILE ("expression-primary.galgas", 80)) ;
    } break ;
    case 5: {
      inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__2E_ COMMA_SOURCE_FILE ("expression-primary.galgas", 86)) ;
      GGS_lstring var_methodName_3307 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("expression-primary.galgas", 87)) ;
      GGS_effectiveArgumentListAST var_arguments_3360 ;
      GGS_location var_endOfArguments_3375 ;
      nt_effective_5F_parameters_ (ioArgument_ioAST, var_arguments_3360, var_endOfArguments_3375, inCompiler) ;
      outArgument_outAccessList.addAssignOperation (GGS_primaryInExpressionAccessAST::class_func_funcCall (var_methodName_3307, var_arguments_3360, var_endOfArguments_3375  COMMA_SOURCE_FILE ("expression-primary.galgas", 89))  COMMA_SOURCE_FILE ("expression-primary.galgas", 89)) ;
    } break ;
    default:
      repeatFlag_1 = false ;
      break ;
...
void cParser_omnibus_5F_syntax::rule_omnibus_5F_syntax_declaration_i24_ (GGS_ast & ioArgument_ioAST,
  ...
  GGS_location var_operationLocation_5289 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("prefix-operator-llvm.galgas", 142)) ;
  GGS_llvmPrefixOperatorEnumeration var_prefixOperator_5354 ;
  nt_llvmPrefixOperator_ (var_prefixOperator_5354, inCompiler) ;
  inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__28_ COMMA_SOURCE_FILE ("prefix-operator-llvm.galgas", 144)) ;
  GGS_lstring var_receiverName_5399 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("prefix-operator-llvm.galgas", 145)) ;
  GGS_lstring var_receiverType_5430 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GGS_lstring var_resultType_5478 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GGS_llvmGenerationInstructionList var_instructionList_5530 ;
  nt_llvm_5F_instruction_5F_list_ (var_instructionList_5530, inCompiler) ;
  inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__7D_ COMMA_SOURCE_FILE ("prefix-operator-llvm.galgas", 152)) ;
  ioArgument_ioAST.mProperty_mDeclarationListAST.addAssignOperation (GGS_llvmPrefixOperatorAST::init_21__21__21__21__21__21_ (var_prefixOperator_5354, var_operationLocation_5289, var_receiverName_5399, var_receiverType_5430, var_instructionList_5530, var_resultType_5478, inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("prefix-operator-llvm.galgas", 153)) ;
}
...
void cParser_omnibus_5F_syntax::rule_omnibus_5F_syntax_primary_i26_ (GGS_ast & ioArgument_ioAST,
  ...
  GGS_location var_endOfExpression_1217 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("expression-convert.galgas", 29)) ;
  inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__29_ COMMA_SOURCE_FILE ("expression-convert.galgas", 30)) ;
  outArgument_outExpression = GGS_convertExpressionAST::init_21__21__21_ (outArgument_outExpression, var_typeName_1059, var_endOfExpression_1217, inCompiler COMMA_HERE) ;
}
...
void cParser_omnibus_5F_syntax::rule_omnibus_5F_syntax_declaration_i27_ (GGS_ast & ioArgument_ioAST,
  ...
  while (repeatFlag_1) {
    ...
    case 1: {
      ...
      GGS_lbigint var_registerGroupBaseAddress_4003 = inCompiler->synthetizedAttribute_bigInteger () ;
      ...
      GGS_controlRegisterGroupKindAST var_groupKind_4040 = GGS_controlRegisterGroupKindAST::class_func_single (var_registerGroupBaseAddress_4003  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 94)) ;
      var_registerGroupListAST_3737.addAssignOperation (var_registerGroupName_3795, var_groupKind_4040  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 95)) ;
    } break ;
    case 2: {
      GGS_lbigintlist temp_4 = GGS_lbigintlist::init (inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 97)) ;
      GGS_lbigintlist var_groupBaseAddresses_4237 = temp_4 ;
      ...
      GGS_expressionAST var_groupSize_4308 ;
      nt_expression_ (ioArgument_ioAST, var_groupSize_4308, inCompiler) ;
      GGS_location var_groupSizeExpressionLocation_4330 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 100)) ;
      GGS_lstring var_attribute_4401 = inCompiler->synthetizedAttribute_tokenString () ;
      ...
      if (GalgasBool::boolTrue == test_5) {
        test_5 = GGS_bool (ComparisonKind::notEqual, var_attribute_4401.readProperty_string ().objectCompare (GGS_string ("at"))).boolEnum () ;
        if (GalgasBool::boolTrue == test_5) {
          GenericArray <FixItDescription> fixItArray6 ;
          inCompiler->emitSemanticError (var_attribute_4401.readProperty_location (), GGS_string ("attribute should be @at"), fixItArray6  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 103)) ;
        }
      }
      bool repeatFlag_7 = true ;
      while (repeatFlag_7) {
        GGS_lbigint var_baseAddress_4569 = inCompiler->synthetizedAttribute_bigInteger () ;
        ...
        var_groupBaseAddresses_4237.addAssignOperation (var_baseAddress_4569  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 107)) ;
      ...
      GGS_controlRegisterGroupKindAST var_groupKind_4692 = GGS_controlRegisterGroupKindAST::class_func_groupArray (var_groupSize_4308, var_groupSizeExpressionLocation_4330, var_groupBaseAddresses_4237  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 112)) ;
      var_registerGroupListAST_3737.addAssignOperation (var_registerGroupName_3795, var_groupKind_4692  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 117)) ;
    } break ;
    default:
      break ;
    }
  ...
  GGS_controlRegisterDeclarationList var_controlRegisterDeclarationList_5047 = temp_8 ;
  ...
  while (repeatFlag_9) {
    ...
    GGS_controlRegisterNameListAST var_registerDeclarationList_5133 = temp_10 ;
    bool repeatFlag_11 = true ;
    while (repeatFlag_11) {
      nt_registerDeclaration_ (ioArgument_ioAST, var_registerDeclarationList_5133, inCompiler) ;
      if (select_omnibus_5F_syntax_36 (inCompiler) == 2) {
      }else{
        repeatFlag_11 = false ;
      }
    }
    GGS_lstring var_registerTypeName_5296 = inCompiler->synthetizedAttribute_tokenString () ;
    ...
    GGS_controlRegisterBitSliceList var_registerBitSliceList_5352 = temp_12 ;
    ...
    case 2: {
      ...
      while (repeatFlag_13) {
        GGS_controlRegisterBitSlice var_registerBitSlice_5467 ;
        switch (select_omnibus_5F_syntax_39 (inCompiler)) {
        case 1: {
          GGS_lbigint var_unusedBitCount_5537 = inCompiler->synthetizedAttribute_bigInteger () ;
          ...
          var_registerBitSlice_5467 = GGS_controlRegisterBitSlice::class_func_unusedBits (var_unusedBitCount_5537  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 140)) ;
        } break ;
        case 2: {
          GGS_lstring var_bitName_5662 = inCompiler->synthetizedAttribute_tokenString () ;
          ...
          case 1: {
            var_registerBitSlice_5467 = GGS_controlRegisterBitSlice::class_func_namedBit (var_bitName_5662, GGS_lbigint::init_21__21_ (GGS_bigint ("1", inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 144)), GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 144)), inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 144)) ;
          } break ;
          case 2: {
            ...
            GGS_lbigint var_bitCount_5840 = inCompiler->synthetizedAttribute_bigInteger () ;
            ...
            var_registerBitSlice_5467 = GGS_controlRegisterBitSlice::class_func_namedBit (var_bitName_5662, var_bitCount_5840  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 148)) ;
          } break ;
          default:
            break ;
          }
        ...
        var_registerBitSliceList_5352.addAssignOperation (var_registerBitSlice_5467  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 151)) ;
    ...
    GGS_location var_endOfBitSlice_6080 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 157)) ;
    var_controlRegisterDeclarationList_5047.addAssignOperation (var_registerDeclarationList_5133, var_registerTypeName_5296, var_registerBitSliceList_5352, var_endOfBitSlice_6080  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 158)) ;
    if (select_omnibus_5F_syntax_35 (inCompiler) == 2) {
    }else{
      repeatFlag_9 = false ;
    }
  }
  ioArgument_ioAST.mProperty_mDeclarationListAST.addAssignOperation (GGS_controlRegisterGroupDeclarationAST::init_21__21_ (var_registerGroupListAST_3737, var_controlRegisterDeclarationList_5047, inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 161)) ;
...
void cParser_omnibus_5F_syntax::rule_omnibus_5F_syntax_registerDeclaration_i28_ (GGS_ast & ioArgument_ioAST,
                                                                                 ...
                                                                                 Lexique_omnibus_5F_lexique * inCompiler) {
  GGS_lstring var_registerName_6801 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  case 1: {
    GGS_lstring var_attributeOffset_6849 = inCompiler->synthetizedAttribute_tokenString () ;
    ...
    GalgasBool test_0 = GalgasBool::boolTrue ;
    if (GalgasBool::boolTrue == test_0) {
      test_0 = GGS_bool (ComparisonKind::notEqual, var_attributeOffset_6849.readProperty_string ().objectCompare (GGS_string ("offset"))).boolEnum () ;
      if (GalgasBool::boolTrue == test_0) {
        GenericArray <FixItDescription> fixItArray1 ;
        appendFixItActions (fixItArray1, EnumFixItKind::fixItReplace, GGS_string ("@offset")) ;
        inCompiler->emitSemanticError (var_attributeOffset_6849.readProperty_location (), GGS_string ("attribute should be @offset"), fixItArray1  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 177)) ;
      }
    }
    GGS_expressionAST var_registerOffset_7044 ;
    nt_expression_ (ioArgument_ioAST, var_registerOffset_7044, inCompiler) ;
    GGS_bool var_isReadOnly_7075 ;
    switch (select_omnibus_5F_syntax_42 (inCompiler)) {
    case 1: {
      var_isReadOnly_7075 = GGS_bool (false) ;
    } break ;
    case 2: {
      GGS_lstring var_attribute_7161 = inCompiler->synthetizedAttribute_tokenString () ;
      ...
      GalgasBool test_2 = GalgasBool::boolTrue ;
      if (GalgasBool::boolTrue == test_2) {
        test_2 = GGS_bool (ComparisonKind::notEqual, var_attribute_7161.readProperty_string ().objectCompare (GGS_string ("ro"))).boolEnum () ;
        if (GalgasBool::boolTrue == test_2) {
          GenericArray <FixItDescription> fixItArray3 ;
          appendFixItActions (fixItArray3, EnumFixItKind::fixItReplace, GGS_string ("@ro")) ;
          inCompiler->emitSemanticError (var_attribute_7161.readProperty_location (), GGS_string ("attribute should be @ro"), fixItArray3  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 186)) ;
        }
      }
      var_isReadOnly_7075 = GGS_bool (true) ;
    } break ;
    default:
      break ;
    }
    ioArgument_ioRegisterDeclarationList.addAssignOperation (var_registerName_6801, GGS_controlRegisterKind::class_func_scalar (SOURCE_FILE ("declaration-control-register.galgas", 192)), var_isReadOnly_7075, var_registerOffset_7044, GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 195))  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 190)) ;
  } break ;
  case 2: {
    ...
    GGS_expressionAST var_baseAddressExpression_7803 ;
    nt_expression_ (ioArgument_ioAST, var_baseAddressExpression_7803, inCompiler) ;
    GGS_location var_baseAddressExpressionLocation_7835 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 205)) ;
    GGS_lstring var_attributeInc_7906 = inCompiler->synthetizedAttribute_tokenString () ;
    ...
    GalgasBool test_6 = GalgasBool::boolTrue ;
    if (GalgasBool::boolTrue == test_6) {
      test_6 = GGS_bool (ComparisonKind::notEqual, var_attributeInc_7906.readProperty_string ().objectCompare (GGS_string ("inc"))).boolEnum () ;
      if (GalgasBool::boolTrue == test_6) {
        GenericArray <FixItDescription> fixItArray7 ;
        appendFixItActions (fixItArray7, EnumFixItKind::fixItReplace, GGS_string ("@inc")) ;
        inCompiler->emitSemanticError (var_attributeInc_7906.readProperty_location (), GGS_string ("attribute should be @inc"), fixItArray7  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 208)) ;
      }
    }
    GGS_expressionAST var_arrayElementSizeExpression_8083 ;
    nt_expression_ (ioArgument_ioAST, var_arrayElementSizeExpression_8083, inCompiler) ;
    ...
    GGS_bool var_isReadOnly_8136 ;
    switch (select_omnibus_5F_syntax_43 (inCompiler)) {
    case 1: {
      var_isReadOnly_8136 = GGS_bool (false) ;
    } break ;
    case 2: {
      GGS_lstring var_attribute_8222 = inCompiler->synthetizedAttribute_tokenString () ;
      ...
      GalgasBool test_8 = GalgasBool::boolTrue ;
      if (GalgasBool::boolTrue == test_8) {
        test_8 = GGS_bool (ComparisonKind::notEqual, var_attribute_8222.readProperty_string ().objectCompare (GGS_string ("ro"))).boolEnum () ;
        if (GalgasBool::boolTrue == test_8) {
          GenericArray <FixItDescription> fixItArray9 ;
          appendFixItActions (fixItArray9, EnumFixItKind::fixItReplace, GGS_string ("@ro")) ;
          inCompiler->emitSemanticError (var_attribute_8222.readProperty_location (), GGS_string ("attribute should be @ro"), fixItArray9  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 218)) ;
        }
      }
      var_isReadOnly_8136 = GGS_bool (true) ;
    } break ;
    default:
      break ;
    }
    GGS_location var_arrayElementSizeExpressionLocation_8407 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 222)) ;
    ioArgument_ioRegisterDeclarationList.addAssignOperation (var_registerName_6801, GGS_controlRegisterKind::class_func_registerArray (var_sizeExpression_7519, var_sizeExpressionLocation_7544, var_arrayElementSizeExpression_8083, var_arrayElementSizeExpressionLocation_8407  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 225)), var_isReadOnly_8136, var_baseAddressExpression_7803, var_baseAddressExpressionLocation_7835  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 223)) ;
  } break ;
  default:
    break ;
  }
...
void cParser_omnibus_5F_syntax::rule_omnibus_5F_syntax_declaration_i29_ (GGS_ast & ioArgument_ioAST,
  ...
  GGS_lstring var_attribute_9240 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GalgasBool test_0 = GalgasBool::boolTrue ;
  if (GalgasBool::boolTrue == test_0) {
    test_0 = GGS_bool (ComparisonKind::notEqual, var_attribute_9240.readProperty_string ().objectCompare (function_userAttributeForRegister (inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 244)))).boolEnum () ;
    if (GalgasBool::boolTrue == test_0) {
      GenericArray <FixItDescription> fixItArray1 ;
      inCompiler->emitSemanticError (var_attribute_9240.readProperty_location (), GGS_string ("this attribute should be @").add_operation (function_userAttributeForRegister (inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 245)), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 245)), fixItArray1  COMMA_SOURCE_FILE ("declaration-control-register.galgas", 245)) ;
    }
  }
  GGS_lstring var_registerGroupName_9425 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  bool repeatFlag_2 = true ;
  while (repeatFlag_2) {
    GGS_lstring var_registerName_9486 = inCompiler->synthetizedAttribute_tokenString () ;
    ...
    GGS_lstring var_key_9509 = GGS_lstring::init_21__21_ (GGS_string ("//").add_operation (var_registerGroupName_9425.readProperty_string (), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 251)).add_operation (GGS_string (":"), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 251)).add_operation (var_registerName_9486.readProperty_string (), inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 251)), var_registerName_9486.readProperty_location (), inCompiler COMMA_HERE) ;
    {
    ioArgument_ioAST.mProperty_mControlRegisterUserAccesMapAST.setter_insertKey (var_key_9509, inCompiler COMMA_SOURCE_FILE ("declaration-control-register.galgas", 252)) ;
    }
...
void cParser_omnibus_5F_syntax::rule_omnibus_5F_syntax_instruction_i33_ (GGS_ast & ioArgument_ioAST,
  ...
  GGS_expressionAST var_bitExpression_1439 ;
  nt_expression_ (ioArgument_ioAST, var_bitExpression_1439, inCompiler) ;
  GGS_location var_bitExpressionLocation_1461 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 28)) ;
  inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__3D_ COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 29)) ;
  GGS_expressionAST var_sourceExpression_1538 ;
  nt_expression_ (ioArgument_ioAST, var_sourceExpression_1538, inCompiler) ;
  ioArgument_ioInstructionList.addAssignOperation (GGS_bitbandInstructionAST::init_21__21__21__21__21__21_ (var_registerLValue_1242.readProperty_mRegisterGroupName ().readProperty_location (), var_registerLValue_1242, var_bitExpression_1439, var_bitExpressionLocation_1461, var_sourceExpression_1538, GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 38)), inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 32)) ;
}
...
void cParser_omnibus_5F_syntax::rule_omnibus_5F_syntax_system_5F_routine_5F_declaration_i34_ (GGS_ast & ioArgument_ioAST,
                                                                                              const GGS_lstring constinArgument_inReceiverTypeName,
                                                                                              Lexique_omnibus_5F_lexique * inCompiler) {
  GGS_bool var_publicAccess_1140 ;
  switch (select_omnibus_5F_syntax_46 (inCompiler)) {
  case 1: {
    var_publicAccess_1140 = GGS_bool (false) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken_public COMMA_SOURCE_FILE ("declaration-svc.galgas", 30)) ;
    var_publicAccess_1140 = GGS_bool (true) ;
  } break ;
  default:
    break ;
  }
  inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken_section COMMA_SOURCE_FILE ("declaration-svc.galgas", 33)) ;
  GGS_lstring var_name_1283 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("declaration-svc.galgas", 34)) ;
  GGS_mode var_mode_1302 ;
  switch (select_omnibus_5F_syntax_47 (inCompiler)) {
  case 1: {
    var_mode_1302 = GGS_mode::class_func_sectionMode (SOURCE_FILE ("declaration-svc.galgas", 37)) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken_safe COMMA_SOURCE_FILE ("declaration-svc.galgas", 39)) ;
    var_mode_1302 = GGS_mode::class_func_safeSectionMode (SOURCE_FILE ("declaration-svc.galgas", 40)) ;
  } break ;
  default:
    break ;
  }
  GGS_lstringlist temp_0 = GGS_lstringlist::init (inCompiler COMMA_SOURCE_FILE ("declaration-svc.galgas", 42)) ;
  GGS_lstringlist var_attributeList_1423 = temp_0 ;
  bool repeatFlag_1 = true ;
  while (repeatFlag_1) {
    if (select_omnibus_5F_syntax_48 (inCompiler) == 2) {
      GGS_lstring var_attribute_1488 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__40_attribute COMMA_SOURCE_FILE ("declaration-svc.galgas", 45)) ;
      var_attributeList_1423.addAssignOperation (var_attribute_1488  COMMA_SOURCE_FILE ("declaration-svc.galgas", 46)) ;
    }else{
      repeatFlag_1 = false ;
    }
  }
  GGS_routineFormalArgumentListAST var_formalArgumentList_1586 ;
  nt_procedure_5F_formal_5F_arguments_ (ioArgument_ioAST, var_formalArgumentList_1586, inCompiler) ;
  GGS_lstring var_returnTypeName_1622 ;
  switch (select_omnibus_5F_syntax_49 (inCompiler)) {
  case 1: {
    var_returnTypeName_1622 = GGS_string::makeEmptyString ().getter_here (inCompiler COMMA_SOURCE_FILE ("declaration-svc.galgas", 51)) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__2D__3E_ COMMA_SOURCE_FILE ("declaration-svc.galgas", 53)) ;
    nt_type_5F_definition_ (ioArgument_ioAST, var_returnTypeName_1622, inCompiler) ;
  } break ;
  default:
    break ;
  }
  inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__7B_ COMMA_SOURCE_FILE ("declaration-svc.galgas", 56)) ;
  GGS_instructionListAST var_instructionList_1796 ;
  nt_instructionList_ (ioArgument_ioAST, var_instructionList_1796, inCompiler) ;
  ioArgument_ioAST.mProperty_mDeclarationListAST.addAssignOperation (GGS_systemRoutineDeclarationAST::init_21__21__21__21__21__21__21__21__21_ (constinArgument_inReceiverTypeName, var_name_1283, var_mode_1302, var_publicAccess_1140, var_attributeList_1423, var_formalArgumentList_1586, var_returnTypeName_1622, var_instructionList_1796, GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("declaration-svc.galgas", 67)), inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("declaration-svc.galgas", 58)) ;
...
void cParser_omnibus_5F_syntax::rule_omnibus_5F_syntax_system_5F_routine_5F_declaration_i35_ (GGS_ast & ioArgument_ioAST,
                                                                                              const GGS_lstring constinArgument_inReceiverTypeName,
                                                                                              Lexique_omnibus_5F_lexique * inCompiler) {
  GGS_bool var_publicAccess_2401 ;
  switch (select_omnibus_5F_syntax_50 (inCompiler)) {
  case 1: {
    var_publicAccess_2401 = GGS_bool (false) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken_public COMMA_SOURCE_FILE ("declaration-svc.galgas", 81)) ;
    var_publicAccess_2401 = GGS_bool (true) ;
  } break ;
  default:
    break ;
  }
  inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken_primitive COMMA_SOURCE_FILE ("declaration-svc.galgas", 84)) ;
  GGS_lstring var_name_2546 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("declaration-svc.galgas", 85)) ;
  GGS_mode var_mode_2565 ;
  switch (select_omnibus_5F_syntax_51 (inCompiler)) {
  case 1: {
    var_mode_2565 = GGS_mode::class_func_primitiveMode (SOURCE_FILE ("declaration-svc.galgas", 88)) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken_safe COMMA_SOURCE_FILE ("declaration-svc.galgas", 90)) ;
    var_mode_2565 = GGS_mode::class_func_safePrimitiveMode (SOURCE_FILE ("declaration-svc.galgas", 91)) ;
  } break ;
  default:
    break ;
  }
  GGS_lstringlist temp_0 = GGS_lstringlist::init (inCompiler COMMA_SOURCE_FILE ("declaration-svc.galgas", 93)) ;
  GGS_lstringlist var_attributeList_2690 = temp_0 ;
  bool repeatFlag_1 = true ;
  while (repeatFlag_1) {
    if (select_omnibus_5F_syntax_52 (inCompiler) == 2) {
      GGS_lstring var_attribute_2755 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__40_attribute COMMA_SOURCE_FILE ("declaration-svc.galgas", 96)) ;
      var_attributeList_2690.addAssignOperation (var_attribute_2755  COMMA_SOURCE_FILE ("declaration-svc.galgas", 97)) ;
    }else{
      repeatFlag_1 = false ;
    }
  }
  GGS_routineFormalArgumentListAST var_formalArgumentList_2859 ;
  nt_procedure_5F_input_5F_formal_5F_arguments_ (ioArgument_ioAST, var_formalArgumentList_2859, inCompiler) ;
  inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__7B_ COMMA_SOURCE_FILE ("declaration-svc.galgas", 100)) ;
  GGS_instructionListAST var_instructionList_2921 ;
  nt_instructionList_ (ioArgument_ioAST, var_instructionList_2921, inCompiler) ;
  inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__7D_ COMMA_SOURCE_FILE ("declaration-svc.galgas", 102)) ;
  ioArgument_ioAST.mProperty_mDeclarationListAST.addAssignOperation (GGS_systemRoutineDeclarationAST::init_21__21__21__21__21__21__21__21__21_ (constinArgument_inReceiverTypeName, var_name_2546, var_mode_2565, var_publicAccess_2401, var_attributeList_2690, var_formalArgumentList_2859, GGS_string::makeEmptyString ().getter_here (inCompiler COMMA_SOURCE_FILE ("declaration-svc.galgas", 110)), var_instructionList_2921, GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("declaration-svc.galgas", 112)), inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("declaration-svc.galgas", 103)) ;
}
...
void cParser_omnibus_5F_syntax::rule_omnibus_5F_syntax_system_5F_routine_5F_declaration_i36_ (GGS_ast & ioArgument_ioAST,
                                                                                              const GGS_lstring constinArgument_inReceiverTypeName,
                                                                                              Lexique_omnibus_5F_lexique * inCompiler) {
  GGS_bool var_publicAccess_3429 ;
  switch (select_omnibus_5F_syntax_53 (inCompiler)) {
  case 1: {
    var_publicAccess_3429 = GGS_bool (false) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken_public COMMA_SOURCE_FILE ("declaration-svc.galgas", 123)) ;
    var_publicAccess_3429 = GGS_bool (true) ;
  } break ;
  default:
    break ;
  }
  inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken_service COMMA_SOURCE_FILE ("declaration-svc.galgas", 126)) ;
  GGS_lstring var_name_3572 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("declaration-svc.galgas", 127)) ;
  GGS_mode var_mode_3591 ;
  switch (select_omnibus_5F_syntax_54 (inCompiler)) {
  case 1: {
    var_mode_3591 = GGS_mode::class_func_serviceMode (SOURCE_FILE ("declaration-svc.galgas", 130)) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken_safe COMMA_SOURCE_FILE ("declaration-svc.galgas", 132)) ;
    var_mode_3591 = GGS_mode::class_func_safeServiceMode (SOURCE_FILE ("declaration-svc.galgas", 133)) ;
  } break ;
  default:
    break ;
  }
  GGS_lstringlist temp_0 = GGS_lstringlist::init (inCompiler COMMA_SOURCE_FILE ("declaration-svc.galgas", 135)) ;
  GGS_lstringlist var_attributeList_3712 = temp_0 ;
  bool repeatFlag_1 = true ;
  while (repeatFlag_1) {
    if (select_omnibus_5F_syntax_55 (inCompiler) == 2) {
      GGS_lstring var_attribute_3777 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__40_attribute COMMA_SOURCE_FILE ("declaration-svc.galgas", 138)) ;
      var_attributeList_3712.addAssignOperation (var_attribute_3777  COMMA_SOURCE_FILE ("declaration-svc.galgas", 139)) ;
    }else{
      repeatFlag_1 = false ;
    }
  }
  GGS_routineFormalArgumentListAST var_formalArgumentList_3881 ;
  nt_procedure_5F_input_5F_formal_5F_arguments_ (ioArgument_ioAST, var_formalArgumentList_3881, inCompiler) ;
  inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__7B_ COMMA_SOURCE_FILE ("declaration-svc.galgas", 142)) ;
  GGS_instructionListAST var_instructionList_3943 ;
  nt_instructionList_ (ioArgument_ioAST, var_instructionList_3943, inCompiler) ;
  inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__7D_ COMMA_SOURCE_FILE ("declaration-svc.galgas", 144)) ;
  ioArgument_ioAST.mProperty_mDeclarationListAST.addAssignOperation (GGS_systemRoutineDeclarationAST::init_21__21__21__21__21__21__21__21__21_ (constinArgument_inReceiverTypeName, var_name_3572, var_mode_3591, var_publicAccess_3429, var_attributeList_3712, var_formalArgumentList_3881, GGS_string::makeEmptyString ().getter_here (inCompiler COMMA_SOURCE_FILE ("declaration-svc.galgas", 152)), var_instructionList_3943, GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("declaration-svc.galgas", 154)), inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("declaration-svc.galgas", 145)) ;
}
...
void cParser_omnibus_5F_syntax::rule_omnibus_5F_syntax_declaration_i42_ (GGS_ast & ioArgument_ioAST,
  ...
  GGS_lstring var_llvmName_1551 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  ioArgument_ioAST.mProperty_mExternFunctionListAST.addAssignOperation (var_procName_1280, var_mode_1259, var_attributeList_1311, var_procFormalArgumentList_1352, var_returnTypeName_1392, var_llvmName_1551, GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("declaration-extern-proc.galgas", 47))  COMMA_SOURCE_FILE ("declaration-extern-proc.galgas", 40)) ;
}
...
void cParser_omnibus_5F_syntax::rule_omnibus_5F_syntax_instruction_i45_ (GGS_ast & ioArgument_ioAST,
  ...
  GGS_expressionAST var_expression_1190 ;
  nt_expression_ (ioArgument_ioAST, var_expression_1190, inCompiler) ;
  ioArgument_ioInstructionList.addAssignOperation (GGS_checkInstructionAST::init_21__21__21_ (var_checkMessage_1038.readProperty_location (), var_checkMessage_1038, var_expression_1190, inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("directive-check.galgas", 28)) ;
...
void cParser_omnibus_5F_syntax::rule_omnibus_5F_syntax_primary_i46_ (GGS_ast & ioArgument_ioAST,
  ...
  nt_expression_ (ioArgument_ioAST, outArgument_outExpression, inCompiler) ;
  GGS_location var_endOfExpression_1219 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("expression-truncate.galgas", 29)) ;
  inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__29_ COMMA_SOURCE_FILE ("expression-truncate.galgas", 30)) ;
  outArgument_outExpression = GGS_truncateExpressionAST::init_21__21__21_ (outArgument_outExpression, var_typeName_1061, var_endOfExpression_1219, inCompiler COMMA_HERE) ;
}
...
void cParser_omnibus_5F_syntax::rule_omnibus_5F_syntax_primary_i47_ (GGS_ast & ioArgument_ioAST,
  ...
  nt_expression_ (ioArgument_ioAST, outArgument_outExpression, inCompiler) ;
  GGS_location var_endOfExpression_1217 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("expression-extend.galgas", 29)) ;
  inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__29_ COMMA_SOURCE_FILE ("expression-extend.galgas", 30)) ;
  outArgument_outExpression = GGS_extendExpressionAST::init_21__21__21_ (outArgument_outExpression, var_typeName_1059, var_endOfExpression_1217, inCompiler COMMA_HERE) ;
}
...
void cParser_omnibus_5F_syntax::rule_omnibus_5F_syntax_expression_5F_logical_5F_and_i49_ (GGS_ast & ioArgument_ioAST,
  ...
  while (repeatFlag_0) {
    if (select_omnibus_5F_syntax_61 (inCompiler) == 2) {
      inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__26__26_ COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 43)) ;
      GGS_location var_operatorLocation_1848 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 44)) ;
      GGS_expressionAST var_rightExpression_1925 ;
      nt_expression_5F_bitwise_5F_or_ (ioArgument_ioAST, var_rightExpression_1925, inCompiler) ;
      outArgument_outExpression = GGS_booleanShortCircuitAndOperatorExpressionAST::init_21__21__21_ (outArgument_outExpression, var_operatorLocation_1848, var_rightExpression_1925, inCompiler COMMA_HERE) ;
    }else{
      repeatFlag_0 = false ;
    }
  }
...
void cParser_omnibus_5F_syntax::rule_omnibus_5F_syntax_expression_5F_bitwise_5F_or_i50_ (GGS_ast & ioArgument_ioAST,
  ...
  while (repeatFlag_0) {
    if (select_omnibus_5F_syntax_62 (inCompiler) == 2) {
      inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__7C_ COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 60)) ;
      GGS_location var_operatorLocation_2397 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 61)) ;
      GGS_expressionAST var_rightExpression_2475 ;
      nt_expression_5F_bitwise_5F_xor_ (ioArgument_ioAST, var_rightExpression_2475, inCompiler) ;
      outArgument_outExpression = GGS_omnibusInfixOperatorExpressionAST::init_21__21__21__21_ (outArgument_outExpression, var_operatorLocation_2397, GGS_omnibusInfixOperator::class_func_bitWiseOrOp (SOURCE_FILE ("expression-operator-priority.galgas", 66)), var_rightExpression_2475, inCompiler COMMA_HERE) ;
    }else{
      repeatFlag_0 = false ;
    }
  }
...
void cParser_omnibus_5F_syntax::rule_omnibus_5F_syntax_expression_5F_bitwise_5F_xor_i51_ (GGS_ast & ioArgument_ioAST,
  ...
  while (repeatFlag_0) {
    if (select_omnibus_5F_syntax_63 (inCompiler) == 2) {
      inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__5E_ COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 78)) ;
      GGS_location var_operatorLocation_2960 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 79)) ;
      GGS_expressionAST var_rightExpression_3038 ;
      nt_expression_5F_bitwise_5F_and_ (ioArgument_ioAST, var_rightExpression_3038, inCompiler) ;
      outArgument_outExpression = GGS_omnibusInfixOperatorExpressionAST::init_21__21__21__21_ (outArgument_outExpression, var_operatorLocation_2960, GGS_omnibusInfixOperator::class_func_bitWiseXorOp (SOURCE_FILE ("expression-operator-priority.galgas", 84)), var_rightExpression_3038, inCompiler COMMA_HERE) ;
    }else{
      repeatFlag_0 = false ;
    }
  }
...
void cParser_omnibus_5F_syntax::rule_omnibus_5F_syntax_expression_5F_bitwise_5F_and_i52_ (GGS_ast & ioArgument_ioAST,
  ...
  while (repeatFlag_0) {
    if (select_omnibus_5F_syntax_64 (inCompiler) == 2) {
      inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__26_ COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 96)) ;
      GGS_location var_operatorLocation_3522 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 97)) ;
      GGS_expressionAST var_rightExpression_3597 ;
      nt_expression_5F_equality_ (ioArgument_ioAST, var_rightExpression_3597, inCompiler) ;
      outArgument_outExpression = GGS_omnibusInfixOperatorExpressionAST::init_21__21__21__21_ (outArgument_outExpression, var_operatorLocation_3522, GGS_omnibusInfixOperator::class_func_bitWiseAndOp (SOURCE_FILE ("expression-operator-priority.galgas", 102)), var_rightExpression_3597, inCompiler COMMA_HERE) ;
    }else{
      repeatFlag_0 = false ;
    }
  }
...
void cParser_omnibus_5F_syntax::rule_omnibus_5F_syntax_expression_5F_equality_i53_ (GGS_ast & ioArgument_ioAST,
  ...
  case 2: {
    inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__3D__3D_ COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 114)) ;
    GGS_location var_operatorLocation_4077 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 115)) ;
    GGS_expressionAST var_rightExpression_4154 ;
    nt_expression_5F_comparison_ (ioArgument_ioAST, var_rightExpression_4154, inCompiler) ;
    outArgument_outExpression = GGS_omnibusInfixOperatorExpressionAST::init_21__21__21__21_ (outArgument_outExpression, var_operatorLocation_4077, GGS_omnibusInfixOperator::class_func_equal (SOURCE_FILE ("expression-operator-priority.galgas", 120)), var_rightExpression_4154, inCompiler COMMA_HERE) ;
  } break ;
  case 3: {
    inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__2260_ COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 124)) ;
    GGS_location var_operatorLocation_4354 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 125)) ;
    GGS_expressionAST var_rightExpression_4431 ;
    nt_expression_5F_comparison_ (ioArgument_ioAST, var_rightExpression_4431, inCompiler) ;
    GGS_omnibusInfixOperatorExpressionAST var_expression_4457 = GGS_omnibusInfixOperatorExpressionAST::init_21__21__21__21_ (outArgument_outExpression, var_operatorLocation_4354, GGS_omnibusInfixOperator::class_func_equal (SOURCE_FILE ("expression-operator-priority.galgas", 130)), var_rightExpression_4431, inCompiler COMMA_HERE) ;
    outArgument_outExpression = GGS_prefixOperatorExpressionAST::init_21__21__21_ (var_operatorLocation_4354, GGS_prefixOperator::class_func_notOp (SOURCE_FILE ("expression-operator-priority.galgas", 135)), var_expression_4457, inCompiler COMMA_HERE) ;
  } break ;
  default:
    break ;
  }
...
void cParser_omnibus_5F_syntax::rule_omnibus_5F_syntax_expression_5F_comparison_i54_ (GGS_ast & ioArgument_ioAST,
  ...
  case 2: {
    inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__2264_ COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 147)) ;
    GGS_location var_operatorLocation_5024 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 148)) ;
    GGS_expressionAST var_rightExpression_5096 ;
    nt_expression_5F_shift_ (ioArgument_ioAST, var_rightExpression_5096, inCompiler) ;
    outArgument_outExpression = GGS_omnibusInfixOperatorExpressionAST::init_21__21__21__21_ (outArgument_outExpression, var_operatorLocation_5024, GGS_omnibusInfixOperator::class_func_infEqual (SOURCE_FILE ("expression-operator-priority.galgas", 153)), var_rightExpression_5096, inCompiler COMMA_HERE) ;
  } break ;
  case 3: {
    inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__2265_ COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 157)) ;
    GGS_location var_operatorLocation_5299 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 158)) ;
    GGS_expressionAST var_rightExpression_5371 ;
    nt_expression_5F_shift_ (ioArgument_ioAST, var_rightExpression_5371, inCompiler) ;
    GGS_omnibusInfixOperatorExpressionAST var_expression_5397 = GGS_omnibusInfixOperatorExpressionAST::init_21__21__21__21_ (outArgument_outExpression, var_operatorLocation_5299, GGS_omnibusInfixOperator::class_func_lessThan (SOURCE_FILE ("expression-operator-priority.galgas", 163)), var_rightExpression_5371, inCompiler COMMA_HERE) ;
    outArgument_outExpression = GGS_prefixOperatorExpressionAST::init_21__21__21_ (var_operatorLocation_5299, GGS_prefixOperator::class_func_notOp (SOURCE_FILE ("expression-operator-priority.galgas", 168)), var_expression_5397, inCompiler COMMA_HERE) ;
  } break ;
  case 4: {
    inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__3C_ COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 172)) ;
    GGS_location var_operatorLocation_5698 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 173)) ;
    GGS_expressionAST var_rightExpression_5770 ;
    nt_expression_5F_shift_ (ioArgument_ioAST, var_rightExpression_5770, inCompiler) ;
    outArgument_outExpression = GGS_omnibusInfixOperatorExpressionAST::init_21__21__21__21_ (outArgument_outExpression, var_operatorLocation_5698, GGS_omnibusInfixOperator::class_func_lessThan (SOURCE_FILE ("expression-operator-priority.galgas", 178)), var_rightExpression_5770, inCompiler COMMA_HERE) ;
  } break ;
  case 5: {
    inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__3E_ COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 182)) ;
    GGS_location var_operatorLocation_5973 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 183)) ;
    GGS_expressionAST var_rightExpression_6045 ;
    nt_expression_5F_shift_ (ioArgument_ioAST, var_rightExpression_6045, inCompiler) ;
    GGS_omnibusInfixOperatorExpressionAST var_expression_6071 = GGS_omnibusInfixOperatorExpressionAST::init_21__21__21__21_ (outArgument_outExpression, var_operatorLocation_5973, GGS_omnibusInfixOperator::class_func_infEqual (SOURCE_FILE ("expression-operator-priority.galgas", 188)), var_rightExpression_6045, inCompiler COMMA_HERE) ;
    outArgument_outExpression = GGS_prefixOperatorExpressionAST::init_21__21__21_ (var_operatorLocation_5973, GGS_prefixOperator::class_func_notOp (SOURCE_FILE ("expression-operator-priority.galgas", 193)), var_expression_6071, inCompiler COMMA_HERE) ;
  } break ;
  default:
    break ;
  }
...
void cParser_omnibus_5F_syntax::rule_omnibus_5F_syntax_expression_5F_shift_i55_ (GGS_ast & ioArgument_ioAST,
  ...
  while (repeatFlag_0) {
    ...
    case 2: {
      inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__3C__3C_ COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 205)) ;
      GGS_location var_operatorLocation_6643 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 206)) ;
      GGS_expressionAST var_rightExpression_6718 ;
      nt_expression_5F_addition_ (ioArgument_ioAST, var_rightExpression_6718, inCompiler) ;
      outArgument_outExpression = GGS_omnibusInfixOperatorExpressionAST::init_21__21__21__21_ (outArgument_outExpression, var_operatorLocation_6643, GGS_omnibusInfixOperator::class_func_leftShiftOp (SOURCE_FILE ("expression-operator-priority.galgas", 211)), var_rightExpression_6718, inCompiler COMMA_HERE) ;
    } break ;
    case 3: {
      inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__3E__3E_ COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 215)) ;
      GGS_location var_operatorLocation_6928 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 216)) ;
      GGS_expressionAST var_rightExpression_7003 ;
      nt_expression_5F_addition_ (ioArgument_ioAST, var_rightExpression_7003, inCompiler) ;
      outArgument_outExpression = GGS_omnibusInfixOperatorExpressionAST::init_21__21__21__21_ (outArgument_outExpression, var_operatorLocation_6928, GGS_omnibusInfixOperator::class_func_rightShiftOp (SOURCE_FILE ("expression-operator-priority.galgas", 221)), var_rightExpression_7003, inCompiler COMMA_HERE) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
...
void cParser_omnibus_5F_syntax::rule_omnibus_5F_syntax_expression_5F_addition_i56_ (GGS_ast & ioArgument_ioAST,
  ...
  while (repeatFlag_0) {
    ...
    case 2: {
      inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__2B_ COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 233)) ;
      GGS_location var_operatorLocation_7482 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 234)) ;
      GGS_expressionAST var_rightExpression_7556 ;
      nt_expression_5F_product_ (ioArgument_ioAST, var_rightExpression_7556, inCompiler) ;
      outArgument_outExpression = GGS_omnibusInfixOperatorExpressionAST::init_21__21__21__21_ (outArgument_outExpression, var_operatorLocation_7482, GGS_omnibusInfixOperator::class_func_addOp (SOURCE_FILE ("expression-operator-priority.galgas", 239)), var_rightExpression_7556, inCompiler COMMA_HERE) ;
    } break ;
    case 3: {
      inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__2B__25_ COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 243)) ;
      GGS_location var_operatorLocation_7760 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 244)) ;
      GGS_expressionAST var_rightExpression_7834 ;
      nt_expression_5F_product_ (ioArgument_ioAST, var_rightExpression_7834, inCompiler) ;
      outArgument_outExpression = GGS_omnibusInfixOperatorExpressionAST::init_21__21__21__21_ (outArgument_outExpression, var_operatorLocation_7760, GGS_omnibusInfixOperator::class_func_addOpNoOvf (SOURCE_FILE ("expression-operator-priority.galgas", 249)), var_rightExpression_7834, inCompiler COMMA_HERE) ;
    } break ;
    case 4: {
      inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__2D_ COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 253)) ;
      GGS_location var_operatorLocation_8042 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 254)) ;
      GGS_expressionAST var_rightExpression_8116 ;
      nt_expression_5F_product_ (ioArgument_ioAST, var_rightExpression_8116, inCompiler) ;
      outArgument_outExpression = GGS_omnibusInfixOperatorExpressionAST::init_21__21__21__21_ (outArgument_outExpression, var_operatorLocation_8042, GGS_omnibusInfixOperator::class_func_subOp (SOURCE_FILE ("expression-operator-priority.galgas", 259)), var_rightExpression_8116, inCompiler COMMA_HERE) ;
    } break ;
    case 5: {
      inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__2D__25_ COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 263)) ;
      GGS_location var_operatorLocation_8320 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 264)) ;
      GGS_expressionAST var_rightExpression_8394 ;
      nt_expression_5F_product_ (ioArgument_ioAST, var_rightExpression_8394, inCompiler) ;
      outArgument_outExpression = GGS_omnibusInfixOperatorExpressionAST::init_21__21__21__21_ (outArgument_outExpression, var_operatorLocation_8320, GGS_omnibusInfixOperator::class_func_subOpNoOvf (SOURCE_FILE ("expression-operator-priority.galgas", 269)), var_rightExpression_8394, inCompiler COMMA_HERE) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
...
void cParser_omnibus_5F_syntax::rule_omnibus_5F_syntax_expression_5F_product_i57_ (GGS_ast & ioArgument_ioAST,
  ...
  while (repeatFlag_0) {
    ...
    case 2: {
      inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__2A_ COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 281)) ;
      GGS_location var_operatorLocation_8859 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 282)) ;
      GGS_expressionAST var_rightExpression_8922 ;
      nt_primary_ (ioArgument_ioAST, var_rightExpression_8922, inCompiler) ;
      outArgument_outExpression = GGS_omnibusInfixOperatorExpressionAST::init_21__21__21__21_ (outArgument_outExpression, var_operatorLocation_8859, GGS_omnibusInfixOperator::class_func_mulOp (SOURCE_FILE ("expression-operator-priority.galgas", 287)), var_rightExpression_8922, inCompiler COMMA_HERE) ;
    } break ;
    case 3: {
      inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__2A__25_ COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 291)) ;
      GGS_location var_operatorLocation_9126 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 292)) ;
      GGS_expressionAST var_rightExpression_9189 ;
      nt_primary_ (ioArgument_ioAST, var_rightExpression_9189, inCompiler) ;
      outArgument_outExpression = GGS_omnibusInfixOperatorExpressionAST::init_21__21__21__21_ (outArgument_outExpression, var_operatorLocation_9126, GGS_omnibusInfixOperator::class_func_mulOpNoOvf (SOURCE_FILE ("expression-operator-priority.galgas", 297)), var_rightExpression_9189, inCompiler COMMA_HERE) ;
    } break ;
    case 4: {
      inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__25_ COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 301)) ;
      GGS_location var_operatorLocation_9397 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 302)) ;
      GGS_expressionAST var_rightExpression_9460 ;
      nt_primary_ (ioArgument_ioAST, var_rightExpression_9460, inCompiler) ;
      outArgument_outExpression = GGS_omnibusInfixOperatorExpressionAST::init_21__21__21__21_ (outArgument_outExpression, var_operatorLocation_9397, GGS_omnibusInfixOperator::class_func_modOp (SOURCE_FILE ("expression-operator-priority.galgas", 307)), var_rightExpression_9460, inCompiler COMMA_HERE) ;
    } break ;
    case 5: {
      inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__21__25_ COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 311)) ;
      GGS_location var_operatorLocation_9664 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 312)) ;
      GGS_expressionAST var_rightExpression_9727 ;
      nt_primary_ (ioArgument_ioAST, var_rightExpression_9727, inCompiler) ;
      outArgument_outExpression = GGS_omnibusInfixOperatorExpressionAST::init_21__21__21__21_ (outArgument_outExpression, var_operatorLocation_9664, GGS_omnibusInfixOperator::class_func_modOpNoOvf (SOURCE_FILE ("expression-operator-priority.galgas", 317)), var_rightExpression_9727, inCompiler COMMA_HERE) ;
    } break ;
    case 6: {
      inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__2F_ COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 321)) ;
      GGS_location var_operatorLocation_9935 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 322)) ;
      GGS_expressionAST var_rightExpression_9998 ;
      nt_primary_ (ioArgument_ioAST, var_rightExpression_9998, inCompiler) ;
      outArgument_outExpression = GGS_omnibusInfixOperatorExpressionAST::init_21__21__21__21_ (outArgument_outExpression, var_operatorLocation_9935, GGS_omnibusInfixOperator::class_func_divOp (SOURCE_FILE ("expression-operator-priority.galgas", 327)), var_rightExpression_9998, inCompiler COMMA_HERE) ;
    } break ;
    case 7: {
      inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__21__2F_ COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 331)) ;
      GGS_location var_operatorLocation_10202 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 332)) ;
      GGS_expressionAST var_rightExpression_10265 ;
      nt_primary_ (ioArgument_ioAST, var_rightExpression_10265, inCompiler) ;
      outArgument_outExpression = GGS_omnibusInfixOperatorExpressionAST::init_21__21__21__21_ (outArgument_outExpression, var_operatorLocation_10202, GGS_omnibusInfixOperator::class_func_divOpNoOvf (SOURCE_FILE ("expression-operator-priority.galgas", 337)), var_rightExpression_10265, inCompiler COMMA_HERE) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
...
void cParser_omnibus_5F_syntax::rule_omnibus_5F_syntax_primary_i58_ (GGS_ast & ioArgument_ioAST,
                                                                     ...
                                                                     Lexique_omnibus_5F_lexique * inCompiler) {
  outArgument_outExpression.drop () ; // Release 'out' argument
  inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__7E_ COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 346)) ;
  GGS_location var_operatorLocation_10657 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 347)) ;
  GGS_expressionAST var_expression_10718 ;
  nt_primary_ (ioArgument_ioAST, var_expression_10718, inCompiler) ;
  outArgument_outExpression = GGS_prefixOperatorExpressionAST::init_21__21__21_ (var_operatorLocation_10657, GGS_prefixOperator::class_func_bitWiseComplement (SOURCE_FILE ("expression-operator-priority.galgas", 351)), var_expression_10718, inCompiler COMMA_HERE) ;
}
...
void cParser_omnibus_5F_syntax::rule_omnibus_5F_syntax_primary_i59_ (GGS_ast & ioArgument_ioAST,
                                                                     ...
                                                                     Lexique_omnibus_5F_lexique * inCompiler) {
  outArgument_outExpression.drop () ; // Release 'out' argument
  inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken_not COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 359)) ;
  GGS_location var_operatorLocation_11062 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 360)) ;
  GGS_expressionAST var_expression_11123 ;
  nt_primary_ (ioArgument_ioAST, var_expression_11123, inCompiler) ;
  outArgument_outExpression = GGS_prefixOperatorExpressionAST::init_21__21__21_ (var_operatorLocation_11062, GGS_prefixOperator::class_func_notOp (SOURCE_FILE ("expression-operator-priority.galgas", 364)), var_expression_11123, inCompiler COMMA_HERE) ;
}
...
void cParser_omnibus_5F_syntax::rule_omnibus_5F_syntax_primary_i60_ (GGS_ast & ioArgument_ioAST,
                                                                     ...
                                                                     Lexique_omnibus_5F_lexique * inCompiler) {
  outArgument_outExpression.drop () ; // Release 'out' argument
  inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__2D_ COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 372)) ;
  GGS_location var_operatorLocation_11453 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 373)) ;
  GGS_expressionAST var_expression_11514 ;
  nt_primary_ (ioArgument_ioAST, var_expression_11514, inCompiler) ;
  outArgument_outExpression = GGS_prefixOperatorExpressionAST::init_21__21__21_ (var_operatorLocation_11453, GGS_prefixOperator::class_func_minusOp (SOURCE_FILE ("expression-operator-priority.galgas", 377)), var_expression_11514, inCompiler COMMA_HERE) ;
}
...
void cParser_omnibus_5F_syntax::rule_omnibus_5F_syntax_primary_i61_ (GGS_ast & ioArgument_ioAST,
                                                                     ...
                                                                     Lexique_omnibus_5F_lexique * inCompiler) {
  outArgument_outExpression.drop () ; // Release 'out' argument
  inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__2D__25_ COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 385)) ;
  GGS_location var_operatorLocation_11847 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 386)) ;
  GGS_expressionAST var_expression_11908 ;
  nt_primary_ (ioArgument_ioAST, var_expression_11908, inCompiler) ;
  outArgument_outExpression = GGS_prefixOperatorExpressionAST::init_21__21__21_ (var_operatorLocation_11847, GGS_prefixOperator::class_func_minusNoOvf (SOURCE_FILE ("expression-operator-priority.galgas", 390)), var_expression_11908, inCompiler COMMA_HERE) ;
}
...
void cParser_omnibus_5F_syntax::rule_omnibus_5F_syntax_primary_i62_ (GGS_ast & ioArgument_ioAST,
                                                                     ...
                                                                     Lexique_omnibus_5F_lexique * inCompiler) {
  outArgument_outExpression.drop () ; // Release 'out' argument
  inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__28_ COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 398)) ;
  nt_expression_ (ioArgument_ioAST, outArgument_outExpression, inCompiler) ;
  inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__29_ COMMA_SOURCE_FILE ("expression-operator-priority.galgas", 400)) ;
}
...
void cParser_omnibus_5F_syntax::rule_omnibus_5F_syntax_declaration_i63_ (GGS_ast & ioArgument_ioAST,
  ...
  GGS_expressionAST var_expression_1715 ;
  nt_expression_ (ioArgument_ioAST, var_expression_1715, inCompiler) ;
  ioArgument_ioAST.mProperty_mDeclarationListAST.addAssignOperation (GGS_globalConstantDeclarationAST::init_21__21__21__21_ (var_constantName_1527, var_attributeList_1388, var_typeName_1557, var_expression_1715, inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("declaration-global-constant.galgas", 43)) ;
}
...
void cParser_omnibus_5F_syntax::rule_omnibus_5F_syntax_if_5F_instruction_i85_ (GGS_ast & ioArgument_ioAST,
  ...
  GGS_expressionAST var_testExpression_2118 ;
  nt_expression_ (ioArgument_ioAST, var_testExpression_2118, inCompiler) ;
  GGS_location var_testExpressionEndLocation_2141 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("instruction-if.galgas", 48)) ;
  inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__7B_ COMMA_SOURCE_FILE ("instruction-if.galgas", 49)) ;
  GGS_instructionListAST var_thenInstructionList_2227 ;
  ...
  GGS_location var_endOfThenBranch_2263 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("instruction-if.galgas", 52)) ;
  GGS_instructionListAST var_elseInstructionList_2324 ;
  ...
  case 3: {
    ...
    GGS_ifInstructionAST var_ifInstruction_2536 ;
    ...
    temp_3.plusPlusAssignOperation (GGS_instructionListAST_2E_element::init_21_ (var_ifInstruction_2536, inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("instruction-if.galgas", 64)) ;
    var_elseInstructionList_2324 = temp_3 ;
  } break ;
  default:
    break ;
  }
  GGS_location var_endOfElseBranch_2614 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("instruction-if.galgas", 66)) ;
  outArgument_outIfInstruction = GGS_ifInstructionAST::init_21__21__21__21__21__21__21__21__21_ (var_instructionLocation_1621, var_testExpression_2118, var_testExpressionEndLocation_2141, var_staticIfExpression_1672, var_thenInstructionList_2227, var_endOfThenBranch_2263, var_elseInstructionList_2324, var_endOfElseBranch_2614, GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("instruction-if.galgas", 76)), inCompiler COMMA_HERE) ;
}
...
void cParser_omnibus_5F_syntax::rule_omnibus_5F_syntax_declaration_i91_ (GGS_ast & ioArgument_ioAST,
  ...
  GGS_lbigint var_bitSize_3989 = inCompiler->synthetizedAttribute_bigInteger () ;
  inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken_integer COMMA_SOURCE_FILE ("llvm-generic-type.galgas", 113)) ;
  inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__7D_ COMMA_SOURCE_FILE ("llvm-generic-type.galgas", 114)) ;
  ioArgument_ioAST.mProperty_mDeclarationListAST.addAssignOperation (GGS_llvmGenericType::init_21__21__21__21_ (var_typeName_3704, var_genericFormalParameterList_3749, var_whereClause_3808, var_bitSize_3989.readProperty_bigint (), inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("llvm-generic-type.galgas", 115)) ;
}
...
void cParser_omnibus_5F_syntax::rule_omnibus_5F_syntax_instruction_i103_ (GGS_ast & ioArgument_ioAST,
                                                                          GGS_instructionListAST & ioArgument_ioInstructionList,
                                                                          Lexique_omnibus_5F_lexique * inCompiler) {
  inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken_var COMMA_SOURCE_FILE ("instruction-var.galgas", 42)) ;
  GGS_lstring var_varName_1761 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("instruction-var.galgas", 43)) ;
  GGS_lstring var_typeName_1804 ;
  nt_type_5F_definition_ (ioArgument_ioAST, var_typeName_1804, inCompiler) ;
  ioArgument_ioInstructionList.addAssignOperation (GGS_varDeclarationInstructionAST::init_21__21__21_ (var_varName_1761.readProperty_location (), var_varName_1761, var_typeName_1804, inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("instruction-var.galgas", 45)) ;
  switch (select_omnibus_5F_syntax_101 (inCompiler)) {
  case 1: {
  } break ;
  case 2: {
    inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__3D_ COMMA_SOURCE_FILE ("instruction-var.galgas", 52)) ;
    GGS_expressionAST var_sourceExpression_2007 ;
    nt_expression_ (ioArgument_ioAST, var_sourceExpression_2007, inCompiler) ;
    GGS_LValueAST var_assignmentTargetAST_2034 = GGS_LValueAST::init_21__21_ (var_varName_1761, GGS_LValueOperandAST::class_func_noOperand (SOURCE_FILE ("instruction-var.galgas", 54)), inCompiler COMMA_HERE) ;
    ioArgument_ioInstructionList.addAssignOperation (GGS_assignmentInstructionAST::init_21__21__21_ (var_assignmentTargetAST_2034.readProperty_mIdentifier ().readProperty_location (), var_assignmentTargetAST_2034, var_sourceExpression_2007, inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("instruction-var.galgas", 55)) ;
  } break ;
  default:
    break ;
  }
...
void cParser_omnibus_5F_syntax::rule_omnibus_5F_syntax_isr_5F_in_5F_driver_i107_ (GGS_ast & ioArgument_ioAST,
  ...
  case 1: {
    ...
    var_mode_917 = GGS_mode::class_func_serviceMode (SOURCE_FILE ("declaration-isr.galgas", 26)) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken_section COMMA_SOURCE_FILE ("declaration-isr.galgas", 28)) ;
    var_mode_917 = GGS_mode::class_func_sectionMode (SOURCE_FILE ("declaration-isr.galgas", 29)) ;
  } break ;
  default:
    break ;
  }
  GGS_lstring var_isrName_1054 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GGS_instructionListAST var_instructionList_1105 ;
  nt_instructionList_ (ioArgument_ioAST, var_instructionList_1105, inCompiler) ;
  inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__7D_ COMMA_SOURCE_FILE ("declaration-isr.galgas", 34)) ;
  ioArgument_ioAST.mProperty_mDeclarationListAST.addAssignOperation (GGS_isrDeclarationAST::init_21__21__21__21__21_ (var_isrName_1054, var_mode_917, constinArgument_inDriverName, var_instructionList_1105, GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("declaration-isr.galgas", 40)), inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("declaration-isr.galgas", 35)) ;
}
...
void cParser_omnibus_5F_syntax::rule_omnibus_5F_syntax_primary_i108_ (GGS_ast & ioArgument_ioAST,
                                                                      ...
                                                                      Lexique_omnibus_5F_lexique * inCompiler) {
  outArgument_outExpression.drop () ; // Release 'out' argument
  GGS_controlRegisterLValueAST var_registerLValue_1158 ;
  nt_control_5F_register_5F_lvalue_ (ioArgument_ioAST, var_registerLValue_1158, inCompiler) ;
  GGS_lstring var_fieldName_1190 ;
  switch (select_omnibus_5F_syntax_105 (inCompiler)) {
  case 1: {
    var_fieldName_1190 = GGS_string::makeEmptyString ().getter_nowhere (SOURCE_FILE ("expression-control-register.galgas", 22)) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__2E_ COMMA_SOURCE_FILE ("expression-control-register.galgas", 24)) ;
    var_fieldName_1190 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  outArgument_outExpression = GGS_registerInExpressionAST::init_21__21_ (var_registerLValue_1158, var_fieldName_1190, inCompiler COMMA_HERE) ;
}
...
void cParser_omnibus_5F_syntax::rule_omnibus_5F_syntax_effective_5F_parameters_i109_ (GGS_ast & ioArgument_ioAST,
  ...
  while (repeatFlag_1) {
    ...
    case 2: {
      GGS_lstring var_selector_2646 = inCompiler->synthetizedAttribute_tokenString () ;
      ...
      GGS_expressionAST var_expression_2687 ;
      nt_expression_ (ioArgument_ioAST, var_expression_2687, inCompiler) ;
      outArgument_outEffectiveParameterList.addAssignOperation (GGS_effectiveArgumentPassingModeAST::class_func_output (var_expression_2687, GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("effective-parameters.galgas", 65))  COMMA_SOURCE_FILE ("effective-parameters.galgas", 65)), var_selector_2646  COMMA_SOURCE_FILE ("effective-parameters.galgas", 65)) ;
    } break ;
    case 3: {
      GGS_lstring var_selector_2820 = inCompiler->synthetizedAttribute_tokenString () ;
      ...
      GGS_lstring var_effectiveParameterName_2853 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("effective-parameters.galgas", 68)) ;
      outArgument_outEffectiveParameterList.addAssignOperation (GGS_effectiveArgumentPassingModeAST::class_func_outputInput (var_effectiveParameterName_2853  COMMA_SOURCE_FILE ("effective-parameters.galgas", 69)), var_selector_2820  COMMA_SOURCE_FILE ("effective-parameters.galgas", 69)) ;
    } break ;
    case 4: {
      GGS_lstring var_selector_3000 = inCompiler->synthetizedAttribute_tokenString () ;
      ...
      GGS_lstring var_effectiveParameterName_3056 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("effective-parameters.galgas", 74)) ;
      outArgument_outEffectiveParameterList.addAssignOperation (GGS_effectiveArgumentPassingModeAST::class_func_outputInputSelfVariable (var_effectiveParameterName_3056  COMMA_SOURCE_FILE ("effective-parameters.galgas", 75)), var_selector_3000  COMMA_SOURCE_FILE ("effective-parameters.galgas", 75)) ;
    } break ;
    case 5: {
      GGS_lstring var_selector_3214 = inCompiler->synthetizedAttribute_tokenString () ;
      ...
      GGS_lstring var_effectiveParameterName_3247 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("effective-parameters.galgas", 78)) ;
      outArgument_outEffectiveParameterList.addAssignOperation (GGS_effectiveArgumentPassingModeAST::class_func_input (var_effectiveParameterName_3247  COMMA_SOURCE_FILE ("effective-parameters.galgas", 79)), var_selector_3214  COMMA_SOURCE_FILE ("effective-parameters.galgas", 79)) ;
    } break ;
    case 6: {
      GGS_lstring var_selector_3387 = inCompiler->synthetizedAttribute_tokenString () ;
      ...
      case 1: {
        ...
        var_constant_3412 = GGS_bool (false) ;
      } break ;
      case 2: {
        inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken_let COMMA_SOURCE_FILE ("effective-parameters.galgas", 87)) ;
        var_constant_3412 = GGS_bool (true) ;
      } break ;
      default:
        break ;
      }
      GGS_lstring var_effectiveParameterName_3554 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("effective-parameters.galgas", 90)) ;
      GGS_lstring var_typeName_3596 ;
      switch (select_omnibus_5F_syntax_108 (inCompiler)) {
      case 1: {
        var_typeName_3596 = GGS_string::makeEmptyString ().getter_nowhere (SOURCE_FILE ("effective-parameters.galgas", 93)) ;
      } break ;
      case 2: {
        nt_type_5F_definition_ (ioArgument_ioAST, var_typeName_3596, inCompiler) ;
      } break ;
      default:
        break ;
      }
      outArgument_outEffectiveParameterList.addAssignOperation (GGS_effectiveArgumentPassingModeAST::class_func_inputWithType (var_constant_3412, var_typeName_3596, var_effectiveParameterName_3554  COMMA_SOURCE_FILE ("effective-parameters.galgas", 98)), var_selector_3387  COMMA_SOURCE_FILE ("effective-parameters.galgas", 97)) ;
    } break ;
    default:
      repeatFlag_1 = false ;
      break ;
...
void cParser_omnibus_5F_syntax::rule_omnibus_5F_syntax_lvalue_i114_ (GGS_ast & ioArgument_ioAST,
  ...
  GGS_LValueOperandAST var_operand_2045 ;
  nt_lvalue_5F_operand_ (ioArgument_ioAST, var_operand_2045, inCompiler) ;
  outArgument_outAssignmentTargetAST = GGS_LValueAST::init_21__21_ (var_receiver_1909, var_operand_2045, inCompiler COMMA_HERE) ;
}
...
void cParser_omnibus_5F_syntax::rule_omnibus_5F_syntax_lvalue_5F_operand_i116_ (GGS_ast & ioArgument_ioAST,
  ...
  GGS_lstring var_propertyName_2565 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("lvalue.galgas", 62)) ;
  GGS_LValueOperandAST var_operand_2612 ;
  nt_lvalue_5F_operand_ (ioArgument_ioAST, var_operand_2612, inCompiler) ;
  outArgument_outOperand = GGS_LValueOperandAST::class_func_property (var_propertyName_2565, var_operand_2612  COMMA_SOURCE_FILE ("lvalue.galgas", 64)) ;
}
...
void cParser_omnibus_5F_syntax::rule_omnibus_5F_syntax_lvalue_5F_operand_i117_ (GGS_ast & ioArgument_ioAST,
  ...
  GGS_expressionAST var_expression_2919 ;
  nt_expression_ (ioArgument_ioAST, var_expression_2919, inCompiler) ;
  GGS_location var_endOfIndex_2938 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("lvalue.galgas", 72)) ;
  GGS_bool var_checkIndexExpression_2980 ;
  ...
  case 1: {
    ...
    var_checkIndexExpression_2980 = GGS_bool (true) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__5D__21_ COMMA_SOURCE_FILE ("lvalue.galgas", 78)) ;
    var_checkIndexExpression_2980 = GGS_bool (false) ;
  } break ;
  default:
    break ;
  }
  GGS_LValueOperandAST var_operand_3151 ;
  nt_lvalue_5F_operand_ (ioArgument_ioAST, var_operand_3151, inCompiler) ;
  outArgument_outOperand = GGS_LValueOperandAST::class_func_arrayAccess (var_expression_2919, var_endOfIndex_2938, var_checkIndexExpression_2980, var_operand_3151  COMMA_SOURCE_FILE ("lvalue.galgas", 82)) ;
}
...
void cParser_omnibus_5F_syntax::rule_omnibus_5F_syntax_instruction_i119_ (GGS_ast & ioArgument_ioAST,
  ...
  GGS_expressionAST var_expression_1303 ;
  nt_expression_ (ioArgument_ioAST, var_expression_1303, inCompiler) ;
  ioArgument_ioInstructionList.addAssignOperation (GGS_letInstructionWithAssignmentAST::init_21__21__21__21_ (var_varName_1096.readProperty_location (), var_varName_1096, var_optionalTypeName_1121, var_expression_1303, inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("instruction-let.galgas", 30)) ;
}
...
void cParser_omnibus_5F_syntax::rule_omnibus_5F_syntax_procedure_5F_formal_5F_arguments_i123_ (GGS_ast & ioArgument_ioAST,
  ...
  while (repeatFlag_1) {
    ...
    case 3: {
      ...
      GGS_lstring var_formalArgumentTypeName_2699 ;
      nt_type_5F_definition_ (ioArgument_ioAST, var_formalArgumentTypeName_2699, inCompiler) ;
      outArgument_outProcFormalArgumentList.addAssignOperation (GGS_procFormalArgumentPassingMode::class_func_inputOutput (SOURCE_FILE ("formal-arguments.galgas", 75)), var_selector_2490, var_formalArgumentTypeName_2699, var_formalArgumentName_2518  COMMA_SOURCE_FILE ("formal-arguments.galgas", 74)) ;
    } break ;
    case 4: {
      GGS_lstring var_selector_2921 = inCompiler->synthetizedAttribute_tokenString () ;
      ...
      GGS_lstring var_formalArgumentName_2949 ;
      ...
      case 1: {
        ...
        var_formalArgumentName_2949 = GGS_string::makeEmptyString ().getter_nowhere (SOURCE_FILE ("formal-arguments.galgas", 84)) ;
      } break ;
      case 2: {
        var_formalArgumentName_2949 = inCompiler->synthetizedAttribute_tokenString () ;
        inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("formal-arguments.galgas", 86)) ;
      } break ;
      default:
        break ;
      }
      GGS_lstring var_formalArgumentTypeName_3131 ;
      nt_type_5F_definition_ (ioArgument_ioAST, var_formalArgumentTypeName_3131, inCompiler) ;
      outArgument_outProcFormalArgumentList.addAssignOperation (GGS_procFormalArgumentPassingMode::class_func_input (SOURCE_FILE ("formal-arguments.galgas", 90)), var_selector_2921, var_formalArgumentTypeName_3131, var_formalArgumentName_2949  COMMA_SOURCE_FILE ("formal-arguments.galgas", 89)) ;
    } break ;
    default:
      repeatFlag_1 = false ;
      break ;
...
void cParser_omnibus_5F_syntax::rule_omnibus_5F_syntax_procedure_5F_input_5F_formal_5F_arguments_i124_ (GGS_ast & ioArgument_ioAST,
  ...
  while (repeatFlag_1) {
    if (select_omnibus_5F_syntax_118 (inCompiler) == 2) {
      GGS_lstring var_selector_3660 = inCompiler->synthetizedAttribute_tokenString () ;
      ...
      GGS_lstring var_formalArgumentName_3693 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("formal-arguments.galgas", 106)) ;
      GGS_lstring var_formalArgumentTypeName_3750 ;
      nt_type_5F_definition_ (ioArgument_ioAST, var_formalArgumentTypeName_3750, inCompiler) ;
      outArgument_outProcFormalArgumentList.addAssignOperation (GGS_procFormalArgumentPassingMode::class_func_input (SOURCE_FILE ("formal-arguments.galgas", 109)), var_selector_3660, var_formalArgumentTypeName_3750, var_formalArgumentName_3693  COMMA_SOURCE_FILE ("formal-arguments.galgas", 108)) ;
    }else{
      repeatFlag_1 = false ;
    }
  }
...
void cParser_omnibus_5F_syntax::rule_omnibus_5F_syntax_declaration_i128_ (GGS_ast & ioArgument_ioAST,
  ...
  GGS_expressionAST var_expression_1265 ;
  nt_expression_ (ioArgument_ioAST, var_expression_1265, inCompiler) ;
  ioArgument_ioAST.mProperty_mDeclarationListAST.addAssignOperation (GGS_syncToolInstanceDeclarationAST::init_21__21__21_ (var_syncTypeName_1098, var_syncInstanceName_1064, var_expression_1265, inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("declaration-global-sync-instance.galgas", 30)) ;
}
...
void cParser_omnibus_5F_syntax::rule_omnibus_5F_syntax_function_5F_declaration_i130_ (GGS_ast & ioArgument_ioAST,
                                                                                      const GGS_lstring constinArgument_inReceiverTypeName,
                                                                                      Lexique_omnibus_5F_lexique * inCompiler) {
  GGS_bool var_publicAccess_1695 ;
  switch (select_omnibus_5F_syntax_126 (inCompiler)) {
  case 1: {
    var_publicAccess_1695 = GGS_bool (false) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken_public COMMA_SOURCE_FILE ("declaration-function.galgas", 37)) ;
    var_publicAccess_1695 = GGS_bool (true) ;
  } break ;
  default:
    break ;
  }
  GGS_mode var_mode_1860 ;
  GGS_lstring var_procName_1881 ;
  GGS_lstringlist var_attributeList_1912 ;
  GGS_routineFormalArgumentListAST var_procFormalArgumentList_1953 ;
  nt_function_5F_header_ (ioArgument_ioAST, var_mode_1860, var_procName_1881, var_attributeList_1912, var_procFormalArgumentList_1953, inCompiler) ;
  GGS_lstring var_returnTypeName_1993 ;
  switch (select_omnibus_5F_syntax_127 (inCompiler)) {
  case 1: {
    var_returnTypeName_1993 = GGS_string::makeEmptyString ().getter_here (inCompiler COMMA_SOURCE_FILE ("declaration-function.galgas", 48)) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__2D__3E_ COMMA_SOURCE_FILE ("declaration-function.galgas", 50)) ;
    nt_type_5F_definition_ (ioArgument_ioAST, var_returnTypeName_1993, inCompiler) ;
  } break ;
  default:
    break ;
  }
  inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__7B_ COMMA_SOURCE_FILE ("declaration-function.galgas", 53)) ;
  GGS_instructionListAST var_instructionList_2167 ;
  nt_instructionList_ (ioArgument_ioAST, var_instructionList_2167, inCompiler) ;
  inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__7D_ COMMA_SOURCE_FILE ("declaration-function.galgas", 55)) ;
  ioArgument_ioAST.mProperty_mDeclarationListAST.addAssignOperation (GGS_functionDeclarationAST::init_21__21__21__21__21__21__21__21__21_ (var_mode_1860, var_publicAccess_1695, constinArgument_inReceiverTypeName, var_procName_1881, var_attributeList_1912, var_procFormalArgumentList_1953, var_returnTypeName_1993, var_instructionList_2167, GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("declaration-function.galgas", 65)), inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("declaration-function.galgas", 56)) ;
}
...
void cParser_omnibus_5F_syntax::rule_omnibus_5F_syntax_function_5F_header_i132_ (GGS_ast & ioArgument_ioAST,
  ...
  while (repeatFlag_1) {
    if (select_omnibus_5F_syntax_130 (inCompiler) == 2) {
      GGS_lstring var_attribute_3906 = inCompiler->synthetizedAttribute_tokenString () ;
      ...
      outArgument_outAttributeList.addAssignOperation (var_attribute_3906  COMMA_SOURCE_FILE ("declaration-function.galgas", 137)) ;
    }else{
      repeatFlag_1 = false ;
    }
  }
...
void cParser_omnibus_5F_syntax::rule_omnibus_5F_syntax_declaration_i135_ (GGS_ast & ioArgument_ioAST,
                                                                          Lexique_omnibus_5F_lexique * inCompiler) {
  GGS_lstring var_leftVariableName_4901 ;
  GGS_lstring var_leftTypeName_4923 ;
  GGS_genericFormalParameterList var_leftGenericFormalParameterList_4941 ;
  nt_llvm_5F_function_5F_header_ (var_leftVariableName_4901, var_leftTypeName_4923, var_leftGenericFormalParameterList_4941, inCompiler) ;
  GGS_location var_operationLocation_4980 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("infix-operator-llvm.galgas", 121)) ;
  GGS_compileTimeInfixOperatorEnumeration var_infixOperator_5051 ;
  nt_compileTimeInfixOperator_ (var_infixOperator_5051, inCompiler) ;
  inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__28_ COMMA_SOURCE_FILE ("infix-operator-llvm.galgas", 123)) ;
  GGS_lstring var_rightVariableName_5095 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("infix-operator-llvm.galgas", 124)) ;
  GGS_lstring var_rightType_5131 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__24_type COMMA_SOURCE_FILE ("infix-operator-llvm.galgas", 125)) ;
  GGS_genericFormalParameterList var_rightGenericFormalParameterList_5177 ;
  nt_generic_5F_formal_5F_arguments_ (var_rightGenericFormalParameterList_5177, inCompiler) ;
  inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__29_ COMMA_SOURCE_FILE ("infix-operator-llvm.galgas", 127)) ;
  inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__2D__3E_ COMMA_SOURCE_FILE ("infix-operator-llvm.galgas", 128)) ;
  GGS_lstring var_resultType_5244 = inCompiler->synthetizedAttribute_tokenString () ;
  inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__24_type COMMA_SOURCE_FILE ("infix-operator-llvm.galgas", 129)) ;
  GGS_genericFormalParameterList var_resultGenericFormalParameterList_5291 ;
  nt_generic_5F_formal_5F_arguments_ (var_resultGenericFormalParameterList_5291, inCompiler) ;
  inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__7B_ COMMA_SOURCE_FILE ("infix-operator-llvm.galgas", 131)) ;
  GGS_llvmGenerationInstructionList var_instructionList_5365 ;
  nt_llvm_5F_instruction_5F_list_ (var_instructionList_5365, inCompiler) ;
  inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__7D_ COMMA_SOURCE_FILE ("infix-operator-llvm.galgas", 133)) ;
  ioArgument_ioAST.mProperty_mDeclarationListAST.addAssignOperation (GGS_llvmInfixOperatorAST::init_21__21__21__21__21__21__21__21__21__21__21_ (extensionGetter_omnibusInfixOperator (var_infixOperator_5051, inCompiler COMMA_SOURCE_FILE ("infix-operator-llvm.galgas", 135)), var_operationLocation_4980, var_leftVariableName_4901, var_leftTypeName_4923, var_leftGenericFormalParameterList_4941, var_rightVariableName_5095, var_rightType_5131, var_rightGenericFormalParameterList_5177, var_resultType_5244, var_resultGenericFormalParameterList_5291, var_instructionList_5365, inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("infix-operator-llvm.galgas", 134)) ;
}
...
void cParser_omnibus_5F_syntax::rule_omnibus_5F_syntax_private_5F_or_5F_public_5F_struct_5F_property_5F_declaration_i136_ (GGS_ast & ioArgument_ioAST,
                                                                                                                           ...
                                                                                                                           Lexique_omnibus_5F_lexique * inCompiler) {
  GGS_propertyVisibility var_visibility_2638 ;
  switch (select_omnibus_5F_syntax_131 (inCompiler)) {
  case 1: {
    var_visibility_2638 = GGS_propertyVisibility::class_func_isPrivate (SOURCE_FILE ("type-structure-declaration.galgas", 57)) ;
  } break ;
  case 2: {
    ...
    var_visibility_2638 = GGS_propertyVisibility::class_func_isPublic (SOURCE_FILE ("type-structure-declaration.galgas", 60)) ;
  } break ;
  default:
    break ;
  }
  nt_struct_5F_property_5F_declaration_ (ioArgument_ioAST, var_visibility_2638, ioArgument_ioPropertyListAST, inCompiler) ;
}
...
void cParser_omnibus_5F_syntax::rule_omnibus_5F_syntax_struct_5F_property_5F_declaration_i138_ (GGS_ast & ioArgument_ioAST,
  ...
  GGS_lstring var_propertyName_3453 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GGS_lstring var_typeName_3483 ;
  switch (select_omnibus_5F_syntax_132 (inCompiler)) {
  case 1: {
    nt_type_5F_definition_ (ioArgument_ioAST, var_typeName_3483, inCompiler) ;
  } break ;
  case 2: {
    var_typeName_3483 = GGS_string::makeEmptyString ().getter_nowhere (SOURCE_FILE ("type-structure-declaration.galgas", 87)) ;
  } break ;
  default:
    break ;
  }
  ...
  case 1: {
    ...
    GGS_expressionAST var_initExpression_3641 ;
    nt_expression_ (ioArgument_ioAST, var_initExpression_3641, inCompiler) ;
    ...
    ioArgument_ioPropertyListAST.addAssignOperation (var_propertyName_3453, temp_0, constinArgument_inVisibility, var_typeName_3483, GGS_propertyKindAST::class_func_initializedConstantProperty (var_initExpression_3641  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 97))  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 92)) ;
  } break ;
  case 2: {
    ...
    ioArgument_ioPropertyListAST.addAssignOperation (var_propertyName_3453, temp_1, constinArgument_inVisibility, var_typeName_3483, GGS_propertyKindAST::class_func_uninitializedConstantProperty (SOURCE_FILE ("type-structure-declaration.galgas", 104))  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 99)) ;
  } break ;
  default:
    break ;
  }
...
void cParser_omnibus_5F_syntax::rule_omnibus_5F_syntax_struct_5F_property_5F_declaration_i139_ (GGS_ast & ioArgument_ioAST,
  ...
  GGS_lstring var_propertyName_4297 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GGS_propertyAttributeList var_propertyAttributeList_4341 = temp_0 ;
  bool repeatFlag_1 = true ;
  while (repeatFlag_1) {
    if (select_omnibus_5F_syntax_134 (inCompiler) == 2) {
      GGS_lstring var_attribute_4414 = inCompiler->synthetizedAttribute_tokenString () ;
      ...
      GGS_lbigint var_value_4445 = inCompiler->synthetizedAttribute_bigInteger () ;
      ...
      var_propertyAttributeList_4341.addAssignOperation (var_attribute_4414, var_value_4445  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 122)) ;
    }else{
      repeatFlag_1 = false ;
    }
  }
  ...
  case 1: {
    GGS_lstring var_typeName_4557 ;
    nt_type_5F_definition_ (ioArgument_ioAST, var_typeName_4557, inCompiler) ;
    ...
    case 1: {
      ...
      ioArgument_ioPropertyListAST.addAssignOperation (var_propertyName_4297, temp_2, constinArgument_inVisibility, var_typeName_4557, GGS_propertyKindAST::class_func_uninitializedStoredProperty (SOURCE_FILE ("type-structure-declaration.galgas", 127))  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 127)) ;
    } break ;
    case 2: {
      nt_propertyGetterSetter_ (ioArgument_ioAST, constinArgument_inVisibility, var_propertyName_4297, var_propertyAttributeList_4341, var_typeName_4557, ioArgument_ioPropertyListAST, inCompiler) ;
    } break ;
    case 3: {
      inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__3D_ COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 137)) ;
      GGS_expressionAST var_initExpression_4919 ;
      nt_expression_ (ioArgument_ioAST, var_initExpression_4919, inCompiler) ;
      ioArgument_ioPropertyListAST.addAssignOperation (var_propertyName_4297, var_propertyAttributeList_4341, constinArgument_inVisibility, var_typeName_4557, GGS_propertyKindAST::class_func_initializedStoredProperty (var_initExpression_4919  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 144))  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 139)) ;
    } break ;
    default:
      break ;
    }
  ...
  case 2: {
    ...
    GGS_expressionAST var_initExpression_5194 ;
    nt_expression_ (ioArgument_ioAST, var_initExpression_5194, inCompiler) ;
    ioArgument_ioPropertyListAST.addAssignOperation (var_propertyName_4297, var_propertyAttributeList_4341, constinArgument_inVisibility, GGS_string::makeEmptyString ().getter_nowhere (SOURCE_FILE ("type-structure-declaration.galgas", 153)), GGS_propertyKindAST::class_func_initializedStoredProperty (var_initExpression_5194  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 154))  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 149)) ;
  } break ;
  default:
    break ;
  }
...
void cParser_omnibus_5F_syntax::rule_omnibus_5F_syntax_propertyGetterSetter_i140_ (GGS_ast & ioArgument_ioAST,
  ...
  case 1: {
    GGS_bool var_getterDefined_5827 = GGS_bool (false) ;
    GGS_bool var_setterDefined_5859 = GGS_bool (false) ;
    bool repeatFlag_0 = true ;
    while (repeatFlag_0) {
      GGS_lstring var_getterOrSetter_5920 = inCompiler->synthetizedAttribute_tokenString () ;
      ...
      GGS_instructionListAST var_instructionList_5986 ;
      nt_instructionList_ (ioArgument_ioAST, var_instructionList_5986, inCompiler) ;
      GGS_location var_endOfInstructionList_6014 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 176)) ;
      inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__7D_ COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 177)) ;
      GalgasBool test_1 = GalgasBool::boolTrue ;
      if (GalgasBool::boolTrue == test_1) {
        test_1 = GGS_bool (ComparisonKind::equal, var_getterOrSetter_5920.readProperty_string ().objectCompare (GGS_string ("get"))).boolEnum () ;
        if (GalgasBool::boolTrue == test_1) {
          ioArgument_ioPropertyListAST.addAssignOperation (constinArgument_inPropertyName, constinArgument_inPropertyAttributeList, constinArgument_inVisibility, constinArgument_inTypeName, GGS_propertyKindAST::class_func_readOnlyComputedProperty (var_instructionList_5986, var_endOfInstructionList_6014  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 184))  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 179)) ;
          GalgasBool test_2 = GalgasBool::boolTrue ;
          if (GalgasBool::boolTrue == test_2) {
            test_2 = var_getterDefined_5827.boolEnum () ;
            if (GalgasBool::boolTrue == test_2) {
              GenericArray <FixItDescription> fixItArray3 ;
              inCompiler->emitSemanticError (var_getterOrSetter_5920.readProperty_location (), GGS_string ("duplicate getter definition"), fixItArray3  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 189)) ;
            }
          }
          var_getterDefined_5827 = GGS_bool (true) ;
        }
      }
      if (GalgasBool::boolFalse == test_1) {
        GalgasBool test_4 = GalgasBool::boolTrue ;
        if (GalgasBool::boolTrue == test_4) {
          test_4 = GGS_bool (ComparisonKind::equal, var_getterOrSetter_5920.readProperty_string ().objectCompare (GGS_string ("set"))).boolEnum () ;
          if (GalgasBool::boolTrue == test_4) {
            ioArgument_ioPropertyListAST.addAssignOperation (constinArgument_inPropertyName, constinArgument_inPropertyAttributeList, constinArgument_inVisibility, constinArgument_inTypeName, GGS_propertyKindAST::class_func_writeComputedProperty (var_instructionList_5986, var_endOfInstructionList_6014  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 198))  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 193)) ;
            GalgasBool test_5 = GalgasBool::boolTrue ;
            if (GalgasBool::boolTrue == test_5) {
              test_5 = var_setterDefined_5859.boolEnum () ;
              if (GalgasBool::boolTrue == test_5) {
                GenericArray <FixItDescription> fixItArray6 ;
                inCompiler->emitSemanticError (var_getterOrSetter_5920.readProperty_location (), GGS_string ("duplicate setter definition"), fixItArray6  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 203)) ;
              }
            }
            var_setterDefined_5859 = GGS_bool (true) ;
          }
        }
        if (GalgasBool::boolFalse == test_4) {
          GenericArray <FixItDescription> fixItArray7 ;
          ...
          inCompiler->emitSemanticError (var_getterOrSetter_5920.readProperty_location (), GGS_string ("invalid attribute"), fixItArray7  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 207)) ;
        }
      }
    ...
    GalgasBool test_8 = GalgasBool::boolTrue ;
    if (GalgasBool::boolTrue == test_8) {
      GGS_bool test_9 = var_setterDefined_5859 ;
      if (GalgasBool::boolTrue == test_9.boolEnum ()) {
        test_9 = var_getterDefined_5827.operator_not (SOURCE_FILE ("type-structure-declaration.galgas", 211)) ;
      }
    ...
    if (GalgasBool::boolFalse == test_8) {
      ...
      if (GalgasBool::boolTrue == test_11) {
        GGS_bool test_12 = var_setterDefined_5859.operator_not (SOURCE_FILE ("type-structure-declaration.galgas", 213)) ;
        if (GalgasBool::boolTrue == test_12.boolEnum ()) {
          test_12 = var_getterDefined_5827.operator_not (SOURCE_FILE ("type-structure-declaration.galgas", 213)) ;
        }
  ...
  case 2: {
    GGS_instructionListAST var_readInstructionList_7509 ;
    nt_instructionList_ (ioArgument_ioAST, var_readInstructionList_7509, inCompiler) ;
    GGS_location var_endOfReadInstructionList_7539 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 218)) ;
    ioArgument_ioPropertyListAST.addAssignOperation (constinArgument_inPropertyName, constinArgument_inPropertyAttributeList, constinArgument_inVisibility, constinArgument_inTypeName, GGS_propertyKindAST::class_func_readOnlyComputedProperty (var_readInstructionList_7509, var_endOfReadInstructionList_7539  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 224))  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 219)) ;
  } break ;
  default:
    break ;
  }
...
void cParser_omnibus_5F_syntax::rule_omnibus_5F_syntax_declaration_i141_ (GGS_ast & ioArgument_ioAST,
  ...
  GGS_lstring var_structureName_8073 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GGS_lstringlist var_attributeList_8108 = temp_0 ;
  bool repeatFlag_1 = true ;
  while (repeatFlag_1) {
    if (select_omnibus_5F_syntax_139 (inCompiler) == 2) {
      GGS_lstring var_attribute_8173 = inCompiler->synthetizedAttribute_tokenString () ;
      ...
      var_attributeList_8108.addAssignOperation (var_attribute_8173  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 241)) ;
    }else{
      repeatFlag_1 = false ;
    }
  }
  ...
  GGS_structurePropertyListAST var_fieldList_8268 = temp_2 ;
  bool repeatFlag_3 = true ;
  while (repeatFlag_3) {
    switch (select_omnibus_5F_syntax_140 (inCompiler)) {
    case 2: {
      nt_private_5F_or_5F_public_5F_struct_5F_property_5F_declaration_ (ioArgument_ioAST, var_fieldList_8268, inCompiler) ;
    } break ;
    case 3: {
      nt_function_5F_declaration_ (ioArgument_ioAST, var_structureName_8073, inCompiler) ;
    } break ;
    default:
      repeatFlag_3 = false ;
      break ;
  ...
  ioArgument_ioAST.mProperty_mDeclarationListAST.addAssignOperation (GGS_structureDeclarationAST::init_21__21__21__21__21__21__21_ (var_structureName_8073, var_structureName_8073, var_structureName_8073, var_attributeList_8108, GGS_bool (true), var_fieldList_8268, GGS_bool (true), inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("type-structure-declaration.galgas", 252)) ;
}
...
void cParser_omnibus_5F_syntax::rule_omnibus_5F_syntax_instruction_i142_ (GGS_ast & ioArgument_ioAST,
  ...
  GGS_expressionAST var_lowerBoundExpression_1551 ;
  nt_expression_ (ioArgument_ioAST, var_lowerBoundExpression_1551, inCompiler) ;
  GGS_location var_endOf_5F_lowerBoundExpression_5F_instruction_1580 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("instruction-for-in-lower-upper-bounds.galgas", 36)) ;
  ...
  GGS_expressionAST var_upperBoundExpression_1692 ;
  nt_expression_ (ioArgument_ioAST, var_upperBoundExpression_1692, inCompiler) ;
  GGS_location var_endOf_5F_upperBoundExpression_5F_instruction_1721 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("instruction-for-in-lower-upper-bounds.galgas", 39)) ;
  ...
  GGS_instructionListAST var_instructionList_1820 ;
  nt_instructionList_ (ioArgument_ioAST, var_instructionList_1820, inCompiler) ;
  GGS_location var_endOfInstruction_1844 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("instruction-for-in-lower-upper-bounds.galgas", 42)) ;
  ...
  ioArgument_ioInstructionList.addAssignOperation (GGS_forLowerUpperBoundInstructionAST::init_21__21__21__21__21__21__21__21__21_ (var_varName_1356.readProperty_location (), var_varName_1356, var_typeName_1487, var_lowerBoundExpression_1551, var_endOf_5F_lowerBoundExpression_5F_instruction_1580, var_upperBoundExpression_1692, var_endOf_5F_upperBoundExpression_5F_instruction_1721, var_instructionList_1820, var_endOfInstruction_1844, inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("instruction-for-in-lower-upper-bounds.galgas", 44)) ;
}
...
void cParser_omnibus_5F_target_5F_specific_5F_syntax::rule_omnibus_5F_target_5F_specific_5F_syntax_python_5F_utility_5F_tool_5F_list_i1_ (GGS__32_lstringlist & outArgument_outPythonUtilityToolList,
  ...
  while (repeatFlag_1) {
    if (select_omnibus_5F_target_5F_specific_5F_syntax_0 (inCompiler) == 2) {
      GGS_lstring var_relativePath_3758 = inCompiler->synthetizedAttribute_tokenString () ;
      ...
      GGS_lstring var_destinationFile_3804 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__22_string_22_ COMMA_SOURCE_FILE ("configuration.galgas", 98)) ;
      outArgument_outPythonUtilityToolList.addAssignOperation (var_relativePath_3758, var_destinationFile_3804  COMMA_SOURCE_FILE ("configuration.galgas", 99)) ;
    }else{
      repeatFlag_1 = false ;
    }
  }
...
void cParser_omnibus_5F_target_5F_specific_5F_syntax::rule_omnibus_5F_target_5F_specific_5F_syntax_configuration_5F_start_5F_symbol_i2_ (GGS_ast & ioArgument_ioAST,
  ...
  outArgument_outImportedFileList.drop () ; // Release 'out' argument
  outArgument_outEndOfSourceFile.drop () ; // Release 'out' argument
  GGS_location var_loc_4191 = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("configuration.galgas", 110)) ;
  GGS__32_lstringlist var_python_5F_utilityToolList_4248 ;
  nt_python_5F_utility_5F_tool_5F_list_ (var_python_5F_utilityToolList_4248, inCompiler) ;
  nt_configuration_5F_key_ (GGS_string ("PYTHON_BUILD"), inCompiler) ;
  GGS_lstring var_python_5F_build_4331 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GGS_lstring var_linkerScript_4405 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GGS_lstring var_panicCodeTypeName_4484 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GGS_lstring var_panicLineTypeName_4569 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GGS_lbigint var_pointerSize_4651 = inCompiler->synthetizedAttribute_bigInteger () ;
  ...
  GGS_bool var_handleDynamicArray_4718 ;
  ...
  GGS_lstring var_nopInstructionStringInLLVM_4982 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GGS_lbigint var_bitbandRegisterBaseAddress_5062 ;
  GGS_lbigint var_bitbandRegisterEndAddress_5106 ;
  GGS_lbigint var_bitbandRegisterRelocationAddress_5149 ;
  GGS_lbigint var_bitbandRegisterOffsetMultiplier_5199 ;
  GGS_lbigint var_bitbandRegisterBitMultiplier_5248 ;
  ...
  case 1: {
    ...
    var_bitbandRegisterBaseAddress_5062 = GGS_lbigint::init_21__21_ (GGS_bigint ("0", inCompiler  COMMA_SOURCE_FILE ("configuration.galgas", 143)), GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("configuration.galgas", 143)), inCompiler COMMA_HERE) ;
    var_bitbandRegisterEndAddress_5106 = GGS_lbigint::init_21__21_ (GGS_bigint ("0", inCompiler  COMMA_SOURCE_FILE ("configuration.galgas", 144)), GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("configuration.galgas", 144)), inCompiler COMMA_HERE) ;
    var_bitbandRegisterRelocationAddress_5149 = GGS_lbigint::init_21__21_ (GGS_bigint ("0", inCompiler  COMMA_SOURCE_FILE ("configuration.galgas", 145)), GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("configuration.galgas", 145)), inCompiler COMMA_HERE) ;
    var_bitbandRegisterOffsetMultiplier_5199 = GGS_lbigint::init_21__21_ (GGS_bigint ("0", inCompiler  COMMA_SOURCE_FILE ("configuration.galgas", 146)), GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("configuration.galgas", 146)), inCompiler COMMA_HERE) ;
    var_bitbandRegisterBitMultiplier_5248 = GGS_lbigint::init_21__21_ (GGS_bigint ("0", inCompiler  COMMA_SOURCE_FILE ("configuration.galgas", 147)), GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("configuration.galgas", 147)), inCompiler COMMA_HERE) ;
  } break ;
  case 2: {
    var_bitbandRegisterBaseAddress_5062 = inCompiler->synthetizedAttribute_bigInteger () ;
    inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken_integer COMMA_SOURCE_FILE ("configuration.galgas", 149)) ;
    var_bitbandRegisterEndAddress_5106 = inCompiler->synthetizedAttribute_bigInteger () ;
    inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken_integer COMMA_SOURCE_FILE ("configuration.galgas", 150)) ;
    var_bitbandRegisterRelocationAddress_5149 = inCompiler->synthetizedAttribute_bigInteger () ;
    inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken_integer COMMA_SOURCE_FILE ("configuration.galgas", 151)) ;
    var_bitbandRegisterOffsetMultiplier_5199 = inCompiler->synthetizedAttribute_bigInteger () ;
    inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken_integer COMMA_SOURCE_FILE ("configuration.galgas", 152)) ;
    var_bitbandRegisterBitMultiplier_5248 = inCompiler->synthetizedAttribute_bigInteger () ;
  ...
  GGS_lstring var_serviceHandler_5861 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GGS_lbigint var_servicePushedRegisterByteSize_5948 = inCompiler->synthetizedAttribute_bigInteger () ;
  ...
  GGS_lstring var_serviceDispatcherHeader_6051 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GGS_lstring var_serviceDispatcherEntry_6147 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GGS_lstring var_serviceEntryNoReturnedValue_6249 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GGS_lstring var_serviceEntryReturnValue_6358 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GGS_lstring var_sectionHandler_6445 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GGS_lbigint var_sectionPushedRegisterByteSize_6532 = inCompiler->synthetizedAttribute_bigInteger () ;
  ...
  GGS_lstring var_sectionDispatcherHeader_6635 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GGS_lstring var_sectionDispatcherEntry_6731 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GGS_lstring var_sectionDispatcherInvocationFromAnyMode_6833 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GGS_lstring var_sectionDispatcherInvocationFromUserMode_6948 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GGS_lstring var_xtrInterruptHandler_7053 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GGS_lbigint var_stackedUserRegisterOnInterruptByteSize_7145 = inCompiler->synthetizedAttribute_bigInteger () ;
  ...
  GGS_lstring var_undefinedInterruptHandler_7248 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GGS_lstringlist var_C_5F_definitionFiles_7332 = temp_0 ;
  bool repeatFlag_1 = true ;
  while (repeatFlag_1) {
    if (select_omnibus_5F_target_5F_specific_5F_syntax_3 (inCompiler) == 2) {
      GGS_lstring var_fileRelativePath_7399 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__22_string_22_ COMMA_SOURCE_FILE ("configuration.galgas", 189)) ;
      var_C_5F_definitionFiles_7332.addAssignOperation (var_fileRelativePath_7399  COMMA_SOURCE_FILE ("configuration.galgas", 190)) ;
    }else{
      repeatFlag_1 = false ;
    }
  }
  ...
  GGS_lstringlist var_S_5F_definitionFiles_7525 = temp_2 ;
  bool repeatFlag_3 = true ;
  while (repeatFlag_3) {
    if (select_omnibus_5F_target_5F_specific_5F_syntax_4 (inCompiler) == 2) {
      GGS_lstring var_fileRelativePath_7592 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__22_string_22_ COMMA_SOURCE_FILE ("configuration.galgas", 196)) ;
      var_S_5F_definitionFiles_7525.addAssignOperation (var_fileRelativePath_7592  COMMA_SOURCE_FILE ("configuration.galgas", 197)) ;
    }else{
      repeatFlag_3 = false ;
    }
  }
  ...
  GGS_lstringlist var_LL_5F_definitionFiles_7719 = temp_4 ;
  bool repeatFlag_5 = true ;
  while (repeatFlag_5) {
    if (select_omnibus_5F_target_5F_specific_5F_syntax_5 (inCompiler) == 2) {
      GGS_lstring var_fileRelativePath_7787 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__22_string_22_ COMMA_SOURCE_FILE ("configuration.galgas", 203)) ;
      var_LL_5F_definitionFiles_7719.addAssignOperation (var_fileRelativePath_7787  COMMA_SOURCE_FILE ("configuration.galgas", 204)) ;
    }else{
      repeatFlag_5 = false ;
    }
  }
  ...
  while (repeatFlag_7) {
    if (select_omnibus_5F_target_5F_specific_5F_syntax_6 (inCompiler) == 2) {
      GGS_lstring var_relativeFilePath_7972 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__22_string_22_ COMMA_SOURCE_FILE ("configuration.galgas", 210)) ;
      outArgument_outImportedFileList.addAssignOperation (var_relativeFilePath_7972  COMMA_SOURCE_FILE ("configuration.galgas", 211)) ;
    }else{
      repeatFlag_7 = false ;
    }
  }
  GGS_interruptionConfigurationList var_interruptionConfigurationList_8075 ;
  GGS_enumerationConstantList var_interruptConstantList_8110 ;
  nt_interruptConfigList_ (var_interruptionConfigurationList_8075, var_interruptConstantList_8110, inCompiler) ;
  GGS_uint var_ptrSize_8146 ;
  GalgasBool test_8 = GalgasBool::boolTrue ;
  if (GalgasBool::boolTrue == test_8) {
    test_8 = GGS_bool (ComparisonKind::equal, var_pointerSize_4651.readProperty_bigint ().objectCompare (GGS_bigint ("0", inCompiler  COMMA_SOURCE_FILE ("configuration.galgas", 215)))).boolEnum () ;
    if (GalgasBool::boolTrue == test_8) {
      GenericArray <FixItDescription> fixItArray9 ;
      inCompiler->emitSemanticError (var_pointerSize_4651.readProperty_location (), GGS_string ("zero size pointer is invalid"), fixItArray9  COMMA_SOURCE_FILE ("configuration.galgas", 216)) ;
      var_ptrSize_8146.drop () ; // Release error dropped variable
    }
  }
  if (GalgasBool::boolFalse == test_8) {
    var_ptrSize_8146 = var_pointerSize_4651.readProperty_bigint ().getter_uint (inCompiler COMMA_SOURCE_FILE ("configuration.galgas", 218)) ;
  }
  GGS_targetParameters var_parameters_8328 = GGS_targetParameters::init_21__21__21__21__21__21__21__21__21__21__21__21__21__21__21__21__21__21__21__21__21__21__21__21__21__21__21__21__21__21__21_ (var_loc_4191, var_python_5F_utilityToolList_4248, var_python_5F_build_4331, var_linkerScript_4405, var_ptrSize_8146, var_handleDynamicArray_4718, var_systemStackSize_4915, var_stackedUserRegisterOnInterruptByteSize_7145, var_nopInstructionStringInLLVM_4982, var_bitbandRegisterBaseAddress_5062, var_bitbandRegisterEndAddress_5106, var_bitbandRegisterRelocationAddress_5149, var_bitbandRegisterOffsetMultiplier_5199, var_bitbandRegisterBitMultiplier_5248, var_sectionHandler_6445, var_sectionPushedRegisterByteSize_6532, var_sectionDispatcherHeader_6635, var_sectionDispatcherEntry_6731, var_sectionDispatcherInvocationFromAnyMode_6833, var_sectionDispatcherInvocationFromUserMode_6948, var_C_5F_definitionFiles_7332, var_S_5F_definitionFiles_7525, var_LL_5F_definitionFiles_7719, var_xtrInterruptHandler_7053, var_undefinedInterruptHandler_7248, var_serviceHandler_5861, var_servicePushedRegisterByteSize_5948, var_serviceDispatcherEntry_6147, var_serviceDispatcherHeader_6051, var_serviceEntryNoReturnedValue_6249, var_serviceEntryReturnValue_6358, inCompiler COMMA_HERE) ;
  ioArgument_ioAST.mProperty_mDeclarationListAST.addAssignOperation (GGS_configurationDeclarationAST::init_21__21__21__21_ (var_panicCodeTypeName_4484, var_panicLineTypeName_4569, var_parameters_8328, var_interruptionConfigurationList_8075, inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("configuration.galgas", 253)) ;
  outArgument_outEndOfSourceFile = GGS_location::class_func_here (inCompiler  COMMA_SOURCE_FILE ("configuration.galgas", 259)) ;
  ioArgument_ioAST.mProperty_mDeclarationListAST.addAssignOperation (GGS_enumerationDeclarationAST::init_21__21_ (GGS_lstring::init_21__21_ (function_isrSlotTypeName (inCompiler COMMA_SOURCE_FILE ("configuration.galgas", 261)), var_xtrInterruptHandler_7053.readProperty_location (), inCompiler COMMA_HERE), var_interruptConstantList_8110, inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("configuration.galgas", 260)) ;
}
...
void cParser_omnibus_5F_target_5F_specific_5F_syntax::rule_omnibus_5F_target_5F_specific_5F_syntax_interruptConfigList_i3_ (GGS_interruptionConfigurationList & outArgument_interruptionConfigurationList,
  ...
  while (repeatFlag_2) {
    if (select_omnibus_5F_target_5F_specific_5F_syntax_7 (inCompiler) == 2) {
      GGS_lstring var_interruptName_10116 = inCompiler->synthetizedAttribute_tokenString () ;
      inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken_identifier COMMA_SOURCE_FILE ("configuration.galgas", 277)) ;
      GGS_interruptionPanicCode var_interruptionPanicCode_10163 ;
      switch (select_omnibus_5F_target_5F_specific_5F_syntax_8 (inCompiler)) {
      case 1: {
        var_interruptionPanicCode_10163 = GGS_interruptionPanicCode::class_func_noCode (SOURCE_FILE ("configuration.galgas", 280)) ;
      } break ;
      case 2: {
        inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken__2D__3E_ COMMA_SOURCE_FILE ("configuration.galgas", 282)) ;
        GGS_lbigint var_panicCode_10283 = inCompiler->synthetizedAttribute_bigInteger () ;
        inCompiler->acceptTerminal (Lexique_omnibus_5F_lexique::kToken_integer COMMA_SOURCE_FILE ("configuration.galgas", 283)) ;
        var_interruptionPanicCode_10163 = GGS_interruptionPanicCode::class_func_code (var_panicCode_10283  COMMA_SOURCE_FILE ("configuration.galgas", 284)) ;
        outArgument_outEnumerationConstantList.addAssignOperation (var_interruptName_10116, var_panicCode_10283.readProperty_bigint ()  COMMA_SOURCE_FILE ("configuration.galgas", 285)) ;
      } break ;
      default:
        break ;
      }
      outArgument_interruptionConfigurationList.addAssignOperation (var_interruptName_10116, var_interruptionPanicCode_10163  COMMA_SOURCE_FILE ("configuration.galgas", 287)) ;
    }else{
      repeatFlag_2 = false ;
    }
  }
...
AbstractPtrClass * cPtr_typeAliasDeclarationAST::duplicate (Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  AbstractPtrClass * ptr = nullptr ;
...
AbstractPtrClass * cPtr_standAloneProcedureCallInstructionAST::duplicate (Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  AbstractPtrClass * ptr = nullptr ;
...
AbstractPtrClass * cPtr_procedureCallInstructionAST::duplicate (Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  AbstractPtrClass * ptr = nullptr ;
...
void extensionMethod_externProcedureSemanticAnalysis (const GGS_externFunctionDeclarationListAST_2E_element inObject,
  ...
  GGS_routineFormalArgumentListIR var_formalArguments_5174 = temp_0 ;
  GGS_universalValuedObjectMap joker_5282 = GGS_universalValuedObjectMap::init (inCompiler COMMA_HERE) ;
  {
  const GGS_externFunctionDeclarationListAST_2E_element temp_1 = inObject ;
  routine_enterFormalArguments_3F_context_3F__26__26__3F_warningOnUnusedArgs (constinArgument_inContext, temp_1.readProperty_mProcFormalArgumentList (), joker_5282, var_formalArguments_5174, GGS_bool (true), inCompiler  COMMA_SOURCE_FILE ("declaration-extern-proc.galgas", 131)) ;
  }
  ...
  GGS_unifiedTypeMapEntry var_returnType_5376 = temp_3 ;
  {
  const GGS_externFunctionDeclarationListAST_2E_element temp_6 = inObject ;
  ioArgument_ioIntermediateCodeStruct.mProperty_mExternProcedureMapIR.setter_insertKey (temp_6.readProperty_mRoutineNameForGeneration (), var_formalArguments_5174, var_returnType_5376, inCompiler COMMA_SOURCE_FILE ("declaration-extern-proc.galgas", 145)) ;
  }
  const GGS_externFunctionDeclarationListAST_2E_element temp_7 = inObject ;
  ioArgument_ioIntermediateCodeStruct.mProperty_mRoutineListIR.addAssignOperation (GGS_externRoutineIR::init_21__21_isRequired_21_warnsIfUnused_21__21_ (temp_7.readProperty_mRoutineNameForGeneration (), GGS_bool (false), GGS_bool (false), var_formalArguments_5174, var_returnType_5376, inCompiler COMMA_HERE)  COMMA_SOURCE_FILE ("declaration-extern-proc.galgas", 150)) ;
}
...
AbstractPtrClass * cPtr_externRoutineIR::duplicate (Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  AbstractPtrClass * ptr = nullptr ;
