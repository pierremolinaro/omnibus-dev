...
void routine_codeGeneration (const class GALGAS_string constinArgument0,
                             ...
                             const class GALGAS_userLLVMTypeDefinitionListIR constinArgument5,
                             const class GALGAS_lstring constinArgument6,
                             const class GALGAS_PLMType constinArgument7,
                             const class GALGAS_PLMType constinArgument8,
                             const class GALGAS_availableInterruptMap constinArgument9,
                             const class GALGAS_staticListInitializationMap constinArgument10,
...
void routine_generateCodeFiles (const class GALGAS_string constinArgument0,
                                ...
                                const class GALGAS_unifiedTypeMap constinArgument3,
