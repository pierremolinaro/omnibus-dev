...
static void extensionMethod_assignmentInstructionAST_analyze (const cPtr_instructionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    {
    extensionSetter_appendCopyFromReferences (ioArgument_ioInstructionGenerationList, ioArgument_ioTemporaries, object->mProperty_mTargetAST.getter_mIdentifier (HERE).getter_location (SOURCE_FILE ("instruction-assignment.galgas", 97)), var_sourceOperandPossibleReference_3797, var_lvalueIR_4262, inCompiler COMMA_SOURCE_FILE ("instruction-assignment.galgas", 95)) ;
    }
  }
}
...
static void extensionMethod_syncInstructionAST_analyze (const cPtr_instructionAST * inObject,
  ...
  const cPtr_syncInstructionAST * object = (const cPtr_syncInstructionAST *) inObject ;
  macroValidSharedObject (object, cPtr_syncInstructionAST) ;
  GALGAS_syncInstructionBranchListIR var_onInstructionBranchListIR_6113 = GALGAS_syncInstructionBranchListIR::constructor_emptyList (SOURCE_FILE ("instruction-sync.galgas", 162)) ;
  cEnumerator_syncInstructionBranchListAST enumerator_6184 (object->mProperty_mBranchList, kENUMERATION_UP) ;
  while (enumerator_6184.hasCurrentObject ()) {
    ...
    GALGAS_guardedCommandIR var_guardedCommandIR_6289 ;
    switch (enumerator_6184.current_mGuardedCommand (HERE).enumValue ()) {
    case GALGAS_guardedCommandAST::kNotBuilt:
      break ;
    case GALGAS_guardedCommandAST::kEnum_boolean:
      {
        const cEnumAssociatedValues_guardedCommandAST_boolean * extractPtr_7545 = (const cEnumAssociatedValues_guardedCommandAST_boolean *) (enumerator_6184.current_mGuardedCommand (HERE).unsafePointer ()) ;
        const GALGAS_bool extractedValue_isContinue = extractPtr_7545->mAssociatedValue0 ;
        const GALGAS_expressionAST extractedValue_expression = extractPtr_7545->mAssociatedValue1 ;
        const GALGAS_location extractedValue_endOfExpression = extractPtr_7545->mAssociatedValue2 ;
        GALGAS_instructionListIR var_guardInstructionGenerationList_6430 = GALGAS_instructionListIR::constructor_emptyList (SOURCE_FILE ("instruction-sync.galgas", 169)) ;
        GALGAS_objectIR var_sourceOperand_6966 ;
        callExtensionMethod_analyzeExpression ((const cPtr_expressionAST *) extractedValue_expression.ptr (), constinArgument_inSelfType, constinArgument_inRoutineAttributes.operator_or (GALGAS_routineAttributes::constructor_guard (SOURCE_FILE ("instruction-sync.galgas", 172)) COMMA_SOURCE_FILE ("instruction-sync.galgas", 172)), constinArgument_inCallerNameForInvocationGraph, function_voidType (inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 174)), constinArgument_inContext, constinArgument_inMode, ioArgument_ioTemporaries, ioArgument_ioGlobalLiteralStringMap, ioArgument_ioUniversalMap, ioArgument_ioAllocaList, var_guardInstructionGenerationList_6430, var_sourceOperand_6966, inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 170)) ;
        const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, extensionGetter_plmTypeName (var_sourceOperand_6966, inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 184)).objectCompare (function_boolTypeName (inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 184)))).boolEnum () ;
        if (kBoolTrue == test_0) {
          TC_Array <C_FixItDescription> fixItArray1 ;
          ...
          const enumGalgasBool test_2 = extensionGetter_isStatic (var_sourceOperand_6966, inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 186)).boolEnum () ;
          if (kBoolTrue == test_2) {
            TC_Array <C_FixItDescription> fixItArray3 ;
        ...
        {
        extensionSetter_appendLoadWhenReference (var_guardInstructionGenerationList_6430, ioArgument_ioTemporaries, var_sourceOperand_6966, var_sourceValue_7359, inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 189)) ;
        }
        var_guardedCommandIR_6289 = GALGAS_guardedCommandIR::constructor_booleanGuard (extractedValue_isContinue, var_guardInstructionGenerationList_6430, var_sourceValue_7359  COMMA_SOURCE_FILE ("instruction-sync.galgas", 194)) ;
      }
      break ;
    case GALGAS_guardedCommandAST::kEnum_boolAndSync:
      {
        const cEnumAssociatedValues_guardedCommandAST_boolAndSync * extractPtr_12597 = (const cEnumAssociatedValues_guardedCommandAST_boolAndSync *) (enumerator_6184.current_mGuardedCommand (HERE).unsafePointer ()) ;
        const GALGAS_bool extractedValue_isContinue = extractPtr_12597->mAssociatedValue0 ;
        const GALGAS_expressionAST extractedValue_exp = extractPtr_12597->mAssociatedValue1 ;
        const GALGAS_bool extractedValue_warnsOnStaticExpression = extractPtr_12597->mAssociatedValue2 ;
        const GALGAS_location extractedValue_endOfExp = extractPtr_12597->mAssociatedValue3 ;
        const GALGAS_lbool extractedValue_usesSelf = extractPtr_12597->mAssociatedValue4 ;
        const GALGAS_lstringlist extractedValue_nameList = extractPtr_12597->mAssociatedValue5 ;
        const GALGAS_effectiveArgumentListAST extractedValue_parameterList = extractPtr_12597->mAssociatedValue6 ;
        GALGAS_instructionListIR var_boolExpInstructionGenerationList_7708 = GALGAS_instructionListIR::constructor_emptyList (SOURCE_FILE ("instruction-sync.galgas", 200)) ;
        GALGAS_objectIR var_boolExpressionResult_8265 ;
        callExtensionMethod_analyzeExpression ((const cPtr_expressionAST *) extractedValue_exp.ptr (), constinArgument_inSelfType, GALGAS_routineAttributes::constructor_guard (SOURCE_FILE ("instruction-sync.galgas", 204)), constinArgument_inCallerNameForInvocationGraph, function_voidType (inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 206)), constinArgument_inContext, constinArgument_inMode, ioArgument_ioTemporaries, ioArgument_ioGlobalLiteralStringMap, ioArgument_ioUniversalMap, ioArgument_ioAllocaList, var_boolExpInstructionGenerationList_7708, var_boolExpressionResult_8265, inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 202)) ;
        ...
        {
        extensionSetter_appendLoadWhenReference (var_boolExpInstructionGenerationList_7708, ioArgument_ioTemporaries, var_boolExpressionResult_8265, var_boolExpressionValue_8702, inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 221)) ;
        }
        ...
        if (kBoolTrue == test_9) {
          ...
          if (kBoolTrue == test_10) {
            ...
            {
            routine_analyzeGuardCall (constinArgument_inSelfType, var_currentObject_9249, var_guardName_9214, extractedValue_parameterList, constinArgument_inCallerNameForInvocationGraph, constinArgument_inContext, constinArgument_inMode, ioArgument_ioTemporaries, ioArgument_ioGlobalLiteralStringMap, ioArgument_ioUniversalMap, ioArgument_ioAllocaList, var_guardInstructionGenerationList_8799, var_guardEffectiveParameterListIR_8874, var_guardMangledName_8906, inCompiler  COMMA_SOURCE_FILE ("instruction-sync.galgas", 245)) ;
            }
          }
          ...
          if (kBoolTrue == test_12) {
            ...
            GALGAS_lstringlist var_propertyList_11010 = extractedValue_nameList ;
            GALGAS_lstring var_globalReceiverName_11078 ;
            {
            var_propertyList_11010.setter_popFirst (var_globalReceiverName_11078, inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 280)) ;
            }
            GALGAS_lstring var_guardName_11126 ;
            {
            var_propertyList_11010.setter_popLast (var_guardName_11126, inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 281)) ;
            }
            GALGAS_objectIR var_currentObjectIR_11309 ;
            extensionMethod_searchValuedObject (ioArgument_ioUniversalMap, var_globalReceiverName_11078, constinArgument_inRoutineAttributes, ioArgument_ioTemporaries.getter_mInitializedDriverSet (HERE), var_currentObjectIR_11309, inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 282)) ;
            cEnumerator_lstringlist enumerator_11362 (var_propertyList_11010, kENUMERATION_UP) ;
            while (enumerator_11362.hasCurrentObject ()) {
              {
              routine_handlePropertyAccessInExpression (var_currentObjectIR_11309, enumerator_11362.current_mValue (HERE), ioArgument_ioTemporaries, ioArgument_ioInstructionGenerationList, inCompiler  COMMA_SOURCE_FILE ("instruction-sync.galgas", 289)) ;
              }
              enumerator_11362.gotoNextObject () ;
            }
            {
            routine_analyzeGuardCall (constinArgument_inSelfType, var_currentObjectIR_11309, var_guardName_11126, extractedValue_parameterList, constinArgument_inCallerNameForInvocationGraph, constinArgument_inContext, constinArgument_inMode, ioArgument_ioTemporaries, ioArgument_ioGlobalLiteralStringMap, ioArgument_ioUniversalMap, ioArgument_ioAllocaList, var_guardInstructionGenerationList_8799, var_guardEffectiveParameterListIR_8874, var_guardMangledName_8906, inCompiler  COMMA_SOURCE_FILE ("instruction-sync.galgas", 296)) ;
            }
          }
        }
        var_guardedCommandIR_6289 = GALGAS_guardedCommandIR::constructor_boolAndSync (extractedValue_isContinue, var_boolExpInstructionGenerationList_7708, var_boolExpressionValue_8702, var_guardMangledName_8906.getter_string (HERE), var_guardInstructionGenerationList_8799, var_guardEffectiveParameterListIR_8874  COMMA_SOURCE_FILE ("instruction-sync.galgas", 313)) ;
      }
      break ;
    }
    GALGAS_instructionListIR var_branchInstructionGenerationList_12684 = GALGAS_instructionListIR::constructor_emptyList (SOURCE_FILE ("instruction-sync.galgas", 323)) ;
    extensionMethod_analyzeBranchInstructionList (enumerator_6184.current_mInstructionList (HERE), constinArgument_inSelfType, constinArgument_inRoutineAttributes, constinArgument_inCallerNameForInvocationGraph, enumerator_6184.current_mEndOfBranch (HERE), constinArgument_inContext, constinArgument_inMode, ioArgument_ioTemporaries, ioArgument_ioGlobalLiteralStringMap, ioArgument_ioUniversalMap, ioArgument_ioAllocaList, var_branchInstructionGenerationList_12684, inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 324)) ;
    {
    extensionSetter_closeOverride (ioArgument_ioUniversalMap, enumerator_6184.current_mEndOfBranch (HERE), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 337)) ;
    }
    var_onInstructionBranchListIR_6113.addAssign_operation (var_guardedCommandIR_6289, var_branchInstructionGenerationList_12684  COMMA_SOURCE_FILE ("instruction-sync.galgas", 339)) ;
    enumerator_6184.gotoNextObject () ;
  }
  ioArgument_ioInstructionGenerationList.addAssign_operation (GALGAS_syncInstructionIR::constructor_new (object->mProperty_mInstructionLocation, var_onInstructionBranchListIR_6113  COMMA_SOURCE_FILE ("instruction-sync.galgas", 344))  COMMA_SOURCE_FILE ("instruction-sync.galgas", 344)) ;
}
...
void routine_analyzeGuardCall (const GALGAS_PLMType constinArgument_inSelfType,
  ...
  GALGAS_guardMapForContext var_guardMap_14354 = extensionGetter_type (constinArgument_inReceiver, inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 365)).getter_guardMap (SOURCE_FILE ("instruction-sync.galgas", 365)) ;
  GALGAS_lstring var_guardMangledName_14408 = function_routineMangledNameFromCall (GALGAS_string::makeEmptyString (), constinArgument_inGuardName, constinArgument_inEffectiveParameterList, inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 366)) ;
  GALGAS_bool var_isPublic_14536 ;
  GALGAS_routineTypedSignature var_formalSignature_14580 ;
  var_guardMap_14354.method_searchKey (var_guardMangledName_14408, var_isPublic_14536, var_formalSignature_14580, inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 367)) ;
  const enumGalgasBool test_0 = var_isPublic_14536.operator_not (SOURCE_FILE ("instruction-sync.galgas", 369)).boolEnum () ;
  if (kBoolTrue == test_0) {
    TC_Array <C_FixItDescription> fixItArray1 ;
    ...
    outArgument_outGuardMangledName = function_routineMangledNameFromCall (function_llvmTypeStringFromPLMname (extensionGetter_type (constinArgument_inReceiver, inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 373)).getter_plmTypeName (HERE), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 373)), constinArgument_inGuardName, constinArgument_inEffectiveParameterList, inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 372)) ;
    {
    ioArgument_ioTemporaries.mProperty_mSubprogramInvocationGraph.setter_addEdge (constinArgument_inCallerNameForInvocationGraph, outArgument_outGuardMangledName COMMA_SOURCE_FILE ("instruction-sync.galgas", 378)) ;
    }
    GALGAS_procCallEffectiveParameterListIR temp_2 = GALGAS_procCallEffectiveParameterListIR::constructor_emptyList (SOURCE_FILE ("instruction-sync.galgas", 380)) ;
    temp_2.addAssign_operation (GALGAS_procEffectiveParameterPassingModeIR::constructor_outputInput (SOURCE_FILE ("instruction-sync.galgas", 380)), constinArgument_inReceiver  COMMA_SOURCE_FILE ("instruction-sync.galgas", 380)) ;
...
void routine_analyzeStandaloneGuardCall (const GALGAS_PLMType constinArgument_inSelfType,
  ...
  outArgument_outEffectiveParameterListIR.drop () ; // Release 'out' argument
  outArgument_outGuardMangledName.drop () ; // Release 'out' argument
  outArgument_outGuardMangledName = function_routineMangledNameFromCall (GALGAS_string::makeEmptyString (), constinArgument_inGuardName, constinArgument_inEffectiveParameterList, inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 416)) ;
  GALGAS_bool var_isPublic_16764 ;
  GALGAS_routineTypedSignature var_formalSignature_16812 ;
  constinArgument_inContext.getter_mGuardMapForContext (HERE).method_searchKey (outArgument_outGuardMangledName, var_isPublic_16764, var_formalSignature_16812, inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 421)) ;
  const enumGalgasBool test_0 = var_isPublic_16764.operator_not (SOURCE_FILE ("instruction-sync.galgas", 427)).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_string var_declarationFile_16896 = constinArgument_inContext.getter_mGuardMapForContext (HERE).getter_locationForKey (outArgument_outGuardMangledName.getter_string (HERE), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 428)).getter_file (inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 428)) ;
    GALGAS_string var_invocationFile_17003 = constinArgument_inGuardName.getter_location (HERE).getter_file (inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 429)) ;
    const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, var_invocationFile_17003.objectCompare (var_declarationFile_16896)).boolEnum () ;
    if (kBoolTrue == test_1) {
      TC_Array <C_FixItDescription> fixItArray2 ;
      inCompiler->emitSemanticError (constinArgument_inGuardName.getter_location (SOURCE_FILE ("instruction-sync.galgas", 431)), GALGAS_string ("this guard is not public"), fixItArray2  COMMA_SOURCE_FILE ("instruction-sync.galgas", 431)) ;
    }
  }
  {
  ioArgument_ioTemporaries.mProperty_mSubprogramInvocationGraph.setter_addEdge (constinArgument_inCallerNameForInvocationGraph, outArgument_outGuardMangledName COMMA_SOURCE_FILE ("instruction-sync.galgas", 435)) ;
  }
  outArgument_outEffectiveParameterListIR = GALGAS_procCallEffectiveParameterListIR::constructor_emptyList (SOURCE_FILE ("instruction-sync.galgas", 437)) ;
  {
  routine_analyzeEffectiveParameters (constinArgument_inSelfType, var_formalSignature_16812, constinArgument_inEffectiveParameterList, constinArgument_inGuardName.getter_location (HERE), constinArgument_inCallerNameForInvocationGraph, constinArgument_inContext, constinArgument_inRequiredMode, ioArgument_ioTemporaries, ioArgument_ioGlobalLiteralStringMap, ioArgument_ioUniversalMap, ioArgument_ioAllocaList, ioArgument_ioInstructionGenerationList, outArgument_outEffectiveParameterListIR, inCompiler  COMMA_SOURCE_FILE ("instruction-sync.galgas", 438)) ;
  }
}
...
static void extensionMethod_syncInstructionIR_llvmInstructionCode (const cPtr_abstractInstructionIR * inObject,
  ...
  GALGAS_string var_startLabel_19766 = GALGAS_string ("select.").add_operation (ioArgument_ioGenerationAdds.getter_mUniqueIndex (HERE).getter_string (SOURCE_FILE ("instruction-sync.galgas", 495)), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 495)) ;
  ioArgument_ioGenerationAdds.mProperty_mUniqueIndex.increment_operation (inCompiler  COMMA_SOURCE_FILE ("instruction-sync.galgas", 496)) ;
  ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  br label %").add_operation (var_startLabel_19766, inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 498)).add_operation (GALGAS_string (".start\n"
    "\n"), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 498)), inCompiler  COMMA_SOURCE_FILE ("instruction-sync.galgas", 498)) ;
  GALGAS_string var_startLabelName_19930 = var_startLabel_19766.add_operation (GALGAS_string (".start"), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 499)) ;
  ioArgument_ioLLVMcode.plusAssign_operation(var_startLabelName_19930.add_operation (GALGAS_string (":\n"), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 500)), inCompiler  COMMA_SOURCE_FILE ("instruction-sync.galgas", 500)) ;
  GALGAS_string var_exitLabelName_20014 = var_startLabel_19766.add_operation (GALGAS_string (".exit"), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 501)) ;
  GALGAS_string var_selectLabelName_20059 = var_startLabel_19766.add_operation (GALGAS_string (".select"), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 502)) ;
  GALGAS_string var_errorLabelName_20105 = var_startLabel_19766.add_operation (GALGAS_string (".error"), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 503)) ;
  GALGAS_string var_currentStartBranchLabel_20159 = var_startLabelName_19930 ;
  cEnumerator_syncInstructionBranchListIR enumerator_20219 (object->mProperty_mOnInstructionBranchListIR, kENUMERATION_UP) ;
  GALGAS_uint index_20182 ((uint32_t) 0) ;
  while (enumerator_20219.hasCurrentObject ()) {
    GALGAS_string var_acceptanceVarName_20254 = GALGAS_string ("%").add_operation (var_startLabel_19766, inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 506)).add_operation (GALGAS_string (".accept."), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 506)).add_operation (index_20182.getter_string (SOURCE_FILE ("instruction-sync.galgas", 506)), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 506)) ;
    GALGAS_bool var_isWhileGuardedCommand_20324 ;
    switch (enumerator_20219.current (HERE).getter_mGuardedCommand (HERE).enumValue ()) {
    case GALGAS_guardedCommandIR::kNotBuilt:
      break ;
    case GALGAS_guardedCommandIR::kEnum_booleanGuard:
      {
        const cEnumAssociatedValues_guardedCommandIR_booleanGuard * extractPtr_21176 = (const cEnumAssociatedValues_guardedCommandIR_booleanGuard *) (enumerator_20219.current (HERE).getter_mGuardedCommand (HERE).unsafePointer ()) ;
        const GALGAS_bool extractedValue_isWhileCommand = extractPtr_21176->mAssociatedValue0 ;
        const GALGAS_instructionListIR extractedValue_instructionGenerationList = extractPtr_21176->mAssociatedValue1 ;
        const GALGAS_objectIR extractedValue_result = extractPtr_21176->mAssociatedValue2 ;
        var_isWhileGuardedCommand_20324 = extractedValue_isWhileCommand ;
        extensionMethod_instructionListLLVMCode (extractedValue_instructionGenerationList, ioArgument_ioLLVMcode, constinArgument_inGenerationContext, ioArgument_ioGenerationAdds, inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 511)) ;
        GALGAS_string var_acceptedLabelName_20626 = var_startLabel_19766.add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 512)).add_operation (index_20182.getter_string (SOURCE_FILE ("instruction-sync.galgas", 512)), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 512)).add_operation (GALGAS_string (".true"), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 512)) ;
        GALGAS_string var_rejectedLabelName_20689 = var_startLabel_19766.add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 513)).add_operation (index_20182.getter_string (SOURCE_FILE ("instruction-sync.galgas", 513)), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 513)).add_operation (GALGAS_string (".false"), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 513)) ;
        ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  br i1 ").add_operation (extensionGetter_llvmName (extractedValue_result, inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 514)), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 514)).add_operation (GALGAS_string (", label %"), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 514)).add_operation (var_acceptedLabelName_20626, inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 514)).add_operation (GALGAS_string (", label %"), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 514)).add_operation (var_rejectedLabelName_20689, inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 514)).add_operation (GALGAS_string ("\n"
          "\n"), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 514)), inCompiler  COMMA_SOURCE_FILE ("instruction-sync.galgas", 514)) ;
        ioArgument_ioLLVMcode.plusAssign_operation(var_acceptedLabelName_20626.add_operation (GALGAS_string (":\n"), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 515)), inCompiler  COMMA_SOURCE_FILE ("instruction-sync.galgas", 515)) ;
        ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  call void @noteGuardHasBeenAccepted ()\n"), inCompiler  COMMA_SOURCE_FILE ("instruction-sync.galgas", 516)) ;
        ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  br label %").add_operation (var_rejectedLabelName_20689, inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 517)).add_operation (GALGAS_string ("\n"
          "\n"), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 517)), inCompiler  COMMA_SOURCE_FILE ("instruction-sync.galgas", 517)) ;
        ioArgument_ioLLVMcode.plusAssign_operation(var_rejectedLabelName_20689.add_operation (GALGAS_string (":\n"), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 518)), inCompiler  COMMA_SOURCE_FILE ("instruction-sync.galgas", 518)) ;
        ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  ").add_operation (var_acceptanceVarName_20254, inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 519)).add_operation (GALGAS_string (" = or i1 "), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 519)).add_operation (extensionGetter_llvmName (extractedValue_result, inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 519)), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 519)).add_operation (GALGAS_string (", 0 ; assignment\n"), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 519)), inCompiler  COMMA_SOURCE_FILE ("instruction-sync.galgas", 519)) ;
      }
      break ;
    case GALGAS_guardedCommandIR::kEnum_boolAndSync:
      {
        const cEnumAssociatedValues_guardedCommandIR_boolAndSync * extractPtr_22905 = (const cEnumAssociatedValues_guardedCommandIR_boolAndSync *) (enumerator_20219.current (HERE).getter_mGuardedCommand (HERE).unsafePointer ()) ;
        const GALGAS_bool extractedValue_isWhileCommand = extractPtr_22905->mAssociatedValue0 ;
        const GALGAS_instructionListIR extractedValue_expInstructionList = extractPtr_22905->mAssociatedValue1 ;
        const GALGAS_objectIR extractedValue_expResult = extractPtr_22905->mAssociatedValue2 ;
        const GALGAS_string extractedValue_guardMangledName = extractPtr_22905->mAssociatedValue3 ;
        const GALGAS_instructionListIR extractedValue_guardInstructionList = extractPtr_22905->mAssociatedValue4 ;
        const GALGAS_procCallEffectiveParameterListIR extractedValue_effectiveParameterList = extractPtr_22905->mAssociatedValue5 ;
        var_isWhileGuardedCommand_20324 = extractedValue_isWhileCommand ;
        extensionMethod_instructionListLLVMCode (extractedValue_expInstructionList, ioArgument_ioLLVMcode, constinArgument_inGenerationContext, ioArgument_ioGenerationAdds, inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 522)) ;
        GALGAS_string var_testOkLabelName_21481 = var_startLabel_19766.add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 523)).add_operation (index_20182.getter_string (SOURCE_FILE ("instruction-sync.galgas", 523)), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 523)).add_operation (GALGAS_string (".boolexp.true"), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 523)) ;
        GALGAS_string var_testExitLabelName_21552 = var_startLabel_19766.add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 524)).add_operation (index_20182.getter_string (SOURCE_FILE ("instruction-sync.galgas", 524)), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 524)).add_operation (GALGAS_string (".test.exit"), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 524)) ;
        ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  br i1 ").add_operation (extensionGetter_llvmName (extractedValue_expResult, inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 525)), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 525)).add_operation (GALGAS_string (", label %"), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 525)).add_operation (var_testOkLabelName_21481, inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 525)).add_operation (GALGAS_string (", label %"), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 525)).add_operation (var_testExitLabelName_21552, inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 525)).add_operation (GALGAS_string ("\n"
          "\n"), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 525)), inCompiler  COMMA_SOURCE_FILE ("instruction-sync.galgas", 525)) ;
        ioArgument_ioLLVMcode.plusAssign_operation(var_testOkLabelName_21481.add_operation (GALGAS_string (":\n"), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 526)), inCompiler  COMMA_SOURCE_FILE ("instruction-sync.galgas", 526)) ;
        extensionMethod_instructionListLLVMCode (extractedValue_guardInstructionList, ioArgument_ioLLVMcode, constinArgument_inGenerationContext, ioArgument_ioGenerationAdds, inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 527)) ;
        GALGAS_string var_guardAcceptationLabelName_21907 = var_startLabel_19766.add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 528)).add_operation (index_20182.getter_string (SOURCE_FILE ("instruction-sync.galgas", 528)), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 528)).add_operation (GALGAS_string (".guard.acceptation"), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 528)) ;
        ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  %").add_operation (var_guardAcceptationLabelName_21907, inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 529)).add_operation (GALGAS_string (" = call i1 @"), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 529)).add_operation (function_llvmNameForGuardCall (extractedValue_guardMangledName, inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 529)), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 529)), inCompiler  COMMA_SOURCE_FILE ("instruction-sync.galgas", 529)) ;
        ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string (" ("), inCompiler  COMMA_SOURCE_FILE ("instruction-sync.galgas", 530)) ;
        cEnumerator_procCallEffectiveParameterListIR enumerator_22133 (extractedValue_effectiveParameterList, kENUMERATION_UP) ;
        while (enumerator_22133.hasCurrentObject ()) {
          switch (enumerator_22133.current_mEffectiveParameterPassingMode (HERE).enumValue ()) {
          case GALGAS_procEffectiveParameterPassingModeIR::kNotBuilt:
            break ;
          case GALGAS_procEffectiveParameterPassingModeIR::kEnum_input:
            {
              ioArgument_ioLLVMcode.plusAssign_operation(extensionGetter_llvmTypeName (enumerator_22133.current_mParameter (HERE), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 534)).add_operation (GALGAS_string (" * "), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 534)).add_operation (extensionGetter_llvmName (enumerator_22133.current_mParameter (HERE), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 534)), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 534)), inCompiler  COMMA_SOURCE_FILE ("instruction-sync.galgas", 534)) ;
            }
            break ;
          case GALGAS_procEffectiveParameterPassingModeIR::kEnum_output:
            {
              ioArgument_ioLLVMcode.plusAssign_operation(extensionGetter_llvmTypeName (enumerator_22133.current_mParameter (HERE), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 536)).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 536)).add_operation (extensionGetter_llvmName (enumerator_22133.current_mParameter (HERE), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 536)), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 536)), inCompiler  COMMA_SOURCE_FILE ("instruction-sync.galgas", 536)) ;
            }
            break ;
          case GALGAS_procEffectiveParameterPassingModeIR::kEnum_outputInput:
            {
              ioArgument_ioLLVMcode.plusAssign_operation(extensionGetter_llvmTypeName (enumerator_22133.current_mParameter (HERE), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 538)).add_operation (GALGAS_string (" * "), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 538)).add_operation (extensionGetter_llvmName (enumerator_22133.current_mParameter (HERE), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 538)), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 538)), inCompiler  COMMA_SOURCE_FILE ("instruction-sync.galgas", 538)) ;
            }
            break ;
          }
          if (enumerator_22133.hasNextObject ()) {
            ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string (", "), inCompiler  COMMA_SOURCE_FILE ("instruction-sync.galgas", 541)) ;
          }
          enumerator_22133.gotoNextObject () ;
        }
        ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string (")\n"), inCompiler  COMMA_SOURCE_FILE ("instruction-sync.galgas", 543)) ;
        ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  br label %").add_operation (var_testExitLabelName_21552, inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 544)).add_operation (GALGAS_string ("\n"
          "\n"), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 544)), inCompiler  COMMA_SOURCE_FILE ("instruction-sync.galgas", 544)) ;
        ioArgument_ioLLVMcode.plusAssign_operation(var_testExitLabelName_21552.add_operation (GALGAS_string (":\n"), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 545)), inCompiler  COMMA_SOURCE_FILE ("instruction-sync.galgas", 545)) ;
        ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  ").add_operation (var_acceptanceVarName_20254, inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 546)).add_operation (GALGAS_string (" = phi i1 "), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 546)), inCompiler  COMMA_SOURCE_FILE ("instruction-sync.galgas", 546)) ;
        ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("[%").add_operation (var_guardAcceptationLabelName_21907, inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 547)).add_operation (GALGAS_string (", %"), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 547)).add_operation (var_testOkLabelName_21481, inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 547)).add_operation (GALGAS_string ("], "), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 547)), inCompiler  COMMA_SOURCE_FILE ("instruction-sync.galgas", 547)) ;
        ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("[false, %").add_operation (var_currentStartBranchLabel_20159, inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 548)).add_operation (GALGAS_string ("]\n"), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 548)), inCompiler  COMMA_SOURCE_FILE ("instruction-sync.galgas", 548)) ;
      }
      break ;
    }
    GALGAS_string var_acceptedLabelName_22939 = var_startLabel_19766.add_operation (GALGAS_string (".accepted."), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 550)).add_operation (index_20182.getter_string (SOURCE_FILE ("instruction-sync.galgas", 550)), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 550)) ;
    GALGAS_string var_rejectedLabelName_22999 = var_startLabel_19766.add_operation (GALGAS_string (".rejected."), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 551)).add_operation (index_20182.getter_string (SOURCE_FILE ("instruction-sync.galgas", 551)), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 551)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  br i1 ").add_operation (var_acceptanceVarName_20254, inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 552)).add_operation (GALGAS_string (", label %"), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 552)).add_operation (var_acceptedLabelName_22939, inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 552)).add_operation (GALGAS_string (", label %"), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 552)).add_operation (var_rejectedLabelName_22999, inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 552)).add_operation (GALGAS_string ("\n"
      "\n"), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 552)), inCompiler  COMMA_SOURCE_FILE ("instruction-sync.galgas", 552)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(var_acceptedLabelName_22939.add_operation (GALGAS_string (":\n"), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 553)), inCompiler  COMMA_SOURCE_FILE ("instruction-sync.galgas", 553)) ;
    extensionMethod_instructionListLLVMCode (enumerator_20219.current (HERE).getter_mInstructionGenerationList (HERE), ioArgument_ioLLVMcode, constinArgument_inGenerationContext, ioArgument_ioGenerationAdds, inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 554)) ;
    GALGAS_string temp_0 ;
    const enumGalgasBool test_1 = var_isWhileGuardedCommand_20324.boolEnum () ;
    if (kBoolTrue == test_1) {
      temp_0 = var_startLabelName_19930 ;
    }else if (kBoolFalse == test_1) {
      temp_0 = var_exitLabelName_20014 ;
    }
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  br label %").add_operation (temp_0, inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 555)).add_operation (GALGAS_string ("\n"
      "\n"), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 555)), inCompiler  COMMA_SOURCE_FILE ("instruction-sync.galgas", 555)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(var_rejectedLabelName_22999.add_operation (GALGAS_string (":\n"), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 556)), inCompiler  COMMA_SOURCE_FILE ("instruction-sync.galgas", 556)) ;
    var_currentStartBranchLabel_20159 = var_rejectedLabelName_22999 ;
    enumerator_20219.gotoNextObject () ;
    index_20182.increment_operation (inCompiler  COMMA_SOURCE_FILE ("instruction-sync.galgas", 505)) ;
  }
  ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  %").add_operation (var_selectLabelName_20059, inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 559)).add_operation (GALGAS_string (" = call i1 @"), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 559)).add_operation (function_llvmNameForServiceCall (function_waitForGuardChangeFunctionName (inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 559)), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 559)), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 559)).add_operation (GALGAS_string (" ()\n"), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 559)), inCompiler  COMMA_SOURCE_FILE ("instruction-sync.galgas", 559)) ;
  ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  br i1 %").add_operation (var_selectLabelName_20059, inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 560)).add_operation (GALGAS_string (", label %"), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 560)).add_operation (var_startLabelName_19930, inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 560)).add_operation (GALGAS_string (", label %"), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 560)).add_operation (var_errorLabelName_20105, inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 560)).add_operation (GALGAS_string ("\n"
    "\n"), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 560)), inCompiler  COMMA_SOURCE_FILE ("instruction-sync.galgas", 560)) ;
  ioArgument_ioLLVMcode.plusAssign_operation(var_errorLabelName_20105.add_operation (GALGAS_string (":\n"), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 561)), inCompiler  COMMA_SOURCE_FILE ("instruction-sync.galgas", 561)) ;
  const enumGalgasBool test_2 = GALGAS_bool (gOption_plm_5F_options_noPanicGeneration.getter_value ()).boolEnum () ;
  if (kBoolTrue == test_2) {
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  br label %").add_operation (var_exitLabelName_20014, inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 563)).add_operation (GALGAS_string ("\n"
      "\n"), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 563)), inCompiler  COMMA_SOURCE_FILE ("instruction-sync.galgas", 563)) ;
  }else if (kBoolFalse == test_2) {
    GALGAS_uint var_staticStringIndex_24191 ;
    {
    extensionSetter_findOrAddStaticString (ioArgument_ioGenerationAdds.mProperty_mStaticStringMap, object->mProperty_mSelectInstructionLocation.getter_file (inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 566)).getter_lastPathComponent (SOURCE_FILE ("instruction-sync.galgas", 566)).getter_stringByDeletingPathExtension (SOURCE_FILE ("instruction-sync.galgas", 566)), var_staticStringIndex_24191, inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 565)) ;
    }
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  call void @raise.panic.").add_operation (var_staticStringIndex_24191.getter_string (SOURCE_FILE ("instruction-sync.galgas", 569)), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 569)).add_operation (GALGAS_string (" ("), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 569)), inCompiler  COMMA_SOURCE_FILE ("instruction-sync.galgas", 569)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(constinArgument_inGenerationContext.getter_mPanicLineLLVMType (HERE).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 570)).add_operation (object->mProperty_mSelectInstructionLocation.getter_line (inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 570)).getter_string (SOURCE_FILE ("instruction-sync.galgas", 570)), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 570)).add_operation (GALGAS_string (", "), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 570)), inCompiler  COMMA_SOURCE_FILE ("instruction-sync.galgas", 570)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(constinArgument_inGenerationContext.getter_mPanicCodeLLVMType (HERE).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 571)).add_operation (function_panicCodeForClosedSync (inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 571)).getter_string (SOURCE_FILE ("instruction-sync.galgas", 571)), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 571)).add_operation (GALGAS_string (")\n"), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 571)), inCompiler  COMMA_SOURCE_FILE ("instruction-sync.galgas", 571)) ;
    ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  unreachable\n"
      "\n"), inCompiler  COMMA_SOURCE_FILE ("instruction-sync.galgas", 572)) ;
  }
  ioArgument_ioLLVMcode.plusAssign_operation(var_exitLabelName_20014.add_operation (GALGAS_string (":\n"), inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 574)), inCompiler  COMMA_SOURCE_FILE ("instruction-sync.galgas", 574)) ;
}
...
static void extensionMethod_syncInstructionIR_enterAccessibleEntities (const cPtr_abstractInstructionIR * inObject,
  ...
  const cPtr_syncInstructionIR * object = (const cPtr_syncInstructionIR *) inObject ;
  macroValidSharedObject (object, cPtr_syncInstructionIR) ;
  GALGAS_uint var_branchCount_24844 = object->mProperty_mOnInstructionBranchListIR.getter_length (SOURCE_FILE ("instruction-sync.galgas", 583)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictInf, ioArgument_ioMaxBranchOfOnInstructions.objectCompare (var_branchCount_24844)).boolEnum () ;
  if (kBoolTrue == test_0) {
    ioArgument_ioMaxBranchOfOnInstructions = var_branchCount_24844 ;
  }
  cEnumerator_syncInstructionBranchListIR enumerator_25029 (object->mProperty_mOnInstructionBranchListIR, kENUMERATION_UP) ;
  while (enumerator_25029.hasCurrentObject ()) {
    extensionMethod_enterAccessibleEntities (enumerator_25029.current (HERE).getter_mInstructionGenerationList (HERE), ioArgument_ioAccessibleEntities, ioArgument_ioMaxBranchOfOnInstructions, inCompiler COMMA_SOURCE_FILE ("instruction-sync.galgas", 588)) ;
    switch (enumerator_25029.current (HERE).getter_mGuardedCommand (HERE).enumValue ()) {
    case GALGAS_guardedCommandIR::kNotBuilt:
      break ;
    case GALGAS_guardedCommandIR::kEnum_booleanGuard:
      {
        const cEnumAssociatedValues_guardedCommandIR_booleanGuard * extractPtr_25350 = (const cEnumAssociatedValues_guardedCommandIR_booleanGuard *) (enumerator_25029.current (HERE).getter_mGuardedCommand (HERE).unsafePointer ()) ;
        const GALGAS_instructionListIR extractedValue_instructionGenerationList = extractPtr_25350->mAssociatedValue1 ;
    ...
    case GALGAS_guardedCommandIR::kEnum_boolAndSync:
      {
        const cEnumAssociatedValues_guardedCommandIR_boolAndSync * extractPtr_25740 = (const cEnumAssociatedValues_guardedCommandIR_boolAndSync *) (enumerator_25029.current (HERE).getter_mGuardedCommand (HERE).unsafePointer ()) ;
        ...
        const GALGAS_instructionListIR extractedValue_guardInstructionGenerationList = extractPtr_25740->mAssociatedValue4 ;
        ...
        ioArgument_ioAccessibleEntities.mProperty_mGuardSet.addAssign_operation (extractedValue_guardMangledName  COMMA_SOURCE_FILE ("instruction-sync.galgas", 595)) ;
      }
      break ;
    }
...
static void extensionMethod_procedureCallInstructionAST_analyze (const cPtr_instructionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    case GALGAS_valuedObject::kEnum_registerGroup:
      {
        TC_Array <C_FixItDescription> fixItArray6 ;
        inCompiler->emitSemanticError (object->mProperty_mIdentifier.getter_location (SOURCE_FILE ("instruction-procedure-call.galgas", 248)), GALGAS_string ("a control register constant cannot be used in this context"), fixItArray6  COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 248)) ;
        var_currentType_8960.drop () ; // Release error dropped variable
        var_currentLLVMAddressVar_8992.drop () ; // Release error dropped variable
      }
      break ;
    case GALGAS_valuedObject::kEnum_globalConstant:
      {
        TC_Array <C_FixItDescription> fixItArray7 ;
        inCompiler->emitSemanticError (object->mProperty_mIdentifier.getter_location (SOURCE_FILE ("instruction-procedure-call.galgas", 252)), GALGAS_string ("a global constant cannot be used in this context"), fixItArray7  COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 252)) ;
        var_currentType_8960.drop () ; // Release error dropped variable
        var_currentLLVMAddressVar_8992.drop () ; // Release error dropped variable
      }
      break ;
    case GALGAS_valuedObject::kEnum_localConstant:
      {
        const cEnumAssociatedValues_valuedObject_localConstant * extractPtr_10442 = (const cEnumAssociatedValues_valuedObject_localConstant *) (var_entity_9362.unsafePointer ()) ;
        const GALGAS_PLMType extractedValue_type = extractPtr_10442->mAssociatedValue0 ;
        const GALGAS_lstring extractedValue_plmName = extractPtr_10442->mAssociatedValue1 ;
        var_currentType_8960 = extractedValue_type ;
        var_currentLLVMAddressVar_8992 = function_llvmNameForLocalVariable (extractedValue_plmName.getter_string (SOURCE_FILE ("instruction-procedure-call.galgas", 257)), inCompiler COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 257)) ;
      }
      break ;
    case GALGAS_valuedObject::kEnum_localVariable:
      {
        const cEnumAssociatedValues_valuedObject_localVariable * extractPtr_10591 = (const cEnumAssociatedValues_valuedObject_localVariable *) (var_entity_9362.unsafePointer ()) ;
        ...
        var_currentType_8960 = extractedValue_type ;
        var_currentLLVMAddressVar_8992 = function_llvmNameForLocalVariable (extractedValue_plmName.getter_string (SOURCE_FILE ("instruction-procedure-call.galgas", 260)), inCompiler COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 260)) ;
      }
      break ;
    }
  }
  GALGAS_propertyMap var_propertyMap_10673 = var_currentType_8960.getter_propertyMap (HERE) ;
  GALGAS_accessInAssignmentListAST var_accessList_10788 = object->mProperty_mAccessList ;
  GALGAS_accessInAssignmentAST var_lastAccess_10842 ;
  {
  var_accessList_10788.setter_popLast (var_lastAccess_10842, inCompiler COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 267)) ;
  }
  cEnumerator_accessInAssignmentListAST enumerator_10897 (var_accessList_10788, kENUMERATION_UP) ;
  while (enumerator_10897.hasCurrentObject ()) {
    switch (enumerator_10897.current_mAccess (HERE).enumValue ()) {
    case GALGAS_accessInAssignmentAST::kNotBuilt:
      break ;
    case GALGAS_accessInAssignmentAST::kEnum_property:
      {
        const cEnumAssociatedValues_accessInAssignmentAST_property * extractPtr_11887 = (const cEnumAssociatedValues_accessInAssignmentAST_property *) (enumerator_10897.current_mAccess (HERE).unsafePointer ()) ;
        const GALGAS_lstring extractedValue_propertyName = extractPtr_11887->mAssociatedValue0 ;
        GALGAS_bool var_isPublic_11048 ;
        GALGAS_propertyAccessKind var_propertyAccess_11096 ;
        var_propertyMap_10673.method_searchKey (extractedValue_propertyName, var_isPublic_11048, var_propertyAccess_11096, inCompiler COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 272)) ;
        switch (var_propertyAccess_11096.enumValue ()) {
        ...
        case GALGAS_propertyAccessKind::kEnum_indexed:
          {
            const cEnumAssociatedValues_propertyAccessKind_indexed * extractPtr_11877 = (const cEnumAssociatedValues_propertyAccessKind_indexed *) (var_propertyAccess_11096.unsafePointer ()) ;
            const GALGAS_PLMType extractedValue_propertyType = extractPtr_11877->mAssociatedValue0 ;
            const GALGAS_uint extractedValue_propertyIndex = extractPtr_11877->mAssociatedValue1 ;
            GALGAS_string var_llvmPropertyName_11574 ;
            {
            extensionSetter_newTempLLVMVar (ioArgument_ioTemporaries, var_llvmPropertyName_11574, inCompiler COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 285)) ;
            }
            {
            extensionSetter_appendGetUniversalPropertyReference (ioArgument_ioInstructionGenerationList, var_currentType_8960, var_currentLLVMAddressVar_8992, var_llvmPropertyName_11574, extractedValue_propertyIndex, extractedValue_propertyName.getter_string (SOURCE_FILE ("instruction-procedure-call.galgas", 291)), inCompiler COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 286)) ;
            }
            var_currentType_8960 = extractedValue_propertyType ;
            var_currentLLVMAddressVar_8992 = var_llvmPropertyName_11574 ;
          }
          break ;
        }
      }
    ...
    case GALGAS_accessInAssignmentAST::kEnum_arrayAccess:
      {
        const cEnumAssociatedValues_accessInAssignmentAST_arrayAccess * extractPtr_12051 = (const cEnumAssociatedValues_accessInAssignmentAST_arrayAccess *) (enumerator_10897.current_mAccess (HERE).unsafePointer ()) ;
        const GALGAS_expressionAST extractedValue_indexExpression = extractPtr_12051->mAssociatedValue0 ;
        const GALGAS_location extractedValue_endOfIndex = extractPtr_12051->mAssociatedValue1 ;
        TC_Array <C_FixItDescription> fixItArray10 ;
        inCompiler->emitSemanticError (extractedValue_endOfIndex, GALGAS_string ("not handled yet"), fixItArray10  COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 297)) ;
        var_currentType_8960.drop () ; // Release error dropped variable
        var_currentLLVMAddressVar_8992.drop () ; // Release error dropped variable
      }
      break ;
  ...
  switch (var_lastAccess_10842.enumValue ()) {
  case GALGAS_accessInAssignmentAST::kNotBuilt:
    break ;
  case GALGAS_accessInAssignmentAST::kEnum_arrayAccess:
    {
      const cEnumAssociatedValues_accessInAssignmentAST_arrayAccess * extractPtr_12215 = (const cEnumAssociatedValues_accessInAssignmentAST_arrayAccess *) (var_lastAccess_10842.unsafePointer ()) ;
      const GALGAS_location extractedValue_endOfIndex = extractPtr_12215->mAssociatedValue1 ;
      TC_Array <C_FixItDescription> fixItArray11 ;
      inCompiler->emitSemanticError (extractedValue_endOfIndex, GALGAS_string ("a property access is required here"), fixItArray11  COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 303)) ;
    }
    break ;
  case GALGAS_accessInAssignmentAST::kEnum_property:
    {
      const cEnumAssociatedValues_accessInAssignmentAST_property * extractPtr_17321 = (const cEnumAssociatedValues_accessInAssignmentAST_property *) (var_lastAccess_10842.unsafePointer ()) ;
      const GALGAS_lstring extractedValue_methodName = extractPtr_17321->mAssociatedValue0 ;
      GALGAS_propertyMap var_propertyMap_12288 = var_currentType_8960.getter_propertyMap (HERE) ;
      GALGAS_lstring var_key_12326 = function_routineMangledNameFromCall (GALGAS_string::makeEmptyString (), extractedValue_methodName, object->mProperty_mArguments, inCompiler COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 306)) ;
      GALGAS_propertyAccessKind var_propertyAccess_12460 ;
      GALGAS_bool joker_12419 ; // Joker input parameter
      var_propertyMap_12288.method_searchKey (var_key_12326, joker_12419, var_propertyAccess_12460, inCompiler COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 307)) ;
      switch (var_propertyAccess_12460.enumValue ()) {
      case GALGAS_propertyAccessKind::kNotBuilt:
        break ;
      case GALGAS_propertyAccessKind::kEnum_constantProperty:
        {
          TC_Array <C_FixItDescription> fixItArray12 ;
          inCompiler->emitSemanticError (extractedValue_methodName.getter_location (SOURCE_FILE ("instruction-procedure-call.galgas", 310)), GALGAS_string ("a constant cannot be used as method"), fixItArray12  COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 310)) ;
        }
        break ;
      case GALGAS_propertyAccessKind::kEnum_nonVirtualMethod:
        {
          const cEnumAssociatedValues_propertyAccessKind_nonVirtualMethod * extractPtr_15215 = (const cEnumAssociatedValues_propertyAccessKind_nonVirtualMethod *) (var_propertyAccess_12460.unsafePointer ()) ;
          const GALGAS_routineDescriptor extractedValue_routineDescriptor = extractPtr_15215->mAssociatedValue0 ;
          GALGAS_procCallEffectiveParameterListIR temp_13 = GALGAS_procCallEffectiveParameterListIR::constructor_emptyList (SOURCE_FILE ("instruction-procedure-call.galgas", 315)) ;
          temp_13.addAssign_operation (GALGAS_procEffectiveParameterPassingModeIR::constructor_outputInput (SOURCE_FILE ("instruction-procedure-call.galgas", 314)), GALGAS_objectIR::constructor_reference (var_currentType_8960, var_currentLLVMAddressVar_8992  COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 315))  COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 315)) ;
          GALGAS_procCallEffectiveParameterListIR var_effectiveParameterListIR_12755 = temp_13 ;
          GALGAS_routineKind var_routineKind_12942 = extractedValue_routineDescriptor.getter_routineKind (HERE) ;
          GALGAS_mode var_calleeMode_12995 = extensionGetter_executionMode (var_routineKind_12942, inCompiler COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 320)) ;
          GALGAS_routineTypedSignature var_formalSignature_13051 = extractedValue_routineDescriptor.getter_signature (HERE) ;
          GALGAS_bool test_14 = GALGAS_bool (kIsEqual, object->mProperty_mIdentifier.getter_string (HERE).objectCompare (GALGAS_string::makeEmptyString ())) ;
          if (kBoolTrue == test_14.boolEnum ()) {
            test_14 = extractedValue_routineDescriptor.getter_canMutateProperties (HERE) ;
          }
          GALGAS_bool test_15 = test_14 ;
          if (kBoolTrue == test_15.boolEnum ()) {
            test_15 = constinArgument_inRoutineAttributes.getter_mutating (SOURCE_FILE ("instruction-procedure-call.galgas", 324)).operator_not (SOURCE_FILE ("instruction-procedure-call.galgas", 324)) ;
          }
          const enumGalgasBool test_16 = test_15.boolEnum () ;
          if (kBoolTrue == test_16) {
            TC_Array <C_FixItDescription> fixItArray17 ;
            inCompiler->emitSemanticError (extractedValue_methodName.getter_location (SOURCE_FILE ("instruction-procedure-call.galgas", 325)), GALGAS_string ("cannot mutate properties, current method is not declared with @").add_operation (function_mutatingAttribute (inCompiler COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 326)), inCompiler COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 326)).add_operation (GALGAS_string (" attribute"), inCompiler COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 326)), fixItArray17  COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 325)) ;
          }
          const enumGalgasBool test_18 = GALGAS_bool (kIsNotEqual, extractedValue_routineDescriptor.getter_returnTypeProxy (HERE).objectCompare (GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("instruction-procedure-call.galgas", 329)))).boolEnum () ;
          if (kBoolTrue == test_18) {
            TC_Array <C_FixItDescription> fixItArray19 ;
            inCompiler->emitSemanticError (extractedValue_methodName.getter_location (SOURCE_FILE ("instruction-procedure-call.galgas", 330)), GALGAS_string ("not a procedure (returns a value)"), fixItArray19  COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 330)) ;
          }else if (kBoolFalse == test_18) {
            GALGAS_calleeKindIR var_calleeKind_13753 = function_checkMode (constinArgument_inCurrentMode, var_calleeMode_12995, var_routineKind_12942, extractedValue_methodName.getter_location (HERE), inCompiler COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 333)) ;
            {
            routine_analyzeEffectiveParameters (constinArgument_inSelfType, var_formalSignature_13051, object->mProperty_mArguments, extractedValue_methodName.getter_location (HERE), constinArgument_inCallerNameForInvocationGraph, constinArgument_inContext, constinArgument_inCurrentMode, ioArgument_ioTemporaries, ioArgument_ioGlobalLiteralStringMap, ioArgument_ioUniversalMap, ioArgument_ioAllocaList, ioArgument_ioInstructionGenerationList, var_effectiveParameterListIR_12755, inCompiler  COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 340)) ;
            }
            GALGAS_lstring var_routineMangledName_14640 = function_routineMangledNameFromCall (function_llvmTypeStringFromPLMname (var_currentType_8960.getter_plmTypeName (HERE), inCompiler COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 356)), extractedValue_methodName, object->mProperty_mArguments, inCompiler COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 356)) ;
            ioArgument_ioInstructionGenerationList.addAssign_operation (GALGAS_standaloneRoutineCallIR::constructor_new (object->mProperty_mIdentifier.getter_string (SOURCE_FILE ("instruction-procedure-call.galgas", 359)), GALGAS_objectIR::constructor_null (SOURCE_FILE ("instruction-procedure-call.galgas", 360)), var_routineMangledName_14640, var_routineMangledName_14640, var_calleeKind_13753, var_effectiveParameterListIR_12755  COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 358))  COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 358)) ;
            {
            ioArgument_ioTemporaries.mProperty_mSubprogramInvocationGraph.setter_addEdge (constinArgument_inCallerNameForInvocationGraph, var_routineMangledName_14640 COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 367)) ;
            }
          }
        }
        break ;
      case GALGAS_propertyAccessKind::kEnum_indexed:
        {
          const cEnumAssociatedValues_propertyAccessKind_indexed * extractPtr_17313 = (const cEnumAssociatedValues_propertyAccessKind_indexed *) (var_propertyAccess_12460.unsafePointer ()) ;
          const GALGAS_PLMType extractedValue_propertyType = extractPtr_17313->mAssociatedValue0 ;
          const GALGAS_uint extractedValue_propertyIndex = extractPtr_17313->mAssociatedValue1 ;
          const enumGalgasBool test_20 = extractedValue_propertyType.getter_kind (HERE).getter_isFunction (SOURCE_FILE ("instruction-procedure-call.galgas", 370)).operator_not (SOURCE_FILE ("instruction-procedure-call.galgas", 370)).boolEnum () ;
          if (kBoolTrue == test_20) {
            TC_Array <C_FixItDescription> fixItArray21 ;
            inCompiler->emitSemanticError (extractedValue_methodName.getter_location (SOURCE_FILE ("instruction-procedure-call.galgas", 371)), GALGAS_string ("an indexed property cannot be used as method"), fixItArray21  COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 371)) ;
          }else if (kBoolFalse == test_20) {
            GALGAS_routineDescriptor var_descriptor_15476 ;
            extractedValue_propertyType.getter_kind (HERE).method_function (var_descriptor_15476, inCompiler COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 373)) ;
            const enumGalgasBool test_22 = GALGAS_bool (kIsNotEqual, var_descriptor_15476.getter_returnTypeProxy (HERE).objectCompare (GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("instruction-procedure-call.galgas", 375)))).boolEnum () ;
            if (kBoolTrue == test_22) {
              TC_Array <C_FixItDescription> fixItArray23 ;
              inCompiler->emitSemanticError (extractedValue_methodName.getter_location (SOURCE_FILE ("instruction-procedure-call.galgas", 376)), GALGAS_string ("a function returns a value and cannot be called as a procedure"), fixItArray23  COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 376)) ;
            }else if (kBoolFalse == test_22) {
              GALGAS_procCallEffectiveParameterListIR var_effectiveParameterListIR_16027 = GALGAS_procCallEffectiveParameterListIR::constructor_emptyList (SOURCE_FILE ("instruction-procedure-call.galgas", 386)) ;
              {
              routine_analyzeEffectiveParameters (constinArgument_inSelfType, var_descriptor_15476.getter_signature (HERE), object->mProperty_mArguments, extractedValue_methodName.getter_location (HERE), constinArgument_inCallerNameForInvocationGraph, constinArgument_inContext, constinArgument_inCurrentMode, ioArgument_ioTemporaries, ioArgument_ioGlobalLiteralStringMap, ioArgument_ioUniversalMap, ioArgument_ioAllocaList, ioArgument_ioInstructionGenerationList, var_effectiveParameterListIR_16027, inCompiler  COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 387)) ;
              }
              GALGAS_string var_property_5F_llvmName_16754 ;
              {
              extensionSetter_newTempLLVMVar (ioArgument_ioTemporaries, var_property_5F_llvmName_16754, inCompiler COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 403)) ;
              }
              {
              extensionSetter_appendGetUniversalPropertyReference (ioArgument_ioInstructionGenerationList, var_currentType_8960, var_currentLLVMAddressVar_8992, var_property_5F_llvmName_16754, extractedValue_propertyIndex, extractedValue_methodName.getter_string (SOURCE_FILE ("instruction-procedure-call.galgas", 409)), inCompiler COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 404)) ;
              }
              ioArgument_ioInstructionGenerationList.addAssign_operation (GALGAS_indirectRoutineCallIR::constructor_new (GALGAS_objectIR::constructor_reference (extractedValue_propertyType, var_property_5F_llvmName_16754  COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 413)), extractedValue_propertyType, GALGAS_objectIR::constructor_null (SOURCE_FILE ("instruction-procedure-call.galgas", 415)), var_effectiveParameterListIR_16027  COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 412))  COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 412)) ;
            }
          }
        }
        break ;
...
void routine_analyzeControlRegisterInLValue (const GALGAS_PLMType constinArgument_inSelfType,
  ...
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, constinArgument_inAccessList.getter_length (SOURCE_FILE ("lvalue.galgas", 235)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    TC_Array <C_FixItDescription> fixItArray1 ;
    inCompiler->emitSemanticError (constinArgument_inRegisterGroupName.getter_location (SOURCE_FILE ("lvalue.galgas", 236)), GALGAS_string ("a control register group has no value"), fixItArray1  COMMA_SOURCE_FILE ("lvalue.galgas", 236)) ;
    outArgument_outInternalRepresentation.drop () ; // Release error dropped variable
  }else if (kBoolFalse == test_0) {
    GALGAS_accessInAssignmentListAST var_accessList_9905 = constinArgument_inAccessList ;
    GALGAS_accessInAssignmentAST var_registerNameAsField_9972 ;
    {
    var_accessList_9905.setter_popFirst (var_registerNameAsField_9972, inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 239)) ;
    }
    const enumGalgasBool test_2 = var_registerNameAsField_9972.getter_isProperty (SOURCE_FILE ("lvalue.galgas", 240)).operator_not (SOURCE_FILE ("lvalue.galgas", 240)).boolEnum () ;
    if (kBoolTrue == test_2) {
      TC_Array <C_FixItDescription> fixItArray3 ;
      inCompiler->emitSemanticError (constinArgument_inRegisterGroupName.getter_location (SOURCE_FILE ("lvalue.galgas", 241)), GALGAS_string ("the control register group should be followed by a control register name"), fixItArray3  COMMA_SOURCE_FILE ("lvalue.galgas", 241)) ;
      outArgument_outInternalRepresentation.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_2) {
      GALGAS_lstring var_controlRegisterName_10246 ;
      var_registerNameAsField_9972.method_property (var_controlRegisterName_10246, inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 245)) ;
      GALGAS_PLMType var_inRegisterType_10351 ;
      GALGAS_bool var_mIsReadOnly_10389 ;
      GALGAS_sliceMap var_inRegisterSliceMap_10438 ;
      GALGAS_controlRegisterFieldMap var_mRegisterFieldMap_10501 ;
      GALGAS_bigint var_inRegisterAddress_10540 ;
      GALGAS_controlRegisterFieldList var_mControlRegisterFieldList_10612 ;
      GALGAS_uint var_mRegisterBitCount_10677 ;
      GALGAS_uint var_inRegisterArraySize_10716 ;
      GALGAS_uint var_inRegisterElementSize_10777 ;
      constinArgument_inControlRegisterMap.method_searchKey (var_controlRegisterName_10246, var_inRegisterType_10351, var_mIsReadOnly_10389, var_inRegisterSliceMap_10438, var_mRegisterFieldMap_10501, var_inRegisterAddress_10540, var_mControlRegisterFieldList_10612, var_mRegisterBitCount_10677, var_inRegisterArraySize_10716, var_inRegisterElementSize_10777, inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 246)) ;
      const enumGalgasBool test_4 = GALGAS_bool (kIsEqual, var_accessList_9905.getter_length (SOURCE_FILE ("lvalue.galgas", 258)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_4) {
        const enumGalgasBool test_5 = GALGAS_bool (kIsEqual, var_inRegisterArraySize_10716.objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
        if (kBoolTrue == test_5) {
          outArgument_outInternalRepresentation = GALGAS_LValueRepresentation::constructor_volatileAbsoluteReference (var_inRegisterType_10351, var_inRegisterAddress_10540.getter_uint (inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 260))  COMMA_SOURCE_FILE ("lvalue.galgas", 260)) ;
        }else if (kBoolFalse == test_5) {
          TC_Array <C_FixItDescription> fixItArray6 ;
          inCompiler->emitSemanticError (var_controlRegisterName_10246.getter_location (SOURCE_FILE ("lvalue.galgas", 262)), GALGAS_string ("the control register is an array"), fixItArray6  COMMA_SOURCE_FILE ("lvalue.galgas", 262)) ;
          outArgument_outInternalRepresentation.drop () ; // Release error dropped variable
        }
      }else if (kBoolFalse == test_4) {
        const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, var_accessList_9905.getter_length (SOURCE_FILE ("lvalue.galgas", 264)).objectCompare (GALGAS_uint ((uint32_t) 1U))).boolEnum () ;
        if (kBoolTrue == test_7) {
          GALGAS_accessInAssignmentAST var_access_11306 ;
          var_accessList_9905.method_first (var_access_11306, inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 265)) ;
          switch (var_access_11306.enumValue ()) {
          case GALGAS_accessInAssignmentAST::kNotBuilt:
            break ;
          case GALGAS_accessInAssignmentAST::kEnum_property:
            {
              const cEnumAssociatedValues_accessInAssignmentAST_property * extractPtr_11491 = (const cEnumAssociatedValues_accessInAssignmentAST_property *) (var_access_11306.unsafePointer ()) ;
              const GALGAS_lstring extractedValue_propertyName = extractPtr_11491->mAssociatedValue0 ;
              TC_Array <C_FixItDescription> fixItArray8 ;
              inCompiler->emitSemanticError (extractedValue_propertyName.getter_location (SOURCE_FILE ("lvalue.galgas", 268)), GALGAS_string ("writing a slice of a control register is not allowed"), fixItArray8  COMMA_SOURCE_FILE ("lvalue.galgas", 268)) ;
              outArgument_outInternalRepresentation.drop () ; // Release error dropped variable
            }
            break ;
          case GALGAS_accessInAssignmentAST::kEnum_arrayAccess:
            {
              const cEnumAssociatedValues_accessInAssignmentAST_arrayAccess * extractPtr_12974 = (const cEnumAssociatedValues_accessInAssignmentAST_arrayAccess *) (var_access_11306.unsafePointer ()) ;
              const GALGAS_expressionAST extractedValue_indexExpression = extractPtr_12974->mAssociatedValue0 ;
              const GALGAS_location extractedValue_endOfIndex = extractPtr_12974->mAssociatedValue1 ;
              GALGAS_objectIR var_indexIR_12209 ;
              {
              routine_handleArraySubscriptNew (constinArgument_inSelfType, constinArgument_inRoutineAttributes, constinArgument_inCallerNameForInvocationGraph, constinArgument_inContext, constinArgument_inMode, ioArgument_ioTemporaries, ioArgument_ioGlobalLiteralStringMap, ioArgument_ioUniversalMap, ioArgument_ioAllocaList, extractedValue_indexExpression, extractedValue_endOfIndex, var_inRegisterArraySize_10716.getter_bigint (SOURCE_FILE ("lvalue.galgas", 282)), var_inRegisterType_10351, ioArgument_ioInstructionGenerationList, var_indexIR_12209, inCompiler  COMMA_SOURCE_FILE ("lvalue.galgas", 270)) ;
              }
              const enumGalgasBool test_9 = var_indexIR_12209.getter_isLiteralInteger (SOURCE_FILE ("lvalue.galgas", 287)).boolEnum () ;
              if (kBoolTrue == test_9) {
                GALGAS_bigint var_idx_12365 ;
                GALGAS_PLMType joker_12340_1 ; // Joker input parameter
                var_indexIR_12209.method_literalInteger (joker_12340_1, var_idx_12365, inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 288)) ;
                GALGAS_bigint var_addr_12388 = var_inRegisterAddress_10540.add_operation (var_idx_12365.multiply_operation (var_inRegisterElementSize_10777.getter_bigint (SOURCE_FILE ("lvalue.galgas", 289)), inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 289)), inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 289)) ;
                outArgument_outInternalRepresentation = GALGAS_LValueRepresentation::constructor_volatileAbsoluteReference (var_inRegisterType_10351, var_addr_12388.getter_uint (inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 290))  COMMA_SOURCE_FILE ("lvalue.galgas", 290)) ;
              }else if (kBoolFalse == test_9) {
                GALGAS_string var_llvmName_12622 ;
                {
                extensionSetter_newTempLLVMVar (ioArgument_ioTemporaries, var_llvmName_12622, inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 292)) ;
                }
                {
                extensionSetter_appendComputeSubscriptedVolatileRegisterAddress (ioArgument_ioInstructionGenerationList, var_llvmName_12622, var_indexIR_12209, var_inRegisterAddress_10540, var_inRegisterElementSize_10777, inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 293)) ;
                }
                outArgument_outInternalRepresentation = GALGAS_LValueRepresentation::constructor_volatileIndirectReference (var_inRegisterType_10351, var_llvmName_12622  COMMA_SOURCE_FILE ("lvalue.galgas", 299)) ;
              }
            }
            break ;
          }
          ...
          TC_Array <C_FixItDescription> fixItArray10 ;
          inCompiler->emitSemanticError (var_controlRegisterName_10246.getter_location (SOURCE_FILE ("lvalue.galgas", 303)), GALGAS_string ("only subscripting is allowed in control register assignment"), fixItArray10  COMMA_SOURCE_FILE ("lvalue.galgas", 303)) ;
          outArgument_outInternalRepresentation.drop () ; // Release error dropped variable
        }
      }
    }
...
void routine_analyzeControlRegisterInLValueEX (const GALGAS_PLMType constinArgument_inSelfType,
                                               const GALGAS_routineAttributes constinArgument_inRoutineAttributes,
                                               const GALGAS_lstring constinArgument_inCallerNameForInvocationGraph,
                                               const GALGAS_semanticContext constinArgument_inContext,
                                               const GALGAS_mode constinArgument_inMode,
                                               ...
                                               COMMA_UNUSED_LOCATION_ARGS) {
  outArgument_outInternalRepresentation.drop () ; // Release 'out' argument
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, constinArgument_inAccessList.getter_length (SOURCE_FILE ("lvalue.galgas", 331)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_1) {
      outArgument_outInternalRepresentation = GALGAS_LValueRepresentation::constructor_volatileAbsoluteReference (constinArgument_inRegisterType, constinArgument_inRegisterAddress  COMMA_SOURCE_FILE ("lvalue.galgas", 333)) ;
    }else if (kBoolFalse == test_1) {
      TC_Array <C_FixItDescription> fixItArray2 ;
      inCompiler->emitSemanticError (constinArgument_inRegisterName.getter_location (SOURCE_FILE ("lvalue.galgas", 335)), GALGAS_string ("the control register is an array"), fixItArray2  COMMA_SOURCE_FILE ("lvalue.galgas", 335)) ;
      outArgument_outInternalRepresentation.drop () ; // Release error dropped variable
    }
  }else if (kBoolFalse == test_0) {
    const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, constinArgument_inAccessList.getter_length (SOURCE_FILE ("lvalue.galgas", 337)).objectCompare (GALGAS_uint ((uint32_t) 1U))).boolEnum () ;
    if (kBoolTrue == test_3) {
      GALGAS_accessInAssignmentAST var_access_14627 ;
      constinArgument_inAccessList.method_first (var_access_14627, inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 338)) ;
      switch (var_access_14627.enumValue ()) {
      case GALGAS_accessInAssignmentAST::kNotBuilt:
        break ;
      case GALGAS_accessInAssignmentAST::kEnum_property:
        {
          const cEnumAssociatedValues_accessInAssignmentAST_property * extractPtr_14797 = (const cEnumAssociatedValues_accessInAssignmentAST_property *) (var_access_14627.unsafePointer ()) ;
          const GALGAS_lstring extractedValue_propertyName = extractPtr_14797->mAssociatedValue0 ;
          TC_Array <C_FixItDescription> fixItArray4 ;
          inCompiler->emitSemanticError (extractedValue_propertyName.getter_location (SOURCE_FILE ("lvalue.galgas", 341)), GALGAS_string ("writing a slice of a control register is not allowed"), fixItArray4  COMMA_SOURCE_FILE ("lvalue.galgas", 341)) ;
          outArgument_outInternalRepresentation.drop () ; // Release error dropped variable
        }
        break ;
      case GALGAS_accessInAssignmentAST::kEnum_arrayAccess:
        {
          const cEnumAssociatedValues_accessInAssignmentAST_arrayAccess * extractPtr_16096 = (const cEnumAssociatedValues_accessInAssignmentAST_arrayAccess *) (var_access_14627.unsafePointer ()) ;
          const GALGAS_expressionAST extractedValue_indexExpression = extractPtr_16096->mAssociatedValue0 ;
          const GALGAS_location extractedValue_endOfIndex = extractPtr_16096->mAssociatedValue1 ;
          GALGAS_objectIR var_indexIR_15422 ;
          {
          routine_handleArraySubscriptNew (constinArgument_inSelfType, constinArgument_inRoutineAttributes, constinArgument_inCallerNameForInvocationGraph, constinArgument_inContext, constinArgument_inMode, ioArgument_ioTemporaries, ioArgument_ioGlobalLiteralStringMap, ioArgument_ioUniversalMap, ioArgument_ioAllocaList, extractedValue_indexExpression, extractedValue_endOfIndex, constinArgument_inArraySize.getter_bigint (SOURCE_FILE ("lvalue.galgas", 355)), constinArgument_inRegisterType, ioArgument_ioInstructionGenerationList, var_indexIR_15422, inCompiler  COMMA_SOURCE_FILE ("lvalue.galgas", 343)) ;
          }
          const enumGalgasBool test_5 = var_indexIR_15422.getter_isLiteralInteger (SOURCE_FILE ("lvalue.galgas", 360)).boolEnum () ;
          if (kBoolTrue == test_5) {
            GALGAS_bigint var_idx_15563 ;
            GALGAS_PLMType joker_15538_1 ; // Joker input parameter
            var_indexIR_15422.method_literalInteger (joker_15538_1, var_idx_15563, inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 361)) ;
            GALGAS_uint var_addr_15581 = constinArgument_inRegisterAddress.add_operation (var_idx_15563.multiply_operation (constinArgument_inElementSize.getter_bigint (SOURCE_FILE ("lvalue.galgas", 362)), inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 362)).getter_uint (inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 362)), inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 362)) ;
            outArgument_outInternalRepresentation = GALGAS_LValueRepresentation::constructor_volatileAbsoluteReference (constinArgument_inRegisterType, var_addr_15581  COMMA_SOURCE_FILE ("lvalue.galgas", 363)) ;
          }else if (kBoolFalse == test_5) {
            GALGAS_string var_llvmName_15792 ;
            {
            extensionSetter_newTempLLVMVar (ioArgument_ioTemporaries, var_llvmName_15792, inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 365)) ;
            }
            {
            extensionSetter_appendComputeSubscriptedVolatileRegisterAddress (ioArgument_ioInstructionGenerationList, var_llvmName_15792, var_indexIR_15422, constinArgument_inRegisterAddress.getter_bigint (SOURCE_FILE ("lvalue.galgas", 369)), constinArgument_inElementSize, inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 366)) ;
            }
            outArgument_outInternalRepresentation = GALGAS_LValueRepresentation::constructor_volatileIndirectReference (constinArgument_inRegisterType, var_llvmName_15792  COMMA_SOURCE_FILE ("lvalue.galgas", 372)) ;
          }
        }
        break ;
      }
      ...
      TC_Array <C_FixItDescription> fixItArray6 ;
      inCompiler->emitSemanticError (constinArgument_inRegisterName.getter_location (SOURCE_FILE ("lvalue.galgas", 376)), GALGAS_string ("only subscripting is allowed in control register assignment"), fixItArray6  COMMA_SOURCE_FILE ("lvalue.galgas", 376)) ;
      outArgument_outInternalRepresentation.drop () ; // Release error dropped variable
    }
  }
}
...
void routine_analyzeVariableInLValue (const GALGAS_PLMType constinArgument_inSelfType,
                                      ...
                                      COMMA_UNUSED_LOCATION_ARGS) {
  outArgument_outInternalRepresentation.drop () ; // Release 'out' argument
  GALGAS_PLMType var_currentType_17159 = constinArgument_inVariableType ;
  GALGAS_string var_currentLLVMName_17198 = constinArgument_inLLVMName ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, constinArgument_inAccessList.getter_length (SOURCE_FILE ("lvalue.galgas", 401)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    {
    GALGAS_objectIR joker_17321 ; // Joker input parameter
    extensionSetter_searchValuedObjectForWriteAccess (ioArgument_ioUniversalMap, constinArgument_inVariableName, joker_17321, inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 402)) ;
    }
  }else if (kBoolFalse == test_0) {
    {
    GALGAS_objectIR joker_17407 ; // Joker input parameter
    extensionSetter_searchValuedObjectForReadWriteAccess (ioArgument_ioUniversalMap, constinArgument_inVariableName, joker_17407, inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 404)) ;
    }
    cEnumerator_accessInAssignmentListAST enumerator_17442 (constinArgument_inAccessList, kENUMERATION_UP) ;
    while (enumerator_17442.hasCurrentObject ()) {
      switch (enumerator_17442.current_mAccess (HERE).enumValue ()) {
      case GALGAS_accessInAssignmentAST::kNotBuilt:
        break ;
      case GALGAS_accessInAssignmentAST::kEnum_property:
        {
          const cEnumAssociatedValues_accessInAssignmentAST_property * extractPtr_18392 = (const cEnumAssociatedValues_accessInAssignmentAST_property *) (enumerator_17442.current_mAccess (HERE).unsafePointer ()) ;
          const GALGAS_lstring extractedValue_propertyName = extractPtr_18392->mAssociatedValue0 ;
          GALGAS_propertyMap var_propertyMap_17548 = var_currentType_17159.getter_propertyMap (HERE) ;
          GALGAS_propertyAccessKind var_propertyAccess_17662 ;
          GALGAS_bool joker_17621 ; // Joker input parameter
          var_propertyMap_17548.method_searchKey (extractedValue_propertyName, joker_17621, var_propertyAccess_17662, inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 409)) ;
          switch (var_propertyAccess_17662.enumValue ()) {
          case GALGAS_propertyAccessKind::kNotBuilt:
            break ;
          case GALGAS_propertyAccessKind::kEnum_nonVirtualMethod:
            {
              TC_Array <C_FixItDescription> fixItArray1 ;
              inCompiler->emitSemanticError (extractedValue_propertyName.getter_location (SOURCE_FILE ("lvalue.galgas", 412)), GALGAS_string ("a method cannot be written"), fixItArray1  COMMA_SOURCE_FILE ("lvalue.galgas", 412)) ;
              var_currentType_17159.drop () ; // Release error dropped variable
              var_currentLLVMName_17198.drop () ; // Release error dropped variable
            }
            break ;
          case GALGAS_propertyAccessKind::kEnum_constantProperty:
            {
              TC_Array <C_FixItDescription> fixItArray2 ;
              inCompiler->emitSemanticError (extractedValue_propertyName.getter_location (SOURCE_FILE ("lvalue.galgas", 414)), GALGAS_string ("a constant property cannot be written"), fixItArray2  COMMA_SOURCE_FILE ("lvalue.galgas", 414)) ;
              var_currentType_17159.drop () ; // Release error dropped variable
              var_currentLLVMName_17198.drop () ; // Release error dropped variable
            }
            break ;
          case GALGAS_propertyAccessKind::kEnum_indexed:
            {
              const cEnumAssociatedValues_propertyAccessKind_indexed * extractPtr_18380 = (const cEnumAssociatedValues_propertyAccessKind_indexed *) (var_propertyAccess_17662.unsafePointer ()) ;
              const GALGAS_PLMType extractedValue_propertyType = extractPtr_18380->mAssociatedValue0 ;
              const GALGAS_uint extractedValue_index = extractPtr_18380->mAssociatedValue1 ;
              GALGAS_string var_newLLVMvariable_18081 ;
              {
              extensionSetter_newTempLLVMVar (ioArgument_ioTemporaries, var_newLLVMvariable_18081, inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 416)) ;
              }
              {
              extensionSetter_appendGetUniversalPropertyReference (ioArgument_ioInstructionGenerationList, var_currentType_17159, var_currentLLVMName_17198, var_newLLVMvariable_18081, extractedValue_index, extractedValue_propertyName.getter_string (SOURCE_FILE ("lvalue.galgas", 422)), inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 417)) ;
              }
              var_currentType_17159 = extractedValue_propertyType ;
              var_currentLLVMName_17198 = var_newLLVMvariable_18081 ;
            }
            break ;
          }
        }
      ...
      case GALGAS_accessInAssignmentAST::kEnum_arrayAccess:
        {
          const cEnumAssociatedValues_accessInAssignmentAST_arrayAccess * extractPtr_19721 = (const cEnumAssociatedValues_accessInAssignmentAST_arrayAccess *) (enumerator_17442.current_mAccess (HERE).unsafePointer ()) ;
          const GALGAS_expressionAST extractedValue_indexExpression = extractPtr_19721->mAssociatedValue0 ;
          const GALGAS_location extractedValue_endOfIndex = extractPtr_19721->mAssociatedValue1 ;
          const enumGalgasBool test_3 = var_currentType_17159.getter_kind (HERE).getter_isArrayType (SOURCE_FILE ("lvalue.galgas", 428)).boolEnum () ;
          if (kBoolTrue == test_3) {
            GALGAS_PLMType var_elementType_18585 ;
            GALGAS_bigint var_arraySize_18613 ;
            var_currentType_17159.getter_kind (HERE).method_arrayType (var_elementType_18585, var_arraySize_18613, inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 429)) ;
            GALGAS_objectIR var_indexIR_19236 ;
            {
            routine_handleArraySubscriptNew (constinArgument_inSelfType, constinArgument_inRoutineAttributes, constinArgument_inCallerNameForInvocationGraph, constinArgument_inContext, constinArgument_inMode, ioArgument_ioTemporaries, ioArgument_ioGlobalLiteralStringMap, ioArgument_ioUniversalMap, ioArgument_ioAllocaList, extractedValue_indexExpression, extractedValue_endOfIndex, var_arraySize_18613, var_elementType_18585, ioArgument_ioInstructionGenerationList, var_indexIR_19236, inCompiler  COMMA_SOURCE_FILE ("lvalue.galgas", 430)) ;
            }
            GALGAS_string var_newLLVMvariable_19309 ;
            {
            extensionSetter_newTempLLVMVar (ioArgument_ioTemporaries, var_newLLVMvariable_19309, inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 447)) ;
            }
            {
            extensionSetter_appendGetUniversalArrayElementReference (ioArgument_ioInstructionGenerationList, var_currentType_17159, var_currentLLVMName_17198, var_elementType_18585, var_newLLVMvariable_19309, var_indexIR_19236, inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 448)) ;
            }
            var_currentType_17159 = var_elementType_18585 ;
            var_currentLLVMName_17198 = var_newLLVMvariable_19309 ;
          }else if (kBoolFalse == test_3) {
            TC_Array <C_FixItDescription> fixItArray4 ;
            inCompiler->emitSemanticError (extractedValue_endOfIndex, GALGAS_string ("cannot subscript, not an array"), fixItArray4  COMMA_SOURCE_FILE ("lvalue.galgas", 458)) ;
            var_currentType_17159.drop () ; // Release error dropped variable
            var_currentLLVMName_17198.drop () ; // Release error dropped variable
          }
        }
  ...
  outArgument_outInternalRepresentation = GALGAS_LValueRepresentation::constructor_universalReference (var_currentType_17159, var_currentLLVMName_17198  COMMA_SOURCE_FILE ("lvalue.galgas", 463)) ;
}
...
void routine_analyzeSelfAssignmentTarget (const GALGAS_PLMType constinArgument_inSelfType,
                                          ...
                                          COMMA_UNUSED_LOCATION_ARGS) {
  outArgument_outInternalRepresentation.drop () ; // Release 'out' argument
  const enumGalgasBool test_0 = constinArgument_inSelfType.getter_kind (HERE).getter_isStructure (SOURCE_FILE ("lvalue.galgas", 483)).operator_not (SOURCE_FILE ("lvalue.galgas", 483)).boolEnum () ;
  if (kBoolTrue == test_0) {
    TC_Array <C_FixItDescription> fixItArray1 ;
    inCompiler->emitSemanticError (constinArgument_inSelfLocation, GALGAS_string ("'self' should be a structure instance"), fixItArray1  COMMA_SOURCE_FILE ("lvalue.galgas", 484)) ;
    outArgument_outInternalRepresentation.drop () ; // Release error dropped variable
  }else if (kBoolFalse == test_0) {
    GALGAS_PLMType var_currentType_20825 = constinArgument_inSelfType ;
    GALGAS_string var_currentLLVMName_20862 = function_llvmNameForSelf (inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 487)) ;
    cEnumerator_accessInAssignmentListAST enumerator_20916 (constinArgument_inAccessList, kENUMERATION_UP) ;
    while (enumerator_20916.hasCurrentObject ()) {
      switch (enumerator_20916.current_mAccess (HERE).enumValue ()) {
      case GALGAS_accessInAssignmentAST::kNotBuilt:
        break ;
      case GALGAS_accessInAssignmentAST::kEnum_property:
        {
          const cEnumAssociatedValues_accessInAssignmentAST_property * extractPtr_21866 = (const cEnumAssociatedValues_accessInAssignmentAST_property *) (enumerator_20916.current_mAccess (HERE).unsafePointer ()) ;
          const GALGAS_lstring extractedValue_propertyName = extractPtr_21866->mAssociatedValue0 ;
          GALGAS_propertyMap var_propertyMap_21022 = var_currentType_20825.getter_propertyMap (HERE) ;
          GALGAS_propertyAccessKind var_propertyAccess_21136 ;
          GALGAS_bool joker_21095 ; // Joker input parameter
          var_propertyMap_21022.method_searchKey (extractedValue_propertyName, joker_21095, var_propertyAccess_21136, inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 492)) ;
          switch (var_propertyAccess_21136.enumValue ()) {
          case GALGAS_propertyAccessKind::kNotBuilt:
            break ;
          case GALGAS_propertyAccessKind::kEnum_nonVirtualMethod:
            {
              TC_Array <C_FixItDescription> fixItArray2 ;
              inCompiler->emitSemanticError (extractedValue_propertyName.getter_location (SOURCE_FILE ("lvalue.galgas", 495)), GALGAS_string ("a method cannot be written"), fixItArray2  COMMA_SOURCE_FILE ("lvalue.galgas", 495)) ;
              var_currentType_20825.drop () ; // Release error dropped variable
              var_currentLLVMName_20862.drop () ; // Release error dropped variable
            }
            break ;
          case GALGAS_propertyAccessKind::kEnum_constantProperty:
            {
              TC_Array <C_FixItDescription> fixItArray3 ;
              inCompiler->emitSemanticError (extractedValue_propertyName.getter_location (SOURCE_FILE ("lvalue.galgas", 497)), GALGAS_string ("a constant property cannot be written"), fixItArray3  COMMA_SOURCE_FILE ("lvalue.galgas", 497)) ;
              var_currentType_20825.drop () ; // Release error dropped variable
              var_currentLLVMName_20862.drop () ; // Release error dropped variable
            }
            break ;
          case GALGAS_propertyAccessKind::kEnum_indexed:
            {
              const cEnumAssociatedValues_propertyAccessKind_indexed * extractPtr_21854 = (const cEnumAssociatedValues_propertyAccessKind_indexed *) (var_propertyAccess_21136.unsafePointer ()) ;
              const GALGAS_PLMType extractedValue_propertyType = extractPtr_21854->mAssociatedValue0 ;
              const GALGAS_uint extractedValue_index = extractPtr_21854->mAssociatedValue1 ;
              GALGAS_string var_newLLVMvariable_21555 ;
              {
              extensionSetter_newTempLLVMVar (ioArgument_ioTemporaries, var_newLLVMvariable_21555, inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 499)) ;
              }
              {
              extensionSetter_appendGetUniversalPropertyReference (ioArgument_ioInstructionGenerationList, var_currentType_20825, var_currentLLVMName_20862, var_newLLVMvariable_21555, extractedValue_index, extractedValue_propertyName.getter_string (SOURCE_FILE ("lvalue.galgas", 505)), inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 500)) ;
              }
              var_currentType_20825 = extractedValue_propertyType ;
              var_currentLLVMName_20862 = var_newLLVMvariable_21555 ;
            }
            break ;
          }
        }
      ...
      case GALGAS_accessInAssignmentAST::kEnum_arrayAccess:
        {
          const cEnumAssociatedValues_accessInAssignmentAST_arrayAccess * extractPtr_23195 = (const cEnumAssociatedValues_accessInAssignmentAST_arrayAccess *) (enumerator_20916.current_mAccess (HERE).unsafePointer ()) ;
          const GALGAS_expressionAST extractedValue_indexExpression = extractPtr_23195->mAssociatedValue0 ;
          const GALGAS_location extractedValue_endOfIndex = extractPtr_23195->mAssociatedValue1 ;
          const enumGalgasBool test_4 = var_currentType_20825.getter_kind (HERE).getter_isArrayType (SOURCE_FILE ("lvalue.galgas", 511)).boolEnum () ;
          if (kBoolTrue == test_4) {
            GALGAS_PLMType var_elementType_22059 ;
            GALGAS_bigint var_arraySize_22087 ;
            var_currentType_20825.getter_kind (HERE).method_arrayType (var_elementType_22059, var_arraySize_22087, inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 512)) ;
            GALGAS_objectIR var_indexIR_22710 ;
            {
            routine_handleArraySubscriptNew (constinArgument_inSelfType, constinArgument_inRoutineAttributes, constinArgument_inCallerNameForInvocationGraph, constinArgument_inContext, constinArgument_inMode, ioArgument_ioTemporaries, ioArgument_ioGlobalLiteralStringMap, ioArgument_ioUniversalMap, ioArgument_ioAllocaList, extractedValue_indexExpression, extractedValue_endOfIndex, var_arraySize_22087, var_elementType_22059, ioArgument_ioInstructionGenerationList, var_indexIR_22710, inCompiler  COMMA_SOURCE_FILE ("lvalue.galgas", 513)) ;
            }
            GALGAS_string var_newLLVMvariable_22783 ;
            {
            extensionSetter_newTempLLVMVar (ioArgument_ioTemporaries, var_newLLVMvariable_22783, inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 530)) ;
            }
            {
            extensionSetter_appendGetUniversalArrayElementReference (ioArgument_ioInstructionGenerationList, var_currentType_20825, var_currentLLVMName_20862, var_elementType_22059, var_newLLVMvariable_22783, var_indexIR_22710, inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 531)) ;
            }
            var_currentType_20825 = var_elementType_22059 ;
            var_currentLLVMName_20862 = var_newLLVMvariable_22783 ;
          }else if (kBoolFalse == test_4) {
            TC_Array <C_FixItDescription> fixItArray5 ;
            inCompiler->emitSemanticError (extractedValue_endOfIndex, GALGAS_string ("cannot subscript, not an array"), fixItArray5  COMMA_SOURCE_FILE ("lvalue.galgas", 541)) ;
            var_currentType_20825.drop () ; // Release error dropped variable
            var_currentLLVMName_20862.drop () ; // Release error dropped variable
          }
        }
      ...
      enumerator_20916.gotoNextObject () ;
    }
    outArgument_outInternalRepresentation = GALGAS_LValueRepresentation::constructor_universalReference (var_currentType_20825, var_currentLLVMName_20862  COMMA_SOURCE_FILE ("lvalue.galgas", 545)) ;
  }
}
...
void routine_buildSemanticContext (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  cEnumerator_declarationListAST enumerator_7608 (constinArgument_inAST.getter_mDeclarationListAST (HERE), kENUMERATION_UP) ;
  while (enumerator_7608.hasCurrentObject ()) {
    ...
    enumerator_7608.gotoNextObject () ;
  }
  {
...
void routine_semanticAnalysis (const GALGAS_string constinArgument_inSourceFile,
  ...
  extensionMethod_externProcedureSemanticAnalysis (constinArgument_inAST.getter_mExternProcListAST (HERE), constinArgument_inSemanticContext, var_temporaries_5081, outArgument_outIntermediateCodeStruct, inCompiler COMMA_SOURCE_FILE ("semantic-analysis.galgas", 137)) ;
  {
  ...
  const enumGalgasBool test_1 = test_0.boolEnum () ;
  if (kBoolTrue == test_1) {
    GALGAS_string var_s_6258 = var_temporaries_5081.getter_mSubprogramInvocationGraph (HERE).getter_graphviz (SOURCE_FILE ("semantic-analysis.galgas", 150)) ;
    GALGAS_string var_filePath_6327 = constinArgument_inSourceFile.getter_stringByDeletingPathExtension (SOURCE_FILE ("semantic-analysis.galgas", 151)).add_operation (GALGAS_string (".routineInvocation.dot"), inCompiler COMMA_SOURCE_FILE ("semantic-analysis.galgas", 151)) ;
    GALGAS_bool joker_6453 ; // Joker input parameter
    var_s_6258.method_writeToFileWhenDifferentContents (var_filePath_6327, joker_6453, inCompiler COMMA_SOURCE_FILE ("semantic-analysis.galgas", 152)) ;
  }
  ...
  const enumGalgasBool test_3 = test_2.boolEnum () ;
  if (kBoolTrue == test_3) {
    GALGAS_stringlist var_undefinedNodeKeyList_6622 = var_temporaries_5081.getter_mSubprogramInvocationGraph (HERE).getter_undefinedNodeKeyList (SOURCE_FILE ("semantic-analysis.galgas", 156)) ;
    const enumGalgasBool test_4 = GALGAS_bool (kIsStrictSup, var_undefinedNodeKeyList_6622.getter_length (SOURCE_FILE ("semantic-analysis.galgas", 157)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_4) {
      GALGAS_string var_s_6746 = GALGAS_string ("subprogram invocation graph error, undefined nodes:") ;
      cEnumerator_stringlist enumerator_6844 (var_undefinedNodeKeyList_6622, kENUMERATION_UP) ;
      while (enumerator_6844.hasCurrentObject ()) {
        var_s_6746.plusAssign_operation(GALGAS_string ("\n"
          " - ").add_operation (enumerator_6844.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("semantic-analysis.galgas", 160)), inCompiler  COMMA_SOURCE_FILE ("semantic-analysis.galgas", 160)) ;
        enumerator_6844.gotoNextObject () ;
      }
      TC_Array <C_FixItDescription> fixItArray5 ;
      inCompiler->emitSemanticError (constinArgument_inEndOfSourceFile, var_s_6746, fixItArray5  COMMA_SOURCE_FILE ("semantic-analysis.galgas", 162)) ;
    }else if (kBoolFalse == test_4) {
      GALGAS_lstringlist var_unsortedInformationList_7051 ;
      GALGAS_lstringlist var_unsortedLKeyList_7095 ;
      var_temporaries_5081.getter_mSubprogramInvocationGraph (HERE).method_circularities (var_unsortedInformationList_7051, var_unsortedLKeyList_7095 COMMA_SOURCE_FILE ("semantic-analysis.galgas", 164)) ;
      const enumGalgasBool test_6 = GALGAS_bool (kIsStrictSup, var_unsortedLKeyList_7095.getter_length (SOURCE_FILE ("semantic-analysis.galgas", 168)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_6) {
        GALGAS_string var_s_7161 = GALGAS_string ("the following routines are recursive:") ;
        cEnumerator_lstringlist enumerator_7241 (var_unsortedLKeyList_7095, kENUMERATION_UP) ;
        while (enumerator_7241.hasCurrentObject ()) {
          var_s_7161.plusAssign_operation(GALGAS_string ("\n"
            " - ").add_operation (enumerator_7241.current_mValue (HERE).getter_string (SOURCE_FILE ("semantic-analysis.galgas", 171)), inCompiler COMMA_SOURCE_FILE ("semantic-analysis.galgas", 171)), inCompiler  COMMA_SOURCE_FILE ("semantic-analysis.galgas", 171)) ;
          enumerator_7241.gotoNextObject () ;
        }
        TC_Array <C_FixItDescription> fixItArray7 ;
        inCompiler->emitSemanticError (constinArgument_inEndOfSourceFile, var_s_7161, fixItArray7  COMMA_SOURCE_FILE ("semantic-analysis.galgas", 173)) ;
      }
    }
  }
}
...
GALGAS_string function_stackNameForTask (const GALGAS_string & constinArgument_inTaskName,
                                         ...
                                         COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_result ; // Returned variable
  result_result = GALGAS_string ("@").add_operation (GALGAS_string ("task.stack.").add_operation (constinArgument_inTaskName, inCompiler COMMA_SOURCE_FILE ("generated-code-prefixes.galgas", 312)).getter_assemblerRepresentation (SOURCE_FILE ("generated-code-prefixes.galgas", 312)), inCompiler COMMA_SOURCE_FILE ("generated-code-prefixes.galgas", 312)) ;
//---
  return result_result ;
}
...
GALGAS_string function_initNameForTaskType (const GALGAS_string & constinArgument_inTaskTypeName,
                                            ...
                                            COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_result ; // Returned variable
  result_result = GALGAS_string ("@").add_operation (GALGAS_string ("task.init.").add_operation (constinArgument_inTaskTypeName, inCompiler COMMA_SOURCE_FILE ("generated-code-prefixes.galgas", 318)).getter_assemblerRepresentation (SOURCE_FILE ("generated-code-prefixes.galgas", 318)), inCompiler COMMA_SOURCE_FILE ("generated-code-prefixes.galgas", 318)) ;
//---
  return result_result ;
}
...
GALGAS_string function_stackAddressForTask (const GALGAS_string & constinArgument_inTaskName,
                                            ...
                                            COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_result ; // Returned variable
  result_result = GALGAS_string ("%").add_operation (GALGAS_string ("task.stack.address.").add_operation (constinArgument_inTaskName, inCompiler COMMA_SOURCE_FILE ("generated-code-prefixes.galgas", 324)).getter_assemblerRepresentation (SOURCE_FILE ("generated-code-prefixes.galgas", 324)), inCompiler COMMA_SOURCE_FILE ("generated-code-prefixes.galgas", 324)) ;
//---
  return result_result ;
}
...
GALGAS_string function_mainRoutineNameForTask (const GALGAS_string & constinArgument_inTaskName,
                                               ...
                                               COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_result ; // Returned variable
  result_result = GALGAS_string ("@").add_operation (GALGAS_string ("task.main.").add_operation (constinArgument_inTaskName, inCompiler COMMA_SOURCE_FILE ("generated-code-prefixes.galgas", 330)).getter_assemblerRepresentation (SOURCE_FILE ("generated-code-prefixes.galgas", 330)), inCompiler COMMA_SOURCE_FILE ("generated-code-prefixes.galgas", 330)) ;
//---
  return result_result ;
}
...
GALGAS_lstring function_plmNameForStaticListType (const GALGAS_lstring & constinArgument_inStaticListName,
                                                  ...
                                                  COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_lstring result_result ; // Returned variable
  result_result = GALGAS_lstring::constructor_new (GALGAS_string ("staticlist.").add_operation (constinArgument_inStaticListName.getter_string (SOURCE_FILE ("generated-code-prefixes.galgas", 349)), inCompiler COMMA_SOURCE_FILE ("generated-code-prefixes.galgas", 349)), constinArgument_inStaticListName.getter_location (SOURCE_FILE ("generated-code-prefixes.galgas", 349))  COMMA_SOURCE_FILE ("generated-code-prefixes.galgas", 349)) ;
//---
  return result_result ;
}
...
GALGAS_lstring function_llvmNameForStaticListElementType (const GALGAS_lstring & constinArgument_inStaticListName,
                                                          ...
                                                          COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_lstring result_result ; // Returned variable
  result_result = GALGAS_lstring::constructor_new (GALGAS_string ("static.list.element.type.").add_operation (constinArgument_inStaticListName.getter_string (HERE).getter_assemblerRepresentation (SOURCE_FILE ("generated-code-prefixes.galgas", 361)), inCompiler COMMA_SOURCE_FILE ("generated-code-prefixes.galgas", 361)), constinArgument_inStaticListName.getter_location (HERE)  COMMA_SOURCE_FILE ("generated-code-prefixes.galgas", 361)) ;
//---
  return result_result ;
}
