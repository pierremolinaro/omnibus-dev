...
static void extensionMethod_addressofExpressionAST_noteExpressionTypesInPrecedenceGraph (const cPtr_expressionAST * inObject,
  ...
  extensionMethod_noteInstructionTypesInPrecedenceGraph (object->mProperty_mLValue, ioArgument_ioGraph, inCompiler COMMA_SOURCE_FILE ("expression-addressof.galgas", 72)) ;
}
...
static void extensionMethod_addressofExpressionAST_analyzeExpression (const cPtr_expressionAST * inObject,
  ...
  const cPtr_addressofExpressionAST * object = (const cPtr_addressofExpressionAST *) inObject ;
  macroValidSharedObject (object, cPtr_addressofExpressionAST) ;
  const enumGalgasBool test_0 = constinArgument_inRoutineAttributes.getter_guard (SOURCE_FILE ("expression-addressof.galgas", 219)).boolEnum () ;
  if (kBoolTrue == test_0) {
    TC_Array <C_FixItDescription> fixItArray1 ;
    inCompiler->emitSemanticError (object->mProperty_mLValue.getter_mIdentifier (HERE).getter_location (SOURCE_FILE ("expression-addressof.galgas", 220)), GALGAS_string ("addressof () cannot be used in guard"), fixItArray1  COMMA_SOURCE_FILE ("expression-addressof.galgas", 220)) ;
    outArgument_outResult.drop () ; // Release error dropped variable
  }else if (kBoolFalse == test_0) {
    GALGAS_LValueRepresentation var_lvalueIR_10353 ;
    extensionMethod_analyzeLValue (object->mProperty_mLValue, constinArgument_inSelfType, GALGAS_bool (true), constinArgument_inRoutineAttributes, constinArgument_inCallerNameForInvocationGraph, constinArgument_inContext, constinArgument_inCurrentMode, ioArgument_ioTemporaries, ioArgument_ioStaticEntityMap, ioArgument_ioUniversalMap, ioArgument_ioAllocaList, ioArgument_ioInstructionGenerationList, var_lvalueIR_10353, inCompiler COMMA_SOURCE_FILE ("expression-addressof.galgas", 223)) ;
    GALGAS_unifiedTypeMap_2D_proxy var_resultTypeProxy_10383 = GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inContext.getter_mTypeMap (HERE), GALGAS_string ("uint").add_operation (constinArgument_inContext.getter_mTargetParameters (HERE).getter_mPointerSize (HERE).getter_string (SOURCE_FILE ("expression-addressof.galgas", 239)), inCompiler COMMA_SOURCE_FILE ("expression-addressof.galgas", 239)).getter_nowhere (SOURCE_FILE ("expression-addressof.galgas", 239)), inCompiler  COMMA_SOURCE_FILE ("expression-addressof.galgas", 237)) ;
    GALGAS_PLMType var_resultType_10546 = var_resultTypeProxy_10383.getter_type (inCompiler COMMA_SOURCE_FILE ("expression-addressof.galgas", 241)) ;
    {
    routine_getNewTempValue (var_resultType_10546, ioArgument_ioTemporaries, outArgument_outResult, inCompiler  COMMA_SOURCE_FILE ("expression-addressof.galgas", 242)) ;
    }
    ioArgument_ioInstructionGenerationList.addAssign_operation (GALGAS_addressofInstructionIR::constructor_new (outArgument_outResult, var_lvalueIR_10353  COMMA_SOURCE_FILE ("expression-addressof.galgas", 243))  COMMA_SOURCE_FILE ("expression-addressof.galgas", 243)) ;
  }
}
...
static void extensionMethod_addressofInstructionIR_llvmInstructionCode (const cPtr_abstractInstructionIR * inObject,
  ...
  case GALGAS_LValueRepresentation::kEnum_volatileAbsoluteReference:
    {
      const cEnumAssociatedValues_LValueRepresentation_volatileAbsoluteReference * extractPtr_11918 = (const cEnumAssociatedValues_LValueRepresentation_volatileAbsoluteReference *) (object->mProperty_mLValue.unsafePointer ()) ;
      const GALGAS_PLMType extractedValue_type = extractPtr_11918->mAssociatedValue0 ;
      const GALGAS_uint extractedValue_address = extractPtr_11918->mAssociatedValue1 ;
      ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  ").add_operation (extensionGetter_llvmName (object->mProperty_mTarget, inCompiler COMMA_SOURCE_FILE ("expression-addressof.galgas", 270)), inCompiler COMMA_SOURCE_FILE ("expression-addressof.galgas", 270)).add_operation (GALGAS_string (" = add "), inCompiler COMMA_SOURCE_FILE ("expression-addressof.galgas", 270)).add_operation (extensionGetter_llvmTypeName (extractedValue_type, inCompiler COMMA_SOURCE_FILE ("expression-addressof.galgas", 270)), inCompiler COMMA_SOURCE_FILE ("expression-addressof.galgas", 270)).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("expression-addressof.galgas", 270)).add_operation (extractedValue_address.getter_string (SOURCE_FILE ("expression-addressof.galgas", 270)), inCompiler COMMA_SOURCE_FILE ("expression-addressof.galgas", 270)).add_operation (GALGAS_string (", 0 ; addressof ("), inCompiler COMMA_SOURCE_FILE ("expression-addressof.galgas", 270)).add_operation (extractedValue_address.getter_hexString (SOURCE_FILE ("expression-addressof.galgas", 271)), inCompiler COMMA_SOURCE_FILE ("expression-addressof.galgas", 271)).add_operation (GALGAS_string (")\n"), inCompiler COMMA_SOURCE_FILE ("expression-addressof.galgas", 271)), inCompiler  COMMA_SOURCE_FILE ("expression-addressof.galgas", 270)) ;
    }
    break ;
  case GALGAS_LValueRepresentation::kEnum_volatileIndirectReference:
    {
      const cEnumAssociatedValues_LValueRepresentation_volatileIndirectReference * extractPtr_12138 = (const cEnumAssociatedValues_LValueRepresentation_volatileIndirectReference *) (object->mProperty_mLValue.unsafePointer ()) ;
      const GALGAS_PLMType extractedValue_type = extractPtr_12138->mAssociatedValue0 ;
      const GALGAS_string extractedValue_llvmName = extractPtr_12138->mAssociatedValue1 ;
      ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  ").add_operation (extensionGetter_llvmName (object->mProperty_mTarget, inCompiler COMMA_SOURCE_FILE ("expression-addressof.galgas", 273)), inCompiler COMMA_SOURCE_FILE ("expression-addressof.galgas", 273)).add_operation (GALGAS_string (" = add "), inCompiler COMMA_SOURCE_FILE ("expression-addressof.galgas", 273)).add_operation (extensionGetter_llvmTypeName (extractedValue_type, inCompiler COMMA_SOURCE_FILE ("expression-addressof.galgas", 273)), inCompiler COMMA_SOURCE_FILE ("expression-addressof.galgas", 273)).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("expression-addressof.galgas", 273)).add_operation (extractedValue_llvmName, inCompiler COMMA_SOURCE_FILE ("expression-addressof.galgas", 273)).add_operation (GALGAS_string (", 0 ; addressof ("), inCompiler COMMA_SOURCE_FILE ("expression-addressof.galgas", 273)).add_operation (extractedValue_llvmName, inCompiler COMMA_SOURCE_FILE ("expression-addressof.galgas", 274)).add_operation (GALGAS_string (")\n"), inCompiler COMMA_SOURCE_FILE ("expression-addressof.galgas", 274)), inCompiler  COMMA_SOURCE_FILE ("expression-addressof.galgas", 273)) ;
    }
    break ;
  case GALGAS_LValueRepresentation::kEnum_universalReference:
    {
      const cEnumAssociatedValues_LValueRepresentation_universalReference * extractPtr_12369 = (const cEnumAssociatedValues_LValueRepresentation_universalReference *) (object->mProperty_mLValue.unsafePointer ()) ;
      const GALGAS_PLMType extractedValue_type = extractPtr_12369->mAssociatedValue0 ;
      const GALGAS_string extractedValue_llvmName = extractPtr_12369->mAssociatedValue1 ;
      ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  ").add_operation (extensionGetter_llvmName (object->mProperty_mTarget, inCompiler COMMA_SOURCE_FILE ("expression-addressof.galgas", 276)), inCompiler COMMA_SOURCE_FILE ("expression-addressof.galgas", 276)).add_operation (GALGAS_string (" = ptrtoint "), inCompiler COMMA_SOURCE_FILE ("expression-addressof.galgas", 276)).add_operation (extensionGetter_llvmTypeName (extractedValue_type, inCompiler COMMA_SOURCE_FILE ("expression-addressof.galgas", 276)), inCompiler COMMA_SOURCE_FILE ("expression-addressof.galgas", 276)).add_operation (GALGAS_string ("* "), inCompiler COMMA_SOURCE_FILE ("expression-addressof.galgas", 276)).add_operation (extractedValue_llvmName, inCompiler COMMA_SOURCE_FILE ("expression-addressof.galgas", 276)).add_operation (GALGAS_string (" to "), inCompiler COMMA_SOURCE_FILE ("expression-addressof.galgas", 276)).add_operation (extensionGetter_llvmTypeName (object->mProperty_mTarget, inCompiler COMMA_SOURCE_FILE ("expression-addressof.galgas", 277)), inCompiler COMMA_SOURCE_FILE ("expression-addressof.galgas", 277)).add_operation (GALGAS_string (" ; addressof\n"), inCompiler COMMA_SOURCE_FILE ("expression-addressof.galgas", 277)), inCompiler  COMMA_SOURCE_FILE ("expression-addressof.galgas", 276)) ;
    }
    break ;
  }
}
...
static void extensionMethod_primaryInExpressionAST_addDependenceEdgeForStaticExpression (const cPtr_expressionAST * inObject,
  ...
  cEnumerator_primaryInExpressionAccessListAST enumerator_3753 (object->mProperty_mAccessList, kENUMERATION_UP) ;
  while (enumerator_3753.hasCurrentObject ()) {
    switch (enumerator_3753.current_mAccess (HERE).enumValue ()) {
    case GALGAS_primaryInExpressionAccessAST::kNotBuilt:
      break ;
    case GALGAS_primaryInExpressionAccessAST::kEnum_integerSlice:
      {
    ...
    case GALGAS_primaryInExpressionAccessAST::kEnum_arrayAccess:
      {
        const cEnumAssociatedValues_primaryInExpressionAccessAST_arrayAccess * extractPtr_3997 = (const cEnumAssociatedValues_primaryInExpressionAccessAST_arrayAccess *) (enumerator_3753.current_mAccess (HERE).unsafePointer ()) ;
        const GALGAS_expressionAST extractedValue_indexExpression = extractPtr_3997->mAssociatedValue0 ;
    ...
    case GALGAS_primaryInExpressionAccessAST::kEnum_funcCall:
      {
        const cEnumAssociatedValues_primaryInExpressionAccessAST_funcCall * extractPtr_4538 = (const cEnumAssociatedValues_primaryInExpressionAccessAST_funcCall *) (enumerator_3753.current_mAccess (HERE).unsafePointer ()) ;
        const GALGAS_effectiveArgumentListAST extractedValue_arguments = extractPtr_4538->mAssociatedValue1 ;
        cEnumerator_effectiveArgumentListAST enumerator_4085 (extractedValue_arguments, kENUMERATION_UP) ;
        while (enumerator_4085.hasCurrentObject ()) {
          switch (enumerator_4085.current_mEffectiveParameterKind (HERE).enumValue ()) {
          case GALGAS_effectiveArgumentPassingModeAST::kNotBuilt:
            break ;
          case GALGAS_effectiveArgumentPassingModeAST::kEnum_input:
            {
          ...
          case GALGAS_effectiveArgumentPassingModeAST::kEnum_inputWithType:
            {
              const cEnumAssociatedValues_effectiveArgumentPassingModeAST_inputWithType * extractPtr_4328 = (const cEnumAssociatedValues_effectiveArgumentPassingModeAST_inputWithType *) (enumerator_4085.current_mEffectiveParameterKind (HERE).unsafePointer ()) ;
              const GALGAS_lstring extractedValue_typeName = extractPtr_4328->mAssociatedValue1 ;
              const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, extractedValue_typeName.getter_string (HERE).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
              if (kBoolTrue == test_1) {
                {
          ...
          case GALGAS_effectiveArgumentPassingModeAST::kEnum_output:
            {
              const cEnumAssociatedValues_effectiveArgumentPassingModeAST_output * extractPtr_4441 = (const cEnumAssociatedValues_effectiveArgumentPassingModeAST_output *) (enumerator_4085.current_mEffectiveParameterKind (HERE).unsafePointer ()) ;
              const GALGAS_expressionAST extractedValue_expression = extractPtr_4441->mAssociatedValue0 ;
...
static void extensionMethod_primaryInExpressionAST_noteExpressionTypesInPrecedenceGraph (const cPtr_expressionAST * inObject,
  ...
  const cPtr_primaryInExpressionAST * object = (const cPtr_primaryInExpressionAST *) inObject ;
  macroValidSharedObject (object, cPtr_primaryInExpressionAST) ;
  cEnumerator_primaryInExpressionAccessListAST enumerator_5067 (object->mProperty_mAccessList, kENUMERATION_UP) ;
  while (enumerator_5067.hasCurrentObject ()) {
    switch (enumerator_5067.current_mAccess (HERE).enumValue ()) {
    case GALGAS_primaryInExpressionAccessAST::kNotBuilt:
      break ;
    case GALGAS_primaryInExpressionAccessAST::kEnum_integerSlice:
      {
        const cEnumAssociatedValues_primaryInExpressionAccessAST_integerSlice * extractPtr_5276 = (const cEnumAssociatedValues_primaryInExpressionAccessAST_integerSlice *) (enumerator_5067.current_mAccess (HERE).unsafePointer ()) ;
        const GALGAS_lbigint extractedValue_low = extractPtr_5276->mAssociatedValue0 ;
        const GALGAS_lbigint extractedValue_high = extractPtr_5276->mAssociatedValue1 ;
    ...
    case GALGAS_primaryInExpressionAccessAST::kEnum_arrayAccess:
      {
        const cEnumAssociatedValues_primaryInExpressionAccessAST_arrayAccess * extractPtr_5429 = (const cEnumAssociatedValues_primaryInExpressionAccessAST_arrayAccess *) (enumerator_5067.current_mAccess (HERE).unsafePointer ()) ;
        const GALGAS_expressionAST extractedValue_indexExpression = extractPtr_5429->mAssociatedValue0 ;
        callExtensionMethod_noteExpressionTypesInPrecedenceGraph ((const cPtr_expressionAST *) extractedValue_indexExpression.ptr (), ioArgument_ioGraph, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 131)) ;
      }
      break ;
    case GALGAS_primaryInExpressionAccessAST::kEnum_funcCall:
      {
        const cEnumAssociatedValues_primaryInExpressionAccessAST_funcCall * extractPtr_5954 = (const cEnumAssociatedValues_primaryInExpressionAccessAST_funcCall *) (enumerator_5067.current_mAccess (HERE).unsafePointer ()) ;
        const GALGAS_effectiveArgumentListAST extractedValue_arguments = extractPtr_5954->mAssociatedValue1 ;
        cEnumerator_effectiveArgumentListAST enumerator_5517 (extractedValue_arguments, kENUMERATION_UP) ;
        while (enumerator_5517.hasCurrentObject ()) {
          switch (enumerator_5517.current_mEffectiveParameterKind (HERE).enumValue ()) {
          case GALGAS_effectiveArgumentPassingModeAST::kNotBuilt:
            break ;
          case GALGAS_effectiveArgumentPassingModeAST::kEnum_input:
            {
          ...
          case GALGAS_effectiveArgumentPassingModeAST::kEnum_inputWithType:
            {
              const cEnumAssociatedValues_effectiveArgumentPassingModeAST_inputWithType * extractPtr_5760 = (const cEnumAssociatedValues_effectiveArgumentPassingModeAST_inputWithType *) (enumerator_5517.current_mEffectiveParameterKind (HERE).unsafePointer ()) ;
              const GALGAS_lstring extractedValue_typeName = extractPtr_5760->mAssociatedValue1 ;
              const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, extractedValue_typeName.getter_string (HERE).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
              if (kBoolTrue == test_1) {
                {
                ioArgument_ioGraph.setter_noteNode (function_llvmTypeNameFromPLMname (extractedValue_typeName, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 138)) COMMA_SOURCE_FILE ("expression-primary.galgas", 138)) ;
                }
              }
            }
            break ;
          case GALGAS_effectiveArgumentPassingModeAST::kEnum_output:
            {
              const cEnumAssociatedValues_effectiveArgumentPassingModeAST_output * extractPtr_5857 = (const cEnumAssociatedValues_effectiveArgumentPassingModeAST_output *) (enumerator_5517.current_mEffectiveParameterKind (HERE).unsafePointer ()) ;
              const GALGAS_expressionAST extractedValue_expression = extractPtr_5857->mAssociatedValue0 ;
              callExtensionMethod_noteExpressionTypesInPrecedenceGraph ((const cPtr_expressionAST *) extractedValue_expression.ptr (), ioArgument_ioGraph, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 140)) ;
            }
            break ;
          case GALGAS_effectiveArgumentPassingModeAST::kEnum_outputInput:
            {
...
static void extensionMethod_primaryInExpressionAST_analyzeExpression (const cPtr_expressionAST * inObject,
  ...
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, object->mProperty_mReceiverName.getter_string (HERE).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
  if (kBoolTrue == test_0) {
    const enumGalgasBool test_1 = constinArgument_inRoutineAttributes.getter_guard (SOURCE_FILE ("expression-primary.galgas", 169)).boolEnum () ;
    if (kBoolTrue == test_1) {
      TC_Array <C_FixItDescription> fixItArray2 ;
      inCompiler->emitSemanticError (object->mProperty_mReceiverName.getter_location (SOURCE_FILE ("expression-primary.galgas", 170)), GALGAS_string ("in guard, only 'self' properties may be accessed"), fixItArray2  COMMA_SOURCE_FILE ("expression-primary.galgas", 170)) ;
      outArgument_outResult.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_1) {
      const GALGAS_primaryInExpressionAST temp_3 = object ;
      callExtensionMethod_analyzePrimaryExpressionNoSelf ((const cPtr_primaryInExpressionAST *) temp_3.ptr (), constinArgument_inSelfType, constinArgument_inRoutineAttributes, constinArgument_inCallerNameForInvocationGraph, constinArgument_inOptionalTargetType, constinArgument_inContext, constinArgument_inMode, ioArgument_ioTemporaries, ioArgument_ioStaticEntityMap, ioArgument_ioUniversalMap, ioArgument_ioAllocaList, ioArgument_ioInstructionGenerationList, outArgument_outResult, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 172)) ;
    }
  }else if (kBoolFalse == test_0) {
    const enumGalgasBool test_4 = GALGAS_bool (kIsEqual, constinArgument_inSelfType.getter_kind (HERE).objectCompare (GALGAS_typeKind::constructor_void (SOURCE_FILE ("expression-primary.galgas", 187)))).boolEnum () ;
    if (kBoolTrue == test_4) {
      TC_Array <C_FixItDescription> fixItArray5 ;
      inCompiler->emitSemanticError (object->mProperty_mReceiverName.getter_location (SOURCE_FILE ("expression-primary.galgas", 188)), GALGAS_string ("'self' is not available in this context"), fixItArray5  COMMA_SOURCE_FILE ("expression-primary.galgas", 188)) ;
      outArgument_outResult.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_4) {
...
void routine_procAnalyzeAccesListInExpression (const GALGAS_PLMType constinArgument_inSelfType,
                                               ...
                                               C_Compiler * inCompiler
                                               COMMA_UNUSED_LOCATION_ARGS) {
  cEnumerator_primaryInExpressionAccessListAST enumerator_14280 (constinArgument_inAccessList, kENUMERATION_UP) ;
  while (enumerator_14280.hasCurrentObject ()) {
    switch (enumerator_14280.current_mAccess (HERE).enumValue ()) {
    case GALGAS_primaryInExpressionAccessAST::kNotBuilt:
      break ;
    case GALGAS_primaryInExpressionAccessAST::kEnum_integerSlice:
      {
        const cEnumAssociatedValues_primaryInExpressionAccessAST_integerSlice * extractPtr_14659 = (const cEnumAssociatedValues_primaryInExpressionAccessAST_integerSlice *) (enumerator_14280.current_mAccess (HERE).unsafePointer ()) ;
        const GALGAS_lbigint extractedValue_low = extractPtr_14659->mAssociatedValue0 ;
        const GALGAS_lbigint extractedValue_high = extractPtr_14659->mAssociatedValue1 ;
        {
        routine_handleSliceInExpression (constinArgument_inContext, ioArgument_ioResult, extractedValue_low, extractedValue_high, ioArgument_ioTemporaries, ioArgument_ioInstructionGenerationList, inCompiler  COMMA_SOURCE_FILE ("expression-primary.galgas", 360)) ;
        }
      }
      break ;
    case GALGAS_primaryInExpressionAccessAST::kEnum_property:
      {
        const cEnumAssociatedValues_primaryInExpressionAccessAST_property * extractPtr_14883 = (const cEnumAssociatedValues_primaryInExpressionAccessAST_property *) (enumerator_14280.current_mAccess (HERE).unsafePointer ()) ;
        const GALGAS_lstring extractedValue_propertyName = extractPtr_14883->mAssociatedValue0 ;
        {
        routine_handlePropertyAccessInExpression (ioArgument_ioResult, extractedValue_propertyName, ioArgument_ioTemporaries, ioArgument_ioInstructionGenerationList, inCompiler  COMMA_SOURCE_FILE ("expression-primary.galgas", 369)) ;
        }
      }
      break ;
    case GALGAS_primaryInExpressionAccessAST::kEnum_arrayAccess:
      {
        const cEnumAssociatedValues_primaryInExpressionAccessAST_arrayAccess * extractPtr_15510 = (const cEnumAssociatedValues_primaryInExpressionAccessAST_arrayAccess *) (enumerator_14280.current_mAccess (HERE).unsafePointer ()) ;
        const GALGAS_expressionAST extractedValue_indexExpression = extractPtr_15510->mAssociatedValue0 ;
        const GALGAS_location extractedValue_endOfIndex = extractPtr_15510->mAssociatedValue1 ;
        {
    ...
    case GALGAS_primaryInExpressionAccessAST::kEnum_funcCall:
      {
        const cEnumAssociatedValues_primaryInExpressionAccessAST_funcCall * extractPtr_16262 = (const cEnumAssociatedValues_primaryInExpressionAccessAST_funcCall *) (enumerator_14280.current_mAccess (HERE).unsafePointer ()) ;
        const GALGAS_lstring extractedValue_methodName = extractPtr_16262->mAssociatedValue0 ;
        const GALGAS_effectiveArgumentListAST extractedValue_arguments = extractPtr_16262->mAssociatedValue1 ;
        const GALGAS_location extractedValue_errorLocation = extractPtr_16262->mAssociatedValue2 ;
        const enumGalgasBool test_0 = constinArgument_inRoutineAttributes.getter_guard (SOURCE_FILE ("expression-primary.galgas", 393)).boolEnum () ;
        if (kBoolTrue == test_0) {
          TC_Array <C_FixItDescription> fixItArray1 ;
...
void routine_handleSliceInExpression (const GALGAS_semanticContext constinArgument_inContext,
  ...
  if (kBoolTrue == test_0) {
    ...
    GALGAS_bool test_2 = extensionGetter_type (ioArgument_ioResult, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 508)).getter_kind (HERE).getter_isInteger (SOURCE_FILE ("expression-primary.galgas", 508)) ;
    if (kBoolTrue != test_2.boolEnum ()) {
      test_2 = extensionGetter_type (ioArgument_ioResult, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 508)).getter_kind (HERE).getter_isStaticInteger (SOURCE_FILE ("expression-primary.galgas", 508)) ;
    }
    const enumGalgasBool test_3 = test_2.operator_not (SOURCE_FILE ("expression-primary.galgas", 508)).boolEnum () ;
    if (kBoolTrue == test_3) {
      TC_Array <C_FixItDescription> fixItArray4 ;
      ...
      GALGAS_lstring var_resultIntegerName_20082 = GALGAS_lstring::constructor_new (GALGAS_string ("uint").add_operation (constinArgument_inHigh.getter_bigint (HERE).substract_operation (constinArgument_inLow.getter_bigint (HERE), inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 514)).add_operation (GALGAS_bigint ("1", inCompiler  COMMA_SOURCE_FILE ("expression-primary.galgas", 514)), inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 514)).getter_string (SOURCE_FILE ("expression-primary.galgas", 514)), inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 514)), constinArgument_inLow.getter_location (HERE)  COMMA_SOURCE_FILE ("expression-primary.galgas", 514)) ;
      GALGAS_PLMType var_sliceType_20239 ;
      GALGAS_uint joker_20241_1 ; // Joker input parameter
      constinArgument_inContext.getter_mTypeMap (HERE).method_searchKey (var_resultIntegerName_20082, var_sliceType_20239, joker_20241_1, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 515)) ;
      {
      extensionSetter_appendTrunc (ioArgument_ioInstructionGenerationList, var_sliceType_20239, ioArgument_ioResult, ioArgument_ioTemporaries, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 516)) ;
      }
    }
  }
}
...
void routine_handlePropertyAccessInExpression (GALGAS_objectIR & ioArgument_ioResult,
                                               ...
                                               C_Compiler * inCompiler
                                               COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_PLMType var_type_20690 = extensionGetter_type (ioArgument_ioResult, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 528)) ;
  GALGAS_propertyMap var_propertyMap_20739 = var_type_20690.getter_propertyMap (HERE) ;
  GALGAS_propertyAccessKind var_accessKind_20838 ;
  GALGAS_bool joker_20801 ; // Joker input parameter
  var_propertyMap_20739.method_searchKey (constinArgument_inPropertyName, joker_20801, var_accessKind_20838, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 530)) ;
  switch (var_accessKind_20838.enumValue ()) {
  case GALGAS_propertyAccessKind::kNotBuilt:
    break ;
  case GALGAS_propertyAccessKind::kEnum_nonVirtualMethod:
    {
      TC_Array <C_FixItDescription> fixItArray0 ;
      inCompiler->emitSemanticError (constinArgument_inPropertyName.getter_location (SOURCE_FILE ("expression-primary.galgas", 533)), GALGAS_string ("a method cannot be used in this context"), fixItArray0  COMMA_SOURCE_FILE ("expression-primary.galgas", 533)) ;
      ioArgument_ioResult.drop () ; // Release error dropped variable
    }
    break ;
  case GALGAS_propertyAccessKind::kEnum_constantProperty:
    {
      const cEnumAssociatedValues_propertyAccessKind_constantProperty * extractPtr_21034 = (const cEnumAssociatedValues_propertyAccessKind_constantProperty *) (var_accessKind_20838.unsafePointer ()) ;
      const GALGAS_objectIR extractedValue_value = extractPtr_21034->mAssociatedValue0 ;
      ioArgument_ioResult = extractedValue_value ;
    }
    break ;
  case GALGAS_propertyAccessKind::kEnum_singleton:
    {
      const cEnumAssociatedValues_propertyAccessKind_singleton * extractPtr_21087 = (const cEnumAssociatedValues_propertyAccessKind_singleton *) (var_accessKind_20838.unsafePointer ()) ;
      const GALGAS_objectIR extractedValue_object = extractPtr_21087->mAssociatedValue0 ;
      ioArgument_ioResult = extractedValue_object ;
    }
    break ;
  case GALGAS_propertyAccessKind::kEnum_indexed:
    {
      const cEnumAssociatedValues_propertyAccessKind_indexed * extractPtr_21478 = (const cEnumAssociatedValues_propertyAccessKind_indexed *) (var_accessKind_20838.unsafePointer ()) ;
      const GALGAS_PLMType extractedValue_propertyType = extractPtr_21478->mAssociatedValue0 ;
      const GALGAS_uint extractedValue_propertyIndex = extractPtr_21478->mAssociatedValue1 ;
      GALGAS_string var_property_5F_llvmName_21207 ;
      {
      extensionSetter_newTempLLVMVar (ioArgument_ioTemporaries, var_property_5F_llvmName_21207, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 539)) ;
      }
      {
      extensionSetter_appendGetUniversalPropertyReference (ioArgument_ioInstructionGenerationList, extensionGetter_type (ioArgument_ioResult, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 541)), extensionGetter_llvmName (ioArgument_ioResult, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 542)), var_property_5F_llvmName_21207, extractedValue_propertyIndex, constinArgument_inPropertyName.getter_string (SOURCE_FILE ("expression-primary.galgas", 545)), inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 540)) ;
      }
      ioArgument_ioResult = GALGAS_objectIR::constructor_reference (extractedValue_propertyType, var_property_5F_llvmName_21207  COMMA_SOURCE_FILE ("expression-primary.galgas", 547)) ;
    }
    break ;
  }
}
...
void routine_handleArrayAccessInExpression (GALGAS_objectIR & ioArgument_ioResult,
                                            ...
                                            C_Compiler * inCompiler
                                            COMMA_UNUSED_LOCATION_ARGS) {
  const enumGalgasBool test_0 = extensionGetter_type (ioArgument_ioResult, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 570)).getter_kind (HERE).getter_isArrayType (SOURCE_FILE ("expression-primary.galgas", 570)).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_PLMType var_elementType_22470 ;
    GALGAS_bigint var_arraySize_22498 ;
    extensionGetter_type (ioArgument_ioResult, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 571)).getter_kind (HERE).method_arrayType (var_elementType_22470, var_arraySize_22498, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 571)) ;
    {
    routine_handleArraySubscript (constinArgument_inSelfType, constinArgument_inRoutineAttributes, constinArgument_inCallerNameForInvocationGraph, constinArgument_inContext, constinArgument_inMode, ioArgument_ioTemporaries, ioArgument_ioStaticEntityMap, ioArgument_ioUniversalMap, ioArgument_ioAllocaList, constinArgument_inIndexExpression, constinArgument_inEndOfIndex, var_arraySize_22498, var_elementType_22470, ioArgument_ioInstructionGenerationList, ioArgument_ioResult, inCompiler  COMMA_SOURCE_FILE ("expression-primary.galgas", 572)) ;
    }
  }else if (kBoolFalse == test_0) {
    TC_Array <C_FixItDescription> fixItArray1 ;
    inCompiler->emitSemanticError (constinArgument_inEndOfIndex, GALGAS_string ("the receiver is not an array and does not accept subscripting"), fixItArray1  COMMA_SOURCE_FILE ("expression-primary.galgas", 590)) ;
  }
}
...
void routine_handleFunctionCallInExpression (const GALGAS_lstring constinArgument_inMethodName,
                                             ...
                                             C_Compiler * inCompiler
                                             COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_PLMType var_receiverType_23897 = extensionGetter_type (ioArgument_ioObjectIR, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 611)) ;
  GALGAS_propertyMap var_propertyMap_23948 = var_receiverType_23897.getter_propertyMap (HERE) ;
  GALGAS_lstring var_key_23985 = function_routineMangledNameFromCall (GALGAS_string::makeEmptyString (), constinArgument_inMethodName, constinArgument_inArguments, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 613)) ;
  GALGAS_propertyAccessKind var_propertyAccess_24120 ;
  GALGAS_bool joker_24079 ; // Joker input parameter
  var_propertyMap_23948.method_searchKey (var_key_23985, joker_24079, var_propertyAccess_24120, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 614)) ;
  switch (var_propertyAccess_24120.enumValue ()) {
  case GALGAS_propertyAccessKind::kNotBuilt:
    break ;
  case GALGAS_propertyAccessKind::kEnum_constantProperty:
    {
      TC_Array <C_FixItDescription> fixItArray0 ;
      inCompiler->emitSemanticError (constinArgument_inMethodName.getter_location (SOURCE_FILE ("expression-primary.galgas", 617)), GALGAS_string ("a constant cannot be used as method"), fixItArray0  COMMA_SOURCE_FILE ("expression-primary.galgas", 617)) ;
      ioArgument_ioObjectIR.drop () ; // Release error dropped variable
    }
    break ;
  case GALGAS_propertyAccessKind::kEnum_nonVirtualMethod:
    {
      const cEnumAssociatedValues_propertyAccessKind_nonVirtualMethod * extractPtr_26549 = (const cEnumAssociatedValues_propertyAccessKind_nonVirtualMethod *) (var_propertyAccess_24120.unsafePointer ()) ;
      const GALGAS_routineDescriptor extractedValue_routineDescriptor = extractPtr_26549->mAssociatedValue0 ;
      const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, extractedValue_routineDescriptor.getter_returnTypeProxy (HERE).getter_type (inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 620)).getter_kind (HERE).objectCompare (GALGAS_typeKind::constructor_void (SOURCE_FILE ("expression-primary.galgas", 620)))).boolEnum () ;
      if (kBoolTrue == test_1) {
        TC_Array <C_FixItDescription> fixItArray2 ;
        inCompiler->emitSemanticError (constinArgument_inMethodName.getter_location (SOURCE_FILE ("expression-primary.galgas", 621)), GALGAS_string ("not a function (returns no value)"), fixItArray2  COMMA_SOURCE_FILE ("expression-primary.galgas", 621)) ;
        ioArgument_ioObjectIR.drop () ; // Release error dropped variable
      }else if (kBoolFalse == test_1) {
        GALGAS_calleeKindIR var_calleeKind_24554 = function_checkMode (constinArgument_inMode, extensionGetter_executionMode (extractedValue_routineDescriptor.getter_routineKind (HERE), inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 626)), extractedValue_routineDescriptor.getter_routineKind (HERE), constinArgument_inMethodName.getter_location (HERE), inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 624)) ;
        {
        extensionSetter_referenceFromPossibleValue (ioArgument_ioInstructionGenerationList, ioArgument_ioTemporaries, ioArgument_ioAllocaList, ioArgument_ioObjectIR, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 631)) ;
        }
        GALGAS_procCallEffectiveParameterListIR var_effectiveParameterListIR_25017 = GALGAS_procCallEffectiveParameterListIR::constructor_emptyList (SOURCE_FILE ("expression-primary.galgas", 633)) ;
        var_effectiveParameterListIR_25017.addAssign_operation (GALGAS_procEffectiveParameterPassingModeIR::constructor_outputInput (SOURCE_FILE ("expression-primary.galgas", 634)), ioArgument_ioObjectIR  COMMA_SOURCE_FILE ("expression-primary.galgas", 634)) ;
        {
        routine_analyzeEffectiveParameters (constinArgument_inSelfType, constinArgument_inRoutineAttributes, extractedValue_routineDescriptor.getter_signature (HERE), constinArgument_inArguments, constinArgument_inMethodName.getter_location (HERE), constinArgument_inCallerNameForInvocationGraph, constinArgument_inContext, constinArgument_inMode, ioArgument_ioTemporaries, ioArgument_ioStaticEntityMap, ioArgument_ioUniversalMap, ioArgument_ioAllocaList, ioArgument_ioInstructionGenerationList, var_effectiveParameterListIR_25017, inCompiler  COMMA_SOURCE_FILE ("expression-primary.galgas", 636)) ;
        }
        GALGAS_objectIR var_callReturnedResult_25914 ;
        {
        routine_getNewTempValue (extractedValue_routineDescriptor.getter_returnTypeProxy (HERE).getter_type (inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 653)), ioArgument_ioTemporaries, var_callReturnedResult_25914, inCompiler  COMMA_SOURCE_FILE ("expression-primary.galgas", 653)) ;
        }
        GALGAS_lstring var_routineMangledName_25967 = function_routineMangledNameFromCall (function_llvmTypeStringFromPLMname (extensionGetter_type (ioArgument_ioObjectIR, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 655)).getter_plmOriginalTypeName (HERE), inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 655)), constinArgument_inMethodName, constinArgument_inArguments, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 655)) ;
        ioArgument_ioInstructionGenerationList.addAssign_operation (GALGAS_standaloneRoutineCallIR::constructor_new (GALGAS_string::makeEmptyString (), var_callReturnedResult_25914, var_routineMangledName_25967, var_routineMangledName_25967, var_calleeKind_24554, var_effectiveParameterListIR_25017  COMMA_SOURCE_FILE ("expression-primary.galgas", 656))  COMMA_SOURCE_FILE ("expression-primary.galgas", 656)) ;
        {
        ioArgument_ioTemporaries.mProperty_mSubprogramInvocationGraph.setter_addEdge (constinArgument_inCallerNameForInvocationGraph, var_routineMangledName_25967 COMMA_SOURCE_FILE ("expression-primary.galgas", 665)) ;
        }
        ioArgument_ioObjectIR = var_callReturnedResult_25914 ;
      }
    }
    break ;
  case GALGAS_propertyAccessKind::kEnum_singleton:
    {
      const cEnumAssociatedValues_propertyAccessKind_singleton * extractPtr_26664 = (const cEnumAssociatedValues_propertyAccessKind_singleton *) (var_propertyAccess_24120.unsafePointer ()) ;
      const GALGAS_location extractedValue_errorLocation = extractPtr_26664->mAssociatedValue1 ;
      TC_Array <C_FixItDescription> fixItArray3 ;
      inCompiler->emitSemanticError (extractedValue_errorLocation, GALGAS_string ("a property cannot be used as method"), fixItArray3  COMMA_SOURCE_FILE ("expression-primary.galgas", 670)) ;
      ioArgument_ioObjectIR.drop () ; // Release error dropped variable
    }
    break ;
  case GALGAS_propertyAccessKind::kEnum_indexed:
    {
      const cEnumAssociatedValues_propertyAccessKind_indexed * extractPtr_28890 = (const cEnumAssociatedValues_propertyAccessKind_indexed *) (var_propertyAccess_24120.unsafePointer ()) ;
      const GALGAS_PLMType extractedValue_propertyType = extractPtr_28890->mAssociatedValue0 ;
      const GALGAS_uint extractedValue_propertyIndex = extractPtr_28890->mAssociatedValue1 ;
      const enumGalgasBool test_4 = extractedValue_propertyType.getter_kind (HERE).getter_isFunction (SOURCE_FILE ("expression-primary.galgas", 672)).operator_not (SOURCE_FILE ("expression-primary.galgas", 672)).boolEnum () ;
      if (kBoolTrue == test_4) {
        TC_Array <C_FixItDescription> fixItArray5 ;
        inCompiler->emitSemanticError (constinArgument_inMethodName.getter_location (SOURCE_FILE ("expression-primary.galgas", 673)), GALGAS_string ("an indexed property cannot be used as method"), fixItArray5  COMMA_SOURCE_FILE ("expression-primary.galgas", 673)) ;
        ioArgument_ioObjectIR.drop () ; // Release error dropped variable
      }else if (kBoolFalse == test_4) {
        GALGAS_routineDescriptor var_descriptor_26930 ;
        extractedValue_propertyType.getter_kind (HERE).method_function (var_descriptor_26930, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 675)) ;
        const enumGalgasBool test_6 = GALGAS_bool (kIsEqual, var_descriptor_26930.getter_returnTypeProxy (HERE).objectCompare (GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("expression-primary.galgas", 677)))).boolEnum () ;
        if (kBoolTrue == test_6) {
          TC_Array <C_FixItDescription> fixItArray7 ;
          inCompiler->emitSemanticError (constinArgument_inMethodName.getter_location (SOURCE_FILE ("expression-primary.galgas", 678)), GALGAS_string ("not a function (returns no value)"), fixItArray7  COMMA_SOURCE_FILE ("expression-primary.galgas", 678)) ;
          ioArgument_ioObjectIR.drop () ; // Release error dropped variable
        }else if (kBoolFalse == test_6) {
          GALGAS_procCallEffectiveParameterListIR var_effectiveParameterListIR_27453 = GALGAS_procCallEffectiveParameterListIR::constructor_emptyList (SOURCE_FILE ("expression-primary.galgas", 688)) ;
          {
          routine_analyzeEffectiveParameters (constinArgument_inSelfType, constinArgument_inRoutineAttributes, var_descriptor_26930.getter_signature (HERE), constinArgument_inArguments, constinArgument_inMethodName.getter_location (HERE), constinArgument_inCallerNameForInvocationGraph, constinArgument_inContext, constinArgument_inMode, ioArgument_ioTemporaries, ioArgument_ioStaticEntityMap, ioArgument_ioUniversalMap, ioArgument_ioAllocaList, ioArgument_ioInstructionGenerationList, var_effectiveParameterListIR_27453, inCompiler  COMMA_SOURCE_FILE ("expression-primary.galgas", 689)) ;
          }
          GALGAS_string var_property_5F_llvmName_28184 ;
          {
          extensionSetter_newTempLLVMVar (ioArgument_ioTemporaries, var_property_5F_llvmName_28184, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 706)) ;
          }
          {
          extensionSetter_appendGetUniversalPropertyReference (ioArgument_ioInstructionGenerationList, extensionGetter_type (ioArgument_ioObjectIR, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 708)), extensionGetter_llvmName (ioArgument_ioObjectIR, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 709)), var_property_5F_llvmName_28184, extractedValue_propertyIndex, constinArgument_inMethodName.getter_string (SOURCE_FILE ("expression-primary.galgas", 712)), inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 707)) ;
          }
          GALGAS_objectIR var_callReturnedResult_28564 ;
          {
          routine_getNewTempValue (var_descriptor_26930.getter_returnTypeProxy (HERE).getter_type (inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 715)), ioArgument_ioTemporaries, var_callReturnedResult_28564, inCompiler  COMMA_SOURCE_FILE ("expression-primary.galgas", 715)) ;
          }
          ioArgument_ioInstructionGenerationList.addAssign_operation (GALGAS_indirectRoutineCallIR::constructor_new (GALGAS_objectIR::constructor_reference (extractedValue_propertyType, var_property_5F_llvmName_28184  COMMA_SOURCE_FILE ("expression-primary.galgas", 718)), extractedValue_propertyType, var_callReturnedResult_28564, var_effectiveParameterListIR_27453  COMMA_SOURCE_FILE ("expression-primary.galgas", 717))  COMMA_SOURCE_FILE ("expression-primary.galgas", 717)) ;
          ioArgument_ioObjectIR = var_callReturnedResult_28564 ;
        }
      }
    }
    break ;
...
static void extensionMethod_assignmentInstructionAST_instructionSemanticAnalysis (const cPtr_instructionAST * inObject,
  ...
  const cPtr_assignmentInstructionAST * object = (const cPtr_assignmentInstructionAST *) inObject ;
  macroValidSharedObject (object, cPtr_assignmentInstructionAST) ;
  GALGAS_PLMType var_targetType_3196 ;
  extensionMethod_searchValuedObjectType (ioArgument_ioUniversalMap, constinArgument_inSelfType, object->mProperty_mTargetAST.getter_mIdentifier (HERE), object->mProperty_mTargetAST.getter_mKind (HERE), var_targetType_3196, inCompiler COMMA_SOURCE_FILE ("instruction-assignment.galgas", 60)) ;
  GALGAS_objectIR var_sourceOperandPossibleReference_3713 ;
  callExtensionMethod_analyzeExpression ((const cPtr_expressionAST *) object->mProperty_mSourceExpression.ptr (), constinArgument_inSelfType, constinArgument_inRoutineAttributes, constinArgument_inCallerNameForInvocationGraph, var_targetType_3196, constinArgument_inContext, constinArgument_inCurrentMode, ioArgument_ioTemporaries, ioArgument_ioStaticEntityMap, ioArgument_ioUniversalMap, ioArgument_ioAllocaList, ioArgument_ioInstructionGenerationList, var_sourceOperandPossibleReference_3713, inCompiler COMMA_SOURCE_FILE ("instruction-assignment.galgas", 62)) ;
  GALGAS_LValueRepresentation var_lvalueIR_4192 ;
  extensionMethod_analyzeLValue (object->mProperty_mTargetAST, constinArgument_inSelfType, GALGAS_bool (false), constinArgument_inRoutineAttributes, constinArgument_inCallerNameForInvocationGraph, constinArgument_inContext, constinArgument_inCurrentMode, ioArgument_ioTemporaries, ioArgument_ioStaticEntityMap, ioArgument_ioUniversalMap, ioArgument_ioAllocaList, ioArgument_ioInstructionGenerationList, var_lvalueIR_4192, inCompiler COMMA_SOURCE_FILE ("instruction-assignment.galgas", 77)) ;
  GALGAS_PLMType var_t_4230 = extensionGetter_type (var_sourceOperandPossibleReference_3713, inCompiler COMMA_SOURCE_FILE ("instruction-assignment.galgas", 92)) ;
  const enumGalgasBool test_0 = extensionGetter_copyable (var_t_4230, inCompiler COMMA_SOURCE_FILE ("instruction-assignment.galgas", 93)).operator_not (SOURCE_FILE ("instruction-assignment.galgas", 93)).boolEnum () ;
  if (kBoolTrue == test_0) {
    TC_Array <C_FixItDescription> fixItArray1 ;
    ...
    {
    extensionSetter_appendCopyFromReferences (ioArgument_ioInstructionGenerationList, ioArgument_ioTemporaries, object->mProperty_mTargetAST.getter_mIdentifier (HERE).getter_location (SOURCE_FILE ("instruction-assignment.galgas", 98)), var_sourceOperandPossibleReference_3713, var_lvalueIR_4192, inCompiler COMMA_SOURCE_FILE ("instruction-assignment.galgas", 96)) ;
    }
  }
}
...
static void extensionMethod_controlRegisterAssignmentInstructionAST_noteInstructionTypesInPrecedenceGraph (const cPtr_instructionAST * inObject,
  ...
  callExtensionMethod_noteExpressionTypesInPrecedenceGraph ((const cPtr_expressionAST *) object->mProperty_mSourceExpression.ptr (), ioArgument_ioGraph, inCompiler COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 86)) ;
  switch (object->mProperty_mRegisterIndex.enumValue ()) {
  case GALGAS_registerIndexAST::kNotBuilt:
    break ;
  case GALGAS_registerIndexAST::kEnum_noIndex:
  ...
  case GALGAS_registerIndexAST::kEnum_index:
    {
      const cEnumAssociatedValues_registerIndexAST_index * extractPtr_3717 = (const cEnumAssociatedValues_registerIndexAST_index *) (object->mProperty_mRegisterIndex.unsafePointer ()) ;
      const GALGAS_expressionAST extractedValue_indexExpression = extractPtr_3717->mAssociatedValue0 ;
      callExtensionMethod_noteExpressionTypesInPrecedenceGraph ((const cPtr_expressionAST *) extractedValue_indexExpression.ptr (), ioArgument_ioGraph, inCompiler COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 90)) ;
    }
    break ;
  }
}
...
static void extensionMethod_controlRegisterAssignmentInstructionAST_instructionSemanticAnalysis (const cPtr_instructionAST * inObject,
  ...
  const cPtr_controlRegisterAssignmentInstructionAST * object = (const cPtr_controlRegisterAssignmentInstructionAST *) inObject ;
  macroValidSharedObject (object, cPtr_controlRegisterAssignmentInstructionAST) ;
  GALGAS_valuedObject var_entity_4816 ;
  extensionMethod_searchEntity (ioArgument_ioUniversalMap, object->mProperty_mRegisterGroupName, var_entity_4816, inCompiler COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 111)) ;
  GALGAS_controlRegisterMap var_registerMap_4851 ;
  switch (var_entity_4816.enumValue ()) {
  case GALGAS_valuedObject::kNotBuilt:
    break ;
  case GALGAS_valuedObject::kEnum_task:
    {
      TC_Array <C_FixItDescription> fixItArray0 ;
      inCompiler->emitSemanticError (object->mProperty_mRegisterGroupName.getter_location (SOURCE_FILE ("instruction-assignment-control-register.galgas", 116)), GALGAS_string ("the \":\" access is reserved to control register"), fixItArray0  COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 116)) ;
      var_registerMap_4851.drop () ; // Release error dropped variable
    }
    break ;
  case GALGAS_valuedObject::kEnum_driver:
    {
      TC_Array <C_FixItDescription> fixItArray1 ;
      inCompiler->emitSemanticError (object->mProperty_mRegisterGroupName.getter_location (SOURCE_FILE ("instruction-assignment-control-register.galgas", 118)), GALGAS_string ("the \":\" access is reserved to control register"), fixItArray1  COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 118)) ;
      var_registerMap_4851.drop () ; // Release error dropped variable
    }
    break ;
  case GALGAS_valuedObject::kEnum_globalConstant:
    {
      TC_Array <C_FixItDescription> fixItArray2 ;
      inCompiler->emitSemanticError (object->mProperty_mRegisterGroupName.getter_location (SOURCE_FILE ("instruction-assignment-control-register.galgas", 120)), GALGAS_string ("the \":\" access is reserved to control register"), fixItArray2  COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 120)) ;
      var_registerMap_4851.drop () ; // Release error dropped variable
    }
    break ;
  case GALGAS_valuedObject::kEnum_localConstant:
    {
      TC_Array <C_FixItDescription> fixItArray3 ;
      inCompiler->emitSemanticError (object->mProperty_mRegisterGroupName.getter_location (SOURCE_FILE ("instruction-assignment-control-register.galgas", 122)), GALGAS_string ("the \":\" access is reserved to control register"), fixItArray3  COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 122)) ;
      var_registerMap_4851.drop () ; // Release error dropped variable
    }
    break ;
  case GALGAS_valuedObject::kEnum_globalSyncInstance:
    {
      TC_Array <C_FixItDescription> fixItArray4 ;
      inCompiler->emitSemanticError (object->mProperty_mRegisterGroupName.getter_location (SOURCE_FILE ("instruction-assignment-control-register.galgas", 124)), GALGAS_string ("the \":\" access is reserved to control register"), fixItArray4  COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 124)) ;
      var_registerMap_4851.drop () ; // Release error dropped variable
    }
    break ;
  case GALGAS_valuedObject::kEnum_localVariable:
    {
      TC_Array <C_FixItDescription> fixItArray5 ;
      inCompiler->emitSemanticError (object->mProperty_mRegisterGroupName.getter_location (SOURCE_FILE ("instruction-assignment-control-register.galgas", 126)), GALGAS_string ("the \":\" access is reserved to control register"), fixItArray5  COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 126)) ;
      var_registerMap_4851.drop () ; // Release error dropped variable
    }
    break ;
  case GALGAS_valuedObject::kEnum_registerGroup:
    {
      const cEnumAssociatedValues_valuedObject_registerGroup * extractPtr_5737 = (const cEnumAssociatedValues_valuedObject_registerGroup *) (var_entity_4816.unsafePointer ()) ;
      const GALGAS_controlRegisterMap extractedValue_theRegisterMap = extractPtr_5737->mAssociatedValue0 ;
      var_registerMap_4851 = extractedValue_theRegisterMap ;
    }
    break ;
  }
  GALGAS_PLMType var_registerType_5818 ;
  GALGAS_bool var_readOnly_5842 ;
  GALGAS_bool var_userAccess_5868 ;
  GALGAS_controlRegisterGroupKind var_controlRegisterGroupKind_5936 ;
  GALGAS_uint var_inRegisterArraySize_5979 ;
  GALGAS_uint var_inRegisterElementSize_6036 ;
  GALGAS_sliceMap joker_5874_2 ; // Joker input parameter
  GALGAS_controlRegisterFieldMap joker_5874_1 ; // Joker input parameter
  GALGAS_controlRegisterFieldList joker_5942_2 ; // Joker input parameter
  GALGAS_uint joker_5942_1 ; // Joker input parameter
  var_registerMap_4851.method_searchKey (object->mProperty_mRegisterName, var_registerType_5818, var_readOnly_5842, var_userAccess_5868, joker_5874_2, joker_5874_1, var_controlRegisterGroupKind_5936, joker_5942_2, joker_5942_1, var_inRegisterArraySize_5979, var_inRegisterElementSize_6036, inCompiler COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 130)) ;
  const enumGalgasBool test_6 = var_readOnly_5842.boolEnum () ;
  if (kBoolTrue == test_6) {
    TC_Array <C_FixItDescription> fixItArray7 ;
    inCompiler->emitSemanticError (object->mProperty_mRegisterName.getter_location (SOURCE_FILE ("instruction-assignment-control-register.galgas", 143)), GALGAS_string ("this control register cannot be modified (declared with @ro attribute)"), fixItArray7  COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 143)) ;
  }else if (kBoolFalse == test_6) {
    GALGAS_bool test_8 = var_userAccess_5868.operator_not (SOURCE_FILE ("instruction-assignment-control-register.galgas", 145)) ;
    if (kBoolTrue == test_8.boolEnum ()) {
      GALGAS_bool test_9 = constinArgument_inMode.getter_isUserMode (SOURCE_FILE ("instruction-assignment-control-register.galgas", 145)) ;
      if (kBoolTrue != test_9.boolEnum ()) {
        test_9 = constinArgument_inMode.getter_isAnyMode (SOURCE_FILE ("instruction-assignment-control-register.galgas", 145)) ;
      }
      test_8 = test_9 ;
    }
    const enumGalgasBool test_10 = test_8.boolEnum () ;
    if (kBoolTrue == test_10) {
      TC_Array <C_FixItDescription> fixItArray11 ;
      inCompiler->emitSemanticError (object->mProperty_mRegisterName.getter_location (SOURCE_FILE ("instruction-assignment-control-register.galgas", 146)), GALGAS_string ("this control register is not accessible in user mode"), fixItArray11  COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 146)) ;
    }
  }
  GALGAS_objectIR var_sourceOperand_6892 ;
  callExtensionMethod_analyzeExpression ((const cPtr_expressionAST *) object->mProperty_mSourceExpression.ptr (), constinArgument_inSelfType, constinArgument_inRoutineAttributes, constinArgument_inCallerNameForInvocationGraph, var_registerType_5818, constinArgument_inContext, constinArgument_inMode, ioArgument_ioTemporaries, ioArgument_ioStaticEntityMap, ioArgument_ioUniversalMap, ioArgument_ioAllocaList, ioArgument_ioInstructionGenerationList, var_sourceOperand_6892, inCompiler COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 149)) ;
  {
  extensionSetter_appendLoadWhenReference (ioArgument_ioInstructionGenerationList, ioArgument_ioTemporaries, var_sourceOperand_6892, inCompiler COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 164)) ;
  }
  GALGAS_LValueRepresentation var_registerRepresentation_7143 ;
  switch (var_controlRegisterGroupKind_5936.enumValue ()) {
  case GALGAS_controlRegisterGroupKind::kNotBuilt:
    break ;
  case GALGAS_controlRegisterGroupKind::kEnum_single:
    {
      const cEnumAssociatedValues_controlRegisterGroupKind_single * extractPtr_8956 = (const cEnumAssociatedValues_controlRegisterGroupKind_single *) (var_controlRegisterGroupKind_5936.unsafePointer ()) ;
      const GALGAS_bigint extractedValue_registerAddress = extractPtr_8956->mAssociatedValue0 ;
      const enumGalgasBool test_12 = object->mProperty_mRegisterIndex.getter_isNoIndex (SOURCE_FILE ("instruction-assignment-control-register.galgas", 172)).boolEnum () ;
      if (kBoolTrue == test_12) {
        const enumGalgasBool test_13 = GALGAS_bool (kIsEqual, var_inRegisterArraySize_5979.objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
        if (kBoolTrue == test_13) {
          var_registerRepresentation_7143 = GALGAS_LValueRepresentation::constructor_volatileAbsoluteReference (var_registerType_5818, extractedValue_registerAddress.getter_uint (inCompiler COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 174))  COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 174)) ;
        }else if (kBoolFalse == test_13) {
          TC_Array <C_FixItDescription> fixItArray14 ;
          inCompiler->emitSemanticError (object->mProperty_mRegisterName.getter_location (SOURCE_FILE ("instruction-assignment-control-register.galgas", 176)), GALGAS_string ("the control register is an array"), fixItArray14  COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 176)) ;
          var_registerRepresentation_7143.drop () ; // Release error dropped variable
        }
      }else if (kBoolFalse == test_12) {
        GALGAS_expressionAST var_indexExpression_7670 ;
        GALGAS_location var_endOfIndex_7697 ;
        object->mProperty_mRegisterIndex.method_index (var_indexExpression_7670, var_endOfIndex_7697, inCompiler COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 179)) ;
        GALGAS_objectIR var_indexIR_8260 ;
        {
        routine_handleArraySubscriptNew (constinArgument_inSelfType, constinArgument_inRoutineAttributes, constinArgument_inCallerNameForInvocationGraph, constinArgument_inContext, constinArgument_inMode, ioArgument_ioTemporaries, ioArgument_ioStaticEntityMap, ioArgument_ioUniversalMap, ioArgument_ioAllocaList, var_indexExpression_7670, var_endOfIndex_7697, var_inRegisterArraySize_5979.getter_bigint (SOURCE_FILE ("instruction-assignment-control-register.galgas", 192)), var_registerType_5818, ioArgument_ioInstructionGenerationList, var_indexIR_8260, inCompiler  COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 180)) ;
        }
        const enumGalgasBool test_15 = var_indexIR_8260.getter_isLiteralInteger (SOURCE_FILE ("instruction-assignment-control-register.galgas", 197)).boolEnum () ;
        if (kBoolTrue == test_15) {
          GALGAS_bigint var_idx_8403 ;
          GALGAS_PLMType joker_8378_1 ; // Joker input parameter
          var_indexIR_8260.method_literalInteger (joker_8378_1, var_idx_8403, inCompiler COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 198)) ;
          GALGAS_bigint var_addr_8421 = extractedValue_registerAddress.add_operation (var_idx_8403.multiply_operation (var_inRegisterElementSize_6036.getter_bigint (SOURCE_FILE ("instruction-assignment-control-register.galgas", 199)), inCompiler COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 199)), inCompiler COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 199)) ;
          var_registerRepresentation_7143 = GALGAS_LValueRepresentation::constructor_volatileAbsoluteReference (var_registerType_5818, var_addr_8421.getter_uint (inCompiler COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 200))  COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 200)) ;
        }else if (kBoolFalse == test_15) {
          GALGAS_string var_llvmName_8635 ;
          {
          extensionSetter_newTempLLVMVar (ioArgument_ioTemporaries, var_llvmName_8635, inCompiler COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 202)) ;
          }
          {
          extensionSetter_appendComputeSubscriptedVolatileRegisterAddress (ioArgument_ioInstructionGenerationList, var_llvmName_8635, var_indexIR_8260, extractedValue_registerAddress, var_inRegisterElementSize_6036, inCompiler COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 203)) ;
          }
          var_registerRepresentation_7143 = GALGAS_LValueRepresentation::constructor_volatileIndirectReference (var_registerType_5818, var_llvmName_8635  COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 209)) ;
        }
      }
    }
    break ;
  }
  GALGAS_PLMType var_t_9011 = extensionGetter_type (var_sourceOperand_6892, inCompiler COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 214)) ;
  const enumGalgasBool test_16 = extensionGetter_copyable (var_t_9011, inCompiler COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 215)).operator_not (SOURCE_FILE ("instruction-assignment-control-register.galgas", 215)).boolEnum () ;
  if (kBoolTrue == test_16) {
    TC_Array <C_FixItDescription> fixItArray17 ;
    inCompiler->emitSemanticError (object->mProperty_mRegisterGroupName.getter_location (SOURCE_FILE ("instruction-assignment-control-register.galgas", 216)), GALGAS_string ("source expression is not copyable"), fixItArray17  COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 216)) ;
  }else if (kBoolFalse == test_16) {
    ...
    case GALGAS_controlRegisterAssignmentOperatorKind::kEnum_assignment:
      {
        switch (var_registerRepresentation_7143.enumValue ()) {
        case GALGAS_LValueRepresentation::kNotBuilt:
          break ;
        case GALGAS_LValueRepresentation::kEnum_volatileAbsoluteReference:
          {
            const cEnumAssociatedValues_LValueRepresentation_volatileAbsoluteReference * extractPtr_9387 = (const cEnumAssociatedValues_LValueRepresentation_volatileAbsoluteReference *) (var_registerRepresentation_7143.unsafePointer ()) ;
            const GALGAS_PLMType extractedValue_type = extractPtr_9387->mAssociatedValue0 ;
            const GALGAS_uint extractedValue_address = extractPtr_9387->mAssociatedValue1 ;
            {
            extensionSetter_appendStoreVolatileRegister (ioArgument_ioInstructionGenerationList, extractedValue_type, extractedValue_address.getter_bigint (SOURCE_FILE ("instruction-assignment-control-register.galgas", 222)), var_sourceOperand_6892, inCompiler COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 222)) ;
            }
          }
          break ;
        case GALGAS_LValueRepresentation::kEnum_volatileIndirectReference:
          {
            const cEnumAssociatedValues_LValueRepresentation_volatileIndirectReference * extractPtr_9566 = (const cEnumAssociatedValues_LValueRepresentation_volatileIndirectReference *) (var_registerRepresentation_7143.unsafePointer ()) ;
            const GALGAS_PLMType extractedValue_type = extractPtr_9566->mAssociatedValue0 ;
            const GALGAS_string extractedValue_llvmName = extractPtr_9566->mAssociatedValue1 ;
            {
            extensionSetter_appendStoreIndirectVolatileRegister (ioArgument_ioInstructionGenerationList, extractedValue_type, extractedValue_llvmName, var_sourceOperand_6892, inCompiler COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 224)) ;
            }
          }
          break ;
        case GALGAS_LValueRepresentation::kEnum_universalReference:
          {
            TC_Array <C_FixItDescription> fixItArray18 ;
            inCompiler->emitSemanticError (object->mProperty_mRegisterGroupName.getter_location (SOURCE_FILE ("instruction-assignment-control-register.galgas", 226)), GALGAS_string ("INTERNAL ERROR"), fixItArray18  COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 226)) ;
          }
          break ;
        }
      }
    ...
    case GALGAS_controlRegisterAssignmentOperatorKind::kEnum_assignmentWithOperator:
      {
        const cEnumAssociatedValues_controlRegisterAssignmentOperatorKind_assignmentWithOperator * extractPtr_11447 = (const cEnumAssociatedValues_controlRegisterAssignmentOperatorKind_assignmentWithOperator *) (object->mProperty_mAssignmentKind.unsafePointer ()) ;
        const GALGAS_infixOperator extractedValue_infixOperator = extractPtr_11447->mAssociatedValue0 ;
        const GALGAS_location extractedValue_operatorLocation = extractPtr_11447->mAssociatedValue1 ;
        GALGAS_objectIR var_registerValueIR_9854 ;
        {
        routine_getNewTempValue (var_registerType_5818, ioArgument_ioTemporaries, var_registerValueIR_9854, inCompiler  COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 230)) ;
        }
        switch (var_registerRepresentation_7143.enumValue ()) {
        case GALGAS_LValueRepresentation::kNotBuilt:
          break ;
        case GALGAS_LValueRepresentation::kEnum_volatileAbsoluteReference:
          {
            const cEnumAssociatedValues_LValueRepresentation_volatileAbsoluteReference * extractPtr_10041 = (const cEnumAssociatedValues_LValueRepresentation_volatileAbsoluteReference *) (var_registerRepresentation_7143.unsafePointer ()) ;
            const GALGAS_uint extractedValue_address = extractPtr_10041->mAssociatedValue1 ;
            {
            extensionSetter_appendLoadVolatileRegister (ioArgument_ioInstructionGenerationList, var_registerValueIR_9854, extractedValue_address.getter_bigint (SOURCE_FILE ("instruction-assignment-control-register.galgas", 233)), inCompiler COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 233)) ;
            }
          }
          break ;
        case GALGAS_LValueRepresentation::kEnum_volatileIndirectReference:
          {
            const cEnumAssociatedValues_LValueRepresentation_volatileIndirectReference * extractPtr_10192 = (const cEnumAssociatedValues_LValueRepresentation_volatileIndirectReference *) (var_registerRepresentation_7143.unsafePointer ()) ;
            const GALGAS_string extractedValue_llvmName = extractPtr_10192->mAssociatedValue1 ;
            {
            extensionSetter_appendLoadFromReference (ioArgument_ioInstructionGenerationList, var_registerValueIR_9854, extractedValue_llvmName, inCompiler COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 235)) ;
            }
          }
          break ;
        case GALGAS_LValueRepresentation::kEnum_universalReference:
          {
            ...
            inCompiler->emitSemanticError (object->mProperty_mRegisterGroupName.getter_location (SOURCE_FILE ("instruction-assignment-control-register.galgas", 237)), GALGAS_string ("INTERNAL ERROR"), fixItArray19  COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 237)) ;
          }
          break ;
        }
        GALGAS_infixOperatorMap var_operatorMap_10340 = function_getInfixOperatorMap (extractedValue_infixOperator, constinArgument_inContext, constinArgument_inMode, extractedValue_operatorLocation, inCompiler COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 240)) ;
        GALGAS_PLMType var_resultType_10632 ;
        GALGAS_infixOperatorDescription var_binaryOperator_10689 ;
        extensionMethod_checkBinaryOperationWith (var_operatorMap_10340, extensionGetter_type (var_registerValueIR_9854, inCompiler COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 242)), extensionGetter_type (var_sourceOperand_6892, inCompiler COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 243)), extractedValue_operatorLocation, var_resultType_10632, var_binaryOperator_10689, inCompiler COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 241)) ;
        GALGAS_objectIR var_operationResult_10930 ;
        callExtensionMethod_generateInfixOperatorCode ((const cPtr_infixOperatorDescription *) var_binaryOperator_10689.ptr (), ioArgument_ioTemporaries, ioArgument_ioInstructionGenerationList, var_registerValueIR_9854, extractedValue_operatorLocation, var_sourceOperand_6892, var_resultType_10632, var_operationResult_10930, inCompiler COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 248)) ;
        switch (var_registerRepresentation_7143.enumValue ()) {
        case GALGAS_LValueRepresentation::kNotBuilt:
          break ;
        case GALGAS_LValueRepresentation::kEnum_volatileAbsoluteReference:
          {
            const cEnumAssociatedValues_LValueRepresentation_volatileAbsoluteReference * extractPtr_11167 = (const cEnumAssociatedValues_LValueRepresentation_volatileAbsoluteReference *) (var_registerRepresentation_7143.unsafePointer ()) ;
            const GALGAS_PLMType extractedValue_type = extractPtr_11167->mAssociatedValue0 ;
            const GALGAS_uint extractedValue_address = extractPtr_11167->mAssociatedValue1 ;
            {
            extensionSetter_appendStoreVolatileRegister (ioArgument_ioInstructionGenerationList, extractedValue_type, extractedValue_address.getter_bigint (SOURCE_FILE ("instruction-assignment-control-register.galgas", 260)), var_operationResult_10930, inCompiler COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 260)) ;
            }
          }
          break ;
        case GALGAS_LValueRepresentation::kEnum_volatileIndirectReference:
          {
            const cEnumAssociatedValues_LValueRepresentation_volatileIndirectReference * extractPtr_11348 = (const cEnumAssociatedValues_LValueRepresentation_volatileIndirectReference *) (var_registerRepresentation_7143.unsafePointer ()) ;
            const GALGAS_PLMType extractedValue_type = extractPtr_11348->mAssociatedValue0 ;
            const GALGAS_string extractedValue_llvmName = extractPtr_11348->mAssociatedValue1 ;
            {
            extensionSetter_appendStoreIndirectVolatileRegister (ioArgument_ioInstructionGenerationList, extractedValue_type, extractedValue_llvmName, var_operationResult_10930, inCompiler COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 262)) ;
            }
          }
          break ;
        case GALGAS_LValueRepresentation::kEnum_universalReference:
          {
            TC_Array <C_FixItDescription> fixItArray20 ;
            inCompiler->emitSemanticError (object->mProperty_mRegisterGroupName.getter_location (SOURCE_FILE ("instruction-assignment-control-register.galgas", 264)), GALGAS_string ("INTERNAL ERROR"), fixItArray20  COMMA_SOURCE_FILE ("instruction-assignment-control-register.galgas", 264)) ;
          }
          break ;
        }
      }
