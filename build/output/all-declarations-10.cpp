...
static void extensionMethod_sizeofExpressionAST_analyzeExpression (const cPtr_expressionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    GALGAS_PLMType var_type_4844 ;
    extensionMethod_searchValuedObjectType (ioArgument_ioUniversalMap, constinArgument_inSelfType, object->mProperty_mLValue.getter_mIdentifier (HERE), object->mProperty_mLValue.getter_mKind (HERE), var_type_4844, inCompiler COMMA_SOURCE_FILE ("expression-sizeof.galgas", 105)) ;
    GALGAS_unifiedTypeMap_2D_proxy var_resultTypeProxy_4869 = GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inContext.getter_mTypeMap (HERE), GALGAS_string ("uint").add_operation (constinArgument_inContext.getter_mTargetParameters (HERE).getter_mPointerSize (HERE).getter_string (SOURCE_FILE ("expression-sizeof.galgas", 108)), inCompiler COMMA_SOURCE_FILE ("expression-sizeof.galgas", 108)).getter_nowhere (SOURCE_FILE ("expression-sizeof.galgas", 108)), inCompiler  COMMA_SOURCE_FILE ("expression-sizeof.galgas", 106)) ;
    GALGAS_PLMType var_resultType_5023 = var_resultTypeProxy_4869.getter_type (inCompiler COMMA_SOURCE_FILE ("expression-sizeof.galgas", 110)) ;
    {
    routine_getNewTempValue (var_resultType_5023, ioArgument_ioTemporaries, outArgument_outResult, inCompiler  COMMA_SOURCE_FILE ("expression-sizeof.galgas", 111)) ;
    }
    ioArgument_ioInstructionGenerationList.addAssign_operation (GALGAS_sizeofInstructionIR::constructor_new (outArgument_outResult, var_type_4844  COMMA_SOURCE_FILE ("expression-sizeof.galgas", 112))  COMMA_SOURCE_FILE ("expression-sizeof.galgas", 112)) ;
  }
}
...
static void extensionMethod_sizeofTypeAST_analyzeExpression (const cPtr_expressionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    GALGAS_PLMType var_type_6311 = GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inContext.getter_mTypeMap (HERE), object->mProperty_mTypeName, inCompiler  COMMA_SOURCE_FILE ("expression-sizeof.galgas", 140)).getter_type (inCompiler COMMA_SOURCE_FILE ("expression-sizeof.galgas", 140)) ;
    GALGAS_unifiedTypeMap_2D_proxy var_resultTypeProxy_6409 = GALGAS_unifiedTypeMap_2D_proxy::constructor_searchKey (constinArgument_inContext.getter_mTypeMap (HERE), GALGAS_string ("uint").add_operation (constinArgument_inContext.getter_mTargetParameters (HERE).getter_mPointerSize (HERE).getter_string (SOURCE_FILE ("expression-sizeof.galgas", 143)), inCompiler COMMA_SOURCE_FILE ("expression-sizeof.galgas", 143)).getter_nowhere (SOURCE_FILE ("expression-sizeof.galgas", 143)), inCompiler  COMMA_SOURCE_FILE ("expression-sizeof.galgas", 141)) ;
    GALGAS_PLMType var_resultType_6563 = var_resultTypeProxy_6409.getter_type (inCompiler COMMA_SOURCE_FILE ("expression-sizeof.galgas", 145)) ;
    {
    routine_getNewTempValue (var_resultType_6563, ioArgument_ioTemporaries, outArgument_outResult, inCompiler  COMMA_SOURCE_FILE ("expression-sizeof.galgas", 146)) ;
    }
    ioArgument_ioInstructionGenerationList.addAssign_operation (GALGAS_sizeofInstructionIR::constructor_new (outArgument_outResult, var_type_6311  COMMA_SOURCE_FILE ("expression-sizeof.galgas", 147))  COMMA_SOURCE_FILE ("expression-sizeof.galgas", 147)) ;
  }
}
...
static void extensionMethod_typedConstantCallAST_addDependenceEdgeForStaticExpression (const cPtr_expressionAST * inObject,
  ...
  while (enumerator_2274.hasCurrentObject ()) {
    ...
    case GALGAS_primaryInExpressionAccessAST::kEnum_arrayAccess:
      {
        const cEnumAssociatedValues_primaryInExpressionAccessAST_arrayAccess * extractPtr_2517 = (const cEnumAssociatedValues_primaryInExpressionAccessAST_arrayAccess *) (enumerator_2274.current_mAccess (HERE).unsafePointer ()) ;
        const GALGAS_expressionAST extractedValue_indexExpression = extractPtr_2517->mAssociatedValue0 ;
    ...
    case GALGAS_primaryInExpressionAccessAST::kEnum_funcCall:
      {
        const cEnumAssociatedValues_primaryInExpressionAccessAST_funcCall * extractPtr_3058 = (const cEnumAssociatedValues_primaryInExpressionAccessAST_funcCall *) (enumerator_2274.current_mAccess (HERE).unsafePointer ()) ;
        const GALGAS_effectiveArgumentListAST extractedValue_arguments = extractPtr_3058->mAssociatedValue1 ;
        cEnumerator_effectiveArgumentListAST enumerator_2605 (extractedValue_arguments, kENUMERATION_UP) ;
        while (enumerator_2605.hasCurrentObject ()) {
          switch (enumerator_2605.current_mEffectiveParameterKind (HERE).enumValue ()) {
          ...
          case GALGAS_effectiveArgumentPassingModeAST::kEnum_inputWithType:
            {
              const cEnumAssociatedValues_effectiveArgumentPassingModeAST_inputWithType * extractPtr_2848 = (const cEnumAssociatedValues_effectiveArgumentPassingModeAST_inputWithType *) (enumerator_2605.current_mEffectiveParameterKind (HERE).unsafePointer ()) ;
              const GALGAS_lstring extractedValue_typeName = extractPtr_2848->mAssociatedValue1 ;
          ...
          case GALGAS_effectiveArgumentPassingModeAST::kEnum_output:
            {
              const cEnumAssociatedValues_effectiveArgumentPassingModeAST_output * extractPtr_2961 = (const cEnumAssociatedValues_effectiveArgumentPassingModeAST_output *) (enumerator_2605.current_mEffectiveParameterKind (HERE).unsafePointer ()) ;
              const GALGAS_expressionAST extractedValue_expression = extractPtr_2961->mAssociatedValue0 ;
...
static void extensionMethod_registerInExpressionAST_addDependenceEdgeForStaticExpression (const cPtr_expressionAST * inObject,
  ...
  {
  ioArgument_ioGraph.setter_addEdge (constinArgument_inConstantName, object->mProperty_mGroupName COMMA_SOURCE_FILE ("expression-control-register.galgas", 64)) ;
  }
  ...
  case GALGAS_registerIndexAST::kEnum_index:
    {
      const cEnumAssociatedValues_registerIndexAST_index * extractPtr_2814 = (const cEnumAssociatedValues_registerIndexAST_index *) (object->mProperty_mRegisterIndex.unsafePointer ()) ;
      const GALGAS_expressionAST extractedValue_indexExpression = extractPtr_2814->mAssociatedValue0 ;
      callExtensionMethod_addDependenceEdgeForStaticExpression ((const cPtr_expressionAST *) extractedValue_indexExpression.ptr (), constinArgument_inConstantName, ioArgument_ioGraph, inCompiler COMMA_SOURCE_FILE ("expression-control-register.galgas", 68)) ;
    }
    break ;
  }
}
...
static void extensionMethod_registerInExpressionAST_noteExpressionTypesInPrecedenceGraph (const cPtr_expressionAST * inObject,
  ...
  case GALGAS_registerIndexAST::kEnum_index:
    {
      const cEnumAssociatedValues_registerIndexAST_index * extractPtr_3466 = (const cEnumAssociatedValues_registerIndexAST_index *) (object->mProperty_mRegisterIndex.unsafePointer ()) ;
      const GALGAS_expressionAST extractedValue_indexExpression = extractPtr_3466->mAssociatedValue0 ;
      callExtensionMethod_noteExpressionTypesInPrecedenceGraph ((const cPtr_expressionAST *) extractedValue_indexExpression.ptr (), ioArgument_ioGraph, inCompiler COMMA_SOURCE_FILE ("expression-control-register.galgas", 80)) ;
    }
    break ;
  }
}
...
static void extensionMethod_registerInExpressionAST_analyzeExpression (const cPtr_expressionAST * inObject,
  ...
  const cPtr_registerInExpressionAST * object = (const cPtr_registerInExpressionAST *) inObject ;
  macroValidSharedObject (object, cPtr_registerInExpressionAST) ;
  GALGAS_valuedObject var_entity_4560 ;
  extensionMethod_searchEntity (ioArgument_ioUniversalMap, object->mProperty_mGroupName, var_entity_4560, inCompiler COMMA_SOURCE_FILE ("expression-control-register.galgas", 102)) ;
  switch (var_entity_4560.enumValue ()) {
  case GALGAS_valuedObject::kNotBuilt:
    break ;
  case GALGAS_valuedObject::kEnum_globalConstant:
    {
      TC_Array <C_FixItDescription> fixItArray0 ;
      inCompiler->emitSemanticError (object->mProperty_mGroupName.getter_location (SOURCE_FILE ("expression-control-register.galgas", 105)), GALGAS_string ("the \":\" access is reserved for a control register"), fixItArray0  COMMA_SOURCE_FILE ("expression-control-register.galgas", 105)) ;
      outArgument_outResult.drop () ; // Release error dropped variable
    }
    break ;
  case GALGAS_valuedObject::kEnum_driver:
    {
      TC_Array <C_FixItDescription> fixItArray1 ;
      inCompiler->emitSemanticError (object->mProperty_mGroupName.getter_location (SOURCE_FILE ("expression-control-register.galgas", 107)), GALGAS_string ("the \":\" access is reserved for a control register"), fixItArray1  COMMA_SOURCE_FILE ("expression-control-register.galgas", 107)) ;
      outArgument_outResult.drop () ; // Release error dropped variable
    }
    break ;
  case GALGAS_valuedObject::kEnum_globalSyncInstance:
    {
      TC_Array <C_FixItDescription> fixItArray2 ;
      inCompiler->emitSemanticError (object->mProperty_mGroupName.getter_location (SOURCE_FILE ("expression-control-register.galgas", 109)), GALGAS_string ("the \":\" access is reserved for a control register"), fixItArray2  COMMA_SOURCE_FILE ("expression-control-register.galgas", 109)) ;
      outArgument_outResult.drop () ; // Release error dropped variable
    }
    break ;
  case GALGAS_valuedObject::kEnum_localConstant:
    {
      TC_Array <C_FixItDescription> fixItArray3 ;
      inCompiler->emitSemanticError (object->mProperty_mGroupName.getter_location (SOURCE_FILE ("expression-control-register.galgas", 111)), GALGAS_string ("the \":\" access is reserved for a control register"), fixItArray3  COMMA_SOURCE_FILE ("expression-control-register.galgas", 111)) ;
      outArgument_outResult.drop () ; // Release error dropped variable
    }
    break ;
  case GALGAS_valuedObject::kEnum_localVariable:
    {
      TC_Array <C_FixItDescription> fixItArray4 ;
      inCompiler->emitSemanticError (object->mProperty_mGroupName.getter_location (SOURCE_FILE ("expression-control-register.galgas", 113)), GALGAS_string ("the \":\" access is reserved for a control register"), fixItArray4  COMMA_SOURCE_FILE ("expression-control-register.galgas", 113)) ;
      outArgument_outResult.drop () ; // Release error dropped variable
    }
    break ;
  case GALGAS_valuedObject::kEnum_task:
    {
      TC_Array <C_FixItDescription> fixItArray5 ;
      inCompiler->emitSemanticError (object->mProperty_mGroupName.getter_location (SOURCE_FILE ("expression-control-register.galgas", 115)), GALGAS_string ("the \":\" access is reserved for a control register"), fixItArray5  COMMA_SOURCE_FILE ("expression-control-register.galgas", 115)) ;
      outArgument_outResult.drop () ; // Release error dropped variable
    }
    break ;
  case GALGAS_valuedObject::kEnum_registerGroup:
    {
      const cEnumAssociatedValues_valuedObject_registerGroup * extractPtr_6185 = (const cEnumAssociatedValues_valuedObject_registerGroup *) (var_entity_4560.unsafePointer ()) ;
      const GALGAS_controlRegisterMap extractedValue_registerMap = extractPtr_6185->mAssociatedValue0 ;
      const enumGalgasBool test_6 = constinArgument_inRoutineAttributes.getter_guard (SOURCE_FILE ("expression-control-register.galgas", 117)).boolEnum () ;
      if (kBoolTrue == test_6) {
        TC_Array <C_FixItDescription> fixItArray7 ;
        inCompiler->emitSemanticError (object->mProperty_mGroupName.getter_location (SOURCE_FILE ("expression-control-register.galgas", 118)), GALGAS_string ("control register is not readable in guard"), fixItArray7  COMMA_SOURCE_FILE ("expression-control-register.galgas", 118)) ;
        outArgument_outResult.drop () ; // Release error dropped variable
      }else if (kBoolFalse == test_6) {
        const enumGalgasBool test_8 = constinArgument_inRoutineAttributes.getter_controlRegisterReadable (SOURCE_FILE ("expression-control-register.galgas", 119)).operator_not (SOURCE_FILE ("expression-control-register.galgas", 119)).boolEnum () ;
        if (kBoolTrue == test_8) {
          TC_Array <C_FixItDescription> fixItArray9 ;
          inCompiler->emitSemanticError (object->mProperty_mGroupName.getter_location (SOURCE_FILE ("expression-control-register.galgas", 120)), GALGAS_string ("control register is not readable in this context"), fixItArray9  COMMA_SOURCE_FILE ("expression-control-register.galgas", 120)) ;
          outArgument_outResult.drop () ; // Release error dropped variable
        }else if (kBoolFalse == test_8) {
          {
          routine_analyzeRegisterExpression (constinArgument_inSelfType, constinArgument_inRoutineAttributes, constinArgument_inCallerNameForInvocationGraph, constinArgument_inContext, constinArgument_inMode, ioArgument_ioTemporaries, ioArgument_ioStaticEntityMap, ioArgument_ioUniversalMap, ioArgument_ioAllocaList, ioArgument_ioInstructionGenerationList, extractedValue_registerMap, object->mProperty_mRegisterName, object->mProperty_mRegisterIndex, object->mProperty_mFieldName, outArgument_outResult, inCompiler  COMMA_SOURCE_FILE ("expression-control-register.galgas", 122)) ;
          }
        }
      }
    }
...
void routine_analyzeRegisterExpression (const GALGAS_PLMType constinArgument_inSelfType,
                                        ...
                                        const GALGAS_registerIndexAST constinArgument_inRegisterIndex,
                                        const GALGAS_lstring constinArgument_inFieldName,
                                        GALGAS_objectIR & outArgument_outResult,
                                        C_Compiler * inCompiler
                                        COMMA_UNUSED_LOCATION_ARGS) {
  outArgument_outResult.drop () ; // Release 'out' argument
  GALGAS_PLMType var_inRegisterType_7215 ;
  GALGAS_bool var_userAccess_7248 ;
  GALGAS_sliceMap var_inRegisterSliceMap_7286 ;
  GALGAS_controlRegisterFieldMap var_mRegisterFieldMap_7345 ;
  GALGAS_controlRegisterGroupKind var_controlRegisterGroupKind_7405 ;
  GALGAS_controlRegisterFieldList var_mControlRegisterFieldList_7473 ;
  GALGAS_uint var_mRegisterBitCount_7534 ;
  GALGAS_uint var_inRegisterArraySize_7569 ;
  GALGAS_uint var_inRegisterElementSize_7626 ;
  GALGAS_bool joker_7221 ; // Joker input parameter
  constinArgument_inControlRegisterMap.method_searchKey (constinArgument_inRegisterName, var_inRegisterType_7215, joker_7221, var_userAccess_7248, var_inRegisterSliceMap_7286, var_mRegisterFieldMap_7345, var_controlRegisterGroupKind_7405, var_mControlRegisterFieldList_7473, var_mRegisterBitCount_7534, var_inRegisterArraySize_7569, var_inRegisterElementSize_7626, inCompiler COMMA_SOURCE_FILE ("expression-control-register.galgas", 163)) ;
  switch (constinArgument_inRegisterIndex.enumValue ()) {
  case GALGAS_registerIndexAST::kNotBuilt:
    break ;
  case GALGAS_registerIndexAST::kEnum_noIndex:
    {
      {
      routine_getNewTempValue (var_inRegisterType_7215, ioArgument_ioTemporaries, outArgument_outResult, inCompiler  COMMA_SOURCE_FILE ("expression-control-register.galgas", 179)) ;
      }
      switch (var_controlRegisterGroupKind_7405.enumValue ()) {
      case GALGAS_controlRegisterGroupKind::kNotBuilt:
        break ;
      case GALGAS_controlRegisterGroupKind::kEnum_single:
        {
          const cEnumAssociatedValues_controlRegisterGroupKind_single * extractPtr_7959 = (const cEnumAssociatedValues_controlRegisterGroupKind_single *) (var_controlRegisterGroupKind_7405.unsafePointer ()) ;
          const GALGAS_bigint extractedValue_registerAddress = extractPtr_7959->mAssociatedValue0 ;
          {
          extensionSetter_appendLoadVolatileRegister (ioArgument_ioInstructionGenerationList, outArgument_outResult, extractedValue_registerAddress, inCompiler COMMA_SOURCE_FILE ("expression-control-register.galgas", 182)) ;
          }
        }
        break ;
      }
  ...
  case GALGAS_registerIndexAST::kEnum_index:
    {
      const cEnumAssociatedValues_registerIndexAST_index * extractPtr_9386 = (const cEnumAssociatedValues_registerIndexAST_index *) (constinArgument_inRegisterIndex.unsafePointer ()) ;
      const GALGAS_expressionAST extractedValue_indexExpression = extractPtr_9386->mAssociatedValue0 ;
      const GALGAS_location extractedValue_endOfIndex = extractPtr_9386->mAssociatedValue1 ;
      GALGAS_objectIR var_indexIR_8584 ;
      {
      routine_handleArraySubscriptNew (constinArgument_inSelfType, constinArgument_inRoutineAttributes, constinArgument_inCallerNameForInvocationGraph, constinArgument_inContext, constinArgument_inMode, ioArgument_ioTemporaries, ioArgument_ioStaticEntityMap, ioArgument_ioUniversalMap, ioArgument_ioAllocaList, extractedValue_indexExpression, extractedValue_endOfIndex, var_inRegisterArraySize_7569.getter_bigint (SOURCE_FILE ("expression-control-register.galgas", 197)), var_inRegisterType_7215, ioArgument_ioInstructionGenerationList, var_indexIR_8584, inCompiler  COMMA_SOURCE_FILE ("expression-control-register.galgas", 185)) ;
      }
      const enumGalgasBool test_0 = var_indexIR_8584.getter_isLiteralInteger (SOURCE_FILE ("expression-control-register.galgas", 202)).boolEnum () ;
      if (kBoolTrue == test_0) {
        GALGAS_bigint var_idx_8721 ;
        GALGAS_PLMType joker_8696_1 ; // Joker input parameter
        var_indexIR_8584.method_literalInteger (joker_8696_1, var_idx_8721, inCompiler COMMA_SOURCE_FILE ("expression-control-register.galgas", 203)) ;
        switch (var_controlRegisterGroupKind_7405.enumValue ()) {
        case GALGAS_controlRegisterGroupKind::kNotBuilt:
          break ;
        case GALGAS_controlRegisterGroupKind::kEnum_single:
          {
            const cEnumAssociatedValues_controlRegisterGroupKind_single * extractPtr_9016 = (const cEnumAssociatedValues_controlRegisterGroupKind_single *) (var_controlRegisterGroupKind_7405.unsafePointer ()) ;
            const GALGAS_bigint extractedValue_registerAddress = extractPtr_9016->mAssociatedValue0 ;
            GALGAS_bigint var_addr_8815 = extractedValue_registerAddress.add_operation (var_idx_8721.multiply_operation (var_inRegisterElementSize_7626.getter_bigint (SOURCE_FILE ("expression-control-register.galgas", 206)), inCompiler COMMA_SOURCE_FILE ("expression-control-register.galgas", 206)), inCompiler COMMA_SOURCE_FILE ("expression-control-register.galgas", 206)) ;
            {
            routine_getNewTempValue (var_inRegisterType_7215, ioArgument_ioTemporaries, outArgument_outResult, inCompiler  COMMA_SOURCE_FILE ("expression-control-register.galgas", 207)) ;
            }
            {
            extensionSetter_appendLoadVolatileRegister (ioArgument_ioInstructionGenerationList, outArgument_outResult, var_addr_8815, inCompiler COMMA_SOURCE_FILE ("expression-control-register.galgas", 208)) ;
            }
          }
          break ;
        }
        ...
        {
        routine_getNewTempValue (var_inRegisterType_7215, ioArgument_ioTemporaries, outArgument_outResult, inCompiler  COMMA_SOURCE_FILE ("expression-control-register.galgas", 211)) ;
        }
        switch (var_controlRegisterGroupKind_7405.enumValue ()) {
        case GALGAS_controlRegisterGroupKind::kNotBuilt:
          break ;
        case GALGAS_controlRegisterGroupKind::kEnum_single:
          {
            const cEnumAssociatedValues_controlRegisterGroupKind_single * extractPtr_9368 = (const cEnumAssociatedValues_controlRegisterGroupKind_single *) (var_controlRegisterGroupKind_7405.unsafePointer ()) ;
            const GALGAS_bigint extractedValue_registerAddress = extractPtr_9368->mAssociatedValue0 ;
            {
            extensionSetter_appendLoadVolatileRegisterWithSubscript (ioArgument_ioInstructionGenerationList, outArgument_outResult, var_indexIR_8584, extractedValue_registerAddress, var_inRegisterElementSize_7626.getter_bigint (SOURCE_FILE ("expression-control-register.galgas", 218)), inCompiler COMMA_SOURCE_FILE ("expression-control-register.galgas", 214)) ;
            }
          }
          break ;
        }
  ...
  const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, constinArgument_inFieldName.getter_string (HERE).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
  if (kBoolTrue == test_1) {
    GALGAS_llvmBinaryOperation var_accessOperator_9562 ;
    GALGAS_bigint var_accessRightOperand_9600 ;
    GALGAS_PLMType var_resultType_9640 ;
    GALGAS_sliceMap joker_9608 ; // Joker input parameter
    var_inRegisterSliceMap_7286.method_searchKey (constinArgument_inFieldName, var_accessOperator_9562, var_accessRightOperand_9600, joker_9608, var_resultType_9640, inCompiler COMMA_SOURCE_FILE ("expression-control-register.galgas", 225)) ;
    GALGAS_objectIR var_resultIR_9709 ;
    {
    routine_getNewTempValue (var_resultType_9640, ioArgument_ioTemporaries, var_resultIR_9709, inCompiler  COMMA_SOURCE_FILE ("expression-control-register.galgas", 232)) ;
    }
    {
    extensionSetter_appendBinaryOperation (ioArgument_ioInstructionGenerationList, var_resultIR_9709, extensionGetter_type (outArgument_outResult, inCompiler COMMA_SOURCE_FILE ("expression-control-register.galgas", 235)), constinArgument_inFieldName.getter_location (HERE), outArgument_outResult, var_accessOperator_9562, GALGAS_objectIR::constructor_literalInteger (function_staticIntegerType (inCompiler COMMA_SOURCE_FILE ("expression-control-register.galgas", 239)), var_accessRightOperand_9600  COMMA_SOURCE_FILE ("expression-control-register.galgas", 239)), inCompiler COMMA_SOURCE_FILE ("expression-control-register.galgas", 233)) ;
    }
    outArgument_outResult = var_resultIR_9709 ;
  }
  GALGAS_bool test_2 = var_userAccess_7248.operator_not (SOURCE_FILE ("expression-control-register.galgas", 244)) ;
  if (kBoolTrue == test_2.boolEnum ()) {
    GALGAS_bool test_3 = constinArgument_inMode.getter_isUserMode (SOURCE_FILE ("expression-control-register.galgas", 244)) ;
    if (kBoolTrue != test_3.boolEnum ()) {
      test_3 = constinArgument_inMode.getter_isAnyMode (SOURCE_FILE ("expression-control-register.galgas", 244)) ;
    }
    test_2 = test_3 ;
  }
  ...
  if (kBoolTrue == test_4) {
    TC_Array <C_FixItDescription> fixItArray5 ;
    inCompiler->emitSemanticError (constinArgument_inRegisterName.getter_location (SOURCE_FILE ("expression-control-register.galgas", 245)), GALGAS_string ("this control register is not accessible in user mode"), fixItArray5  COMMA_SOURCE_FILE ("expression-control-register.galgas", 245)) ;
    outArgument_outResult.drop () ; // Release error dropped variable
  }
}
...
static void extensionMethod_registerConstantExpressionAST_analyzeExpression (const cPtr_expressionAST * inObject,
  ...
  GALGAS_uint var_registerBitCount_4589 ;
  GALGAS_uint var_powerOfTwoForArraySize_4628 ;
  GALGAS_uint var_elementArraySize_4661 ;
  GALGAS_bool joker_4456_2 ; // Joker input parameter
  GALGAS_bool joker_4456_1 ; // Joker input parameter
  GALGAS_controlRegisterGroupKind joker_4561_2 ; // Joker input parameter
  GALGAS_controlRegisterFieldList joker_4561_1 ; // Joker input parameter
  var_controlRegisterMap_4293.method_searchKey (object->mProperty_mRegisterName, var_registerType_4450, joker_4456_2, joker_4456_1, var_registerBitSliceMap_4504, var_registerFieldMap_4555, joker_4561_2, joker_4561_1, var_registerBitCount_4589, var_powerOfTwoForArraySize_4628, var_elementArraySize_4661, inCompiler COMMA_SOURCE_FILE ("expression-register-value-from-slices.galgas", 93)) ;
  GALGAS_bigint var_accumulatedFieldStaticValues_4776 = GALGAS_bigint ("0", inCompiler  COMMA_SOURCE_FILE ("expression-register-value-from-slices.galgas", 105)) ;
  GALGAS_operandIRList var_operandList_4810 = GALGAS_operandIRList::constructor_emptyList (SOURCE_FILE ("expression-register-value-from-slices.galgas", 106)) ;
  cEnumerator_registerIntegerFieldListAST enumerator_4879 (object->mProperty_mFieldValues, kENUMERATION_UP) ;
  while (enumerator_4879.hasCurrentObject ()) {
    const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, enumerator_4879.current_mFieldName (HERE).getter_string (HERE).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      TC_Array <C_FixItDescription> fixItArray1 ;
      inCompiler->emitSemanticError (enumerator_4879.current_mFieldName (HERE).getter_location (SOURCE_FILE ("expression-register-value-from-slices.galgas", 109)), GALGAS_string ("anonymous selector not allowed here"), fixItArray1  COMMA_SOURCE_FILE ("expression-register-value-from-slices.galgas", 109)) ;
      var_operandList_4810.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_0) {
      GALGAS_uint var_fieldBitIndex_5088 ;
      GALGAS_uint var_fieldBitCount_5121 ;
      var_registerFieldMap_4555.method_searchKey (enumerator_4879.current_mFieldName (HERE), var_fieldBitIndex_5088, var_fieldBitCount_5121, inCompiler COMMA_SOURCE_FILE ("expression-register-value-from-slices.galgas", 111)) ;
      GALGAS_lstring var_inferredTypeName_5156 = GALGAS_lstring::constructor_new (GALGAS_string ("uint").add_operation (var_fieldBitCount_5121.getter_string (SOURCE_FILE ("expression-register-value-from-slices.galgas", 116)), inCompiler COMMA_SOURCE_FILE ("expression-register-value-from-slices.galgas", 116)), enumerator_4879.current_mFieldName (HERE).getter_location (HERE)  COMMA_SOURCE_FILE ("expression-register-value-from-slices.galgas", 116)) ;
      GALGAS_PLMType var_inferredType_5299 ;
      GALGAS_uint joker_5301_1 ; // Joker input parameter
      constinArgument_inContext.getter_mTypeMap (HERE).method_searchKey (var_inferredTypeName_5156, var_inferredType_5299, joker_5301_1, inCompiler COMMA_SOURCE_FILE ("expression-register-value-from-slices.galgas", 117)) ;
      GALGAS_objectIR var_expressionResult_5850 ;
      callExtensionMethod_analyzeExpression ((const cPtr_expressionAST *) enumerator_4879.current_mExpression (HERE).ptr (), constinArgument_inSelfType, constinArgument_inRoutineAttributes, constinArgument_inCallerNameForInvocationGraph, var_inferredType_5299, constinArgument_inContext, constinArgument_inCurrentMode, ioArgument_ioTemporaries, ioArgument_ioStaticEntityMap, ioArgument_ioUniversalMap, ioArgument_ioAllocaList, ioArgument_ioInstructionGenerationList, var_expressionResult_5850, inCompiler COMMA_SOURCE_FILE ("expression-register-value-from-slices.galgas", 119)) ;
      {
      extensionSetter_appendLoadWhenReference (ioArgument_ioInstructionGenerationList, ioArgument_ioTemporaries, var_expressionResult_5850, inCompiler COMMA_SOURCE_FILE ("expression-register-value-from-slices.galgas", 133)) ;
      }
      const enumGalgasBool test_2 = extensionGetter_type (var_expressionResult_5850, inCompiler COMMA_SOURCE_FILE ("expression-register-value-from-slices.galgas", 138)).getter_kind (HERE).getter_isStaticInteger (SOURCE_FILE ("expression-register-value-from-slices.galgas", 138)).boolEnum () ;
      if (kBoolTrue == test_2) {
        GALGAS_bigint var_value_6143 ;
        GALGAS_PLMType joker_6116_1 ; // Joker input parameter
        var_expressionResult_5850.method_literalInteger (joker_6116_1, var_value_6143, inCompiler COMMA_SOURCE_FILE ("expression-register-value-from-slices.galgas", 139)) ;
        const enumGalgasBool test_3 = GALGAS_bool (kIsStrictInf, var_value_6143.objectCompare (GALGAS_bigint ("0", inCompiler  COMMA_SOURCE_FILE ("expression-register-value-from-slices.galgas", 140)))).boolEnum () ;
        if (kBoolTrue == test_3) {
          TC_Array <C_FixItDescription> fixItArray4 ;
          inCompiler->emitSemanticError (enumerator_4879.current_mExpressionLocation (HERE), GALGAS_string ("this integer expression should be positive"), fixItArray4  COMMA_SOURCE_FILE ("expression-register-value-from-slices.galgas", 141)) ;
        }else if (kBoolFalse == test_3) {
          const enumGalgasBool test_5 = GALGAS_bool (kIsStrictInf, var_value_6143.objectCompare (GALGAS_bigint ("1", inCompiler  COMMA_SOURCE_FILE ("expression-register-value-from-slices.galgas", 142)).left_shift_operation (var_fieldBitCount_5121 COMMA_SOURCE_FILE ("expression-register-value-from-slices.galgas", 142)))).boolEnum () ;
          if (kBoolTrue == test_5) {
            var_accumulatedFieldStaticValues_4776 = var_accumulatedFieldStaticValues_4776.operator_or (var_value_6143.left_shift_operation (var_fieldBitIndex_5088 COMMA_SOURCE_FILE ("expression-register-value-from-slices.galgas", 143)) COMMA_SOURCE_FILE ("expression-register-value-from-slices.galgas", 143)) ;
          }else if (kBoolFalse == test_5) {
            TC_Array <C_FixItDescription> fixItArray6 ;
            inCompiler->emitSemanticError (enumerator_4879.current_mExpressionLocation (HERE), GALGAS_string ("expression too large (should be < ").add_operation (GALGAS_bigint ("1", inCompiler  COMMA_SOURCE_FILE ("expression-register-value-from-slices.galgas", 145)).left_shift_operation (var_fieldBitCount_5121 COMMA_SOURCE_FILE ("expression-register-value-from-slices.galgas", 145)).getter_string (SOURCE_FILE ("expression-register-value-from-slices.galgas", 145)), inCompiler COMMA_SOURCE_FILE ("expression-register-value-from-slices.galgas", 145)).add_operation (GALGAS_string (")"), inCompiler COMMA_SOURCE_FILE ("expression-register-value-from-slices.galgas", 145)), fixItArray6  COMMA_SOURCE_FILE ("expression-register-value-from-slices.galgas", 145)) ;
          }
        }
      }else if (kBoolFalse == test_2) {
        const enumGalgasBool test_7 = extensionGetter_type (var_expressionResult_5850, inCompiler COMMA_SOURCE_FILE ("expression-register-value-from-slices.galgas", 147)).getter_kind (HERE).getter_isInteger (SOURCE_FILE ("expression-register-value-from-slices.galgas", 147)).boolEnum () ;
        if (kBoolTrue == test_7) {
          GALGAS_bool var_unsigned_6664 ;
          GALGAS_uint var_expressionBitCount_6703 ;
          GALGAS_bigint joker_6633_2 ; // Joker input parameter
          GALGAS_bigint joker_6633_1 ; // Joker input parameter
          extensionGetter_type (var_expressionResult_5850, inCompiler COMMA_SOURCE_FILE ("expression-register-value-from-slices.galgas", 148)).getter_kind (HERE).method_integer (joker_6633_2, joker_6633_1, var_unsigned_6664, var_expressionBitCount_6703, inCompiler COMMA_SOURCE_FILE ("expression-register-value-from-slices.galgas", 148)) ;
          const enumGalgasBool test_8 = var_unsigned_6664.operator_not (SOURCE_FILE ("expression-register-value-from-slices.galgas", 149)).boolEnum () ;
          if (kBoolTrue == test_8) {
            TC_Array <C_FixItDescription> fixItArray9 ;
            inCompiler->emitSemanticError (enumerator_4879.current_mExpressionLocation (HERE), GALGAS_string ("an unsigned integer expression is required here"), fixItArray9  COMMA_SOURCE_FILE ("expression-register-value-from-slices.galgas", 150)) ;
          }else if (kBoolFalse == test_8) {
            const enumGalgasBool test_10 = GALGAS_bool (kIsNotEqual, var_expressionBitCount_6703.objectCompare (var_fieldBitCount_5121)).boolEnum () ;
            if (kBoolTrue == test_10) {
              TC_Array <C_FixItDescription> fixItArray11 ;
              inCompiler->emitSemanticError (enumerator_4879.current_mExpressionLocation (HERE), GALGAS_string ("type error, $uint").add_operation (var_fieldBitCount_5121.getter_string (SOURCE_FILE ("expression-register-value-from-slices.galgas", 152)), inCompiler COMMA_SOURCE_FILE ("expression-register-value-from-slices.galgas", 152)).add_operation (GALGAS_string (" type required"), inCompiler COMMA_SOURCE_FILE ("expression-register-value-from-slices.galgas", 152)), fixItArray11  COMMA_SOURCE_FILE ("expression-register-value-from-slices.galgas", 152)) ;
            }else if (kBoolFalse == test_10) {
              GALGAS_objectIR var_partialResult_7072 = var_expressionResult_5850 ;
              const enumGalgasBool test_12 = GALGAS_bool (kIsStrictInf, var_expressionBitCount_6703.objectCompare (var_registerBitCount_4589)).boolEnum () ;
              if (kBoolTrue == test_12) {
                GALGAS_objectIR var_extendedResult_7226 ;
                {
                routine_getNewTempValue (var_registerType_4450, ioArgument_ioTemporaries, var_extendedResult_7226, inCompiler  COMMA_SOURCE_FILE ("expression-register-value-from-slices.galgas", 157)) ;
                }
                {
                extensionSetter_appendExtend (ioArgument_ioInstructionGenerationList, var_extendedResult_7226, var_partialResult_7072, inCompiler COMMA_SOURCE_FILE ("expression-register-value-from-slices.galgas", 158)) ;
                }
                var_partialResult_7072 = var_extendedResult_7226 ;
              }
              GALGAS_objectIR var_shiftedResult_7480 ;
              {
              routine_getNewTempValue (var_registerType_4450, ioArgument_ioTemporaries, var_shiftedResult_7480, inCompiler  COMMA_SOURCE_FILE ("expression-register-value-from-slices.galgas", 162)) ;
              }
              {
              extensionSetter_appendShiftLeft (ioArgument_ioInstructionGenerationList, var_shiftedResult_7480, var_partialResult_7072, var_fieldBitIndex_5088, inCompiler COMMA_SOURCE_FILE ("expression-register-value-from-slices.galgas", 163)) ;
              }
              var_operandList_4810.addAssign_operation (var_shiftedResult_7480  COMMA_SOURCE_FILE ("expression-register-value-from-slices.galgas", 165)) ;
            }
          }
        }
      }
  ...
  outArgument_outResult = GALGAS_objectIR::constructor_literalInteger (var_registerType_4450, var_accumulatedFieldStaticValues_4776  COMMA_SOURCE_FILE ("expression-register-value-from-slices.galgas", 171)) ;
  cEnumerator_operandIRList enumerator_7870 (var_operandList_4810, kENUMERATION_UP) ;
  while (enumerator_7870.hasCurrentObject ()) {
    GALGAS_objectIR var_newResult_7939 ;
    {
    routine_getNewTempValue (var_registerType_4450, ioArgument_ioTemporaries, var_newResult_7939, inCompiler  COMMA_SOURCE_FILE ("expression-register-value-from-slices.galgas", 173)) ;
    }
    {
    extensionSetter_appendBinaryOperation (ioArgument_ioInstructionGenerationList, var_newResult_7939, extensionGetter_type (var_newResult_7939, inCompiler COMMA_SOURCE_FILE ("expression-register-value-from-slices.galgas", 176)), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("expression-register-value-from-slices.galgas", 177)), outArgument_outResult, GALGAS_llvmBinaryOperation::constructor_ior (SOURCE_FILE ("expression-register-value-from-slices.galgas", 179)), enumerator_7870.current_mOperand (HERE), inCompiler COMMA_SOURCE_FILE ("expression-register-value-from-slices.galgas", 174)) ;
    }
    outArgument_outResult = var_newResult_7939 ;
...
static void extensionMethod_primaryInExpressionAST_addDependenceEdgeForStaticExpression (const cPtr_expressionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    {
    ioArgument_ioGraph.setter_addEdge (constinArgument_inConstantName, object->mProperty_mReceiverName COMMA_SOURCE_FILE ("expression-primary.galgas", 92)) ;
    }
  }
  cEnumerator_primaryInExpressionAccessListAST enumerator_3752 (object->mProperty_mAccessList, kENUMERATION_UP) ;
  while (enumerator_3752.hasCurrentObject ()) {
    switch (enumerator_3752.current_mAccess (HERE).enumValue ()) {
    case GALGAS_primaryInExpressionAccessAST::kNotBuilt:
      break ;
    case GALGAS_primaryInExpressionAccessAST::kEnum_register:
      {
    ...
    case GALGAS_primaryInExpressionAccessAST::kEnum_arrayAccess:
      {
        const cEnumAssociatedValues_primaryInExpressionAccessAST_arrayAccess * extractPtr_3995 = (const cEnumAssociatedValues_primaryInExpressionAccessAST_arrayAccess *) (enumerator_3752.current_mAccess (HERE).unsafePointer ()) ;
        const GALGAS_expressionAST extractedValue_indexExpression = extractPtr_3995->mAssociatedValue0 ;
        callExtensionMethod_addDependenceEdgeForStaticExpression ((const cPtr_expressionAST *) extractedValue_indexExpression.ptr (), constinArgument_inConstantName, ioArgument_ioGraph, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 100)) ;
      }
      break ;
    case GALGAS_primaryInExpressionAccessAST::kEnum_funcCall:
      {
        const cEnumAssociatedValues_primaryInExpressionAccessAST_funcCall * extractPtr_4536 = (const cEnumAssociatedValues_primaryInExpressionAccessAST_funcCall *) (enumerator_3752.current_mAccess (HERE).unsafePointer ()) ;
        const GALGAS_effectiveArgumentListAST extractedValue_arguments = extractPtr_4536->mAssociatedValue1 ;
        cEnumerator_effectiveArgumentListAST enumerator_4083 (extractedValue_arguments, kENUMERATION_UP) ;
        while (enumerator_4083.hasCurrentObject ()) {
          switch (enumerator_4083.current_mEffectiveParameterKind (HERE).enumValue ()) {
          case GALGAS_effectiveArgumentPassingModeAST::kNotBuilt:
            break ;
          case GALGAS_effectiveArgumentPassingModeAST::kEnum_input:
            {
          ...
          case GALGAS_effectiveArgumentPassingModeAST::kEnum_inputWithType:
            {
              const cEnumAssociatedValues_effectiveArgumentPassingModeAST_inputWithType * extractPtr_4326 = (const cEnumAssociatedValues_effectiveArgumentPassingModeAST_inputWithType *) (enumerator_4083.current_mEffectiveParameterKind (HERE).unsafePointer ()) ;
              const GALGAS_lstring extractedValue_typeName = extractPtr_4326->mAssociatedValue1 ;
              const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, extractedValue_typeName.getter_string (HERE).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
              if (kBoolTrue == test_1) {
                {
                ioArgument_ioGraph.setter_noteNode (function_llvmTypeNameFromPLMname (extractedValue_typeName, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 107)) COMMA_SOURCE_FILE ("expression-primary.galgas", 107)) ;
                }
              }
            }
            break ;
          case GALGAS_effectiveArgumentPassingModeAST::kEnum_output:
            {
              const cEnumAssociatedValues_effectiveArgumentPassingModeAST_output * extractPtr_4439 = (const cEnumAssociatedValues_effectiveArgumentPassingModeAST_output *) (enumerator_4083.current_mEffectiveParameterKind (HERE).unsafePointer ()) ;
              const GALGAS_expressionAST extractedValue_expression = extractPtr_4439->mAssociatedValue0 ;
              callExtensionMethod_addDependenceEdgeForStaticExpression ((const cPtr_expressionAST *) extractedValue_expression.ptr (), constinArgument_inConstantName, ioArgument_ioGraph, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 109)) ;
            }
            break ;
          case GALGAS_effectiveArgumentPassingModeAST::kEnum_outputInput:
            {
          ...
          enumerator_4083.gotoNextObject () ;
        }
      }
      break ;
    }
...
static void extensionMethod_primaryInExpressionAST_noteExpressionTypesInPrecedenceGraph (const cPtr_expressionAST * inObject,
  ...
  const cPtr_primaryInExpressionAST * object = (const cPtr_primaryInExpressionAST *) inObject ;
  macroValidSharedObject (object, cPtr_primaryInExpressionAST) ;
  cEnumerator_primaryInExpressionAccessListAST enumerator_5065 (object->mProperty_mAccessList, kENUMERATION_UP) ;
  while (enumerator_5065.hasCurrentObject ()) {
    switch (enumerator_5065.current_mAccess (HERE).enumValue ()) {
    case GALGAS_primaryInExpressionAccessAST::kNotBuilt:
      break ;
    case GALGAS_primaryInExpressionAccessAST::kEnum_integerSlice:
      {
        const cEnumAssociatedValues_primaryInExpressionAccessAST_integerSlice * extractPtr_5274 = (const cEnumAssociatedValues_primaryInExpressionAccessAST_integerSlice *) (enumerator_5065.current_mAccess (HERE).unsafePointer ()) ;
        const GALGAS_lbigint extractedValue_low = extractPtr_5274->mAssociatedValue0 ;
        const GALGAS_lbigint extractedValue_high = extractPtr_5274->mAssociatedValue1 ;
        ...
        if (kBoolTrue == test_0) {
          {
          extensionSetter_noteUINTType (ioArgument_ioGraph, extractedValue_high.getter_bigint (HERE).substract_operation (extractedValue_low.getter_bigint (HERE), inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 127)).add_operation (GALGAS_bigint ("1", inCompiler  COMMA_SOURCE_FILE ("expression-primary.galgas", 127)), inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 127)).getter_uint (inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 127)), extractedValue_low.getter_location (HERE), inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 127)) ;
          }
        }
      }
      break ;
    ...
    case GALGAS_primaryInExpressionAccessAST::kEnum_arrayAccess:
      {
        const cEnumAssociatedValues_primaryInExpressionAccessAST_arrayAccess * extractPtr_5451 = (const cEnumAssociatedValues_primaryInExpressionAccessAST_arrayAccess *) (enumerator_5065.current_mAccess (HERE).unsafePointer ()) ;
        const GALGAS_expressionAST extractedValue_indexExpression = extractPtr_5451->mAssociatedValue0 ;
        callExtensionMethod_noteExpressionTypesInPrecedenceGraph ((const cPtr_expressionAST *) extractedValue_indexExpression.ptr (), ioArgument_ioGraph, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 132)) ;
      }
      break ;
    case GALGAS_primaryInExpressionAccessAST::kEnum_funcCall:
      {
        const cEnumAssociatedValues_primaryInExpressionAccessAST_funcCall * extractPtr_5976 = (const cEnumAssociatedValues_primaryInExpressionAccessAST_funcCall *) (enumerator_5065.current_mAccess (HERE).unsafePointer ()) ;
        const GALGAS_effectiveArgumentListAST extractedValue_arguments = extractPtr_5976->mAssociatedValue1 ;
        cEnumerator_effectiveArgumentListAST enumerator_5539 (extractedValue_arguments, kENUMERATION_UP) ;
        while (enumerator_5539.hasCurrentObject ()) {
          switch (enumerator_5539.current_mEffectiveParameterKind (HERE).enumValue ()) {
          case GALGAS_effectiveArgumentPassingModeAST::kNotBuilt:
            break ;
          case GALGAS_effectiveArgumentPassingModeAST::kEnum_input:
            {
          ...
          case GALGAS_effectiveArgumentPassingModeAST::kEnum_inputWithType:
            {
              const cEnumAssociatedValues_effectiveArgumentPassingModeAST_inputWithType * extractPtr_5782 = (const cEnumAssociatedValues_effectiveArgumentPassingModeAST_inputWithType *) (enumerator_5539.current_mEffectiveParameterKind (HERE).unsafePointer ()) ;
              const GALGAS_lstring extractedValue_typeName = extractPtr_5782->mAssociatedValue1 ;
              const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, extractedValue_typeName.getter_string (HERE).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
              if (kBoolTrue == test_1) {
                {
                ioArgument_ioGraph.setter_noteNode (function_llvmTypeNameFromPLMname (extractedValue_typeName, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 139)) COMMA_SOURCE_FILE ("expression-primary.galgas", 139)) ;
                }
              }
            }
            break ;
          case GALGAS_effectiveArgumentPassingModeAST::kEnum_output:
            {
              const cEnumAssociatedValues_effectiveArgumentPassingModeAST_output * extractPtr_5879 = (const cEnumAssociatedValues_effectiveArgumentPassingModeAST_output *) (enumerator_5539.current_mEffectiveParameterKind (HERE).unsafePointer ()) ;
              const GALGAS_expressionAST extractedValue_expression = extractPtr_5879->mAssociatedValue0 ;
              callExtensionMethod_noteExpressionTypesInPrecedenceGraph ((const cPtr_expressionAST *) extractedValue_expression.ptr (), ioArgument_ioGraph, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 141)) ;
            }
            break ;
          case GALGAS_effectiveArgumentPassingModeAST::kEnum_outputInput:
            {
...
static void extensionMethod_primaryInExpressionAST_analyzeExpression (const cPtr_expressionAST * inObject,
  ...
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, object->mProperty_mReceiverName.getter_string (HERE).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
  if (kBoolTrue == test_0) {
    const enumGalgasBool test_1 = constinArgument_inRoutineAttributes.getter_guard (SOURCE_FILE ("expression-primary.galgas", 170)).boolEnum () ;
    if (kBoolTrue == test_1) {
      TC_Array <C_FixItDescription> fixItArray2 ;
      inCompiler->emitSemanticError (object->mProperty_mReceiverName.getter_location (SOURCE_FILE ("expression-primary.galgas", 171)), GALGAS_string ("in guard, only 'self' properties may be accessed"), fixItArray2  COMMA_SOURCE_FILE ("expression-primary.galgas", 171)) ;
      outArgument_outResult.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_1) {
      const GALGAS_primaryInExpressionAST temp_3 = object ;
      callExtensionMethod_analyzePrimaryExpressionNoSelf ((const cPtr_primaryInExpressionAST *) temp_3.ptr (), constinArgument_inSelfType, constinArgument_inRoutineAttributes, constinArgument_inCallerNameForInvocationGraph, constinArgument_inOptionalTargetType, constinArgument_inContext, constinArgument_inMode, ioArgument_ioTemporaries, ioArgument_ioStaticEntityMap, ioArgument_ioUniversalMap, ioArgument_ioAllocaList, ioArgument_ioInstructionGenerationList, outArgument_outResult, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 173)) ;
    }
  }else if (kBoolFalse == test_0) {
    const enumGalgasBool test_4 = GALGAS_bool (kIsEqual, constinArgument_inSelfType.getter_kind (HERE).objectCompare (GALGAS_typeKind::constructor_void (SOURCE_FILE ("expression-primary.galgas", 188)))).boolEnum () ;
    if (kBoolTrue == test_4) {
      TC_Array <C_FixItDescription> fixItArray5 ;
      inCompiler->emitSemanticError (object->mProperty_mReceiverName.getter_location (SOURCE_FILE ("expression-primary.galgas", 189)), GALGAS_string ("'self' is not available in this context"), fixItArray5  COMMA_SOURCE_FILE ("expression-primary.galgas", 189)) ;
      outArgument_outResult.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_4) {
      const GALGAS_primaryInExpressionAST temp_6 = object ;
      callExtensionMethod_analyzePrimaryExpressionWithSelf ((const cPtr_primaryInExpressionAST *) temp_6.ptr (), constinArgument_inSelfType, constinArgument_inRoutineAttributes, constinArgument_inCallerNameForInvocationGraph, constinArgument_inOptionalTargetType, constinArgument_inContext, constinArgument_inMode, ioArgument_ioTemporaries, ioArgument_ioStaticEntityMap, ioArgument_ioUniversalMap, ioArgument_ioAllocaList, ioArgument_ioInstructionGenerationList, outArgument_outResult, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 191)) ;
    }
  }
}
...
void routine_procAnalyzeAccesListInExpression (const GALGAS_PLMType constinArgument_inSelfType,
                                               ...
                                               C_Compiler * inCompiler
                                               COMMA_UNUSED_LOCATION_ARGS) {
  cEnumerator_primaryInExpressionAccessListAST enumerator_15062 (constinArgument_inAccessList, kENUMERATION_UP) ;
  while (enumerator_15062.hasCurrentObject ()) {
    switch (enumerator_15062.current_mAccess (HERE).enumValue ()) {
    case GALGAS_primaryInExpressionAccessAST::kNotBuilt:
      break ;
    case GALGAS_primaryInExpressionAccessAST::kEnum_register:
      {
        const cEnumAssociatedValues_primaryInExpressionAccessAST_register * extractPtr_15180 = (const cEnumAssociatedValues_primaryInExpressionAccessAST_register *) (enumerator_15062.current_mAccess (HERE).unsafePointer ()) ;
        const GALGAS_lstring extractedValue_registerName = extractPtr_15180->mAssociatedValue0 ;
        TC_Array <C_FixItDescription> fixItArray0 ;
        inCompiler->emitSemanticError (extractedValue_registerName.getter_location (SOURCE_FILE ("expression-primary.galgas", 380)), GALGAS_string ("invalid register access"), fixItArray0  COMMA_SOURCE_FILE ("expression-primary.galgas", 380)) ;
      }
      break ;
    case GALGAS_primaryInExpressionAccessAST::kEnum_integerSlice:
      {
        const cEnumAssociatedValues_primaryInExpressionAccessAST_integerSlice * extractPtr_15439 = (const cEnumAssociatedValues_primaryInExpressionAccessAST_integerSlice *) (enumerator_15062.current_mAccess (HERE).unsafePointer ()) ;
        const GALGAS_lbigint extractedValue_low = extractPtr_15439->mAssociatedValue0 ;
        const GALGAS_lbigint extractedValue_high = extractPtr_15439->mAssociatedValue1 ;
        {
        routine_handleSliceInExpression (constinArgument_inContext, ioArgument_ioResult, extractedValue_low, extractedValue_high, ioArgument_ioTemporaries, ioArgument_ioInstructionGenerationList, inCompiler  COMMA_SOURCE_FILE ("expression-primary.galgas", 382)) ;
        }
      }
      break ;
    case GALGAS_primaryInExpressionAccessAST::kEnum_property:
      {
        const cEnumAssociatedValues_primaryInExpressionAccessAST_property * extractPtr_15663 = (const cEnumAssociatedValues_primaryInExpressionAccessAST_property *) (enumerator_15062.current_mAccess (HERE).unsafePointer ()) ;
        const GALGAS_lstring extractedValue_propertyName = extractPtr_15663->mAssociatedValue0 ;
        {
        routine_handlePropertyAccessInExpression (ioArgument_ioResult, extractedValue_propertyName, ioArgument_ioTemporaries, ioArgument_ioInstructionGenerationList, inCompiler  COMMA_SOURCE_FILE ("expression-primary.galgas", 391)) ;
        }
      }
      break ;
    case GALGAS_primaryInExpressionAccessAST::kEnum_arrayAccess:
      {
        const cEnumAssociatedValues_primaryInExpressionAccessAST_arrayAccess * extractPtr_16290 = (const cEnumAssociatedValues_primaryInExpressionAccessAST_arrayAccess *) (enumerator_15062.current_mAccess (HERE).unsafePointer ()) ;
        const GALGAS_expressionAST extractedValue_indexExpression = extractPtr_16290->mAssociatedValue0 ;
        const GALGAS_location extractedValue_endOfIndex = extractPtr_16290->mAssociatedValue1 ;
        {
    ...
    case GALGAS_primaryInExpressionAccessAST::kEnum_funcCall:
      {
        const cEnumAssociatedValues_primaryInExpressionAccessAST_funcCall * extractPtr_17042 = (const cEnumAssociatedValues_primaryInExpressionAccessAST_funcCall *) (enumerator_15062.current_mAccess (HERE).unsafePointer ()) ;
        const GALGAS_lstring extractedValue_methodName = extractPtr_17042->mAssociatedValue0 ;
        const GALGAS_effectiveArgumentListAST extractedValue_arguments = extractPtr_17042->mAssociatedValue1 ;
        const GALGAS_location extractedValue_errorLocation = extractPtr_17042->mAssociatedValue2 ;
        const enumGalgasBool test_1 = constinArgument_inRoutineAttributes.getter_guard (SOURCE_FILE ("expression-primary.galgas", 415)).boolEnum () ;
        if (kBoolTrue == test_1) {
          TC_Array <C_FixItDescription> fixItArray2 ;
          inCompiler->emitSemanticError (extractedValue_errorLocation, GALGAS_string ("a method cannot be called in guard"), fixItArray2  COMMA_SOURCE_FILE ("expression-primary.galgas", 416)) ;
...
void routine_handleSliceInExpression (const GALGAS_semanticContext constinArgument_inContext,
  ...
  if (kBoolTrue == test_0) {
    TC_Array <C_FixItDescription> fixItArray1 ;
    inCompiler->emitSemanticError (constinArgument_inLow.getter_location (SOURCE_FILE ("expression-primary.galgas", 529)), GALGAS_string ("low bound should be lower or equal to high bound"), fixItArray1  COMMA_SOURCE_FILE ("expression-primary.galgas", 529)) ;
    ioArgument_ioResult.drop () ; // Release error dropped variable
  }else if (kBoolFalse == test_0) {
    GALGAS_bool test_2 = extensionGetter_type (ioArgument_ioResult, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 530)).getter_kind (HERE).getter_isInteger (SOURCE_FILE ("expression-primary.galgas", 530)) ;
    if (kBoolTrue != test_2.boolEnum ()) {
      test_2 = extensionGetter_type (ioArgument_ioResult, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 530)).getter_kind (HERE).getter_isStaticInteger (SOURCE_FILE ("expression-primary.galgas", 530)) ;
    }
    const enumGalgasBool test_3 = test_2.operator_not (SOURCE_FILE ("expression-primary.galgas", 530)).boolEnum () ;
    if (kBoolTrue == test_3) {
      TC_Array <C_FixItDescription> fixItArray4 ;
      inCompiler->emitSemanticError (constinArgument_inLow.getter_location (SOURCE_FILE ("expression-primary.galgas", 531)), GALGAS_string ("Invalid, receiver is not an integer"), fixItArray4  COMMA_SOURCE_FILE ("expression-primary.galgas", 531)) ;
      ioArgument_ioResult.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_3) {
      {
      extensionSetter_appendLogicalShiftRight (ioArgument_ioInstructionGenerationList, ioArgument_ioResult, constinArgument_inLow.getter_bigint (HERE).getter_uint (inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 534)), ioArgument_ioTemporaries, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 534)) ;
      }
      GALGAS_lstring var_resultIntegerName_20860 = GALGAS_lstring::constructor_new (GALGAS_string ("uint").add_operation (constinArgument_inHigh.getter_bigint (HERE).substract_operation (constinArgument_inLow.getter_bigint (HERE), inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 536)).add_operation (GALGAS_bigint ("1", inCompiler  COMMA_SOURCE_FILE ("expression-primary.galgas", 536)), inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 536)).getter_string (SOURCE_FILE ("expression-primary.galgas", 536)), inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 536)), constinArgument_inLow.getter_location (HERE)  COMMA_SOURCE_FILE ("expression-primary.galgas", 536)) ;
      GALGAS_PLMType var_sliceType_21017 ;
      GALGAS_uint joker_21019_1 ; // Joker input parameter
      constinArgument_inContext.getter_mTypeMap (HERE).method_searchKey (var_resultIntegerName_20860, var_sliceType_21017, joker_21019_1, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 537)) ;
      {
      extensionSetter_appendTrunc (ioArgument_ioInstructionGenerationList, var_sliceType_21017, ioArgument_ioResult, ioArgument_ioTemporaries, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 538)) ;
      }
    }
  }
}
...
void routine_handlePropertyAccessInExpression (GALGAS_objectIR & ioArgument_ioResult,
                                               ...
                                               C_Compiler * inCompiler
                                               COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_PLMType var_type_21468 = extensionGetter_type (ioArgument_ioResult, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 550)) ;
  GALGAS_propertyMap var_propertyMap_21517 = var_type_21468.getter_propertyMap (HERE) ;
  GALGAS_propertyAccessKind var_accessKind_21616 ;
  GALGAS_bool joker_21579 ; // Joker input parameter
  var_propertyMap_21517.method_searchKey (constinArgument_inPropertyName, joker_21579, var_accessKind_21616, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 552)) ;
  switch (var_accessKind_21616.enumValue ()) {
  case GALGAS_propertyAccessKind::kNotBuilt:
    break ;
  case GALGAS_propertyAccessKind::kEnum_nonVirtualMethod:
    {
      TC_Array <C_FixItDescription> fixItArray0 ;
      inCompiler->emitSemanticError (constinArgument_inPropertyName.getter_location (SOURCE_FILE ("expression-primary.galgas", 555)), GALGAS_string ("a method cannot be used in this context"), fixItArray0  COMMA_SOURCE_FILE ("expression-primary.galgas", 555)) ;
      ioArgument_ioResult.drop () ; // Release error dropped variable
    }
    break ;
  case GALGAS_propertyAccessKind::kEnum_constantProperty:
    {
      const cEnumAssociatedValues_propertyAccessKind_constantProperty * extractPtr_21812 = (const cEnumAssociatedValues_propertyAccessKind_constantProperty *) (var_accessKind_21616.unsafePointer ()) ;
      const GALGAS_objectIR extractedValue_value = extractPtr_21812->mAssociatedValue0 ;
      ioArgument_ioResult = extractedValue_value ;
    }
    break ;
  case GALGAS_propertyAccessKind::kEnum_singleton:
    {
      const cEnumAssociatedValues_propertyAccessKind_singleton * extractPtr_21865 = (const cEnumAssociatedValues_propertyAccessKind_singleton *) (var_accessKind_21616.unsafePointer ()) ;
      const GALGAS_objectIR extractedValue_object = extractPtr_21865->mAssociatedValue0 ;
      ioArgument_ioResult = extractedValue_object ;
    }
    break ;
  case GALGAS_propertyAccessKind::kEnum_indexed:
    {
      const cEnumAssociatedValues_propertyAccessKind_indexed * extractPtr_22256 = (const cEnumAssociatedValues_propertyAccessKind_indexed *) (var_accessKind_21616.unsafePointer ()) ;
      const GALGAS_PLMType extractedValue_propertyType = extractPtr_22256->mAssociatedValue0 ;
      const GALGAS_uint extractedValue_propertyIndex = extractPtr_22256->mAssociatedValue1 ;
      GALGAS_string var_property_5F_llvmName_21985 ;
      {
      extensionSetter_newTempLLVMVar (ioArgument_ioTemporaries, var_property_5F_llvmName_21985, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 561)) ;
      }
      {
      extensionSetter_appendGetUniversalPropertyReference (ioArgument_ioInstructionGenerationList, extensionGetter_type (ioArgument_ioResult, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 563)), extensionGetter_llvmName (ioArgument_ioResult, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 564)), var_property_5F_llvmName_21985, extractedValue_propertyIndex, constinArgument_inPropertyName.getter_string (SOURCE_FILE ("expression-primary.galgas", 567)), inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 562)) ;
      }
      ioArgument_ioResult = GALGAS_objectIR::constructor_reference (extractedValue_propertyType, var_property_5F_llvmName_21985  COMMA_SOURCE_FILE ("expression-primary.galgas", 569)) ;
    }
    break ;
  }
}
...
void routine_handleArrayAccessInExpression (GALGAS_objectIR & ioArgument_ioResult,
                                            ...
                                            C_Compiler * inCompiler
                                            COMMA_UNUSED_LOCATION_ARGS) {
  const enumGalgasBool test_0 = extensionGetter_type (ioArgument_ioResult, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 592)).getter_kind (HERE).getter_isArrayType (SOURCE_FILE ("expression-primary.galgas", 592)).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_PLMType var_elementType_23248 ;
    GALGAS_bigint var_arraySize_23276 ;
    extensionGetter_type (ioArgument_ioResult, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 593)).getter_kind (HERE).method_arrayType (var_elementType_23248, var_arraySize_23276, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 593)) ;
    {
    routine_handleArraySubscript (constinArgument_inSelfType, constinArgument_inRoutineAttributes, constinArgument_inCallerNameForInvocationGraph, constinArgument_inContext, constinArgument_inMode, ioArgument_ioTemporaries, ioArgument_ioStaticEntityMap, ioArgument_ioUniversalMap, ioArgument_ioAllocaList, constinArgument_inIndexExpression, constinArgument_inEndOfIndex, var_arraySize_23276, var_elementType_23248, ioArgument_ioInstructionGenerationList, ioArgument_ioResult, inCompiler  COMMA_SOURCE_FILE ("expression-primary.galgas", 594)) ;
    }
  }else if (kBoolFalse == test_0) {
    TC_Array <C_FixItDescription> fixItArray1 ;
    inCompiler->emitSemanticError (constinArgument_inEndOfIndex, GALGAS_string ("the receiver is not an array and does not accept subscripting"), fixItArray1  COMMA_SOURCE_FILE ("expression-primary.galgas", 617)) ;
  }
}
...
void routine_handleFunctionCallInExpression (const GALGAS_lstring constinArgument_inMethodName,
                                             ...
                                             C_Compiler * inCompiler
                                             COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_PLMType var_receiverType_24864 = extensionGetter_type (ioArgument_ioObjectIR, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 638)) ;
  GALGAS_propertyMap var_propertyMap_24915 = var_receiverType_24864.getter_propertyMap (HERE) ;
  GALGAS_lstring var_key_24952 = function_routineMangledNameFromCall (GALGAS_string::makeEmptyString (), constinArgument_inMethodName, constinArgument_inArguments, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 640)) ;
  GALGAS_propertyAccessKind var_propertyAccess_25087 ;
  GALGAS_bool joker_25046 ; // Joker input parameter
  var_propertyMap_24915.method_searchKey (var_key_24952, joker_25046, var_propertyAccess_25087, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 641)) ;
  switch (var_propertyAccess_25087.enumValue ()) {
  case GALGAS_propertyAccessKind::kNotBuilt:
    break ;
  case GALGAS_propertyAccessKind::kEnum_constantProperty:
    {
      TC_Array <C_FixItDescription> fixItArray0 ;
      inCompiler->emitSemanticError (constinArgument_inMethodName.getter_location (SOURCE_FILE ("expression-primary.galgas", 644)), GALGAS_string ("a constant cannot be used as method"), fixItArray0  COMMA_SOURCE_FILE ("expression-primary.galgas", 644)) ;
      ioArgument_ioObjectIR.drop () ; // Release error dropped variable
    }
    break ;
  case GALGAS_propertyAccessKind::kEnum_nonVirtualMethod:
    {
      const cEnumAssociatedValues_propertyAccessKind_nonVirtualMethod * extractPtr_27516 = (const cEnumAssociatedValues_propertyAccessKind_nonVirtualMethod *) (var_propertyAccess_25087.unsafePointer ()) ;
      const GALGAS_routineDescriptor extractedValue_routineDescriptor = extractPtr_27516->mAssociatedValue0 ;
      const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, extractedValue_routineDescriptor.getter_returnTypeProxy (HERE).getter_type (inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 647)).getter_kind (HERE).objectCompare (GALGAS_typeKind::constructor_void (SOURCE_FILE ("expression-primary.galgas", 647)))).boolEnum () ;
      if (kBoolTrue == test_1) {
        TC_Array <C_FixItDescription> fixItArray2 ;
        inCompiler->emitSemanticError (constinArgument_inMethodName.getter_location (SOURCE_FILE ("expression-primary.galgas", 648)), GALGAS_string ("not a function (returns no value)"), fixItArray2  COMMA_SOURCE_FILE ("expression-primary.galgas", 648)) ;
        ioArgument_ioObjectIR.drop () ; // Release error dropped variable
      }else if (kBoolFalse == test_1) {
        GALGAS_calleeKindIR var_calleeKind_25521 = function_checkMode (constinArgument_inMode, extensionGetter_executionMode (extractedValue_routineDescriptor.getter_routineKind (HERE), inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 653)), extractedValue_routineDescriptor.getter_routineKind (HERE), constinArgument_inMethodName.getter_location (HERE), inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 651)) ;
        {
        extensionSetter_referenceFromPossibleValue (ioArgument_ioInstructionGenerationList, ioArgument_ioTemporaries, ioArgument_ioAllocaList, ioArgument_ioObjectIR, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 658)) ;
        }
        GALGAS_procCallEffectiveParameterListIR var_effectiveParameterListIR_25984 = GALGAS_procCallEffectiveParameterListIR::constructor_emptyList (SOURCE_FILE ("expression-primary.galgas", 660)) ;
        var_effectiveParameterListIR_25984.addAssign_operation (GALGAS_procEffectiveParameterPassingModeIR::constructor_outputInput (SOURCE_FILE ("expression-primary.galgas", 661)), ioArgument_ioObjectIR  COMMA_SOURCE_FILE ("expression-primary.galgas", 661)) ;
        {
        routine_analyzeEffectiveParameters (constinArgument_inSelfType, constinArgument_inRoutineAttributes, extractedValue_routineDescriptor.getter_signature (HERE), constinArgument_inArguments, constinArgument_inMethodName.getter_location (HERE), constinArgument_inCallerNameForInvocationGraph, constinArgument_inContext, constinArgument_inMode, ioArgument_ioTemporaries, ioArgument_ioStaticEntityMap, ioArgument_ioUniversalMap, ioArgument_ioAllocaList, ioArgument_ioInstructionGenerationList, var_effectiveParameterListIR_25984, inCompiler  COMMA_SOURCE_FILE ("expression-primary.galgas", 663)) ;
        }
        GALGAS_objectIR var_callReturnedResult_26881 ;
        {
        routine_getNewTempValue (extractedValue_routineDescriptor.getter_returnTypeProxy (HERE).getter_type (inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 680)), ioArgument_ioTemporaries, var_callReturnedResult_26881, inCompiler  COMMA_SOURCE_FILE ("expression-primary.galgas", 680)) ;
        }
        GALGAS_lstring var_routineMangledName_26934 = function_routineMangledNameFromCall (function_llvmTypeStringFromPLMname (extensionGetter_type (ioArgument_ioObjectIR, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 682)).getter_plmOriginalTypeName (HERE), inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 682)), constinArgument_inMethodName, constinArgument_inArguments, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 682)) ;
        ioArgument_ioInstructionGenerationList.addAssign_operation (GALGAS_standaloneRoutineCallIR::constructor_new (GALGAS_string::makeEmptyString (), var_callReturnedResult_26881, var_routineMangledName_26934, var_routineMangledName_26934, var_calleeKind_25521, var_effectiveParameterListIR_25984  COMMA_SOURCE_FILE ("expression-primary.galgas", 683))  COMMA_SOURCE_FILE ("expression-primary.galgas", 683)) ;
        {
        ioArgument_ioTemporaries.mProperty_mSubprogramInvocationGraph.setter_addEdge (constinArgument_inCallerNameForInvocationGraph, var_routineMangledName_26934 COMMA_SOURCE_FILE ("expression-primary.galgas", 692)) ;
        }
        ioArgument_ioObjectIR = var_callReturnedResult_26881 ;
      }
    }
    break ;
  case GALGAS_propertyAccessKind::kEnum_singleton:
    {
      const cEnumAssociatedValues_propertyAccessKind_singleton * extractPtr_27631 = (const cEnumAssociatedValues_propertyAccessKind_singleton *) (var_propertyAccess_25087.unsafePointer ()) ;
      const GALGAS_location extractedValue_errorLocation = extractPtr_27631->mAssociatedValue1 ;
      TC_Array <C_FixItDescription> fixItArray3 ;
      inCompiler->emitSemanticError (extractedValue_errorLocation, GALGAS_string ("a property cannot be used as method"), fixItArray3  COMMA_SOURCE_FILE ("expression-primary.galgas", 697)) ;
      ioArgument_ioObjectIR.drop () ; // Release error dropped variable
    }
    break ;
  case GALGAS_propertyAccessKind::kEnum_indexed:
    {
      const cEnumAssociatedValues_propertyAccessKind_indexed * extractPtr_29857 = (const cEnumAssociatedValues_propertyAccessKind_indexed *) (var_propertyAccess_25087.unsafePointer ()) ;
      const GALGAS_PLMType extractedValue_propertyType = extractPtr_29857->mAssociatedValue0 ;
      const GALGAS_uint extractedValue_propertyIndex = extractPtr_29857->mAssociatedValue1 ;
      const enumGalgasBool test_4 = extractedValue_propertyType.getter_kind (HERE).getter_isFunction (SOURCE_FILE ("expression-primary.galgas", 699)).operator_not (SOURCE_FILE ("expression-primary.galgas", 699)).boolEnum () ;
      if (kBoolTrue == test_4) {
        TC_Array <C_FixItDescription> fixItArray5 ;
        inCompiler->emitSemanticError (constinArgument_inMethodName.getter_location (SOURCE_FILE ("expression-primary.galgas", 700)), GALGAS_string ("an indexed property cannot be used as method"), fixItArray5  COMMA_SOURCE_FILE ("expression-primary.galgas", 700)) ;
        ioArgument_ioObjectIR.drop () ; // Release error dropped variable
      }else if (kBoolFalse == test_4) {
        GALGAS_routineDescriptor var_descriptor_27897 ;
        extractedValue_propertyType.getter_kind (HERE).method_function (var_descriptor_27897, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 702)) ;
        const enumGalgasBool test_6 = GALGAS_bool (kIsEqual, var_descriptor_27897.getter_returnTypeProxy (HERE).objectCompare (GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("expression-primary.galgas", 704)))).boolEnum () ;
        if (kBoolTrue == test_6) {
          TC_Array <C_FixItDescription> fixItArray7 ;
          inCompiler->emitSemanticError (constinArgument_inMethodName.getter_location (SOURCE_FILE ("expression-primary.galgas", 705)), GALGAS_string ("not a function (returns no value)"), fixItArray7  COMMA_SOURCE_FILE ("expression-primary.galgas", 705)) ;
          ioArgument_ioObjectIR.drop () ; // Release error dropped variable
        }else if (kBoolFalse == test_6) {
          GALGAS_procCallEffectiveParameterListIR var_effectiveParameterListIR_28420 = GALGAS_procCallEffectiveParameterListIR::constructor_emptyList (SOURCE_FILE ("expression-primary.galgas", 715)) ;
          {
          routine_analyzeEffectiveParameters (constinArgument_inSelfType, constinArgument_inRoutineAttributes, var_descriptor_27897.getter_signature (HERE), constinArgument_inArguments, constinArgument_inMethodName.getter_location (HERE), constinArgument_inCallerNameForInvocationGraph, constinArgument_inContext, constinArgument_inMode, ioArgument_ioTemporaries, ioArgument_ioStaticEntityMap, ioArgument_ioUniversalMap, ioArgument_ioAllocaList, ioArgument_ioInstructionGenerationList, var_effectiveParameterListIR_28420, inCompiler  COMMA_SOURCE_FILE ("expression-primary.galgas", 716)) ;
          }
          GALGAS_string var_property_5F_llvmName_29151 ;
          {
          extensionSetter_newTempLLVMVar (ioArgument_ioTemporaries, var_property_5F_llvmName_29151, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 733)) ;
          }
          {
          extensionSetter_appendGetUniversalPropertyReference (ioArgument_ioInstructionGenerationList, extensionGetter_type (ioArgument_ioObjectIR, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 735)), extensionGetter_llvmName (ioArgument_ioObjectIR, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 736)), var_property_5F_llvmName_29151, extractedValue_propertyIndex, constinArgument_inMethodName.getter_string (SOURCE_FILE ("expression-primary.galgas", 739)), inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 734)) ;
          }
          GALGAS_objectIR var_callReturnedResult_29531 ;
          {
          routine_getNewTempValue (var_descriptor_27897.getter_returnTypeProxy (HERE).getter_type (inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 742)), ioArgument_ioTemporaries, var_callReturnedResult_29531, inCompiler  COMMA_SOURCE_FILE ("expression-primary.galgas", 742)) ;
          }
          ioArgument_ioInstructionGenerationList.addAssign_operation (GALGAS_indirectRoutineCallIR::constructor_new (GALGAS_objectIR::constructor_reference (extractedValue_propertyType, var_property_5F_llvmName_29151  COMMA_SOURCE_FILE ("expression-primary.galgas", 745)), extractedValue_propertyType, var_callReturnedResult_29531, var_effectiveParameterListIR_28420  COMMA_SOURCE_FILE ("expression-primary.galgas", 744))  COMMA_SOURCE_FILE ("expression-primary.galgas", 744)) ;
          ioArgument_ioObjectIR = var_callReturnedResult_29531 ;
        }
      }
    }
    break ;
...
void routine_analyzeRegisterExpressionEX (const GALGAS_PLMType constinArgument_inSelfType,
                                          const GALGAS_routineAttributes constinArgument_inRoutineAttributes,
                                          const GALGAS_lstring constinArgument_inCallerNameForInvocationGraph,
                                          const GALGAS_semanticContext constinArgument_inContext,
                                          const GALGAS_mode constinArgument_inMode,
                                          ...
                                          COMMA_UNUSED_LOCATION_ARGS) {
  outArgument_outResult.drop () ; // Release 'out' argument
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, constinArgument_inAccessList.getter_length (SOURCE_FILE ("expression-primary.galgas", 774)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    TC_Array <C_FixItDescription> fixItArray1 ;
    inCompiler->emitSemanticError (constinArgument_inErrorLocation, GALGAS_string ("a control register group has no value"), fixItArray1  COMMA_SOURCE_FILE ("expression-primary.galgas", 775)) ;
    outArgument_outResult.drop () ; // Release error dropped variable
  }else if (kBoolFalse == test_0) {
    GALGAS_primaryInExpressionAccessListAST var_accessList_30876 = constinArgument_inAccessList ;
    GALGAS_primaryInExpressionAccessAST var_registerNameAsField_30943 ;
    {
    var_accessList_30876.setter_popFirst (var_registerNameAsField_30943, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 778)) ;
    }
    const enumGalgasBool test_2 = var_registerNameAsField_30943.getter_isRegister (SOURCE_FILE ("expression-primary.galgas", 779)).operator_not (SOURCE_FILE ("expression-primary.galgas", 779)).boolEnum () ;
    if (kBoolTrue == test_2) {
      TC_Array <C_FixItDescription> fixItArray3 ;
      inCompiler->emitSemanticError (constinArgument_inErrorLocation, GALGAS_string ("the control register group should be followed by a control register name"), fixItArray3  COMMA_SOURCE_FILE ("expression-primary.galgas", 780)) ;
      outArgument_outResult.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_2) {
      GALGAS_lstring var_controlRegisterName_31185 ;
      var_registerNameAsField_30943.method_register (var_controlRegisterName_31185, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 782)) ;
      GALGAS_PLMType var_inRegisterType_31290 ;
      GALGAS_bool var_userAccess_31331 ;
      GALGAS_sliceMap var_inRegisterSliceMap_31373 ;
      GALGAS_controlRegisterFieldMap var_mRegisterFieldMap_31436 ;
      GALGAS_controlRegisterGroupKind var_controlRegisterGroupKind_31500 ;
      GALGAS_controlRegisterFieldList var_mControlRegisterFieldList_31572 ;
      GALGAS_uint var_mRegisterBitCount_31637 ;
      GALGAS_uint var_inRegisterArraySize_31676 ;
      GALGAS_uint var_inRegisterElementSize_31737 ;
      GALGAS_bool joker_31300 ; // Joker input parameter
      constinArgument_inControlRegisterMap.method_searchKey (var_controlRegisterName_31185, var_inRegisterType_31290, joker_31300, var_userAccess_31331, var_inRegisterSliceMap_31373, var_mRegisterFieldMap_31436, var_controlRegisterGroupKind_31500, var_mControlRegisterFieldList_31572, var_mRegisterBitCount_31637, var_inRegisterArraySize_31676, var_inRegisterElementSize_31737, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 783)) ;
      GALGAS_bool test_4 = var_userAccess_31331.operator_not (SOURCE_FILE ("expression-primary.galgas", 796)) ;
      if (kBoolTrue == test_4.boolEnum ()) {
        GALGAS_bool test_5 = constinArgument_inMode.getter_isUserMode (SOURCE_FILE ("expression-primary.galgas", 796)) ;
        if (kBoolTrue != test_5.boolEnum ()) {
          test_5 = constinArgument_inMode.getter_isAnyMode (SOURCE_FILE ("expression-primary.galgas", 796)) ;
        }
        test_4 = test_5 ;
      }
      ...
      if (kBoolTrue == test_6) {
        TC_Array <C_FixItDescription> fixItArray7 ;
        inCompiler->emitSemanticError (var_controlRegisterName_31185.getter_location (SOURCE_FILE ("expression-primary.galgas", 797)), GALGAS_string ("this control register is not accessible in user mode"), fixItArray7  COMMA_SOURCE_FILE ("expression-primary.galgas", 797)) ;
        outArgument_outResult.drop () ; // Release error dropped variable
      }else if (kBoolFalse == test_6) {
        const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, var_accessList_30876.getter_length (SOURCE_FILE ("expression-primary.galgas", 798)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
        if (kBoolTrue == test_8) {
          {
          routine_getNewTempValue (var_inRegisterType_31290, ioArgument_ioTemporaries, outArgument_outResult, inCompiler  COMMA_SOURCE_FILE ("expression-primary.galgas", 799)) ;
          }
          switch (var_controlRegisterGroupKind_31500.enumValue ()) {
          case GALGAS_controlRegisterGroupKind::kNotBuilt:
            break ;
          case GALGAS_controlRegisterGroupKind::kEnum_single:
            {
              const cEnumAssociatedValues_controlRegisterGroupKind_single * extractPtr_32257 = (const cEnumAssociatedValues_controlRegisterGroupKind_single *) (var_controlRegisterGroupKind_31500.unsafePointer ()) ;
              const GALGAS_bigint extractedValue_registerAddress = extractPtr_32257->mAssociatedValue0 ;
              {
              extensionSetter_appendLoadVolatileRegister (ioArgument_ioInstructionGenerationList, outArgument_outResult, extractedValue_registerAddress, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 802)) ;
              }
            }
            break ;
          }
        }else if (kBoolFalse == test_8) {
          const enumGalgasBool test_9 = var_accessList_30876.getter_mAccessAtIndex (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 804)).getter_isArrayAccess (SOURCE_FILE ("expression-primary.galgas", 804)).boolEnum () ;
          if (kBoolTrue == test_9) {
            GALGAS_primaryInExpressionAccessAST var_first_32375 ;
            {
            var_accessList_30876.setter_popFirst (var_first_32375, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 805)) ;
            }
            GALGAS_expressionAST var_indexExpression_32445 ;
            GALGAS_location var_endOfIndex_32482 ;
            var_first_32375.method_arrayAccess (var_indexExpression_32445, var_endOfIndex_32482, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 806)) ;
            GALGAS_objectIR var_indexIR_33095 ;
            {
            routine_handleArraySubscriptNew (constinArgument_inSelfType, constinArgument_inRoutineAttributes, constinArgument_inCallerNameForInvocationGraph, constinArgument_inContext, constinArgument_inMode, ioArgument_ioTemporaries, ioArgument_ioStaticEntityMap, ioArgument_ioUniversalMap, ioArgument_ioAllocaList, var_indexExpression_32445, var_endOfIndex_32482, var_inRegisterArraySize_31676.getter_bigint (SOURCE_FILE ("expression-primary.galgas", 819)), var_inRegisterType_31290, ioArgument_ioInstructionGenerationList, var_indexIR_33095, inCompiler  COMMA_SOURCE_FILE ("expression-primary.galgas", 807)) ;
            }
            const enumGalgasBool test_10 = var_indexIR_33095.getter_isLiteralInteger (SOURCE_FILE ("expression-primary.galgas", 824)).boolEnum () ;
            if (kBoolTrue == test_10) {
              GALGAS_bigint var_idx_33244 ;
              GALGAS_PLMType joker_33219_1 ; // Joker input parameter
              var_indexIR_33095.method_literalInteger (joker_33219_1, var_idx_33244, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 825)) ;
              switch (var_controlRegisterGroupKind_31500.enumValue ()) {
              case GALGAS_controlRegisterGroupKind::kNotBuilt:
                break ;
              case GALGAS_controlRegisterGroupKind::kEnum_single:
                {
                  const cEnumAssociatedValues_controlRegisterGroupKind_single * extractPtr_33559 = (const cEnumAssociatedValues_controlRegisterGroupKind_single *) (var_controlRegisterGroupKind_31500.unsafePointer ()) ;
                  const GALGAS_bigint extractedValue_registerAddress = extractPtr_33559->mAssociatedValue0 ;
                  GALGAS_bigint var_addr_33350 = extractedValue_registerAddress.add_operation (var_idx_33244.multiply_operation (var_inRegisterElementSize_31737.getter_bigint (SOURCE_FILE ("expression-primary.galgas", 828)), inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 828)), inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 828)) ;
                  {
                  routine_getNewTempValue (var_inRegisterType_31290, ioArgument_ioTemporaries, outArgument_outResult, inCompiler  COMMA_SOURCE_FILE ("expression-primary.galgas", 829)) ;
                  }
                  {
                  extensionSetter_appendLoadVolatileRegister (ioArgument_ioInstructionGenerationList, outArgument_outResult, var_addr_33350, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 830)) ;
                  }
                }
                break ;
              }
              ...
              {
              routine_getNewTempValue (var_inRegisterType_31290, ioArgument_ioTemporaries, outArgument_outResult, inCompiler  COMMA_SOURCE_FILE ("expression-primary.galgas", 833)) ;
              }
              switch (var_controlRegisterGroupKind_31500.enumValue ()) {
              case GALGAS_controlRegisterGroupKind::kNotBuilt:
                break ;
              case GALGAS_controlRegisterGroupKind::kEnum_single:
                {
                  const cEnumAssociatedValues_controlRegisterGroupKind_single * extractPtr_33955 = (const cEnumAssociatedValues_controlRegisterGroupKind_single *) (var_controlRegisterGroupKind_31500.unsafePointer ()) ;
                  const GALGAS_bigint extractedValue_registerAddress = extractPtr_33955->mAssociatedValue0 ;
                  {
                  extensionSetter_appendLoadVolatileRegisterWithSubscript (ioArgument_ioInstructionGenerationList, outArgument_outResult, var_indexIR_33095, extractedValue_registerAddress, var_inRegisterElementSize_31737.getter_bigint (SOURCE_FILE ("expression-primary.galgas", 840)), inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 836)) ;
                  }
                }
                break ;
              }
            ...
            {
            routine_getNewTempValue (var_inRegisterType_31290, ioArgument_ioTemporaries, outArgument_outResult, inCompiler  COMMA_SOURCE_FILE ("expression-primary.galgas", 845)) ;
            }
            switch (var_controlRegisterGroupKind_31500.enumValue ()) {
            case GALGAS_controlRegisterGroupKind::kNotBuilt:
              break ;
            case GALGAS_controlRegisterGroupKind::kEnum_single:
              {
                const cEnumAssociatedValues_controlRegisterGroupKind_single * extractPtr_34238 = (const cEnumAssociatedValues_controlRegisterGroupKind_single *) (var_controlRegisterGroupKind_31500.unsafePointer ()) ;
                const GALGAS_bigint extractedValue_registerAddress = extractPtr_34238->mAssociatedValue0 ;
                {
                extensionSetter_appendLoadVolatileRegister (ioArgument_ioInstructionGenerationList, outArgument_outResult, extractedValue_registerAddress, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 848)) ;
                }
              }
              break ;
            }
      ...
      GALGAS_sliceMap var_currentSliceMap_34307 = var_inRegisterSliceMap_31373 ;
      GALGAS_PLMType var_currentType_34350 = var_inRegisterType_31290 ;
      cEnumerator_primaryInExpressionAccessListAST enumerator_34400 (var_accessList_30876, kENUMERATION_UP) ;
      while (enumerator_34400.hasCurrentObject ()) {
        switch (enumerator_34400.current_mAccess (HERE).enumValue ()) {
        case GALGAS_primaryInExpressionAccessAST::kNotBuilt:
          break ;
        case GALGAS_primaryInExpressionAccessAST::kEnum_integerSlice:
          {
            const cEnumAssociatedValues_primaryInExpressionAccessAST_integerSlice * extractPtr_34533 = (const cEnumAssociatedValues_primaryInExpressionAccessAST_integerSlice *) (enumerator_34400.current_mAccess (HERE).unsafePointer ()) ;
            const GALGAS_lbigint extractedValue_low = extractPtr_34533->mAssociatedValue0 ;
            TC_Array <C_FixItDescription> fixItArray11 ;
            inCompiler->emitSemanticError (extractedValue_low.getter_location (SOURCE_FILE ("expression-primary.galgas", 857)), GALGAS_string ("cannot extract a slice from a register"), fixItArray11  COMMA_SOURCE_FILE ("expression-primary.galgas", 857)) ;
          }
          break ;
        case GALGAS_primaryInExpressionAccessAST::kEnum_property:
          {
            const cEnumAssociatedValues_primaryInExpressionAccessAST_property * extractPtr_34637 = (const cEnumAssociatedValues_primaryInExpressionAccessAST_property *) (enumerator_34400.current_mAccess (HERE).unsafePointer ()) ;
            const GALGAS_lstring extractedValue_propertyName = extractPtr_34637->mAssociatedValue0 ;
            TC_Array <C_FixItDescription> fixItArray12 ;
            inCompiler->emitSemanticError (extractedValue_propertyName.getter_location (SOURCE_FILE ("expression-primary.galgas", 859)), GALGAS_string ("invalid prperty access"), fixItArray12  COMMA_SOURCE_FILE ("expression-primary.galgas", 859)) ;
          }
          break ;
        case GALGAS_primaryInExpressionAccessAST::kEnum_register:
          {
            const cEnumAssociatedValues_primaryInExpressionAccessAST_register * extractPtr_35396 = (const cEnumAssociatedValues_primaryInExpressionAccessAST_register *) (enumerator_34400.current_mAccess (HERE).unsafePointer ()) ;
            const GALGAS_lstring extractedValue_registerName = extractPtr_35396->mAssociatedValue0 ;
            GALGAS_llvmBinaryOperation var_accessOperator_34801 ;
            GALGAS_bigint var_accessRightOperand_34845 ;
            GALGAS_sliceMap var_subMap_34879 ;
            GALGAS_PLMType var_resultType_34916 ;
            var_currentSliceMap_34307.method_searchKey (extractedValue_registerName, var_accessOperator_34801, var_accessRightOperand_34845, var_subMap_34879, var_resultType_34916, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 861)) ;
            GALGAS_objectIR var_resultIR_34997 ;
            {
            routine_getNewTempValue (var_resultType_34916, ioArgument_ioTemporaries, var_resultIR_34997, inCompiler  COMMA_SOURCE_FILE ("expression-primary.galgas", 868)) ;
            }
            {
            extensionSetter_appendBinaryOperation (ioArgument_ioInstructionGenerationList, var_resultIR_34997, extensionGetter_type (outArgument_outResult, inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 871)), extractedValue_registerName.getter_location (HERE), outArgument_outResult, var_accessOperator_34801, GALGAS_objectIR::constructor_literalInteger (function_staticIntegerType (inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 875)), var_accessRightOperand_34845  COMMA_SOURCE_FILE ("expression-primary.galgas", 875)), inCompiler COMMA_SOURCE_FILE ("expression-primary.galgas", 869)) ;
            }
            var_currentSliceMap_34307 = var_subMap_34879 ;
            var_currentType_34350 = var_resultType_34916 ;
            outArgument_outResult = var_resultIR_34997 ;
          }
          break ;
        case GALGAS_primaryInExpressionAccessAST::kEnum_arrayAccess:
          {
            const cEnumAssociatedValues_primaryInExpressionAccessAST_arrayAccess * extractPtr_35540 = (const cEnumAssociatedValues_primaryInExpressionAccessAST_arrayAccess *) (enumerator_34400.current_mAccess (HERE).unsafePointer ()) ;
            const GALGAS_location extractedValue_endOfIndex = extractPtr_35540->mAssociatedValue1 ;
            TC_Array <C_FixItDescription> fixItArray13 ;
            inCompiler->emitSemanticError (extractedValue_endOfIndex, GALGAS_string ("receiver is a control register, subscripting is invalid here"), fixItArray13  COMMA_SOURCE_FILE ("expression-primary.galgas", 881)) ;
          }
          break ;
        case GALGAS_primaryInExpressionAccessAST::kEnum_funcCall:
          {
            const cEnumAssociatedValues_primaryInExpressionAccessAST_funcCall * extractPtr_35679 = (const cEnumAssociatedValues_primaryInExpressionAccessAST_funcCall *) (enumerator_34400.current_mAccess (HERE).unsafePointer ()) ;
            const GALGAS_location extractedValue_errorLocation = extractPtr_35679->mAssociatedValue2 ;
            TC_Array <C_FixItDescription> fixItArray14 ;
            inCompiler->emitSemanticError (extractedValue_errorLocation, GALGAS_string ("receiver is a control register, cannot be used as a function"), fixItArray14  COMMA_SOURCE_FILE ("expression-primary.galgas", 883)) ;
          }
          break ;
        }
        enumerator_34400.gotoNextObject () ;
      }
    }
  }
}
...
static void extensionMethod_assignmentInstructionAST_instructionSemanticAnalysis (const cPtr_instructionAST * inObject,
  ...
  const cPtr_assignmentInstructionAST * object = (const cPtr_assignmentInstructionAST *) inObject ;
  macroValidSharedObject (object, cPtr_assignmentInstructionAST) ;
  GALGAS_PLMType var_targetType_3194 ;
  extensionMethod_searchValuedObjectType (ioArgument_ioUniversalMap, constinArgument_inSelfType, object->mProperty_mTargetAST.getter_mIdentifier (HERE), object->mProperty_mTargetAST.getter_mKind (HERE), var_targetType_3194, inCompiler COMMA_SOURCE_FILE ("instruction-assignment.galgas", 60)) ;
  GALGAS_objectIR var_sourceOperandPossibleReference_3711 ;
  callExtensionMethod_analyzeExpression ((const cPtr_expressionAST *) object->mProperty_mSourceExpression.ptr (), constinArgument_inSelfType, constinArgument_inRoutineAttributes, constinArgument_inCallerNameForInvocationGraph, var_targetType_3194, constinArgument_inContext, constinArgument_inCurrentMode, ioArgument_ioTemporaries, ioArgument_ioStaticEntityMap, ioArgument_ioUniversalMap, ioArgument_ioAllocaList, ioArgument_ioInstructionGenerationList, var_sourceOperandPossibleReference_3711, inCompiler COMMA_SOURCE_FILE ("instruction-assignment.galgas", 62)) ;
  GALGAS_LValueRepresentation var_lvalueIR_4190 ;
  extensionMethod_analyzeLValue (object->mProperty_mTargetAST, constinArgument_inSelfType, GALGAS_bool (false), constinArgument_inRoutineAttributes, constinArgument_inCallerNameForInvocationGraph, constinArgument_inContext, constinArgument_inCurrentMode, ioArgument_ioTemporaries, ioArgument_ioStaticEntityMap, ioArgument_ioUniversalMap, ioArgument_ioAllocaList, ioArgument_ioInstructionGenerationList, var_lvalueIR_4190, inCompiler COMMA_SOURCE_FILE ("instruction-assignment.galgas", 77)) ;
  GALGAS_PLMType var_t_4228 = extensionGetter_type (var_sourceOperandPossibleReference_3711, inCompiler COMMA_SOURCE_FILE ("instruction-assignment.galgas", 92)) ;
  const enumGalgasBool test_0 = extensionGetter_copyable (var_t_4228, inCompiler COMMA_SOURCE_FILE ("instruction-assignment.galgas", 93)).operator_not (SOURCE_FILE ("instruction-assignment.galgas", 93)).boolEnum () ;
  if (kBoolTrue == test_0) {
    TC_Array <C_FixItDescription> fixItArray1 ;
    ...
    {
    extensionSetter_appendCopyFromReferences (ioArgument_ioInstructionGenerationList, ioArgument_ioTemporaries, object->mProperty_mTargetAST.getter_mIdentifier (HERE).getter_location (SOURCE_FILE ("instruction-assignment.galgas", 98)), var_sourceOperandPossibleReference_3711, var_lvalueIR_4190, inCompiler COMMA_SOURCE_FILE ("instruction-assignment.galgas", 96)) ;
    }
  }
}
...
static void extensionMethod_bitbandInstructionAST_instructionSemanticAnalysis (const cPtr_instructionAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    GALGAS_controlRegisterGroupKind var_controlRegisterGroupKind_4195 ;
    GALGAS_controlRegisterFieldList var_mControlRegisterFieldList_4265 ;
    GALGAS_uint var_registerBitCount_4327 ;
    GALGAS_uint var_registerArraySize_4362 ;
    GALGAS_uint var_registerElementSize_4426 ;
    var_registerMap_3882.method_searchKey (object->mProperty_mRegisterName, var_registerType_3971, var_readOnly_3997, var_userAccess_4025, var_inRegisterSliceMap_4072, var_mRegisterFieldMap_4133, var_controlRegisterGroupKind_4195, var_mControlRegisterFieldList_4265, var_registerBitCount_4327, var_registerArraySize_4362, var_registerElementSize_4426, inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 82)) ;
    switch (var_controlRegisterGroupKind_4195.enumValue ()) {
    case GALGAS_controlRegisterGroupKind::kNotBuilt:
      break ;
    case GALGAS_controlRegisterGroupKind::kEnum_single:
      {
        const cEnumAssociatedValues_controlRegisterGroupKind_single * extractPtr_9626 = (const cEnumAssociatedValues_controlRegisterGroupKind_single *) (var_controlRegisterGroupKind_4195.unsafePointer ()) ;
        const GALGAS_bigint extractedValue_registerAddress = extractPtr_9626->mAssociatedValue0 ;
        GALGAS_bool test_2 = GALGAS_bool (kIsStrictInf, extractedValue_registerAddress.objectCompare (constinArgument_inContext.getter_mTargetParameters (HERE).getter_mBitbandRegisterBaseAddress (HERE).getter_bigint (HERE))) ;
        if (kBoolTrue != test_2.boolEnum ()) {
          test_2 = GALGAS_bool (kIsSupOrEqual, extractedValue_registerAddress.objectCompare (constinArgument_inContext.getter_mTargetParameters (HERE).getter_mBitbandRegisterEndAddress (HERE).getter_bigint (HERE))) ;
        }
        const enumGalgasBool test_3 = test_2.boolEnum () ;
        if (kBoolTrue == test_3) {
          TC_Array <C_FixItDescription> fixItArray4 ;
          inCompiler->emitSemanticError (object->mProperty_mRegisterName.getter_location (SOURCE_FILE ("instruction-bit-banding.galgas", 100)), GALGAS_string ("register address (").add_operation (extractedValue_registerAddress.getter_hexString (SOURCE_FILE ("instruction-bit-banding.galgas", 101)), inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 101)).add_operation (GALGAS_string (") invalid: should be >= "), inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 101)).add_operation (constinArgument_inContext.getter_mTargetParameters (HERE).getter_mBitbandRegisterBaseAddress (HERE).getter_bigint (HERE).getter_hexString (SOURCE_FILE ("instruction-bit-banding.galgas", 102)), inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 101)).add_operation (GALGAS_string (" and < "), inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 102)).add_operation (constinArgument_inContext.getter_mTargetParameters (HERE).getter_mBitbandRegisterEndAddress (HERE).getter_bigint (HERE).getter_hexString (SOURCE_FILE ("instruction-bit-banding.galgas", 103)), inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 103)), fixItArray4  COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 100)) ;
        }else if (kBoolFalse == test_3) {
          const enumGalgasBool test_5 = var_readOnly_3997.boolEnum () ;
          if (kBoolTrue == test_5) {
            TC_Array <C_FixItDescription> fixItArray6 ;
            inCompiler->emitSemanticError (object->mProperty_mRegisterName.getter_location (SOURCE_FILE ("instruction-bit-banding.galgas", 105)), GALGAS_string ("this control register cannot be modified (declared with @ro attribute)"), fixItArray6  COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 105)) ;
          }else if (kBoolFalse == test_5) {
            GALGAS_bool test_7 = var_userAccess_4025.operator_not (SOURCE_FILE ("instruction-bit-banding.galgas", 106)) ;
            if (kBoolTrue == test_7.boolEnum ()) {
              GALGAS_bool test_8 = constinArgument_inMode.getter_isUserMode (SOURCE_FILE ("instruction-bit-banding.galgas", 106)) ;
              if (kBoolTrue != test_8.boolEnum ()) {
                test_8 = constinArgument_inMode.getter_isAnyMode (SOURCE_FILE ("instruction-bit-banding.galgas", 106)) ;
              }
              test_7 = test_8 ;
            }
            ...
            if (kBoolTrue == test_9) {
              TC_Array <C_FixItDescription> fixItArray10 ;
              inCompiler->emitSemanticError (object->mProperty_mRegisterName.getter_location (SOURCE_FILE ("instruction-bit-banding.galgas", 107)), GALGAS_string ("this control register is not accessible in user mode"), fixItArray10  COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 107)) ;
            }else if (kBoolFalse == test_9) {
              const enumGalgasBool test_11 = GALGAS_bool (kIsNotEqual, var_registerArraySize_4362.objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
              if (kBoolTrue == test_11) {
                TC_Array <C_FixItDescription> fixItArray12 ;
                inCompiler->emitSemanticError (object->mProperty_mRegisterName.getter_location (SOURCE_FILE ("instruction-bit-banding.galgas", 109)), GALGAS_string ("control register array not handled yet"), fixItArray12  COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 109)) ;
              }
            }
          }
        }
        GALGAS_PLMType var_requiredBitExpressionType_5698 ;
        GALGAS_uint joker_5708_1 ; // Joker input parameter
        constinArgument_inContext.getter_mTypeMap (HERE).method_searchKey (GALGAS_lstring::constructor_new (GALGAS_string ("uint").add_operation (var_registerBitCount_4327.substract_operation (GALGAS_bigint ("1", inCompiler  COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 113)).getter_uint (inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 113)), inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 113)).getter_significantBitCount (SOURCE_FILE ("instruction-bit-banding.galgas", 113)).getter_string (SOURCE_FILE ("instruction-bit-banding.galgas", 113)), inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 113)), object->mProperty_mBitExpressionLocation  COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 113)), var_requiredBitExpressionType_5698, joker_5708_1, inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 112)) ;
        GALGAS_objectIR var_bitExpressionOperand_6282 ;
        callExtensionMethod_analyzeExpression ((const cPtr_expressionAST *) object->mProperty_mBitExpression.ptr (), constinArgument_inSelfType, constinArgument_inRoutineAttributes, constinArgument_inCallerNameForInvocationGraph, var_requiredBitExpressionType_5698, constinArgument_inContext, constinArgument_inMode, ioArgument_ioTemporaries, ioArgument_ioStaticEntityMap, ioArgument_ioUniversalMap, ioArgument_ioAllocaList, ioArgument_ioInstructionGenerationList, var_bitExpressionOperand_6282, inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 118)) ;
        {
        extensionSetter_appendLoadWhenReference (ioArgument_ioInstructionGenerationList, ioArgument_ioTemporaries, var_bitExpressionOperand_6282, inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 133)) ;
        }
        GALGAS_bool test_13 = GALGAS_bool (kIsEqual, extensionGetter_type (var_bitExpressionOperand_6282, inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 138)).getter_plmOriginalTypeName (HERE).objectCompare (function_staticIntegerTypeName (inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 138)))) ;
        if (kBoolTrue == test_13.boolEnum ()) {
          test_13 = var_bitExpressionOperand_6282.getter_isLiteralInteger (SOURCE_FILE ("instruction-bit-banding.galgas", 138)) ;
        }
        const enumGalgasBool test_14 = test_13.boolEnum () ;
        if (kBoolTrue == test_14) {
          GALGAS_bigint var_value_6763 ;
          GALGAS_PLMType joker_6736_1 ; // Joker input parameter
          var_bitExpressionOperand_6282.method_literalInteger (joker_6736_1, var_value_6763, inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 139)) ;
          GALGAS_bool test_15 = GALGAS_bool (kIsStrictInf, var_value_6763.objectCompare (GALGAS_bigint ("0", inCompiler  COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 140)))) ;
          if (kBoolTrue != test_15.boolEnum ()) {
            test_15 = GALGAS_bool (kIsSupOrEqual, var_value_6763.objectCompare (var_registerBitCount_4327.getter_bigint (SOURCE_FILE ("instruction-bit-banding.galgas", 140)))) ;
          }
          const enumGalgasBool test_16 = test_15.boolEnum () ;
          if (kBoolTrue == test_16) {
            TC_Array <C_FixItDescription> fixItArray17 ;
            inCompiler->emitSemanticError (object->mProperty_mBitExpressionLocation, GALGAS_string ("static value should be >= 0 and <").add_operation (var_registerBitCount_4327.getter_string (SOURCE_FILE ("instruction-bit-banding.galgas", 141)), inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 141)), fixItArray17  COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 141)) ;
          }else if (kBoolFalse == test_16) {
            var_bitExpressionOperand_6282 = GALGAS_objectIR::constructor_literalInteger (var_requiredBitExpressionType_5698, var_value_6763  COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 143)) ;
          }
        }else if (kBoolFalse == test_14) {
          const enumGalgasBool test_18 = GALGAS_bool (kIsNotEqual, extensionGetter_type (var_bitExpressionOperand_6282, inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 145)).getter_plmOriginalTypeName (HERE).objectCompare (var_requiredBitExpressionType_5698.getter_plmOriginalTypeName (HERE))).boolEnum () ;
          if (kBoolTrue == test_18) {
            TC_Array <C_FixItDescription> fixItArray19 ;
            inCompiler->emitSemanticError (object->mProperty_mBitExpressionLocation, GALGAS_string ("bit expression type should be $").add_operation (var_requiredBitExpressionType_5698.getter_plmOriginalTypeName (HERE), inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 146)), fixItArray19  COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 146)) ;
          }
        }
        GALGAS_PLMType var_requiredSourceExpressionType_7467 ;
        GALGAS_uint joker_7477_1 ; // Joker input parameter
        constinArgument_inContext.getter_mTypeMap (HERE).method_searchKey (GALGAS_lstring::constructor_new (GALGAS_string ("uint1"), object->mProperty_mSourceExpressionLocation  COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 150)), var_requiredSourceExpressionType_7467, joker_7477_1, inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 149)) ;
        GALGAS_objectIR var_sourceExpressionOperand_8063 ;
        callExtensionMethod_analyzeExpression ((const cPtr_expressionAST *) object->mProperty_mSourceExpression.ptr (), constinArgument_inSelfType, constinArgument_inRoutineAttributes, constinArgument_inCallerNameForInvocationGraph, var_requiredSourceExpressionType_7467, constinArgument_inContext, constinArgument_inMode, ioArgument_ioTemporaries, ioArgument_ioStaticEntityMap, ioArgument_ioUniversalMap, ioArgument_ioAllocaList, ioArgument_ioInstructionGenerationList, var_sourceExpressionOperand_8063, inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 155)) ;
        {
        extensionSetter_appendLoadWhenReference (ioArgument_ioInstructionGenerationList, ioArgument_ioTemporaries, var_sourceExpressionOperand_8063, inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 171)) ;
        }
        GALGAS_bool test_20 = GALGAS_bool (kIsEqual, extensionGetter_type (var_sourceExpressionOperand_8063, inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 177)).getter_plmOriginalTypeName (HERE).objectCompare (function_staticIntegerTypeName (inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 177)))) ;
        if (kBoolTrue == test_20.boolEnum ()) {
          test_20 = var_sourceExpressionOperand_8063.getter_isLiteralInteger (SOURCE_FILE ("instruction-bit-banding.galgas", 177)) ;
        }
        const enumGalgasBool test_21 = test_20.boolEnum () ;
        if (kBoolTrue == test_21) {
          GALGAS_bigint var_value_8634 ;
          GALGAS_PLMType joker_8607_1 ; // Joker input parameter
          var_sourceExpressionOperand_8063.method_literalInteger (joker_8607_1, var_value_8634, inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 178)) ;
          GALGAS_bool test_22 = GALGAS_bool (kIsStrictInf, var_value_8634.objectCompare (GALGAS_bigint ("0", inCompiler  COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 179)))) ;
          if (kBoolTrue != test_22.boolEnum ()) {
            test_22 = GALGAS_bool (kIsStrictSup, var_value_8634.objectCompare (GALGAS_bigint ("1", inCompiler  COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 179)))) ;
          }
          const enumGalgasBool test_23 = test_22.boolEnum () ;
          if (kBoolTrue == test_23) {
            TC_Array <C_FixItDescription> fixItArray24 ;
            inCompiler->emitSemanticError (object->mProperty_mSourceExpressionLocation, GALGAS_string ("static value should be 0 or 1"), fixItArray24  COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 180)) ;
          }else if (kBoolFalse == test_23) {
            var_sourceExpressionOperand_8063 = GALGAS_objectIR::constructor_literalInteger (var_requiredSourceExpressionType_7467, var_value_8634  COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 182)) ;
          }
        }else if (kBoolFalse == test_21) {
          const enumGalgasBool test_25 = GALGAS_bool (kIsNotEqual, extensionGetter_type (var_sourceExpressionOperand_8063, inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 184)).getter_plmOriginalTypeName (HERE).objectCompare (var_requiredSourceExpressionType_7467.getter_plmOriginalTypeName (HERE))).boolEnum () ;
          if (kBoolTrue == test_25) {
            TC_Array <C_FixItDescription> fixItArray26 ;
            inCompiler->emitSemanticError (object->mProperty_mSourceExpressionLocation, GALGAS_string ("bit expression type should be $").add_operation (var_requiredSourceExpressionType_7467.getter_plmOriginalTypeName (HERE), inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 185)), fixItArray26  COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 185)) ;
          }
        }
        ioArgument_ioInstructionGenerationList.addAssign_operation (GALGAS_bitbandInstructionIR::constructor_new (extractedValue_registerAddress, var_bitExpressionOperand_6282, var_sourceExpressionOperand_8063, constinArgument_inContext.getter_mTargetParameters (HERE).getter_mBitbandRegisterBaseAddress (HERE).getter_bigint (HERE), constinArgument_inContext.getter_mTargetParameters (HERE).getter_mBitbandRegisterRelocationAddress (HERE).getter_bigint (HERE), constinArgument_inContext.getter_mTargetParameters (HERE).getter_mBitbandRegisterOffsetMultiplier (HERE).getter_bigint (HERE), constinArgument_inContext.getter_mTargetParameters (HERE).getter_mBitbandRegisterBitMultiplier (HERE).getter_bigint (HERE)  COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 188))  COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 188)) ;
      }
      break ;
    }
  }
...
static void extensionMethod_bitbandInstructionIR_llvmInstructionCode (const cPtr_abstractInstructionIR * inObject,
  ...
  GALGAS_string var_idx_11230 = ioArgument_ioGenerationAdds.getter_mUniqueIndex (HERE).getter_string (SOURCE_FILE ("instruction-bit-banding.galgas", 232)) ;
  ioArgument_ioGenerationAdds.mProperty_mUniqueIndex.increment_operation (inCompiler  COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 233)) ;
  ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string (";--- Bit band\n"), inCompiler  COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 234)) ;
  ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  %byte.offset.").add_operation (var_idx_11230, inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 235)).add_operation (GALGAS_string (" = sub i32 "), inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 235)).add_operation (object->mProperty_mRegisterAddress.getter_string (SOURCE_FILE ("instruction-bit-banding.galgas", 235)), inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 235)).add_operation (GALGAS_string (", "), inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 235)).add_operation (object->mProperty_mBitbandRegisterBaseAddress.getter_string (SOURCE_FILE ("instruction-bit-banding.galgas", 235)), inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 235)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 235)), inCompiler  COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 235)) ;
  ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  %byte.offset.").add_operation (var_idx_11230, inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 236)).add_operation (GALGAS_string (".mul = mul i32 %byte.offset."), inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 236)).add_operation (var_idx_11230, inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 236)).add_operation (GALGAS_string (", "), inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 236)).add_operation (object->mProperty_mBitbandRegisterOffsetMultiplier.getter_string (SOURCE_FILE ("instruction-bit-banding.galgas", 236)), inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 236)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 236)), inCompiler  COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 236)) ;
  ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  %bit.offset.").add_operation (var_idx_11230, inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 237)).add_operation (GALGAS_string (".mul = mul i32 "), inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 237)).add_operation (extensionGetter_llvmName (object->mProperty_mBitExpressionOperand, inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 237)), inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 237)).add_operation (GALGAS_string (", "), inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 237)).add_operation (object->mProperty_mBitbandRegisterBitMultiplier.getter_string (SOURCE_FILE ("instruction-bit-banding.galgas", 237)), inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 237)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 237)), inCompiler  COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 237)) ;
  ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  %offset.").add_operation (var_idx_11230, inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 238)).add_operation (GALGAS_string (" = add i32 %byte.offset."), inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 238)).add_operation (var_idx_11230, inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 238)).add_operation (GALGAS_string (".mul, %bit.offset."), inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 238)).add_operation (var_idx_11230, inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 238)).add_operation (GALGAS_string (".mul\n"), inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 238)), inCompiler  COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 238)) ;
  ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  %bit.word.addr.").add_operation (var_idx_11230, inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 239)).add_operation (GALGAS_string (" = add i32 %offset."), inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 239)).add_operation (var_idx_11230, inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 239)).add_operation (GALGAS_string (", "), inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 239)).add_operation (object->mProperty_mBitbandRegisterRelocationAddress.getter_string (SOURCE_FILE ("instruction-bit-banding.galgas", 239)), inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 239)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 239)), inCompiler  COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 239)) ;
  ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  %ptr.").add_operation (var_idx_11230, inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 240)).add_operation (GALGAS_string (" = inttoptr i32 %bit.word.addr."), inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 240)).add_operation (var_idx_11230, inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 240)).add_operation (GALGAS_string (" to i32*\n"), inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 240)), inCompiler  COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 240)) ;
  ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  %value.").add_operation (var_idx_11230, inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 241)).add_operation (GALGAS_string (" = zext i1 "), inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 241)).add_operation (extensionGetter_llvmName (object->mProperty_mSourceExpressionOperand, inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 241)), inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 241)).add_operation (GALGAS_string (" to i32\n"), inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 241)), inCompiler  COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 241)) ;
  ioArgument_ioLLVMcode.plusAssign_operation(GALGAS_string ("  store i32 %value.").add_operation (var_idx_11230, inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 242)).add_operation (GALGAS_string (", i32* %ptr."), inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 242)).add_operation (var_idx_11230, inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 242)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 242)), inCompiler  COMMA_SOURCE_FILE ("instruction-bit-banding.galgas", 242)) ;
}
...
static void extensionMethod_procedureCallInstructionAST_noteInstructionTypesInPrecedenceGraph (const cPtr_instructionAST * inObject,
  ...
  cEnumerator_accessInAssignmentListAST enumerator_3446 (object->mProperty_mAccessList, kENUMERATION_UP) ;
  while (enumerator_3446.hasCurrentObject ()) {
    switch (enumerator_3446.current_mAccess (HERE).enumValue ()) {
    ...
    case GALGAS_accessInAssignmentAST::kEnum_arrayAccess:
      {
        const cEnumAssociatedValues_accessInAssignmentAST_arrayAccess * extractPtr_3620 = (const cEnumAssociatedValues_accessInAssignmentAST_arrayAccess *) (enumerator_3446.current_mAccess (HERE).unsafePointer ()) ;
        const GALGAS_expressionAST extractedValue_indexExpression = extractPtr_3620->mAssociatedValue0 ;
        callExtensionMethod_noteExpressionTypesInPrecedenceGraph ((const cPtr_expressionAST *) extractedValue_indexExpression.ptr (), ioArgument_ioGraph, inCompiler COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 80)) ;
      }
      break ;
    }
    enumerator_3446.gotoNextObject () ;
  }
  cEnumerator_effectiveArgumentListAST enumerator_3657 (object->mProperty_mArguments, kENUMERATION_UP) ;
  while (enumerator_3657.hasCurrentObject ()) {
    switch (enumerator_3657.current_mEffectiveParameterKind (HERE).enumValue ()) {
    case GALGAS_effectiveArgumentPassingModeAST::kNotBuilt:
      break ;
    case GALGAS_effectiveArgumentPassingModeAST::kEnum_input:
      {
    ...
    case GALGAS_effectiveArgumentPassingModeAST::kEnum_inputWithType:
      {
        const cEnumAssociatedValues_effectiveArgumentPassingModeAST_inputWithType * extractPtr_3876 = (const cEnumAssociatedValues_effectiveArgumentPassingModeAST_inputWithType *) (enumerator_3657.current_mEffectiveParameterKind (HERE).unsafePointer ()) ;
        const GALGAS_lstring extractedValue_typeName = extractPtr_3876->mAssociatedValue1 ;
        const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, extractedValue_typeName.getter_string (HERE).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
        if (kBoolTrue == test_0) {
          {
          ioArgument_ioGraph.setter_noteNode (function_llvmTypeNameFromPLMname (extractedValue_typeName, inCompiler COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 88)) COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 88)) ;
          }
        }
      }
      break ;
    case GALGAS_effectiveArgumentPassingModeAST::kEnum_output:
      {
        const cEnumAssociatedValues_effectiveArgumentPassingModeAST_output * extractPtr_3969 = (const cEnumAssociatedValues_effectiveArgumentPassingModeAST_output *) (enumerator_3657.current_mEffectiveParameterKind (HERE).unsafePointer ()) ;
        const GALGAS_expressionAST extractedValue_expression = extractPtr_3969->mAssociatedValue0 ;
        callExtensionMethod_noteExpressionTypesInPrecedenceGraph ((const cPtr_expressionAST *) extractedValue_expression.ptr (), ioArgument_ioGraph, inCompiler COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 90)) ;
      }
      break ;
    case GALGAS_effectiveArgumentPassingModeAST::kEnum_outputInput:
      {
...
static void extensionMethod_standAloneProcedureCallInstructionAST_noteInstructionTypesInPrecedenceGraph (const cPtr_instructionAST * inObject,
  ...
  cEnumerator_effectiveArgumentListAST enumerator_4334 (object->mProperty_mArguments, kENUMERATION_UP) ;
  while (enumerator_4334.hasCurrentObject ()) {
    switch (enumerator_4334.current_mEffectiveParameterKind (HERE).enumValue ()) {
    case GALGAS_effectiveArgumentPassingModeAST::kNotBuilt:
      break ;
    case GALGAS_effectiveArgumentPassingModeAST::kEnum_input:
      {
    ...
    case GALGAS_effectiveArgumentPassingModeAST::kEnum_inputWithType:
      {
        const cEnumAssociatedValues_effectiveArgumentPassingModeAST_inputWithType * extractPtr_4553 = (const cEnumAssociatedValues_effectiveArgumentPassingModeAST_inputWithType *) (enumerator_4334.current_mEffectiveParameterKind (HERE).unsafePointer ()) ;
        const GALGAS_lstring extractedValue_typeName = extractPtr_4553->mAssociatedValue1 ;
        const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, extractedValue_typeName.getter_string (HERE).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
        if (kBoolTrue == test_0) {
          {
          ioArgument_ioGraph.setter_noteNode (function_llvmTypeNameFromPLMname (extractedValue_typeName, inCompiler COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 107)) COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 107)) ;
          }
        }
      }
      break ;
    case GALGAS_effectiveArgumentPassingModeAST::kEnum_output:
      {
        const cEnumAssociatedValues_effectiveArgumentPassingModeAST_output * extractPtr_4646 = (const cEnumAssociatedValues_effectiveArgumentPassingModeAST_output *) (enumerator_4334.current_mEffectiveParameterKind (HERE).unsafePointer ()) ;
        const GALGAS_expressionAST extractedValue_expression = extractPtr_4646->mAssociatedValue0 ;
        callExtensionMethod_noteExpressionTypesInPrecedenceGraph ((const cPtr_expressionAST *) extractedValue_expression.ptr (), ioArgument_ioGraph, inCompiler COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 109)) ;
      }
      break ;
    case GALGAS_effectiveArgumentPassingModeAST::kEnum_outputInput:
      {
...
static void extensionMethod_standAloneProcedureCallInstructionAST_instructionSemanticAnalysis (const cPtr_instructionAST * inObject,
  ...
  const cPtr_standAloneProcedureCallInstructionAST * object = (const cPtr_standAloneProcedureCallInstructionAST *) inObject ;
  macroValidSharedObject (object, cPtr_standAloneProcedureCallInstructionAST) ;
  GALGAS_lstring var_calledRoutineSignature_6562 = extensionGetter_routineSignature (object->mProperty_mArguments, object->mProperty_mSandAloneRoutineName.getter_location (HERE), inCompiler COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 156)) ;
  GALGAS_lstring var_LLVMInvocationRoutineName_6805 ;
  GALGAS_routineDescriptor var_routineDescriptor_6851 ;
  GALGAS_location var_keyLocation_6889 ;
  extensionMethod_searchKey (constinArgument_inContext.getter_mRoutineMapForContext (HERE), GALGAS_string::makeEmptyString (), object->mProperty_mSandAloneRoutineName, var_calledRoutineSignature_6562, var_LLVMInvocationRoutineName_6805, var_routineDescriptor_6851, var_keyLocation_6889, inCompiler COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 158)) ;
  GALGAS_lstring var_routineMangledName_6957 = function_routineMangledNameFromCall (GALGAS_string::makeEmptyString (), object->mProperty_mSandAloneRoutineName, object->mProperty_mArguments, inCompiler COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 167)) ;
  {
  ioArgument_ioTemporaries.mProperty_mSubprogramInvocationGraph.setter_addEdge (constinArgument_inCallerNameForInvocationGraph, var_routineMangledName_6957 COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 173)) ;
  }
  GALGAS_calleeKindIR var_routineKindIR_7218 = function_checkMode (constinArgument_inCurrentMode, extensionGetter_executionMode (var_routineDescriptor_6851.getter_routineKind (HERE), inCompiler COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 177)), var_routineDescriptor_6851.getter_routineKind (HERE), object->mProperty_mSandAloneRoutineName.getter_location (HERE), inCompiler COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 175)) ;
  GALGAS_procCallEffectiveParameterListIR var_effectiveParameterListIR_7505 = GALGAS_procCallEffectiveParameterListIR::constructor_emptyList (SOURCE_FILE ("instruction-procedure-call.galgas", 182)) ;
  {
  routine_analyzeEffectiveParameters (constinArgument_inSelfType, constinArgument_inRoutineAttributes, var_routineDescriptor_6851.getter_signature (HERE), object->mProperty_mArguments, object->mProperty_mSandAloneRoutineName.getter_location (HERE), constinArgument_inCallerNameForInvocationGraph, constinArgument_inContext, constinArgument_inCurrentMode, ioArgument_ioTemporaries, ioArgument_ioStaticEntityMap, ioArgument_ioUniversalMap, ioArgument_ioAllocaList, ioArgument_ioInstructionGenerationList, var_effectiveParameterListIR_7505, inCompiler  COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 183)) ;
  }
  ioArgument_ioInstructionGenerationList.addAssign_operation (GALGAS_standaloneRoutineCallIR::constructor_new (GALGAS_string::makeEmptyString (), GALGAS_objectIR::constructor_void (SOURCE_FILE ("instruction-procedure-call.galgas", 203)), var_routineMangledName_6957, var_LLVMInvocationRoutineName_6805, var_routineKindIR_7218, var_effectiveParameterListIR_7505  COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 201))  COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 201)) ;
}
...
static void extensionMethod_procedureCallInstructionAST_instructionSemanticAnalysis (const cPtr_instructionAST * inObject,
  ...
  const cPtr_procedureCallInstructionAST * object = (const cPtr_procedureCallInstructionAST *) inObject ;
  macroValidSharedObject (object, cPtr_procedureCallInstructionAST) ;
  GALGAS_PLMType var_currentType_9191 ;
  GALGAS_string var_currentLLVMAddressVar_9223 ;
  ...
  if (kBoolTrue == test_0) {
    const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, constinArgument_inSelfType.getter_kind (HERE).objectCompare (GALGAS_typeKind::constructor_void (SOURCE_FILE ("instruction-procedure-call.galgas", 230)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      TC_Array <C_FixItDescription> fixItArray2 ;
      inCompiler->emitSemanticError (object->mProperty_mIdentifier.getter_location (SOURCE_FILE ("instruction-procedure-call.galgas", 231)), GALGAS_string ("self is not available in this context"), fixItArray2  COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 231)) ;
      var_currentType_9191.drop () ; // Release error dropped variable
      var_currentLLVMAddressVar_9223.drop () ; // Release error dropped variable
    }else if (kBoolFalse == test_1) {
      var_currentType_9191 = constinArgument_inSelfType ;
      var_currentLLVMAddressVar_9223 = function_llvmNameForSelf (inCompiler COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 234)) ;
    }
  }else if (kBoolFalse == test_0) {
    GALGAS_valuedObject var_entity_9593 ;
    extensionMethod_searchEntity (ioArgument_ioUniversalMap, object->mProperty_mIdentifier, var_entity_9593, inCompiler COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 237)) ;
    switch (var_entity_9593.enumValue ()) {
    case GALGAS_valuedObject::kNotBuilt:
      break ;
    case GALGAS_valuedObject::kEnum_task:
      {
        const cEnumAssociatedValues_valuedObject_task * extractPtr_9740 = (const cEnumAssociatedValues_valuedObject_task *) (var_entity_9593.unsafePointer ()) ;
        const GALGAS_PLMType extractedValue_type = extractPtr_9740->mAssociatedValue0 ;
        var_currentType_9191 = extractedValue_type ;
        var_currentLLVMAddressVar_9223 = function_llvmNameForGlobalVariable (object->mProperty_mIdentifier.getter_string (SOURCE_FILE ("instruction-procedure-call.galgas", 241)), inCompiler COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 241)) ;
      }
      break ;
    case GALGAS_valuedObject::kEnum_driver:
      {
        const cEnumAssociatedValues_valuedObject_driver * extractPtr_10030 = (const cEnumAssociatedValues_valuedObject_driver *) (var_entity_9593.unsafePointer ()) ;
        const GALGAS_PLMType extractedValue_type = extractPtr_10030->mAssociatedValue0 ;
        const GALGAS_bool extractedValue_instancied = extractPtr_10030->mAssociatedValue1 ;
        const enumGalgasBool test_3 = extractedValue_instancied.boolEnum () ;
        if (kBoolTrue == test_3) {
          var_currentType_9191 = extractedValue_type ;
          var_currentLLVMAddressVar_9223 = function_llvmNameForGlobalVariable (object->mProperty_mIdentifier.getter_string (SOURCE_FILE ("instruction-procedure-call.galgas", 245)), inCompiler COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 245)) ;
        }else if (kBoolFalse == test_3) {
          TC_Array <C_FixItDescription> fixItArray4 ;
          inCompiler->emitSemanticError (object->mProperty_mIdentifier.getter_location (SOURCE_FILE ("instruction-procedure-call.galgas", 247)), GALGAS_string ("the driver should be instancied"), fixItArray4  COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 247)) ;
          var_currentType_9191.drop () ; // Release error dropped variable
          var_currentLLVMAddressVar_9223.drop () ; // Release error dropped variable
        }
      }
    ...
    case GALGAS_valuedObject::kEnum_registerGroup:
      {
        TC_Array <C_FixItDescription> fixItArray5 ;
        inCompiler->emitSemanticError (object->mProperty_mIdentifier.getter_location (SOURCE_FILE ("instruction-procedure-call.galgas", 250)), GALGAS_string ("a control register constant cannot be used in this context"), fixItArray5  COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 250)) ;
        var_currentType_9191.drop () ; // Release error dropped variable
        var_currentLLVMAddressVar_9223.drop () ; // Release error dropped variable
      }
      break ;
    case GALGAS_valuedObject::kEnum_globalConstant:
      {
        TC_Array <C_FixItDescription> fixItArray6 ;
        inCompiler->emitSemanticError (object->mProperty_mIdentifier.getter_location (SOURCE_FILE ("instruction-procedure-call.galgas", 254)), GALGAS_string ("a global constant cannot be used in this context"), fixItArray6  COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 254)) ;
        var_currentType_9191.drop () ; // Release error dropped variable
        var_currentLLVMAddressVar_9223.drop () ; // Release error dropped variable
      }
      break ;
    case GALGAS_valuedObject::kEnum_localConstant:
      {
        const cEnumAssociatedValues_valuedObject_localConstant * extractPtr_10510 = (const cEnumAssociatedValues_valuedObject_localConstant *) (var_entity_9593.unsafePointer ()) ;
        const GALGAS_PLMType extractedValue_type = extractPtr_10510->mAssociatedValue0 ;
        const GALGAS_lstring extractedValue_plmName = extractPtr_10510->mAssociatedValue1 ;
        var_currentType_9191 = extractedValue_type ;
        var_currentLLVMAddressVar_9223 = function_llvmNameForLocalVariable (extractedValue_plmName.getter_string (SOURCE_FILE ("instruction-procedure-call.galgas", 259)), inCompiler COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 259)) ;
      }
      break ;
    case GALGAS_valuedObject::kEnum_localVariable:
      {
        const cEnumAssociatedValues_valuedObject_localVariable * extractPtr_10659 = (const cEnumAssociatedValues_valuedObject_localVariable *) (var_entity_9593.unsafePointer ()) ;
        const GALGAS_PLMType extractedValue_type = extractPtr_10659->mAssociatedValue0 ;
        const GALGAS_lstring extractedValue_plmName = extractPtr_10659->mAssociatedValue1 ;
        var_currentType_9191 = extractedValue_type ;
        var_currentLLVMAddressVar_9223 = function_llvmNameForLocalVariable (extractedValue_plmName.getter_string (SOURCE_FILE ("instruction-procedure-call.galgas", 262)), inCompiler COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 262)) ;
      }
      break ;
    case GALGAS_valuedObject::kEnum_globalSyncInstance:
      {
        const cEnumAssociatedValues_valuedObject_globalSyncInstance * extractPtr_10818 = (const cEnumAssociatedValues_valuedObject_globalSyncInstance *) (var_entity_9593.unsafePointer ()) ;
        const GALGAS_PLMType extractedValue_type = extractPtr_10818->mAssociatedValue0 ;
        const GALGAS_lstring extractedValue_plmName = extractPtr_10818->mAssociatedValue1 ;
        var_currentType_9191 = extractedValue_type ;
        var_currentLLVMAddressVar_9223 = function_llvmNameForGlobalSyncInstance (extractedValue_plmName.getter_string (SOURCE_FILE ("instruction-procedure-call.galgas", 265)), inCompiler COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 265)) ;
      }
      break ;
    }
  }
  GALGAS_propertyMap var_currentObjectPropertyMap_10909 = var_currentType_9191.getter_propertyMap (HERE) ;
  GALGAS_accessInAssignmentListAST var_accessList_11024 = object->mProperty_mAccessList ;
  GALGAS_accessInAssignmentAST var_lastAccess_11078 ;
  {
  var_accessList_11024.setter_popLast (var_lastAccess_11078, inCompiler COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 272)) ;
  }
  cEnumerator_accessInAssignmentListAST enumerator_11133 (var_accessList_11024, kENUMERATION_UP) ;
  while (enumerator_11133.hasCurrentObject ()) {
    switch (enumerator_11133.current_mAccess (HERE).enumValue ()) {
    case GALGAS_accessInAssignmentAST::kNotBuilt:
      break ;
    case GALGAS_accessInAssignmentAST::kEnum_property:
      {
        const cEnumAssociatedValues_accessInAssignmentAST_property * extractPtr_12510 = (const cEnumAssociatedValues_accessInAssignmentAST_property *) (enumerator_11133.current_mAccess (HERE).unsafePointer ()) ;
        const GALGAS_lstring extractedValue_propertyName = extractPtr_12510->mAssociatedValue0 ;
        GALGAS_bool var_isPublic_11406 ;
        GALGAS_propertyAccessKind var_propertyAccess_11454 ;
        var_currentObjectPropertyMap_10909.method_searchKey (extractedValue_propertyName, var_isPublic_11406, var_propertyAccess_11454, inCompiler COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 279)) ;
        switch (var_propertyAccess_11454.enumValue ()) {
        case GALGAS_propertyAccessKind::kNotBuilt:
          break ;
        case GALGAS_propertyAccessKind::kEnum_nonVirtualMethod:
          {
            TC_Array <C_FixItDescription> fixItArray7 ;
            inCompiler->emitSemanticError (extractedValue_propertyName.getter_location (SOURCE_FILE ("instruction-procedure-call.galgas", 286)), GALGAS_string ("a method cannot be used in this context"), fixItArray7  COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 286)) ;
            var_currentType_9191.drop () ; // Release error dropped variable
            var_currentLLVMAddressVar_9223.drop () ; // Release error dropped variable
          }
          break ;
        case GALGAS_propertyAccessKind::kEnum_constantProperty:
          {
            TC_Array <C_FixItDescription> fixItArray8 ;
            inCompiler->emitSemanticError (extractedValue_propertyName.getter_location (SOURCE_FILE ("instruction-procedure-call.galgas", 288)), GALGAS_string ("a context property cannot be used in this context"), fixItArray8  COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 288)) ;
            var_currentType_9191.drop () ; // Release error dropped variable
            var_currentLLVMAddressVar_9223.drop () ; // Release error dropped variable
          }
          break ;
        case GALGAS_propertyAccessKind::kEnum_singleton:
          {
            const cEnumAssociatedValues_propertyAccessKind_singleton * extractPtr_11997 = (const cEnumAssociatedValues_propertyAccessKind_singleton *) (var_propertyAccess_11454.unsafePointer ()) ;
            const GALGAS_objectIR extractedValue_object = extractPtr_11997->mAssociatedValue0 ;
            var_currentType_9191 = extensionGetter_type (extractedValue_object, inCompiler COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 292)) ;
            var_currentLLVMAddressVar_9223 = extensionGetter_llvmName (extractedValue_object, inCompiler COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 293)) ;
            var_currentObjectPropertyMap_10909 = extensionGetter_type (extractedValue_object, inCompiler COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 294)).getter_propertyMap (HERE) ;
          }
          break ;
        case GALGAS_propertyAccessKind::kEnum_indexed:
          {
            const cEnumAssociatedValues_propertyAccessKind_indexed * extractPtr_12493 = (const cEnumAssociatedValues_propertyAccessKind_indexed *) (var_propertyAccess_11454.unsafePointer ()) ;
            const GALGAS_PLMType extractedValue_propertyType = extractPtr_12493->mAssociatedValue0 ;
            const GALGAS_uint extractedValue_propertyIndex = extractPtr_12493->mAssociatedValue1 ;
            GALGAS_string var_llvmPropertyName_12131 ;
            {
            extensionSetter_newTempLLVMVar (ioArgument_ioTemporaries, var_llvmPropertyName_12131, inCompiler COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 296)) ;
            }
            {
            extensionSetter_appendGetUniversalPropertyReference (ioArgument_ioInstructionGenerationList, var_currentType_9191, var_currentLLVMAddressVar_9223, var_llvmPropertyName_12131, extractedValue_propertyIndex, extractedValue_propertyName.getter_string (SOURCE_FILE ("instruction-procedure-call.galgas", 302)), inCompiler COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 297)) ;
            }
            var_currentType_9191 = extractedValue_propertyType ;
            var_currentLLVMAddressVar_9223 = var_llvmPropertyName_12131 ;
            var_currentObjectPropertyMap_10909 = var_currentType_9191.getter_propertyMap (HERE) ;
          }
          break ;
        }
      }
    ...
    case GALGAS_accessInAssignmentAST::kEnum_arrayAccess:
      {
        const cEnumAssociatedValues_accessInAssignmentAST_arrayAccess * extractPtr_12674 = (const cEnumAssociatedValues_accessInAssignmentAST_arrayAccess *) (enumerator_11133.current_mAccess (HERE).unsafePointer ()) ;
        const GALGAS_expressionAST extractedValue_indexExpression = extractPtr_12674->mAssociatedValue0 ;
        const GALGAS_location extractedValue_endOfIndex = extractPtr_12674->mAssociatedValue1 ;
        TC_Array <C_FixItDescription> fixItArray9 ;
        inCompiler->emitSemanticError (extractedValue_endOfIndex, GALGAS_string ("not handled yet"), fixItArray9  COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 309)) ;
        var_currentType_9191.drop () ; // Release error dropped variable
        var_currentLLVMAddressVar_9223.drop () ; // Release error dropped variable
      }
      break ;
  ...
  switch (var_lastAccess_11078.enumValue ()) {
  case GALGAS_accessInAssignmentAST::kNotBuilt:
    break ;
  case GALGAS_accessInAssignmentAST::kEnum_arrayAccess:
    {
      const cEnumAssociatedValues_accessInAssignmentAST_arrayAccess * extractPtr_12930 = (const cEnumAssociatedValues_accessInAssignmentAST_arrayAccess *) (var_lastAccess_11078.unsafePointer ()) ;
      const GALGAS_location extractedValue_endOfIndex = extractPtr_12930->mAssociatedValue1 ;
      TC_Array <C_FixItDescription> fixItArray10 ;
      inCompiler->emitSemanticError (extractedValue_endOfIndex, GALGAS_string ("a property is required here"), fixItArray10  COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 317)) ;
    }
    break ;
  case GALGAS_accessInAssignmentAST::kEnum_property:
    {
      const cEnumAssociatedValues_accessInAssignmentAST_property * extractPtr_18231 = (const cEnumAssociatedValues_accessInAssignmentAST_property *) (var_lastAccess_11078.unsafePointer ()) ;
      const GALGAS_lstring extractedValue_methodName = extractPtr_18231->mAssociatedValue0 ;
      GALGAS_propertyMap var_propertyMap_12990 = var_currentObjectPropertyMap_10909 ;
      GALGAS_lstring var_key_13036 = function_routineMangledNameFromCall (GALGAS_string::makeEmptyString (), extractedValue_methodName, object->mProperty_mArguments, inCompiler COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 320)) ;
      GALGAS_propertyAccessKind var_propertyAccess_13170 ;
      GALGAS_bool joker_13129 ; // Joker input parameter
      var_propertyMap_12990.method_searchKey (var_key_13036, joker_13129, var_propertyAccess_13170, inCompiler COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 321)) ;
      switch (var_propertyAccess_13170.enumValue ()) {
      case GALGAS_propertyAccessKind::kNotBuilt:
        break ;
      case GALGAS_propertyAccessKind::kEnum_constantProperty:
        {
          TC_Array <C_FixItDescription> fixItArray11 ;
          inCompiler->emitSemanticError (extractedValue_methodName.getter_location (SOURCE_FILE ("instruction-procedure-call.galgas", 324)), GALGAS_string ("a constant cannot be used as method"), fixItArray11  COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 324)) ;
        }
        break ;
      case GALGAS_propertyAccessKind::kEnum_nonVirtualMethod:
        {
          const cEnumAssociatedValues_propertyAccessKind_nonVirtualMethod * extractPtr_15975 = (const cEnumAssociatedValues_propertyAccessKind_nonVirtualMethod *) (var_propertyAccess_13170.unsafePointer ()) ;
          const GALGAS_routineDescriptor extractedValue_routineDescriptor = extractPtr_15975->mAssociatedValue0 ;
          GALGAS_procCallEffectiveParameterListIR temp_12 = GALGAS_procCallEffectiveParameterListIR::constructor_emptyList (SOURCE_FILE ("instruction-procedure-call.galgas", 329)) ;
          temp_12.addAssign_operation (GALGAS_procEffectiveParameterPassingModeIR::constructor_outputInput (SOURCE_FILE ("instruction-procedure-call.galgas", 328)), GALGAS_objectIR::constructor_reference (var_currentType_9191, var_currentLLVMAddressVar_9223  COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 329))  COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 329)) ;
          GALGAS_procCallEffectiveParameterListIR var_effectiveParameterListIR_13465 = temp_12 ;
          GALGAS_routineKind var_routineKind_13652 = extractedValue_routineDescriptor.getter_routineKind (HERE) ;
          GALGAS_mode var_calleeMode_13705 = extensionGetter_executionMode (var_routineKind_13652, inCompiler COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 334)) ;
          GALGAS_routineTypedSignature var_formalSignature_13761 = extractedValue_routineDescriptor.getter_signature (HERE) ;
          ...
          if (kBoolTrue == test_14.boolEnum ()) {
            test_14 = constinArgument_inRoutineAttributes.getter_mutating (SOURCE_FILE ("instruction-procedure-call.galgas", 338)).operator_not (SOURCE_FILE ("instruction-procedure-call.galgas", 338)) ;
          }
          const enumGalgasBool test_15 = test_14.boolEnum () ;
          if (kBoolTrue == test_15) {
            TC_Array <C_FixItDescription> fixItArray16 ;
            inCompiler->emitSemanticError (extractedValue_methodName.getter_location (SOURCE_FILE ("instruction-procedure-call.galgas", 339)), GALGAS_string ("cannot mutate properties, current method is not declared with @").add_operation (function_mutatingAttribute (inCompiler COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 340)), inCompiler COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 340)).add_operation (GALGAS_string (" attribute"), inCompiler COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 340)), fixItArray16  COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 339)) ;
          }
          const enumGalgasBool test_17 = GALGAS_bool (kIsNotEqual, extractedValue_routineDescriptor.getter_returnTypeProxy (HERE).objectCompare (GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("instruction-procedure-call.galgas", 343)))).boolEnum () ;
          if (kBoolTrue == test_17) {
            TC_Array <C_FixItDescription> fixItArray18 ;
            inCompiler->emitSemanticError (extractedValue_methodName.getter_location (SOURCE_FILE ("instruction-procedure-call.galgas", 344)), GALGAS_string ("not a procedure (returns a value)"), fixItArray18  COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 344)) ;
          }else if (kBoolFalse == test_17) {
            GALGAS_calleeKindIR var_calleeKind_14463 = function_checkMode (constinArgument_inCurrentMode, var_calleeMode_13705, var_routineKind_13652, extractedValue_methodName.getter_location (HERE), inCompiler COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 347)) ;
            {
            routine_analyzeEffectiveParameters (constinArgument_inSelfType, constinArgument_inRoutineAttributes, var_formalSignature_13761, object->mProperty_mArguments, extractedValue_methodName.getter_location (HERE), constinArgument_inCallerNameForInvocationGraph, constinArgument_inContext, constinArgument_inCurrentMode, ioArgument_ioTemporaries, ioArgument_ioStaticEntityMap, ioArgument_ioUniversalMap, ioArgument_ioAllocaList, ioArgument_ioInstructionGenerationList, var_effectiveParameterListIR_13465, inCompiler  COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 354)) ;
            }
            GALGAS_lstring var_routineMangledName_15392 = function_routineMangledNameFromCall (function_llvmTypeStringFromPLMname (var_currentType_9191.getter_plmOriginalTypeName (HERE), inCompiler COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 371)), extractedValue_methodName, object->mProperty_mArguments, inCompiler COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 371)) ;
            ioArgument_ioInstructionGenerationList.addAssign_operation (GALGAS_standaloneRoutineCallIR::constructor_new (object->mProperty_mIdentifier.getter_string (SOURCE_FILE ("instruction-procedure-call.galgas", 374)), GALGAS_objectIR::constructor_void (SOURCE_FILE ("instruction-procedure-call.galgas", 375)), var_routineMangledName_15392, var_routineMangledName_15392, var_calleeKind_14463, var_effectiveParameterListIR_13465  COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 373))  COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 373)) ;
            {
            ioArgument_ioTemporaries.mProperty_mSubprogramInvocationGraph.setter_addEdge (constinArgument_inCallerNameForInvocationGraph, var_routineMangledName_15392 COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 382)) ;
            }
          }
        }
        break ;
      case GALGAS_propertyAccessKind::kEnum_singleton:
        {
          const cEnumAssociatedValues_propertyAccessKind_singleton * extractPtr_16081 = (const cEnumAssociatedValues_propertyAccessKind_singleton *) (var_propertyAccess_13170.unsafePointer ()) ;
          const GALGAS_location extractedValue_errorLocation = extractPtr_16081->mAssociatedValue1 ;
          TC_Array <C_FixItDescription> fixItArray19 ;
          inCompiler->emitSemanticError (extractedValue_errorLocation, GALGAS_string ("a property cannot be used as method"), fixItArray19  COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 385)) ;
        }
        break ;
      case GALGAS_propertyAccessKind::kEnum_indexed:
        {
          const cEnumAssociatedValues_propertyAccessKind_indexed * extractPtr_18223 = (const cEnumAssociatedValues_propertyAccessKind_indexed *) (var_propertyAccess_13170.unsafePointer ()) ;
          const GALGAS_PLMType extractedValue_propertyType = extractPtr_18223->mAssociatedValue0 ;
          const GALGAS_uint extractedValue_propertyIndex = extractPtr_18223->mAssociatedValue1 ;
          const enumGalgasBool test_20 = extractedValue_propertyType.getter_kind (HERE).getter_isFunction (SOURCE_FILE ("instruction-procedure-call.galgas", 387)).operator_not (SOURCE_FILE ("instruction-procedure-call.galgas", 387)).boolEnum () ;
          if (kBoolTrue == test_20) {
            TC_Array <C_FixItDescription> fixItArray21 ;
            inCompiler->emitSemanticError (extractedValue_methodName.getter_location (SOURCE_FILE ("instruction-procedure-call.galgas", 388)), GALGAS_string ("an indexed property cannot be used as method"), fixItArray21  COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 388)) ;
          }else if (kBoolFalse == test_20) {
            GALGAS_routineDescriptor var_descriptor_16342 ;
            extractedValue_propertyType.getter_kind (HERE).method_function (var_descriptor_16342, inCompiler COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 390)) ;
            const enumGalgasBool test_22 = GALGAS_bool (kIsNotEqual, var_descriptor_16342.getter_returnTypeProxy (HERE).objectCompare (GALGAS_unifiedTypeMap_2D_proxy::constructor_null (SOURCE_FILE ("instruction-procedure-call.galgas", 392)))).boolEnum () ;
            if (kBoolTrue == test_22) {
              TC_Array <C_FixItDescription> fixItArray23 ;
              inCompiler->emitSemanticError (extractedValue_methodName.getter_location (SOURCE_FILE ("instruction-procedure-call.galgas", 393)), GALGAS_string ("a function returns a value and cannot be called as a procedure"), fixItArray23  COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 393)) ;
            }else if (kBoolFalse == test_22) {
              GALGAS_procCallEffectiveParameterListIR var_effectiveParameterListIR_16893 = GALGAS_procCallEffectiveParameterListIR::constructor_emptyList (SOURCE_FILE ("instruction-procedure-call.galgas", 403)) ;
              {
              routine_analyzeEffectiveParameters (constinArgument_inSelfType, constinArgument_inRoutineAttributes, var_descriptor_16342.getter_signature (HERE), object->mProperty_mArguments, extractedValue_methodName.getter_location (HERE), constinArgument_inCallerNameForInvocationGraph, constinArgument_inContext, constinArgument_inCurrentMode, ioArgument_ioTemporaries, ioArgument_ioStaticEntityMap, ioArgument_ioUniversalMap, ioArgument_ioAllocaList, ioArgument_ioInstructionGenerationList, var_effectiveParameterListIR_16893, inCompiler  COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 404)) ;
              }
              GALGAS_string var_property_5F_llvmName_17664 ;
              {
              extensionSetter_newTempLLVMVar (ioArgument_ioTemporaries, var_property_5F_llvmName_17664, inCompiler COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 421)) ;
              }
              {
              extensionSetter_appendGetUniversalPropertyReference (ioArgument_ioInstructionGenerationList, var_currentType_9191, var_currentLLVMAddressVar_9223, var_property_5F_llvmName_17664, extractedValue_propertyIndex, extractedValue_methodName.getter_string (SOURCE_FILE ("instruction-procedure-call.galgas", 427)), inCompiler COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 422)) ;
              }
              ioArgument_ioInstructionGenerationList.addAssign_operation (GALGAS_indirectRoutineCallIR::constructor_new (GALGAS_objectIR::constructor_reference (extractedValue_propertyType, var_property_5F_llvmName_17664  COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 431)), extractedValue_propertyType, GALGAS_objectIR::constructor_void (SOURCE_FILE ("instruction-procedure-call.galgas", 433)), var_effectiveParameterListIR_16893  COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 430))  COMMA_SOURCE_FILE ("instruction-procedure-call.galgas", 430)) ;
            }
          }
        }
        break ;
...
void routine_analyzeControlRegisterInLValue (const GALGAS_PLMType constinArgument_inSelfType,
  ...
  const enumGalgasBool test_0 = constinArgument_inKind.getter_isRegister (SOURCE_FILE ("lvalue.galgas", 247)).operator_not (SOURCE_FILE ("lvalue.galgas", 247)).boolEnum () ;
  if (kBoolTrue == test_0) {
    TC_Array <C_FixItDescription> fixItArray1 ;
    inCompiler->emitSemanticError (constinArgument_inRegisterGroupName.getter_location (SOURCE_FILE ("lvalue.galgas", 248)), GALGAS_string ("the \":\" access is reserved for control register"), fixItArray1  COMMA_SOURCE_FILE ("lvalue.galgas", 248)) ;
    outArgument_outInternalRepresentation.drop () ; // Release error dropped variable
  }else if (kBoolFalse == test_0) {
    GALGAS_lstring var_registerName_10069 ;
    GALGAS_registerIndexAST var_registerIndex_10094 ;
    constinArgument_inKind.method_register (var_registerName_10069, var_registerIndex_10094, inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 250)) ;
    GALGAS_PLMType var_inRegisterType_10186 ;
    GALGAS_bool var_readOnly_10212 ;
    GALGAS_bool var_userAccess_10240 ;
    GALGAS_sliceMap var_inRegisterSliceMap_10287 ;
    GALGAS_controlRegisterFieldMap var_mRegisterFieldMap_10348 ;
    GALGAS_controlRegisterGroupKind var_controlRegisterGroupKind_10410 ;
    GALGAS_controlRegisterFieldList var_mControlRegisterFieldList_10480 ;
    GALGAS_uint var_mRegisterBitCount_10543 ;
    GALGAS_uint var_inRegisterArraySize_10580 ;
    GALGAS_uint var_inRegisterElementSize_10639 ;
    constinArgument_inControlRegisterMap.method_searchKey (var_registerName_10069, var_inRegisterType_10186, var_readOnly_10212, var_userAccess_10240, var_inRegisterSliceMap_10287, var_mRegisterFieldMap_10348, var_controlRegisterGroupKind_10410, var_mControlRegisterFieldList_10480, var_mRegisterBitCount_10543, var_inRegisterArraySize_10580, var_inRegisterElementSize_10639, inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 251)) ;
    switch (var_controlRegisterGroupKind_10410.enumValue ()) {
    case GALGAS_controlRegisterGroupKind::kNotBuilt:
      break ;
    case GALGAS_controlRegisterGroupKind::kEnum_single:
      {
        const cEnumAssociatedValues_controlRegisterGroupKind_single * extractPtr_12939 = (const cEnumAssociatedValues_controlRegisterGroupKind_single *) (var_controlRegisterGroupKind_10410.unsafePointer ()) ;
        const GALGAS_bigint extractedValue_registerAddress = extractPtr_12939->mAssociatedValue0 ;
        const enumGalgasBool test_2 = var_readOnly_10212.boolEnum () ;
        if (kBoolTrue == test_2) {
          TC_Array <C_FixItDescription> fixItArray3 ;
          inCompiler->emitSemanticError (var_registerName_10069.getter_location (SOURCE_FILE ("lvalue.galgas", 267)), GALGAS_string ("this control register cannot be modified (declared with @ro attribute)"), fixItArray3  COMMA_SOURCE_FILE ("lvalue.galgas", 267)) ;
          outArgument_outInternalRepresentation.drop () ; // Release error dropped variable
        }else if (kBoolFalse == test_2) {
          GALGAS_bool test_4 = var_userAccess_10240.operator_not (SOURCE_FILE ("lvalue.galgas", 269)) ;
          if (kBoolTrue == test_4.boolEnum ()) {
            GALGAS_bool test_5 = constinArgument_inMode.getter_isUserMode (SOURCE_FILE ("lvalue.galgas", 269)) ;
            if (kBoolTrue != test_5.boolEnum ()) {
              test_5 = constinArgument_inMode.getter_isAnyMode (SOURCE_FILE ("lvalue.galgas", 269)) ;
            }
            test_4 = test_5 ;
          }
          const enumGalgasBool test_6 = test_4.boolEnum () ;
          if (kBoolTrue == test_6) {
            TC_Array <C_FixItDescription> fixItArray7 ;
            inCompiler->emitSemanticError (var_registerName_10069.getter_location (SOURCE_FILE ("lvalue.galgas", 270)), GALGAS_string ("this control register is not accessible in user mode"), fixItArray7  COMMA_SOURCE_FILE ("lvalue.galgas", 270)) ;
            outArgument_outInternalRepresentation.drop () ; // Release error dropped variable
          }else if (kBoolFalse == test_6) {
            const enumGalgasBool test_8 = var_registerIndex_10094.getter_isNoIndex (SOURCE_FILE ("lvalue.galgas", 271)).boolEnum () ;
            if (kBoolTrue == test_8) {
              const enumGalgasBool test_9 = GALGAS_bool (kIsEqual, var_inRegisterArraySize_10580.objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
              if (kBoolTrue == test_9) {
                outArgument_outInternalRepresentation = GALGAS_LValueRepresentation::constructor_volatileAbsoluteReference (var_inRegisterType_10186, extractedValue_registerAddress.getter_uint (inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 273))  COMMA_SOURCE_FILE ("lvalue.galgas", 273)) ;
              }else if (kBoolFalse == test_9) {
                TC_Array <C_FixItDescription> fixItArray10 ;
                inCompiler->emitSemanticError (var_registerName_10069.getter_location (SOURCE_FILE ("lvalue.galgas", 275)), GALGAS_string ("the control register is an array"), fixItArray10  COMMA_SOURCE_FILE ("lvalue.galgas", 275)) ;
                outArgument_outInternalRepresentation.drop () ; // Release error dropped variable
              }
            }else if (kBoolFalse == test_8) {
              GALGAS_expressionAST var_indexExpression_11574 ;
              GALGAS_location var_endOfIndex_11601 ;
              var_registerIndex_10094.method_index (var_indexExpression_11574, var_endOfIndex_11601, inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 278)) ;
              GALGAS_objectIR var_indexIR_12198 ;
              {
              routine_handleArraySubscriptNew (constinArgument_inSelfType, constinArgument_inRoutineAttributes, constinArgument_inCallerNameForInvocationGraph, constinArgument_inContext, constinArgument_inMode, ioArgument_ioTemporaries, ioArgument_ioStaticEntityMap, ioArgument_ioUniversalMap, ioArgument_ioAllocaList, var_indexExpression_11574, var_endOfIndex_11601, var_inRegisterArraySize_10580.getter_bigint (SOURCE_FILE ("lvalue.galgas", 291)), var_inRegisterType_10186, ioArgument_ioInstructionGenerationList, var_indexIR_12198, inCompiler  COMMA_SOURCE_FILE ("lvalue.galgas", 279)) ;
              }
              const enumGalgasBool test_11 = var_indexIR_12198.getter_isLiteralInteger (SOURCE_FILE ("lvalue.galgas", 296)).boolEnum () ;
              if (kBoolTrue == test_11) {
                GALGAS_bigint var_idx_12348 ;
                GALGAS_PLMType joker_12323_1 ; // Joker input parameter
                var_indexIR_12198.method_literalInteger (joker_12323_1, var_idx_12348, inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 297)) ;
                GALGAS_bigint var_addr_12369 = extractedValue_registerAddress.add_operation (var_idx_12348.multiply_operation (var_inRegisterElementSize_10639.getter_bigint (SOURCE_FILE ("lvalue.galgas", 298)), inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 298)), inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 298)) ;
                outArgument_outInternalRepresentation = GALGAS_LValueRepresentation::constructor_volatileAbsoluteReference (var_inRegisterType_10186, var_addr_12369.getter_uint (inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 299))  COMMA_SOURCE_FILE ("lvalue.galgas", 299)) ;
              }else if (kBoolFalse == test_11) {
                GALGAS_string var_llvmName_12595 ;
                {
                extensionSetter_newTempLLVMVar (ioArgument_ioTemporaries, var_llvmName_12595, inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 301)) ;
                }
                {
                extensionSetter_appendComputeSubscriptedVolatileRegisterAddress (ioArgument_ioInstructionGenerationList, var_llvmName_12595, var_indexIR_12198, extractedValue_registerAddress, var_inRegisterElementSize_10639, inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 302)) ;
                }
                outArgument_outInternalRepresentation = GALGAS_LValueRepresentation::constructor_volatileIndirectReference (var_inRegisterType_10186, var_llvmName_12595  COMMA_SOURCE_FILE ("lvalue.galgas", 308)) ;
              }
            }
          }
        }
...
void routine_analyzeVariableInLValue (const GALGAS_PLMType constinArgument_inSelfType,
                                      ...
                                      COMMA_UNUSED_LOCATION_ARGS) {
  outArgument_outInternalRepresentation.drop () ; // Release 'out' argument
  const enumGalgasBool test_0 = constinArgument_inKind.getter_isRegular (SOURCE_FILE ("lvalue.galgas", 335)).operator_not (SOURCE_FILE ("lvalue.galgas", 335)).boolEnum () ;
  if (kBoolTrue == test_0) {
    TC_Array <C_FixItDescription> fixItArray1 ;
    inCompiler->emitSemanticError (constinArgument_inVariableName.getter_location (SOURCE_FILE ("lvalue.galgas", 336)), GALGAS_string ("the \":\" access is reserved for control register"), fixItArray1  COMMA_SOURCE_FILE ("lvalue.galgas", 336)) ;
    outArgument_outInternalRepresentation.drop () ; // Release error dropped variable
  }else if (kBoolFalse == test_0) {
    GALGAS_accessInAssignmentListAST var_accessList_14082 ;
    constinArgument_inKind.method_regular (var_accessList_14082, inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 338)) ;
    GALGAS_PLMType var_currentType_14103 = constinArgument_inVariableType ;
    GALGAS_string var_currentLLVMName_14144 = constinArgument_inLLVMName ;
    const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, var_accessList_14082.getter_length (SOURCE_FILE ("lvalue.galgas", 341)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_2) {
      const enumGalgasBool test_3 = constinArgument_inIsReadAccess.boolEnum () ;
      if (kBoolTrue == test_3) {
        {
        GALGAS_objectIR joker_14299 ; // Joker input parameter
        extensionSetter_searchValuedObjectForReadAccess (ioArgument_ioUniversalMap, constinArgument_inVariableName, joker_14299, inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 343)) ;
        }
      }else if (kBoolFalse == test_3) {
        {
        GALGAS_objectIR joker_14389 ; // Joker input parameter
        extensionSetter_searchValuedObjectForWriteAccess (ioArgument_ioUniversalMap, constinArgument_inVariableName, joker_14389, inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 345)) ;
        }
      }
    }else if (kBoolFalse == test_2) {
      ...
      if (kBoolTrue == test_4) {
        {
        GALGAS_objectIR joker_14515 ; // Joker input parameter
        extensionSetter_searchValuedObjectForReadAccess (ioArgument_ioUniversalMap, constinArgument_inVariableName, joker_14515, inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 349)) ;
        }
      }else if (kBoolFalse == test_4) {
        {
        GALGAS_objectIR joker_14609 ; // Joker input parameter
        extensionSetter_searchValuedObjectForReadWriteAccess (ioArgument_ioUniversalMap, constinArgument_inVariableName, joker_14609, inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 351)) ;
        }
      }
      cEnumerator_accessInAssignmentListAST enumerator_14654 (var_accessList_14082, kENUMERATION_UP) ;
      while (enumerator_14654.hasCurrentObject ()) {
        switch (enumerator_14654.current_mAccess (HERE).enumValue ()) {
        case GALGAS_accessInAssignmentAST::kNotBuilt:
          break ;
        case GALGAS_accessInAssignmentAST::kEnum_property:
          {
            const cEnumAssociatedValues_accessInAssignmentAST_property * extractPtr_15924 = (const cEnumAssociatedValues_accessInAssignmentAST_property *) (enumerator_14654.current_mAccess (HERE).unsafePointer ()) ;
            const GALGAS_lstring extractedValue_propertyName = extractPtr_15924->mAssociatedValue0 ;
            GALGAS_propertyMap var_propertyMap_14907 = var_currentType_14103.getter_propertyMap (HERE) ;
            GALGAS_propertyAccessKind var_propertyAccess_15023 ;
            GALGAS_bool joker_14982 ; // Joker input parameter
            var_propertyMap_14907.method_searchKey (extractedValue_propertyName, joker_14982, var_propertyAccess_15023, inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 359)) ;
            switch (var_propertyAccess_15023.enumValue ()) {
            case GALGAS_propertyAccessKind::kNotBuilt:
              break ;
            case GALGAS_propertyAccessKind::kEnum_nonVirtualMethod:
              {
                TC_Array <C_FixItDescription> fixItArray5 ;
                inCompiler->emitSemanticError (extractedValue_propertyName.getter_location (SOURCE_FILE ("lvalue.galgas", 362)), GALGAS_string ("a method cannot be written"), fixItArray5  COMMA_SOURCE_FILE ("lvalue.galgas", 362)) ;
                var_currentType_14103.drop () ; // Release error dropped variable
                var_currentLLVMName_14144.drop () ; // Release error dropped variable
              }
              break ;
            case GALGAS_propertyAccessKind::kEnum_singleton:
              {
                const cEnumAssociatedValues_propertyAccessKind_singleton * extractPtr_15325 = (const cEnumAssociatedValues_propertyAccessKind_singleton *) (var_propertyAccess_15023.unsafePointer ()) ;
                const GALGAS_objectIR extractedValue_object = extractPtr_15325->mAssociatedValue0 ;
                var_currentType_14103 = extensionGetter_type (extractedValue_object, inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 364)) ;
                var_currentLLVMName_14144 = extensionGetter_llvmName (extractedValue_object, inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 365)) ;
              }
              break ;
            case GALGAS_propertyAccessKind::kEnum_constantProperty:
              {
                TC_Array <C_FixItDescription> fixItArray6 ;
                inCompiler->emitSemanticError (extractedValue_propertyName.getter_location (SOURCE_FILE ("lvalue.galgas", 367)), GALGAS_string ("a constant property cannot be written"), fixItArray6  COMMA_SOURCE_FILE ("lvalue.galgas", 367)) ;
                var_currentType_14103.drop () ; // Release error dropped variable
                var_currentLLVMName_14144.drop () ; // Release error dropped variable
              }
              break ;
            case GALGAS_propertyAccessKind::kEnum_indexed:
              {
                const cEnumAssociatedValues_propertyAccessKind_indexed * extractPtr_15910 = (const cEnumAssociatedValues_propertyAccessKind_indexed *) (var_propertyAccess_15023.unsafePointer ()) ;
                const GALGAS_PLMType extractedValue_propertyType = extractPtr_15910->mAssociatedValue0 ;
                const GALGAS_uint extractedValue_index = extractPtr_15910->mAssociatedValue1 ;
                GALGAS_string var_newLLVMvariable_15593 ;
                {
                extensionSetter_newTempLLVMVar (ioArgument_ioTemporaries, var_newLLVMvariable_15593, inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 369)) ;
                }
                {
                extensionSetter_appendGetUniversalPropertyReference (ioArgument_ioInstructionGenerationList, var_currentType_14103, var_currentLLVMName_14144, var_newLLVMvariable_15593, extractedValue_index, extractedValue_propertyName.getter_string (SOURCE_FILE ("lvalue.galgas", 375)), inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 370)) ;
                }
                var_currentType_14103 = extractedValue_propertyType ;
                var_currentLLVMName_14144 = var_newLLVMvariable_15593 ;
              }
              break ;
            }
        ...
        case GALGAS_accessInAssignmentAST::kEnum_arrayAccess:
          {
            const cEnumAssociatedValues_accessInAssignmentAST_arrayAccess * extractPtr_17311 = (const cEnumAssociatedValues_accessInAssignmentAST_arrayAccess *) (enumerator_14654.current_mAccess (HERE).unsafePointer ()) ;
            const GALGAS_expressionAST extractedValue_indexExpression = extractPtr_17311->mAssociatedValue0 ;
            const GALGAS_location extractedValue_endOfIndex = extractPtr_17311->mAssociatedValue1 ;
            const enumGalgasBool test_7 = var_currentType_14103.getter_kind (HERE).getter_isArrayType (SOURCE_FILE ("lvalue.galgas", 381)).boolEnum () ;
            if (kBoolTrue == test_7) {
              GALGAS_PLMType var_elementType_16123 ;
              GALGAS_bigint var_arraySize_16151 ;
              var_currentType_14103.getter_kind (HERE).method_arrayType (var_elementType_16123, var_arraySize_16151, inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 382)) ;
              GALGAS_objectIR var_indexIR_16798 ;
              {
              routine_handleArraySubscriptNew (constinArgument_inSelfType, constinArgument_inRoutineAttributes, constinArgument_inCallerNameForInvocationGraph, constinArgument_inContext, constinArgument_inMode, ioArgument_ioTemporaries, ioArgument_ioStaticEntityMap, ioArgument_ioUniversalMap, ioArgument_ioAllocaList, extractedValue_indexExpression, extractedValue_endOfIndex, var_arraySize_16151, var_elementType_16123, ioArgument_ioInstructionGenerationList, var_indexIR_16798, inCompiler  COMMA_SOURCE_FILE ("lvalue.galgas", 383)) ;
              }
              GALGAS_string var_newLLVMvariable_16875 ;
              {
              extensionSetter_newTempLLVMVar (ioArgument_ioTemporaries, var_newLLVMvariable_16875, inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 400)) ;
              }
              {
              extensionSetter_appendGetUniversalArrayElementReference (ioArgument_ioInstructionGenerationList, var_currentType_14103, var_currentLLVMName_14144, var_elementType_16123, var_newLLVMvariable_16875, var_indexIR_16798, inCompiler COMMA_SOURCE_FILE ("lvalue.galgas", 401)) ;
              }
              var_currentType_14103 = var_elementType_16123 ;
              var_currentLLVMName_14144 = var_newLLVMvariable_16875 ;
            }else if (kBoolFalse == test_7) {
              TC_Array <C_FixItDescription> fixItArray8 ;
              inCompiler->emitSemanticError (extractedValue_endOfIndex, GALGAS_string ("cannot subscript, not an array"), fixItArray8  COMMA_SOURCE_FILE ("lvalue.galgas", 411)) ;
              var_currentType_14103.drop () ; // Release error dropped variable
              var_currentLLVMName_14144.drop () ; // Release error dropped variable
            }
          }
    ...
    outArgument_outInternalRepresentation = GALGAS_LValueRepresentation::constructor_universalReference (var_currentType_14103, var_currentLLVMName_14144  COMMA_SOURCE_FILE ("lvalue.galgas", 416)) ;
  }
}
