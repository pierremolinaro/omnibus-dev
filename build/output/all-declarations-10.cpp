...
static void extensionMethod_forLowerUpperBoundInstructionAST_analyze (const cPtr_instructionAST * inObject,
  ...
  case GALGAS_typeKind::kEnum_integer:
    {
      const cEnumAssociatedValues_typeKind_integer * extractPtr_8070 = (const cEnumAssociatedValues_typeKind_integer *) (var_type_4152.getter_kind (inCompiler COMMA_SOURCE_FILE ("instruction-for-in-lower-upper-bounds.galgas", 88)).unsafePointer ()) ;
      const GALGAS_bigint extractedValue_min = extractPtr_8070->mAssociatedValue0 ;
      const GALGAS_bigint extractedValue_max = extractPtr_8070->mAssociatedValue1 ;
      const GALGAS_bool extractedValue_unsigned = extractPtr_8070->mAssociatedValue2 ;
...
static void extensionMethod_callInstructionAST_noteInstructionTypesInPrecedenceGraph (const cPtr_instructionAST * inObject,
  ...
  cEnumerator_effectiveParameterListAST enumerator_2346 (object->mAttribute_mArguments, kEnumeration_up) ;
  while (enumerator_2346.hasCurrentObject ()) {
    switch (enumerator_2346.current_mEffectiveParameterKind (HERE).enumValue ()) {
    ...
    case GALGAS_effectiveParameterPassingModeAST::kEnum_inputWithType:
      {
        const cEnumAssociatedValues_effectiveParameterPassingModeAST_inputWithType * extractPtr_2577 = (const cEnumAssociatedValues_effectiveParameterPassingModeAST_inputWithType *) (enumerator_2346.current_mEffectiveParameterKind (HERE).unsafePointer ()) ;
        const GALGAS_lstring extractedValue_typeName = extractPtr_2577->mAssociatedValue1 ;
    ...
    case GALGAS_effectiveParameterPassingModeAST::kEnum_output:
      {
        const cEnumAssociatedValues_effectiveParameterPassingModeAST_output * extractPtr_2670 = (const cEnumAssociatedValues_effectiveParameterPassingModeAST_output *) (enumerator_2346.current_mEffectiveParameterKind (HERE).unsafePointer ()) ;
        const GALGAS_expressionAST extractedValue_expression = extractPtr_2670->mAssociatedValue0 ;
