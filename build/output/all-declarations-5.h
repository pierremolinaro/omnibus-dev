...
//--------------------------------- GALGAS constructors
  public : static GALGAS_semanticContext constructor_new (const class GALGAS_targetParameters & inOperand0,
                                                          ...
                                                          const class GALGAS_stringset & inOperand18,
                                                          const class GALGAS_availableInterruptMap & inOperand19,
                                                          ...
                                                          const class GALGAS_globalTaskVariableList & inOperand46
                                                          COMMA_LOCATION_ARGS) ;
...
void routine_analyzeVariableReadWriteAccess (const class GALGAS_accessList constinArgument0,
                                             ...
                                             class GALGAS_string & outArgument15,
                                             class C_Compiler * inCompiler
                                             COMMA_LOCATION_ARGS) ;
...
typedef void (*extensionMethodSignature_expressionAST_analyzeExpression) (const class cPtr_expressionAST * inObject,
                                                                          ...
                                                                          class GALGAS_allocaList & ioArgument11,
                                                                          class GALGAS_instructionListIR & ioArgument12,
                                                                          class GALGAS_operandIR & outArgument13,
                                                                          class C_Compiler * inCompiler
                                                                          COMMA_LOCATION_ARGS) ;
