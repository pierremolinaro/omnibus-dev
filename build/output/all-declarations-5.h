...
//--- 'parse' label
  public : virtual void nt_function_parse (C_Lexique_omnibus_5F_lexique * inCompiler) ;
...
//------------------------------------- 'isr' non terminal
//--- 'parse' label
  public : virtual void nt_isr_parse (C_Lexique_omnibus_5F_lexique * inCompiler) ;
...
//--- 'parse' label
  public : virtual void nt_structure_5F_function_parse (C_Lexique_omnibus_5F_lexique * inCompiler) ;
