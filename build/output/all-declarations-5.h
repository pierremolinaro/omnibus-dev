...
//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*
//                                                                                                                     *
//                                     @routineSectionDictionary_2D_element struct                                     *
//                                                                                                                     *
//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*

class GALGAS_routineSectionDictionary_2D_element : public AC_GALGAS_root {
//--------------------------------- Properties
  public : GALGAS_string mProperty_key ;

  public : GALGAS_string mProperty_mSectionRoutineMangledName ;
...
//--------------------------------- Default GALGAS constructor
  public : static GALGAS_routineSectionDictionary_2D_element constructor_default (LOCATION_ARGS) ;

//--------------------------------- Default constructor
  public : GALGAS_routineSectionDictionary_2D_element (void) ;

//--------------------------------- Virtual destructor (in debug mode)
  public : virtual ~ GALGAS_routineSectionDictionary_2D_element (void) ;

//--------------------------------- Native constructor
  public : GALGAS_routineSectionDictionary_2D_element (const GALGAS_string & in_key,
                                                       const GALGAS_string & in_mSectionRoutineMangledName) ;
...
//--------------------------------- Object extraction
  public : static GALGAS_routineSectionDictionary_2D_element extractObject (const GALGAS_object & inObject,
                                                                            C_Compiler * inCompiler
                                                                            COMMA_LOCATION_ARGS) ;

//--------------------------------- GALGAS constructors
  public : static class GALGAS_routineSectionDictionary_2D_element constructor_new (const class GALGAS_string & inOperand0,
...
//--------------------------------- Implementation of getter 'description'
  public : VIRTUAL_IN_DEBUG void description (C_String & ioString,
                                              const int32_t inIndentation) const ;
//--------------------------------- Comparison
  public : typeComparisonResult objectCompare (const GALGAS_routineSectionDictionary_2D_element & inOperand) const ;
...
//--------------------------------- Getters
  ...
  public : VIRTUAL_IN_DEBUG class GALGAS_string getter_mSectionRoutineMangledName (LOCATION_ARGS) const ;


//--------------------------------- Introspection
  public : VIRTUAL_IN_DEBUG const C_galgas_type_descriptor * staticTypeDescriptor (void) const ;
 
} ; // End of GALGAS_routineSectionDictionary_2D_element class


//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*

extern const C_galgas_type_descriptor kTypeDescriptor_GALGAS_routineSectionDictionary_2D_element ;
...
//----------- '' label
  ...
  public : virtual int32_t select_plm_5F_syntax_105 (C_Lexique_plm_5F_lexique *) ;

  public : virtual int32_t select_plm_5F_syntax_106 (C_Lexique_plm_5F_lexique *) ;

  public : virtual int32_t select_plm_5F_syntax_107 (C_Lexique_plm_5F_lexique *) ;

  public : virtual int32_t select_plm_5F_syntax_108 (C_Lexique_plm_5F_lexique *) ;

  public : virtual int32_t select_plm_5F_syntax_109 (C_Lexique_plm_5F_lexique *) ;
  ...
  public : virtual int32_t select_plm_5F_syntax_113 (C_Lexique_plm_5F_lexique *) ;

  public : virtual int32_t select_plm_5F_syntax_114 (C_Lexique_plm_5F_lexique *) ;

  public : virtual int32_t select_plm_5F_syntax_115 (C_Lexique_plm_5F_lexique *) ;
