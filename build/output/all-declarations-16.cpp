...
void routine_copyExecutableFileWithSubstitutions (const GALGAS_string constinArgument_inCurrentDirectory,
                                                  ...
                                                  C_Compiler * inCompiler
                                                  COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_s_6769 ;
  enumGalgasBool test_0 = kBoolTrue ;
  if (kBoolTrue == test_0) {
    test_0 = GALGAS_bool (kIsEqual, GALGAS_string (gOption_omnibus_5F_options_useDirAsTargetDir.readProperty_value ()).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_filewrapper var_fw_6866 = GALGAS_filewrapper (gWrapperDirectory_0_targetTemplates) ;
      var_s_6769 = var_fw_6866.getter_textFileContentsAtPath (constinArgument_inSourceFileNamePath, inCompiler COMMA_SOURCE_FILE ("target-generation.galgas", 165)) ;
    }
  }
  if (kBoolFalse == test_0) {
    ...
    var_s_6769 = GALGAS_string::constructor_stringWithContentsOfFile (var_targetDefinitionDir_6991.add_operation (GALGAS_string ("/"), inCompiler COMMA_SOURCE_FILE ("target-generation.galgas", 168)).add_operation (constinArgument_inSourceFileNamePath, inCompiler COMMA_SOURCE_FILE ("target-generation.galgas", 168)), inCompiler  COMMA_SOURCE_FILE ("target-generation.galgas", 168)) ;
  }
  cEnumerator__32_stringlist enumerator_7224 (constinArgument_inSubstitutions, kENUMERATION_UP) ;
  while (enumerator_7224.hasCurrentObject ()) {
    var_s_6769 = var_s_6769.getter_stringByReplacingStringByString (enumerator_7224.current_mValue_30_ (HERE), enumerator_7224.current_mValue_31_ (HERE), inCompiler COMMA_SOURCE_FILE ("target-generation.galgas", 171)) ;
    enumerator_7224.gotoNextObject () ;
  }
  GALGAS_bool joker_7413 ; // Joker input parameter
  var_s_6769.method_writeToExecutableFileWhenDifferentContents (constinArgument_inDestinationAbsoluteFilePath, joker_7413, inCompiler COMMA_SOURCE_FILE ("target-generation.galgas", 173)) ;
}
...
void routine_copyFileWithSubstitutions (const GALGAS_string constinArgument_inCurrentDirectory,
                                        ...
                                        C_Compiler * inCompiler
                                        COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_s_7767 ;
  enumGalgasBool test_0 = kBoolTrue ;
  if (kBoolTrue == test_0) {
    test_0 = GALGAS_bool (kIsEqual, GALGAS_string (gOption_omnibus_5F_options_useDirAsTargetDir.readProperty_value ()).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_filewrapper var_fw_7864 = GALGAS_filewrapper (gWrapperDirectory_0_targetTemplates) ;
      var_s_7767 = var_fw_7864.getter_textFileContentsAtPath (constinArgument_inSourceFileNamePath, inCompiler COMMA_SOURCE_FILE ("target-generation.galgas", 187)) ;
    }
  }
  if (kBoolFalse == test_0) {
    ...
    var_s_7767 = GALGAS_string::constructor_stringWithContentsOfFile (var_targetDefinitionDir_7989.add_operation (GALGAS_string ("/"), inCompiler COMMA_SOURCE_FILE ("target-generation.galgas", 190)).add_operation (constinArgument_inSourceFileNamePath, inCompiler COMMA_SOURCE_FILE ("target-generation.galgas", 190)), inCompiler  COMMA_SOURCE_FILE ("target-generation.galgas", 190)) ;
  }
  cEnumerator__32_stringlist enumerator_8222 (constinArgument_inSubstitutions, kENUMERATION_UP) ;
  while (enumerator_8222.hasCurrentObject ()) {
    var_s_7767 = var_s_7767.getter_stringByReplacingStringByString (enumerator_8222.current_mValue_30_ (HERE), enumerator_8222.current_mValue_31_ (HERE), inCompiler COMMA_SOURCE_FILE ("target-generation.galgas", 193)) ;
    enumerator_8222.gotoNextObject () ;
  }
  GALGAS_bool joker_8401 ; // Joker input parameter
  var_s_7767.method_writeToFileWhenDifferentContents (constinArgument_inDestinationAbsoluteFilePath, joker_8401, inCompiler COMMA_SOURCE_FILE ("target-generation.galgas", 195)) ;
}
...
GALGAS_string function_getTargetTextFile (const GALGAS_string & constinArgument_inCurrentDirectory,
  ...
  if (kBoolTrue == test_0) {
    test_0 = GALGAS_bool (kIsEqual, GALGAS_string (gOption_omnibus_5F_options_useDirAsTargetDir.readProperty_value ()).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_filewrapper var_fw_8753 = GALGAS_filewrapper (gWrapperDirectory_0_targetTemplates) ;
      result_outContents = var_fw_8753.getter_textFileContentsAtPath (constinArgument_inTargetFile, inCompiler COMMA_SOURCE_FILE ("target-generation.galgas", 207)) ;
    }
  }
  if (kBoolFalse == test_0) {
    ...
    result_outContents = GALGAS_string::constructor_stringWithContentsOfFile (var_targetDefinitionDir_8880.add_operation (GALGAS_string ("/"), inCompiler COMMA_SOURCE_FILE ("target-generation.galgas", 210)).add_operation (constinArgument_inTargetFile, inCompiler COMMA_SOURCE_FILE ("target-generation.galgas", 210)), inCompiler  COMMA_SOURCE_FILE ("target-generation.galgas", 210)) ;
  }
//---
